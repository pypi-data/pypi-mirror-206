...
class XlsChartWallOrFloor (  XlsObject, IChartWallOrFloor, IChartFillBorder) :
    ...
    def Border(self)->'ChartBorder':
        ...
        intPtr = GetDllLibXls().XlsChartWallOrFloor_get_Border(self.Ptr)
    ...
    def HasInterior(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartWallOrFloor_get_HasInterior(self.Ptr)
        return ret
    ...
    def HasLineProperties(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartWallOrFloor_get_HasLineProperties(self.Ptr)
        return ret
    ...
    def HasFormat3D(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartWallOrFloor_get_HasFormat3D(self.Ptr)
        return ret
    ...
    def HasShadow(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartWallOrFloor_get_HasShadow(self.Ptr)
        return ret
    ...
    def LineProperties(self)->'ChartBorder':
        ...
        intPtr = GetDllLibXls().XlsChartWallOrFloor_get_LineProperties(self.Ptr)
        ret = None if intPtr==None else ChartBorder(intPtr)
        return ret
    ...
    def Interior(self)->'IChartInterior':
        ...
        intPtr = GetDllLibXls().XlsChartWallOrFloor_get_Interior(self.Ptr)
    ...
    def Fill(self)->'IShapeFill':
        ...
        intPtr = GetDllLibXls().XlsChartWallOrFloor_get_Fill(self.Ptr)
    ...
    def Format3D(self)->'Format3D':
        ...
        intPtr = GetDllLibXls().XlsChartWallOrFloor_get_Format3D(self.Ptr)
    ...
    def Shadow(self)->'ChartShadow':
        ...
        intPtr = GetDllLibXls().XlsChartWallOrFloor_get_Shadow(self.Ptr)
    ...
    def Delete(self):
        ...
        GetDllLibXls().XlsChartWallOrFloor_Delete(self.Ptr)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsChartWallOrFloor_Clone(self.Ptr, intPtrparent)
    ...
    def SetToDefault(self):
        ...
        GetDllLibXls().XlsChartWallOrFloor_SetToDefault(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartWallOrFloor_get_ForeGroundColor(self.Ptr)
    ...
    def ForeGroundColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartWallOrFloor_set_ForeGroundColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartWallOrFloor_get_ForeGroundKnownColor(self.Ptr)
    ...
    def ForeGroundKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartWallOrFloor_set_ForeGroundKnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartWallOrFloor_get_ForeGroundColorObject(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartWallOrFloor_get_BackGroundColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def BackGroundColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartWallOrFloor_set_BackGroundColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartWallOrFloor_get_BackGroundKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def BackGroundKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartWallOrFloor_set_BackGroundKnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartWallOrFloor_get_BackGroundColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartWallOrFloor_get_Pattern(self.Ptr)
    ...
    def Pattern(self, value:'ExcelPatternType'):
        ...
        GetDllLibXls().XlsChartWallOrFloor_set_Pattern(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartWallOrFloor_get_IsAutomaticFormat(self.Ptr)
        return ret
    ...
    def IsAutomaticFormat(self, value:bool):
        ...
        GetDllLibXls().XlsChartWallOrFloor_set_IsAutomaticFormat(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartWallOrFloor_get_Visible(self.Ptr)
        return ret

    @Visible.setter
    def Visible(self, value:bool):
        GetDllLibXls().XlsChartWallOrFloor_set_Visible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartWallOrFloor_set_Visible(self.Ptr, value)
