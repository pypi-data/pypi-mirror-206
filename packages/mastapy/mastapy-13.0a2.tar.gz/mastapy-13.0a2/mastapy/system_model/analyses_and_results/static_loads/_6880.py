...
class KlingelnbergCycloPalloidHypoidGearMeshLoadCase(_6877.KlingelnbergCycloPalloidConicalGearMeshLoadCase):
    """KlingelnbergCycloPalloidHypoidGearMeshLoadCase
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearMeshLoadCase:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearMeshLoadCase'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_mesh_load_case(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshLoadCase._Cast_KlingelnbergCycloPalloidHypoidGearMeshLoadCase':
