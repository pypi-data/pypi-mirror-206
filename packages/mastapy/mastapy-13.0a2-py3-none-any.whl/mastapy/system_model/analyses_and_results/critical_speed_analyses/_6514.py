...
class AGMAGleasonConicalGearSetCriticalSpeedAnalysis(_6542.ConicalGearSetCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearSetCriticalSpeedAnalysis
    ...
    class _Cast_AGMAGleasonConicalGearSetCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearSetCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_set_critical_speed_analysis(self) -> 'AGMAGleasonConicalGearSetCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearSetCriticalSpeedAnalysis._Cast_AGMAGleasonConicalGearSetCriticalSpeedAnalysis':
