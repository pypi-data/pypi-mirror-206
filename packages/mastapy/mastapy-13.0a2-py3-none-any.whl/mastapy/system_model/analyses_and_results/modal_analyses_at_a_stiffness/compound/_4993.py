...
class ConicalGearMeshCompoundModalAnalysisAtAStiffness(_5019.GearMeshCompoundModalAnalysisAtAStiffness):
    """ConicalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_ConicalGearMeshCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ConicalGearMeshCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def conical_gear_mesh_compound_modal_analysis_at_a_stiffness(self) -> 'ConicalGearMeshCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4862.ConicalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4862.ConicalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'ConicalGearMeshCompoundModalAnalysisAtAStiffness._Cast_ConicalGearMeshCompoundModalAnalysisAtAStiffness':
