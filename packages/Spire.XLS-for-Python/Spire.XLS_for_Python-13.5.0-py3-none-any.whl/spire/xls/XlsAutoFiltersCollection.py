...
class XlsAutoFiltersCollection (  SpireObject, IAutoFilters) :
    ...
    def Sorter(self)->'DataSorter':
        ...
        intPtr = GetDllLibXls().XlsAutoFiltersCollection_get_Sorter(self.Ptr)
    ...
    def Range(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsAutoFiltersCollection_get_Range(self.Ptr)
    ...
    def Range(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsAutoFiltersCollection_set_Range(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsAutoFiltersCollection_get_AddressR1C1.restype=c_wchar_p
        ret = GetDllLibXls().XlsAutoFiltersCollection_get_AddressR1C1(self.Ptr)
        return ret
    ...
    def Worksheet(self)->'Worksheet':
        ...
        intPtr = GetDllLibXls().XlsAutoFiltersCollection_get_Worksheet(self.Ptr)
    ...
    def HasFiltered(self)->bool:
        ...
        ret = GetDllLibXls().XlsAutoFiltersCollection_get_HasFiltered(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsAutoFiltersCollection_get_Item(self.Ptr, columnIndex)
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().XlsAutoFiltersCollection_get_Count(self.Ptr)
        return ret
    ...
    def Clone(self ,parent:'XlsWorksheet')->'XlsAutoFiltersCollection':
        ...
        intPtr = GetDllLibXls().XlsAutoFiltersCollection_Clone(self.Ptr, intPtrparent)
