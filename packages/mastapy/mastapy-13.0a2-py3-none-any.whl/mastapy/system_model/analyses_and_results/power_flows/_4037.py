...
class ConceptCouplingPowerFlow(_4048.CouplingPowerFlow):
    """ConceptCouplingPowerFlow
    ...
    class _Cast_ConceptCouplingPowerFlow:
        ...
        def __init__(self, parent: 'ConceptCouplingPowerFlow'):
            self._parent = parent
        ...
        @property
        def concept_coupling_power_flow(self) -> 'ConceptCouplingPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingPowerFlow._Cast_ConceptCouplingPowerFlow':
