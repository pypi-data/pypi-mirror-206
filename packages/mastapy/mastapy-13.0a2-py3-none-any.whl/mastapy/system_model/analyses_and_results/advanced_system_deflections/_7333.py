...
class ShaftAdvancedSystemDeflection(_7233.AbstractShaftAdvancedSystemDeflection):
    """ShaftAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2783.ShaftSystemDeflection]':
