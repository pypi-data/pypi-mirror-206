...
class EigenvalueOptions(_0.APIBase):
    ...
    class _Cast_EigenvalueOptions:
        ...
        def __init__(self, parent: 'EigenvalueOptions'):
            self._parent = parent

        @property
        def eigenvalue_options(self) -> 'EigenvalueOptions':
            return self._parent
    ...
    @property
    def mass_matrix_type(self) -> '_195.MassMatrixType':
        ...
        value = conversion.pn_to_mp_enum(temp, _195.MassMatrixType)
        return constructor.new_from_mastapy_type(_195.MassMatrixType)(value) if value is not None else None

    @mass_matrix_type.setter
    def mass_matrix_type(self, value: '_195.MassMatrixType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _195.MassMatrixType.type_())
    ...
    @property
    def cast_to(self) -> 'EigenvalueOptions._Cast_EigenvalueOptions':
