...
from mastapy.materials.efficiency import _296, _297
...
class OilSeal(_2427.Connector):
    ...
    @property
    def drag_torque_vs_rotational_speed(self) -> '_1523.Vector2DListAccessor':
    ...
    def drag_torque_vs_rotational_speed(self, value: '_1523.Vector2DListAccessor'):
    ...
    @property
    def oil_seal_material(self) -> '_297.OilSealMaterialType':
        ...
        value = conversion.pn_to_mp_enum(temp, _297.OilSealMaterialType)
        return constructor.new_from_mastapy_type(_297.OilSealMaterialType)(value) if value is not None else None

    @oil_seal_material.setter
    def oil_seal_material(self, value: '_297.OilSealMaterialType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _297.OilSealMaterialType.type_())
    ...
    @property
    def oil_seal_orientation(self) -> '_1945.Orientations':
    ...
    def oil_seal_orientation(self, value: '_1945.Orientations'):
        value = value if value else None
