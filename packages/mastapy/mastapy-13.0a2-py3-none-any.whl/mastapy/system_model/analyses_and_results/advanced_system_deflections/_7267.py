...
class ConicalGearAdvancedSystemDeflection(_7295.GearAdvancedSystemDeflection):
    """ConicalGearAdvancedSystemDeflection
    ...
    class _Cast_ConicalGearAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'ConicalGearAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def conical_gear_advanced_system_deflection(self) -> 'ConicalGearAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConicalGearAdvancedSystemDeflection._Cast_ConicalGearAdvancedSystemDeflection':
