...
class CylindricalGearLTCAContactCharts(_1207.GearLTCAContactCharts):
    """CylindricalGearLTCAContactCharts
    ...
    class _Cast_CylindricalGearLTCAContactCharts:
        ...
        def __init__(self, parent: 'CylindricalGearLTCAContactCharts'):
            self._parent = parent

        @property
        def gear_ltca_contact_charts(self):
            return self._parent._cast(_1207.GearLTCAContactCharts)

        @property
        def cylindrical_gear_ltca_contact_charts(self) -> 'CylindricalGearLTCAContactCharts':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearLTCAContactCharts._Cast_CylindricalGearLTCAContactCharts':
