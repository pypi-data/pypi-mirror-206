...
class RingPinsCompoundModalAnalysisAtAStiffness(_5037.MountableComponentCompoundModalAnalysisAtAStiffness):
    """RingPinsCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_RingPinsCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'RingPinsCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def ring_pins_compound_modal_analysis_at_a_stiffness(self) -> 'RingPinsCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4920.RingPinsModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4920.RingPinsModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'RingPinsCompoundModalAnalysisAtAStiffness._Cast_RingPinsCompoundModalAnalysisAtAStiffness':
