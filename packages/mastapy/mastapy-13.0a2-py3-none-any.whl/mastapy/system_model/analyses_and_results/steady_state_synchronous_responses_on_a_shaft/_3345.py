...
class TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft(_3262.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    """TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_steady_state_synchronous_response_on_a_shaft(self) -> 'TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft._Cast_TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft(self)
