...
class AGMAScuffingResultsRow(_479.ScuffingResultsRow):
    """AGMAScuffingResultsRow
    ...
    class _Cast_AGMAScuffingResultsRow:
        ...
        def __init__(self, parent: 'AGMAScuffingResultsRow'):
            self._parent = parent

        @property
        def scuffing_results_row(self):
            return self._parent._cast(_479.ScuffingResultsRow)

        @property
        def agma_scuffing_results_row(self) -> 'AGMAScuffingResultsRow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMAScuffingResultsRow._Cast_AGMAScuffingResultsRow':
