...
_ELECTRIC_MACHINE_STATOR_TOOTH_MOMENTS_EXCITATION_DETAIL = python_net_import('SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses', 'ElectricMachineStatorToothMomentsExcitationDetail')
...
class ElectricMachineStatorToothMomentsExcitationDetail(_5709.ElectricMachineStatorToothLoadsExcitationDetail):
    """ElectricMachineStatorToothMomentsExcitationDetail
    ...
    class _Cast_ElectricMachineStatorToothMomentsExcitationDetail:
        ...
        def __init__(self, parent: 'ElectricMachineStatorToothMomentsExcitationDetail'):
            self._parent = parent
        ...
        @property
        def electric_machine_stator_tooth_moments_excitation_detail(self) -> 'ElectricMachineStatorToothMomentsExcitationDetail':
            return self._parent
    ...
    def __init__(self, instance_to_wrap: 'ElectricMachineStatorToothMomentsExcitationDetail.TYPE'):
        super().__init__(instance_to_wrap)
        self._freeze()

    @property
    def cast_to(self) -> 'ElectricMachineStatorToothMomentsExcitationDetail._Cast_ElectricMachineStatorToothMomentsExcitationDetail':
