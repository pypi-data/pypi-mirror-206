...
class ClutchHalfStabilityAnalysis(_3780.CouplingHalfStabilityAnalysis):
    """ClutchHalfStabilityAnalysis
    ...
    class _Cast_ClutchHalfStabilityAnalysis:
        ...
        def __init__(self, parent: 'ClutchHalfStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_half_stability_analysis(self) -> 'ClutchHalfStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchHalfStabilityAnalysis._Cast_ClutchHalfStabilityAnalysis':
