...
class FaceGearCompoundParametricStudyTool(_4476.GearCompoundParametricStudyTool):
    """FaceGearCompoundParametricStudyTool
    ...
    class _Cast_FaceGearCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'FaceGearCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def face_gear_compound_parametric_study_tool(self) -> 'FaceGearCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4332.FaceGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4332.FaceGearParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'FaceGearCompoundParametricStudyTool._Cast_FaceGearCompoundParametricStudyTool':
