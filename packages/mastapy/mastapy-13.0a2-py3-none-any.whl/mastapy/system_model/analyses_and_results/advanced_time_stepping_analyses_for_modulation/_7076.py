...
class SpringDamperAdvancedTimeSteppingAnalysisForModulation(_7010.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_SpringDamperAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'SpringDamperAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def spring_damper_advanced_time_stepping_analysis_for_modulation(self) -> 'SpringDamperAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperAdvancedTimeSteppingAnalysisForModulation._Cast_SpringDamperAdvancedTimeSteppingAnalysisForModulation':
