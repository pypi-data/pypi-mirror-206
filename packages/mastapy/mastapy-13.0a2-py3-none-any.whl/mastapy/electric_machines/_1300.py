...
from mastapy.electric_machines import _1262, _1284
...
class VShapedMagnetLayerSpecification(_1284.RotorInternalLayerSpecification):
    """VShapedMagnetLayerSpecification
    ...
    class _Cast_VShapedMagnetLayerSpecification:
        ...
        def __init__(self, parent: 'VShapedMagnetLayerSpecification'):
            self._parent = parent

        @property
        def rotor_internal_layer_specification(self):
            return self._parent._cast(_1284.RotorInternalLayerSpecification)

        @property
        def v_shaped_magnet_layer_specification(self) -> 'VShapedMagnetLayerSpecification':
            return self._parent
    ...
    @property
    def upper_flux_barrier_web_specification(self) -> '_1262.FluxBarrierOrWeb':
        ...
        value = conversion.pn_to_mp_enum(temp, _1262.FluxBarrierOrWeb)
        return constructor.new_from_mastapy_type(_1262.FluxBarrierOrWeb)(value) if value is not None else None

    @upper_flux_barrier_web_specification.setter
    def upper_flux_barrier_web_specification(self, value: '_1262.FluxBarrierOrWeb'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1262.FluxBarrierOrWeb.type_())
    ...
    @property
    def cast_to(self) -> 'VShapedMagnetLayerSpecification._Cast_VShapedMagnetLayerSpecification':
