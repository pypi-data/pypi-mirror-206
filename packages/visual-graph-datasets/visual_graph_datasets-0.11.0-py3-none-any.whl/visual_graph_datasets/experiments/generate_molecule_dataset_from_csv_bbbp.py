...
NAMESPACE = 'results/' + os.path.basename(__file__)
BASE_PATH = PATH
with Skippable(), (se := SubExperiment(EXPERIMENT_PATH, BASE_PATH, NAMESPACE, globals())):

    @se.hook('additional_graph_data')
    def additional_graph_data(e, mol, data):
        keys = [
            'node_importances_1_gao',
            'edge_importances_1_gao',
            'node_importances_2_gao',
            'edge_importances_2_gao'
        ]
