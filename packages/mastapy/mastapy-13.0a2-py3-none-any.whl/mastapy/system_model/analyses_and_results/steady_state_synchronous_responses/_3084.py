...
class TorqueConverterPumpSteadyStateSynchronousResponse(_3000.CouplingHalfSteadyStateSynchronousResponse):
    """TorqueConverterPumpSteadyStateSynchronousResponse
    ...
    class _Cast_TorqueConverterPumpSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'TorqueConverterPumpSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def torque_converter_pump_steady_state_synchronous_response(self) -> 'TorqueConverterPumpSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterPumpSteadyStateSynchronousResponse._Cast_TorqueConverterPumpSteadyStateSynchronousResponse':
