...
class MeasurementComponentModalAnalysisAtASpeed(_5211.VirtualComponentModalAnalysisAtASpeed):
    """MeasurementComponentModalAnalysisAtASpeed
    ...
    class _Cast_MeasurementComponentModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'MeasurementComponentModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def measurement_component_modal_analysis_at_a_speed(self) -> 'MeasurementComponentModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MeasurementComponentModalAnalysisAtASpeed._Cast_MeasurementComponentModalAnalysisAtASpeed':
