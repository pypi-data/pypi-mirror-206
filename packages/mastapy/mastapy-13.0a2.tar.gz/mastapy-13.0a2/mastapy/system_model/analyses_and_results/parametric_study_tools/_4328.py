...
class DutyCycleResultsForSingleBearing(_0.APIBase):
    ...
    class _Cast_DutyCycleResultsForSingleBearing:
        ...
        def __init__(self, parent: 'DutyCycleResultsForSingleBearing'):
            self._parent = parent

        @property
        def duty_cycle_results_for_single_bearing(self) -> 'DutyCycleResultsForSingleBearing':
            return self._parent
    ...
    @property
    def duty_cycle_results(self) -> '_1933.LoadedBearingDutyCycle':
    ...
    @property
    def cast_to(self) -> 'DutyCycleResultsForSingleBearing._Cast_DutyCycleResultsForSingleBearing':
