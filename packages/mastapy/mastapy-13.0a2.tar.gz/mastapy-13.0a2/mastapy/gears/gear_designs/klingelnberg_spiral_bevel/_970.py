...
from mastapy.gears.gear_designs.klingelnberg_spiral_bevel import _968, _969
...
class KlingelnbergCycloPalloidSpiralBevelGearSetDesign(_978.KlingelnbergConicalGearSetDesign):
    """KlingelnbergCycloPalloidSpiralBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_968.KlingelnbergCycloPalloidSpiralBevelGearDesign]':
    ...
    @property
    def klingelnberg_conical_meshes(self) -> 'List[_969.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes(self) -> 'List[_969.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign]':
