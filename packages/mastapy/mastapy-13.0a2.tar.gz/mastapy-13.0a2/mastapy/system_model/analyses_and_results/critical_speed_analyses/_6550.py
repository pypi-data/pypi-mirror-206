...
class CVTBeltConnectionCriticalSpeedAnalysis(_6517.BeltConnectionCriticalSpeedAnalysis):
    """CVTBeltConnectionCriticalSpeedAnalysis
    ...
    class _Cast_CVTBeltConnectionCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'CVTBeltConnectionCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def cvt_belt_connection_critical_speed_analysis(self) -> 'CVTBeltConnectionCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CVTBeltConnectionCriticalSpeedAnalysis._Cast_CVTBeltConnectionCriticalSpeedAnalysis':
