...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysisAtAStiffness(_5026.KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtAStiffness):
    """KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_compound_modal_analysis_at_a_stiffness(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4904.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4904.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysisAtAStiffness._Cast_KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysisAtAStiffness':
        return self._Cast_KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysisAtAStiffness(self)
