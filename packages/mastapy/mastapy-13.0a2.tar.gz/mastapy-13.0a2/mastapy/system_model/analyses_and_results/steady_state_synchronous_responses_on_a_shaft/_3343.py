...
class TorqueConverterPumpSteadyStateSynchronousResponseOnAShaft(_3262.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    """TorqueConverterPumpSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_TorqueConverterPumpSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'TorqueConverterPumpSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def torque_converter_pump_steady_state_synchronous_response_on_a_shaft(self) -> 'TorqueConverterPumpSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterPumpSteadyStateSynchronousResponseOnAShaft._Cast_TorqueConverterPumpSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_TorqueConverterPumpSteadyStateSynchronousResponseOnAShaft(self)
