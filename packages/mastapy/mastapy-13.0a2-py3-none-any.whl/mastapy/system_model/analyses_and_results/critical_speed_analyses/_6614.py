...
class SpringDamperHalfCriticalSpeedAnalysis(_6547.CouplingHalfCriticalSpeedAnalysis):
    """SpringDamperHalfCriticalSpeedAnalysis
    ...
    class _Cast_SpringDamperHalfCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'SpringDamperHalfCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def spring_damper_half_critical_speed_analysis(self) -> 'SpringDamperHalfCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperHalfCriticalSpeedAnalysis._Cast_SpringDamperHalfCriticalSpeedAnalysis':
