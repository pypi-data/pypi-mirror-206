...
from mastapy.gears.rating.cylindrical.optimisation import _496
from mastapy.gears.rating.cylindrical import _450, _456, _454
...
class CylindricalGearSetRating(_359.GearSetRating):
    """CylindricalGearSetRating
    ...
    @property
    def rating_method(self) -> '_247.CylindricalGearRatingMethods':
        ...
        value = conversion.pn_to_mp_enum(temp, _247.CylindricalGearRatingMethods)
        return constructor.new_from_mastapy_type(_247.CylindricalGearRatingMethods)(value) if value is not None else None
    ...
    @property
    def optimisations(self) -> '_496.CylindricalGearSetRatingOptimisationHelper':
    ...
    @property
    def gear_ratings(self) -> 'List[_456.CylindricalGearRating]':
    ...
    @property
    def cylindrical_mesh_ratings(self) -> 'List[_454.CylindricalGearMeshRating]':
    ...
    @property
    def vdi_cylindrical_gear_single_flank_ratings(self) -> 'List[_484.VDI2737InternalGearSingleFlankRating]':
