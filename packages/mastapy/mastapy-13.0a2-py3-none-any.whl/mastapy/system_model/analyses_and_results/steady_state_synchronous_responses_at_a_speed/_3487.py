...
class AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseAtASpeed(_3515.ConicalGearMeshSteadyStateSynchronousResponseAtASpeed):
    """AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_mesh_steady_state_synchronous_response_at_a_speed(self) -> 'AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseAtASpeed._Cast_AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseAtASpeed(self)
