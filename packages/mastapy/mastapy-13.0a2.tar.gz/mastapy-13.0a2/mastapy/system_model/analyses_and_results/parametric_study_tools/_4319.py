...
class CylindricalGearParametricStudyTool(_4337.GearParametricStudyTool):
    """CylindricalGearParametricStudyTool
    ...
    class _Cast_CylindricalGearParametricStudyTool:
        ...
        def __init__(self, parent: 'CylindricalGearParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_parametric_study_tool(self) -> 'CylindricalGearParametricStudyTool':
            return self._parent
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2724.CylindricalGearSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearParametricStudyTool._Cast_CylindricalGearParametricStudyTool':
