...
class CycloidalDiscHarmonicAnalysisOfSingleExcitation(_5976.AbstractShaftHarmonicAnalysisOfSingleExcitation):
    """CycloidalDiscHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_CycloidalDiscHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'CycloidalDiscHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_harmonic_analysis_of_single_excitation(self) -> 'CycloidalDiscHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscHarmonicAnalysisOfSingleExcitation._Cast_CycloidalDiscHarmonicAnalysisOfSingleExcitation':
