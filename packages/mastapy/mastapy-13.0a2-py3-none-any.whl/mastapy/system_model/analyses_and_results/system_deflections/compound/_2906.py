...
class MassDiscCompoundSystemDeflection(_2954.VirtualComponentCompoundSystemDeflection):
    """MassDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2758.MassDiscSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2758.MassDiscSystemDeflection]':
