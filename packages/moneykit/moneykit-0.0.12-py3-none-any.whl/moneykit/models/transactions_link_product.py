...
T = TypeVar("T", bound="TransactionsLinkProduct")
...
class TransactionsLinkProduct:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        settings = TransactionsProductSettings.from_dict(d.pop("settings"))
        ...
        transactions_link_product = cls(
            settings=settings,
            refreshed_at=refreshed_at,
            last_attempted_at=last_attempted_at,
        )

        transactions_link_product.additional_properties = d
        return transactions_link_product
