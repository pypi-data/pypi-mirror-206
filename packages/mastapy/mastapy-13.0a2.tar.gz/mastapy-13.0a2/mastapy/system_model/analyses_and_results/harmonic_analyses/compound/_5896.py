...
class CylindricalPlanetGearCompoundHarmonicAnalysis(_5893.CylindricalGearCompoundHarmonicAnalysis):
    """CylindricalPlanetGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5700.CylindricalPlanetGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5700.CylindricalPlanetGearHarmonicAnalysis]':
