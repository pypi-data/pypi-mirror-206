...
class TorqueConverterTurbineCompoundStabilityAnalysis(_3913.CouplingHalfCompoundStabilityAnalysis):
    """TorqueConverterTurbineCompoundStabilityAnalysis
    ...
    class _Cast_TorqueConverterTurbineCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_compound_stability_analysis(self) -> 'TorqueConverterTurbineCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3865.TorqueConverterTurbineStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3865.TorqueConverterTurbineStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineCompoundStabilityAnalysis._Cast_TorqueConverterTurbineCompoundStabilityAnalysis':
