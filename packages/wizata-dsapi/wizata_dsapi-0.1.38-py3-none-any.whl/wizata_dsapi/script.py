...
class Script(ApiDto):
    ...
    def from_json(self, obj):
        ...
        if "needExactColumnNumbers" in obj.keys():
            if obj["needExactColumnNumbers"].lower() == "false":
        ...
        if "needExactColumnNames" in obj.keys():
            if obj["needExactColumnNames"].lower() == "false":
