...
class ShaftCompoundModalAnalysisAtAStiffness(_4961.AbstractShaftCompoundModalAnalysisAtAStiffness):
    """ShaftCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4927.ShaftModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4927.ShaftModalAnalysisAtAStiffness]':
