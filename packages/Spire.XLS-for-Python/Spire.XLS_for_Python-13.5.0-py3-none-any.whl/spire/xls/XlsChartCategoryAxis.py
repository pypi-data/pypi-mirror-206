...
class XlsChartCategoryAxis (  XlsChartAxis, IChartCategoryAxis, IChartValueAxis) :
    ...
    def IsLogScale(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_IsLogScale(self.Ptr)
        return ret

    @IsLogScale.setter
    def IsLogScale(self, value:bool):
        GetDllLibXls().XlsChartCategoryAxis_set_IsLogScale.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartCategoryAxis_set_IsLogScale(self.Ptr, value)
    ...
    def MaxValue(self)->float:
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_MaxValue(self.Ptr)
        return ret

    @MaxValue.setter
    def MaxValue(self, value:float):
        GetDllLibXls().XlsChartCategoryAxis_set_MaxValue.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartCategoryAxis_set_MaxValue(self.Ptr, value)
    ...
    def MinValue(self)->float:
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_MinValue(self.Ptr)
        return ret

    @MinValue.setter
    def MinValue(self, value:float):
        GetDllLibXls().XlsChartCategoryAxis_set_MinValue.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartCategoryAxis_set_MinValue(self.Ptr, value)
    ...
    def LogBase(self)->float:
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_LogBase(self.Ptr)
        return ret

    @LogBase.setter
    def LogBase(self, value:float):
        GetDllLibXls().XlsChartCategoryAxis_set_LogBase.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartCategoryAxis_set_LogBase(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_CrossValue(self.Ptr)
        return ret

    @CrossValue.setter
    def CrossValue(self, value:float):
        GetDllLibXls().XlsChartCategoryAxis_set_CrossValue.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartCategoryAxis_set_CrossValue(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_CrossesAt(self.Ptr)
        return ret

    @CrossesAt.setter
    def CrossesAt(self, value:float):
        GetDllLibXls().XlsChartCategoryAxis_set_CrossesAt.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartCategoryAxis_set_CrossesAt(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_IsMaxCross(self.Ptr)
        return ret

    @IsMaxCross.setter
    def IsMaxCross(self, value:bool):
        GetDllLibXls().XlsChartCategoryAxis_set_IsMaxCross.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartCategoryAxis_set_IsMaxCross(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_CrossingPoint(self.Ptr)
        return ret
    ...
    def CrossingPoint(self, value:float):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_CrossingPoint(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_LabelFrequency(self.Ptr)
        return ret
    ...
    def LabelFrequency(self, value:int):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_LabelFrequency(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_TickLabelSpacing(self.Ptr)
        return ret
    ...
    def TickLabelSpacing(self, value:int):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_TickLabelSpacing(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_TickMarksFrequency(self.Ptr)
        return ret
    ...
    def TickMarksFrequency(self, value:int):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_TickMarksFrequency(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_TickMarkSpacing(self.Ptr)
        return ret
    ...
    def TickMarkSpacing(self, value:int):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_TickMarkSpacing(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_AxisBetweenCategories(self.Ptr)
        return ret
    ...
    def AxisBetweenCategories(self, value:bool):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_AxisBetweenCategories(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_IsReverseOrder(self.Ptr)
        return ret
    ...
    def IsReverseOrder(self, value:bool):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_IsReverseOrder(self.Ptr, value)
    ...
    def CategoryLabels(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsChartCategoryAxis_get_CategoryLabels(self.Ptr)
    ...
    def CategoryLabels(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_CategoryLabels(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtrArray = GetDllLibXls().XlsChartCategoryAxis_get_EnteredDirectlyCategoryLabels(self.Ptr)
    ...
    def EnteredDirectlyCategoryLabels(self, value:List['SpireObject']):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_EnteredDirectlyCategoryLabels(self.Ptr, vArray, vCount)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_CategoryType(self.Ptr)
    ...
    def CategoryType(self, value:'CategoryType'):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_CategoryType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_Offset(self.Ptr)
        return ret

    @Offset.setter
    def Offset(self, value:int):
        GetDllLibXls().XlsChartCategoryAxis_set_Offset.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartCategoryAxis_set_Offset(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_BaseUnit(self.Ptr)
    ...
    def BaseUnit(self, value:'ChartBaseUnitType'):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_BaseUnit(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_BaseUnitIsAuto(self.Ptr)
        return ret
    ...
    def BaseUnitIsAuto(self, value:bool):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_BaseUnitIsAuto(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_IsAutoMajor(self.Ptr)
        return ret

    @IsAutoMajor.setter
    def IsAutoMajor(self, value:bool):
        GetDllLibXls().XlsChartCategoryAxis_set_IsAutoMajor.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartCategoryAxis_set_IsAutoMajor(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_IsAutoMinor(self.Ptr)
        return ret

    @IsAutoMinor.setter
    def IsAutoMinor(self, value:bool):
        GetDllLibXls().XlsChartCategoryAxis_set_IsAutoMinor.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartCategoryAxis_set_IsAutoMinor(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_IsAutoCross(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_IsAutoMax(self.Ptr)
        return ret

    @IsAutoMax.setter
    def IsAutoMax(self, value:bool):
        GetDllLibXls().XlsChartCategoryAxis_set_IsAutoMax.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartCategoryAxis_set_IsAutoMax(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_IsAutoMin(self.Ptr)
        return ret

    @IsAutoMin.setter
    def IsAutoMin(self, value:bool):
        GetDllLibXls().XlsChartCategoryAxis_set_IsAutoMin.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartCategoryAxis_set_IsAutoMin(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_MajorUnit(self.Ptr)
        return ret

    @MajorUnit.setter
    def MajorUnit(self, value:float):
        GetDllLibXls().XlsChartCategoryAxis_set_MajorUnit.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartCategoryAxis_set_MajorUnit(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_MinorUnit(self.Ptr)
        return ret

    @MinorUnit.setter
    def MinorUnit(self, value:float):
        GetDllLibXls().XlsChartCategoryAxis_set_MinorUnit.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartCategoryAxis_set_MinorUnit(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_MajorUnitScale(self.Ptr)
        objwraped = ChartBaseUnitType(ret)
        return objwraped
    ...
    def MajorUnitScale(self, value:'ChartBaseUnitType'):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_MajorUnitScale(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_MinorUnitScale(self.Ptr)
        objwraped = ChartBaseUnitType(ret)
        return objwraped
    ...
    def MinorUnitScale(self, value:'ChartBaseUnitType'):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_MinorUnitScale(self.Ptr, value.value)
...
<remarks>Applies only to Histogram and Pareto charts.</remarks>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_IsBinningByCategory(self.Ptr)
        return ret
    ...
    def IsBinningByCategory(self, value:bool):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_IsBinningByCategory(self.Ptr, value)
...
<remarks>Applies only to Histogram and Pareto charts.</remarks>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_HasAutomaticBins(self.Ptr)
        return ret
    ...
    def HasAutomaticBins(self, value:bool):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_HasAutomaticBins(self.Ptr, value)
...
<remarks>Applies only to Histogram and Pareto charts.Can be a value from 1 through 31999.</remarks>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_NumberOfBins(self.Ptr)
        return ret

    @NumberOfBins.setter
    def NumberOfBins(self, value:int):
        GetDllLibXls().XlsChartCategoryAxis_set_NumberOfBins.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartCategoryAxis_set_NumberOfBins(self.Ptr, value)
...
<remarks>Applies only to Histogram and Pareto charts.</remarks>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_BinWidth(self.Ptr)
        return ret

    @BinWidth.setter
    def BinWidth(self, value:float):
        GetDllLibXls().XlsChartCategoryAxis_set_BinWidth.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartCategoryAxis_set_BinWidth(self.Ptr, value)
...
<remarks>Applies only to Histogram and Pareto charts.</remarks>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_UnderflowBinValue(self.Ptr)
        return ret
    ...
    def UnderflowBinValue(self, value:float):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_UnderflowBinValue(self.Ptr, value)
...
<remarks>Applies only to Histogram and Pareto charts.</remarks>
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_get_OverflowBinValue(self.Ptr)
        return ret
    ...
    def OverflowBinValue(self, value:float):
        ...
        GetDllLibXls().XlsChartCategoryAxis_set_OverflowBinValue(self.Ptr, value)
...
#        intPtr = GetDllLibXls().XlsChartCategoryAxis_Clone(self.Ptr, intPtrparent,intPtrdicFontIndexes,intPtrdicNewSheetNames)
...
#
    ...
    def DefaultCategoryAxisId()->int:
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_DefaultCategoryAxisId()
        return ret
    ...
    def DefaultSecondaryCategoryAxisId()->int:
        ...
        ret = GetDllLibXls().XlsChartCategoryAxis_DefaultSecondaryCategoryAxisId()
        return ret
