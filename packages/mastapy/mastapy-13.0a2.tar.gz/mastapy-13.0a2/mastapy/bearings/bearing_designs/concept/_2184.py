...
class ConceptRadialClearanceBearing(_2183.ConceptClearanceBearing):
    """ConceptRadialClearanceBearing
    ...
    class _Cast_ConceptRadialClearanceBearing:
        ...
        def __init__(self, parent: 'ConceptRadialClearanceBearing'):
            self._parent = parent
        ...
        @property
        def concept_radial_clearance_bearing(self) -> 'ConceptRadialClearanceBearing':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptRadialClearanceBearing._Cast_ConceptRadialClearanceBearing':
