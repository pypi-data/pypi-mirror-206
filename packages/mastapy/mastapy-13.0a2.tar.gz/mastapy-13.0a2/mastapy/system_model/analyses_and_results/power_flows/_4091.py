...
class PartToPartShearCouplingHalfPowerFlow(_4047.CouplingHalfPowerFlow):
    """PartToPartShearCouplingHalfPowerFlow
    ...
    class _Cast_PartToPartShearCouplingHalfPowerFlow:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingHalfPowerFlow'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_half_power_flow(self) -> 'PartToPartShearCouplingHalfPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingHalfPowerFlow._Cast_PartToPartShearCouplingHalfPowerFlow':
