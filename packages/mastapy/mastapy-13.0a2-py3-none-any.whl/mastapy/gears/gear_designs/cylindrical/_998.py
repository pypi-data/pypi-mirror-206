...
class CrossedAxisCylindricalGearPair(_0.APIBase):
    ...
    class _Cast_CrossedAxisCylindricalGearPair:
        ...
        def __init__(self, parent: 'CrossedAxisCylindricalGearPair'):
            self._parent = parent

        @property
        def crossed_axis_cylindrical_gear_pair_line_contact(self):
            from mastapy.gears.gear_designs.cylindrical import _999
            
            return self._parent._cast(_999.CrossedAxisCylindricalGearPairLineContact)

        @property
        def crossed_axis_cylindrical_gear_pair_point_contact(self):
            from mastapy.gears.gear_designs.cylindrical import _1000
            
            return self._parent._cast(_1000.CrossedAxisCylindricalGearPairPointContact)

        @property
        def crossed_axis_cylindrical_gear_pair(self) -> 'CrossedAxisCylindricalGearPair':
            return self._parent
    ...
    @property
    def shaver(self) -> '_727.CylindricalCutterSimulatableGear':
    ...
    @property
    def cast_to(self) -> 'CrossedAxisCylindricalGearPair._Cast_CrossedAxisCylindricalGearPair':
