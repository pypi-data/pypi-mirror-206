...
class BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse(_3106.BevelDifferentialGearCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def bevel_differential_planet_gear_compound_steady_state_synchronous_response(self) -> 'BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2976.BevelDifferentialPlanetGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2976.BevelDifferentialPlanetGearSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse._Cast_BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse':
        return self._Cast_BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse(self)
