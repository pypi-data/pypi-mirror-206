...
class BevelGearLoadCase(_6778.AGMAGleasonConicalGearLoadCase):
    """BevelGearLoadCase
    ...
    class _Cast_BevelGearLoadCase:
        ...
        def __init__(self, parent: 'BevelGearLoadCase'):
            self._parent = parent
        ...
        @property
        def bevel_gear_load_case(self) -> 'BevelGearLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearLoadCase._Cast_BevelGearLoadCase':
