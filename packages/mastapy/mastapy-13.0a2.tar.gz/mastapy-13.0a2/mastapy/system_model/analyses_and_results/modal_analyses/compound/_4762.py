...
class GuideDxfModelCompoundModalAnalysis(_4726.ComponentCompoundModalAnalysis):
    """GuideDxfModelCompoundModalAnalysis
    ...
    class _Cast_GuideDxfModelCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'GuideDxfModelCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def guide_dxf_model_compound_modal_analysis(self) -> 'GuideDxfModelCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4612.GuideDxfModelModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4612.GuideDxfModelModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'GuideDxfModelCompoundModalAnalysis._Cast_GuideDxfModelCompoundModalAnalysis':
