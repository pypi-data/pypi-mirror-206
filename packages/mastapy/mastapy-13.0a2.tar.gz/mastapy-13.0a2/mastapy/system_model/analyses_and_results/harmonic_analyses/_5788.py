...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5786, _5787, _5667
...
class StraightBevelDiffGearSetHarmonicAnalysis(_5667.BevelGearSetHarmonicAnalysis):
    """StraightBevelDiffGearSetHarmonicAnalysis
    ...
    class _Cast_StraightBevelDiffGearSetHarmonicAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearSetHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_set_harmonic_analysis(self) -> 'StraightBevelDiffGearSetHarmonicAnalysis':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2793.StraightBevelDiffGearSetSystemDeflection':
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5786.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_harmonic_analysis(self) -> 'List[_5786.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5787.StraightBevelDiffGearMeshHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_harmonic_analysis(self) -> 'List[_5787.StraightBevelDiffGearMeshHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearSetHarmonicAnalysis._Cast_StraightBevelDiffGearSetHarmonicAnalysis':
