...
class DatumCompoundCriticalSpeedAnalysis(_6664.ComponentCompoundCriticalSpeedAnalysis):
    """DatumCompoundCriticalSpeedAnalysis
    ...
    class _Cast_DatumCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'DatumCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def datum_compound_critical_speed_analysis(self) -> 'DatumCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6561.DatumCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6561.DatumCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'DatumCompoundCriticalSpeedAnalysis._Cast_DatumCompoundCriticalSpeedAnalysis':
