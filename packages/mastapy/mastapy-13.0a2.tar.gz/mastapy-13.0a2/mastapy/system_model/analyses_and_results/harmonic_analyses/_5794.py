...
class SynchroniserHalfHarmonicAnalysis(_5796.SynchroniserPartHarmonicAnalysis):
    """SynchroniserHalfHarmonicAnalysis
    ...
    class _Cast_SynchroniserHalfHarmonicAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserHalfHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_half_harmonic_analysis(self) -> 'SynchroniserHalfHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserHalfHarmonicAnalysis._Cast_SynchroniserHalfHarmonicAnalysis':
