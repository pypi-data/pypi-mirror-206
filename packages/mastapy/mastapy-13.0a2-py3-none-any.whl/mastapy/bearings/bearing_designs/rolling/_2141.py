...
class GeometricConstantsForRollingFrictionalMoments(_0.APIBase):
    ...
    class _Cast_GeometricConstantsForRollingFrictionalMoments:
        ...
        def __init__(self, parent: 'GeometricConstantsForRollingFrictionalMoments'):
            self._parent = parent

        @property
        def geometric_constants_for_rolling_frictional_moments(self) -> 'GeometricConstantsForRollingFrictionalMoments':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GeometricConstantsForRollingFrictionalMoments._Cast_GeometricConstantsForRollingFrictionalMoments':
