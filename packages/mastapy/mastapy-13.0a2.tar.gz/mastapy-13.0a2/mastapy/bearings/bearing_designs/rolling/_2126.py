...
class BallBearingShoulderDefinition(_0.APIBase):
    ...
    class _Cast_BallBearingShoulderDefinition:
        ...
        def __init__(self, parent: 'BallBearingShoulderDefinition'):
            self._parent = parent

        @property
        def ball_bearing_shoulder_definition(self) -> 'BallBearingShoulderDefinition':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BallBearingShoulderDefinition._Cast_BallBearingShoulderDefinition':
