...
class CVTPulleyCompoundSteadyStateSynchronousResponse(_3183.PulleyCompoundSteadyStateSynchronousResponse):
    """CVTPulleyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3003.CVTPulleySteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3003.CVTPulleySteadyStateSynchronousResponse]':
