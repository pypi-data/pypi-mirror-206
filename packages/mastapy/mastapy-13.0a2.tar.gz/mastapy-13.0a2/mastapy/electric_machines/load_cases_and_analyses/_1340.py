...
class ElectricMachineBasicMechanicalLossSettings(_0.APIBase):
    ...
    class _Cast_ElectricMachineBasicMechanicalLossSettings:
        ...
        def __init__(self, parent: 'ElectricMachineBasicMechanicalLossSettings'):
            self._parent = parent

        @property
        def electric_machine_basic_mechanical_loss_settings(self) -> 'ElectricMachineBasicMechanicalLossSettings':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ElectricMachineBasicMechanicalLossSettings._Cast_ElectricMachineBasicMechanicalLossSettings':
