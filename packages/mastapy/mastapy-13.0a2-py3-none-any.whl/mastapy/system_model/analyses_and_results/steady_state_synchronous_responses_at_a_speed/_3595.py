...
class StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed(_3591.StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_planet_gear_steady_state_synchronous_response_at_a_speed(self) -> 'StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed._Cast_StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed(self)
