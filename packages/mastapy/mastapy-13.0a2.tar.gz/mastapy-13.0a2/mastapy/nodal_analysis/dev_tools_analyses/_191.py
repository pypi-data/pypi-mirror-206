...
class FENodeSelectionDrawStyle(_0.APIBase):
    ...
    class _Cast_FENodeSelectionDrawStyle:
        ...
        def __init__(self, parent: 'FENodeSelectionDrawStyle'):
            self._parent = parent

        @property
        def fe_node_selection_draw_style(self) -> 'FENodeSelectionDrawStyle':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FENodeSelectionDrawStyle._Cast_FENodeSelectionDrawStyle':
