...
class SpringDamperConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6143.CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """SpringDamperConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_SpringDamperConnectionCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'SpringDamperConnectionCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_compound_harmonic_analysis_of_single_excitation(self) -> 'SpringDamperConnectionCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6078.SpringDamperConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6078.SpringDamperConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionCompoundHarmonicAnalysisOfSingleExcitation._Cast_SpringDamperConnectionCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_SpringDamperConnectionCompoundHarmonicAnalysisOfSingleExcitation(self)
