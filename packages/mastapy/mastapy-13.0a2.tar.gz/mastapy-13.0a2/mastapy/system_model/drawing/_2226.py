...
class ConcentricPartGroupCombinationSystemDeflectionShaftResults(_0.APIBase):
    ...
    class _Cast_ConcentricPartGroupCombinationSystemDeflectionShaftResults:
        ...
        def __init__(self, parent: 'ConcentricPartGroupCombinationSystemDeflectionShaftResults'):
            self._parent = parent

        @property
        def concentric_part_group_combination_system_deflection_shaft_results(self) -> 'ConcentricPartGroupCombinationSystemDeflectionShaftResults':
            return self._parent
    ...
    @property
    def shaft_system_deflection(self) -> '_2783.ShaftSystemDeflection':
    ...
    @property
    def node_results(self) -> 'List[_2237.ShaftDeflectionDrawingNodeItem]':
    ...
    @property
    def cast_to(self) -> 'ConcentricPartGroupCombinationSystemDeflectionShaftResults._Cast_ConcentricPartGroupCombinationSystemDeflectionShaftResults':
        return self._Cast_ConcentricPartGroupCombinationSystemDeflectionShaftResults(self)
