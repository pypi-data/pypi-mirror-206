...
class ElectricMachineResultsForPhaseAtTimeStep(_0.APIBase):
    ...
    class _Cast_ElectricMachineResultsForPhaseAtTimeStep:
        ...
        def __init__(self, parent: 'ElectricMachineResultsForPhaseAtTimeStep'):
            self._parent = parent

        @property
        def electric_machine_results_for_phase_at_time_step(self) -> 'ElectricMachineResultsForPhaseAtTimeStep':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ElectricMachineResultsForPhaseAtTimeStep._Cast_ElectricMachineResultsForPhaseAtTimeStep':
