...
class ConceptCouplingHarmonicAnalysis(_5689.CouplingHarmonicAnalysis):
    """ConceptCouplingHarmonicAnalysis
    ...
    class _Cast_ConceptCouplingHarmonicAnalysis:
        ...
        def __init__(self, parent: 'ConceptCouplingHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_coupling_harmonic_analysis(self) -> 'ConceptCouplingHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHarmonicAnalysis._Cast_ConceptCouplingHarmonicAnalysis':
