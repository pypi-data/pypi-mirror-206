...
class ConceptCouplingHalfCompoundModalAnalysisAtASpeed(_5257.CouplingHalfCompoundModalAnalysisAtASpeed):
    """ConceptCouplingHalfCompoundModalAnalysisAtASpeed
    ...
    class _Cast_ConceptCouplingHalfCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ConceptCouplingHalfCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def concept_coupling_half_compound_modal_analysis_at_a_speed(self) -> 'ConceptCouplingHalfCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5116.ConceptCouplingHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5116.ConceptCouplingHalfModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHalfCompoundModalAnalysisAtASpeed._Cast_ConceptCouplingHalfCompoundModalAnalysisAtASpeed':
