...
SchemaFor200ResponseBodyApplicationJson = GetUserAccountsResponse
...
class GetUserAccounts(BaseApi):
    ...
    def get_user_accounts(
        ...
        return self._get_user_accounts_oapg(
