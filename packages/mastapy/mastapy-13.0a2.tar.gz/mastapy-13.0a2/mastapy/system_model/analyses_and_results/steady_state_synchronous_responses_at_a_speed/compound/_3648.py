...
class ConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_7501.ConnectionCompoundAnalysis):
    """ConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ConnectionCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ConnectionCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def connection_compound_steady_state_synchronous_response_at_a_speed(self) -> 'ConnectionCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3518.ConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3518.ConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ConnectionCompoundSteadyStateSynchronousResponseAtASpeed._Cast_ConnectionCompoundSteadyStateSynchronousResponseAtASpeed':
