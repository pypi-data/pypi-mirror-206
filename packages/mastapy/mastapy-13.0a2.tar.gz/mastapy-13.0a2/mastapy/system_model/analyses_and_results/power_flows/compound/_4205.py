...
class HypoidGearMeshCompoundPowerFlow(_4147.AGMAGleasonConicalGearMeshCompoundPowerFlow):
    """HypoidGearMeshCompoundPowerFlow
    ...
    class _Cast_HypoidGearMeshCompoundPowerFlow:
        ...
        def __init__(self, parent: 'HypoidGearMeshCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_mesh_compound_power_flow(self) -> 'HypoidGearMeshCompoundPowerFlow':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4072.HypoidGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4072.HypoidGearMeshPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearMeshCompoundPowerFlow._Cast_HypoidGearMeshCompoundPowerFlow':
