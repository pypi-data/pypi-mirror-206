...
class CylindricalPlanetGearParametricStudyTool(_4319.CylindricalGearParametricStudyTool):
    """CylindricalPlanetGearParametricStudyTool
    ...
    class _Cast_CylindricalPlanetGearParametricStudyTool:
        ...
        def __init__(self, parent: 'CylindricalPlanetGearParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def cylindrical_planet_gear_parametric_study_tool(self) -> 'CylindricalPlanetGearParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalPlanetGearParametricStudyTool._Cast_CylindricalPlanetGearParametricStudyTool':
