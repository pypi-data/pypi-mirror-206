...
class StraightBevelSunGearCompoundSteadyStateSynchronousResponseAtASpeed(_3718.StraightBevelDiffGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelSunGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_StraightBevelSunGearCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelSunGearCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_sun_gear_compound_steady_state_synchronous_response_at_a_speed(self) -> 'StraightBevelSunGearCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3596.StraightBevelSunGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3596.StraightBevelSunGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelSunGearCompoundSteadyStateSynchronousResponseAtASpeed._Cast_StraightBevelSunGearCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_StraightBevelSunGearCompoundSteadyStateSynchronousResponseAtASpeed(self)
