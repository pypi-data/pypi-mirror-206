...
class RadioButtonCollection (  CollectionBase[XlsRadioButtonShape], IRadioButtons) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().RadioButtonCollection_get_Item(self.Ptr, index)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().RadioButtonCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsRadioButtonShape(intPtr)
        return ret
    ...
    <returns>returns option button shape</returns>
        ...
        intPtr = GetDllLibXls().RadioButtonCollection_Add(self.Ptr)
        ret = None if intPtr==None else XlsRadioButtonShape(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().RadioButtonCollection_AddRC(self.Ptr, row,column)
        ret = None if intPtr==None else XlsRadioButtonShape(intPtr)
        return ret
    ...
    <returns>Newly created TextBox object.</returns>
        ...
        intPtr = GetDllLibXls().RadioButtonCollection_AddRCHW(self.Ptr, row,column,height,width)
        ret = None if intPtr==None else XlsRadioButtonShape(intPtr)
        return ret
    ...
    def AddCopy(self ,source:'IRadioButton'):
        ...
        GetDllLibXls().RadioButtonCollection_AddCopy(self.Ptr, intPtrsource)
    ...
    def Clear(self):
        ...
        GetDllLibXls().RadioButtonCollection_Clear(self.Ptr)
    ...
    def AverageWidth()->int:
        ...
        ret = GetDllLibXls().RadioButtonCollection_AverageWidth()
        return ret
    ...
    def AverageHeight()->int:
        ...
        ret = GetDllLibXls().RadioButtonCollection_AverageHeight()
        return ret
