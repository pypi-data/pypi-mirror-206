...
class TorqueConverterTurbineCompoundModalAnalysisAtAStiffness(_4999.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """TorqueConverterTurbineCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_TorqueConverterTurbineCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_compound_modal_analysis_at_a_stiffness(self) -> 'TorqueConverterTurbineCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4951.TorqueConverterTurbineModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4951.TorqueConverterTurbineModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineCompoundModalAnalysisAtAStiffness._Cast_TorqueConverterTurbineCompoundModalAnalysisAtAStiffness':
