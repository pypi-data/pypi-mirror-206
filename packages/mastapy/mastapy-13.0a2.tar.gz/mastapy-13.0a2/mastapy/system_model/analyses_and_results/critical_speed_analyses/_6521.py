...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6519, _6520, _6526
...
class BevelDifferentialGearSetCriticalSpeedAnalysis(_6526.BevelGearSetCriticalSpeedAnalysis):
    """BevelDifferentialGearSetCriticalSpeedAnalysis
    ...
    class _Cast_BevelDifferentialGearSetCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialGearSetCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_set_critical_speed_analysis(self) -> 'BevelDifferentialGearSetCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def bevel_differential_gears_critical_speed_analysis(self) -> 'List[_6519.BevelDifferentialGearCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_meshes_critical_speed_analysis(self) -> 'List[_6520.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearSetCriticalSpeedAnalysis._Cast_BevelDifferentialGearSetCriticalSpeedAnalysis':
