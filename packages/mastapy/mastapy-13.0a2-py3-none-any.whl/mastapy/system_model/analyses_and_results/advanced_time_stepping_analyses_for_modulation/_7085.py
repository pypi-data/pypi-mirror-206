...
class StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation(_7079.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def straight_bevel_planet_gear_advanced_time_stepping_analysis_for_modulation(self) -> 'StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation._Cast_StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation(self)
