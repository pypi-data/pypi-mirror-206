...
from mastapy.gears.materials import _597, _589
...
class CylindricalGearMaterial(_589.GearMaterial):
    """CylindricalGearMaterial
    ...
    class _Cast_CylindricalGearMaterial:
        ...
        def __init__(self, parent: 'CylindricalGearMaterial'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_material(self) -> 'CylindricalGearMaterial':
            return self._parent
    ...
    @property
    def heat_treatment_distortion_control(self) -> '_597.ManufactureRating':
        ...
        value = conversion.pn_to_mp_enum(temp, _597.ManufactureRating)
        return constructor.new_from_mastapy_type(_597.ManufactureRating)(value) if value is not None else None

    @heat_treatment_distortion_control.setter
    def heat_treatment_distortion_control(self, value: '_597.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _597.ManufactureRating.type_())
        self.wrapped.HeatTreatmentDistortionControl = value

    @property
    def heat_treatment_process_development(self) -> '_597.ManufactureRating':
    ...
    def heat_treatment_process_development(self, value: '_597.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _597.ManufactureRating.type_())
        self.wrapped.HeatTreatmentProcessDevelopment = value

    @property
    def machine_process_development(self) -> '_597.ManufactureRating':
    ...
    def machine_process_development(self, value: '_597.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _597.ManufactureRating.type_())
        self.wrapped.MachineProcessDevelopment = value

    @property
    def manufacturability(self) -> '_597.ManufactureRating':
    ...
    def manufacturability(self, value: '_597.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _597.ManufactureRating.type_())
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMaterial._Cast_CylindricalGearMaterial':
