...
class OilSealCompoundSteadyStateSynchronousResponseAtASpeed(_3649.ConnectorCompoundSteadyStateSynchronousResponseAtASpeed):
    """OilSealCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3561.OilSealSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3561.OilSealSteadyStateSynchronousResponseAtASpeed]':
