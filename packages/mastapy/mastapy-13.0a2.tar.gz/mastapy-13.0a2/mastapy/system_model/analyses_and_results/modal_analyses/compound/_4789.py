...
class PulleyCompoundModalAnalysis(_4740.CouplingHalfCompoundModalAnalysis):
    """PulleyCompoundModalAnalysis
    ...
    class _Cast_PulleyCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'PulleyCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def pulley_compound_modal_analysis(self) -> 'PulleyCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4644.PulleyModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4644.PulleyModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PulleyCompoundModalAnalysis._Cast_PulleyCompoundModalAnalysis':
