...
class StraightBevelDiffGearMeshParametricStudyTool(_4287.BevelGearMeshParametricStudyTool):
    """StraightBevelDiffGearMeshParametricStudyTool
    ...
    class _Cast_StraightBevelDiffGearMeshParametricStudyTool:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearMeshParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_mesh_parametric_study_tool(self) -> 'StraightBevelDiffGearMeshParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearMeshParametricStudyTool._Cast_StraightBevelDiffGearMeshParametricStudyTool':
