...
class BeltConnectionSteadyStateSynchronousResponseOnAShaft(_3289.InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft):
    """BeltConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_BeltConnectionSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'BeltConnectionSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def belt_connection_steady_state_synchronous_response_on_a_shaft(self) -> 'BeltConnectionSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BeltConnectionSteadyStateSynchronousResponseOnAShaft._Cast_BeltConnectionSteadyStateSynchronousResponseOnAShaft':
