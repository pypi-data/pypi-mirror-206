...
class BevelDifferentialGearCompoundCriticalSpeedAnalysis(_6655.BevelGearCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearCompoundCriticalSpeedAnalysis
    ...
    class _Cast_BevelDifferentialGearCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialGearCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_compound_critical_speed_analysis(self) -> 'BevelDifferentialGearCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6519.BevelDifferentialGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6519.BevelDifferentialGearCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearCompoundCriticalSpeedAnalysis._Cast_BevelDifferentialGearCompoundCriticalSpeedAnalysis':
