...
class LoadedBolt(_0.APIBase):
    ...
    class _Cast_LoadedBolt:
        ...
        def __init__(self, parent: 'LoadedBolt'):
            self._parent = parent

        @property
        def loaded_bolt(self) -> 'LoadedBolt':
            return self._parent
    ...
    @property
    def axial_load_type(self) -> '_1453.AxialLoadType':
        ...
        value = conversion.pn_to_mp_enum(temp, _1453.AxialLoadType)
        return constructor.new_from_mastapy_type(_1453.AxialLoadType)(value) if value is not None else None

    @axial_load_type.setter
    def axial_load_type(self, value: '_1453.AxialLoadType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1453.AxialLoadType.type_())
    ...
    @property
    def joint_type(self) -> '_1469.JointTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, _1469.JointTypes)
        return constructor.new_from_mastapy_type(_1469.JointTypes)(value) if value is not None else None

    @joint_type.setter
    def joint_type(self, value: '_1469.JointTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1469.JointTypes.type_())
    ...
    @property
    def tightening_technique(self) -> '_1475.TighteningTechniques':
        ...
        value = conversion.pn_to_mp_enum(temp, _1475.TighteningTechniques)
        return constructor.new_from_mastapy_type(_1475.TighteningTechniques)(value) if value is not None else None

    @tightening_technique.setter
    def tightening_technique(self, value: '_1475.TighteningTechniques'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1475.TighteningTechniques.type_())
    ...
    @property
    def bolt(self) -> '_1465.DetailedBoltDesign':
    ...
    @property
    def cast_to(self) -> 'LoadedBolt._Cast_LoadedBolt':
