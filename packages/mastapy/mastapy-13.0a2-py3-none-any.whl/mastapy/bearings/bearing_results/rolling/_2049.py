...
class PermissibleContinuousAxialLoadResults(_0.APIBase):
    ...
    class _Cast_PermissibleContinuousAxialLoadResults:
        ...
        def __init__(self, parent: 'PermissibleContinuousAxialLoadResults'):
            self._parent = parent

        @property
        def permissible_continuous_axial_load_results(self) -> 'PermissibleContinuousAxialLoadResults':
            return self._parent
    ...
    @property
    def calculation_method(self) -> '_1927.CylindricalRollerMaxAxialLoadMethod':
    ...
    @property
    def cast_to(self) -> 'PermissibleContinuousAxialLoadResults._Cast_PermissibleContinuousAxialLoadResults':
