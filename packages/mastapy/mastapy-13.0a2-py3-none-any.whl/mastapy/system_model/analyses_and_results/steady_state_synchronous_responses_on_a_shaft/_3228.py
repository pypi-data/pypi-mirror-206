...
class AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft(_3256.ConicalGearMeshSteadyStateSynchronousResponseOnAShaft):
    """AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_mesh_steady_state_synchronous_response_on_a_shaft(self) -> 'AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft._Cast_AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseOnAShaft(self)
