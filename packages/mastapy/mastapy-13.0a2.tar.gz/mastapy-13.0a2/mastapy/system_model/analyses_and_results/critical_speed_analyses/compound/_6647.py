...
class BearingCompoundCriticalSpeedAnalysis(_6675.ConnectorCompoundCriticalSpeedAnalysis):
    """BearingCompoundCriticalSpeedAnalysis
    ...
    class _Cast_BearingCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'BearingCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def bearing_compound_critical_speed_analysis(self) -> 'BearingCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6516.BearingCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6516.BearingCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BearingCompoundCriticalSpeedAnalysis._Cast_BearingCompoundCriticalSpeedAnalysis':
