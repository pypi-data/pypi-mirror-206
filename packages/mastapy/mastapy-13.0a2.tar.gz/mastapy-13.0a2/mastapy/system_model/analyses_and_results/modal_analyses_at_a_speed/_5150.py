...
class GuideDxfModelModalAnalysisAtASpeed(_5114.ComponentModalAnalysisAtASpeed):
    """GuideDxfModelModalAnalysisAtASpeed
    ...
    class _Cast_GuideDxfModelModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'GuideDxfModelModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def guide_dxf_model_modal_analysis_at_a_speed(self) -> 'GuideDxfModelModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GuideDxfModelModalAnalysisAtASpeed._Cast_GuideDxfModelModalAnalysisAtASpeed':
