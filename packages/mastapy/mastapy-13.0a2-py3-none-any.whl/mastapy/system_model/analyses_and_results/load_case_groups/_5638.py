...
class SystemOptimisationGearSet(_0.APIBase):
    ...
    class _Cast_SystemOptimisationGearSet:
        ...
        def __init__(self, parent: 'SystemOptimisationGearSet'):
            self._parent = parent

        @property
        def system_optimisation_gear_set(self) -> 'SystemOptimisationGearSet':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SystemOptimisationGearSet._Cast_SystemOptimisationGearSet':
