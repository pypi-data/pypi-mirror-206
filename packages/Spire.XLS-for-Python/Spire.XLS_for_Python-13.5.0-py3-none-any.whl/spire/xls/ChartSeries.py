...
class ChartSeries (  XlsChartSeries) :
    ...
    def Add(self ,serieToAdd:ChartSerie)->ChartSerie:
        ...
        intPtr = GetDllLibXls().ChartSeries_Add(self.Ptr, intPtrserieToAdd)
    ...
    def ClearDataFormats(self ,format:'ChartSerieDataFormat'):
        ...
        GetDllLibXls().ChartSeries_ClearDataFormats(self.Ptr, intPtrformat)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartSeries_get_Item(self.Ptr, index)
        ret = None if intPtr==None else ChartSerie(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartSeries_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else ChartSerie(intPtr)
        return ret
    ...
    def Add(self)->ChartSerie:
        ...
        intPtr = GetDllLibXls().ChartSeries_Add1(self.Ptr)
        ret = None if intPtr==None else ChartSerie(intPtr)
        return ret
    ...
    def Add(self ,name:str)->ChartSerie:
        ...
        intPtr = GetDllLibXls().ChartSeries_AddN(self.Ptr, name)
        ret = None if intPtr==None else ChartSerie(intPtr)
        return ret
    ...
    def Add(self ,serieType:ExcelChartType)->ChartSerie:
        ...
        intPtr = GetDllLibXls().ChartSeries_AddS(self.Ptr, enumserieType)
        ret = None if intPtr==None else ChartSerie(intPtr)
        return ret
    ...
    def Add(self ,name:str,serieType:ExcelChartType)->ChartSerie:
        ...
        intPtr = GetDllLibXls().ChartSeries_AddNS(self.Ptr, name,enumserieType)
        ret = None if intPtr==None else ChartSerie(intPtr)
        return ret
    ...
    def Add(self ,area:str,isVertical:bool)->int:
        ...
        ret = GetDllLibXls().ChartSeries_AddAI(self.Ptr, area,isVertical)
        return ret
    ...
    def CategoryData(self)->str:
        ...
        GetDllLibXls().ChartSeries_get_CategoryData.restype=c_wchar_p
        ret = GetDllLibXls().ChartSeries_get_CategoryData(self.Ptr)
        return ret
    ...
    def CategoryData(self, value:str):
        ...
        GetDllLibXls().ChartSeries_set_CategoryData(self.Ptr, value)
