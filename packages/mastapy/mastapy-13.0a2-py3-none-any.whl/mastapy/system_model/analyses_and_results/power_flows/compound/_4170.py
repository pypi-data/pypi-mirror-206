...
class ConceptCouplingHalfCompoundPowerFlow(_4181.CouplingHalfCompoundPowerFlow):
    """ConceptCouplingHalfCompoundPowerFlow
    ...
    class _Cast_ConceptCouplingHalfCompoundPowerFlow:
        ...
        def __init__(self, parent: 'ConceptCouplingHalfCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def concept_coupling_half_compound_power_flow(self) -> 'ConceptCouplingHalfCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4036.ConceptCouplingHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4036.ConceptCouplingHalfPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHalfCompoundPowerFlow._Cast_ConceptCouplingHalfCompoundPowerFlow':
