...
class ShaftHubConnectionCompoundStabilityAnalysis(_3910.ConnectorCompoundStabilityAnalysis):
    """ShaftHubConnectionCompoundStabilityAnalysis
    ...
    class _Cast_ShaftHubConnectionCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'ShaftHubConnectionCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def shaft_hub_connection_compound_stability_analysis(self) -> 'ShaftHubConnectionCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3838.ShaftHubConnectionStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3838.ShaftHubConnectionStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ShaftHubConnectionCompoundStabilityAnalysis._Cast_ShaftHubConnectionCompoundStabilityAnalysis':
