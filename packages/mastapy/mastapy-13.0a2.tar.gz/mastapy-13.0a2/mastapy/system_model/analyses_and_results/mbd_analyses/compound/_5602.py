...
class SpringDamperConnectionCompoundMultibodyDynamicsAnalysis(_5537.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """SpringDamperConnectionCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_SpringDamperConnectionCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'SpringDamperConnectionCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_compound_multibody_dynamics_analysis(self) -> 'SpringDamperConnectionCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5463.SpringDamperConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5463.SpringDamperConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionCompoundMultibodyDynamicsAnalysis._Cast_SpringDamperConnectionCompoundMultibodyDynamicsAnalysis':
