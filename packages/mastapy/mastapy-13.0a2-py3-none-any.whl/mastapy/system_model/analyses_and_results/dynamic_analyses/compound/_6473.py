...
class SpiralBevelGearMeshCompoundDynamicAnalysis(_6390.BevelGearMeshCompoundDynamicAnalysis):
    """SpiralBevelGearMeshCompoundDynamicAnalysis
    ...
    class _Cast_SpiralBevelGearMeshCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_compound_dynamic_analysis(self) -> 'SpiralBevelGearMeshCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6344.SpiralBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6344.SpiralBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshCompoundDynamicAnalysis._Cast_SpiralBevelGearMeshCompoundDynamicAnalysis':
