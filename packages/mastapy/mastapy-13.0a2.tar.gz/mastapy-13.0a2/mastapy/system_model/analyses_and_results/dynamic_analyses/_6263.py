...
class BoltedJointDynamicAnalysis(_6342.SpecialisedAssemblyDynamicAnalysis):
    """BoltedJointDynamicAnalysis
    ...
    class _Cast_BoltedJointDynamicAnalysis:
        ...
        def __init__(self, parent: 'BoltedJointDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def bolted_joint_dynamic_analysis(self) -> 'BoltedJointDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltedJointDynamicAnalysis._Cast_BoltedJointDynamicAnalysis':
