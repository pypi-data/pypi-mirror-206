...
from mastapy.electric_machines.load_cases_and_analyses import _1362, _1339
...
class SpeedTorqueCurveAnalysis(_1339.ElectricMachineAnalysis):
    """SpeedTorqueCurveAnalysis
    ...
    @property
    def load_case(self) -> '_1362.SpeedTorqueCurveLoadCase':
    ...
    @property
    def results_points(self) -> 'List[_1330.MaximumTorqueResultsPoints]':
