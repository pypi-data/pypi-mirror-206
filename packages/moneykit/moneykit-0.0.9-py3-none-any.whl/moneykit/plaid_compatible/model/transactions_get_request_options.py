...
class TransactionsGetRequestOptions(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'include_personal_finance_category_beta': (bool, none_type,),  # noqa: E501
            'include_personal_finance_category': (bool, none_type,),  # noqa: E501
            'include_logo_and_counterparty_beta': (bool, none_type,),  # noqa: E501
        }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            account_ids ([str], none_type): A list of `account_ids` to retrieve for the Item  Note: An error will be returned if a provided `account_id` is not associated with the Item.. [optional]  # noqa: E501
            count (int, none_type): The number of transactions to fetch.. [optional]  # noqa: E501
            offset (int, none_type): The number of transactions to skip. The default value is 0.. [optional]  # noqa: E501
            include_original_description (bool, none_type): Include the raw unparsed transaction description from the financial institution. This field is disabled by default. If you need this information in addition to the parsed data provided, contact your Plaid Account Manager, or submit a [Support request](https://dashboard.plaid.com/support/new/product-and-development/product-troubleshooting/product-functionality) .. [optional]  # noqa: E501
            include_personal_finance_category_beta (bool, none_type): Please use [`include_personal_finance_category`](https://plaid.com/docs/api/products/transactions/#transactions-get-request-options-include-personal-finance-category) instead.. [optional]  # noqa: E501
            include_personal_finance_category (bool, none_type): Include the [`personal_finance_category`](https://plaid.com/docs/api/products/transactions/#transactions-get-response-transactions-personal-finance-category) object in the response.  See the [`taxonomy csv file`](https://plaid.com/documents/transactions-personal-finance-category-taxonomy.csv) for a full list of personal finance categories.  We’re introducing Category Rules - a new beta endpoint that will enable you to change the `personal_finance_category` for a transaction based on your users’ needs. When rules are set, the selected category will override the Plaid provided category. To learn more, send a note to transactions-feedback@plaid.com.. [optional]  # noqa: E501
            include_logo_and_counterparty_beta (bool, none_type): Include counterparties and extran merchant fields in the transaction. This field is disabled by default. If you need this information in addition to the parsed data provided, contact your Plaid Account Manager.. [optional]  # noqa: E501
        """
