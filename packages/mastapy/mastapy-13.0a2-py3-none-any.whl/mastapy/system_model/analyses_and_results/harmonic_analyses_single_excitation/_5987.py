...
class BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation(_5992.BevelGearMeshHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_harmonic_analysis_of_single_excitation(self) -> 'BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation._Cast_BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation':
        return self._Cast_BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation(self)
