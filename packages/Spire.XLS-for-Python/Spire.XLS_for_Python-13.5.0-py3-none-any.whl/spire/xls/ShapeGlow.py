...
class ShapeGlow (  XlsObject, IGlow, ICloneParent) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().ShapeGlow_get_SoftEdge(self.Ptr)
        return ret

    @SoftEdge.setter
    def SoftEdge(self, value:int):
        GetDllLibXls().ShapeGlow_set_SoftEdge.argtypes=[c_void_p, c_int]
        GetDllLibXls().ShapeGlow_set_SoftEdge(self.Ptr, value)
    ...
    def Transparency(self)->int:
        ...
        ret = GetDllLibXls().ShapeGlow_get_Transparency(self.Ptr)
        return ret

    @Transparency.setter
    def Transparency(self, value:int):
        GetDllLibXls().ShapeGlow_set_Transparency.argtypes=[c_void_p, c_int]
        GetDllLibXls().ShapeGlow_set_Transparency(self.Ptr, value)
    ...
    def Radius(self)->int:
        ...
        ret = GetDllLibXls().ShapeGlow_get_Radius(self.Ptr)
        return ret

    @Radius.setter
    def Radius(self, value:int):
        GetDllLibXls().ShapeGlow_set_Radius.argtypes=[c_void_p, c_int]
        GetDllLibXls().ShapeGlow_set_Radius(self.Ptr, value)
    ...
    def Color(self)->'Color':
        ...
        intPtr = GetDllLibXls().ShapeGlow_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().ShapeGlow_set_Color(self.Ptr, value.Ptr)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().ShapeGlow_Clone(self.Ptr, intPtrparent)
