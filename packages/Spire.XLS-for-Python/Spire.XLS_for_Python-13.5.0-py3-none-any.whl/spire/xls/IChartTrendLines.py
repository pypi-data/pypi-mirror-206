...
class IChartTrendLines (SpireObject) :
    ...
    def get_Item(self ,iIndex:int)->'IChartTrendLine':
        ...
        intPtr = GetDllLibXls().IChartTrendLines_get_Item(self.Ptr, iIndex)
    ...
    def Add(self)->IChartTrendLine:
        ...
        intPtr = GetDllLibXls().IChartTrendLines_Add(self.Ptr)
        ret = None if intPtr==None else IChartTrendLine(intPtr)
        return ret
    ...
    def Add(self ,type:TrendLineType)->IChartTrendLine:
        ...
        intPtr = GetDllLibXls().IChartTrendLines_AddT(self.Ptr, enumtype)
        ret = None if intPtr==None else IChartTrendLine(intPtr)
        return ret
    ...
    def RemoveAt(self ,index:int):
        ...
        GetDllLibXls().IChartTrendLines_RemoveAt(self.Ptr, index)
    ...
    def Clear(self):
        ...
        GetDllLibXls().IChartTrendLines_Clear(self.Ptr)
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().IChartTrendLines_get_Count(self.Ptr)
        return ret
