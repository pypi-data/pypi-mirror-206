...
from mastapy.system_model.analyses_and_results.static_loads import _6782, _6891
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.system_model import _2194, _2188
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4366, _4367
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    class _Cast_ParametricStudyToolOptions:
        ...
        def __init__(self, parent: 'ParametricStudyToolOptions'):
            self._parent = parent

        @property
        def parametric_study_tool_options(self) -> 'ParametricStudyToolOptions':
            return self._parent
    ...
    @property
    def parametric_study_type(self) -> '_6891.ParametricStudyType':
        ...
        value = conversion.pn_to_mp_enum(temp, _6891.ParametricStudyType)
        return constructor.new_from_mastapy_type(_6891.ParametricStudyType)(value) if value is not None else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6891.ParametricStudyType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _6891.ParametricStudyType.type_())
    ...
    @property
    def external_full_fe_loader(self) -> '_2194.ExternalFullFELoader':
    ...
    @property
    def step_results(self) -> 'List[_4366.ParametricStudyToolStepResult]':
    ...
    @property
    def study_variables(self) -> 'List[_4367.ParametricStudyVariable]':
    ...
    @property
    def parametric_study_logging_variables(self) -> 'List[_2627.AnalysisCaseVariable]':
    ...
    def add_logging_variable(self, design_entity: '_2188.DesignEntity', path: 'List[str]') -> '_2627.AnalysisCaseVariable':
    ...
    def add_study_variable(self, design_entity: '_2188.DesignEntity', path: 'List[str]') -> '_4367.ParametricStudyVariable':
    ...
    def data_logger_for(self, design_entity: '_2188.DesignEntity') -> '_1564.DataLogger':
    ...
    def move_study_variable_down(self, study_variable: '_4367.ParametricStudyVariable'):
    ...
    def move_study_variable_up(self, study_variable: '_4367.ParametricStudyVariable'):
    ...
    def remove_logging_variable(self, analysis_variable: '_2627.AnalysisCaseVariable'):
    ...
    def remove_study_variable(self, study_variable: '_4367.ParametricStudyVariable'):
    ...
    @property
    def cast_to(self) -> 'ParametricStudyToolOptions._Cast_ParametricStudyToolOptions':
