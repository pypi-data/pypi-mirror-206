...
class DesignMeasurements(_0.APIBase):
    ...
    class _Cast_DesignMeasurements:
        ...
        def __init__(self, parent: 'DesignMeasurements'):
            self._parent = parent

        @property
        def design_measurements(self) -> 'DesignMeasurements':
            return self._parent
    ...
    @property
    def component_connections(self) -> 'List[_2252.ComponentMeasurer]':
    ...
    @property
    def cast_to(self) -> 'DesignMeasurements._Cast_DesignMeasurements':
