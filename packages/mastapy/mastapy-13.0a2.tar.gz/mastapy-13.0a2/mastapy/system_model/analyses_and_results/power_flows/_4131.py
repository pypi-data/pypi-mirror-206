...
class TorqueConverterPowerFlow(_4048.CouplingPowerFlow):
    """TorqueConverterPowerFlow
    ...
    class _Cast_TorqueConverterPowerFlow:
        ...
        def __init__(self, parent: 'TorqueConverterPowerFlow'):
            self._parent = parent
        ...
        @property
        def torque_converter_power_flow(self) -> 'TorqueConverterPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterPowerFlow._Cast_TorqueConverterPowerFlow':
