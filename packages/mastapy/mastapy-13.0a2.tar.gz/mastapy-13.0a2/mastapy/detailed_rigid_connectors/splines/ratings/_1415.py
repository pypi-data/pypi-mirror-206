...
class GBT17855SplineHalfRating(_1419.SplineHalfRating):
    """GBT17855SplineHalfRating
    ...
    class _Cast_GBT17855SplineHalfRating:
        ...
        def __init__(self, parent: 'GBT17855SplineHalfRating'):
            self._parent = parent

        @property
        def spline_half_rating(self):
            return self._parent._cast(_1419.SplineHalfRating)

        @property
        def gbt17855_spline_half_rating(self) -> 'GBT17855SplineHalfRating':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GBT17855SplineHalfRating._Cast_GBT17855SplineHalfRating':
