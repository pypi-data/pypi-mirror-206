...
from cryptotoolbox.parallel_run import launcher_utility
...
class MixerParalleLauncher():
                    ...
                    for calibration_step in calibration_steps:
                        for transaction_cost in transaction_costs:
                            for signal_type, params  in signal_idiosyncratic_paramaters.items():
                                for param in params:
                                    self.args.append((self,self.seed,n,s,s_eval,calibration_step,transaction_cost,signal_type,json.dumps(param, sort_keys=True)))
                                    self.key_args.append((self.seed,n,s,s_eval,calibration_step,transaction_cost,signal_type,json.dumps(param, sort_keys=True)))
    ...
    def create_saving_key(self,seed, n, s, s_eval, calibration_step, transaction_costs, signal_type, idios_string):
