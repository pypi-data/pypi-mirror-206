...
class StylesCollection (  XlsStylesCollection) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().StylesCollection_get_Item(self.Ptr, Index)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().StylesCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else CellStyle(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().StylesCollection_Add(self.Ptr, name)
        ret = None if intPtr==None else CellStyle(intPtr)
        return ret
    ...
    <param name="style">Style to added.</param>
        ...
        GetDllLibXls().StylesCollection_AddS(self.Ptr, intPtrstyle)
    ...
    def Remove(self ,style:'CellStyle'):
        ...
        GetDllLibXls().StylesCollection_Remove(self.Ptr, intPtrstyle)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().StylesCollection_Contains(self.Ptr, intPtrstyle)
        ret = None if intPtr==None else CellStyle(intPtr)
        return ret
    ...
    def Compare(source:'CellStyle',destination:'CellStyle')->bool:
        ...
        ret = GetDllLibXls().StylesCollection_Compare( intPtrsource,intPtrdestination)
        return ret
    ...
    def Replace(self ,style:'CellStyle'):
        ...
        GetDllLibXls().StylesCollection_Replace(self.Ptr, intPtrstyle)
    ...
    def GetDefaultStyle(self ,styleName:str)->'CellStyle':
        ...
        intPtr = GetDllLibXls().StylesCollection_GetDefaultStyle(self.Ptr, styleName)
        ret = None if intPtr==None else CellStyle(intPtr)
        return ret
