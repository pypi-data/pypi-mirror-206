...
class StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation(_6989.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_advanced_time_stepping_analysis_for_modulation(self) -> 'StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation._Cast_StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation(self)
