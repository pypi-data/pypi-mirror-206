...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5213, _5212, _5149
...
class WormGearSetModalAnalysisAtASpeed(_5149.GearSetModalAnalysisAtASpeed):
    """WormGearSetModalAnalysisAtASpeed
    ...
    @property
    def worm_gears_modal_analysis_at_a_speed(self) -> 'List[_5213.WormGearModalAnalysisAtASpeed]':
    ...
    @property
    def worm_meshes_modal_analysis_at_a_speed(self) -> 'List[_5212.WormGearMeshModalAnalysisAtASpeed]':
