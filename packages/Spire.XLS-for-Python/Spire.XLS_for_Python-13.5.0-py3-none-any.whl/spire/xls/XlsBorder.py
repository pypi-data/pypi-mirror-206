...
#        ret = GetDllLibXls().XlsBorder_GetThemeColor(self.Ptr, intPtrtype,intPtrtint)
#        return ret
    ...
    def SetThemeColor(self ,type:'ThemeColorType',tint:float):
        ...
        GetDllLibXls().XlsBorder_SetThemeColor(self.Ptr, enumtype,tint)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBorder_get_KnownColor(self.Ptr)
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsBorder_set_KnownColor(self.Ptr, value.value)
    ...
    def OColor(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsBorder_get_OColor(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsBorder_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().XlsBorder_set_Color(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBorder_get_LineStyle(self.Ptr)
    ...
    def LineStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().XlsBorder_set_LineStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBorder_get_ShowDiagonalLine(self.Ptr)
        return ret
    ...
    def ShowDiagonalLine(self, value:bool):
        ...
        GetDllLibXls().XlsBorder_set_ShowDiagonalLine(self.Ptr, value)
    ...
    def BorderIndex(self)->'BordersLineType':
        ...
        ret = GetDllLibXls().XlsBorder_get_BorderIndex(self.Ptr)
    ...
    def ColorToExcelColor(color:'ExcelColors')->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsBorder_ColorToExcelColor( enumcolor)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def CopyFrom(self ,baseBorder:'IBorder'):
        ...
        GetDllLibXls().XlsBorder_CopyFrom(self.Ptr, intPtrbaseBorder)
    ...
    def setLineStyleAndColor(self ,borderLine:'LineStyleType',borderColor:'ExcelColors'):
        ...
        GetDllLibXls().XlsBorder_setLineStyleAndColor(self.Ptr, enumborderLine,enumborderColor)
