...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5808, _5809, _5667
...
class ZerolBevelGearSetHarmonicAnalysis(_5667.BevelGearSetHarmonicAnalysis):
    """ZerolBevelGearSetHarmonicAnalysis
    ...
    class _Cast_ZerolBevelGearSetHarmonicAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_harmonic_analysis(self) -> 'ZerolBevelGearSetHarmonicAnalysis':
            return self._parent
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5808.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_harmonic_analysis(self) -> 'List[_5808.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5809.ZerolBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_harmonic_analysis(self) -> 'List[_5809.ZerolBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetHarmonicAnalysis._Cast_ZerolBevelGearSetHarmonicAnalysis':
