...
class HypoidGearAdvancedTimeSteppingAnalysisForModulation(_6976.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_HypoidGearAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'HypoidGearAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_advanced_time_stepping_analysis_for_modulation(self) -> 'HypoidGearAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidGearAdvancedTimeSteppingAnalysisForModulation._Cast_HypoidGearAdvancedTimeSteppingAnalysisForModulation':
