...
class XlsChartLegend (  XlsObject, IChartLegend) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_AutoPosition(self.Ptr)
        return ret
    ...
    def TextArea(self)->'IChartTextArea':
        ...
        intPtr = GetDllLibXls().XlsChartLegend_get_TextArea(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_X(self.Ptr)
        return ret

    @X.setter
    def X(self, value:int):
        GetDllLibXls().XlsChartLegend_set_X.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartLegend_set_X(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_Y(self.Ptr)
        return ret

    @Y.setter
    def Y(self, value:int):
        GetDllLibXls().XlsChartLegend_set_Y.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartLegend_set_Y(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_Position(self.Ptr)
    ...
    def Position(self, value:'LegendPositionType'):
        ...
        GetDllLibXls().XlsChartLegend_set_Position(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_IsVerticalLegend(self.Ptr)
        return ret
    ...
    def IsVerticalLegend(self, value:bool):
        ...
        GetDllLibXls().XlsChartLegend_set_IsVerticalLegend(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_IncludeInLayout(self.Ptr)
        return ret
    ...
    def IncludeInLayout(self, value:bool):
        ...
        GetDllLibXls().XlsChartLegend_set_IncludeInLayout(self.Ptr, value)
    ...
    def InnerLayoutTarget(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartLegend_get_InnerLayoutTarget(self.Ptr)
        return ret
    ...
    def InnerLayoutTarget(self, value:bool):
        ...
        GetDllLibXls().XlsChartLegend_set_InnerLayoutTarget(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_IsWMode(self.Ptr)
        return ret

    @IsWMode.setter
    def IsWMode(self, value:bool):
        GetDllLibXls().XlsChartLegend_set_IsWMode.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartLegend_set_IsWMode(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_IsHMode(self.Ptr)
        return ret

    @IsHMode.setter
    def IsHMode(self, value:bool):
        GetDllLibXls().XlsChartLegend_set_IsHMode.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartLegend_set_IsHMode(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_IsXMode(self.Ptr)
        return ret

    @IsXMode.setter
    def IsXMode(self, value:bool):
        GetDllLibXls().XlsChartLegend_set_IsXMode.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartLegend_set_IsXMode(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_IsYMode(self.Ptr)
        return ret

    @IsYMode.setter
    def IsYMode(self, value:bool):
        GetDllLibXls().XlsChartLegend_set_IsYMode.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartLegend_set_IsYMode(self.Ptr, value)
    ...
    def LegendEntries(self)->'IChartLegendEntries':
        ...
        intPtr = GetDllLibXls().XlsChartLegend_get_LegendEntries(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:int):
        GetDllLibXls().XlsChartLegend_set_Width.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartLegend_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:int):
        GetDllLibXls().XlsChartLegend_set_Height.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartLegend_set_Height(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_AutoPositionX(self.Ptr)
        return ret
    ...
    def AutoPositionX(self, value:bool):
        ...
        GetDllLibXls().XlsChartLegend_set_AutoPositionX(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_AutoPositionY(self.Ptr)
        return ret
    ...
    def AutoPositionY(self, value:bool):
        ...
        GetDllLibXls().XlsChartLegend_set_AutoPositionY(self.Ptr, value)
    ...
    def FrameFormat(self)->'IChartFrameFormat':
        ...
        intPtr = GetDllLibXls().XlsChartLegend_get_FrameFormat(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegend_get_HasDataTable(self.Ptr)
        return ret

    @HasDataTable.setter
    def HasDataTable(self, value:bool):
        GetDllLibXls().XlsChartLegend_set_HasDataTable.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartLegend_set_HasDataTable(self.Ptr, value)
    ...
    def Clear(self):
        ...
        GetDllLibXls().XlsChartLegend_Clear(self.Ptr)
    ...
    def Delete(self):
        ...
        GetDllLibXls().XlsChartLegend_Delete(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsChartLegend_Clone(self.Ptr, intPtrparent,intPtrdicFontIndexes,intPtrdicNewSheetNames)
