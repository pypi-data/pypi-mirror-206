...
class ConceptGearSteadyStateSynchronousResponseOnAShaft(_3284.GearSteadyStateSynchronousResponseOnAShaft):
    """ConceptGearSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_ConceptGearSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'ConceptGearSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def concept_gear_steady_state_synchronous_response_on_a_shaft(self) -> 'ConceptGearSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptGearSteadyStateSynchronousResponseOnAShaft._Cast_ConceptGearSteadyStateSynchronousResponseOnAShaft':
