...
class SpiralBevelGearCompoundSteadyStateSynchronousResponse(_3111.BevelGearCompoundSteadyStateSynchronousResponse):
    """SpiralBevelGearCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_SpiralBevelGearCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'SpiralBevelGearCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_compound_steady_state_synchronous_response(self) -> 'SpiralBevelGearCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3064.SpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3064.SpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearCompoundSteadyStateSynchronousResponse._Cast_SpiralBevelGearCompoundSteadyStateSynchronousResponse':
