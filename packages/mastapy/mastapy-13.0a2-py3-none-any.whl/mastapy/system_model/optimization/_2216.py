...
class CylindricalGearSetOptimizer(_0.APIBase):
    ...
    class _Cast_CylindricalGearSetOptimizer:
        """Special nested class for casting CylindricalGearSetOptimizer to subclasses."""

        def __init__(self, parent: 'CylindricalGearSetOptimizer'):
            self._parent = parent

        @property
        def cylindrical_gear_set_optimizer(self) -> 'CylindricalGearSetOptimizer':
            return self._parent
    ...
    @property
    def constraints(self) -> 'List[_2217.MeasuredAndFactorViewModel]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearSetOptimizer._Cast_CylindricalGearSetOptimizer':
        return self._Cast_CylindricalGearSetOptimizer(self)
