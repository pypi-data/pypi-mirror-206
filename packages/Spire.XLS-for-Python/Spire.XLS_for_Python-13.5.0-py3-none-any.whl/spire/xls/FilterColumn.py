...
class FilterColumn (  SpireObject,IAutoFilter) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().FilterColumn_get_Visibledropdown(self.Ptr)
        return ret
    ...
    def Visibledropdown(self, value:bool):
        ...
        GetDllLibXls().FilterColumn_set_Visibledropdown(self.Ptr, value)
    ...
    def Filter(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().FilterColumn_get_Filter(self.Ptr)
    ...
    def Filter(self, value:'SpireObject'):
        ...
        GetDllLibXls().FilterColumn_set_Filter(self.Ptr, value.Ptr)
    ...
    def FilterType(self)->'FilterType':
        ...
        ret = GetDllLibXls().FilterColumn_get_FilterType(self.Ptr)
    ...
    def FilterType(self, value:'FilterType'):
        ...
        GetDllLibXls().FilterColumn_set_FilterType(self.Ptr, value.value)
    ...
    def FieldIndex(self)->int:
        ...
        ret = GetDllLibXls().FilterColumn_get_FieldIndex(self.Ptr)
        return ret

    @FieldIndex.setter
    def FieldIndex(self, value:int):
        GetDllLibXls().FilterColumn_set_FieldIndex.argtypes=[c_void_p, c_int]
        GetDllLibXls().FilterColumn_set_FieldIndex(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().FilterColumn_get_Top10Items(self.Ptr)
        return ret

    @Top10Items.setter
    def Top10Items(self, value:int):
        GetDllLibXls().FilterColumn_set_Top10Items.argtypes=[c_void_p, c_int]
        GetDllLibXls().FilterColumn_set_Top10Items(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().FilterColumn_get_IsTop10Items(self.Ptr)
        return ret

    @IsTop10Items.setter
    def IsTop10Items(self, value:bool):
        GetDllLibXls().FilterColumn_set_IsTop10Items.argtypes=[c_void_p, c_bool]
        GetDllLibXls().FilterColumn_set_IsTop10Items(self.Ptr, value)
    ...
    def ShowTopItem(self)->bool:
        ...
        ret = GetDllLibXls().FilterColumn_get_ShowTopItem(self.Ptr)
        return ret

    @ShowTopItem.setter
    def ShowTopItem(self, value:bool):
        GetDllLibXls().FilterColumn_set_ShowTopItem.argtypes=[c_void_p, c_bool]
        GetDllLibXls().FilterColumn_set_ShowTopItem(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().FilterColumn_get_IsSimple2(self.Ptr)
        return ret

    @IsSimple2.setter
    def IsSimple2(self, value:bool):
        GetDllLibXls().FilterColumn_set_IsSimple2.argtypes=[c_void_p, c_bool]
        GetDllLibXls().FilterColumn_set_IsSimple2(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().FilterColumn_get_IsSimple1(self.Ptr)
        return ret

    @IsSimple1.setter
    def IsSimple1(self, value:bool):
        GetDllLibXls().FilterColumn_set_IsSimple1.argtypes=[c_void_p, c_bool]
        GetDllLibXls().FilterColumn_set_IsSimple1(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().FilterColumn_get_IsTop10Percent(self.Ptr)
        return ret
    ...
    def IsTop10Percent(self, value:bool):
        ...
        GetDllLibXls().FilterColumn_set_IsTop10Percent(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().FilterColumn_get_IsAnd(self.Ptr)
        return ret

    @IsAnd.setter
    def IsAnd(self, value:bool):
        GetDllLibXls().FilterColumn_set_IsAnd.argtypes=[c_void_p, c_bool]
        GetDllLibXls().FilterColumn_set_IsAnd(self.Ptr, value)
    ...
    def IsFiltered(self)->bool:
        ...
        ret = GetDllLibXls().FilterColumn_get_IsFiltered(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().FilterColumn_get_SecondCondition(self.Ptr)
    ...
    def FirstCondition(self)->'IAutoFilterCondition':
        ...
        intPtr = GetDllLibXls().FilterColumn_get_FirstCondition(self.Ptr)
        ret = None if intPtr==None else IAutoFilterCondition(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().FilterColumn_get_HasFirstCondition(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().FilterColumn_get_HasSecondCondition(self.Ptr)
        return ret
