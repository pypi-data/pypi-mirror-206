...
class ZerolBevelGearHarmonicAnalysis(_5665.BevelGearHarmonicAnalysis):
    """ZerolBevelGearHarmonicAnalysis
    ...
    class _Cast_ZerolBevelGearHarmonicAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_harmonic_analysis(self) -> 'ZerolBevelGearHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearHarmonicAnalysis._Cast_ZerolBevelGearHarmonicAnalysis':
