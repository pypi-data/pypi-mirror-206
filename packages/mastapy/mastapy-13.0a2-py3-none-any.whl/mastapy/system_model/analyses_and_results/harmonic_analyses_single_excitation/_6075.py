...
class SpiralBevelGearHarmonicAnalysisOfSingleExcitation(_5991.BevelGearHarmonicAnalysisOfSingleExcitation):
    """SpiralBevelGearHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_SpiralBevelGearHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'SpiralBevelGearHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_harmonic_analysis_of_single_excitation(self) -> 'SpiralBevelGearHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearHarmonicAnalysisOfSingleExcitation._Cast_SpiralBevelGearHarmonicAnalysisOfSingleExcitation':
