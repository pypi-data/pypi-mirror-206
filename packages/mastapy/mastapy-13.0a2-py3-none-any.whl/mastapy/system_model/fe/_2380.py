...
from mastapy.system_model.fe import _2352, _2353
...
class NodeBoundaryConditionStaticAnalysis(_0.APIBase):
    ...
    class _Cast_NodeBoundaryConditionStaticAnalysis:
        ...
        def __init__(self, parent: 'NodeBoundaryConditionStaticAnalysis'):
            self._parent = parent

        @property
        def node_boundary_condition_static_analysis(self) -> 'NodeBoundaryConditionStaticAnalysis':
            return self._parent
    ...
    @property
    def boundary_conditions_angular(self) -> 'List[_2352.DegreeOfFreedomBoundaryConditionAngular]':
    ...
    @property
    def boundary_conditions_linear(self) -> 'List[_2353.DegreeOfFreedomBoundaryConditionLinear]':
    ...
    @property
    def cast_to(self) -> 'NodeBoundaryConditionStaticAnalysis._Cast_NodeBoundaryConditionStaticAnalysis':
