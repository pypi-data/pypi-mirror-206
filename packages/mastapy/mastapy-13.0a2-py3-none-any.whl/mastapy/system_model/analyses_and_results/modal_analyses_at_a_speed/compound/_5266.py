...
class CylindricalGearMeshCompoundModalAnalysisAtASpeed(_5277.GearMeshCompoundModalAnalysisAtASpeed):
    """CylindricalGearMeshCompoundModalAnalysisAtASpeed
    ...
    class _Cast_CylindricalGearMeshCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'CylindricalGearMeshCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_compound_modal_analysis_at_a_speed(self) -> 'CylindricalGearMeshCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5136.CylindricalGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5136.CylindricalGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshCompoundModalAnalysisAtASpeed._Cast_CylindricalGearMeshCompoundModalAnalysisAtASpeed':
