...
class BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed(_3711.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def belt_drive_compound_steady_state_synchronous_response_at_a_speed(self) -> 'BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3493.BeltDriveSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3493.BeltDriveSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed._Cast_BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed':
