...
class RollingRingAssemblyCompoundSteadyStateSynchronousResponse(_3193.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """RollingRingAssemblyCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_RollingRingAssemblyCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'RollingRingAssemblyCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def rolling_ring_assembly_compound_steady_state_synchronous_response(self) -> 'RollingRingAssemblyCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3054.RollingRingAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3054.RollingRingAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'RollingRingAssemblyCompoundSteadyStateSynchronousResponse._Cast_RollingRingAssemblyCompoundSteadyStateSynchronousResponse':
        return self._Cast_RollingRingAssemblyCompoundSteadyStateSynchronousResponse(self)
