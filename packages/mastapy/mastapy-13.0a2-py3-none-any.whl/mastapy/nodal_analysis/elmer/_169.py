...
class ElmerResultsViewable(_0.APIBase):
    ...
    class _Cast_ElmerResultsViewable:
        ...
        def __init__(self, parent: 'ElmerResultsViewable'):
            self._parent = parent

        @property
        def electric_machine_mechanical_results_viewable(self):
            from mastapy.electric_machines.results import _1314
            
            return self._parent._cast(_1314.ElectricMachineMechanicalResultsViewable)

        @property
        def electric_machine_results_viewable(self):
            from mastapy.electric_machines.results import _1326
            
            return self._parent._cast(_1326.ElectricMachineResultsViewable)

        @property
        def elmer_results_viewable(self) -> 'ElmerResultsViewable':
            return self._parent
    ...
    @property
    def scaling_draw_style(self) -> '_1837.ScalingDrawStyle':
        """ScalingDrawStyle: 'ScalingDrawStyle' is the original name of this property.
    ...
    @property
    def cast_to(self) -> 'ElmerResultsViewable._Cast_ElmerResultsViewable':
