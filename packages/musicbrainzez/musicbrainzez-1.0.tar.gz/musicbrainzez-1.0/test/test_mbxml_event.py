...
class EventTest(unittest.TestCase):
    ...
    def testCorrectId(self):
        ...
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "%s-place-rels.xml" % event_id)
    ...
    def testEventElements(self):
        ...
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, filename)
        e = res["event"]
