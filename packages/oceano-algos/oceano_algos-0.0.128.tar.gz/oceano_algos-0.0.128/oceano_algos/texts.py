...
__all__ = ['welcome_text', 'settings_text', 'after_rocket_text', 'start_search_text', 'stop_search_text',
           'see_search_setting_text', 'no_recommended_vacancies_texts']
...
def see_search_setting_text(cv, max_responses, min_salary, experience, inserted_into_db_msk):
...
def no_recommended_vacancies_texts():
    return """
