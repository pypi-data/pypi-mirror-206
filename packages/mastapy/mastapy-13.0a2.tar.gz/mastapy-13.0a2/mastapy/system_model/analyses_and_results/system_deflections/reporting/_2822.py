...
class FlexibleGearChart(_0.APIBase):
    ...
    class _Cast_FlexibleGearChart:
        ...
        def __init__(self, parent: 'FlexibleGearChart'):
            self._parent = parent

        @property
        def flexible_gear_chart(self) -> 'FlexibleGearChart':
            return self._parent
    ...
    @property
    def chart(self) -> '_1842.LegacyChartMathChartDefinition':
    ...
    @property
    def cast_to(self) -> 'FlexibleGearChart._Cast_FlexibleGearChart':
