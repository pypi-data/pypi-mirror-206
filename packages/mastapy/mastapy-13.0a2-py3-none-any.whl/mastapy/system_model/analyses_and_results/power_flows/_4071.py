...
class GuideDxfModelPowerFlow(_4034.ComponentPowerFlow):
    """GuideDxfModelPowerFlow
    ...
    class _Cast_GuideDxfModelPowerFlow:
        ...
        def __init__(self, parent: 'GuideDxfModelPowerFlow'):
            self._parent = parent
        ...
        @property
        def guide_dxf_model_power_flow(self) -> 'GuideDxfModelPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GuideDxfModelPowerFlow._Cast_GuideDxfModelPowerFlow':
