...
class GuideDxfModelStabilityAnalysis(_3767.ComponentStabilityAnalysis):
    """GuideDxfModelStabilityAnalysis
    ...
    class _Cast_GuideDxfModelStabilityAnalysis:
        ...
        def __init__(self, parent: 'GuideDxfModelStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def guide_dxf_model_stability_analysis(self) -> 'GuideDxfModelStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GuideDxfModelStabilityAnalysis._Cast_GuideDxfModelStabilityAnalysis':
