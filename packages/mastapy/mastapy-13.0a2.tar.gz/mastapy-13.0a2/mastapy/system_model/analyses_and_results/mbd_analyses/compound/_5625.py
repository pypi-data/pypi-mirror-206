...
class ZerolBevelGearCompoundMultibodyDynamicsAnalysis(_5515.BevelGearCompoundMultibodyDynamicsAnalysis):
    """ZerolBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5491.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5491.ZerolBevelGearMultibodyDynamicsAnalysis]':
