...
class KlingelnbergCycloPalloidSpiralBevelGearSteadyStateSynchronousResponse(_3031.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidSpiralBevelGearSteadyStateSynchronousResponse
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_steady_state_synchronous_response(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearSteadyStateSynchronousResponse._Cast_KlingelnbergCycloPalloidSpiralBevelGearSteadyStateSynchronousResponse':
        return self._Cast_KlingelnbergCycloPalloidSpiralBevelGearSteadyStateSynchronousResponse(self)
