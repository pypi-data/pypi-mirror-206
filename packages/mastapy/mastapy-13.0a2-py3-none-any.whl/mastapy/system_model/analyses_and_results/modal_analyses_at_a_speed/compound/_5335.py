...
class TorqueConverterCompoundModalAnalysisAtASpeed(_5255.CouplingCompoundModalAnalysisAtASpeed):
    """TorqueConverterCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5207.TorqueConverterModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5207.TorqueConverterModalAnalysisAtASpeed]':
