...
class PlanetCarrierCreationOptions(_0.APIBase):
    ...
    class _Cast_PlanetCarrierCreationOptions:
        ...
        def __init__(self, parent: 'PlanetCarrierCreationOptions'):
            self._parent = parent

        @property
        def planet_carrier_creation_options(self) -> 'PlanetCarrierCreationOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierCreationOptions._Cast_PlanetCarrierCreationOptions':
        return self._Cast_PlanetCarrierCreationOptions(self)
