...
class ConceptGearCompoundModalAnalysisAtAStiffness(_5018.GearCompoundModalAnalysisAtAStiffness):
    """ConceptGearCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_ConceptGearCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ConceptGearCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def concept_gear_compound_modal_analysis_at_a_stiffness(self) -> 'ConceptGearCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4860.ConceptGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4860.ConceptGearModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'ConceptGearCompoundModalAnalysisAtAStiffness._Cast_ConceptGearCompoundModalAnalysisAtAStiffness':
