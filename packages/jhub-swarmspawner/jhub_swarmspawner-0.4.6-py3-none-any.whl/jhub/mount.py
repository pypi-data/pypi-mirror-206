...
class Mounter(LoggingConfigurable):
    def __init__(self, template_config):
        ...
        self.log.debug("instantiating Mounter with config: {}".format(template_config))
        self.template_config = copy.deepcopy(template_config)

    @gen.coroutine
    def gen_config(self):
        return Config(copy.deepcopy(self.template_config))
...
class VolumeMounter(Mounter):
    ...
    def create(self, **format_config_kwargs):
        ...
        new_config = yield self.gen_config()
