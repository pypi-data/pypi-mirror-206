...
class TorqueConverterParametricStudyTool(_4310.CouplingParametricStudyTool):
    """TorqueConverterParametricStudyTool
    ...
    class _Cast_TorqueConverterParametricStudyTool:
        ...
        def __init__(self, parent: 'TorqueConverterParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def torque_converter_parametric_study_tool(self) -> 'TorqueConverterParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterParametricStudyTool._Cast_TorqueConverterParametricStudyTool':
