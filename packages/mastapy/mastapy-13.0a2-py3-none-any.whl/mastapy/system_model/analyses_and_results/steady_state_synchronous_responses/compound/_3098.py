...
class AbstractShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse(_3130.ConnectionCompoundSteadyStateSynchronousResponse):
    """AbstractShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2965.AbstractShaftToMountableComponentConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2965.AbstractShaftToMountableComponentConnectionSteadyStateSynchronousResponse]':
