...
class PointLoadCompoundSteadyStateSynchronousResponse(_3217.VirtualComponentCompoundSteadyStateSynchronousResponse):
    """PointLoadCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3049.PointLoadSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3049.PointLoadSteadyStateSynchronousResponse]':
