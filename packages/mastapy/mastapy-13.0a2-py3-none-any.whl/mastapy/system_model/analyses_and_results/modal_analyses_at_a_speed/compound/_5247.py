...
class ConceptGearCompoundModalAnalysisAtASpeed(_5276.GearCompoundModalAnalysisAtASpeed):
    """ConceptGearCompoundModalAnalysisAtASpeed
    ...
    class _Cast_ConceptGearCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ConceptGearCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def concept_gear_compound_modal_analysis_at_a_speed(self) -> 'ConceptGearCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5119.ConceptGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5119.ConceptGearModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ConceptGearCompoundModalAnalysisAtASpeed._Cast_ConceptGearCompoundModalAnalysisAtASpeed':
