...
class PlanetCarrierSteadyStateSynchronousResponseAtASpeed(_3560.MountableComponentSteadyStateSynchronousResponseAtASpeed):
    """PlanetCarrierSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_PlanetCarrierSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'PlanetCarrierSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def planet_carrier_steady_state_synchronous_response_at_a_speed(self) -> 'PlanetCarrierSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierSteadyStateSynchronousResponseAtASpeed._Cast_PlanetCarrierSteadyStateSynchronousResponseAtASpeed':
