...
class KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection(_7267.ConicalGearAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection
    ...
    class _Cast_KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_conical_gear_advanced_system_deflection(self) -> 'KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection._Cast_KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection':
        return self._Cast_KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection(self)
