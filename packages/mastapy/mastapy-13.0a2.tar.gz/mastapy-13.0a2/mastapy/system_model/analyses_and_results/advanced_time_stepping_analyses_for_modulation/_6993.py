...
class BoltedJointAdvancedTimeSteppingAnalysisForModulation(_7072.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """BoltedJointAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_BoltedJointAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'BoltedJointAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def bolted_joint_advanced_time_stepping_analysis_for_modulation(self) -> 'BoltedJointAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2688.BoltedJointSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'BoltedJointAdvancedTimeSteppingAnalysisForModulation._Cast_BoltedJointAdvancedTimeSteppingAnalysisForModulation':
