...
class XlsWorksheetsCollection (  CollectionBase[XlsWorksheet], IWorksheets) :
    ...
    #    intPtr = GetDllLibXls().XlsWorksheetsCollection_get_Item(self.Ptr, Index)
    ...
    #    intPtr = GetDllLibXls().XlsWorksheetsCollection_get_ItemS(self.Ptr, sheetName)
    #    ret = None if intPtr==None else XlsWorksheet(intPtr)
    #    return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetsCollection_get_UseRangesCache(self.Ptr)
        return ret
    ...
    def UseRangesCache(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheetsCollection_set_UseRangesCache(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetsCollection_get_UseHashForWorksheetLookup(self.Ptr)
        return ret
    ...
    def UseHashForWorksheetLookup(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheetsCollection_set_UseHashForWorksheetLookup(self.Ptr, value)
    ...
    def Clear(self):
        ...
        GetDllLibXls().XlsWorksheetsCollection_Clear(self.Ptr)
    ...
    def Create(self)->IWorksheet:
        ...
        intPtr = GetDllLibXls().XlsWorksheetsCollection_Create(self.Ptr)
        ret = None if intPtr==None else XlsWorksheet(intPtr)
        return ret
    ...
    def Create(self ,name:str)->IWorksheet:
        ...
        intPtr = GetDllLibXls().XlsWorksheetsCollection_CreateN(self.Ptr, name)
        ret = None if intPtr==None else XlsWorksheet(intPtr)
        return ret
...
#        intPtr = GetDllLibXls().XlsWorksheetsCollection_FindAll(self.Ptr, findValue,enumflags,enumfindOptions)
...
#        return ret
    ...
    def FindFirst(self ,findValue:str,flags:'FindType',findOptions:'ExcelFindOptions')->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsWorksheetsCollection_FindFirst(self.Ptr, findValue,enumflags,enumfindOptions)
    ...
    def Remove(self ,sheet:IWorksheet):
        ...
        GetDllLibXls().XlsWorksheetsCollection_Remove(self.Ptr, intPtrsheet)
    ...
    <param name="sheetName">Name of the sheet to remove.</param>
        ...
        GetDllLibXls().XlsWorksheetsCollection_RemoveS(self.Ptr, sheetName)
    ...
    <param name="index">Index of the sheet to remove.</param>
        ...
        GetDllLibXls().XlsWorksheetsCollection_RemoveI(self.Ptr, index)
    ...
    <param name="index">Index of the sheet to remove.</param>
        ...
        GetDllLibXls().XlsWorksheetsCollection_RemoveAt(self.Ptr, index)
    ...
    def AddCopyBefore(self ,toCopy:IWorksheet)->IWorksheet:
        ...
        intPtr = GetDllLibXls().XlsWorksheetsCollection_AddCopyBefore(self.Ptr, intPtrtoCopy)
        ret = None if intPtr==None else XlsWorksheet(intPtr)
        return ret
    ...
    def AddCopyBefore(self ,toCopy:IWorksheet,sheetAfter:IWorksheet)->IWorksheet:
        ...
        intPtr = GetDllLibXls().XlsWorksheetsCollection_AddCopyBeforeTS(self.Ptr, intPtrtoCopy,intPtrsheetAfter)
        ret = None if intPtr==None else XlsWorksheet(intPtr)
        return ret
    ...
    def AddCopyAfter(self ,toCopy:IWorksheet)->IWorksheet:
        ...
        intPtr = GetDllLibXls().XlsWorksheetsCollection_AddCopyAfter(self.Ptr, intPtrtoCopy)
        ret = None if intPtr==None else XlsWorksheet(intPtr)
        return ret
    ...
    def AddCopyAfter(self ,toCopy:IWorksheet,sheetBefore:IWorksheet)->IWorksheet:
        ...
        intPtr = GetDllLibXls().XlsWorksheetsCollection_AddCopyAfterTS(self.Ptr, intPtrtoCopy,intPtrsheetBefore)
        ret = None if intPtr==None else XlsWorksheet(intPtr)
        return ret
    ...
    def IsRightToLeft(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorksheetsCollection_get_IsRightToLeft(self.Ptr)
        return ret
    ...
    def IsRightToLeft(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheetsCollection_set_IsRightToLeft(self.Ptr, value)
    ...
    def InnerAdd(self ,sheet:'IWorksheet'):
        ...
        GetDllLibXls().XlsWorksheetsCollection_InnerAdd(self.Ptr, intPtrsheet)
    ...
    def Move(self ,oldIndex:int,newIndex:int):
        ...
        GetDllLibXls().XlsWorksheetsCollection_Move(self.Ptr, oldIndex,newIndex)
    ...
    def UpdateSheetIndex(self ,sheet:'XlsWorksheet',iOldRealIndex:int):
        ...
        GetDllLibXls().XlsWorksheetsCollection_UpdateSheetIndex(self.Ptr, intPtrsheet,iOldRealIndex)
...
#        GetDllLibXls().XlsWorksheetsCollection_UpdateStringIndexes(self.Ptr, intPtrnewIndexes)
    ...
    def Add(self ,sheetName:str)->'IWorksheet':
        ...
        intPtr = GetDllLibXls().XlsWorksheetsCollection_Add(self.Ptr, sheetName)
        ret = None if intPtr==None else XlsWorksheet(intPtr)
        return ret
    ...
    def AddCopy(self ,sheetIndex:int)->IWorksheet:
        ...
        intPtr = GetDllLibXls().XlsWorksheetsCollection_AddCopy(self.Ptr, sheetIndex)
        ret = None if intPtr==None else XlsWorksheet(intPtr)
        return ret
    ...
    <returns>Copy of worksheet that was added.</returns>
        ...
        intPtr = GetDllLibXls().XlsWorksheetsCollection_AddCopyS(self.Ptr, intPtrsheet)
        ret = None if intPtr==None else XlsWorksheet(intPtr)
        return ret
    ...
    def AddCopy(self ,sheet:IWorksheet,flags:WorksheetCopyType)->IWorksheet:
        ...
        intPtr = GetDllLibXls().XlsWorksheetsCollection_AddCopySF(self.Ptr, intPtrsheet,enumflags)
        ret = None if intPtr==None else XlsWorksheet(intPtr)
        return ret
    ...
    def AddCopy(self ,worksheets:IWorksheets):
        ...
        GetDllLibXls().XlsWorksheetsCollection_AddCopyW(self.Ptr, intPtrworksheets)
    ...
    def AddCopy(self ,worksheets:IWorksheets,flags:WorksheetCopyType):
        ...
        GetDllLibXls().XlsWorksheetsCollection_AddCopyWF(self.Ptr, intPtrworksheets,enumflags)
    ...
    <returns>Returns copied sheet.</returns>
        ...
        intPtr = GetDllLibXls().XlsWorksheetsCollection_AddCopySF1(self.Ptr, sheetIndex,enumflags)
        ret = None if intPtr==None else XlsWorksheet(intPtr)
        return ret
