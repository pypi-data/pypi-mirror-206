...
class StraightBevelDiffGearCompoundDynamicAnalysis(_6389.BevelGearCompoundDynamicAnalysis):
    """StraightBevelDiffGearCompoundDynamicAnalysis
    ...
    class _Cast_StraightBevelDiffGearCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_compound_dynamic_analysis(self) -> 'StraightBevelDiffGearCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6349.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6349.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearCompoundDynamicAnalysis._Cast_StraightBevelDiffGearCompoundDynamicAnalysis':
