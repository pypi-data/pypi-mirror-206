...
class ModelJobConfig(object):
    ...
    def __init__(self, stage=None, job_type=None, analysis_method=None, model_job_id=None, client_id=None, cohort_window_count=None, train_model_job_id=None, container_config=None, pipeline_config=None):  # noqa: E501
