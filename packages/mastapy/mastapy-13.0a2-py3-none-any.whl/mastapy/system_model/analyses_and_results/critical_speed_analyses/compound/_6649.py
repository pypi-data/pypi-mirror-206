...
class BeltDriveCompoundCriticalSpeedAnalysis(_6737.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """BeltDriveCompoundCriticalSpeedAnalysis
    ...
    class _Cast_BeltDriveCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'BeltDriveCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def belt_drive_compound_critical_speed_analysis(self) -> 'BeltDriveCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6518.BeltDriveCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6518.BeltDriveCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BeltDriveCompoundCriticalSpeedAnalysis._Cast_BeltDriveCompoundCriticalSpeedAnalysis':
