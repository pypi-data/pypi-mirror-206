...
class PageColRow (SpireObject) :
    ...
    def StartRow(self)->int:
        ...
        ret = GetDllLibXls().PageColRow_StartRow(self.Ptr)
        return ret
    ...
    def EndRow(self)->int:
        ...
        ret = GetDllLibXls().PageColRow_EndRow(self.Ptr)
        return ret
    ...
    def StartCol(self)->int:
        ...
        ret = GetDllLibXls().PageColRow_StartCol(self.Ptr)
        return ret
    ...
    def EndCol(self)->int:
        ...
        ret = GetDllLibXls().PageColRow_EndCol(self.Ptr)
        return ret
