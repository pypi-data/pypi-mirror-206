...
class XlsGradientStop (SpireObject) :
    ...
    def OColor(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsGradientStop_get_OColor(self.Ptr)
    ...
    def Position(self)->int:
        ...
        ret = GetDllLibXls().XlsGradientStop_get_Position(self.Ptr)
        return ret

    @Position.setter
    def Position(self, value:int):
        GetDllLibXls().XlsGradientStop_set_Position.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsGradientStop_set_Position(self.Ptr, value)
    ...
    def Transparency(self)->int:
        ...
        ret = GetDllLibXls().XlsGradientStop_get_Transparency(self.Ptr)
        return ret

    @Transparency.setter
    def Transparency(self, value:int):
        GetDllLibXls().XlsGradientStop_set_Transparency.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsGradientStop_set_Transparency(self.Ptr, value)
    ...
    def Tint(self)->int:
        ...
        ret = GetDllLibXls().XlsGradientStop_get_Tint(self.Ptr)
        return ret

    @Tint.setter
    def Tint(self, value:int):
        GetDllLibXls().XlsGradientStop_set_Tint.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsGradientStop_set_Tint(self.Ptr, value)
    ...
    def Shade(self)->int:
        ...
        ret = GetDllLibXls().XlsGradientStop_get_Shade(self.Ptr)
        return ret

    @Shade.setter
    def Shade(self, value:int):
        GetDllLibXls().XlsGradientStop_set_Shade.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsGradientStop_set_Shade(self.Ptr, value)
