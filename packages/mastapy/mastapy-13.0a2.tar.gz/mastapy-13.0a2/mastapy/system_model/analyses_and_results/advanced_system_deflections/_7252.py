...
class BevelGearMeshAdvancedSystemDeflection(_7240.AGMAGleasonConicalGearMeshAdvancedSystemDeflection):
    """BevelGearMeshAdvancedSystemDeflection
    ...
    class _Cast_BevelGearMeshAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'BevelGearMeshAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def bevel_gear_mesh_advanced_system_deflection(self) -> 'BevelGearMeshAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearMeshAdvancedSystemDeflection._Cast_BevelGearMeshAdvancedSystemDeflection':
