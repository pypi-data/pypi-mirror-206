...
class ShaftSteadyStateSynchronousResponse(_2964.AbstractShaftSteadyStateSynchronousResponse):
    """ShaftSteadyStateSynchronousResponse
    ...
    class _Cast_ShaftSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'ShaftSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def shaft_steady_state_synchronous_response(self) -> 'ShaftSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftSteadyStateSynchronousResponse._Cast_ShaftSteadyStateSynchronousResponse':
