...
class StraightBevelGearCriticalSpeedAnalysis(_6524.BevelGearCriticalSpeedAnalysis):
    """StraightBevelGearCriticalSpeedAnalysis
    ...
    class _Cast_StraightBevelGearCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_critical_speed_analysis(self) -> 'StraightBevelGearCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearCriticalSpeedAnalysis._Cast_StraightBevelGearCriticalSpeedAnalysis':
