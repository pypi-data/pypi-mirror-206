...
class LabelShapeCollection (  CollectionBase[XlsLabelShape],ILabelShapes) :
    ...
    def get_Item(self ,index:int)->ILabelShape:
        ...
        intPtr = GetDllLibXls().LabelShapeCollection_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->ILabelShape:
        ...
        intPtr = GetDllLibXls().LabelShapeCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsLabelShape(intPtr)
        return ret
    ...
    def AddLabel(self ,row:int,column:int,height:int,width:int)->'ILabelShape':
        ...
        intPtr = GetDllLibXls().LabelShapeCollection_AddLabel(self.Ptr, row,column,height,width)
        ret = None if intPtr==None else XlsLabelShape(intPtr)
        return ret
    ...
    def AddCopy(self ,source:'ILabelShape'):
        ...
        GetDllLibXls().LabelShapeCollection_AddCopy(self.Ptr, intPtrsource)
    ...
    def Clear(self):
        ...
        GetDllLibXls().LabelShapeCollection_Clear(self.Ptr)
