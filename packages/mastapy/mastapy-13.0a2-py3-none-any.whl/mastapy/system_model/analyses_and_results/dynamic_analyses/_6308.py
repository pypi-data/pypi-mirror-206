...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6306, _6307, _6249
...
class HypoidGearSetDynamicAnalysis(_6249.AGMAGleasonConicalGearSetDynamicAnalysis):
    """HypoidGearSetDynamicAnalysis
    ...
    class _Cast_HypoidGearSetDynamicAnalysis:
        ...
        def __init__(self, parent: 'HypoidGearSetDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_set_dynamic_analysis(self) -> 'HypoidGearSetDynamicAnalysis':
            return self._parent
    ...
    @property
    def hypoid_gears_dynamic_analysis(self) -> 'List[_6306.HypoidGearDynamicAnalysis]':
    ...
    @property
    def hypoid_meshes_dynamic_analysis(self) -> 'List[_6307.HypoidGearMeshDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearSetDynamicAnalysis._Cast_HypoidGearSetDynamicAnalysis':
