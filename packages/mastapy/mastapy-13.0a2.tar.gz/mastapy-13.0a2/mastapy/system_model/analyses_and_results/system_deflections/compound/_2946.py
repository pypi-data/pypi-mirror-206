...
class SynchroniserHalfCompoundSystemDeflection(_2947.SynchroniserPartCompoundSystemDeflection):
    """SynchroniserHalfCompoundSystemDeflection
    ...
    class _Cast_SynchroniserHalfCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'SynchroniserHalfCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def synchroniser_half_compound_system_deflection(self) -> 'SynchroniserHalfCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2800.SynchroniserHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2800.SynchroniserHalfSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserHalfCompoundSystemDeflection._Cast_SynchroniserHalfCompoundSystemDeflection':
