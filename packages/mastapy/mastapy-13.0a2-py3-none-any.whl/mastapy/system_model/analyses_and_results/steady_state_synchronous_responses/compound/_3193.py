...
class SpecialisedAssemblyCompoundSteadyStateSynchronousResponse(_3095.AbstractAssemblyCompoundSteadyStateSynchronousResponse):
    """SpecialisedAssemblyCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_SpecialisedAssemblyCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'SpecialisedAssemblyCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def specialised_assembly_compound_steady_state_synchronous_response(self) -> 'SpecialisedAssemblyCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3061.SpecialisedAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3061.SpecialisedAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'SpecialisedAssemblyCompoundSteadyStateSynchronousResponse._Cast_SpecialisedAssemblyCompoundSteadyStateSynchronousResponse':
        return self._Cast_SpecialisedAssemblyCompoundSteadyStateSynchronousResponse(self)
