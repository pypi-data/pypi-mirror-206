...
class PartToPartShearCouplingHalfSystemDeflection(_2709.CouplingHalfSystemDeflection):
    """PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4091.PartToPartShearCouplingHalfPowerFlow':
