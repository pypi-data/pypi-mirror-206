...
class XlsHeaderFooterShapeCollection (  ShapeCollectionBase) :
    ...
    def SetPicture(self ,strShapeName:str,image:Image)->XlsShape:
        """
        ...
        intPtr = GetDllLibXls().XlsHeaderFooterShapeCollection_SetPicture(self.Ptr, strShapeName,intPtrimage)
    ...
    def SetPicture(self ,strShapeName:str,image:Image,index:int)->XlsShape:
        """
        ...
        intPtr = GetDllLibXls().XlsHeaderFooterShapeCollection_SetPictureSII(self.Ptr, strShapeName,intPtrimage,index)
        ret = None if intPtr==None else XlsShape(intPtr)
        return ret
    ...
    def SetPicture(self ,strShapeName:str,image:Image,iIndex:int,bIncludeOptions:bool)->XlsShape:
        """
        ...
        intPtr = GetDllLibXls().XlsHeaderFooterShapeCollection_SetPictureSIIB(self.Ptr, strShapeName,intPtrimage,iIndex,bIncludeOptions)
        ret = None if intPtr==None else XlsShape(intPtr)
        return ret
