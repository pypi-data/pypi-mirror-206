...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6254, _6255, _6261
...
class BevelDifferentialGearSetDynamicAnalysis(_6261.BevelGearSetDynamicAnalysis):
    """BevelDifferentialGearSetDynamicAnalysis
    ...
    @property
    def bevel_differential_gears_dynamic_analysis(self) -> 'List[_6254.BevelDifferentialGearDynamicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_dynamic_analysis(self) -> 'List[_6255.BevelDifferentialGearMeshDynamicAnalysis]':
