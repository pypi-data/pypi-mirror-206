...
class ExcelGradient (  SpireObject, IGradient) :
    ...
    def BackColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().ExcelGradient_get_BackColor(self.Ptr)
    ...
    def BackColor(self, value:'Color'):
        ...
        GetDllLibXls().ExcelGradient_set_BackColor(self.Ptr, value.Ptr)
    ...
    def BackColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().ExcelGradient_get_BackColorObject(self.Ptr)
    ...
    def BackKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().ExcelGradient_get_BackKnownColor(self.Ptr)
    ...
    def BackKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().ExcelGradient_set_BackKnownColor(self.Ptr, value.value)
    ...
    def ForeColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().ExcelGradient_get_ForeColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def ForeColor(self, value:'Color'):
        ...
        GetDllLibXls().ExcelGradient_set_ForeColor(self.Ptr, value.Ptr)
    ...
    def ForeKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().ExcelGradient_get_ForeKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def ForeKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().ExcelGradient_set_ForeKnownColor(self.Ptr, value.value)
    ...
    def ForeColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().ExcelGradient_get_ForeColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def GradientStyle(self)->'GradientStyleType':
        ...
        ret = GetDllLibXls().ExcelGradient_get_GradientStyle(self.Ptr)
    ...
    def GradientStyle(self, value:'GradientStyleType'):
        ...
        GetDllLibXls().ExcelGradient_set_GradientStyle(self.Ptr, value.value)
    ...
    def GradientVariant(self)->'GradientVariantsType':
        ...
        ret = GetDllLibXls().ExcelGradient_get_GradientVariant(self.Ptr)
    ...
    def GradientVariant(self, value:'GradientVariantsType'):
        ...
        GetDllLibXls().ExcelGradient_set_GradientVariant(self.Ptr, value.value)
    ...
    def CompareTo(self ,gradient:'IGradient')->int:
        ...
        ret = GetDllLibXls().ExcelGradient_CompareTo(self.Ptr, intPtrgradient)
        return ret
    ...
    def TwoColorGradient(self):
        ...
        GetDllLibXls().ExcelGradient_TwoColorGradient(self.Ptr)
    ...
    def TwoColorGradient(self ,style:GradientStyleType,variant:GradientVariantsType):
        ...
        GetDllLibXls().ExcelGradient_TwoColorGradientSV(self.Ptr, enumstyle,enumvariant)
