...
class FlexiblePinAssemblySteadyStateSynchronousResponse(_3061.SpecialisedAssemblySteadyStateSynchronousResponse):
    """FlexiblePinAssemblySteadyStateSynchronousResponse
    ...
    class _Cast_FlexiblePinAssemblySteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'FlexiblePinAssemblySteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def flexible_pin_assembly_steady_state_synchronous_response(self) -> 'FlexiblePinAssemblySteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FlexiblePinAssemblySteadyStateSynchronousResponse._Cast_FlexiblePinAssemblySteadyStateSynchronousResponse':
