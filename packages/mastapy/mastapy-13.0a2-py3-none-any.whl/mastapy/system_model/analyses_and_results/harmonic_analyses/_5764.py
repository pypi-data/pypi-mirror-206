...
class PowerLoadHarmonicAnalysis(_5804.VirtualComponentHarmonicAnalysis):
    """PowerLoadHarmonicAnalysis
    ...
    class _Cast_PowerLoadHarmonicAnalysis:
        ...
        def __init__(self, parent: 'PowerLoadHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def power_load_harmonic_analysis(self) -> 'PowerLoadHarmonicAnalysis':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2771.PowerLoadSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'PowerLoadHarmonicAnalysis._Cast_PowerLoadHarmonicAnalysis':
