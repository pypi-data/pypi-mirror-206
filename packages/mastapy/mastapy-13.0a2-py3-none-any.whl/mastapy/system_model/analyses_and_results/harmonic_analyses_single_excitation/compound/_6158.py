...
class FaceGearCompoundHarmonicAnalysisOfSingleExcitation(_6163.GearCompoundHarmonicAnalysisOfSingleExcitation):
    """FaceGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_FaceGearCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'FaceGearCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def face_gear_compound_harmonic_analysis_of_single_excitation(self) -> 'FaceGearCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6028.FaceGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6028.FaceGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'FaceGearCompoundHarmonicAnalysisOfSingleExcitation._Cast_FaceGearCompoundHarmonicAnalysisOfSingleExcitation':
