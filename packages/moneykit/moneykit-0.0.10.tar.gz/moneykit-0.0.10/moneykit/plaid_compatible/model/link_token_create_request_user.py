...
class LinkTokenCreateRequestUser(ModelNormal):
    ...
    def __init__(self, client_user_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            legal_name (str, none_type): The user's full legal name, used for [micro-deposit based verification flows](https://plaid.com/docs/auth/coverage/). For a small number of customers on legacy flows, providing this field is required to enable micro-deposit-based flows. For all other customers, this field is optional, but providing the user's name in this field when using micro-deposit-based verification will enable certain risk checks and can reduce micro-deposit fraud.. [optional]  # noqa: E501
            name (LinkTokenCreateRequestUserName): [optional]  # noqa: E501
            phone_number (str, none_type): The user's phone number in [E.164](https://en.wikipedia.org/wiki/E.164) format. This field is optional, but required to enable the [returning user experience](https://plaid.com/docs/link/returning-user).. [optional]  # noqa: E501
            ...
            email_address (str, none_type): The user's email address. This field is optional, but required to enable the [pre-authenticated returning user flow](https://plaid.com/docs/link/returning-user/#pre-authenticated-rux).. [optional]  # noqa: E501
            ...
            ssn (str, none_type): To be provided in the format \"ddd-dd-dddd\". Not currently used.. [optional]  # noqa: E501
            date_of_birth (date, none_type): To be provided in the format \"yyyy-mm-dd\". Not currently used.. [optional]  # noqa: E501
