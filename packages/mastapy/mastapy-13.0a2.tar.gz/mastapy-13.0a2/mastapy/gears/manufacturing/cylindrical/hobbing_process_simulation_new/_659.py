...
class CutterHeadSlideError(_0.APIBase):
    ...
    class _Cast_CutterHeadSlideError:
        ...
        def __init__(self, parent: 'CutterHeadSlideError'):
            self._parent = parent

        @property
        def cutter_head_slide_error(self) -> 'CutterHeadSlideError':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CutterHeadSlideError._Cast_CutterHeadSlideError':
