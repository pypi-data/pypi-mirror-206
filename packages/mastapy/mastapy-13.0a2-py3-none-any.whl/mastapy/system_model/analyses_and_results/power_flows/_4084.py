...
from mastapy.system_model.analyses_and_results.power_flows import _4083, _4082, _4078
...
class KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow(_4078.KlingelnbergCycloPalloidConicalGearSetPowerFlow):
    """KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4083.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_power_flow(self) -> 'List[_4083.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4082.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_power_flow(self) -> 'List[_4082.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow]':
