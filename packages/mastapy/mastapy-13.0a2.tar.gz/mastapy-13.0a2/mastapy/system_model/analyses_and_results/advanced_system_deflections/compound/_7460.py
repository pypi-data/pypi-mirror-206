...
class RollingRingCompoundAdvancedSystemDeflection(_7407.CouplingHalfCompoundAdvancedSystemDeflection):
    """RollingRingCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7329.RollingRingAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7329.RollingRingAdvancedSystemDeflection]':
