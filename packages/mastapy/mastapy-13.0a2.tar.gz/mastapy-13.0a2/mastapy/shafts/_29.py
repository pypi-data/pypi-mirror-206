...
class ShaftPointStressCycleReporting(_0.APIBase):
    ...
    class _Cast_ShaftPointStressCycleReporting:
        ...
        def __init__(self, parent: 'ShaftPointStressCycleReporting'):
            self._parent = parent

        @property
        def shaft_point_stress_cycle_reporting(self) -> 'ShaftPointStressCycleReporting':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftPointStressCycleReporting._Cast_ShaftPointStressCycleReporting':
        return self._Cast_ShaftPointStressCycleReporting(self)
