...
class BevelDifferentialPlanetGearDynamicAnalysis(_6254.BevelDifferentialGearDynamicAnalysis):
    """BevelDifferentialPlanetGearDynamicAnalysis
    ...
    class _Cast_BevelDifferentialPlanetGearDynamicAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialPlanetGearDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_planet_gear_dynamic_analysis(self) -> 'BevelDifferentialPlanetGearDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialPlanetGearDynamicAnalysis._Cast_BevelDifferentialPlanetGearDynamicAnalysis':
