...
class RTFCommentArray (  XlsObject, IRichTextString, IOptimizedUpdate) :
    ...
    def GetFont(self ,iPosition:int)->'IFont':
        ...
        intPtr = GetDllLibXls().RTFCommentArray_GetFont(self.Ptr, iPosition)
    ...
    def SetFont(self ,iStartPos:int,iEndPos:int,font:'IFont'):
        ...
        GetDllLibXls().RTFCommentArray_SetFont(self.Ptr, iStartPos,iEndPos,intPtrfont)
    ...
    def ClearFormatting(self):
        ...
        GetDllLibXls().RTFCommentArray_ClearFormatting(self.Ptr)
    ...
    def Append(self ,text:str,font:'IFont'):
        ...
        GetDllLibXls().RTFCommentArray_Append(self.Ptr, text,intPtrfont)
    ...
    def Clear(self):
        ...
        GetDllLibXls().RTFCommentArray_Clear(self.Ptr)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().RTFCommentArray_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().RTFCommentArray_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().RTFCommentArray_set_Text(self.Ptr, value)
    ...
    def RtfText(self)->str:
        ...
        GetDllLibXls().RTFCommentArray_get_RtfText.restype=c_wchar_p
        ret = GetDllLibXls().RTFCommentArray_get_RtfText(self.Ptr)
        return ret
    ...
    def IsFormatted(self)->bool:
        ...
        ret = GetDllLibXls().RTFCommentArray_get_IsFormatted(self.Ptr)
        return ret
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().RTFCommentArray_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().RTFCommentArray_EndUpdate(self.Ptr)
