...
class StraightBevelGearDynamicAnalysis(_6259.BevelGearDynamicAnalysis):
    """StraightBevelGearDynamicAnalysis
    ...
    class _Cast_StraightBevelGearDynamicAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_dynamic_analysis(self) -> 'StraightBevelGearDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearDynamicAnalysis._Cast_StraightBevelGearDynamicAnalysis':
