...
class DocumentProperty (  SpireObject, IDocumentProperty) :
    ...
    def IsBuiltIn(self)->bool:
        ...
        ret = GetDllLibXls().DocumentProperty_get_IsBuiltIn(self.Ptr)
        return ret
    ...
    def PropertyId(self)->'BuiltInPropertyType':
        ...
        ret = GetDllLibXls().DocumentProperty_get_PropertyId(self.Ptr)
    ...
    def PropertyType(self)->'PropertyType':
        ...
        ret = GetDllLibXls().DocumentProperty_get_PropertyType(self.Ptr)
    ...
    def InternalName(self)->str:
        ...
        GetDllLibXls().DocumentProperty_get_InternalName.restype=c_wchar_p
        ret = GetDllLibXls().DocumentProperty_get_InternalName(self.Ptr)
        return ret
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().DocumentProperty_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().DocumentProperty_get_Name(self.Ptr)
        return ret
    ...
    def Value(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().DocumentProperty_get_Value(self.Ptr)
    ...
    def Value(self, value:'SpireObject'):
        ...
        GetDllLibXls().DocumentProperty_set_Value(self.Ptr, value.Ptr)
...
#        intPtrArray = GetDllLibXls().DocumentProperty_get_Blob(self.Ptr)
...
#        GetDllLibXls().DocumentProperty_set_Blob(self.Ptr, vArray, vCount)
    ...
    def Boolean(self)->bool:
        ...
        ret = GetDllLibXls().DocumentProperty_get_Boolean(self.Ptr)
        return ret

    @Boolean.setter
    def Boolean(self, value:bool):
        GetDllLibXls().DocumentProperty_set_Boolean.argtypes=[c_void_p, c_bool]
        GetDllLibXls().DocumentProperty_set_Boolean(self.Ptr, value)
    ...
    def Integer(self)->int:
        ...
        ret = GetDllLibXls().DocumentProperty_get_Integer(self.Ptr)
        return ret

    @Integer.setter
    def Integer(self, value:int):
        GetDllLibXls().DocumentProperty_set_Integer.argtypes=[c_void_p, c_int]
        GetDllLibXls().DocumentProperty_set_Integer(self.Ptr, value)
    ...
    def Int32(self)->int:
        ...
        ret = GetDllLibXls().DocumentProperty_get_Int32(self.Ptr)
        return ret

    @Int32.setter
    def Int32(self, value:int):
        GetDllLibXls().DocumentProperty_set_Int32.argtypes=[c_void_p, c_int]
        GetDllLibXls().DocumentProperty_set_Int32(self.Ptr, value)
    ...
    def Double(self)->float:
        ...
        ret = GetDllLibXls().DocumentProperty_get_Double(self.Ptr)
        return ret

    @Double.setter
    def Double(self, value:float):
        GetDllLibXls().DocumentProperty_set_Double.argtypes=[c_void_p, c_double]
        GetDllLibXls().DocumentProperty_set_Double(self.Ptr, value)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().DocumentProperty_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().DocumentProperty_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().DocumentProperty_set_Text(self.Ptr, value)
    ...
    def DateTime(self)->'DateTime':
        ...
        intPtr = GetDllLibXls().DocumentProperty_get_DateTime(self.Ptr)
    ...
    def DateTime(self, value:'DateTime'):
        ...
        GetDllLibXls().DocumentProperty_set_DateTime(self.Ptr, value.Ptr)
    ...
    def TimeSpan(self)->'TimeSpan':
        ...
        intPtr = GetDllLibXls().DocumentProperty_get_TimeSpan(self.Ptr)
    ...
    def TimeSpan(self, value:'TimeSpan'):
        ...
        GetDllLibXls().DocumentProperty_set_TimeSpan(self.Ptr, value.Ptr)
    ...
    def LinkSource(self)->str:
        ...
        GetDllLibXls().DocumentProperty_get_LinkSource.restype=c_wchar_p
        ret = GetDllLibXls().DocumentProperty_get_LinkSource(self.Ptr)
        return ret
    ...
    def LinkSource(self, value:str):
        ...
        GetDllLibXls().DocumentProperty_set_LinkSource(self.Ptr, value)
    ...
    def LinkToContent(self)->bool:
        ...
        ret = GetDllLibXls().DocumentProperty_get_LinkToContent(self.Ptr)
        return ret
    ...
    def LinkToContent(self, value:bool):
        ...
        GetDllLibXls().DocumentProperty_set_LinkToContent(self.Ptr, value)
    ...
    def Clone(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().DocumentProperty_Clone(self.Ptr)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    def SetLinkSource(self ,variant:'IPropertyData'):
        ...
        GetDllLibXls().DocumentProperty_SetLinkSource(self.Ptr, intPtrvariant)
...
#        ret = GetDllLibXls().DocumentProperty_CorrectIndex( enumpropertyId,intPtrbSummary)
#        return ret
    ...
    def DEF_FILE_TIME_START_YEAR()->int:
        ...
        ret = GetDllLibXls().DocumentProperty_DEF_FILE_TIME_START_YEAR()
        return ret
