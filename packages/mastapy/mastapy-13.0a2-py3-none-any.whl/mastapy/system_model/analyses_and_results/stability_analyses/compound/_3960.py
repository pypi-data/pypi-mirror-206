...
class PointLoadCompoundStabilityAnalysis(_3996.VirtualComponentCompoundStabilityAnalysis):
    """PointLoadCompoundStabilityAnalysis
    ...
    class _Cast_PointLoadCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'PointLoadCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def point_load_compound_stability_analysis(self) -> 'PointLoadCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3829.PointLoadStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3829.PointLoadStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PointLoadCompoundStabilityAnalysis._Cast_PointLoadCompoundStabilityAnalysis':
