...
class GetInstrumentTest(unittest.TestCase):
    ...
    def testData(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "9447c0af-5569-48f2-b4c5-241105d58c91.xml")
        inst = res["instrument"]
    ...
    def testAliases(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "6505f98c-f698-4406-8bf4-8ca43d05c36f-aliases.xml")
        inst = res["instrument"]
    ...
    def testTags(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "6505f98c-f698-4406-8bf4-8ca43d05c36f-tags.xml")
        inst = res["instrument"]
    ...
    def testUrlRels(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "d00cec5f-f9bc-4235-a54f-6639a02d4e4c-url-rels.xml")
        inst = res["instrument"]
    ...
    def testAnnotations(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "d00cec5f-f9bc-4235-a54f-6639a02d4e4c-annotation.xml")
        inst = res["instrument"]
        self.assertEqual(inst["annotation"]["text"], "Hornbostel-Sachs: 412.22")

    def testInstrumentRels(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "01ba56a2-4306-493d-8088-c7e9b671c74e-instrument-rels.xml")
        inst = res["instrument"]
    ...
    def testDisambiguation(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "dabdeb41-560f-4d84-aa6a-cf22349326fe.xml")
        inst = res["instrument"]
