...
class MXProtocolType:
    ...
    class Base(Enum):
        ...
        TM_VALUE_PUBLISH_NEW = 'TM/VALUE_PUBLISH/%s/%s'
    ...
    def get(self, topic: str) -> 'MXProtocolType':
        ...
        elif 'TM/VALUE_PUBLISH/' in topic:
            return MXProtocolType.Base.TM_VALUE_PUBLISH_NEW
        ...
        elif 'ME/RESULT/ADD_SCENARIO/' in topic:
            return MXProtocolType.WebClient.ME_RESULT_ADD_SCENARIO
        ...
        elif 'ME/RESULT/UPDATE_SCENARIO/' in topic:
            return MXProtocolType.WebClient.ME_RESULT_UPDATE_SCENARIO
