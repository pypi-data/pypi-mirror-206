...
class SynchroniserSleeveSystemDeflection(_2801.SynchroniserPartSystemDeflection):
    """SynchroniserSleeveSystemDeflection
    ...
    class _Cast_SynchroniserSleeveSystemDeflection:
        ...
        def __init__(self, parent: 'SynchroniserSleeveSystemDeflection'):
            self._parent = parent
        ...
        @property
        def synchroniser_sleeve_system_deflection(self) -> 'SynchroniserSleeveSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4128.SynchroniserSleevePowerFlow':
    ...
    @property
    def cast_to(self) -> 'SynchroniserSleeveSystemDeflection._Cast_SynchroniserSleeveSystemDeflection':
