...
class WorldOilSupply:
    ...
    def get_cost_of_supplies(
        ...
        **Compose Ref Data with Costs**
        >>> sup_sub_types = ci.WorldOilSupply().get_reference_data(type=ci.WorldOilSupply.RefType.SupplySubTypes)
    ...
    def get_ownership(
        ...
        **Compose Ref Data with Ownership**
        >>> res_locations = ci.WorldOilSupply.get_reference_data(type=ci.WorldOilSupply.RefType.ReserveLocations)
    ...
    def get_production(
        ...
        **Compose Ref Data with Production**
        >>> opec = ci.WorldOilSupply().get_reference_data(type=ci.WorldOilSupply().RefType.OPECCountries)
    ...
    def get_production_archive(
        ...
        **Get List of Scenario IDs**
        >>> ci.WorldOilSupply().get_reference_data(type=ci.WorldOilSupply().RefType.ScenarioList)

        **Compose Ref Data with Production Archive**
        >>> scenarios = ci.WorldOilSupply.get_reference_data(type=ci.WorldOilSupply().RefType.ScenarioList)
