...
class CylindricalManufacturedRealGearInMesh(_0.APIBase):
    ...
    class _Cast_CylindricalManufacturedRealGearInMesh:
        ...
        def __init__(self, parent: 'CylindricalManufacturedRealGearInMesh'):
            self._parent = parent

        @property
        def cylindrical_manufactured_real_gear_in_mesh(self) -> 'CylindricalManufacturedRealGearInMesh':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalManufacturedRealGearInMesh._Cast_CylindricalManufacturedRealGearInMesh':
        return self._Cast_CylindricalManufacturedRealGearInMesh(self)
