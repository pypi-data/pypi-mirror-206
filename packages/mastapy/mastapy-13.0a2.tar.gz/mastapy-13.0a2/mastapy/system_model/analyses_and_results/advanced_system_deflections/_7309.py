...
class KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection(_7303.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_advanced_system_deflection(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_detailed_analysis(self) -> '_402.KlingelnbergCycloPalloidSpiralBevelGearRating':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2755.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection._Cast_KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection':
        return self._Cast_KlingelnbergCycloPalloidSpiralBevelGearAdvancedSystemDeflection(self)
