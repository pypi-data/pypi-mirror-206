...
class CylindricalGearShaper(_713.InvoluteCutterDesign):
    """CylindricalGearShaper
    ...
    class _Cast_CylindricalGearShaper:
        ...
        def __init__(self, parent: 'CylindricalGearShaper'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_shaper(self) -> 'CylindricalGearShaper':
            return self._parent
    ...
    @property
    def shaper_edge_type(self) -> '_1068.ShaperEdgeTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, _1068.ShaperEdgeTypes)
        return constructor.new_from_mastapy_type(_1068.ShaperEdgeTypes)(value) if value is not None else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_1068.ShaperEdgeTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1068.ShaperEdgeTypes.type_())
    ...
    @property
    def cast_to(self) -> 'CylindricalGearShaper._Cast_CylindricalGearShaper':
