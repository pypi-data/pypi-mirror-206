...
"""
from mastapy.system_model.analyses_and_results.mbd_analyses import _5419, _5453, _5458
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy._internal.implicit import list_with_selected_item
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.system_model.analyses_and_results.analysis_cases import _7498
...
class MBDRunUpAnalysisOptions(_7498.AbstractAnalysisOptions['_6770.TimeSeriesLoadCase']):
    """MBDRunUpAnalysisOptions
    ...
    class _Cast_MBDRunUpAnalysisOptions:
        ...
        def __init__(self, parent: 'MBDRunUpAnalysisOptions'):
            self._parent = parent

        @property
        def abstract_analysis_options(self):
            return self._parent._cast(_7498.AbstractAnalysisOptions)

        @property
        def mbd_run_up_analysis_options(self) -> 'MBDRunUpAnalysisOptions':
            return self._parent
    ...
    @property
    def input_velocity_processing_type(self) -> '_5419.InputVelocityForRunUpProcessingType':
        ...
        value = conversion.pn_to_mp_enum(temp, _5419.InputVelocityForRunUpProcessingType)
        return constructor.new_from_mastapy_type(_5419.InputVelocityForRunUpProcessingType)(value) if value is not None else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5419.InputVelocityForRunUpProcessingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _5419.InputVelocityForRunUpProcessingType.type_())
    ...
    @property
    def run_up_driving_mode(self) -> '_5453.RunUpDrivingMode':
        ...
        value = conversion.pn_to_mp_enum(temp, _5453.RunUpDrivingMode)
        return constructor.new_from_mastapy_type(_5453.RunUpDrivingMode)(value) if value is not None else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5453.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _5453.RunUpDrivingMode.type_())
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5458.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        value = conversion.pn_to_mp_enum(temp, _5458.ShapeOfInitialAccelerationPeriodForRunUp)
        return constructor.new_from_mastapy_type(_5458.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value is not None else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5458.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _5458.ShapeOfInitialAccelerationPeriodForRunUp.type_())
    ...
    @property
    def cast_to(self) -> 'MBDRunUpAnalysisOptions._Cast_MBDRunUpAnalysisOptions':
