...
class StraightBevelPlanetGearCriticalSpeedAnalysis(_6615.StraightBevelDiffGearCriticalSpeedAnalysis):
    """StraightBevelPlanetGearCriticalSpeedAnalysis
    ...
    class _Cast_StraightBevelPlanetGearCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelPlanetGearCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_planet_gear_critical_speed_analysis(self) -> 'StraightBevelPlanetGearCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelPlanetGearCriticalSpeedAnalysis._Cast_StraightBevelPlanetGearCriticalSpeedAnalysis':
