...
class RangeRichTextString (  RichTextString) :
    ...
    def Dispose(self):
        ...
        GetDllLibXls().RangeRichTextString_Dispose(self.Ptr)
    ...
    def Index(self)->int:
        ...
        ret = GetDllLibXls().RangeRichTextString_get_Index(self.Ptr)
        return ret
    ...
    def DefaultFont(self)->'XlsFont':
        ...
        intPtr = GetDllLibXls().RangeRichTextString_get_DefaultFont(self.Ptr)
