...
class ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase(_924.ParetoFaceRatingOptimisationStrategyDatabase):
    """ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase
    ...
    class _Cast_ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase:
        ...
        def __init__(self, parent: 'ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase'):
            self._parent = parent
        ...
        @property
        def pareto_face_gear_set_duty_cycle_optimisation_strategy_database(self) -> 'ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase._Cast_ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase':
