...
class ElectricMachineResultsTimeStepAtLocation(_0.APIBase):
    ...
    class _Cast_ElectricMachineResultsTimeStepAtLocation:
        ...
        def __init__(self, parent: 'ElectricMachineResultsTimeStepAtLocation'):
            self._parent = parent

        @property
        def electric_machine_results_time_step_at_location(self) -> 'ElectricMachineResultsTimeStepAtLocation':
            return self._parent
    ...
    @property
    def magnetic_vector_potential(self) -> 'float':
        """float: 'MagneticVectorPotential' is the original name of this property.
    ...
    @property
    def cast_to(self) -> 'ElectricMachineResultsTimeStepAtLocation._Cast_ElectricMachineResultsTimeStepAtLocation':
