...
class BeltDriveCompoundStabilityAnalysis(_3972.SpecialisedAssemblyCompoundStabilityAnalysis):
    """BeltDriveCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3752.BeltDriveStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3752.BeltDriveStabilityAnalysis]':
