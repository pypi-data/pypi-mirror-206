...
class MeasurementComponentPowerFlow(_4135.VirtualComponentPowerFlow):
    """MeasurementComponentPowerFlow
    ...
    class _Cast_MeasurementComponentPowerFlow:
        ...
        def __init__(self, parent: 'MeasurementComponentPowerFlow'):
            self._parent = parent
        ...
        @property
        def measurement_component_power_flow(self) -> 'MeasurementComponentPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MeasurementComponentPowerFlow._Cast_MeasurementComponentPowerFlow':
