...
class FaceGearSystemDeflection(_2740.GearSystemDeflection):
    """FaceGearSystemDeflection
    ...
    class _Cast_FaceGearSystemDeflection:
        ...
        def __init__(self, parent: 'FaceGearSystemDeflection'):
            self._parent = parent
        ...
        @property
        def face_gear_system_deflection(self) -> 'FaceGearSystemDeflection':
            return self._parent
    ...
    @property
    def component_detailed_analysis(self) -> '_444.FaceGearRating':
    ...
    @property
    def power_flow_results(self) -> '_4064.FaceGearPowerFlow':
    ...
    @property
    def cast_to(self) -> 'FaceGearSystemDeflection._Cast_FaceGearSystemDeflection':
