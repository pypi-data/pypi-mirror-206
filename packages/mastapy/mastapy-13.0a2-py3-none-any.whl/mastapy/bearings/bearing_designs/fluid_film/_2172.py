...
class PadFluidFilmBearing(_2116.DetailedBearing):
    """PadFluidFilmBearing
    ...
    class _Cast_PadFluidFilmBearing:
        ...
        def __init__(self, parent: 'PadFluidFilmBearing'):
            self._parent = parent
        ...
        @property
        def pad_fluid_film_bearing(self) -> 'PadFluidFilmBearing':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PadFluidFilmBearing._Cast_PadFluidFilmBearing':
