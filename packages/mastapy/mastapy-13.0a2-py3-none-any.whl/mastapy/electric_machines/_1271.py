...
class MagnetDesign(_0.APIBase):
    ...
    class _Cast_MagnetDesign:
        ...
        def __init__(self, parent: 'MagnetDesign'):
            self._parent = parent

        @property
        def cad_magnets_for_layer(self):
            from mastapy.electric_machines import _1241
            
            return self._parent._cast(_1241.CADMagnetsForLayer)

        @property
        def magnet_for_layer(self):
            from mastapy.electric_machines import _1272
            
            return self._parent._cast(_1272.MagnetForLayer)

        @property
        def magnet_design(self) -> 'MagnetDesign':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MagnetDesign._Cast_MagnetDesign':
