...
class SafetyFactorResults(_0.APIBase):
    ...
    class _Cast_SafetyFactorResults:
        ...
        def __init__(self, parent: 'SafetyFactorResults'):
            self._parent = parent

        @property
        def safety_factor_results(self) -> 'SafetyFactorResults':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SafetyFactorResults._Cast_SafetyFactorResults':
