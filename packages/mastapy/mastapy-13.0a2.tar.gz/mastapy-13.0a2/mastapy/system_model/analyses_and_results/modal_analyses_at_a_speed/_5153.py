...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5152, _5151, _5095
...
class HypoidGearSetModalAnalysisAtASpeed(_5095.AGMAGleasonConicalGearSetModalAnalysisAtASpeed):
    """HypoidGearSetModalAnalysisAtASpeed
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_speed(self) -> 'List[_5152.HypoidGearModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_meshes_modal_analysis_at_a_speed(self) -> 'List[_5151.HypoidGearMeshModalAnalysisAtASpeed]':
