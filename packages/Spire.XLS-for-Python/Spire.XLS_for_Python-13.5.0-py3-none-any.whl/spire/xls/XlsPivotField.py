...
class XlsPivotField (  SpireObject, IPivotField, ICloneParent) :
    ...
    def Parent(self)->'PivotTableFields':
        ...
        intPtr = GetDllLibXls().XlsPivotField_get_Parent(self.Ptr)
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().XlsPivotField_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotField_get_Name(self.Ptr)
        return ret
    ...
    def Axis(self)->'AxisTypes':
        ...
        ret = GetDllLibXls().XlsPivotField_get_Axis(self.Ptr)
    ...
    def Axis(self, value:'AxisTypes'):
        ...
        GetDllLibXls().XlsPivotField_set_Axis(self.Ptr, value.value)
    ...
    def NumberFormat(self)->str:
        ...
        GetDllLibXls().XlsPivotField_get_NumberFormat.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotField_get_NumberFormat(self.Ptr)
        return ret
    ...
    def NumberFormat(self, value:str):
        ...
        GetDllLibXls().XlsPivotField_set_NumberFormat(self.Ptr, value)
    ...
    def Subtotals(self)->'SubtotalTypes':
        ...
        ret = GetDllLibXls().XlsPivotField_get_Subtotals(self.Ptr)
    ...
    def Subtotals(self, value:'SubtotalTypes'):
        ...
        GetDllLibXls().XlsPivotField_set_Subtotals(self.Ptr, value.value)
    ...
    def CanDragToRow(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotField_get_CanDragToRow(self.Ptr)
        return ret

    @CanDragToRow.setter
    def CanDragToRow(self, value:bool):
        GetDllLibXls().XlsPivotField_set_CanDragToRow.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotField_set_CanDragToRow(self.Ptr, value)
    ...
    def CanDragToColumn(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotField_get_CanDragToColumn(self.Ptr)
        return ret
    ...
    def CanDragToColumn(self, value:bool):
        ...
        GetDllLibXls().XlsPivotField_set_CanDragToColumn(self.Ptr, value)
    ...
    def CanDragToPage(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotField_get_CanDragToPage(self.Ptr)
        return ret
    ...
    def CanDragToPage(self, value:bool):
        ...
        GetDllLibXls().XlsPivotField_set_CanDragToPage(self.Ptr, value)
    ...
    def CanDragOff(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotField_get_CanDragOff(self.Ptr)
        return ret

    @CanDragOff.setter
    def CanDragOff(self, value:bool):
        GetDllLibXls().XlsPivotField_set_CanDragOff.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotField_set_CanDragOff(self.Ptr, value)
    ...
    def CanDragToData(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotField_get_CanDragToData(self.Ptr)
        return ret
    ...
    def CanDragToData(self, value:bool):
        ...
        GetDllLibXls().XlsPivotField_set_CanDragToData(self.Ptr, value)
    ...
    def DataField(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotField_get_DataField(self.Ptr)
        return ret

    @DataField.setter
    def DataField(self, value:bool):
        GetDllLibXls().XlsPivotField_set_DataField.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotField_set_DataField(self.Ptr, value)
    ...
    def IsDataField(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotField_get_IsDataField(self.Ptr)
        return ret
    ...
    def NumberFormatIndex(self)->int:
        ...
        ret = GetDllLibXls().XlsPivotField_get_NumberFormatIndex(self.Ptr)
        return ret
    ...
    def NumberFormatIndex(self, value:int):
        ...
        GetDllLibXls().XlsPivotField_set_NumberFormatIndex(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsPivotField_get_SubtotalCaption.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotField_get_SubtotalCaption(self.Ptr)
        return ret
    ...
    def SubtotalCaption(self, value:str):
        ...
        GetDllLibXls().XlsPivotField_set_SubtotalCaption(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_SubtotalTop(self.Ptr)
        return ret

    @SubtotalTop.setter
    def SubtotalTop(self, value:bool):
        GetDllLibXls().XlsPivotField_set_SubtotalTop.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotField_set_SubtotalTop(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_IsAutoShow(self.Ptr)
        return ret

    @IsAutoShow.setter
    def IsAutoShow(self, value:bool):
        GetDllLibXls().XlsPivotField_set_IsAutoShow.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotField_set_IsAutoShow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_IsDragToHide(self.Ptr)
        return ret

    @IsDragToHide.setter
    def IsDragToHide(self, value:bool):
        GetDllLibXls().XlsPivotField_set_IsDragToHide.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotField_set_IsDragToHide(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_ShowNewItemsInFilter(self.Ptr)
        return ret
    ...
    def ShowNewItemsInFilter(self, value:bool):
        ...
        GetDllLibXls().XlsPivotField_set_ShowNewItemsInFilter(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_ShowNewItemsOnRefresh(self.Ptr)
        return ret
    ...
    def ShowNewItemsOnRefresh(self, value:bool):
        ...
        GetDllLibXls().XlsPivotField_set_ShowNewItemsOnRefresh(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_ShowBlankRow(self.Ptr)
        return ret

    @ShowBlankRow.setter
    def ShowBlankRow(self, value:bool):
        GetDllLibXls().XlsPivotField_set_ShowBlankRow.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotField_set_ShowBlankRow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_ShowPageBreak(self.Ptr)
        return ret
    ...
    def ShowPageBreak(self, value:bool):
        ...
        GetDllLibXls().XlsPivotField_set_ShowPageBreak(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_ItemsPerPage(self.Ptr)
        return ret

    @ItemsPerPage.setter
    def ItemsPerPage(self, value:int):
        GetDllLibXls().XlsPivotField_set_ItemsPerPage.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsPivotField_set_ItemsPerPage(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_IsMultiSelected(self.Ptr)
        return ret
    ...
    def IsMultiSelected(self, value:bool):
        ...
        GetDllLibXls().XlsPivotField_set_IsMultiSelected(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_IsShowAllItems(self.Ptr)
        return ret
    ...
    def IsShowAllItems(self, value:bool):
        ...
        GetDllLibXls().XlsPivotField_set_IsShowAllItems(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_ShowOutline(self.Ptr)
        return ret

    @ShowOutline.setter
    def ShowOutline(self, value:bool):
        GetDllLibXls().XlsPivotField_set_ShowOutline.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotField_set_ShowOutline(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_ShowDropDown(self.Ptr)
        return ret

    @ShowDropDown.setter
    def ShowDropDown(self, value:bool):
        GetDllLibXls().XlsPivotField_set_ShowDropDown.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotField_set_ShowDropDown(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_ShowPropAsCaption(self.Ptr)
        return ret
    ...
    def ShowPropAsCaption(self, value:bool):
        ...
        GetDllLibXls().XlsPivotField_set_ShowPropAsCaption(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_ShowToolTip(self.Ptr)
        return ret

    @ShowToolTip.setter
    def ShowToolTip(self, value:bool):
        GetDllLibXls().XlsPivotField_set_ShowToolTip.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotField_set_ShowToolTip(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsPivotField_get_SortType(self.Ptr)
    ...
    def SortType(self, value:PivotFieldSortType):
        ...
        GetDllLibXls().XlsPivotField_set_SortType(self.Ptr, value.value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsPivotField_get_Caption.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotField_get_Caption(self.Ptr)
        return ret
    ...
    def Caption(self, value:str):
        ...
        GetDllLibXls().XlsPivotField_set_Caption(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_Compact(self.Ptr)
        return ret

    @Compact.setter
    def Compact(self, value:bool):
        GetDllLibXls().XlsPivotField_set_Compact.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotField_set_Compact(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsPivotField_get_Formula.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotField_get_Formula(self.Ptr)
        return ret
    ...
    def Formula(self, value:str):
        ...
        GetDllLibXls().XlsPivotField_set_Formula(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_IsFormulaField(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotField_get_RepeatItemLabels(self.Ptr)
        return ret
    ...
    def RepeatItemLabels(self, value:bool):
        ...
        GetDllLibXls().XlsPivotField_set_RepeatItemLabels(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsPivotField_get_AutoSort(self.Ptr)
    ...
    def AutoSort(self, value:'AutoSortScope'):
        ...
        GetDllLibXls().XlsPivotField_set_AutoSort(self.Ptr, value.Ptr)
    ...
    def ShowDataAs(self)->'PivotFieldFormatType':
        ...
        ret = GetDllLibXls().XlsPivotField_get_ShowDataAs(self.Ptr)
    ...
    def ShowDataAs(self, value:'PivotFieldFormatType'):
        ...
        GetDllLibXls().XlsPivotField_set_ShowDataAs(self.Ptr, value.value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsPivotField_AddItemOption(self.Ptr, index)
    ...
    <returns>whether the specific PivotItem is hidden detail</returns>
        ...
        ret = GetDllLibXls().XlsPivotField_IsHiddenItemDetail(self.Ptr, index)
        return ret
    ...
    <param name="isHiddenDetail">whether the specific PivotItem is hidden</param>
        ...
        GetDllLibXls().XlsPivotField_HideItemDetail(self.Ptr, index,isHiddenDetail)
    ...
    <param name="isHiddenDetail">whether the specific PivotItem is hidden</param>
        ...
        GetDllLibXls().XlsPivotField_HideItemDetailII(self.Ptr, itemValue,isHiddenDetail)
    ...
    <param name="isHiddenDetail">whether DetailItems is hidden</param>
        ...
        GetDllLibXls().XlsPivotField_HideDetail(self.Ptr, isHiddenDetail)
    ...
    <returns>whether the specific PivotItem is hidden</returns>
        ...
        ret = GetDllLibXls().XlsPivotField_IsHiddenItem(self.Ptr, index)
        return ret
    ...
    <param name="isHidden">whether the specific PivotItem is hidden</param>
        ...
        GetDllLibXls().XlsPivotField_HideItem(self.Ptr, index,isHidden)
    ...
    <param name="isHidden">whether the specific PivotItem is hidden</param>
        ...
        GetDllLibXls().XlsPivotField_HideAllItem(self.Ptr, isHidden)
    ...
    <param name="isHidden">whether the specific PivotItem is hidden</param>
        ...
        GetDllLibXls().XlsPivotField_HideItemII(self.Ptr, itemValue,isHidden)
    ...
    <summary>
        ...
        GetDllLibXls().XlsPivotField_Sort(self.Ptr, isAscendSort,intPtrsortByField)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsPivotField_Clone(self.Ptr, intPtrparent)
