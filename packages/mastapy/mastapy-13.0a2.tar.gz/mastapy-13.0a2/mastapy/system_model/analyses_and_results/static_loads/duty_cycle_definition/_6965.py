...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6955, _6954, _6957, _6958,
    _6966, _6953, _6960, _6956,
    _6959, _6964, _6967
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def boost_pressure_chart(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def force_chart(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def import_type(self) -> '_6872.ImportType':
        ...
        value = conversion.pn_to_mp_enum(temp, _6872.ImportType)
        return constructor.new_from_mastapy_type(_6872.ImportType)(value) if value is not None else None

    @import_type.setter
    def import_type(self, value: '_6872.ImportType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _6872.ImportType.type_())
        self.wrapped.ImportType = value

    @property
    def moment_chart(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def speed_chart(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def torque_chart(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def design_state_options(self) -> '_6954.DesignStateOptions':
    ...
    @property
    def gear_ratio_options(self) -> '_6957.GearRatioInputOptions':
    ...
    @property
    def load_case_name_inputs(self) -> '_6958.LoadCaseNameOptions':
    ...
    @property
    def time_step_input(self) -> '_6966.TimeStepInputOptions':
    ...
    @property
    def boost_pressure_inputs(self) -> 'List[_6953.BoostPressureLoadCaseInputOptions]':
    ...
    @property
    def file_inputs(self) -> 'List[_6960.MultiTimeSeriesDataInputFileOptions]':
    ...
    @property
    def force_inputs(self) -> 'List[_6956.ForceInputOptions]':
    ...
    @property
    def moment_inputs(self) -> 'List[_6959.MomentInputOptions]':
    ...
    @property
    def speed_inputs(self) -> 'List[_6964.SpeedInputOptions]':
    ...
    @property
    def torque_inputs(self) -> 'List[_6967.TorqueInputOptions]':
    ...
    @property
    def columns(self) -> 'List[_1804.ColumnTitle]':
