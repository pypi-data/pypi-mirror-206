...
class CylindricalGearMeshCompoundModalAnalysis(_4760.GearMeshCompoundModalAnalysis):
    """CylindricalGearMeshCompoundModalAnalysis
    ...
    class _Cast_CylindricalGearMeshCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'CylindricalGearMeshCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_compound_modal_analysis(self) -> 'CylindricalGearMeshCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4595.CylindricalGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4595.CylindricalGearMeshModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshCompoundModalAnalysis._Cast_CylindricalGearMeshCompoundModalAnalysis':
