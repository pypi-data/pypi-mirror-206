...
class StraightBevelGearStabilityAnalysis(_3760.BevelGearStabilityAnalysis):
    """StraightBevelGearStabilityAnalysis
    ...
    class _Cast_StraightBevelGearStabilityAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_stability_analysis(self) -> 'StraightBevelGearStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearStabilityAnalysis._Cast_StraightBevelGearStabilityAnalysis':
