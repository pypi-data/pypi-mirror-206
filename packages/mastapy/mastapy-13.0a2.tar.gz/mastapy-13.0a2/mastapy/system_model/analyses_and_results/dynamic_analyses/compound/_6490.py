...
class TorqueConverterCompoundDynamicAnalysis(_6410.CouplingCompoundDynamicAnalysis):
    """TorqueConverterCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6362.TorqueConverterDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6362.TorqueConverterDynamicAnalysis]':
