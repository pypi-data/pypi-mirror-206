...
class StraightBevelDiffGearMesh(_2284.BevelGearMesh):
    """StraightBevelDiffGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_961.StraightBevelDiffGearMeshDesign':
    ...
    @property
    def straight_bevel_diff_gear_mesh_design(self) -> '_961.StraightBevelDiffGearMeshDesign':
