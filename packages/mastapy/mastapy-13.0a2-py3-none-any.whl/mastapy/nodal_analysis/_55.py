...
class CylindricalMisalignmentCalculator(_0.APIBase):
    ...
    class _Cast_CylindricalMisalignmentCalculator:
        ...
        def __init__(self, parent: 'CylindricalMisalignmentCalculator'):
            self._parent = parent

        @property
        def cylindrical_misalignment_calculator(self) -> 'CylindricalMisalignmentCalculator':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalMisalignmentCalculator._Cast_CylindricalMisalignmentCalculator':
