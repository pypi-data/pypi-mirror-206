...
class HypoidGearDesign(_1187.AGMAGleasonConicalGearDesign):
    """HypoidGearDesign
    ...
    class _Cast_HypoidGearDesign:
        ...
        def __init__(self, parent: 'HypoidGearDesign'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_design(self) -> 'HypoidGearDesign':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidGearDesign._Cast_HypoidGearDesign':
