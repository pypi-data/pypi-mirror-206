...
from mastapy.gears.gear_designs.cylindrical import _1076, _1009
from mastapy._internal.implicit import enum_with_selected_value
from mastapy.gears import _333
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.gears.rating.cylindrical import _474, _450
from mastapy.materials import _252, _263
...
class GearSetDesignGroup(_0.APIBase):
    ...
    class _Cast_GearSetDesignGroup:
        ...
        def __init__(self, parent: 'GearSetDesignGroup'):
            self._parent = parent

        @property
        def gear_set_design_group(self) -> 'GearSetDesignGroup':
            return self._parent
    ...
    @property
    def default_rough_toleranced_metal_measurement(self) -> '_1076.TolerancedMetalMeasurements':
        ...
        value = conversion.pn_to_mp_enum(temp, _1076.TolerancedMetalMeasurements)
        return constructor.new_from_mastapy_type(_1076.TolerancedMetalMeasurements)(value) if value is not None else None

    @default_rough_toleranced_metal_measurement.setter
    def default_rough_toleranced_metal_measurement(self, value: '_1076.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1076.TolerancedMetalMeasurements.type_())
    ...
    @property
    def cylindrical_gear_design_constraint_settings(self) -> '_1009.CylindricalGearDesignConstraints':
    ...
    @property
    def general_transmission_properties(self) -> '_252.GeneralTransmissionProperties':
    ...
    @property
    def settings(self) -> '_450.CylindricalGearDesignAndRatingSettingsItem':
    ...
    @property
    def cast_to(self) -> 'GearSetDesignGroup._Cast_GearSetDesignGroup':
