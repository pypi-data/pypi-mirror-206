...
class BoltCompoundSteadyStateSynchronousResponse(_3120.ComponentCompoundSteadyStateSynchronousResponse):
    """BoltCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_BoltCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'BoltCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def bolt_compound_steady_state_synchronous_response(self) -> 'BoltCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2982.BoltSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2982.BoltSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'BoltCompoundSteadyStateSynchronousResponse._Cast_BoltCompoundSteadyStateSynchronousResponse':
