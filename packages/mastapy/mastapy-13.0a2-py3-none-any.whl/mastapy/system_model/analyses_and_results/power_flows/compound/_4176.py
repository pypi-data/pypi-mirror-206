...
class ConicalGearSetCompoundPowerFlow(_4202.GearSetCompoundPowerFlow):
    """ConicalGearSetCompoundPowerFlow
    ...
    class _Cast_ConicalGearSetCompoundPowerFlow:
        ...
        def __init__(self, parent: 'ConicalGearSetCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def conical_gear_set_compound_power_flow(self) -> 'ConicalGearSetCompoundPowerFlow':
            return self._parent
    ...
    @property
    def gear_set_duty_cycle_rating(self) -> '_536.ConicalGearSetDutyCycleRating':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4043.ConicalGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4043.ConicalGearSetPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'ConicalGearSetCompoundPowerFlow._Cast_ConicalGearSetCompoundPowerFlow':
