...
#
    ...
    def OriginalFontName(self)->str:
        ...
        dlllib.Font_get_OriginalFontName.restype=c_wchar_p
        ret = dlllib.Font_get_OriginalFontName(self.Ptr)
        return ret
...
#
    ...
    def Name(self)->str:
        ...
        dlllib.Font_get_Name.restype=c_wchar_p
        ret = dlllib.Font_get_Name(self.Ptr)
        return ret
    ...
    def ToString(self)->str:
        ...
        dlllib.Font_ToString.restype=c_wchar_p
        ret = dlllib.Font_ToString(self.Ptr)
        return ret
...
#        return ret
    ...
    def SystemFontName(self)->str:
        ...
        dlllib.Font_get_SystemFontName.restype=c_wchar_p
        ret = dlllib.Font_get_SystemFontName(self.Ptr)
        return ret
