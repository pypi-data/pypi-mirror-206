...
class AbstractDesignStateLoadCaseGroup(_5630.AbstractStaticLoadCaseGroup):
    """AbstractDesignStateLoadCaseGroup
    ...
    class _Cast_AbstractDesignStateLoadCaseGroup:
        ...
        def __init__(self, parent: 'AbstractDesignStateLoadCaseGroup'):
            self._parent = parent
        ...
        @property
        def abstract_design_state_load_case_group(self) -> 'AbstractDesignStateLoadCaseGroup':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AbstractDesignStateLoadCaseGroup._Cast_AbstractDesignStateLoadCaseGroup':
