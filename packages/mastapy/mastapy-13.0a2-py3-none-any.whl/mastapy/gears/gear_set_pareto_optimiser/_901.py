...
from mastapy.math_utility.optimisation import _1538, _1535, _1529
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    class _Cast_DesignSpaceSearchBase:
        ...
        def __init__(self, parent: 'DesignSpaceSearchBase'):
            self._parent = parent
        ...
        def gear_set_pareto_optimiser(self):
            ...
            return self._parent._cast(_907.GearSetParetoOptimiser)
        ...
        def micro_geometry_design_space_search(self):
            ...
            return self._parent._cast(_911.MicroGeometryDesignSpaceSearch)

        @property
        def micro_geometry_gear_set_design_space_search(self):
            from mastapy.gears.gear_set_pareto_optimiser import _914
            
            return self._parent._cast(_914.MicroGeometryGearSetDesignSpaceSearch)
        ...
        @property
        def design_space_search_base(self) -> 'DesignSpaceSearchBase':
            return self._parent
    ...
    @property
    def remove_candidates_with(self) -> '_910.LargerOrSmaller':
        ...
        value = conversion.pn_to_mp_enum(temp, _910.LargerOrSmaller)
        return constructor.new_from_mastapy_type(_910.LargerOrSmaller)(value) if value is not None else None

    @remove_candidates_with.setter
    def remove_candidates_with(self, value: '_910.LargerOrSmaller'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _910.LargerOrSmaller.type_())
    ...
    def load_case_duty_cycle(self) -> 'TAnalysis':
        ...
        return constructor.new_from_mastapy_type(TAnalysis)(temp) if temp is not None else None
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1538.ParetoOptimisationStrategy':
    ...
    @property
    def chart_details(self) -> 'List[_899.ChartInfoBase[TAnalysis, TCandidate]]':
    ...
    @property
    def filters(self) -> 'List[_1535.ParetoOptimisationFilter]':
    ...
    @property
    def input_setters(self) -> 'List[_1529.InputSetter[TAnalysis]]':
    ...
    @property
    def optimisation_targets(self) -> 'List[_917.OptimisationTarget[TAnalysis]]':
    ...
    @property
    def reasons_for_invalid_candidates(self) -> 'List[_932.ReasonsForInvalidDesigns]':
    ...
    @property
    def cast_to(self) -> 'DesignSpaceSearchBase._Cast_DesignSpaceSearchBase':
