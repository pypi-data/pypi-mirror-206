...
class ZerolBevelGearCompoundHarmonicAnalysis(_5862.BevelGearCompoundHarmonicAnalysis):
    """ZerolBevelGearCompoundHarmonicAnalysis
    ...
    class _Cast_ZerolBevelGearCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_compound_harmonic_analysis(self) -> 'ZerolBevelGearCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5808.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5808.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearCompoundHarmonicAnalysis._Cast_ZerolBevelGearCompoundHarmonicAnalysis':
