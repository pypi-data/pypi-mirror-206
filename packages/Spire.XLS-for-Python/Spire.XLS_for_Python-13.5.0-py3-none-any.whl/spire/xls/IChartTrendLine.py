...
class IChartTrendLine (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().IChartTrendLine_get_Chart3DOptions(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().IChartTrendLine_get_Shadow(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().IChartTrendLine_get_Border(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IChartTrendLine_get_Backward(self.Ptr)
        return ret

    @Backward.setter
    def Backward(self, value:float):
        GetDllLibXls().IChartTrendLine_set_Backward.argtypes=[c_void_p, c_double]
        GetDllLibXls().IChartTrendLine_set_Backward(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IChartTrendLine_get_Forward(self.Ptr)
        return ret

    @Forward.setter
    def Forward(self, value:float):
        GetDllLibXls().IChartTrendLine_set_Forward.argtypes=[c_void_p, c_double]
        GetDllLibXls().IChartTrendLine_set_Forward(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IChartTrendLine_get_DisplayEquation(self.Ptr)
        return ret
    ...
    def DisplayEquation(self, value:bool):
        ...
        GetDllLibXls().IChartTrendLine_set_DisplayEquation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IChartTrendLine_get_DisplayRSquared(self.Ptr)
        return ret
    ...
    def DisplayRSquared(self, value:bool):
        ...
        GetDllLibXls().IChartTrendLine_set_DisplayRSquared(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IChartTrendLine_get_Intercept(self.Ptr)
        return ret

    @Intercept.setter
    def Intercept(self, value:float):
        GetDllLibXls().IChartTrendLine_set_Intercept.argtypes=[c_void_p, c_double]
        GetDllLibXls().IChartTrendLine_set_Intercept(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IChartTrendLine_get_InterceptIsAuto(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().IChartTrendLine_get_Type(self.Ptr)
    ...
    def Type(self, value:'TrendLineType'):
        ...
        GetDllLibXls().IChartTrendLine_set_Type(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IChartTrendLine_get_Order(self.Ptr)
        return ret

    @Order.setter
    def Order(self, value:int):
        GetDllLibXls().IChartTrendLine_set_Order.argtypes=[c_void_p, c_int]
        GetDllLibXls().IChartTrendLine_set_Order(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IChartTrendLine_get_NameIsAuto(self.Ptr)
        return ret

    @NameIsAuto.setter
    def NameIsAuto(self, value:bool):
        GetDllLibXls().IChartTrendLine_set_NameIsAuto.argtypes=[c_void_p, c_bool]
        GetDllLibXls().IChartTrendLine_set_NameIsAuto(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().IChartTrendLine_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().IChartTrendLine_get_Name(self.Ptr)
        return ret
    ...
    def Name(self, value:str):
        ...
        GetDllLibXls().IChartTrendLine_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().IChartTrendLine_get_DataLabel(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().IChartTrendLine_get_Formula.restype=c_wchar_p
        ret = GetDllLibXls().IChartTrendLine_get_Formula(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().IChartTrendLine_ClearFormats(self.Ptr)
