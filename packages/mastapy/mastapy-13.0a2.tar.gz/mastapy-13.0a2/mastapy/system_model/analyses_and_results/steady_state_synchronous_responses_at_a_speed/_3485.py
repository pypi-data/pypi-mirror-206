...
class AbstractShaftSteadyStateSynchronousResponseAtASpeed(_3484.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed):
    """AbstractShaftSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_AbstractShaftSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'AbstractShaftSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def abstract_shaft_steady_state_synchronous_response_at_a_speed(self) -> 'AbstractShaftSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AbstractShaftSteadyStateSynchronousResponseAtASpeed._Cast_AbstractShaftSteadyStateSynchronousResponseAtASpeed':
