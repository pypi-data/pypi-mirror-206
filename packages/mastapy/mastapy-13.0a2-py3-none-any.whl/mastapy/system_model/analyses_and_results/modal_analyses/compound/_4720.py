...
class BoltCompoundModalAnalysis(_4726.ComponentCompoundModalAnalysis):
    """BoltCompoundModalAnalysis
    ...
    class _Cast_BoltCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'BoltCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def bolt_compound_modal_analysis(self) -> 'BoltCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4567.BoltModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4567.BoltModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BoltCompoundModalAnalysis._Cast_BoltCompoundModalAnalysis':
