...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4319, _4318, _4338
...
class CylindricalGearSetParametricStudyTool(_4338.GearSetParametricStudyTool):
    """CylindricalGearSetParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2721.CylindricalGearSetSystemDeflection]':
    ...
    @property
    def cylindrical_gears_parametric_study_tool(self) -> 'List[_4319.CylindricalGearParametricStudyTool]':
    ...
    @property
    def cylindrical_meshes_parametric_study_tool(self) -> 'List[_4318.CylindricalGearMeshParametricStudyTool]':
