...
class H2OGBMParams(HasMonotoneConstraints, HasCalibrationDataFrame, HasIgnoredCols, Params):
    ...
    calibrationMethod = Param(
        Params._dummy(),
        "calibrationMethod",
        """Calibration method to use""",
        H2OTypeConverters.toEnumString("hex.tree.CalibrationHelper$CalibrationMethod"))
    ...
    inTrainingCheckpointsDir = Param(
        Params._dummy(),
    ...
    inTrainingCheckpointsTreeInterval = Param(
        Params._dummy(),
    ...
    def getCalibrationMethod(self):
        return self.getOrDefault(self.calibrationMethod)

    def getCheckConstantResponse(self):
        return self.getOrDefault(self.checkConstantResponse)

    def getInTrainingCheckpointsDir(self):
        return self.getOrDefault(self.inTrainingCheckpointsDir)

    def getInTrainingCheckpointsTreeInterval(self):
        return self.getOrDefault(self.inTrainingCheckpointsTreeInterval)
    ...
    def setCalibrationMethod(self, value):
        return self._set(calibrationMethod=value)

    def setCheckConstantResponse(self, value):
        return self._set(checkConstantResponse=value)

    def setInTrainingCheckpointsDir(self, value):
        return self._set(inTrainingCheckpointsDir=value)

    def setInTrainingCheckpointsTreeInterval(self, value):
        return self._set(inTrainingCheckpointsTreeInterval=value)
