...
class BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness(_4971.BevelDifferentialGearCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def bevel_differential_sun_gear_compound_modal_analysis_at_a_stiffness(self) -> 'BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4845.BevelDifferentialSunGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4845.BevelDifferentialSunGearModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness._Cast_BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness':
        return self._Cast_BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness(self)
