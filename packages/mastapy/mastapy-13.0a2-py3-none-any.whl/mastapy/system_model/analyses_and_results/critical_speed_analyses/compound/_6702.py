...
class HypoidGearMeshCompoundCriticalSpeedAnalysis(_6644.AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis):
    """HypoidGearMeshCompoundCriticalSpeedAnalysis
    ...
    class _Cast_HypoidGearMeshCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'HypoidGearMeshCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_mesh_compound_critical_speed_analysis(self) -> 'HypoidGearMeshCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6573.HypoidGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6573.HypoidGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearMeshCompoundCriticalSpeedAnalysis._Cast_HypoidGearMeshCompoundCriticalSpeedAnalysis':
