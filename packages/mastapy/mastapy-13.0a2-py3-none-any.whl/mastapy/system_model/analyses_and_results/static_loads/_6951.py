...
from mastapy.system_model.analyses_and_results.static_loads import _6949, _6950, _6794
...
class ZerolBevelGearSetLoadCase(_6794.BevelGearSetLoadCase):
    """ZerolBevelGearSetLoadCase
    ...
    class _Cast_ZerolBevelGearSetLoadCase:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetLoadCase'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_load_case(self) -> 'ZerolBevelGearSetLoadCase':
            return self._parent
    ...
    @property
    def gears(self) -> 'List[_6949.ZerolBevelGearLoadCase]':
    ...
    @property
    def zerol_bevel_gears_load_case(self) -> 'List[_6949.ZerolBevelGearLoadCase]':
    ...
    @property
    def zerol_bevel_meshes_load_case(self) -> 'List[_6950.ZerolBevelGearMeshLoadCase]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetLoadCase._Cast_ZerolBevelGearSetLoadCase':
