...
class CouplingHalfCompoundAdvancedSystemDeflection(_7445.MountableComponentCompoundAdvancedSystemDeflection):
    """CouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7275.CouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7275.CouplingHalfAdvancedSystemDeflection]':
