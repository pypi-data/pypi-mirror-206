...
class ConicalGearMeshModalAnalysisAtASpeed(_5147.GearMeshModalAnalysisAtASpeed):
    """ConicalGearMeshModalAnalysisAtASpeed
    ...
    class _Cast_ConicalGearMeshModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ConicalGearMeshModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def conical_gear_mesh_modal_analysis_at_a_speed(self) -> 'ConicalGearMeshModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConicalGearMeshModalAnalysisAtASpeed._Cast_ConicalGearMeshModalAnalysisAtASpeed':
