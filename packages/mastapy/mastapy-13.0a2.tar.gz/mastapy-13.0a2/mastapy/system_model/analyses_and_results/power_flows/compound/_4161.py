...
class BoltCompoundPowerFlow(_4167.ComponentCompoundPowerFlow):
    """BoltCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4029.BoltPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4029.BoltPowerFlow]':
