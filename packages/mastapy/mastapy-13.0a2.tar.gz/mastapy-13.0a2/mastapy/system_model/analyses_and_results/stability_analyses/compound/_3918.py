...
class CycloidalDiscCentralBearingConnectionCompoundStabilityAnalysis(_3898.CoaxialConnectionCompoundStabilityAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3787.CycloidalDiscCentralBearingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3787.CycloidalDiscCentralBearingConnectionStabilityAnalysis]':
