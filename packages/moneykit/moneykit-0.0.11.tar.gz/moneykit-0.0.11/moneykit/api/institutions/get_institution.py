...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/institutions/{institution_id}".format(client.base_url, institution_id=institution_id)
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[APIErrorRateLimitExceededResponse, Institution, InstitutionErrorNotFoundResponse, Union['APIErrorAuthExpiredAccessTokenResponse', 'APIErrorAuthUnauthorizedResponse']]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[APIErrorRateLimitExceededResponse, Institution, InstitutionErrorNotFoundResponse, Union['APIErrorAuthExpiredAccessTokenResponse', 'APIErrorAuthUnauthorizedResponse']]
    """
