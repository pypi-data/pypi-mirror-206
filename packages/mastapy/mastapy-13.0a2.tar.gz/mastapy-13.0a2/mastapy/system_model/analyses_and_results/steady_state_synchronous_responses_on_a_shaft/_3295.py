...
class KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponseOnAShaft(_3292.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponseOnAShaft):
    """KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_steady_state_synchronous_response_on_a_shaft(self) -> 'KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponseOnAShaft._Cast_KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponseOnAShaft(self)
