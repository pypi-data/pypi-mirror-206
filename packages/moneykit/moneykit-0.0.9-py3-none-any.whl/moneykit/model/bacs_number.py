...
class BacsNumber(schemas.DictSchema):
    ...
    sort_code: MetaOapg.properties.sort_code
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sort_code"]) -> MetaOapg.properties.sort_code:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        sort_code: typing.Union[
            MetaOapg.properties.sort_code,
            str,
        ],
