...
class FaceGearMeshMultibodyDynamicsAnalysis(_5408.GearMeshMultibodyDynamicsAnalysis):
    """FaceGearMeshMultibodyDynamicsAnalysis
    ...
    class _Cast_FaceGearMeshMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'FaceGearMeshMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def face_gear_mesh_multibody_dynamics_analysis(self) -> 'FaceGearMeshMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearMeshMultibodyDynamicsAnalysis._Cast_FaceGearMeshMultibodyDynamicsAnalysis':
