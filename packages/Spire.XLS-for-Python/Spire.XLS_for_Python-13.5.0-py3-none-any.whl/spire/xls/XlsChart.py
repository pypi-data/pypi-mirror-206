...
class XlsChart (  XlsWorksheetBase, ICloneParent, IChart) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartPyramid(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartRadar(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartScatter(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartSmoothedLine(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartStock(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartVeryColor(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartVolume(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartWalls(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsClustered(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsEmbeded(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsPerspective(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsPivot3DChart(self.Ptr)
        return ret
    ...
    def IsSecondaryAxes(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_IsSecondaryAxes(self.Ptr)
        return ret
    ...
    def IsSecondaryAxes(self, value:bool):
        ...
        GetDllLibXls().XlsChart_set_IsSecondaryAxes(self.Ptr, value)
    ...
    def IsSecondaryCategoryAxisAvail(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_IsSecondaryCategoryAxisAvail(self.Ptr)
        return ret
    ...
    def IsSecondaryValueAxisAvail(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_IsSecondaryValueAxisAvail(self.Ptr)
        return ret
    ...
    def IsSeriesAxisAvail(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_IsSeriesAxisAvail(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsSeriesLines(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsSpecialDataLabels(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsStacked(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsValueAxisAvail(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_NeedDataFormat(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_NeedDropBar(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_NeedMarkerFormat(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_NoPlotArea(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_Style(self.Ptr)
        return ret

    @Style.setter
    def Style(self, value:int):
        GetDllLibXls().XlsChart_set_Style.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChart_set_Style(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_SupportWallsAndFloor(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_ZoomToFit(self.Ptr)
        return ret

    @ZoomToFit.setter
    def ZoomToFit(self, value:bool):
        GetDllLibXls().XlsChart_set_ZoomToFit.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChart_set_ZoomToFit(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChart_get_SecondaryCategoryAxisTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsChart_get_SecondaryCategoryAxisTitle(self.Ptr)
        return ret
    ...
    def SecondaryCategoryAxisTitle(self, value:str):
        ...
        GetDllLibXls().XlsChart_set_SecondaryCategoryAxisTitle(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChart_get_SecondaryValueAxisTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsChart_get_SecondaryValueAxisTitle(self.Ptr)
        return ret
    ...
    def SecondaryValueAxisTitle(self, value:str):
        ...
        GetDllLibXls().XlsChart_set_SecondaryValueAxisTitle(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChart_get_SeriesAxisTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsChart_get_SeriesAxisTitle(self.Ptr)
        return ret
    ...
    def SeriesAxisTitle(self, value:str):
        ...
        GetDllLibXls().XlsChart_set_SeriesAxisTitle(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChart_get_ValueAxisTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsChart_get_ValueAxisTitle(self.Ptr)
        return ret
    ...
    def ValueAxisTitle(self, value:str):
        ...
        GetDllLibXls().XlsChart_set_ValueAxisTitle(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_HasChartArea(self.Ptr)
        return ret

    @HasChartArea.setter
    def HasChartArea(self, value:bool):
        GetDllLibXls().XlsChart_set_HasChartArea.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChart_set_HasChartArea(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_HasChartTitle(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_HasFloor(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_HasWalls(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_HasPivotTable(self.Ptr)
        return ret
    ...
    def CheckDataTablePossibility(startType:str,bThrowException:bool)->bool:
        ...
        ret = GetDllLibXls().XlsChart_CheckDataTablePossibility( startType,bThrowException)
        return ret
    ...
    def CheckForSupportGridLine(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_CheckForSupportGridLine(self.Ptr)
        return ret
...
#        intPtr = GetDllLibXls().XlsChart_Clone(self.Ptr, intPtrhashNewNames,intPtrparent,intPtrdicFontIndexes)
...
#
    ...
    <returns>Returns clone of current object.</returns>
        ...
        intPtr = GetDllLibXls().XlsChart_CloneP(self.Ptr, intPtrparent)
    ...
    def SetToDefaultGridlines(self ,type:'ExcelChartType'):
        ...
        GetDllLibXls().XlsChart_SetToDefaultGridlines(self.Ptr, enumtype)
    ...
    def ChartType(self)->'ExcelChartType':
        ...
        ret = GetDllLibXls().XlsChart_get_ChartType(self.Ptr)
    ...
    def ChartType(self, value:'ExcelChartType'):
        ...
        GetDllLibXls().XlsChart_set_ChartType(self.Ptr, value.value)
    ...
    def DataRange(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsChart_get_DataRange(self.Ptr)
    ...
    def DataRange(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsChart_set_DataRange(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_SeriesDataFromRange(self.Ptr)
        return ret
    ...
    def SeriesDataFromRange(self, value:bool):
        ...
        GetDllLibXls().XlsChart_set_SeriesDataFromRange(self.Ptr, value)
    ...
    def PageSetup(self)->'IChartPageSetup':
        ...
        intPtr = GetDllLibXls().XlsChart_get_PageSetup(self.Ptr)
    ...
    def XPos(self)->float:
        ...
        ret = GetDllLibXls().XlsChart_get_XPos(self.Ptr)
        return ret

    @XPos.setter
    def XPos(self, value:float):
        GetDllLibXls().XlsChart_set_XPos.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChart_set_XPos(self.Ptr, value)
    ...
    def YPos(self)->float:
        ...
        ret = GetDllLibXls().XlsChart_get_YPos(self.Ptr)
        return ret

    @YPos.setter
    def YPos(self, value:float):
        GetDllLibXls().XlsChart_set_YPos.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChart_set_YPos(self.Ptr, value)
    ...
    def Width(self)->float:
        ...
        ret = GetDllLibXls().XlsChart_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibXls().XlsChart_set_Width.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChart_set_Width(self.Ptr, value)
    ...
    def Height(self)->float:
        ...
        ret = GetDllLibXls().XlsChart_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibXls().XlsChart_set_Height.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChart_set_Height(self.Ptr, value)
    ...
    def PrimaryCategoryAxis(self)->'IChartCategoryAxis':
        ...
        intPtr = GetDllLibXls().XlsChart_get_PrimaryCategoryAxis(self.Ptr)
    ...
    def PrimaryValueAxis(self)->'IChartValueAxis':
        ...
        intPtr = GetDllLibXls().XlsChart_get_PrimaryValueAxis(self.Ptr)
    ...
    def PrimarySerieAxis(self)->'IChartSeriesAxis':
        ...
        intPtr = GetDllLibXls().XlsChart_get_PrimarySerieAxis(self.Ptr)
    ...
    def SecondaryCategoryAxis(self)->'IChartCategoryAxis':
        ...
        intPtr = GetDllLibXls().XlsChart_get_SecondaryCategoryAxis(self.Ptr)
        ret = None if intPtr==None else IChartCategoryAxis(intPtr)
        return ret
    ...
    def SecondaryValueAxis(self)->'IChartValueAxis':
        ...
        intPtr = GetDllLibXls().XlsChart_get_SecondaryValueAxis(self.Ptr)
        ret = None if intPtr==None else IChartValueAxis(intPtr)
        return ret
    ...
    def ChartArea(self)->'IChartFrameFormat':
        ...
        intPtr = GetDllLibXls().XlsChart_get_ChartArea(self.Ptr)
    ...
    def PlotArea(self)->'IChartFrameFormat':
        ...
        intPtr = GetDllLibXls().XlsChart_get_PlotArea(self.Ptr)
        ret = None if intPtr==None else XlsChartFrameFormat(intPtr)
        return ret
    ...
    def Walls(self)->'IChartWallOrFloor':
        ...
        intPtr = GetDllLibXls().XlsChart_get_Walls(self.Ptr)
    ...
    def Floor(self)->'IChartWallOrFloor':
        ...
        intPtr = GetDllLibXls().XlsChart_get_Floor(self.Ptr)
        ret = None if intPtr==None else IChartWallOrFloor(intPtr)
        return ret
    ...
    def DataTable(self)->'IChartDataTable':
        ...
        intPtr = GetDllLibXls().XlsChart_get_DataTable(self.Ptr)
    ...
    def HasDataTable(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_HasDataTable(self.Ptr)
        return ret

    @HasDataTable.setter
    def HasDataTable(self, value:bool):
        GetDllLibXls().XlsChart_set_HasDataTable.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChart_set_HasDataTable(self.Ptr, value)
    ...
    def Legend(self)->'IChartLegend':
        ...
        intPtr = GetDllLibXls().XlsChart_get_Legend(self.Ptr)
    ...
    def HasLegend(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_HasLegend(self.Ptr)
        return ret

    @HasLegend.setter
    def HasLegend(self, value:bool):
        GetDllLibXls().XlsChart_set_HasLegend.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChart_set_HasLegend(self.Ptr, value)
    ...
    def Rotation(self)->int:
        ...
        ret = GetDllLibXls().XlsChart_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:int):
        GetDllLibXls().XlsChart_set_Rotation.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChart_set_Rotation(self.Ptr, value)
    ...
    def Elevation(self)->int:
        ...
        ret = GetDllLibXls().XlsChart_get_Elevation(self.Ptr)
        return ret

    @Elevation.setter
    def Elevation(self, value:int):
        GetDllLibXls().XlsChart_set_Elevation.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChart_set_Elevation(self.Ptr, value)
    ...
    def Perspective(self)->int:
        ...
        ret = GetDllLibXls().XlsChart_get_Perspective(self.Ptr)
        return ret

    @Perspective.setter
    def Perspective(self, value:int):
        GetDllLibXls().XlsChart_set_Perspective.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChart_set_Perspective(self.Ptr, value)
    ...
    def DepthPercent(self)->int:
        ...
        ret = GetDllLibXls().XlsChart_get_DepthPercent(self.Ptr)
        return ret

    @DepthPercent.setter
    def DepthPercent(self, value:int):
        GetDllLibXls().XlsChart_set_DepthPercent.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChart_set_DepthPercent(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_DestinationType(self.Ptr)
        objwraped = ExcelChartType(ret)
        return objwraped
    ...
    def DestinationType(self, value:'ExcelChartType'):
        ...
        GetDllLibXls().XlsChart_set_DestinationType(self.Ptr, value.value)
    ...
    def GapDepth(self)->int:
        ...
        ret = GetDllLibXls().XlsChart_get_GapDepth(self.Ptr)
        return ret

    @GapDepth.setter
    def GapDepth(self, value:int):
        GetDllLibXls().XlsChart_set_GapDepth.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChart_set_GapDepth(self.Ptr, value)
    ...
    def AutoScaling(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_AutoScaling(self.Ptr)
        return ret

    @AutoScaling.setter
    def AutoScaling(self, value:bool):
        GetDllLibXls().XlsChart_set_AutoScaling.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChart_set_AutoScaling(self.Ptr, value)
    ...
    def WallsAndGridlines2D(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_WallsAndGridlines2D(self.Ptr)
        return ret
    ...
    def WallsAndGridlines2D(self, value:bool):
        ...
        GetDllLibXls().XlsChart_set_WallsAndGridlines2D(self.Ptr, value)
    ...
    def HasPlotArea(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_HasPlotArea(self.Ptr)
        return ret

    @HasPlotArea.setter
    def HasPlotArea(self, value:bool):
        GetDllLibXls().XlsChart_set_HasPlotArea.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChart_set_HasPlotArea(self.Ptr, value)
    ...
    def DisplayBlanksAs(self)->'ChartPlotEmptyType':
        ...
        ret = GetDllLibXls().XlsChart_get_DisplayBlanksAs(self.Ptr)
    ...
    def DisplayBlanksAs(self, value:'ChartPlotEmptyType'):
        ...
        GetDllLibXls().XlsChart_set_DisplayBlanksAs(self.Ptr, value.value)
    ...
    def PlotVisibleOnly(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_PlotVisibleOnly(self.Ptr)
        return ret
    ...
    def PlotVisibleOnly(self, value:bool):
        ...
        GetDllLibXls().XlsChart_set_PlotVisibleOnly(self.Ptr, value)
    ...
    def PivotTable(self)->'PivotTable':
        ...
        intPtr = GetDllLibXls().XlsChart_get_PivotTable(self.Ptr)
    ...
    def PivotTable(self, value:'PivotTable'):
        ...
        GetDllLibXls().XlsChart_set_PivotTable(self.Ptr, value.Ptr)
    ...
    def PivotChartType(self)->'ExcelChartType':
        ...
        ret = GetDllLibXls().XlsChart_get_PivotChartType(self.Ptr)
        objwraped = ExcelChartType(ret)
        return objwraped
    ...
    def PivotChartType(self, value:'ExcelChartType'):
        ...
        GetDllLibXls().XlsChart_set_PivotChartType(self.Ptr, value.value)
    ...
    def DisplayEntireFieldButtons(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_DisplayEntireFieldButtons(self.Ptr)
        return ret
    ...
    def DisplayEntireFieldButtons(self, value:bool):
        ...
        GetDllLibXls().XlsChart_set_DisplayEntireFieldButtons(self.Ptr, value)
    ...
    def DisplayValueFieldButtons(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_DisplayValueFieldButtons(self.Ptr)
        return ret
    ...
    def DisplayValueFieldButtons(self, value:bool):
        ...
        GetDllLibXls().XlsChart_set_DisplayValueFieldButtons(self.Ptr, value)
    ...
    def DisplayAxisFieldButtons(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_DisplayAxisFieldButtons(self.Ptr)
        return ret
    ...
    def DisplayAxisFieldButtons(self, value:bool):
        ...
        GetDllLibXls().XlsChart_set_DisplayAxisFieldButtons(self.Ptr, value)
    ...
    def DisplayLegendFieldButtons(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_DisplayLegendFieldButtons(self.Ptr)
        return ret
    ...
    def DisplayLegendFieldButtons(self, value:bool):
        ...
        GetDllLibXls().XlsChart_set_DisplayLegendFieldButtons(self.Ptr, value)
    ...
    def ShowReportFilterFieldButtons(self)->bool:
        ...
        ret = GetDllLibXls().XlsChart_get_ShowReportFilterFieldButtons(self.Ptr)
        return ret
    ...
    def ShowReportFilterFieldButtons(self, value:bool):
        ...
        GetDllLibXls().XlsChart_set_ShowReportFilterFieldButtons(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_CanChartBubbleLabel(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_CanChartHaveSeriesLines(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_CanChartPercentageLabel(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsChart_get_CategoryAxisTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsChart_get_CategoryAxisTitle(self.Ptr)
        return ret
    ...
    def CategoryAxisTitle(self, value:str):
        ...
        GetDllLibXls().XlsChart_set_CategoryAxisTitle(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChart_get_ChartStartType.restype=c_wchar_p
        ret = GetDllLibXls().XlsChart_get_ChartStartType(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsChart_get_ChartTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsChart_get_ChartTitle(self.Ptr)
        return ret
    ...
    def ChartTitle(self, value:str):
        ...
        GetDllLibXls().XlsChart_set_ChartTitle(self.Ptr, value)
    ...
    def ChartTitleFont(self)->'IFont':
        ...
        intPtr = GetDllLibXls().XlsChart_get_ChartTitleFont(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_DefaultLinePattern(self.Ptr)
    ...
    def DefaultTextIndex(self)->int:
        ...
        ret = GetDllLibXls().XlsChart_get_DefaultTextIndex(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChart_get_Font(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsCategoryAxisAvail(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChart_100(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChart3D(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartBar(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartBubble(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartCone(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartCylinder(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartDoughnut(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartExploded(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartFloor(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartLine(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChart_get_IsChartPie(self.Ptr)
        return ret
    ...
    def DEF_SUPPORT_SERIES_AXIS()->List['ExcelChartType']:
        ...
        intPtrArray = GetDllLibXls().XlsChart_DEF_SUPPORT_SERIES_AXIS()
    ...
    def DEF_SUPPORT_ERROR_BARS()->List[str]:
        ...
        intPtrArray = GetDllLibXls().XlsChart_DEF_SUPPORT_ERROR_BARS()
    ...
    def DEF_SUPPORT_TREND_LINES()->List['ExcelChartType']:
        ...
        intPtrArray = GetDllLibXls().XlsChart_DEF_SUPPORT_TREND_LINES()
        ret = GetVectorFromArray(intPtrArray, ExcelChartType)
        return ret
