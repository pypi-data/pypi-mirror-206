...
from mastapy.system_model.analyses_and_results.system_deflections import _2694, _2764
...
class AbstractAssemblySystemDeflection(_2764.PartSystemDeflection):
    """AbstractAssemblySystemDeflection
    ...
    class _Cast_AbstractAssemblySystemDeflection:
        ...
        def __init__(self, parent: 'AbstractAssemblySystemDeflection'):
            self._parent = parent
        ...
        @property
        def abstract_assembly_system_deflection(self) -> 'AbstractAssemblySystemDeflection':
            return self._parent
    ...
    @property
    def components_with_unknown_mass_properties(self) -> 'List[_2694.ComponentSystemDeflection]':
    ...
    @property
    def components_with_zero_mass_properties(self) -> 'List[_2694.ComponentSystemDeflection]':
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_2827.RigidlyConnectedComponentGroupSystemDeflection]':
    ...
    @property
    def power_flow_results(self) -> '_4009.AbstractAssemblyPowerFlow':
    ...
    @property
    def cast_to(self) -> 'AbstractAssemblySystemDeflection._Cast_AbstractAssemblySystemDeflection':
