...
class RangesCollection (  XlsRangesCollection) :
    ...
    <param name="range">Range to add.</param>
        ...
        GetDllLibXls().RangesCollection_Add(self.Ptr, intPtrrange)
    ...
    <returns>Added comment.</returns>
        ...
        intPtr = GetDllLibXls().RangesCollection_AddComment(self.Ptr)
    ...
    <param name="range">Range to add.</param>
        ...
        GetDllLibXls().RangesCollection_AddRange(self.Ptr, intPtrrange)
    ...
    <returns>Destination range</returns>
        ...
        intPtr = GetDllLibXls().RangesCollection_Copy(self.Ptr, intPtrdestRange)
    ...
    <param name="updateReference">Indicates whether to update reference cells.</param>
        ...
        intPtr = GetDllLibXls().RangesCollection_CopyDU(self.Ptr, intPtrdestRange,updateReference)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Destination range</returns>
        ...
        intPtr = GetDllLibXls().RangesCollection_CopyDUC(self.Ptr, intPtrdestRange,updateReference,copyStyles)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
...
#        intPtr = GetDllLibXls().RangesCollection_FindAllNumber(self.Ptr, doubleValue,formulaValue)
...
#        intPtr = GetDllLibXls().RangesCollection_FindAllString(self.Ptr, stringValue,formula,formulaValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().RangesCollection_FindAllDateTime(self.Ptr, intPtrdateTimeValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().RangesCollection_FindAllTimeSpan(self.Ptr, intPtrtimeSpanValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().RangesCollection_FindAllBool(self.Ptr, boolValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
    ...
    <returns>Found range</returns>
        ...
        intPtr = GetDllLibXls().RangesCollection_FindBool(self.Ptr, boolValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range</returns>
        ...
        intPtr = GetDllLibXls().RangesCollection_FindNumber(self.Ptr, doubleValue,formulaValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range</returns>
        ...
        intPtr = GetDllLibXls().RangesCollection_FindString(self.Ptr, stringValue,formula,formulaValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range</returns>
        ...
        intPtr = GetDllLibXls().RangesCollection_FindDateTime(self.Ptr, intPtrdateTimeValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range.</returns>
        ...
        intPtr = GetDllLibXls().RangesCollection_FindTimeSpan(self.Ptr, intPtrtimeSpanValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Range intersection.</returns>
        ...
        intPtr = GetDllLibXls().RangesCollection_Intersect(self.Ptr, intPtrrange)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <param name="destination">Destnation Range.</param>
        ...
        GetDllLibXls().RangesCollection_Move(self.Ptr, intPtrdestRange)
    ...
    <param name="updateReference">Indicates whether to update reference range.</param>
        ...
        GetDllLibXls().RangesCollection_MoveDU(self.Ptr, intPtrdestRange,updateReference)
    ...
    <param name="range">Range to remove.</param>
        ...
        GetDllLibXls().RangesCollection_Remove(self.Ptr, intPtrrange)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().RangesCollection_get_EntireRow(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().RangesCollection_get_EntireColumn(self.Ptr)
        ret = None if intPtr==None else RangesCollection(intPtr)
        return ret
...
#        intPtr = GetDllLibXls().RangesCollection_get_Cells(self.Ptr)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().RangesCollection_get_Rows(self.Ptr)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().RangesCollection_get_Columns(self.Ptr)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().RangesCollection_get_Comment(self.Ptr)
        ret = None if intPtr==None else ExcelComment(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().RangesCollection_get_EndCell(self.Ptr)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().RangesCollection_get_Borders(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().RangesCollection_get_MergeArea(self.Ptr)
        ret = None if intPtr==None else RangesCollection(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().RangesCollection_get_RichText(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().RangesCollection_get_Style(self.Ptr)
    ...
    def Style(self, value:'CellStyle'):
        ...
        GetDllLibXls().RangesCollection_set_Style(self.Ptr, value.Ptr)
    ...
    def Worksheet(self)->'Worksheet':
        ...
        intPtr = GetDllLibXls().RangesCollection_get_Worksheet(self.Ptr)
