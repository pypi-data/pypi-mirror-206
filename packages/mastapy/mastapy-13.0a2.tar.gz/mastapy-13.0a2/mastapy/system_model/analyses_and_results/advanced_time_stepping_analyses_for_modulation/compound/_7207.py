...
class SpringDamperHalfCompoundAdvancedTimeSteppingAnalysisForModulation(_7142.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperHalfCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_SpringDamperHalfCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'SpringDamperHalfCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def spring_damper_half_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'SpringDamperHalfCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7078.SpringDamperHalfAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7078.SpringDamperHalfAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperHalfCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_SpringDamperHalfCompoundAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_SpringDamperHalfCompoundAdvancedTimeSteppingAnalysisForModulation(self)
