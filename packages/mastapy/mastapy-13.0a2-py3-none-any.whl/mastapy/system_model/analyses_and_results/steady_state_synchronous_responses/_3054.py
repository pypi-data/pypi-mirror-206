...
class RollingRingAssemblySteadyStateSynchronousResponse(_3061.SpecialisedAssemblySteadyStateSynchronousResponse):
    """RollingRingAssemblySteadyStateSynchronousResponse
    ...
    class _Cast_RollingRingAssemblySteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'RollingRingAssemblySteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def rolling_ring_assembly_steady_state_synchronous_response(self) -> 'RollingRingAssemblySteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingAssemblySteadyStateSynchronousResponse._Cast_RollingRingAssemblySteadyStateSynchronousResponse':
