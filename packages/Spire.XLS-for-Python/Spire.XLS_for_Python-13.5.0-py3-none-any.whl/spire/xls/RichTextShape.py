...
class RichTextShape (  SpireObject, IRichTextString) :
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().RichTextShape_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().RichTextShape_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().RichTextShape_set_Text(self.Ptr, value)
    ...
    def RtfText(self)->str:
        ...
        GetDllLibXls().RichTextShape_get_RtfText.restype=c_wchar_p
        ret = GetDllLibXls().RichTextShape_get_RtfText(self.Ptr)
        return ret
    ...
    def IsFormatted(self)->bool:
        ...
        ret = GetDllLibXls().RichTextShape_get_IsFormatted(self.Ptr)
        return ret
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().RichTextShape_get_Parent(self.Ptr)
    ...
    def GetFont(self ,index:int)->'IFont':
        ...
        intPtr = GetDllLibXls().RichTextShape_GetFont(self.Ptr, index)
    ...
    def SetFont(self ,startIndex:int,endIndex:int,font:'IFont'):
        ...
        GetDllLibXls().RichTextShape_SetFont(self.Ptr, startIndex,endIndex,intPtrfont)
    ...
    def ClearFormatting(self):
        ...
        GetDllLibXls().RichTextShape_ClearFormatting(self.Ptr)
    ...
    def Clear(self):
        ...
        GetDllLibXls().RichTextShape_Clear(self.Ptr)
    ...
    def Append(self ,text:str,font:'IFont'):
        ...
        GetDllLibXls().RichTextShape_Append(self.Ptr, text,intPtrfont)
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().RichTextShape_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().RichTextShape_EndUpdate(self.Ptr)
    ...
    def DefaultFont(self)->'XlsFont':
        ...
        intPtr = GetDllLibXls().RichTextShape_get_DefaultFont(self.Ptr)
        ret = None if intPtr==None else XlsFont(intPtr)
        return ret
    ...
    def FormattingRunsCount(self)->int:
        ...
        ret = GetDllLibXls().RichTextShape_get_FormattingRunsCount(self.Ptr)
        return ret
    ...
    def GetSpace(self ,FormattingRunsIndex:int)->int:
        ...
        ret = GetDllLibXls().RichTextShape_GetSpace(self.Ptr, FormattingRunsIndex)
        return ret
    ...
    def SetSpace(self ,FormattingRunsIndex:int,SpaceValue:int):
        ...
        GetDllLibXls().RichTextShape_SetSpace(self.Ptr, FormattingRunsIndex,SpaceValue)
