...
class PlanetCarrierCompoundStabilityAnalysis(_3951.MountableComponentCompoundStabilityAnalysis):
    """PlanetCarrierCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3828.PlanetCarrierStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3828.PlanetCarrierStabilityAnalysis]':
