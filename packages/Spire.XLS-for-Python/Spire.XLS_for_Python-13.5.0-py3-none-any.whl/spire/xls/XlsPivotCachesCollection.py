...
class XlsPivotCachesCollection (  CollectionBase[XlsPivotCache], IPivotCaches) :
    ...
    def Parent(self)->'XlsWorkbook':
        ...
        intPtr = GetDllLibXls().XlsPivotCachesCollection_get_Parent(self.Ptr)
    ...
    def Workbook(self)->'XlsWorkbook':
        ...
        intPtr = GetDllLibXls().XlsPivotCachesCollection_get_Workbook(self.Ptr)
        ret = None if intPtr==None else XlsWorkbook(intPtr)
        return ret
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().XlsPivotCachesCollection_get_Count(self.Ptr)
        return ret
    ...
    def Add(self ,range:XlsRange)->XlsPivotCache:
        ...
        intPtr = GetDllLibXls().XlsPivotCachesCollection_Add(self.Ptr, intPtrrange)
    ...
    def Add(self ,cache:XlsPivotCache):
        ...
        GetDllLibXls().XlsPivotCachesCollection_AddC(self.Ptr, intPtrcache)
    ...
    <summary>
        ...
        GetDllLibXls().XlsPivotCachesCollection_Clear(self.Ptr)
    ...
    def RemoveAt(self ,index:int):
        ...
        GetDllLibXls().XlsPivotCachesCollection_RemoveAt(self.Ptr, index)
    ...
    def Remove(self ,pivotCache:'IPivotCache'):
        ...
        GetDllLibXls().XlsPivotCachesCollection_Remove(self.Ptr, intPtrpivotCache)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsPivotCachesCollection_Clone(self.Ptr, intPtrparent)
