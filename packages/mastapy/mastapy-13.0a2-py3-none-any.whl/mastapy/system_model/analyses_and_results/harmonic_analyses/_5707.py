...
class ElectricMachineRotorZForcePeriodicExcitationDetail(_5702.ElectricMachinePeriodicExcitationDetail):
    """ElectricMachineRotorZForcePeriodicExcitationDetail
    ...
    class _Cast_ElectricMachineRotorZForcePeriodicExcitationDetail:
        ...
        def __init__(self, parent: 'ElectricMachineRotorZForcePeriodicExcitationDetail'):
            self._parent = parent
        ...
        @property
        def electric_machine_rotor_z_force_periodic_excitation_detail(self) -> 'ElectricMachineRotorZForcePeriodicExcitationDetail':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ElectricMachineRotorZForcePeriodicExcitationDetail._Cast_ElectricMachineRotorZForcePeriodicExcitationDetail':
