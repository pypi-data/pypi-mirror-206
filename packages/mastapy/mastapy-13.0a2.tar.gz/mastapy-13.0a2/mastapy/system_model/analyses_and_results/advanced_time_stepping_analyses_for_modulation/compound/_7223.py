...
class TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation(_7142.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7094.TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7094.TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation(self)
