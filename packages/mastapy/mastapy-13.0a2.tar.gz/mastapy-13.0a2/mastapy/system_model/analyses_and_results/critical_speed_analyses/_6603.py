...
class RollingRingCriticalSpeedAnalysis(_6547.CouplingHalfCriticalSpeedAnalysis):
    """RollingRingCriticalSpeedAnalysis
    ...
    class _Cast_RollingRingCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'RollingRingCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def rolling_ring_critical_speed_analysis(self) -> 'RollingRingCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingCriticalSpeedAnalysis._Cast_RollingRingCriticalSpeedAnalysis':
