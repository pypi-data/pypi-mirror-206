...
class PivotStyle (SpireObject) :
    ...
    def Parent(self)->'PivotTableStyle':
        ...
        intPtr = GetDllLibXls().PivotStyle_get_Parent(self.Ptr)
...
<summary></summary>
        ...
        intPtr = GetDllLibXls().PivotStyle_get_Font(self.Ptr)
    ...
    def Font(self, value:'ExcelFont'):
        ...
        GetDllLibXls().PivotStyle_set_Font(self.Ptr, value.Ptr)
...
<summary></summary>
        ...
        intPtr = GetDllLibXls().PivotStyle_get_Borders(self.Ptr)
    ...
    def Borders(self, value:'XlsBordersCollection'):
        ...
        GetDllLibXls().PivotStyle_set_Borders(self.Ptr, value.Ptr)
...
<summary></summary>
        ...
        intPtr = GetDllLibXls().PivotStyle_get_Fill(self.Ptr)
    ...
    def Fill(self, value:'XlsFill'):
        ...
        GetDllLibXls().PivotStyle_set_Fill(self.Ptr, value.Ptr)
