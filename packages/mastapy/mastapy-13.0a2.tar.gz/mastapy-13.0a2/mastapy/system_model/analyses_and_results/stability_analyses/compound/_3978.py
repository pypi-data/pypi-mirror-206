...
class SpringDamperHalfCompoundStabilityAnalysis(_3913.CouplingHalfCompoundStabilityAnalysis):
    """SpringDamperHalfCompoundStabilityAnalysis
    ...
    class _Cast_SpringDamperHalfCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'SpringDamperHalfCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def spring_damper_half_compound_stability_analysis(self) -> 'SpringDamperHalfCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3846.SpringDamperHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3846.SpringDamperHalfStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperHalfCompoundStabilityAnalysis._Cast_SpringDamperHalfCompoundStabilityAnalysis':
