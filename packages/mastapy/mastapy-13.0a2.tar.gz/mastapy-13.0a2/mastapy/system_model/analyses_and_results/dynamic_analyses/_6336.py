...
class RollingRingConnectionDynamicAnalysis(_6309.InterMountableComponentConnectionDynamicAnalysis):
    """RollingRingConnectionDynamicAnalysis
    ...
    class _Cast_RollingRingConnectionDynamicAnalysis:
        ...
        def __init__(self, parent: 'RollingRingConnectionDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def rolling_ring_connection_dynamic_analysis(self) -> 'RollingRingConnectionDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingConnectionDynamicAnalysis._Cast_RollingRingConnectionDynamicAnalysis':
