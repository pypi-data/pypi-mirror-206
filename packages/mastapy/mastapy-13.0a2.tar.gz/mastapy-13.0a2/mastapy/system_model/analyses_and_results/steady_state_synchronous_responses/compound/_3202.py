...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3200, _3201, _3113
...
class StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse(_3113.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3072.StraightBevelDiffGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_gears_compound_steady_state_synchronous_response(self) -> 'List[_3200.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3201.StraightBevelDiffGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3072.StraightBevelDiffGearSetSteadyStateSynchronousResponse]':
