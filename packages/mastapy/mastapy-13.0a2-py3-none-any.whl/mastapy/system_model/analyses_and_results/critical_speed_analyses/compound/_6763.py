...
class WormGearMeshCompoundCriticalSpeedAnalysis(_6698.GearMeshCompoundCriticalSpeedAnalysis):
    """WormGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6634.WormGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6634.WormGearMeshCriticalSpeedAnalysis]':
