...
class ShaftProfilePoint(_0.APIBase):
    ...
    class _Cast_ShaftProfilePoint:
        ...
        def __init__(self, parent: 'ShaftProfilePoint'):
            self._parent = parent

        @property
        def shaft_profile_point_copy(self):
            from mastapy.shafts import _32
            
            return self._parent._cast(_32.ShaftProfilePointCopy)

        @property
        def shaft_profile_point(self) -> 'ShaftProfilePoint':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftProfilePoint._Cast_ShaftProfilePoint':
