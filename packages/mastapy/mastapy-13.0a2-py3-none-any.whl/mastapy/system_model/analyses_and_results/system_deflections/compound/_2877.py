...
class CylindricalGearCompoundSystemDeflection(_2889.GearCompoundSystemDeflection):
    """CylindricalGearCompoundSystemDeflection
    ...
    class _Cast_CylindricalGearCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'CylindricalGearCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_compound_system_deflection(self) -> 'CylindricalGearCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def duty_cycle_rating(self) -> '_451.CylindricalGearDutyCycleRating':
    ...
    @property
    def cylindrical_duty_cycle_rating(self) -> '_451.CylindricalGearDutyCycleRating':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2726.CylindricalGearSystemDeflectionWithLTCAResults]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2726.CylindricalGearSystemDeflectionWithLTCAResults]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearCompoundSystemDeflection._Cast_CylindricalGearCompoundSystemDeflection':
