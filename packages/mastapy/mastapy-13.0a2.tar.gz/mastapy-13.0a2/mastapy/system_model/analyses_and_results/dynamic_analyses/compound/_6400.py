...
class ConceptCouplingConnectionCompoundDynamicAnalysis(_6411.CouplingConnectionCompoundDynamicAnalysis):
    """ConceptCouplingConnectionCompoundDynamicAnalysis
    ...
    class _Cast_ConceptCouplingConnectionCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_compound_dynamic_analysis(self) -> 'ConceptCouplingConnectionCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6269.ConceptCouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6269.ConceptCouplingConnectionDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionCompoundDynamicAnalysis._Cast_ConceptCouplingConnectionCompoundDynamicAnalysis':
