...
class RingPinsStabilityAnalysis(_3820.MountableComponentStabilityAnalysis):
    """RingPinsStabilityAnalysis
    ...
    class _Cast_RingPinsStabilityAnalysis:
        ...
        def __init__(self, parent: 'RingPinsStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def ring_pins_stability_analysis(self) -> 'RingPinsStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RingPinsStabilityAnalysis._Cast_RingPinsStabilityAnalysis':
