...
class MastaPropertyAttribute:
    ...
    @property
    def measurement(self) -> '_7522.MeasurementType':
        ...
        value = conversion.pn_to_mp_enum(temp, _7522.MeasurementType)
        return constructor.new_from_mastapy_type(_7522.MeasurementType)(value) if value is not None else None
