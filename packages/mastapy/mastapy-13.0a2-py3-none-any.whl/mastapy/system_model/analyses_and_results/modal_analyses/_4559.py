...
class BevelDifferentialGearModalAnalysis(_4564.BevelGearModalAnalysis):
    """BevelDifferentialGearModalAnalysis
    ...
    class _Cast_BevelDifferentialGearModalAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialGearModalAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_modal_analysis(self) -> 'BevelDifferentialGearModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearModalAnalysis._Cast_BevelDifferentialGearModalAnalysis':
