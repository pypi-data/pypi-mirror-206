...
class MassDiscCompoundDynamicAnalysis(_6495.VirtualComponentCompoundDynamicAnalysis):
    """MassDiscCompoundDynamicAnalysis
    ...
    class _Cast_MassDiscCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'MassDiscCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def mass_disc_compound_dynamic_analysis(self) -> 'MassDiscCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6319.MassDiscDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6319.MassDiscDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'MassDiscCompoundDynamicAnalysis._Cast_MassDiscCompoundDynamicAnalysis':
