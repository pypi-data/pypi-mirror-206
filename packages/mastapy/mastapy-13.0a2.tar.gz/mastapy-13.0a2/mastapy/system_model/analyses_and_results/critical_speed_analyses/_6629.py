...
class TorqueConverterPumpCriticalSpeedAnalysis(_6547.CouplingHalfCriticalSpeedAnalysis):
    """TorqueConverterPumpCriticalSpeedAnalysis
    ...
    class _Cast_TorqueConverterPumpCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'TorqueConverterPumpCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def torque_converter_pump_critical_speed_analysis(self) -> 'TorqueConverterPumpCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterPumpCriticalSpeedAnalysis._Cast_TorqueConverterPumpCriticalSpeedAnalysis':
