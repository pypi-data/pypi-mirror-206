...
class BevelDifferentialSunGearCompoundAdvancedSystemDeflection(_7379.BevelDifferentialGearCompoundAdvancedSystemDeflection):
    """BevelDifferentialSunGearCompoundAdvancedSystemDeflection
    ...
    class _Cast_BevelDifferentialSunGearCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'BevelDifferentialSunGearCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def bevel_differential_sun_gear_compound_advanced_system_deflection(self) -> 'BevelDifferentialSunGearCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7250.BevelDifferentialSunGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7250.BevelDifferentialSunGearAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialSunGearCompoundAdvancedSystemDeflection._Cast_BevelDifferentialSunGearCompoundAdvancedSystemDeflection':
