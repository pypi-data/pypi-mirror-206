...
class SynchroniserHalfModalAnalysis(_4672.SynchroniserPartModalAnalysis):
    """SynchroniserHalfModalAnalysis
    ...
    class _Cast_SynchroniserHalfModalAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserHalfModalAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_half_modal_analysis(self) -> 'SynchroniserHalfModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserHalfModalAnalysis._Cast_SynchroniserHalfModalAnalysis':
