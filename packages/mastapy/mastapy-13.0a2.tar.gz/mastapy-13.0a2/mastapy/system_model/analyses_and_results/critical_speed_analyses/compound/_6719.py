...
class PartToPartShearCouplingCompoundCriticalSpeedAnalysis(_6676.CouplingCompoundCriticalSpeedAnalysis):
    """PartToPartShearCouplingCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6591.PartToPartShearCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6591.PartToPartShearCouplingCriticalSpeedAnalysis]':
