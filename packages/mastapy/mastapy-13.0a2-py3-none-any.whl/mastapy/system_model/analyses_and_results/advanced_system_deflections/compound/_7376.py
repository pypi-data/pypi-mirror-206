...
class BearingCompoundAdvancedSystemDeflection(_7404.ConnectorCompoundAdvancedSystemDeflection):
    """BearingCompoundAdvancedSystemDeflection
    ...
    class _Cast_BearingCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'BearingCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def bearing_compound_advanced_system_deflection(self) -> 'BearingCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7243.BearingAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7243.BearingAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'BearingCompoundAdvancedSystemDeflection._Cast_BearingCompoundAdvancedSystemDeflection':
