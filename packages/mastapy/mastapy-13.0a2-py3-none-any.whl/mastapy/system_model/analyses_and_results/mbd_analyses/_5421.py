...
class KlingelnbergCycloPalloidConicalGearMeshMultibodyDynamicsAnalysis(_5382.ConicalGearMeshMultibodyDynamicsAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshMultibodyDynamicsAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidConicalGearMeshMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidConicalGearMeshMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_conical_gear_mesh_multibody_dynamics_analysis(self) -> 'KlingelnbergCycloPalloidConicalGearMeshMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidConicalGearMeshMultibodyDynamicsAnalysis._Cast_KlingelnbergCycloPalloidConicalGearMeshMultibodyDynamicsAnalysis':
        return self._Cast_KlingelnbergCycloPalloidConicalGearMeshMultibodyDynamicsAnalysis(self)
