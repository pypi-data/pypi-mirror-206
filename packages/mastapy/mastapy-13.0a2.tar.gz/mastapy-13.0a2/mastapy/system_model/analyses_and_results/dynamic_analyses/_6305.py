...
class GuideDxfModelDynamicAnalysis(_6268.ComponentDynamicAnalysis):
    """GuideDxfModelDynamicAnalysis
    ...
    class _Cast_GuideDxfModelDynamicAnalysis:
        ...
        def __init__(self, parent: 'GuideDxfModelDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def guide_dxf_model_dynamic_analysis(self) -> 'GuideDxfModelDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GuideDxfModelDynamicAnalysis._Cast_GuideDxfModelDynamicAnalysis':
