...
class ClutchConnectionSteadyStateSynchronousResponse(_2999.CouplingConnectionSteadyStateSynchronousResponse):
    """ClutchConnectionSteadyStateSynchronousResponse
    ...
    class _Cast_ClutchConnectionSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'ClutchConnectionSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def clutch_connection_steady_state_synchronous_response(self) -> 'ClutchConnectionSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchConnectionSteadyStateSynchronousResponse._Cast_ClutchConnectionSteadyStateSynchronousResponse':
