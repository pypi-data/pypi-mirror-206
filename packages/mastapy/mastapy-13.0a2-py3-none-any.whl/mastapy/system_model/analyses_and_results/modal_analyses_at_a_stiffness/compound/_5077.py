...
class TorqueConverterCompoundModalAnalysisAtAStiffness(_4997.CouplingCompoundModalAnalysisAtAStiffness):
    """TorqueConverterCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_TorqueConverterCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'TorqueConverterCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def torque_converter_compound_modal_analysis_at_a_stiffness(self) -> 'TorqueConverterCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4949.TorqueConverterModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4949.TorqueConverterModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterCompoundModalAnalysisAtAStiffness._Cast_TorqueConverterCompoundModalAnalysisAtAStiffness':
