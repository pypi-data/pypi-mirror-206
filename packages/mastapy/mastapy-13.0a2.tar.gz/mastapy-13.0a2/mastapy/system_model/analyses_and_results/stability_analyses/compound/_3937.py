...
class HypoidGearMeshCompoundStabilityAnalysis(_3879.AGMAGleasonConicalGearMeshCompoundStabilityAnalysis):
    """HypoidGearMeshCompoundStabilityAnalysis
    ...
    class _Cast_HypoidGearMeshCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'HypoidGearMeshCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_mesh_compound_stability_analysis(self) -> 'HypoidGearMeshCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3805.HypoidGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3805.HypoidGearMeshStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearMeshCompoundStabilityAnalysis._Cast_HypoidGearMeshCompoundStabilityAnalysis':
