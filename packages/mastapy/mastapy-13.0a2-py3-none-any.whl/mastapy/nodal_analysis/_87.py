...
class TransientSolverOptions(_0.APIBase):
    ...
    class _Cast_TransientSolverOptions:
        ...
        def __init__(self, parent: 'TransientSolverOptions'):
            self._parent = parent

        @property
        def transient_solver_options(self) -> 'TransientSolverOptions':
            return self._parent
    ...
    def damping_scaling_for_initial_transients(self) -> '_56.DampingScalingTypeForInitialTransients':
        ...
        value = conversion.pn_to_mp_enum(temp, _56.DampingScalingTypeForInitialTransients)
    ...
    def damping_scaling_for_initial_transients(self, value: '_56.DampingScalingTypeForInitialTransients'):
        ...
        value = conversion.mp_to_pn_enum(value, _56.DampingScalingTypeForInitialTransients.type_())
    ...
    def result_logging_frequency(self) -> '_82.ResultLoggingFrequency':
        ...
        value = conversion.pn_to_mp_enum(temp, _82.ResultLoggingFrequency)
    ...
    def result_logging_frequency(self, value: '_82.ResultLoggingFrequency'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _82.ResultLoggingFrequency.type_())
    ...
    def solver_tolerance_input_method(self) -> '_89.TransientSolverToleranceInputMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _89.TransientSolverToleranceInputMethod)
    ...
    def solver_tolerance_input_method(self, value: '_89.TransientSolverToleranceInputMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _89.TransientSolverToleranceInputMethod.type_())
    ...
    @property
    def cast_to(self) -> 'TransientSolverOptions._Cast_TransientSolverOptions':
