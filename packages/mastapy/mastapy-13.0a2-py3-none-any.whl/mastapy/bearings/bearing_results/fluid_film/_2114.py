...
from mastapy.bearings.bearing_results.fluid_film import _2103
...
class LoadedTiltingThrustPad(_2103.LoadedFluidFilmBearingPad):
    """LoadedTiltingThrustPad
    ...
    class _Cast_LoadedTiltingThrustPad:
        ...
        def __init__(self, parent: 'LoadedTiltingThrustPad'):
            self._parent = parent

        @property
        def loaded_fluid_film_bearing_pad(self):
            return self._parent._cast(_2103.LoadedFluidFilmBearingPad)

        @property
        def loaded_tilting_thrust_pad(self) -> 'LoadedTiltingThrustPad':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'LoadedTiltingThrustPad._Cast_LoadedTiltingThrustPad':
