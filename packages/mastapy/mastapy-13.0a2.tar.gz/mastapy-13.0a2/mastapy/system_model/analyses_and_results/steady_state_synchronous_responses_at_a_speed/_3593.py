...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3594, _3592, _3500
...
class StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed(_3500.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_set_steady_state_synchronous_response_at_a_speed(self) -> 'StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def straight_bevel_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3594.StraightBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3592.StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed._Cast_StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed(self)
