...
from mastapy.system_model.analyses_and_results.mbd_analyses.external_interfaces import _5498
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    class _Cast_MBDAnalysisOptions:
        ...
        def __init__(self, parent: 'MBDAnalysisOptions'):
            self._parent = parent

        @property
        def mbd_analysis_options(self) -> 'MBDAnalysisOptions':
            return self._parent
    ...
    @property
    def analysis_type(self) -> '_5354.AnalysisTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, _5354.AnalysisTypes)
        return constructor.new_from_mastapy_type(_5354.AnalysisTypes)(value) if value is not None else None

    @analysis_type.setter
    def analysis_type(self, value: '_5354.AnalysisTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _5354.AnalysisTypes.type_())
    ...
    @property
    def method_to_define_period(self) -> '_5416.InertiaAdjustedLoadCasePeriodMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _5416.InertiaAdjustedLoadCasePeriodMethod)
        return constructor.new_from_mastapy_type(_5416.InertiaAdjustedLoadCasePeriodMethod)(value) if value is not None else None

    @method_to_define_period.setter
    def method_to_define_period(self, value: '_5416.InertiaAdjustedLoadCasePeriodMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _5416.InertiaAdjustedLoadCasePeriodMethod.type_())
    ...
    @property
    def static_load_cases_to_create(self) -> '_5417.InertiaAdjustedLoadCaseResultsToCreate':
        ...
        value = conversion.pn_to_mp_enum(temp, _5417.InertiaAdjustedLoadCaseResultsToCreate)
        return constructor.new_from_mastapy_type(_5417.InertiaAdjustedLoadCaseResultsToCreate)(value) if value is not None else None

    @static_load_cases_to_create.setter
    def static_load_cases_to_create(self, value: '_5417.InertiaAdjustedLoadCaseResultsToCreate'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _5417.InertiaAdjustedLoadCaseResultsToCreate.type_())
    ...
    @property
    def external_interface_options(self) -> '_5498.DynamicExternalInterfaceOptions':
    ...
    @property
    def frequency_response_options(self) -> '_4608.FrequencyResponseAnalysisOptions':
    ...
    @property
    def run_up_analysis_options(self) -> '_5433.MBDRunUpAnalysisOptions':
    ...
    @property
    def cast_to(self) -> 'MBDAnalysisOptions._Cast_MBDAnalysisOptions':
