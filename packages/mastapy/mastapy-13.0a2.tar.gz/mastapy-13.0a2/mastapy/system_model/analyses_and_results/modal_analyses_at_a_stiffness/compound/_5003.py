...
class CycloidalAssemblyCompoundModalAnalysisAtAStiffness(_5058.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """CycloidalAssemblyCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_CycloidalAssemblyCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'CycloidalAssemblyCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def cycloidal_assembly_compound_modal_analysis_at_a_stiffness(self) -> 'CycloidalAssemblyCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4873.CycloidalAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4873.CycloidalAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'CycloidalAssemblyCompoundModalAnalysisAtAStiffness._Cast_CycloidalAssemblyCompoundModalAnalysisAtAStiffness':
