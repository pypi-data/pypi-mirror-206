...
class StraightBevelGearCompoundModalAnalysis(_4717.BevelGearCompoundModalAnalysis):
    """StraightBevelGearCompoundModalAnalysis
    ...
    class _Cast_StraightBevelGearCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_compound_modal_analysis(self) -> 'StraightBevelGearCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4666.StraightBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4666.StraightBevelGearModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearCompoundModalAnalysis._Cast_StraightBevelGearCompoundModalAnalysis':
