...
class SynchroniserHalfHarmonicAnalysisOfSingleExcitation(_6091.SynchroniserPartHarmonicAnalysisOfSingleExcitation):
    """SynchroniserHalfHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_SynchroniserHalfHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'SynchroniserHalfHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def synchroniser_half_harmonic_analysis_of_single_excitation(self) -> 'SynchroniserHalfHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserHalfHarmonicAnalysisOfSingleExcitation._Cast_SynchroniserHalfHarmonicAnalysisOfSingleExcitation':
