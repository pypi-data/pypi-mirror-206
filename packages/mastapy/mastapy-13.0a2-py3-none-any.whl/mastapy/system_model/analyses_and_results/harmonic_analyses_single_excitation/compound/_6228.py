...
class WormGearCompoundHarmonicAnalysisOfSingleExcitation(_6163.GearCompoundHarmonicAnalysisOfSingleExcitation):
    """WormGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_WormGearCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'WormGearCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def worm_gear_compound_harmonic_analysis_of_single_excitation(self) -> 'WormGearCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6099.WormGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6099.WormGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'WormGearCompoundHarmonicAnalysisOfSingleExcitation._Cast_WormGearCompoundHarmonicAnalysisOfSingleExcitation':
