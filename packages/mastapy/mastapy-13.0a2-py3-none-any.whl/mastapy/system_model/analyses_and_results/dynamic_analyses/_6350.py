...
class StraightBevelDiffGearMeshDynamicAnalysis(_6260.BevelGearMeshDynamicAnalysis):
    """StraightBevelDiffGearMeshDynamicAnalysis
    ...
    class _Cast_StraightBevelDiffGearMeshDynamicAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearMeshDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_mesh_dynamic_analysis(self) -> 'StraightBevelDiffGearMeshDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearMeshDynamicAnalysis._Cast_StraightBevelDiffGearMeshDynamicAnalysis':
