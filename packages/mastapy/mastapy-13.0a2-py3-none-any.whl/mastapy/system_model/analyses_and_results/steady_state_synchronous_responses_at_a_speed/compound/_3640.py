...
class ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3651.CouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_compound_steady_state_synchronous_response_at_a_speed(self) -> 'ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3509.ConceptCouplingConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3509.ConceptCouplingConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed._Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(self)
