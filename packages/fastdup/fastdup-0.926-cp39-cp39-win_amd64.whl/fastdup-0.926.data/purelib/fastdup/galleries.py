...
if __name__ == "__main__":
    ...
    if False:
        ...
        import fastdup
        os.chdir('/Users/dannybickson/visual_database/cxx/unittests/')
        fastdup.init_search(2, 'search_out', license='magical')
        df = fastdup.search('one_image/test_1234.jpg', None, verbose=1)
        assert df is not None and len(df) == 2
        fastdup.create_duplicates_gallery(df, ".",input_dir='/Users/dannybickson/visual_database/cxx/unittests')
    elif False:
        ...
        os.chdir("/Users/dannybickson/Downloads/mafat")
        import fastdup
        fastdup.run('mafat.csv', 'new_output', license='magical', bounding_box='rotated',
