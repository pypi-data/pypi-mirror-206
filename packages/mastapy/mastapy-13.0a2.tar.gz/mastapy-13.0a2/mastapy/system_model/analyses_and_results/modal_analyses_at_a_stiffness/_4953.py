...
class VirtualComponentModalAnalysisAtAStiffness(_4908.MountableComponentModalAnalysisAtAStiffness):
    """VirtualComponentModalAnalysisAtAStiffness
    ...
    class _Cast_VirtualComponentModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'VirtualComponentModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def virtual_component_modal_analysis_at_a_stiffness(self) -> 'VirtualComponentModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'VirtualComponentModalAnalysisAtAStiffness._Cast_VirtualComponentModalAnalysisAtAStiffness':
