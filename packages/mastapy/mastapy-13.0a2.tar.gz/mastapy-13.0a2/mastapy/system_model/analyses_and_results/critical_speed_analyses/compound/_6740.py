...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6738, _6739, _6657
...
class SpiralBevelGearSetCompoundCriticalSpeedAnalysis(_6657.BevelGearSetCompoundCriticalSpeedAnalysis):
    """SpiralBevelGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6611.SpiralBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_critical_speed_analysis(self) -> 'List[_6738.SpiralBevelGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_critical_speed_analysis(self) -> 'List[_6739.SpiralBevelGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6611.SpiralBevelGearSetCriticalSpeedAnalysis]':
