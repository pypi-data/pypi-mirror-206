...
class PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft(_3476.VirtualComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def power_load_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3311.PowerLoadSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3311.PowerLoadSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft._Cast_PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft':
