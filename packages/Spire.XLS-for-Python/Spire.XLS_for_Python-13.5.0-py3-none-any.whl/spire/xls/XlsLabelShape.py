...
class XlsLabelShape (  XlsShape, ILabelShape) :
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().XlsLabelShape_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsLabelShape_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsLabelShape_set_Text(self.Ptr, value)
    ...
    def IsTextLocked(self)->bool:
        ...
        ret = GetDllLibXls().XlsLabelShape_get_IsTextLocked(self.Ptr)
        return ret

    @IsTextLocked.setter
    def IsTextLocked(self, value:bool):
        GetDllLibXls().XlsLabelShape_set_IsTextLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsLabelShape_set_IsTextLocked(self.Ptr, value)
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsLabelShape_get_ShapeType(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsLabelShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
