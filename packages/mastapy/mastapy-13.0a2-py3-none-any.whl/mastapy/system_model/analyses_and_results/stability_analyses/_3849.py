...
class StabilityAnalysisOptions(_0.APIBase):
    ...
    class _Cast_StabilityAnalysisOptions:
        ...
        def __init__(self, parent: 'StabilityAnalysisOptions'):
            self._parent = parent

        @property
        def stability_analysis_options(self) -> 'StabilityAnalysisOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StabilityAnalysisOptions._Cast_StabilityAnalysisOptions':
