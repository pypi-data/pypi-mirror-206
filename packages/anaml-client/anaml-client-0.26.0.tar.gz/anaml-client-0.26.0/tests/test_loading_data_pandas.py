...
from anaml_client.models.destination import TemporaryGCSStagingArea, LocalDestination, GCSDestination, DestinationId, \
    DestinationName, DestinationVersionId, BigQueryDestination
from anaml_client.models.file_format import FileFormat, Orc, CSV
