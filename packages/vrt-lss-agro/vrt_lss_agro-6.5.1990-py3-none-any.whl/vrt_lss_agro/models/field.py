...
class Field(BaseModel):
    ...
    amount: conint(strict=True, le=10000000, ge=0) = Field(..., description="Amount.")
    ...
    humidity_forecast: Optional[conlist(HumidityForecastElement, max_items=3653, min_items=0)] = Field(None, description="Field humidity forecast.")
