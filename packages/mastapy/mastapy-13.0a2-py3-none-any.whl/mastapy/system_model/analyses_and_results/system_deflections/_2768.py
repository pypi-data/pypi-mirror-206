...
class PlanetaryConnectionSystemDeflection(_2784.ShaftToMountableComponentConnectionSystemDeflection):
    """PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4093.PlanetaryConnectionPowerFlow':
