...
class DatabaseConnectionSettings(_0.APIBase):
    ...
    class _Cast_DatabaseConnectionSettings:
        ...
        def __init__(self, parent: 'DatabaseConnectionSettings'):
            self._parent = parent

        @property
        def database_connection_settings(self) -> 'DatabaseConnectionSettings':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DatabaseConnectionSettings._Cast_DatabaseConnectionSettings':
