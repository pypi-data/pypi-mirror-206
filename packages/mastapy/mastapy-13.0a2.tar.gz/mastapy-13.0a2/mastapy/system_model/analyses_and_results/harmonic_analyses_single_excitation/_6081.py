...
class StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation(_5991.BevelGearHarmonicAnalysisOfSingleExcitation):
    """StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_harmonic_analysis_of_single_excitation(self) -> 'StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation._Cast_StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation':
