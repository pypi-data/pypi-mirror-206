...
class SpringDamperConnectionCompoundModalAnalysisAtASpeed(_5256.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """SpringDamperConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5191.SpringDamperConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5191.SpringDamperConnectionModalAnalysisAtASpeed]':
