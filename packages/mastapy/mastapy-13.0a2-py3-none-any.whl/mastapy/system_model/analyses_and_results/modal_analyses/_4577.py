...
class ConceptGearModalAnalysis(_4610.GearModalAnalysis):
    """ConceptGearModalAnalysis
    ...
    class _Cast_ConceptGearModalAnalysis:
        ...
        def __init__(self, parent: 'ConceptGearModalAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_gear_modal_analysis(self) -> 'ConceptGearModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptGearModalAnalysis._Cast_ConceptGearModalAnalysis':
