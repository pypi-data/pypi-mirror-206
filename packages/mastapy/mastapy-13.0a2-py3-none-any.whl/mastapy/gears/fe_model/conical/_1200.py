...
class ConicalSetFEModel(_1194.GearSetFEModel):
    """ConicalSetFEModel
    ...
    @property
    def flank_data_source(self) -> '_1201.FlankDataSource':
        ...
        value = conversion.pn_to_mp_enum(temp, _1201.FlankDataSource)
        return constructor.new_from_mastapy_type(_1201.FlankDataSource)(value) if value is not None else None

    @flank_data_source.setter
    def flank_data_source(self, value: '_1201.FlankDataSource'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1201.FlankDataSource.type_())
