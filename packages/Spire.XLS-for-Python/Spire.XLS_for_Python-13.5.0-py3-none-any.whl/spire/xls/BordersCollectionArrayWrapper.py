...
class BordersCollectionArrayWrapper (  IBorders) :
    ...
    def KnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().BordersCollectionArrayWrapper_get_KnownColor(self.Ptr)
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().BordersCollectionArrayWrapper_set_KnownColor(self.Ptr, value.value)
    ...
    def Color(self)->'Color':
        ...
        intPtr = GetDllLibXls().BordersCollectionArrayWrapper_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().BordersCollectionArrayWrapper_set_Color(self.Ptr, value.Ptr)
    ...
    def get_Item(self ,Index:'BordersLineType')->'IBorder':
        ...
        intPtr = GetDllLibXls().BordersCollectionArrayWrapper_get_Item(self.Ptr, enumIndex)
    ...
    def LineStyle(self)->'LineStyleType':
        ...
        ret = GetDllLibXls().BordersCollectionArrayWrapper_get_LineStyle(self.Ptr)
    ...
    def LineStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().BordersCollectionArrayWrapper_set_LineStyle(self.Ptr, value.value)
    ...
    def Value(self)->'LineStyleType':
        ...
        ret = GetDllLibXls().BordersCollectionArrayWrapper_get_Value(self.Ptr)
        objwraped = LineStyleType(ret)
        return objwraped
    ...
    def Value(self, value:'LineStyleType'):
        ...
        GetDllLibXls().BordersCollectionArrayWrapper_set_Value(self.Ptr, value.value)
