...
from mastapy.system_model.analyses_and_results.stability_analyses import _3814, _3812, _3810
...
class KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis(_3810.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_stability_analysis(self) -> 'List[_3814.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_stability_analysis(self) -> 'List[_3812.KlingelnbergCycloPalloidHypoidGearMeshStabilityAnalysis]':
