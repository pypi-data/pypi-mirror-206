...
from mastapy.materials import _284, _281, _282
...
class PlasticSNCurve(_0.APIBase):
    ...
    class _Cast_PlasticSNCurve:
        ...
        def __init__(self, parent: 'PlasticSNCurve'):
            self._parent = parent

        @property
        def plastic_sn_curve_for_the_specified_operating_conditions(self):
            from mastapy.gears.rating.cylindrical.plastic_vdi2736 import _490
            
            return self._parent._cast(_490.PlasticSNCurveForTheSpecifiedOperatingConditions)

        @property
        def plastic_sn_curve(self) -> 'PlasticSNCurve':
            return self._parent
    ...
    @property
    def material(self) -> '_598.PlasticCylindricalGearMaterial':
    ...
    @property
    def bending_stress_cycle_data_for_damage_tables(self) -> 'List[_281.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
    ...
    @property
    def bending_stress_cycle_data(self) -> 'List[_281.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
    ...
    @property
    def contact_stress_cycle_data_for_damage_tables(self) -> 'List[_282.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
    ...
    @property
    def contact_stress_cycle_data(self) -> 'List[_282.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
    ...
    @property
    def cast_to(self) -> 'PlasticSNCurve._Cast_PlasticSNCurve':
