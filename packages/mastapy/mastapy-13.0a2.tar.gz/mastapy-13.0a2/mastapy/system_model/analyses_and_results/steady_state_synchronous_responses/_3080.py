...
class SynchroniserPartSteadyStateSynchronousResponse(_3000.CouplingHalfSteadyStateSynchronousResponse):
    """SynchroniserPartSteadyStateSynchronousResponse
    ...
    class _Cast_SynchroniserPartSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'SynchroniserPartSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def synchroniser_part_steady_state_synchronous_response(self) -> 'SynchroniserPartSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserPartSteadyStateSynchronousResponse._Cast_SynchroniserPartSteadyStateSynchronousResponse':
