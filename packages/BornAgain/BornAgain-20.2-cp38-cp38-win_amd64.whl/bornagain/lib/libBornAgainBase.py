...
class VariableBinAxis(IAxis):
    r"""Proxy of C++ VariableBinAxis class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, name, bin_boundaries):
        r"""__init__(VariableBinAxis self, std::string const & name, vdouble1d_t bin_boundaries) -> VariableBinAxis"""
        _libBornAgainBase.VariableBinAxis_swiginit(self, _libBornAgainBase.new_VariableBinAxis(name, bin_boundaries))
    ...
    def size(self):
        r"""size(VariableBinAxis self) -> size_t"""
        return _libBornAgainBase.VariableBinAxis_size(self)

    def bin(self, index):
        r"""bin(VariableBinAxis self, size_t index) -> Bin1D"""
    ...
    def binCenter(self, index):
        r"""binCenter(VariableBinAxis self, size_t index) -> double"""
        return _libBornAgainBase.VariableBinAxis_binCenter(self, index)

    def findClosestIndex(self, value):
        r"""findClosestIndex(VariableBinAxis self, double value) -> size_t"""
        return _libBornAgainBase.VariableBinAxis_findClosestIndex(self, value)

    def binCenters(self):
        r"""binCenters(VariableBinAxis self) -> vdouble1d_t"""
        return _libBornAgainBase.VariableBinAxis_binCenters(self)

    def binBoundaries(self):
        r"""binBoundaries(VariableBinAxis self) -> vdouble1d_t"""
...
class ConstKBinAxis(VariableBinAxis):
    r"""Proxy of C++ ConstKBinAxis class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, name, nbins, start, end):
        r"""__init__(ConstKBinAxis self, std::string const & name, size_t nbins, double start, double end) -> ConstKBinAxis"""
    ...
    def clone(self):
        r"""clone(ConstKBinAxis self) -> ConstKBinAxis"""
        return _libBornAgainBase.ConstKBinAxis_clone(self)

    def clip(self, lower, upper):
        r"""clip(ConstKBinAxis self, double lower, double upper)"""
...
class CustomBinAxis(VariableBinAxis):
    r"""Proxy of C++ CustomBinAxis class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, name, nbins, start, end):
        r"""__init__(CustomBinAxis self, std::string const & name, size_t nbins, double start, double end) -> CustomBinAxis"""
    ...
    def clone(self):
        r"""clone(CustomBinAxis self) -> CustomBinAxis"""
        return _libBornAgainBase.CustomBinAxis_clone(self)

    def bin(self, index):
        r"""bin(CustomBinAxis self, size_t index) -> Bin1D"""
        return _libBornAgainBase.CustomBinAxis_bin(self, index)

    def binCenters(self):
        r"""binCenters(CustomBinAxis self) -> vdouble1d_t"""
        return _libBornAgainBase.CustomBinAxis_binCenters(self)

    def clip(self, lower, upper):
        r"""clip(CustomBinAxis self, double lower, double upper)"""
...
class FixedBinAxis(IAxis):
    r"""Proxy of C++ FixedBinAxis class."""
...
class Frame(object):
    ...
    def __init__(self, axes):
        r"""__init__(Frame self, std::vector< IAxis const *,std::allocator< IAxis const * > > const & axes) -> Frame"""
