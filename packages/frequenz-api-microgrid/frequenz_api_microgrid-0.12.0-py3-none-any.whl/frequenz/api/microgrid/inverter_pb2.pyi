...
class Data(google.protobuf.message.Message):
    ...
    @property
    def dc(self) -> frequenz.api.microgrid.common_pb2.DC:
        """DC metrics of the inverter."""
    @property
    def ac(self) -> frequenz.api.microgrid.common_pb2.AC:
        """AC metrics of the inverter."""
    @property
    def temperature(self) -> frequenz.api.microgrid.common_pb2.Metric:
    ...
    def __init__(
        self,
        *,
        dc: frequenz.api.microgrid.common_pb2.DC | None = ...,
        ac: frequenz.api.microgrid.common_pb2.AC | None = ...,
        temperature: frequenz.api.microgrid.common_pb2.Metric | None = ...,
    ) -> None: ...
