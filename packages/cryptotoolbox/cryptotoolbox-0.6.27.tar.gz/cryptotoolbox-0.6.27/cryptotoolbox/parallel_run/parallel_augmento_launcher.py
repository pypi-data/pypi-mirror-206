...
class AugmentoForecasterParalleLauncher():
                    ...
                    for s_eval in s_evals:
                        for calibration_step in calibration_steps:
                            for signal_type, params  in signal_idiosyncratic_paramaters.items():
                                for param in params:
                                    self.args.append((self,self.seed,adv_feat,n,s,s_eval,calibration_step,signal_type,json.dumps(param, sort_keys=True)))
                                    self.key_args.append((self.seed,adv_feat,n,s,s_eval,calibration_step,signal_type,json.dumps(param, sort_keys=True)))
    ...
    def create_saving_key(self, seed, adv_feat, n, s, s_eval, calibration_step, signal_type, idios_string):
