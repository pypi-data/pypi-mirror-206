...
class ClutchConnectionCriticalSpeedAnalysis(_6545.CouplingConnectionCriticalSpeedAnalysis):
    """ClutchConnectionCriticalSpeedAnalysis
    ...
    class _Cast_ClutchConnectionCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ClutchConnectionCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_connection_critical_speed_analysis(self) -> 'ClutchConnectionCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchConnectionCriticalSpeedAnalysis._Cast_ClutchConnectionCriticalSpeedAnalysis':
