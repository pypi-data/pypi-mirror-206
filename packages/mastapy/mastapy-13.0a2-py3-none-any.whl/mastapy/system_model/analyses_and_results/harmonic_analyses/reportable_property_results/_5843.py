...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5835, _5844, _5837
...
class RootAssemblyHarmonicAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def combined_orders(self) -> '_5835.ResultsForMultipleOrdersForGroups':
    ...
    @property
    def excitations(self) -> 'List[_5844.RootAssemblySingleWhineAnalysisResultsPropertyAccessor]':
    ...
    @property
    def orders_for_combined_excitations(self) -> 'List[_5837.ResultsForOrderIncludingGroups]':
    ...
    @property
    def orders_for_combined_excitations_from_same_parts(self) -> 'List[_5837.ResultsForOrderIncludingGroups]':
