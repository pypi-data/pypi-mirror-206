...
class FaceGearAdvancedTimeSteppingAnalysisForModulation(_7031.GearAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_FaceGearAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'FaceGearAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def face_gear_advanced_time_stepping_analysis_for_modulation(self) -> 'FaceGearAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2735.FaceGearSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'FaceGearAdvancedTimeSteppingAnalysisForModulation._Cast_FaceGearAdvancedTimeSteppingAnalysisForModulation':
