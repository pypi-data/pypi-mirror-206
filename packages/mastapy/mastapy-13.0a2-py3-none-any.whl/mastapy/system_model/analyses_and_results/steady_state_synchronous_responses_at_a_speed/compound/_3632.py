...
class BoltCompoundSteadyStateSynchronousResponseAtASpeed(_3638.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """BoltCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3503.BoltSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3503.BoltSteadyStateSynchronousResponseAtASpeed]':
