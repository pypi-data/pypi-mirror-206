...
class BearingCompoundSteadyStateSynchronousResponse(_3131.ConnectorCompoundSteadyStateSynchronousResponse):
    """BearingCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_BearingCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'BearingCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def bearing_compound_steady_state_synchronous_response(self) -> 'BearingCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2970.BearingSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2970.BearingSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'BearingCompoundSteadyStateSynchronousResponse._Cast_BearingCompoundSteadyStateSynchronousResponse':
