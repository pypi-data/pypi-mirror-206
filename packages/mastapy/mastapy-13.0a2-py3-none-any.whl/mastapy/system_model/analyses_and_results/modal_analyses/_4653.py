...
class ShaftModalAnalysisMode(_0.APIBase):
    ...
    class _Cast_ShaftModalAnalysisMode:
        ...
        def __init__(self, parent: 'ShaftModalAnalysisMode'):
            self._parent = parent

        @property
        def shaft_modal_analysis_mode(self) -> 'ShaftModalAnalysisMode':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftModalAnalysisMode._Cast_ShaftModalAnalysisMode':
