...
class SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation(_7140.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def spring_damper_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7076.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7076.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation(self)
