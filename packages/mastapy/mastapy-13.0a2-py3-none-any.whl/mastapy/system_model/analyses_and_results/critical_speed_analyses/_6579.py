...
class KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis(_6576.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_critical_speed_analysis(self) -> 'KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis._Cast_KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis':
