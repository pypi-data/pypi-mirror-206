...
class StraightBevelGearSteadyStateSynchronousResponse(_2980.BevelGearSteadyStateSynchronousResponse):
    """StraightBevelGearSteadyStateSynchronousResponse
    ...
    class _Cast_StraightBevelGearSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'StraightBevelGearSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_steady_state_synchronous_response(self) -> 'StraightBevelGearSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSteadyStateSynchronousResponse._Cast_StraightBevelGearSteadyStateSynchronousResponse':
