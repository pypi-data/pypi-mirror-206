...
class SynchroniserPartSteadyStateSynchronousResponseOnAShaft(_3262.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    """SynchroniserPartSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_SynchroniserPartSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'SynchroniserPartSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def synchroniser_part_steady_state_synchronous_response_on_a_shaft(self) -> 'SynchroniserPartSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserPartSteadyStateSynchronousResponseOnAShaft._Cast_SynchroniserPartSteadyStateSynchronousResponseOnAShaft':
