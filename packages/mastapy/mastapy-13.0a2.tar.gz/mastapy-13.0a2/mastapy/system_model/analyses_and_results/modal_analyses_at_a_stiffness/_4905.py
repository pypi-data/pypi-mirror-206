...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4904, _4903, _4899
...
class KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtAStiffness(_4899.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness):
    """KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtAStiffness
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_set_modal_analysis_at_a_stiffness(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4904.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4903.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtAStiffness._Cast_KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtAStiffness':
        return self._Cast_KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtAStiffness(self)
