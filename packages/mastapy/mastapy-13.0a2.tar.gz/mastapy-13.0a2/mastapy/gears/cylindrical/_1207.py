...
class GearLTCAContactCharts(_0.APIBase):
    ...
    class _Cast_GearLTCAContactCharts:
        ...
        def __init__(self, parent: 'GearLTCAContactCharts'):
            self._parent = parent

        @property
        def cylindrical_gear_ltca_contact_charts(self):
            from mastapy.gears.cylindrical import _1203
            
            return self._parent._cast(_1203.CylindricalGearLTCAContactCharts)

        @property
        def gear_ltca_contact_charts(self) -> 'GearLTCAContactCharts':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GearLTCAContactCharts._Cast_GearLTCAContactCharts':
