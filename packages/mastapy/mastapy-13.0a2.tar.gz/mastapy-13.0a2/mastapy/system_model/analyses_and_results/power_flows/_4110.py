...
class SpecialisedAssemblyPowerFlow(_4009.AbstractAssemblyPowerFlow):
    """SpecialisedAssemblyPowerFlow
    ...
    class _Cast_SpecialisedAssemblyPowerFlow:
        ...
        def __init__(self, parent: 'SpecialisedAssemblyPowerFlow'):
            self._parent = parent
        ...
        @property
        def specialised_assembly_power_flow(self) -> 'SpecialisedAssemblyPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpecialisedAssemblyPowerFlow._Cast_SpecialisedAssemblyPowerFlow':
