...
class OpenersThirdBid(Hand):
    ...
    def _responder_support(self):
        ...
        if self._responder_has_jumped_in_minor():
            ...
            bid = self.next_level_bid(self.opener_bid_one.denomination, '1624')
        elif self._responder_repeats_suit_and_can_support():
            bid = self.next_level_bid(self.opener_bid_two.denomination, '1625')
            ...
            bid = self.bid_to_game(self.opener_bid_two.denomination, '1629')
    ...
    def _responder_support_strong(self):
        ...
        if (self.responder_bid_two.denomination == self.opener_bid_one.denomination and
            ...
            bid = self.next_level_bid(self.opener_bid_one.denomination, '1633')
        else:
            bid = Pass('1634')
        self.tracer(__name__, inspection(), bid, self.trace)
        return bid
    ...
    def _responder_support_strong_constructive(self):
        ...
        if self._responder_rebids_minor_and_semi_balanced():
            ...
            bid = self.bid_to_game(self.opener_bid_one.denomination, '1639')
            ...
            if self.shape[0] >= 5 or self.nt_level > 3:
                bid = self.next_level_bid(self.responder_bid_two.denomination, '1641')
            else:
        ...
        #     bid = self.next_level_bid(self.opener_bid_two.denomination, '1705')
    ...
    def _support_responders_rebid_suit(self):
        ...
        #         bid = self.nt_bid(4, '1695')
        #     elif self._responders_suit_is_minor_and_semi_balanced():
        #         bid = self.nt_bid(3, '1696')
        #     else:
        #         bid = self.next_level_bid(responders_suit, '1697')
    ...
    #         if self.spades >= 3:
    #             bid = self.spade_bid(4, '1708')
    #         else:
    #             bid = self.nt_bid(3, '1709')
    #     elif self.responder_bid_two.name == '3H':
    #         if self.hearts >= 3:
    #             bid = self.heart_bid(4, '1710')
    #         else:
    #             bid = self.nt_bid(3, '1711')
    #     else:
