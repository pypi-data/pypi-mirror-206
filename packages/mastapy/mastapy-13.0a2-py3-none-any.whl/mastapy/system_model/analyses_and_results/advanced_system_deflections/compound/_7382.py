...
class BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection(_7379.BevelDifferentialGearCompoundAdvancedSystemDeflection):
    """BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection
    ...
    class _Cast_BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def bevel_differential_planet_gear_compound_advanced_system_deflection(self) -> 'BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7249.BevelDifferentialPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7249.BevelDifferentialPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection._Cast_BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection':
        return self._Cast_BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection(self)
