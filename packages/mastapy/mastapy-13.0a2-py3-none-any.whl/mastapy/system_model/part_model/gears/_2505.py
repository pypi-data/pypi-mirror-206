...
from mastapy.system_model.part_model.gears import _2504, _2511
...
class CylindricalGearSet(_2511.GearSet):
    """CylindricalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_1023.CylindricalGearSetDesign':
    ...
    @property
    def supercharger_rotor_set(self) -> '_2542.SuperchargerRotorSet':
    ...
    @property
    def cylindrical_meshes(self) -> 'List[_2290.CylindricalGearMesh]':
    ...
    @property
    def gear_set_designs(self) -> 'List[_1023.CylindricalGearSetDesign]':
