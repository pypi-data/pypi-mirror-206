...
class StraightBevelGearMeshCompoundAdvancedSystemDeflection(_7385.BevelGearMeshCompoundAdvancedSystemDeflection):
    """StraightBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    class _Cast_StraightBevelGearMeshCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_compound_advanced_system_deflection(self) -> 'StraightBevelGearMeshCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7347.StraightBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7347.StraightBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshCompoundAdvancedSystemDeflection._Cast_StraightBevelGearMeshCompoundAdvancedSystemDeflection':
