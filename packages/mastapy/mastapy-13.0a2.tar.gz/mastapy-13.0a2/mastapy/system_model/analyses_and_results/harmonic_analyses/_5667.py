...
class BevelGearSetHarmonicAnalysis(_5655.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """BevelGearSetHarmonicAnalysis
    ...
    class _Cast_BevelGearSetHarmonicAnalysis:
        ...
        def __init__(self, parent: 'BevelGearSetHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_gear_set_harmonic_analysis(self) -> 'BevelGearSetHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearSetHarmonicAnalysis._Cast_BevelGearSetHarmonicAnalysis':
