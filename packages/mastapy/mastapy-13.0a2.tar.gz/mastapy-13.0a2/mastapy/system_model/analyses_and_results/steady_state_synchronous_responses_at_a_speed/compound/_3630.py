...
class BevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_3618.AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    """BevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_BevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'BevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def bevel_gear_mesh_compound_steady_state_synchronous_response_at_a_speed(self) -> 'BevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3499.BevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3499.BevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'BevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed._Cast_BevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_BevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(self)
