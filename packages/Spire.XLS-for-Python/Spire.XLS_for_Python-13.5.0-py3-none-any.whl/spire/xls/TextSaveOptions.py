...
class TextSaveOptions (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().TextSaveOptions_get_RetainHiddenData(self.Ptr)
        return ret
    ...
    def RetainHiddenData(self, value:bool):
        ...
        GetDllLibXls().TextSaveOptions_set_RetainHiddenData(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().TextSaveOptions_get_RetainBlankRowsAndCols(self.Ptr)
        return ret
    ...
    def RetainBlankRowsAndCols(self, value:bool):
        ...
        GetDllLibXls().TextSaveOptions_set_RetainBlankRowsAndCols(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().TextSaveOptions_get_Separator.restype=c_wchar_p
        ret = GetDllLibXls().TextSaveOptions_get_Separator(self.Ptr)
        return ret
    ...
    def Separator(self, value:str):
        ...
        GetDllLibXls().TextSaveOptions_set_Separator(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().TextSaveOptions_get_Encoding(self.Ptr)
    ...
    def Encoding(self, value:'Encoding'):
        ...
        GetDllLibXls().TextSaveOptions_set_Encoding(self.Ptr, value.Ptr)
