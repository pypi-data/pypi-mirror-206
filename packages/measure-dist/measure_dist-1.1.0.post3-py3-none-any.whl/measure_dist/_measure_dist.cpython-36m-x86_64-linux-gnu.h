...
/* package measure_dist/measure_dist */
...
//
extern long long int Slice_measure_dist_Object_CTor();
extern GoInt Slice_measure_dist_Object_len(long long int handle);
extern long long int Slice_measure_dist_Object_elem(long long int handle, GoInt _idx);
extern long long int Slice_measure_dist_Object_subslice(long long int handle, GoInt _st, GoInt _ed);
extern void Slice_measure_dist_Object_set(long long int handle, GoInt _idx, long long int _vl);
extern void Slice_measure_dist_Object_append(long long int handle, long long int _vl);

// --- wrapping struct: measure_dist.AnnotationResult ---
//
extern long long int measure_dist_AnnotationResult_CTor();
extern long long int measure_dist_AnnotationResult_List_object_names_Get(long long int handle);
extern void measure_dist_AnnotationResult_List_object_names_Set(long long int handle, long long int val);
extern long long int measure_dist_AnnotationResult_List_with_all_boxes_Get(long long int handle);
extern void measure_dist_AnnotationResult_List_with_all_boxes_Set(long long int handle, long long int val);

// --- wrapping struct: measure_dist.BndBox ---
//
extern long long int measure_dist_BndBox_CTor();
extern double measure_dist_BndBox_XMin_Get(long long int handle);
extern void measure_dist_BndBox_XMin_Set(long long int handle, double val);
extern double measure_dist_BndBox_YMin_Get(long long int handle);
extern void measure_dist_BndBox_YMin_Set(long long int handle, double val);
extern double measure_dist_BndBox_XMax_Get(long long int handle);
extern void measure_dist_BndBox_XMax_Set(long long int handle, double val);
extern double measure_dist_BndBox_YMax_Get(long long int handle);
extern void measure_dist_BndBox_YMax_Set(long long int handle, double val);

// --- wrapping struct: measure_dist.Object ---
//
extern long long int measure_dist_Object_CTor();
extern char* measure_dist_Object_Name_Get(long long int handle);
extern void measure_dist_Object_Name_Set(long long int handle, char* val);
extern long long int measure_dist_Object_BndBox_Get(long long int handle);
extern void measure_dist_Object_BndBox_Set(long long int handle, long long int val);

// --- wrapping struct: measure_dist.Annotation ---
//
extern long long int measure_dist_Annotation_CTor();
extern long long int measure_dist_Annotation_XMLName_Get(long long int handle);
extern void measure_dist_Annotation_XMLName_Set(long long int handle, long long int val);
extern long long int measure_dist_Annotation_Object_Get(long long int handle);
extern void measure_dist_Annotation_Object_Set(long long int handle, long long int val);
extern long long int measure_dist_ReadAnnotation(char* xmlFile);
extern long long int measure_dist_MergeBoxes(long long int box1, long long int box2);
extern long long int measure_dist_ThreePCenterPoint(long long int mesh);
extern long long int measure_dist_TwoPCenterPoint(long long int mesh);
extern long long int measure_dist_CalculateArea(long long int box);
extern double measure_dist_CalculateIOU(long long int boxA, long long int boxB);
extern char measure_dist_Contains(long long int s, char* e);
extern double measure_dist_CoordinateToAzimuth(long long int coordinate);
extern long long int measure_dist_EnlargeArea(long long int area, long long int margin, long long int imageWidth, long long int imageHeight);
extern char measure_dist_IsInsideArea(long long int objectBox, long long int area);
extern long long int measure_dist_XywhToXyxy(long long int iCrop);
