...
from mastapy.bearings import _1875, _1868, _1869
...
class BearingSettingsItem(_1816.NamedDatabaseItem):
    """BearingSettingsItem
    ...
    @property
    def failure_probability_for_rating_life_percent(self) -> '_1875.RatingLife':
        ...
        value = conversion.pn_to_mp_enum(temp, _1875.RatingLife)
        return constructor.new_from_mastapy_type(_1875.RatingLife)(value) if value is not None else None

    @failure_probability_for_rating_life_percent.setter
    def failure_probability_for_rating_life_percent(self, value: '_1875.RatingLife'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1875.RatingLife.type_())
        self.wrapped.FailureProbabilityForRatingLifePercent = value

    @property
    def include_exponent_and_reduction_factors_in_isots162812008(self) -> '_1868.ExponentAndReductionFactorsInISO16281Calculation':
        ...
        value = conversion.pn_to_mp_enum(temp, _1868.ExponentAndReductionFactorsInISO16281Calculation)
        return constructor.new_from_mastapy_type(_1868.ExponentAndReductionFactorsInISO16281Calculation)(value) if value is not None else None

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    def include_exponent_and_reduction_factors_in_isots162812008(self, value: '_1868.ExponentAndReductionFactorsInISO16281Calculation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1868.ExponentAndReductionFactorsInISO16281Calculation.type_())
