...
class PointLoadCompoundParametricStudyTool(_4540.VirtualComponentCompoundParametricStudyTool):
    """PointLoadCompoundParametricStudyTool
    ...
    class _Cast_PointLoadCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'PointLoadCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def point_load_compound_parametric_study_tool(self) -> 'PointLoadCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4375.PointLoadParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4375.PointLoadParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'PointLoadCompoundParametricStudyTool._Cast_PointLoadCompoundParametricStudyTool':
