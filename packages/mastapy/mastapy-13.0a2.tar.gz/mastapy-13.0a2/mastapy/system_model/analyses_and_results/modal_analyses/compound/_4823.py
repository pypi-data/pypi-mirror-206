...
class VirtualComponentCompoundModalAnalysis(_4778.MountableComponentCompoundModalAnalysis):
    """VirtualComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4679.VirtualComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4679.VirtualComponentModalAnalysis]':
