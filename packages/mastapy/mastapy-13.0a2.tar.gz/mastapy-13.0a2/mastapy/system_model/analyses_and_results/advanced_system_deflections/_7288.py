...
class DatumAdvancedSystemDeflection(_7260.ComponentAdvancedSystemDeflection):
    """DatumAdvancedSystemDeflection
    ...
    class _Cast_DatumAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'DatumAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def datum_advanced_system_deflection(self) -> 'DatumAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2730.DatumSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'DatumAdvancedSystemDeflection._Cast_DatumAdvancedSystemDeflection':
