...
class ISO1328AccuracyGrades(_1132.CylindricalAccuracyGrades):
    """ISO1328AccuracyGrades
    ...
    class _Cast_ISO1328AccuracyGrades:
        ...
        def __init__(self, parent: 'ISO1328AccuracyGrades'):
            self._parent = parent

        @property
        def cylindrical_accuracy_grades(self):
            return self._parent._cast(_1132.CylindricalAccuracyGrades)

        @property
        def accuracy_grades(self):
            from mastapy.gears import _310
            
            return self._parent._cast(_310.AccuracyGrades)

        @property
        def iso1328_accuracy_grades(self) -> 'ISO1328AccuracyGrades':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ISO1328AccuracyGrades._Cast_ISO1328AccuracyGrades':
