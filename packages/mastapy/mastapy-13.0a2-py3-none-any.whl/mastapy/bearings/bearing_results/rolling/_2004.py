...
class LoadedMultiPointContactBallBearingElement(_1985.LoadedBallBearingElement):
    """LoadedMultiPointContactBallBearingElement
    ...
    class _Cast_LoadedMultiPointContactBallBearingElement:
        ...
        def __init__(self, parent: 'LoadedMultiPointContactBallBearingElement'):
            self._parent = parent
        ...
        @property
        def loaded_multi_point_contact_ball_bearing_element(self) -> 'LoadedMultiPointContactBallBearingElement':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'LoadedMultiPointContactBallBearingElement._Cast_LoadedMultiPointContactBallBearingElement':
