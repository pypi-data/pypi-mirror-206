...
class PowerLoadCompoundModalAnalysisAtASpeed(_5340.VirtualComponentCompoundModalAnalysisAtASpeed):
    """PowerLoadCompoundModalAnalysisAtASpeed
    ...
    class _Cast_PowerLoadCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'PowerLoadCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def power_load_compound_modal_analysis_at_a_speed(self) -> 'PowerLoadCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5176.PowerLoadModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5176.PowerLoadModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'PowerLoadCompoundModalAnalysisAtASpeed._Cast_PowerLoadCompoundModalAnalysisAtASpeed':
