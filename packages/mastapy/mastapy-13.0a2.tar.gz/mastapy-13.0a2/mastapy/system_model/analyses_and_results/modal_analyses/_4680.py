...
class WaterfallChartSettings(_0.APIBase):
    ...
    class _Cast_WaterfallChartSettings:
        ...
        def __init__(self, parent: 'WaterfallChartSettings'):
            self._parent = parent

        @property
        def waterfall_chart_settings(self) -> 'WaterfallChartSettings':
            return self._parent
    ...
    @property
    def draw_lines_on_top_in_2d(self) -> 'bool':
        """bool: 'DrawLinesOnTopIn2D' is the original name of this property."""
    ...
    def draw_lines_on_top_in_2d(self, value: 'bool'):
        self.wrapped.DrawLinesOnTopIn2D = bool(value) if value else False
    ...
    @property
    def cast_to(self) -> 'WaterfallChartSettings._Cast_WaterfallChartSettings':
