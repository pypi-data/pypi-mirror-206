...
class XlsChartValueAxis (  XlsChartAxis, IChartValueAxis) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_LogBase(self.Ptr)
        return ret

    @LogBase.setter
    def LogBase(self, value:float):
        GetDllLibXls().XlsChartValueAxis_set_LogBase.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartValueAxis_set_LogBase(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_MinValue(self.Ptr)
        return ret

    @MinValue.setter
    def MinValue(self, value:float):
        GetDllLibXls().XlsChartValueAxis_set_MinValue.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartValueAxis_set_MinValue(self.Ptr, value)
    ...
    def MaxValue(self)->float:
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_MaxValue(self.Ptr)
        return ret

    @MaxValue.setter
    def MaxValue(self, value:float):
        GetDllLibXls().XlsChartValueAxis_set_MaxValue.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartValueAxis_set_MaxValue(self.Ptr, value)
    ...
    def MajorUnit(self)->float:
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_MajorUnit(self.Ptr)
        return ret

    @MajorUnit.setter
    def MajorUnit(self, value:float):
        GetDllLibXls().XlsChartValueAxis_set_MajorUnit.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartValueAxis_set_MajorUnit(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_MinorUnit(self.Ptr)
        return ret

    @MinorUnit.setter
    def MinorUnit(self, value:float):
        GetDllLibXls().XlsChartValueAxis_set_MinorUnit.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartValueAxis_set_MinorUnit(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_CrossValue(self.Ptr)
        return ret

    @CrossValue.setter
    def CrossValue(self, value:float):
        GetDllLibXls().XlsChartValueAxis_set_CrossValue.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartValueAxis_set_CrossValue(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_CrossesAt(self.Ptr)
        return ret

    @CrossesAt.setter
    def CrossesAt(self, value:float):
        GetDllLibXls().XlsChartValueAxis_set_CrossesAt.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartValueAxis_set_CrossesAt(self.Ptr, value)
    ...
    def IsAutoMin(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_IsAutoMin(self.Ptr)
        return ret

    @IsAutoMin.setter
    def IsAutoMin(self, value:bool):
        GetDllLibXls().XlsChartValueAxis_set_IsAutoMin.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartValueAxis_set_IsAutoMin(self.Ptr, value)
    ...
    def IsAutoMax(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_IsAutoMax(self.Ptr)
        return ret

    @IsAutoMax.setter
    def IsAutoMax(self, value:bool):
        GetDllLibXls().XlsChartValueAxis_set_IsAutoMax.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartValueAxis_set_IsAutoMax(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_IsAutoMajor(self.Ptr)
        return ret

    @IsAutoMajor.setter
    def IsAutoMajor(self, value:bool):
        GetDllLibXls().XlsChartValueAxis_set_IsAutoMajor.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartValueAxis_set_IsAutoMajor(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_IsAutoMinor(self.Ptr)
        return ret

    @IsAutoMinor.setter
    def IsAutoMinor(self, value:bool):
        GetDllLibXls().XlsChartValueAxis_set_IsAutoMinor.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartValueAxis_set_IsAutoMinor(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_IsAutoCross(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_IsLogScale(self.Ptr)
        return ret

    @IsLogScale.setter
    def IsLogScale(self, value:bool):
        GetDllLibXls().XlsChartValueAxis_set_IsLogScale.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartValueAxis_set_IsLogScale(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_IsReverseOrder(self.Ptr)
        return ret
    ...
    def IsReverseOrder(self, value:bool):
        ...
        GetDllLibXls().XlsChartValueAxis_set_IsReverseOrder(self.Ptr, value)
    ...
    def IsMaxCross(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_IsMaxCross(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_DisplayUnitCustom(self.Ptr)
        return ret
    ...
    def DisplayUnitCustom(self, value:float):
        ...
        GetDllLibXls().XlsChartValueAxis_set_DisplayUnitCustom(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_DisplayUnit(self.Ptr)
    ...
    def DisplayUnit(self, value:'ChartDisplayUnitType'):
        ...
        GetDllLibXls().XlsChartValueAxis_set_DisplayUnit(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartValueAxis_get_HasDisplayUnitLabel(self.Ptr)
        return ret
    ...
    def HasDisplayUnitLabel(self, value:bool):
        ...
        GetDllLibXls().XlsChartValueAxis_set_HasDisplayUnitLabel(self.Ptr, value)
...
#        intPtr = GetDllLibXls().XlsChartValueAxis_Clone(self.Ptr, intPtrparent,intPtrdicFontIndexes,intPtrdicNewSheetNames)
