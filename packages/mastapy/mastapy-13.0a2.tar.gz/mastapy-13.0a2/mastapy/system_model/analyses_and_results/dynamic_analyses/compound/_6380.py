...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import (
    _6381, _6383, _6386, _6393,
    _6392, _6414, _6394, _6399,
    _6404, _6416, _6418, _6422,
    _6429, _6428, _6430, _6437,
    _6444, _6447, _6448, _6449,
    _6451, _6453, _6458, _6459,
    _6460, _6462, _6464, _6469,
    _6468, _6474, _6475, _6480,
    _6483, _6486, _6490, _6494,
    _6498, _6501, _6373
)
...
class AssemblyCompoundDynamicAnalysis(_6373.AbstractAssemblyCompoundDynamicAnalysis):
    """AssemblyCompoundDynamicAnalysis
    ...
    class _Cast_AssemblyCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'AssemblyCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def assembly_compound_dynamic_analysis(self) -> 'AssemblyCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6250.AssemblyDynamicAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_6381.BearingCompoundDynamicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6383.BeltDriveCompoundDynamicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6386.BevelDifferentialGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6393.BoltedJointCompoundDynamicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6392.BoltCompoundDynamicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6414.CVTCompoundDynamicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6394.ClutchCompoundDynamicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6399.ConceptCouplingCompoundDynamicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6404.ConceptGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6416.CycloidalAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6418.CycloidalDiscCompoundDynamicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6422.CylindricalGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6429.FEPartCompoundDynamicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6428.FaceGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6430.FlexiblePinAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6437.HypoidGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6444.KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6447.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6448.MassDiscCompoundDynamicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6449.MeasurementComponentCompoundDynamicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6451.OilSealCompoundDynamicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6453.PartToPartShearCouplingCompoundDynamicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6458.PlanetCarrierCompoundDynamicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6459.PointLoadCompoundDynamicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6460.PowerLoadCompoundDynamicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6462.RingPinsCompoundDynamicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6464.RollingRingAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6469.ShaftHubConnectionCompoundDynamicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6468.ShaftCompoundDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6474.SpiralBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6475.SpringDamperCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6480.StraightBevelDiffGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6483.StraightBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6486.SynchroniserCompoundDynamicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6490.TorqueConverterCompoundDynamicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6494.UnbalancedMassCompoundDynamicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6498.WormGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6501.ZerolBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6250.AssemblyDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'AssemblyCompoundDynamicAnalysis._Cast_AssemblyCompoundDynamicAnalysis':
