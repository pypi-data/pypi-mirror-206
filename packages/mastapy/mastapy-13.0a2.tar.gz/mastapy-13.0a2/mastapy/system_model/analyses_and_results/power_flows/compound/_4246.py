...
class SpringDamperHalfCompoundPowerFlow(_4181.CouplingHalfCompoundPowerFlow):
    """SpringDamperHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4115.SpringDamperHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4115.SpringDamperHalfPowerFlow]':
