"use strict";
(self["webpackChunkjupyterlab_quarto"] = self["webpackChunkjupyterlab_quarto"] || []).push([["vendors-node_modules_mermaid_dist_timeline-definition-8e5a9bc6_js"],{
...
/***/ "../../node_modules/mermaid/dist/timeline-definition-8e5a9bc6.js":
/*!***********************************************************************!*\
  !*** ../../node_modules/mermaid/dist/timeline-definition-8e5a9bc6.js ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./mermaid-ae477ddf.js */ "../../node_modules/mermaid/dist/mermaid-ae477ddf.js");
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! d3 */ "../../node_modules/d3/src/index.js");
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! khroma */ "../../node_modules/khroma/dist/methods/is_dark.js");
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! khroma */ "../../node_modules/khroma/dist/methods/lighten.js");
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! khroma */ "../../node_modules/khroma/dist/methods/darken.js");
...
/* harmony import */ var dayjs_plugin_isoWeek_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! dayjs/plugin/isoWeek.js */ "../../node_modules/dayjs/plugin/isoWeek.js");
/* harmony import */ var dayjs_plugin_isoWeek_js__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_isoWeek_js__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! dayjs/plugin/customParseFormat.js */ "../../node_modules/dayjs/plugin/customParseFormat.js");
/* harmony import */ var dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! dayjs/plugin/advancedFormat.js */ "../../node_modules/dayjs/plugin/advancedFormat.js");
/* harmony import */ var dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_15__);
...
const tasks = [];
const rawTasks = [];
const getCommonDb = () => _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.j;
const parseDirective = (statement, context, type) => {
  (0,_mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.k)(globalThis, statement, context, type);
};
const clear = function() {
  ...
  currentSection = "";
  rawTasks.length = 0;
  (0,_mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.m)();
};
...
const draw = function(text, id, version, diagObj) {
  const conf2 = (0,_mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.g)();
  const LEFT_MARGIN = conf2.leftMargin ? conf2.leftMargin : 50;
  diagObj.db.clear();
  diagObj.parser.parse(text + "\n");
  _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.l.debug("timeline", diagObj.db);
  ...
  _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.l.debug("task", tasks2);
  svgDraw.initGraphics(svg);
  const sections2 = diagObj.db.getSections();
  _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.l.debug("sections", sections2);
  ...
  sections2.forEach(function(section) {
    ...
    _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.l.debug("sectionHeight before draw", sectionHeight);
    maxSectionHeight = Math.max(maxSectionHeight, sectionHeight + 20);
  });
  let maxEventCount = 0;
  let maxEventLineLength = 0;
  _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.l.debug("tasks.length", tasks2.length);
  for (const [i, task] of tasks2.entries()) {
    ...
    _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.l.debug("taskHeight before draw", taskHeight);
  ...
  _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.l.debug("maxSectionHeight before draw", maxSectionHeight);
  _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.l.debug("maxTaskHeight before draw", maxTaskHeight);
  if (sections2 && sections2.length > 0) {
    sections2.forEach((section) => {
      ...
      _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.l.debug("sectionNode", sectionNode);
      const sectionNodeWrapper = svg.append("g");
      const node = svgDraw.drawNode(sectionNodeWrapper, sectionNode, sectionNumber, conf2);
      _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.l.debug("sectionNode output", node);
  ...
  _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.l.debug("bounds", box);
  if (title) {
  ...
  (0,_mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.s)(
    void 0,
    svg,
...
const drawTasks = function(diagram2, tasks2, sectionColor, masterX, masterY, maxTaskHeight, conf2, maxEventCount, maxEventLineLength, maxSectionHeight, isWithoutSections) {
  for (const task of tasks2) {
    ...
    _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.l.debug("taskNode", taskNode);
    const taskWrapper = diagram2.append("g").attr("class", "taskWrapper");
    const node = svgDraw.drawNode(taskWrapper, taskNode, sectionColor, conf2);
    const taskHeight = node.height;
    _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.l.debug("taskHeight after draw", taskHeight);
    ...
    masterX = masterX + 200;
    if (isWithoutSections && !(0,_mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.g)().timeline.disableMulticolor) {
      sectionColor++;
    }
  }
  masterY = masterY - 10;
...
const drawEvents = function(diagram2, events, sectionColor, masterX, masterY, conf2) {
  ...
  for (const event of events) {
    ...
    _mermaid_ae477ddf_js__WEBPACK_IMPORTED_MODULE_16__.l.debug("eventNode", eventNode);
...
const genSections = (options) => {
  ...
  for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
    ...
    if ((0,khroma__WEBPACK_IMPORTED_MODULE_17__["default"])(options["lineColor" + i])) {
      options["lineColor" + i] = (0,khroma__WEBPACK_IMPORTED_MODULE_18__["default"])(options["lineColor" + i], 20);
    } else {
      options["lineColor" + i] = (0,khroma__WEBPACK_IMPORTED_MODULE_19__["default"])(options["lineColor" + i], 20);
    }
  }
  for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
    const sw = "" + (17 - 3 * i);
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_timeline-definition-8e5a9bc6_js.8e4504a1f9ebfe017e71.js.map