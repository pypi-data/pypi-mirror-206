...
class SpringDamperSteadyStateSynchronousResponseAtASpeed(_3522.CouplingSteadyStateSynchronousResponseAtASpeed):
    """SpringDamperSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_SpringDamperSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'SpringDamperSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def spring_damper_steady_state_synchronous_response_at_a_speed(self) -> 'SpringDamperSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperSteadyStateSynchronousResponseAtASpeed._Cast_SpringDamperSteadyStateSynchronousResponseAtASpeed':
