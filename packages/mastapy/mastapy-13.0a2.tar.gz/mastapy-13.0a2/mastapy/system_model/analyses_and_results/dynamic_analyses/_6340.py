...
class ShaftHubConnectionDynamicAnalysis(_6279.ConnectorDynamicAnalysis):
    """ShaftHubConnectionDynamicAnalysis
    ...
    class _Cast_ShaftHubConnectionDynamicAnalysis:
        ...
        def __init__(self, parent: 'ShaftHubConnectionDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def shaft_hub_connection_dynamic_analysis(self) -> 'ShaftHubConnectionDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftHubConnectionDynamicAnalysis._Cast_ShaftHubConnectionDynamicAnalysis':
