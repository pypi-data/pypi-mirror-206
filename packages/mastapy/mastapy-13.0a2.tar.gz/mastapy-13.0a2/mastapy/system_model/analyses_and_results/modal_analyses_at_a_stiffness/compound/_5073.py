...
class SynchroniserCompoundModalAnalysisAtAStiffness(_5058.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """SynchroniserCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_SynchroniserCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'SynchroniserCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def synchroniser_compound_modal_analysis_at_a_stiffness(self) -> 'SynchroniserCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4945.SynchroniserModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4945.SynchroniserModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserCompoundModalAnalysisAtAStiffness._Cast_SynchroniserCompoundModalAnalysisAtAStiffness':
