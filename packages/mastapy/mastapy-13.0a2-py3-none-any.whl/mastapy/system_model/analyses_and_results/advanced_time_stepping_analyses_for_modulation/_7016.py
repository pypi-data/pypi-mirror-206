...
class CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation(_7072.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def cycloidal_assembly_advanced_time_stepping_analysis_for_modulation(self) -> 'CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation._Cast_CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation(self)
