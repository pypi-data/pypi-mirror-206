...
class SpiralBevelGearModalAnalysisAtAStiffness(_4847.BevelGearModalAnalysisAtAStiffness):
    """SpiralBevelGearModalAnalysisAtAStiffness
    ...
    class _Cast_SpiralBevelGearModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'SpiralBevelGearModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_modal_analysis_at_a_stiffness(self) -> 'SpiralBevelGearModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearModalAnalysisAtAStiffness._Cast_SpiralBevelGearModalAnalysisAtAStiffness':
