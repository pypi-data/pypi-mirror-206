...
from mastapy.gears.gear_designs.conical import _1162, _1150
...
class KlingelnbergConicalGearSetDesign(_1150.ConicalGearSetDesign):
    """KlingelnbergConicalGearSetDesign
    ...
    class _Cast_KlingelnbergConicalGearSetDesign:
        ...
        def __init__(self, parent: 'KlingelnbergConicalGearSetDesign'):
            self._parent = parent
        ...
        @property
        def klingelnberg_conical_gear_set_design(self) -> 'KlingelnbergConicalGearSetDesign':
            return self._parent
    ...
    @property
    def gear_finish(self) -> '_1162.KlingelnbergFinishingMethods':
        ...
        value = conversion.pn_to_mp_enum(temp, _1162.KlingelnbergFinishingMethods)
        return constructor.new_from_mastapy_type(_1162.KlingelnbergFinishingMethods)(value) if value is not None else None

    @gear_finish.setter
    def gear_finish(self, value: '_1162.KlingelnbergFinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1162.KlingelnbergFinishingMethods.type_())
    ...
    @property
    def conical_meshes(self) -> 'List[_977.KlingelnbergConicalGearMeshDesign]':
    ...
    @property
    def klingelnberg_conical_meshes(self) -> 'List[_977.KlingelnbergConicalGearMeshDesign]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergConicalGearSetDesign._Cast_KlingelnbergConicalGearSetDesign':
