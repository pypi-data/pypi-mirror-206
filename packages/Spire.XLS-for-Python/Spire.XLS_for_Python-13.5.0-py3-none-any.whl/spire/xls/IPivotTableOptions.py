...
class IPivotTableOptions (SpireObject) :
    ...
    def ShowAsteriskTotals(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_ShowAsteriskTotals(self.Ptr)
        return ret
    ...
    def ShowAsteriskTotals(self, value:bool):
        ...
        GetDllLibXls().IPivotTableOptions_set_ShowAsteriskTotals(self.Ptr, value)
    ...
    def ColumnHeaderCaption(self)->str:
        ...
        GetDllLibXls().IPivotTableOptions_get_ColumnHeaderCaption.restype=c_wchar_p
        ret = GetDllLibXls().IPivotTableOptions_get_ColumnHeaderCaption(self.Ptr)
        return ret
    ...
    def ColumnHeaderCaption(self, value:str):
        ...
        GetDllLibXls().IPivotTableOptions_set_ColumnHeaderCaption(self.Ptr, value)
    ...
    def RowHeaderCaption(self)->str:
        ...
        GetDllLibXls().IPivotTableOptions_get_RowHeaderCaption.restype=c_wchar_p
        ret = GetDllLibXls().IPivotTableOptions_get_RowHeaderCaption(self.Ptr)
        return ret
    ...
    def RowHeaderCaption(self, value:str):
        ...
        GetDllLibXls().IPivotTableOptions_set_RowHeaderCaption(self.Ptr, value)
    ...
    def ShowCustomSortList(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_ShowCustomSortList(self.Ptr)
        return ret
    ...
    def ShowCustomSortList(self, value:bool):
        ...
        GetDllLibXls().IPivotTableOptions_set_ShowCustomSortList(self.Ptr, value)
    ...
    def ShowFieldList(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_ShowFieldList(self.Ptr)
        return ret
    ...
    def ShowFieldList(self, value:bool):
        ...
        GetDllLibXls().IPivotTableOptions_set_ShowFieldList(self.Ptr, value)
    ...
    def ShowGridDropZone(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_ShowGridDropZone(self.Ptr)
        return ret
    ...
    def ShowGridDropZone(self, value:bool):
        ...
        GetDllLibXls().IPivotTableOptions_set_ShowGridDropZone(self.Ptr, value)
    ...
    def IsDataEditable(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_IsDataEditable(self.Ptr)
        return ret
    ...
    def IsDataEditable(self, value:bool):
        ...
        GetDllLibXls().IPivotTableOptions_set_IsDataEditable(self.Ptr, value)
    ...
    def EnableFieldProperties(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_EnableFieldProperties(self.Ptr)
        return ret
    ...
    def EnableFieldProperties(self, value:bool):
        ...
        GetDllLibXls().IPivotTableOptions_set_EnableFieldProperties(self.Ptr, value)
    ...
    def Indent(self)->'UInt32':
        ...
        intPtr = GetDllLibXls().IPivotTableOptions_get_Indent(self.Ptr)
    ...
    def Indent(self, value:'UInt32'):
        ...
        GetDllLibXls().IPivotTableOptions_set_Indent(self.Ptr, value.Ptr)
    ...
    def ErrorString(self)->str:
        ...
        GetDllLibXls().IPivotTableOptions_get_ErrorString.restype=c_wchar_p
        ret = GetDllLibXls().IPivotTableOptions_get_ErrorString(self.Ptr)
        return ret
    ...
    def ErrorString(self, value:str):
        ...
        GetDllLibXls().IPivotTableOptions_set_ErrorString(self.Ptr, value)
    ...
    def DisplayErrorString(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_DisplayErrorString(self.Ptr)
        return ret
    ...
    def DisplayErrorString(self, value:bool):
        ...
        GetDllLibXls().IPivotTableOptions_set_DisplayErrorString(self.Ptr, value)
    ...
    def MergeLabels(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_MergeLabels(self.Ptr)
        return ret

    @MergeLabels.setter
    def MergeLabels(self, value:bool):
        GetDllLibXls().IPivotTableOptions_set_MergeLabels.argtypes=[c_void_p, c_bool]
        GetDllLibXls().IPivotTableOptions_set_MergeLabels(self.Ptr, value)
    ...
    def PageFieldWrapCount(self)->int:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_PageFieldWrapCount(self.Ptr)
        return ret
    ...
    def PageFieldWrapCount(self, value:int):
        ...
        GetDllLibXls().IPivotTableOptions_set_PageFieldWrapCount(self.Ptr, value)
    ...
    def PageFieldsOrder(self)->'PivotPageAreaFieldsOrderType':
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_PageFieldsOrder(self.Ptr)
    ...
    def PageFieldsOrder(self, value:'PivotPageAreaFieldsOrderType'):
        ...
        GetDllLibXls().IPivotTableOptions_set_PageFieldsOrder(self.Ptr, value.value)
    ...
    def DisplayNullString(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_DisplayNullString(self.Ptr)
        return ret
    ...
    def DisplayNullString(self, value:bool):
        ...
        GetDllLibXls().IPivotTableOptions_set_DisplayNullString(self.Ptr, value)
    ...
    def NullString(self)->str:
        ...
        GetDllLibXls().IPivotTableOptions_get_NullString.restype=c_wchar_p
        ret = GetDllLibXls().IPivotTableOptions_get_NullString(self.Ptr)
        return ret
    ...
    def NullString(self, value:str):
        ...
        GetDllLibXls().IPivotTableOptions_set_NullString(self.Ptr, value)
    ...
    def PreserveFormatting(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_PreserveFormatting(self.Ptr)
        return ret
    ...
    def PreserveFormatting(self, value:bool):
        ...
        GetDllLibXls().IPivotTableOptions_set_PreserveFormatting(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_IsAutoFormat(self.Ptr)
        return ret

    @IsAutoFormat.setter
    def IsAutoFormat(self, value:bool):
        GetDllLibXls().IPivotTableOptions_set_IsAutoFormat.argtypes=[c_void_p, c_bool]
        GetDllLibXls().IPivotTableOptions_set_IsAutoFormat(self.Ptr, value)
    ...
    def ShowTooltips(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_ShowTooltips(self.Ptr)
        return ret

    @ShowTooltips.setter
    def ShowTooltips(self, value:bool):
        GetDllLibXls().IPivotTableOptions_set_ShowTooltips.argtypes=[c_void_p, c_bool]
        GetDllLibXls().IPivotTableOptions_set_ShowTooltips(self.Ptr, value)
    ...
    def DisplayFieldCaptions(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_DisplayFieldCaptions(self.Ptr)
        return ret
    ...
    def DisplayFieldCaptions(self, value:bool):
        ...
        GetDllLibXls().IPivotTableOptions_set_DisplayFieldCaptions(self.Ptr, value)
    ...
    def PrintTitles(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_PrintTitles(self.Ptr)
        return ret

    @PrintTitles.setter
    def PrintTitles(self, value:bool):
        GetDllLibXls().IPivotTableOptions_set_PrintTitles.argtypes=[c_void_p, c_bool]
        GetDllLibXls().IPivotTableOptions_set_PrintTitles(self.Ptr, value)
    ...
    def IsSaveData(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_IsSaveData(self.Ptr)
        return ret

    @IsSaveData.setter
    def IsSaveData(self, value:bool):
        GetDllLibXls().IPivotTableOptions_set_IsSaveData.argtypes=[c_void_p, c_bool]
        GetDllLibXls().IPivotTableOptions_set_IsSaveData(self.Ptr, value)
    ...
    def ReportLayout(self)->'PivotTableLayoutType':
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_ReportLayout(self.Ptr)
    ...
    def ReportLayout(self, value:'PivotTableLayoutType'):
        ...
        GetDllLibXls().IPivotTableOptions_set_ReportLayout(self.Ptr, value.value)
    ...
    def RowLayout(self)->'PivotTableLayoutType':
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_RowLayout(self.Ptr)
        objwraped = PivotTableLayoutType(ret)
        return objwraped
    ...
    def RowLayout(self, value:'PivotTableLayoutType'):
        ...
        GetDllLibXls().IPivotTableOptions_set_RowLayout(self.Ptr, value.value)
    ...
    def ShowDrillIndicators(self)->bool:
        ...
        ret = GetDllLibXls().IPivotTableOptions_get_ShowDrillIndicators(self.Ptr)
        return ret
    ...
    def ShowDrillIndicators(self, value:bool):
        ...
        GetDllLibXls().IPivotTableOptions_set_ShowDrillIndicators(self.Ptr, value)
    ...
    def DataPosition(self)->'Int16':
        ...
        intPtr = GetDllLibXls().IPivotTableOptions_get_DataPosition(self.Ptr)
    ...
    def DataPosition(self, value:'Int16'):
        ...
        GetDllLibXls().IPivotTableOptions_set_DataPosition(self.Ptr, value.Ptr)
