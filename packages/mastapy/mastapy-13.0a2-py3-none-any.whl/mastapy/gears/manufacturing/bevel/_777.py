...
from mastapy.gears.gear_designs.conical.micro_geometry import _1167
...
class ConicalMeshFlankMicroGeometryConfig(_0.APIBase):
    ...
    class _Cast_ConicalMeshFlankMicroGeometryConfig:
        ...
        def __init__(self, parent: 'ConicalMeshFlankMicroGeometryConfig'):
            self._parent = parent

        @property
        def conical_mesh_flank_manufacturing_config(self):
            from mastapy.gears.manufacturing.bevel import _776
            
            return self._parent._cast(_776.ConicalMeshFlankManufacturingConfig)

        @property
        def conical_mesh_flank_nurbs_micro_geometry_config(self):
            from mastapy.gears.manufacturing.bevel import _778
            
            return self._parent._cast(_778.ConicalMeshFlankNurbsMicroGeometryConfig)

        @property
        def conical_mesh_flank_micro_geometry_config(self) -> 'ConicalMeshFlankMicroGeometryConfig':
            return self._parent
    ...
    @property
    def specified_ease_off_surface(self) -> '_1167.ConicalGearFlankMicroGeometry':
    ...
    @property
    def cast_to(self) -> 'ConicalMeshFlankMicroGeometryConfig._Cast_ConicalMeshFlankMicroGeometryConfig':
