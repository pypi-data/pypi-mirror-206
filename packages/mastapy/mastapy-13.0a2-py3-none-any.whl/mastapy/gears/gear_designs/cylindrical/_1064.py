...
from mastapy.gears.gear_designs.cylindrical import _1065, _1066, _1067
...
class Scuffing(_1575.IndependentReportablePropertiesBase['Scuffing']):
    """Scuffing
    ...
    class _Cast_Scuffing:
        ...
        def __init__(self, parent: 'Scuffing'):
            self._parent = parent
    ...
    @property
    def scuffing_temperature_method_agma(self) -> '_1066.ScuffingTemperatureMethodsAGMA':
    ...
    def scuffing_temperature_method_agma(self, value: '_1066.ScuffingTemperatureMethodsAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1066.ScuffingTemperatureMethodsAGMA.type_())
        self.wrapped.ScuffingTemperatureMethodAGMA = value

    @property
    def scuffing_temperature_method_iso(self) -> '_1067.ScuffingTemperatureMethodsISO':
    ...
    def scuffing_temperature_method_iso(self, value: '_1067.ScuffingTemperatureMethodsISO'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1067.ScuffingTemperatureMethodsISO.type_())
    ...
    @property
    def cast_to(self) -> 'Scuffing._Cast_Scuffing':
