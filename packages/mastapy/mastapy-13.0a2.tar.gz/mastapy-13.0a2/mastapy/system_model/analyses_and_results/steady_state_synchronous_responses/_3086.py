...
class TorqueConverterTurbineSteadyStateSynchronousResponse(_3000.CouplingHalfSteadyStateSynchronousResponse):
    """TorqueConverterTurbineSteadyStateSynchronousResponse
    ...
    class _Cast_TorqueConverterTurbineSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_steady_state_synchronous_response(self) -> 'TorqueConverterTurbineSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineSteadyStateSynchronousResponse._Cast_TorqueConverterTurbineSteadyStateSynchronousResponse':
