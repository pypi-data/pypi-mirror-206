...
class SpiralBevelGearAdvancedSystemDeflection(_7251.BevelGearAdvancedSystemDeflection):
    """SpiralBevelGearAdvancedSystemDeflection
    ...
    class _Cast_SpiralBevelGearAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'SpiralBevelGearAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_advanced_system_deflection(self) -> 'SpiralBevelGearAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearAdvancedSystemDeflection._Cast_SpiralBevelGearAdvancedSystemDeflection':
