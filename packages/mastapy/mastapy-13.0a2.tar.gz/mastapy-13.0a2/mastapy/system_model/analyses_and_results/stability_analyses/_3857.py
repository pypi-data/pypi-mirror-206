...
class StraightBevelSunGearStabilityAnalysis(_3852.StraightBevelDiffGearStabilityAnalysis):
    """StraightBevelSunGearStabilityAnalysis
    ...
    class _Cast_StraightBevelSunGearStabilityAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelSunGearStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_sun_gear_stability_analysis(self) -> 'StraightBevelSunGearStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelSunGearStabilityAnalysis._Cast_StraightBevelSunGearStabilityAnalysis':
