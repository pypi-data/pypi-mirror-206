...
class ClutchHalfSteadyStateSynchronousResponseAtASpeed(_3521.CouplingHalfSteadyStateSynchronousResponseAtASpeed):
    """ClutchHalfSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ClutchHalfSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ClutchHalfSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def clutch_half_steady_state_synchronous_response_at_a_speed(self) -> 'ClutchHalfSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchHalfSteadyStateSynchronousResponseAtASpeed._Cast_ClutchHalfSteadyStateSynchronousResponseAtASpeed':
