...
class FEPartCriticalSpeedAnalysis(_6510.AbstractShaftOrHousingCriticalSpeedAnalysis):
    """FEPartCriticalSpeedAnalysis
    ...
    class _Cast_FEPartCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'FEPartCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def fe_part_critical_speed_analysis(self) -> 'FEPartCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FEPartCriticalSpeedAnalysis._Cast_FEPartCriticalSpeedAnalysis':
