...
class WormGearMeshParametricStudyTool(_4336.GearMeshParametricStudyTool):
    """WormGearMeshParametricStudyTool
    ...
    class _Cast_WormGearMeshParametricStudyTool:
        ...
        def __init__(self, parent: 'WormGearMeshParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def worm_gear_mesh_parametric_study_tool(self) -> 'WormGearMeshParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearMeshParametricStudyTool._Cast_WormGearMeshParametricStudyTool':
