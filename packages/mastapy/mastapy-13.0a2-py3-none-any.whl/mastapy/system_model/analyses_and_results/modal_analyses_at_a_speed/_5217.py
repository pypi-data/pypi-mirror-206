...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5216, _5215, _5107
...
class ZerolBevelGearSetModalAnalysisAtASpeed(_5107.BevelGearSetModalAnalysisAtASpeed):
    """ZerolBevelGearSetModalAnalysisAtASpeed
    ...
    class _Cast_ZerolBevelGearSetModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_modal_analysis_at_a_speed(self) -> 'ZerolBevelGearSetModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def zerol_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_5216.ZerolBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_5215.ZerolBevelGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetModalAnalysisAtASpeed._Cast_ZerolBevelGearSetModalAnalysisAtASpeed':
