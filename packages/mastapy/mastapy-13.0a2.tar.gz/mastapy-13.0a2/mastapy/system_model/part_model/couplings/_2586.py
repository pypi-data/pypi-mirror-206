...
from mastapy.system_model.part_model.couplings import _2587, _2589, _2562
...
class TorqueConverter(_2562.Coupling):
    """TorqueConverter
    ...
    @property
    def pump(self) -> '_2587.TorqueConverterPump':
    ...
    @property
    def turbine(self) -> '_2589.TorqueConverterTurbine':
