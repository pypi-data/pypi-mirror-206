...
class UtilityMethods (SpireObject) :
    ...
    def SetPdfLogFile(path:str):
        ...
        GetDllLibXls().UtilityMethods_SetPdfLogFile( path)
    ...
    def SetLogFile(path:str):
        ...
        GetDllLibXls().UtilityMethods_SetLogFile( path)
    ...
    def SpecialSymbolConvertForStyleName(s:str)->str:
        ...
        GetDllLibXls().UtilityMethods_SpecialSymbolConvertForStyleName.restype=c_wchar_p
        ret = GetDllLibXls().UtilityMethods_SpecialSymbolConvertForStyleName( s)
        return ret
    ...
    def StandardResolution()->float:
        ...
        ret = GetDllLibXls().UtilityMethods_StandardResolution()
        return ret
