...
class XlsHPageBreaksCollection (  CollectionBase[HPageBreak], IHPageBreaks) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsHPageBreaksCollection_get_ManualBreakCount(self.Ptr)
        return ret
    ...
    def RecordCode(self)->int:
        ...
        ret = GetDllLibXls().XlsHPageBreaksCollection_get_RecordCode(self.Ptr)
        return ret
    ...
    def NeedDataArray(self)->bool:
        ...
        ret = GetDllLibXls().XlsHPageBreaksCollection_get_NeedDataArray(self.Ptr)
        return ret
    ...
    def StreamPos(self)->int:
        ...
        ret = GetDllLibXls().XlsHPageBreaksCollection_get_StreamPos(self.Ptr)
        return ret

    @StreamPos.setter
    def StreamPos(self, value:int):
        GetDllLibXls().XlsHPageBreaksCollection_set_StreamPos.argtypes=[c_void_p, c_long]
        GetDllLibXls().XlsHPageBreaksCollection_set_StreamPos(self.Ptr, value)
    ...
    <returns>A clone of the current collection.</returns>
        ...
        intPtr = GetDllLibXls().XlsHPageBreaksCollection_Clone(self.Ptr, intPtrparent)
