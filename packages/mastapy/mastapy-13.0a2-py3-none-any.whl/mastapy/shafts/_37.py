...
class ShaftSectionEndDamageResults(_0.APIBase):
    ...
    class _Cast_ShaftSectionEndDamageResults:
        ...
        def __init__(self, parent: 'ShaftSectionEndDamageResults'):
            self._parent = parent

        @property
        def shaft_section_end_damage_results(self) -> 'ShaftSectionEndDamageResults':
            return self._parent
    ...
    def section_end(self) -> '_83.SectionEnd':
        ...
        value = conversion.pn_to_mp_enum(temp, _83.SectionEnd)
    ...
    @property
    def sn_curve(self) -> '_277.SNCurve':
    ...
    @property
    def sn_curve_axial(self) -> '_277.SNCurve':
    ...
    @property
    def sn_curve_bending_x(self) -> '_277.SNCurve':
    ...
    @property
    def sn_curve_bending_y(self) -> '_277.SNCurve':
    ...
    @property
    def sn_curve_torsional(self) -> '_277.SNCurve':
    ...
    @property
    def cast_to(self) -> 'ShaftSectionEndDamageResults._Cast_ShaftSectionEndDamageResults':
