...
class ClutchHalfModalAnalysis(_4586.CouplingHalfModalAnalysis):
    """ClutchHalfModalAnalysis
    ...
    class _Cast_ClutchHalfModalAnalysis:
        ...
        def __init__(self, parent: 'ClutchHalfModalAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_half_modal_analysis(self) -> 'ClutchHalfModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchHalfModalAnalysis._Cast_ClutchHalfModalAnalysis':
