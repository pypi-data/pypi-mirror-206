...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import (
    _3882, _3884, _3887, _3894,
    _3893, _3915, _3895, _3900,
    _3905, _3917, _3919, _3923,
    _3930, _3929, _3931, _3938,
    _3945, _3948, _3949, _3950,
    _3952, _3954, _3959, _3960,
    _3961, _3963, _3965, _3970,
    _3969, _3975, _3976, _3981,
    _3984, _3987, _3991, _3995,
    _3999, _4002, _3874
)
...
class AssemblyCompoundStabilityAnalysis(_3874.AbstractAssemblyCompoundStabilityAnalysis):
    """AssemblyCompoundStabilityAnalysis
    ...
    class _Cast_AssemblyCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'AssemblyCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def assembly_compound_stability_analysis(self) -> 'AssemblyCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3749.AssemblyStabilityAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_3882.BearingCompoundStabilityAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_3884.BeltDriveCompoundStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3887.BevelDifferentialGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3894.BoltedJointCompoundStabilityAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_3893.BoltCompoundStabilityAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_3915.CVTCompoundStabilityAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_3895.ClutchCompoundStabilityAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3900.ConceptCouplingCompoundStabilityAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3905.ConceptGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3917.CycloidalAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3919.CycloidalDiscCompoundStabilityAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3923.CylindricalGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_3930.FEPartCompoundStabilityAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3929.FaceGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3931.FlexiblePinAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3938.HypoidGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3945.KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3948.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_3949.MassDiscCompoundStabilityAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_3950.MeasurementComponentCompoundStabilityAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_3952.OilSealCompoundStabilityAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3954.PartToPartShearCouplingCompoundStabilityAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3959.PlanetCarrierCompoundStabilityAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_3960.PointLoadCompoundStabilityAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_3961.PowerLoadCompoundStabilityAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_3963.RingPinsCompoundStabilityAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3965.RollingRingAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3970.ShaftHubConnectionCompoundStabilityAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_3969.ShaftCompoundStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3975.SpiralBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3976.SpringDamperCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3981.StraightBevelDiffGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3984.StraightBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_3987.SynchroniserCompoundStabilityAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_3991.TorqueConverterCompoundStabilityAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3995.UnbalancedMassCompoundStabilityAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3999.WormGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4002.ZerolBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3749.AssemblyStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'AssemblyCompoundStabilityAnalysis._Cast_AssemblyCompoundStabilityAnalysis':
