...
class ConceptCouplingConnectionCompoundStabilityAnalysis(_3912.CouplingConnectionCompoundStabilityAnalysis):
    """ConceptCouplingConnectionCompoundStabilityAnalysis
    ...
    class _Cast_ConceptCouplingConnectionCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_compound_stability_analysis(self) -> 'ConceptCouplingConnectionCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3768.ConceptCouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3768.ConceptCouplingConnectionStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionCompoundStabilityAnalysis._Cast_ConceptCouplingConnectionCompoundStabilityAnalysis':
