...
from mastapy.system_model.part_model.part_groups import _2467, _2469, _2466
...
class ParallelPartGroup(_2466.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    class _Cast_ParallelPartGroup:
        ...
        def part_group(self):
            ...
            return self._parent._cast(_2471.PartGroup)
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2467.ConcentricPartGroup]':
    ...
    @property
    def design_measurements(self) -> 'List[_2469.DesignMeasurements]':
