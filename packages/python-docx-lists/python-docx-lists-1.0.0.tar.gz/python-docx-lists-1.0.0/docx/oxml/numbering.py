...
from .simpletypes import (
        ...
        ST_TwipsMeasure, ST_SignedTwipsMeasure, ST_OnOff, ST_LongHexNumber, ST_LevelJustification
)
...
class CT_Leveljustification(BaseOxmlElement):
    """
    Pohui
    """
    val = RequiredAttribute('w:val', ST_LevelJustification)
