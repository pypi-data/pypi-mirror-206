...
class RollingRingCompoundSystemDeflection(_2869.CouplingHalfCompoundSystemDeflection):
    """RollingRingCompoundSystemDeflection
    ...
    class _Cast_RollingRingCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'RollingRingCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def rolling_ring_compound_system_deflection(self) -> 'RollingRingCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2778.RollingRingSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2778.RollingRingSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'RollingRingCompoundSystemDeflection._Cast_RollingRingCompoundSystemDeflection':
