...
class SpringDamperCompoundHarmonicAnalysis(_5883.CouplingCompoundHarmonicAnalysis):
    """SpringDamperCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5784.SpringDamperHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5784.SpringDamperHarmonicAnalysis]':
