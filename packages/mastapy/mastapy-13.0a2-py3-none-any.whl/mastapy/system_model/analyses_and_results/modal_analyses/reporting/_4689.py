...
class CalculateFullFEResultsForMode(_0.APIBase):
    ...
    class _Cast_CalculateFullFEResultsForMode:
        ...
        def __init__(self, parent: 'CalculateFullFEResultsForMode'):
            self._parent = parent

        @property
        def calculate_full_fe_results_for_mode(self) -> 'CalculateFullFEResultsForMode':
            return self._parent
    ...
    @property
    def fe_results(self) -> 'List[_4693.ModalCMSResultsForModeAndFE]':
    ...
    @property
    def cast_to(self) -> 'CalculateFullFEResultsForMode._Cast_CalculateFullFEResultsForMode':
