...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5059, _5060, _4978
...
class SpiralBevelGearSetCompoundModalAnalysisAtAStiffness(_4978.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """SpiralBevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_SpiralBevelGearSetCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'SpiralBevelGearSetCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_set_compound_modal_analysis_at_a_stiffness(self) -> 'SpiralBevelGearSetCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4932.SpiralBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5059.SpiralBevelGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5060.SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4932.SpiralBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearSetCompoundModalAnalysisAtAStiffness._Cast_SpiralBevelGearSetCompoundModalAnalysisAtAStiffness':
