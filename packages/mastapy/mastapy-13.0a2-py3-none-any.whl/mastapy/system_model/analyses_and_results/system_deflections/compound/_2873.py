...
class CycloidalAssemblyCompoundSystemDeflection(_2930.SpecialisedAssemblyCompoundSystemDeflection):
    """CycloidalAssemblyCompoundSystemDeflection
    ...
    class _Cast_CycloidalAssemblyCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'CycloidalAssemblyCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def cycloidal_assembly_compound_system_deflection(self) -> 'CycloidalAssemblyCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2714.CycloidalAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2714.CycloidalAssemblySystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'CycloidalAssemblyCompoundSystemDeflection._Cast_CycloidalAssemblyCompoundSystemDeflection':
