...
class BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed(_3499.BevelGearMeshSteadyStateSynchronousResponseAtASpeed):
    """BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_steady_state_synchronous_response_at_a_speed(self) -> 'BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed._Cast_BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed(self)
