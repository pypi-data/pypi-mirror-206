...
class XlsCheckBoxShape (  XlsShape, ICheckBox) :
    ...
    def CheckState(self)->'CheckState':
        ...
        ret = GetDllLibXls().XlsCheckBoxShape_get_CheckState(self.Ptr)
    ...
    def CheckState(self, value:'CheckState'):
        ...
        GetDllLibXls().XlsCheckBoxShape_set_CheckState(self.Ptr, value.value)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().XlsCheckBoxShape_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsCheckBoxShape_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsCheckBoxShape_set_Text(self.Ptr, value)
    ...
    def IsTextLocked(self)->bool:
        ...
        ret = GetDllLibXls().XlsCheckBoxShape_get_IsTextLocked(self.Ptr)
        return ret

    @IsTextLocked.setter
    def IsTextLocked(self, value:bool):
        GetDllLibXls().XlsCheckBoxShape_set_IsTextLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsCheckBoxShape_set_IsTextLocked(self.Ptr, value)
    ...
    def Display3DShading(self)->bool:
        ...
        ret = GetDllLibXls().XlsCheckBoxShape_get_Display3DShading(self.Ptr)
        return ret
    ...
    def Display3DShading(self, value:bool):
        ...
        GetDllLibXls().XlsCheckBoxShape_set_Display3DShading(self.Ptr, value)
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsCheckBoxShape_get_ShapeType(self.Ptr)
    ...
    def HAlignment(self)->'CommentHAlignType':
        ...
        ret = GetDllLibXls().XlsCheckBoxShape_get_HAlignment(self.Ptr)
    ...
    def HAlignment(self, value:'CommentHAlignType'):
        ...
        GetDllLibXls().XlsCheckBoxShape_set_HAlignment(self.Ptr, value.value)
    ...
    def VAlignment(self)->'CommentVAlignType':
        ...
        ret = GetDllLibXls().XlsCheckBoxShape_get_VAlignment(self.Ptr)
    ...
    def VAlignment(self, value:'CommentVAlignType'):
        ...
        GetDllLibXls().XlsCheckBoxShape_set_VAlignment(self.Ptr, value.value)
    ...
    def TextRotation(self)->'TextRotationType':
        ...
        ret = GetDllLibXls().XlsCheckBoxShape_get_TextRotation(self.Ptr)
    ...
    def TextRotation(self, value:'TextRotationType'):
        ...
        GetDllLibXls().XlsCheckBoxShape_set_TextRotation(self.Ptr, value.value)
...
#        intPtr = GetDllLibXls().XlsCheckBoxShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
