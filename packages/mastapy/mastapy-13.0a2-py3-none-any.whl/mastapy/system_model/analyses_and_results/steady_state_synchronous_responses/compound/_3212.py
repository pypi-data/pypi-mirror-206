...
class TorqueConverterCompoundSteadyStateSynchronousResponse(_3132.CouplingCompoundSteadyStateSynchronousResponse):
    """TorqueConverterCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_TorqueConverterCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'TorqueConverterCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def torque_converter_compound_steady_state_synchronous_response(self) -> 'TorqueConverterCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3085.TorqueConverterSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3085.TorqueConverterSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterCompoundSteadyStateSynchronousResponse._Cast_TorqueConverterCompoundSteadyStateSynchronousResponse':
