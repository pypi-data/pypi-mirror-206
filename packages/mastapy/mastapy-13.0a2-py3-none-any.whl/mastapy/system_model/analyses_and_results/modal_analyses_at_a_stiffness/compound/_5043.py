...
class PlanetaryConnectionCompoundModalAnalysisAtAStiffness(_5057.ShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """PlanetaryConnectionCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_PlanetaryConnectionCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'PlanetaryConnectionCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def planetary_connection_compound_modal_analysis_at_a_stiffness(self) -> 'PlanetaryConnectionCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4914.PlanetaryConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4914.PlanetaryConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'PlanetaryConnectionCompoundModalAnalysisAtAStiffness._Cast_PlanetaryConnectionCompoundModalAnalysisAtAStiffness':
