...
class PivotItem (SpireObject) :
    ...
    def IsExpaned(self)->bool:
        ...
        ret = GetDllLibXls().PivotItem_get_IsExpaned(self.Ptr)
        return ret

    @IsExpaned.setter
    def IsExpaned(self, value:bool):
        GetDllLibXls().PivotItem_set_IsExpaned.argtypes=[c_void_p, c_bool]
        GetDllLibXls().PivotItem_set_IsExpaned(self.Ptr, value)
    ...
    def DrillAcross(self)->bool:
        ...
        ret = GetDllLibXls().PivotItem_get_DrillAcross(self.Ptr)
        return ret

    @DrillAcross.setter
    def DrillAcross(self, value:bool):
        GetDllLibXls().PivotItem_set_DrillAcross.argtypes=[c_void_p, c_bool]
        GetDllLibXls().PivotItem_set_DrillAcross(self.Ptr, value)
    ...
    def IsCalculatedItem(self)->bool:
        ...
        ret = GetDllLibXls().PivotItem_get_IsCalculatedItem(self.Ptr)
        return ret
    ...
    def IsCalculatedItem(self, value:bool):
        ...
        GetDllLibXls().PivotItem_set_IsCalculatedItem(self.Ptr, value)
    ...
    def IsHidden(self)->bool:
        ...
        ret = GetDllLibXls().PivotItem_get_IsHidden(self.Ptr)
        return ret

    @IsHidden.setter
    def IsHidden(self, value:bool):
        GetDllLibXls().PivotItem_set_IsHidden.argtypes=[c_void_p, c_bool]
        GetDllLibXls().PivotItem_set_IsHidden(self.Ptr, value)
    ...
    def IsMissing(self)->bool:
        ...
        ret = GetDllLibXls().PivotItem_get_IsMissing(self.Ptr)
        return ret

    @IsMissing.setter
    def IsMissing(self, value:bool):
        GetDllLibXls().PivotItem_set_IsMissing.argtypes=[c_void_p, c_bool]
        GetDllLibXls().PivotItem_set_IsMissing(self.Ptr, value)
    ...
    def UserCaption(self)->str:
        ...
        GetDllLibXls().PivotItem_get_UserCaption.restype=c_wchar_p
        ret = GetDllLibXls().PivotItem_get_UserCaption(self.Ptr)
        return ret
    ...
    def IsChar(self)->bool:
        ...
        ret = GetDllLibXls().PivotItem_get_IsChar(self.Ptr)
        return ret

    @IsChar.setter
    def IsChar(self, value:bool):
        GetDllLibXls().PivotItem_set_IsChar.argtypes=[c_void_p, c_bool]
        GetDllLibXls().PivotItem_set_IsChar(self.Ptr, value)
    ...
    def IsHiddenDetails(self)->bool:
        ...
        ret = GetDllLibXls().PivotItem_get_IsHiddenDetails(self.Ptr)
        return ret
    ...
    def IsHiddenDetails(self, value:bool):
        ...
        GetDllLibXls().PivotItem_set_IsHiddenDetails(self.Ptr, value)
    ...
    def ItemType(self)->'PivotItemType':
        ...
        ret = GetDllLibXls().PivotItem_get_ItemType(self.Ptr)
    ...
    def ItemType(self, value:'PivotItemType'):
        ...
        GetDllLibXls().PivotItem_set_ItemType(self.Ptr, value.value)
