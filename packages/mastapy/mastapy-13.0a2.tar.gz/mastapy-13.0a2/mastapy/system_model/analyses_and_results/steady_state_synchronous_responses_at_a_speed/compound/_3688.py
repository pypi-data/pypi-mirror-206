...
class MassDiscCompoundSteadyStateSynchronousResponseAtASpeed(_3735.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """MassDiscCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3558.MassDiscSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3558.MassDiscSteadyStateSynchronousResponseAtASpeed]':
