...
class PulleyModalAnalysisAtASpeed(_5127.CouplingHalfModalAnalysisAtASpeed):
    """PulleyModalAnalysisAtASpeed
    ...
    class _Cast_PulleyModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'PulleyModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def pulley_modal_analysis_at_a_speed(self) -> 'PulleyModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PulleyModalAnalysisAtASpeed._Cast_PulleyModalAnalysisAtASpeed':
