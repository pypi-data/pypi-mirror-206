...
class SpiralBevelGearModalAnalysis(_4564.BevelGearModalAnalysis):
    """SpiralBevelGearModalAnalysis
    ...
    class _Cast_SpiralBevelGearModalAnalysis:
        ...
        def __init__(self, parent: 'SpiralBevelGearModalAnalysis'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_modal_analysis(self) -> 'SpiralBevelGearModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearModalAnalysis._Cast_SpiralBevelGearModalAnalysis':
