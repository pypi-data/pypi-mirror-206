...
class SynchroniserHalfCompoundParametricStudyTool(_4533.SynchroniserPartCompoundParametricStudyTool):
    """SynchroniserHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4402.SynchroniserHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4402.SynchroniserHalfParametricStudyTool]':
