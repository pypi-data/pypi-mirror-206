...
class StraightBevelSunGearCompoundDynamicAnalysis(_6478.StraightBevelDiffGearCompoundDynamicAnalysis):
    """StraightBevelSunGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6356.StraightBevelSunGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6356.StraightBevelSunGearDynamicAnalysis]':
