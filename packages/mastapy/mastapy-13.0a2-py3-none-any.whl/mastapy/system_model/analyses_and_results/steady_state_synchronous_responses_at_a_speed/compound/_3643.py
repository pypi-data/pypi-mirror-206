...
class ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_3672.GearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def concept_gear_mesh_compound_steady_state_synchronous_response_at_a_speed(self) -> 'ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3512.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3512.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed._Cast_ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(self)
