...
class CVTPulleyCompoundModalAnalysisAtASpeed(_5306.PulleyCompoundModalAnalysisAtASpeed):
    """CVTPulleyCompoundModalAnalysisAtASpeed
    ...
    class _Cast_CVTPulleyCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'CVTPulleyCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def cvt_pulley_compound_modal_analysis_at_a_speed(self) -> 'CVTPulleyCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5131.CVTPulleyModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5131.CVTPulleyModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'CVTPulleyCompoundModalAnalysisAtASpeed._Cast_CVTPulleyCompoundModalAnalysisAtASpeed':
