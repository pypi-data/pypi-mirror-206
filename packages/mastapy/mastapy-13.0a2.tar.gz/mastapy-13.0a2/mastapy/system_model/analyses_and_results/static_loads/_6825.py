...
from mastapy.system_model.analyses_and_results.static_loads import _6826, _6854
...
class CylindricalGearLoadCase(_6854.GearLoadCase):
    """CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6826.CylindricalGearManufactureError':
    ...
    @property
    def overridden_micro_geometry(self) -> '_1095.CylindricalGearMicroGeometryBase':
