...
class KlingelnbergCycloPalloidHypoidGearMeshPowerFlow(_4076.KlingelnbergCycloPalloidConicalGearMeshPowerFlow):
    """KlingelnbergCycloPalloidHypoidGearMeshPowerFlow
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearMeshPowerFlow:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearMeshPowerFlow'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_mesh_power_flow(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshPowerFlow':
            return self._parent
    ...
    @property
    def rating(self) -> '_404.KlingelnbergCycloPalloidHypoidGearMeshRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_404.KlingelnbergCycloPalloidHypoidGearMeshRating':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshPowerFlow._Cast_KlingelnbergCycloPalloidHypoidGearMeshPowerFlow':
