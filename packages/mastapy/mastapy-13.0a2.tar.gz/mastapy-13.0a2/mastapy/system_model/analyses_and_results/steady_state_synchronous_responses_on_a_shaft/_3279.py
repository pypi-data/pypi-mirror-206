...
class FaceGearSteadyStateSynchronousResponseOnAShaft(_3284.GearSteadyStateSynchronousResponseOnAShaft):
    """FaceGearSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_FaceGearSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'FaceGearSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def face_gear_steady_state_synchronous_response_on_a_shaft(self) -> 'FaceGearSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearSteadyStateSynchronousResponseOnAShaft._Cast_FaceGearSteadyStateSynchronousResponseOnAShaft':
