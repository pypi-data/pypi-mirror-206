...
class SparklineGroupCollection (SpireObject) :
    ...
    def get_Item(self ,index:int)->'SparklineGroup':
        ...
        intPtr = GetDllLibXls().SparklineGroupCollection_get_Item(self.Ptr, index)
    ...
    <summary>
        ...
        GetDllLibXls().SparklineGroupCollection_Clear(self.Ptr, intPtrsparklineGroup)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().SparklineGroupCollection_AddGroup(self.Ptr, enumsparklineType)
        ret = None if intPtr==None else SparklineGroup(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().SparklineGroupCollection_AddGroup1(self.Ptr)
        ret = None if intPtr==None else SparklineGroup(intPtr)
        return ret
