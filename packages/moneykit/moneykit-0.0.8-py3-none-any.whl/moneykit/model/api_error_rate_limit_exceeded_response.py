...
class APIErrorRateLimitExceededResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        class properties:
            class error_code(schemas.EnumBase, schemas.StrSchema):
                class MetaOapg:
                    enum_value_to_name = {
                        "api_error.rate_limit_exceeded": "API_ERROR_RATE_LIMIT_EXCEEDED",
                    }

                @schemas.classproperty
                def API_ERROR_RATE_LIMIT_EXCEEDED(cls):
                    return cls("api_error.rate_limit_exceeded")
