...
class CVTModalAnalysisAtAStiffness(_4840.BeltDriveModalAnalysisAtAStiffness):
    """CVTModalAnalysisAtAStiffness
    ...
    class _Cast_CVTModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'CVTModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def cvt_modal_analysis_at_a_stiffness(self) -> 'CVTModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CVTModalAnalysisAtAStiffness._Cast_CVTModalAnalysisAtAStiffness':
