...
telepules = [
    ...
    'Miskolc', 'Mohács', 'Monor', 'Monorierdő', 'Mór', 'Mosonmagyaróvár', 'Múcsony',
    ...
    'Őrbottyán', 'Paks', 'Pálháza', 'Pápa', 'Pásztó', 'Pécs', 'Pécsvárad', 'Pellérd', 'Pétfürdő',
    ...
    'Szombathely', 'Tab', 'Táborfalva', 'Tápiószecső', 'Tapolca', 'Tárnok']
