...
class BoltGeometry(_1816.NamedDatabaseItem):
    """BoltGeometry
    ...
    @property
    def bolt_sections(self) -> 'List[_1460.BoltSection]':
    ...
    def bolt_sections(self, value: 'List[_1460.BoltSection]'):
        value = value if value else None
        value = conversion.mp_to_pn_objects_in_list(value)
        self.wrapped.BoltSections = value

    @property
    def bolt_shank_type(self) -> '_1461.BoltShankType':
        ...
        value = conversion.pn_to_mp_enum(temp, _1461.BoltShankType)
        return constructor.new_from_mastapy_type(_1461.BoltShankType)(value) if value is not None else None

    @bolt_shank_type.setter
    def bolt_shank_type(self, value: '_1461.BoltShankType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1461.BoltShankType.type_())
    ...
    @property
    def standard_size(self) -> '_1472.StandardSizes':
        ...
        value = conversion.pn_to_mp_enum(temp, _1472.StandardSizes)
        return constructor.new_from_mastapy_type(_1472.StandardSizes)(value) if value is not None else None

    @standard_size.setter
    def standard_size(self, value: '_1472.StandardSizes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1472.StandardSizes.type_())
    ...
    @property
    def type_of_bolted_joint(self) -> '_1462.BoltTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, _1462.BoltTypes)
        return constructor.new_from_mastapy_type(_1462.BoltTypes)(value) if value is not None else None

    @type_of_bolted_joint.setter
    def type_of_bolted_joint(self, value: '_1462.BoltTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1462.BoltTypes.type_())
        self.wrapped.TypeOfBoltedJoint = value

    @property
    def type_of_head_cap(self) -> '_1467.HeadCapTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, _1467.HeadCapTypes)
        return constructor.new_from_mastapy_type(_1467.HeadCapTypes)(value) if value is not None else None

    @type_of_head_cap.setter
    def type_of_head_cap(self, value: '_1467.HeadCapTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1467.HeadCapTypes.type_())
        self.wrapped.TypeOfHeadCap = value

    @property
    def type_of_thread(self) -> '_1474.ThreadTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, _1474.ThreadTypes)
        return constructor.new_from_mastapy_type(_1474.ThreadTypes)(value) if value is not None else None

    @type_of_thread.setter
    def type_of_thread(self, value: '_1474.ThreadTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1474.ThreadTypes.type_())
