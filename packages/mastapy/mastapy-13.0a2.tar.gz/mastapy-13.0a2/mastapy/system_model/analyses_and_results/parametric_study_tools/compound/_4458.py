...
class CVTBeltConnectionCompoundParametricStudyTool(_4427.BeltConnectionCompoundParametricStudyTool):
    """CVTBeltConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4311.CVTBeltConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4311.CVTBeltConnectionParametricStudyTool]':
