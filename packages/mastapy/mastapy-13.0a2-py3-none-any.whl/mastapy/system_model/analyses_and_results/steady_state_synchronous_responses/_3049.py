...
class PointLoadSteadyStateSynchronousResponse(_3088.VirtualComponentSteadyStateSynchronousResponse):
    """PointLoadSteadyStateSynchronousResponse
    ...
    class _Cast_PointLoadSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'PointLoadSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def point_load_steady_state_synchronous_response(self) -> 'PointLoadSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PointLoadSteadyStateSynchronousResponse._Cast_PointLoadSteadyStateSynchronousResponse':
