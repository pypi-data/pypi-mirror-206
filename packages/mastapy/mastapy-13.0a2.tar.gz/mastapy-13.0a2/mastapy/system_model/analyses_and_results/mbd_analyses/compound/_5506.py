...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import (
    _5507, _5509, _5512, _5519,
    _5518, _5540, _5520, _5525,
    _5530, _5542, _5544, _5548,
    _5555, _5554, _5556, _5563,
    _5570, _5573, _5574, _5575,
    _5577, _5579, _5584, _5585,
    _5586, _5588, _5590, _5595,
    _5594, _5600, _5601, _5606,
    _5609, _5612, _5616, _5620,
    _5624, _5627, _5499
)
...
class AssemblyCompoundMultibodyDynamicsAnalysis(_5499.AbstractAssemblyCompoundMultibodyDynamicsAnalysis):
    """AssemblyCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_AssemblyCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'AssemblyCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def assembly_compound_multibody_dynamics_analysis(self) -> 'AssemblyCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5355.AssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_5507.BearingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5509.BeltDriveCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5512.BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5519.BoltedJointCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5518.BoltCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5540.CVTCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5520.ClutchCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5525.ConceptCouplingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5530.ConceptGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5542.CycloidalAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5544.CycloidalDiscCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5548.CylindricalGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5555.FEPartCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5554.FaceGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5556.FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5563.HypoidGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5570.KlingelnbergCycloPalloidHypoidGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5573.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5574.MassDiscCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5575.MeasurementComponentCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5577.OilSealCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5579.PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5584.PlanetCarrierCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5585.PointLoadCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5586.PowerLoadCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5588.RingPinsCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5590.RollingRingAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5595.ShaftHubConnectionCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5594.ShaftCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5600.SpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5601.SpringDamperCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5606.StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5609.StraightBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5612.SynchroniserCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5616.TorqueConverterCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5620.UnbalancedMassCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5624.WormGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5627.ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5355.AssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'AssemblyCompoundMultibodyDynamicsAnalysis._Cast_AssemblyCompoundMultibodyDynamicsAnalysis':
