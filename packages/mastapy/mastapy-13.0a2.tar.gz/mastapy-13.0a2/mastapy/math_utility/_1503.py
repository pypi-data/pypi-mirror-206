...
class GriddedSurface(_0.APIBase):
    ...
    class _Cast_GriddedSurface:
        ...
        def __init__(self, parent: 'GriddedSurface'):
            self._parent = parent

        @property
        def gridded_surface(self) -> 'GriddedSurface':
            return self._parent
    ...
    def data_value_interpolated_at(self, row_value: 'float', column_value: 'float', row_extrapolation_option: '_1498.ExtrapolationOptions', column_extrapolation_option: '_1498.ExtrapolationOptions') -> 'float':
        ...
        row_extrapolation_option = conversion.mp_to_pn_enum(row_extrapolation_option, _1498.ExtrapolationOptions.type_())
        column_extrapolation_option = conversion.mp_to_pn_enum(column_extrapolation_option, _1498.ExtrapolationOptions.type_())
    ...
    @property
    def cast_to(self) -> 'GriddedSurface._Cast_GriddedSurface':
