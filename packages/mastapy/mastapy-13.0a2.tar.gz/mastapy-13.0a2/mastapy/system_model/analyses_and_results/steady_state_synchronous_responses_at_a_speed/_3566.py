...
class PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed(_3580.ShaftToMountableComponentConnectionSteadyStateSynchronousResponseAtASpeed):
    """PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def planetary_connection_steady_state_synchronous_response_at_a_speed(self) -> 'PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed._Cast_PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed(self)
