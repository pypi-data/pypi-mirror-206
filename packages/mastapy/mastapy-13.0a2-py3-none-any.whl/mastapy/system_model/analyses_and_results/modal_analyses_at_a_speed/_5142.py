...
class FaceGearMeshModalAnalysisAtASpeed(_5147.GearMeshModalAnalysisAtASpeed):
    """FaceGearMeshModalAnalysisAtASpeed
    ...
    class _Cast_FaceGearMeshModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'FaceGearMeshModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def face_gear_mesh_modal_analysis_at_a_speed(self) -> 'FaceGearMeshModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearMeshModalAnalysisAtASpeed._Cast_FaceGearMeshModalAnalysisAtASpeed':
