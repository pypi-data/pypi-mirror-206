...
class ModificationSegment(_0.APIBase):
    ...
    class _Cast_ModificationSegment:
        ...
        def __init__(self, parent: 'ModificationSegment'):
            self._parent = parent

        @property
        def lead_modification_segment(self):
            from mastapy.gears.manufacturing.cylindrical import _627
            
            return self._parent._cast(_627.LeadModificationSegment)

        @property
        def profile_modification_segment(self):
            from mastapy.gears.manufacturing.cylindrical import _632
            
            return self._parent._cast(_632.ProfileModificationSegment)

        @property
        def modification_segment(self) -> 'ModificationSegment':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ModificationSegment._Cast_ModificationSegment':
