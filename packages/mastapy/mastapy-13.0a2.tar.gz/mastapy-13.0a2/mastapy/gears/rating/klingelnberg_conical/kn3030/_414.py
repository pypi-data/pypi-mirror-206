...
from mastapy.gears.rating.klingelnberg_conical.kn3030 import _413, _410
...
class KlingelnbergCycloPalloidHypoidMeshSingleFlankRating(_410.KlingelnbergConicalMeshSingleFlankRating):
    """KlingelnbergCycloPalloidHypoidMeshSingleFlankRating
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidMeshSingleFlankRating:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidMeshSingleFlankRating'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_mesh_single_flank_rating(self) -> 'KlingelnbergCycloPalloidHypoidMeshSingleFlankRating':
            return self._parent
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_413.KlingelnbergCycloPalloidHypoidGearSingleFlankRating]':
    ...
    @property
    def kn3030_klingelnberg_gear_single_flank_ratings(self) -> 'List[_413.KlingelnbergCycloPalloidHypoidGearSingleFlankRating]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidMeshSingleFlankRating._Cast_KlingelnbergCycloPalloidHypoidMeshSingleFlankRating':
