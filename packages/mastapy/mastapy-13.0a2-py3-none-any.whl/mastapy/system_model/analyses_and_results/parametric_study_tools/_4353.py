...
class MassDiscParametricStudyTool(_4411.VirtualComponentParametricStudyTool):
    """MassDiscParametricStudyTool
    ...
    class _Cast_MassDiscParametricStudyTool:
        ...
        def __init__(self, parent: 'MassDiscParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def mass_disc_parametric_study_tool(self) -> 'MassDiscParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MassDiscParametricStudyTool._Cast_MassDiscParametricStudyTool':
