...
class StraightBevelGearCompoundSteadyStateSynchronousResponseAtASpeed(_3629.BevelGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_StraightBevelGearCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelGearCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_compound_steady_state_synchronous_response_at_a_speed(self) -> 'StraightBevelGearCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3594.StraightBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3594.StraightBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearCompoundSteadyStateSynchronousResponseAtASpeed._Cast_StraightBevelGearCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_StraightBevelGearCompoundSteadyStateSynchronousResponseAtASpeed(self)
