...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5265, _5266, _5278
...
class CylindricalGearSetCompoundModalAnalysisAtASpeed(_5278.GearSetCompoundModalAnalysisAtASpeed):
    """CylindricalGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5138.CylindricalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5265.CylindricalGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5266.CylindricalGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5138.CylindricalGearSetModalAnalysisAtASpeed]':
