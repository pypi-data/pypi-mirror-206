...
class StraightBevelSunGearCompoundStabilityAnalysis(_3979.StraightBevelDiffGearCompoundStabilityAnalysis):
    """StraightBevelSunGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3857.StraightBevelSunGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3857.StraightBevelSunGearStabilityAnalysis]':
