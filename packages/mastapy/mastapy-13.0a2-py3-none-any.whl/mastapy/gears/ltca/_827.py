...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    class _Cast_CylindricalMeshedGearLoadDistributionAnalysis:
        ...
        def __init__(self, parent: 'CylindricalMeshedGearLoadDistributionAnalysis'):
            self._parent = parent

        @property
        def cylindrical_meshed_gear_load_distribution_analysis(self) -> 'CylindricalMeshedGearLoadDistributionAnalysis':
            return self._parent
    ...
    @property
    def gear_load_distribution_analysis(self) -> '_851.CylindricalGearLoadDistributionAnalysis':
    ...
    @property
    def other_gear_load_distribution_analysis(self) -> '_851.CylindricalGearLoadDistributionAnalysis':
    ...
    @property
    def worst_contact_charts(self) -> '_1205.CylindricalGearWorstLTCAContactCharts':
    ...
    @property
    def worst_contact_charts_as_text_files(self) -> '_1204.CylindricalGearWorstLTCAContactChartDataAsTextFile':
    ...
    @property
    def contact_charts(self) -> 'List[_1203.CylindricalGearLTCAContactCharts]':
    ...
    @property
    def contact_charts_as_text_files(self) -> 'List[_1202.CylindricalGearLTCAContactChartDataAsTextFile]':
    ...
    def contact_patch_as_text(self, result_type: '_822.ContactResultType', include_tip_contact: 'bool', file_name_with_path: 'str', start_rotation_index: Optional['int'] = 0):
        ...
        result_type = conversion.mp_to_pn_enum(result_type, _822.ContactResultType.type_())
    ...
    def contact_patch(self, result_type: '_822.ContactResultType', include_tip_contact: 'bool', start_rotation_index: Optional['int'] = 0) -> '_1503.GriddedSurface':
    ...
    def contact_patch_detailed(self, result_type: '_822.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int', start_rotation_index: Optional['int'] = 0) -> '_1503.GriddedSurface':
        """ 'ContactPatch' is the original name of this method.
    ...
    @property
    def cast_to(self) -> 'CylindricalMeshedGearLoadDistributionAnalysis._Cast_CylindricalMeshedGearLoadDistributionAnalysis':
