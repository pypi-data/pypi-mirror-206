...
class InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft(_3259.ConnectionSteadyStateSynchronousResponseOnAShaft):
    """InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def inter_mountable_component_connection_steady_state_synchronous_response_on_a_shaft(self) -> 'InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft._Cast_InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft(self)
