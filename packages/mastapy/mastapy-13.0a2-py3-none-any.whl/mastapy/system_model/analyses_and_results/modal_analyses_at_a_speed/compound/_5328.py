...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5326, _5327, _5236
...
class StraightBevelGearSetCompoundModalAnalysisAtASpeed(_5236.BevelGearSetCompoundModalAnalysisAtASpeed):
    """StraightBevelGearSetCompoundModalAnalysisAtASpeed
    ...
    class _Cast_StraightBevelGearSetCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelGearSetCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_set_compound_modal_analysis_at_a_speed(self) -> 'StraightBevelGearSetCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5199.StraightBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5326.StraightBevelGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5327.StraightBevelGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5199.StraightBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSetCompoundModalAnalysisAtASpeed._Cast_StraightBevelGearSetCompoundModalAnalysisAtASpeed':
