...
def update(dry=False, allow_dirty=False, fetch=True, verbose=0, major=False,
    minor=False, patch=False, tag=None, tag_num=False, pin_increments=False,
    pin_date=False, date=None, set_version=None, commit_message=None,
    commit=None, tag_commit=None, push=None):
    ...
    if commit_message is None:
        ...
        commit_msg_template, _ = re.subn('\\b(OLD|NEW)\\b', '{\\1_VERSION}',
            commit_message)
    commit_message_kwargs = {'new_version': new_version, 'old_version':
        old_version, 'NEW_VERSION': new_version, 'OLD_VERSION': old_version,
