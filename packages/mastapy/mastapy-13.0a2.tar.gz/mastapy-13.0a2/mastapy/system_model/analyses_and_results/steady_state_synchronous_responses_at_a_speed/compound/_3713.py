...
class SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_3630.BevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    """SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_compound_steady_state_synchronous_response_at_a_speed(self) -> 'SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3582.SpiralBevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3582.SpiralBevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed._Cast_SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(self)
