...
class MeasurementComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_7225.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """MeasurementComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_MeasurementComponentCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'MeasurementComponentCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def measurement_component_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'MeasurementComponentCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7050.MeasurementComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7050.MeasurementComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'MeasurementComponentCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_MeasurementComponentCompoundAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_MeasurementComponentCompoundAdvancedTimeSteppingAnalysisForModulation(self)
