...
class ZerolBevelGearStabilityAnalysis(_3760.BevelGearStabilityAnalysis):
    """ZerolBevelGearStabilityAnalysis
    ...
    class _Cast_ZerolBevelGearStabilityAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_stability_analysis(self) -> 'ZerolBevelGearStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearStabilityAnalysis._Cast_ZerolBevelGearStabilityAnalysis':
