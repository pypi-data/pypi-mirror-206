...
class SynchroniserSleeveCompoundHarmonicAnalysis(_5961.SynchroniserPartCompoundHarmonicAnalysis):
    """SynchroniserSleeveCompoundHarmonicAnalysis
    ...
    class _Cast_SynchroniserSleeveCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserSleeveCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_sleeve_compound_harmonic_analysis(self) -> 'SynchroniserSleeveCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5797.SynchroniserSleeveHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5797.SynchroniserSleeveHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserSleeveCompoundHarmonicAnalysis._Cast_SynchroniserSleeveCompoundHarmonicAnalysis':
