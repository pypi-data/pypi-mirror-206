...
"""
from mastapy.bearings.bearing_results.rolling import _2025, _2015
...
class LoadedSphericalRollerRadialBearingRow(_2015.LoadedRollerBearingRow):
    """LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2025.LoadedSphericalRollerRadialBearingResults':
