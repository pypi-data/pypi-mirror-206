...
class KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection(_2864.ConicalGearSetCompoundSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2748.KlingelnbergCycloPalloidConicalGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2748.KlingelnbergCycloPalloidConicalGearSetSystemDeflection]':
