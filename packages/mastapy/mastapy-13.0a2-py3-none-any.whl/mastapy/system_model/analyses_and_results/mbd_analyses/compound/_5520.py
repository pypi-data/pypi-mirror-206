...
class ClutchCompoundMultibodyDynamicsAnalysis(_5536.CouplingCompoundMultibodyDynamicsAnalysis):
    """ClutchCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_ClutchCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'ClutchCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_compound_multibody_dynamics_analysis(self) -> 'ClutchCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5372.ClutchMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5372.ClutchMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ClutchCompoundMultibodyDynamicsAnalysis._Cast_ClutchCompoundMultibodyDynamicsAnalysis':
