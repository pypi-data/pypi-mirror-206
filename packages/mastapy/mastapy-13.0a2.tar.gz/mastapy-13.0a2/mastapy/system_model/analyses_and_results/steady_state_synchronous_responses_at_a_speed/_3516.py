...
class ConicalGearSetSteadyStateSynchronousResponseAtASpeed(_3542.GearSetSteadyStateSynchronousResponseAtASpeed):
    """ConicalGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ConicalGearSetSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ConicalGearSetSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def conical_gear_set_steady_state_synchronous_response_at_a_speed(self) -> 'ConicalGearSetSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConicalGearSetSteadyStateSynchronousResponseAtASpeed._Cast_ConicalGearSetSteadyStateSynchronousResponseAtASpeed':
