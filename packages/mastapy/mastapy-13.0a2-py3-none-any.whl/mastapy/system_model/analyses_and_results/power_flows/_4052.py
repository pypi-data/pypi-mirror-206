...
class CycloidalAssemblyPowerFlow(_4110.SpecialisedAssemblyPowerFlow):
    """CycloidalAssemblyPowerFlow
    ...
    class _Cast_CycloidalAssemblyPowerFlow:
        ...
        def __init__(self, parent: 'CycloidalAssemblyPowerFlow'):
            self._parent = parent
        ...
        @property
        def cycloidal_assembly_power_flow(self) -> 'CycloidalAssemblyPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalAssemblyPowerFlow._Cast_CycloidalAssemblyPowerFlow':
