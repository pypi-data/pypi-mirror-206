...
class LinkTokenCreateRequestIncomeVerification(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'precheck_id': (str, none_type,),  # noqa: E501
            'access_tokens': ([str], none_type,),  # noqa: E501
            'income_source_types': ([IncomeVerificationSourceType], none_type,),  # noqa: E501
            ...
            'stated_income_sources': ([LinkTokenCreateRequestUserStatedIncomeSource], none_type,),  # noqa: E501
        }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            income_verification_id (str, none_type): The `income_verification_id` of the verification instance, as provided by `/income/verification/create`.. [optional]  # noqa: E501
            ...
            precheck_id (str, none_type): The ID of a precheck created with `/income/verification/precheck`. Will be used to improve conversion of the income verification flow by streamlining the Link interface presented to the end user.. [optional]  # noqa: E501
            ...
            income_source_types ([IncomeVerificationSourceType], none_type): The types of source income data that users will be permitted to share. Options include `bank` and `payroll`. Currently you can only specify one of these options.. [optional]  # noqa: E501
            ...
            stated_income_sources ([LinkTokenCreateRequestUserStatedIncomeSource], none_type): A list of user stated income sources. [optional]  # noqa: E501
        """
