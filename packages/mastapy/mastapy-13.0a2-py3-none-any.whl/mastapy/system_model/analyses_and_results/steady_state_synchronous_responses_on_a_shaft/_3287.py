...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3288, _3286, _3229
...
class HypoidGearSetSteadyStateSynchronousResponseOnAShaft(_3229.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseOnAShaft):
    """HypoidGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def hypoid_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3288.HypoidGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def hypoid_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3286.HypoidGearMeshSteadyStateSynchronousResponseOnAShaft]':
