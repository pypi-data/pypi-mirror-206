...
class NamedTuple6(_0.APIBase, Generic[T1, T2, T3, T4, T5, T6]):
    ...
    class _Cast_NamedTuple6:
        ...
        def __init__(self, parent: 'NamedTuple6'):
            self._parent = parent

        @property
        def named_tuple_6(self) -> 'NamedTuple6':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'NamedTuple6._Cast_NamedTuple6':
        return self._Cast_NamedTuple6(self)
