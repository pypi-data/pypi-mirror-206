...
class PointF (SpireObject) :
    ...
    def IsEmpty(self)->bool:
        ...
        ret = dlllib.PointF_get_IsEmpty(self.Ptr)
        return ret
    ...
    def X(self)->float:
        ...
        ret = dlllib.PointF_get_X(self.Ptr)
        return ret

    @X.setter
    def X(self, value:float):
        dlllib.PointF_set_X.argtypes=[c_void_p, c_float]
        dlllib.PointF_set_X(self.Ptr, value)
    ...
    def Y(self)->float:
        ...
        ret = dlllib.PointF_get_Y(self.Ptr)
        return ret

    @Y.setter
    def Y(self, value:float):
        dlllib.PointF_set_Y.argtypes=[c_void_p, c_float]
        dlllib.PointF_set_Y(self.Ptr, value)
    ...
    def op_Addition(pt:'PointF',sz:Size)->'PointF':
        ...
        intPtr = dlllib.PointF_op_Addition( intPtrpt,intPtrsz)
    ...
    def op_Subtraction(pt:'PointF',sz:Size)->'PointF':
        ...
        intPtr = dlllib.PointF_op_Subtraction( intPtrpt,intPtrsz)
        ret = None if intPtr==None else PointF(intPtr)
        return ret
    ...
    def op_Addition(pt:'PointF',sz:SizeF)->'PointF':
        ...
        intPtr = dlllib.PointF_op_AdditionPS( intPtrpt,intPtrsz)
        ret = None if intPtr==None else PointF(intPtr)
        return ret
    ...
    def op_Subtraction(pt:'PointF',sz:SizeF)->'PointF':
        ...
        intPtr = dlllib.PointF_op_SubtractionPS( intPtrpt,intPtrsz)
        ret = None if intPtr==None else PointF(intPtr)
        return ret
    ...
    def op_Equality(left:'PointF',right:'PointF')->bool:
        ...
        ret = dlllib.PointF_op_Equality( intPtrleft,intPtrright)
        return ret
    ...
    def op_Inequality(left:'PointF',right:'PointF')->bool:
        ...
        ret = dlllib.PointF_op_Inequality( intPtrleft,intPtrright)
        return ret
    ...
    def Add(pt:'PointF',sz:Size)->'PointF':
        ...
        intPtr = dlllib.PointF_Add( intPtrpt,intPtrsz)
        ret = None if intPtr==None else PointF(intPtr)
        return ret
    ...
    def Subtract(pt:'PointF',sz:Size)->'PointF':
        ...
        intPtr = dlllib.PointF_Subtract( intPtrpt,intPtrsz)
        ret = None if intPtr==None else PointF(intPtr)
        return ret
    ...
    def Add(pt:'PointF',sz:SizeF)->'PointF':
        ...
        intPtr = dlllib.PointF_AddPS( intPtrpt,intPtrsz)
        ret = None if intPtr==None else PointF(intPtr)
        return ret
    ...
    def Subtract(pt:'PointF',sz:SizeF)->'PointF':
        ...
        intPtr = dlllib.PointF_SubtractPS( intPtrpt,intPtrsz)
        ret = None if intPtr==None else PointF(intPtr)
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = dlllib.PointF_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = dlllib.PointF_GetHashCode(self.Ptr)
        return ret
    ...
    def ToString(self)->str:
        ...
        dlllib.PointF_ToString.restype=c_wchar_p
        ret = dlllib.PointF_ToString(self.Ptr)
        return ret
