...
class ConditionalFormatWrapper (  CommonWrapper, IOptimizedUpdate, IConditionalFormat, IExcelApplication) :
    ...
    def DxfId(self)->int:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_DxfId(self.Ptr)
        return ret

    @DxfId.setter
    def DxfId(self, value:int):
        GetDllLibXls().ConditionalFormatWrapper_set_DxfId.argtypes=[c_void_p, c_int]
        GetDllLibXls().ConditionalFormatWrapper_set_DxfId(self.Ptr, value)
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_Parent(self.Ptr)
    ...
    def Priority(self)->int:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_Priority(self.Ptr)
        return ret

    @Priority.setter
    def Priority(self, value:int):
        GetDllLibXls().ConditionalFormatWrapper_set_Priority.argtypes=[c_void_p, c_int]
        GetDllLibXls().ConditionalFormatWrapper_set_Priority(self.Ptr, value)
    ...
    def TopBottom(self)->'TopBottom':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_TopBottom(self.Ptr)
    ...
    def Average(self)->'Average':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_Average(self.Ptr)
    ...
    def FormatType(self)->'ConditionalFormatType':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_FormatType(self.Ptr)
    ...
    def FormatType(self, value:'ConditionalFormatType'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_FormatType(self.Ptr, value.value)
    ...
    def StopIfTrue(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_StopIfTrue(self.Ptr)
        return ret

    @StopIfTrue.setter
    def StopIfTrue(self, value:bool):
        GetDllLibXls().ConditionalFormatWrapper_set_StopIfTrue.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ConditionalFormatWrapper_set_StopIfTrue(self.Ptr, value)
    ...
    def Operator(self)->'ComparisonOperatorType':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_Operator(self.Ptr)
    ...
    def Operator(self, value:'ComparisonOperatorType'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_Operator(self.Ptr, value.value)
    ...
    def IsBold(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsBold(self.Ptr)
        return ret

    @IsBold.setter
    def IsBold(self, value:bool):
        GetDllLibXls().ConditionalFormatWrapper_set_IsBold.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ConditionalFormatWrapper_set_IsBold(self.Ptr, value)
    ...
    def IsItalic(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsItalic(self.Ptr)
        return ret

    @IsItalic.setter
    def IsItalic(self, value:bool):
        GetDllLibXls().ConditionalFormatWrapper_set_IsItalic.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ConditionalFormatWrapper_set_IsItalic(self.Ptr, value)
    ...
    def FontKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_FontKnownColor(self.Ptr)
    ...
    def FontKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_FontKnownColor(self.Ptr, value.value)
    ...
    def FontColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_FontColor(self.Ptr)
    ...
    def FontColor(self, value:'Color'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_FontColor(self.Ptr, value.Ptr)
    ...
    def Underline(self)->'FontUnderlineType':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_Underline(self.Ptr)
    ...
    def Underline(self, value:'FontUnderlineType'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_Underline(self.Ptr, value.value)
    ...
    def IsStrikeThrough(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsStrikeThrough(self.Ptr)
        return ret
    ...
    def IsStrikeThrough(self, value:bool):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_IsStrikeThrough(self.Ptr, value)
    ...
    def LeftBorderKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_LeftBorderKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def LeftBorderKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_LeftBorderKnownColor(self.Ptr, value.value)
    ...
    def LeftBorderColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_LeftBorderColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def LeftBorderColor(self, value:'Color'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_LeftBorderColor(self.Ptr, value.Ptr)
    ...
    def LeftBorderStyle(self)->'LineStyleType':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_LeftBorderStyle(self.Ptr)
    ...
    def LeftBorderStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_LeftBorderStyle(self.Ptr, value.value)
    ...
    def RightBorderKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_RightBorderKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def RightBorderKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_RightBorderKnownColor(self.Ptr, value.value)
    ...
    def RightBorderColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_RightBorderColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def RightBorderColor(self, value:'Color'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_RightBorderColor(self.Ptr, value.Ptr)
    ...
    def RightBorderStyle(self)->'LineStyleType':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_RightBorderStyle(self.Ptr)
        objwraped = LineStyleType(ret)
        return objwraped
    ...
    def RightBorderStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_RightBorderStyle(self.Ptr, value.value)
    ...
    def TopBorderKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_TopBorderKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def TopBorderKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_TopBorderKnownColor(self.Ptr, value.value)
    ...
    def TopBorderColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_TopBorderColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def TopBorderColor(self, value:'Color'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_TopBorderColor(self.Ptr, value.Ptr)
    ...
    def TopBorderStyle(self)->'LineStyleType':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_TopBorderStyle(self.Ptr)
        objwraped = LineStyleType(ret)
        return objwraped
    ...
    def TopBorderStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_TopBorderStyle(self.Ptr, value.value)
    ...
    def BottomBorderKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_BottomBorderKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def BottomBorderKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_BottomBorderKnownColor(self.Ptr, value.value)
    ...
    def BottomBorderColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_BottomBorderColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def BottomBorderColor(self, value:'Color'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_BottomBorderColor(self.Ptr, value.Ptr)
    ...
    def BottomBorderStyle(self)->'LineStyleType':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_BottomBorderStyle(self.Ptr)
        objwraped = LineStyleType(ret)
        return objwraped
    ...
    def BottomBorderStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_BottomBorderStyle(self.Ptr, value.value)
    ...
    def FirstFormula(self)->str:
        ...
        GetDllLibXls().ConditionalFormatWrapper_get_FirstFormula.restype=c_wchar_p
        ret = GetDllLibXls().ConditionalFormatWrapper_get_FirstFormula(self.Ptr)
        return ret
    ...
    def FirstFormula(self, value:str):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_FirstFormula(self.Ptr, value)
    ...
    def FirstFormulaR1C1(self)->str:
        ...
        GetDllLibXls().ConditionalFormatWrapper_get_FirstFormulaR1C1.restype=c_wchar_p
        ret = GetDllLibXls().ConditionalFormatWrapper_get_FirstFormulaR1C1(self.Ptr)
        return ret
    ...
    def FirstFormulaR1C1(self, value:str):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_FirstFormulaR1C1(self.Ptr, value)
    ...
    def SecondFormulaR1C1(self)->str:
        ...
        GetDllLibXls().ConditionalFormatWrapper_get_SecondFormulaR1C1.restype=c_wchar_p
        ret = GetDllLibXls().ConditionalFormatWrapper_get_SecondFormulaR1C1(self.Ptr)
        return ret
    ...
    def SecondFormulaR1C1(self, value:str):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_SecondFormulaR1C1(self.Ptr, value)
    ...
    def SecondFormula(self)->str:
        ...
        GetDllLibXls().ConditionalFormatWrapper_get_SecondFormula.restype=c_wchar_p
        ret = GetDllLibXls().ConditionalFormatWrapper_get_SecondFormula(self.Ptr)
        return ret
    ...
    def SecondFormula(self, value:str):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_SecondFormula(self.Ptr, value)
    ...
    def KnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_KnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_KnownColor(self.Ptr, value.value)
    ...
    def Color(self)->'Color':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_Color(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_Color(self.Ptr, value.Ptr)
    ...
    def BackKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_BackKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def BackKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_BackKnownColor(self.Ptr, value.value)
    ...
    def BackColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_BackColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def BackColor(self, value:'Color'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_BackColor(self.Ptr, value.Ptr)
    ...
    def FillPattern(self)->'ExcelPatternType':
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_FillPattern(self.Ptr)
    ...
    def FillPattern(self, value:'ExcelPatternType'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_FillPattern(self.Ptr, value.value)
    ...
    def IsSuperScript(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsSuperScript(self.Ptr)
        return ret
    ...
    def IsSuperScript(self, value:bool):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_IsSuperScript(self.Ptr, value)
    ...
    def IsSubScript(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsSubScript(self.Ptr)
        return ret

    @IsSubScript.setter
    def IsSubScript(self, value:bool):
        GetDllLibXls().ConditionalFormatWrapper_set_IsSubScript.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ConditionalFormatWrapper_set_IsSubScript(self.Ptr, value)
    ...
    def NumberFormat(self)->str:
        ...
        GetDllLibXls().ConditionalFormatWrapper_get_NumberFormat.restype=c_wchar_p
        ret = GetDllLibXls().ConditionalFormatWrapper_get_NumberFormat(self.Ptr)
        return ret
    ...
    def NumberFormat(self, value:str):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_NumberFormat(self.Ptr, value)
    ...
    def ColorScale(self)->'ColorScale':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_ColorScale(self.Ptr)
    ...
    def DataBar(self)->'DataBar':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_DataBar(self.Ptr)
    ...
    def IconSet(self)->'IconSet':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_IconSet(self.Ptr)
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().ConditionalFormatWrapper_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().ConditionalFormatWrapper_EndUpdate(self.Ptr)
    ...
    def MakeFormula(self)->str:
        ...
        GetDllLibXls().ConditionalFormatWrapper_MakeFormula.restype=c_wchar_p
        ret = GetDllLibXls().ConditionalFormatWrapper_MakeFormula(self.Ptr)
        return ret
    ...
    def MakeFormula(self ,para:str)->str:
        ...
        GetDllLibXls().ConditionalFormatWrapper_MakeFormulaP.restype=c_wchar_p
        ret = GetDllLibXls().ConditionalFormatWrapper_MakeFormulaP(self.Ptr, para)
        return ret
    ...
    def SetTimePeriod(self ,timePeriod:'TimePeriodType'):
        ...
        GetDllLibXls().ConditionalFormatWrapper_SetTimePeriod(self.Ptr, enumtimePeriod)
    ...
    def OColor(self)->'OColor':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_OColor(self.Ptr)
    ...
    def BackColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_BackColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def TopBorderColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_TopBorderColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def BottomBorderColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_BottomBorderColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def LeftBorderColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_LeftBorderColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def RightBorderColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_RightBorderColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def FontColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().ConditionalFormatWrapper_get_FontColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def IsPatternStyleModified(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsPatternStyleModified(self.Ptr)
        return ret
    ...
    def IsPatternStyleModified(self, value:bool):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_IsPatternStyleModified(self.Ptr, value)
    ...
    def IsBackgroundColorPresent(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsBackgroundColorPresent(self.Ptr)
        return ret
    ...
    def IsBackgroundColorPresent(self, value:bool):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_IsBackgroundColorPresent(self.Ptr, value)
    ...
    def IsBorderFormatPresent(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsBorderFormatPresent(self.Ptr)
        return ret
    ...
    def IsBorderFormatPresent(self, value:bool):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_IsBorderFormatPresent(self.Ptr, value)
    ...
    def IsBottomBorderModified(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsBottomBorderModified(self.Ptr)
        return ret
    ...
    def IsBottomBorderModified(self, value:bool):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_IsBottomBorderModified(self.Ptr, value)
    ...
    def IsFontColorPresent(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsFontColorPresent(self.Ptr)
        return ret
    ...
    def IsFontColorPresent(self, value:bool):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_IsFontColorPresent(self.Ptr, value)
    ...
    def IsFontFormatPresent(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsFontFormatPresent(self.Ptr)
        return ret
    ...
    def IsFontFormatPresent(self, value:bool):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_IsFontFormatPresent(self.Ptr, value)
    ...
    def IsLeftBorderModified(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsLeftBorderModified(self.Ptr)
        return ret
    ...
    def IsLeftBorderModified(self, value:bool):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_IsLeftBorderModified(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsPatternColorPresent(self.Ptr)
        return ret
    ...
    def IsPatternColorPresent(self, value:bool):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_IsPatternColorPresent(self.Ptr, value)
    ...
    def IsPatternFormatPresent(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsPatternFormatPresent(self.Ptr)
        return ret
    ...
    def IsPatternFormatPresent(self, value:bool):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_IsPatternFormatPresent(self.Ptr, value)
    ...
    def IsRightBorderModified(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsRightBorderModified(self.Ptr)
        return ret
    ...
    def IsRightBorderModified(self, value:bool):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_IsRightBorderModified(self.Ptr, value)
    ...
    def IsTopBorderModified(self)->bool:
        ...
        ret = GetDllLibXls().ConditionalFormatWrapper_get_IsTopBorderModified(self.Ptr)
        return ret
    ...
    def IsTopBorderModified(self, value:bool):
        ...
        GetDllLibXls().ConditionalFormatWrapper_set_IsTopBorderModified(self.Ptr, value)
