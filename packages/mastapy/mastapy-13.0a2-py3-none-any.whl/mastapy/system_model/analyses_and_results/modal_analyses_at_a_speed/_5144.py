...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5143, _5142, _5149
...
class FaceGearSetModalAnalysisAtASpeed(_5149.GearSetModalAnalysisAtASpeed):
    """FaceGearSetModalAnalysisAtASpeed
    ...
    class _Cast_FaceGearSetModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'FaceGearSetModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def face_gear_set_modal_analysis_at_a_speed(self) -> 'FaceGearSetModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def face_gears_modal_analysis_at_a_speed(self) -> 'List[_5143.FaceGearModalAnalysisAtASpeed]':
    ...
    @property
    def face_meshes_modal_analysis_at_a_speed(self) -> 'List[_5142.FaceGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'FaceGearSetModalAnalysisAtASpeed._Cast_FaceGearSetModalAnalysisAtASpeed':
