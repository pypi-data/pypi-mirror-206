...
class BevelGearModalAnalysisAtAStiffness(_4835.AGMAGleasonConicalGearModalAnalysisAtAStiffness):
    """BevelGearModalAnalysisAtAStiffness
    ...
    class _Cast_BevelGearModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'BevelGearModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def bevel_gear_modal_analysis_at_a_stiffness(self) -> 'BevelGearModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearModalAnalysisAtAStiffness._Cast_BevelGearModalAnalysisAtAStiffness':
