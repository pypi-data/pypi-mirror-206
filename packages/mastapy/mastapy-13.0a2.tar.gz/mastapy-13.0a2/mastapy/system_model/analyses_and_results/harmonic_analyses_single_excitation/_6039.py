...
class HypoidGearMeshHarmonicAnalysisOfSingleExcitation(_5980.AGMAGleasonConicalGearMeshHarmonicAnalysisOfSingleExcitation):
    """HypoidGearMeshHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_HypoidGearMeshHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'HypoidGearMeshHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_mesh_harmonic_analysis_of_single_excitation(self) -> 'HypoidGearMeshHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidGearMeshHarmonicAnalysisOfSingleExcitation._Cast_HypoidGearMeshHarmonicAnalysisOfSingleExcitation':
