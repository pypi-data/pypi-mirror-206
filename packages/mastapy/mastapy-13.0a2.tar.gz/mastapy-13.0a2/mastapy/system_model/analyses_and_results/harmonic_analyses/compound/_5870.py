...
class CoaxialConnectionCompoundHarmonicAnalysis(_5943.ShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """CoaxialConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5673.CoaxialConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5673.CoaxialConnectionHarmonicAnalysis]':
