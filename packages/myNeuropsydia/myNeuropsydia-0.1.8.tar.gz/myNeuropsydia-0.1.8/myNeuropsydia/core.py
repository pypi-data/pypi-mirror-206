...
class Coordinates:
    ...
    def to_pygame(global_, x=None, y=None, 
    ...
    def from_pygame(global_, 
        ...
        if distance_x != None and distance_y is None:
            distance_x = (distance_x)*(10.0+10.0)/(screen_width-0.0)
            return(distance_x)

        if distance_y != None and distance_x is None:
            distance_y = (distance_y)*(10.0+10.0)/(screen_height-0.0)
            return(distance_y)
