...
class CylindricalGearMeshStabilityAnalysis(_3801.GearMeshStabilityAnalysis):
    """CylindricalGearMeshStabilityAnalysis
    ...
    class _Cast_CylindricalGearMeshStabilityAnalysis:
        ...
        def __init__(self, parent: 'CylindricalGearMeshStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_stability_analysis(self) -> 'CylindricalGearMeshStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshStabilityAnalysis._Cast_CylindricalGearMeshStabilityAnalysis':
