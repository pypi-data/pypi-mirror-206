...
class BoltCompoundModalAnalysisAtAStiffness(_4985.ComponentCompoundModalAnalysisAtAStiffness):
    """BoltCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_BoltCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'BoltCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def bolt_compound_modal_analysis_at_a_stiffness(self) -> 'BoltCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4850.BoltModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4850.BoltModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'BoltCompoundModalAnalysisAtAStiffness._Cast_BoltCompoundModalAnalysisAtAStiffness':
