...
class ConceptGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_6164.GearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    """ConceptGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6005.ConceptGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6005.ConceptGearMeshHarmonicAnalysisOfSingleExcitation]':
