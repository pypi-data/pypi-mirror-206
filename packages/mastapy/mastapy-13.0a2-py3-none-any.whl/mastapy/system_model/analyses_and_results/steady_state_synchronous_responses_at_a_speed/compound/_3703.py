...
class RingPinsToDiscConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3678.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """RingPinsToDiscConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_RingPinsToDiscConnectionCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'RingPinsToDiscConnectionCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def ring_pins_to_disc_connection_compound_steady_state_synchronous_response_at_a_speed(self) -> 'RingPinsToDiscConnectionCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3573.RingPinsToDiscConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3573.RingPinsToDiscConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'RingPinsToDiscConnectionCompoundSteadyStateSynchronousResponseAtASpeed._Cast_RingPinsToDiscConnectionCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_RingPinsToDiscConnectionCompoundSteadyStateSynchronousResponseAtASpeed(self)
