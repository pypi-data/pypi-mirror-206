...
class ShapeCollectionBase (SpireObject) :
    ...
    def get_Item(self ,index:int)->IShape:
        ...
        intPtr = GetDllLibXls().ShapeCollectionBase_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,strShapeName:str)->IShape:
        ...
        intPtr = GetDllLibXls().ShapeCollectionBase_get_ItemS(self.Ptr, strShapeName)
        ret = None if intPtr==None else IShape(intPtr)
        return ret
...
#        intPtr = GetDllLibXls().ShapeCollectionBase_AddCopy(self.Ptr, intPtrsourceShape,intPtrhashNewNames,intPtrarrFontIndexes)
#        ret = None if intPtr==None else IShape(intPtr)
#        return ret
#
    ...
    def AddCopy(self ,sourceShape:IShape)->IShape:
        ...
        intPtr = GetDllLibXls().ShapeCollectionBase_AddCopyS(self.Ptr, intPtrsourceShape)
        ret = None if intPtr==None else IShape(intPtr)
        return ret
    ...
    def AddShape(self ,newXlsShape:'XlsShape')->'XlsShape':
        ...
        intPtr = GetDllLibXls().ShapeCollectionBase_AddShape(self.Ptr, intPtrnewXlsShape)
