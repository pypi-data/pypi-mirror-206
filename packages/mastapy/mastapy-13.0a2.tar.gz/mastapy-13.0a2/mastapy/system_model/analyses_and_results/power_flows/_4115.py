...
class SpringDamperHalfPowerFlow(_4047.CouplingHalfPowerFlow):
    """SpringDamperHalfPowerFlow
    ...
    class _Cast_SpringDamperHalfPowerFlow:
        ...
        def __init__(self, parent: 'SpringDamperHalfPowerFlow'):
            self._parent = parent
        ...
        @property
        def spring_damper_half_power_flow(self) -> 'SpringDamperHalfPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperHalfPowerFlow._Cast_SpringDamperHalfPowerFlow':
