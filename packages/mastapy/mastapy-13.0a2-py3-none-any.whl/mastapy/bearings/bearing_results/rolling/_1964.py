...
class ISOTR141792001Results(_0.APIBase):
    ...
    class _Cast_ISOTR141792001Results:
        ...
        def __init__(self, parent: 'ISOTR141792001Results'):
            self._parent = parent

        @property
        def isotr1417912001_results(self):
            from mastapy.bearings.bearing_results.rolling import _1963
            
            return self._parent._cast(_1963.ISOTR1417912001Results)

        @property
        def isotr1417922001_results(self):
            from mastapy.bearings.bearing_results.rolling import _1965
            
            return self._parent._cast(_1965.ISOTR1417922001Results)

        @property
        def isotr141792001_results(self) -> 'ISOTR141792001Results':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ISOTR141792001Results._Cast_ISOTR141792001Results':
