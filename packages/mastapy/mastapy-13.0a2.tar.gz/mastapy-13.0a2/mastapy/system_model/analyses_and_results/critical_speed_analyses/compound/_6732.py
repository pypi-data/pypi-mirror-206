...
class RollingRingConnectionCompoundCriticalSpeedAnalysis(_6704.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """RollingRingConnectionCompoundCriticalSpeedAnalysis
    ...
    class _Cast_RollingRingConnectionCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'RollingRingConnectionCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def rolling_ring_connection_compound_critical_speed_analysis(self) -> 'RollingRingConnectionCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6602.RollingRingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6602.RollingRingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'RollingRingConnectionCompoundCriticalSpeedAnalysis._Cast_RollingRingConnectionCompoundCriticalSpeedAnalysis':
