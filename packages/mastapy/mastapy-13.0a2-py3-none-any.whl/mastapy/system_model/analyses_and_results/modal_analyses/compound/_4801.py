...
class SpiralBevelGearMeshCompoundModalAnalysis(_4718.BevelGearMeshCompoundModalAnalysis):
    """SpiralBevelGearMeshCompoundModalAnalysis
    ...
    class _Cast_SpiralBevelGearMeshCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_compound_modal_analysis(self) -> 'SpiralBevelGearMeshCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4656.SpiralBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4656.SpiralBevelGearMeshModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshCompoundModalAnalysis._Cast_SpiralBevelGearMeshCompoundModalAnalysis':
