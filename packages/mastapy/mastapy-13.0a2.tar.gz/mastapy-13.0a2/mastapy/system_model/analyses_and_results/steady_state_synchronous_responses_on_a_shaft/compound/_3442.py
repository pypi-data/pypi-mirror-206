...
class PulleyCompoundSteadyStateSynchronousResponseOnAShaft(_3393.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    """PulleyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_PulleyCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'PulleyCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def pulley_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'PulleyCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3312.PulleySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3312.PulleySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'PulleyCompoundSteadyStateSynchronousResponseOnAShaft._Cast_PulleyCompoundSteadyStateSynchronousResponseOnAShaft':
