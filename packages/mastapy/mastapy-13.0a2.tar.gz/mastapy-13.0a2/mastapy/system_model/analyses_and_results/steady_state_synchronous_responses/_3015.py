...
class ExternalCADModelSteadyStateSynchronousResponse(_2987.ComponentSteadyStateSynchronousResponse):
    ...
    class _Cast_ExternalCADModelSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'ExternalCADModelSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def external_cad_model_steady_state_synchronous_response(self) -> 'ExternalCADModelSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ExternalCADModelSteadyStateSynchronousResponse._Cast_ExternalCADModelSteadyStateSynchronousResponse':
