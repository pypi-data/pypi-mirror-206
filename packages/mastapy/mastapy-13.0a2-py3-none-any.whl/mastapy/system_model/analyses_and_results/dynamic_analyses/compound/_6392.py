...
class BoltCompoundDynamicAnalysis(_6398.ComponentCompoundDynamicAnalysis):
    """BoltCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6262.BoltDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6262.BoltDynamicAnalysis]':
