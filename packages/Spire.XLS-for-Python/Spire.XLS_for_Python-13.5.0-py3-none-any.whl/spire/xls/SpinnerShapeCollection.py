...
class SpinnerShapeCollection (  CollectionBase[XlsSpinnerShape],ISpinnerShapes) :
    ...
    def get_Item(self ,index:int)->ISpinnerShape:
        ...
        intPtr = GetDllLibXls().SpinnerShapeCollection_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->ISpinnerShape:
        ...
        intPtr = GetDllLibXls().SpinnerShapeCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsSpinnerShape(intPtr)
        return ret
    ...
    def AddSpinner(self ,row:int,column:int,height:int,width:int)->'ISpinnerShape':
        ...
        intPtr = GetDllLibXls().SpinnerShapeCollection_AddSpinner(self.Ptr, row,column,height,width)
        ret = None if intPtr==None else XlsSpinnerShape(intPtr)
        return ret
    ...
    def AddCopy(self ,source:'ISpinnerShape'):
        ...
        GetDllLibXls().SpinnerShapeCollection_AddCopy(self.Ptr, intPtrsource)
    ...
    def Clear(self):
        ...
        GetDllLibXls().SpinnerShapeCollection_Clear(self.Ptr)
