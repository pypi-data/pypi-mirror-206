...
class WorksheetChartsCollection (  XlsWorksheetChartsCollection) :
    ...
    def Add(self)->Chart:
        ...
        intPtr = GetDllLibXls().WorksheetChartsCollection_Add(self.Ptr)
    ...
    def Add(self ,chartType:ExcelChartType)->Chart:
        ...
        intPtr = GetDllLibXls().WorksheetChartsCollection_AddC(self.Ptr, enumchartType)
        ret = None if intPtr==None else Chart(intPtr)
        return ret
    ...
    def AddCopy(self ,chart:'Chart',upperLeftRow:int,upperLeftColumn:int,lowerRightRow:int,lowerRightColumn:int)->'Chart':
        ...
        intPtr = GetDllLibXls().WorksheetChartsCollection_AddCopy(self.Ptr, intPtrchart,upperLeftRow,upperLeftColumn,lowerRightRow,lowerRightColumn)
        ret = None if intPtr==None else Chart(intPtr)
        return ret
    ...
    def Add(self ,pivotChartType:ExcelChartType,pivotTable:IPivotTable)->Chart:
        ...
        intPtr = GetDllLibXls().WorksheetChartsCollection_AddPP(self.Ptr, enumpivotChartType,intPtrpivotTable)
        ret = None if intPtr==None else Chart(intPtr)
        return ret
    ...
    def get_Item(self ,index:int)->'Chart':
        ...
        intPtr = GetDllLibXls().WorksheetChartsCollection_get_Item(self.Ptr, index)
        ret = None if intPtr==None else Chart(intPtr)
        return ret
