...
class FaceGearHarmonicAnalysisOfSingleExcitation(_6033.GearHarmonicAnalysisOfSingleExcitation):
    """FaceGearHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_FaceGearHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'FaceGearHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def face_gear_harmonic_analysis_of_single_excitation(self) -> 'FaceGearHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearHarmonicAnalysisOfSingleExcitation._Cast_FaceGearHarmonicAnalysisOfSingleExcitation':
