...
class Rectangle (SpireObject) :
    ...
    def FromLTRB(left:int,top:int,right:int,bottom:int)->'Rectangle':
        ...
        intPtr = dlllib.Rectangle_FromLTRB( left,top,right,bottom)
    ...
    def Location(self)->'Point':
        ...
        intPtr = dlllib.Rectangle_get_Location(self.Ptr)
    ...
    def SIZE(self)->'Size':
        ...
        intPtr = dlllib.Rectangle_get_Size(self.Ptr)
    ...
    def SIZE(self, value:'Size'):
        ...
        dlllib.Rectangle_set_Size(self.Ptr, value.Ptr)
    ...
    def X(self)->int:
        ...
        ret = dlllib.Rectangle_get_X(self.Ptr)
        return ret

    @X.setter
    def X(self, value:int):
        dlllib.Rectangle_set_X.argtypes=[c_void_p, c_int]
        dlllib.Rectangle_set_X(self.Ptr, value)
    ...
    def Y(self)->int:
        ...
        ret = dlllib.Rectangle_get_Y(self.Ptr)
        return ret

    @Y.setter
    def Y(self, value:int):
        dlllib.Rectangle_set_Y.argtypes=[c_void_p, c_int]
        dlllib.Rectangle_set_Y(self.Ptr, value)
    ...
    def Width(self)->int:
        ...
        ret = dlllib.Rectangle_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:int):
        dlllib.Rectangle_set_Width.argtypes=[c_void_p, c_int]
        dlllib.Rectangle_set_Width(self.Ptr, value)
    ...
    def Height(self)->int:
        ...
        ret = dlllib.Rectangle_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:int):
        dlllib.Rectangle_set_Height.argtypes=[c_void_p, c_int]
        dlllib.Rectangle_set_Height(self.Ptr, value)
    ...
    def Left(self)->int:
        ...
        ret = dlllib.Rectangle_get_Left(self.Ptr)
        return ret
    ...
    def Right(self)->int:
        ...
        ret = dlllib.Rectangle_get_Right(self.Ptr)
        return ret
    ...
    def Bottom(self)->int:
        ...
        ret = dlllib.Rectangle_get_Bottom(self.Ptr)
        return ret
    ...
    def op_Equality(left:'Rectangle',right:'Rectangle')->bool:
        ...
        ret = dlllib.Rectangle_op_Equality( intPtrleft,intPtrright)
        return ret
    ...
    def Truncate(value:'RectangleF')->'Rectangle':
        ...
        intPtr = dlllib.Rectangle_Truncate( intPtrvalue)
        ret = None if intPtr==None else Rectangle(intPtr)
        return ret
    ...
    def Contains(self ,x:int,y:int)->bool:
        ...
        ret = dlllib.Rectangle_Contains(self.Ptr, x,y)
        return ret
    ...
    def Contains(self ,pt:Point)->bool:
        ...
        ret = dlllib.Rectangle_ContainsP(self.Ptr, intPtrpt)
        return ret
    ...
    def Contains(self ,rect:'Rectangle')->bool:
        ...
        ret = dlllib.Rectangle_ContainsR(self.Ptr, intPtrrect)
        return ret
    ...
    def Inflate(self ,width:int,height:int):
        ...
        dlllib.Rectangle_Inflate(self.Ptr, width,height)
    ...
    def Intersect(self ,rect:'Rectangle'):
        ...
        dlllib.Rectangle_Intersect(self.Ptr, intPtrrect)
    ...
    def Intersect(a:'Rectangle',b:'Rectangle')->'Rectangle':
        ...
        intPtr = dlllib.Rectangle_IntersectAB( intPtra,intPtrb)
        ret = None if intPtr==None else Rectangle(intPtr)
        return ret
    ...
    def IntersectsWith(self ,rect:'Rectangle')->bool:
        ...
        ret = dlllib.Rectangle_IntersectsWith(self.Ptr, intPtrrect)
        return ret
    ...
    def Union(a:'Rectangle',b:'Rectangle')->'Rectangle':
        ...
        intPtr = dlllib.Rectangle_Union( intPtra,intPtrb)
        ret = None if intPtr==None else Rectangle(intPtr)
        return ret
    ...
    def Location(self, value:'Point'):
        ...
        dlllib.Rectangle_set_Location(self.Ptr, value.Ptr)
    ...
    def Top(self)->int:
        ...
        ret = dlllib.Rectangle_get_Top(self.Ptr)
        return ret
    ...
    def IsEmpty(self)->bool:
        ...
        ret = dlllib.Rectangle_get_IsEmpty(self.Ptr)
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = dlllib.Rectangle_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def op_Inequality(left:'Rectangle',right:'Rectangle')->bool:
        ...
        ret = dlllib.Rectangle_op_Inequality( intPtrleft,intPtrright)
        return ret
    ...
    def Ceiling(value:'RectangleF')->'Rectangle':
        ...
        intPtr = dlllib.Rectangle_Ceiling( intPtrvalue)
        ret = None if intPtr==None else Rectangle(intPtr)
        return ret
    ...
    def Round(value:'RectangleF')->'Rectangle':
        ...
        intPtr = dlllib.Rectangle_Round( intPtrvalue)
        ret = None if intPtr==None else Rectangle(intPtr)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = dlllib.Rectangle_GetHashCode(self.Ptr)
        return ret
    ...
    def Inflate(self ,size:Size):
        ...
        dlllib.Rectangle_InflateS(self.Ptr, intPtrsize)
    ...
    def Inflate(rect:'Rectangle',x:int,y:int)->'Rectangle':
        ...
        intPtr = dlllib.Rectangle_InflateRXY( intPtrrect,x,y)
        ret = None if intPtr==None else Rectangle(intPtr)
        return ret
    ...
    def Offset(self ,pos:Point):
        ...
        dlllib.Rectangle_Offset(self.Ptr, intPtrpos)
    ...
    def Offset(self ,x:int,y:int):
        ...
        dlllib.Rectangle_OffsetXY(self.Ptr, x,y)
    ...
    def ToString(self)->str:
        ...
        dlllib.Rectangle_ToString.restype=c_wchar_p
        ret = dlllib.Rectangle_ToString(self.Ptr)
        return ret
