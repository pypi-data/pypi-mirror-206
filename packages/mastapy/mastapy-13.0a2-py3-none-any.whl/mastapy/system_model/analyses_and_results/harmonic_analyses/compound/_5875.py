...
class ConceptGearCompoundHarmonicAnalysis(_5904.GearCompoundHarmonicAnalysis):
    """ConceptGearCompoundHarmonicAnalysis
    ...
    class _Cast_ConceptGearCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'ConceptGearCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_gear_compound_harmonic_analysis(self) -> 'ConceptGearCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5679.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5679.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ConceptGearCompoundHarmonicAnalysis._Cast_ConceptGearCompoundHarmonicAnalysis':
