...
class CycloidalAssemblyCompoundCriticalSpeedAnalysis(_6737.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """CycloidalAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6553.CycloidalAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6553.CycloidalAssemblyCriticalSpeedAnalysis]':
