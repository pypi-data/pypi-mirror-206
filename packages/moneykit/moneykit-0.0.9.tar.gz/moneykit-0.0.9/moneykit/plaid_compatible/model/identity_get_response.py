...
class IdentityGetResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'accounts': ([AccountIdentity],),  # noqa: E501
            'item': (Item,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, accounts, item, request_id, *args, **kwargs):  # noqa: E501
        """IdentityGetResponse - a model defined in OpenAPI
