...
class BearingHarmonicAnalysis(_5686.ConnectorHarmonicAnalysis):
    """BearingHarmonicAnalysis
    ...
    class _Cast_BearingHarmonicAnalysis:
        ...
        def __init__(self, parent: 'BearingHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def bearing_harmonic_analysis(self) -> 'BearingHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BearingHarmonicAnalysis._Cast_BearingHarmonicAnalysis':
