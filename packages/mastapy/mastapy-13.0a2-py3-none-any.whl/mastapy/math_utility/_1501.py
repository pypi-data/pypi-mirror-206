...
class FourierSeries(_0.APIBase):
    ...
    class _Cast_FourierSeries:
        ...
        def __init__(self, parent: 'FourierSeries'):
            self._parent = parent

        @property
        def fourier_series(self) -> 'FourierSeries':
            return self._parent
    ...
    def harmonic(self, index: 'int') -> '_1504.HarmonicValue':
    ...
    def harmonics_above_cut_off(self) -> 'List[_1504.HarmonicValue]':
    ...
    def harmonics_with_zeros_truncated(self) -> 'List[_1504.HarmonicValue]':
    ...
    @property
    def cast_to(self) -> 'FourierSeries._Cast_FourierSeries':
