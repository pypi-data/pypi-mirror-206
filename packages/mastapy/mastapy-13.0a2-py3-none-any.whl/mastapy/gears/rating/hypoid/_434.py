...
from mastapy.gears.rating.iso_10300 import _421, _420
...
class HypoidGearMeshRating(_560.AGMAGleasonConicalGearMeshRating):
    """HypoidGearMeshRating
    ...
    class _Cast_HypoidGearMeshRating:
        ...
        def __init__(self, parent: 'HypoidGearMeshRating'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_mesh_rating(self) -> 'HypoidGearMeshRating':
            return self._parent
    ...
    @property
    def gleason_hypoid_mesh_single_flank_rating(self) -> '_439.GleasonHypoidMeshSingleFlankRating':
    ...
    @property
    def hypoid_gear_mesh(self) -> '_981.HypoidGearMeshDesign':
    ...
    @property
    def iso10300_hypoid_mesh_single_flank_rating_method_b1(self) -> '_421.ISO10300MeshSingleFlankRatingMethodB1':
    ...
    @property
    def iso10300_hypoid_mesh_single_flank_rating_method_b2(self) -> '_420.Iso10300MeshSingleFlankRatingHypoidMethodB2':
    ...
    @property
    def hypoid_gear_ratings(self) -> 'List[_435.HypoidGearRating]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearMeshRating._Cast_HypoidGearMeshRating':
