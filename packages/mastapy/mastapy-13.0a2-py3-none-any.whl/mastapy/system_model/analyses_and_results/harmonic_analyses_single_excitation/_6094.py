...
class TorqueConverterHarmonicAnalysisOfSingleExcitation(_6014.CouplingHarmonicAnalysisOfSingleExcitation):
    """TorqueConverterHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_TorqueConverterHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'TorqueConverterHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def torque_converter_harmonic_analysis_of_single_excitation(self) -> 'TorqueConverterHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterHarmonicAnalysisOfSingleExcitation._Cast_TorqueConverterHarmonicAnalysisOfSingleExcitation':
