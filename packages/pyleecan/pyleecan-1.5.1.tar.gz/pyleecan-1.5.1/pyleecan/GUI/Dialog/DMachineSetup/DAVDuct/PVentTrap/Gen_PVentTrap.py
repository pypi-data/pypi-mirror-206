...
class Gen_PVentTrap(Ui_PVentTrap):
    def setupUi(self, PVentTrap):
        ...
        # Setup of in_D0
        txt = self.tr(u"""<qt><nobr>Hole height</nobr></qt>""")
        ...
        # Setup of in_H0
        txt = self.tr(u"""<qt><nobr>Radius of the hole bottom</nobr></qt>""")
        ...
        # Setup of in_W1
        txt = self.tr(u"""<qt><nobr>Hole small basis</nobr></qt>""")
        ...
        # Setup of in_W2
        txt = self.tr(u"""<qt><nobr>Hole large basis</nobr></qt>""")
