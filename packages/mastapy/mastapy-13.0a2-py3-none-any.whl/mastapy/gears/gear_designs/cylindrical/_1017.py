...
class CylindricalGearMicroGeometrySettingsItem(_1816.NamedDatabaseItem):
    """CylindricalGearMicroGeometrySettingsItem
    ...
    class _Cast_CylindricalGearMicroGeometrySettingsItem:
        ...
        def __init__(self, parent: 'CylindricalGearMicroGeometrySettingsItem'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_micro_geometry_settings_item(self) -> 'CylindricalGearMicroGeometrySettingsItem':
            return self._parent
    ...
    def adjust_micro_geometry_for_analysis_by_default_when_including_pitch_errors(self, value: 'bool'):
        self.wrapped.AdjustMicroGeometryForAnalysisByDefaultWhenIncludingPitchErrors = bool(value) if value else False
    ...
    @property
    def default_flank_side_with_zero_face_width(self) -> '_566.FlankSide':
    ...
    def default_flank_side_with_zero_face_width(self, value: '_566.FlankSide'):
    ...
    @property
    def default_micro_geometry_lead_tolerance_chart_view(self) -> '_1116.MicroGeometryLeadToleranceChartView':
    ...
    def default_micro_geometry_lead_tolerance_chart_view(self, value: '_1116.MicroGeometryLeadToleranceChartView'):
        value = value if value else None
    ...
    @property
    def default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(self) -> '_1039.DoubleAxisScaleAndRange':
    ...
    def default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(self, value: '_1039.DoubleAxisScaleAndRange'):
        value = value if value else None
    ...
    @property
    def ltca_root_stress_surface_chart_option(self) -> '_1063.RootStressSurfaceChartOption':
        ...
        value = conversion.pn_to_mp_enum(temp, _1063.RootStressSurfaceChartOption)
        return constructor.new_from_mastapy_type(_1063.RootStressSurfaceChartOption)(value) if value is not None else None

    @ltca_root_stress_surface_chart_option.setter
    def ltca_root_stress_surface_chart_option(self, value: '_1063.RootStressSurfaceChartOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1063.RootStressSurfaceChartOption.type_())
        self.wrapped.LTCARootStressSurfaceChartOption = value

    @property
    def main_profile_modification_ends_at_the_start_of_root_relief_by_default(self) -> '_572.MainProfileReliefEndsAtTheStartOfRootReliefOption':
        ...
        value = conversion.pn_to_mp_enum(temp, _572.MainProfileReliefEndsAtTheStartOfRootReliefOption)
        return constructor.new_from_mastapy_type(_572.MainProfileReliefEndsAtTheStartOfRootReliefOption)(value) if value is not None else None

    @main_profile_modification_ends_at_the_start_of_root_relief_by_default.setter
    def main_profile_modification_ends_at_the_start_of_root_relief_by_default(self, value: '_572.MainProfileReliefEndsAtTheStartOfRootReliefOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _572.MainProfileReliefEndsAtTheStartOfRootReliefOption.type_())
        self.wrapped.MainProfileModificationEndsAtTheStartOfRootReliefByDefault = value

    @property
    def main_profile_modification_ends_at_the_start_of_tip_relief_by_default(self) -> '_573.MainProfileReliefEndsAtTheStartOfTipReliefOption':
        ...
        value = conversion.pn_to_mp_enum(temp, _573.MainProfileReliefEndsAtTheStartOfTipReliefOption)
        return constructor.new_from_mastapy_type(_573.MainProfileReliefEndsAtTheStartOfTipReliefOption)(value) if value is not None else None

    @main_profile_modification_ends_at_the_start_of_tip_relief_by_default.setter
    def main_profile_modification_ends_at_the_start_of_tip_relief_by_default(self, value: '_573.MainProfileReliefEndsAtTheStartOfTipReliefOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _573.MainProfileReliefEndsAtTheStartOfTipReliefOption.type_())
    ...
    @property
    def micro_geometry_lead_relief_definition(self) -> '_1055.MicroGeometryConvention':
        ...
        value = conversion.pn_to_mp_enum(temp, _1055.MicroGeometryConvention)
        return constructor.new_from_mastapy_type(_1055.MicroGeometryConvention)(value) if value is not None else None

    @micro_geometry_lead_relief_definition.setter
    def micro_geometry_lead_relief_definition(self, value: '_1055.MicroGeometryConvention'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1055.MicroGeometryConvention.type_())
        self.wrapped.MicroGeometryLeadReliefDefinition = value

    @property
    def micro_geometry_profile_relief_definition(self) -> '_1056.MicroGeometryProfileConvention':
        ...
        value = conversion.pn_to_mp_enum(temp, _1056.MicroGeometryProfileConvention)
        return constructor.new_from_mastapy_type(_1056.MicroGeometryProfileConvention)(value) if value is not None else None

    @micro_geometry_profile_relief_definition.setter
    def micro_geometry_profile_relief_definition(self, value: '_1056.MicroGeometryProfileConvention'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1056.MicroGeometryProfileConvention.type_())
    ...
    @property
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(self) -> '_575.ParabolicRootReliefStartsTangentToMainProfileRelief':
        ...
        value = conversion.pn_to_mp_enum(temp, _575.ParabolicRootReliefStartsTangentToMainProfileRelief)
        return constructor.new_from_mastapy_type(_575.ParabolicRootReliefStartsTangentToMainProfileRelief)(value) if value is not None else None

    @parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default.setter
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(self, value: '_575.ParabolicRootReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _575.ParabolicRootReliefStartsTangentToMainProfileRelief.type_())
        self.wrapped.ParabolicRootReliefStartsTangentToMainProfileReliefByDefault = value

    @property
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(self) -> '_576.ParabolicTipReliefStartsTangentToMainProfileRelief':
        ...
        value = conversion.pn_to_mp_enum(temp, _576.ParabolicTipReliefStartsTangentToMainProfileRelief)
        return constructor.new_from_mastapy_type(_576.ParabolicTipReliefStartsTangentToMainProfileRelief)(value) if value is not None else None

    @parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default.setter
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(self, value: '_576.ParabolicTipReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _576.ParabolicTipReliefStartsTangentToMainProfileRelief.type_())
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMicroGeometrySettingsItem._Cast_CylindricalGearMicroGeometrySettingsItem':
