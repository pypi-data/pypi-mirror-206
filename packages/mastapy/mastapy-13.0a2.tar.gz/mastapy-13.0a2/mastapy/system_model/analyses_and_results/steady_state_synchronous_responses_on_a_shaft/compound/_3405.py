...
class DatumCompoundSteadyStateSynchronousResponseOnAShaft(_3379.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """DatumCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_DatumCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'DatumCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def datum_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'DatumCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3275.DatumSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3275.DatumSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'DatumCompoundSteadyStateSynchronousResponseOnAShaft._Cast_DatumCompoundSteadyStateSynchronousResponseOnAShaft':
