...
class CoaxialConnectionStabilityAnalysis(_3840.ShaftToMountableComponentConnectionStabilityAnalysis):
    """CoaxialConnectionStabilityAnalysis
    ...
    class _Cast_CoaxialConnectionStabilityAnalysis:
        ...
        def __init__(self, parent: 'CoaxialConnectionStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def coaxial_connection_stability_analysis(self) -> 'CoaxialConnectionStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CoaxialConnectionStabilityAnalysis._Cast_CoaxialConnectionStabilityAnalysis':
