...
class PartToPartShearCouplingConnectionSteadyStateSynchronousResponseOnAShaft(_3261.CouplingConnectionSteadyStateSynchronousResponseOnAShaft):
    """PartToPartShearCouplingConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_PartToPartShearCouplingConnectionSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingConnectionSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_connection_steady_state_synchronous_response_on_a_shaft(self) -> 'PartToPartShearCouplingConnectionSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingConnectionSteadyStateSynchronousResponseOnAShaft._Cast_PartToPartShearCouplingConnectionSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_PartToPartShearCouplingConnectionSteadyStateSynchronousResponseOnAShaft(self)
