...
class ZerolBevelGearMeshCompoundHarmonicAnalysis(_5863.BevelGearMeshCompoundHarmonicAnalysis):
    """ZerolBevelGearMeshCompoundHarmonicAnalysis
    ...
    class _Cast_ZerolBevelGearMeshCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearMeshCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_mesh_compound_harmonic_analysis(self) -> 'ZerolBevelGearMeshCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5809.ZerolBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5809.ZerolBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearMeshCompoundHarmonicAnalysis._Cast_ZerolBevelGearMeshCompoundHarmonicAnalysis':
