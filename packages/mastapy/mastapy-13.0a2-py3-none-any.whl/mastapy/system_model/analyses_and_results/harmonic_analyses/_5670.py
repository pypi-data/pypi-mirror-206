...
class ClutchConnectionHarmonicAnalysis(_5687.CouplingConnectionHarmonicAnalysis):
    """ClutchConnectionHarmonicAnalysis
    ...
    class _Cast_ClutchConnectionHarmonicAnalysis:
        ...
        def __init__(self, parent: 'ClutchConnectionHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_connection_harmonic_analysis(self) -> 'ClutchConnectionHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchConnectionHarmonicAnalysis._Cast_ClutchConnectionHarmonicAnalysis':
