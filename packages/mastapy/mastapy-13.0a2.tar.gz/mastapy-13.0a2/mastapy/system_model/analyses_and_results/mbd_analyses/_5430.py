...
class MassDiscMultibodyDynamicsAnalysis(_5485.VirtualComponentMultibodyDynamicsAnalysis):
    """MassDiscMultibodyDynamicsAnalysis
    ...
    class _Cast_MassDiscMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'MassDiscMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def mass_disc_multibody_dynamics_analysis(self) -> 'MassDiscMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MassDiscMultibodyDynamicsAnalysis._Cast_MassDiscMultibodyDynamicsAnalysis':
