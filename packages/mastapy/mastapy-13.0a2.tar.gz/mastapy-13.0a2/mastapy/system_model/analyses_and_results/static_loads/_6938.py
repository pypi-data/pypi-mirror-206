...
class TorqueConverterPumpLoadCase(_6816.CouplingHalfLoadCase):
    """TorqueConverterPumpLoadCase
    ...
    class _Cast_TorqueConverterPumpLoadCase:
        ...
        def __init__(self, parent: 'TorqueConverterPumpLoadCase'):
            self._parent = parent
        ...
        @property
        def torque_converter_pump_load_case(self) -> 'TorqueConverterPumpLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterPumpLoadCase._Cast_TorqueConverterPumpLoadCase':
