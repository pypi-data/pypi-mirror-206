...
class AutoFitterOptions (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().AutoFitterOptions_get_AutoFitMergedCells(self.Ptr)
        return ret
    ...
    def AutoFitMergedCells(self, value:bool):
        ...
        GetDllLibXls().AutoFitterOptions_set_AutoFitMergedCells(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AutoFitterOptions_get_OnlyAuto(self.Ptr)
        return ret

    @OnlyAuto.setter
    def OnlyAuto(self, value:bool):
        GetDllLibXls().AutoFitterOptions_set_OnlyAuto.argtypes=[c_void_p, c_bool]
        GetDllLibXls().AutoFitterOptions_set_OnlyAuto(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AutoFitterOptions_get_IgnoreHidden(self.Ptr)
        return ret

    @IgnoreHidden.setter
    def IgnoreHidden(self, value:bool):
        GetDllLibXls().AutoFitterOptions_set_IgnoreHidden.argtypes=[c_void_p, c_bool]
        GetDllLibXls().AutoFitterOptions_set_IgnoreHidden(self.Ptr, value)
