...
class PocketingPowerLossCoefficients(_1816.NamedDatabaseItem):
    """PocketingPowerLossCoefficients
    ...
    class _Cast_PocketingPowerLossCoefficients:
        ...
        def __init__(self, parent: 'PocketingPowerLossCoefficients'):
            self._parent = parent
        ...
        @property
        def pocketing_power_loss_coefficients(self) -> 'PocketingPowerLossCoefficients':
            return self._parent
    ...
    @property
    def raw_pocketing_power_loss_lookup_table(self) -> '_1554.GriddedSurfaceAccessor':
    ...
    def raw_pocketing_power_loss_lookup_table(self, value: '_1554.GriddedSurfaceAccessor'):
    ...
    @property
    def specifications_for_the_effect_of_oil_kinematic_viscosity(self) -> 'List[_342.SpecificationForTheEffectOfOilKinematicViscosity]':
    ...
    @property
    def cast_to(self) -> 'PocketingPowerLossCoefficients._Cast_PocketingPowerLossCoefficients':
