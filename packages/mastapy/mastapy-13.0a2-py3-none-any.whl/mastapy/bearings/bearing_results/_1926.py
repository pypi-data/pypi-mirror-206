...
class BearingStiffnessMatrixReporter(_0.APIBase):
    ...
    class _Cast_BearingStiffnessMatrixReporter:
        ...
        def __init__(self, parent: 'BearingStiffnessMatrixReporter'):
            self._parent = parent

        @property
        def bearing_stiffness_matrix_reporter(self) -> 'BearingStiffnessMatrixReporter':
            return self._parent
    ...
    @property
    def rows(self) -> 'List[_1950.StiffnessRow]':
    ...
    @property
    def cast_to(self) -> 'BearingStiffnessMatrixReporter._Cast_BearingStiffnessMatrixReporter':
