...
class UnbalancedMassCompoundCriticalSpeedAnalysis(_6761.VirtualComponentCompoundCriticalSpeedAnalysis):
    """UnbalancedMassCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6631.UnbalancedMassCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6631.UnbalancedMassCriticalSpeedAnalysis]':
