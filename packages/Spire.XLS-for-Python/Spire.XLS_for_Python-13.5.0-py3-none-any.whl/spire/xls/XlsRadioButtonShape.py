...
class XlsRadioButtonShape (  XlsShape, IRadioButton) :
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().XlsRadioButtonShape_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsRadioButtonShape_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsRadioButtonShape_set_Text(self.Ptr, value)
    ...
    def IsTextLocked(self)->bool:
        ...
        ret = GetDllLibXls().XlsRadioButtonShape_get_IsTextLocked(self.Ptr)
        return ret

    @IsTextLocked.setter
    def IsTextLocked(self, value:bool):
        GetDllLibXls().XlsRadioButtonShape_set_IsTextLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsRadioButtonShape_set_IsTextLocked(self.Ptr, value)
    ...
    def LinkedCell(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsRadioButtonShape_get_LinkedCell(self.Ptr)
    ...
    def LinkedCell(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsRadioButtonShape_set_LinkedCell(self.Ptr, value.Ptr)
    ...
    def Display3DShading(self)->bool:
        ...
        ret = GetDllLibXls().XlsRadioButtonShape_get_Display3DShading(self.Ptr)
        return ret
    ...
    def Display3DShading(self, value:bool):
        ...
        GetDllLibXls().XlsRadioButtonShape_set_Display3DShading(self.Ptr, value)
    ...
    def IsFirstButton(self)->bool:
        ...
        ret = GetDllLibXls().XlsRadioButtonShape_get_IsFirstButton(self.Ptr)
        return ret
    ...
    def CheckState(self)->'CheckState':
        ...
        ret = GetDllLibXls().XlsRadioButtonShape_get_CheckState(self.Ptr)
    ...
    def CheckState(self, value:'CheckState'):
        ...
        GetDllLibXls().XlsRadioButtonShape_set_CheckState(self.Ptr, value.value)
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsRadioButtonShape_get_ShapeType(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsRadioButtonShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
...
#
    ...
    def HAlignment(self)->'CommentHAlignType':
        ...
        ret = GetDllLibXls().XlsRadioButtonShape_get_HAlignment(self.Ptr)
    ...
    def HAlignment(self, value:'CommentHAlignType'):
        ...
        GetDllLibXls().XlsRadioButtonShape_set_HAlignment(self.Ptr, value.value)
    ...
    def VAlignment(self)->'CommentVAlignType':
        ...
        ret = GetDllLibXls().XlsRadioButtonShape_get_VAlignment(self.Ptr)
    ...
    def VAlignment(self, value:'CommentVAlignType'):
        ...
        GetDllLibXls().XlsRadioButtonShape_set_VAlignment(self.Ptr, value.value)
    ...
    def TextRotation(self)->'TextRotationType':
        ...
        ret = GetDllLibXls().XlsRadioButtonShape_get_TextRotation(self.Ptr)
    ...
    def TextRotation(self, value:'TextRotationType'):
        ...
        GetDllLibXls().XlsRadioButtonShape_set_TextRotation(self.Ptr, value.value)

    def SetRichText(self, value:RichTextString):
        GetDllLibXls().XlsRadioButtonShape_set_RichText.argtypes=[c_void_p, c_void_p]
        GetDllLibXls().XlsRadioButtonShape_set_RichText(self.Ptr, value.Ptr)
