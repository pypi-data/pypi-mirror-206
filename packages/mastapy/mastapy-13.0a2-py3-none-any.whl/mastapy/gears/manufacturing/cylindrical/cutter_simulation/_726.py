...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _727, _732
...
class CutterSimulationCalc(_0.APIBase):
    ...
    class _Cast_CutterSimulationCalc:
        ...
        def __init__(self, parent: 'CutterSimulationCalc'):
            self._parent = parent

        @property
        def form_wheel_grinding_simulation_calculator(self):
            from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _733
            
            return self._parent._cast(_733.FormWheelGrindingSimulationCalculator)
        ...
        @property
        def shaper_simulation_calculator(self):
            from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _740
            
            return self._parent._cast(_740.ShaperSimulationCalculator)

        @property
        def shaving_simulation_calculator(self):
            from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _741
            
            return self._parent._cast(_741.ShavingSimulationCalculator)

        @property
        def virtual_simulation_calculator(self):
            from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _742
            
            return self._parent._cast(_742.VirtualSimulationCalculator)
        ...
        @property
        def cutter_simulation_calc(self) -> 'CutterSimulationCalc':
            return self._parent
    ...
    @property
    def gear(self) -> '_727.CylindricalCutterSimulatableGear':
    ...
    @property
    def gear_fillet_points(self) -> 'List[_724.NamedPoint]':
    ...
    @property
    def cast_to(self) -> 'CutterSimulationCalc._Cast_CutterSimulationCalc':
