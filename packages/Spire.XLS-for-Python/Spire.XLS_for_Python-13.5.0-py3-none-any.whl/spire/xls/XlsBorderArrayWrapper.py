...
#        ret = GetDllLibXls().XlsBorderArrayWrapper_GetThemeColor(self.Ptr, intPtrtype,intPtrtint)
#        return ret
    ...
    def SetThemeColor(self ,type:'ThemeColorType',tint:float):
        ...
        GetDllLibXls().XlsBorderArrayWrapper_SetThemeColor(self.Ptr, enumtype,tint)
    ...
    def KnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsBorderArrayWrapper_get_KnownColor(self.Ptr)
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsBorderArrayWrapper_set_KnownColor(self.Ptr, value.value)
    ...
    def OColor(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsBorderArrayWrapper_get_OColor(self.Ptr)
    ...
    def Color(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsBorderArrayWrapper_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().XlsBorderArrayWrapper_set_Color(self.Ptr, value.Ptr)
    ...
    def LineStyle(self)->'LineStyleType':
        ...
        ret = GetDllLibXls().XlsBorderArrayWrapper_get_LineStyle(self.Ptr)
    ...
    def LineStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().XlsBorderArrayWrapper_set_LineStyle(self.Ptr, value.value)
    ...
    def ShowDiagonalLine(self)->bool:
        ...
        ret = GetDllLibXls().XlsBorderArrayWrapper_get_ShowDiagonalLine(self.Ptr)
        return ret
    ...
    def ShowDiagonalLine(self, value:bool):
        ...
        GetDllLibXls().XlsBorderArrayWrapper_set_ShowDiagonalLine(self.Ptr, value)
