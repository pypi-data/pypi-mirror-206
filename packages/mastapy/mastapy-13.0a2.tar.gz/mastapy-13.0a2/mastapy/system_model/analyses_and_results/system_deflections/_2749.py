...
class KlingelnbergCycloPalloidConicalGearSystemDeflection(_2705.ConicalGearSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearSystemDeflection
    ...
    class _Cast_KlingelnbergCycloPalloidConicalGearSystemDeflection:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidConicalGearSystemDeflection'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_conical_gear_system_deflection(self) -> 'KlingelnbergCycloPalloidConicalGearSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4077.KlingelnbergCycloPalloidConicalGearPowerFlow':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidConicalGearSystemDeflection._Cast_KlingelnbergCycloPalloidConicalGearSystemDeflection':
