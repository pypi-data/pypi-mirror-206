...
class CustomSubReport(_1749.CustomReportDefinitionItem):
    """CustomSubReport
    ...
    class _Cast_CustomSubReport:
        ...
        def __init__(self, parent: 'CustomSubReport'):
            self._parent = parent
        ...
        @property
        def custom_sub_report(self) -> 'CustomSubReport':
            return self._parent
    ...
    def is_read_only_in_editor(self, value: 'bool'):
        self.wrapped.IsReadOnlyInEditor = bool(value) if value else False
    ...
    @property
    def cast_to(self) -> 'CustomSubReport._Cast_CustomSubReport':
