...
class StraightBevelDiffGearModalAnalysis(_4564.BevelGearModalAnalysis):
    """StraightBevelDiffGearModalAnalysis
    ...
    class _Cast_StraightBevelDiffGearModalAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearModalAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_modal_analysis(self) -> 'StraightBevelDiffGearModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearModalAnalysis._Cast_StraightBevelDiffGearModalAnalysis':
