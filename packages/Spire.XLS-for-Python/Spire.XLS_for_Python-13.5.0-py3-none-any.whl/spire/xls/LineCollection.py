...
class LineCollection (  CollectionBase[XlsLineShape], ILines) :
    ...
    def AddLine(self)->ILineShape:
        ...
        intPtr = GetDllLibXls().LineCollection_AddLine(self.Ptr)
    ...
    def AddLine(self ,row:int,column:int,width:int,height:int,lineShapeType:LineShapeType)->ILineShape:
        ...
        intPtr = GetDllLibXls().LineCollection_AddLineRCWHL(self.Ptr, row,column,width,height,enumlineShapeType)
        ret = None if intPtr==None else XlsLineShape(intPtr)
        return ret
    ...
    def AddCopy(self ,source:'ILineShape'):
        ...
        GetDllLibXls().LineCollection_AddCopy(self.Ptr, intPtrsource)
    ...
    def get_Item(self ,index:int)->ILineShape:
        ...
        intPtr = GetDllLibXls().LineCollection_get_Item(self.Ptr, index)
        ret = None if intPtr==None else XlsLineShape(intPtr)
        return ret
    ...
    def get_Item(self ,name:str)->ILineShape:
        ...
        intPtr = GetDllLibXls().LineCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsLineShape(intPtr)
        return ret
    ...
    def Clear(self):
        ...
        GetDllLibXls().LineCollection_Clear(self.Ptr)
