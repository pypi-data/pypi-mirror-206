...
class TorqueConverterCompoundHarmonicAnalysis(_5883.CouplingCompoundHarmonicAnalysis):
    """TorqueConverterCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5799.TorqueConverterHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5799.TorqueConverterHarmonicAnalysis]':
