...
class SAESplineHalfRating(_1419.SplineHalfRating):
    """SAESplineHalfRating
    ...
    class _Cast_SAESplineHalfRating:
        ...
        def __init__(self, parent: 'SAESplineHalfRating'):
            self._parent = parent
        ...
        @property
        def sae_spline_half_rating(self) -> 'SAESplineHalfRating':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SAESplineHalfRating._Cast_SAESplineHalfRating':
