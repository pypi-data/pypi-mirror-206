...
class MassDiscAdvancedTimeSteppingAnalysisForModulation(_7096.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """MassDiscAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_MassDiscAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'MassDiscAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def mass_disc_advanced_time_stepping_analysis_for_modulation(self) -> 'MassDiscAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MassDiscAdvancedTimeSteppingAnalysisForModulation._Cast_MassDiscAdvancedTimeSteppingAnalysisForModulation':
