...
class XlsChartBorder (  XlsObject, IChartBorder, ICloneParent) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartBorder_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartBorder_set_Color(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartBorder_get_Pattern(self.Ptr)
    ...
    def Pattern(self, value:'ChartLinePatternType'):
        ...
        GetDllLibXls().XlsChartBorder_set_Pattern(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartBorder_get_Weight(self.Ptr)
    ...
    def Weight(self, value:'ChartLineWeightType'):
        ...
        GetDllLibXls().XlsChartBorder_set_Weight(self.Ptr, value.value)
    ...
    def UseDefaultFormat(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartBorder_get_UseDefaultFormat(self.Ptr)
        return ret
    ...
    def UseDefaultFormat(self, value:bool):
        ...
        GetDllLibXls().XlsChartBorder_set_UseDefaultFormat(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartBorder_get_UseDefaultLineColor(self.Ptr)
        return ret
    ...
    def UseDefaultLineColor(self, value:bool):
        ...
        GetDllLibXls().XlsChartBorder_set_UseDefaultLineColor(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartBorder_get_KnownColor(self.Ptr)
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartBorder_set_KnownColor(self.Ptr, value.value)
    ...
    def Transparency(self)->float:
        ...
        ret = GetDllLibXls().XlsChartBorder_get_Transparency(self.Ptr)
        return ret

    @Transparency.setter
    def Transparency(self, value:float):
        GetDllLibXls().XlsChartBorder_set_Transparency.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartBorder_set_Transparency(self.Ptr, value)
    ...
    def CustomLineWeight(self)->float:
        ...
        ret = GetDllLibXls().XlsChartBorder_get_CustomLineWeight(self.Ptr)
        return ret
    ...
    def CustomLineWeight(self, value:float):
        ...
        GetDllLibXls().XlsChartBorder_set_CustomLineWeight(self.Ptr, value)
    ...
    def Clone(self ,parent:'SpireObject')->'XlsChartBorder':
        ...
        intPtr = GetDllLibXls().XlsChartBorder_Clone(self.Ptr, intPtrparent)
