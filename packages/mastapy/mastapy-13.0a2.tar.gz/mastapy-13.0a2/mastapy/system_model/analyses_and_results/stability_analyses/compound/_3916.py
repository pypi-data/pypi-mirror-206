...
class CVTPulleyCompoundStabilityAnalysis(_3962.PulleyCompoundStabilityAnalysis):
    """CVTPulleyCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3784.CVTPulleyStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3784.CVTPulleyStabilityAnalysis]':
