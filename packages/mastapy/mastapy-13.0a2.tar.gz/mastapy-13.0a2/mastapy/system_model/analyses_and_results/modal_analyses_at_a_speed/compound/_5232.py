...
class BevelDifferentialPlanetGearCompoundModalAnalysisAtASpeed(_5229.BevelDifferentialGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5103.BevelDifferentialPlanetGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5103.BevelDifferentialPlanetGearModalAnalysisAtASpeed]':
