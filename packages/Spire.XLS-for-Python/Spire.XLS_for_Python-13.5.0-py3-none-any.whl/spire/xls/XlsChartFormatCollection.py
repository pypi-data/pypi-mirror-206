...
class XlsChartFormatCollection (  ICloneParent) :
    ...
    def get_Item(self ,index:int)->'XlsChartFormat':
        ...
        intPtr = GetDllLibXls().XlsChartFormatCollection_get_Item(self.Ptr, index)
    ...
    def IsPrimary(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormatCollection_get_IsPrimary(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormatCollection_get_NeedSecondaryAxis(self.Ptr)
        return ret
    ...
    def Add(self ,format:XlsChartFormat)->XlsChartFormat:
        ...
        intPtr = GetDllLibXls().XlsChartFormatCollection_Add(self.Ptr, intPtrformat)
        ret = None if intPtr==None else XlsChartFormat(intPtr)
        return ret
    ...
    def Add(self ,format:XlsChartFormat,bCanReplace:bool)->XlsChartFormat:
        ...
        intPtr = GetDllLibXls().XlsChartFormatCollection_AddFB(self.Ptr, intPtrformat,bCanReplace)
        ret = None if intPtr==None else XlsChartFormat(intPtr)
        return ret
    ...
    def FindOrAdd(self ,formatToAdd:'XlsChartFormat')->'XlsChartFormat':
        ...
        intPtr = GetDllLibXls().XlsChartFormatCollection_FindOrAdd(self.Ptr, intPtrformatToAdd)
        ret = None if intPtr==None else XlsChartFormat(intPtr)
        return ret
    ...
    def ContainsIndex(self ,index:int)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormatCollection_ContainsIndex(self.Ptr, index)
        return ret
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsChartFormatCollection_Clone(self.Ptr, intPtrparent)
    ...
    def SetIndex(self ,index:int,Value:int):
        ...
        GetDllLibXls().XlsChartFormatCollection_SetIndex(self.Ptr, index,Value)
    ...
    def UpdateIndexesAfterRemove(self ,removeIndex:int):
        ...
        GetDllLibXls().XlsChartFormatCollection_UpdateIndexesAfterRemove(self.Ptr, removeIndex)
    ...
    def UpdateSeriesByChartGroup(self ,newIndex:int,OldIndex:int):
        ...
        GetDllLibXls().XlsChartFormatCollection_UpdateSeriesByChartGroup(self.Ptr, newIndex,OldIndex)
    ...
    def UpdateFormatsOnAdding(self ,index:int):
        ...
        GetDllLibXls().XlsChartFormatCollection_UpdateFormatsOnAdding(self.Ptr, index)
    ...
    def UpdateFormatsOnRemoving(self ,index:int):
        ...
        GetDllLibXls().XlsChartFormatCollection_UpdateFormatsOnRemoving(self.Ptr, index)
