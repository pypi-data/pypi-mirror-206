...
class BevelDifferentialGearMeshSteadyStateSynchronousResponse(_2978.BevelGearMeshSteadyStateSynchronousResponse):
    ...
    class _Cast_BevelDifferentialGearMeshSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_steady_state_synchronous_response(self) -> 'BevelDifferentialGearMeshSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshSteadyStateSynchronousResponse._Cast_BevelDifferentialGearMeshSteadyStateSynchronousResponse':
