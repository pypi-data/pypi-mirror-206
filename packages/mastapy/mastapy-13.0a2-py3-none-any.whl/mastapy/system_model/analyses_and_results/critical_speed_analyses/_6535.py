...
class ConceptCouplingCriticalSpeedAnalysis(_6546.CouplingCriticalSpeedAnalysis):
    """ConceptCouplingCriticalSpeedAnalysis
    ...
    class _Cast_ConceptCouplingCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ConceptCouplingCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_coupling_critical_speed_analysis(self) -> 'ConceptCouplingCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingCriticalSpeedAnalysis._Cast_ConceptCouplingCriticalSpeedAnalysis':
