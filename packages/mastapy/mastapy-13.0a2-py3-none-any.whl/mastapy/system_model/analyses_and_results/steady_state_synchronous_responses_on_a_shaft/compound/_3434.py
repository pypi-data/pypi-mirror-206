...
class PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft(_3391.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    """PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3306.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3306.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft._Cast_PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft(self)
