...
class PointLoadCompoundModalAnalysis(_4823.VirtualComponentCompoundModalAnalysis):
    """PointLoadCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4642.PointLoadModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4642.PointLoadModalAnalysis]':
