...
class XlsHyperLinksCollection (  CollectionBase[XlsHyperLink],ICloneParent, IHyperLinks) :
    ...
    def get_Item(self ,index:int)->'IHyperLink':
        ...
        intPtr = GetDllLibXls().XlsHyperLinksCollection_get_Item(self.Ptr, index)
    ...
    <returns>A new object that is a copy of this instance.</returns>
        ...
        intPtr = GetDllLibXls().XlsHyperLinksCollection_Clone(self.Ptr, intPtrparent)
    ...
    def Add(self ,range:'IXLSRange')->'IHyperLink':
        ...
        intPtr = GetDllLibXls().XlsHyperLinksCollection_Add(self.Ptr, intPtrrange)
        ret = None if intPtr==None else HyperLink(intPtr)
        return ret
    ...
    def IsReadOnly(self)->bool:
        ...
        ret = GetDllLibXls().XlsHyperLinksCollection_get_IsReadOnly(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsHyperLinksCollection_CreateHyperlinkStyles(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsHyperLinksCollection_GetRangeHyperlinks(self.Ptr, intPtrrange)
