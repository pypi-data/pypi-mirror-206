...
class RollingRingCompoundDynamicAnalysis(_6412.CouplingHalfCompoundDynamicAnalysis):
    """RollingRingCompoundDynamicAnalysis
    ...
    class _Cast_RollingRingCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'RollingRingCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def rolling_ring_compound_dynamic_analysis(self) -> 'RollingRingCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6337.RollingRingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6337.RollingRingDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'RollingRingCompoundDynamicAnalysis._Cast_RollingRingCompoundDynamicAnalysis':
