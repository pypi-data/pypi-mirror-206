...
with open(os.path.join(here, 'amazon-captcha', '__version__.py'), 'r', encoding='utf-8') as f:
...
setuptools.setup(
    ...
    packages=['amazon-captcha'],
    py_modules=['devtools', 'exceptions', 'solver', 'utils'],
    include_package_data=True,
    package_data={'': ['*.json'], 'amazon-captcha': ['training_data/*.*']},
    ...
    url=about['__url__'],
    project_urls={
        'Documentation': 'https://amazon-captcha.readthedocs.io/en/latest/',
