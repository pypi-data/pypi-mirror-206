...
class GearSetCompoundCriticalSpeedAnalysis(_6737.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """GearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6570.GearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6570.GearSetCriticalSpeedAnalysis]':
