...
class LinkTokenCreateRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'link_customization_name': (str, none_type,),  # noqa: E501
            'redirect_uri': (str, none_type,),  # noqa: E501
            'android_package_name': (str, none_type,),  # noqa: E501
            ...
            'user_token': (str, none_type,),  # noqa: E501
    ...
    def __init__(self, client_name, language, country_codes, user, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            client_id (str, none_type): Your Plaid API `client_id`. The `client_id` is required and may be provided either in the `PLAID-CLIENT-ID` header or as part of a request body.. [optional]  # noqa: E501
            secret (str, none_type): Your Plaid API `secret`. The `secret` is required and may be provided either in the `PLAID-SECRET` header or as part of a request body.. [optional]  # noqa: E501
            ...
            webhook (str, none_type): The destination URL to which any webhooks should be sent. Note that webhooks for Payment Initiation (e-wallet transactions only), Transfer, Bank Transfer (including Auth micro-deposit notification webhooks) and Identity Verification are configured via the Dashboard instead.. [optional]  # noqa: E501
            ...
            institution_id (str, none_type): Used for certain Europe-only configurations, as well as certain legacy use cases in other regions.. [optional]  # noqa: E501
            ...
            user_token (str, none_type): A user token generated using `/user/create`. Any Item created during the Link session will be associated with the user.. [optional]  # noqa: E501
