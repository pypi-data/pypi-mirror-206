...
from mastapy.system_model.part_model.couplings import _2583, _2585
...
class SynchroniserShift(_0.APIBase):
    ...
    class _Cast_SynchroniserShift:
        ...
        def __init__(self, parent: 'SynchroniserShift'):
            self._parent = parent

        @property
        def synchroniser_shift(self) -> 'SynchroniserShift':
            return self._parent
    ...
    @property
    def cone(self) -> '_2583.SynchroniserHalf':
    ...
    @property
    def sleeve(self) -> '_2585.SynchroniserSleeve':
    ...
    @property
    def cast_to(self) -> 'SynchroniserShift._Cast_SynchroniserShift':
