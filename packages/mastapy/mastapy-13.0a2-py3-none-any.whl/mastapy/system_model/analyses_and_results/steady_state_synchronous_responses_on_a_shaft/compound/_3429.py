...
class MassDiscCompoundSteadyStateSynchronousResponseOnAShaft(_3476.VirtualComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """MassDiscCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_MassDiscCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'MassDiscCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def mass_disc_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'MassDiscCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3299.MassDiscSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3299.MassDiscSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'MassDiscCompoundSteadyStateSynchronousResponseOnAShaft._Cast_MassDiscCompoundSteadyStateSynchronousResponseOnAShaft':
