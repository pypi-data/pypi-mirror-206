...
class GeomertyAdjustValue (SpireObject) :
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().GeomertyAdjustValue_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().GeomertyAdjustValue_get_Name(self.Ptr)
        return ret
    ...
    def Formula(self)->str:
        ...
        GetDllLibXls().GeomertyAdjustValue_get_Formula.restype=c_wchar_p
        ret = GetDllLibXls().GeomertyAdjustValue_get_Formula(self.Ptr)
        return ret
    ...
    def SetFormulaParameter(self ,args:List[float]):
        ...
        GetDllLibXls().GeomertyAdjustValue_SetFormulaParameter(self.Ptr, arrayargs,countargs)
    ...
    def FormulaType(self)->'GeomertyAdjustValueFormulaType':
        ...
        ret = GetDllLibXls().GeomertyAdjustValue_FormulaType(self.Ptr)
