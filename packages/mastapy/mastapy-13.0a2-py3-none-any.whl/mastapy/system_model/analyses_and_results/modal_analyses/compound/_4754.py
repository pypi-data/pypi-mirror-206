...
class FaceGearCompoundModalAnalysis(_4759.GearCompoundModalAnalysis):
    """FaceGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4604.FaceGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4604.FaceGearModalAnalysis]':
