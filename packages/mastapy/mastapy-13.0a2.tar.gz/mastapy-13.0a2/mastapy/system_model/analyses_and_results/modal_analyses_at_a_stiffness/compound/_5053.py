...
class RollingRingConnectionCompoundModalAnalysisAtAStiffness(_5025.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """RollingRingConnectionCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_RollingRingConnectionCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'RollingRingConnectionCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def rolling_ring_connection_compound_modal_analysis_at_a_stiffness(self) -> 'RollingRingConnectionCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4923.RollingRingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4923.RollingRingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'RollingRingConnectionCompoundModalAnalysisAtAStiffness._Cast_RollingRingConnectionCompoundModalAnalysisAtAStiffness':
