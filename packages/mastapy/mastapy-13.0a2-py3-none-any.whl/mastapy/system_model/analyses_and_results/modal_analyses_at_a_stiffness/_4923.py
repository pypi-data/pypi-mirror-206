...
class RollingRingConnectionModalAnalysisAtAStiffness(_4896.InterMountableComponentConnectionModalAnalysisAtAStiffness):
    """RollingRingConnectionModalAnalysisAtAStiffness
    ...
    class _Cast_RollingRingConnectionModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'RollingRingConnectionModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def rolling_ring_connection_modal_analysis_at_a_stiffness(self) -> 'RollingRingConnectionModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingConnectionModalAnalysisAtAStiffness._Cast_RollingRingConnectionModalAnalysisAtAStiffness':
