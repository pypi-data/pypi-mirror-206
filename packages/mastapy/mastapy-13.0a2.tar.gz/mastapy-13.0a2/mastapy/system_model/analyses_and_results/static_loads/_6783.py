...
from mastapy.system_model.analyses_and_results.static_loads import (
    _6784, _6786, _6789, _6795,
    _6796, _6819, _6797, _6799,
    _6804, _6807, _6821, _6823,
    _6829, _6851, _6850, _6852,
    _6856, _6871, _6881, _6884,
    _6885, _6886, _6890, _6895,
    _6899, _6902, _6903, _6907,
    _6908, _6909, _6913, _6914,
    _6773, _6919, _6922, _6925,
    _6928, _6932, _6937, _6944,
    _6948, _6951, _6771
)
...
class AssemblyLoadCase(_6771.AbstractAssemblyLoadCase):
    """AssemblyLoadCase
    ...
    @property
    def bearings(self) -> 'List[_6784.BearingLoadCase]':
    ...
    @property
    def belt_drives(self) -> 'List[_6786.BeltDriveLoadCase]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6789.BevelDifferentialGearSetLoadCase]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6795.BoltedJointLoadCase]':
    ...
    @property
    def bolts(self) -> 'List[_6796.BoltLoadCase]':
    ...
    @property
    def cv_ts(self) -> 'List[_6819.CVTLoadCase]':
    ...
    @property
    def clutch_connections(self) -> 'List[_6797.ClutchConnectionLoadCase]':
    ...
    @property
    def clutches(self) -> 'List[_6799.ClutchLoadCase]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6804.ConceptCouplingLoadCase]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6807.ConceptGearSetLoadCase]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6821.CycloidalAssemblyLoadCase]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6823.CycloidalDiscLoadCase]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6829.CylindricalGearSetLoadCase]':
    ...
    @property
    def fe_parts(self) -> 'List[_6851.FEPartLoadCase]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6850.FaceGearSetLoadCase]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6852.FlexiblePinAssemblyLoadCase]':
    ...
    @property
    def gear_meshes(self) -> 'List[_6856.GearMeshLoadCase]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6871.HypoidGearSetLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6881.KlingelnbergCycloPalloidHypoidGearSetLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6884.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase]':
    ...
    @property
    def mass_discs(self) -> 'List[_6885.MassDiscLoadCase]':
    ...
    @property
    def measurement_components(self) -> 'List[_6886.MeasurementComponentLoadCase]':
    ...
    @property
    def oil_seals(self) -> 'List[_6890.OilSealLoadCase]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6895.PartToPartShearCouplingLoadCase]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6899.PlanetCarrierLoadCase]':
    ...
    @property
    def point_loads(self) -> 'List[_6902.PointLoadLoadCase]':
    ...
    @property
    def ring_pins(self) -> 'List[_6907.RingPinsLoadCase]':
    ...
    @property
    def ring_pins_to_cycloidal_disc_connections(self) -> 'List[_6908.RingPinsToDiscConnectionLoadCase]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6909.RollingRingAssemblyLoadCase]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6913.ShaftHubConnectionLoadCase]':
    ...
    @property
    def shafts(self) -> 'List[_6914.ShaftLoadCase]':
    ...
    @property
    def shafts_and_housings(self) -> 'List[_6773.AbstractShaftOrHousingLoadCase]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6919.SpiralBevelGearSetLoadCase]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6922.SpringDamperLoadCase]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6925.StraightBevelDiffGearSetLoadCase]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6928.StraightBevelGearSetLoadCase]':
    ...
    @property
    def synchronisers(self) -> 'List[_6932.SynchroniserLoadCase]':
    ...
    @property
    def torque_converters(self) -> 'List[_6937.TorqueConverterLoadCase]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6944.UnbalancedMassLoadCase]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6948.WormGearSetLoadCase]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6951.ZerolBevelGearSetLoadCase]':
