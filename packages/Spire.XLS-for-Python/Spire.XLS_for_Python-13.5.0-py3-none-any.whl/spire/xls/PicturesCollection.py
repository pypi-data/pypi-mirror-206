...
class PicturesCollection (  XlsPicturesCollection) :
    ...
    #    intPtr = GetDllLibXls().PicturesCollection_get_Item(self.Ptr, Index)
    ...
    #    intPtr = GetDllLibXls().PicturesCollection_Add(self.Ptr, intPtrimage,pictureName)
    #    ret = None if intPtr==None else ExcelPicture(intPtr)
    #    return ret
    ...
    #    intPtr = GetDllLibXls().PicturesCollection_AddIPI(self.Ptr, intPtrimage,pictureName,enumimageFormat)
    #    ret = None if intPtr==None else ExcelPicture(intPtr)
    #    return ret
    ...
    <returns>Added picture.</returns>
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddF(self.Ptr, fileName)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
    ...
    <returns>Added picture.</returns>
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddFI(self.Ptr, fileName,enumimageFormat)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
    ...
    #    intPtr = GetDllLibXls().PicturesCollection_AddTLI(self.Ptr, topRow,leftColumn,intPtrimage)
    #    ret = None if intPtr==None else ExcelPicture(intPtr)
    #    return ret
    ...
    #    intPtr = GetDllLibXls().PicturesCollection_AddTLII(self.Ptr, topRow,leftColumn,intPtrimage,enumimageFormat)
    #    ret = None if intPtr==None else ExcelPicture(intPtr)
    #    return ret
    ...
    <returns>Added picture.</returns>
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddTLS(self.Ptr, topRow,leftColumn,intPtrstream)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
    ...
    <returns>Added picture.</returns>
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddTLSI(self.Ptr, topRow,leftColumn,intPtrstream,enumimageFormat)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
    ...
    <returns>Added picture.</returns>
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddTLF(self.Ptr, topRow,leftColumn,fileName)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
    ...
    <returns>Added picture.</returns>
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddTLFI(self.Ptr, topRow,leftColumn,fileName,enumimageFormat)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
    ...
    #    intPtr = GetDllLibXls().PicturesCollection_AddTLBRI(self.Ptr, topRow,leftColumn,bottomRow,rightColumn,intPtrimage)
    #    ret = None if intPtr==None else ExcelPicture(intPtr)
    #    return ret
    ...
    def AddLinkPic(self ,topRow:int,leftColumn:int,height:int,width:int,linktarget:str)->'ExcelPicture':
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddLinkPic(self.Ptr, topRow,leftColumn,height,width,linktarget)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
    ...
    #    intPtr = GetDllLibXls().PicturesCollection_AddTLBRII(self.Ptr, topRow,leftColumn,bottomRow,rightColumn,intPtrimage,enumimageFormat)
    #    ret = None if intPtr==None else ExcelPicture(intPtr)
    #    return ret
    ...
    <returns>Added picture.</returns>
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddTLBRS(self.Ptr, topRow,leftColumn,bottomRow,rightColumn,intPtrstream)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
    ...
    <returns>Added picture.</returns>
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddTLBRSI(self.Ptr, topRow,leftColumn,bottomRow,rightColumn,intPtrstream,enumimageFormat)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
    ...
    <returns>Added picture.</returns>
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddTLBRF(self.Ptr, topRow,leftColumn,bottomRow,rightColumn,fileName)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
    ...
    <returns>Added picture.</returns>
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddTLBRFI(self.Ptr, topRow,leftColumn,bottomRow,rightColumn,fileName,enumimageFormat)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
    ...
    #    intPtr = GetDllLibXls().PicturesCollection_AddTLISS(self.Ptr, topRow,leftColumn,intPtrimage,scaleWidth,scaleHeight)
    #    ret = None if intPtr==None else ExcelPicture(intPtr)
    #    return ret
    ...
    #    intPtr = GetDllLibXls().PicturesCollection_AddTLISSI(self.Ptr, topRow,leftColumn,intPtrimage,scaleWidth,scaleHeight,enumimageFormat)
    #    ret = None if intPtr==None else ExcelPicture(intPtr)
    #    return ret
    ...
    <returns>Added picture.</returns>
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddTLSSS(self.Ptr, topRow,leftColumn,intPtrstream,scaleWidth,scaleHeight)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
    ...
    <returns>Added picture.</returns>
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddTLSSSI(self.Ptr, topRow,leftColumn,intPtrstream,scaleWidth,scaleHeight,enumimageFormat)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
    ...
    <returns>Added picture.</returns>
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddTLFSS(self.Ptr, topRow,leftColumn,fileName,scaleWidth,scaleHeight)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
    ...
    <returns>Added picture.</returns>
        ...
        intPtr = GetDllLibXls().PicturesCollection_AddTLFSSI(self.Ptr, topRow,leftColumn,fileName,scaleWidth,scaleHeight,enumimageFormat)
        ret = None if intPtr==None else ExcelPicture(intPtr)
        return ret
