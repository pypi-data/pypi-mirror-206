...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5488, _5487, _5411
...
class WormGearSetMultibodyDynamicsAnalysis(_5411.GearSetMultibodyDynamicsAnalysis):
    """WormGearSetMultibodyDynamicsAnalysis
    ...
    class _Cast_WormGearSetMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'WormGearSetMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def worm_gear_set_multibody_dynamics_analysis(self) -> 'WormGearSetMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def gears(self) -> 'List[_5488.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gears_multibody_dynamics_analysis(self) -> 'List[_5488.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_meshes_multibody_dynamics_analysis(self) -> 'List[_5487.WormGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'WormGearSetMultibodyDynamicsAnalysis._Cast_WormGearSetMultibodyDynamicsAnalysis':
