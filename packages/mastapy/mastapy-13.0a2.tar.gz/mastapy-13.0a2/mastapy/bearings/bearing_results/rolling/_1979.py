...
class LoadedAxialThrustCylindricalRollerBearingResults(_2009.LoadedNonBarrelRollerBearingResults):
    """LoadedAxialThrustCylindricalRollerBearingResults
    ...
    class _Cast_LoadedAxialThrustCylindricalRollerBearingResults:
        ...
        def __init__(self, parent: 'LoadedAxialThrustCylindricalRollerBearingResults'):
            self._parent = parent
        ...
        @property
        def loaded_axial_thrust_cylindrical_roller_bearing_results(self) -> 'LoadedAxialThrustCylindricalRollerBearingResults':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'LoadedAxialThrustCylindricalRollerBearingResults._Cast_LoadedAxialThrustCylindricalRollerBearingResults':
