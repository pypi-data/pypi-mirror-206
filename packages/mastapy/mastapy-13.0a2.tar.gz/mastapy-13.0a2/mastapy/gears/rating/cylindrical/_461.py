...
from mastapy.gears.rating import _353, _360
...
class CylindricalGearSingleFlankRating(_360.GearSingleFlankRating):
    """CylindricalGearSingleFlankRating
    ...
    class _Cast_CylindricalGearSingleFlankRating:
        ...
        def plastic_vdi2736_gear_single_flank_rating_in_a_metal_plastic_or_a_plastic_metal_mesh(self):
            ...
            return self._parent._cast(_491.PlasticVDI2736GearSingleFlankRatingInAMetalPlasticOrAPlasticMetalMesh)
        ...
        def iso6336_abstract_metal_gear_single_flank_rating(self):
            ...
            return self._parent._cast(_514.ISO6336AbstractMetalGearSingleFlankRating)

        @property
        def din3990_gear_single_flank_rating(self):
            from mastapy.gears.rating.cylindrical.din3990 import _527
            
            return self._parent._cast(_527.DIN3990GearSingleFlankRating)

        @property
        def agma2101_gear_single_flank_rating(self):
            from mastapy.gears.rating.cylindrical.agma import _529
            
            return self._parent._cast(_529.AGMA2101GearSingleFlankRating)
    ...
    @property
    def geometry_data_source_for_rating(self) -> '_457.CylindricalGearRatingGeometryDataSource':
        ...
        value = conversion.pn_to_mp_enum(temp, _457.CylindricalGearRatingGeometryDataSource)
        return constructor.new_from_mastapy_type(_457.CylindricalGearRatingGeometryDataSource)(value) if value is not None else None
    ...
    @property
    def is_gear_driving_or_driven(self) -> '_353.FlankLoadingState':
        ...
        value = conversion.pn_to_mp_enum(temp, _353.FlankLoadingState)
        return constructor.new_from_mastapy_type(_353.FlankLoadingState)(value) if value is not None else None
    ...
    @property
    def metal_plastic(self) -> '_271.MetalPlasticType':
        ...
        value = conversion.pn_to_mp_enum(temp, _271.MetalPlasticType)
        return constructor.new_from_mastapy_type(_271.MetalPlasticType)(value) if value is not None else None
