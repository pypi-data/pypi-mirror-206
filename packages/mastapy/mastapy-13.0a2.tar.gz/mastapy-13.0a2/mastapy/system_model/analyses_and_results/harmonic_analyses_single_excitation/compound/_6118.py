...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6116, _6117, _6123
...
class BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6123.BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_set_compound_harmonic_analysis_of_single_excitation(self) -> 'BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5988.BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bevel_differential_gears_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6116.BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bevel_differential_meshes_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6117.BevelDifferentialGearMeshCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5988.BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation._Cast_BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation(self)
