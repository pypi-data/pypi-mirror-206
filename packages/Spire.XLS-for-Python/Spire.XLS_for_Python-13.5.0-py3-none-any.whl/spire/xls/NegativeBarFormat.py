...
class NegativeBarFormat (SpireObject) :
    ...
    def BorderColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().NegativeBarFormat_get_BorderColor(self.Ptr)
    ...
    def BorderColor(self, value:'Color'):
        ...
        GetDllLibXls().NegativeBarFormat_set_BorderColor(self.Ptr, value.Ptr)
    ...
    def BorderColorType(self)->'DataBarNegativeColorType':
        ...
        ret = GetDllLibXls().NegativeBarFormat_get_BorderColorType(self.Ptr)
    ...
    def BorderColorType(self, value:'DataBarNegativeColorType'):
        ...
        GetDllLibXls().NegativeBarFormat_set_BorderColorType(self.Ptr, value.value)
    ...
    def Color(self)->'Color':
        ...
        intPtr = GetDllLibXls().NegativeBarFormat_get_Color(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().NegativeBarFormat_set_Color(self.Ptr, value.Ptr)
    ...
    def ColorType(self)->'DataBarNegativeColorType':
        ...
        ret = GetDllLibXls().NegativeBarFormat_get_ColorType(self.Ptr)
        objwraped = DataBarNegativeColorType(ret)
        return objwraped
    ...
    def ColorType(self, value:'DataBarNegativeColorType'):
        ...
        GetDllLibXls().NegativeBarFormat_set_ColorType(self.Ptr, value.value)
