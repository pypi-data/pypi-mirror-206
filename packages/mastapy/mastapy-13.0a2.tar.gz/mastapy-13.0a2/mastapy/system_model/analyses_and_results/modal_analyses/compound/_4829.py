...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4827, _4828, _4719
...
class ZerolBevelGearSetCompoundModalAnalysis(_4719.BevelGearSetCompoundModalAnalysis):
    """ZerolBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4688.ZerolBevelGearSetModalAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_modal_analysis(self) -> 'List[_4827.ZerolBevelGearCompoundModalAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_modal_analysis(self) -> 'List[_4828.ZerolBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4688.ZerolBevelGearSetModalAnalysis]':
