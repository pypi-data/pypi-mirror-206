...
from ...models.refresh_products_request import RefreshProductsRequest
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: RefreshProductsRequest,
    moneykit_version: Union[Unset, None, SupportedVersion] = SupportedVersion.VALUE_0,
) -> Dict[str, Any]:
    url = "{}/links/{id}/products".format(client.base_url, id=id)
    ...
    *,
    ...
    """/links/{id}/products
     ...
     Requests an update of the provided products for the link.
        This is an asynchronous operation. The response will be a 202 Accepted if the request was
    successful.
    ...
    Returns:
        Response[Union[APIErrorRateLimitExceededResponse, Any, LinkErrorBadStateResponse, LinkErrorDeletedResponse, LinkErrorForbiddenActionResponse, LinkErrorNotFoundResponse, Union['APIErrorAuthExpiredAccessTokenResponse', 'APIErrorAuthUnauthorizedResponse', 'LinkErrorUnauthorizedAccessResponse']]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[APIErrorRateLimitExceededResponse, Any, LinkErrorBadStateResponse, LinkErrorDeletedResponse, LinkErrorForbiddenActionResponse, LinkErrorNotFoundResponse, Union['APIErrorAuthExpiredAccessTokenResponse', 'APIErrorAuthUnauthorizedResponse', 'LinkErrorUnauthorizedAccessResponse']]
    """
