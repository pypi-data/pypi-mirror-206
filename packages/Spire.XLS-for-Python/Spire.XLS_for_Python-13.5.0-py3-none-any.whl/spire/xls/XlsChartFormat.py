...
class XlsChartFormat (  XlsObject, IChartFormat, ICloneParent) :
    ...
    def IsPrimaryAxis(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsPrimaryAxis(self.Ptr)
        return ret
    ...
    def IsSeriesName(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsSeriesName(self.Ptr)
        return ret

    @IsSeriesName.setter
    def IsSeriesName(self, value:bool):
        GetDllLibXls().XlsChartFormat_set_IsSeriesName.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFormat_set_IsSeriesName(self.Ptr, value)
    ...
    def IsShowLeaderLines(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsShowLeaderLines(self.Ptr)
        return ret
    ...
    def IsShowLeaderLines(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_IsShowLeaderLines(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsSmoothed(self.Ptr)
        return ret
    ...
    def IsStacked(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsStacked(self.Ptr)
        return ret

    @IsStacked.setter
    def IsStacked(self, value:bool):
        GetDllLibXls().XlsChartFormat_set_IsStacked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFormat_set_IsStacked(self.Ptr, value)
    ...
    def LineStyle(self)->'DropLineStyleType':
        ...
        ret = GetDllLibXls().XlsChartFormat_get_LineStyle(self.Ptr)
    ...
    def LineStyle(self, value:'DropLineStyleType'):
        ...
        GetDllLibXls().XlsChartFormat_set_LineStyle(self.Ptr, value.value)
    ...
    def NumSplitValue(self)->int:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_NumSplitValue(self.Ptr)
        return ret
    ...
    def NumSplitValue(self, value:int):
        ...
        GetDllLibXls().XlsChartFormat_set_NumSplitValue(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_Perspective(self.Ptr)
        return ret

    @Perspective.setter
    def Perspective(self, value:int):
        GetDllLibXls().XlsChartFormat_set_Perspective.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFormat_set_Perspective(self.Ptr, value)
    ...
    def PieChartType(self)->'ChartPieType':
        ...
        ret = GetDllLibXls().XlsChartFormat_get_PieChartType(self.Ptr)
    ...
    def PieChartType(self, value:'ChartPieType'):
        ...
        GetDllLibXls().XlsChartFormat_set_PieChartType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_RightAngleAxes(self.Ptr)
        return ret
    ...
    def RightAngleAxes(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_RightAngleAxes(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:int):
        GetDllLibXls().XlsChartFormat_set_Rotation.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFormat_set_Rotation(self.Ptr, value)
    ...
    def ShowAsPercentsBar(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_ShowAsPercentsBar(self.Ptr)
        return ret
    ...
    def ShowAsPercentsBar(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_ShowAsPercentsBar(self.Ptr, value)
    ...
    def ShowAsPercentsLine(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_ShowAsPercentsLine(self.Ptr)
        return ret
    ...
    def ShowAsPercentsLine(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_ShowAsPercentsLine(self.Ptr, value)
    ...
    def SplitPercent(self)->int:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_SplitPercent(self.Ptr)
        return ret

    @SplitPercent.setter
    def SplitPercent(self, value:int):
        GetDllLibXls().XlsChartFormat_set_SplitPercent.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFormat_set_SplitPercent(self.Ptr, value)
    ...
    def StackValuesBar(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_StackValuesBar(self.Ptr)
        return ret
    ...
    def StackValuesBar(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_StackValuesBar(self.Ptr, value)
    ...
    def StackValuesLine(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_StackValuesLine(self.Ptr)
        return ret
    ...
    def StackValuesLine(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_StackValuesLine(self.Ptr, value)
    ...
    def UseDefaultSplitValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_UseDefaultSplitValue(self.Ptr)
        return ret
    ...
    def UseDefaultSplitValue(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_UseDefaultSplitValue(self.Ptr, value)
    ...
    def WallsAndGridlines2D(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_WallsAndGridlines2D(self.Ptr)
        return ret
    ...
    def WallsAndGridlines2D(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_WallsAndGridlines2D(self.Ptr, value)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsChartFormat_Clone(self.Ptr, intPtrparent)
    ...
    def IsVaryColor(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsVaryColor(self.Ptr)
        return ret

    @IsVaryColor.setter
    def IsVaryColor(self, value:bool):
        GetDllLibXls().XlsChartFormat_set_IsVaryColor.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFormat_set_IsVaryColor(self.Ptr, value)
    ...
    def IsVeryColor(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsVeryColor(self.Ptr)
        return ret

    @IsVeryColor.setter
    def IsVeryColor(self, value:bool):
        GetDllLibXls().XlsChartFormat_set_IsVeryColor.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFormat_set_IsVeryColor(self.Ptr, value)
    ...
    def Overlap(self)->int:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_Overlap(self.Ptr)
        return ret

    @Overlap.setter
    def Overlap(self, value:int):
        GetDllLibXls().XlsChartFormat_set_Overlap.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFormat_set_Overlap(self.Ptr, value)
    ...
    def GapWidth(self)->int:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_GapWidth(self.Ptr)
        return ret

    @GapWidth.setter
    def GapWidth(self, value:int):
        GetDllLibXls().XlsChartFormat_set_GapWidth.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFormat_set_GapWidth(self.Ptr, value)
    ...
    def FirstSliceAngle(self)->int:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_FirstSliceAngle(self.Ptr)
        return ret
    ...
    def FirstSliceAngle(self, value:int):
        ...
        GetDllLibXls().XlsChartFormat_set_FirstSliceAngle(self.Ptr, value)
    ...
    def DoughnutHoleSize(self)->int:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_DoughnutHoleSize(self.Ptr)
        return ret
    ...
    def DoughnutHoleSize(self, value:int):
        ...
        GetDllLibXls().XlsChartFormat_set_DoughnutHoleSize(self.Ptr, value)
    ...
    def BubbleScale(self)->int:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_BubbleScale(self.Ptr)
        return ret

    @BubbleScale.setter
    def BubbleScale(self, value:int):
        GetDllLibXls().XlsChartFormat_set_BubbleScale.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFormat_set_BubbleScale(self.Ptr, value)
    ...
    def SizeRepresents(self)->'BubbleSizeType':
        ...
        ret = GetDllLibXls().XlsChartFormat_get_SizeRepresents(self.Ptr)
    ...
    def SizeRepresents(self, value:'BubbleSizeType'):
        ...
        GetDllLibXls().XlsChartFormat_set_SizeRepresents(self.Ptr, value.value)
    ...
    def ShowNegativeBubbles(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_ShowNegativeBubbles(self.Ptr)
        return ret
    ...
    def ShowNegativeBubbles(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_ShowNegativeBubbles(self.Ptr, value)
    ...
    def HasRadarAxisLabels(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_HasRadarAxisLabels(self.Ptr)
        return ret
    ...
    def HasRadarAxisLabels(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_HasRadarAxisLabels(self.Ptr, value)
    ...
    def SplitType(self)->'SplitType':
        ...
        ret = GetDllLibXls().XlsChartFormat_get_SplitType(self.Ptr)
    ...
    def SplitType(self, value:'SplitType'):
        ...
        GetDllLibXls().XlsChartFormat_set_SplitType(self.Ptr, value.value)
    ...
    def SplitValue(self)->int:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_SplitValue(self.Ptr)
        return ret

    @SplitValue.setter
    def SplitValue(self, value:int):
        GetDllLibXls().XlsChartFormat_set_SplitValue.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFormat_set_SplitValue(self.Ptr, value)
    ...
    def PieSecondSize(self)->int:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_PieSecondSize(self.Ptr)
        return ret
    ...
    def PieSecondSize(self, value:int):
        ...
        GetDllLibXls().XlsChartFormat_set_PieSecondSize(self.Ptr, value)
    ...
    def FirstDropBar(self)->'IChartDropBar':
        ...
        intPtr = GetDllLibXls().XlsChartFormat_get_FirstDropBar(self.Ptr)
    ...
    def SecondDropBar(self)->'IChartDropBar':
        ...
        intPtr = GetDllLibXls().XlsChartFormat_get_SecondDropBar(self.Ptr)
        ret = None if intPtr==None else IChartDropBar(intPtr)
        return ret
    ...
    def PieSeriesLine(self)->'IChartBorder':
        ...
        intPtr = GetDllLibXls().XlsChartFormat_get_PieSeriesLine(self.Ptr)
    ...
    def DataFormatOrNull(self)->'XlsChartSerieDataFormat':
        ...
        intPtr = GetDllLibXls().XlsChartFormat_get_DataFormatOrNull(self.Ptr)
    ...
    def Delimiter(self)->str:
        ...
        GetDllLibXls().XlsChartFormat_get_Delimiter.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartFormat_get_Delimiter(self.Ptr)
        return ret
    ...
    def Delimiter(self, value:str):
        ...
        GetDllLibXls().XlsChartFormat_set_Delimiter(self.Ptr, value)
    ...
    def DelimiterLength(self)->int:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_DelimiterLength(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_DepthPercent(self.Ptr)
        return ret

    @DepthPercent.setter
    def DepthPercent(self, value:int):
        GetDllLibXls().XlsChartFormat_set_DepthPercent.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFormat_set_DepthPercent(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_DrawingZOrder(self.Ptr)
        return ret
    ...
    def DrawingZOrder(self, value:int):
        ...
        GetDllLibXls().XlsChartFormat_set_DrawingZOrder(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_Elevation(self.Ptr)
        return ret

    @Elevation.setter
    def Elevation(self, value:int):
        GetDllLibXls().XlsChartFormat_set_Elevation.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFormat_set_Elevation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_AutoScaling(self.Ptr)
        return ret

    @AutoScaling.setter
    def AutoScaling(self, value:bool):
        GetDllLibXls().XlsChartFormat_set_AutoScaling.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFormat_set_AutoScaling(self.Ptr, value)
    ...
    def Gap(self)->int:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_Gap(self.Ptr)
        return ret

    @Gap.setter
    def Gap(self, value:int):
        GetDllLibXls().XlsChartFormat_set_Gap.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFormat_set_Gap(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_GapDepth(self.Ptr)
        return ret

    @GapDepth.setter
    def GapDepth(self, value:int):
        GetDllLibXls().XlsChartFormat_set_GapDepth.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFormat_set_GapDepth(self.Ptr, value)
    ...
    def HasShadowBar(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_HasShadowBar(self.Ptr)
        return ret

    @HasShadowBar.setter
    def HasShadowBar(self, value:bool):
        GetDllLibXls().XlsChartFormat_set_HasShadowBar.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFormat_set_HasShadowBar(self.Ptr, value)
    ...
    def HasShadowBoppop(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_HasShadowBoppop(self.Ptr)
        return ret
    ...
    def HasShadowBoppop(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_HasShadowBoppop(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_HasShadowLine(self.Ptr)
        return ret
    ...
    def HasShadowLine(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_HasShadowLine(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_HasShadowPie(self.Ptr)
        return ret

    @HasShadowPie.setter
    def HasShadowPie(self, value:bool):
        GetDllLibXls().XlsChartFormat_set_HasShadowPie.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFormat_set_HasShadowPie(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_HasShadowRadar(self.Ptr)
        return ret
    ...
    def HasShadowRadar(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_HasShadowRadar(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_HasShadowScatter(self.Ptr)
        return ret
    ...
    def HasShadowScatter(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_HasShadowScatter(self.Ptr, value)
    ...
    def HasValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_HasValue(self.Ptr)
        return ret

    @HasValue.setter
    def HasValue(self, value:bool):
        GetDllLibXls().XlsChartFormat_set_HasValue.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFormat_set_HasValue(self.Ptr, value)
    ...
    def HasWedgeCallout(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_HasWedgeCallout(self.Ptr)
        return ret
    ...
    def HasWedgeCallout(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_HasWedgeCallout(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_HeightPercent(self.Ptr)
        return ret
    ...
    def HeightPercent(self, value:int):
        ...
        GetDllLibXls().XlsChartFormat_set_HeightPercent(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_Is3D(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_Is3DPhongShade(self.Ptr)
        return ret
    ...
    def Is3DPhongShade(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_Is3DPhongShade(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsAreaShadowed(self.Ptr)
        return ret
    ...
    def IsAreaShadowed(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_IsAreaShadowed(self.Ptr, value)
    ...
    def IsBubbles(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsBubbles(self.Ptr)
        return ret

    @IsBubbles.setter
    def IsBubbles(self, value:bool):
        GetDllLibXls().XlsChartFormat_set_IsBubbles.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFormat_set_IsBubbles(self.Ptr, value)
    ...
    def IsBubbleSize(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsBubbleSize(self.Ptr)
        return ret

    @IsBubbleSize.setter
    def IsBubbleSize(self, value:bool):
        GetDllLibXls().XlsChartFormat_set_IsBubbleSize.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFormat_set_IsBubbleSize(self.Ptr, value)
    ...
    def IsCategoryBrokenDown(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsCategoryBrokenDown(self.Ptr)
        return ret
    ...
    def IsCategoryBrokenDown(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_IsCategoryBrokenDown(self.Ptr, value)
    ...
    def IsCategoryName(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsCategoryName(self.Ptr)
        return ret
    ...
    def IsCategoryName(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_IsCategoryName(self.Ptr, value)
    ...
    def IsChartChartLine(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsChartChartLine(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsChartLineFormat(self.Ptr)
        return ret
    ...
    def IsClustered(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsClustered(self.Ptr)
        return ret

    @IsClustered.setter
    def IsClustered(self, value:bool):
        GetDllLibXls().XlsChartFormat_set_IsClustered.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFormat_set_IsClustered(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsDefaultElevation(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsDefaultRotation(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsDropBar(self.Ptr)
        return ret
    ...
    def IsFillSurface(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsFillSurface(self.Ptr)
        return ret
    ...
    def IsFillSurface(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_IsFillSurface(self.Ptr, value)
    ...
    def IsHorizontalBar(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsHorizontalBar(self.Ptr)
        return ret
    ...
    def IsHorizontalBar(self, value:bool):
        ...
        GetDllLibXls().XlsChartFormat_set_IsHorizontalBar(self.Ptr, value)
    ...
    def IsLine(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsLine(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsMarker(self.Ptr)
        return ret
    ...
    def IsPercentage(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFormat_get_IsPercentage(self.Ptr)
        return ret

    @IsPercentage.setter
    def IsPercentage(self, value:bool):
        GetDllLibXls().XlsChartFormat_set_IsPercentage.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFormat_set_IsPercentage(self.Ptr, value)
