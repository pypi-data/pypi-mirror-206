...
class BearingCompoundSteadyStateSynchronousResponseAtASpeed(_3649.ConnectorCompoundSteadyStateSynchronousResponseAtASpeed):
    """BearingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3491.BearingSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3491.BearingSteadyStateSynchronousResponseAtASpeed]':
