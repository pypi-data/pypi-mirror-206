...
class ConnectionCompoundSteadyStateSynchronousResponse(_7501.ConnectionCompoundAnalysis):
    """ConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2997.ConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2997.ConnectionSteadyStateSynchronousResponse]':
