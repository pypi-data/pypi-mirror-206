...
class DataBar (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().DataBar_get_MinPoint(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().DataBar_get_MaxPoint(self.Ptr)
        ret = None if intPtr==None else ConditionValue(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().DataBar_get_BarColor(self.Ptr)
    ...
    def BarColor(self, value:'Color'):
        ...
        GetDllLibXls().DataBar_set_BarColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().DataBar_get_PercentMax(self.Ptr)
        return ret

    @PercentMax.setter
    def PercentMax(self, value:int):
        GetDllLibXls().DataBar_set_PercentMax.argtypes=[c_void_p, c_int]
        GetDllLibXls().DataBar_set_PercentMax(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().DataBar_get_PercentMin(self.Ptr)
        return ret

    @PercentMin.setter
    def PercentMin(self, value:int):
        GetDllLibXls().DataBar_set_PercentMin.argtypes=[c_void_p, c_int]
        GetDllLibXls().DataBar_set_PercentMin(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().DataBar_get_ShowValue(self.Ptr)
        return ret

    @ShowValue.setter
    def ShowValue(self, value:bool):
        GetDllLibXls().DataBar_set_ShowValue.argtypes=[c_void_p, c_bool]
        GetDllLibXls().DataBar_set_ShowValue(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().DataBar_get_AxisColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def AxisColor(self, value:'Color'):
        ...
        GetDllLibXls().DataBar_set_AxisColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().DataBar_get_AxisPosition(self.Ptr)
    ...
    def AxisPosition(self, value:'DataBarAxisPosition'):
        ...
        GetDllLibXls().DataBar_set_AxisPosition(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().DataBar_get_BarBorder(self.Ptr)
    ...
    def BarFillType(self)->'DataBarFillType':
        ...
        ret = GetDllLibXls().DataBar_get_BarFillType(self.Ptr)
    ...
    def BarFillType(self, value:'DataBarFillType'):
        ...
        GetDllLibXls().DataBar_set_BarFillType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().DataBar_get_Direction(self.Ptr)
    ...
    def Direction(self, value:'TextDirectionType'):
        ...
        GetDllLibXls().DataBar_set_Direction(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().DataBar_get_NegativeBarFormat(self.Ptr)
