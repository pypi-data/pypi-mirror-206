...
class AddressData(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, street, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            region (str, none_type): The region or state. In API versions 2018-05-22 and earlier, this field is called `state`. Example: `\"NC\"`. [optional]  # noqa: E501
            postal_code (str, none_type): The postal code. In API versions 2018-05-22 and earlier, this field is called `zip`.. [optional]  # noqa: E501
