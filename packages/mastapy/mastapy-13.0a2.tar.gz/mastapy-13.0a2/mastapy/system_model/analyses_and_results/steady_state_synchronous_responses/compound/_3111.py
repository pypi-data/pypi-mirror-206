...
class BevelGearCompoundSteadyStateSynchronousResponse(_3099.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse):
    """BevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2980.BevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2980.BevelGearSteadyStateSynchronousResponse]':
