...
class RectangleCollection (  CollectionBase[XlsRectangleShape], IRectangleShapes) :
    ...
    def get_Item(self ,index:int)->IRectangleShape:
        ...
        intPtr = GetDllLibXls().RectangleCollection_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->IRectangleShape:
        ...
        intPtr = GetDllLibXls().RectangleCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsRectangleShape(intPtr)
        return ret
    ...
    def AddRectangle(self ,row:int,column:int,height:int,width:int,rectShapeType:'RectangleShapeType')->'IRectangleShape':
        ...
        intPtr = GetDllLibXls().RectangleCollection_AddRectangle(self.Ptr, row,column,height,width,enumrectShapeType)
        ret = None if intPtr==None else XlsRectangleShape(intPtr)
        return ret
    ...
    def AddCopy(self ,source:'IRectangleShape'):
        ...
        GetDllLibXls().RectangleCollection_AddCopy(self.Ptr, intPtrsource)
    ...
    def Clear(self):
        ...
        GetDllLibXls().RectangleCollection_Clear(self.Ptr)
