# python build stubs for package measure_dist
...
mod = Module('_measure_dist')
mod.add_include('"measure_dist_go.h"')
...
mod.add_function('Slice_measure_dist_Object_CTor', retval('int64_t'), [])
mod.add_function('Slice_measure_dist_Object_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_measure_dist_Object_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice_measure_dist_Object_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice_measure_dist_Object_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice_measure_dist_Object_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
mod.add_function('measure_dist_Annotation_CTor', retval('int64_t'), [])
mod.add_function('measure_dist_Annotation_XMLName_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('measure_dist_Annotation_XMLName_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('measure_dist_Annotation_Object_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('measure_dist_Annotation_Object_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('measure_dist_AnnotationResult_CTor', retval('int64_t'), [])
mod.add_function('measure_dist_AnnotationResult_List_object_names_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('measure_dist_AnnotationResult_List_object_names_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('measure_dist_AnnotationResult_List_with_all_boxes_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('measure_dist_AnnotationResult_List_with_all_boxes_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('measure_dist_BndBox_CTor', retval('int64_t'), [])
mod.add_function('measure_dist_BndBox_XMin_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('measure_dist_BndBox_XMin_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('measure_dist_BndBox_YMin_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('measure_dist_BndBox_YMin_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('measure_dist_BndBox_XMax_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('measure_dist_BndBox_XMax_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('measure_dist_BndBox_YMax_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('measure_dist_BndBox_YMax_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('measure_dist_Object_CTor', retval('int64_t'), [])
mod.add_function('measure_dist_Object_Name_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('measure_dist_Object_Name_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('measure_dist_Object_BndBox_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('measure_dist_Object_BndBox_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
add_checked_function(mod, 'measure_dist_ReadAnnotation', retval('int64_t'), [param('char*', 'xmlFile')])
add_checked_function(mod, 'measure_dist_Contains', retval('bool'), [param('int64_t', 's'), param('char*', 'e')])
add_checked_function(mod, 'measure_dist_MergeBoxes', retval('int64_t'), [param('int64_t', 'box1'), param('int64_t', 'box2')])
add_checked_function(mod, 'measure_dist_TwoPCenterPoint', retval('int64_t'), [param('int64_t', 'mesh')])
add_checked_function(mod, 'measure_dist_XywhToXyxy', retval('int64_t'), [param('int64_t', 'iCrop')])
add_checked_function(mod, 'measure_dist_CalculateArea', retval('int64_t'), [param('int64_t', 'box')])
add_checked_function(mod, 'measure_dist_CoordinateToAzimuth', retval('double'), [param('int64_t', 'coordinate')])
add_checked_function(mod, 'measure_dist_EnlargeArea', retval('int64_t'), [param('int64_t', 'area'), param('int64_t', 'margin'), param('int64_t', 'imageWidth'), param('int64_t', 'imageHeight')])
add_checked_function(mod, 'measure_dist_IsInsideArea', retval('bool'), [param('int64_t', 'objectBox'), param('int64_t', 'area')])
add_checked_function(mod, 'measure_dist_ThreePCenterPoint', retval('int64_t'), [param('int64_t', 'mesh')])
add_checked_function(mod, 'measure_dist_CalculateIOU', retval('double'), [param('int64_t', 'boxA'), param('int64_t', 'boxB')])

mod.generate(open('measure_dist.c', 'w'))
