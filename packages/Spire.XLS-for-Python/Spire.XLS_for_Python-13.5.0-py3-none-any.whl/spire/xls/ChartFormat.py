...
class ChartFormat (  XlsChartFormat) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartFormat_get_DataFormatOrNull(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartFormat_get_FirstDropBar(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartFormat_get_PieSeriesLine(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartFormat_get_SecondDropBar(self.Ptr)
        ret = None if intPtr==None else ChartDropBar(intPtr)
        return ret
