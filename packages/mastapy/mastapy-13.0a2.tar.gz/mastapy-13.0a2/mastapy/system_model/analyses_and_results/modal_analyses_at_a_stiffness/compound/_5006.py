...
class CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtAStiffness(_4963.AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_planetary_bearing_connection_compound_modal_analysis_at_a_stiffness(self) -> 'CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4876.CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4876.CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtAStiffness._Cast_CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtAStiffness':
        return self._Cast_CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtAStiffness(self)
