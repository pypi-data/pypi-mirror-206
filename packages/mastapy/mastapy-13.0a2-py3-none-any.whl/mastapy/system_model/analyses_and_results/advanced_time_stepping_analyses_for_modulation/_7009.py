...
class ConnectorAdvancedTimeSteppingAnalysisForModulation(_7051.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    """ConnectorAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_ConnectorAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'ConnectorAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def connector_advanced_time_stepping_analysis_for_modulation(self) -> 'ConnectorAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConnectorAdvancedTimeSteppingAnalysisForModulation._Cast_ConnectorAdvancedTimeSteppingAnalysisForModulation':
