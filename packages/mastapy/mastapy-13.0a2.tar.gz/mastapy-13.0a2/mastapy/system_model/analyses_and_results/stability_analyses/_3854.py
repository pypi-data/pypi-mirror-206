...
from mastapy.system_model.analyses_and_results.stability_analyses import _3855, _3853, _3759
...
class StraightBevelGearSetStabilityAnalysis(_3759.BevelGearSetStabilityAnalysis):
    """StraightBevelGearSetStabilityAnalysis
    ...
    class _Cast_StraightBevelGearSetStabilityAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearSetStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_set_stability_analysis(self) -> 'StraightBevelGearSetStabilityAnalysis':
            return self._parent
    ...
    @property
    def straight_bevel_gears_stability_analysis(self) -> 'List[_3855.StraightBevelGearStabilityAnalysis]':
    ...
    @property
    def straight_bevel_meshes_stability_analysis(self) -> 'List[_3853.StraightBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSetStabilityAnalysis._Cast_StraightBevelGearSetStabilityAnalysis':
