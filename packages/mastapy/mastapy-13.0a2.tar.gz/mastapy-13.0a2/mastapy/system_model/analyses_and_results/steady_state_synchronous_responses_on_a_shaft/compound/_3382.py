...
class ConceptCouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft(_3393.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    """ConceptCouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_ConceptCouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'ConceptCouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def concept_coupling_half_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'ConceptCouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3251.ConceptCouplingHalfSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3251.ConceptCouplingHalfSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft._Cast_ConceptCouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_ConceptCouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft(self)
