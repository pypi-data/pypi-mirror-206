...
class KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness(_4863.ConicalGearModalAnalysisAtAStiffness):
    """KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness
    ...
    class _Cast_KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_conical_gear_modal_analysis_at_a_stiffness(self) -> 'KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness._Cast_KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness':
        return self._Cast_KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness(self)
