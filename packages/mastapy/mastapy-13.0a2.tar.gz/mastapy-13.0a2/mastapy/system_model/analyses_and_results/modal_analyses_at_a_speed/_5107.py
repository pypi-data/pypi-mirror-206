...
class BevelGearSetModalAnalysisAtASpeed(_5095.AGMAGleasonConicalGearSetModalAnalysisAtASpeed):
    """BevelGearSetModalAnalysisAtASpeed
    ...
    class _Cast_BevelGearSetModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'BevelGearSetModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def bevel_gear_set_modal_analysis_at_a_speed(self) -> 'BevelGearSetModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearSetModalAnalysisAtASpeed._Cast_BevelGearSetModalAnalysisAtASpeed':
