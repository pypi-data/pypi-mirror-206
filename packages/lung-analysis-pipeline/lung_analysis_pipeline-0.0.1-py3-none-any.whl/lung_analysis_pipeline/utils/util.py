...
def tensor2mask(tensor, out_type=np.uint8, min_max=(0, 1), intercept=-1024):
    ...
    output_prob_thresh = (mask_np > 0.5) * 1
    return output_prob_thresh.astype(out_type)
...
def save_vol(opt, spacings, results_dir, patient_id, volume):
    ...
    # if opt['datasets']['val']['data_type'] == 'nrrd':
