...
class PlanetCarrierCompoundPowerFlow(_4219.MountableComponentCompoundPowerFlow):
    """PlanetCarrierCompoundPowerFlow
    ...
    class _Cast_PlanetCarrierCompoundPowerFlow:
        ...
        def __init__(self, parent: 'PlanetCarrierCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def planet_carrier_compound_power_flow(self) -> 'PlanetCarrierCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4095.PlanetCarrierPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4095.PlanetCarrierPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierCompoundPowerFlow._Cast_PlanetCarrierCompoundPowerFlow':
