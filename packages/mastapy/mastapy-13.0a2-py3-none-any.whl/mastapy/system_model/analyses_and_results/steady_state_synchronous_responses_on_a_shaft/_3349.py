...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3350, _3348, _3283
...
class WormGearSetSteadyStateSynchronousResponseOnAShaft(_3283.GearSetSteadyStateSynchronousResponseOnAShaft):
    """WormGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_WormGearSetSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'WormGearSetSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def worm_gear_set_steady_state_synchronous_response_on_a_shaft(self) -> 'WormGearSetSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def worm_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3350.WormGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3348.WormGearMeshSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'WormGearSetSteadyStateSynchronousResponseOnAShaft._Cast_WormGearSetSteadyStateSynchronousResponseOnAShaft':
