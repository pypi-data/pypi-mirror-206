...
class ClutchCompoundHarmonicAnalysisOfSingleExcitation(_6142.CouplingCompoundHarmonicAnalysisOfSingleExcitation):
    """ClutchCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_ClutchCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'ClutchCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def clutch_compound_harmonic_analysis_of_single_excitation(self) -> 'ClutchCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5998.ClutchHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5998.ClutchHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'ClutchCompoundHarmonicAnalysisOfSingleExcitation._Cast_ClutchCompoundHarmonicAnalysisOfSingleExcitation':
