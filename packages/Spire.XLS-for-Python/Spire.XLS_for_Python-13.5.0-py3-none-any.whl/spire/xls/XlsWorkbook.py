...
class XlsWorkbook (  XlsObject, IWorkbook) :
    ...
    def CreateTemplateMarkersProcessor(self)->'IMarkersDesigner':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_CreateTemplateMarkersProcessor(self.Ptr)
    ...
    <param name="Filename">
        ...
        GetDllLibXls().XlsWorkbook_Close(self.Ptr, Filename)
    ...
    def Close(self ,SaveChanges:bool,Filename:str):
        ...
        GetDllLibXls().XlsWorkbook_CloseSF(self.Ptr, SaveChanges,Filename)
    ...
    def Close(self ,saveChanges:bool):
        ...
        GetDllLibXls().XlsWorkbook_CloseS(self.Ptr, saveChanges)
    ...
    def Close(self):
        ...
        GetDllLibXls().XlsWorkbook_Close1(self.Ptr)
    ...
    def AddFont(self ,fontToAdd:'IFont')->'IFont':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_AddFont(self.Ptr, intPtrfontToAdd)
    ...
    def Activate(self):
        ...
        GetDllLibXls().XlsWorkbook_Activate(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsWorkbook_SplitPageInfo(self.Ptr, intPtrconverterSetting)
...
#
    ...
    def PixelsToWidth(self ,pixels:float)->float:
        ...
        ret = GetDllLibXls().XlsWorkbook_PixelsToWidth(self.Ptr, pixels)
        return ret
    ...
    #    ret = GetDllLibXls().XlsWorkbook_ConvertUnits(self.Ptr, value,enumfrom,enumto)
    #    return ret
    ...
    def DecodeName(self ,name:str)->str:
        ...
        GetDllLibXls().XlsWorkbook_DecodeName.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorkbook_DecodeName(self.Ptr, name)
        return ret
    ...
    def EncodeName(self ,strName:str)->str:
        ...
        GetDllLibXls().XlsWorkbook_EncodeName.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorkbook_EncodeName(self.Ptr, strName)
        return ret
    ...
    def GetBookIndex(self ,referenceIndex:int)->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_GetBookIndex(self.Ptr, referenceIndex)
        return ret
    ...
    def IsExternalReference(self ,reference:int)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_IsExternalReference(self.Ptr, reference)
        return ret
    ...
    def IsFormatted(self ,xfIndex:int)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_IsFormatted(self.Ptr, xfIndex)
        return ret
    ...
    def GetMaxDigitWidth(self)->float:
        ...
        ret = GetDllLibXls().XlsWorkbook_GetMaxDigitWidth(self.Ptr)
        return ret
    ...
    def Dispose(self):
        ...
        GetDllLibXls().XlsWorkbook_Dispose(self.Ptr)
    ...
    def IsVScrollBarVisible(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_IsVScrollBarVisible(self.Ptr)
        return ret
    ...
    def IsVScrollBarVisible(self, value:bool):
        ...
        GetDllLibXls().XlsWorkbook_set_IsVScrollBarVisible(self.Ptr, value)
    ...
    def Loading(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_Loading(self.Ptr)
        return ret
    ...
    def IsWindowProtection(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_IsWindowProtection(self.Ptr)
        return ret
    ...
    def MaxColumnCount(self)->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_MaxColumnCount(self.Ptr)
        return ret
    ...
    def MaxRowCount(self)->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_MaxRowCount(self.Ptr)
        return ret
    ...
    def MaxDigitWidth(self)->float:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_MaxDigitWidth(self.Ptr)
        return ret
    ...
    def PasswordToOpen(self)->str:
        ...
        GetDllLibXls().XlsWorkbook_get_PasswordToOpen.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorkbook_get_PasswordToOpen(self.Ptr)
        return ret
    ...
    def PasswordToOpen(self, value:str):
        ...
        GetDllLibXls().XlsWorkbook_set_PasswordToOpen(self.Ptr, value)
    ...
    def ReadOnly(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_ReadOnly(self.Ptr)
        return ret
    ...
    def ReadOnlyRecommended(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_ReadOnlyRecommended(self.Ptr)
        return ret
    ...
    def ReadOnlyRecommended(self, value:bool):
        ...
        GetDllLibXls().XlsWorkbook_set_ReadOnlyRecommended(self.Ptr, value)
    ...
    def RowSeparator(self)->str:
        ...
        GetDllLibXls().XlsWorkbook_get_RowSeparator.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorkbook_get_RowSeparator(self.Ptr)
        return ret
    ...
    def Styles(self)->'IStyles':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_get_Styles(self.Ptr)
    ...
    def TabSheets(self)->'ITabSheets':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_get_TabSheets(self.Ptr)
    ...
    def ThrowOnUnknownNames(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_ThrowOnUnknownNames(self.Ptr)
        return ret
    ...
    def ThrowOnUnknownNames(self, value:bool):
        ...
        GetDllLibXls().XlsWorkbook_set_ThrowOnUnknownNames(self.Ptr, value)
    ...
    def ContainsFont(self ,font:'XlsFont')->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_ContainsFont(self.Ptr, intPtrfont)
        return ret
    ...
    def FileWidthToPixels(self ,fileWidth:float)->float:
        ...
        ret = GetDllLibXls().XlsWorkbook_FileWidthToPixels(self.Ptr, fileWidth)
        return ret
    ...
    def WidthToFileWidth(self ,width:float)->float:
        ...
        ret = GetDllLibXls().XlsWorkbook_WidthToFileWidth(self.Ptr, width)
        return ret
    ...
    def CopyToClipboard(self):
        ...
        GetDllLibXls().XlsWorkbook_CopyToClipboard(self.Ptr)
    ...
    def SetWriteProtectionPassword(self ,password:str):
        ...
        GetDllLibXls().XlsWorkbook_SetWriteProtectionPassword(self.Ptr, password)
    ...
    def Clone(self)->'IWorkbook':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_Clone(self.Ptr)
    ...
    def Unprotect(self):
        ...
        GetDllLibXls().XlsWorkbook_Unprotect(self.Ptr)
    ...
    def Unprotect(self ,password:str):
        ...
        GetDllLibXls().XlsWorkbook_UnprotectP(self.Ptr, password)
    ...
    def Protect(self ,bIsProtectWindow:bool,bIsProtectContent:bool):
        ...
        GetDllLibXls().XlsWorkbook_Protect(self.Ptr, bIsProtectWindow,bIsProtectContent)
    ...
    def Protect(self ,bIsProtectWindow:bool,bIsProtectContent:bool,password:str):
        ...
        GetDllLibXls().XlsWorkbook_ProtectBBP(self.Ptr, bIsProtectWindow,bIsProtectContent,password)
    ...
    def SetSeparators(self ,argumentsSeparator:int,arrayRowsSeparator:int):
        ...
        GetDllLibXls().XlsWorkbook_SetSeparators(self.Ptr, argumentsSeparator,arrayRowsSeparator)
    ...
    def SaveAs(self ,stream:Stream,separator:str):
        ...
        GetDllLibXls().XlsWorkbook_SaveAs(self.Ptr, intPtrstream,separator)
    ...
    def SaveAs(self ,fileName:str,separator:str):
        ...
        GetDllLibXls().XlsWorkbook_SaveAsFS(self.Ptr, fileName,separator)

    @dispatch

    def SaveAsImages(self ,dpiX:float,dpiY:float)->List[Image]:
        """
        ...
        intPtrArray = GetDllLibXls().XlsWorkbook_SaveAsImages(self.Ptr, dpiX,dpiY)
    ...
    def SaveAsImages(self ,sheetIndex:int,dpiX:float,dpiY:float)->Image:
        """
        ...
        intPtr = GetDllLibXls().XlsWorkbook_SaveAsImagesSDD(self.Ptr, sheetIndex,dpiX,dpiY)
    ...
    def SaveAsImages(self ,sheetIndex:int,firstRow:int,firstColumn:int,lastRow:int,lastColumn:int,dpiX:float,dpiY:float)->Image:
        """
        ...
        intPtr = GetDllLibXls().XlsWorkbook_SaveAsImagesSFFLLDD(self.Ptr, sheetIndex,firstRow,firstColumn,lastRow,lastColumn,dpiX,dpiY)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def SaveAsEmfStream(self ,sheetIndex:int,EmfStream:'Stream',firstRow:int,firstColumn:int,lastRow:int,lastColumn:int):
        ...
        GetDllLibXls().XlsWorkbook_SaveAsEmfStream(self.Ptr, sheetIndex,intPtrEmfStream,firstRow,firstColumn,lastRow,lastColumn)


    def SaveChartAsEmfImage(self ,worksheet:'Worksheet',chartIndex:int,imageOrPrintOptions:'ConverterSetting',emfStream:'Stream')->'Image':
        """
        ...
        intPtr = GetDllLibXls().XlsWorkbook_SaveChartAsEmfImage(self.Ptr, intPtrworksheet,chartIndex,intPtrimageOrPrintOptions,intPtremfStream)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def SaveChartAsImage(self ,worksheet:Worksheet,imageOrPrintOptions:ConverterSetting)->List[Image]:
        """
        ...
        intPtrArray = GetDllLibXls().XlsWorkbook_SaveChartAsImage(self.Ptr, intPtrworksheet,intPtrimageOrPrintOptions)
        ret = GetObjVectorFromArray(intPtrArray, Image)
        return ret
    ...
    def SaveChartAsImage(self ,chartSheet:ChartSheet,imageOrPrintOptions:ConverterSetting)->Image:
        """
        ...
        intPtr = GetDllLibXls().XlsWorkbook_SaveChartAsImageCI(self.Ptr, intPtrchartSheet,intPtrimageOrPrintOptions)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def SaveChartAsImage(self ,worksheet:Worksheet,charIndex:int,imageOrPrintOptions:ConverterSetting)->Image:
        """
        ...
        intPtr = GetDllLibXls().XlsWorkbook_SaveChartAsImageWCI(self.Ptr, intPtrworksheet,charIndex,intPtrimageOrPrintOptions)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def FindOne(self ,findValue:float,flags:FindType)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsWorkbook_FindOne(self.Ptr, findValue,enumflags)
    ...
    def FindOne(self ,findValue:str,flags:FindType)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsWorkbook_FindOneFF(self.Ptr, findValue,enumflags)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def FindOne(self ,findValue:bool)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsWorkbook_FindOneF(self.Ptr, findValue)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def FindOne(self ,findValue:DateTime)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsWorkbook_FindOneF1(self.Ptr, intPtrfindValue)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def FindOne(self ,findValue:TimeSpan)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsWorkbook_FindOneF11(self.Ptr, intPtrfindValue)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
...
#        intPtr = GetDllLibXls().XlsWorkbook_FindAll(self.Ptr, findValue,enumflags)
...
#        intPtr = GetDllLibXls().XlsWorkbook_FindAllFF(self.Ptr, findValue,enumflags)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().XlsWorkbook_FindAllF(self.Ptr, findValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().XlsWorkbook_FindAllF1(self.Ptr, intPtrfindValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().XlsWorkbook_FindAllF11(self.Ptr, intPtrfindValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
    ...
    def Replace(self ,oldValue:str,newValue:str):
        ...
        GetDllLibXls().XlsWorkbook_Replace(self.Ptr, oldValue,newValue)
    ...
    def Replace(self ,oldValue:str,newValue:DateTime):
        ...
        GetDllLibXls().XlsWorkbook_ReplaceON(self.Ptr, oldValue,intPtrnewValue)
    ...
    def Replace(self ,oldValue:str,newValue:float):
        ...
        GetDllLibXls().XlsWorkbook_ReplaceON1(self.Ptr, oldValue,newValue)
    ...
    def Replace(self ,oldValue:str,newValues:List[str],isVertical:bool):
        ...
        GetDllLibXls().XlsWorkbook_ReplaceONI(self.Ptr, oldValue,arraynewValues,countnewValues,isVertical)
    ...
    def Replace(self ,oldValue:str,newValues:List[int],isVertical:bool):
        ...
        GetDllLibXls().XlsWorkbook_ReplaceONI1(self.Ptr, oldValue,arraynewValues,countnewValues,isVertical)
    ...
    def Replace(self ,oldValue:str,newValues:List[float],isVertical:bool):
        ...
        GetDllLibXls().XlsWorkbook_ReplaceONI11(self.Ptr, oldValue,arraynewValues,countnewValues,isVertical)
...
#        GetDllLibXls().XlsWorkbook_ReplaceONI111(self.Ptr, oldValue,intPtrnewValues,isFieldNamesShown)
...
#        GetDllLibXls().XlsWorkbook_ReplaceONI1111(self.Ptr, oldValue,intPtrnewValues,isFieldNamesShown)
    ...
    def CreateFont(self)->IFont:
        ...
        intPtr = GetDllLibXls().XlsWorkbook_CreateFont(self.Ptr)
        ret = None if intPtr==None else XlsFont(intPtr)
        return ret
    ...
    def CreateFont(self ,nativeFont:Font)->IFont:
        ...
        intPtr = GetDllLibXls().XlsWorkbook_CreateFontN(self.Ptr, intPtrnativeFont)
        ret = None if intPtr==None else XlsFont(intPtr)
        return ret
    ...
    def CreateFont(self ,baseFont:IFont)->IFont:
        ...
        intPtr = GetDllLibXls().XlsWorkbook_CreateFontB(self.Ptr, intPtrbaseFont)
        ret = None if intPtr==None else XlsFont(intPtr)
        return ret
    ...
    def CreateFont(self ,baseFont:IFont,bAddToCollection:bool)->IFont:
        ...
        intPtr = GetDllLibXls().XlsWorkbook_CreateFontBB(self.Ptr, intPtrbaseFont,bAddToCollection)
        ret = None if intPtr==None else XlsFont(intPtr)
        return ret
    ...
    def SetColorOrGetNearest(self ,color:Color)->ExcelColors:
        ...
        ret = GetDllLibXls().XlsWorkbook_SetColorOrGetNearest(self.Ptr, intPtrcolor)
    ...
    def SetActiveWorksheet(self ,sheet:'XlsWorksheetBase'):
        ...
        GetDllLibXls().XlsWorkbook_SetActiveWorksheet(self.Ptr, intPtrsheet)
    ...
    def SetChanged(self):
        ...
        GetDllLibXls().XlsWorkbook_SetChanged(self.Ptr)
    ...
    def SetColorOrGetNearest(self ,r:int,g:int,b:int)->ExcelColors:
        ...
        ret = GetDllLibXls().XlsWorkbook_SetColorOrGetNearestRGB(self.Ptr, r,g,b)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def SetMaxDigitWidth(self ,w:int):
        ...
        GetDllLibXls().XlsWorkbook_SetMaxDigitWidth(self.Ptr, w)
    ...
    def GetNearestColor(self ,color:Color)->ExcelColors:
        ...
        ret = GetDllLibXls().XlsWorkbook_GetNearestColor(self.Ptr, intPtrcolor)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def GetNearestColor(self ,color:Color,iStartIndex:int)->ExcelColors:
        ...
        ret = GetDllLibXls().XlsWorkbook_GetNearestColorCI(self.Ptr, intPtrcolor,iStartIndex)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def GetNearestColor(self ,r:int,g:int,b:int)->ExcelColors:
        ...
        ret = GetDllLibXls().XlsWorkbook_GetNearestColorRGB(self.Ptr, r,g,b)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def GetPaletteColor(self ,color:'ExcelColors')->'Color':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_GetPaletteColor(self.Ptr, enumcolor)
    ...
    def ResetPalette(self):
        ...
        GetDllLibXls().XlsWorkbook_ResetPalette(self.Ptr)
    ...
    def SetPaletteColor(self ,index:int,color:'Color'):
        ...
        GetDllLibXls().XlsWorkbook_SetPaletteColor(self.Ptr, index,intPtrcolor)
...
#        GetDllLibXls().XlsWorkbook_SaveAsFR(self.Ptr, fileName,intPtrresponse)
...
#        GetDllLibXls().XlsWorkbook_SaveAsFSR(self.Ptr, fileName,enumsaveType,intPtrresponse)
    ...
    def SaveAs(self ,stream:Stream,saveType:ExcelSaveType):
        ...
        GetDllLibXls().XlsWorkbook_SaveAsSS(self.Ptr, intPtrstream,enumsaveType)
    ...
    def SaveAs(self ,stream:Stream,saveType:ExcelSaveType,version:ExcelVersion):
        ...
        GetDllLibXls().XlsWorkbook_SaveAsSSV(self.Ptr, intPtrstream,enumsaveType,enumversion)
    ...
    def SaveAs(self ,stream:Stream):
        ...
        GetDllLibXls().XlsWorkbook_SaveAsS(self.Ptr, intPtrstream)
    ...
    def SaveAs(self ,fileName:str,saveType:ExcelSaveType):
        ...
        GetDllLibXls().XlsWorkbook_SaveAsFS1(self.Ptr, fileName,enumsaveType)
    ...
    def SaveAs(self ,fileName:str,saveType:ExcelSaveType,version:ExcelVersion):
        ...
        GetDllLibXls().XlsWorkbook_SaveAsFSV(self.Ptr, fileName,enumsaveType,enumversion)
    ...
    def SaveToXlsm(self ,fileName:str):
        ...
        GetDllLibXls().XlsWorkbook_SaveToXlsm(self.Ptr, fileName)
    ...
    def SaveToXlsm(self ,stream:Stream):
        ...
        GetDllLibXls().XlsWorkbook_SaveToXlsmS(self.Ptr, intPtrstream)
    ...
    def SaveToPdf(self ,stream:Stream):
        ...
        GetDllLibXls().XlsWorkbook_SaveToPdf(self.Ptr, intPtrstream)
    ...
    def SaveToPdf(self ,fileName:str):
        ...
        GetDllLibXls().XlsWorkbook_SaveToPdfF(self.Ptr, fileName)
    ...
    def SaveAsImageOrXps(self ,stream:Stream,fileFormat:FileFormat):
        ...
        GetDllLibXls().XlsWorkbook_SaveAsImageOrXps(self.Ptr, intPtrstream,enumfileFormat)
    ...
    def SaveAsImageOrXps(self ,fileName:str,fileFormat:FileFormat):
        ...
        GetDllLibXls().XlsWorkbook_SaveAsImageOrXpsFF(self.Ptr, fileName,enumfileFormat)
    ...
    def SaveAsHtml(self ,fileName:str,saveOption:'HTMLOptions'):
        ...
        GetDllLibXls().XlsWorkbook_SaveAsHtml(self.Ptr, fileName,intPtrsaveOption)
    ...
    def SaveAs(self ,FileName:str):
        ...
        GetDllLibXls().XlsWorkbook_SaveAsF(self.Ptr, FileName)
    ...
    def Save(self):
        ...
        GetDllLibXls().XlsWorkbook_Save(self.Ptr)
    ...
    def StandardRowHeight(self)->float:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_StandardRowHeight(self.Ptr)
        return ret
    ...
    def StandardRowHeight(self, value:float):
        ...
        GetDllLibXls().XlsWorkbook_set_StandardRowHeight(self.Ptr, value)
    ...
    def StandardRowHeightInPixels(self)->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_StandardRowHeightInPixels(self.Ptr)
        return ret
    ...
    def StandardRowHeightInPixels(self, value:int):
        ...
        GetDllLibXls().XlsWorkbook_set_StandardRowHeightInPixels(self.Ptr, value)
    ...
    def MaxXFCount(self)->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_MaxXFCount(self.Ptr)
        return ret
    ...
    def MaxIndent(self)->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_MaxIndent(self.Ptr)
        return ret
    ...
    def Version(self)->'ExcelVersion':
        ...
        ret = GetDllLibXls().XlsWorkbook_get_Version(self.Ptr)
    ...
    def Version(self, value:'ExcelVersion'):
        ...
        GetDllLibXls().XlsWorkbook_set_Version(self.Ptr, value.value)
    ...
    def Worksheets(self)->'IWorksheets':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_get_Worksheets(self.Ptr)
    ...
    def InnerAddInFunctions(self)->'XlsAddInFunctionsCollection':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_get_InnerAddInFunctions(self.Ptr)
    ...
    def InnerFonts(self)->'XlsFontsCollection':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_get_InnerFonts(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsWorkbook_get_InnerGraphics(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsWorkbook_get_InnerPalette(self.Ptr)
#        ret = None if intPtr==None else List1(intPtr)
#        return ret
#
    ...
    def Names(self)->'INameRanges':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_get_Names(self.Ptr)
    ...
    def DataConns(self)->'DataConnections':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_get_DataConns(self.Ptr)
    ...
    def ExternalLinks(self)->'ExternalLinkCollection':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_get_ExternalLinks(self.Ptr)
    ...
    def ObjectCount(self)->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_ObjectCount(self.Ptr)
        return ret
    ...
    def OleSize(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_get_OleSize(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def OleSize(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsWorkbook_set_OleSize(self.Ptr, value.Ptr)
    ...
    def ActiveSheet(self)->'IWorksheet':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_get_ActiveSheet(self.Ptr)
    ...
    def ActiveSheetIndex(self)->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_ActiveSheetIndex(self.Ptr)
        return ret
    ...
    def ActiveSheetIndex(self, value:int):
        ...
        GetDllLibXls().XlsWorkbook_set_ActiveSheetIndex(self.Ptr, value)
    ...
    def CodeName(self)->str:
        ...
        GetDllLibXls().XlsWorkbook_get_CodeName.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorkbook_get_CodeName(self.Ptr)
        return ret
    ...
    def CodeName(self, value:str):
        ...
        GetDllLibXls().XlsWorkbook_set_CodeName(self.Ptr, value)
    ...
    def Palette(self)->List['Color']:
        ...
        intPtrArray = GetDllLibXls().XlsWorkbook_get_Palette(self.Ptr)
    ...
    def Date1904(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_Date1904(self.Ptr)
        return ret

    @Date1904.setter
    def Date1904(self, value:bool):
        GetDllLibXls().XlsWorkbook_set_Date1904.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsWorkbook_set_Date1904(self.Ptr, value)
    ...
    def StandardFont(self)->str:
        ...
        GetDllLibXls().XlsWorkbook_get_StandardFont.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorkbook_get_StandardFont(self.Ptr)
        return ret
    ...
    def StandardFont(self, value:str):
        ...
        GetDllLibXls().XlsWorkbook_set_StandardFont(self.Ptr, value)
    ...
    def StandardFontSize(self)->float:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_StandardFontSize(self.Ptr)
        return ret
    ...
    def StandardFontSize(self, value:float):
        ...
        GetDllLibXls().XlsWorkbook_set_StandardFontSize(self.Ptr, value)
    ...
    def DisableMacrosStart(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_DisableMacrosStart(self.Ptr)
        return ret
    ...
    def DisableMacrosStart(self, value:bool):
        ...
        GetDllLibXls().XlsWorkbook_set_DisableMacrosStart(self.Ptr, value)
    ...
    def SecondCharSize(self)->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_SecondCharSize(self.Ptr)
        return ret
    ...
    def SecondCharSize(self, value:int):
        ...
        GetDllLibXls().XlsWorkbook_set_SecondCharSize(self.Ptr, value)
    ...
    def FullFileName(self)->str:
        ...
        GetDllLibXls().XlsWorkbook_get_FullFileName.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorkbook_get_FullFileName(self.Ptr)
        return ret
    ...
    def HasDuplicatedNames(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_HasDuplicatedNames(self.Ptr)
        return ret
    ...
    def HasDuplicatedNames(self, value:bool):
        ...
        GetDllLibXls().XlsWorkbook_set_HasDuplicatedNames(self.Ptr, value)
    ...
    def HasMacros(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_HasMacros(self.Ptr)
        return ret
    ...
    def Saved(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_Saved(self.Ptr)
        return ret

    @Saved.setter
    def Saved(self, value:bool):
        GetDllLibXls().XlsWorkbook_set_Saved.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsWorkbook_set_Saved(self.Ptr, value)
    ...
    def Saving(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_Saving(self.Ptr)
        return ret
    ...
    def Author(self)->str:
        ...
        GetDllLibXls().XlsWorkbook_get_Author.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorkbook_get_Author(self.Ptr)
        return ret
    ...
    def Author(self, value:str):
        ...
        GetDllLibXls().XlsWorkbook_set_Author(self.Ptr, value)
    ...
    def AddInFunctions(self)->'IAddInFunctions':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_get_AddInFunctions(self.Ptr)
    ...
    def Allow3DRangesInDataValidation(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_Allow3DRangesInDataValidation(self.Ptr)
        return ret
    ...
    def Allow3DRangesInDataValidation(self, value:bool):
        ...
        GetDllLibXls().XlsWorkbook_set_Allow3DRangesInDataValidation(self.Ptr, value)
    ...
    def ArgumentsSeparator(self)->str:
        ...
        GetDllLibXls().XlsWorkbook_get_ArgumentsSeparator.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorkbook_get_ArgumentsSeparator(self.Ptr)
        return ret
    ...
    def BuiltInDocumentProperties(self)->'IBuiltInDocumentProperties':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_get_BuiltInDocumentProperties(self.Ptr)
    ...
    def Charts(self)->'ICharts':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_get_Charts(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsWorkbook_get_Chartsheets(self.Ptr)
#        ret = None if intPtr==None else List1(intPtr)
#        return ret
#
    ...
    def CustomDocumentProperties(self)->'ICustomDocumentProperties':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_get_CustomDocumentProperties(self.Ptr)
    ...
    def CurrentObjectId(self)->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_CurrentObjectId(self.Ptr)
        return ret
    ...
    def CurrentObjectId(self, value:int):
        ...
        GetDllLibXls().XlsWorkbook_set_CurrentObjectId(self.Ptr, value)
    ...
    def CurrentShapeId(self)->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_CurrentShapeId(self.Ptr)
        return ret
    ...
    def CurrentShapeId(self, value:int):
        ...
        GetDllLibXls().XlsWorkbook_set_CurrentShapeId(self.Ptr, value)
    ...
    def CurrentHeaderId(self)->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_CurrentHeaderId(self.Ptr)
        return ret
    ...
    def CurrentHeaderId(self, value:int):
        ...
        GetDllLibXls().XlsWorkbook_set_CurrentHeaderId(self.Ptr, value)
    ...
    def DefaultXFIndex(self)->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_DefaultXFIndex(self.Ptr)
        return ret
    ...
    def DefaultXFIndex(self, value:int):
        ...
        GetDllLibXls().XlsWorkbook_set_DefaultXFIndex(self.Ptr, value)
    ...
    def DetectDateTimeInValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_DetectDateTimeInValue(self.Ptr)
        return ret
    ...
    def DetectDateTimeInValue(self, value:bool):
        ...
        GetDllLibXls().XlsWorkbook_set_DetectDateTimeInValue(self.Ptr, value)
    ...
    def DisplayedTab(self)->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_DisplayedTab(self.Ptr)
        return ret

    @DisplayedTab.setter
    def DisplayedTab(self, value:int):
        GetDllLibXls().XlsWorkbook_set_DisplayedTab.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsWorkbook_set_DisplayedTab(self.Ptr, value)
    ...
    def DisplayWorkbookTabs(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_DisplayWorkbookTabs(self.Ptr)
        return ret
    ...
    def DisplayWorkbookTabs(self, value:bool):
        ...
        GetDllLibXls().XlsWorkbook_set_DisplayWorkbookTabs(self.Ptr, value)
    ...
    def IsCellProtection(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_IsCellProtection(self.Ptr)
        return ret
    ...
    def IsDisplayPrecision(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_IsDisplayPrecision(self.Ptr)
        return ret
    ...
    def IsDisplayPrecision(self, value:bool):
        ...
        GetDllLibXls().XlsWorkbook_set_IsDisplayPrecision(self.Ptr, value)
    ...
    def IsHScrollBarVisible(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_IsHScrollBarVisible(self.Ptr)
        return ret
    ...
    def IsHScrollBarVisible(self, value:bool):
        ...
        GetDllLibXls().XlsWorkbook_set_IsHScrollBarVisible(self.Ptr, value)
    ...
    def IsLoaded(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorkbook_get_IsLoaded(self.Ptr)
        return ret
    ...
    def DEF_COMENT_PARSE_COLOR()->'Color':
        ...
        intPtr = GetDllLibXls().XlsWorkbook_DEF_COMENT_PARSE_COLOR()
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def DEF_FIRST_USER_COLOR()->int:
        ...
        ret = GetDllLibXls().XlsWorkbook_DEF_FIRST_USER_COLOR()
        return ret
    ...
    def DEF_BAD_SHEET_NAME()->str:
        ...
        GetDllLibXls().XlsWorkbook_DEF_BAD_SHEET_NAME.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorkbook_DEF_BAD_SHEET_NAME()
        return ret
