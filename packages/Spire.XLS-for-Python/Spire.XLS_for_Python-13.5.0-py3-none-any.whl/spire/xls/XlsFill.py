...
class XlsFill (SpireObject) :
    ...
    def OColor(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsFill_get_OColor(self.Ptr)
    ...
    def PatternColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsFill_get_PatternColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def Pattern(self)->'ExcelPatternType':
        ...
        ret = GetDllLibXls().XlsFill_get_Pattern(self.Ptr)
    ...
    def Pattern(self, value:'ExcelPatternType'):
        ...
        GetDllLibXls().XlsFill_set_Pattern(self.Ptr, value.value)
    ...
    def GradientStyle(self)->'GradientStyleType':
        ...
        ret = GetDllLibXls().XlsFill_get_GradientStyle(self.Ptr)
    ...
    def GradientStyle(self, value:'GradientStyleType'):
        ...
        GetDllLibXls().XlsFill_set_GradientStyle(self.Ptr, value.value)
    ...
    def GradientVariant(self)->'GradientVariantsType':
        ...
        ret = GetDllLibXls().XlsFill_get_GradientVariant(self.Ptr)
    ...
    def GradientVariant(self, value:'GradientVariantsType'):
        ...
        GetDllLibXls().XlsFill_set_GradientVariant(self.Ptr, value.value)
    ...
    def FillType(self)->'ShapeFillType':
        ...
        ret = GetDllLibXls().XlsFill_get_FillType(self.Ptr)
    ...
    def FillType(self, value:'ShapeFillType'):
        ...
        GetDllLibXls().XlsFill_set_FillType(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibXls().XlsFill_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = GetDllLibXls().XlsFill_GetHashCode(self.Ptr)
        return ret
    ...
    def Clone(self)->'XlsFill':
        ...
        intPtr = GetDllLibXls().XlsFill_Clone(self.Ptr)
