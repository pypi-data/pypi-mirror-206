...
class AGMAGleasonConicalGearModalAnalysisAtASpeed(_5122.ConicalGearModalAnalysisAtASpeed):
    """AGMAGleasonConicalGearModalAnalysisAtASpeed
    ...
    class _Cast_AGMAGleasonConicalGearModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_modal_analysis_at_a_speed(self) -> 'AGMAGleasonConicalGearModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearModalAnalysisAtASpeed._Cast_AGMAGleasonConicalGearModalAnalysisAtASpeed':
