...
class LinkErrorNotFoundResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        class properties:
            class error_code(schemas.EnumBase, schemas.StrSchema):
                class MetaOapg:
                    enum_value_to_name = {
                        "link_error.not_found": "LINK_ERROR_NOT_FOUND",
                    }

                @schemas.classproperty
                def LINK_ERROR_NOT_FOUND(cls):
                    return cls("link_error.not_found")
