...
class TorqueConverterTurbinePowerFlow(_4047.CouplingHalfPowerFlow):
    """TorqueConverterTurbinePowerFlow
    ...
    class _Cast_TorqueConverterTurbinePowerFlow:
        ...
        def __init__(self, parent: 'TorqueConverterTurbinePowerFlow'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_power_flow(self) -> 'TorqueConverterTurbinePowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbinePowerFlow._Cast_TorqueConverterTurbinePowerFlow':
