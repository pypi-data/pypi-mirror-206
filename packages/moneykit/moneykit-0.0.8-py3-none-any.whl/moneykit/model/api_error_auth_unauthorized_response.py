...
class APIErrorAuthUnauthorizedResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error_code(schemas.EnumBase, schemas.StrSchema):
                class MetaOapg:
                    enum_value_to_name = {
                        "api_error.auth.unauthorized": "API_ERROR_AUTH_UNAUTHORIZED",
                    }

                @schemas.classproperty
                def API_ERROR_AUTH_UNAUTHORIZED(cls):
                    return cls("api_error.auth.unauthorized")
