...
class XlsPivotCacheField (SpireObject) :
    ...
    def Formula(self)->str:
        ...
        GetDllLibXls().XlsPivotCacheField_get_Formula.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotCacheField_get_Formula(self.Ptr)
        return ret
    ...
    def Formula(self, value:str):
        ...
        GetDllLibXls().XlsPivotCacheField_set_Formula(self.Ptr, value)
    ...
    def IsDataBaseField(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotCacheField_get_IsDataBaseField(self.Ptr)
        return ret
    ...
    def IsDataBaseField(self, value:bool):
        ...
        GetDllLibXls().XlsPivotCacheField_set_IsDataBaseField(self.Ptr, value)
    ...
    def IsDouble(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotCacheField_get_IsDouble(self.Ptr)
        return ret

    @IsDouble.setter
    def IsDouble(self, value:bool):
        GetDllLibXls().XlsPivotCacheField_set_IsDouble.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotCacheField_set_IsDouble(self.Ptr, value)
    ...
    def IsDoubleInt(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotCacheField_get_IsDoubleInt(self.Ptr)
        return ret

    @IsDoubleInt.setter
    def IsDoubleInt(self, value:bool):
        GetDllLibXls().XlsPivotCacheField_set_IsDoubleInt.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotCacheField_set_IsDoubleInt(self.Ptr, value)
    ...
    def IsString(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotCacheField_get_IsString(self.Ptr)
        return ret

    @IsString.setter
    def IsString(self, value:bool):
        GetDllLibXls().XlsPivotCacheField_set_IsString.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotCacheField_set_IsString(self.Ptr, value)
    ...
    def IsDate(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotCacheField_get_IsDate(self.Ptr)
        return ret
    ...
    def ItemCount(self)->int:
        ...
        ret = GetDllLibXls().XlsPivotCacheField_get_ItemCount(self.Ptr)
        return ret
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().XlsPivotCacheField_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotCacheField_get_Name(self.Ptr)
        return ret
    ...
    def Name(self, value:str):
        ...
        GetDllLibXls().XlsPivotCacheField_set_Name(self.Ptr, value)
    ...
    def Index(self)->int:
        ...
        ret = GetDllLibXls().XlsPivotCacheField_get_Index(self.Ptr)
        return ret

    @Index.setter
    def Index(self, value:int):
        GetDllLibXls().XlsPivotCacheField_set_Index.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsPivotCacheField_set_Index(self.Ptr, value)
    ...
    def DataType(self)->'PivotDataType':
        ...
        ret = GetDllLibXls().XlsPivotCacheField_get_DataType(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotCacheField_get_IsFormulaField(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsPivotCacheField_get_Caption.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotCacheField_get_Caption(self.Ptr)
        return ret
    ...
    def Caption(self, value:str):
        ...
        GetDllLibXls().XlsPivotCacheField_set_Caption(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotCacheField_get_isfieldgroup(self.Ptr)
        return ret
    ...
    def GetValue(self ,index:int)->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsPivotCacheField_GetValue(self.Ptr, index)
