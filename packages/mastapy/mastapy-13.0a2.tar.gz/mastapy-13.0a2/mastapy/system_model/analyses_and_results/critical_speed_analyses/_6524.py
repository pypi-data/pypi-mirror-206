...
class BevelGearCriticalSpeedAnalysis(_6512.AGMAGleasonConicalGearCriticalSpeedAnalysis):
    """BevelGearCriticalSpeedAnalysis
    ...
    class _Cast_BevelGearCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'BevelGearCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_gear_critical_speed_analysis(self) -> 'BevelGearCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearCriticalSpeedAnalysis._Cast_BevelGearCriticalSpeedAnalysis':
