...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
    _1128, _1132, _1133, _1138,
    _1134
)
from mastapy.gears.gear_designs.cylindrical import (
    _996, _1005, _1017, _1023,
    _1040, _1049, _1012, _1015,
    _1079, _1072, _1074, _1013
)
...
from mastapy.gears.gear_designs.cylindrical.thickness_stock_and_backlash import _1083
...
class CylindricalGearDesign(_942.GearDesign):
    """CylindricalGearDesign
    ...
    class _Cast_CylindricalGearDesign:
        ...
        def __init__(self, parent: 'CylindricalGearDesign'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_design(self) -> 'CylindricalGearDesign':
            return self._parent
    ...
    @property
    def internal_external(self) -> '_308.InternalExternalType':
        ...
        value = conversion.pn_to_mp_enum(temp, _308.InternalExternalType)
        return constructor.new_from_mastapy_type(_308.InternalExternalType)(value) if value is not None else None

    @internal_external.setter
    def internal_external(self, value: '_308.InternalExternalType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _308.InternalExternalType.type_())
    ...
    @property
    def agma_accuracy_grade(self) -> '_1128.AGMA20151AccuracyGrades':
    ...
    @property
    def accuracy_grades_specified_accuracy(self) -> '_1132.CylindricalAccuracyGrades':
    ...
    @property
    def case_hardening_properties(self) -> '_996.CaseHardeningProperties':
    ...
    @property
    def cylindrical_gear_cutting_options(self) -> '_1005.CylindricalGearCuttingOptions':
    ...
    @property
    def cylindrical_gear_manufacturing_configuration(self) -> '_607.CylindricalGearManufacturingConfig':
    ...
    @property
    def cylindrical_gear_micro_geometry(self) -> '_1095.CylindricalGearMicroGeometryBase':
    ...
    @property
    def cylindrical_gear_set(self) -> '_1023.CylindricalGearSetDesign':
    ...
    @property
    def finish_stock_specification(self) -> '_1083.FinishStockSpecification':
    ...
    @property
    def finished_tooth_thickness_specification(self) -> '_1040.FinishToothThicknessDesignSpecification':
    ...
    @property
    def gear_accuracy_tolerances(self) -> '_1133.CylindricalGearAccuracyTolerances':
        """CylindricalGearAccuracyTolerances: 'GearAccuracyTolerances' is the original name of this property.
    ...
    @property
    def iso6336_geometry(self) -> '_1049.ISO6336GeometryBase':
    ...
    @property
    def iso_accuracy_grade(self) -> '_1138.ISO1328AccuracyGrades':
    ...
    @property
    def left_flank(self) -> '_1012.CylindricalGearFlankDesign':
    ...
    @property
    def material(self) -> '_589.GearMaterial':
    ...
    @property
    def micro_geometry_settings(self) -> '_1015.CylindricalGearMicroGeometrySettings':
    ...
    @property
    def right_flank(self) -> '_1012.CylindricalGearFlankDesign':
    ...
    @property
    def rough_tooth_thickness_specification(self) -> '_1079.ToothThicknessSpecification':
    ...
    @property
    def system_of_gear_fits(self) -> '_1134.DIN3967SystemOfGearFits':
    ...
    @property
    def tiff_analysis_settings(self) -> '_1074.TiffAnalysisSettings':
    ...
    @property
    def flanks(self) -> 'List[_1012.CylindricalGearFlankDesign]':
    ...
    @property
    def both_flanks(self) -> '_1012.CylindricalGearFlankDesign':
    ...
    @property
    def manufacturing_configurations(self) -> 'List[_607.CylindricalGearManufacturingConfig]':
    ...
    @property
    def micro_geometries(self) -> 'List[_1095.CylindricalGearMicroGeometryBase]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearDesign._Cast_CylindricalGearDesign':
