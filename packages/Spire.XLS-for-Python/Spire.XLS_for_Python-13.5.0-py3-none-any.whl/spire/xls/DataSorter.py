...
class DataSorter (  SpireObject, IDataSort) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().DataSorter_get_IsCaseSensitive(self.Ptr)
        return ret
    ...
    def IsCaseSensitive(self, value:bool):
        ...
        GetDllLibXls().DataSorter_set_IsCaseSensitive(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().DataSorter_get_IsIncludeTitle(self.Ptr)
        return ret
    ...
    def IsIncludeTitle(self, value:bool):
        ...
        GetDllLibXls().DataSorter_set_IsIncludeTitle(self.Ptr, value)
    ...
    def Orientation(self)->'SortOrientationType':
        ...
        ret = GetDllLibXls().DataSorter_get_Orientation(self.Ptr)
    ...
    def Orientation(self, value:'SortOrientationType'):
        ...
        GetDllLibXls().DataSorter_set_Orientation(self.Ptr, value.value)
    ...
    def SortColumns(self)->'SortColumns':
        ...
        intPtr = GetDllLibXls().DataSorter_get_SortColumns(self.Ptr)
    ...
    def SortColumns(self, value:'SortColumns'):
        ...
        GetDllLibXls().DataSorter_set_SortColumns(self.Ptr, value.Ptr)
    ...
    def SortedWay(self)->'SortedWayType':
        ...
        ret = GetDllLibXls().DataSorter_get_SortedWay(self.Ptr)
    ...
    def SortedWay(self, value:'SortedWayType'):
        ...
        GetDllLibXls().DataSorter_set_SortedWay(self.Ptr, value.value)
    ...
    def SortLeftToRight(self)->bool:
        ...
        ret = GetDllLibXls().DataSorter_get_SortLeftToRight(self.Ptr)
        return ret
    ...
    def SortLeftToRight(self, value:bool):
        ...
        GetDllLibXls().DataSorter_set_SortLeftToRight(self.Ptr, value)
    ...
    def Sort(self ,range:'CellRange'):
        ...
        GetDllLibXls().DataSorter_Sort(self.Ptr, intPtrrange)
...
#        GetDllLibXls().DataSorter_SortBy(self.Ptr, arrayiColumns,arrayorderBy,arraycolors)
