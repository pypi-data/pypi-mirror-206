...
class DatasetRevisionImpl(DatasetRevision):
    ...
    def _hydrate(self, show_progress: Optional[bool] = None) -> None:
        if self._hydrated:
            return
        ...
        self._client._await_operation_completion(operation_id=self.revision_id, show_progress=should_show_progress)
