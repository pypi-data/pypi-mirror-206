...
class SpringDamperHalfLoadCase(_6816.CouplingHalfLoadCase):
    """SpringDamperHalfLoadCase
    ...
    class _Cast_SpringDamperHalfLoadCase:
        ...
        def __init__(self, parent: 'SpringDamperHalfLoadCase'):
            self._parent = parent
        ...
        @property
        def spring_damper_half_load_case(self) -> 'SpringDamperHalfLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperHalfLoadCase._Cast_SpringDamperHalfLoadCase':
