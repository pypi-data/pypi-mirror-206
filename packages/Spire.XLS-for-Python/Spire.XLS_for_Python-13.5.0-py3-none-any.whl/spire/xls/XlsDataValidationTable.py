...
class XlsDataValidationTable (  SpireObject, IDataValidationTable) :
    ...
    def Worksheet(self)->'Worksheet':
        ...
        intPtr = GetDllLibXls().XlsDataValidationTable_get_Worksheet(self.Ptr)
    ...
    def Workbook(self)->'Workbook':
        ...
        intPtr = GetDllLibXls().XlsDataValidationTable_get_Workbook(self.Ptr)
    ...
    def get_Item(self ,index:int)->'XlsDataValidationCollection':
        ...
        intPtr = GetDllLibXls().XlsDataValidationTable_get_Item(self.Ptr, index)
    ...
    def ShapesCount(self)->int:
        ...
        ret = GetDllLibXls().XlsDataValidationTable_get_ShapesCount(self.Ptr)
        return ret
    ...
    def FindDataValidation(self ,iCellIndex:int)->'IDataValidation':
        ...
        intPtr = GetDllLibXls().XlsDataValidationTable_FindDataValidation(self.Ptr, iCellIndex)
    ...
    def Remove(self ,rectangles:List[Rectangle]):
        ...
        GetDllLibXls().XlsDataValidationTable_Remove(self.Ptr, arrayrectangles, countrectangles)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsDataValidationTable_Clone(self.Ptr, intPtrparent)
