...
class StraightBevelGearMeshSteadyStateSynchronousResponse(_2978.BevelGearMeshSteadyStateSynchronousResponse):
    """StraightBevelGearMeshSteadyStateSynchronousResponse
    ...
    class _Cast_StraightBevelGearMeshSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_steady_state_synchronous_response(self) -> 'StraightBevelGearMeshSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshSteadyStateSynchronousResponse._Cast_StraightBevelGearMeshSteadyStateSynchronousResponse':
