...
class BevelDifferentialGearDynamicAnalysis(_6259.BevelGearDynamicAnalysis):
    """BevelDifferentialGearDynamicAnalysis
    ...
    class _Cast_BevelDifferentialGearDynamicAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialGearDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_dynamic_analysis(self) -> 'BevelDifferentialGearDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearDynamicAnalysis._Cast_BevelDifferentialGearDynamicAnalysis':
