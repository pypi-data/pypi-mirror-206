...
class StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed(_5235.BevelGearMeshCompoundModalAnalysisAtASpeed):
    """StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed
    ...
    class _Cast_StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_mesh_compound_modal_analysis_at_a_speed(self) -> 'StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5194.StraightBevelDiffGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5194.StraightBevelDiffGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed._Cast_StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed':
