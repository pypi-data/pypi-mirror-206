...
class CycloidalAssemblyMultibodyDynamicsAnalysis(_5459.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    """CycloidalAssemblyMultibodyDynamicsAnalysis
    ...
    class _Cast_CycloidalAssemblyMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'CycloidalAssemblyMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def cycloidal_assembly_multibody_dynamics_analysis(self) -> 'CycloidalAssemblyMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalAssemblyMultibodyDynamicsAnalysis._Cast_CycloidalAssemblyMultibodyDynamicsAnalysis':
