...
class AGMAGleasonConicalGearMeshModalAnalysisAtASpeed(_5121.ConicalGearMeshModalAnalysisAtASpeed):
    """AGMAGleasonConicalGearMeshModalAnalysisAtASpeed
    ...
    class _Cast_AGMAGleasonConicalGearMeshModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearMeshModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_mesh_modal_analysis_at_a_speed(self) -> 'AGMAGleasonConicalGearMeshModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearMeshModalAnalysisAtASpeed._Cast_AGMAGleasonConicalGearMeshModalAnalysisAtASpeed':
