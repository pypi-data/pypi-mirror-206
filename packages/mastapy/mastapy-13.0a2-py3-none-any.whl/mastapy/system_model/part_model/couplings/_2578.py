...
from mastapy.math_utility.stiffness_calculators import _1525
...
class SplineLeadRelief(_0.APIBase):
    ...
    class _Cast_SplineLeadRelief:
        ...
        def __init__(self, parent: 'SplineLeadRelief'):
            self._parent = parent

        @property
        def spline_lead_relief(self) -> 'SplineLeadRelief':
            return self._parent
    ...
    @property
    def contact_position(self) -> '_1525.IndividualContactPosition':
        ...
        value = conversion.pn_to_mp_enum(temp, _1525.IndividualContactPosition)
        return constructor.new_from_mastapy_type(_1525.IndividualContactPosition)(value) if value is not None else None
    ...
    @property
    def microgeometry_clearance_chart(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def crowning(self) -> '_2564.CrowningSpecification':
    ...
    @property
    def cast_to(self) -> 'SplineLeadRelief._Cast_SplineLeadRelief':
