...
class ClutchDynamicAnalysis(_6281.CouplingDynamicAnalysis):
    """ClutchDynamicAnalysis
    ...
    class _Cast_ClutchDynamicAnalysis:
        ...
        def __init__(self, parent: 'ClutchDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_dynamic_analysis(self) -> 'ClutchDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchDynamicAnalysis._Cast_ClutchDynamicAnalysis':
