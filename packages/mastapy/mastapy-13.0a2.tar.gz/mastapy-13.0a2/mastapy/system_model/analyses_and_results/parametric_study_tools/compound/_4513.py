...
class ShaftCompoundParametricStudyTool(_4419.AbstractShaftCompoundParametricStudyTool):
    """ShaftCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4385.ShaftParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4385.ShaftParametricStudyTool]':
