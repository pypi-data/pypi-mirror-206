...
class BevelDifferentialSunGearModalAnalysisAtASpeed(_5101.BevelDifferentialGearModalAnalysisAtASpeed):
    """BevelDifferentialSunGearModalAnalysisAtASpeed
    ...
    class _Cast_BevelDifferentialSunGearModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'BevelDifferentialSunGearModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def bevel_differential_sun_gear_modal_analysis_at_a_speed(self) -> 'BevelDifferentialSunGearModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialSunGearModalAnalysisAtASpeed._Cast_BevelDifferentialSunGearModalAnalysisAtASpeed':
