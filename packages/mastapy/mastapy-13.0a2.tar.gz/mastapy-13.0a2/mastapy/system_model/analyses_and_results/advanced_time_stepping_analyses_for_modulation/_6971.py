...
class AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation(_6998.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def abstract_shaft_or_housing_advanced_time_stepping_analysis_for_modulation(self) -> 'AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2665.AbstractShaftOrHousingSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation._Cast_AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation(self)
