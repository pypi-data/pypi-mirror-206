...
class CycloidalDiscCentralBearingConnectionSystemDeflection(_2693.CoaxialConnectionSystemDeflection):
    """CycloidalDiscCentralBearingConnectionSystemDeflection
    ...
    class _Cast_CycloidalDiscCentralBearingConnectionSystemDeflection:
        ...
        def __init__(self, parent: 'CycloidalDiscCentralBearingConnectionSystemDeflection'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_central_bearing_connection_system_deflection(self) -> 'CycloidalDiscCentralBearingConnectionSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4053.CycloidalDiscCentralBearingConnectionPowerFlow':
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscCentralBearingConnectionSystemDeflection._Cast_CycloidalDiscCentralBearingConnectionSystemDeflection':
