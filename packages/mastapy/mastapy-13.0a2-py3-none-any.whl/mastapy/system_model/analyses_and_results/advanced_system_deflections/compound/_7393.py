...
class ComponentCompoundAdvancedSystemDeflection(_7447.PartCompoundAdvancedSystemDeflection):
    """ComponentCompoundAdvancedSystemDeflection
    ...
    class _Cast_ComponentCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'ComponentCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def component_compound_advanced_system_deflection(self) -> 'ComponentCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7260.ComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7260.ComponentAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'ComponentCompoundAdvancedSystemDeflection._Cast_ComponentCompoundAdvancedSystemDeflection':
