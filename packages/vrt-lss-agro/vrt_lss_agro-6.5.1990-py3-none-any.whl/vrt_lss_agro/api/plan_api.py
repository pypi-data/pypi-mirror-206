...
class PlanApi(object):
    ...
    @validate_arguments
    def run_plan_calculation_with_http_info(self, plan_task : Annotated[PlanTask, Field(..., description="Data for calculation.")], **kwargs):  # noqa: E501
        """Planning (SYNC)  # noqa: E501
    ...
    @validate_arguments
    def run_plan_calculation_async_with_http_info(self, plan_task : Annotated[PlanTask, Field(..., description="Data for calculation.")], **kwargs):  # noqa: E501
        """Planning (ASYNC)  # noqa: E501
    ...
    @validate_arguments
    def run_plan_clip(self, clip_key : Annotated[constr(strict=True, max_length=1024, min_length=1), Field(..., description="Target essence key.")], plan_task : Annotated[PlanTask, Field(..., description="Data for clipping.")], clip_strategy : Annotated[Optional[StrictStr], Field(description="Data clipping strategy.")] = None, **kwargs) -> PlanTask:  # noqa: E501
    ...
    @validate_arguments
    def run_plan_clip_with_http_info(self, clip_key : Annotated[constr(strict=True, max_length=1024, min_length=1), Field(..., description="Target essence key.")], plan_task : Annotated[PlanTask, Field(..., description="Data for clipping.")], clip_strategy : Annotated[Optional[StrictStr], Field(description="Data clipping strategy.")] = None, **kwargs):  # noqa: E501
        """Clipping (SYNC)  # noqa: E501
    ...
    @validate_arguments
    def run_plan_validation_with_http_info(self, plan_task : Annotated[PlanTask, Field(..., description="Data for calculation.")], **kwargs):  # noqa: E501
        """Data validation  # noqa: E501
