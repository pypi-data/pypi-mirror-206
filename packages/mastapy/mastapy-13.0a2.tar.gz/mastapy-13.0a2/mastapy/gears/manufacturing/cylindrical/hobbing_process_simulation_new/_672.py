...
class HobResharpeningError(_0.APIBase):
    ...
    class _Cast_HobResharpeningError:
        ...
        def __init__(self, parent: 'HobResharpeningError'):
            self._parent = parent

        @property
        def hob_resharpening_error(self) -> 'HobResharpeningError':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HobResharpeningError._Cast_HobResharpeningError':
