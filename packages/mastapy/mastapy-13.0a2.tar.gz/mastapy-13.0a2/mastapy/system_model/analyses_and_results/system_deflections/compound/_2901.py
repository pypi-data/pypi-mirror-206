...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundSystemDeflection(_2898.KlingelnbergCycloPalloidConicalGearMeshCompoundSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearMeshCompoundSystemDeflection
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearMeshCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearMeshCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_mesh_compound_system_deflection(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2750.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2750.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshCompoundSystemDeflection._Cast_KlingelnbergCycloPalloidHypoidGearMeshCompoundSystemDeflection':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearMeshCompoundSystemDeflection(self)
