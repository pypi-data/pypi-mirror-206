...
class AbstractAssemblyCompoundParametricStudyTool(_4497.PartCompoundParametricStudyTool):
    """AbstractAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4271.AbstractAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4271.AbstractAssemblyParametricStudyTool]':
