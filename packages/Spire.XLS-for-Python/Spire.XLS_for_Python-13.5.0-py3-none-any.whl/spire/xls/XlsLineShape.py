...
class XlsLineShape (  XlsPrstGeomShape, ILineShape) :
    ...
    def LineShapeType(self)->'LineShapeType':
        ...
        ret = GetDllLibXls().XlsLineShape_get_LineShapeType(self.Ptr)
    ...
    def LineShapeType(self, value:'LineShapeType'):
        ...
        GetDllLibXls().XlsLineShape_set_LineShapeType(self.Ptr, value.value)
    ...
    def Weight(self)->float:
        ...
        ret = GetDllLibXls().XlsLineShape_get_Weight(self.Ptr)
        return ret

    @Weight.setter
    def Weight(self, value:float):
        GetDllLibXls().XlsLineShape_set_Weight.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsLineShape_set_Weight(self.Ptr, value)
    ...
    def MiddleOffset(self)->int:
        ...
        ret = GetDllLibXls().XlsLineShape_get_MiddleOffset(self.Ptr)
        return ret

    @MiddleOffset.setter
    def MiddleOffset(self, value:int):
        GetDllLibXls().XlsLineShape_set_MiddleOffset.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsLineShape_set_MiddleOffset(self.Ptr, value)
    ...
    def MiddleOffsetPercent(self)->float:
        ...
        ret = GetDllLibXls().XlsLineShape_get_MiddleOffsetPercent(self.Ptr)
        return ret
    ...
    def MiddleOffsetPercent(self, value:float):
        ...
        GetDllLibXls().XlsLineShape_set_MiddleOffsetPercent(self.Ptr, value)
    ...
    def Transparency(self)->float:
        ...
        ret = GetDllLibXls().XlsLineShape_get_Transparency(self.Ptr)
        return ret

    @Transparency.setter
    def Transparency(self, value:float):
        GetDllLibXls().XlsLineShape_set_Transparency.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsLineShape_set_Transparency(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsLineShape_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().XlsLineShape_set_Color(self.Ptr, value.Ptr)
    ...
    def Style(self)->'ShapeLineStyleType':
        ...
        ret = GetDllLibXls().XlsLineShape_get_Style(self.Ptr)
    ...
    def Style(self, value:'ShapeLineStyleType'):
        ...
        GetDllLibXls().XlsLineShape_set_Style(self.Ptr, value.value)
    ...
    def DashStyle(self)->'ShapeDashLineStyleType':
        ...
        ret = GetDllLibXls().XlsLineShape_get_DashStyle(self.Ptr)
    ...
    def DashStyle(self, value:'ShapeDashLineStyleType'):
        ...
        GetDllLibXls().XlsLineShape_set_DashStyle(self.Ptr, value.value)
    ...
    def BeginArrowheadWidth(self)->'ShapeArrowWidthType':
        ...
        ret = GetDllLibXls().XlsLineShape_get_BeginArrowheadWidth(self.Ptr)
    ...
    def BeginArrowheadWidth(self, value:'ShapeArrowWidthType'):
        ...
        GetDllLibXls().XlsLineShape_set_BeginArrowheadWidth(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsLineShape_get_BeginArrowHeadStyle(self.Ptr)
    ...
    def BeginArrowHeadStyle(self, value:'ShapeArrowStyleType'):
        ...
        GetDllLibXls().XlsLineShape_set_BeginArrowHeadStyle(self.Ptr, value.value)
    ...
    def BeginArrowheadLength(self)->'ShapeArrowLengthType':
        ...
        ret = GetDllLibXls().XlsLineShape_get_BeginArrowheadLength(self.Ptr)
    ...
    def BeginArrowheadLength(self, value:'ShapeArrowLengthType'):
        ...
        GetDllLibXls().XlsLineShape_set_BeginArrowheadLength(self.Ptr, value.value)
    ...
    def EndArrowHeadStyle(self)->'ShapeArrowStyleType':
        ...
        ret = GetDllLibXls().XlsLineShape_get_EndArrowHeadStyle(self.Ptr)
        objwraped = ShapeArrowStyleType(ret)
        return objwraped
    ...
    def EndArrowHeadStyle(self, value:'ShapeArrowStyleType'):
        ...
        GetDllLibXls().XlsLineShape_set_EndArrowHeadStyle(self.Ptr, value.value)
    ...
    def EndArrowheadLength(self)->'ShapeArrowLengthType':
        ...
        ret = GetDllLibXls().XlsLineShape_get_EndArrowheadLength(self.Ptr)
        objwraped = ShapeArrowLengthType(ret)
        return objwraped
    ...
    def EndArrowheadLength(self, value:'ShapeArrowLengthType'):
        ...
        GetDllLibXls().XlsLineShape_set_EndArrowheadLength(self.Ptr, value.value)
    ...
    def EndArrowheadWidth(self)->'ShapeArrowWidthType':
        ...
        ret = GetDllLibXls().XlsLineShape_get_EndArrowheadWidth(self.Ptr)
        objwraped = ShapeArrowWidthType(ret)
        return objwraped
    ...
    def EndArrowheadWidth(self, value:'ShapeArrowWidthType'):
        ...
        GetDllLibXls().XlsLineShape_set_EndArrowheadWidth(self.Ptr, value.value)
    ...
    def HyLink(self)->'IHyperLink':
        ...
        intPtr = GetDllLibXls().XlsLineShape_get_HyLink(self.Ptr)
    ...
    def PrstShapeType(self)->'PrstGeomShapeType':
        ...
        ret = GetDllLibXls().XlsLineShape_get_PrstShapeType(self.Ptr)
...
<summary></summary>
        ...
        intPtr = GetDllLibXls().XlsLineShape_get_StartPoint(self.Ptr)
    ...
    def StartPoint(self, value:'Point'):
        ...
        GetDllLibXls().XlsLineShape_set_StartPoint(self.Ptr, value.Ptr)
...
<summary></summary>
        ...
        intPtr = GetDllLibXls().XlsLineShape_get_EndPoint(self.Ptr)
        ret = None if intPtr==None else Point(intPtr)
        return ret
    ...
    def EndPoint(self, value:'Point'):
        ...
        GetDllLibXls().XlsLineShape_set_EndPoint(self.Ptr, value.Ptr)
    ...
    def FlipH(self)->bool:
        ...
        ret = GetDllLibXls().XlsLineShape_get_FlipH(self.Ptr)
        return ret

    @FlipH.setter
    def FlipH(self, value:bool):
        GetDllLibXls().XlsLineShape_set_FlipH.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsLineShape_set_FlipH(self.Ptr, value)
    ...
    def FlipV(self)->bool:
        ...
        ret = GetDllLibXls().XlsLineShape_get_FlipV(self.Ptr)
        return ret

    @FlipV.setter
    def FlipV(self, value:bool):
        GetDllLibXls().XlsLineShape_set_FlipV.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsLineShape_set_FlipV(self.Ptr, value)
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsLineShape_get_ShapeType(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsLineShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
