...
class StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis(_5516.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    """StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_compound_multibody_dynamics_analysis(self) -> 'StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5469.StraightBevelGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5469.StraightBevelGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis._Cast_StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis':
