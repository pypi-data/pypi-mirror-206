...
class BevelDifferentialGearMeshCompoundSystemDeflection(_2847.BevelGearMeshCompoundSystemDeflection):
    """BevelDifferentialGearMeshCompoundSystemDeflection
    ...
    class _Cast_BevelDifferentialGearMeshCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_compound_system_deflection(self) -> 'BevelDifferentialGearMeshCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2680.BevelDifferentialGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2680.BevelDifferentialGearMeshSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshCompoundSystemDeflection._Cast_BevelDifferentialGearMeshCompoundSystemDeflection':
