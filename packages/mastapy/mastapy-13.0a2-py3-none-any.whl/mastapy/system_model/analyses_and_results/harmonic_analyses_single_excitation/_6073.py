...
class ShaftToMountableComponentConnectionHarmonicAnalysisOfSingleExcitation(_5978.AbstractShaftToMountableComponentConnectionHarmonicAnalysisOfSingleExcitation):
    """ShaftToMountableComponentConnectionHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_ShaftToMountableComponentConnectionHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'ShaftToMountableComponentConnectionHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def shaft_to_mountable_component_connection_harmonic_analysis_of_single_excitation(self) -> 'ShaftToMountableComponentConnectionHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftToMountableComponentConnectionHarmonicAnalysisOfSingleExcitation._Cast_ShaftToMountableComponentConnectionHarmonicAnalysisOfSingleExcitation':
        return self._Cast_ShaftToMountableComponentConnectionHarmonicAnalysisOfSingleExcitation(self)
