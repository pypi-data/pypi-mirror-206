...
class LicenceServerDetails:
    ...
    class _Cast_LicenceServerDetails:
        ...
        def __init__(self, parent: 'LicenceServerDetails'):
            self._parent = parent

        @property
        def licence_server_details(self) -> 'LicenceServerDetails':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'LicenceServerDetails._Cast_LicenceServerDetails':
