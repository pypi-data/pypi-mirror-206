...
#        intPtr = GetDllLibXls().ColorScale_get_Criteria(self.Ptr)
...
#
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ColorScale_get_MaxColor(self.Ptr)
    ...
    def MaxColor(self, value:'Color'):
        ...
        GetDllLibXls().ColorScale_set_MaxColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ColorScale_get_MidColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def MidColor(self, value:'Color'):
        ...
        GetDllLibXls().ColorScale_set_MidColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ColorScale_get_MinColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def MinColor(self, value:'Color'):
        ...
        GetDllLibXls().ColorScale_set_MinColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ColorScale_get_MaxValue(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ColorScale_get_MidValue(self.Ptr)
        ret = None if intPtr==None else XlsConditionValue(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ColorScale_get_MinValue(self.Ptr)
        ret = None if intPtr==None else XlsConditionValue(intPtr)
        return ret
    ...
    def AddCriteria(self ,item:ColorConditionValue):
        ...
        GetDllLibXls().ColorScale_AddCriteria(self.Ptr, intPtritem)
    ...
    def AddCriteria(self ,type:ConditionValueType,value:SpireObject,color:Color):
        ...
        GetDllLibXls().ColorScale_AddCriteriaTVC(self.Ptr, enumtype,intPtrvalue,intPtrcolor)
    ...
    <param name="count"></param>
        ...
        GetDllLibXls().ColorScale_SetConditionCount(self.Ptr, count)
