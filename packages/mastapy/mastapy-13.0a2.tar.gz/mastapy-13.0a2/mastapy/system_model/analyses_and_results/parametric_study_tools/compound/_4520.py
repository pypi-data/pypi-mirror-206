...
class SpringDamperCompoundParametricStudyTool(_4455.CouplingCompoundParametricStudyTool):
    """SpringDamperCompoundParametricStudyTool
    ...
    class _Cast_SpringDamperCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'SpringDamperCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def spring_damper_compound_parametric_study_tool(self) -> 'SpringDamperCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4393.SpringDamperParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4393.SpringDamperParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperCompoundParametricStudyTool._Cast_SpringDamperCompoundParametricStudyTool':
