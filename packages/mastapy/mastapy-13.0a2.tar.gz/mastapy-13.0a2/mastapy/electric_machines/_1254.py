...
from mastapy.electric_machines.results import _1331, _1332
...
class ElectricMachineDetail(_0.APIBase):
    ...
    class _Cast_ElectricMachineDetail:
        ...
        def __init__(self, parent: 'ElectricMachineDetail'):
            self._parent = parent

        @property
        def cad_electric_machine_detail(self):
            from mastapy.electric_machines import _1240
            
            return self._parent._cast(_1240.CADElectricMachineDetail)
        ...
        @property
        def electric_machine_detail(self) -> 'ElectricMachineDetail':
            return self._parent
    ...
    @property
    def core_loss_build_factor_specification_method(self) -> '_1249.CoreLossBuildFactorSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _1249.CoreLossBuildFactorSpecificationMethod)
        return constructor.new_from_mastapy_type(_1249.CoreLossBuildFactorSpecificationMethod)(value) if value is not None else None

    @core_loss_build_factor_specification_method.setter
    def core_loss_build_factor_specification_method(self, value: '_1249.CoreLossBuildFactorSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1249.CoreLossBuildFactorSpecificationMethod.type_())
    ...
    @property
    def electric_machine_type(self) -> '_1260.ElectricMachineType':
        ...
        value = conversion.pn_to_mp_enum(temp, _1260.ElectricMachineType)
        return constructor.new_from_mastapy_type(_1260.ElectricMachineType)(value) if value is not None else None
    ...
    @property
    def number_of_slots_per_phase(self) -> 'int':
        """int: 'NumberOfSlotsPerPhase' is the original name of this property.
    ...
    @property
    def number_of_slots_per_pole(self) -> 'float':
        """float: 'NumberOfSlotsPerPole' is the original name of this property.
    ...
    @property
    def non_linear_dq_model(self) -> '_1331.NonLinearDQModel':
    ...
    @property
    def non_linear_dq_model_generator_settings(self) -> '_1332.NonLinearDQModelSettings':
    ...
    @property
    def selected_setup(self) -> '_1259.ElectricMachineSetup':
    ...
    @property
    def stator(self) -> '_1237.AbstractStator':
    ...
    @property
    def results_locations(self) -> 'List[_1510.Named2DLocation]':
    ...
    @property
    def setups(self) -> 'List[_1259.ElectricMachineSetup]':
    ...
    def add_setup(self) -> '_1259.ElectricMachineSetup':
    ...
    def duplicate_setup(self, setup: '_1259.ElectricMachineSetup') -> '_1259.ElectricMachineSetup':
    ...
    def generate_design_without_non_linear_dq_model(self) -> '_1580.MethodOutcomeWithResult[ElectricMachineDetail]':
    ...
    def remove_setup(self, setup: '_1259.ElectricMachineSetup'):
    ...
    def setup_named(self, name: 'str') -> '_1259.ElectricMachineSetup':
    ...
    def try_generate_non_linear_dq_model(self) -> '_1580.MethodOutcomeWithResult[ElectricMachineDetail]':
    ...
    def try_generate_non_linear_dq_model_with_task_progress(self, progress: '_7521.TaskProgress') -> '_1580.MethodOutcomeWithResult[ElectricMachineDetail]':
    ...
    @property
    def cast_to(self) -> 'ElectricMachineDetail._Cast_ElectricMachineDetail':
