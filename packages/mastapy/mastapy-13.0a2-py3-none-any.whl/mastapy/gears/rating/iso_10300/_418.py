...
class ISO10300MeshSingleFlankRating(_541.ConicalMeshSingleFlankRating, Generic[T]):
    ...
    class _Cast_ISO10300MeshSingleFlankRating:
        ...
        def __init__(self, parent: 'ISO10300MeshSingleFlankRating'):
            self._parent = parent
        ...
        @property
        def iso10300_mesh_single_flank_rating(self) -> 'ISO10300MeshSingleFlankRating':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ISO10300MeshSingleFlankRating._Cast_ISO10300MeshSingleFlankRating':
