...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _655, _689
...
class WormGrindingLeadCalculation(_689.WormGrindingProcessCalculation):
    """WormGrindingLeadCalculation
