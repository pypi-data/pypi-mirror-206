...
class DesignShaftSection(_0.APIBase):
    ...
    class _Cast_DesignShaftSection:
        ...
        def __init__(self, parent: 'DesignShaftSection'):
            self._parent = parent

        @property
        def design_shaft_section(self) -> 'DesignShaftSection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DesignShaftSection._Cast_DesignShaftSection':
