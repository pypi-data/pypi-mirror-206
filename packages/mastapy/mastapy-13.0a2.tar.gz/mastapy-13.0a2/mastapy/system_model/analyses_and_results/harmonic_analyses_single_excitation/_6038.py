...
class HypoidGearHarmonicAnalysisOfSingleExcitation(_5979.AGMAGleasonConicalGearHarmonicAnalysisOfSingleExcitation):
    """HypoidGearHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_HypoidGearHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'HypoidGearHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_harmonic_analysis_of_single_excitation(self) -> 'HypoidGearHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidGearHarmonicAnalysisOfSingleExcitation._Cast_HypoidGearHarmonicAnalysisOfSingleExcitation':
