...
class DatumSystemDeflection(_2694.ComponentSystemDeflection):
    """DatumSystemDeflection
    ...
    class _Cast_DatumSystemDeflection:
        ...
        def __init__(self, parent: 'DatumSystemDeflection'):
            self._parent = parent
        ...
        @property
        def datum_system_deflection(self) -> 'DatumSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4061.DatumPowerFlow':
    ...
    @property
    def cast_to(self) -> 'DatumSystemDeflection._Cast_DatumSystemDeflection':
