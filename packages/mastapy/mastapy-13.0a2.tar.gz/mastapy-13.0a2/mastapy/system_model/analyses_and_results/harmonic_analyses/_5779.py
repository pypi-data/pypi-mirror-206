...
class SpiralBevelGearHarmonicAnalysis(_5665.BevelGearHarmonicAnalysis):
    """SpiralBevelGearHarmonicAnalysis
    ...
    class _Cast_SpiralBevelGearHarmonicAnalysis:
        ...
        def __init__(self, parent: 'SpiralBevelGearHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_harmonic_analysis(self) -> 'SpiralBevelGearHarmonicAnalysis':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2788.SpiralBevelGearSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearHarmonicAnalysis._Cast_SpiralBevelGearHarmonicAnalysis':
