...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5697, _5698, _5727
...
class CylindricalGearSetHarmonicAnalysis(_5727.GearSetHarmonicAnalysis):
    """CylindricalGearSetHarmonicAnalysis
    ...
    class _Cast_CylindricalGearSetHarmonicAnalysis:
        ...
        def __init__(self, parent: 'CylindricalGearSetHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_set_harmonic_analysis(self) -> 'CylindricalGearSetHarmonicAnalysis':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2721.CylindricalGearSetSystemDeflection':
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5697.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gears_harmonic_analysis(self) -> 'List[_5697.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5698.CylindricalGearMeshHarmonicAnalysis]':
    ...
    @property
    def cylindrical_meshes_harmonic_analysis(self) -> 'List[_5698.CylindricalGearMeshHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearSetHarmonicAnalysis._Cast_CylindricalGearSetHarmonicAnalysis':
