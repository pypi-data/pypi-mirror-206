...
class ChartSerie (  XlsChartSerie) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartSerie_get_DataPoints(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartSerie_get_CategoryLabels(self.Ptr)
    ...
    def CategoryLabels(self, value:'CellRange'):
        ...
        GetDllLibXls().ChartSerie_set_CategoryLabels(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartSerie_get_Bubbles(self.Ptr)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    def Bubbles(self, value:'CellRange'):
        ...
        GetDllLibXls().ChartSerie_set_Bubbles(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartSerie_get_Values(self.Ptr)
    ...
    def Values(self, value:'IXLSRange'):
        ...
        GetDllLibXls().ChartSerie_set_Values(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartSerie_get_Format(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartSerie_get_DataFormat(self.Ptr)
        ret = None if intPtr==None else ChartSerieDataFormat(intPtr)
        return ret
    ...
    def GetSerieNameRange(self)->'CellRange':
        ...
        intPtr = GetDllLibXls().ChartSerie_GetSerieNameRange(self.Ptr)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    def DataLabels(self)->'ChartDataLabels':
        ...
        intPtr = GetDllLibXls().ChartSerie_get_DataLabels(self.Ptr)
