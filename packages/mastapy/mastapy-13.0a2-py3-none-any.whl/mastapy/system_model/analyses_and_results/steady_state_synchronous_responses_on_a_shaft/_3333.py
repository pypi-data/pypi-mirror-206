...
class StraightBevelGearMeshSteadyStateSynchronousResponseOnAShaft(_3240.BevelGearMeshSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_StraightBevelGearMeshSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_steady_state_synchronous_response_on_a_shaft(self) -> 'StraightBevelGearMeshSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshSteadyStateSynchronousResponseOnAShaft._Cast_StraightBevelGearMeshSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_StraightBevelGearMeshSteadyStateSynchronousResponseOnAShaft(self)
