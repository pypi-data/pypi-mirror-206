...
class XlsFont (  XlsObject, IFont, IOptimizedUpdate, ICloneParent) :
    ...
    def Clone(self ,parent:'SpireObject')->'XlsFont':
        ...
        intPtr = GetDllLibXls().XlsFont_Clone(self.Ptr, intPtrparent)
    ...
    def CompareTo(self ,obj:'SpireObject')->int:
        ...
        ret = GetDllLibXls().XlsFont_CompareTo(self.Ptr, intPtrobj)
        return ret
    ...
    def IsAutoColor(self)->bool:
        ...
        ret = GetDllLibXls().XlsFont_get_IsAutoColor(self.Ptr)
        return ret
    ...
    def IsBold(self)->bool:
        ...
        ret = GetDllLibXls().XlsFont_get_IsBold(self.Ptr)
        return ret

    @IsBold.setter
    def IsBold(self, value:bool):
        GetDllLibXls().XlsFont_set_IsBold.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsFont_set_IsBold(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsFont_get_OColor(self.Ptr)
    ...
    def KnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsFont_get_KnownColor(self.Ptr)
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsFont_set_KnownColor(self.Ptr, value.value)
    ...
    def Color(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsFont_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().XlsFont_set_Color(self.Ptr, value.Ptr)
    ...
    def SetThemeColor(self ,type:'ThemeColorType',tint:float):
        ...
        GetDllLibXls().XlsFont_SetThemeColor(self.Ptr, enumtype,tint)
...
#        ret = GetDllLibXls().XlsFont_GetThemeColor(self.Ptr, intPtrtype,intPtrtint)
#        return ret
    ...
    def IsItalic(self)->bool:
        ...
        ret = GetDllLibXls().XlsFont_get_IsItalic(self.Ptr)
        return ret

    @IsItalic.setter
    def IsItalic(self, value:bool):
        GetDllLibXls().XlsFont_set_IsItalic.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsFont_set_IsItalic(self.Ptr, value)
    ...
    def Size(self)->float:
        ...
        ret = GetDllLibXls().XlsFont_get_Size(self.Ptr)
        return ret

    @Size.setter
    def Size(self, value:float):
        GetDllLibXls().XlsFont_set_Size.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsFont_set_Size(self.Ptr, value)
    ...
    def IsStrikethrough(self)->bool:
        ...
        ret = GetDllLibXls().XlsFont_get_IsStrikethrough(self.Ptr)
        return ret
    ...
    def IsStrikethrough(self, value:bool):
        ...
        GetDllLibXls().XlsFont_set_IsStrikethrough(self.Ptr, value)
    ...
    def IsSubscript(self)->bool:
        ...
        ret = GetDllLibXls().XlsFont_get_IsSubscript(self.Ptr)
        return ret

    @IsSubscript.setter
    def IsSubscript(self, value:bool):
        GetDllLibXls().XlsFont_set_IsSubscript.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsFont_set_IsSubscript(self.Ptr, value)
    ...
    def StrikethroughType(self)->str:
        ...
        GetDllLibXls().XlsFont_get_StrikethroughType.restype=c_wchar_p
        ret = GetDllLibXls().XlsFont_get_StrikethroughType(self.Ptr)
        return ret
    ...
    def StrikethroughType(self, value:str):
        ...
        GetDllLibXls().XlsFont_set_StrikethroughType(self.Ptr, value)
    ...
    def Underline(self)->'FontUnderlineType':
        ...
        ret = GetDllLibXls().XlsFont_get_Underline(self.Ptr)
    ...
    def Underline(self, value:'FontUnderlineType'):
        ...
        GetDllLibXls().XlsFont_set_Underline(self.Ptr, value.value)
    ...
    def FontName(self)->str:
        ...
        GetDllLibXls().XlsFont_get_FontName.restype=c_wchar_p
        ret = GetDllLibXls().XlsFont_get_FontName(self.Ptr)
        return ret
    ...
    def FontName(self, value:str):
        ...
        GetDllLibXls().XlsFont_set_FontName(self.Ptr, value)
    ...
    def VerticalAlignment(self)->'FontVertialAlignmentType':
        ...
        ret = GetDllLibXls().XlsFont_get_VerticalAlignment(self.Ptr)
    ...
    def VerticalAlignment(self, value:'FontVertialAlignmentType'):
        ...
        GetDllLibXls().XlsFont_set_VerticalAlignment(self.Ptr, value.value)
    ...
    def Scheme(self)->str:
        ...
        GetDllLibXls().XlsFont_get_Scheme.restype=c_wchar_p
        ret = GetDllLibXls().XlsFont_get_Scheme(self.Ptr)
        return ret
    ...
    def Scheme(self, value:str):
        ...
        GetDllLibXls().XlsFont_set_Scheme(self.Ptr, value)
    ...
    def GenerateNativeFont(self)->Font:
        ...
        intPtr = GetDllLibXls().XlsFont_GenerateNativeFont(self.Ptr)
    ...
    def GenerateNativeFont(self ,size:float)->Font:
        ...
        intPtr = GetDllLibXls().XlsFont_GenerateNativeFontS(self.Ptr, size)
        ret = None if intPtr==None else Font(intPtr)
        return ret
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().XlsFont_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().XlsFont_EndUpdate(self.Ptr)
    ...
    def Font(self)->'XlsFont':
        ...
        intPtr = GetDllLibXls().XlsFont_get_Font(self.Ptr)
        ret = None if intPtr==None else XlsFont(intPtr)
        return ret
    ...
    def MeasureString(self ,strValue:str)->'SizeF':
        ...
        intPtr = GetDllLibXls().XlsFont_MeasureString(self.Ptr, strValue)
