...
def start(package_name: str,
    ...
    :param package_name: the microservice's distribution package name (required). Should match the name of a component
...
def get_application(package_name: str | None = None,
    ...
    async def _hea_component(app: web.Application) -> AsyncGenerator:
        ...
        if package_name is not None:
            # Needs its own client session because the main client session is not started yet.
