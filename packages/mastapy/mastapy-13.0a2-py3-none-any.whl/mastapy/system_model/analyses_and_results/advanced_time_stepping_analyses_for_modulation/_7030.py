...
class FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation(_7072.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def flexible_pin_assembly_advanced_time_stepping_analysis_for_modulation(self) -> 'FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation._Cast_FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation(self)
