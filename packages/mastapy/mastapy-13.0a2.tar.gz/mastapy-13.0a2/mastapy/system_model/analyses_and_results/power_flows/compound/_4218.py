...
class MeasurementComponentCompoundPowerFlow(_4264.VirtualComponentCompoundPowerFlow):
    """MeasurementComponentCompoundPowerFlow
    ...
    class _Cast_MeasurementComponentCompoundPowerFlow:
        ...
        def __init__(self, parent: 'MeasurementComponentCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def measurement_component_compound_power_flow(self) -> 'MeasurementComponentCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4086.MeasurementComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4086.MeasurementComponentPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'MeasurementComponentCompoundPowerFlow._Cast_MeasurementComponentCompoundPowerFlow':
