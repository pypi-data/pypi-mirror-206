...
class RollingRingAssemblyModalAnalysisAtAStiffness(_4929.SpecialisedAssemblyModalAnalysisAtAStiffness):
    """RollingRingAssemblyModalAnalysisAtAStiffness
    ...
    class _Cast_RollingRingAssemblyModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'RollingRingAssemblyModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def rolling_ring_assembly_modal_analysis_at_a_stiffness(self) -> 'RollingRingAssemblyModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingAssemblyModalAnalysisAtAStiffness._Cast_RollingRingAssemblyModalAnalysisAtAStiffness':
