...
class StraightBevelGearAdvancedTimeSteppingAnalysisForModulation(_6989.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_StraightBevelGearAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'StraightBevelGearAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_advanced_time_stepping_analysis_for_modulation(self) -> 'StraightBevelGearAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearAdvancedTimeSteppingAnalysisForModulation._Cast_StraightBevelGearAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_StraightBevelGearAdvancedTimeSteppingAnalysisForModulation(self)
