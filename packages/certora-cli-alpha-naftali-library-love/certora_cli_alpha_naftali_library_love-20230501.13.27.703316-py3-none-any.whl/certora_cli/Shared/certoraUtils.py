...
def run_typechecker(typechecker_name: str, with_typechecking: bool, suppress_output: bool = False) -> int:
    """
    ...
    # args to typechecker
    base_cmd = f"java -jar {path_to_typechecker} -v {get_certora_verify_file()} " \
