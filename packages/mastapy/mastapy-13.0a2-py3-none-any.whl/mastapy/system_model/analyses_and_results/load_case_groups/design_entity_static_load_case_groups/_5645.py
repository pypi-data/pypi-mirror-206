...
class DesignEntityStaticLoadCaseGroup(_0.APIBase):
    ...
    class _Cast_DesignEntityStaticLoadCaseGroup:
        ...
        def __init__(self, parent: 'DesignEntityStaticLoadCaseGroup'):
            self._parent = parent

        @property
        def abstract_assembly_static_load_case_group(self):
            from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5642
            
            return self._parent._cast(_5642.AbstractAssemblyStaticLoadCaseGroup)

        @property
        def component_static_load_case_group(self):
            from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5643
            
            return self._parent._cast(_5643.ComponentStaticLoadCaseGroup)

        @property
        def connection_static_load_case_group(self):
            from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5644
            
            return self._parent._cast(_5644.ConnectionStaticLoadCaseGroup)
        ...
        def gear_set_static_load_case_group(self):
            ...
            return self._parent._cast(_5646.GearSetStaticLoadCaseGroup)
        ...
        @property
        def design_entity_static_load_case_group(self) -> 'DesignEntityStaticLoadCaseGroup':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DesignEntityStaticLoadCaseGroup._Cast_DesignEntityStaticLoadCaseGroup':
