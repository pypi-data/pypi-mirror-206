...
class UrlTest(unittest.TestCase):
    ...
    def testGetCollection(self):
        ...
        musicbrainzez.get_artists_in_collection("7e582256-b3ce-421f-82ba-451b0ab080eb", api="xml")
...
class GetCollectionTest(unittest.TestCase):
    ...
    def testCollectionInfo(self):
        ...
        """
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "0b15c97c-8eb8-4b4f-81c3-0eb24266a2ac-releases.xml")
    ...
    def testCollectionWorks(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "2326c2e8-be4b-4300-acc6-dbd0adf5645b-works.xml")
        coll = res["collection"]
    ...
    def testCollectionArtists(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "29611d8b-b3ad-4ffb-acb5-27f77342a5b0-artists.xml")
        coll = res["collection"]
    ...
    def testCollectionEvents(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "20562e36-c7cc-44fb-96b4-486d51a1174b-events.xml")
        coll = res["collection"]
    ...
    def testCollectionPlaces(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "855b134e-9a3b-4717-8df8-8c4838d89924-places.xml")
        coll = res["collection"]
    ...
    def testCollectionRecordings(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "a91320b2-fd2f-4a93-9e4e-603d16d514b6-recordings.xml")
        coll = res["collection"]
