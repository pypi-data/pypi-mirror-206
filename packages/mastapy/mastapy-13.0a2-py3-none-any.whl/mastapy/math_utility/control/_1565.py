...
class PIDControlSettings(_0.APIBase):
    ...
    class _Cast_PIDControlSettings:
        ...
        def __init__(self, parent: 'PIDControlSettings'):
            self._parent = parent

        @property
        def pid_control_settings(self) -> 'PIDControlSettings':
            return self._parent
    ...
    @property
    def differential_gain_vs_time_and_error(self) -> '_1554.GriddedSurfaceAccessor':
    ...
    def differential_gain_vs_time_and_error(self, value: '_1554.GriddedSurfaceAccessor'):
    ...
    @property
    def integral_gain_vs_time_and_error(self) -> '_1554.GriddedSurfaceAccessor':
    ...
    def integral_gain_vs_time_and_error(self, value: '_1554.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def proportional_gain_vs_time_and_error(self) -> '_1554.GriddedSurfaceAccessor':
    ...
    def proportional_gain_vs_time_and_error(self, value: '_1554.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def update_method(self) -> '_1511.PIDControlUpdateMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _1511.PIDControlUpdateMethod)
        return constructor.new_from_mastapy_type(_1511.PIDControlUpdateMethod)(value) if value is not None else None

    @update_method.setter
    def update_method(self, value: '_1511.PIDControlUpdateMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1511.PIDControlUpdateMethod.type_())
    ...
    @property
    def cast_to(self) -> 'PIDControlSettings._Cast_PIDControlSettings':
