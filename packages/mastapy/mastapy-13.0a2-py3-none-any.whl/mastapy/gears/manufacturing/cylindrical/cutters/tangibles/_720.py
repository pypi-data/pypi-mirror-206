...
class CylindricalGearHobShape(_725.RackShape):
    """CylindricalGearHobShape
    ...
    class _Cast_CylindricalGearHobShape:
        ...
        def __init__(self, parent: 'CylindricalGearHobShape'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_hob_shape(self) -> 'CylindricalGearHobShape':
            return self._parent
    ...
    @property
    def design(self) -> '_704.CylindricalGearHobDesign':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearHobShape._Cast_CylindricalGearHobShape':
