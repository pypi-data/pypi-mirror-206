...
class ClutchHalfCompoundModalAnalysisAtASpeed(_5257.CouplingHalfCompoundModalAnalysisAtASpeed):
    """ClutchHalfCompoundModalAnalysisAtASpeed
    ...
    class _Cast_ClutchHalfCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ClutchHalfCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def clutch_half_compound_modal_analysis_at_a_speed(self) -> 'ClutchHalfCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5111.ClutchHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5111.ClutchHalfModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ClutchHalfCompoundModalAnalysisAtASpeed._Cast_ClutchHalfCompoundModalAnalysisAtASpeed':
