...
class PivotTableStyle (SpireObject) :
    ...
    def SetConverter(self ,converter:'SpireObject'):
        ...
        GetDllLibXls().PivotTableStyle_SetConverter(self.Ptr, intPtrconverter)
    ...
    def IsDefaultStyle(self)->bool:
        ...
        ret = GetDllLibXls().PivotTableStyle_get_IsDefaultStyle(self.Ptr)
        return ret
    ...
    def IsDefaultStyle(self, value:bool):
        ...
        GetDllLibXls().PivotTableStyle_set_IsDefaultStyle(self.Ptr, value)
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().PivotTableStyle_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().PivotTableStyle_get_Name(self.Ptr)
        return ret
...
#        intPtr = GetDllLibXls().PivotTableStyle_get_Styles(self.Ptr)
