...
class SynchroniserSleeveDynamicAnalysis(_6359.SynchroniserPartDynamicAnalysis):
    """SynchroniserSleeveDynamicAnalysis
    ...
    class _Cast_SynchroniserSleeveDynamicAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserSleeveDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_sleeve_dynamic_analysis(self) -> 'SynchroniserSleeveDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserSleeveDynamicAnalysis._Cast_SynchroniserSleeveDynamicAnalysis':
