...
class CylindricalGearProfileMeasurement(_0.APIBase):
    ...
    class _Cast_CylindricalGearProfileMeasurement:
        ...
        def __init__(self, parent: 'CylindricalGearProfileMeasurement'):
            self._parent = parent

        @property
        def cylindrical_gear_profile_measurement(self) -> 'CylindricalGearProfileMeasurement':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearProfileMeasurement._Cast_CylindricalGearProfileMeasurement':
