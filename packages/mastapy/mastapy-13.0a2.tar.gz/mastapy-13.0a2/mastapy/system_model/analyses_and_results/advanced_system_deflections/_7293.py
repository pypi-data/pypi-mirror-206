...
class FEPartAdvancedSystemDeflection(_7234.AbstractShaftOrHousingAdvancedSystemDeflection):
    """FEPartAdvancedSystemDeflection
    ...
    class _Cast_FEPartAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'FEPartAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def fe_part_advanced_system_deflection(self) -> 'FEPartAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2736.FEPartSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'FEPartAdvancedSystemDeflection._Cast_FEPartAdvancedSystemDeflection':
