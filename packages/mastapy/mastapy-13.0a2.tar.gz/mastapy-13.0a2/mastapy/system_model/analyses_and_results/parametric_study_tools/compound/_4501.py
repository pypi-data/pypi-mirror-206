...
class PlanetaryConnectionCompoundParametricStudyTool(_4515.ShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """PlanetaryConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4372.PlanetaryConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4372.PlanetaryConnectionParametricStudyTool]':
