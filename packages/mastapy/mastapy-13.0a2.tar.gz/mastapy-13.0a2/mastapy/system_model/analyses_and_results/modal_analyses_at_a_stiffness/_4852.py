...
class ClutchHalfModalAnalysisAtAStiffness(_4868.CouplingHalfModalAnalysisAtAStiffness):
    """ClutchHalfModalAnalysisAtAStiffness
    ...
    class _Cast_ClutchHalfModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ClutchHalfModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def clutch_half_modal_analysis_at_a_stiffness(self) -> 'ClutchHalfModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchHalfModalAnalysisAtAStiffness._Cast_ClutchHalfModalAnalysisAtAStiffness':
