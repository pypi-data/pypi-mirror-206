...
def lazy_import():
    ...
    globals()['ExternalBankAccount'] = ExternalBankAccount


class ExternalBankAccountList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([ExternalBankAccount],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """ExternalBankAccountList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([ExternalBankAccount]): Array of external bank account entities
