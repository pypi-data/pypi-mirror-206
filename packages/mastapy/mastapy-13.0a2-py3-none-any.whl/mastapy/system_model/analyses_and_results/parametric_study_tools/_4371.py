...
class PartToPartShearCouplingParametricStudyTool(_4310.CouplingParametricStudyTool):
    """PartToPartShearCouplingParametricStudyTool
    ...
    class _Cast_PartToPartShearCouplingParametricStudyTool:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_parametric_study_tool(self) -> 'PartToPartShearCouplingParametricStudyTool':
            return self._parent
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2767.PartToPartShearCouplingSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingParametricStudyTool._Cast_PartToPartShearCouplingParametricStudyTool':
