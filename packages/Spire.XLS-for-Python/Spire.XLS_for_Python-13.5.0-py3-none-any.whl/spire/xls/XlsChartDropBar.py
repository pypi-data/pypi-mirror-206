...
class XlsChartDropBar (  XlsObject, IChartFillBorder) :
    ...
    def HasInterior(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDropBar_get_HasInterior(self.Ptr)
        return ret
    ...
    def HasLineProperties(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDropBar_get_HasLineProperties(self.Ptr)
        return ret
    ...
    def HasFormat3D(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDropBar_get_HasFormat3D(self.Ptr)
        return ret
    ...
    def HasShadow(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDropBar_get_HasShadow(self.Ptr)
        return ret
    ...
    def LineProperties(self)->'ChartBorder':
        ...
        intPtr = GetDllLibXls().XlsChartDropBar_get_LineProperties(self.Ptr)
    ...
    def Interior(self)->'IChartInterior':
        ...
        intPtr = GetDllLibXls().XlsChartDropBar_get_Interior(self.Ptr)
    ...
    def Fill(self)->'IShapeFill':
        ...
        intPtr = GetDllLibXls().XlsChartDropBar_get_Fill(self.Ptr)
    ...
    def Format3D(self)->'Format3D':
        ...
        intPtr = GetDllLibXls().XlsChartDropBar_get_Format3D(self.Ptr)
    ...
    def GapWidth(self)->int:
        ...
        ret = GetDllLibXls().XlsChartDropBar_get_GapWidth(self.Ptr)
        return ret

    @GapWidth.setter
    def GapWidth(self, value:int):
        GetDllLibXls().XlsChartDropBar_set_GapWidth.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartDropBar_set_GapWidth(self.Ptr, value)
    ...
    def Shadow(self)->'ChartShadow':
        ...
        intPtr = GetDllLibXls().XlsChartDropBar_get_Shadow(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartDropBar_get_ForeGroundColorObject(self.Ptr)
    ...
    def ForeGroundColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsChartDropBar_get_ForeGroundColor(self.Ptr)
    ...
    def ForeGroundColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartDropBar_set_ForeGroundColor(self.Ptr, value.Ptr)
    ...
    def ForeGroundKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsChartDropBar_get_ForeGroundKnownColor(self.Ptr)
    ...
    def ForeGroundKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartDropBar_set_ForeGroundKnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartDropBar_get_BackGroundColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def BackGroundColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartDropBar_set_BackGroundColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDropBar_get_BackGroundKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def BackGroundKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartDropBar_set_BackGroundKnownColor(self.Ptr, value.value)
    ...
    def BackGroundColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsChartDropBar_get_BackGroundColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDropBar_get_Pattern(self.Ptr)
    ...
    def Pattern(self, value:'ExcelPatternType'):
        ...
        GetDllLibXls().XlsChartDropBar_set_Pattern(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDropBar_get_IsAutomaticFormat(self.Ptr)
        return ret
    ...
    def IsAutomaticFormat(self, value:bool):
        ...
        GetDllLibXls().XlsChartDropBar_set_IsAutomaticFormat(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDropBar_get_Visible(self.Ptr)
        return ret

    @Visible.setter
    def Visible(self, value:bool):
        GetDllLibXls().XlsChartDropBar_set_Visible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDropBar_set_Visible(self.Ptr, value)
    ...
    def Clone(self ,parent:'SpireObject')->'XlsChartDropBar':
        ...
        intPtr = GetDllLibXls().XlsChartDropBar_Clone(self.Ptr, intPtrparent)
