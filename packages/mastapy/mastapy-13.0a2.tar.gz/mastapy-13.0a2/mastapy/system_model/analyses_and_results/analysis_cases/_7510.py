...
class PartStaticLoadAnalysisCase(_7507.PartAnalysisCase):
    """PartStaticLoadAnalysisCase
    ...
    class _Cast_PartStaticLoadAnalysisCase:
        ...
        def __init__(self, parent: 'PartStaticLoadAnalysisCase'):
            self._parent = parent
        ...
        @property
        def part_static_load_analysis_case(self) -> 'PartStaticLoadAnalysisCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartStaticLoadAnalysisCase._Cast_PartStaticLoadAnalysisCase':
