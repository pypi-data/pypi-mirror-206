...
class CylindricalGearModalAnalysisAtAStiffness(_4890.GearModalAnalysisAtAStiffness):
    """CylindricalGearModalAnalysisAtAStiffness
    ...
    class _Cast_CylindricalGearModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'CylindricalGearModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_modal_analysis_at_a_stiffness(self) -> 'CylindricalGearModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearModalAnalysisAtAStiffness._Cast_CylindricalGearModalAnalysisAtAStiffness':
