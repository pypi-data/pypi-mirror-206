...
class MutatableCurve(_714.MutatableCommon):
    """MutatableCurve
    ...
    class _Cast_MutatableCurve:
        """Special nested class for casting MutatableCurve to subclasses."""

        def __init__(self, parent: 'MutatableCurve'):
            self._parent = parent
        ...
        @property
        def mutatable_curve(self) -> 'MutatableCurve':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MutatableCurve._Cast_MutatableCurve':
        return self._Cast_MutatableCurve(self)
