...
class ObservedPinStiffnessReporter(_0.APIBase):
    ...
    class _Cast_ObservedPinStiffnessReporter:
        ...
        def __init__(self, parent: 'ObservedPinStiffnessReporter'):
            self._parent = parent

        @property
        def observed_pin_stiffness_reporter(self) -> 'ObservedPinStiffnessReporter':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ObservedPinStiffnessReporter._Cast_ObservedPinStiffnessReporter':
