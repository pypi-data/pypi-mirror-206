...
class AbstractShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis(_5534.ConnectionCompoundMultibodyDynamicsAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5350.AbstractShaftToMountableComponentConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5350.AbstractShaftToMountableComponentConnectionMultibodyDynamicsAnalysis]':
