...
class PivotDataFields (  CollectionBase[PivotDataField], IPivotDataFields) :
    ...
    def get_Item(self ,index:int)->IPivotDataField:
        ...
        intPtr = GetDllLibXls().PivotDataFields_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->IPivotDataField:
        ...
        intPtr = GetDllLibXls().PivotDataFields_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else PivotDataField(intPtr)
        return ret
    ...
    def Parent(self)->'XlsPivotTable':
        ...
        intPtr = GetDllLibXls().PivotDataFields_get_Parent(self.Ptr)
    ...
    def Add(self ,iField:'IPivotField',name:str,subtotal:'SubtotalTypes')->'IPivotDataField':
        ...
        intPtr = GetDllLibXls().PivotDataFields_Add(self.Ptr, intPtriField,name,enumsubtotal)
        ret = None if intPtr==None else PivotDataField(intPtr)
        return ret
    ...
    def Remove(self ,item:'PivotDataField')->bool:
        ...
        ret = GetDllLibXls().PivotDataFields_Remove(self.Ptr, intPtritem)
        return ret
    ...
    def RemoveAt(self ,index:int):
        ...
        GetDllLibXls().PivotDataFields_RemoveAt(self.Ptr, index)
    ...
    def Clear(self):
        ...
        GetDllLibXls().PivotDataFields_Clear(self.Ptr)
