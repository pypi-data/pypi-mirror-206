...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5414, _5413, _5353
...
class HypoidGearSetMultibodyDynamicsAnalysis(_5353.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis):
    """HypoidGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5414.HypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_gears_multibody_dynamics_analysis(self) -> 'List[_5414.HypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_meshes_multibody_dynamics_analysis(self) -> 'List[_5413.HypoidGearMeshMultibodyDynamicsAnalysis]':
