...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5779, _5780, _5667
...
class SpiralBevelGearSetHarmonicAnalysis(_5667.BevelGearSetHarmonicAnalysis):
    """SpiralBevelGearSetHarmonicAnalysis
    ...
    class _Cast_SpiralBevelGearSetHarmonicAnalysis:
        ...
        def __init__(self, parent: 'SpiralBevelGearSetHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_set_harmonic_analysis(self) -> 'SpiralBevelGearSetHarmonicAnalysis':
            return self._parent
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5779.SpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gears_harmonic_analysis(self) -> 'List[_5779.SpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5780.SpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_harmonic_analysis(self) -> 'List[_5780.SpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearSetHarmonicAnalysis._Cast_SpiralBevelGearSetHarmonicAnalysis':
