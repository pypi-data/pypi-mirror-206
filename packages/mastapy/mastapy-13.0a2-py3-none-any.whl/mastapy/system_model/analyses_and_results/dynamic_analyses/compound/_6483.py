...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6481, _6482, _6391
...
class StraightBevelGearSetCompoundDynamicAnalysis(_6391.BevelGearSetCompoundDynamicAnalysis):
    """StraightBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6354.StraightBevelGearSetDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6481.StraightBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6482.StraightBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6354.StraightBevelGearSetDynamicAnalysis]':
