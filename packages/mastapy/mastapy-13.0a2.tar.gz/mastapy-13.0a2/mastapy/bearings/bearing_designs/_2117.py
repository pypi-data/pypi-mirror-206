...
class DummyRollingBearing(_2115.BearingDesign):
    """DummyRollingBearing
    ...
    class _Cast_DummyRollingBearing:
        ...
        def __init__(self, parent: 'DummyRollingBearing'):
            self._parent = parent
        ...
        @property
        def dummy_rolling_bearing(self) -> 'DummyRollingBearing':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DummyRollingBearing._Cast_DummyRollingBearing':
