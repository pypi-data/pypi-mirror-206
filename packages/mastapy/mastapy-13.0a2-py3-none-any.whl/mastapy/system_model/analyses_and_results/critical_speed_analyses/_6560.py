...
class CylindricalPlanetGearCriticalSpeedAnalysis(_6557.CylindricalGearCriticalSpeedAnalysis):
    """CylindricalPlanetGearCriticalSpeedAnalysis
    ...
    class _Cast_CylindricalPlanetGearCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'CylindricalPlanetGearCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_planet_gear_critical_speed_analysis(self) -> 'CylindricalPlanetGearCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalPlanetGearCriticalSpeedAnalysis._Cast_CylindricalPlanetGearCriticalSpeedAnalysis':
