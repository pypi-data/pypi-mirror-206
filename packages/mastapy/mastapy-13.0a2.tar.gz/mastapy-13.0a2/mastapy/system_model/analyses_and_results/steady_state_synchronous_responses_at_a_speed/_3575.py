...
class RollingRingConnectionSteadyStateSynchronousResponseAtASpeed(_3548.InterMountableComponentConnectionSteadyStateSynchronousResponseAtASpeed):
    """RollingRingConnectionSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_RollingRingConnectionSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'RollingRingConnectionSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def rolling_ring_connection_steady_state_synchronous_response_at_a_speed(self) -> 'RollingRingConnectionSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingConnectionSteadyStateSynchronousResponseAtASpeed._Cast_RollingRingConnectionSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_RollingRingConnectionSteadyStateSynchronousResponseAtASpeed(self)
