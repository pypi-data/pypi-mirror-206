...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _640, _641, _648
...
class PlungeShaverInputsAndMicroGeometry(_0.APIBase):
    ...
    class _Cast_PlungeShaverInputsAndMicroGeometry:
        ...
        def __init__(self, parent: 'PlungeShaverInputsAndMicroGeometry'):
            self._parent = parent

        @property
        def plunge_shaver_inputs_and_micro_geometry(self) -> 'PlungeShaverInputsAndMicroGeometry':
            return self._parent
    ...
    @property
    def points_of_interest_left_flank(self) -> 'List[_648.PointOfInterest]':
    ...
    @property
    def points_of_interest_right_flank(self) -> 'List[_648.PointOfInterest]':
    ...
    @property
    def cast_to(self) -> 'PlungeShaverInputsAndMicroGeometry._Cast_PlungeShaverInputsAndMicroGeometry':
