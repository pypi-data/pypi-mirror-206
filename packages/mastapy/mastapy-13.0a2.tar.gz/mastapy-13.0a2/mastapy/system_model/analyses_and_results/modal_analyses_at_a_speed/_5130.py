...
class CVTModalAnalysisAtASpeed(_5099.BeltDriveModalAnalysisAtASpeed):
    """CVTModalAnalysisAtASpeed
    ...
    class _Cast_CVTModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'CVTModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def cvt_modal_analysis_at_a_speed(self) -> 'CVTModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CVTModalAnalysisAtASpeed._Cast_CVTModalAnalysisAtASpeed':
