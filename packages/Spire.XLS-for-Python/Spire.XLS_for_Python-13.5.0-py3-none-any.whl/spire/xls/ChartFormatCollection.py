...
class ChartFormatCollection (  XlsChartFormatCollection) :
    ...
    def Add(self ,format:'ChartFormat'):
        ...
        GetDllLibXls().ChartFormatCollection_Add(self.Ptr, intPtrformat)
    ...
    def GetFormat(self ,index:int)->'ChartFormat':
        ...
        intPtr = GetDllLibXls().ChartFormatCollection_GetFormat(self.Ptr, index)
    ...
    def Remove(self ,index:int):
        ...
        GetDllLibXls().ChartFormatCollection_Remove(self.Ptr, index)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartFormatCollection_get_Item(self.Ptr, index)
        ret = None if intPtr==None else ChartFormat(intPtr)
        return ret
