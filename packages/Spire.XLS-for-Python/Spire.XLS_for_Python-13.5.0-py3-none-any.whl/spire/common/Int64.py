...
class Int64 (SpireObject) :
    ...
    def ToString(self)->str:
        ...
        dlllib.Int64_ToString.restype=c_wchar_p
        ret = dlllib.Int64_ToString(self.Ptr)
        return ret
...
#
    ...
    def ToString(self ,format:str)->str:
        ...
        dlllib.Int64_ToStringF.restype=c_wchar_p
        ret = dlllib.Int64_ToStringF(self.Ptr, format)
        return ret
