...
def open_and_parse_test_data(parser, datadir, filename):
    """ Opens a file dumped from the MusicBrainz web service and returns
    the parses it using the provided parser.
