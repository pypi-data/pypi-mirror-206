...
class HypoidGearMeshCompoundModalAnalysisAtAStiffness(_4965.AGMAGleasonConicalGearMeshCompoundModalAnalysisAtAStiffness):
    """HypoidGearMeshCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_HypoidGearMeshCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'HypoidGearMeshCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_mesh_compound_modal_analysis_at_a_stiffness(self) -> 'HypoidGearMeshCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4893.HypoidGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4893.HypoidGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearMeshCompoundModalAnalysisAtAStiffness._Cast_HypoidGearMeshCompoundModalAnalysisAtAStiffness':
