...
class ZerolBevelGearParametricStudyTool(_4288.BevelGearParametricStudyTool):
    """ZerolBevelGearParametricStudyTool
    ...
    class _Cast_ZerolBevelGearParametricStudyTool:
        ...
        def __init__(self, parent: 'ZerolBevelGearParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_parametric_study_tool(self) -> 'ZerolBevelGearParametricStudyTool':
            return self._parent
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2820.ZerolBevelGearSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearParametricStudyTool._Cast_ZerolBevelGearParametricStudyTool':
