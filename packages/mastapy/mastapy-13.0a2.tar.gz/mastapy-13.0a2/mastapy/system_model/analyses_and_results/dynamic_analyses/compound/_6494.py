...
class UnbalancedMassCompoundDynamicAnalysis(_6495.VirtualComponentCompoundDynamicAnalysis):
    """UnbalancedMassCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6365.UnbalancedMassDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6365.UnbalancedMassDynamicAnalysis]':
