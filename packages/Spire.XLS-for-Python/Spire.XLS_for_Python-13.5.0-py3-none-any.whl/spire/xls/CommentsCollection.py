...
class CommentsCollection (  XlsCommentsCollection) :
    ...
    <returns>Created comment object..</returns>
        ...
        intPtr = GetDllLibXls().CommentsCollection_AddComment(self.Ptr, intPtrrange)
    ...
    <returns>Created comment object.</returns>
        ...
        intPtr = GetDllLibXls().CommentsCollection_AddCommentRC(self.Ptr, rowIndex,columnIndex)
        ret = None if intPtr==None else ExcelComment(intPtr)
        return ret
    ...
    <param name="comment">Comment to remove.</param>
        ...
        GetDllLibXls().CommentsCollection_Remove(self.Ptr, intPtrcomment)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CommentsCollection_get_Item(self.Ptr, index)
        ret = None if intPtr==None else ExcelComment(intPtr)
        return ret
    ...
    def get_Item(self ,name:str)->ExcelComment:
        ...
        intPtr = GetDllLibXls().CommentsCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else ExcelComment(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CommentsCollection_get_ItemRC(self.Ptr, Row,Column)
        ret = None if intPtr==None else ExcelComment(intPtr)
        return ret
