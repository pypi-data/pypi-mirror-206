...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6701, _6702, _6645
...
class HypoidGearSetCompoundCriticalSpeedAnalysis(_6645.AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis):
    """HypoidGearSetCompoundCriticalSpeedAnalysis
    ...
    class _Cast_HypoidGearSetCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'HypoidGearSetCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_set_compound_critical_speed_analysis(self) -> 'HypoidGearSetCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6574.HypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_gears_compound_critical_speed_analysis(self) -> 'List[_6701.HypoidGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_critical_speed_analysis(self) -> 'List[_6702.HypoidGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6574.HypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearSetCompoundCriticalSpeedAnalysis._Cast_HypoidGearSetCompoundCriticalSpeedAnalysis':
