...
from mastapy.gears.rating.spiral_bevel import _399, _398
...
class SpiralBevelGearSetRating(_551.BevelGearSetRating):
    """SpiralBevelGearSetRating
    ...
    @property
    def spiral_bevel_gear_ratings(self) -> 'List[_399.SpiralBevelGearRating]':
    ...
    @property
    def spiral_bevel_mesh_ratings(self) -> 'List[_398.SpiralBevelGearMeshRating]':
