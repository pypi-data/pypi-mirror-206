...
class ClutchHalfCompoundSteadyStateSynchronousResponseAtASpeed(_3652.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    """ClutchHalfCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ClutchHalfCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ClutchHalfCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def clutch_half_compound_steady_state_synchronous_response_at_a_speed(self) -> 'ClutchHalfCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3505.ClutchHalfSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3505.ClutchHalfSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ClutchHalfCompoundSteadyStateSynchronousResponseAtASpeed._Cast_ClutchHalfCompoundSteadyStateSynchronousResponseAtASpeed':
