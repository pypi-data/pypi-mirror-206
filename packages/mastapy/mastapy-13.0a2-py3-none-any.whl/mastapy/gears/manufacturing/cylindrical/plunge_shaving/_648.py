...
class PointOfInterest(_0.APIBase):
    ...
    class _Cast_PointOfInterest:
        ...
        def __init__(self, parent: 'PointOfInterest'):
            self._parent = parent

        @property
        def point_of_interest(self) -> 'PointOfInterest':
            return self._parent
    ...
    def flank(self) -> '_622.Flank':
        ...
        value = conversion.pn_to_mp_enum(temp, _622.Flank)
        return constructor.new_from_mastapy_type(_622.Flank)(value) if value is not None else None

    @flank.setter
    def flank(self, value: '_622.Flank'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _622.Flank.type_())
    ...
    @property
    def cast_to(self) -> 'PointOfInterest._Cast_PointOfInterest':
