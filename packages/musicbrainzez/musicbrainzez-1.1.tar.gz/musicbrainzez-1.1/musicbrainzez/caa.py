...
# Copyright (C) Louis Rannou, Alastair Porter, Wieland Hoffmann, and others
...
def set_caa_hostname(new_hostname, use_https=True):
...
def get_image_list(releaseid):
    ...
    If an error occurs then a :class:`~musicbrainzez.ResponseError` will
...
def get_image(mbid, coverid, size=None, entitytype="release"):
    ...
    If an error occurs then a :class:`~musicbrainzez.ResponseError`
