...
class ConceptCouplingHalfSystemDeflection(_2709.CouplingHalfSystemDeflection):
    """ConceptCouplingHalfSystemDeflection
    ...
    class _Cast_ConceptCouplingHalfSystemDeflection:
        ...
        def __init__(self, parent: 'ConceptCouplingHalfSystemDeflection'):
            self._parent = parent
        ...
        @property
        def concept_coupling_half_system_deflection(self) -> 'ConceptCouplingHalfSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4036.ConceptCouplingHalfPowerFlow':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHalfSystemDeflection._Cast_ConceptCouplingHalfSystemDeflection':
