...
from mastapy.gears.manufacturing.bevel.control_parameters import _812
...
class ConicalManufacturingSMTControlParameters(_812.ConicalGearManufacturingControlParameters):
    """ConicalManufacturingSMTControlParameters
    ...
    class _Cast_ConicalManufacturingSMTControlParameters:
        ...
        def __init__(self, parent: 'ConicalManufacturingSMTControlParameters'):
            self._parent = parent

        @property
        def conical_gear_manufacturing_control_parameters(self):
            return self._parent._cast(_812.ConicalGearManufacturingControlParameters)

        @property
        def conical_manufacturing_smt_control_parameters(self) -> 'ConicalManufacturingSMTControlParameters':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConicalManufacturingSMTControlParameters._Cast_ConicalManufacturingSMTControlParameters':
