...
class BevelGearSetCompoundDynamicAnalysis(_6379.AGMAGleasonConicalGearSetCompoundDynamicAnalysis):
    """BevelGearSetCompoundDynamicAnalysis
    ...
    class _Cast_BevelGearSetCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'BevelGearSetCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_gear_set_compound_dynamic_analysis(self) -> 'BevelGearSetCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6261.BevelGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6261.BevelGearSetDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BevelGearSetCompoundDynamicAnalysis._Cast_BevelGearSetCompoundDynamicAnalysis':
