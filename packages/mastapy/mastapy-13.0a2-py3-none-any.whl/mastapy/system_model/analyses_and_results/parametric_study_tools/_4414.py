...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4413, _4412, _4338
...
class WormGearSetParametricStudyTool(_4338.GearSetParametricStudyTool):
    """WormGearSetParametricStudyTool
    ...
    @property
    def worm_gears_parametric_study_tool(self) -> 'List[_4413.WormGearParametricStudyTool]':
    ...
    @property
    def worm_meshes_parametric_study_tool(self) -> 'List[_4412.WormGearMeshParametricStudyTool]':
