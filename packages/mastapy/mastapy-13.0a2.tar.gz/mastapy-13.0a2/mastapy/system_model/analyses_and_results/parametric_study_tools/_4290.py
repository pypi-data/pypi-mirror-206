...
class BoltedJointParametricStudyTool(_4387.SpecialisedAssemblyParametricStudyTool):
    """BoltedJointParametricStudyTool
    ...
    class _Cast_BoltedJointParametricStudyTool:
        ...
        def __init__(self, parent: 'BoltedJointParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def bolted_joint_parametric_study_tool(self) -> 'BoltedJointParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltedJointParametricStudyTool._Cast_BoltedJointParametricStudyTool':
