...
"""
from mastapy.bearings.bearing_results.rolling import _2049, _2009
...
class LoadedCylindricalRollerBearingResults(_2009.LoadedNonBarrelRollerBearingResults):
    """LoadedCylindricalRollerBearingResults
    ...
    @property
    def permissible_continuous_axial_load(self) -> '_2049.PermissibleContinuousAxialLoadResults':
