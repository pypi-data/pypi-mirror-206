...
class SpringDamperConnectionParametricStudyTool(_4308.CouplingConnectionParametricStudyTool):
    """SpringDamperConnectionParametricStudyTool
    ...
    class _Cast_SpringDamperConnectionParametricStudyTool:
        ...
        def __init__(self, parent: 'SpringDamperConnectionParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_parametric_study_tool(self) -> 'SpringDamperConnectionParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionParametricStudyTool._Cast_SpringDamperConnectionParametricStudyTool':
