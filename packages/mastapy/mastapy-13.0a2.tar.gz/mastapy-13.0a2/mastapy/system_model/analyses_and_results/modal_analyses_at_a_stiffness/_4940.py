...
class StraightBevelGearModalAnalysisAtAStiffness(_4847.BevelGearModalAnalysisAtAStiffness):
    """StraightBevelGearModalAnalysisAtAStiffness
    ...
    class _Cast_StraightBevelGearModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'StraightBevelGearModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_modal_analysis_at_a_stiffness(self) -> 'StraightBevelGearModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearModalAnalysisAtAStiffness._Cast_StraightBevelGearModalAnalysisAtAStiffness':
