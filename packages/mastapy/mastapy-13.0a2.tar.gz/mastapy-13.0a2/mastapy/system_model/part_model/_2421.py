...
from mastapy.bearings.bearing_results import _1948, _1949
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    class _Cast_BearingRaceMountingOptions:
        ...
        def __init__(self, parent: 'BearingRaceMountingOptions'):
            self._parent = parent

        @property
        def inner_bearing_race_mounting_options(self):
            from mastapy.system_model.part_model import _2438
            
            return self._parent._cast(_2438.InnerBearingRaceMountingOptions)

        @property
        def outer_bearing_race_mounting_options(self):
            from mastapy.system_model.part_model import _2447
            
            return self._parent._cast(_2447.OuterBearingRaceMountingOptions)

        @property
        def bearing_race_mounting_options(self) -> 'BearingRaceMountingOptions':
            return self._parent
    ...
    @property
    def mounting_sleeve_material(self) -> '_241.BearingMaterial':
    ...
    @property
    def cast_to(self) -> 'BearingRaceMountingOptions._Cast_BearingRaceMountingOptions':
