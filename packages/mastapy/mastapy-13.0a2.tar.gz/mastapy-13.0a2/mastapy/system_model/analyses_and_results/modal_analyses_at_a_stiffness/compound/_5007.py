...
class CylindricalGearCompoundModalAnalysisAtAStiffness(_5018.GearCompoundModalAnalysisAtAStiffness):
    """CylindricalGearCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_CylindricalGearCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'CylindricalGearCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_compound_modal_analysis_at_a_stiffness(self) -> 'CylindricalGearCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4878.CylindricalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4878.CylindricalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearCompoundModalAnalysisAtAStiffness._Cast_CylindricalGearCompoundModalAnalysisAtAStiffness':
