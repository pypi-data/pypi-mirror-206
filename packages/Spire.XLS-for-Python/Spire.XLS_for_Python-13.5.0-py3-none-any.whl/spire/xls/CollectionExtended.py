...
class CollectionExtended (  IExcelApplication, ICloneParent) :
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().CollectionExtended_get_Parent(self.Ptr)
...
#        GetDllLibXls().CollectionExtended_add_Changed(self.Ptr, intPtrvalue)
...
#        GetDllLibXls().CollectionExtended_remove_Changed(self.Ptr, intPtrvalue)
    ...
    <returns>A copy of the collection.</returns>
        ...
        intPtr = GetDllLibXls().CollectionExtended_Clone(self.Ptr, intPtrparent)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    <param name="size">Required size.</param>
        ...
        GetDllLibXls().CollectionExtended_EnsureCapacity(self.Ptr, size)
...
#        ret = GetDllLibXls().CollectionExtended_GenerateDefaultName( intPtrnamesCollection,strStart)
#        return ret
#
