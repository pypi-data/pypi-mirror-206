...
from cryton_core.cryton_app.models import StageExecutionModel
from cryton_core.lib.util import exceptions as core_exceptions
from cryton_core.lib.models.stage import StageExecution
...
class StageExecutionViewSet(util.ExecutionViewSet):
    ...
    @extend_schema(
        description="Delete Stage execution.",
        responses={
    ...
    def destroy(self, request: Request, *args, **kwargs):
        stage_ex_id = kwargs.get('pk')
        try:
            StageExecution(stage_execution_id=stage_ex_id).delete()
