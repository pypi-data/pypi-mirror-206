...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2940, _2941, _2848
...
class StraightBevelGearSetCompoundSystemDeflection(_2848.BevelGearSetCompoundSystemDeflection):
    """StraightBevelGearSetCompoundSystemDeflection
    ...
    class _Cast_StraightBevelGearSetCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'StraightBevelGearSetCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_set_compound_system_deflection(self) -> 'StraightBevelGearSetCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2796.StraightBevelGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_compound_system_deflection(self) -> 'List[_2940.StraightBevelGearCompoundSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_compound_system_deflection(self) -> 'List[_2941.StraightBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2796.StraightBevelGearSetSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSetCompoundSystemDeflection._Cast_StraightBevelGearSetCompoundSystemDeflection':
