...
class PartToPartShearCouplingHalfModalAnalysisAtASpeed(_5127.CouplingHalfModalAnalysisAtASpeed):
    """PartToPartShearCouplingHalfModalAnalysisAtASpeed
    ...
    class _Cast_PartToPartShearCouplingHalfModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingHalfModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_half_modal_analysis_at_a_speed(self) -> 'PartToPartShearCouplingHalfModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingHalfModalAnalysisAtASpeed._Cast_PartToPartShearCouplingHalfModalAnalysisAtASpeed':
