...
class PlanetCarrierCompoundHarmonicAnalysis(_5923.MountableComponentCompoundHarmonicAnalysis):
    """PlanetCarrierCompoundHarmonicAnalysis
    ...
    class _Cast_PlanetCarrierCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'PlanetCarrierCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def planet_carrier_compound_harmonic_analysis(self) -> 'PlanetCarrierCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5762.PlanetCarrierHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5762.PlanetCarrierHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierCompoundHarmonicAnalysis._Cast_PlanetCarrierCompoundHarmonicAnalysis':
