...
class BevelDifferentialGearMeshCompoundPowerFlow(_4159.BevelGearMeshCompoundPowerFlow):
    """BevelDifferentialGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4020.BevelDifferentialGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4020.BevelDifferentialGearMeshPowerFlow]':
