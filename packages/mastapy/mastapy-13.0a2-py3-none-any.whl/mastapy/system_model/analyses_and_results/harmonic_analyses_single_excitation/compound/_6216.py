...
class StraightBevelPlanetGearCompoundHarmonicAnalysisOfSingleExcitation(_6210.StraightBevelDiffGearCompoundHarmonicAnalysisOfSingleExcitation):
    """StraightBevelPlanetGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_StraightBevelPlanetGearCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'StraightBevelPlanetGearCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def straight_bevel_planet_gear_compound_harmonic_analysis_of_single_excitation(self) -> 'StraightBevelPlanetGearCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6087.StraightBevelPlanetGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6087.StraightBevelPlanetGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelPlanetGearCompoundHarmonicAnalysisOfSingleExcitation._Cast_StraightBevelPlanetGearCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_StraightBevelPlanetGearCompoundHarmonicAnalysisOfSingleExcitation(self)
