...
class StraightBevelSunGearHarmonicAnalysis(_5786.StraightBevelDiffGearHarmonicAnalysis):
    """StraightBevelSunGearHarmonicAnalysis
    ...
    class _Cast_StraightBevelSunGearHarmonicAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelSunGearHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_sun_gear_harmonic_analysis(self) -> 'StraightBevelSunGearHarmonicAnalysis':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2799.StraightBevelSunGearSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'StraightBevelSunGearHarmonicAnalysis._Cast_StraightBevelSunGearHarmonicAnalysis':
