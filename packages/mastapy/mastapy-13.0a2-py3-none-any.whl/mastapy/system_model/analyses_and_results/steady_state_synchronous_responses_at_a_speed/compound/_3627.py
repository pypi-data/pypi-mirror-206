...
class BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed(_3624.BevelDifferentialGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def bevel_differential_planet_gear_compound_steady_state_synchronous_response_at_a_speed(self) -> 'BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3497.BevelDifferentialPlanetGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3497.BevelDifferentialPlanetGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed._Cast_BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed(self)
