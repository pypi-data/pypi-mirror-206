...
class PerformersApi(object):
    ...
    @validate_arguments
    def create_performer(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_performer : Annotated[WebPerformer, Field(..., description="New essence creation request.")], **kwargs) -> WebPerformer:  # noqa: E501
    ...
    @validate_arguments
    def create_performer_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_performer : Annotated[WebPerformer, Field(..., description="New essence creation request.")], **kwargs):  # noqa: E501
        """Create performer  # noqa: E501
    ...
    @validate_arguments
    def delete_performer(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_performer_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs):  # noqa: E501
        """Remove performer  # noqa: E501
    ...
    @validate_arguments
    def read_performer(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> WebPerformer:  # noqa: E501
    ...
    @validate_arguments
    def read_performer_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs):  # noqa: E501
        """Read performer  # noqa: E501
    ...
    @validate_arguments
    def read_performers_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], offset : Annotated[Optional[conint(strict=True, le=10000000, ge=0)], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[conint(strict=True, le=10000000, ge=1)], Field(description="The number of items to return.")] = None, sort_field : Annotated[Optional[TablePerformerColumnType], Field(description="Performers table column name. ")] = None, sort_direction : Annotated[Optional[StrictStr], Field(description="Sort direction.")] = None, table_performer_filter_list : Annotated[Optional[TablePerformerFilterList], Field(description="Performers filter.")] = None, **kwargs):  # noqa: E501
        """Performers list  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['table_performer_filter_list']:
    ...
    @validate_arguments
    def read_performers_geopoints(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], table_performer_filter_list : Annotated[Optional[TablePerformerFilterList], Field(description="Performers filter.")] = None, **kwargs) -> WebPerformerGeopointList:  # noqa: E501
        ...
        >>> thread = api.read_performers_geopoints(experiment_key, table_performer_filter_list, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_performers_geopoints_with_http_info(experiment_key, table_performer_filter_list, **kwargs)  # noqa: E501

    @validate_arguments
    def read_performers_geopoints_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], table_performer_filter_list : Annotated[Optional[TablePerformerFilterList], Field(description="Performers filter.")] = None, **kwargs):  # noqa: E501
        """Performer geopoints  # noqa: E501
        ...
        >>> thread = api.read_performers_geopoints_with_http_info(experiment_key, table_performer_filter_list, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def update_performer(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_performer : Annotated[WebPerformer, Field(..., description="Essence update request.")], **kwargs) -> WebPerformer:  # noqa: E501
    ...
    @validate_arguments
    def update_performer_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_performer : Annotated[WebPerformer, Field(..., description="Essence update request.")], **kwargs):  # noqa: E501
        """Update performer  # noqa: E501
