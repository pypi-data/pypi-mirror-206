...
class CellStyle (  CellStyleObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellStyle_get_Borders(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellStyle_get_Font(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellStyle_get_Interior(self.Ptr)
    ...
    def clone(self)->'CellStyle':
        ...
        intPtr = GetDllLibXls().CellStyle_clone(self.Ptr)
    ...
    def clone(self ,book)->'CellStyle':
        ...
        intPtr = GetDllLibXls().CellStyle_cloneB(self.Ptr, intPtrbook)
        ret = None if intPtr==None else CellStyle(intPtr)
        return ret
