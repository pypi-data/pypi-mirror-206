...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1125, _1119
...
class MeshedCylindricalGearFlankMicroGeometry(_0.APIBase):
    ...
    class _Cast_MeshedCylindricalGearFlankMicroGeometry:
        ...
        def __init__(self, parent: 'MeshedCylindricalGearFlankMicroGeometry'):
            self._parent = parent

        @property
        def meshed_cylindrical_gear_flank_micro_geometry(self) -> 'MeshedCylindricalGearFlankMicroGeometry':
            return self._parent
    ...
    @property
    def involute_inspection_points(self) -> 'List[_1125.TotalProfileReliefWithDeviation]':
    ...
    @property
    def profile_form_relief_points(self) -> 'List[_1119.ProfileFormReliefWithDeviation]':
    ...
    @property
    def cast_to(self) -> 'MeshedCylindricalGearFlankMicroGeometry._Cast_MeshedCylindricalGearFlankMicroGeometry':
