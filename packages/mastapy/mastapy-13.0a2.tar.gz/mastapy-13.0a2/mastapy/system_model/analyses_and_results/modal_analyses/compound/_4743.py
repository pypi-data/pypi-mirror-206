...
class CVTPulleyCompoundModalAnalysis(_4789.PulleyCompoundModalAnalysis):
    """CVTPulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4590.CVTPulleyModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4590.CVTPulleyModalAnalysis]':
