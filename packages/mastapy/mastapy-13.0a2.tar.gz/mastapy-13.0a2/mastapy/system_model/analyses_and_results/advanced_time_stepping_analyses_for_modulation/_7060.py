...
class PointLoadAdvancedTimeSteppingAnalysisForModulation(_7096.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """PointLoadAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_PointLoadAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'PointLoadAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def point_load_advanced_time_stepping_analysis_for_modulation(self) -> 'PointLoadAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PointLoadAdvancedTimeSteppingAnalysisForModulation._Cast_PointLoadAdvancedTimeSteppingAnalysisForModulation':
