...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4526, _4527, _4436
...
class StraightBevelGearSetCompoundParametricStudyTool(_4436.BevelGearSetCompoundParametricStudyTool):
    """StraightBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4399.StraightBevelGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4526.StraightBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4527.StraightBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4399.StraightBevelGearSetParametricStudyTool]':
