...
class ConceptGearMeshCompoundDynamicAnalysis(_6432.GearMeshCompoundDynamicAnalysis):
    """ConceptGearMeshCompoundDynamicAnalysis
    ...
    class _Cast_ConceptGearMeshCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'ConceptGearMeshCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_gear_mesh_compound_dynamic_analysis(self) -> 'ConceptGearMeshCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6273.ConceptGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6273.ConceptGearMeshDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ConceptGearMeshCompoundDynamicAnalysis._Cast_ConceptGearMeshCompoundDynamicAnalysis':
