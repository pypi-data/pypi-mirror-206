...
class TorqueConverterConnectionCompoundPowerFlow(_4180.CouplingConnectionCompoundPowerFlow):
    """TorqueConverterConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4130.TorqueConverterConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4130.TorqueConverterConnectionPowerFlow]':
