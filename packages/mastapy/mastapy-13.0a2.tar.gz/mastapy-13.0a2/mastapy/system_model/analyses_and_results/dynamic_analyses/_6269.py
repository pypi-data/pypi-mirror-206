...
class ConceptCouplingConnectionDynamicAnalysis(_6280.CouplingConnectionDynamicAnalysis):
    """ConceptCouplingConnectionDynamicAnalysis
    ...
    class _Cast_ConceptCouplingConnectionDynamicAnalysis:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_dynamic_analysis(self) -> 'ConceptCouplingConnectionDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionDynamicAnalysis._Cast_ConceptCouplingConnectionDynamicAnalysis':
