...
class KlingelnbergCycloPalloidHypoidGearDynamicAnalysis(_6310.KlingelnbergCycloPalloidConicalGearDynamicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearDynamicAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearDynamicAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_dynamic_analysis(self) -> 'KlingelnbergCycloPalloidHypoidGearDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearDynamicAnalysis._Cast_KlingelnbergCycloPalloidHypoidGearDynamicAnalysis':
