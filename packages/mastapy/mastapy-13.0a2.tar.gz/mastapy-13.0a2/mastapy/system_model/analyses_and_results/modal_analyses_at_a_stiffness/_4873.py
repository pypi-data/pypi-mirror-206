...
class CycloidalAssemblyModalAnalysisAtAStiffness(_4929.SpecialisedAssemblyModalAnalysisAtAStiffness):
    """CycloidalAssemblyModalAnalysisAtAStiffness
    ...
    class _Cast_CycloidalAssemblyModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'CycloidalAssemblyModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def cycloidal_assembly_modal_analysis_at_a_stiffness(self) -> 'CycloidalAssemblyModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalAssemblyModalAnalysisAtAStiffness._Cast_CycloidalAssemblyModalAnalysisAtAStiffness':
