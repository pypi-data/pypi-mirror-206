...
class SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness(_4977.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_compound_modal_analysis_at_a_stiffness(self) -> 'SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4930.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4930.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness._Cast_SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness':
