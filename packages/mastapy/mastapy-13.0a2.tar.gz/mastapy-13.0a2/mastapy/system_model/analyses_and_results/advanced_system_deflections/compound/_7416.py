...
class CylindricalGearMeshCompoundAdvancedSystemDeflection(_7427.GearMeshCompoundAdvancedSystemDeflection):
    """CylindricalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7284.CylindricalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7284.CylindricalGearMeshAdvancedSystemDeflection]':
