...
class AutoFiltersCollection (  XlsAutoFiltersCollection) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().AutoFiltersCollection_get_Worksheet(self.Ptr)
    ...
    #    intPtr = GetDllLibXls().AutoFiltersCollection_get_Item(self.Ptr, columnIndex)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().AutoFiltersCollection_get_Range(self.Ptr)
    ...
    def Range(self, value:'CellRange'):
        ...
        GetDllLibXls().AutoFiltersCollection_set_Range(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().AutoFiltersCollection_Filter(self.Ptr)
    ...
    <returns>Returns all hidden rows indexes. </returns>
        ...
        intPtrArray = GetDllLibXls().AutoFiltersCollection_FilterH(self.Ptr, hideRows)
    ...
    <param name="criteria">The specified criteria (a string; for example, "hello"). 
        ...
        GetDllLibXls().AutoFiltersCollection_AddFilter(self.Ptr, columnIndex,criteria)
    ...
    def AddFilter(self ,column:IAutoFilter,criteria:str):
        ...
        GetDllLibXls().AutoFiltersCollection_AddFilterCC(self.Ptr, intPtrcolumn,criteria)
...
<remarks>
        ...
        GetDllLibXls().AutoFiltersCollection_AddDateFilter(self.Ptr, columnIndex,enumdateTimeGroupingType,year,month,day,hour,minute,second)
...
<remarks>
        ...
        GetDllLibXls().AutoFiltersCollection_RemoveDateFilter(self.Ptr, columnIndex,enumdateTimeGroupingType,year,month,day,hour,minute,second)
    ...
    <param name="criteria">The specified criteria (a string; for example, "hello"). 
        ...
        GetDllLibXls().AutoFiltersCollection_RemoveFilter(self.Ptr, columnIndex,criteria)
...
<remarks>
        ...
        GetDllLibXls().AutoFiltersCollection_QuickFilter(self.Ptr, columnIndex,criteria)
    ...
    def QuickFilter(self ,column:IAutoFilter,criteria:str):
        ...
        GetDllLibXls().AutoFiltersCollection_QuickFilterCC(self.Ptr, intPtrcolumn,criteria)
    ...
    <param name="dynamicFilterType">Dynamic filter type.</param>
        ...
        GetDllLibXls().AutoFiltersCollection_DynamicFilter(self.Ptr, columnIndex,enumdynamicFilterType)
    ...
    <param name="color">Font Color.</param>
        ...
        GetDllLibXls().AutoFiltersCollection_AddFontColorFilter(self.Ptr, columnIndex,intPtrcolor)
    ...
    <param name="backgroundColor">The background color.</param>
        ...
        GetDllLibXls().AutoFiltersCollection_AddFillColorFilter(self.Ptr, columnIndex,enumpattern,intPtrforeColor,intPtrbackColor)
    ...
    <param name="color">Fill Color.</param>
        ...
        GetDllLibXls().AutoFiltersCollection_AddFillColorFilterFC(self.Ptr, filterColumnIndex,intPtrcolor)
    ...
    def AddFillColorFilter(self ,column:IAutoFilter,color:Color):
        ...
        GetDllLibXls().AutoFiltersCollection_AddFillColorFilterCC(self.Ptr, intPtrcolumn,intPtrcolor)
    ...
    def AddFontColorFilter(self ,column:IAutoFilter,color:Color):
        ...
        GetDllLibXls().AutoFiltersCollection_AddFontColorFilterCC(self.Ptr, intPtrcolumn,intPtrcolor)
    ...
    def AddIconFilter(self ,columnIndex:int,iconSetType:'IconSetType',iconId:int):
        ...
        GetDllLibXls().AutoFiltersCollection_AddIconFilter(self.Ptr, columnIndex,enumiconSetType,iconId)
    ...
    <param name="column">The column field on which you want to base the filter . for exapmle: sheet.AutoFilters[0]</param>
        ...
        GetDllLibXls().AutoFiltersCollection_MatchBlanks(self.Ptr, columnIndex)
    ...
    <param name="column">The column field on which you want to base the filter . for exapmle: sheet.AutoFilters[0]</param>
        ...
        GetDllLibXls().AutoFiltersCollection_MatchBlanksC(self.Ptr, intPtrcolumn)
    ...
    <param name="criteria">The custom criteria</param>
        ...
        GetDllLibXls().AutoFiltersCollection_CustomFilter(self.Ptr, columnIndex,enumoperatorType,intPtrcriteria)
    ...
    <param name="criteria2">The second custom criteria</param>
        ...
        GetDllLibXls().AutoFiltersCollection_CustomFilterCOCIOC(self.Ptr, columnIndex,enumoperatorType1,intPtrcriteria1,isAnd,enumoperatorType2,intPtrcriteria2)
    ...
    def CustomFilter(self ,column:FilterColumn,operatorType:FilterOperatorType,criteria:SpireObject):
        ...
        GetDllLibXls().AutoFiltersCollection_CustomFilterCOC(self.Ptr, intPtrcolumn,enumoperatorType,intPtrcriteria)
    ...
    def CustomFilter(self ,column:FilterColumn,operatorType1:FilterOperatorType,criteria1:SpireObject,isAnd:bool,operatorType2:FilterOperatorType,criteria2:SpireObject):
        ...
        GetDllLibXls().AutoFiltersCollection_CustomFilterCOCIOC1(self.Ptr, intPtrcolumn,enumoperatorType1,intPtrcriteria1,isAnd,enumoperatorType2,intPtrcriteria2)
    ...
    def DynamicFilter(self ,column:IAutoFilter,dynamicFilterType:DynamicFilterType):
        ...
        GetDllLibXls().AutoFiltersCollection_DynamicFilterCD(self.Ptr, intPtrcolumn,enumdynamicFilterType)
    ...
    <param name="columName">column name</param>
        ...
        GetDllLibXls().AutoFiltersCollection_ClearFilter(self.Ptr, columnName)
    ...
    <param name="columName">column index</param>
        ...
        GetDllLibXls().AutoFiltersCollection_ClearFilterF(self.Ptr, filterColumnIndex)
    ...
    def AddDateFilter(self ,column:IAutoFilter,dateTimeGroupingType:DateTimeGroupingType,year:int,month:int,day:int,hour:int,minute:int,second:int):
        ...
        GetDllLibXls().AutoFiltersCollection_AddDateFilterCDYMDHMS(self.Ptr, intPtrcolumn,enumdateTimeGroupingType,year,month,day,hour,minute,second)
    ...
    <param name="itemCount">The item count</param>
        ...
        GetDllLibXls().AutoFiltersCollection_FilterTop10(self.Ptr, filterColumnIndex,isTop,isPercent,itemCount)
    ...
    <param name="itemCount">The item count</param>
        ...
        GetDllLibXls().AutoFiltersCollection_FilterTop10CIII(self.Ptr, intPtrcolumn,isTop,isPercent,itemCount)
    ...
    <param name="filterColumnIndex">The column field index on which you want to base the filter (from the left of the list; the leftmost field is field 0).</param>
        ...
        GetDllLibXls().AutoFiltersCollection_MatchNonBlanks(self.Ptr, filterColumnIndex)
    ...
    <param name="column">The column field on which you want to base the filter . for exapmle: sheet.AutoFilters[0]</param>
        ...
        GetDllLibXls().AutoFiltersCollection_MatchNonBlanksC(self.Ptr, intPtrcolumn)
    ...
    def Clear(self):
        ...
        GetDllLibXls().AutoFiltersCollection_Clear(self.Ptr)
