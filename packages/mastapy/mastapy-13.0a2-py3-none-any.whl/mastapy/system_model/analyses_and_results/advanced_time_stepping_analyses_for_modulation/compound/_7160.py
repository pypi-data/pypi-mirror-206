...
class FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_7201.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def flexible_pin_assembly_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7030.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7030.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_FlexiblePinAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(self)
