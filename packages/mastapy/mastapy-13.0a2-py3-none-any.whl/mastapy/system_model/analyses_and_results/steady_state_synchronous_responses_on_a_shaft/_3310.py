...
class PointLoadSteadyStateSynchronousResponseOnAShaft(_3347.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    """PointLoadSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_PointLoadSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'PointLoadSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def point_load_steady_state_synchronous_response_on_a_shaft(self) -> 'PointLoadSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PointLoadSteadyStateSynchronousResponseOnAShaft._Cast_PointLoadSteadyStateSynchronousResponseOnAShaft':
