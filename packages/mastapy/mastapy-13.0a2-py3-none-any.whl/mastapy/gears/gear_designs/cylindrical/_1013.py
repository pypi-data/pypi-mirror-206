...
from mastapy.gears import _314, _331
from mastapy._internal.implicit import overridable, enum_with_selected_value
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.gears.gear_designs.cylindrical import (
    _1022, _1081, _994, _1023,
    _1014, _1007, _1032
)
...
class CylindricalGearMeshDesign(_944.GearMeshDesign):
    """CylindricalGearMeshDesign
    ...
    class _Cast_CylindricalGearMeshDesign:
        ...
        def __init__(self, parent: 'CylindricalGearMeshDesign'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_design(self) -> 'CylindricalGearMeshDesign':
            return self._parent
    ...
    @property
    def centre_distance_change_method(self) -> '_314.CentreDistanceChangeMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _314.CentreDistanceChangeMethod)
        return constructor.new_from_mastapy_type(_314.CentreDistanceChangeMethod)(value) if value is not None else None

    @centre_distance_change_method.setter
    def centre_distance_change_method(self, value: '_314.CentreDistanceChangeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _314.CentreDistanceChangeMethod.type_())
    ...
    @property
    def profile_modification(self) -> '_1022.CylindricalGearProfileModifications':
        ...
        value = conversion.pn_to_mp_enum(temp, _1022.CylindricalGearProfileModifications)
        return constructor.new_from_mastapy_type(_1022.CylindricalGearProfileModifications)(value) if value is not None else None

    @profile_modification.setter
    def profile_modification(self, value: '_1022.CylindricalGearProfileModifications'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1022.CylindricalGearProfileModifications.type_())
    ...
    @property
    def type_of_mechanism_housing(self) -> '_1081.TypeOfMechanismHousing':
        ...
        value = conversion.pn_to_mp_enum(temp, _1081.TypeOfMechanismHousing)
        return constructor.new_from_mastapy_type(_1081.TypeOfMechanismHousing)(value) if value is not None else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_1081.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1081.TypeOfMechanismHousing.type_())
    ...
    @property
    def valid_normal_module_range(self) -> '_1477.Range':
        """Range: 'ValidNormalModuleRange' is the original name of this property.
    ...
    @property
    def backlash_specification(self) -> '_994.BacklashSpecification':
    ...
    @property
    def left_flank(self) -> '_1014.CylindricalGearMeshFlankDesign':
    ...
    @property
    def right_flank(self) -> '_1014.CylindricalGearMeshFlankDesign':
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_1032.CylindricalMeshedGear]':
    ...
    @property
    def flanks(self) -> 'List[_1014.CylindricalGearMeshFlankDesign]':
    ...
    @property
    def both_flanks(self) -> '_1014.CylindricalGearMeshFlankDesign':
    ...
    @property
    def gear_a(self) -> '_1007.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_1007.CylindricalGearDesign':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshDesign._Cast_CylindricalGearMeshDesign':
