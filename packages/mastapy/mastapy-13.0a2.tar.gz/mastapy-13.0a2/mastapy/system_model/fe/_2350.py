...
class CreateConnectedComponentOptions(_0.APIBase):
    ...
    class _Cast_CreateConnectedComponentOptions:
        ...
        def __init__(self, parent: 'CreateConnectedComponentOptions'):
            self._parent = parent

        @property
        def create_connected_component_options(self) -> 'CreateConnectedComponentOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CreateConnectedComponentOptions._Cast_CreateConnectedComponentOptions':
