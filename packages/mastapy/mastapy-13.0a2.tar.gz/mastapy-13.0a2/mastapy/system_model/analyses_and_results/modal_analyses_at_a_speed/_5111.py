...
class ClutchHalfModalAnalysisAtASpeed(_5127.CouplingHalfModalAnalysisAtASpeed):
    """ClutchHalfModalAnalysisAtASpeed
    ...
    class _Cast_ClutchHalfModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ClutchHalfModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def clutch_half_modal_analysis_at_a_speed(self) -> 'ClutchHalfModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchHalfModalAnalysisAtASpeed._Cast_ClutchHalfModalAnalysisAtASpeed':
