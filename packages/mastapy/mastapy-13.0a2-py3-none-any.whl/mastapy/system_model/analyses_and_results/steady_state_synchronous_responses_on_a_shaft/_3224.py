...
class AbstractAssemblySteadyStateSynchronousResponseOnAShaft(_3303.PartSteadyStateSynchronousResponseOnAShaft):
    """AbstractAssemblySteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_AbstractAssemblySteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'AbstractAssemblySteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def abstract_assembly_steady_state_synchronous_response_on_a_shaft(self) -> 'AbstractAssemblySteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AbstractAssemblySteadyStateSynchronousResponseOnAShaft._Cast_AbstractAssemblySteadyStateSynchronousResponseOnAShaft':
