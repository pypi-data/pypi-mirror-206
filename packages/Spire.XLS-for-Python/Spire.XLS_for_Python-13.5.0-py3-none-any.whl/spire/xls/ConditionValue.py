...
class ConditionValue (  SpireObject,IConditionValue) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().ConditionValue_get_Type(self.Ptr)
    ...
    def Type(self, value:'ConditionValueType'):
        ...
        GetDllLibXls().ConditionValue_set_Type(self.Ptr, value.value)
    ...
    def IsGTE(self)->bool:
        ...
        ret = GetDllLibXls().ConditionValue_get_IsGTE(self.Ptr)
        return ret

    @IsGTE.setter
    def IsGTE(self, value:bool):
        GetDllLibXls().ConditionValue_set_IsGTE.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ConditionValue_set_IsGTE(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ConditionValue_get_Value(self.Ptr)
    ...
    def Value(self, value:'SpireObject'):
        ...
        GetDllLibXls().ConditionValue_set_Value(self.Ptr, value.Ptr)
    ...
    def m_condtionValue(self)->'IConditionValue':
        ...
        intPtr = GetDllLibXls().ConditionValue_m_condtionValue(self.Ptr)
