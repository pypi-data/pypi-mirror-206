...
class BevelGearCompoundStabilityAnalysis(_3878.AGMAGleasonConicalGearCompoundStabilityAnalysis):
    """BevelGearCompoundStabilityAnalysis
    ...
    class _Cast_BevelGearCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'BevelGearCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_gear_compound_stability_analysis(self) -> 'BevelGearCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3760.BevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3760.BevelGearStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BevelGearCompoundStabilityAnalysis._Cast_BevelGearCompoundStabilityAnalysis':
