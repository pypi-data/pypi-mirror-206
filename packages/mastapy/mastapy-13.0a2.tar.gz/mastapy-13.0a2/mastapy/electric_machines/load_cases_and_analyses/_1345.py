...
class ElectricMachineLoadCase(_1346.ElectricMachineLoadCaseBase):
    """ElectricMachineLoadCase
    ...
    class _Cast_ElectricMachineLoadCase:
        ...
        def speed_torque_load_case(self):
            ...
            return self._parent._cast(_1363.SpeedTorqueLoadCase)
    ...
    def include_winding_ac_losses(self, value: 'bool'):
        self.wrapped.IncludeWindingACLosses = bool(value) if value else False
    ...
    @property
    def motoring_or_generating(self) -> '_1353.MotoringOrGenerating':
        ...
        value = conversion.pn_to_mp_enum(temp, _1353.MotoringOrGenerating)
        return constructor.new_from_mastapy_type(_1353.MotoringOrGenerating)(value) if value is not None else None

    @motoring_or_generating.setter
    def motoring_or_generating(self, value: '_1353.MotoringOrGenerating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1353.MotoringOrGenerating.type_())
    ...
    def non_linear_system_convergence_tolerance(self, value: 'float'):
        self.wrapped.NonLinearSystemConvergenceTolerance = float(value) if value else 0.0
    ...
    def number_of_initial_transient_steps(self, value: 'int'):
        self.wrapped.NumberOfInitialTransientSteps = int(value) if value else 0
    ...
    def analysis_for(self, setup: '_1259.ElectricMachineSetup') -> '_1343.ElectricMachineFEAnalysis':
