...
from mastapy.electric_machines.load_cases_and_analyses import _1345, _1358, _1339
...
class SingleOperatingPointAnalysis(_1339.ElectricMachineAnalysis):
    """SingleOperatingPointAnalysis
    ...
    @property
    def electric_machine_results(self) -> '_1319.ElectricMachineResultsForOpenCircuitAndOnLoad':
    ...
    @property
    def load_case(self) -> '_1345.ElectricMachineLoadCase':
    ...
    @property
    def slot_section_details_for_analysis(self) -> 'List[_1358.SlotDetailForAnalysis]':
