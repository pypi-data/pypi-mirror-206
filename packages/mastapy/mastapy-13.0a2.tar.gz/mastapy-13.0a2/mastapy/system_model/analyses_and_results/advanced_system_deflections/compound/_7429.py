...
class GuideDxfModelCompoundAdvancedSystemDeflection(_7393.ComponentCompoundAdvancedSystemDeflection):
    """GuideDxfModelCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7298.GuideDxfModelAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7298.GuideDxfModelAdvancedSystemDeflection]':
