...
class ClutchConnectionCompoundStabilityAnalysis(_3912.CouplingConnectionCompoundStabilityAnalysis):
    """ClutchConnectionCompoundStabilityAnalysis
    ...
    class _Cast_ClutchConnectionCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'ClutchConnectionCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_connection_compound_stability_analysis(self) -> 'ClutchConnectionCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3763.ClutchConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3763.ClutchConnectionStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ClutchConnectionCompoundStabilityAnalysis._Cast_ClutchConnectionCompoundStabilityAnalysis':
