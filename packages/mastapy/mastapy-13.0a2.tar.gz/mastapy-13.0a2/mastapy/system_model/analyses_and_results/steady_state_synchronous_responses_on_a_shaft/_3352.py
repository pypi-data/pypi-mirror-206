...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3353, _3351, _3241
...
class ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft(_3241.BevelGearSetSteadyStateSynchronousResponseOnAShaft):
    """ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_steady_state_synchronous_response_on_a_shaft(self) -> 'ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def zerol_bevel_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3353.ZerolBevelGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def zerol_bevel_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3351.ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft._Cast_ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft':
