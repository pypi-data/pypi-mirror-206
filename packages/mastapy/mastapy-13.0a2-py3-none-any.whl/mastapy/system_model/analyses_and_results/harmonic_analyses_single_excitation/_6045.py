...
class KlingelnbergCycloPalloidHypoidGearHarmonicAnalysisOfSingleExcitation(_6042.KlingelnbergCycloPalloidConicalGearHarmonicAnalysisOfSingleExcitation):
    """KlingelnbergCycloPalloidHypoidGearHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_harmonic_analysis_of_single_excitation(self) -> 'KlingelnbergCycloPalloidHypoidGearHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearHarmonicAnalysisOfSingleExcitation._Cast_KlingelnbergCycloPalloidHypoidGearHarmonicAnalysisOfSingleExcitation':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearHarmonicAnalysisOfSingleExcitation(self)
