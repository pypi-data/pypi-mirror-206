...
class ExternalCADModelPowerFlow(_4034.ComponentPowerFlow):
    """ExternalCADModelPowerFlow
    ...
    class _Cast_ExternalCADModelPowerFlow:
        ...
        def __init__(self, parent: 'ExternalCADModelPowerFlow'):
            self._parent = parent
        ...
        @property
        def external_cad_model_power_flow(self) -> 'ExternalCADModelPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ExternalCADModelPowerFlow._Cast_ExternalCADModelPowerFlow':
