...
class BeltConnectionCompoundMultibodyDynamicsAnalysis(_5564.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """BeltConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5358.BeltConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5358.BeltConnectionMultibodyDynamicsAnalysis]':
