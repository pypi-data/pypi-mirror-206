...
class BoltCompoundMultibodyDynamicsAnalysis(_5524.ComponentCompoundMultibodyDynamicsAnalysis):
    """BoltCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_BoltCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'BoltCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def bolt_compound_multibody_dynamics_analysis(self) -> 'BoltCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5369.BoltMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5369.BoltMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BoltCompoundMultibodyDynamicsAnalysis._Cast_BoltCompoundMultibodyDynamicsAnalysis':
