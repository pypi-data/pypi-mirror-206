...
class AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed(_5124.ConnectionModalAnalysisAtASpeed):
    """AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed
    ...
    class _Cast_AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def abstract_shaft_to_mountable_component_connection_modal_analysis_at_a_speed(self) -> 'AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed._Cast_AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed':
        return self._Cast_AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed(self)
