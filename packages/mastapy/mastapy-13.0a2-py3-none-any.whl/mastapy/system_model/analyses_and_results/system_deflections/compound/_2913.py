...
class PartToPartShearCouplingHalfCompoundSystemDeflection(_2869.CouplingHalfCompoundSystemDeflection):
    """PartToPartShearCouplingHalfCompoundSystemDeflection
    ...
    class _Cast_PartToPartShearCouplingHalfCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingHalfCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_half_compound_system_deflection(self) -> 'PartToPartShearCouplingHalfCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2766.PartToPartShearCouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2766.PartToPartShearCouplingHalfSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingHalfCompoundSystemDeflection._Cast_PartToPartShearCouplingHalfCompoundSystemDeflection':
