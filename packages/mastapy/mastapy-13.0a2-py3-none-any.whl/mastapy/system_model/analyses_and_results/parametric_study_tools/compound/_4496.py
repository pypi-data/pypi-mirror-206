...
class OilSealCompoundParametricStudyTool(_4454.ConnectorCompoundParametricStudyTool):
    """OilSealCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4357.OilSealParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4357.OilSealParametricStudyTool]':
