...
class TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation(_7012.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def torque_converter_pump_advanced_time_stepping_analysis_for_modulation(self) -> 'TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2808.TorqueConverterPumpSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation._Cast_TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation(self)
