...
class ConnectionStaticLoadAnalysisCase(_7500.ConnectionAnalysisCase):
    """ConnectionStaticLoadAnalysisCase
    ...
    class _Cast_ConnectionStaticLoadAnalysisCase:
        ...
        def __init__(self, parent: 'ConnectionStaticLoadAnalysisCase'):
            self._parent = parent
        ...
        @property
        def connection_static_load_analysis_case(self) -> 'ConnectionStaticLoadAnalysisCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConnectionStaticLoadAnalysisCase._Cast_ConnectionStaticLoadAnalysisCase':
