...
class CoaxialConnectionPowerFlow(_4109.ShaftToMountableComponentConnectionPowerFlow):
    """CoaxialConnectionPowerFlow
    ...
    class _Cast_CoaxialConnectionPowerFlow:
        ...
        def __init__(self, parent: 'CoaxialConnectionPowerFlow'):
            self._parent = parent
        ...
        @property
        def coaxial_connection_power_flow(self) -> 'CoaxialConnectionPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CoaxialConnectionPowerFlow._Cast_CoaxialConnectionPowerFlow':
