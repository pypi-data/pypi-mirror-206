...
class BoltPowerFlow(_4034.ComponentPowerFlow):
    """BoltPowerFlow
    ...
    class _Cast_BoltPowerFlow:
        ...
        def __init__(self, parent: 'BoltPowerFlow'):
            self._parent = parent
        ...
        @property
        def bolt_power_flow(self) -> 'BoltPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltPowerFlow._Cast_BoltPowerFlow':
