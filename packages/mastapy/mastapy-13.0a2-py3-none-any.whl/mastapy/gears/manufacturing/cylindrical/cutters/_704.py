...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _720, _725
...
class CylindricalGearHobDesign(_707.CylindricalGearRackDesign):
    """CylindricalGearHobDesign
    ...
    @property
    def hob_edge_type(self) -> '_626.HobEdgeTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, _626.HobEdgeTypes)
        return constructor.new_from_mastapy_type(_626.HobEdgeTypes)(value) if value is not None else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_626.HobEdgeTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _626.HobEdgeTypes.type_())
    ...
    @property
    def maximum_hob_material_shape(self) -> '_720.CylindricalGearHobShape':
    ...
    @property
    def minimum_hob_material_shape(self) -> '_720.CylindricalGearHobShape':
    ...
    @property
    def nominal_hob_shape(self) -> '_720.CylindricalGearHobShape':
