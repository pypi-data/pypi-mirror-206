...
"""
from mastapy.bearings.bearing_results.rolling import _1982, _1980
...
class LoadedAxialThrustNeedleRollerBearingRow(_1980.LoadedAxialThrustCylindricalRollerBearingRow):
    """LoadedAxialThrustNeedleRollerBearingRow
    ...
    class _Cast_LoadedAxialThrustNeedleRollerBearingRow:
        ...
        def __init__(self, parent: 'LoadedAxialThrustNeedleRollerBearingRow'):
            self._parent = parent
        ...
        @property
        def loaded_axial_thrust_needle_roller_bearing_row(self) -> 'LoadedAxialThrustNeedleRollerBearingRow':
            return self._parent
    ...
    @property
    def loaded_bearing(self) -> '_1982.LoadedAxialThrustNeedleRollerBearingResults':
    ...
    @property
    def cast_to(self) -> 'LoadedAxialThrustNeedleRollerBearingRow._Cast_LoadedAxialThrustNeedleRollerBearingRow':
