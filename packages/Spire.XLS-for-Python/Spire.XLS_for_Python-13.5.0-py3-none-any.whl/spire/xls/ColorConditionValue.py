...
class ColorConditionValue (  XlsConditionValue) :
    ...
    def FormatColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().ColorConditionValue_get_FormatColor(self.Ptr)
    ...
    def FormatColor(self, value:'Color'):
        ...
        GetDllLibXls().ColorConditionValue_set_FormatColor(self.Ptr, value.Ptr)
    ...
    def IsGTE(self)->bool:
        ...
        ret = GetDllLibXls().ColorConditionValue_get_IsGTE(self.Ptr)
        return ret

    @IsGTE.setter
    def IsGTE(self, value:bool):
        GetDllLibXls().ColorConditionValue_set_IsGTE.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ColorConditionValue_set_IsGTE(self.Ptr, value)
    ...
    def Position(self)->'ConditionValuePosition':
        ...
        ret = GetDllLibXls().ColorConditionValue_get_Position(self.Ptr)
    ...
    def Type(self)->'ConditionValueType':
        ...
        ret = GetDllLibXls().ColorConditionValue_get_Type(self.Ptr)
    ...
    def Type(self, value:'ConditionValueType'):
        ...
        GetDllLibXls().ColorConditionValue_set_Type(self.Ptr, value.value)
    ...
    def Value(self)->str:
        ...
        GetDllLibXls().ColorConditionValue_get_Value.restype=c_wchar_p
        ret = GetDllLibXls().ColorConditionValue_get_Value(self.Ptr)
        return ret
    ...
    def Value(self, value:str):
        ...
        GetDllLibXls().ColorConditionValue_set_Value(self.Ptr, value)
