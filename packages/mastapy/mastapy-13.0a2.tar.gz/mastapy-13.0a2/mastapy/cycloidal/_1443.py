...
from mastapy.cycloidal import _1448
...
class CycloidalDiscDesignExporter(_0.APIBase):
    ...
    class _Cast_CycloidalDiscDesignExporter:
        ...
        def __init__(self, parent: 'CycloidalDiscDesignExporter'):
            self._parent = parent

        @property
        def cycloidal_disc_design_exporter(self) -> 'CycloidalDiscDesignExporter':
            return self._parent
    ...
    @property
    def geometry_to_export(self) -> '_1448.GeometryToExport':
        ...
        value = conversion.pn_to_mp_enum(temp, _1448.GeometryToExport)
        return constructor.new_from_mastapy_type(_1448.GeometryToExport)(value) if value is not None else None

    @geometry_to_export.setter
    def geometry_to_export(self, value: '_1448.GeometryToExport'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1448.GeometryToExport.type_())
    ...
    def include_modifications(self, value: 'bool'):
        self.wrapped.IncludeModifications = bool(value) if value else False
    ...
    def number_of_half_lobe_points_for_export(self, value: 'int'):
        self.wrapped.NumberOfHalfLobePointsForExport = int(value) if value else 0
    ...
    def profile_points(self, geometry_to_export: '_1448.GeometryToExport', include_modifications_in_export: 'bool', number_of_half_lobe_points_for_export: 'int') -> 'List[Vector2D]':
        ...
        geometry_to_export = conversion.mp_to_pn_enum(geometry_to_export, _1448.GeometryToExport.type_())
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.ProfilePoints(geometry_to_export, include_modifications_in_export if include_modifications_in_export else False, number_of_half_lobe_points_for_export if number_of_half_lobe_points_for_export else 0))
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscDesignExporter._Cast_CycloidalDiscDesignExporter':
