...
Example: ["user1@example.com","user2@example.com"]"""
    ...
    r""" The name of the transport protocol used to deliver AutoSupport messages. Note: Support for 'http' transport has been deprecated and is no longer supported by AutoSupport servers.
    ...
    if RECLINE_INSTALLED:
        ...
        def autosupport_show(
            ...
            Args:
                ...
                transport: The name of the transport protocol used to deliver AutoSupport messages. Note: Support for 'http' transport has been deprecated and is no longer supported by AutoSupport servers. 
            """
    ...
    if RECLINE_INSTALLED:
        ...
        async def autosupport_modify(
            ...
            Args:
                ...
                transport: The name of the transport protocol used to deliver AutoSupport messages. Note: Support for 'http' transport has been deprecated and is no longer supported by AutoSupport servers. 
                query_transport: The name of the transport protocol used to deliver AutoSupport messages. Note: Support for 'http' transport has been deprecated and is no longer supported by AutoSupport servers. 
            """
