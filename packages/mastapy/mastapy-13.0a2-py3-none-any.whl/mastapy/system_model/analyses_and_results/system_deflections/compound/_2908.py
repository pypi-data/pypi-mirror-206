...
class MountableComponentCompoundSystemDeflection(_2855.ComponentCompoundSystemDeflection):
    """MountableComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2761.MountableComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2761.MountableComponentSystemDeflection]':
