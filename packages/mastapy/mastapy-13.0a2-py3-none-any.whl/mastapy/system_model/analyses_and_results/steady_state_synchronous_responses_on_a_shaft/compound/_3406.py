...
class ExternalCADModelCompoundSteadyStateSynchronousResponseOnAShaft(_3379.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """ExternalCADModelCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_ExternalCADModelCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'ExternalCADModelCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def external_cad_model_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'ExternalCADModelCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3276.ExternalCADModelSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3276.ExternalCADModelSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'ExternalCADModelCompoundSteadyStateSynchronousResponseOnAShaft._Cast_ExternalCADModelCompoundSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_ExternalCADModelCompoundSteadyStateSynchronousResponseOnAShaft(self)
