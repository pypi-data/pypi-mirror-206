...
class CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtASpeed(_5092.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed):
    """CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtASpeed
    ...
    class _Cast_CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_planetary_bearing_connection_modal_analysis_at_a_speed(self) -> 'CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtASpeed._Cast_CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtASpeed':
        return self._Cast_CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtASpeed(self)
