...
class MassDiscModalAnalysisAtASpeed(_5211.VirtualComponentModalAnalysisAtASpeed):
    """MassDiscModalAnalysisAtASpeed
    ...
    class _Cast_MassDiscModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'MassDiscModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def mass_disc_modal_analysis_at_a_speed(self) -> 'MassDiscModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MassDiscModalAnalysisAtASpeed._Cast_MassDiscModalAnalysisAtASpeed':
