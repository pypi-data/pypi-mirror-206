...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5461, _5460, _5367
...
class SpiralBevelGearSetMultibodyDynamicsAnalysis(_5367.BevelGearSetMultibodyDynamicsAnalysis):
    """SpiralBevelGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5461.SpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_gears_multibody_dynamics_analysis(self) -> 'List[_5461.SpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_multibody_dynamics_analysis(self) -> 'List[_5460.SpiralBevelGearMeshMultibodyDynamicsAnalysis]':
