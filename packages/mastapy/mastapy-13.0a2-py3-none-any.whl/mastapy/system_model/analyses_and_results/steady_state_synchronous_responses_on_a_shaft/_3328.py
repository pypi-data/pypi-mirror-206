...
class SpringDamperSteadyStateSynchronousResponseOnAShaft(_3263.CouplingSteadyStateSynchronousResponseOnAShaft):
    """SpringDamperSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_SpringDamperSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'SpringDamperSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def spring_damper_steady_state_synchronous_response_on_a_shaft(self) -> 'SpringDamperSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperSteadyStateSynchronousResponseOnAShaft._Cast_SpringDamperSteadyStateSynchronousResponseOnAShaft':
