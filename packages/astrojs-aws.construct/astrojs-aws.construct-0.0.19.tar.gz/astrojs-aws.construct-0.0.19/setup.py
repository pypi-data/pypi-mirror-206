    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-apigatewayv2-alpha>=2.77.0.a0, <3.0.0",
        "aws-cdk.aws-apigatewayv2-integrations-alpha>=2.77.0.a0, <3.0.0",
        "constructs>=10.2.14, <11.0.0",
        "jsii>=1.80.0, <2.0.0",
        "publication>=0.0.3",
        "typeguard~=2.13.3"
    ],
