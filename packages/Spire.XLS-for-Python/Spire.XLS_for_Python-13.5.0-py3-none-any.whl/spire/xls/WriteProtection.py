...
class WriteProtection (SpireObject) :
    ...
    <summary>
        ...
        GetDllLibXls().WriteProtection_get_Author.restype=c_wchar_p
        ret = GetDllLibXls().WriteProtection_get_Author(self.Ptr)
        return ret
    ...
    def Author(self, value:str):
        ...
        GetDllLibXls().WriteProtection_set_Author(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().WriteProtection_get_IsWriteProtected(self.Ptr)
        return ret

    def SetPassword(self, value:str):
        GetDllLibXls().WriteProtection_set_Password.argtypes=[c_void_p, c_wchar_p]
        GetDllLibXls().WriteProtection_set_Password(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().WriteProtection_get_RecommendReadOnly(self.Ptr)
        return ret
    ...
    def RecommendReadOnly(self, value:bool):
        ...
        GetDllLibXls().WriteProtection_set_RecommendReadOnly(self.Ptr, value)
