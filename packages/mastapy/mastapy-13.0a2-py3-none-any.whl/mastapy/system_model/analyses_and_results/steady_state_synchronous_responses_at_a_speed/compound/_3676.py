...
class HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_3618.AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    """HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_mesh_compound_steady_state_synchronous_response_at_a_speed(self) -> 'HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3545.HypoidGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3545.HypoidGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed._Cast_HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(self)
