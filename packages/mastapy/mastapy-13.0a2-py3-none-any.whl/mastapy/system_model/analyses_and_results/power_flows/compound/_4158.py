...
class BevelGearCompoundPowerFlow(_4146.AGMAGleasonConicalGearCompoundPowerFlow):
    """BevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4026.BevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4026.BevelGearPowerFlow]':
