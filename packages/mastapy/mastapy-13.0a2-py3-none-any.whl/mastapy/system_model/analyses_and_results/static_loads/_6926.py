...
class StraightBevelGearLoadCase(_6792.BevelGearLoadCase):
    """StraightBevelGearLoadCase
    ...
    class _Cast_StraightBevelGearLoadCase:
        ...
        def __init__(self, parent: 'StraightBevelGearLoadCase'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_load_case(self) -> 'StraightBevelGearLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearLoadCase._Cast_StraightBevelGearLoadCase':
