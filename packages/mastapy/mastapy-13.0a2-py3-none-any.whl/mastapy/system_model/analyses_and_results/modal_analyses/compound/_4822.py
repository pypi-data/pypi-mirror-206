...
class UnbalancedMassCompoundModalAnalysis(_4823.VirtualComponentCompoundModalAnalysis):
    """UnbalancedMassCompoundModalAnalysis
    ...
    class _Cast_UnbalancedMassCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'UnbalancedMassCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_compound_modal_analysis(self) -> 'UnbalancedMassCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4678.UnbalancedMassModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4678.UnbalancedMassModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassCompoundModalAnalysis._Cast_UnbalancedMassCompoundModalAnalysis':
