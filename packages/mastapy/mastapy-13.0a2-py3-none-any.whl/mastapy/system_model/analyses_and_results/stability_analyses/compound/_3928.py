...
class FaceGearMeshCompoundStabilityAnalysis(_3933.GearMeshCompoundStabilityAnalysis):
    """FaceGearMeshCompoundStabilityAnalysis
    ...
    class _Cast_FaceGearMeshCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'FaceGearMeshCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def face_gear_mesh_compound_stability_analysis(self) -> 'FaceGearMeshCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3796.FaceGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3796.FaceGearMeshStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'FaceGearMeshCompoundStabilityAnalysis._Cast_FaceGearMeshCompoundStabilityAnalysis':
