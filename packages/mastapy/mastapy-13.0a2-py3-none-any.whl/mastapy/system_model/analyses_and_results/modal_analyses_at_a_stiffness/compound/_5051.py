...
class RollingRingAssemblyCompoundModalAnalysisAtAStiffness(_5058.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """RollingRingAssemblyCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_RollingRingAssemblyCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'RollingRingAssemblyCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def rolling_ring_assembly_compound_modal_analysis_at_a_stiffness(self) -> 'RollingRingAssemblyCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4922.RollingRingAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4922.RollingRingAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'RollingRingAssemblyCompoundModalAnalysisAtAStiffness._Cast_RollingRingAssemblyCompoundModalAnalysisAtAStiffness':
