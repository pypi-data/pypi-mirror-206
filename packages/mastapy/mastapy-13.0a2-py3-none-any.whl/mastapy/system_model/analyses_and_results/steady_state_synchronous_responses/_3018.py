...
class FaceGearSteadyStateSynchronousResponse(_3023.GearSteadyStateSynchronousResponse):
    """FaceGearSteadyStateSynchronousResponse
    ...
    class _Cast_FaceGearSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'FaceGearSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def face_gear_steady_state_synchronous_response(self) -> 'FaceGearSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearSteadyStateSynchronousResponse._Cast_FaceGearSteadyStateSynchronousResponse':
