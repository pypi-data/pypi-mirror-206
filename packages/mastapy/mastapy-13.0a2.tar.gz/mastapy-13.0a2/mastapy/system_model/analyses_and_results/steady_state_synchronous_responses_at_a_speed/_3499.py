...
class BevelGearMeshSteadyStateSynchronousResponseAtASpeed(_3487.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseAtASpeed):
    """BevelGearMeshSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_BevelGearMeshSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'BevelGearMeshSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def bevel_gear_mesh_steady_state_synchronous_response_at_a_speed(self) -> 'BevelGearMeshSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearMeshSteadyStateSynchronousResponseAtASpeed._Cast_BevelGearMeshSteadyStateSynchronousResponseAtASpeed':
