...
class CylindricalGearBiasModification(_564.BiasModification):
    ...
    class _Cast_CylindricalGearBiasModification:
        ...
        def __init__(self, parent: 'CylindricalGearBiasModification'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_bias_modification(self) -> 'CylindricalGearBiasModification':
            return self._parent
    ...
    @property
    def zero_bias_relief(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def profile_evaluation_lower_limit(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def profile_evaluation_upper_limit(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearBiasModification._Cast_CylindricalGearBiasModification':
