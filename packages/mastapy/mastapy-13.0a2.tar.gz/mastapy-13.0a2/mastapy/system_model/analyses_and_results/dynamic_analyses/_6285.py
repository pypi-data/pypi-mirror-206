...
class CVTPulleyDynamicAnalysis(_6332.PulleyDynamicAnalysis):
    """CVTPulleyDynamicAnalysis
    ...
    class _Cast_CVTPulleyDynamicAnalysis:
        ...
        def __init__(self, parent: 'CVTPulleyDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def cvt_pulley_dynamic_analysis(self) -> 'CVTPulleyDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CVTPulleyDynamicAnalysis._Cast_CVTPulleyDynamicAnalysis':
