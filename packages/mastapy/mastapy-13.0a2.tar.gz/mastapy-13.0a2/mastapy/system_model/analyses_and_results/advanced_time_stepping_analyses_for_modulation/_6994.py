...
class ClutchAdvancedTimeSteppingAnalysisForModulation(_7010.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """ClutchAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_ClutchAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'ClutchAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def clutch_advanced_time_stepping_analysis_for_modulation(self) -> 'ClutchAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchAdvancedTimeSteppingAnalysisForModulation._Cast_ClutchAdvancedTimeSteppingAnalysisForModulation':
