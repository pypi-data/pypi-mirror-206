...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2958, _2959, _2848
...
class ZerolBevelGearSetCompoundSystemDeflection(_2848.BevelGearSetCompoundSystemDeflection):
    """ZerolBevelGearSetCompoundSystemDeflection
    ...
    class _Cast_ZerolBevelGearSetCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_compound_system_deflection(self) -> 'ZerolBevelGearSetCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2819.ZerolBevelGearSetSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_compound_system_deflection(self) -> 'List[_2958.ZerolBevelGearCompoundSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_compound_system_deflection(self) -> 'List[_2959.ZerolBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2819.ZerolBevelGearSetSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetCompoundSystemDeflection._Cast_ZerolBevelGearSetCompoundSystemDeflection':
