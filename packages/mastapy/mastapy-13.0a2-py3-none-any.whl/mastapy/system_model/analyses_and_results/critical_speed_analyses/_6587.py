...
class MountableComponentCriticalSpeedAnalysis(_6533.ComponentCriticalSpeedAnalysis):
    """MountableComponentCriticalSpeedAnalysis
    ...
    class _Cast_MountableComponentCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'MountableComponentCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def mountable_component_critical_speed_analysis(self) -> 'MountableComponentCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MountableComponentCriticalSpeedAnalysis._Cast_MountableComponentCriticalSpeedAnalysis':
