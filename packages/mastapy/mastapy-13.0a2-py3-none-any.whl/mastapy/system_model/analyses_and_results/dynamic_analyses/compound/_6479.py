...
class StraightBevelDiffGearMeshCompoundDynamicAnalysis(_6390.BevelGearMeshCompoundDynamicAnalysis):
    """StraightBevelDiffGearMeshCompoundDynamicAnalysis
    ...
    class _Cast_StraightBevelDiffGearMeshCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearMeshCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_mesh_compound_dynamic_analysis(self) -> 'StraightBevelDiffGearMeshCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6350.StraightBevelDiffGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6350.StraightBevelDiffGearMeshDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearMeshCompoundDynamicAnalysis._Cast_StraightBevelDiffGearMeshCompoundDynamicAnalysis':
