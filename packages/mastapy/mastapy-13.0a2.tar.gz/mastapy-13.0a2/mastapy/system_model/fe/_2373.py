...
from mastapy.nodal_analysis.dev_tools_analyses import _176, _185
from mastapy.nodal_analysis import _64
from mastapy.system_model.fe import _2367, _2370
...
class FESubstructureWithSelectionForModalAnalysis(_2370.FESubstructureWithSelection):
    """FESubstructureWithSelectionForModalAnalysis
    ...
    class _Cast_FESubstructureWithSelectionForModalAnalysis:
        ...
        def __init__(self, parent: 'FESubstructureWithSelectionForModalAnalysis'):
            self._parent = parent
        ...
        @property
        def fe_substructure_with_selection_for_modal_analysis(self) -> 'FESubstructureWithSelectionForModalAnalysis':
            return self._parent
    ...
    @property
    def eigenvalue_options(self) -> '_176.EigenvalueOptions':
    ...
    @property
    def full_fe_mode_shapes_at_condensation_nodes(self) -> 'List[_2367.FESubstructureNodeModeShapes]':
    ...
    @property
    def cast_to(self) -> 'FESubstructureWithSelectionForModalAnalysis._Cast_FESubstructureWithSelectionForModalAnalysis':
