...
class CylindricalGearLinearTrainCreationOptions(_0.APIBase):
    ...
    class _Cast_CylindricalGearLinearTrainCreationOptions:
        ...
        def __init__(self, parent: 'CylindricalGearLinearTrainCreationOptions'):
            self._parent = parent

        @property
        def cylindrical_gear_linear_train_creation_options(self) -> 'CylindricalGearLinearTrainCreationOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearLinearTrainCreationOptions._Cast_CylindricalGearLinearTrainCreationOptions':
