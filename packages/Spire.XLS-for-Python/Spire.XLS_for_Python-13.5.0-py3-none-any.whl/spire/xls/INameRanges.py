...
class INameRanges (  IEnumerable[XlsName]) :
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().INameRanges_get_Count(self.Ptr)
        return ret
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().INameRanges_get_Parent(self.Ptr)
    ...
    def get_Item(self ,index:int)->INamedRange:
        ...
        intPtr = GetDllLibXls().INameRanges_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->INamedRange:
        ...
        intPtr = GetDllLibXls().INameRanges_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsName(intPtr)
        return ret
    ...
    def GetByName(self ,name:str)->'INamedRange':
        ...
        intPtr = GetDllLibXls().INameRanges_GetByName(self.Ptr, name)
        ret = None if intPtr==None else XlsName(intPtr)
        return ret
    ...
    def ParentWorksheet(self)->'IWorksheet':
        ...
        intPtr = GetDllLibXls().INameRanges_get_ParentWorksheet(self.Ptr)
    ...
    def Add(self ,name:str)->INamedRange:
        ...
        intPtr = GetDllLibXls().INameRanges_Add(self.Ptr, name)
        ret = None if intPtr==None else XlsName(intPtr)
        return ret
    ...
    def Add(self ,name:str,namedObject:IXLSRange)->INamedRange:
        ...
        intPtr = GetDllLibXls().INameRanges_AddNN(self.Ptr, name,intPtrnamedObject)
        ret = None if intPtr==None else XlsName(intPtr)
        return ret
    ...
    def Add(self ,name:INamedRange)->INamedRange:
        ...
        intPtr = GetDllLibXls().INameRanges_AddN(self.Ptr, intPtrname)
        ret = None if intPtr==None else XlsName(intPtr)
        return ret
    ...
    def Remove(self ,name:str):
        ...
        GetDllLibXls().INameRanges_Remove(self.Ptr, name)
    ...
    def RemoveAt(self ,index:int):
        ...
        GetDllLibXls().INameRanges_RemoveAt(self.Ptr, index)
    ...
    def Contains(self ,name:str)->bool:
        ...
        ret = GetDllLibXls().INameRanges_Contains(self.Ptr, name)
        return ret
