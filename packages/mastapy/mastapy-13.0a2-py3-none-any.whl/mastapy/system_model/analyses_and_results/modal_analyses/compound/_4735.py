...
class ConicalGearSetCompoundModalAnalysis(_4761.GearSetCompoundModalAnalysis):
    """ConicalGearSetCompoundModalAnalysis
    ...
    class _Cast_ConicalGearSetCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'ConicalGearSetCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def conical_gear_set_compound_modal_analysis(self) -> 'ConicalGearSetCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4581.ConicalGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4581.ConicalGearSetModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ConicalGearSetCompoundModalAnalysis._Cast_ConicalGearSetCompoundModalAnalysis':
