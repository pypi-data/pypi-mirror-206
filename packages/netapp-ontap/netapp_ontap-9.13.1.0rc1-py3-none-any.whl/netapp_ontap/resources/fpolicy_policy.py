...
class FpolicyPolicySchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    allow_privileged_access = fields.Boolean(
...
Example: mydomain\testuser"""
    ...
    """allow_privileged_access,enabled,engine.links,engine.name,events,mandatory,name,passthrough_read,priority,privileged_user,scope,svm,"""
    ...
    """allow_privileged_access,enabled,engine.name,events,mandatory,passthrough_read,priority,privileged_user,scope,svm,"""
...
"""
    ...
    if RECLINE_INSTALLED:
        ...
        def fpolicy_policy_show(
            ...
            fields: List[Choices.define(["allow_privileged_access", "enabled", "mandatory", "name", "passthrough_read", "priority", "privileged_user", "*"])]=None,
        ) -> ResourceTable:
