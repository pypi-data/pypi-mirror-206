...
class BevelDifferentialGearCriticalSpeedAnalysis(_6524.BevelGearCriticalSpeedAnalysis):
    """BevelDifferentialGearCriticalSpeedAnalysis
    ...
    class _Cast_BevelDifferentialGearCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialGearCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_critical_speed_analysis(self) -> 'BevelDifferentialGearCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearCriticalSpeedAnalysis._Cast_BevelDifferentialGearCriticalSpeedAnalysis':
