...
class ConnectorMultibodyDynamicsAnalysis(_5435.MountableComponentMultibodyDynamicsAnalysis):
    """ConnectorMultibodyDynamicsAnalysis
    ...
    class _Cast_ConnectorMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'ConnectorMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def connector_multibody_dynamics_analysis(self) -> 'ConnectorMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConnectorMultibodyDynamicsAnalysis._Cast_ConnectorMultibodyDynamicsAnalysis':
