...
class CoaxialConnectionCompoundModalAnalysisAtASpeed(_5315.ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """CoaxialConnectionCompoundModalAnalysisAtASpeed
    ...
    class _Cast_CoaxialConnectionCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'CoaxialConnectionCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def coaxial_connection_compound_modal_analysis_at_a_speed(self) -> 'CoaxialConnectionCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5113.CoaxialConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5113.CoaxialConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'CoaxialConnectionCompoundModalAnalysisAtASpeed._Cast_CoaxialConnectionCompoundModalAnalysisAtASpeed':
