...
class ResistiveTorque(_0.APIBase):
    ...
    class _Cast_ResistiveTorque:
        ...
        def __init__(self, parent: 'ResistiveTorque'):
            self._parent = parent

        @property
        def combined_resistive_torque(self):
            from mastapy.materials.efficiency import _289
            
            return self._parent._cast(_289.CombinedResistiveTorque)

        @property
        def independent_resistive_torque(self):
            from mastapy.materials.efficiency import _292
            
            return self._parent._cast(_292.IndependentResistiveTorque)

        @property
        def resistive_torque(self) -> 'ResistiveTorque':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ResistiveTorque._Cast_ResistiveTorque':
