...
class FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation(_6074.SpecialisedAssemblyHarmonicAnalysisOfSingleExcitation):
    """FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def flexible_pin_assembly_harmonic_analysis_of_single_excitation(self) -> 'FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation._Cast_FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation':
