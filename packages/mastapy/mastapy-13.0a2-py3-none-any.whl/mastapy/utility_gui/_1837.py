...
from mastapy.utility.enums import _1806
...
class ScalingDrawStyle(_0.APIBase):
    ...
    class _Cast_ScalingDrawStyle:
        ...
        def __init__(self, parent: 'ScalingDrawStyle'):
            self._parent = parent

        @property
        def scaling_draw_style(self) -> 'ScalingDrawStyle':
            return self._parent
    ...
    @property
    def bearing_force_arrows(self) -> '_1806.BearingForceArrowOption':
        ...
        value = conversion.pn_to_mp_enum(temp, _1806.BearingForceArrowOption)
        return constructor.new_from_mastapy_type(_1806.BearingForceArrowOption)(value) if value is not None else None

    @bearing_force_arrows.setter
    def bearing_force_arrows(self, value: '_1806.BearingForceArrowOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1806.BearingForceArrowOption.type_())
    ...
    @property
    def cast_to(self) -> 'ScalingDrawStyle._Cast_ScalingDrawStyle':
