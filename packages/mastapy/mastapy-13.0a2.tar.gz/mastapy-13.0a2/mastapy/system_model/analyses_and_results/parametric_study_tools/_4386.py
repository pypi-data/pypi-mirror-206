...
class ShaftToMountableComponentConnectionParametricStudyTool(_4274.AbstractShaftToMountableComponentConnectionParametricStudyTool):
    """ShaftToMountableComponentConnectionParametricStudyTool
    ...
    class _Cast_ShaftToMountableComponentConnectionParametricStudyTool:
        ...
        def __init__(self, parent: 'ShaftToMountableComponentConnectionParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def shaft_to_mountable_component_connection_parametric_study_tool(self) -> 'ShaftToMountableComponentConnectionParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftToMountableComponentConnectionParametricStudyTool._Cast_ShaftToMountableComponentConnectionParametricStudyTool':
