...
class SpringDamperConnectionCompoundSystemDeflection(_2868.CouplingConnectionCompoundSystemDeflection):
    """SpringDamperConnectionCompoundSystemDeflection
    ...
    class _Cast_SpringDamperConnectionCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'SpringDamperConnectionCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_compound_system_deflection(self) -> 'SpringDamperConnectionCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2789.SpringDamperConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2789.SpringDamperConnectionSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionCompoundSystemDeflection._Cast_SpringDamperConnectionCompoundSystemDeflection':
