...
from mastapy.bearings.bearing_results.fluid_film import _2108, _2104
...
class LoadedPlainJournalBearingResults(_2104.LoadedFluidFilmBearingResults):
    """LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_2108.LoadedPlainJournalBearingRow]':
