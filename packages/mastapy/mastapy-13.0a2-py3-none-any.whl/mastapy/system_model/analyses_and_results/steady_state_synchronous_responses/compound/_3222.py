...
class ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse(_3112.BevelGearMeshCompoundSteadyStateSynchronousResponse):
    """ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_mesh_compound_steady_state_synchronous_response(self) -> 'ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3092.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3092.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse._Cast_ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse':
