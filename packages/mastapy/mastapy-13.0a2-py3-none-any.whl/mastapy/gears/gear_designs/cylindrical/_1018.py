...
from mastapy.gears.gear_designs.cylindrical import _1019, _1001
...
class CylindricalGearPinionTypeCutter(_1001.CylindricalGearAbstractRack):
    """CylindricalGearPinionTypeCutter
    ...
    class _Cast_CylindricalGearPinionTypeCutter:
        ...
        def __init__(self, parent: 'CylindricalGearPinionTypeCutter'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_pinion_type_cutter(self) -> 'CylindricalGearPinionTypeCutter':
            return self._parent
    ...
    @property
    def left_flank(self) -> '_1019.CylindricalGearPinionTypeCutterFlank':
    ...
    @property
    def right_flank(self) -> '_1019.CylindricalGearPinionTypeCutterFlank':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearPinionTypeCutter._Cast_CylindricalGearPinionTypeCutter':
