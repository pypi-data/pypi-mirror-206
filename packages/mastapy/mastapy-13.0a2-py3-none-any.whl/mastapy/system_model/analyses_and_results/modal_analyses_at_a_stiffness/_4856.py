...
class ConceptCouplingConnectionModalAnalysisAtAStiffness(_4867.CouplingConnectionModalAnalysisAtAStiffness):
    """ConceptCouplingConnectionModalAnalysisAtAStiffness
    ...
    class _Cast_ConceptCouplingConnectionModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_modal_analysis_at_a_stiffness(self) -> 'ConceptCouplingConnectionModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionModalAnalysisAtAStiffness._Cast_ConceptCouplingConnectionModalAnalysisAtAStiffness':
