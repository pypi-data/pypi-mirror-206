...
class HypoidGearMeshCompoundParametricStudyTool(_4423.AGMAGleasonConicalGearMeshCompoundParametricStudyTool):
    """HypoidGearMeshCompoundParametricStudyTool
    ...
    class _Cast_HypoidGearMeshCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'HypoidGearMeshCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_mesh_compound_parametric_study_tool(self) -> 'HypoidGearMeshCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4340.HypoidGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4340.HypoidGearMeshParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearMeshCompoundParametricStudyTool._Cast_HypoidGearMeshCompoundParametricStudyTool':
