...
class RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed(_5283.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed
    ...
    class _Cast_RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def ring_pins_to_disc_connection_compound_modal_analysis_at_a_speed(self) -> 'RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5179.RingPinsToDiscConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5179.RingPinsToDiscConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed._Cast_RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed':
