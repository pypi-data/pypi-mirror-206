...
class StraightBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(_3630.BevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_StraightBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_compound_steady_state_synchronous_response_at_a_speed(self) -> 'StraightBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3592.StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3592.StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed._Cast_StraightBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_StraightBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(self)
