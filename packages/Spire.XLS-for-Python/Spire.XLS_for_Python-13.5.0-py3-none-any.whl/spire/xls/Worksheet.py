...
class Worksheet (  XlsWorksheet) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_AllocatedRange(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().Worksheet_get_Item(self.Ptr, row,column,lastRow,lastColumn)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().Worksheet_get_ItemRC(self.Ptr, row,column)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().Worksheet_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_MergedCells(self.Ptr)
    ...
    <returns>All found cells, or Null if value was not found.</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_FindAll(self.Ptr, findValue,enumflags,enumfindOptions)
        ret = None if intPtr==None else ListCellRanges(intPtr)
        return ret
    ...
    <returns>Found ranges.</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_FindAllNumber(self.Ptr, doubleValue,formulaValue)
        ret = None if intPtr==None else ListCellRanges(intPtr)
        return ret
    ...
    <returns>Found ranges.</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_FindAllString(self.Ptr, stringValue,formula,formulaValue)
        ret = None if intPtr==None else ListCellRanges(intPtr)
        return ret
    ...
    <returns>Found ranges.</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_FindAllDateTime(self.Ptr, intPtrdateTimeValue)
        ret = None if intPtr==None else ListCellRanges(intPtr)
        return ret
    ...
    <returns>Found ranges.</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_FindAllTimeSpan(self.Ptr, intPtrtimeSpanValue)
        ret = None if intPtr==None else ListCellRanges(intPtr)
        return ret
    ...
    <returns>Found ranges.</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_FindAllBool(self.Ptr, boolValue)
        ret = None if intPtr==None else ListCellRanges(intPtr)
        return ret
    ...
    <returns>Found range.</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_FindBool(self.Ptr, boolValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range.</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_FindNumber(self.Ptr, doubleValue,formulaValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range.</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_FindString(self.Ptr, stringValue,formula,formulaValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range.</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_FindDateTime(self.Ptr, intPtrdateTimeValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range.</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_FindTimeSpan(self.Ptr, intPtrtimeSpanValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <param name="worksheet">worksheet object</param>
        ...
        GetDllLibXls().Worksheet_CopyFrom(self.Ptr, intPtrworksheet)
    ...
    <param name="destRange">Destination range.</param>
        ...
        GetDllLibXls().Worksheet_Copy(self.Ptr, intPtrsourceRange,intPtrdestRange)
    ...
    <param name="copyStyle">Indicates whether copys styles.</param>
        ...
        GetDllLibXls().Worksheet_CopySDC(self.Ptr, intPtrsourceRange,intPtrdestRange,copyStyle)
    ...
    <param name="ignoreSize">Indicates whether check range sizes.</param>
        ...
        GetDllLibXls().Worksheet_CopySDCUI(self.Ptr, intPtrsourceRange,intPtrdestRange,copyStyle,updateReference,ignoreSize)
    ...
    <param name="destColumn">Column index of destination worksheet.</param>
        ...
        GetDllLibXls().Worksheet_CopySWDD(self.Ptr, intPtrsourceRange,intPtrworksheet,destRow,destColumn)
    ...
    <param name="copyStyle">Indicates whehter copy styles.</param>
        ...
        GetDllLibXls().Worksheet_CopySWDDC(self.Ptr, intPtrsourceRange,intPtrworksheet,destRow,destColumn,copyStyle)
    ...
    <param name="updateRerence">Indicates whether update reference range.</param>
        ...
        GetDllLibXls().Worksheet_CopySWDDCU(self.Ptr, intPtrsourceRange,intPtrworksheet,destRow,destColumn,copyStyle,updateRerence)
    ...
    <param name="copyShape">Indicates whether copy shape.</param>
        ...
        GetDllLibXls().Worksheet_CopySDCUIC(self.Ptr, intPtrsourceRange,intPtrdestRange,copyStyle,updateReference,ignoreSize,copyShape)
    ...
    <param name="copyOptions">Copy options.</param>
        ...
        GetDllLibXls().Worksheet_CopySDC1(self.Ptr, intPtrsourceRange,intPtrdestRange,enumcopyOptions)
    ...
    <param name="copyOptions">Copy options.</param>
        ...
        GetDllLibXls().Worksheet_CopyRow(self.Ptr, intPtrsourceRow,intPtrdestSheet,destRowIndex,enumcopyOptions)
    ...
    <param name="copyOptions">Copy options.</param>
        ...
        GetDllLibXls().Worksheet_CopyColumn(self.Ptr, intPtrsourceColumn,intPtrdestSheet,destColIndex,enumcopyOptions)
    ...
    <param name="destRange">Destination range.</param>
        ...
        GetDllLibXls().Worksheet_Move(self.Ptr, intPtrsourceRange,intPtrdestRange)
    ...
    def Move(self ,sourceRange:CellRange,destRange:CellRange,updateReference:bool,copyStyle:bool):
        ...
        GetDllLibXls().Worksheet_MoveSDUC(self.Ptr, intPtrsourceRange,intPtrdestRange,updateReference,copyStyle)
...
#        intPtr = GetDllLibXls().Worksheet_ExportDataTable(self.Ptr, intPtrrange,exportColumnNames)
...
#        intPtr = GetDllLibXls().Worksheet_ExportDataTableRO(self.Ptr, intPtrrange,intPtroptions)
#        ret = None if intPtr==None else DataTable(intPtr)
#        return ret
#
...
#        intPtr = GetDllLibXls().Worksheet_ExportDataTableFFMMO(self.Ptr, firstRow,firstColumn,maxRows,maxColumns,intPtroptions)
#        ret = None if intPtr==None else DataTable(intPtr)
#        return ret
#
...
#        intPtr = GetDllLibXls().Worksheet_ExportDataTableREC(self.Ptr, intPtrrange,exportColumnNames,computedFormulaValue)
#        ret = None if intPtr==None else DataTable(intPtr)
#        return ret
#
...
#        intPtr = GetDllLibXls().Worksheet_ExportDataTableFFMME(self.Ptr, firstRow,firstColumn,maxRows,maxColumns,exportColumnNames)
#        ret = None if intPtr==None else DataTable(intPtr)
#        return ret
#
    ...
    <returns>Intersection of two ranges</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_GetIntersectRanges(self.Ptr, intPtrrange1,intPtrrange2)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_GroupShapeCollection(self.Ptr)
    ...
    <returns>Merged ranges</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_Merge(self.Ptr, intPtrrange1,intPtrrange2)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <param name="defaultStyle">Default style.</param>
        ...
        GetDllLibXls().Worksheet_SetDefaultColumnStyle(self.Ptr, columnIndex,intPtrdefaultStyle)
    ...
    <param name="defaultStyle">Default style.</param>
        ...
        GetDllLibXls().Worksheet_SetDefaultColumnStyleFLD(self.Ptr, firstColumnIndex,lastColumnIndex,intPtrdefaultStyle)
    ...
    <param name="defaultStyle">Default style.</param>
        ...
        GetDllLibXls().Worksheet_SetDefaultRowStyle(self.Ptr, rowIndex,intPtrdefaultStyle)
    ...
    <param name="defaultStyle">Default style.</param>
        ...
        GetDllLibXls().Worksheet_SetDefaultRowStyleFLD(self.Ptr, firstRowIndex,lastRowIndex,intPtrdefaultStyle)
    ...
    <returns>Default column style or null if default style is not exists.</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_GetDefaultColumnStyle(self.Ptr, columnIndex)
    ...
    <returns>Default row style or null if default style is not set.</returns>
        ...
        intPtr = GetDllLibXls().Worksheet_GetDefaultRowStyle(self.Ptr, rowIndex)
        ret = None if intPtr==None else CellStyle(intPtr)
        return ret
    ...
    def RemoveMergedCells(self ,range:'CellRange'):
        ...
        GetDllLibXls().Worksheet_RemoveMergedCells(self.Ptr, intPtrrange)
    ...
    <param name="range">Specified range.</param>
        ...
        GetDllLibXls().Worksheet_RemoveRange(self.Ptr, intPtrrange)
    ...
    <param name="columnIndex">Column index.</param>
        ...
        GetDllLibXls().Worksheet_RemoveRangeRC(self.Ptr, rowIndex,columnIndex)
    ...
    <param name="index">Picture ID</param>
        ...
        GetDllLibXls().Worksheet_RemovePicture(self.Ptr, index)
    ...
    <param name="picturename">Picture name</param>
        ...
        GetDllLibXls().Worksheet_RemovePictureP(self.Ptr, picturename)
    ...
    <param name="picture">A pictureshape</param>
        ...
        GetDllLibXls().Worksheet_RemovePictureP1.argtypes=[c_void_p ,c_void_p]
        GetDllLibXls().Worksheet_RemovePictureP1(self.Ptr, intPtrpicture)
    ...
    <param name="style">style to apply</param>
        ...
        GetDllLibXls().Worksheet_ApplyStyle(self.Ptr, intPtrstyle)
    ...
    <param name="columnIndex">Column index.</param>
        ...
        GetDllLibXls().Worksheet_FreezePanes(self.Ptr, rowIndex,columnIndex)
    ...
    def GetFreezePanes(self )->List[int]:
        ...
        intPtrArray = GetDllLibXls().Worksheet_GetFreezePanes(self.Ptr)
        ret =[]
    ...
    <param name="range">Cell to activate.</param>
        ...
        GetDllLibXls().Worksheet_SetActiveCell(self.Ptr, intPtrrange)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_Cells(self.Ptr)
        ret = None if intPtr==None else ListCellRanges(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_Columns(self.Ptr)
        ret = None if intPtr==None else ListCellRanges(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_PageSetup(self.Ptr)
    ...
    def AutoFilters(self)->'AutoFiltersCollection':
        ...
        intPtr = GetDllLibXls().Worksheet_get_AutoFilters(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_Charts(self.Ptr)
    ...
    def QueryTables(self)->'QueryTableCollection':
        ...
        intPtr = GetDllLibXls().Worksheet_get_QueryTables(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_Comments(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_HPageBreaks(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_HyperLinks(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_Pictures(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_PrintRange(self.Ptr)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_VPageBreaks(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_Range(self.Ptr)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    def CalculateAndGetRowHeight(self ,rowIndex:int)->float:
        ...
        ret = GetDllLibXls().Worksheet_CalculateAndGetRowHeight(self.Ptr, rowIndex)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Worksheet_get_Rows(self.Ptr)
        ret = None if intPtr==None else ListCellRanges(intPtr)
        return ret
    ...
    def Workbook(self)->'Workbook':
        ...
        intPtr = GetDllLibXls().Worksheet_get_Workbook(self.Ptr)
    ...
    def ParentWorkbook(self)->'Workbook':
        ...
        intPtr = GetDllLibXls().Worksheet_get_ParentWorkbook(self.Ptr)
        ret = None if intPtr==None else Workbook(intPtr)
        return ret
