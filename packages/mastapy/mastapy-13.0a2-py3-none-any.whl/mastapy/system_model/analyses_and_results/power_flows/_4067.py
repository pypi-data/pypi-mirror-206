...
class FlexiblePinAssemblyPowerFlow(_4110.SpecialisedAssemblyPowerFlow):
    """FlexiblePinAssemblyPowerFlow
    ...
    class _Cast_FlexiblePinAssemblyPowerFlow:
        ...
        def __init__(self, parent: 'FlexiblePinAssemblyPowerFlow'):
            self._parent = parent
        ...
        @property
        def flexible_pin_assembly_power_flow(self) -> 'FlexiblePinAssemblyPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FlexiblePinAssemblyPowerFlow._Cast_FlexiblePinAssemblyPowerFlow':
