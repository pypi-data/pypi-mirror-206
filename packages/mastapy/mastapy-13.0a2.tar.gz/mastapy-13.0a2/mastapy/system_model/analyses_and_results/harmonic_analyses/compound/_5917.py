...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5915, _5916, _5914
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis(_5914.KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_set_compound_harmonic_analysis(self) -> 'KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5747.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_harmonic_analysis(self) -> 'List[_5915.KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_harmonic_analysis(self) -> 'List[_5916.KlingelnbergCycloPalloidHypoidGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5747.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis._Cast_KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis(self)
