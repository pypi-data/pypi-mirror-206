...
class ICustomDocumentProperties (CollectionBase[DocumentProperty]) :
    ...
    def get_Item(self ,strName:str)->IDocumentProperty:
        ...
        intPtr = GetDllLibXls().ICustomDocumentProperties_get_Item(self.Ptr, strName)
    ...
    def get_Item(self ,iIndex:int)->IDocumentProperty:
        ...
        intPtr = GetDllLibXls().ICustomDocumentProperties_get_ItemI(self.Ptr, iIndex)
        ret = None if intPtr==None else DocumentProperty(intPtr)
        return ret
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().ICustomDocumentProperties_get_Count(self.Ptr)
        return ret
    ...
    def Remove(self ,strName:str):
        ...
        GetDllLibXls().ICustomDocumentProperties_Remove(self.Ptr, strName)
    ...
    def Contains(self ,strName:str)->bool:
        ...
        ret = GetDllLibXls().ICustomDocumentProperties_Contains(self.Ptr, strName)
        return ret
    ...
    def Clear(self):
        ...
        GetDllLibXls().ICustomDocumentProperties_Clear(self.Ptr)
    ...
    def Add(self ,strName:str,value:str):
        ...
        GetDllLibXls().ICustomDocumentProperties_Add(self.Ptr, strName,value)
    ...
    def Add(self ,strName:str,value:bool):
        ...
        GetDllLibXls().ICustomDocumentProperties_AddSV(self.Ptr, strName,value)
    ...
    def Add(self ,strName:str,value:DateTime):
        ...
        GetDllLibXls().ICustomDocumentProperties_AddSV1(self.Ptr, strName,intPtrvalue)
    ...
    def Add(self ,strName:str,value:int):
        ...
        GetDllLibXls().ICustomDocumentProperties_AddSV11(self.Ptr, strName,value)
    ...
    def Add(self ,strName:str,value:float):
        ...
        GetDllLibXls().ICustomDocumentProperties_AddSV111(self.Ptr, strName,value)
