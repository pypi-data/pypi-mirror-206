...
class ConceptCouplingConnectionSteadyStateSynchronousResponseAtASpeed(_3520.CouplingConnectionSteadyStateSynchronousResponseAtASpeed):
    """ConceptCouplingConnectionSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ConceptCouplingConnectionSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_steady_state_synchronous_response_at_a_speed(self) -> 'ConceptCouplingConnectionSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionSteadyStateSynchronousResponseAtASpeed._Cast_ConceptCouplingConnectionSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_ConceptCouplingConnectionSteadyStateSynchronousResponseAtASpeed(self)
