...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7100, _7101, _6991
...
class ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6991.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_advanced_time_stepping_analysis_for_modulation(self) -> 'ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2819.ZerolBevelGearSetSystemDeflection':
    ...
    @property
    def zerol_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7100.ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def zerol_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7101.ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation._Cast_ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation(self)
