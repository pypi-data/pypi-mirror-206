...
class StraightBevelGearModalAnalysisAtASpeed(_5106.BevelGearModalAnalysisAtASpeed):
    """StraightBevelGearModalAnalysisAtASpeed
    ...
    class _Cast_StraightBevelGearModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelGearModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_modal_analysis_at_a_speed(self) -> 'StraightBevelGearModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearModalAnalysisAtASpeed._Cast_StraightBevelGearModalAnalysisAtASpeed':
