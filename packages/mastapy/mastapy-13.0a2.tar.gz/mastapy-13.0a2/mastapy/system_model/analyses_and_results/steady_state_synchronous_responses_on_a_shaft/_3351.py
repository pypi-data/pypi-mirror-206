...
class ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft(_3240.BevelGearMeshSteadyStateSynchronousResponseOnAShaft):
    """ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_mesh_steady_state_synchronous_response_on_a_shaft(self) -> 'ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft._Cast_ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft':
