...
class XlsChartDataPointsCollection (  XlsObject, IChartDataPoints, IEnumerable[XlsChartDataPoint]) :
    ...
    def get_Item(self ,index:int)->'IChartDataPoint':
        ...
        intPtr = GetDllLibXls().XlsChartDataPointsCollection_get_Item(self.Ptr, index)
    ...
    def DefaultDataPoint(self)->'IChartDataPoint':
        ...
        intPtr = GetDllLibXls().XlsChartDataPointsCollection_get_DefaultDataPoint(self.Ptr)
        ret = None if intPtr==None else XlsChartDataPoint(intPtr)
        return ret
    ...
    def GetEnumerator(self)->EnumeratorChartDataPoint:
        ...
        intPtr = GetDllLibXls().XlsChartDataPointsCollection_GetEnumerator(self.Ptr)
    ...
    def Add(self ,point:'XlsChartDataPoint'):
        ...
        GetDllLibXls().XlsChartDataPointsCollection_Add(self.Ptr, intPtrpoint)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChartDataPointsCollection_Clear(self.Ptr)
    ...
    def ClearDataFormats(self ,format:'XlsChartSerieDataFormat'):
        ...
        GetDllLibXls().XlsChartDataPointsCollection_ClearDataFormats(self.Ptr, intPtrformat)
    ...
    def DefaultPointFormat(self)->'XlsChartSerieDataFormat':
        ...
        intPtr = GetDllLibXls().XlsChartDataPointsCollection_get_DefaultPointFormat(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsChartDataPointsCollection_Clone(self.Ptr, intPtrparent,intPtrbook,intPtrfontIndexes,intPtrdicNewSheetNames)
...
#
    ...
    def UpdateSerieIndex(self):
        ...
        GetDllLibXls().XlsChartDataPointsCollection_UpdateSerieIndex(self.Ptr)
