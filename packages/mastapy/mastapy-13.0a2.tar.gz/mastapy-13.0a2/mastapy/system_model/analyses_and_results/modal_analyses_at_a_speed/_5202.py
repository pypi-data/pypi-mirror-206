...
class SynchroniserHalfModalAnalysisAtASpeed(_5204.SynchroniserPartModalAnalysisAtASpeed):
    """SynchroniserHalfModalAnalysisAtASpeed
    ...
    class _Cast_SynchroniserHalfModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'SynchroniserHalfModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def synchroniser_half_modal_analysis_at_a_speed(self) -> 'SynchroniserHalfModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserHalfModalAnalysisAtASpeed._Cast_SynchroniserHalfModalAnalysisAtASpeed':
