...
class BeltConnectionCompoundDynamicAnalysis(_6438.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """BeltConnectionCompoundDynamicAnalysis
    ...
    class _Cast_BeltConnectionCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'BeltConnectionCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def belt_connection_compound_dynamic_analysis(self) -> 'BeltConnectionCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6252.BeltConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6252.BeltConnectionDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BeltConnectionCompoundDynamicAnalysis._Cast_BeltConnectionCompoundDynamicAnalysis':
