...
class BevelGearSetCompoundSystemDeflection(_2836.AGMAGleasonConicalGearSetCompoundSystemDeflection):
    """BevelGearSetCompoundSystemDeflection
    ...
    class _Cast_BevelGearSetCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'BevelGearSetCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def bevel_gear_set_compound_system_deflection(self) -> 'BevelGearSetCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2686.BevelGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2686.BevelGearSetSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'BevelGearSetCompoundSystemDeflection._Cast_BevelGearSetCompoundSystemDeflection':
