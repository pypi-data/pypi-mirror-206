...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5738, _5739, _5655
...
class HypoidGearSetHarmonicAnalysis(_5655.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """HypoidGearSetHarmonicAnalysis
    ...
    class _Cast_HypoidGearSetHarmonicAnalysis:
        ...
        def __init__(self, parent: 'HypoidGearSetHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_set_harmonic_analysis(self) -> 'HypoidGearSetHarmonicAnalysis':
            return self._parent
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5738.HypoidGearHarmonicAnalysis]':
    ...
    @property
    def hypoid_gears_harmonic_analysis(self) -> 'List[_5738.HypoidGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5739.HypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def hypoid_meshes_harmonic_analysis(self) -> 'List[_5739.HypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearSetHarmonicAnalysis._Cast_HypoidGearSetHarmonicAnalysis':
