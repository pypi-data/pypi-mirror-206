...
class StraightBevelGearSystemDeflection(_2687.BevelGearSystemDeflection):
    """StraightBevelGearSystemDeflection
    ...
    class _Cast_StraightBevelGearSystemDeflection:
        ...
        def __init__(self, parent: 'StraightBevelGearSystemDeflection'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_system_deflection(self) -> 'StraightBevelGearSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4121.StraightBevelGearPowerFlow':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSystemDeflection._Cast_StraightBevelGearSystemDeflection':
