...
class UnbalancedMassSteadyStateSynchronousResponseOnAShaft(_3347.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    """UnbalancedMassSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_UnbalancedMassSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'UnbalancedMassSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_steady_state_synchronous_response_on_a_shaft(self) -> 'UnbalancedMassSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassSteadyStateSynchronousResponseOnAShaft._Cast_UnbalancedMassSteadyStateSynchronousResponseOnAShaft':
