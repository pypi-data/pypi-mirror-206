...
class CylindricalGearMeshCompoundCriticalSpeedAnalysis(_6698.GearMeshCompoundCriticalSpeedAnalysis):
    """CylindricalGearMeshCompoundCriticalSpeedAnalysis
    ...
    class _Cast_CylindricalGearMeshCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'CylindricalGearMeshCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_compound_critical_speed_analysis(self) -> 'CylindricalGearMeshCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6558.CylindricalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6558.CylindricalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshCompoundCriticalSpeedAnalysis._Cast_CylindricalGearMeshCompoundCriticalSpeedAnalysis':
