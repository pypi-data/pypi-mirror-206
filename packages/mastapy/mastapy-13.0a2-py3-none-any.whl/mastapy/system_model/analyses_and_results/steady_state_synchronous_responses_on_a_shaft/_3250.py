...
class ConceptCouplingConnectionSteadyStateSynchronousResponseOnAShaft(_3261.CouplingConnectionSteadyStateSynchronousResponseOnAShaft):
    """ConceptCouplingConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_ConceptCouplingConnectionSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_steady_state_synchronous_response_on_a_shaft(self) -> 'ConceptCouplingConnectionSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionSteadyStateSynchronousResponseOnAShaft._Cast_ConceptCouplingConnectionSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_ConceptCouplingConnectionSteadyStateSynchronousResponseOnAShaft(self)
