...
class KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed(_5155.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed):
    """KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_mesh_modal_analysis_at_a_speed(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed._Cast_KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed(self)
