...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5137, _5136, _5149
...
class CylindricalGearSetModalAnalysisAtASpeed(_5149.GearSetModalAnalysisAtASpeed):
    """CylindricalGearSetModalAnalysisAtASpeed
    ...
    class _Cast_CylindricalGearSetModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'CylindricalGearSetModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_set_modal_analysis_at_a_speed(self) -> 'CylindricalGearSetModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_speed(self) -> 'List[_5137.CylindricalGearModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_meshes_modal_analysis_at_a_speed(self) -> 'List[_5136.CylindricalGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearSetModalAnalysisAtASpeed._Cast_CylindricalGearSetModalAnalysisAtASpeed':
