...
class RollingRingAssemblyModalAnalysisAtASpeed(_5187.SpecialisedAssemblyModalAnalysisAtASpeed):
    """RollingRingAssemblyModalAnalysisAtASpeed
    ...
    class _Cast_RollingRingAssemblyModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'RollingRingAssemblyModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def rolling_ring_assembly_modal_analysis_at_a_speed(self) -> 'RollingRingAssemblyModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingAssemblyModalAnalysisAtASpeed._Cast_RollingRingAssemblyModalAnalysisAtASpeed':
