...
class PowerLoadStabilityAnalysis(_3867.VirtualComponentStabilityAnalysis):
    """PowerLoadStabilityAnalysis
    ...
    class _Cast_PowerLoadStabilityAnalysis:
        ...
        def __init__(self, parent: 'PowerLoadStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def power_load_stability_analysis(self) -> 'PowerLoadStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PowerLoadStabilityAnalysis._Cast_PowerLoadStabilityAnalysis':
