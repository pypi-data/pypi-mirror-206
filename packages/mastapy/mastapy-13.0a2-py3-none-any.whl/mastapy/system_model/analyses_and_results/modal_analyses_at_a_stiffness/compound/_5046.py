...
class PointLoadCompoundModalAnalysisAtAStiffness(_5082.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """PointLoadCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_PointLoadCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'PointLoadCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def point_load_compound_modal_analysis_at_a_stiffness(self) -> 'PointLoadCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4917.PointLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4917.PointLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'PointLoadCompoundModalAnalysisAtAStiffness._Cast_PointLoadCompoundModalAnalysisAtAStiffness':
