...
class SynchroniserHalfCompoundSteadyStateSynchronousResponseOnAShaft(_3469.SynchroniserPartCompoundSteadyStateSynchronousResponseOnAShaft):
    """SynchroniserHalfCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_SynchroniserHalfCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'SynchroniserHalfCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def synchroniser_half_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'SynchroniserHalfCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3338.SynchroniserHalfSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3338.SynchroniserHalfSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserHalfCompoundSteadyStateSynchronousResponseOnAShaft._Cast_SynchroniserHalfCompoundSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_SynchroniserHalfCompoundSteadyStateSynchronousResponseOnAShaft(self)
