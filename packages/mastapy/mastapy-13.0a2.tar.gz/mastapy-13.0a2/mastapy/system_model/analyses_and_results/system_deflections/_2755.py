...
class KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection(_2749.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    """KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_system_deflection(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4083.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection._Cast_KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection':
