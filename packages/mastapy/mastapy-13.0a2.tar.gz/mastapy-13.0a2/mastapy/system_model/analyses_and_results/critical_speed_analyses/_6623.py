...
class SynchroniserCriticalSpeedAnalysis(_6608.SpecialisedAssemblyCriticalSpeedAnalysis):
    """SynchroniserCriticalSpeedAnalysis
    ...
    class _Cast_SynchroniserCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_critical_speed_analysis(self) -> 'SynchroniserCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserCriticalSpeedAnalysis._Cast_SynchroniserCriticalSpeedAnalysis':
