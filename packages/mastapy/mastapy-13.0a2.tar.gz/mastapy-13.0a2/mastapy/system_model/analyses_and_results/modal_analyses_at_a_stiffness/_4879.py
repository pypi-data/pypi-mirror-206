...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4878, _4877, _4891
...
class CylindricalGearSetModalAnalysisAtAStiffness(_4891.GearSetModalAnalysisAtAStiffness):
    """CylindricalGearSetModalAnalysisAtAStiffness
    ...
    class _Cast_CylindricalGearSetModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'CylindricalGearSetModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_set_modal_analysis_at_a_stiffness(self) -> 'CylindricalGearSetModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4878.CylindricalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4877.CylindricalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearSetModalAnalysisAtAStiffness._Cast_CylindricalGearSetModalAnalysisAtAStiffness':
