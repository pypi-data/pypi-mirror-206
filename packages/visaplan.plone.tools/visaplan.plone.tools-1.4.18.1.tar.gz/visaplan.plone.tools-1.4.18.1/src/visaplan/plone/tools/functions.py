...
__all__ = ['is_uid_shaped',
           'id_of',
           'short_hostname',  # expects an .absolute_url() style URL
...
def short_hostname(url):
    """
    For use in title suffixes: we like to have crisp titles for search engines!

    >>> short_hostname('https://www.unitracc.com/some/quite/lengthy/path')
    u'unitracc.com'
    """
    liz = url.split(u'/', 3)
    hostname = liz[2]
