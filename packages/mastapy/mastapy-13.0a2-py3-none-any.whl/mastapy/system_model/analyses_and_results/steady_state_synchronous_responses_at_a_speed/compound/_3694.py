...
class PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3651.CouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_connection_compound_steady_state_synchronous_response_at_a_speed(self) -> 'PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3563.PartToPartShearCouplingConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3563.PartToPartShearCouplingConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed._Cast_PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(self)
