...
#        GetDllLibXls().MarkerDesigner_AddDataTable(self.Ptr, paraName,intPtrdataTable)
...
#        GetDllLibXls().MarkerDesigner_AddDataTablePDR(self.Ptr, paraName,intPtrdataTable,rowCount)
...
#        GetDllLibXls().MarkerDesigner_AddDataView(self.Ptr, paraName,intPtrdataView)
    ...
    def AddArray(self ,paraName:str,paramValues:List['SpireObject']):
        ...
        GetDllLibXls().MarkerDesigner_AddArray(self.Ptr, paraName,arrayparamValues,countparamValues)
...
#        GetDllLibXls().MarkerDesigner_AddDataColumn(self.Ptr, paramName,intPtrparamValue)
    ...
    <param name="paramValue">Parameter Value</param>
        ...
        GetDllLibXls().MarkerDesigner_AddParameter(self.Ptr, paraName,intPtrparamValue)
    ...
    <param name="paraName"></param>
        ...
        GetDllLibXls().MarkerDesigner_RemoveParameter(self.Ptr, paraName)
    ...
    <param name="paramName"></param>
        ...
        GetDllLibXls().MarkerDesigner_Contains(self.Ptr, paramName)
    ...
    <summary>
        ...
        GetDllLibXls().MarkerDesigner_Apply(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().MarkerDesigner_get_Prefix.restype=c_wchar_p
        ret = GetDllLibXls().MarkerDesigner_get_Prefix(self.Ptr)
        return ret
    ...
    def Prefix(self, value:str):
        ...
        GetDllLibXls().MarkerDesigner_set_Prefix(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().MarkerDesigner_get_IsDetectDataTypes(self.Ptr)
        return ret
    ...
    def IsDetectDataTypes(self, value:bool):
        ...
        GetDllLibXls().MarkerDesigner_set_IsDetectDataTypes(self.Ptr, value)
