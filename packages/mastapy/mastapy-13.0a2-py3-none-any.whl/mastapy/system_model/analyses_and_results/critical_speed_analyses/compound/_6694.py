...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6692, _6693, _6699
...
class FaceGearSetCompoundCriticalSpeedAnalysis(_6699.GearSetCompoundCriticalSpeedAnalysis):
    """FaceGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6565.FaceGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def face_gears_compound_critical_speed_analysis(self) -> 'List[_6692.FaceGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def face_meshes_compound_critical_speed_analysis(self) -> 'List[_6693.FaceGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6565.FaceGearSetCriticalSpeedAnalysis]':
