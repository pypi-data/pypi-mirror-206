...
class GearManufacturingConfigurationViewModel(_0.APIBase):
    ...
    class _Cast_GearManufacturingConfigurationViewModel:
        ...
        def __init__(self, parent: 'GearManufacturingConfigurationViewModel'):
            self._parent = parent

        @property
        def gear_manufacturing_configuration_view_model_placeholder(self):
            from mastapy.gears.manufacturing.cylindrical import _624
            
            return self._parent._cast(_624.GearManufacturingConfigurationViewModelPlaceholder)
        ...
        def hobbing_process_simulation_view_model(self):
            ...
            return self._parent._cast(_669.HobbingProcessSimulationViewModel)
        ...
        def process_simulation_view_model(self):
            ...
            return self._parent._cast(_682.ProcessSimulationViewModel)
        ...
        def worm_grinding_process_simulation_view_model(self):
            ...
            return self._parent._cast(_696.WormGrindingProcessSimulationViewModel)
        ...
        @property
        def gear_manufacturing_configuration_view_model(self) -> 'GearManufacturingConfigurationViewModel':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GearManufacturingConfigurationViewModel._Cast_GearManufacturingConfigurationViewModel':
