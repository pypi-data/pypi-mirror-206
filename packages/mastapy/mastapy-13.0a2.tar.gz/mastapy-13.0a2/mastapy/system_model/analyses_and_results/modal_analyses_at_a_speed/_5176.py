...
class PowerLoadModalAnalysisAtASpeed(_5211.VirtualComponentModalAnalysisAtASpeed):
    """PowerLoadModalAnalysisAtASpeed
    ...
    class _Cast_PowerLoadModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'PowerLoadModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def power_load_modal_analysis_at_a_speed(self) -> 'PowerLoadModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PowerLoadModalAnalysisAtASpeed._Cast_PowerLoadModalAnalysisAtASpeed':
