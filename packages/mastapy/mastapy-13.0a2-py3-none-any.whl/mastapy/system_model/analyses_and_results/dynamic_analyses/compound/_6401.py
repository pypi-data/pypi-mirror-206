...
class ConceptCouplingHalfCompoundDynamicAnalysis(_6412.CouplingHalfCompoundDynamicAnalysis):
    """ConceptCouplingHalfCompoundDynamicAnalysis
    ...
    class _Cast_ConceptCouplingHalfCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'ConceptCouplingHalfCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_coupling_half_compound_dynamic_analysis(self) -> 'ConceptCouplingHalfCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6271.ConceptCouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6271.ConceptCouplingHalfDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHalfCompoundDynamicAnalysis._Cast_ConceptCouplingHalfCompoundDynamicAnalysis':
