...
class SpringDamperMultibodyDynamicsAnalysis(_5389.CouplingMultibodyDynamicsAnalysis):
    """SpringDamperMultibodyDynamicsAnalysis
    ...
    class _Cast_SpringDamperMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'SpringDamperMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def spring_damper_multibody_dynamics_analysis(self) -> 'SpringDamperMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperMultibodyDynamicsAnalysis._Cast_SpringDamperMultibodyDynamicsAnalysis':
