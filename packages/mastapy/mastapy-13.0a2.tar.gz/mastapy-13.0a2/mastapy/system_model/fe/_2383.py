...
class OptionsWhenExternalFEFileAlreadyExists(_0.APIBase):
    ...
    class _Cast_OptionsWhenExternalFEFileAlreadyExists:
        ...
        def __init__(self, parent: 'OptionsWhenExternalFEFileAlreadyExists'):
            self._parent = parent

        @property
        def options_when_external_fe_file_already_exists(self) -> 'OptionsWhenExternalFEFileAlreadyExists':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'OptionsWhenExternalFEFileAlreadyExists._Cast_OptionsWhenExternalFEFileAlreadyExists':
