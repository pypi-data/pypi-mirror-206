...
class MassDiscModalAnalysisAtAStiffness(_4953.VirtualComponentModalAnalysisAtAStiffness):
    """MassDiscModalAnalysisAtAStiffness
    ...
    class _Cast_MassDiscModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'MassDiscModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def mass_disc_modal_analysis_at_a_stiffness(self) -> 'MassDiscModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MassDiscModalAnalysisAtAStiffness._Cast_MassDiscModalAnalysisAtAStiffness':
