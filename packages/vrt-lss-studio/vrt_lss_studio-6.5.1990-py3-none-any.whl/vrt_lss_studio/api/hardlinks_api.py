...
class HardlinksApi(object):
    ...
    @validate_arguments
    def create_hardlink(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_hardlink : Annotated[WebHardlink, Field(..., description="New essence creation request.")], **kwargs) -> WebHardlink:  # noqa: E501
    ...
    @validate_arguments
    def create_hardlink_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_hardlink : Annotated[WebHardlink, Field(..., description="New essence creation request.")], **kwargs):  # noqa: E501
        """Create hardlink  # noqa: E501
    ...
    @validate_arguments
    def delete_hardlink(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_hardlink_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs):  # noqa: E501
        """Remove hardlink  # noqa: E501
    ...
    @validate_arguments
    def read_hardlink(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> WebHardlink:  # noqa: E501
    ...
    @validate_arguments
    def read_hardlink_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs):  # noqa: E501
        """Read hardlink  # noqa: E501
    ...
    @validate_arguments
    def read_hardlinks_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], offset : Annotated[Optional[conint(strict=True, le=10000000, ge=0)], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[conint(strict=True, le=10000000, ge=1)], Field(description="The number of items to return.")] = None, sort_field : Annotated[Optional[TableHardlinkColumnType], Field(description="Hardlink table column name. ")] = None, sort_direction : Annotated[Optional[StrictStr], Field(description="Sort direction.")] = None, table_hardlink_filter_list : Annotated[Optional[TableHardlinkFilterList], Field(description="Hardlinks filter.")] = None, **kwargs):  # noqa: E501
        """List hardlinks  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['table_hardlink_filter_list']:
    ...
    @validate_arguments
    def update_hardlink(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_hardlink : Annotated[WebHardlink, Field(..., description="Essence update request.")], **kwargs) -> WebHardlink:  # noqa: E501
    ...
    @validate_arguments
    def update_hardlink_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_hardlink : Annotated[WebHardlink, Field(..., description="Essence update request.")], **kwargs):  # noqa: E501
        """Update hardlink  # noqa: E501
