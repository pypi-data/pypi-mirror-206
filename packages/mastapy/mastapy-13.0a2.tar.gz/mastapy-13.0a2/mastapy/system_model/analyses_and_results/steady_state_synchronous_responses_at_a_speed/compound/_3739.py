...
class ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed(_3629.BevelGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_compound_steady_state_synchronous_response_at_a_speed(self) -> 'ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3612.ZerolBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3612.ZerolBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed._Cast_ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed(self)
