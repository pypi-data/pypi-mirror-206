...
class BevelDifferentialPlanetGearAdvancedSystemDeflection(_7246.BevelDifferentialGearAdvancedSystemDeflection):
    """BevelDifferentialPlanetGearAdvancedSystemDeflection
    ...
    class _Cast_BevelDifferentialPlanetGearAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'BevelDifferentialPlanetGearAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def bevel_differential_planet_gear_advanced_system_deflection(self) -> 'BevelDifferentialPlanetGearAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialPlanetGearAdvancedSystemDeflection._Cast_BevelDifferentialPlanetGearAdvancedSystemDeflection':
