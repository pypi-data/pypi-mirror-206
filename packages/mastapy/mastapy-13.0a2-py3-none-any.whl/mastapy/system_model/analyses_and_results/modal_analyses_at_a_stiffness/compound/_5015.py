...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5013, _5014, _5020
...
class FaceGearSetCompoundModalAnalysisAtAStiffness(_5020.GearSetCompoundModalAnalysisAtAStiffness):
    """FaceGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4886.FaceGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def face_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5013.FaceGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def face_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5014.FaceGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4886.FaceGearSetModalAnalysisAtAStiffness]':
