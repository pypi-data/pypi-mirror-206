...
class CustomFilterCollection (SpireObject) :
    ...
    def GetEnumerator(self)->'IEnumerator':
        ...
        intPtr = GetDllLibXls().CustomFilterCollection_GetEnumerator(self.Ptr)
    ...
    def Clear(self):
        ...
        GetDllLibXls().CustomFilterCollection_Clear(self.Ptr)
    ...
    def Capacity(self)->int:
        ...
        ret = GetDllLibXls().CustomFilterCollection_get_Capacity(self.Ptr)
        return ret

    @Capacity.setter
    def Capacity(self, value:int):
        GetDllLibXls().CustomFilterCollection_set_Capacity.argtypes=[c_void_p, c_int]
        GetDllLibXls().CustomFilterCollection_set_Capacity(self.Ptr, value)
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().CustomFilterCollection_get_Count(self.Ptr)
        return ret
    ...
    def RelationShip(self)->'RelationShip':
        ...
        ret = GetDllLibXls().CustomFilterCollection_get_RelationShip(self.Ptr)
    ...
    def RelationShip(self, value:'RelationShip'):
        ...
        GetDllLibXls().CustomFilterCollection_set_RelationShip(self.Ptr, value.value)
    ...
    def Add(self ,customFilter:'CustomFilter'):
        ...
        GetDllLibXls().CustomFilterCollection_Add(self.Ptr, intPtrcustomFilter)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().CustomFilterCollection_get_Item(self.Ptr, index)
    ...
    def GetByIndex(self ,index:int)->'CustomFilter':
        ...
        intPtr = GetDllLibXls().CustomFilterCollection_GetByIndex(self.Ptr, index)
        ret = None if intPtr==None else CustomFilter(intPtr)
        return ret
