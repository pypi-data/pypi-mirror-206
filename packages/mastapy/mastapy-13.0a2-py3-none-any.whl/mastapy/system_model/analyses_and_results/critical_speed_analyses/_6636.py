...
class ZerolBevelGearCriticalSpeedAnalysis(_6524.BevelGearCriticalSpeedAnalysis):
    """ZerolBevelGearCriticalSpeedAnalysis
    ...
    class _Cast_ZerolBevelGearCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_critical_speed_analysis(self) -> 'ZerolBevelGearCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearCriticalSpeedAnalysis._Cast_ZerolBevelGearCriticalSpeedAnalysis':
