...
class BoltedJointCompoundHarmonicAnalysis(_5944.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """BoltedJointCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5668.BoltedJointHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5668.BoltedJointHarmonicAnalysis]':
