...
class UnbalancedMassSystemDeflection(_2814.VirtualComponentSystemDeflection):
    """UnbalancedMassSystemDeflection
    ...
    class _Cast_UnbalancedMassSystemDeflection:
        ...
        def __init__(self, parent: 'UnbalancedMassSystemDeflection'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_system_deflection(self) -> 'UnbalancedMassSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4134.UnbalancedMassPowerFlow':
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassSystemDeflection._Cast_UnbalancedMassSystemDeflection':
