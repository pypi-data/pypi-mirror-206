...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import (
    _7376, _7378, _7381, _7388,
    _7387, _7409, _7389, _7394,
    _7399, _7411, _7413, _7417,
    _7424, _7423, _7425, _7432,
    _7439, _7442, _7443, _7444,
    _7446, _7448, _7453, _7454,
    _7455, _7457, _7459, _7464,
    _7463, _7469, _7470, _7475,
    _7478, _7481, _7485, _7489,
    _7493, _7496, _7368
)
...
class AssemblyCompoundAdvancedSystemDeflection(_7368.AbstractAssemblyCompoundAdvancedSystemDeflection):
    """AssemblyCompoundAdvancedSystemDeflection
    ...
    class _Cast_AssemblyCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'AssemblyCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def assembly_compound_advanced_system_deflection(self) -> 'AssemblyCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7242.AssemblyAdvancedSystemDeflection]':
    ...
    @property
    def bearings(self) -> 'List[_7376.BearingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_7378.BeltDriveCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_7381.BevelDifferentialGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_7388.BoltedJointCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_7387.BoltCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_7409.CVTCompoundAdvancedSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_7389.ClutchCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_7394.ConceptCouplingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_7399.ConceptGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_7411.CycloidalAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_7413.CycloidalDiscCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_7417.CylindricalGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_7424.FEPartCompoundAdvancedSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_7423.FaceGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_7425.FlexiblePinAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_7432.HypoidGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7439.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7442.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_7443.MassDiscCompoundAdvancedSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_7444.MeasurementComponentCompoundAdvancedSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_7446.OilSealCompoundAdvancedSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7448.PartToPartShearCouplingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7453.PlanetCarrierCompoundAdvancedSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_7454.PointLoadCompoundAdvancedSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_7455.PowerLoadCompoundAdvancedSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_7457.RingPinsCompoundAdvancedSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7459.RollingRingAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7464.ShaftHubConnectionCompoundAdvancedSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_7463.ShaftCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7469.SpiralBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7470.SpringDamperCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7475.StraightBevelDiffGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7478.StraightBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_7481.SynchroniserCompoundAdvancedSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_7485.TorqueConverterCompoundAdvancedSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7489.UnbalancedMassCompoundAdvancedSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7493.WormGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7496.ZerolBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7242.AssemblyAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'AssemblyCompoundAdvancedSystemDeflection._Cast_AssemblyCompoundAdvancedSystemDeflection':
