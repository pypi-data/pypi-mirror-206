...
class ZerolBevelGearLoadCase(_6792.BevelGearLoadCase):
    """ZerolBevelGearLoadCase
    ...
    class _Cast_ZerolBevelGearLoadCase:
        ...
        def __init__(self, parent: 'ZerolBevelGearLoadCase'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_load_case(self) -> 'ZerolBevelGearLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearLoadCase._Cast_ZerolBevelGearLoadCase':
