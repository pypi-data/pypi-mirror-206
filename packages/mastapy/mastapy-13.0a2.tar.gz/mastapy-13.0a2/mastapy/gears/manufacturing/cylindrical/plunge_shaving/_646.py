...
class PlungeShaverOutputs(_0.APIBase):
    ...
    class _Cast_PlungeShaverOutputs:
        ...
        def __init__(self, parent: 'PlungeShaverOutputs'):
            self._parent = parent

        @property
        def real_plunge_shaver_outputs(self):
            from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _649
            
            return self._parent._cast(_649.RealPlungeShaverOutputs)

        @property
        def virtual_plunge_shaver_outputs(self):
            from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _652
            
            return self._parent._cast(_652.VirtualPlungeShaverOutputs)

        @property
        def plunge_shaver_outputs(self) -> 'PlungeShaverOutputs':
            return self._parent
    ...
    @property
    def calculation_details(self) -> '_644.PlungeShaverGeneration':
    ...
    @property
    def cast_to(self) -> 'PlungeShaverOutputs._Cast_PlungeShaverOutputs':
