...
Example: 1"""
    ...
    parameter_criteria = fields.List(fields.Nested("netapp_ontap.models.ems_filter_response_records_rules_parameter_criteria.EmsFilterResponseRecordsRulesParameterCriteriaSchema", unknown=EXCLUDE), data_key="parameter_criteria")
