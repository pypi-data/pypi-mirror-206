...
class AGMAGleasonConicalGearCriticalSpeedAnalysis(_6540.ConicalGearCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearCriticalSpeedAnalysis
    ...
    class _Cast_AGMAGleasonConicalGearCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_critical_speed_analysis(self) -> 'AGMAGleasonConicalGearCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearCriticalSpeedAnalysis._Cast_AGMAGleasonConicalGearCriticalSpeedAnalysis':
