...
class WormGearAdvancedSystemDeflection(_7295.GearAdvancedSystemDeflection):
    """WormGearAdvancedSystemDeflection
    ...
    class _Cast_WormGearAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'WormGearAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def worm_gear_advanced_system_deflection(self) -> 'WormGearAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_detailed_analysis(self) -> '_370.WormGearRating':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2817.WormGearSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'WormGearAdvancedSystemDeflection._Cast_WormGearAdvancedSystemDeflection':
