...
from heaserver.service.runner import client_session_cleanup_ctx
...
from heaserver.service.testcase.collection import CollectionKey, convert_to_collection_keys, validate_collection_keys
...
def run(project_slug: str,
        desktop_objects: Mapping[str, List[HEAObjectDict]] | Mapping[CollectionKey, List[HEAObjectDict]],
        routes: Iterable[Tuple[Callable, str, Callable]],
        content: Mapping[str, Mapping[str, bytes]] | Mapping[CollectionKey, Mapping[str, bytes]] | None = None,
