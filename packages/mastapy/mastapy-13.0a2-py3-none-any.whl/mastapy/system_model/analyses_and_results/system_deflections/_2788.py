...
class SpiralBevelGearSystemDeflection(_2687.BevelGearSystemDeflection):
    """SpiralBevelGearSystemDeflection
    ...
    class _Cast_SpiralBevelGearSystemDeflection:
        ...
        def __init__(self, parent: 'SpiralBevelGearSystemDeflection'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_system_deflection(self) -> 'SpiralBevelGearSystemDeflection':
            return self._parent
    ...
    @property
    def component_detailed_analysis(self) -> '_399.SpiralBevelGearRating':
    ...
    @property
    def power_flow_results(self) -> '_4112.SpiralBevelGearPowerFlow':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearSystemDeflection._Cast_SpiralBevelGearSystemDeflection':
