...
class CylindricalGearCompoundModalAnalysisAtASpeed(_5276.GearCompoundModalAnalysisAtASpeed):
    """CylindricalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5137.CylindricalGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5137.CylindricalGearModalAnalysisAtASpeed]':
