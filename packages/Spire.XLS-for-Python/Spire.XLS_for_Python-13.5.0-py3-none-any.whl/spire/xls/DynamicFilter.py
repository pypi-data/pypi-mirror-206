...
class DynamicFilter (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().DynamicFilter_get_DynamicFilterType(self.Ptr)
    ...
    def DynamicFilterType(self, value:'DynamicFilterType'):
        ...
        GetDllLibXls().DynamicFilter_set_DynamicFilterType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().DynamicFilter_get_Value(self.Ptr)
    ...
    def Value(self, value:'SpireObject'):
        ...
        GetDllLibXls().DynamicFilter_set_Value(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().DynamicFilter_get_MaxValue(self.Ptr)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    def MaxValue(self, value:'SpireObject'):
        ...
        GetDllLibXls().DynamicFilter_set_MaxValue(self.Ptr, value.Ptr)
