...
class ResultLocationSelectionGroups(_0.APIBase):
    ...
    class _Cast_ResultLocationSelectionGroups:
        ...
        def __init__(self, parent: 'ResultLocationSelectionGroups'):
            self._parent = parent

        @property
        def result_location_selection_groups(self) -> 'ResultLocationSelectionGroups':
            return self._parent
    ...
    def display_location_selection(self) -> 'ResultLocationSelectionGroups.DisplayLocationSelectionOption':
        ...
        value = conversion.pn_to_mp_enum(temp, ResultLocationSelectionGroups.DisplayLocationSelectionOption)
    ...
    def display_location_selection(self, value: 'ResultLocationSelectionGroups.DisplayLocationSelectionOption'):
        ...
        value = conversion.mp_to_pn_enum(value, ResultLocationSelectionGroups.DisplayLocationSelectionOption.type_())
    ...
    @property
    def selected_result_location_group(self) -> '_5818.ResultLocationSelectionGroup':
    ...
    @property
    def result_location_groups(self) -> 'List[_5818.ResultLocationSelectionGroup]':
    ...
    @property
    def cast_to(self) -> 'ResultLocationSelectionGroups._Cast_ResultLocationSelectionGroups':
