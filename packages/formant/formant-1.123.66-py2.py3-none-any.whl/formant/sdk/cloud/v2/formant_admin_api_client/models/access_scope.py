...
from ..models.access_scope_types_item import AccessScopeTypesItem
...
class AccessScope:
    """
    Attributes:
        datapoints (Union[Unset, None, ScopeFilter]):
        ...
        types (Union[Unset, List[AccessScopeTypesItem]]):
    ...
    datapoints: Union[Unset, None, "ScopeFilter"] = UNSET
    ...
    types: Union[Unset, List[AccessScopeTypesItem]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        datapoints: Union[Unset, None, Dict[str, Any]] = UNSET
        if not isinstance(self.datapoints, Unset):
            datapoints = self.datapoints.to_dict() if self.datapoints else None
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        datapoints: Union[Unset, None, ScopeFilter]
        if _datapoints is None:
            datapoints = None
        elif isinstance(_datapoints, Unset):
            datapoints = UNSET
        else:
            datapoints = ScopeFilter.from_dict(_datapoints)
        ...
        for types_item_data in _types or []:
            types_item = AccessScopeTypesItem(types_item_data)
