...
class Top10Filter (SpireObject) :
    ...
    def IsTop(self)->bool:
        ...
        ret = GetDllLibXls().Top10Filter_get_IsTop(self.Ptr)
        return ret

    @IsTop.setter
    def IsTop(self, value:bool):
        GetDllLibXls().Top10Filter_set_IsTop.argtypes=[c_void_p, c_bool]
        GetDllLibXls().Top10Filter_set_IsTop(self.Ptr, value)
    ...
    def IsPercent(self)->bool:
        ...
        ret = GetDllLibXls().Top10Filter_get_IsPercent(self.Ptr)
        return ret

    @IsPercent.setter
    def IsPercent(self, value:bool):
        GetDllLibXls().Top10Filter_set_IsPercent.argtypes=[c_void_p, c_bool]
        GetDllLibXls().Top10Filter_set_IsPercent(self.Ptr, value)
    ...
    def Items(self)->int:
        ...
        ret = GetDllLibXls().Top10Filter_get_Items(self.Ptr)
        return ret

    @Items.setter
    def Items(self, value:int):
        GetDllLibXls().Top10Filter_set_Items.argtypes=[c_void_p, c_int]
        GetDllLibXls().Top10Filter_set_Items(self.Ptr, value)
    ...
    def Criteria(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().Top10Filter_get_Criteria(self.Ptr)
    ...
    def Criteria(self, value:'SpireObject'):
        ...
        GetDllLibXls().Top10Filter_set_Criteria(self.Ptr, value.Ptr)
