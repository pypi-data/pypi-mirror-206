...
class BevelGearSetSteadyStateSynchronousResponseOnAShaft(_3229.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseOnAShaft):
    """BevelGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_BevelGearSetSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'BevelGearSetSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def bevel_gear_set_steady_state_synchronous_response_on_a_shaft(self) -> 'BevelGearSetSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearSetSteadyStateSynchronousResponseOnAShaft._Cast_BevelGearSetSteadyStateSynchronousResponseOnAShaft':
