...
class CouplingCompoundSystemDeflection(_2930.SpecialisedAssemblyCompoundSystemDeflection):
    """CouplingCompoundSystemDeflection
    ...
    class _Cast_CouplingCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'CouplingCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def coupling_compound_system_deflection(self) -> 'CouplingCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2710.CouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2710.CouplingSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'CouplingCompoundSystemDeflection._Cast_CouplingCompoundSystemDeflection':
