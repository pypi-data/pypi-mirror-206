...
class WormGearMeshCompoundModalAnalysisAtAStiffness(_5019.GearMeshCompoundModalAnalysisAtAStiffness):
    """WormGearMeshCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_WormGearMeshCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'WormGearMeshCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def worm_gear_mesh_compound_modal_analysis_at_a_stiffness(self) -> 'WormGearMeshCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4954.WormGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4954.WormGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'WormGearMeshCompoundModalAnalysisAtAStiffness._Cast_WormGearMeshCompoundModalAnalysisAtAStiffness':
