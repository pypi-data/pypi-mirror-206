...
class BoltedJointModalAnalysis(_4655.SpecialisedAssemblyModalAnalysis):
    """BoltedJointModalAnalysis
    ...
    class _Cast_BoltedJointModalAnalysis:
        ...
        def __init__(self, parent: 'BoltedJointModalAnalysis'):
            self._parent = parent
        ...
        @property
        def bolted_joint_modal_analysis(self) -> 'BoltedJointModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltedJointModalAnalysis._Cast_BoltedJointModalAnalysis':
