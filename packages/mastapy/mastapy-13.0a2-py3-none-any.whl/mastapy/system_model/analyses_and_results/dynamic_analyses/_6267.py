...
class CoaxialConnectionDynamicAnalysis(_6341.ShaftToMountableComponentConnectionDynamicAnalysis):
    """CoaxialConnectionDynamicAnalysis
    ...
    class _Cast_CoaxialConnectionDynamicAnalysis:
        ...
        def __init__(self, parent: 'CoaxialConnectionDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def coaxial_connection_dynamic_analysis(self) -> 'CoaxialConnectionDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CoaxialConnectionDynamicAnalysis._Cast_CoaxialConnectionDynamicAnalysis':
