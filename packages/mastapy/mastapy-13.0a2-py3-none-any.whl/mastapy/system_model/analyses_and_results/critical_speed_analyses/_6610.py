...
class SpiralBevelGearMeshCriticalSpeedAnalysis(_6525.BevelGearMeshCriticalSpeedAnalysis):
    """SpiralBevelGearMeshCriticalSpeedAnalysis
    ...
    class _Cast_SpiralBevelGearMeshCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_critical_speed_analysis(self) -> 'SpiralBevelGearMeshCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshCriticalSpeedAnalysis._Cast_SpiralBevelGearMeshCriticalSpeedAnalysis':
