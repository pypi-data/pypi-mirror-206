...
from .sch_models import (ActionAudits, AdminTool, Alert, ApiCredentialBuilder, ApiCredentials,
                         ...
                         LegacyDeployments, LoginAudits, MeteringUsage, OrganizationBuilder, Organizations, Pipeline,
...
class ControlHub:
    ...
    def start_job_template(self, job_template, name=None, description=None, attach_to_template=True,
                           ...
                           wait_for_data_collectors=False, inherit_permissions=False, wait=True):
        ...
        jobs_reponse = self.api_client.create_and_start_job_instances(
        ...
        if engine_config['jvmConfig']:
            ...
            jvm_config = {'jvmMinMemory': requested_jvm_config.get('jvmMinMemory', None) or 1024,
                          ...
                          'memoryConfigStrategy': requested_jvm_config.get('memoryConfigStrategy', None) or
                                                  'PERCENTAGE'}
        # Fill up stage_libs: default_stage_libs logic as defined at https://git.io/JDuwM
