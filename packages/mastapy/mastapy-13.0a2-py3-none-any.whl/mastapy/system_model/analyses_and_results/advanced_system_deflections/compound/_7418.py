...
class CylindricalPlanetGearCompoundAdvancedSystemDeflection(_7415.CylindricalGearCompoundAdvancedSystemDeflection):
    """CylindricalPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7287.CylindricalPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7287.CylindricalPlanetGearAdvancedSystemDeflection]':
