...
T = TypeVar("T", bound="AccountsLinkProduct")


@attr.s(auto_attribs=True)
class AccountsLinkProduct:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accounts_link_product = cls(
            refreshed_at=refreshed_at,
            last_attempted_at=last_attempted_at,
        )

        accounts_link_product.additional_properties = d
        return accounts_link_product
