...
class SynchroniserHalfMultibodyDynamicsAnalysis(_5476.SynchroniserPartMultibodyDynamicsAnalysis):
    """SynchroniserHalfMultibodyDynamicsAnalysis
    ...
    class _Cast_SynchroniserHalfMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserHalfMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_half_multibody_dynamics_analysis(self) -> 'SynchroniserHalfMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserHalfMultibodyDynamicsAnalysis._Cast_SynchroniserHalfMultibodyDynamicsAnalysis':
