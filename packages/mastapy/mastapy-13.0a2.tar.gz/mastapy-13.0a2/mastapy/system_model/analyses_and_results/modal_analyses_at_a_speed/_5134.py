...
class CycloidalDiscModalAnalysisAtASpeed(_5090.AbstractShaftModalAnalysisAtASpeed):
    """CycloidalDiscModalAnalysisAtASpeed
    ...
    class _Cast_CycloidalDiscModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'CycloidalDiscModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_modal_analysis_at_a_speed(self) -> 'CycloidalDiscModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscModalAnalysisAtASpeed._Cast_CycloidalDiscModalAnalysisAtASpeed':
