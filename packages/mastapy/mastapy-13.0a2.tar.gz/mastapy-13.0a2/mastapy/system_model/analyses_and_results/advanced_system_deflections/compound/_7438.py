...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection(_7435.KlingelnbergCycloPalloidConicalGearMeshCompoundAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_mesh_compound_advanced_system_deflection(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7307.KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7307.KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection._Cast_KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection(self)
