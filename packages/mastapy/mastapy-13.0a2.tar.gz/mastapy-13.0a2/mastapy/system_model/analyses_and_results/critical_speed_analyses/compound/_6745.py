...
class StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis(_6656.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis
    ...
    class _Cast_StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_mesh_compound_critical_speed_analysis(self) -> 'StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6616.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6616.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis._Cast_StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis':
