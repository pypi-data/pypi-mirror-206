...
class KlingelnbergCycloPalloidSpiralBevelGearRating(_408.KlingelnbergCycloPalloidConicalGearRating):
    """KlingelnbergCycloPalloidSpiralBevelGearRating
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> '_968.KlingelnbergCycloPalloidSpiralBevelGearDesign':
