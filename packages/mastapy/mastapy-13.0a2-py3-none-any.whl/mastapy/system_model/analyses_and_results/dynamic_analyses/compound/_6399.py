...
class ConceptCouplingCompoundDynamicAnalysis(_6410.CouplingCompoundDynamicAnalysis):
    """ConceptCouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6270.ConceptCouplingDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6270.ConceptCouplingDynamicAnalysis]':
