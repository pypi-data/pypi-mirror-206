...
class ConicalGearSetCompoundModalAnalysisAtASpeed(_5278.GearSetCompoundModalAnalysisAtASpeed):
    """ConicalGearSetCompoundModalAnalysisAtASpeed
    ...
    class _Cast_ConicalGearSetCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ConicalGearSetCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def conical_gear_set_compound_modal_analysis_at_a_speed(self) -> 'ConicalGearSetCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5123.ConicalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5123.ConicalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ConicalGearSetCompoundModalAnalysisAtASpeed._Cast_ConicalGearSetCompoundModalAnalysisAtASpeed':
