...
class AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness(_4865.ConnectionModalAnalysisAtAStiffness):
    """AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness
    ...
    class _Cast_AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def abstract_shaft_to_mountable_component_connection_modal_analysis_at_a_stiffness(self) -> 'AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness._Cast_AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness':
        return self._Cast_AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness(self)
