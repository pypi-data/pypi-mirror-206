...
class CylindricalCutterSimulatableGear(_0.APIBase):
    ...
    class _Cast_CylindricalCutterSimulatableGear:
        ...
        def __init__(self, parent: 'CylindricalCutterSimulatableGear'):
            self._parent = parent

        @property
        def cylindrical_cutter_simulatable_gear(self) -> 'CylindricalCutterSimulatableGear':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalCutterSimulatableGear._Cast_CylindricalCutterSimulatableGear':
