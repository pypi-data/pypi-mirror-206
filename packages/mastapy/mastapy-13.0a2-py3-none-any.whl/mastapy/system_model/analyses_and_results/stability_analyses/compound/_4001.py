...
class ZerolBevelGearMeshCompoundStabilityAnalysis(_3891.BevelGearMeshCompoundStabilityAnalysis):
    """ZerolBevelGearMeshCompoundStabilityAnalysis
    ...
    class _Cast_ZerolBevelGearMeshCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearMeshCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_mesh_compound_stability_analysis(self) -> 'ZerolBevelGearMeshCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3871.ZerolBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3871.ZerolBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearMeshCompoundStabilityAnalysis._Cast_ZerolBevelGearMeshCompoundStabilityAnalysis':
