...
class SpiralBevelGearSteadyStateSynchronousResponseAtASpeed(_3501.BevelGearSteadyStateSynchronousResponseAtASpeed):
    """SpiralBevelGearSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_SpiralBevelGearSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'SpiralBevelGearSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_steady_state_synchronous_response_at_a_speed(self) -> 'SpiralBevelGearSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearSteadyStateSynchronousResponseAtASpeed._Cast_SpiralBevelGearSteadyStateSynchronousResponseAtASpeed':
