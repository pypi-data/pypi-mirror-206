...
class CylindricalGearFilletNodeStressResultsColumn(_833.GearFilletNodeStressResultsColumn):
    """CylindricalGearFilletNodeStressResultsColumn
    ...
    class _Cast_CylindricalGearFilletNodeStressResultsColumn:
        ...
        def gear_fillet_node_stress_results_column(self):
            return self._parent._cast(_833.GearFilletNodeStressResultsColumn)
