...
class ScuffingResultsRow(_0.APIBase):
    ...
    class _Cast_ScuffingResultsRow:
        ...
        def agma_scuffing_results_row(self):
            from mastapy.gears.rating.cylindrical import _447
            
            return self._parent._cast(_447.AGMAScuffingResultsRow)

        @property
        def iso_scuffing_results_row(self):
            from mastapy.gears.rating.cylindrical import _470
            
            return self._parent._cast(_470.ISOScuffingResultsRow)
    ...
    @property
    def pinion(self) -> '_480.ScuffingResultsRowGear':
