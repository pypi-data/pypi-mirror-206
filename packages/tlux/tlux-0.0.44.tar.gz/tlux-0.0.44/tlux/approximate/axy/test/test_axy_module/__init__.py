...
_shared_object_name = "test_axy_module." + platform.machine() + ".so"
...
_ordered_dependencies = ['axy_random.f90', 'axy_matrix_operations.f90', 'axy_sort_and_select.f90', 'axy.f90', 'test_axy_module_c_wrapper.f90']
_symbol_files = []# 
# --------------------------------------------------------------------
#               AUTO-COMPILING
#
