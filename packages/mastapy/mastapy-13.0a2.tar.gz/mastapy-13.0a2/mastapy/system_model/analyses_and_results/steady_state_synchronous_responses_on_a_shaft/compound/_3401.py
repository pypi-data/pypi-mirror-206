...
class CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft(_3412.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    """CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3273.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3273.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft._Cast_CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft(self)
