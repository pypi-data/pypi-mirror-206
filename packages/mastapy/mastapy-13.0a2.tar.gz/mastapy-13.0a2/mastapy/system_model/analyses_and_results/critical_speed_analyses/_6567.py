...
class FlexiblePinAssemblyCriticalSpeedAnalysis(_6608.SpecialisedAssemblyCriticalSpeedAnalysis):
    """FlexiblePinAssemblyCriticalSpeedAnalysis
    ...
    class _Cast_FlexiblePinAssemblyCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'FlexiblePinAssemblyCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def flexible_pin_assembly_critical_speed_analysis(self) -> 'FlexiblePinAssemblyCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FlexiblePinAssemblyCriticalSpeedAnalysis._Cast_FlexiblePinAssemblyCriticalSpeedAnalysis':
