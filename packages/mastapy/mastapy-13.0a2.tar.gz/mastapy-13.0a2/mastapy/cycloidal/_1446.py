...
from mastapy.cycloidal import _1440, _1447
...
class CycloidalDiscModificationsSpecification(_0.APIBase):
    ...
    @property
    def crowning_specification_method(self) -> '_1440.CrowningSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _1440.CrowningSpecificationMethod)
        return constructor.new_from_mastapy_type(_1440.CrowningSpecificationMethod)(value) if value is not None else None

    @crowning_specification_method.setter
    def crowning_specification_method(self, value: '_1440.CrowningSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1440.CrowningSpecificationMethod.type_())
        self.wrapped.CrowningSpecificationMethod = value

    @property
    def direction_of_measured_modifications(self) -> '_1447.DirectionOfMeasuredModifications':
        ...
        value = conversion.pn_to_mp_enum(temp, _1447.DirectionOfMeasuredModifications)
        return constructor.new_from_mastapy_type(_1447.DirectionOfMeasuredModifications)(value) if value is not None else None

    @direction_of_measured_modifications.setter
    def direction_of_measured_modifications(self, value: '_1447.DirectionOfMeasuredModifications'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1447.DirectionOfMeasuredModifications.type_())
    ...
    @property
    def measured_profile_modification(self) -> '_1523.Vector2DListAccessor':
    ...
    def measured_profile_modification(self, value: '_1523.Vector2DListAccessor'):
