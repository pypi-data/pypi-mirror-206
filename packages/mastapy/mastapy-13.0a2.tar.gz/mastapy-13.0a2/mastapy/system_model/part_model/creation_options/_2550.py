...
class BeltCreationOptions(_0.APIBase):
    ...
    class _Cast_BeltCreationOptions:
        ...
        def __init__(self, parent: 'BeltCreationOptions'):
            self._parent = parent

        @property
        def belt_creation_options(self) -> 'BeltCreationOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BeltCreationOptions._Cast_BeltCreationOptions':
        return self._Cast_BeltCreationOptions(self)
