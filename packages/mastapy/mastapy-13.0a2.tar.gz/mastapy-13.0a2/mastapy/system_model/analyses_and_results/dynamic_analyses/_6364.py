...
class TorqueConverterTurbineDynamicAnalysis(_6282.CouplingHalfDynamicAnalysis):
    """TorqueConverterTurbineDynamicAnalysis
    ...
    class _Cast_TorqueConverterTurbineDynamicAnalysis:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_dynamic_analysis(self) -> 'TorqueConverterTurbineDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineDynamicAnalysis._Cast_TorqueConverterTurbineDynamicAnalysis':
