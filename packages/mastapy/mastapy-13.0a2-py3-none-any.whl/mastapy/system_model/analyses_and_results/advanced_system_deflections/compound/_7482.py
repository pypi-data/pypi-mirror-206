...
class SynchroniserHalfCompoundAdvancedSystemDeflection(_7483.SynchroniserPartCompoundAdvancedSystemDeflection):
    """SynchroniserHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7352.SynchroniserHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7352.SynchroniserHalfAdvancedSystemDeflection]':
