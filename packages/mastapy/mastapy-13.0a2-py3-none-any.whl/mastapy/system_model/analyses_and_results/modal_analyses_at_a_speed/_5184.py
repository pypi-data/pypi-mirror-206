...
class ShaftHubConnectionModalAnalysisAtASpeed(_5125.ConnectorModalAnalysisAtASpeed):
    """ShaftHubConnectionModalAnalysisAtASpeed
    ...
    class _Cast_ShaftHubConnectionModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ShaftHubConnectionModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def shaft_hub_connection_modal_analysis_at_a_speed(self) -> 'ShaftHubConnectionModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftHubConnectionModalAnalysisAtASpeed._Cast_ShaftHubConnectionModalAnalysisAtASpeed':
