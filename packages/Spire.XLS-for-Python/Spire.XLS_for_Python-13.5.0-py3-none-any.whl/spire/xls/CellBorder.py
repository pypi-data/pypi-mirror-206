...
#        ret = GetDllLibXls().CellBorder_GetThemeColor(self.Ptr, intPtrtype,intPtrtint)
#        return ret
    ...
    def SetThemeColor(self ,type:'ThemeColorType',tint:float):
        ...
        GetDllLibXls().CellBorder_SetThemeColor(self.Ptr, enumtype,tint)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellBorder_get_KnownColor(self.Ptr)
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().CellBorder_set_KnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellBorder_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().CellBorder_set_Color(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellBorder_get_OColor(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellBorder_get_LineStyle(self.Ptr)
    ...
    def LineStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().CellBorder_set_LineStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellBorder_get_ShowDiagonalLine(self.Ptr)
        return ret
    ...
    def ShowDiagonalLine(self, value:bool):
        ...
        GetDllLibXls().CellBorder_set_ShowDiagonalLine(self.Ptr, value)
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().CellBorder_get_Parent(self.Ptr)
    ...
    <param name="baseBorder">source border.</param>
        ...
        GetDllLibXls().CellBorder_CopyFrom(self.Ptr, intPtrsrcBorder)
