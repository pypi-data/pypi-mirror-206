...
class ConicalMeshMisalignments(_0.APIBase):
    ...
    class _Cast_ConicalMeshMisalignments:
        ...
        def __init__(self, parent: 'ConicalMeshMisalignments'):
            self._parent = parent

        @property
        def conical_mesh_misalignments(self) -> 'ConicalMeshMisalignments':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConicalMeshMisalignments._Cast_ConicalMeshMisalignments':
