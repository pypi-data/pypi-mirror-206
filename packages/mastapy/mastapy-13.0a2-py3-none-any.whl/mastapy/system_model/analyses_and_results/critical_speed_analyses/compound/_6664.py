...
class ComponentCompoundCriticalSpeedAnalysis(_6718.PartCompoundCriticalSpeedAnalysis):
    """ComponentCompoundCriticalSpeedAnalysis
    ...
    class _Cast_ComponentCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ComponentCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def component_compound_critical_speed_analysis(self) -> 'ComponentCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6533.ComponentCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6533.ComponentCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ComponentCompoundCriticalSpeedAnalysis._Cast_ComponentCompoundCriticalSpeedAnalysis':
