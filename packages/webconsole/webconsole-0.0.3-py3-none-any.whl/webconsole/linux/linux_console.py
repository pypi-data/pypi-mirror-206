...
<script>
    ...
    let socket = new WebSocket('ws://127.0.0.1:8000/ws/linux?address=10.161.238.19&user=rbadmin_app1');
    term.attach(socket);
...
async def websocket_endpoint(websocket: WebSocket, address: str, user: str, passwd=None):
