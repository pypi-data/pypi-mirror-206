...
class FaceGearModalAnalysisAtAStiffness(_4890.GearModalAnalysisAtAStiffness):
    """FaceGearModalAnalysisAtAStiffness
    ...
    class _Cast_FaceGearModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'FaceGearModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def face_gear_modal_analysis_at_a_stiffness(self) -> 'FaceGearModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearModalAnalysisAtAStiffness._Cast_FaceGearModalAnalysisAtAStiffness':
