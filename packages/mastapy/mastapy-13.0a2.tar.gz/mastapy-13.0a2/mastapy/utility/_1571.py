...
class FileHistory(_0.APIBase):
    ...
    class _Cast_FileHistory:
        ...
        def __init__(self, parent: 'FileHistory'):
            self._parent = parent
    ...
    @property
    def items(self) -> 'List[_1572.FileHistoryItem]':
    ...
    def add_file_history_item(self, item: '_1572.FileHistoryItem'):
    ...
    def create_history_item(self, user_name: 'str', comment: 'str') -> '_1572.FileHistoryItem':
    ...
    @property
    def cast_to(self) -> 'FileHistory._Cast_FileHistory':
