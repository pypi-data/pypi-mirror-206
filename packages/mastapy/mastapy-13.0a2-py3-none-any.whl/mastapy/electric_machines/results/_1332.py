...
class NonLinearDQModelSettings(_0.APIBase):
    ...
    class _Cast_NonLinearDQModelSettings:
        """Special nested class for casting NonLinearDQModelSettings to subclasses."""

        def __init__(self, parent: 'NonLinearDQModelSettings'):
            self._parent = parent

        @property
        def non_linear_dq_model_settings(self) -> 'NonLinearDQModelSettings':
            return self._parent
    ...
    @property
    def exponent_for_ac_winding_loss_temperature_scaling(self) -> 'float':
        """float: 'ExponentForACWindingLossTemperatureScaling' is the original name of this property."""
    ...
    def exponent_for_ac_winding_loss_temperature_scaling(self, value: 'float'):
        self.wrapped.ExponentForACWindingLossTemperatureScaling = float(value) if value else 0.0

    @property
    def include_ac_winding_losses(self) -> 'bool':
        """bool: 'IncludeACWindingLosses' is the original name of this property."""
    ...
    def include_ac_winding_losses(self, value: 'bool'):
        self.wrapped.IncludeACWindingLosses = bool(value) if value else False
    ...
    @property
    def temperatures(self) -> '_1365.Temperatures':
    ...
    @property
    def cast_to(self) -> 'NonLinearDQModelSettings._Cast_NonLinearDQModelSettings':
        return self._Cast_NonLinearDQModelSettings(self)
