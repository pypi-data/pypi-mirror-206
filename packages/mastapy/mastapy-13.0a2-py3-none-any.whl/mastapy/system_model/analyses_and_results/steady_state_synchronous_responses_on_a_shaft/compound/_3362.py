...
class BearingCompoundSteadyStateSynchronousResponseOnAShaft(_3390.ConnectorCompoundSteadyStateSynchronousResponseOnAShaft):
    """BearingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_BearingCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'BearingCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def bearing_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'BearingCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3232.BearingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3232.BearingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'BearingCompoundSteadyStateSynchronousResponseOnAShaft._Cast_BearingCompoundSteadyStateSynchronousResponseOnAShaft':
