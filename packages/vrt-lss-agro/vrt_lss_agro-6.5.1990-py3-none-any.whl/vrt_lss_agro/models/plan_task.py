...
class PlanTask(BaseModel):
    ...
    Initial task.
    """
    crops: conlist(Crop, max_items=201, min_items=1, unique_items=True) = Field(..., description="List of crops.")
    fields: conlist(Field, max_items=20001, min_items=1, unique_items=True) = Field(..., description="List of fields.")
    elevators: Optional[conlist(Elevator, max_items=201, min_items=1, unique_items=True)] = Field(None, description="List of elevators.")
    factories: conlist(Factory, max_items=201, min_items=1, unique_items=True) = Field(..., description="List of factories.")
    markets: Optional[conlist(Market, max_items=201, min_items=1, unique_items=True)] = Field(None, description="List of markets.")
