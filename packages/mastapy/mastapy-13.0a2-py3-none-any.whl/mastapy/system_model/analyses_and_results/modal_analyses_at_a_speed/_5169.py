...
class PartToPartShearCouplingConnectionModalAnalysisAtASpeed(_5126.CouplingConnectionModalAnalysisAtASpeed):
    """PartToPartShearCouplingConnectionModalAnalysisAtASpeed
    ...
    class _Cast_PartToPartShearCouplingConnectionModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingConnectionModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_connection_modal_analysis_at_a_speed(self) -> 'PartToPartShearCouplingConnectionModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingConnectionModalAnalysisAtASpeed._Cast_PartToPartShearCouplingConnectionModalAnalysisAtASpeed':
