...
class CfnDataLakeSettings(
    ...
    def __init__(
        ...
        *,
        ...
        :param allow_external_data_filtering: ``AWS::LakeFormation::DataLakeSettings.AllowExternalDataFiltering``.
        :param authorized_session_tag_value_list: ``AWS::LakeFormation::DataLakeSettings.AuthorizedSessionTagValueList``.
        :param create_database_default_permissions: ``AWS::LakeFormation::DataLakeSettings.CreateDatabaseDefaultPermissions``.
        :param create_table_default_permissions: ``AWS::LakeFormation::DataLakeSettings.CreateTableDefaultPermissions``.
        :param external_data_filtering_allow_list: ``AWS::LakeFormation::DataLakeSettings.ExternalDataFilteringAllowList``.
        :param parameters: ``AWS::LakeFormation::DataLakeSettings.Parameters``.
    ...
    class PrincipalPermissionsProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param permissions: ``CfnDataLakeSettings.PrincipalPermissionsProperty.Permissions``.
            :param principal: ``CfnDataLakeSettings.PrincipalPermissionsProperty.Principal``.
