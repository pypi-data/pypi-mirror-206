...
class ThreadCategory(models.Model):
    ...
    parent = models.ForeignKey(to="self", verbose_name='父类类别', db_column='parent_id', blank=True, null=True, help_text='', on_delete=models.DO_NOTHING)
...
class ThreadClassify(models.Model):
    ...
    name = models.CharField(verbose_name='名称', max_length=255, blank=True, null=True, help_text='')
    show = models.ForeignKey(verbose_name='默认展示ID', to=ThreadShow, db_column='show_id', related_name='+', on_delete=models.DO_NOTHING, null=True, blank=True, help_text='')
    description = models.CharField(verbose_name='描述', max_length=255, blank=True, null=True, help_text='')
    category = models.ForeignKey(verbose_name='所属类别', to=ThreadCategory, db_column='category_id', related_name='+', on_delete=models.DO_NOTHING, blank=True, null=True, help_text='')
    icon = models.CharField(verbose_name='图标', max_length=255, blank=True, null=True, help_text='')
    sort = models.IntegerField(verbose_name="排序", blank=True, null=True, help_text='默认排序为升序')
    parent = models.ForeignKey(to="self", verbose_name='父类分类', db_column='parent_id', blank=True, null=True, help_text='', on_delete=models.DO_NOTHING)
...
class Thread(models.Model):
    ...
    category = models.ForeignKey(verbose_name='类别ID', to=ThreadCategory, on_delete=models.DO_NOTHING, null=True, blank=True, help_text='')
    classify = models.ForeignKey(verbose_name='分类ID', to=ThreadClassify, on_delete=models.DO_NOTHING, null=True, blank=True, help_text='')
    show = models.ForeignKey(verbose_name='展示ID', to=ThreadShow, null=True, blank=True, on_delete=models.DO_NOTHING, related_name='+',
    ...
    price = models.DecimalField(verbose_name='价格', max_digits=32, decimal_places=8, null=True, blank=True, help_text='')  # add-2022-05-20
...
class ThreadTag(models.Model):
    ...
    user_id = models.IntegerField(verbose_name='用户ID', blank=True, null=True, default=0, help_text='如果是私人标签则不为空，如果为0代表公域标签。')
...
class ThreadTagMapping(models.Model):
    ...
    id = models.AutoField(verbose_name='ID', primary_key=True, help_text='')
    thread = models.ForeignKey(verbose_name='信息ID', to=Thread, db_column='thread_id', related_name="thread", on_delete=models.DO_NOTHING, help_text='')
    ...
    tag = models.ForeignKey(verbose_name='标签ID', to=ThreadTag, db_column='tag_id', related_name='+', on_delete=models.DO_NOTHING, help_text='')
