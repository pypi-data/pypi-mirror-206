...
class InstitutionsGetByIdResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, institution, request_id, *args, **kwargs):  # noqa: E501
        """InstitutionsGetByIdResponse - a model defined in OpenAPI
