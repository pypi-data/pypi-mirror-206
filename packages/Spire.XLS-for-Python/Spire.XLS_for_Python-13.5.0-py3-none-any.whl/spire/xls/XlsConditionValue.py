...
class XlsConditionValue (  SpireObject, IConditionValue) :
    ...
    def IsGTE(self)->bool:
        ...
        ret = GetDllLibXls().XlsConditionValue_get_IsGTE(self.Ptr)
        return ret

    @IsGTE.setter
    def IsGTE(self, value:bool):
        GetDllLibXls().XlsConditionValue_set_IsGTE.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsConditionValue_set_IsGTE(self.Ptr, value)
    ...
    def Type(self)->'ConditionValueType':
        ...
        ret = GetDllLibXls().XlsConditionValue_get_Type(self.Ptr)
    ...
    def Type(self, value:'ConditionValueType'):
        ...
        GetDllLibXls().XlsConditionValue_set_Type(self.Ptr, value.value)
    ...
    def Value(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsConditionValue_get_Value(self.Ptr)
    ...
    def Value(self, value:'SpireObject'):
        ...
        GetDllLibXls().XlsConditionValue_set_Value(self.Ptr, value.Ptr)
    ...
    def op_Equality(first:'XlsConditionValue',second:'XlsConditionValue')->bool:
        ...
        ret = GetDllLibXls().XlsConditionValue_op_Equality( intPtrfirst,intPtrsecond)
        return ret
    ...
    def op_Inequality(first:'XlsConditionValue',second:'XlsConditionValue')->bool:
        ...
        ret = GetDllLibXls().XlsConditionValue_op_Inequality( intPtrfirst,intPtrsecond)
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibXls().XlsConditionValue_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = GetDllLibXls().XlsConditionValue_GetHashCode(self.Ptr)
        return ret
