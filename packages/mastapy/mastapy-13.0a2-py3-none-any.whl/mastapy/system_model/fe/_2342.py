...
class BatchOperations(_0.APIBase):
    ...
    class _Cast_BatchOperations:
        ...
        def __init__(self, parent: 'BatchOperations'):
            self._parent = parent
    ...
    @property
    def fe_parts(self) -> 'List[_2360.FEPartWithBatchOptions]':
    ...
    @property
    def fe_parts_with_external_files(self) -> 'List[_2360.FEPartWithBatchOptions]':
    ...
    @property
    def cast_to(self) -> 'BatchOperations._Cast_BatchOperations':
