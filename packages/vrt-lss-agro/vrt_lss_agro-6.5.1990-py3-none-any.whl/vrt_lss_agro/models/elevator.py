...
class Elevator(BaseModel):
    ...
    gate: Gate = ...
    dryers: Optional[conlist(Dryer, max_items=201, min_items=0, unique_items=True)] = Field(None, description="List of dryers.")
    storages: Optional[conlist(Storage, max_items=201, min_items=0, unique_items=True)] = Field(None, description="List of storages.")
    silos: Optional[conlist(Silo, max_items=201, min_items=0, unique_items=True)] = Field(None, description="List of storages.")
