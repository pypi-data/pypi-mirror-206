...
class ConceptCouplingSteadyStateSynchronousResponse(_3001.CouplingSteadyStateSynchronousResponse):
    """ConceptCouplingSteadyStateSynchronousResponse
    ...
    class _Cast_ConceptCouplingSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'ConceptCouplingSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def concept_coupling_steady_state_synchronous_response(self) -> 'ConceptCouplingSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingSteadyStateSynchronousResponse._Cast_ConceptCouplingSteadyStateSynchronousResponse':
