...
class SpringDamperCompoundStabilityAnalysis(_3911.CouplingCompoundStabilityAnalysis):
    """SpringDamperCompoundStabilityAnalysis
    ...
    class _Cast_SpringDamperCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'SpringDamperCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def spring_damper_compound_stability_analysis(self) -> 'SpringDamperCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3847.SpringDamperStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3847.SpringDamperStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperCompoundStabilityAnalysis._Cast_SpringDamperCompoundStabilityAnalysis':
