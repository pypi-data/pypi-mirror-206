...
class AGMAGleasonConicalGearSetCompoundDynamicAnalysis(_6407.ConicalGearSetCompoundDynamicAnalysis):
    """AGMAGleasonConicalGearSetCompoundDynamicAnalysis
    ...
    class _Cast_AGMAGleasonConicalGearSetCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearSetCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_set_compound_dynamic_analysis(self) -> 'AGMAGleasonConicalGearSetCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6249.AGMAGleasonConicalGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6249.AGMAGleasonConicalGearSetDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearSetCompoundDynamicAnalysis._Cast_AGMAGleasonConicalGearSetCompoundDynamicAnalysis':
