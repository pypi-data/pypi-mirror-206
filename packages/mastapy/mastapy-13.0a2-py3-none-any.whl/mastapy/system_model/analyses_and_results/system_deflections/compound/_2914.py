...
class PlanetaryConnectionCompoundSystemDeflection(_2929.ShaftToMountableComponentConnectionCompoundSystemDeflection):
    """PlanetaryConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2768.PlanetaryConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2768.PlanetaryConnectionSystemDeflection]':
