...
class ConicalGearSetCompoundStabilityAnalysis(_3934.GearSetCompoundStabilityAnalysis):
    """ConicalGearSetCompoundStabilityAnalysis
    ...
    class _Cast_ConicalGearSetCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'ConicalGearSetCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def conical_gear_set_compound_stability_analysis(self) -> 'ConicalGearSetCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3775.ConicalGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3775.ConicalGearSetStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ConicalGearSetCompoundStabilityAnalysis._Cast_ConicalGearSetCompoundStabilityAnalysis':
