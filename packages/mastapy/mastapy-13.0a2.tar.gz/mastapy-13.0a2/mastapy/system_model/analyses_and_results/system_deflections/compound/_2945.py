...
class SynchroniserCompoundSystemDeflection(_2930.SpecialisedAssemblyCompoundSystemDeflection):
    """SynchroniserCompoundSystemDeflection
    ...
    class _Cast_SynchroniserCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'SynchroniserCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def synchroniser_compound_system_deflection(self) -> 'SynchroniserCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2803.SynchroniserSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2803.SynchroniserSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserCompoundSystemDeflection._Cast_SynchroniserCompoundSystemDeflection':
