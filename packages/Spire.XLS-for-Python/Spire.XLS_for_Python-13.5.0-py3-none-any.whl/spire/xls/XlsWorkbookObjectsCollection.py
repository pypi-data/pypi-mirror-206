...
class XlsWorkbookObjectsCollection (  ITabSheets) :
    ...
    def Workbook(self)->'IWorkbook':
        ...
        intPtr = GetDllLibXls().XlsWorkbookObjectsCollection_get_Workbook(self.Ptr)
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().XlsWorkbookObjectsCollection_get_Count(self.Ptr)
        return ret
    ...
    def get_Item(self ,index:int)->ITabSheet:
        ...
        intPtr = GetDllLibXls().XlsWorkbookObjectsCollection_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->INamedObject:
        ...
        intPtr = GetDllLibXls().XlsWorkbookObjectsCollection_get_ItemN(self.Ptr, name)
    ...
    def Move(self ,iOldIndex:int,iNewIndex:int):
        ...
        GetDllLibXls().XlsWorkbookObjectsCollection_Move(self.Ptr, iOldIndex,iNewIndex)
    ...
    def MoveBefore(self ,sheetToMove:'ITabSheet',sheetForPlacement:'ITabSheet'):
        ...
        GetDllLibXls().XlsWorkbookObjectsCollection_MoveBefore(self.Ptr, intPtrsheetToMove,intPtrsheetForPlacement)
    ...
    def MoveAfter(self ,sheetToMove:'ITabSheet',sheetForPlacement:'ITabSheet'):
        ...
        GetDllLibXls().XlsWorkbookObjectsCollection_MoveAfter(self.Ptr, intPtrsheetToMove,intPtrsheetForPlacement)
