...
class TorqueConverterConnectionCompoundCriticalSpeedAnalysis(_6677.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """TorqueConverterConnectionCompoundCriticalSpeedAnalysis
    ...
    class _Cast_TorqueConverterConnectionCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'TorqueConverterConnectionCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def torque_converter_connection_compound_critical_speed_analysis(self) -> 'TorqueConverterConnectionCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6627.TorqueConverterConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6627.TorqueConverterConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterConnectionCompoundCriticalSpeedAnalysis._Cast_TorqueConverterConnectionCompoundCriticalSpeedAnalysis':
