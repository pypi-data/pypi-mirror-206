...
class GuideDxfModelCompoundSteadyStateSynchronousResponseAtASpeed(_3638.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """GuideDxfModelCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_GuideDxfModelCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'GuideDxfModelCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def guide_dxf_model_compound_steady_state_synchronous_response_at_a_speed(self) -> 'GuideDxfModelCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3544.GuideDxfModelSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3544.GuideDxfModelSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'GuideDxfModelCompoundSteadyStateSynchronousResponseAtASpeed._Cast_GuideDxfModelCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_GuideDxfModelCompoundSteadyStateSynchronousResponseAtASpeed(self)
