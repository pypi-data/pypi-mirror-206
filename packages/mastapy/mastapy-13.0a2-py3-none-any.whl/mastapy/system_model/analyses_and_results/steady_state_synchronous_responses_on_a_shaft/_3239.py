...
class BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft(_3237.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft):
    """BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def bevel_differential_sun_gear_steady_state_synchronous_response_on_a_shaft(self) -> 'BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft._Cast_BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft(self)
