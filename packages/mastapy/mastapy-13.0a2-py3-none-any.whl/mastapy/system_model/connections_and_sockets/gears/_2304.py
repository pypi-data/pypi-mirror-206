...
class SpiralBevelGearMesh(_2284.BevelGearMesh):
    """SpiralBevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_965.SpiralBevelGearMeshDesign':
    ...
    @property
    def spiral_bevel_gear_mesh_design(self) -> '_965.SpiralBevelGearMeshDesign':
