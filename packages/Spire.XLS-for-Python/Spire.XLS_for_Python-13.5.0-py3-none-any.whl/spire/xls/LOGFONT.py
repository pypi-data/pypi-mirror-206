...
class LOGFONT (SpireObject) :
    ...
    def lfHeight(self)->int:
        ...
        ret = GetDllLibXls().LOGFONT_lfHeight(self.Ptr)
        return ret
    ...
    def lfWidth(self)->int:
        ...
        ret = GetDllLibXls().LOGFONT_lfWidth(self.Ptr)
        return ret
    ...
    def lfEscapement(self)->int:
        ...
        ret = GetDllLibXls().LOGFONT_lfEscapement(self.Ptr)
        return ret
    ...
    def lfOrientation(self)->int:
        ...
        ret = GetDllLibXls().LOGFONT_lfOrientation(self.Ptr)
        return ret
    ...
    def lfWeight(self)->int:
        ...
        ret = GetDllLibXls().LOGFONT_lfWeight(self.Ptr)
        return ret
    ...
    def lfItalic(self)->int:
        ...
        ret = GetDllLibXls().LOGFONT_lfItalic(self.Ptr)
        return ret
    ...
    def lfUnderline(self)->int:
        ...
        ret = GetDllLibXls().LOGFONT_lfUnderline(self.Ptr)
        return ret
    ...
    def lfStrikeOut(self)->int:
        ...
        ret = GetDllLibXls().LOGFONT_lfStrikeOut(self.Ptr)
        return ret
    ...
    def lfCharSet(self)->int:
        ...
        ret = GetDllLibXls().LOGFONT_lfCharSet(self.Ptr)
        return ret
    ...
    def lfOutPrecision(self)->int:
        ...
        ret = GetDllLibXls().LOGFONT_lfOutPrecision(self.Ptr)
        return ret
    ...
    def lfClipPrecision(self)->int:
        ...
        ret = GetDllLibXls().LOGFONT_lfClipPrecision(self.Ptr)
        return ret
    ...
    def lfQuality(self)->int:
        ...
        ret = GetDllLibXls().LOGFONT_lfQuality(self.Ptr)
        return ret
    ...
    def lfPitchAndFamily(self)->int:
        ...
        ret = GetDllLibXls().LOGFONT_lfPitchAndFamily(self.Ptr)
        return ret
    ...
    def lfFaceName(self)->str:
        ...
        GetDllLibXls().LOGFONT_lfFaceName.restype=c_wchar_p
        ret = GetDllLibXls().LOGFONT_lfFaceName(self.Ptr)
        return ret
