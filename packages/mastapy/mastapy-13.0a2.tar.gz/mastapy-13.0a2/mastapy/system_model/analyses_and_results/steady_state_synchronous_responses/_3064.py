...
class SpiralBevelGearSteadyStateSynchronousResponse(_2980.BevelGearSteadyStateSynchronousResponse):
    """SpiralBevelGearSteadyStateSynchronousResponse
    ...
    class _Cast_SpiralBevelGearSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'SpiralBevelGearSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_steady_state_synchronous_response(self) -> 'SpiralBevelGearSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearSteadyStateSynchronousResponse._Cast_SpiralBevelGearSteadyStateSynchronousResponse':
