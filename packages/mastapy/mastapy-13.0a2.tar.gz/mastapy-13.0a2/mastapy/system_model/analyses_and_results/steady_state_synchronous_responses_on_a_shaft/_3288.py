...
class HypoidGearSteadyStateSynchronousResponseOnAShaft(_3230.AGMAGleasonConicalGearSteadyStateSynchronousResponseOnAShaft):
    """HypoidGearSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_HypoidGearSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'HypoidGearSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_steady_state_synchronous_response_on_a_shaft(self) -> 'HypoidGearSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidGearSteadyStateSynchronousResponseOnAShaft._Cast_HypoidGearSteadyStateSynchronousResponseOnAShaft':
