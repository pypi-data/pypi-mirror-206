...
class BevelHypoidGearDesignSettings(_0.APIBase):
    ...
    class _Cast_BevelHypoidGearDesignSettings:
        ...
        def __init__(self, parent: 'BevelHypoidGearDesignSettings'):
            self._parent = parent

        @property
        def bevel_hypoid_gear_design_settings(self) -> 'BevelHypoidGearDesignSettings':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelHypoidGearDesignSettings._Cast_BevelHypoidGearDesignSettings':
