...
class CylindricalGearCompoundCriticalSpeedAnalysis(_6697.GearCompoundCriticalSpeedAnalysis):
    """CylindricalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6557.CylindricalGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6557.CylindricalGearCriticalSpeedAnalysis]':
