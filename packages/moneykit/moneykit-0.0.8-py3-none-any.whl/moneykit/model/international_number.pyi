...
class InternationalNumber(schemas.DictSchema):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["bic"]) -> MetaOapg.properties.bic: ...
    @typing.overload
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        iban: typing.Union[
            MetaOapg.properties.iban,
            str,
        ],
        bic: typing.Union[
            MetaOapg.properties.bic,
            str,
        ],
