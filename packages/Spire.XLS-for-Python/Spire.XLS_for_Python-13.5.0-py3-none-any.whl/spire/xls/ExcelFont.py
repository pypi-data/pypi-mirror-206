...
class ExcelFont (  SpireObject, IFont) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelFont_get_IsItalic(self.Ptr)
        return ret

    @IsItalic.setter
    def IsItalic(self, value:bool):
        GetDllLibXls().ExcelFont_set_IsItalic.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ExcelFont_set_IsItalic(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelFont_get_KnownColor(self.Ptr)
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().ExcelFont_set_KnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ExcelFont_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().ExcelFont_set_Color(self.Ptr, value.Ptr)
    ...
    <param name="tint"></param>
        ...
        GetDllLibXls().ExcelFont_SetThemeColor(self.Ptr, enumtype,tint)
...
#        ret = GetDllLibXls().ExcelFont_GetThemeColor(self.Ptr, intPtrtype,intPtrtint)
#        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelFont_get_IsBold(self.Ptr)
        return ret

    @IsBold.setter
    def IsBold(self, value:bool):
        GetDllLibXls().ExcelFont_set_IsBold.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ExcelFont_set_IsBold(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().ExcelFont_get_FontName.restype=c_wchar_p
        ret = GetDllLibXls().ExcelFont_get_FontName(self.Ptr)
        return ret
    ...
    def FontName(self, value:str):
        ...
        GetDllLibXls().ExcelFont_set_FontName(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelFont_get_Size(self.Ptr)
        return ret

    @Size.setter
    def Size(self, value:float):
        GetDllLibXls().ExcelFont_set_Size.argtypes=[c_void_p, c_double]
        GetDllLibXls().ExcelFont_set_Size(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelFont_get_IsStrikethrough(self.Ptr)
        return ret
    ...
    def IsStrikethrough(self, value:bool):
        ...
        GetDllLibXls().ExcelFont_set_IsStrikethrough(self.Ptr, value)
    ...
    def StrikethroughType(self)->str:
        ...
        GetDllLibXls().ExcelFont_get_StrikethroughType.restype=c_wchar_p
        ret = GetDllLibXls().ExcelFont_get_StrikethroughType(self.Ptr)
        return ret
    ...
    def StrikethroughType(self, value:str):
        ...
        GetDllLibXls().ExcelFont_set_StrikethroughType(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelFont_get_IsSubscript(self.Ptr)
        return ret

    @IsSubscript.setter
    def IsSubscript(self, value:bool):
        GetDllLibXls().ExcelFont_set_IsSubscript.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ExcelFont_set_IsSubscript(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelFont_get_IsAutoColor(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelFont_get_Underline(self.Ptr)
    ...
    def Underline(self, value:'FontUnderlineType'):
        ...
        GetDllLibXls().ExcelFont_set_Underline(self.Ptr, value.value)
    ...
    def VerticalAlignment(self)->'FontVertialAlignmentType':
        ...
        ret = GetDllLibXls().ExcelFont_get_VerticalAlignment(self.Ptr)
    ...
    def VerticalAlignment(self, value:'FontVertialAlignmentType'):
        ...
        GetDllLibXls().ExcelFont_set_VerticalAlignment(self.Ptr, value.value)
    ...
    <returns>Font object.</returns>
        ...
        intPtr = GetDllLibXls().ExcelFont_GenerateNativeFont(self.Ptr)
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().ExcelFont_get_Parent(self.Ptr)
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().ExcelFont_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().ExcelFont_EndUpdate(self.Ptr)
