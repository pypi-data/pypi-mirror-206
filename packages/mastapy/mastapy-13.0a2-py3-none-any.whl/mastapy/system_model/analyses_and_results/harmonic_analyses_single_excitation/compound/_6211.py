...
class StraightBevelDiffGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_6122.BevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    """StraightBevelDiffGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_StraightBevelDiffGearMeshCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearMeshCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_mesh_compound_harmonic_analysis_of_single_excitation(self) -> 'StraightBevelDiffGearMeshCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6082.StraightBevelDiffGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6082.StraightBevelDiffGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearMeshCompoundHarmonicAnalysisOfSingleExcitation._Cast_StraightBevelDiffGearMeshCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_StraightBevelDiffGearMeshCompoundHarmonicAnalysisOfSingleExcitation(self)
