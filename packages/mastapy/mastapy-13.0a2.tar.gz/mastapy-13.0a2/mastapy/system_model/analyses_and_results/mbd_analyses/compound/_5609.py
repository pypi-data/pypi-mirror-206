...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5607, _5608, _5517
...
class StraightBevelGearSetCompoundMultibodyDynamicsAnalysis(_5517.BevelGearSetCompoundMultibodyDynamicsAnalysis):
    """StraightBevelGearSetCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_StraightBevelGearSetCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearSetCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_set_compound_multibody_dynamics_analysis(self) -> 'StraightBevelGearSetCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5471.StraightBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5607.StraightBevelGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5608.StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5471.StraightBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSetCompoundMultibodyDynamicsAnalysis._Cast_StraightBevelGearSetCompoundMultibodyDynamicsAnalysis':
