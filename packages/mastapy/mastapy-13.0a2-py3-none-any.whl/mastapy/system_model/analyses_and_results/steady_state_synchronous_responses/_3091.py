...
class WormGearSteadyStateSynchronousResponse(_3023.GearSteadyStateSynchronousResponse):
    """WormGearSteadyStateSynchronousResponse
    ...
    class _Cast_WormGearSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'WormGearSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def worm_gear_steady_state_synchronous_response(self) -> 'WormGearSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearSteadyStateSynchronousResponse._Cast_WormGearSteadyStateSynchronousResponse':
