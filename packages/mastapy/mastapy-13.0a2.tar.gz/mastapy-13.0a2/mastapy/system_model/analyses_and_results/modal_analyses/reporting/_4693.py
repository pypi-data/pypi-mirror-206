...
class ModalCMSResultsForModeAndFE(_0.APIBase):
    ...
    class _Cast_ModalCMSResultsForModeAndFE:
        ...
        def __init__(self, parent: 'ModalCMSResultsForModeAndFE'):
            self._parent = parent

        @property
        def modal_cms_results_for_mode_and_fe(self) -> 'ModalCMSResultsForModeAndFE':
            return self._parent
    ...
    @property
    def modal_full_fe_results(self) -> '_228.ModalCMSResults':
    ...
    @property
    def cast_to(self) -> 'ModalCMSResultsForModeAndFE._Cast_ModalCMSResultsForModeAndFE':
