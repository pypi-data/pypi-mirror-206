...
class ConceptGearMeshCompoundModalAnalysisAtASpeed(_5277.GearMeshCompoundModalAnalysisAtASpeed):
    """ConceptGearMeshCompoundModalAnalysisAtASpeed
    ...
    class _Cast_ConceptGearMeshCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ConceptGearMeshCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def concept_gear_mesh_compound_modal_analysis_at_a_speed(self) -> 'ConceptGearMeshCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5118.ConceptGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5118.ConceptGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ConceptGearMeshCompoundModalAnalysisAtASpeed._Cast_ConceptGearMeshCompoundModalAnalysisAtASpeed':
