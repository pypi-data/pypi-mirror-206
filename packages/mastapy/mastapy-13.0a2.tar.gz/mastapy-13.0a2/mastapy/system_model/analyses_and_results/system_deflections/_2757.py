...
class LoadSharingFactorReporter(_0.APIBase):
    ...
    class _Cast_LoadSharingFactorReporter:
        ...
        def __init__(self, parent: 'LoadSharingFactorReporter'):
            self._parent = parent

        @property
        def load_sharing_factor_reporter(self) -> 'LoadSharingFactorReporter':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'LoadSharingFactorReporter._Cast_LoadSharingFactorReporter':
        return self._Cast_LoadSharingFactorReporter(self)
