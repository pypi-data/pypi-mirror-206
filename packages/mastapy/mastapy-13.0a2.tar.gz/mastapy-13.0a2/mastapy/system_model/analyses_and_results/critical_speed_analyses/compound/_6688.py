...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6686, _6687, _6699
...
class CylindricalGearSetCompoundCriticalSpeedAnalysis(_6699.GearSetCompoundCriticalSpeedAnalysis):
    """CylindricalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6559.CylindricalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_critical_speed_analysis(self) -> 'List[_6686.CylindricalGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_critical_speed_analysis(self) -> 'List[_6687.CylindricalGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6559.CylindricalGearSetCriticalSpeedAnalysis]':
