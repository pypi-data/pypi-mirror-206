...
class ClutchCompoundAdvancedSystemDeflection(_7405.CouplingCompoundAdvancedSystemDeflection):
    """ClutchCompoundAdvancedSystemDeflection
    ...
    class _Cast_ClutchCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'ClutchCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def clutch_compound_advanced_system_deflection(self) -> 'ClutchCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7256.ClutchAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7256.ClutchAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'ClutchCompoundAdvancedSystemDeflection._Cast_ClutchCompoundAdvancedSystemDeflection':
