...
class HypoidGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_6110.AGMAGleasonConicalGearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    """HypoidGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_HypoidGearMeshCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'HypoidGearMeshCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_mesh_compound_harmonic_analysis_of_single_excitation(self) -> 'HypoidGearMeshCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6039.HypoidGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6039.HypoidGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearMeshCompoundHarmonicAnalysisOfSingleExcitation._Cast_HypoidGearMeshCompoundHarmonicAnalysisOfSingleExcitation':
