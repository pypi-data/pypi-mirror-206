...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5370, _5389
...
class ClutchMultibodyDynamicsAnalysis(_5389.CouplingMultibodyDynamicsAnalysis):
    """ClutchMultibodyDynamicsAnalysis
    ...
    class _Cast_ClutchMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'ClutchMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_multibody_dynamics_analysis(self) -> 'ClutchMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def clutch_connection(self) -> '_5370.ClutchConnectionMultibodyDynamicsAnalysis':
    ...
    @property
    def cast_to(self) -> 'ClutchMultibodyDynamicsAnalysis._Cast_ClutchMultibodyDynamicsAnalysis':
