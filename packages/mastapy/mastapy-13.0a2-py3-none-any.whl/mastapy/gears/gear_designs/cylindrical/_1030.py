...
class CylindricalGearToothThicknessSpecification(_0.APIBase, Generic[TMeasurement]):
    ...
    class _Cast_CylindricalGearToothThicknessSpecification:
        ...
        def __init__(self, parent: 'CylindricalGearToothThicknessSpecification'):
            self._parent = parent

        @property
        def cylindrical_gear_tooth_thickness_specification(self) -> 'CylindricalGearToothThicknessSpecification':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearToothThicknessSpecification._Cast_CylindricalGearToothThicknessSpecification':
