...
class ChartSeriesAxis (  XlsChartSeriesAxis) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartSeriesAxis_get_Font(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartSeriesAxis_get_MajorGridLines(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartSeriesAxis_get_MinorGridLines(self.Ptr)
        ret = None if intPtr==None else ChartGridLine(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartSeriesAxis_get_TitleArea(self.Ptr)
