...
Example: 4"""
    ...
    lifecycle_management = fields.Nested("netapp_ontap.models.s3_bucket_svm_lifecycle_management.S3BucketSvmLifecycleManagementSchema", data_key="lifecycle_management", unknown=EXCLUDE)
...
* suspended"""
    ...
    """audit_event_selector,comment,encryption,lifecycle_management,nas_path,policy,protection_status,qos_policy.max_throughput_iops,qos_policy.max_throughput_mbps,qos_policy.min_throughput_iops,qos_policy.min_throughput_mbps,qos_policy.name,qos_policy.uuid,size,svm.name,svm.uuid,type,versioning_state,volume.name,volume.uuid,"""
    ...
    """aggregates.links,aggregates.name,aggregates.uuid,audit_event_selector,comment,constituents_per_aggregate,encryption,lifecycle_management,name,nas_path,policy,protection_status,qos_policy.max_throughput_iops,qos_policy.max_throughput_mbps,qos_policy.min_throughput_iops,qos_policy.min_throughput_mbps,qos_policy.name,qos_policy.uuid,size,storage_service_level,svm.name,svm.uuid,type,versioning_state,volume.name,volume.uuid,"""
