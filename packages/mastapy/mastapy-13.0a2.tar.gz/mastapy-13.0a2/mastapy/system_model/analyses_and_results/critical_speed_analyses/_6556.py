...
class CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis(_6511.AbstractShaftToMountableComponentConnectionCriticalSpeedAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis
    ...
    class _Cast_CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_planetary_bearing_connection_critical_speed_analysis(self) -> 'CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis._Cast_CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis':
        return self._Cast_CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis(self)
