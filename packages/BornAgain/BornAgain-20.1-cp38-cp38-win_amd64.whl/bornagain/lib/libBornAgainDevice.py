...
class Datafield(object):
    ...
    def hasErrorSigmas(self):
        r"""hasErrorSigmas(Datafield self) -> bool"""
        return _libBornAgainDevice.Datafield_hasErrorSigmas(self)

    def errorSigmas(self, *args):
        r"""
        errorSigmas(Datafield self) -> vdouble1d_t
        errorSigmas(Datafield self) -> vdouble1d_t
        """
        return _libBornAgainDevice.Datafield_errorSigmas(self, *args)
    ...
    def setVector(self, data_vector):
    ...
    def hasSameShape(self, other):
        r"""hasSameShape(Datafield self, Datafield other) -> bool"""
        return _libBornAgainDevice.Datafield_hasSameShape(self, other)
...
class IFootprintFactor(libBornAgainBase.ICloneable, libBornAgainParam.INode):
    ...
    def parDefs(self):
        r"""parDefs(IFootprintFactor self) -> std::vector< ParaMeta,std::allocator< ParaMeta > >"""
        return _libBornAgainDevice.IFootprintFactor_parDefs(self)
    ...
    def validate(self):
        r"""validate(IFootprintFactor self) -> std::string"""
...
Coords_RQ4 = _libBornAgainDevice.Coords_RQ4
...
class IDetector(libBornAgainBase.ICloneable, libBornAgainParam.INode):
    ...
    def setAnalyzer(self, direction, efficiency, total_transmission):
        r"""setAnalyzer(IDetector self, R3 direction, double efficiency, double total_transmission)"""
    ...
    def createPixel(self, index):
        r"""createPixel(IDetector self, size_t index) -> IPixel const *"""
    ...
    def regionOfInterestIndexToDetectorIndex(self, regionOfInterestIndex):
        r"""regionOfInterestIndexToDetectorIndex(IDetector self, size_t regionOfInterestIndex) -> size_t"""
    ...
    def detectorIndexToRegionOfInterestIndex(self, detectorIndex):
        r"""detectorIndexToRegionOfInterestIndex(IDetector self, size_t detectorIndex) -> size_t"""
...
class OffspecDetector(libBornAgainParam.INode):
    ...
    def setAnalyzer(self, direction, efficiency, total_transmission):
        r"""setAnalyzer(OffspecDetector self, R3 direction, double efficiency, double total_transmission)"""
...
class IOFactory(object):
    ...
    def readDatafield(*args):
        ...
        return _libBornAgainDevice.IOFactory_readDatafield(*args)
    ...
    def writeDatafield(data, file_name):
        ...
        return _libBornAgainDevice.IOFactory_writeDatafield(data, file_name)
    ...
    def __init__(self):
        r"""__init__(IOFactory self) -> IOFactory"""
...
def filesAgree(datFileName, refFileName, tol):
    r"""filesAgree(std::string const & datFileName, std::string const & refFileName, double tol) -> bool"""
    return _libBornAgainDevice.filesAgree(datFileName, refFileName, tol)
class SimulationResult(object):
    ...
    def flatVector(self, *args):
        r"""flatVector(SimulationResult self, Coords units=UNDEFINED) -> vdouble1d_t"""
        return _libBornAgainDevice.SimulationResult_flatVector(self, *args)

    def datafield(self, *args):
        r"""datafield(SimulationResult self, Coords units=UNDEFINED) -> Datafield"""
        return _libBornAgainDevice.SimulationResult_datafield(self, *args)
