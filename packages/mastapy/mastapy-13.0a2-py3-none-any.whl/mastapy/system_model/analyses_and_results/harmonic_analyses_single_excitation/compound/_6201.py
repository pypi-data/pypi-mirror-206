...
class ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6141.ConnectorCompoundHarmonicAnalysisOfSingleExcitation):
    """ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def shaft_hub_connection_compound_harmonic_analysis_of_single_excitation(self) -> 'ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6072.ShaftHubConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6072.ShaftHubConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation._Cast_ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation(self)
