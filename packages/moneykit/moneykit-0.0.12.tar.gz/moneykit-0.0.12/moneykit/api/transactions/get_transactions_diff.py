...
from ...models.transaction_sync_response import TransactionSyncResponse
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/links/{id}/transactions/sync".format(client.base_url, id=id)
...
def _parse_response(
    *, client: Client, response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = TransactionSyncResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Union[APIErrorRateLimitExceededResponse, LinkErrorBadStateResponse, LinkErrorDeletedResponse, LinkErrorForbiddenActionResponse, LinkErrorNotFoundResponse, TransactionSyncResponse, Union['APIErrorAuthExpiredAccessTokenResponse', 'APIErrorAuthUnauthorizedResponse', 'LinkErrorUnauthorizedAccessResponse']]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[APIErrorRateLimitExceededResponse, LinkErrorBadStateResponse, LinkErrorDeletedResponse, LinkErrorForbiddenActionResponse, LinkErrorNotFoundResponse, TransactionSyncResponse, Union['APIErrorAuthExpiredAccessTokenResponse', 'APIErrorAuthUnauthorizedResponse', 'LinkErrorUnauthorizedAccessResponse']]
    """
