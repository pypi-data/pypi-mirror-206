...
class ClutchSteadyStateSynchronousResponseOnAShaft(_3263.CouplingSteadyStateSynchronousResponseOnAShaft):
    """ClutchSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_ClutchSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'ClutchSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def clutch_steady_state_synchronous_response_on_a_shaft(self) -> 'ClutchSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchSteadyStateSynchronousResponseOnAShaft._Cast_ClutchSteadyStateSynchronousResponseOnAShaft':
