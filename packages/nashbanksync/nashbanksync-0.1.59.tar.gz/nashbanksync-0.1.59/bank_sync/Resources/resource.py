                ...
                if self.get_bank_id() == super().EQUITY:
                    ...
                    if request.get("business_organization_unit_id", None) is not None:
                        self.callback_payload = {
                            'business_organization_unit_id': request.get("business_organization_unit_id", None)
                        }
            ...
            if forward:
                if callback is not None:
                    ...
                    if callback.business_id is not None:
                        self.callback_payload = {
                            'business_organization_unit_id': str(callback.business_id)
                        }
            ...
            if forward:
                if ipn is not None:
                    ...
                    if ipn.business_id is not None:
                        self.callback_payload = {
                            'business_organization_unit_id': str(ipn.business_id)
                        }
