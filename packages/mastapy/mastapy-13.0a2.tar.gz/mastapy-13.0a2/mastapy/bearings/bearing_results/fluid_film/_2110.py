...
class LoadedPlainOilFedJournalBearingRow(_2108.LoadedPlainJournalBearingRow):
    """LoadedPlainOilFedJournalBearingRow
    ...
    class _Cast_LoadedPlainOilFedJournalBearingRow:
        ...
        def __init__(self, parent: 'LoadedPlainOilFedJournalBearingRow'):
            self._parent = parent

        @property
        def loaded_plain_journal_bearing_row(self):
            return self._parent._cast(_2108.LoadedPlainJournalBearingRow)

        @property
        def loaded_plain_oil_fed_journal_bearing_row(self) -> 'LoadedPlainOilFedJournalBearingRow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'LoadedPlainOilFedJournalBearingRow._Cast_LoadedPlainOilFedJournalBearingRow':
