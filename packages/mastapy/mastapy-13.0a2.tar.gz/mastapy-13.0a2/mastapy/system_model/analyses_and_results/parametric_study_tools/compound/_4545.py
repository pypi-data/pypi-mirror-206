...
class ZerolBevelGearMeshCompoundParametricStudyTool(_4435.BevelGearMeshCompoundParametricStudyTool):
    """ZerolBevelGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4415.ZerolBevelGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4415.ZerolBevelGearMeshParametricStudyTool]':
