...
class WormGearMeshCompoundAdvancedSystemDeflection(_7427.GearMeshCompoundAdvancedSystemDeflection):
    """WormGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7363.WormGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7363.WormGearMeshAdvancedSystemDeflection]':
