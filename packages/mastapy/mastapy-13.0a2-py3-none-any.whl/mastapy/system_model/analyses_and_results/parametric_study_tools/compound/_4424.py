...
class AGMAGleasonConicalGearSetCompoundParametricStudyTool(_4452.ConicalGearSetCompoundParametricStudyTool):
    """AGMAGleasonConicalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4277.AGMAGleasonConicalGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4277.AGMAGleasonConicalGearSetParametricStudyTool]':
