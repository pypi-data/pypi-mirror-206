...
class CycloidalDiscPlanetaryBearingConnectionCompoundStabilityAnalysis(_3877.AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3788.CycloidalDiscPlanetaryBearingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3788.CycloidalDiscPlanetaryBearingConnectionStabilityAnalysis]':
