...
class PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft(_3272.CylindricalGearSetSteadyStateSynchronousResponseOnAShaft):
    """PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def planetary_gear_set_steady_state_synchronous_response_on_a_shaft(self) -> 'PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft._Cast_PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft':
