...
class XlsHPageBreak (  XlsObject) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsHPageBreak_get_Row(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsHPageBreak_get_Type(self.Ptr)
    ...
    def Type(self, value:'PageBreakType'):
        ...
        GetDllLibXls().XlsHPageBreak_set_Type(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsHPageBreak_get_StartColumn(self.Ptr)
        return ret

    @StartColumn.setter
    def StartColumn(self, value:int):
        GetDllLibXls().XlsHPageBreak_set_StartColumn.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsHPageBreak_set_StartColumn(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsHPageBreak_get_EndColumn(self.Ptr)
        return ret

    @EndColumn.setter
    def EndColumn(self, value:int):
        GetDllLibXls().XlsHPageBreak_set_EndColumn.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsHPageBreak_set_EndColumn(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsHPageBreak_get_Extent(self.Ptr)
    ...
    def Clone(self ,parent:'SpireObject')->'XlsHPageBreak':
        ...
        intPtr = GetDllLibXls().XlsHPageBreak_Clone(self.Ptr, intPtrparent)
