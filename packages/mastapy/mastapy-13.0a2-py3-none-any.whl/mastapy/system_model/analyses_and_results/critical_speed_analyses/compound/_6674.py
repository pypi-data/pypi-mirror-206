...
class ConnectionCompoundCriticalSpeedAnalysis(_7501.ConnectionCompoundAnalysis):
    """ConnectionCompoundCriticalSpeedAnalysis
    ...
    class _Cast_ConnectionCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ConnectionCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def connection_compound_critical_speed_analysis(self) -> 'ConnectionCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6543.ConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6543.ConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ConnectionCompoundCriticalSpeedAnalysis._Cast_ConnectionCompoundCriticalSpeedAnalysis':
