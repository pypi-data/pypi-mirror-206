...
class ClutchConnectionModalAnalysisAtAStiffness(_4867.CouplingConnectionModalAnalysisAtAStiffness):
    """ClutchConnectionModalAnalysisAtAStiffness
    ...
    class _Cast_ClutchConnectionModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ClutchConnectionModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def clutch_connection_modal_analysis_at_a_stiffness(self) -> 'ClutchConnectionModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchConnectionModalAnalysisAtAStiffness._Cast_ClutchConnectionModalAnalysisAtAStiffness':
