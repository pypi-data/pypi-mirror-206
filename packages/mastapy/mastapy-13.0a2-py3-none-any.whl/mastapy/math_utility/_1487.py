...
class CoordinateSystem3D(_0.APIBase):
    ...
    def axis(self, degree_of_freedom: '_1492.DegreesOfFreedom') -> 'Vector3D':
        ...
        degree_of_freedom = conversion.mp_to_pn_enum(degree_of_freedom, _1492.DegreesOfFreedom.type_())
