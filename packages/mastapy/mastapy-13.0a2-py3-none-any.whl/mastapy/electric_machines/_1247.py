...
class CoolingDuctLayerSpecification(_0.APIBase):
    ...
    class _Cast_CoolingDuctLayerSpecification:
        ...
        def __init__(self, parent: 'CoolingDuctLayerSpecification'):
            self._parent = parent

        @property
        def cooling_duct_layer_specification(self) -> 'CoolingDuctLayerSpecification':
            return self._parent
    ...
    @property
    def shape(self) -> '_1248.CoolingDuctShape':
        ...
        value = conversion.pn_to_mp_enum(temp, _1248.CoolingDuctShape)
        return constructor.new_from_mastapy_type(_1248.CoolingDuctShape)(value) if value is not None else None

    @shape.setter
    def shape(self, value: '_1248.CoolingDuctShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1248.CoolingDuctShape.type_())
    ...
    @property
    def cast_to(self) -> 'CoolingDuctLayerSpecification._Cast_CoolingDuctLayerSpecification':
