...
class XlsFontsCollection (SpireObject) :
    ...
    def get_Item(self ,index:int)->'IFont':
        ...
        intPtr = GetDllLibXls().XlsFontsCollection_get_Item(self.Ptr, index)
    ...
    def Contains(self ,font:'XlsFont')->bool:
        ...
        ret = GetDllLibXls().XlsFontsCollection_Contains(self.Ptr, intPtrfont)
        return ret
    ...
    def Clone(self ,parent:'XlsWorkbook')->'XlsFontsCollection':
        ...
        intPtr = GetDllLibXls().XlsFontsCollection_Clone(self.Ptr, intPtrparent)
