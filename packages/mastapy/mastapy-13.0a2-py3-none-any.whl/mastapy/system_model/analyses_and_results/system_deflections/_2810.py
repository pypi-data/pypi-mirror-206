...
class TorqueConverterTurbineSystemDeflection(_2709.CouplingHalfSystemDeflection):
    """TorqueConverterTurbineSystemDeflection
    ...
    class _Cast_TorqueConverterTurbineSystemDeflection:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineSystemDeflection'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_system_deflection(self) -> 'TorqueConverterTurbineSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4133.TorqueConverterTurbinePowerFlow':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineSystemDeflection._Cast_TorqueConverterTurbineSystemDeflection':
