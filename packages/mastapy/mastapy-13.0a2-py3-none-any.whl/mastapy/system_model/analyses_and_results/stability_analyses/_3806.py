...
from mastapy.system_model.analyses_and_results.stability_analyses import _3807, _3805, _3747
...
class HypoidGearSetStabilityAnalysis(_3747.AGMAGleasonConicalGearSetStabilityAnalysis):
    """HypoidGearSetStabilityAnalysis
    ...
    @property
    def hypoid_gears_stability_analysis(self) -> 'List[_3807.HypoidGearStabilityAnalysis]':
    ...
    @property
    def hypoid_meshes_stability_analysis(self) -> 'List[_3805.HypoidGearMeshStabilityAnalysis]':
