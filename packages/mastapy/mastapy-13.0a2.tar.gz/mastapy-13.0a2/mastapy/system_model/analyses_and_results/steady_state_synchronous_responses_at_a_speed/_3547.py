...
class HypoidGearSteadyStateSynchronousResponseAtASpeed(_3489.AGMAGleasonConicalGearSteadyStateSynchronousResponseAtASpeed):
    """HypoidGearSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_HypoidGearSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'HypoidGearSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_steady_state_synchronous_response_at_a_speed(self) -> 'HypoidGearSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidGearSteadyStateSynchronousResponseAtASpeed._Cast_HypoidGearSteadyStateSynchronousResponseAtASpeed':
