...
class PrintRichTable:
    ...
    def _draw_vertical_table(self):
        ...
        if self.with_idx:
            self.table.add_column("idx", **self.style.get('idx', {}))
        self.table.add_column("key", **self.style.get('key', {}))
        self.table.add_column("value", **self.style.get('value', {}))
        if self.call_desc_func and callable(self.call_desc_func):
            self.table.add_column("description", **self.style.get('description', {}))
