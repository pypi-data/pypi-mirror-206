...
class BevelDifferentialGearMeshCompoundParametricStudyTool(_4435.BevelGearMeshCompoundParametricStudyTool):
    """BevelDifferentialGearMeshCompoundParametricStudyTool
    ...
    class _Cast_BevelDifferentialGearMeshCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_compound_parametric_study_tool(self) -> 'BevelDifferentialGearMeshCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4282.BevelDifferentialGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4282.BevelDifferentialGearMeshParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshCompoundParametricStudyTool._Cast_BevelDifferentialGearMeshCompoundParametricStudyTool':
