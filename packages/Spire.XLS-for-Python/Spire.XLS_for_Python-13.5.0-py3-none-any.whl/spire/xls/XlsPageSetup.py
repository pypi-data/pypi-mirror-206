...
class XlsPageSetup (  XlsPageSetupBase, IPageSetup) :
    ...
    def IsPrintGridlines(self)->bool:
        ...
        ret = GetDllLibXls().XlsPageSetup_get_IsPrintGridlines(self.Ptr)
        return ret
    ...
    def IsPrintGridlines(self, value:bool):
        ...
        GetDllLibXls().XlsPageSetup_set_IsPrintGridlines(self.Ptr, value)
    ...
    def IsPrintHeadings(self)->bool:
        ...
        ret = GetDllLibXls().XlsPageSetup_get_IsPrintHeadings(self.Ptr)
        return ret
    ...
    def IsPrintHeadings(self, value:bool):
        ...
        GetDllLibXls().XlsPageSetup_set_IsPrintHeadings(self.Ptr, value)
    ...
    def PrintArea(self)->str:
        ...
        GetDllLibXls().XlsPageSetup_get_PrintArea.restype=c_wchar_p
        ret = GetDllLibXls().XlsPageSetup_get_PrintArea(self.Ptr)
        return ret
    ...
    def PrintArea(self, value:str):
        ...
        GetDllLibXls().XlsPageSetup_set_PrintArea(self.Ptr, value)
    ...
    def PrintTitleColumns(self)->str:
        ...
        GetDllLibXls().XlsPageSetup_get_PrintTitleColumns.restype=c_wchar_p
        ret = GetDllLibXls().XlsPageSetup_get_PrintTitleColumns(self.Ptr)
        return ret
    ...
    def PrintTitleColumns(self, value:str):
        ...
        GetDllLibXls().XlsPageSetup_set_PrintTitleColumns(self.Ptr, value)
    ...
    def PrintTitleRows(self)->str:
        ...
        GetDllLibXls().XlsPageSetup_get_PrintTitleRows.restype=c_wchar_p
        ret = GetDllLibXls().XlsPageSetup_get_PrintTitleRows(self.Ptr)
        return ret
    ...
    def PrintTitleRows(self, value:str):
        ...
        GetDllLibXls().XlsPageSetup_set_PrintTitleRows(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsPageSetup_get_RelationId.restype=c_wchar_p
        ret = GetDllLibXls().XlsPageSetup_get_RelationId(self.Ptr)
        return ret
    ...
    def IsSummaryRowBelow(self)->bool:
        ...
        ret = GetDllLibXls().XlsPageSetup_get_IsSummaryRowBelow(self.Ptr)
        return ret
    ...
    def IsSummaryRowBelow(self, value:bool):
        ...
        GetDllLibXls().XlsPageSetup_set_IsSummaryRowBelow(self.Ptr, value)
    ...
    def IsSummaryColumnRight(self)->bool:
        ...
        ret = GetDllLibXls().XlsPageSetup_get_IsSummaryColumnRight(self.Ptr)
        return ret
    ...
    def IsSummaryColumnRight(self, value:bool):
        ...
        GetDllLibXls().XlsPageSetup_set_IsSummaryColumnRight(self.Ptr, value)
    ...
    def IsFitToPage(self)->bool:
        ...
        ret = GetDllLibXls().XlsPageSetup_get_IsFitToPage(self.Ptr)
        return ret

    @IsFitToPage.setter
    def IsFitToPage(self, value:bool):
        GetDllLibXls().XlsPageSetup_set_IsFitToPage.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPageSetup_set_IsFitToPage(self.Ptr, value)
    ...
    def NeedDataArray(self)->bool:
        ...
        ret = GetDllLibXls().XlsPageSetup_get_NeedDataArray(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPageSetup_get_DefaultRowHeight(self.Ptr)
        return ret
    ...
    def DefaultRowHeight(self, value:int):
        ...
        GetDllLibXls().XlsPageSetup_set_DefaultRowHeight(self.Ptr, value)
    ...
    def DefaultRowHeightFlag(self)->bool:
        ...
        ret = GetDllLibXls().XlsPageSetup_get_DefaultRowHeightFlag(self.Ptr)
        return ret
    ...
    def DefaultRowHeightFlag(self, value:bool):
        ...
        GetDllLibXls().XlsPageSetup_set_DefaultRowHeightFlag(self.Ptr, value)
    ...
    def Clone(self ,parent:'SpireObject')->'XlsPageSetup':
        ...
        intPtr = GetDllLibXls().XlsPageSetup_Clone(self.Ptr, intPtrparent)
    ...
    def GetStoreSize(self ,version:'ExcelVersion')->int:
        ...
        ret = GetDllLibXls().XlsPageSetup_GetStoreSize(self.Ptr, enumversion)
        return ret
