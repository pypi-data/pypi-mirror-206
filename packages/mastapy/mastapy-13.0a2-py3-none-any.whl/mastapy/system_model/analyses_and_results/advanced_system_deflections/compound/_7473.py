...
class StraightBevelDiffGearCompoundAdvancedSystemDeflection(_7384.BevelGearCompoundAdvancedSystemDeflection):
    """StraightBevelDiffGearCompoundAdvancedSystemDeflection
    ...
    class _Cast_StraightBevelDiffGearCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_compound_advanced_system_deflection(self) -> 'StraightBevelDiffGearCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7343.StraightBevelDiffGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7343.StraightBevelDiffGearAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearCompoundAdvancedSystemDeflection._Cast_StraightBevelDiffGearCompoundAdvancedSystemDeflection':
