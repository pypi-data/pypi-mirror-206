...
class GradientStops (SpireObject) :
    ...
    def Angle(self)->int:
        ...
        ret = GetDllLibXls().GradientStops_get_Angle(self.Ptr)
        return ret

    @Angle.setter
    def Angle(self, value:int):
        GetDllLibXls().GradientStops_set_Angle.argtypes=[c_void_p, c_int]
        GetDllLibXls().GradientStops_set_Angle(self.Ptr, value)
    ...
    def GradientType(self)->'GradientType':
        ...
        ret = GetDllLibXls().GradientStops_get_GradientType(self.Ptr)
    ...
    def GradientType(self, value:'GradientType'):
        ...
        GetDllLibXls().GradientStops_set_GradientType(self.Ptr, value.value)
    ...
    def FillToRect(self)->'Rectangle':
        ...
        intPtr = GetDllLibXls().GradientStops_get_FillToRect(self.Ptr)
    ...
    def FillToRect(self, value:'Rectangle'):
        ...
        GetDllLibXls().GradientStops_set_FillToRect(self.Ptr, value.Ptr)
    ...
    def IsDoubled(self)->bool:
        ...
        ret = GetDllLibXls().GradientStops_get_IsDoubled(self.Ptr)
        return ret
    ...
    def DoubleGradientStops(self):
        ...
        GetDllLibXls().GradientStops_DoubleGradientStops(self.Ptr)
    ...
    def InvertGradientStops(self):
        ...
        GetDllLibXls().GradientStops_InvertGradientStops(self.Ptr)
    ...
    def ShrinkGradientStops(self)->'GradientStops':
        ...
        intPtr = GetDllLibXls().GradientStops_ShrinkGradientStops(self.Ptr)
    ...
    def Clone(self)->'GradientStops':
        ...
        intPtr = GetDllLibXls().GradientStops_Clone(self.Ptr)
        ret = None if intPtr==None else GradientStops(intPtr)
        return ret
    ...
    def Add(self ,stop:XlsGradientStop):
        ...
        GetDllLibXls().GradientStops_Add(self.Ptr, intPtrstop)
    ...
    def Add(self ,color:Color,position:int,transparency:int,tint:int,shade:int)->XlsGradientStop:
        ...
        intPtr = GetDllLibXls().GradientStops_AddCPTTS(self.Ptr, intPtrcolor,position,transparency,tint,shade)
    ...
    def Serialize(self ,stream:'Stream'):
        ...
        GetDllLibXls().GradientStops_Serialize(self.Ptr, intPtrstream)
