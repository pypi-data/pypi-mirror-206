...
class AbstractShaftOrHousingModalAnalysis(_4572.ComponentModalAnalysis):
    """AbstractShaftOrHousingModalAnalysis
    ...
    class _Cast_AbstractShaftOrHousingModalAnalysis:
        ...
        def __init__(self, parent: 'AbstractShaftOrHousingModalAnalysis'):
            self._parent = parent
        ...
        @property
        def abstract_shaft_or_housing_modal_analysis(self) -> 'AbstractShaftOrHousingModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AbstractShaftOrHousingModalAnalysis._Cast_AbstractShaftOrHousingModalAnalysis':
