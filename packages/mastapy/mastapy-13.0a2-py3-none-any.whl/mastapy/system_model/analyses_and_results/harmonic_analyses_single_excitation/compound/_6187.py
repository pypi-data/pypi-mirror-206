...
class PartToPartShearCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation(_6144.CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation):
    """PartToPartShearCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_PartToPartShearCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_half_compound_harmonic_analysis_of_single_excitation(self) -> 'PartToPartShearCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6057.PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6057.PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation._Cast_PartToPartShearCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_PartToPartShearCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation(self)
