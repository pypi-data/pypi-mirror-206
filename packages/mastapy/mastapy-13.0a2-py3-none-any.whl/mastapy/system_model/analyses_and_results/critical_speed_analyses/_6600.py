...
class RingPinsToDiscConnectionCriticalSpeedAnalysis(_6575.InterMountableComponentConnectionCriticalSpeedAnalysis):
    """RingPinsToDiscConnectionCriticalSpeedAnalysis
    ...
    class _Cast_RingPinsToDiscConnectionCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'RingPinsToDiscConnectionCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def ring_pins_to_disc_connection_critical_speed_analysis(self) -> 'RingPinsToDiscConnectionCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RingPinsToDiscConnectionCriticalSpeedAnalysis._Cast_RingPinsToDiscConnectionCriticalSpeedAnalysis':
