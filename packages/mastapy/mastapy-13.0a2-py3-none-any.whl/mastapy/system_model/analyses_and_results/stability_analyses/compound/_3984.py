...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3982, _3983, _3892
...
class StraightBevelGearSetCompoundStabilityAnalysis(_3892.BevelGearSetCompoundStabilityAnalysis):
    """StraightBevelGearSetCompoundStabilityAnalysis
    ...
    class _Cast_StraightBevelGearSetCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearSetCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_set_compound_stability_analysis(self) -> 'StraightBevelGearSetCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3854.StraightBevelGearSetStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_stability_analysis(self) -> 'List[_3982.StraightBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_stability_analysis(self) -> 'List[_3983.StraightBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3854.StraightBevelGearSetStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSetCompoundStabilityAnalysis._Cast_StraightBevelGearSetCompoundStabilityAnalysis':
