...
class UnbalancedMassCompoundStabilityAnalysis(_3996.VirtualComponentCompoundStabilityAnalysis):
    """UnbalancedMassCompoundStabilityAnalysis
    ...
    class _Cast_UnbalancedMassCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'UnbalancedMassCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_compound_stability_analysis(self) -> 'UnbalancedMassCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3866.UnbalancedMassStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3866.UnbalancedMassStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassCompoundStabilityAnalysis._Cast_UnbalancedMassCompoundStabilityAnalysis':
