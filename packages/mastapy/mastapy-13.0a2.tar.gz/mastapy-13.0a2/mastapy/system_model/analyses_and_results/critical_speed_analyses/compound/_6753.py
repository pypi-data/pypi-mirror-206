...
class SynchroniserHalfCompoundCriticalSpeedAnalysis(_6754.SynchroniserPartCompoundCriticalSpeedAnalysis):
    """SynchroniserHalfCompoundCriticalSpeedAnalysis
    ...
    class _Cast_SynchroniserHalfCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserHalfCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_half_compound_critical_speed_analysis(self) -> 'SynchroniserHalfCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6624.SynchroniserHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6624.SynchroniserHalfCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserHalfCompoundCriticalSpeedAnalysis._Cast_SynchroniserHalfCompoundCriticalSpeedAnalysis':
