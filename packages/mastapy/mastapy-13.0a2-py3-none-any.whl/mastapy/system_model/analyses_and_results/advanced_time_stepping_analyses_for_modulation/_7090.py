...
class SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation(_7089.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def synchroniser_sleeve_advanced_time_stepping_analysis_for_modulation(self) -> 'SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation._Cast_SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation(self)
