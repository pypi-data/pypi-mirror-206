...
from mastapy.math_utility.measured_data import _1556, _1557
...
class ISO14179Settings(_1816.NamedDatabaseItem):
    """ISO14179Settings
    ...
    @property
    def isotr141792001f1_specification_method(self) -> '_2050.PowerRatingF1EstimationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _2050.PowerRatingF1EstimationMethod)
        return constructor.new_from_mastapy_type(_2050.PowerRatingF1EstimationMethod)(value) if value is not None else None

    @isotr141792001f1_specification_method.setter
    def isotr141792001f1_specification_method(self, value: '_2050.PowerRatingF1EstimationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2050.PowerRatingF1EstimationMethod.type_())
    ...
    @property
    def power_rating_f0_scaling_factor_one_dimensional_lookup_table(self) -> '_1556.OnedimensionalFunctionLookupTable':
    ...
    @property
    def power_rating_f1_one_dimensional_lookup_table(self) -> '_1556.OnedimensionalFunctionLookupTable':
    ...
    @property
    def power_rating_f1_scaling_factor_one_dimensional_lookup_table(self) -> '_1556.OnedimensionalFunctionLookupTable':
    ...
    @property
    def power_rating_f1_two_dimensional_lookup_table(self) -> '_1557.TwodimensionalFunctionLookupTable':
