...
class FaceGearMeshModalAnalysisAtAStiffness(_4889.GearMeshModalAnalysisAtAStiffness):
    """FaceGearMeshModalAnalysisAtAStiffness
    ...
    class _Cast_FaceGearMeshModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'FaceGearMeshModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def face_gear_mesh_modal_analysis_at_a_stiffness(self) -> 'FaceGearMeshModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearMeshModalAnalysisAtAStiffness._Cast_FaceGearMeshModalAnalysisAtAStiffness':
