...
class ArcShapeCollection (  IArcShapes) :
    ...
    def get_Item(self ,index:int)->IArcShape:
        ...
        intPtr = GetDllLibXls().ArcShapeCollection_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->IArcShape:
        ...
        intPtr = GetDllLibXls().ArcShapeCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsArcShape(intPtr)
        return ret
    ...
    def AddArc(self ,row:int,column:int,height:int,width:int)->'IArcShape':
        ...
        intPtr = GetDllLibXls().ArcShapeCollection_AddArc(self.Ptr, row,column,height,width)
        ret = None if intPtr==None else XlsArcShape(intPtr)
        return ret
    ...
    def AddCopy(self ,source:'IArcShape'):
        ...
        GetDllLibXls().ArcShapeCollection_AddCopy(self.Ptr, intPtrsource)
    ...
    def Clear(self):
        ...
        GetDllLibXls().ArcShapeCollection_Clear(self.Ptr)
