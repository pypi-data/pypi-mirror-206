...
class BevelGearPowerFlow(_4014.AGMAGleasonConicalGearPowerFlow):
    """BevelGearPowerFlow
    ...
    class _Cast_BevelGearPowerFlow:
        ...
        def __init__(self, parent: 'BevelGearPowerFlow'):
            self._parent = parent
        ...
        @property
        def bevel_gear_power_flow(self) -> 'BevelGearPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearPowerFlow._Cast_BevelGearPowerFlow':
