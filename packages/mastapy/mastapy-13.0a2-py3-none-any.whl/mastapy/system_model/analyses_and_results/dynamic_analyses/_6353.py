...
class StraightBevelGearMeshDynamicAnalysis(_6260.BevelGearMeshDynamicAnalysis):
    """StraightBevelGearMeshDynamicAnalysis
    ...
    class _Cast_StraightBevelGearMeshDynamicAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_dynamic_analysis(self) -> 'StraightBevelGearMeshDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshDynamicAnalysis._Cast_StraightBevelGearMeshDynamicAnalysis':
