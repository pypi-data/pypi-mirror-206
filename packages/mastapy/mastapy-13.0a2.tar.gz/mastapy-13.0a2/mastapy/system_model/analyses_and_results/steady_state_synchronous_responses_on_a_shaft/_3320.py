...
class ShaftSteadyStateSynchronousResponseOnAShaft(_3226.AbstractShaftSteadyStateSynchronousResponseOnAShaft):
    """ShaftSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_ShaftSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'ShaftSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def shaft_steady_state_synchronous_response_on_a_shaft(self) -> 'ShaftSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftSteadyStateSynchronousResponseOnAShaft._Cast_ShaftSteadyStateSynchronousResponseOnAShaft':
