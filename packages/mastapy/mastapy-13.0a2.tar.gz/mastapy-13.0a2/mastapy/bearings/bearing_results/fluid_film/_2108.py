...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    class _Cast_LoadedPlainJournalBearingRow:
        ...
        def __init__(self, parent: 'LoadedPlainJournalBearingRow'):
            self._parent = parent

        @property
        def loaded_plain_oil_fed_journal_bearing_row(self):
            from mastapy.bearings.bearing_results.fluid_film import _2110
            
            return self._parent._cast(_2110.LoadedPlainOilFedJournalBearingRow)

        @property
        def loaded_plain_journal_bearing_row(self) -> 'LoadedPlainJournalBearingRow':
            return self._parent
    ...
    def row(self) -> '_1863.BearingRow':
        ...
        value = conversion.pn_to_mp_enum(temp, _1863.BearingRow)
        return constructor.new_from_mastapy_type(_1863.BearingRow)(value) if value is not None else None
    ...
    @property
    def cast_to(self) -> 'LoadedPlainJournalBearingRow._Cast_LoadedPlainJournalBearingRow':
