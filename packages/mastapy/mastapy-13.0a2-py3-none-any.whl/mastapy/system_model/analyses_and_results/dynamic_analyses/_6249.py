...
class AGMAGleasonConicalGearSetDynamicAnalysis(_6277.ConicalGearSetDynamicAnalysis):
    """AGMAGleasonConicalGearSetDynamicAnalysis
    ...
    class _Cast_AGMAGleasonConicalGearSetDynamicAnalysis:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearSetDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_set_dynamic_analysis(self) -> 'AGMAGleasonConicalGearSetDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearSetDynamicAnalysis._Cast_AGMAGleasonConicalGearSetDynamicAnalysis':
