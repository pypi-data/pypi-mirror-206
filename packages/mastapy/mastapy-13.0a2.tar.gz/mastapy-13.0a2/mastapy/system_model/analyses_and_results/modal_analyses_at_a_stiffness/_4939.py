...
class StraightBevelGearMeshModalAnalysisAtAStiffness(_4846.BevelGearMeshModalAnalysisAtAStiffness):
    """StraightBevelGearMeshModalAnalysisAtAStiffness
    ...
    class _Cast_StraightBevelGearMeshModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_modal_analysis_at_a_stiffness(self) -> 'StraightBevelGearMeshModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshModalAnalysisAtAStiffness._Cast_StraightBevelGearMeshModalAnalysisAtAStiffness':
