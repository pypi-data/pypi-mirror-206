...
class PulleyCompoundParametricStudyTool(_4457.CouplingHalfCompoundParametricStudyTool):
    """PulleyCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4377.PulleyParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4377.PulleyParametricStudyTool]':
