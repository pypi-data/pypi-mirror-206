...
class StraightBevelPlanetGearModalAnalysisAtAStiffness(_4937.StraightBevelDiffGearModalAnalysisAtAStiffness):
    """StraightBevelPlanetGearModalAnalysisAtAStiffness
    ...
    class _Cast_StraightBevelPlanetGearModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'StraightBevelPlanetGearModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def straight_bevel_planet_gear_modal_analysis_at_a_stiffness(self) -> 'StraightBevelPlanetGearModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelPlanetGearModalAnalysisAtAStiffness._Cast_StraightBevelPlanetGearModalAnalysisAtAStiffness':
