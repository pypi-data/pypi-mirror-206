...
class BeltConnectionSteadyStateSynchronousResponseAtASpeed(_3548.InterMountableComponentConnectionSteadyStateSynchronousResponseAtASpeed):
    """BeltConnectionSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_BeltConnectionSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'BeltConnectionSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def belt_connection_steady_state_synchronous_response_at_a_speed(self) -> 'BeltConnectionSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BeltConnectionSteadyStateSynchronousResponseAtASpeed._Cast_BeltConnectionSteadyStateSynchronousResponseAtASpeed':
