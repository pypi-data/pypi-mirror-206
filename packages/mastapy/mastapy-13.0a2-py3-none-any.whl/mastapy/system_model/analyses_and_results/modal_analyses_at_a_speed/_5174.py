...
class PlanetCarrierModalAnalysisAtASpeed(_5166.MountableComponentModalAnalysisAtASpeed):
    """PlanetCarrierModalAnalysisAtASpeed
    ...
    class _Cast_PlanetCarrierModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'PlanetCarrierModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def planet_carrier_modal_analysis_at_a_speed(self) -> 'PlanetCarrierModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierModalAnalysisAtASpeed._Cast_PlanetCarrierModalAnalysisAtASpeed':
