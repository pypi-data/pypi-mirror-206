...
class SAESplineJointRating(_1420.SplineJointRating):
    """SAESplineJointRating
    ...
    class _Cast_SAESplineJointRating:
        ...
        def __init__(self, parent: 'SAESplineJointRating'):
            self._parent = parent
        ...
        @property
        def sae_spline_joint_rating(self) -> 'SAESplineJointRating':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SAESplineJointRating._Cast_SAESplineJointRating':
