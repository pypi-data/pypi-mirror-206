...
class RollerBearingJohnsGoharProfile(_1921.RollerBearingProfile):
    """RollerBearingJohnsGoharProfile
    ...
    class _Cast_RollerBearingJohnsGoharProfile:
        ...
        def __init__(self, parent: 'RollerBearingJohnsGoharProfile'):
            self._parent = parent
        ...
        @property
        def roller_bearing_johns_gohar_profile(self) -> 'RollerBearingJohnsGoharProfile':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollerBearingJohnsGoharProfile._Cast_RollerBearingJohnsGoharProfile':
