...
class CycloidalAssemblyDynamicAnalysis(_6342.SpecialisedAssemblyDynamicAnalysis):
    """CycloidalAssemblyDynamicAnalysis
    ...
    class _Cast_CycloidalAssemblyDynamicAnalysis:
        ...
        def __init__(self, parent: 'CycloidalAssemblyDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def cycloidal_assembly_dynamic_analysis(self) -> 'CycloidalAssemblyDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalAssemblyDynamicAnalysis._Cast_CycloidalAssemblyDynamicAnalysis':
