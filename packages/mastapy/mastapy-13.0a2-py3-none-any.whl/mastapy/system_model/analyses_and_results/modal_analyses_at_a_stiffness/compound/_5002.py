...
class CVTPulleyCompoundModalAnalysisAtAStiffness(_5048.PulleyCompoundModalAnalysisAtAStiffness):
    """CVTPulleyCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_CVTPulleyCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'CVTPulleyCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def cvt_pulley_compound_modal_analysis_at_a_stiffness(self) -> 'CVTPulleyCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4872.CVTPulleyModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4872.CVTPulleyModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'CVTPulleyCompoundModalAnalysisAtAStiffness._Cast_CVTPulleyCompoundModalAnalysisAtAStiffness':
