...
class KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis(_3906.ConicalGearCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_conical_gear_compound_stability_analysis(self) -> 'KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3811.KlingelnbergCycloPalloidConicalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3811.KlingelnbergCycloPalloidConicalGearStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis._Cast_KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis':
        return self._Cast_KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis(self)
