...
class ISOScuffingResultsRow(_479.ScuffingResultsRow):
    """ISOScuffingResultsRow
    ...
    class _Cast_ISOScuffingResultsRow:
        ...
        def __init__(self, parent: 'ISOScuffingResultsRow'):
            self._parent = parent
        ...
        @property
        def iso_scuffing_results_row(self) -> 'ISOScuffingResultsRow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ISOScuffingResultsRow._Cast_ISOScuffingResultsRow':
