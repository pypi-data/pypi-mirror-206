...
class BevelDifferentialGearCompoundSystemDeflection(_2846.BevelGearCompoundSystemDeflection):
    """BevelDifferentialGearCompoundSystemDeflection
    ...
    class _Cast_BevelDifferentialGearCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'BevelDifferentialGearCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_compound_system_deflection(self) -> 'BevelDifferentialGearCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2682.BevelDifferentialGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2682.BevelDifferentialGearSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearCompoundSystemDeflection._Cast_BevelDifferentialGearCompoundSystemDeflection':
