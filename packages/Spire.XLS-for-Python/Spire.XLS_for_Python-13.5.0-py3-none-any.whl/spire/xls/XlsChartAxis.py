...
class XlsChartAxis (  XlsObject, IChartAxis) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartAxis_get_AxisType(self.Ptr)
    ...
    def AxisType(self, value:'AxisType'):
        ...
        GetDllLibXls().XlsChartAxis_set_AxisType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartAxis_get_IsPrimary(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsChartAxis_get_Title.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartAxis_get_Title(self.Ptr)
        return ret
    ...
    def Title(self, value:str):
        ...
        GetDllLibXls().XlsChartAxis_set_Title(self.Ptr, value)
    ...
    def TextRotationAngle(self)->int:
        ...
        ret = GetDllLibXls().XlsChartAxis_get_TextRotationAngle(self.Ptr)
        return ret
    ...
    def TextRotationAngle(self, value:int):
        ...
        GetDllLibXls().XlsChartAxis_set_TextRotationAngle(self.Ptr, value)
    ...
    def IsAutoTextRotation(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartAxis_get_IsAutoTextRotation(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartAxis_get_TitleArea(self.Ptr)
    ...
    def Font(self)->'IFont':
        ...
        intPtr = GetDllLibXls().XlsChartAxis_get_Font(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartAxis_get_FrameFormat(self.Ptr)
    ...
    def Has3dProperties(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartAxis_get_Has3dProperties(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartAxis_get_HasAxisTitle(self.Ptr)
        return ret
    ...
    def MajorGridLines(self)->'IChartGridLine':
        ...
        intPtr = GetDllLibXls().XlsChartAxis_get_MajorGridLines(self.Ptr)
    ...
    def MinorGridLines(self)->'IChartGridLine':
        ...
        intPtr = GetDllLibXls().XlsChartAxis_get_MinorGridLines(self.Ptr)
        ret = None if intPtr==None else IChartGridLine(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartAxis_get_HasMinorGridLines(self.Ptr)
        return ret
    ...
    def HasMinorGridLines(self, value:bool):
        ...
        GetDllLibXls().XlsChartAxis_set_HasMinorGridLines(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartAxis_get_HasMajorGridLines(self.Ptr)
        return ret
    ...
    def HasMajorGridLines(self, value:bool):
        ...
        GetDllLibXls().XlsChartAxis_set_HasMajorGridLines(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartAxis_get_NumberFormatIndex(self.Ptr)
        return ret
    ...
    def NumberFormatIndex(self, value:int):
        ...
        GetDllLibXls().XlsChartAxis_set_NumberFormatIndex(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChartAxis_get_NumberFormat.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartAxis_get_NumberFormat(self.Ptr)
        return ret
    ...
    def NumberFormat(self, value:str):
        ...
        GetDllLibXls().XlsChartAxis_set_NumberFormat(self.Ptr, value)
    ...
    def MinorTickMark(self)->'TickMarkType':
        ...
        ret = GetDllLibXls().XlsChartAxis_get_MinorTickMark(self.Ptr)
    ...
    def MinorTickMark(self, value:'TickMarkType'):
        ...
        GetDllLibXls().XlsChartAxis_set_MinorTickMark(self.Ptr, value.value)
    ...
    def MajorTickMark(self)->'TickMarkType':
        ...
        ret = GetDllLibXls().XlsChartAxis_get_MajorTickMark(self.Ptr)
        objwraped = TickMarkType(ret)
        return objwraped
    ...
    def MajorTickMark(self, value:'TickMarkType'):
        ...
        GetDllLibXls().XlsChartAxis_set_MajorTickMark(self.Ptr, value.value)
    ...
    def Border(self)->'ChartBorder':
        ...
        intPtr = GetDllLibXls().XlsChartAxis_get_Border(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartAxis_get_TickLabelPosition(self.Ptr)
    ...
    def TickLabelPosition(self, value:'TickLabelPositionType'):
        ...
        GetDllLibXls().XlsChartAxis_set_TickLabelPosition(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartAxis_get_MultiLevelLable(self.Ptr)
        return ret
    ...
    def MultiLevelLable(self, value:bool):
        ...
        GetDllLibXls().XlsChartAxis_set_MultiLevelLable(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartAxis_get_Visible(self.Ptr)
        return ret

    @Visible.setter
    def Visible(self, value:bool):
        GetDllLibXls().XlsChartAxis_set_Visible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartAxis_set_Visible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartAxis_get_Alignment(self.Ptr)
    ...
    def Alignment(self, value:'AxisTextDirectionType'):
        ...
        GetDllLibXls().XlsChartAxis_set_Alignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartAxis_get_IsReversed(self.Ptr)
        return ret

    @IsReversed.setter
    def IsReversed(self, value:bool):
        GetDllLibXls().XlsChartAxis_set_IsReversed.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartAxis_set_IsReversed(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartAxis_get_AxisId(self.Ptr)
        return ret
    ...
    def Chart3DOptions(self)->'IFormat3D':
        ...
        intPtr = GetDllLibXls().XlsChartAxis_get_Chart3DOptions(self.Ptr)
    ...
    def Chart3DProperties(self)->'IFormat3D':
        ...
        intPtr = GetDllLibXls().XlsChartAxis_get_Chart3DProperties(self.Ptr)
        ret = None if intPtr==None else Format3D(intPtr)
        return ret
    ...
    def Deleted(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartAxis_get_Deleted(self.Ptr)
        return ret

    @Deleted.setter
    def Deleted(self, value:bool):
        GetDllLibXls().XlsChartAxis_set_Deleted.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartAxis_set_Deleted(self.Ptr, value)
    ...
    def ParagraphType(self)->'ChartParagraphType':
        ...
        ret = GetDllLibXls().XlsChartAxis_get_ParagraphType(self.Ptr)
    ...
    def ParagraphType(self, value:'ChartParagraphType'):
        ...
        GetDllLibXls().XlsChartAxis_set_ParagraphType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartAxis_get_Shadow(self.Ptr)
    ...
    def ShadowProperties(self)->'IShadow':
        ...
        intPtr = GetDllLibXls().XlsChartAxis_get_ShadowProperties(self.Ptr)
        ret = None if intPtr==None else ChartShadow(intPtr)
        return ret
    ...
    def AutoTickLabelSpacing(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartAxis_get_AutoTickLabelSpacing(self.Ptr)
        return ret
    ...
    def AutoTickLabelSpacing(self, value:bool):
        ...
        GetDllLibXls().XlsChartAxis_set_AutoTickLabelSpacing(self.Ptr, value)
    ...
    def AutoTickMarkSpacing(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartAxis_get_AutoTickMarkSpacing(self.Ptr)
        return ret
    ...
    def AutoTickMarkSpacing(self, value:bool):
        ...
        GetDllLibXls().XlsChartAxis_set_AutoTickMarkSpacing(self.Ptr, value)
    ...
    def IsSourceLinked(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartAxis_get_IsSourceLinked(self.Ptr)
        return ret
    ...
    def IsSourceLinked(self, value:bool):
        ...
        GetDllLibXls().XlsChartAxis_set_IsSourceLinked(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartAxis_get_TextDirection(self.Ptr)
    ...
    def TextDirection(self, value:'TextVerticalValue'):
        ...
        GetDllLibXls().XlsChartAxis_set_TextDirection(self.Ptr, value.value)
...
#        intPtr = GetDllLibXls().XlsChartAxis_Clone(self.Ptr, intPtrparent,intPtrdicFontIndexes,intPtrdicNewSheetNames)
