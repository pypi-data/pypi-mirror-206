...
class PlungeShaverSettings(_0.APIBase):
    ...
    class _Cast_PlungeShaverSettings:
        ...
        def __init__(self, parent: 'PlungeShaverSettings'):
            self._parent = parent

        @property
        def plunge_shaver_settings(self) -> 'PlungeShaverSettings':
            return self._parent
    ...
    @property
    def lead_display_method(self) -> '_640.MicroGeometryDefinitionMethod':
    ...
    def lead_display_method(self, value: '_640.MicroGeometryDefinitionMethod'):
    ...
    @property
    def profile_display_method(self) -> '_640.MicroGeometryDefinitionMethod':
    ...
    def profile_display_method(self, value: '_640.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _640.MicroGeometryDefinitionMethod.type_())
    ...
    @property
    def cast_to(self) -> 'PlungeShaverSettings._Cast_PlungeShaverSettings':
