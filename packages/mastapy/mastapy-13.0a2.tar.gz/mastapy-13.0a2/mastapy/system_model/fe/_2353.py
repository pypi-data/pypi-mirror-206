...
from mastapy.system_model.fe import _2351
...
class DegreeOfFreedomBoundaryConditionLinear(_2351.DegreeOfFreedomBoundaryCondition):
    """DegreeOfFreedomBoundaryConditionLinear
    ...
    class _Cast_DegreeOfFreedomBoundaryConditionLinear:
        ...
        def __init__(self, parent: 'DegreeOfFreedomBoundaryConditionLinear'):
            self._parent = parent

        @property
        def degree_of_freedom_boundary_condition(self):
            return self._parent._cast(_2351.DegreeOfFreedomBoundaryCondition)

        @property
        def degree_of_freedom_boundary_condition_linear(self) -> 'DegreeOfFreedomBoundaryConditionLinear':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DegreeOfFreedomBoundaryConditionLinear._Cast_DegreeOfFreedomBoundaryConditionLinear':
