...
class CylindricalGearManufactureError(_6855.GearManufactureError):
    """CylindricalGearManufactureError
    ...
    class _Cast_CylindricalGearManufactureError:
        ...
        def __init__(self, parent: 'CylindricalGearManufactureError'):
            self._parent = parent

        @property
        def gear_manufacture_error(self):
            return self._parent._cast(_6855.GearManufactureError)

        @property
        def cylindrical_gear_manufacture_error(self) -> 'CylindricalGearManufactureError':
            return self._parent
    ...
    @property
    def pitch_errors_left_flank(self) -> '_1523.Vector2DListAccessor':
    ...
    def pitch_errors_left_flank(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.PitchErrorsLeftFlank = value

    @property
    def pitch_errors_right_flank(self) -> '_1523.Vector2DListAccessor':
    ...
    def pitch_errors_right_flank(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def cast_to(self) -> 'CylindricalGearManufactureError._Cast_CylindricalGearManufactureError':
