...
class SynchroniserHalfDynamicAnalysis(_6359.SynchroniserPartDynamicAnalysis):
    """SynchroniserHalfDynamicAnalysis
    ...
    class _Cast_SynchroniserHalfDynamicAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserHalfDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_half_dynamic_analysis(self) -> 'SynchroniserHalfDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserHalfDynamicAnalysis._Cast_SynchroniserHalfDynamicAnalysis':
