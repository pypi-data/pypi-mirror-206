...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3237, _3235, _3241
...
class BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft(_3241.BevelGearSetSteadyStateSynchronousResponseOnAShaft):
    """BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_set_steady_state_synchronous_response_on_a_shaft(self) -> 'BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def bevel_differential_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3237.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bevel_differential_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3235.BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft._Cast_BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft(self)
