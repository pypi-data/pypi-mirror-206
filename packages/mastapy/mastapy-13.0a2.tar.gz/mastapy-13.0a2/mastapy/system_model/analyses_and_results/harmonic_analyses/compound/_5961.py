...
class SynchroniserPartCompoundHarmonicAnalysis(_5885.CouplingHalfCompoundHarmonicAnalysis):
    """SynchroniserPartCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5796.SynchroniserPartHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5796.SynchroniserPartHarmonicAnalysis]':
