...
class BoltHarmonicAnalysisOfSingleExcitation(_6000.ComponentHarmonicAnalysisOfSingleExcitation):
    """BoltHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_BoltHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'BoltHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def bolt_harmonic_analysis_of_single_excitation(self) -> 'BoltHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltHarmonicAnalysisOfSingleExcitation._Cast_BoltHarmonicAnalysisOfSingleExcitation':
