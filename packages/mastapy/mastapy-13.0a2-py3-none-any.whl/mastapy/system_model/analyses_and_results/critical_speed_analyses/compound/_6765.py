...
class ZerolBevelGearCompoundCriticalSpeedAnalysis(_6655.BevelGearCompoundCriticalSpeedAnalysis):
    """ZerolBevelGearCompoundCriticalSpeedAnalysis
    ...
    class _Cast_ZerolBevelGearCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_compound_critical_speed_analysis(self) -> 'ZerolBevelGearCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6636.ZerolBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6636.ZerolBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearCompoundCriticalSpeedAnalysis._Cast_ZerolBevelGearCompoundCriticalSpeedAnalysis':
