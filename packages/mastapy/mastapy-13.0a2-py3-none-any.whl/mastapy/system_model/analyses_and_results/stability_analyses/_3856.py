...
class StraightBevelPlanetGearStabilityAnalysis(_3852.StraightBevelDiffGearStabilityAnalysis):
    """StraightBevelPlanetGearStabilityAnalysis
    ...
    class _Cast_StraightBevelPlanetGearStabilityAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelPlanetGearStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_planet_gear_stability_analysis(self) -> 'StraightBevelPlanetGearStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelPlanetGearStabilityAnalysis._Cast_StraightBevelPlanetGearStabilityAnalysis':
