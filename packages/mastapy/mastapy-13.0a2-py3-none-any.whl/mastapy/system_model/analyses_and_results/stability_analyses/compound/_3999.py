...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3997, _3998, _3934
...
class WormGearSetCompoundStabilityAnalysis(_3934.GearSetCompoundStabilityAnalysis):
    """WormGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3869.WormGearSetStabilityAnalysis]':
    ...
    @property
    def worm_gears_compound_stability_analysis(self) -> 'List[_3997.WormGearCompoundStabilityAnalysis]':
    ...
    @property
    def worm_meshes_compound_stability_analysis(self) -> 'List[_3998.WormGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3869.WormGearSetStabilityAnalysis]':
