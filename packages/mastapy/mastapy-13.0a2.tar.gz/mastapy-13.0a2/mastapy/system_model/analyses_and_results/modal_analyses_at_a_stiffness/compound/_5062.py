...
class SpringDamperCompoundModalAnalysisAtAStiffness(_4997.CouplingCompoundModalAnalysisAtAStiffness):
    """SpringDamperCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4935.SpringDamperModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4935.SpringDamperModalAnalysisAtAStiffness]':
