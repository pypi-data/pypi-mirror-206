...
class KlingelnbergConicalMeshSingleFlankRating(_362.MeshSingleFlankRating):
    """KlingelnbergConicalMeshSingleFlankRating
    ...
    class _Cast_KlingelnbergConicalMeshSingleFlankRating:
        ...
        def __init__(self, parent: 'KlingelnbergConicalMeshSingleFlankRating'):
            self._parent = parent
        ...
        @property
        def klingelnberg_conical_mesh_single_flank_rating(self) -> 'KlingelnbergConicalMeshSingleFlankRating':
            return self._parent
    ...
    @property
    def lubrication_speed_ampersand_roughness_factor_product(self) -> 'float':
        """float: 'LubricationSpeedAmpersandRoughnessFactorProduct' is the original name of this property.
    ...
    @property
    def virtual_cylindrical_gear_set(self) -> '_383.KlingelnbergVirtualCylindricalGearSet':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergConicalMeshSingleFlankRating._Cast_KlingelnbergConicalMeshSingleFlankRating':
