...
from mastapy.licensing import _7534, _7535, _7536
...
class LicenceServer:
    ...
    class _Cast_LicenceServer:
        ...
        def __init__(self, parent: 'LicenceServer'):
            self._parent = parent

        @property
        def licence_server(self) -> 'LicenceServer':
            return self._parent
    ...
    @staticmethod
    def update_server_settings(server_details: '_7534.LicenceServerDetails'):
    ...
    @staticmethod
    def get_server_settings() -> '_7534.LicenceServerDetails':
    ...
    @staticmethod
    def get_licensed_module_details() -> 'Iterable[_7535.ModuleDetails]':
    ...
    @staticmethod
    def get_available_module_details() -> 'Iterable[_7535.ModuleDetails]':
    ...
    @staticmethod
    def get_requested_module_statuses() -> 'Iterable[_7536.ModuleLicenceStatus]':
    ...
    @property
    def cast_to(self) -> 'LicenceServer._Cast_LicenceServer':
