...
class ZerolBevelGearMeshSteadyStateSynchronousResponse(_2978.BevelGearMeshSteadyStateSynchronousResponse):
    """ZerolBevelGearMeshSteadyStateSynchronousResponse
    ...
    class _Cast_ZerolBevelGearMeshSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'ZerolBevelGearMeshSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_mesh_steady_state_synchronous_response(self) -> 'ZerolBevelGearMeshSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearMeshSteadyStateSynchronousResponse._Cast_ZerolBevelGearMeshSteadyStateSynchronousResponse':
