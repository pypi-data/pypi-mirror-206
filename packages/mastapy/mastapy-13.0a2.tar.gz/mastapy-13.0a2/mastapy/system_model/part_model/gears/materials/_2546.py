...
class GearMaterialExpertSystemMaterialOptions(_0.APIBase):
    ...
    class _Cast_GearMaterialExpertSystemMaterialOptions:
        ...
        def __init__(self, parent: 'GearMaterialExpertSystemMaterialOptions'):
            self._parent = parent

        @property
        def gear_material_expert_system_material_options(self) -> 'GearMaterialExpertSystemMaterialOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GearMaterialExpertSystemMaterialOptions._Cast_GearMaterialExpertSystemMaterialOptions':
