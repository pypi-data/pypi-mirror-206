...
class SpringDamperAdvancedSystemDeflection(_7273.CouplingAdvancedSystemDeflection):
    """SpringDamperAdvancedSystemDeflection
    ...
    class _Cast_SpringDamperAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'SpringDamperAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def spring_damper_advanced_system_deflection(self) -> 'SpringDamperAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperAdvancedSystemDeflection._Cast_SpringDamperAdvancedSystemDeflection':
