...
def main():
    ...
    nonce = "baka"
    scope = "openid"
    # getauthToken(client_id, redirect_uri,response_type,secret_key,scope,state,nonce)
    auth_code = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..eZ76ycUKXYuHlGOasqSrOfqfMTlMcpPsCF4KMLlWhjw"

    # print(generate_access_token(auth_code, client_id, redirect_uri,secret_key,grant_type))

    access_token ="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..TUlu1VX_zyNCrwvbhS4nGmGQprjcVfOKn85guw8zi3s"
