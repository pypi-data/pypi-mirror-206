...
class XlsPivotTablesCollection (  SpireObject,IPivotTables) :
    """
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().XlsPivotTablesCollection_get_Count(self.Ptr)
        return ret
    ...
    def get_Item(self ,index:int)->IPivotTable:
        ...
        intPtr = GetDllLibXls().XlsPivotTablesCollection_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->IPivotTable:
        ...
        intPtr = GetDllLibXls().XlsPivotTablesCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsPivotTable(intPtr)
        return ret
    ...
    def Add(self ,name:str,location:'CellRange',cache:'PivotCache')->'XlsPivotTable':
        ...
        intPtr = GetDllLibXls().XlsPivotTablesCollection_Add(self.Ptr, name,intPtrlocation,intPtrcache)
        ret = None if intPtr==None else XlsPivotTable(intPtr)
        return ret
    ...
    def Remove(self ,name:str):
        ...
        GetDllLibXls().XlsPivotTablesCollection_Remove(self.Ptr, name)
    ...
    def RemoveAt(self ,index:int):
        ...
        GetDllLibXls().XlsPivotTablesCollection_RemoveAt(self.Ptr, index)
    ...
    def Remove(self ,pivotTable:IPivotTable):
        ...
        GetDllLibXls().XlsPivotTablesCollection_RemoveP(self.Ptr, intPtrpivotTable)
    ...
    def Clear(self):
        ...
        GetDllLibXls().XlsPivotTablesCollection_Clear(self.Ptr)
    ...
    def ParentWorksheet(self)->'XlsWorksheetBase':
        ...
        intPtr = GetDllLibXls().XlsPivotTablesCollection_get_ParentWorksheet(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsPivotTablesCollection_Clone(self.Ptr, intPtrworksheet,intPtrhashWorksheetNames)
