...
class ConicalGearMeshModalAnalysis(_4609.GearMeshModalAnalysis):
    """ConicalGearMeshModalAnalysis
    ...
    class _Cast_ConicalGearMeshModalAnalysis:
        ...
        def __init__(self, parent: 'ConicalGearMeshModalAnalysis'):
            self._parent = parent
        ...
        @property
        def conical_gear_mesh_modal_analysis(self) -> 'ConicalGearMeshModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConicalGearMeshModalAnalysis._Cast_ConicalGearMeshModalAnalysis':
