...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6213, _6214, _6123
...
class StraightBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6123.BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """StraightBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_StraightBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'StraightBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_set_compound_harmonic_analysis_of_single_excitation(self) -> 'StraightBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6086.StraightBevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_gears_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6213.StraightBevelGearCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_meshes_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6214.StraightBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6086.StraightBevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation._Cast_StraightBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_StraightBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(self)
