...
class ShaftSteadyStateSynchronousResponseAtASpeed(_3485.AbstractShaftSteadyStateSynchronousResponseAtASpeed):
    """ShaftSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ShaftSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ShaftSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def shaft_steady_state_synchronous_response_at_a_speed(self) -> 'ShaftSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftSteadyStateSynchronousResponseAtASpeed._Cast_ShaftSteadyStateSynchronousResponseAtASpeed':
