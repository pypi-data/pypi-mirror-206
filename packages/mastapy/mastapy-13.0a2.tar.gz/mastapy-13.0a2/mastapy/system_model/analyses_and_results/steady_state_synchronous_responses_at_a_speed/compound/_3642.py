...
class ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed(_3671.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def concept_gear_compound_steady_state_synchronous_response_at_a_speed(self) -> 'ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3514.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3514.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed._Cast_ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed(self)
