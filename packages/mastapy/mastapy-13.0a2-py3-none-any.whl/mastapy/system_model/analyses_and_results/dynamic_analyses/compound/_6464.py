...
class RollingRingAssemblyCompoundDynamicAnalysis(_6471.SpecialisedAssemblyCompoundDynamicAnalysis):
    """RollingRingAssemblyCompoundDynamicAnalysis
    ...
    class _Cast_RollingRingAssemblyCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'RollingRingAssemblyCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def rolling_ring_assembly_compound_dynamic_analysis(self) -> 'RollingRingAssemblyCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6335.RollingRingAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6335.RollingRingAssemblyDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'RollingRingAssemblyCompoundDynamicAnalysis._Cast_RollingRingAssemblyCompoundDynamicAnalysis':
