...
class AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis(_5881.ConnectionCompoundHarmonicAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5652.AbstractShaftToMountableComponentConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5652.AbstractShaftToMountableComponentConnectionHarmonicAnalysis]':
