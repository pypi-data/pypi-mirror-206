...
class FaceGearMeshCompoundCriticalSpeedAnalysis(_6698.GearMeshCompoundCriticalSpeedAnalysis):
    """FaceGearMeshCompoundCriticalSpeedAnalysis
    ...
    class _Cast_FaceGearMeshCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'FaceGearMeshCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def face_gear_mesh_compound_critical_speed_analysis(self) -> 'FaceGearMeshCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6564.FaceGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6564.FaceGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'FaceGearMeshCompoundCriticalSpeedAnalysis._Cast_FaceGearMeshCompoundCriticalSpeedAnalysis':
