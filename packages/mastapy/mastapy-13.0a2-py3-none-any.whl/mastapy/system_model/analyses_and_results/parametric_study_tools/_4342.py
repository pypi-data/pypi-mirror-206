...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4341, _4340, _4277
...
class HypoidGearSetParametricStudyTool(_4277.AGMAGleasonConicalGearSetParametricStudyTool):
    """HypoidGearSetParametricStudyTool
    ...
    class _Cast_HypoidGearSetParametricStudyTool:
        ...
        def __init__(self, parent: 'HypoidGearSetParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_set_parametric_study_tool(self) -> 'HypoidGearSetParametricStudyTool':
            return self._parent
    ...
    @property
    def hypoid_gears_parametric_study_tool(self) -> 'List[_4341.HypoidGearParametricStudyTool]':
    ...
    @property
    def hypoid_meshes_parametric_study_tool(self) -> 'List[_4340.HypoidGearMeshParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearSetParametricStudyTool._Cast_HypoidGearSetParametricStudyTool':
