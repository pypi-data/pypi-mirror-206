...
class KlingelnbergCycloPalloidConicalGearSingleFlankRating(_360.GearSingleFlankRating):
    """KlingelnbergCycloPalloidConicalGearSingleFlankRating
    ...
    class _Cast_KlingelnbergCycloPalloidConicalGearSingleFlankRating:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidConicalGearSingleFlankRating'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_conical_gear_single_flank_rating(self) -> 'KlingelnbergCycloPalloidConicalGearSingleFlankRating':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidConicalGearSingleFlankRating._Cast_KlingelnbergCycloPalloidConicalGearSingleFlankRating':
