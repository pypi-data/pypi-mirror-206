...
class ShaverPointOfInterest(_0.APIBase):
    ...
    class _Cast_ShaverPointOfInterest:
        ...
        def __init__(self, parent: 'ShaverPointOfInterest'):
            self._parent = parent

        @property
        def shaver_point_of_interest(self) -> 'ShaverPointOfInterest':
            return self._parent
    ...
    @property
    def point_of_interest_on_the_gear(self) -> '_648.PointOfInterest':
    ...
    @property
    def cast_to(self) -> 'ShaverPointOfInterest._Cast_ShaverPointOfInterest':
