...
class PartToPartShearCouplingCompoundStabilityAnalysis(_3911.CouplingCompoundStabilityAnalysis):
    """PartToPartShearCouplingCompoundStabilityAnalysis
    ...
    class _Cast_PartToPartShearCouplingCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_compound_stability_analysis(self) -> 'PartToPartShearCouplingCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3825.PartToPartShearCouplingStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3825.PartToPartShearCouplingStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingCompoundStabilityAnalysis._Cast_PartToPartShearCouplingCompoundStabilityAnalysis':
