...
class CylindricalGearStabilityAnalysis(_3803.GearStabilityAnalysis):
    """CylindricalGearStabilityAnalysis
    ...
    class _Cast_CylindricalGearStabilityAnalysis:
        ...
        def __init__(self, parent: 'CylindricalGearStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_stability_analysis(self) -> 'CylindricalGearStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearStabilityAnalysis._Cast_CylindricalGearStabilityAnalysis':
