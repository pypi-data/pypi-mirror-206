...
from tecton_core.aggregation_utils import AGGREGATION_FUNCTIONS_TO_COLUMN_NAME
...
def _simple_aggregation_plan(
    ...
    return AggregationPlan(
        ...
        materialized_column_prefixes=[AGGREGATION_FUNCTIONS_TO_COLUMN_NAME.get(aggregation_function)],
...
def _mean_aggregation_plan():
    return AggregationPlan(
        ...
        materialized_column_prefixes=[
            AGGREGATION_FUNCTIONS_TO_COLUMN_NAME.get(afpb.AGGREGATION_FUNCTION_MEAN),
            AGGREGATION_FUNCTIONS_TO_COLUMN_NAME.get(afpb.AGGREGATION_FUNCTION_COUNT),
        ],
...
stddev_var_materialized_column_prefixes = [
    ...
    AGGREGATION_FUNCTIONS_TO_COLUMN_NAME.get(afpb.AGGREGATION_FUNCTION_COUNT),
    AGGREGATION_FUNCTIONS_TO_COLUMN_NAME.get(afpb.AGGREGATION_FUNCTION_SUM),
]
