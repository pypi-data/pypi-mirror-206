...
class AbstractVaryingInputComponent(_0.APIBase):
    ...
    class _Cast_AbstractVaryingInputComponent:
        ...
        def __init__(self, parent: 'AbstractVaryingInputComponent'):
            self._parent = parent

        @property
        def angle_input_component(self):
            from mastapy.nodal_analysis.varying_input_components import _93
            
            return self._parent._cast(_93.AngleInputComponent)

        @property
        def force_input_component(self):
            from mastapy.nodal_analysis.varying_input_components import _94
            
            return self._parent._cast(_94.ForceInputComponent)

        @property
        def moment_input_component(self):
            from mastapy.nodal_analysis.varying_input_components import _95
            
            return self._parent._cast(_95.MomentInputComponent)

        @property
        def non_dimensional_input_component(self):
            from mastapy.nodal_analysis.varying_input_components import _96
            
            return self._parent._cast(_96.NonDimensionalInputComponent)

        @property
        def velocity_input_component(self):
            from mastapy.nodal_analysis.varying_input_components import _98
            
            return self._parent._cast(_98.VelocityInputComponent)

        @property
        def abstract_varying_input_component(self) -> 'AbstractVaryingInputComponent':
            return self._parent
    ...
    @property
    def value_vs_angle(self) -> '_1523.Vector2DListAccessor':
    ...
    def value_vs_angle(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.ValueVsAngle = value

    @property
    def value_vs_angle_and_speed(self) -> '_1554.GriddedSurfaceAccessor':
    ...
    def value_vs_angle_and_speed(self, value: '_1554.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
        self.wrapped.ValueVsAngleAndSpeed = value

    @property
    def value_vs_position(self) -> '_1523.Vector2DListAccessor':
    ...
    def value_vs_position(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.ValueVsPosition = value

    @property
    def value_vs_time(self) -> '_1523.Vector2DListAccessor':
    ...
    def value_vs_time(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def cast_to(self) -> 'AbstractVaryingInputComponent._Cast_AbstractVaryingInputComponent':
