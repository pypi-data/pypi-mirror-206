...
class TorqueConverterCompoundStabilityAnalysis(_3911.CouplingCompoundStabilityAnalysis):
    """TorqueConverterCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3864.TorqueConverterStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3864.TorqueConverterStabilityAnalysis]':
