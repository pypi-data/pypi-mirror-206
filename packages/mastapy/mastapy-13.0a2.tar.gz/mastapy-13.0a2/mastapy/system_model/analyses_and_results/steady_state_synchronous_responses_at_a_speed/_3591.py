...
class StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed(_3501.BevelGearSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_steady_state_synchronous_response_at_a_speed(self) -> 'StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed._Cast_StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed(self)
