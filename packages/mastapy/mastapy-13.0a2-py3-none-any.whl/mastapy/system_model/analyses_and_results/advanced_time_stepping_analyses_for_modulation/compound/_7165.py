...
class HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7107.AGMAGleasonConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7036.HypoidGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7036.HypoidGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation(self)
