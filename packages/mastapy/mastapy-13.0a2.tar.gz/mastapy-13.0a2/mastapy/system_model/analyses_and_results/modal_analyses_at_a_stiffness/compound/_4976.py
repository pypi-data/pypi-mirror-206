...
class BevelGearCompoundModalAnalysisAtAStiffness(_4964.AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness):
    """BevelGearCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_BevelGearCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'BevelGearCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def bevel_gear_compound_modal_analysis_at_a_stiffness(self) -> 'BevelGearCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4847.BevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4847.BevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'BevelGearCompoundModalAnalysisAtAStiffness._Cast_BevelGearCompoundModalAnalysisAtAStiffness':
