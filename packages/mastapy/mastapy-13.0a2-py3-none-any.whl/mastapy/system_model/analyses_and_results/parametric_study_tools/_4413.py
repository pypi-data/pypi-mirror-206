...
class WormGearParametricStudyTool(_4337.GearParametricStudyTool):
    """WormGearParametricStudyTool
    ...
    class _Cast_WormGearParametricStudyTool:
        ...
        def __init__(self, parent: 'WormGearParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def worm_gear_parametric_study_tool(self) -> 'WormGearParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearParametricStudyTool._Cast_WormGearParametricStudyTool':
