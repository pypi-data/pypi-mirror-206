...
class SelectableFolder(_0.APIBase):
    ...
    class _Cast_SelectableFolder:
        ...
        def __init__(self, parent: 'SelectableFolder'):
            self._parent = parent

        @property
        def selectable_folder(self) -> 'SelectableFolder':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SelectableFolder._Cast_SelectableFolder':
        return self._Cast_SelectableFolder(self)
