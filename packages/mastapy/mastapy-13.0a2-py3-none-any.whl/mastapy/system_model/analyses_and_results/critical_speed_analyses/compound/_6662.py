...
class ClutchHalfCompoundCriticalSpeedAnalysis(_6678.CouplingHalfCompoundCriticalSpeedAnalysis):
    """ClutchHalfCompoundCriticalSpeedAnalysis
    ...
    class _Cast_ClutchHalfCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ClutchHalfCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_half_compound_critical_speed_analysis(self) -> 'ClutchHalfCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6531.ClutchHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6531.ClutchHalfCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ClutchHalfCompoundCriticalSpeedAnalysis._Cast_ClutchHalfCompoundCriticalSpeedAnalysis':
