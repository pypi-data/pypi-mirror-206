...
class StraightBevelPlanetGearSteadyStateSynchronousResponseOnAShaft(_3332.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelPlanetGearSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_StraightBevelPlanetGearSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'StraightBevelPlanetGearSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def straight_bevel_planet_gear_steady_state_synchronous_response_on_a_shaft(self) -> 'StraightBevelPlanetGearSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelPlanetGearSteadyStateSynchronousResponseOnAShaft._Cast_StraightBevelPlanetGearSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_StraightBevelPlanetGearSteadyStateSynchronousResponseOnAShaft(self)
