...
from Shared.certoraUtils import get_certora_config_dir, get_certora_build_file, get_certora_verify_file, \
    ...
    get_certora_verify_file_cvl1, find_filename_in, PRE_AUTOFINDER_BACKUP_DIR, POST_AUTOFINDER_BACKUP_DIR
...
class CertoraBuildGenerator:
    ...
    def build(self, context: CertoraContext) -> None:
        ...
        for i, build_arg_contract_file in enumerate(sorted(self.input_config.files)):
            ...
            ignore_patterns = shutil.ignore_patterns(PRE_AUTOFINDER_BACKUP_DIR,
                                                     POST_AUTOFINDER_BACKUP_DIR,
            ...
            shutil.copytree(get_certora_sources_dir(), pre_backup_dir,  # directory should not exist!
                            ignore=ignore_patterns)  # skip previous backups
            ...
            if compiler_lang == CompilerLangSol():
                ...
                shutil.copytree(get_certora_sources_dir(), post_backup_dir, ignore=ignore_patterns)
