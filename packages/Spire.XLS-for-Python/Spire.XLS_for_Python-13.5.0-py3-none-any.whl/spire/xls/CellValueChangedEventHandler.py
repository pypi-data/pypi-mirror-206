...
class CellValueChangedEventHandler (SpireObject) :
    ...
    def Invoke(self ,sender:'SpireObject',e:'CellValueChangedEventArgs'):
        ...
        GetDllLibXls().CellValueChangedEventHandler_Invoke(self.Ptr, intPtrsender,intPtre)
...
#        intPtr = GetDllLibXls().CellValueChangedEventHandler_BeginInvoke(self.Ptr, intPtrsender,intPtre,intPtrcallback,intPtrobject)
...
#        GetDllLibXls().CellValueChangedEventHandler_EndInvoke(self.Ptr, intPtrresult)
