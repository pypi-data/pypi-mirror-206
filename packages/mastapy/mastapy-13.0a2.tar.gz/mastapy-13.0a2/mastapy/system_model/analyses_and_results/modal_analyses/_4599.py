...
class DatumModalAnalysis(_4572.ComponentModalAnalysis):
    """DatumModalAnalysis
    ...
    class _Cast_DatumModalAnalysis:
        ...
        def __init__(self, parent: 'DatumModalAnalysis'):
            self._parent = parent
        ...
        @property
        def datum_modal_analysis(self) -> 'DatumModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DatumModalAnalysis._Cast_DatumModalAnalysis':
