...
class PartToPartShearCouplingModalAnalysis(_4587.CouplingModalAnalysis):
    """PartToPartShearCouplingModalAnalysis
    ...
    class _Cast_PartToPartShearCouplingModalAnalysis:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingModalAnalysis'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_modal_analysis(self) -> 'PartToPartShearCouplingModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingModalAnalysis._Cast_PartToPartShearCouplingModalAnalysis':
