...
class CycloidalAssemblyCriticalSpeedAnalysis(_6608.SpecialisedAssemblyCriticalSpeedAnalysis):
    """CycloidalAssemblyCriticalSpeedAnalysis
    ...
    class _Cast_CycloidalAssemblyCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'CycloidalAssemblyCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def cycloidal_assembly_critical_speed_analysis(self) -> 'CycloidalAssemblyCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalAssemblyCriticalSpeedAnalysis._Cast_CycloidalAssemblyCriticalSpeedAnalysis':
