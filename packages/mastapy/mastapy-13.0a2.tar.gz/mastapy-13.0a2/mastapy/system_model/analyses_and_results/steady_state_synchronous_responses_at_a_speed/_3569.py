...
class PointLoadSteadyStateSynchronousResponseAtASpeed(_3606.VirtualComponentSteadyStateSynchronousResponseAtASpeed):
    """PointLoadSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_PointLoadSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'PointLoadSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def point_load_steady_state_synchronous_response_at_a_speed(self) -> 'PointLoadSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PointLoadSteadyStateSynchronousResponseAtASpeed._Cast_PointLoadSteadyStateSynchronousResponseAtASpeed':
