...
class AddtionalFormatWrapper (  CommonWrapper, IInternalAddtionalFormat, IExtendIndex, IStyle) :
    ...
    def BuiltIn(self)->bool:
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_BuiltIn(self.Ptr)
        return ret
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().AddtionalFormatWrapper_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().AddtionalFormatWrapper_get_Name(self.Ptr)
        return ret
    ...
    def IsInitialized(self)->bool:
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_IsInitialized(self.Ptr)
        return ret
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_get_Parent(self.Ptr)
    ...
    def Workbook(self)->'XlsWorkbook':
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_get_Workbook(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_get_BottomBorderColor(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_get_TopBorderColor(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_get_LeftBorderColor(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_get_RightBorderColor(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_get_DiagonalBorderColor(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_LeftBorderLineStyle(self.Ptr)
    ...
    def LeftBorderLineStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_LeftBorderLineStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_RightBorderLineStyle(self.Ptr)
        objwraped = LineStyleType(ret)
        return objwraped
    ...
    def RightBorderLineStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_RightBorderLineStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_TopBorderLineStyle(self.Ptr)
        objwraped = LineStyleType(ret)
        return objwraped
    ...
    def TopBorderLineStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_TopBorderLineStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_BottomBorderLineStyle(self.Ptr)
        objwraped = LineStyleType(ret)
        return objwraped
    ...
    def BottomBorderLineStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_BottomBorderLineStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_DiagonalUpBorderLineStyle(self.Ptr)
        objwraped = LineStyleType(ret)
        return objwraped
    ...
    def DiagonalUpBorderLineStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_DiagonalUpBorderLineStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_DiagonalDownBorderLineStyle(self.Ptr)
        objwraped = LineStyleType(ret)
        return objwraped
    ...
    def DiagonalDownBorderLineStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_DiagonalDownBorderLineStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_DiagonalUpVisible(self.Ptr)
        return ret
    ...
    def DiagonalUpVisible(self, value:bool):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_DiagonalUpVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_DiagonalDownVisible(self.Ptr)
        return ret
    ...
    def DiagonalDownVisible(self, value:bool):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_DiagonalDownVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_FillPattern(self.Ptr)
    ...
    def FillPattern(self, value:'ExcelPatternType'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_FillPattern(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_ExtendedFormatIndex(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_BackgroundKnownColor(self.Ptr)
    ...
    def BackgroundKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_BackgroundKnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_get_BackgroundColor(self.Ptr)
    ...
    def BackgroundColor(self, value:'Color'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_BackgroundColor(self.Ptr, value.Ptr)
    ...
    def SetThemeColor(self ,type:'ThemeColorType',tint:float):
        ...
        GetDllLibXls().AddtionalFormatWrapper_SetThemeColor(self.Ptr, enumtype,tint)
...
#        ret = GetDllLibXls().AddtionalFormatWrapper_GetThemeColor(self.Ptr, intPtrtype,intPtrtint)
#        return ret
    ...
    def SetBackgroundThemeColor(self ,type:'ThemeColorType',tint:int):
        ...
        GetDllLibXls().AddtionalFormatWrapper_SetBackgroundThemeColor(self.Ptr, enumtype,tint)
...
#        ret = GetDllLibXls().AddtionalFormatWrapper_GetBackgroundThemeColor(self.Ptr, intPtrtype,intPtrtint)
#        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_ForegroundKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def ForegroundKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_ForegroundKnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_get_ForegroundColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def ForegroundColor(self, value:'Color'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_ForegroundColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_NumberFormatIndex(self.Ptr)
        return ret
    ...
    def NumberFormatIndex(self, value:int):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_NumberFormatIndex(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_HorizontalAlignment(self.Ptr)
    ...
    def HorizontalAlignment(self, value:'HorizontalAlignType'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_HorizontalAlignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_IncludeAlignment(self.Ptr)
        return ret
    ...
    def IncludeAlignment(self, value:bool):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_IncludeAlignment(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_IncludeBorder(self.Ptr)
        return ret
    ...
    def IncludeBorder(self, value:bool):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_IncludeBorder(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_IncludeFont(self.Ptr)
        return ret

    @IncludeFont.setter
    def IncludeFont(self, value:bool):
        GetDllLibXls().AddtionalFormatWrapper_set_IncludeFont.argtypes=[c_void_p, c_bool]
        GetDllLibXls().AddtionalFormatWrapper_set_IncludeFont(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_IncludeNumberFormat(self.Ptr)
        return ret
    ...
    def IncludeNumberFormat(self, value:bool):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_IncludeNumberFormat(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_IncludePatterns(self.Ptr)
        return ret
    ...
    def IncludePatterns(self, value:bool):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_IncludePatterns(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_IncludeProtection(self.Ptr)
        return ret
    ...
    def IncludeProtection(self, value:bool):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_IncludeProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_IndentLevel(self.Ptr)
        return ret

    @IndentLevel.setter
    def IndentLevel(self, value:int):
        GetDllLibXls().AddtionalFormatWrapper_set_IndentLevel.argtypes=[c_void_p, c_int]
        GetDllLibXls().AddtionalFormatWrapper_set_IndentLevel(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_FormulaHidden(self.Ptr)
        return ret
    ...
    def FormulaHidden(self, value:bool):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_FormulaHidden(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_Locked(self.Ptr)
        return ret

    @Locked.setter
    def Locked(self, value:bool):
        GetDllLibXls().AddtionalFormatWrapper_set_Locked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().AddtionalFormatWrapper_set_Locked(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_JustifyLast(self.Ptr)
        return ret

    @JustifyLast.setter
    def JustifyLast(self, value:bool):
        GetDllLibXls().AddtionalFormatWrapper_set_JustifyLast.argtypes=[c_void_p, c_bool]
        GetDllLibXls().AddtionalFormatWrapper_set_JustifyLast(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().AddtionalFormatWrapper_get_NumberFormat.restype=c_wchar_p
        ret = GetDllLibXls().AddtionalFormatWrapper_get_NumberFormat(self.Ptr)
        return ret
    ...
    def NumberFormat(self, value:str):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_NumberFormat(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().AddtionalFormatWrapper_get_NumberFormatLocal.restype=c_wchar_p
        ret = GetDllLibXls().AddtionalFormatWrapper_get_NumberFormatLocal(self.Ptr)
        return ret
    ...
    def NumberFormatLocal(self, value:str):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_NumberFormatLocal(self.Ptr, value)
    ...
    #    intPtr = GetDllLibXls().AddtionalFormatWrapper_get_NumberFormatSettings(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_ReadingOrder(self.Ptr)
    ...
    def ReadingOrder(self, value:'ReadingOrderType'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_ReadingOrder(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:int):
        GetDllLibXls().AddtionalFormatWrapper_set_Rotation.argtypes=[c_void_p, c_int]
        GetDllLibXls().AddtionalFormatWrapper_set_Rotation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_ShrinkToFit(self.Ptr)
        return ret

    @ShrinkToFit.setter
    def ShrinkToFit(self, value:bool):
        GetDllLibXls().AddtionalFormatWrapper_set_ShrinkToFit.argtypes=[c_void_p, c_bool]
        GetDllLibXls().AddtionalFormatWrapper_set_ShrinkToFit(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_VerticalAlignment(self.Ptr)
    ...
    def VerticalAlignment(self, value:'VerticalAlignType'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_VerticalAlignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_WrapText(self.Ptr)
        return ret

    @WrapText.setter
    def WrapText(self, value:bool):
        GetDllLibXls().AddtionalFormatWrapper_set_WrapText.argtypes=[c_void_p, c_bool]
        GetDllLibXls().AddtionalFormatWrapper_set_WrapText(self.Ptr, value)
    ...
    def Font(self)->'IFont':
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_get_Font(self.Ptr)
    ...
    def Borders(self)->'IBorders':
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_get_Borders(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_IsFirstSymbolApostrophe(self.Ptr)
        return ret
    ...
    def IsFirstSymbolApostrophe(self, value:bool):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_IsFirstSymbolApostrophe(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_PatternKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def PatternKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_PatternKnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_get_PatternColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def PatternColor(self, value:'Color'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_PatternColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_KnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_KnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_get_Color(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().AddtionalFormatWrapper_set_Color(self.Ptr, value.Ptr)
    ...
    def Interior(self)->'IInterior':
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_get_Interior(self.Ptr)
    ...
    def IsModified(self)->bool:
        ...
        ret = GetDllLibXls().AddtionalFormatWrapper_get_IsModified(self.Ptr)
        return ret
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().AddtionalFormatWrapper_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().AddtionalFormatWrapper_EndUpdate(self.Ptr)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().AddtionalFormatWrapper_Clone(self.Ptr, intPtrparent)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
