...
class PlanetCarrierCompoundSteadyStateSynchronousResponse(_3172.MountableComponentCompoundSteadyStateSynchronousResponse):
    """PlanetCarrierCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_PlanetCarrierCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'PlanetCarrierCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def planet_carrier_compound_steady_state_synchronous_response(self) -> 'PlanetCarrierCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3048.PlanetCarrierSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3048.PlanetCarrierSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierCompoundSteadyStateSynchronousResponse._Cast_PlanetCarrierCompoundSteadyStateSynchronousResponse':
