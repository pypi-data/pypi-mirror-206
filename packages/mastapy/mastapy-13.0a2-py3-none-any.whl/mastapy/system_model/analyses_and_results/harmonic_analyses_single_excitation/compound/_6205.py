...
class SpiralBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_6122.BevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    """SpiralBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_SpiralBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_compound_harmonic_analysis_of_single_excitation(self) -> 'SpiralBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6076.SpiralBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6076.SpiralBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation._Cast_SpiralBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_SpiralBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation(self)
