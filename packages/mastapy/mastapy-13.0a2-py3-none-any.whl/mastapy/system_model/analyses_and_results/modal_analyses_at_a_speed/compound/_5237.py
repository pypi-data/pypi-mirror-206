...
class BoltCompoundModalAnalysisAtASpeed(_5243.ComponentCompoundModalAnalysisAtASpeed):
    """BoltCompoundModalAnalysisAtASpeed
    ...
    class _Cast_BoltCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'BoltCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def bolt_compound_modal_analysis_at_a_speed(self) -> 'BoltCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5109.BoltModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5109.BoltModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'BoltCompoundModalAnalysisAtASpeed._Cast_BoltCompoundModalAnalysisAtASpeed':
