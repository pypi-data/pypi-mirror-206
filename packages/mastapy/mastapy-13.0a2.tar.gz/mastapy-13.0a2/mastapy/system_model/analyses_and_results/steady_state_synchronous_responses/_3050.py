...
class PowerLoadSteadyStateSynchronousResponse(_3088.VirtualComponentSteadyStateSynchronousResponse):
    """PowerLoadSteadyStateSynchronousResponse
    ...
    class _Cast_PowerLoadSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'PowerLoadSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def power_load_steady_state_synchronous_response(self) -> 'PowerLoadSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PowerLoadSteadyStateSynchronousResponse._Cast_PowerLoadSteadyStateSynchronousResponse':
