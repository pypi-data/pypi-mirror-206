...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6038, _6039, _5981
...
class HypoidGearSetHarmonicAnalysisOfSingleExcitation(_5981.AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation):
    """HypoidGearSetHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_HypoidGearSetHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'HypoidGearSetHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_set_harmonic_analysis_of_single_excitation(self) -> 'HypoidGearSetHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def hypoid_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6038.HypoidGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def hypoid_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6039.HypoidGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearSetHarmonicAnalysisOfSingleExcitation._Cast_HypoidGearSetHarmonicAnalysisOfSingleExcitation':
