...
from mastapy.gears.gear_designs.cylindrical.thickness_stock_and_backlash import _1084
...
class CylindricalGearDefaults(_1583.PerMachineSettings):
    """CylindricalGearDefaults
    ...
    class _Cast_CylindricalGearDefaults:
        ...
        def __init__(self, parent: 'CylindricalGearDefaults'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_defaults(self) -> 'CylindricalGearDefaults':
            return self._parent
    ...
    @property
    def finish_stock_type(self) -> '_1084.FinishStockType':
        ...
        value = conversion.pn_to_mp_enum(temp, _1084.FinishStockType)
        return constructor.new_from_mastapy_type(_1084.FinishStockType)(value) if value is not None else None

    @finish_stock_type.setter
    def finish_stock_type(self, value: '_1084.FinishStockType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1084.FinishStockType.type_())
    ...
    @property
    def finish_manufacturing_process_controls(self) -> '_737.ManufacturingProcessControls':
    ...
    @property
    def rough_cutter_creation_settings(self) -> '_717.RoughCutterCreationSettings':
    ...
    @property
    def rough_manufacturing_process_controls(self) -> '_737.ManufacturingProcessControls':
    ...
    @property
    def system_of_fits_defaults(self) -> '_1134.DIN3967SystemOfGearFits':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearDefaults._Cast_CylindricalGearDefaults':
