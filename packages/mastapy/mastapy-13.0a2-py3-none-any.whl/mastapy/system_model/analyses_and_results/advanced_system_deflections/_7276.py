...
class CVTAdvancedSystemDeflection(_7245.BeltDriveAdvancedSystemDeflection):
    """CVTAdvancedSystemDeflection
    ...
    class _Cast_CVTAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'CVTAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def cvt_advanced_system_deflection(self) -> 'CVTAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CVTAdvancedSystemDeflection._Cast_CVTAdvancedSystemDeflection':
