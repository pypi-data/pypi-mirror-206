...
class CylindricalGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_6164.GearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    """CylindricalGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_CylindricalGearMeshCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'CylindricalGearMeshCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_compound_harmonic_analysis_of_single_excitation(self) -> 'CylindricalGearMeshCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6023.CylindricalGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6023.CylindricalGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshCompoundHarmonicAnalysisOfSingleExcitation._Cast_CylindricalGearMeshCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_CylindricalGearMeshCompoundHarmonicAnalysisOfSingleExcitation(self)
