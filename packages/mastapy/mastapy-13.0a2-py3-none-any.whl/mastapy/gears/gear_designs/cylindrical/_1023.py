...
from mastapy.gears.gear_designs.cylindrical import (
    _1041, _993, _1017, _1054,
    _1024, _1057, _1064, _1082,
    _1007, _1013, _1025
)
...
from mastapy.gears.rating.cylindrical import _450, _459
...
class CylindricalGearSetDesign(_945.GearSetDesign):
    """CylindricalGearSetDesign
    ...
    class _Cast_CylindricalGearSetDesign:
        ...
        def __init__(self, parent: 'CylindricalGearSetDesign'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_set_design(self) -> 'CylindricalGearSetDesign':
            return self._parent
    ...
    @property
    def gear_fit_system(self) -> '_1041.GearFitSystems':
        ...
        value = conversion.pn_to_mp_enum(temp, _1041.GearFitSystems)
        return constructor.new_from_mastapy_type(_1041.GearFitSystems)(value) if value is not None else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_1041.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1041.GearFitSystems.type_())
    ...
    @property
    def helical_gear_micro_geometry_option(self) -> '_505.HelicalGearMicroGeometryOption':
        ...
        value = conversion.pn_to_mp_enum(temp, _505.HelicalGearMicroGeometryOption)
        return constructor.new_from_mastapy_type(_505.HelicalGearMicroGeometryOption)(value) if value is not None else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_505.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _505.HelicalGearMicroGeometryOption.type_())
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_993.AddendumModificationDistributionRule':
        ...
        value = conversion.pn_to_mp_enum(temp, _993.AddendumModificationDistributionRule)
        return constructor.new_from_mastapy_type(_993.AddendumModificationDistributionRule)(value) if value is not None else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_993.AddendumModificationDistributionRule'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _993.AddendumModificationDistributionRule.type_())
    ...
    @property
    def cylindrical_gear_micro_geometry_settings(self) -> '_1017.CylindricalGearMicroGeometrySettingsItem':
    ...
    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_620.CylindricalSetManufacturingConfig':
    ...
    @property
    def ltca_settings(self) -> '_1054.LtcaSettings':
    ...
    @property
    def left_flank(self) -> '_1024.CylindricalGearSetFlankDesign':
    ...
    @property
    def micropitting(self) -> '_1057.Micropitting':
    ...
    @property
    def rating_settings(self) -> '_450.CylindricalGearDesignAndRatingSettingsItem':
    ...
    @property
    def right_flank(self) -> '_1024.CylindricalGearSetFlankDesign':
    ...
    @property
    def scuffing(self) -> '_1064.Scuffing':
    ...
    @property
    def gears(self) -> 'List[_1007.CylindricalGearDesign]':
    ...
    @property
    def cylindrical_gears(self) -> 'List[_1007.CylindricalGearDesign]':
    ...
    @property
    def cylindrical_meshes(self) -> 'List[_1013.CylindricalGearMeshDesign]':
    ...
    @property
    def flanks(self) -> 'List[_1024.CylindricalGearSetFlankDesign]':
    ...
    @property
    def both_flanks(self) -> '_1024.CylindricalGearSetFlankDesign':
    ...
    @property
    def micro_geometries(self) -> 'List[_1101.CylindricalGearSetMicroGeometry]':
    ...
    @property
    def manufacturing_configurations(self) -> 'List[_620.CylindricalSetManufacturingConfig]':
    ...
    def add_new_manufacturing_configuration(self, new_config_name: Optional['str'] = 'None') -> '_620.CylindricalSetManufacturingConfig':
    ...
    def add_new_micro_geometry(self) -> '_1101.CylindricalGearSetMicroGeometry':
    ...
    def add_new_micro_geometry_specifying_separate_micro_geometry_per_tooth(self) -> '_1101.CylindricalGearSetMicroGeometry':
    ...
    def add_new_micro_geometry_specifying_separate_micro_geometry_per_tooth_for(self, gears: 'List[_1007.CylindricalGearDesign]') -> '_1101.CylindricalGearSetMicroGeometry':
    ...
    def create_optimiser(self, duty_cycle: '_459.CylindricalGearSetDutyCycleRating') -> '_1025.CylindricalGearSetMacroGeometryOptimiser':
    ...
    def delete_manufacturing_configuration(self, config: '_620.CylindricalSetManufacturingConfig'):
    ...
    def delete_micro_geometry(self, micro_geometry: '_1101.CylindricalGearSetMicroGeometry'):
    ...
    def micro_geometry_named(self, micro_geometry_name: 'str') -> '_1101.CylindricalGearSetMicroGeometry':
    ...
    def set_active_manufacturing_configuration(self, value: '_620.CylindricalSetManufacturingConfig'):
    ...
    def set_active_micro_geometry(self, value: '_1101.CylindricalGearSetMicroGeometry'):
    ...
    @property
    def cast_to(self) -> 'CylindricalGearSetDesign._Cast_CylindricalGearSetDesign':
