...
class MassDiscCompoundModalAnalysis(_4823.VirtualComponentCompoundModalAnalysis):
    """MassDiscCompoundModalAnalysis
    ...
    class _Cast_MassDiscCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'MassDiscCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def mass_disc_compound_modal_analysis(self) -> 'MassDiscCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4626.MassDiscModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4626.MassDiscModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'MassDiscCompoundModalAnalysis._Cast_MassDiscCompoundModalAnalysis':
