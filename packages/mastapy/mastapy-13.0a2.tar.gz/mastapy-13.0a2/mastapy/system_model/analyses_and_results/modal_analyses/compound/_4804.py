...
class SpringDamperConnectionCompoundModalAnalysis(_4739.CouplingConnectionCompoundModalAnalysis):
    """SpringDamperConnectionCompoundModalAnalysis
    ...
    class _Cast_SpringDamperConnectionCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'SpringDamperConnectionCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_compound_modal_analysis(self) -> 'SpringDamperConnectionCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4659.SpringDamperConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4659.SpringDamperConnectionModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionCompoundModalAnalysis._Cast_SpringDamperConnectionCompoundModalAnalysis':
