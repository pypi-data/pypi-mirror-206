...
class CylindricalGearWorstLTCAContactCharts(_0.APIBase):
    ...
    class _Cast_CylindricalGearWorstLTCAContactCharts:
        ...
        def __init__(self, parent: 'CylindricalGearWorstLTCAContactCharts'):
            self._parent = parent

        @property
        def cylindrical_gear_worst_ltca_contact_charts(self) -> 'CylindricalGearWorstLTCAContactCharts':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearWorstLTCAContactCharts._Cast_CylindricalGearWorstLTCAContactCharts':
