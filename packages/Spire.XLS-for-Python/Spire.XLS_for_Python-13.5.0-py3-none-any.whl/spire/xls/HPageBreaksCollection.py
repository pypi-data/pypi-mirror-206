...
class HPageBreaksCollection (  XlsHPageBreaksCollection) :
    ...
    def get_Item(self ,index:int)->HPageBreak:
        ...
        intPtr = GetDllLibXls().HPageBreaksCollection_get_Item(self.Ptr, index)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().HPageBreaksCollection_get_ItemL(self.Ptr, intPtrlocation)
        ret = None if intPtr==None else HPageBreak(intPtr)
        return ret
    ...
    <returns>HPageBreak added.</returns>
        ...
        intPtr = GetDllLibXls().HPageBreaksCollection_Add(self.Ptr, intPtrrange)
        ret = None if intPtr==None else HPageBreak(intPtr)
        return ret
    ...
    def Remove(self ,range:'CellRange'):
        ...
        GetDllLibXls().HPageBreaksCollection_Remove(self.Ptr, intPtrrange)
    ...
    <returns>Page break object.</returns>
        ...
        intPtr = GetDllLibXls().HPageBreaksCollection_GetPageBreak(self.Ptr, rowIndex)
        ret = None if intPtr==None else HPageBreak(intPtr)
        return ret
    ...
    <returns>Page break object.</returns>
        ...
        intPtr = GetDllLibXls().HPageBreaksCollection_GetPageBreakR(self.Ptr, intPtrrange)
        ret = None if intPtr==None else HPageBreak(intPtr)
        return ret
