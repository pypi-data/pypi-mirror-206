...
class ClutchCompoundCriticalSpeedAnalysis(_6676.CouplingCompoundCriticalSpeedAnalysis):
    """ClutchCompoundCriticalSpeedAnalysis
    ...
    class _Cast_ClutchCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ClutchCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_compound_critical_speed_analysis(self) -> 'ClutchCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6530.ClutchCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6530.ClutchCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ClutchCompoundCriticalSpeedAnalysis._Cast_ClutchCompoundCriticalSpeedAnalysis':
