...
class PlanetaryGearSetCriticalSpeedAnalysis(_6559.CylindricalGearSetCriticalSpeedAnalysis):
    """PlanetaryGearSetCriticalSpeedAnalysis
    ...
    class _Cast_PlanetaryGearSetCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'PlanetaryGearSetCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def planetary_gear_set_critical_speed_analysis(self) -> 'PlanetaryGearSetCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetaryGearSetCriticalSpeedAnalysis._Cast_PlanetaryGearSetCriticalSpeedAnalysis':
