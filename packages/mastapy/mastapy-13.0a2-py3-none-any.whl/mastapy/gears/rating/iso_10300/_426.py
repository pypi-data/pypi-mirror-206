...
class ISO10300SingleFlankRatingBevelMethodB2(_429.ISO10300SingleFlankRatingMethodB2):
    """ISO10300SingleFlankRatingBevelMethodB2
    ...
    class _Cast_ISO10300SingleFlankRatingBevelMethodB2:
        ...
        def __init__(self, parent: 'ISO10300SingleFlankRatingBevelMethodB2'):
            self._parent = parent
        ...
        @property
        def iso10300_single_flank_rating_bevel_method_b2(self) -> 'ISO10300SingleFlankRatingBevelMethodB2':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ISO10300SingleFlankRatingBevelMethodB2._Cast_ISO10300SingleFlankRatingBevelMethodB2':
