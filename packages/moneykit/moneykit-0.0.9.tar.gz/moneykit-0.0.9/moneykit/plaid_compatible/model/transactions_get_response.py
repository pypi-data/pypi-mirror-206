...
class TransactionsGetResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'transactions': ([Transaction],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'total_transactions': 'total_transactions',  # noqa: E501
        'item': 'item',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, accounts, transactions, total_transactions, item, request_id, *args, **kwargs):  # noqa: E501
        """TransactionsGetResponse - a model defined in OpenAPI

        Args:
            accounts ([AccountBase]): An array containing the `accounts` associated with the Item for which transactions are being returned. Each transaction can be mapped to its corresponding account via the `account_id` field.
