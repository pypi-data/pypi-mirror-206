...
class CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation(_6022.CylindricalGearHarmonicAnalysisOfSingleExcitation):
    """CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def cylindrical_planet_gear_harmonic_analysis_of_single_excitation(self) -> 'CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation._Cast_CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation':
