...
class PivotDataField (  SpireObject, IPivotDataField, ICloneParent) :
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().PivotDataField_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().PivotDataField_get_Name(self.Ptr)
        return ret
    ...
    def Subtotal(self)->'SubtotalTypes':
        ...
        ret = GetDllLibXls().PivotDataField_get_Subtotal(self.Ptr)
    ...
    def Subtotal(self, value:'SubtotalTypes'):
        ...
        GetDllLibXls().PivotDataField_set_Subtotal(self.Ptr, value.value)
    ...
    def BaseItem(self)->int:
        ...
        ret = GetDllLibXls().PivotDataField_get_BaseItem(self.Ptr)
        return ret

    @BaseItem.setter
    def BaseItem(self, value:int):
        GetDllLibXls().PivotDataField_set_BaseItem.argtypes=[c_void_p, c_int]
        GetDllLibXls().PivotDataField_set_BaseItem(self.Ptr, value)
    ...
    def BaseField(self)->int:
        ...
        ret = GetDllLibXls().PivotDataField_get_BaseField(self.Ptr)
        return ret

    @BaseField.setter
    def BaseField(self, value:int):
        GetDllLibXls().PivotDataField_set_BaseField.argtypes=[c_void_p, c_int]
        GetDllLibXls().PivotDataField_set_BaseField(self.Ptr, value)
    ...
    def ShowDataAs(self)->'PivotFieldFormatType':
        ...
        ret = GetDllLibXls().PivotDataField_get_ShowDataAs(self.Ptr)
    ...
    def ShowDataAs(self, value:'PivotFieldFormatType'):
        ...
        GetDllLibXls().PivotDataField_set_ShowDataAs(self.Ptr, value.value)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().PivotDataField_Clone(self.Ptr, intPtrparent)
