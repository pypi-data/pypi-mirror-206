...
class ZerolBevelGearMeshCompoundPowerFlow(_4159.BevelGearMeshCompoundPowerFlow):
    """ZerolBevelGearMeshCompoundPowerFlow
    ...
    class _Cast_ZerolBevelGearMeshCompoundPowerFlow:
        ...
        def __init__(self, parent: 'ZerolBevelGearMeshCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_mesh_compound_power_flow(self) -> 'ZerolBevelGearMeshCompoundPowerFlow':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4139.ZerolBevelGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4139.ZerolBevelGearMeshPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearMeshCompoundPowerFlow._Cast_ZerolBevelGearMeshCompoundPowerFlow':
