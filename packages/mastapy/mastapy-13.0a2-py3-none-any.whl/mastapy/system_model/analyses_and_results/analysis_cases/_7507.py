...
class PartAnalysisCase(_2636.PartAnalysis):
    """PartAnalysisCase
    ...
    class _Cast_PartAnalysisCase:
        ...
        def __init__(self, parent: 'PartAnalysisCase'):
            self._parent = parent
        ...
        @property
        def part_analysis_case(self) -> 'PartAnalysisCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartAnalysisCase._Cast_PartAnalysisCase':
