...
class StraightBevelSunGearCompoundModalAnalysis(_4806.StraightBevelDiffGearCompoundModalAnalysis):
    """StraightBevelSunGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4669.StraightBevelSunGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4669.StraightBevelSunGearModalAnalysis]':
