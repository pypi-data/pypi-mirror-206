...
class PerNodeExportOptions(_0.APIBase):
    ...
    class _Cast_PerNodeExportOptions:
        ...
        def __init__(self, parent: 'PerNodeExportOptions'):
            self._parent = parent

        @property
        def per_node_export_options(self) -> 'PerNodeExportOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PerNodeExportOptions._Cast_PerNodeExportOptions':
