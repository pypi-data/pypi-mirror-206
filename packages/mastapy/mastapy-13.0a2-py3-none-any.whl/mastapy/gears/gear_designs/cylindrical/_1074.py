...
class TiffAnalysisSettings(_1575.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    """TiffAnalysisSettings
    ...
    @property
    def measured_residual_stress_profile_property(self) -> '_1523.Vector2DListAccessor':
    ...
    def measured_residual_stress_profile_property(self, value: '_1523.Vector2DListAccessor'):
    ...
    @property
    def core_material_properties(self) -> '_1045.HardenedMaterialProperties':
    ...
    @property
    def surface_material_properties(self) -> '_1045.HardenedMaterialProperties':
