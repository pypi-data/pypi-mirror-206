...
class ConceptCouplingHalfModalAnalysisAtAStiffness(_4868.CouplingHalfModalAnalysisAtAStiffness):
    """ConceptCouplingHalfModalAnalysisAtAStiffness
    ...
    class _Cast_ConceptCouplingHalfModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ConceptCouplingHalfModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def concept_coupling_half_modal_analysis_at_a_stiffness(self) -> 'ConceptCouplingHalfModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHalfModalAnalysisAtAStiffness._Cast_ConceptCouplingHalfModalAnalysisAtAStiffness':
