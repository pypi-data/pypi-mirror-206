...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6952
...
class PointLoadInputOptions(_1833.ColumnInputOptions):
    """PointLoadInputOptions
    ...
    @axis.setter
    def axis(self, value: '_1480.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1480.Axis.type_())
        self.wrapped.Axis = value

    @property
    def conversion_to_load_case(self) -> '_6952.AdditionalForcesObtainedFrom':
        ...
        value = conversion.pn_to_mp_enum(temp, _6952.AdditionalForcesObtainedFrom)
        return constructor.new_from_mastapy_type(_6952.AdditionalForcesObtainedFrom)(value) if value is not None else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6952.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _6952.AdditionalForcesObtainedFrom.type_())
