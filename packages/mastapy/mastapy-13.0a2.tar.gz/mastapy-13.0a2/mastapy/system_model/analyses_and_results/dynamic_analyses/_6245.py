...
class AbstractShaftOrHousingDynamicAnalysis(_6268.ComponentDynamicAnalysis):
    """AbstractShaftOrHousingDynamicAnalysis
    ...
    class _Cast_AbstractShaftOrHousingDynamicAnalysis:
        ...
        def __init__(self, parent: 'AbstractShaftOrHousingDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def abstract_shaft_or_housing_dynamic_analysis(self) -> 'AbstractShaftOrHousingDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AbstractShaftOrHousingDynamicAnalysis._Cast_AbstractShaftOrHousingDynamicAnalysis':
