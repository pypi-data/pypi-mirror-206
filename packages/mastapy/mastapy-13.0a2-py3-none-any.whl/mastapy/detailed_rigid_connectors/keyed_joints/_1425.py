...
from mastapy.detailed_rigid_connectors.keyed_joints import _1426, _1428
...
class KeyedJointDesign(_1433.InterferenceFitDesign):
    """KeyedJointDesign
    ...
    class _Cast_KeyedJointDesign:
        ...
        def __init__(self, parent: 'KeyedJointDesign'):
            self._parent = parent

        @property
        def interference_fit_design(self):
            return self._parent._cast(_1433.InterferenceFitDesign)
        ...
        @property
        def keyed_joint_design(self) -> 'KeyedJointDesign':
            return self._parent
    ...
    @property
    def geometry_type(self) -> '_1426.KeyTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, _1426.KeyTypes)
        return constructor.new_from_mastapy_type(_1426.KeyTypes)(value) if value is not None else None

    @geometry_type.setter
    def geometry_type(self, value: '_1426.KeyTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1426.KeyTypes.type_())
    ...
    @property
    def number_of_keys(self) -> '_1428.NumberOfKeys':
        ...
        value = conversion.pn_to_mp_enum(temp, _1428.NumberOfKeys)
        return constructor.new_from_mastapy_type(_1428.NumberOfKeys)(value) if value is not None else None

    @number_of_keys.setter
    def number_of_keys(self, value: '_1428.NumberOfKeys'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1428.NumberOfKeys.type_())
    ...
    @property
    def cast_to(self) -> 'KeyedJointDesign._Cast_KeyedJointDesign':
