...
class ConnectorCompoundParametricStudyTool(_4495.MountableComponentCompoundParametricStudyTool):
    """ConnectorCompoundParametricStudyTool
    ...
    class _Cast_ConnectorCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'ConnectorCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def connector_compound_parametric_study_tool(self) -> 'ConnectorCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4307.ConnectorParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4307.ConnectorParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'ConnectorCompoundParametricStudyTool._Cast_ConnectorCompoundParametricStudyTool':
