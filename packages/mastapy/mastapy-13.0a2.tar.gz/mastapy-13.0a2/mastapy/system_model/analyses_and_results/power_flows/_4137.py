...
class WormGearPowerFlow(_4069.GearPowerFlow):
    """WormGearPowerFlow
    ...
    class _Cast_WormGearPowerFlow:
        ...
        def __init__(self, parent: 'WormGearPowerFlow'):
            self._parent = parent
        ...
        @property
        def worm_gear_power_flow(self) -> 'WormGearPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearPowerFlow._Cast_WormGearPowerFlow':
