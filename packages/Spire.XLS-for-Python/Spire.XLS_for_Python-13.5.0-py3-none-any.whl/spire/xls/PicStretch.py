...
class PicStretch (SpireObject) :
    ...
    def Type(self)->'FillPictureType':
        ...
        ret = GetDllLibXls().PicStretch_get_Type(self.Ptr)
    ...
    def Type(self, value:'FillPictureType'):
        ...
        GetDllLibXls().PicStretch_set_Type(self.Ptr, value.value)
    ...
    def Scale(self)->float:
        ...
        ret = GetDllLibXls().PicStretch_get_Scale(self.Ptr)
        return ret

    @Scale.setter
    def Scale(self, value:float):
        GetDllLibXls().PicStretch_set_Scale.argtypes=[c_void_p, c_double]
        GetDllLibXls().PicStretch_set_Scale(self.Ptr, value)
    ...
    def Left(self)->float:
        ...
        ret = GetDllLibXls().PicStretch_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:float):
        GetDllLibXls().PicStretch_set_Left.argtypes=[c_void_p, c_double]
        GetDllLibXls().PicStretch_set_Left(self.Ptr, value)
    ...
    def Top(self)->float:
        ...
        ret = GetDllLibXls().PicStretch_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:float):
        GetDllLibXls().PicStretch_set_Top.argtypes=[c_void_p, c_double]
        GetDllLibXls().PicStretch_set_Top(self.Ptr, value)
    ...
    def Bottom(self)->float:
        ...
        ret = GetDllLibXls().PicStretch_get_Bottom(self.Ptr)
        return ret

    @Bottom.setter
    def Bottom(self, value:float):
        GetDllLibXls().PicStretch_set_Bottom.argtypes=[c_void_p, c_double]
        GetDllLibXls().PicStretch_set_Bottom(self.Ptr, value)
    ...
    def Right(self)->float:
        ...
        ret = GetDllLibXls().PicStretch_get_Right(self.Ptr)
        return ret

    @Right.setter
    def Right(self, value:float):
        GetDllLibXls().PicStretch_set_Right.argtypes=[c_void_p, c_double]
        GetDllLibXls().PicStretch_set_Right(self.Ptr, value)
