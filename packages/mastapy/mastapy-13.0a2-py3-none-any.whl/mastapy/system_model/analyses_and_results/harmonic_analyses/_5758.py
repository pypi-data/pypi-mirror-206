...
class PartToPartShearCouplingHarmonicAnalysis(_5689.CouplingHarmonicAnalysis):
    """PartToPartShearCouplingHarmonicAnalysis
    ...
    class _Cast_PartToPartShearCouplingHarmonicAnalysis:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_harmonic_analysis(self) -> 'PartToPartShearCouplingHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingHarmonicAnalysis._Cast_PartToPartShearCouplingHarmonicAnalysis':
