...
class ClutchHalfAdvancedSystemDeflection(_7275.CouplingHalfAdvancedSystemDeflection):
    """ClutchHalfAdvancedSystemDeflection
    ...
    class _Cast_ClutchHalfAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'ClutchHalfAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def clutch_half_advanced_system_deflection(self) -> 'ClutchHalfAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2691.ClutchHalfSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'ClutchHalfAdvancedSystemDeflection._Cast_ClutchHalfAdvancedSystemDeflection':
