...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5969, _5970, _5906
...
class WormGearSetCompoundHarmonicAnalysis(_5906.GearSetCompoundHarmonicAnalysis):
    """WormGearSetCompoundHarmonicAnalysis
    ...
    class _Cast_WormGearSetCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'WormGearSetCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def worm_gear_set_compound_harmonic_analysis(self) -> 'WormGearSetCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5807.WormGearSetHarmonicAnalysis]':
    ...
    @property
    def worm_gears_compound_harmonic_analysis(self) -> 'List[_5969.WormGearCompoundHarmonicAnalysis]':
    ...
    @property
    def worm_meshes_compound_harmonic_analysis(self) -> 'List[_5970.WormGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5807.WormGearSetHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'WormGearSetCompoundHarmonicAnalysis._Cast_WormGearSetCompoundHarmonicAnalysis':
