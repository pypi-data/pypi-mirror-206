...
class Shaft(_2415.AbstractShaft):
    """Shaft
    ...
    class _Cast_Shaft:
        ...
        def __init__(self, parent: 'Shaft'):
            self._parent = parent
    ...
    @property
    def guide_image(self) -> '_2436.GuideImage':
    ...
    @property
    def fe_substructure_replacing_this(self) -> '_2363.FESubstructure':
    ...
    def mount_component(self, component: '_2444.MountableComponent', offset: 'float'):
    ...
    @property
    def cast_to(self) -> 'Shaft._Cast_Shaft':
