...
class CVTCompoundModalAnalysis(_4711.BeltDriveCompoundModalAnalysis):
    """CVTCompoundModalAnalysis
    ...
    class _Cast_CVTCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'CVTCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def cvt_compound_modal_analysis(self) -> 'CVTCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4589.CVTModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4589.CVTModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'CVTCompoundModalAnalysis._Cast_CVTCompoundModalAnalysis':
