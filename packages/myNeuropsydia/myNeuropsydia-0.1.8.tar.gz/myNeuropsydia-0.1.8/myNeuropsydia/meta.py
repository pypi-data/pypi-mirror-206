...
# ==============================================================================
# ==============================================================================
def instructions(text, global_,
                 background='white', color="black", size=1.0,
    ...
    if subtitle is not None:
        write(subtitle, global_,
              style="subtitle", color=subtitle_color)

    top_space = ["\n"]*top_space
    top_space = "".join(str(elem) for elem in top_space)
    
    write(top_space + text, global_,
          size=size, color=color, long_text=True)
    
    write(end_text, global_,
          style='end', color=color)
