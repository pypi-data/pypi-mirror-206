...
class SparklineGroup (  SpireObject, ISparklineGroup) :
    ...
    def SparklineList(self)->'SparklineCollection':
        ...
        intPtr = GetDllLibXls().SparklineGroup_get_SparklineList(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_ShowHorizontalAxis(self.Ptr)
        return ret
    ...
    def ShowHorizontalAxis(self, value:bool):
        ...
        GetDllLibXls().SparklineGroup_set_ShowHorizontalAxis(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_IsDisplayHidden(self.Ptr)
        return ret
    ...
    def IsDisplayHidden(self, value:bool):
        ...
        GetDllLibXls().SparklineGroup_set_IsDisplayHidden(self.Ptr, value)
    ...
    def PlotRightToLeft(self)->bool:
        ...
        ret = GetDllLibXls().SparklineGroup_get_PlotRightToLeft(self.Ptr)
        return ret
    ...
    def PlotRightToLeft(self, value:bool):
        ...
        GetDllLibXls().SparklineGroup_set_PlotRightToLeft(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_ShowFirstPoint(self.Ptr)
        return ret
    ...
    def ShowFirstPoint(self, value:bool):
        ...
        GetDllLibXls().SparklineGroup_set_ShowFirstPoint(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_ShowLastPoint(self.Ptr)
        return ret
    ...
    def ShowLastPoint(self, value:bool):
        ...
        GetDllLibXls().SparklineGroup_set_ShowLastPoint(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_ShowLowPoint(self.Ptr)
        return ret

    @ShowLowPoint.setter
    def ShowLowPoint(self, value:bool):
        GetDllLibXls().SparklineGroup_set_ShowLowPoint.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SparklineGroup_set_ShowLowPoint(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_ShowHighPoint(self.Ptr)
        return ret
    ...
    def ShowHighPoint(self, value:bool):
        ...
        GetDllLibXls().SparklineGroup_set_ShowHighPoint(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_ShowNegativePoint(self.Ptr)
        return ret
    ...
    def ShowNegativePoint(self, value:bool):
        ...
        GetDllLibXls().SparklineGroup_set_ShowNegativePoint(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_ShowMarkers(self.Ptr)
        return ret

    @ShowMarkers.setter
    def ShowMarkers(self, value:bool):
        GetDllLibXls().SparklineGroup_set_ShowMarkers.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SparklineGroup_set_ShowMarkers(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_VerticalAxisMaxValue(self.Ptr)
        return ret
    ...
    def VerticalAxisMaxValue(self, value:float):
        ...
        GetDllLibXls().SparklineGroup_set_VerticalAxisMaxValue(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_VerticalAxisMaxType(self.Ptr)
    ...
    def VerticalAxisMaxType(self, value:'SpartlineVerticalAxisType'):
        ...
        GetDllLibXls().SparklineGroup_set_VerticalAxisMaxType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_VerticalAxisMinValue(self.Ptr)
        return ret
    ...
    def VerticalAxisMinValue(self, value:float):
        ...
        GetDllLibXls().SparklineGroup_set_VerticalAxisMinValue(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_VerticalAxisMinValueType(self.Ptr)
        objwraped = SpartlineVerticalAxisType(ret)
        return objwraped
    ...
    def VerticalAxisMinValueType(self, value:'SpartlineVerticalAxisType'):
        ...
        GetDllLibXls().SparklineGroup_set_VerticalAxisMinValueType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_SparklineType(self.Ptr)
    ...
    def SparklineType(self, value:'SparklineType'):
        ...
        GetDllLibXls().SparklineGroup_set_SparklineType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_IsHorizontalDateAxis(self.Ptr)
        return ret
    ...
    def IsHorizontalDateAxis(self, value:bool):
        ...
        GetDllLibXls().SparklineGroup_set_IsHorizontalDateAxis(self.Ptr, value)
    ...
    def EmptyCellsType(self)->'SparklineEmptyCells':
        ...
        ret = GetDllLibXls().SparklineGroup_get_EmptyCellsType(self.Ptr)
    ...
    def EmptyCellsType(self, value:'SparklineEmptyCells'):
        ...
        GetDllLibXls().SparklineGroup_set_EmptyCellsType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().SparklineGroup_get_HorizontalDateAxisRange(self.Ptr)
    ...
    def HorizontalDateAxisRange(self, value:'CellRange'):
        ...
        GetDllLibXls().SparklineGroup_set_HorizontalDateAxisRange(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().SparklineGroup_get_HorizontalAxisColor(self.Ptr)
    ...
    def HorizontalAxisColor(self, value:'Color'):
        ...
        GetDllLibXls().SparklineGroup_set_HorizontalAxisColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().SparklineGroup_get_FirstPointColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def FirstPointColor(self, value:'Color'):
        ...
        GetDllLibXls().SparklineGroup_set_FirstPointColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().SparklineGroup_get_HighPointColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def HighPointColor(self, value:'Color'):
        ...
        GetDllLibXls().SparklineGroup_set_HighPointColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().SparklineGroup_get_LastPointColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def LastPointColor(self, value:'Color'):
        ...
        GetDllLibXls().SparklineGroup_set_LastPointColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SparklineGroup_get_LineWeight(self.Ptr)
        return ret

    @LineWeight.setter
    def LineWeight(self, value:float):
        GetDllLibXls().SparklineGroup_set_LineWeight.argtypes=[c_void_p, c_double]
        GetDllLibXls().SparklineGroup_set_LineWeight(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().SparklineGroup_get_LowPointColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def LowPointColor(self, value:'Color'):
        ...
        GetDllLibXls().SparklineGroup_set_LowPointColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().SparklineGroup_get_MarkersColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def MarkersColor(self, value:'Color'):
        ...
        GetDllLibXls().SparklineGroup_set_MarkersColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().SparklineGroup_get_NegativePointColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def NegativePointColor(self, value:'Color'):
        ...
        GetDllLibXls().SparklineGroup_set_NegativePointColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().SparklineGroup_get_SparklineColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def SparklineColor(self, value:'Color'):
        ...
        GetDllLibXls().SparklineGroup_set_SparklineColor(self.Ptr, value.Ptr)
    ...
    def Add(self)->'SparklineCollection':
        ...
        intPtr = GetDllLibXls().SparklineGroup_Add(self.Ptr)
        ret = None if intPtr==None else SparklineCollection(intPtr)
        return ret
    ...
    def get_Item(self ,index:int)->'SparklineCollection':
        ...
        intPtr = GetDllLibXls().SparklineGroup_get_Item(self.Ptr, index)
        ret = None if intPtr==None else SparklineCollection(intPtr)
        return ret
