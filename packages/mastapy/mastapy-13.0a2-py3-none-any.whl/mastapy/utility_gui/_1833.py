...
class ColumnInputOptions(_0.APIBase):
    ...
    class _Cast_ColumnInputOptions:
        ...
        def boost_pressure_input_options(self):
            from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2534
            
            return self._parent._cast(_2534.BoostPressureInputOptions)

        @property
        def input_power_input_options(self):
            from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2535
            
            return self._parent._cast(_2535.InputPowerInputOptions)

        @property
        def pressure_ratio_input_options(self):
            from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2536
            
            return self._parent._cast(_2536.PressureRatioInputOptions)

        @property
        def rotor_speed_input_options(self):
            from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2539
            
            return self._parent._cast(_2539.RotorSpeedInputOptions)

        @property
        def boost_pressure_load_case_input_options(self):
            from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6953
            
            return self._parent._cast(_6953.BoostPressureLoadCaseInputOptions)

        @property
        def design_state_options(self):
            from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6954
            
            return self._parent._cast(_6954.DesignStateOptions)
        ...
        def force_input_options(self):
            ...
            return self._parent._cast(_6956.ForceInputOptions)
        ...
        def gear_ratio_input_options(self):
            ...
            return self._parent._cast(_6957.GearRatioInputOptions)
        ...
        def load_case_name_options(self):
            ...
            return self._parent._cast(_6958.LoadCaseNameOptions)
        ...
        def moment_input_options(self):
            ...
            return self._parent._cast(_6959.MomentInputOptions)
        ...
        def power_load_input_options(self):
            ...
            return self._parent._cast(_6962.PowerLoadInputOptions)
        ...
        def ramp_or_steady_state_input_options(self):
            ...
            return self._parent._cast(_6963.RampOrSteadyStateInputOptions)

        @property
        def speed_input_options(self):
            from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6964
            
            return self._parent._cast(_6964.SpeedInputOptions)
        ...
        def time_step_input_options(self):
            ...
            return self._parent._cast(_6966.TimeStepInputOptions)
        ...
        def torque_input_options(self):
            ...
            return self._parent._cast(_6967.TorqueInputOptions)
