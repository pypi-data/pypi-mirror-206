...
class FaceGearCompoundMultibodyDynamicsAnalysis(_5557.GearCompoundMultibodyDynamicsAnalysis):
    """FaceGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5404.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5404.FaceGearMultibodyDynamicsAnalysis]':
