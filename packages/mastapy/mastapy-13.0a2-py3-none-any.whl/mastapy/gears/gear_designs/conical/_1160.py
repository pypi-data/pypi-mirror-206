...
class KimosBevelHypoidSingleLoadCaseResultsData(_0.APIBase):
    ...
    class _Cast_KimosBevelHypoidSingleLoadCaseResultsData:
        ...
        @property
        def kimos_bevel_hypoid_single_load_case_results_data(self) -> 'KimosBevelHypoidSingleLoadCaseResultsData':
            return self._parent
    ...
    @property
    def single_rotation_angle_results(self) -> 'List[_1161.KimosBevelHypoidSingleRotationAngleResult]':
