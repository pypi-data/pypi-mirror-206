...
class CycloidalDiscCompoundParametricStudyTool(_4419.AbstractShaftCompoundParametricStudyTool):
    """CycloidalDiscCompoundParametricStudyTool
    ...
    class _Cast_CycloidalDiscCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'CycloidalDiscCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_compound_parametric_study_tool(self) -> 'CycloidalDiscCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4316.CycloidalDiscParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4316.CycloidalDiscParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscCompoundParametricStudyTool._Cast_CycloidalDiscCompoundParametricStudyTool':
