...
class ShaftPowerFlow(_4011.AbstractShaftPowerFlow):
    """ShaftPowerFlow
    ...
    class _Cast_ShaftPowerFlow:
        ...
        def __init__(self, parent: 'ShaftPowerFlow'):
            self._parent = parent
        ...
        @property
        def shaft_power_flow(self) -> 'ShaftPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftPowerFlow._Cast_ShaftPowerFlow':
