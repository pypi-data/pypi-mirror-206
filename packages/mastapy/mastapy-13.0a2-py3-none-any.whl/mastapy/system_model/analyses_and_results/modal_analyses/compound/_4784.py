...
class PlanetaryConnectionCompoundModalAnalysis(_4798.ShaftToMountableComponentConnectionCompoundModalAnalysis):
    """PlanetaryConnectionCompoundModalAnalysis
    ...
    class _Cast_PlanetaryConnectionCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'PlanetaryConnectionCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def planetary_connection_compound_modal_analysis(self) -> 'PlanetaryConnectionCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4639.PlanetaryConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4639.PlanetaryConnectionModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PlanetaryConnectionCompoundModalAnalysis._Cast_PlanetaryConnectionCompoundModalAnalysis':
