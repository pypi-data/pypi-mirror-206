...
class StraightBevelDiffGearMeshSteadyStateSynchronousResponseAtASpeed(_3499.BevelGearMeshSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelDiffGearMeshSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_StraightBevelDiffGearMeshSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearMeshSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_mesh_steady_state_synchronous_response_at_a_speed(self) -> 'StraightBevelDiffGearMeshSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearMeshSteadyStateSynchronousResponseAtASpeed._Cast_StraightBevelDiffGearMeshSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_StraightBevelDiffGearMeshSteadyStateSynchronousResponseAtASpeed(self)
