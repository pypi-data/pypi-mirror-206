...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4332, _4331, _4338
...
class FaceGearSetParametricStudyTool(_4338.GearSetParametricStudyTool):
    """FaceGearSetParametricStudyTool
    ...
    class _Cast_FaceGearSetParametricStudyTool:
        ...
        def __init__(self, parent: 'FaceGearSetParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def face_gear_set_parametric_study_tool(self) -> 'FaceGearSetParametricStudyTool':
            return self._parent
    ...
    @property
    def face_gears_parametric_study_tool(self) -> 'List[_4332.FaceGearParametricStudyTool]':
    ...
    @property
    def face_meshes_parametric_study_tool(self) -> 'List[_4331.FaceGearMeshParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'FaceGearSetParametricStudyTool._Cast_FaceGearSetParametricStudyTool':
