...
class ExcelInterior (  SpireObject, IInterior) :
    ...
    def PatternKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().ExcelInterior_get_PatternKnownColor(self.Ptr)
    ...
    def PatternKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().ExcelInterior_set_PatternKnownColor(self.Ptr, value.value)
    ...
    def PatternColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().ExcelInterior_get_PatternColor(self.Ptr)
    ...
    def PatternColor(self, value:'Color'):
        ...
        GetDllLibXls().ExcelInterior_set_PatternColor(self.Ptr, value.Ptr)
    ...
    def KnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().ExcelInterior_get_KnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().ExcelInterior_set_KnownColor(self.Ptr, value.value)
    ...
    def Color(self)->'Color':
        ...
        intPtr = GetDllLibXls().ExcelInterior_get_Color(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().ExcelInterior_set_Color(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ExcelInterior_get_Gradient(self.Ptr)
    ...
    def FillPattern(self)->'ExcelPatternType':
        ...
        ret = GetDllLibXls().ExcelInterior_get_FillPattern(self.Ptr)
    ...
    def FillPattern(self, value:'ExcelPatternType'):
        ...
        GetDllLibXls().ExcelInterior_set_FillPattern(self.Ptr, value.value)
    ...
    def m_interior(self)->'IInterior':
        ...
        intPtr = GetDllLibXls().ExcelInterior_m_interior(self.Ptr)
