...
class CVTSteadyStateSynchronousResponseAtASpeed(_3493.BeltDriveSteadyStateSynchronousResponseAtASpeed):
    """CVTSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_CVTSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'CVTSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def cvt_steady_state_synchronous_response_at_a_speed(self) -> 'CVTSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CVTSteadyStateSynchronousResponseAtASpeed._Cast_CVTSteadyStateSynchronousResponseAtASpeed':
