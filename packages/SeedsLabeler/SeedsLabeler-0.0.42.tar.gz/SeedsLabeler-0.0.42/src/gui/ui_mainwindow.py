...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.serverAPItoken = QtWidgets.QComboBox(self.dockWidgetContents)
        self.serverAPItoken.setEditable(True)
        self.serverAPItoken.setObjectName("serverAPItoken")
        self.serverAPItoken.addItem("")
        self.serverAPItoken.setItemText(0, "")
        self.gridLayout.addWidget(self.serverAPItoken, 4, 0, 1, 1)
        self.Label_APIToken = QtWidgets.QLabel(self.dockWidgetContents)
        self.Label_APIToken.setObjectName("Label_APIToken")
        self.gridLayout.addWidget(self.Label_APIToken, 3, 0, 1, 1)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("src/gui/../../../../../../../../.designer/backup/resources/icons/edit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.PB_detectAll.clicked.connect(self.detectAll.trigger) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Label_APIToken.setText(_translate("MainWindow", "API_Token:"))
