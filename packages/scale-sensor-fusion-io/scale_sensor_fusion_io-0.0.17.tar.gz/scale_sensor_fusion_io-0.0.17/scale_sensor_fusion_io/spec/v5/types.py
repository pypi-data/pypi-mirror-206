...
@dataclass
class LocalizationAdjustmentAnnotation(SFS.LocalizationAdjustmentAnnotation, _LocalizationAdjustmentAnnotationBase):
    pass


ObjectAnnotation = SFS.ObjectAnnotation

Sensor = Union[PointsSensor, LidarSensor, RadarSensor, CameraSensor, OdometrySensor]
