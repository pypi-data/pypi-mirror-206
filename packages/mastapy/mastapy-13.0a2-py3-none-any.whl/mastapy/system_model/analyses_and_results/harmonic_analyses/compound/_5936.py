...
class RingPinsToDiscConnectionCompoundHarmonicAnalysis(_5911.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    """RingPinsToDiscConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5768.RingPinsToDiscConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5768.RingPinsToDiscConnectionHarmonicAnalysis]':
