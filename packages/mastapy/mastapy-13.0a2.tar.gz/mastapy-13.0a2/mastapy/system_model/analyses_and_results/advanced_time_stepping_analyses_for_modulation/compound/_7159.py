...
class FEPartCompoundAdvancedTimeSteppingAnalysisForModulation(_7105.AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """FEPartCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_FEPartCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'FEPartCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def fe_part_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'FEPartCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7029.FEPartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7029.FEPartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'FEPartCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_FEPartCompoundAdvancedTimeSteppingAnalysisForModulation':
