...
class HarmonicLoadDataImportBase(_0.APIBase, Generic[T]):
    ...
    class _Cast_HarmonicLoadDataImportBase:
        ...
        def __init__(self, parent: 'HarmonicLoadDataImportBase'):
            self._parent = parent
        ...
        @property
        def harmonic_load_data_excel_import(self):
            from mastapy.system_model.analyses_and_results.static_loads import _6863
            
            return self._parent._cast(_6863.HarmonicLoadDataExcelImport)
        ...
        def harmonic_load_data_motor_cad_import(self):
            ...
            return self._parent._cast(_6868.HarmonicLoadDataMotorCADImport)

        @property
        def harmonic_load_data_import_base(self) -> 'HarmonicLoadDataImportBase':
            return self._parent
    ...
    @property
    def negate_tooth_axial_moment_data_on_import(self) -> 'bool':
        """bool: 'NegateToothAxialMomentDataOnImport' is the original name of this property."""
    ...
    def negate_tooth_axial_moment_data_on_import(self, value: 'bool'):
        self.wrapped.NegateToothAxialMomentDataOnImport = bool(value) if value else False
    ...
    @property
    def cast_to(self) -> 'HarmonicLoadDataImportBase._Cast_HarmonicLoadDataImportBase':
