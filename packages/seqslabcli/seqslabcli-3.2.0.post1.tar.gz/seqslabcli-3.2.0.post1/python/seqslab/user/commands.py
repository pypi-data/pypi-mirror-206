...
class BaseUser:
    ...
    def admin_consent(self) -> int:
        ...
        cprint(f'Please copy the URL to a browser to proceed with admin consent {ret}', 'yellow')
        return 0
    ...
    @argument("id",
              type=str,
              positional=False,
              description="Specify a user ID (required).")
    @argument("email",
              type=str,
              positional=False,
    ...
    @argument("id",
              type=str,
              positional=False,
              description="Specify the user ID (required).")
