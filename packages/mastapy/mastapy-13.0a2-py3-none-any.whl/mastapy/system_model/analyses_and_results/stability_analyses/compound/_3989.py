...
class SynchroniserPartCompoundStabilityAnalysis(_3913.CouplingHalfCompoundStabilityAnalysis):
    """SynchroniserPartCompoundStabilityAnalysis
    ...
    class _Cast_SynchroniserPartCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserPartCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_part_compound_stability_analysis(self) -> 'SynchroniserPartCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3859.SynchroniserPartStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3859.SynchroniserPartStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserPartCompoundStabilityAnalysis._Cast_SynchroniserPartCompoundStabilityAnalysis':
