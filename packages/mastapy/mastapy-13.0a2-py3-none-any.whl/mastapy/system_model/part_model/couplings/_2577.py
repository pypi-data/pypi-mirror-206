...
from mastapy.detailed_rigid_connectors.splines import _1398, _1383, _1403
from mastapy.system_model.part_model.couplings import (
    _2570, _2571, _2573, _2574,
    _2578, _2572
)
from mastapy.detailed_rigid_connectors.interference_fits import _1433
...
class ShaftHubConnection(_2427.Connector):
    """ShaftHubConnection
    ...
    @property
    def spline_type(self) -> '_1398.SplineDesignTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, _1398.SplineDesignTypes)
        return constructor.new_from_mastapy_type(_1398.SplineDesignTypes)(value) if value is not None else None

    @spline_type.setter
    def spline_type(self, value: '_1398.SplineDesignTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1398.SplineDesignTypes.type_())
    ...
    @property
    def tilt_stiffness_type(self) -> '_2571.RigidConnectorTiltStiffnessTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, _2571.RigidConnectorTiltStiffnessTypes)
        return constructor.new_from_mastapy_type(_2571.RigidConnectorTiltStiffnessTypes)(value) if value is not None else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2571.RigidConnectorTiltStiffnessTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2571.RigidConnectorTiltStiffnessTypes.type_())
    ...
    @property
    def interference_fit_design(self) -> '_1433.InterferenceFitDesign':
    ...
    @property
    def left_flank_lead_relief(self) -> '_2578.SplineLeadRelief':
    ...
    @property
    def right_flank_lead_relief(self) -> '_2578.SplineLeadRelief':
    ...
    @property
    def spline_joint_design(self) -> '_1403.SplineJointDesign':
    ...
    @property
    def lead_reliefs(self) -> 'List[_2578.SplineLeadRelief]':
    ...
    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2572.RigidConnectorToothLocation]':
