...
class UnbalancedMassCompoundPowerFlow(_4264.VirtualComponentCompoundPowerFlow):
    """UnbalancedMassCompoundPowerFlow
    ...
    class _Cast_UnbalancedMassCompoundPowerFlow:
        ...
        def __init__(self, parent: 'UnbalancedMassCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_compound_power_flow(self) -> 'UnbalancedMassCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4134.UnbalancedMassPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4134.UnbalancedMassPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassCompoundPowerFlow._Cast_UnbalancedMassCompoundPowerFlow':
