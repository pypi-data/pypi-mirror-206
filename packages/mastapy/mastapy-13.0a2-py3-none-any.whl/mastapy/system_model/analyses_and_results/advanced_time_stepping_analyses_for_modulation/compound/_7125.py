...
class ClutchConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7141.CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ClutchConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_ClutchConnectionCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'ClutchConnectionCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def clutch_connection_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'ClutchConnectionCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6995.ClutchConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6995.ClutchConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'ClutchConnectionCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_ClutchConnectionCompoundAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_ClutchConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(self)
