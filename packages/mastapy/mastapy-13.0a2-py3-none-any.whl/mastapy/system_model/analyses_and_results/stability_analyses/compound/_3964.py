...
class RingPinsToDiscConnectionCompoundStabilityAnalysis(_3939.InterMountableComponentConnectionCompoundStabilityAnalysis):
    """RingPinsToDiscConnectionCompoundStabilityAnalysis
    ...
    class _Cast_RingPinsToDiscConnectionCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'RingPinsToDiscConnectionCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def ring_pins_to_disc_connection_compound_stability_analysis(self) -> 'RingPinsToDiscConnectionCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3833.RingPinsToDiscConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3833.RingPinsToDiscConnectionStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'RingPinsToDiscConnectionCompoundStabilityAnalysis._Cast_RingPinsToDiscConnectionCompoundStabilityAnalysis':
