...
class PivotConditionalFormat (SpireObject) :
    ...
    def scope(self)->'ConditionalFormatScope':
        ...
        ret = GetDllLibXls().PivotConditionalFormat_get_scope(self.Ptr)
    ...
    def scope(self, value:'ConditionalFormatScope'):
        ...
        GetDllLibXls().PivotConditionalFormat_set_scope(self.Ptr, value.value)
    ...
    def get_Item(self ,index:int)->'IConditionalFormat':
        ...
        intPtr = GetDllLibXls().PivotConditionalFormat_get_Item(self.Ptr, index)
    ...
    def AddCondition(self)->'IConditionalFormat':
        ...
        intPtr = GetDllLibXls().PivotConditionalFormat_AddCondition(self.Ptr)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
