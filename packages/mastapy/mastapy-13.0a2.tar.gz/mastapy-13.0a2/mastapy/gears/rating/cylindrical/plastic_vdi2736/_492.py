...
class PlasticVDI2736GearSingleFlankRatingInAPlasticPlasticMesh(_486.PlasticGearVDI2736AbstractGearSingleFlankRating):
    """PlasticVDI2736GearSingleFlankRatingInAPlasticPlasticMesh
    ...
    class _Cast_PlasticVDI2736GearSingleFlankRatingInAPlasticPlasticMesh:
        ...
        def __init__(self, parent: 'PlasticVDI2736GearSingleFlankRatingInAPlasticPlasticMesh'):
            self._parent = parent
        ...
        @property
        def plastic_vdi2736_gear_single_flank_rating_in_a_plastic_plastic_mesh(self) -> 'PlasticVDI2736GearSingleFlankRatingInAPlasticPlasticMesh':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlasticVDI2736GearSingleFlankRatingInAPlasticPlasticMesh._Cast_PlasticVDI2736GearSingleFlankRatingInAPlasticPlasticMesh':
