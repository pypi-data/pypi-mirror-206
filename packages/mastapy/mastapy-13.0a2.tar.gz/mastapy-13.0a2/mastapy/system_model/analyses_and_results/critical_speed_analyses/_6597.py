...
class PowerLoadCriticalSpeedAnalysis(_6632.VirtualComponentCriticalSpeedAnalysis):
    """PowerLoadCriticalSpeedAnalysis
    ...
    class _Cast_PowerLoadCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'PowerLoadCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def power_load_critical_speed_analysis(self) -> 'PowerLoadCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PowerLoadCriticalSpeedAnalysis._Cast_PowerLoadCriticalSpeedAnalysis':
