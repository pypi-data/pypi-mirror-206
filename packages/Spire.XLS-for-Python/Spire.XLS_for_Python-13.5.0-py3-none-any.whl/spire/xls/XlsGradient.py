...
class XlsGradient (  XlsObject, IGradient) :
    ...
    def BackColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsGradient_get_BackColorObject(self.Ptr)
    ...
    def ForeColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsGradient_get_ForeColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def BackColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsGradient_get_BackColor(self.Ptr)
    ...
    def BackColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsGradient_set_BackColor(self.Ptr, value.Ptr)
    ...
    def ForeColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsGradient_get_ForeColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def ForeColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsGradient_set_ForeColor(self.Ptr, value.Ptr)
    ...
    def BackKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsGradient_get_BackKnownColor(self.Ptr)
    ...
    def BackKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsGradient_set_BackKnownColor(self.Ptr, value.value)
    ...
    def ForeKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsGradient_get_ForeKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def ForeKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsGradient_set_ForeKnownColor(self.Ptr, value.value)
    ...
    def GradientStyle(self)->'GradientStyleType':
        ...
        ret = GetDllLibXls().XlsGradient_get_GradientStyle(self.Ptr)
    ...
    def GradientStyle(self, value:'GradientStyleType'):
        ...
        GetDllLibXls().XlsGradient_set_GradientStyle(self.Ptr, value.value)
    ...
    def GradientVariant(self)->'GradientVariantsType':
        ...
        ret = GetDllLibXls().XlsGradient_get_GradientVariant(self.Ptr)
    ...
    def GradientVariant(self, value:'GradientVariantsType'):
        ...
        GetDllLibXls().XlsGradient_set_GradientVariant(self.Ptr, value.value)
    ...
    def CompareTo(self ,twin:'IGradient')->int:
        ...
        ret = GetDllLibXls().XlsGradient_CompareTo(self.Ptr, intPtrtwin)
        return ret
    ...
    def TwoColorGradient(self):
        ...
        GetDllLibXls().XlsGradient_TwoColorGradient(self.Ptr)
    ...
    def TwoColorGradient(self ,style:GradientStyleType):
        ...
        GetDllLibXls().XlsGradient_TwoColorGradientS(self.Ptr, enumstyle)
    ...
    def TwoColorGradient(self ,style:GradientStyleType,variant:GradientVariantsType):
        ...
        GetDllLibXls().XlsGradient_TwoColorGradientSV(self.Ptr, enumstyle,enumvariant)
