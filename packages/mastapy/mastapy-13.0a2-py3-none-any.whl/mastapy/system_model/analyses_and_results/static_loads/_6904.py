...
class PulleyLoadCase(_6816.CouplingHalfLoadCase):
    """PulleyLoadCase
    ...
    class _Cast_PulleyLoadCase:
        ...
        def __init__(self, parent: 'PulleyLoadCase'):
            self._parent = parent
        ...
        @property
        def pulley_load_case(self) -> 'PulleyLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PulleyLoadCase._Cast_PulleyLoadCase':
