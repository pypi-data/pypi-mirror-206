...
class ToothFlankFractureAnalysisContactPointCommon(_0.APIBase):
    ...
    class _Cast_ToothFlankFractureAnalysisContactPointCommon:
        ...
        def __init__(self, parent: 'ToothFlankFractureAnalysisContactPointCommon'):
            self._parent = parent

        @property
        def tooth_flank_fracture_analysis_contact_point(self):
            from mastapy.gears.rating.cylindrical.iso6336 import _519
            
            return self._parent._cast(_519.ToothFlankFractureAnalysisContactPoint)

        @property
        def tooth_flank_fracture_analysis_contact_point_method_a(self):
            from mastapy.gears.rating.cylindrical.iso6336 import _521
            
            return self._parent._cast(_521.ToothFlankFractureAnalysisContactPointMethodA)

        @property
        def tooth_flank_fracture_analysis_contact_point_common(self) -> 'ToothFlankFractureAnalysisContactPointCommon':
            return self._parent
    ...
    @property
    def analysis_point_with_maximum_local_material_exposure(self) -> '_523.ToothFlankFractureAnalysisPoint':
    ...
    @property
    def watch_points(self) -> 'List[_523.ToothFlankFractureAnalysisPoint]':
    ...
    @property
    def cast_to(self) -> 'ToothFlankFractureAnalysisContactPointCommon._Cast_ToothFlankFractureAnalysisContactPointCommon':
