...
from mastapy.electric_machines import _1298, _1257, _1253
...
class ElectricMachineSetup(_0.APIBase):
    ...
    class _Cast_ElectricMachineSetup:
        ...
        def __init__(self, parent: 'ElectricMachineSetup'):
            self._parent = parent

        @property
        def electric_machine_setup(self) -> 'ElectricMachineSetup':
            return self._parent
    ...
    @property
    def two_d_fe_model_for_electro_magnetic_analysis(self) -> '_1298.TwoDimensionalFEModelForAnalysis[_1257.ElectricMachineMeshingOptions]':
        """TwoDimensionalFEModelForAnalysis[ElectricMachineMeshingOptions]: 'TwoDFEModelForElectroMagneticAnalysis' is the original name of this property.
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1257.ElectricMachineMeshingOptions](temp) if temp is not None else None

    @property
    def eccentricity(self) -> '_1253.Eccentricity':
    ...
    def generate_electro_magnetic_mesh(self):
        """ 'GenerateElectroMagneticMesh' is the original name of this method."""
    ...
    @property
    def cast_to(self) -> 'ElectricMachineSetup._Cast_ElectricMachineSetup':
