...
class StraightBevelGearMeshAdvancedSystemDeflection(_7252.BevelGearMeshAdvancedSystemDeflection):
    """StraightBevelGearMeshAdvancedSystemDeflection
    ...
    class _Cast_StraightBevelGearMeshAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_advanced_system_deflection(self) -> 'StraightBevelGearMeshAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_detailed_analysis(self) -> '_391.StraightBevelGearMeshRating':
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2795.StraightBevelGearMeshSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshAdvancedSystemDeflection._Cast_StraightBevelGearMeshAdvancedSystemDeflection':
