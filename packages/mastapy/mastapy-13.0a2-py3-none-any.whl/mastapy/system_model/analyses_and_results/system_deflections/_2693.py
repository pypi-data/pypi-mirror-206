...
class CoaxialConnectionSystemDeflection(_2784.ShaftToMountableComponentConnectionSystemDeflection):
    """CoaxialConnectionSystemDeflection
    ...
    class _Cast_CoaxialConnectionSystemDeflection:
        ...
        def __init__(self, parent: 'CoaxialConnectionSystemDeflection'):
            self._parent = parent
        ...
        @property
        def coaxial_connection_system_deflection(self) -> 'CoaxialConnectionSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4033.CoaxialConnectionPowerFlow':
    ...
    @property
    def cast_to(self) -> 'CoaxialConnectionSystemDeflection._Cast_CoaxialConnectionSystemDeflection':
