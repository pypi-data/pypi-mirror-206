...
class LinkResponse:
    """
    Example:
        {'link_id': 'c7318ff7-257c-490e-8242-03a815b223b7', 'institution_id': 'chase', 'provider': 'mx', 'state':
            'connected'}
    ...
    Attributes:
        ...
        provider (Provider): An enumeration.
        ...
        tags (Union[Unset, None, List[str]]): Arbitrary strings used to describe this link. Example: ['smoke_test',
            'user_type:admin'].
        webhook (Union[Unset, None, str]): The webhook url assigned to this link. Example: https://example.com/webhook.
    """
