...
class FaceGearSetDesign(_945.GearSetDesign):
    """FaceGearSetDesign
    ...
    class _Cast_FaceGearSetDesign:
        ...
        def __init__(self, parent: 'FaceGearSetDesign'):
            self._parent = parent
        ...
        @property
        def face_gear_set_design(self) -> 'FaceGearSetDesign':
            return self._parent
    ...
    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_991.FaceGearSetMicroGeometry':
    ...
    @property
    def face_gear(self) -> '_992.FaceGearWheelDesign':
    ...
    @property
    def pinion(self) -> '_989.FaceGearPinionDesign':
    ...
    @property
    def gears(self) -> 'List[_984.FaceGearDesign]':
    ...
    @property
    def face_meshes(self) -> 'List[_986.FaceGearMeshDesign]':
    ...
    @property
    def cast_to(self) -> 'FaceGearSetDesign._Cast_FaceGearSetDesign':
