...
class GearFilletNodeStressResults(_0.APIBase):
    ...
    class _Cast_GearFilletNodeStressResults:
        ...
        def __init__(self, parent: 'GearFilletNodeStressResults'):
            self._parent = parent

        @property
        def conical_gear_fillet_stress_results(self):
            from mastapy.gears.ltca import _820
            
            return self._parent._cast(_820.ConicalGearFilletStressResults)

        @property
        def cylindrical_gear_fillet_node_stress_results(self):
            from mastapy.gears.ltca import _823
            
            return self._parent._cast(_823.CylindricalGearFilletNodeStressResults)

        @property
        def gear_fillet_node_stress_results(self) -> 'GearFilletNodeStressResults':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GearFilletNodeStressResults._Cast_GearFilletNodeStressResults':
