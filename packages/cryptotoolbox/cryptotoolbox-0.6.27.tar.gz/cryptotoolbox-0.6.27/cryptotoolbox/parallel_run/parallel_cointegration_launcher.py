...
class CointegrationParalleLauncher():
    def __init__(self,starting_date = None, running_date = None, drop_token='', dropbox_backup=True, local_root_directory='../data',user='napoleon',underlying_x=None, underlying_y=None, frequence=None,db_path_suffix = '_alphas.sqlite', triggers = [True], transaction_costs = [True], normalizations = [False],signal_idiosyncratic_paramaters=[None], table_max_size = 2000):
        ...
        self.filename =  launcher_utility.get_cointegration_database_name(user, frequence, underlying_x, underlying_y, starting_date, running_date, db_path_suffix)
