...
class Size (SpireObject) :
    ...
    def op_Implicit(p:'Size')->'SizeF':
        ...
        intPtr = dlllib.Size_op_Implicit( intPtrp)
    ...
    def op_Addition(sz1:'Size',sz2:'Size')->'Size':
        ...
        intPtr = dlllib.Size_op_Addition( intPtrsz1,intPtrsz2)
    ...
    def op_Subtraction(sz1:'Size',sz2:'Size')->'Size':
        ...
        intPtr = dlllib.Size_op_Subtraction( intPtrsz1,intPtrsz2)
        ret = None if intPtr==None else Size(intPtr)
        return ret
    ...
    def op_Equality(sz1:'Size',sz2:'Size')->bool:
        ...
        ret = dlllib.Size_op_Equality( intPtrsz1,intPtrsz2)
        return ret
    ...
    def op_Inequality(sz1:'Size',sz2:'Size')->bool:
        ...
        ret = dlllib.Size_op_Inequality( intPtrsz1,intPtrsz2)
        return ret
    ...
    def op_Explicit(size:'Size')->'Point':
        ...
        intPtr = dlllib.Size_op_Explicit( intPtrsize)
    ...
    def IsEmpty(self)->bool:
        ...
        ret = dlllib.Size_get_IsEmpty(self.Ptr)
        return ret
    ...
    def Width(self)->int:
        ...
        ret = dlllib.Size_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:int):
        dlllib.Size_set_Width.argtypes=[c_void_p, c_int]
        dlllib.Size_set_Width(self.Ptr, value)
    ...
    def Height(self)->int:
        ...
        ret = dlllib.Size_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:int):
        dlllib.Size_set_Height.argtypes=[c_void_p, c_int]
        dlllib.Size_set_Height(self.Ptr, value)
    ...
    def Add(sz1:'Size',sz2:'Size')->'Size':
        ...
        intPtr = dlllib.Size_Add( intPtrsz1,intPtrsz2)
        ret = None if intPtr==None else Size(intPtr)
        return ret
    ...
    def Ceiling(value:'SizeF')->'Size':
        ...
        intPtr = dlllib.Size_Ceiling( intPtrvalue)
        ret = None if intPtr==None else Size(intPtr)
        return ret
    ...
    def Subtract(sz1:'Size',sz2:'Size')->'Size':
        ...
        intPtr = dlllib.Size_Subtract( intPtrsz1,intPtrsz2)
        ret = None if intPtr==None else Size(intPtr)
        return ret
    ...
    def Truncate(value:'SizeF')->'Size':
        ...
        intPtr = dlllib.Size_Truncate( intPtrvalue)
        ret = None if intPtr==None else Size(intPtr)
        return ret
    ...
    def Round(value:'SizeF')->'Size':
        ...
        intPtr = dlllib.Size_Round( intPtrvalue)
        ret = None if intPtr==None else Size(intPtr)
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = dlllib.Size_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = dlllib.Size_GetHashCode(self.Ptr)
        return ret
    ...
    def ToString(self)->str:
        ...
        dlllib.Size_ToString.restype=c_wchar_p
        ret = dlllib.Size_ToString(self.Ptr)
        return ret
