...
class WormGearCriticalSpeedAnalysis(_6568.GearCriticalSpeedAnalysis):
    """WormGearCriticalSpeedAnalysis
    ...
    class _Cast_WormGearCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'WormGearCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def worm_gear_critical_speed_analysis(self) -> 'WormGearCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearCriticalSpeedAnalysis._Cast_WormGearCriticalSpeedAnalysis':
