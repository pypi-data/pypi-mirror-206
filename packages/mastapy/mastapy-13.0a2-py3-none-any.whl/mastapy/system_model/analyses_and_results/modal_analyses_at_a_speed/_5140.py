...
class DatumModalAnalysisAtASpeed(_5114.ComponentModalAnalysisAtASpeed):
    """DatumModalAnalysisAtASpeed
    ...
    class _Cast_DatumModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'DatumModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def datum_modal_analysis_at_a_speed(self) -> 'DatumModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DatumModalAnalysisAtASpeed._Cast_DatumModalAnalysisAtASpeed':
