...
class KlingelnbergCycloPalloidHypoidGearModalAnalysis(_4618.KlingelnbergCycloPalloidConicalGearModalAnalysis):
    """KlingelnbergCycloPalloidHypoidGearModalAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearModalAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearModalAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_modal_analysis(self) -> 'KlingelnbergCycloPalloidHypoidGearModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearModalAnalysis._Cast_KlingelnbergCycloPalloidHypoidGearModalAnalysis':
