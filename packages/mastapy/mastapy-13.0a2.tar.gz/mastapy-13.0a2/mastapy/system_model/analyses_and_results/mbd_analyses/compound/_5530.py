...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5528, _5529, _5559
...
class ConceptGearSetCompoundMultibodyDynamicsAnalysis(_5559.GearSetCompoundMultibodyDynamicsAnalysis):
    """ConceptGearSetCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_ConceptGearSetCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'ConceptGearSetCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_gear_set_compound_multibody_dynamics_analysis(self) -> 'ConceptGearSetCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5381.ConceptGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5528.ConceptGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5529.ConceptGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5381.ConceptGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ConceptGearSetCompoundMultibodyDynamicsAnalysis._Cast_ConceptGearSetCompoundMultibodyDynamicsAnalysis':
