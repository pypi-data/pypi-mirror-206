...
class RepositionComponentDetails(_0.APIBase):
    ...
    class _Cast_RepositionComponentDetails:
        ...
        def __init__(self, parent: 'RepositionComponentDetails'):
            self._parent = parent

        @property
        def reposition_component_details(self) -> 'RepositionComponentDetails':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RepositionComponentDetails._Cast_RepositionComponentDetails':
