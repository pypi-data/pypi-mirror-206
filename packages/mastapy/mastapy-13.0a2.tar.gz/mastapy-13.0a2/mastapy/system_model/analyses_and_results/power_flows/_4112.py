...
class SpiralBevelGearPowerFlow(_4026.BevelGearPowerFlow):
    """SpiralBevelGearPowerFlow
    ...
    class _Cast_SpiralBevelGearPowerFlow:
        ...
        def __init__(self, parent: 'SpiralBevelGearPowerFlow'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_power_flow(self) -> 'SpiralBevelGearPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearPowerFlow._Cast_SpiralBevelGearPowerFlow':
