...
class TorqueConverterPumpCompoundCriticalSpeedAnalysis(_6678.CouplingHalfCompoundCriticalSpeedAnalysis):
    """TorqueConverterPumpCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6629.TorqueConverterPumpCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6629.TorqueConverterPumpCriticalSpeedAnalysis]':
