...
"""
from mastapy.bearings.bearing_results.rolling import _2036, _1988
...
class LoadedThreePointContactBallBearingRow(_1988.LoadedBallBearingRow):
    """LoadedThreePointContactBallBearingRow
    ...
    class _Cast_LoadedThreePointContactBallBearingRow:
        ...
        def __init__(self, parent: 'LoadedThreePointContactBallBearingRow'):
            self._parent = parent
        ...
        @property
        def loaded_three_point_contact_ball_bearing_row(self) -> 'LoadedThreePointContactBallBearingRow':
            return self._parent
    ...
    @property
    def loaded_bearing(self) -> '_2036.LoadedThreePointContactBallBearingResults':
    ...
    @property
    def cast_to(self) -> 'LoadedThreePointContactBallBearingRow._Cast_LoadedThreePointContactBallBearingRow':
