...
class SpiralBevelGearCompoundAdvancedSystemDeflection(_7384.BevelGearCompoundAdvancedSystemDeflection):
    """SpiralBevelGearCompoundAdvancedSystemDeflection
    ...
    class _Cast_SpiralBevelGearCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'SpiralBevelGearCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_compound_advanced_system_deflection(self) -> 'SpiralBevelGearCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7337.SpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7337.SpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearCompoundAdvancedSystemDeflection._Cast_SpiralBevelGearCompoundAdvancedSystemDeflection':
