...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7283, _7284
...
class CylindricalMeshedGearAdvancedSystemDeflection(_0.APIBase):
    ...
    class _Cast_CylindricalMeshedGearAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'CylindricalMeshedGearAdvancedSystemDeflection'):
            self._parent = parent

        @property
        def cylindrical_meshed_gear_advanced_system_deflection(self) -> 'CylindricalMeshedGearAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cylindrical_gear_advanced_system_deflection(self) -> '_7283.CylindricalGearAdvancedSystemDeflection':
    ...
    @property
    def cylindrical_gear_mesh_advanced_system_deflection(self) -> '_7284.CylindricalGearMeshAdvancedSystemDeflection':
    ...
    @property
    def other_cylindrical_gear_advanced_system_deflection(self) -> '_7283.CylindricalGearAdvancedSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'CylindricalMeshedGearAdvancedSystemDeflection._Cast_CylindricalMeshedGearAdvancedSystemDeflection':
