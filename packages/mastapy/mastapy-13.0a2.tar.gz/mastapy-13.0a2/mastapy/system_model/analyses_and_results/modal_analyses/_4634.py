...
class OrderCutsChartSettings(_0.APIBase):
    ...
    class _Cast_OrderCutsChartSettings:
        ...
        def __init__(self, parent: 'OrderCutsChartSettings'):
            self._parent = parent

        @property
        def order_cuts_chart_settings(self) -> 'OrderCutsChartSettings':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'OrderCutsChartSettings._Cast_OrderCutsChartSettings':
        return self._Cast_OrderCutsChartSettings(self)
