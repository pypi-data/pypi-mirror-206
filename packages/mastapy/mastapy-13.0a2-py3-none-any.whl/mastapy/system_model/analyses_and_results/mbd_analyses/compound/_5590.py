...
class RollingRingAssemblyCompoundMultibodyDynamicsAnalysis(_5597.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """RollingRingAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5449.RollingRingAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5449.RollingRingAssemblyMultibodyDynamicsAnalysis]':
