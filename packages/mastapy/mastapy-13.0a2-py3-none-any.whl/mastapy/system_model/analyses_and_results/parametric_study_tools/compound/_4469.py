...
class DatumCompoundParametricStudyTool(_4443.ComponentCompoundParametricStudyTool):
    """DatumCompoundParametricStudyTool
    ...
    class _Cast_DatumCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'DatumCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def datum_compound_parametric_study_tool(self) -> 'DatumCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4322.DatumParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4322.DatumParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'DatumCompoundParametricStudyTool._Cast_DatumCompoundParametricStudyTool':
