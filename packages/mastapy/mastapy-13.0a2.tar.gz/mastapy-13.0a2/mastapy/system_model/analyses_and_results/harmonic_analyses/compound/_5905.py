...
class GearMeshCompoundHarmonicAnalysis(_5911.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    """GearMeshCompoundHarmonicAnalysis
    ...
    class _Cast_GearMeshCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'GearMeshCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def gear_mesh_compound_harmonic_analysis(self) -> 'GearMeshCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5724.GearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5724.GearMeshHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'GearMeshCompoundHarmonicAnalysis._Cast_GearMeshCompoundHarmonicAnalysis':
