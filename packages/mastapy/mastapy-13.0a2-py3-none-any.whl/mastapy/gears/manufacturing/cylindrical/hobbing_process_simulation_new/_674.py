...
class MountingError(_0.APIBase):
    ...
    class _Cast_MountingError:
        ...
        def __init__(self, parent: 'MountingError'):
            self._parent = parent

        @property
        def gear_mounting_error(self):
            from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _660
            
            return self._parent._cast(_660.GearMountingError)

        @property
        def rack_mounting_error(self):
            from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _685
            
            return self._parent._cast(_685.RackMountingError)

        @property
        def mounting_error(self) -> 'MountingError':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MountingError._Cast_MountingError':
