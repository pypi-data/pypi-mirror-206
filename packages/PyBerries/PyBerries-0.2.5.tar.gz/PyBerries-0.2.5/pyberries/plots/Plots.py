...
# Decorator function to add plot elements (xlim/ylim, axis labels, plot title,...)
def plot(plot_func):
    def make_plot(df, xlim:tuple=(None, None), ylim:tuple=(None, None), xlabel:str='', ylabel:str='', title:str='', drop_duplicates_by=[], **kwargs):
