...
from mastapy.gears.gear_designs.face import _985, _984
...
class FaceGearWheelDesign(_984.FaceGearDesign):
    """FaceGearWheelDesign
    ...
    class _Cast_FaceGearWheelDesign:
        ...
        def __init__(self, parent: 'FaceGearWheelDesign'):
            self._parent = parent
        ...
        @property
        def face_gear_wheel_design(self) -> 'FaceGearWheelDesign':
            return self._parent
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_985.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _985.FaceGearDiameterFaceWidthSpecificationMethod)
        return constructor.new_from_mastapy_type(_985.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value is not None else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_985.FaceGearDiameterFaceWidthSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _985.FaceGearDiameterFaceWidthSpecificationMethod.type_())
    ...
    @property
    def cast_to(self) -> 'FaceGearWheelDesign._Cast_FaceGearWheelDesign':
