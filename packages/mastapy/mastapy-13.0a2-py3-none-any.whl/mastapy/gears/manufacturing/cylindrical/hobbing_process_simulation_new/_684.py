...
class RackManufactureError(_0.APIBase):
    ...
    class _Cast_RackManufactureError:
        ...
        def __init__(self, parent: 'RackManufactureError'):
            self._parent = parent

        @property
        def hob_manufacture_error(self):
            from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _671
            
            return self._parent._cast(_671.HobManufactureError)

        @property
        def worm_grinder_manufacture_error(self):
            from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _686
            
            return self._parent._cast(_686.WormGrinderManufactureError)

        @property
        def rack_manufacture_error(self) -> 'RackManufactureError':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RackManufactureError._Cast_RackManufactureError':
