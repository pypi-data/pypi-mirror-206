...
class SynchroniserSleeveCompoundStabilityAnalysis(_3989.SynchroniserPartCompoundStabilityAnalysis):
    """SynchroniserSleeveCompoundStabilityAnalysis
    ...
    class _Cast_SynchroniserSleeveCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserSleeveCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_sleeve_compound_stability_analysis(self) -> 'SynchroniserSleeveCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3860.SynchroniserSleeveStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3860.SynchroniserSleeveStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserSleeveCompoundStabilityAnalysis._Cast_SynchroniserSleeveCompoundStabilityAnalysis':
