...
class CycloidalDiscModalAnalysis(_4548.AbstractShaftModalAnalysis):
    """CycloidalDiscModalAnalysis
    ...
    class _Cast_CycloidalDiscModalAnalysis:
        ...
        def __init__(self, parent: 'CycloidalDiscModalAnalysis'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_modal_analysis(self) -> 'CycloidalDiscModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscModalAnalysis._Cast_CycloidalDiscModalAnalysis':
