...
class ShaftHubConnectionModalAnalysisAtAStiffness(_4866.ConnectorModalAnalysisAtAStiffness):
    """ShaftHubConnectionModalAnalysisAtAStiffness
    ...
    class _Cast_ShaftHubConnectionModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ShaftHubConnectionModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def shaft_hub_connection_modal_analysis_at_a_stiffness(self) -> 'ShaftHubConnectionModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftHubConnectionModalAnalysisAtAStiffness._Cast_ShaftHubConnectionModalAnalysisAtAStiffness':
