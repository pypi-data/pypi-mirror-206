...
class ConceptGearMeshCriticalSpeedAnalysis(_6569.GearMeshCriticalSpeedAnalysis):
    """ConceptGearMeshCriticalSpeedAnalysis
    ...
    class _Cast_ConceptGearMeshCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ConceptGearMeshCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_gear_mesh_critical_speed_analysis(self) -> 'ConceptGearMeshCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptGearMeshCriticalSpeedAnalysis._Cast_ConceptGearMeshCriticalSpeedAnalysis':
