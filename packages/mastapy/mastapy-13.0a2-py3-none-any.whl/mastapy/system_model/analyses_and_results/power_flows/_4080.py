...
class KlingelnbergCycloPalloidHypoidGearPowerFlow(_4077.KlingelnbergCycloPalloidConicalGearPowerFlow):
    """KlingelnbergCycloPalloidHypoidGearPowerFlow
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearPowerFlow:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearPowerFlow'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_power_flow(self) -> 'KlingelnbergCycloPalloidHypoidGearPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearPowerFlow._Cast_KlingelnbergCycloPalloidHypoidGearPowerFlow':
