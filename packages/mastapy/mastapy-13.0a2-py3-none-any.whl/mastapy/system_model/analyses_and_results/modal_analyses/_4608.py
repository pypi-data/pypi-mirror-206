...
class FrequencyResponseAnalysisOptions(_7498.AbstractAnalysisOptions['_6768.LoadCase']):
    """FrequencyResponseAnalysisOptions
    ...
    class _Cast_FrequencyResponseAnalysisOptions:
        ...
        def __init__(self, parent: 'FrequencyResponseAnalysisOptions'):
            self._parent = parent
        ...
        @property
        def frequency_response_analysis_options(self) -> 'FrequencyResponseAnalysisOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FrequencyResponseAnalysisOptions._Cast_FrequencyResponseAnalysisOptions':
