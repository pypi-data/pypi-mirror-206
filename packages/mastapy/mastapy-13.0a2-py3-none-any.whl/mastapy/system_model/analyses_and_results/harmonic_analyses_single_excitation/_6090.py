...
class SynchroniserHarmonicAnalysisOfSingleExcitation(_6074.SpecialisedAssemblyHarmonicAnalysisOfSingleExcitation):
    """SynchroniserHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_SynchroniserHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'SynchroniserHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def synchroniser_harmonic_analysis_of_single_excitation(self) -> 'SynchroniserHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserHarmonicAnalysisOfSingleExcitation._Cast_SynchroniserHarmonicAnalysisOfSingleExcitation':
