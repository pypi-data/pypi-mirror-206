...
_ELECTRIC_MACHINE_MECHANICAL_RESULTS = python_net_import('SMT.MastaAPI.ElectricMachines.Results', 'ElectricMachineMechanicalResults')
...
class ElectricMachineMechanicalResults(_0.APIBase):
    ...
    class _Cast_ElectricMachineMechanicalResults:
        ...
        def __init__(self, parent: 'ElectricMachineMechanicalResults'):
            self._parent = parent

        @property
        def electric_machine_mechanical_results(self) -> 'ElectricMachineMechanicalResults':
            return self._parent
    ...
    def __init__(self, instance_to_wrap: 'ElectricMachineMechanicalResults.TYPE'):
    ...
    @property
    def cast_to(self) -> 'ElectricMachineMechanicalResults._Cast_ElectricMachineMechanicalResults':
