...
class SpringDamperConnectionCompoundAdvancedSystemDeflection(_7406.CouplingConnectionCompoundAdvancedSystemDeflection):
    """SpringDamperConnectionCompoundAdvancedSystemDeflection
    ...
    class _Cast_SpringDamperConnectionCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'SpringDamperConnectionCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_compound_advanced_system_deflection(self) -> 'SpringDamperConnectionCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7341.SpringDamperConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7341.SpringDamperConnectionAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionCompoundAdvancedSystemDeflection._Cast_SpringDamperConnectionCompoundAdvancedSystemDeflection':
