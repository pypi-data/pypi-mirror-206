...
class CoaxialConnectionParametricStudyTool(_4386.ShaftToMountableComponentConnectionParametricStudyTool):
    """CoaxialConnectionParametricStudyTool
    ...
    class _Cast_CoaxialConnectionParametricStudyTool:
        ...
        def __init__(self, parent: 'CoaxialConnectionParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def coaxial_connection_parametric_study_tool(self) -> 'CoaxialConnectionParametricStudyTool':
            return self._parent
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2693.CoaxialConnectionSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'CoaxialConnectionParametricStudyTool._Cast_CoaxialConnectionParametricStudyTool':
