...
def same_path(
    file_path1: Union[str, Path], file_path2: Union[str, Path], strict: bool = False
) -> bool:
    ...
    """
    path1 = _get_path(file_path1).resolve(strict=strict)
    path2 = _get_path(file_path2).resolve(strict=strict)
