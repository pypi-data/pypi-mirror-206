...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundSystemDeflection(_2898.KlingelnbergCycloPalloidConicalGearMeshCompoundSystemDeflection):
    """KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundSystemDeflection
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh_compound_system_deflection(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2753.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2753.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundSystemDeflection._Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundSystemDeflection':
        return self._Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundSystemDeflection(self)
