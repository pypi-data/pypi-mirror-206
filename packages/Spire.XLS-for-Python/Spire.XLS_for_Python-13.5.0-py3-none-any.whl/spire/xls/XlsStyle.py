...
class XlsStyle (  AddtionalFormatWrapper, INamedObject) :
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().XlsStyle_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().XlsStyle_get_Name(self.Ptr)
        return ret
    ...
    def IsInitialized(self)->bool:
        ...
        ret = GetDllLibXls().XlsStyle_get_IsInitialized(self.Ptr)
        return ret
    ...
    def BuiltIn(self)->bool:
        ...
        ret = GetDllLibXls().XlsStyle_get_BuiltIn(self.Ptr)
        return ret
    ...
    def Index(self)->int:
        ...
        ret = GetDllLibXls().XlsStyle_get_Index(self.Ptr)
        return ret
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsStyle_Clone(self.Ptr, intPtrparent)
    ...
    def CompareTo(self ,obj:'SpireObject')->int:
        ...
        ret = GetDllLibXls().XlsStyle_CompareTo(self.Ptr, intPtrobj)
        return ret
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().XlsStyle_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().XlsStyle_EndUpdate(self.Ptr)
    ...
    def DEF_DEFAULT_STYLES()->List[str]:
        ...
        intPtrArray = GetDllLibXls().XlsStyle_DEF_DEFAULT_STYLES()
