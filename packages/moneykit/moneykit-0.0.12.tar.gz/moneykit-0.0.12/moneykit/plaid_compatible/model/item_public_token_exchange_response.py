...
class ItemPublicTokenExchangeResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, access_token, item_id, request_id, *args, **kwargs):  # noqa: E501
        """ItemPublicTokenExchangeResponse - a model defined in OpenAPI
