...
from the command line from '{os.getcwd()}'. If you are still having trouble, please contact Chalk support.""",
    ...
    def _await_operation_completion(self, operation_id: uuid.UUID, show_progress: bool = True):
        ProgressService(operation_id=operation_id, client=self).await_operation(show_progress=show_progress)
