...
from mastapy.system_model.analyses_and_results.stability_analyses import _3798, _3796, _3802
...
class FaceGearSetStabilityAnalysis(_3802.GearSetStabilityAnalysis):
    """FaceGearSetStabilityAnalysis
    ...
    class _Cast_FaceGearSetStabilityAnalysis:
        ...
        def __init__(self, parent: 'FaceGearSetStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def face_gear_set_stability_analysis(self) -> 'FaceGearSetStabilityAnalysis':
            return self._parent
    ...
    @property
    def face_gears_stability_analysis(self) -> 'List[_3798.FaceGearStabilityAnalysis]':
    ...
    @property
    def face_meshes_stability_analysis(self) -> 'List[_3796.FaceGearMeshStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'FaceGearSetStabilityAnalysis._Cast_FaceGearSetStabilityAnalysis':
