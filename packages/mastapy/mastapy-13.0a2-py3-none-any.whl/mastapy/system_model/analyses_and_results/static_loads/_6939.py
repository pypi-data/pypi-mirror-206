...
class TorqueConverterTurbineLoadCase(_6816.CouplingHalfLoadCase):
    """TorqueConverterTurbineLoadCase
    ...
    class _Cast_TorqueConverterTurbineLoadCase:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineLoadCase'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_load_case(self) -> 'TorqueConverterTurbineLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineLoadCase._Cast_TorqueConverterTurbineLoadCase':
