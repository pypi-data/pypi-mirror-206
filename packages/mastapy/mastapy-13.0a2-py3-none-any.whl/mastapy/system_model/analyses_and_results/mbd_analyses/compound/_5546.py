...
class CylindricalGearCompoundMultibodyDynamicsAnalysis(_5557.GearCompoundMultibodyDynamicsAnalysis):
    """CylindricalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5398.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5398.CylindricalGearMultibodyDynamicsAnalysis]':
