...
from oblv_ctl.models.repo import Repo
from oblv_ctl.models.repo_all_response import RepoAllResponse
from oblv_ctl.models.user_credit_utilization import UserCreditUtilization
...
class TestUserUnLinkRepo(unittest.TestCase):
    ...
    def test_success_request(self, sync):
        self.assertEqual(self.client.unlink_repo(123456), "Success")
