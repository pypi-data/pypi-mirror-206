...
class ConceptCouplingCompoundCriticalSpeedAnalysis(_6676.CouplingCompoundCriticalSpeedAnalysis):
    """ConceptCouplingCompoundCriticalSpeedAnalysis
    ...
    class _Cast_ConceptCouplingCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ConceptCouplingCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_coupling_compound_critical_speed_analysis(self) -> 'ConceptCouplingCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6535.ConceptCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6535.ConceptCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingCompoundCriticalSpeedAnalysis._Cast_ConceptCouplingCompoundCriticalSpeedAnalysis':
