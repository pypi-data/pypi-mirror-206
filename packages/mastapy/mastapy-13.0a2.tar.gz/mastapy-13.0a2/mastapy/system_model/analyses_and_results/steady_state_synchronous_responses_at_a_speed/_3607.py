...
class WormGearMeshSteadyStateSynchronousResponseAtASpeed(_3541.GearMeshSteadyStateSynchronousResponseAtASpeed):
    """WormGearMeshSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_WormGearMeshSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'WormGearMeshSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def worm_gear_mesh_steady_state_synchronous_response_at_a_speed(self) -> 'WormGearMeshSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearMeshSteadyStateSynchronousResponseAtASpeed._Cast_WormGearMeshSteadyStateSynchronousResponseAtASpeed':
