...
class RollingRingConnectionAdvancedSystemDeflection(_7302.InterMountableComponentConnectionAdvancedSystemDeflection):
    """RollingRingConnectionAdvancedSystemDeflection
    ...
    class _Cast_RollingRingConnectionAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'RollingRingConnectionAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def rolling_ring_connection_advanced_system_deflection(self) -> 'RollingRingConnectionAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2777.RollingRingConnectionSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'RollingRingConnectionAdvancedSystemDeflection._Cast_RollingRingConnectionAdvancedSystemDeflection':
