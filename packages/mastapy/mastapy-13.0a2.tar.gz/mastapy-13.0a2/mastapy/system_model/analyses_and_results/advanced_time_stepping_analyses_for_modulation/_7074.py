...
class SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6990.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_advanced_time_stepping_analysis_for_modulation(self) -> 'SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation._Cast_SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(self)
