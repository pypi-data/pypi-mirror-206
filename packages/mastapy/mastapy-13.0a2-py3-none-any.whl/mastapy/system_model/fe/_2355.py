...
class ElectricMachineDynamicLoadData(_0.APIBase):
    ...
    class _Cast_ElectricMachineDynamicLoadData:
        ...
        def __init__(self, parent: 'ElectricMachineDynamicLoadData'):
            self._parent = parent

        @property
        def electric_machine_dynamic_load_data(self) -> 'ElectricMachineDynamicLoadData':
            return self._parent
    ...
    @property
    def electric_machine_data_sets(self) -> 'List[_2354.ElectricMachineDataSet]':
    ...
    def add_electric_machine_data_set(self, name: 'str') -> '_2354.ElectricMachineDataSet':
    ...
    def add_electric_machine_data_set_from_masta_dynamic_force_analysis(self, analysis: '_1328.IHaveDynamicForceResults', slice_index: 'int') -> '_2354.ElectricMachineDataSet':
    ...
    @property
    def cast_to(self) -> 'ElectricMachineDynamicLoadData._Cast_ElectricMachineDynamicLoadData':
