...
class FlexiblePinAnalysisOptions(_0.APIBase):
    ...
    class _Cast_FlexiblePinAnalysisOptions:
        ...
        def __init__(self, parent: 'FlexiblePinAnalysisOptions'):
            self._parent = parent

        @property
        def flexible_pin_analysis_options(self) -> 'FlexiblePinAnalysisOptions':
            return self._parent
    ...
    @property
    def extreme_load_case_for_stop_start(self) -> '_6769.StaticLoadCase':
    ...
    def extreme_load_case_for_stop_start(self, value: '_6769.StaticLoadCase'):
    ...
    @property
    def nominal_load_case_for_stop_start(self) -> '_6769.StaticLoadCase':
    ...
    def nominal_load_case_for_stop_start(self, value: '_6769.StaticLoadCase'):
        value = value.wrapped if value else None
        self.wrapped.NominalLoadCaseForStopStart = value

    @property
    def cast_to(self) -> 'FlexiblePinAnalysisOptions._Cast_FlexiblePinAnalysisOptions':
