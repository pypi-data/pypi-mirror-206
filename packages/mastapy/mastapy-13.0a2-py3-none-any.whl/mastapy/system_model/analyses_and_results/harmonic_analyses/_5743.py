...
class KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis(_5683.ConicalGearMeshHarmonicAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_conical_gear_mesh_harmonic_analysis(self) -> 'KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis._Cast_KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis':
