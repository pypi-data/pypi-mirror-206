...
from mastapy.gears.gear_designs.bevel import _1185, _1183, _1184
...
class BevelGearSetDesign(_1189.AGMAGleasonConicalGearSetDesign):
    """BevelGearSetDesign
    ...
    class _Cast_BevelGearSetDesign:
        ...
        def __init__(self, parent: 'BevelGearSetDesign'):
            self._parent = parent
        ...
        @property
        def bevel_gear_set_design(self) -> 'BevelGearSetDesign':
            return self._parent
    ...
    @property
    def backlash_distribution_rule(self) -> '_1145.BacklashDistributionRule':
        ...
        value = conversion.pn_to_mp_enum(temp, _1145.BacklashDistributionRule)
        return constructor.new_from_mastapy_type(_1145.BacklashDistributionRule)(value) if value is not None else None

    @backlash_distribution_rule.setter
    def backlash_distribution_rule(self, value: '_1145.BacklashDistributionRule'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1145.BacklashDistributionRule.type_())
        self.wrapped.BacklashDistributionRule = value

    @property
    def backlash_used_for_tooth_thickness_calculation(self) -> '_1507.MaxMinMean':
        ...
        value = conversion.pn_to_mp_enum(temp, _1507.MaxMinMean)
        return constructor.new_from_mastapy_type(_1507.MaxMinMean)(value) if value is not None else None

    @backlash_used_for_tooth_thickness_calculation.setter
    def backlash_used_for_tooth_thickness_calculation(self, value: '_1507.MaxMinMean'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1507.MaxMinMean.type_())
    ...
    @property
    def round_cutter_specifications(self) -> '_1185.WheelFinishCutterPointWidthRestrictionMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _1185.WheelFinishCutterPointWidthRestrictionMethod)
        return constructor.new_from_mastapy_type(_1185.WheelFinishCutterPointWidthRestrictionMethod)(value) if value is not None else None

    @round_cutter_specifications.setter
    def round_cutter_specifications(self, value: '_1185.WheelFinishCutterPointWidthRestrictionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1185.WheelFinishCutterPointWidthRestrictionMethod.type_())
    ...
    @property
    def tooth_proportions_input_method(self) -> '_1183.ToothProportionsInputMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _1183.ToothProportionsInputMethod)
        return constructor.new_from_mastapy_type(_1183.ToothProportionsInputMethod)(value) if value is not None else None

    @tooth_proportions_input_method.setter
    def tooth_proportions_input_method(self, value: '_1183.ToothProportionsInputMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1183.ToothProportionsInputMethod.type_())
        self.wrapped.ToothProportionsInputMethod = value

    @property
    def tooth_taper_root_line_tilt_method(self) -> '_343.SpiralBevelRootLineTilt':
        ...
        value = conversion.pn_to_mp_enum(temp, _343.SpiralBevelRootLineTilt)
        return constructor.new_from_mastapy_type(_343.SpiralBevelRootLineTilt)(value) if value is not None else None

    @tooth_taper_root_line_tilt_method.setter
    def tooth_taper_root_line_tilt_method(self, value: '_343.SpiralBevelRootLineTilt'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _343.SpiralBevelRootLineTilt.type_())
    ...
    @property
    def cast_to(self) -> 'BevelGearSetDesign._Cast_BevelGearSetDesign':
