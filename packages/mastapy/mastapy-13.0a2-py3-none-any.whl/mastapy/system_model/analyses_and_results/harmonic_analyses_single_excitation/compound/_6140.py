...
class ConnectionCompoundHarmonicAnalysisOfSingleExcitation(_7501.ConnectionCompoundAnalysis):
    """ConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6010.ConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6010.ConnectionHarmonicAnalysisOfSingleExcitation]':
