...
class GeometryModellerSettings(_1583.PerMachineSettings):
    """GeometryModellerSettings
    ...
    class _Cast_GeometryModellerSettings:
        ...
        def __init__(self, parent: 'GeometryModellerSettings'):
            self._parent = parent
        ...
        @property
        def geometry_modeller_settings(self) -> 'GeometryModellerSettings':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GeometryModellerSettings._Cast_GeometryModellerSettings':
