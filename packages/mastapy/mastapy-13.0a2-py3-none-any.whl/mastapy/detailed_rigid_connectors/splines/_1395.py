...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1410
...
class SAESplineHalfDesign(_1407.StandardSplineHalfDesign):
    """SAESplineHalfDesign
    ...
    class _Cast_SAESplineHalfDesign:
        ...
        def __init__(self, parent: 'SAESplineHalfDesign'):
            self._parent = parent
        ...
        @property
        def sae_spline_half_design(self) -> 'SAESplineHalfDesign':
            return self._parent
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1410.SAESplineTolerances':
    ...
    @property
    def cast_to(self) -> 'SAESplineHalfDesign._Cast_SAESplineHalfDesign':
