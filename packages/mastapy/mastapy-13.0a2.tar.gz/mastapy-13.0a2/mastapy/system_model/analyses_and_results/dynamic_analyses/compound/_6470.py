...
class ShaftToMountableComponentConnectionCompoundDynamicAnalysis(_6376.AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """ShaftToMountableComponentConnectionCompoundDynamicAnalysis
    ...
    class _Cast_ShaftToMountableComponentConnectionCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'ShaftToMountableComponentConnectionCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def shaft_to_mountable_component_connection_compound_dynamic_analysis(self) -> 'ShaftToMountableComponentConnectionCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6341.ShaftToMountableComponentConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6341.ShaftToMountableComponentConnectionDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ShaftToMountableComponentConnectionCompoundDynamicAnalysis._Cast_ShaftToMountableComponentConnectionCompoundDynamicAnalysis':
        return self._Cast_ShaftToMountableComponentConnectionCompoundDynamicAnalysis(self)
