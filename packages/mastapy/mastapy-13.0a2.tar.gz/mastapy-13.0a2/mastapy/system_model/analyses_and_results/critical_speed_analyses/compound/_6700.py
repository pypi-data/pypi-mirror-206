...
class GuideDxfModelCompoundCriticalSpeedAnalysis(_6664.ComponentCompoundCriticalSpeedAnalysis):
    """GuideDxfModelCompoundCriticalSpeedAnalysis
    ...
    class _Cast_GuideDxfModelCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'GuideDxfModelCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def guide_dxf_model_compound_critical_speed_analysis(self) -> 'GuideDxfModelCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6571.GuideDxfModelCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6571.GuideDxfModelCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'GuideDxfModelCompoundCriticalSpeedAnalysis._Cast_GuideDxfModelCompoundCriticalSpeedAnalysis':
