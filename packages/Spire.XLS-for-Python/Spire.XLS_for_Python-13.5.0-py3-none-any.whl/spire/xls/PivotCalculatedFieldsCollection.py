...
class PivotCalculatedFieldsCollection (  IPivotCalculatedFields) :
    """
    ...
    def Parent(self)->'XlsPivotTable':
        ...
        intPtr = GetDllLibXls().PivotCalculatedFieldsCollection_get_Parent(self.Ptr)
    ...
    def Add(self ,name:str,formula:str)->'IPivotField':
        ...
        intPtr = GetDllLibXls().PivotCalculatedFieldsCollection_Add(self.Ptr, name,formula)
