...
class VectorWithLinearAndAngularComponents(_0.APIBase):
    ...
    class _Cast_VectorWithLinearAndAngularComponents:
        ...
        def __init__(self, parent: 'VectorWithLinearAndAngularComponents'):
            self._parent = parent

        @property
        def vector_with_linear_and_angular_components(self) -> 'VectorWithLinearAndAngularComponents':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'VectorWithLinearAndAngularComponents._Cast_VectorWithLinearAndAngularComponents':
