...
from mastapy.bearings.bearing_results.rolling import (
    _1954, _1963, _1965, _1958,
    _2045, _2019
)
from mastapy.bearings.bearing_results.rolling.iso_rating_results import _2088, _2089, _2091
from mastapy.bearings.bearing_results.rolling.fitting import _2095, _2097, _2098
...
class LoadedRollingBearingResults(_1939.LoadedDetailedBearingResults):
    """LoadedRollingBearingResults
    ...
    class _Cast_LoadedRollingBearingResults:
        ...
        def __init__(self, parent: 'LoadedRollingBearingResults'):
            self._parent = parent
        ...
        @property
        def loaded_rolling_bearing_results(self) -> 'LoadedRollingBearingResults':
            return self._parent
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1869.FluidFilmTemperatureOptions':
        ...
        value = conversion.pn_to_mp_enum(temp, _1869.FluidFilmTemperatureOptions)
        return constructor.new_from_mastapy_type(_1869.FluidFilmTemperatureOptions)(value) if value is not None else None
    ...
    @property
    def total_element_raceway_contact_area_inner(self) -> 'float':
        """float: 'TotalElementRacewayContactAreaInner' is the original name of this property.
    ...
    @property
    def total_element_raceway_contact_area_left(self) -> 'float':
        """float: 'TotalElementRacewayContactAreaLeft' is the original name of this property.
    ...
    @property
    def total_element_raceway_contact_area_outer(self) -> 'float':
        """float: 'TotalElementRacewayContactAreaOuter' is the original name of this property.
    ...
    @property
    def total_element_raceway_contact_area_right(self) -> 'float':
        """float: 'TotalElementRacewayContactAreaRight' is the original name of this property.
    ...
    @property
    def ansiabma(self) -> '_2102.ANSIABMAResults':
    ...
    @property
    def din7322010(self) -> '_1954.DIN7322010Results':
        """DIN7322010Results: 'DIN7322010' is the original name of this property.
    ...
    @property
    def iso2812007(self) -> '_2088.ISO2812007Results':
    ...
    @property
    def iso762006(self) -> '_2089.ISO762006Results':
    ...
    @property
    def isotr1417912001(self) -> '_1963.ISOTR1417912001Results':
    ...
    @property
    def isotr1417922001(self) -> '_1965.ISOTR1417922001Results':
    ...
    @property
    def isots162812008(self) -> '_2091.ISOTS162812008Results':
    ...
    @property
    def inner_ring_fitting_at_assembly(self) -> '_2095.InnerRingFittingThermalResults':
    ...
    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_2095.InnerRingFittingThermalResults':
    ...
    @property
    def maximum_operating_internal_clearance(self) -> '_1958.InternalClearance':
    ...
    @property
    def maximum_static_contact_stress(self) -> '_2045.MaximumStaticContactStress':
    ...
    @property
    def minimum_operating_internal_clearance(self) -> '_1958.InternalClearance':
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_2097.OuterRingFittingThermalResults':
    ...
    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_2097.OuterRingFittingThermalResults':
    ...
    @property
    def skf_module_results(self) -> '_2083.SKFModuleResults':
    ...
    @property
    def all_mounting_results(self) -> 'List[_2098.RingFittingThermalResults]':
    ...
    @property
    def rows(self) -> 'List[_2019.LoadedRollingBearingRow]':
    ...
    @property
    def cast_to(self) -> 'LoadedRollingBearingResults._Cast_LoadedRollingBearingResults':
