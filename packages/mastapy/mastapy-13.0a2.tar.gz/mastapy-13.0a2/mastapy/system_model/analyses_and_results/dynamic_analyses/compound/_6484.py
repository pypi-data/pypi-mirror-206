...
class StraightBevelPlanetGearCompoundDynamicAnalysis(_6478.StraightBevelDiffGearCompoundDynamicAnalysis):
    """StraightBevelPlanetGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6355.StraightBevelPlanetGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6355.StraightBevelPlanetGearDynamicAnalysis]':
