...
class OilSealCompoundHarmonicAnalysis(_5882.ConnectorCompoundHarmonicAnalysis):
    """OilSealCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5754.OilSealHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5754.OilSealHarmonicAnalysis]':
