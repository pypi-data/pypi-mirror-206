...
class HypoidGearMultibodyDynamicsAnalysis(_5352.AGMAGleasonConicalGearMultibodyDynamicsAnalysis):
    """HypoidGearMultibodyDynamicsAnalysis
    ...
    class _Cast_HypoidGearMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'HypoidGearMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_multibody_dynamics_analysis(self) -> 'HypoidGearMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidGearMultibodyDynamicsAnalysis._Cast_HypoidGearMultibodyDynamicsAnalysis':
