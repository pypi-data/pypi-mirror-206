...
class CycloidalAssemblyCompoundModalAnalysis(_4799.SpecialisedAssemblyCompoundModalAnalysis):
    """CycloidalAssemblyCompoundModalAnalysis
    ...
    class _Cast_CycloidalAssemblyCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'CycloidalAssemblyCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def cycloidal_assembly_compound_modal_analysis(self) -> 'CycloidalAssemblyCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4591.CycloidalAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4591.CycloidalAssemblyModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'CycloidalAssemblyCompoundModalAnalysis._Cast_CycloidalAssemblyCompoundModalAnalysis':
