...
class KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysisAtASpeed(_5155.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed):
    """KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysisAtASpeed
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh_modal_analysis_at_a_speed(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysisAtASpeed._Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysisAtASpeed':
        return self._Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysisAtASpeed(self)
