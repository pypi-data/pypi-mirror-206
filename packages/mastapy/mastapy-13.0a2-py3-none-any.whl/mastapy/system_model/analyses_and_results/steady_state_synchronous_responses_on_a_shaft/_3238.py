...
class BevelDifferentialPlanetGearSteadyStateSynchronousResponseOnAShaft(_3237.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft):
    """BevelDifferentialPlanetGearSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_BevelDifferentialPlanetGearSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'BevelDifferentialPlanetGearSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def bevel_differential_planet_gear_steady_state_synchronous_response_on_a_shaft(self) -> 'BevelDifferentialPlanetGearSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialPlanetGearSteadyStateSynchronousResponseOnAShaft._Cast_BevelDifferentialPlanetGearSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_BevelDifferentialPlanetGearSteadyStateSynchronousResponseOnAShaft(self)
