...
class AbstractAssemblyCompoundAdvancedSystemDeflection(_7447.PartCompoundAdvancedSystemDeflection):
    """AbstractAssemblyCompoundAdvancedSystemDeflection
    ...
    class _Cast_AbstractAssemblyCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'AbstractAssemblyCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def abstract_assembly_compound_advanced_system_deflection(self) -> 'AbstractAssemblyCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7232.AbstractAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7232.AbstractAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'AbstractAssemblyCompoundAdvancedSystemDeflection._Cast_AbstractAssemblyCompoundAdvancedSystemDeflection':
