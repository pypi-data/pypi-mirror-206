...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7026, _7027, _7033
...
class FaceGearSetAdvancedTimeSteppingAnalysisForModulation(_7033.GearSetAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_FaceGearSetAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'FaceGearSetAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def face_gear_set_advanced_time_stepping_analysis_for_modulation(self) -> 'FaceGearSetAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def face_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7026.FaceGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7027.FaceGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'FaceGearSetAdvancedTimeSteppingAnalysisForModulation._Cast_FaceGearSetAdvancedTimeSteppingAnalysisForModulation':
