...
class HypoidGearCompoundHarmonicAnalysis(_5850.AGMAGleasonConicalGearCompoundHarmonicAnalysis):
    """HypoidGearCompoundHarmonicAnalysis
    ...
    class _Cast_HypoidGearCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'HypoidGearCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_compound_harmonic_analysis(self) -> 'HypoidGearCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5738.HypoidGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5738.HypoidGearHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearCompoundHarmonicAnalysis._Cast_HypoidGearCompoundHarmonicAnalysis':
