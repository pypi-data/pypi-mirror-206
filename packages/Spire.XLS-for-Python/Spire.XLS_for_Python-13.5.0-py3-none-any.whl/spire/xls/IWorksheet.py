...
<example>The following code illustrates how to saves the worksheet in a different file with separator:
    ...
    @abc.abstractmethod
    def SaveToImage(self ,outputStream:Stream,firstRow:int,firstColumn:int,lastRow:int,lastColumn:int,emfType:EmfType)->Image:
        """
    <summary>
    ...
    @abc.abstractmethod
    def SaveToImage(self ,outputStream:Stream,firstRow:int,firstColumn:int,lastRow:int,lastColumn:int,imageType:ImageType,emfType:EmfType)->Image:
        """
    <summary>
        Converts range into image.
    </summary>
