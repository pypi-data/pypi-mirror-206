...
class AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed(_5252.ConicalGearSetCompoundModalAnalysisAtASpeed):
    """AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed
    ...
    class _Cast_AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_set_compound_modal_analysis_at_a_speed(self) -> 'AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5095.AGMAGleasonConicalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5095.AGMAGleasonConicalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed._Cast_AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed':
