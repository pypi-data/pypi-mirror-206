...
class SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation(_7011.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_advanced_time_stepping_analysis_for_modulation(self) -> 'SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation._Cast_SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation(self)
