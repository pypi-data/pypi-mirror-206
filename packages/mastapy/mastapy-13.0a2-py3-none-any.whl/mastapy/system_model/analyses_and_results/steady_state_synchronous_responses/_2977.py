...
class BevelDifferentialSunGearSteadyStateSynchronousResponse(_2975.BevelDifferentialGearSteadyStateSynchronousResponse):
    ...
    class _Cast_BevelDifferentialSunGearSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'BevelDifferentialSunGearSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def bevel_differential_sun_gear_steady_state_synchronous_response(self) -> 'BevelDifferentialSunGearSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialSunGearSteadyStateSynchronousResponse._Cast_BevelDifferentialSunGearSteadyStateSynchronousResponse':
