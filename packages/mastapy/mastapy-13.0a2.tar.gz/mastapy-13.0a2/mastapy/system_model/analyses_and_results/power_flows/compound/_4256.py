...
class SynchroniserHalfCompoundPowerFlow(_4257.SynchroniserPartCompoundPowerFlow):
    """SynchroniserHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4125.SynchroniserHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4125.SynchroniserHalfPowerFlow]':
