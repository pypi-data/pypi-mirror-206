...
class BevelDifferentialGearModalAnalysisAtAStiffness(_4847.BevelGearModalAnalysisAtAStiffness):
    """BevelDifferentialGearModalAnalysisAtAStiffness
    ...
    class _Cast_BevelDifferentialGearModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'BevelDifferentialGearModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_modal_analysis_at_a_stiffness(self) -> 'BevelDifferentialGearModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearModalAnalysisAtAStiffness._Cast_BevelDifferentialGearModalAnalysisAtAStiffness':
