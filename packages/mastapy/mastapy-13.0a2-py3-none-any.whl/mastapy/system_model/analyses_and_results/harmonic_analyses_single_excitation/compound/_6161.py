...
class FEPartCompoundHarmonicAnalysisOfSingleExcitation(_6107.AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation):
    """FEPartCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_FEPartCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'FEPartCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def fe_part_compound_harmonic_analysis_of_single_excitation(self) -> 'FEPartCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6031.FEPartHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6031.FEPartHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'FEPartCompoundHarmonicAnalysisOfSingleExcitation._Cast_FEPartCompoundHarmonicAnalysisOfSingleExcitation':
