from inverse.src.partition import get_table_name_treshold

from inverse.src.buffer_ops import get_table_names_from_tuple
from inverse.src.sp_utils_inverse import close_two_matrices, close_identity
