...
class SpringDamperSystemDeflection(_2710.CouplingSystemDeflection):
    """SpringDamperSystemDeflection
    ...
    class _Cast_SpringDamperSystemDeflection:
        ...
        def __init__(self, parent: 'SpringDamperSystemDeflection'):
            self._parent = parent
        ...
        @property
        def spring_damper_system_deflection(self) -> 'SpringDamperSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4116.SpringDamperPowerFlow':
    ...
    @property
    def cast_to(self) -> 'SpringDamperSystemDeflection._Cast_SpringDamperSystemDeflection':
