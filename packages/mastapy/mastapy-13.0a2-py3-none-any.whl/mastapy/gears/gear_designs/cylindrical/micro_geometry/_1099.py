...
class CylindricalGearProfileModification(_577.ProfileModification):
    """CylindricalGearProfileModification
    ...
    class _Cast_CylindricalGearProfileModification:
        ...
        def __init__(self, parent: 'CylindricalGearProfileModification'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_profile_modification(self) -> 'CylindricalGearProfileModification':
            return self._parent
    ...
    @property
    def profile_modification_chart(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def barrelling_peak_point(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def evaluation_lower_limit(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def evaluation_lower_limit_for_zero_root_relief(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def evaluation_upper_limit(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def evaluation_upper_limit_for_zero_tip_relief(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def linear_root_relief_evaluation(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def linear_root_relief_start(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def linear_tip_relief_evaluation(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def linear_tip_relief_start(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def parabolic_root_relief_evaluation(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def parabolic_root_relief_start(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def parabolic_tip_relief_evaluation(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def parabolic_tip_relief_start(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearProfileModification._Cast_CylindricalGearProfileModification':
