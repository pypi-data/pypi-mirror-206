...
class RingPinToDiscContactReporting(_0.APIBase):
    ...
    class _Cast_RingPinToDiscContactReporting:
        ...
        def __init__(self, parent: 'RingPinToDiscContactReporting'):
            self._parent = parent

        @property
        def ring_pin_to_disc_contact_reporting(self) -> 'RingPinToDiscContactReporting':
            return self._parent
    ...
    @property
    def contact(self) -> '_2829.SplineFlankContactReporting':
    ...
    @property
    def information_at_ring_pin_to_disc_contact_point_from_geometry(self) -> '_6873.InformationAtRingPinToDiscContactPointFromGeometry':
    ...
    @property
    def information_for_contact_points_along_face_width(self) -> 'List[_2745.InformationForContactAtPointAlongFaceWidth]':
    ...
    @property
    def cast_to(self) -> 'RingPinToDiscContactReporting._Cast_RingPinToDiscContactReporting':
