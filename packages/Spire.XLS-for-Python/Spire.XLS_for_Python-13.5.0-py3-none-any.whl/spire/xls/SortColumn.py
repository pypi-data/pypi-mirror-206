...
class SortColumn (  SpireObject, ISortColumn) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().SortColumn_get_Key(self.Ptr)
        return ret

    @Key.setter
    def Key(self, value:int):
        GetDllLibXls().SortColumn_set_Key.argtypes=[c_void_p, c_int]
        GetDllLibXls().SortColumn_set_Key(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SortColumn_get_ComparsionType(self.Ptr)
    ...
    def ComparsionType(self, value:'SortComparsionType'):
        ...
        GetDllLibXls().SortColumn_set_ComparsionType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SortColumn_get_Order(self.Ptr)
    ...
    def Order(self, value:'OrderBy'):
        ...
        GetDllLibXls().SortColumn_set_Order(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtrArray = GetDllLibXls().SortColumn_get_CustomSortOrder(self.Ptr)
    ...
    def CustomSortOrder(self, value:List[str]):
        ...
        GetDllLibXls().SortColumn_set_CustomSortOrder(self.Ptr, vArray, vCount)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().SortColumn_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().SortColumn_set_Color(self.Ptr, value.Ptr)
    ...
    def SetLevel(self ,level:int):
        ...
        GetDllLibXls().SortColumn_SetLevel(self.Ptr, level)
