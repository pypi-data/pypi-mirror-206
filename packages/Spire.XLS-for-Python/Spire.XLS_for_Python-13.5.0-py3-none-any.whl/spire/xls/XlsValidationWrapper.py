...
class XlsValidationWrapper (  CommonWrapper, IDataValidation, IExcelApplication) :
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsValidationWrapper_get_Parent(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsValidationWrapper_get_InputTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsValidationWrapper_get_InputTitle(self.Ptr)
        return ret
    ...
    def InputTitle(self, value:str):
        ...
        GetDllLibXls().XlsValidationWrapper_set_InputTitle(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsValidationWrapper_get_InputMessage.restype=c_wchar_p
        ret = GetDllLibXls().XlsValidationWrapper_get_InputMessage(self.Ptr)
        return ret
    ...
    def InputMessage(self, value:str):
        ...
        GetDllLibXls().XlsValidationWrapper_set_InputMessage(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsValidationWrapper_get_ErrorTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsValidationWrapper_get_ErrorTitle(self.Ptr)
        return ret
    ...
    def ErrorTitle(self, value:str):
        ...
        GetDllLibXls().XlsValidationWrapper_set_ErrorTitle(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsValidationWrapper_get_ErrorMessage.restype=c_wchar_p
        ret = GetDllLibXls().XlsValidationWrapper_get_ErrorMessage(self.Ptr)
        return ret
    ...
    def ErrorMessage(self, value:str):
        ...
        GetDllLibXls().XlsValidationWrapper_set_ErrorMessage(self.Ptr, value)
    ...
    def Formula1(self)->str:
        ...
        GetDllLibXls().XlsValidationWrapper_get_Formula1.restype=c_wchar_p
        ret = GetDllLibXls().XlsValidationWrapper_get_Formula1(self.Ptr)
        return ret
    ...
    def Formula1(self, value:str):
        ...
        GetDllLibXls().XlsValidationWrapper_set_Formula1(self.Ptr, value)
    ...
    def DateTime1(self)->'DateTime':
        ...
        intPtr = GetDllLibXls().XlsValidationWrapper_get_DateTime1(self.Ptr)
    ...
    def DateTime1(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsValidationWrapper_set_DateTime1(self.Ptr, value.Ptr)
    ...
    def Formula2(self)->str:
        ...
        GetDllLibXls().XlsValidationWrapper_get_Formula2.restype=c_wchar_p
        ret = GetDllLibXls().XlsValidationWrapper_get_Formula2(self.Ptr)
        return ret
    ...
    def Formula2(self, value:str):
        ...
        GetDllLibXls().XlsValidationWrapper_set_Formula2(self.Ptr, value)
    ...
    def DateTime2(self)->'DateTime':
        ...
        intPtr = GetDllLibXls().XlsValidationWrapper_get_DateTime2(self.Ptr)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def DateTime2(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsValidationWrapper_set_DateTime2(self.Ptr, value.Ptr)
    ...
    def AllowType(self)->'CellDataType':
        ...
        ret = GetDllLibXls().XlsValidationWrapper_get_AllowType(self.Ptr)
    ...
    def AllowType(self, value:'CellDataType'):
        ...
        GetDllLibXls().XlsValidationWrapper_set_AllowType(self.Ptr, value.value)
    ...
    def CompareOperator(self)->'ValidationComparisonOperator':
        ...
        ret = GetDllLibXls().XlsValidationWrapper_get_CompareOperator(self.Ptr)
    ...
    def CompareOperator(self, value:'ValidationComparisonOperator'):
        ...
        GetDllLibXls().XlsValidationWrapper_set_CompareOperator(self.Ptr, value.value)
    ...
    def IsListInFormula(self)->bool:
        ...
        ret = GetDllLibXls().XlsValidationWrapper_get_IsListInFormula(self.Ptr)
        return ret
    ...
    def IsListInFormula(self, value:bool):
        ...
        GetDllLibXls().XlsValidationWrapper_set_IsListInFormula(self.Ptr, value)
    ...
    def IgnoreBlank(self)->bool:
        ...
        ret = GetDllLibXls().XlsValidationWrapper_get_IgnoreBlank(self.Ptr)
        return ret

    @IgnoreBlank.setter
    def IgnoreBlank(self, value:bool):
        GetDllLibXls().XlsValidationWrapper_set_IgnoreBlank.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsValidationWrapper_set_IgnoreBlank(self.Ptr, value)
    ...
    def IsSuppressDropDownArrow(self)->bool:
        ...
        ret = GetDllLibXls().XlsValidationWrapper_get_IsSuppressDropDownArrow(self.Ptr)
        return ret
    ...
    def IsSuppressDropDownArrow(self, value:bool):
        ...
        GetDllLibXls().XlsValidationWrapper_set_IsSuppressDropDownArrow(self.Ptr, value)
    ...
    def ShowInput(self)->bool:
        ...
        ret = GetDllLibXls().XlsValidationWrapper_get_ShowInput(self.Ptr)
        return ret

    @ShowInput.setter
    def ShowInput(self, value:bool):
        GetDllLibXls().XlsValidationWrapper_set_ShowInput.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsValidationWrapper_set_ShowInput(self.Ptr, value)
    ...
    def ShowError(self)->bool:
        ...
        ret = GetDllLibXls().XlsValidationWrapper_get_ShowError(self.Ptr)
        return ret

    @ShowError.setter
    def ShowError(self, value:bool):
        GetDllLibXls().XlsValidationWrapper_set_ShowError.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsValidationWrapper_set_ShowError(self.Ptr, value)
    ...
    def PromptBoxHPosition(self)->int:
        ...
        ret = GetDllLibXls().XlsValidationWrapper_get_PromptBoxHPosition(self.Ptr)
        return ret
    ...
    def PromptBoxHPosition(self, value:int):
        ...
        GetDllLibXls().XlsValidationWrapper_set_PromptBoxHPosition(self.Ptr, value)
    ...
    def PromptBoxVPosition(self)->int:
        ...
        ret = GetDllLibXls().XlsValidationWrapper_get_PromptBoxVPosition(self.Ptr)
        return ret
    ...
    def PromptBoxVPosition(self, value:int):
        ...
        GetDllLibXls().XlsValidationWrapper_set_PromptBoxVPosition(self.Ptr, value)
    ...
    def IsInputVisible(self)->bool:
        ...
        ret = GetDllLibXls().XlsValidationWrapper_get_IsInputVisible(self.Ptr)
        return ret
    ...
    def IsInputVisible(self, value:bool):
        ...
        GetDllLibXls().XlsValidationWrapper_set_IsInputVisible(self.Ptr, value)
    ...
    def IsInputPositionFixed(self)->bool:
        ...
        ret = GetDllLibXls().XlsValidationWrapper_get_IsInputPositionFixed(self.Ptr)
        return ret
    ...
    def IsInputPositionFixed(self, value:bool):
        ...
        GetDllLibXls().XlsValidationWrapper_set_IsInputPositionFixed(self.Ptr, value)
    ...
    def AlertStyle(self)->'AlertStyleType':
        ...
        ret = GetDllLibXls().XlsValidationWrapper_get_AlertStyle(self.Ptr)
    ...
    def AlertStyle(self, value:'AlertStyleType'):
        ...
        GetDllLibXls().XlsValidationWrapper_set_AlertStyle(self.Ptr, value.value)
    ...
    def Values(self)->List[str]:
        ...
        intPtrArray = GetDllLibXls().XlsValidationWrapper_get_Values(self.Ptr)
    ...
    def Values(self, value:List[str]):
        ...
        GetDllLibXls().XlsValidationWrapper_set_Values(self.Ptr, vArray, vCount)
    ...
    def DataRange(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsValidationWrapper_get_DataRange(self.Ptr)
    ...
    def DataRange(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsValidationWrapper_set_DataRange(self.Ptr, value.Ptr)
