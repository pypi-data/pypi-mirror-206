...
class CouplingModalAnalysisAtASpeed(_5187.SpecialisedAssemblyModalAnalysisAtASpeed):
    """CouplingModalAnalysisAtASpeed
    ...
    class _Cast_CouplingModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'CouplingModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def coupling_modal_analysis_at_a_speed(self) -> 'CouplingModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CouplingModalAnalysisAtASpeed._Cast_CouplingModalAnalysisAtASpeed':
