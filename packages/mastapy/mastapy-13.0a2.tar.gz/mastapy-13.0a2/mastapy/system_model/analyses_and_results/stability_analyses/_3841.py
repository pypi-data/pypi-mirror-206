...
class SpecialisedAssemblyStabilityAnalysis(_3742.AbstractAssemblyStabilityAnalysis):
    """SpecialisedAssemblyStabilityAnalysis
    ...
    class _Cast_SpecialisedAssemblyStabilityAnalysis:
        ...
        def __init__(self, parent: 'SpecialisedAssemblyStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def specialised_assembly_stability_analysis(self) -> 'SpecialisedAssemblyStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpecialisedAssemblyStabilityAnalysis._Cast_SpecialisedAssemblyStabilityAnalysis':
