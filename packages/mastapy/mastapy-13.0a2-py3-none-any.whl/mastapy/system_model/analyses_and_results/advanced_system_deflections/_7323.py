...
class PlanetCarrierAdvancedSystemDeflection(_7315.MountableComponentAdvancedSystemDeflection):
    """PlanetCarrierAdvancedSystemDeflection
    ...
    class _Cast_PlanetCarrierAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'PlanetCarrierAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def planet_carrier_advanced_system_deflection(self) -> 'PlanetCarrierAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierAdvancedSystemDeflection._Cast_PlanetCarrierAdvancedSystemDeflection':
