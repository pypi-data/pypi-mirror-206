...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2931, _2932, _2848
...
class SpiralBevelGearSetCompoundSystemDeflection(_2848.BevelGearSetCompoundSystemDeflection):
    """SpiralBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2787.SpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def spiral_bevel_gears_compound_system_deflection(self) -> 'List[_2931.SpiralBevelGearCompoundSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_compound_system_deflection(self) -> 'List[_2932.SpiralBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2787.SpiralBevelGearSetSystemDeflection]':
