...
class TorqueConverterCompoundCriticalSpeedAnalysis(_6676.CouplingCompoundCriticalSpeedAnalysis):
    """TorqueConverterCompoundCriticalSpeedAnalysis
    ...
    class _Cast_TorqueConverterCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'TorqueConverterCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def torque_converter_compound_critical_speed_analysis(self) -> 'TorqueConverterCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6628.TorqueConverterCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6628.TorqueConverterCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterCompoundCriticalSpeedAnalysis._Cast_TorqueConverterCompoundCriticalSpeedAnalysis':
