...
PN_MISSING_DATE_COMP = 5451
PAPERTE_DATE_MISS = 5452                                       #: Specificare una data di registrazione!
DE_CANNOT_BE_FROM_DDT = 5453                                   #: Impossibile generare un documento elettronico da un DdT!
...
ELAB_CC_INVALID_STATE = 7229
ELAB_CC_NUMBERING_CHANGED = 7230                               #: Impossibile confermare i documenti: la numerazione è cambiata!
ELAB_CC_EVENT_CONFIRMED_DF = 7231                              #: Eseguita conferma in definitivo del documento
ELAB_CC_EVENT_CONFIRMED_O = 7232                               #: Eseguita conferma in definitivo dell'ordine
ELAB_CC_EVENT_CONFIRMED_PR = 7233                              #: Eseguita conferma in definitivo del preventivo
...
DISPPAG_BON_PARAMETER_NF = 7303                                #: L'elaborazione non ha trovato il sottoconto da utilizzare per i bonifici (archivio Banche Azienda)!
...
ACTIVITY_ATTEMPTED_TO_SAVE_DE_FROM_DDT = 8026
...
IN_SIZE = 'SIZE'
CMD_UNSET_FRESH_INSTALL = 98
OUT_IS_FRESH_INSTALL = 'IS_FRESH_INSTALL'
CMD_GET_DATABASE_STATS = 99
CMD_FETCH_NOTES = 100
OUT_NOTES = 'NOTES'
CMD_TEST = 101
IN_INPUT = 'INPUT'
