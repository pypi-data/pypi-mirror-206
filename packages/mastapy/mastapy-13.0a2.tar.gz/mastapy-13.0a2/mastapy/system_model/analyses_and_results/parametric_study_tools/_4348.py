...
class KlingelnbergCycloPalloidHypoidGearParametricStudyTool(_4345.KlingelnbergCycloPalloidConicalGearParametricStudyTool):
    """KlingelnbergCycloPalloidHypoidGearParametricStudyTool
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearParametricStudyTool:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_parametric_study_tool(self) -> 'KlingelnbergCycloPalloidHypoidGearParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearParametricStudyTool._Cast_KlingelnbergCycloPalloidHypoidGearParametricStudyTool':
