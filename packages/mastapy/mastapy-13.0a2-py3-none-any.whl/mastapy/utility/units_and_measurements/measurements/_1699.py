...
class SpecificAcousticImpedance(_1594.MeasurementBase):
    """SpecificAcousticImpedance
    ...
    class _Cast_SpecificAcousticImpedance:
        ...
        def __init__(self, parent: 'SpecificAcousticImpedance'):
            self._parent = parent
        ...
        @property
        def specific_acoustic_impedance(self) -> 'SpecificAcousticImpedance':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpecificAcousticImpedance._Cast_SpecificAcousticImpedance':
