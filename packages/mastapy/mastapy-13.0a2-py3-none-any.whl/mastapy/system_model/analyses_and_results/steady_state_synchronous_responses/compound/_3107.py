...
class BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse(_3112.BevelGearMeshCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_compound_steady_state_synchronous_response(self) -> 'BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2973.BevelDifferentialGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2973.BevelDifferentialGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse._Cast_BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse':
        return self._Cast_BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse(self)
