...
class TransportsApi(object):
    ...
    @validate_arguments
    def create_transport(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_transport : Annotated[WebTransport, Field(..., description="New essence creation request.")], **kwargs) -> WebTransport:  # noqa: E501
    ...
    @validate_arguments
    def create_transport_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_transport : Annotated[WebTransport, Field(..., description="New essence creation request.")], **kwargs):  # noqa: E501
        """Create transport  # noqa: E501
    ...
    @validate_arguments
    def delete_transport(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_transport_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs):  # noqa: E501
        """Remove transport  # noqa: E501
    ...
    @validate_arguments
    def read_transport(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> WebTransport:  # noqa: E501
    ...
    @validate_arguments
    def read_transport_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs):  # noqa: E501
        """Reading transport  # noqa: E501
    ...
    def read_transports_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], offset : Annotated[Optional[conint(strict=True, le=10000000, ge=0)], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[conint(strict=True, le=10000000, ge=1)], Field(description="The number of items to return.")] = None, sort_field : Annotated[Optional[TableTransportColumnType], Field(description="Transport table column name. ")] = None, sort_direction : Annotated[Optional[StrictStr], Field(description="Sort direction.")] = None, table_transport_filter_list : Annotated[Optional[TableTransportFilterList], Field(description="Transport filter.")] = None, **kwargs):  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['table_transport_filter_list']:
    ...
    @validate_arguments
    def read_transports_geopoints(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], table_transport_filter_list : Annotated[Optional[TableTransportFilterList], Field(description="Transports filter.")] = None, **kwargs) -> WebTransportGeopointList:  # noqa: E501
        ...
        >>> thread = api.read_transports_geopoints(experiment_key, table_transport_filter_list, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_transports_geopoints_with_http_info(experiment_key, table_transport_filter_list, **kwargs)  # noqa: E501

    @validate_arguments
    def read_transports_geopoints_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], table_transport_filter_list : Annotated[Optional[TableTransportFilterList], Field(description="Transports filter.")] = None, **kwargs):  # noqa: E501
        """Transport geopoints  # noqa: E501
        ...
        >>> thread = api.read_transports_geopoints_with_http_info(experiment_key, table_transport_filter_list, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def update_transport(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_transport : Annotated[WebTransport, Field(..., description="Essence update request.")], **kwargs) -> WebTransport:  # noqa: E501
    ...
    @validate_arguments
    def update_transport_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_transport : Annotated[WebTransport, Field(..., description="Essence update request.")], **kwargs):  # noqa: E501
        """Update transport  # noqa: E501
