...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6343, _6344, _6261
...
class SpiralBevelGearSetDynamicAnalysis(_6261.BevelGearSetDynamicAnalysis):
    """SpiralBevelGearSetDynamicAnalysis
    ...
    class _Cast_SpiralBevelGearSetDynamicAnalysis:
        ...
        def __init__(self, parent: 'SpiralBevelGearSetDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_set_dynamic_analysis(self) -> 'SpiralBevelGearSetDynamicAnalysis':
            return self._parent
    ...
    @property
    def spiral_bevel_gears_dynamic_analysis(self) -> 'List[_6343.SpiralBevelGearDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_6344.SpiralBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearSetDynamicAnalysis._Cast_SpiralBevelGearSetDynamicAnalysis':
