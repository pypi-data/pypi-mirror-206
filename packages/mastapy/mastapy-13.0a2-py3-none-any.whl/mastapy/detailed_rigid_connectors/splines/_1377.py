...
class CustomSplineHalfDesign(_1402.SplineHalfDesign):
    """CustomSplineHalfDesign
    ...
    class _Cast_CustomSplineHalfDesign:
        ...
        def __init__(self, parent: 'CustomSplineHalfDesign'):
            self._parent = parent
        ...
        @property
        def custom_spline_half_design(self) -> 'CustomSplineHalfDesign':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CustomSplineHalfDesign._Cast_CustomSplineHalfDesign':
