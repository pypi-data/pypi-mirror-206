...
from mastapy.system_model import _2192, _2196
...
class DutyCycleImporter(_0.APIBase):
    ...
    @property
    def design_state_destinations(self) -> 'List[_2192.DutyCycleImporterDesignEntityMatch[_5633.DesignState]]':
    ...
    @property
    def duty_cycles_to_import(self) -> 'List[_2196.IncludeDutyCycleOption]':
    ...
    @property
    def point_load_destinations(self) -> 'List[_2192.DutyCycleImporterDesignEntityMatch[_2451.PointLoad]]':
    ...
    @property
    def power_load_destinations(self) -> 'List[_2192.DutyCycleImporterDesignEntityMatch[_2452.PowerLoad]]':
