...
_FEATUREDATASETREQUEST_ANNOTATIONTYPE = _descriptor.EnumDescriptor(
  name='AnnotationType',
  full_name='ncbi.datasets.v2.FeatureDatasetRequest.AnnotationType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_sym_db.RegisterEnumDescriptor(_FEATUREDATASETREQUEST_ANNOTATIONTYPE)
...
_DATASETREQUEST = _descriptor.Descriptor(
  ...
  serialized_start=26503,
  serialized_end=26736,
)
...
_FEATUREDATASETREQUEST = _descriptor.Descriptor(
  name='FeatureDatasetRequest',
  full_name='ncbi.datasets.v2.FeatureDatasetRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='accession', full_name='ncbi.datasets.v2.FeatureDatasetRequest.accession', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='accession', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='feature_ids', full_name='ncbi.datasets.v2.FeatureDatasetRequest.feature_ids', index=1,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='featureIds', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='include_annotation_type', full_name='ncbi.datasets.v2.FeatureDatasetRequest.include_annotation_type', index=2,
      number=3, type=14, cpp_type=8, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[],
  enum_types=[
    _FEATUREDATASETREQUEST_ANNOTATIONTYPE,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_FEATUREREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='searchText', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sort', full_name='ncbi.datasets.v2.FeatureRequest.sort', index=5,
      number=6, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='sort', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='page_size', full_name='ncbi.datasets.v2.FeatureRequest.page_size', index=6,
      number=8, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\302\360\031\004\n\00220', json_name='pageSize', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='ncbi.datasets.v2.FeatureRequest.page_token', index=7,
      number=9, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATUREDATASETREQUEST.fields_by_name['include_annotation_type'].enum_type = _FEATUREDATASETREQUEST_ANNOTATIONTYPE
_FEATUREDATASETREQUEST_ANNOTATIONTYPE.containing_type = _FEATUREDATASETREQUEST
_FEATUREREQUEST.fields_by_name['gene_types'].enum_type = _GENETYPE
_FEATUREREQUEST.fields_by_name['sort'].message_type = _SORTFIELD
...
DESCRIPTOR.message_types_by_name['FeatureDatasetRequest'] = _FEATUREDATASETREQUEST
...
FeatureDatasetRequest = _reflection.GeneratedProtocolMessageType('FeatureDatasetRequest', (_message.Message,), {
  'DESCRIPTOR' : _FEATUREDATASETREQUEST,
  '__module__' : 'ncbi.datasets.v2.datasets_pb2'
  # @@protoc_insertion_point(class_scope:ncbi.datasets.v2.FeatureDatasetRequest)
  })
_sym_db.RegisterMessage(FeatureDatasetRequest)
