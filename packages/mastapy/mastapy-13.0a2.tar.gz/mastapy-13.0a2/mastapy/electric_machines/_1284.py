...
class RotorInternalLayerSpecification(_0.APIBase):
    ...
    class _Cast_RotorInternalLayerSpecification:
        ...
        def __init__(self, parent: 'RotorInternalLayerSpecification'):
            self._parent = parent

        @property
        def u_shaped_layer_specification(self):
            from mastapy.electric_machines import _1299
            
            return self._parent._cast(_1299.UShapedLayerSpecification)

        @property
        def v_shaped_magnet_layer_specification(self):
            from mastapy.electric_machines import _1300
            
            return self._parent._cast(_1300.VShapedMagnetLayerSpecification)

        @property
        def rotor_internal_layer_specification(self) -> 'RotorInternalLayerSpecification':
            return self._parent
    ...
    @property
    def magnets(self) -> '_1272.MagnetForLayer':
    ...
    @property
    def cast_to(self) -> 'RotorInternalLayerSpecification._Cast_RotorInternalLayerSpecification':
