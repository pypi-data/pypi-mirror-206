...
from mastapy.electric_machines import _1254, _1259
from mastapy.electric_machines.results import (
    _1324, _1316, _1318, _1320
)
...
class ElectricMachineResults(_0.APIBase):
    ...
    class _Cast_ElectricMachineResults:
        ...
        def __init__(self, parent: 'ElectricMachineResults'):
            self._parent = parent

        @property
        def on_load_electric_machine_results(self):
            from mastapy.electric_machines.results import _1333
            
            return self._parent._cast(_1333.OnLoadElectricMachineResults)

        @property
        def open_circuit_electric_machine_results(self):
            from mastapy.electric_machines.results import _1334
            
            return self._parent._cast(_1334.OpenCircuitElectricMachineResults)

        @property
        def electric_machine_results(self) -> 'ElectricMachineResults':
            return self._parent
    ...
    @property
    def flux_density_in_air_gap_chart_at_time_0(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def force_density_in_air_gap_mst_chart_at_time_0(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def total_ac_winding_loss(self) -> 'float':
        """float: 'TotalACWindingLoss' is the original name of this property.
    ...
    @property
    def electric_machine_detail(self) -> '_1254.ElectricMachineDetail':
    ...
    @property
    def setup(self) -> '_1259.ElectricMachineSetup':
    ...
    @property
    def results_timesteps(self) -> 'List[_1324.ElectricMachineResultsTimeStep]':
    ...
    @property
    def results_for_conductor_turns(self) -> 'List[_1316.ElectricMachineResultsForConductorTurn]':
        """List[ElectricMachineResultsForConductorTurn]: 'ResultsForConductorTurns' is the original name of this property.
    ...
    @property
    def results_for_line_to_line(self) -> 'List[_1318.ElectricMachineResultsForLineToLine]':
    ...
    @property
    def results_for_phases(self) -> 'List[_1320.ElectricMachineResultsForPhase]':
    ...
    @property
    def cast_to(self) -> 'ElectricMachineResults._Cast_ElectricMachineResults':
