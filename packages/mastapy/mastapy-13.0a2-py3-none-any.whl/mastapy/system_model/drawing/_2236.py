...
class RotorDynamicsViewable(_0.APIBase):
    ...
    class _Cast_RotorDynamicsViewable:
        ...
        def critical_speed_analysis_viewable(self):
            ...
            return self._parent._cast(_2228.CriticalSpeedAnalysisViewable)

        @property
        def stability_analysis_viewable(self):
            from mastapy.system_model.drawing import _2238
            
            return self._parent._cast(_2238.StabilityAnalysisViewable)

        @property
        def steady_state_synchronous_response_viewable(self):
            from mastapy.system_model.drawing import _2239
            
            return self._parent._cast(_2239.SteadyStateSynchronousResponseViewable)
    ...
    @property
    def rotor_dynamics(self) -> '_4003.RotorDynamicsDrawStyle':
