...
class HypoidGearCompoundModalAnalysisAtAStiffness(_4964.AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness):
    """HypoidGearCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_HypoidGearCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'HypoidGearCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_compound_modal_analysis_at_a_stiffness(self) -> 'HypoidGearCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4894.HypoidGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4894.HypoidGearModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearCompoundModalAnalysisAtAStiffness._Cast_HypoidGearCompoundModalAnalysisAtAStiffness':
