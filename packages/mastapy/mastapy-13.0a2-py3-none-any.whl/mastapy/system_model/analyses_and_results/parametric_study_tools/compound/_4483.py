...
class InterMountableComponentConnectionCompoundParametricStudyTool(_4453.ConnectionCompoundParametricStudyTool):
    """InterMountableComponentConnectionCompoundParametricStudyTool
    ...
    class _Cast_InterMountableComponentConnectionCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'InterMountableComponentConnectionCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def inter_mountable_component_connection_compound_parametric_study_tool(self) -> 'InterMountableComponentConnectionCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4343.InterMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4343.InterMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'InterMountableComponentConnectionCompoundParametricStudyTool._Cast_InterMountableComponentConnectionCompoundParametricStudyTool':
        return self._Cast_InterMountableComponentConnectionCompoundParametricStudyTool(self)
