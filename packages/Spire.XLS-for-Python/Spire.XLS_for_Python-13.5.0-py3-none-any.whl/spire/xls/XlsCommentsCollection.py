...
class XlsCommentsCollection (  CollectionBase[XlsComment],IComments) :
    ...
    def get_Item(self ,index:int)->ICommentShape:
        ...
        intPtr = GetDllLibXls().XlsCommentsCollection_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,iRow:int,iColumn:int)->ICommentShape:
        ...
        intPtr = GetDllLibXls().XlsCommentsCollection_get_ItemII(self.Ptr, iRow,iColumn)
        ret = None if intPtr==None else XlsComment(intPtr)
        return ret
    ...
    def get_Item(self ,name:str)->ICommentShape:
        ...
        intPtr = GetDllLibXls().XlsCommentsCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsComment(intPtr)
        return ret
    ...
    <returns>Newly created comment shape.</returns>
        ...
        intPtr = GetDllLibXls().XlsCommentsCollection_AddComment(self.Ptr, iRow,iColumn)
        ret = None if intPtr==None else XlsComment(intPtr)
        return ret
    ...
    def AddComment(self ,iRow:int,iColumn:int,bIsParseOptions:bool)->ICommentShape:
        ...
        intPtr = GetDllLibXls().XlsCommentsCollection_AddCommentIIB(self.Ptr, iRow,iColumn,bIsParseOptions)
        ret = None if intPtr==None else XlsComment(intPtr)
        return ret
