...
class HypoidGearModalAnalysisAtAStiffness(_4835.AGMAGleasonConicalGearModalAnalysisAtAStiffness):
    """HypoidGearModalAnalysisAtAStiffness
    ...
    class _Cast_HypoidGearModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'HypoidGearModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_modal_analysis_at_a_stiffness(self) -> 'HypoidGearModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidGearModalAnalysisAtAStiffness._Cast_HypoidGearModalAnalysisAtAStiffness':
