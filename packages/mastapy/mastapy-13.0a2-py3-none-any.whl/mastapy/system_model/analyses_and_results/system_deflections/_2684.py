...
class BevelDifferentialSunGearSystemDeflection(_2682.BevelDifferentialGearSystemDeflection):
    """BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4024.BevelDifferentialSunGearPowerFlow':
