...
class XlsArcShape (  XlsPrstGeomShape, IArcShape) :
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsArcShape_get_ShapeType(self.Ptr)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().XlsArcShape_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsArcShape_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsArcShape_set_Text(self.Ptr, value)
    ...
    def IsTextLocked(self)->bool:
        ...
        ret = GetDllLibXls().XlsArcShape_get_IsTextLocked(self.Ptr)
        return ret

    @IsTextLocked.setter
    def IsTextLocked(self, value:bool):
        GetDllLibXls().XlsArcShape_set_IsTextLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsArcShape_set_IsTextLocked(self.Ptr, value)
    ...
    def TextRotation(self)->'TextRotationType':
        ...
        ret = GetDllLibXls().XlsArcShape_get_TextRotation(self.Ptr)
    ...
    def TextRotation(self, value:'TextRotationType'):
        ...
        GetDllLibXls().XlsArcShape_set_TextRotation(self.Ptr, value.value)
    ...
    def RichText(self)->'IRichTextString':
        ...
        intPtr = GetDllLibXls().XlsArcShape_get_RichText(self.Ptr)
    ...
    def HAlignment(self)->'CommentHAlignType':
        ...
        ret = GetDllLibXls().XlsArcShape_get_HAlignment(self.Ptr)
    ...
    def HAlignment(self, value:'CommentHAlignType'):
        ...
        GetDllLibXls().XlsArcShape_set_HAlignment(self.Ptr, value.value)
    ...
    def VAlignment(self)->'CommentVAlignType':
        ...
        ret = GetDllLibXls().XlsArcShape_get_VAlignment(self.Ptr)
    ...
    def VAlignment(self, value:'CommentVAlignType'):
        ...
        GetDllLibXls().XlsArcShape_set_VAlignment(self.Ptr, value.value)
    ...
    def Weight(self)->float:
        ...
        ret = GetDllLibXls().XlsArcShape_get_Weight(self.Ptr)
        return ret

    @Weight.setter
    def Weight(self, value:float):
        GetDllLibXls().XlsArcShape_set_Weight.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsArcShape_set_Weight(self.Ptr, value)
    ...
    def Color(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsArcShape_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().XlsArcShape_set_Color(self.Ptr, value.Ptr)
    ...
    def Style(self)->'ShapeLineStyleType':
        ...
        ret = GetDllLibXls().XlsArcShape_get_Style(self.Ptr)
    ...
    def Style(self, value:'ShapeLineStyleType'):
        ...
        GetDllLibXls().XlsArcShape_set_Style(self.Ptr, value.value)
    ...
    def DashStyle(self)->'ShapeDashLineStyleType':
        ...
        ret = GetDllLibXls().XlsArcShape_get_DashStyle(self.Ptr)
    ...
    def DashStyle(self, value:'ShapeDashLineStyleType'):
        ...
        GetDllLibXls().XlsArcShape_set_DashStyle(self.Ptr, value.value)
    ...
    def BeginArrowheadWidth(self)->'ShapeArrowWidthType':
        ...
        ret = GetDllLibXls().XlsArcShape_get_BeginArrowheadWidth(self.Ptr)
    ...
    def BeginArrowheadWidth(self, value:'ShapeArrowWidthType'):
        ...
        GetDllLibXls().XlsArcShape_set_BeginArrowheadWidth(self.Ptr, value.value)
    ...
    def BeginArrowHeadStyle(self)->'ShapeArrowStyleType':
        ...
        ret = GetDllLibXls().XlsArcShape_get_BeginArrowHeadStyle(self.Ptr)
    ...
    def BeginArrowHeadStyle(self, value:'ShapeArrowStyleType'):
        ...
        GetDllLibXls().XlsArcShape_set_BeginArrowHeadStyle(self.Ptr, value.value)
    ...
    def BeginArrowheadLength(self)->'ShapeArrowLengthType':
        ...
        ret = GetDllLibXls().XlsArcShape_get_BeginArrowheadLength(self.Ptr)
    ...
    def BeginArrowheadLength(self, value:'ShapeArrowLengthType'):
        ...
        GetDllLibXls().XlsArcShape_set_BeginArrowheadLength(self.Ptr, value.value)
    ...
    def EndArrowHeadStyle(self)->'ShapeArrowStyleType':
        ...
        ret = GetDllLibXls().XlsArcShape_get_EndArrowHeadStyle(self.Ptr)
        objwraped = ShapeArrowStyleType(ret)
        return objwraped
    ...
    def EndArrowHeadStyle(self, value:'ShapeArrowStyleType'):
        ...
        GetDllLibXls().XlsArcShape_set_EndArrowHeadStyle(self.Ptr, value.value)
    ...
    def EndArrowheadLength(self)->'ShapeArrowLengthType':
        ...
        ret = GetDllLibXls().XlsArcShape_get_EndArrowheadLength(self.Ptr)
        objwraped = ShapeArrowLengthType(ret)
        return objwraped
    ...
    def EndArrowheadLength(self, value:'ShapeArrowLengthType'):
        ...
        GetDllLibXls().XlsArcShape_set_EndArrowheadLength(self.Ptr, value.value)
    ...
    def EndArrowheadWidth(self)->'ShapeArrowWidthType':
        ...
        ret = GetDllLibXls().XlsArcShape_get_EndArrowheadWidth(self.Ptr)
        objwraped = ShapeArrowWidthType(ret)
        return objwraped
    ...
    def EndArrowheadWidth(self, value:'ShapeArrowWidthType'):
        ...
        GetDllLibXls().XlsArcShape_set_EndArrowheadWidth(self.Ptr, value.value)
    ...
    def HyLink(self)->'IHyperLink':
        ...
        intPtr = GetDllLibXls().XlsArcShape_get_HyLink(self.Ptr)
    ...
    def PrstShapeType(self)->'PrstGeomShapeType':
        ...
        ret = GetDllLibXls().XlsArcShape_get_PrstShapeType(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsArcShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
