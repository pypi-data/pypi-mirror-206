...
class MassDiscSteadyStateSynchronousResponseAtASpeed(_3606.VirtualComponentSteadyStateSynchronousResponseAtASpeed):
    """MassDiscSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_MassDiscSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'MassDiscSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def mass_disc_steady_state_synchronous_response_at_a_speed(self) -> 'MassDiscSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MassDiscSteadyStateSynchronousResponseAtASpeed._Cast_MassDiscSteadyStateSynchronousResponseAtASpeed':
