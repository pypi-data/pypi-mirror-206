...
from mastapy.bearings import (
    _1877, _1855, _1856, _1857,
    _1854, _1880
)
from mastapy.bearings.bearing_designs.rolling import (
    _2132, _2136, _2137, _2143,
    _2153, _2131, _2160, _2140,
    _2128, _2152
)
...
class RollingBearing(_2116.DetailedBearing):
    """RollingBearing
    ...
    @property
    def cage_bridge_shape(self) -> '_2132.CageBridgeShape':
        ...
        value = conversion.pn_to_mp_enum(temp, _2132.CageBridgeShape)
        return constructor.new_from_mastapy_type(_2132.CageBridgeShape)(value) if value is not None else None

    @cage_bridge_shape.setter
    def cage_bridge_shape(self, value: '_2132.CageBridgeShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2132.CageBridgeShape.type_())
    ...
    @property
    def cage_material(self) -> '_1857.BearingCageMaterial':
        ...
        value = conversion.pn_to_mp_enum(temp, _1857.BearingCageMaterial)
        return constructor.new_from_mastapy_type(_1857.BearingCageMaterial)(value) if value is not None else None

    @cage_material.setter
    def cage_material(self, value: '_1857.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1857.BearingCageMaterial.type_())
    ...
    @property
    def catalogue(self) -> '_1854.BearingCatalog':
        ...
        value = conversion.pn_to_mp_enum(temp, _1854.BearingCatalog)
        return constructor.new_from_mastapy_type(_1854.BearingCatalog)(value) if value is not None else None
    ...
    @property
    def sleeve_type(self) -> '_2153.SleeveType':
        ...
        value = conversion.pn_to_mp_enum(temp, _2153.SleeveType)
        return constructor.new_from_mastapy_type(_2153.SleeveType)(value) if value is not None else None
    ...
    @property
    def type_information(self) -> '_2131.BearingTypeExtraInformation':
        ...
        value = conversion.pn_to_mp_enum(temp, _2131.BearingTypeExtraInformation)
        return constructor.new_from_mastapy_type(_2131.BearingTypeExtraInformation)(value) if value is not None else None
    ...
    @property
    def element_material(self) -> '_241.BearingMaterial':
    ...
    @property
    def geometric_constants(self) -> '_2140.GeometricConstants':
    ...
    @property
    def iso153122018(self) -> '_1962.ISO153122018Results':
    ...
    @property
    def inner_ring_material(self) -> '_241.BearingMaterial':
    ...
    @property
    def outer_ring_material(self) -> '_241.BearingMaterial':
    ...
    @property
    def protection(self) -> '_2128.BearingProtection':
    ...
    @property
    def skf_seal_frictional_moment_constants(self) -> '_2152.SKFSealFrictionalMomentConstants':
