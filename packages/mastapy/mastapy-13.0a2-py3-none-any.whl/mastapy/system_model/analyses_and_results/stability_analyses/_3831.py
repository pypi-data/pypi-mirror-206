...
class PulleyStabilityAnalysis(_3780.CouplingHalfStabilityAnalysis):
    """PulleyStabilityAnalysis
    ...
    class _Cast_PulleyStabilityAnalysis:
        ...
        def __init__(self, parent: 'PulleyStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def pulley_stability_analysis(self) -> 'PulleyStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PulleyStabilityAnalysis._Cast_PulleyStabilityAnalysis':
