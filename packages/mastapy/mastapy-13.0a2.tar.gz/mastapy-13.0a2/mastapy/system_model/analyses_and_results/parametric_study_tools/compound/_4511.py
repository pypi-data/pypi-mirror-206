...
class RollingRingConnectionCompoundParametricStudyTool(_4483.InterMountableComponentConnectionCompoundParametricStudyTool):
    """RollingRingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4381.RollingRingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4381.RollingRingConnectionParametricStudyTool]':
