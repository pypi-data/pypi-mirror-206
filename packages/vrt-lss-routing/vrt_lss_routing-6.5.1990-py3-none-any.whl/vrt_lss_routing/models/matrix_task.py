...
class MatrixTask(BaseModel):
    ...
    """
    waypoints: conlist(Waypoint, max_items=15001, min_items=2) = Field(..., description="Array of geographical points to calculate the distances and times between them.")
