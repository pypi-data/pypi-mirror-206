...
from mastapy.detailed_rigid_connectors.interference_fits import _1431, _1432, _1436
...
class InterferenceFitDesign(_1375.DetailedRigidConnectorDesign):
    """InterferenceFitDesign
    ...
    class _Cast_InterferenceFitDesign:
        ...
        def __init__(self, parent: 'InterferenceFitDesign'):
            self._parent = parent
        ...
        def keyed_joint_design(self):
            from mastapy.detailed_rigid_connectors.keyed_joints import _1425
            
            return self._parent._cast(_1425.KeyedJointDesign)

        @property
        def interference_fit_design(self) -> 'InterferenceFitDesign':
            return self._parent
    ...
    @property
    def assembly_method(self) -> '_1431.AssemblyMethods':
        ...
        value = conversion.pn_to_mp_enum(temp, _1431.AssemblyMethods)
        return constructor.new_from_mastapy_type(_1431.AssemblyMethods)(value) if value is not None else None

    @assembly_method.setter
    def assembly_method(self, value: '_1431.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1431.AssemblyMethods.type_())
    ...
    @property
    def calculation_method(self) -> '_1432.CalculationMethods':
        ...
        value = conversion.pn_to_mp_enum(temp, _1432.CalculationMethods)
        return constructor.new_from_mastapy_type(_1432.CalculationMethods)(value) if value is not None else None

    @calculation_method.setter
    def calculation_method(self, value: '_1432.CalculationMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1432.CalculationMethods.type_())
    ...
    @property
    def cast_to(self) -> 'InterferenceFitDesign._Cast_InterferenceFitDesign':
