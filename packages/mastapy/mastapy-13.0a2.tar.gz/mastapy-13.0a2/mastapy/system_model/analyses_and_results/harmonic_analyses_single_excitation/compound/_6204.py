...
class SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation(_6121.BevelGearCompoundHarmonicAnalysisOfSingleExcitation):
    """SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_compound_harmonic_analysis_of_single_excitation(self) -> 'SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6075.SpiralBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6075.SpiralBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation._Cast_SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation(self)
