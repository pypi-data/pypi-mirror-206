...
class XlsRangesCollection (  CollectionBase[XlsRange], IXLSRanges, ICombinedRange) :
    ...
    def Intersect(self ,range:'IXLSRange')->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_Intersect(self.Ptr, intPtrrange)
    ...
    def Merge(self ,range:IXLSRange)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_Merge(self.Ptr, intPtrrange)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRangesCollection_AutoFitRows(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRangesCollection_AutoFitColumns(self.Ptr)
    ...
    def AddComment(self)->'ICommentShape':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_AddComment(self.Ptr)
    ...
    def BorderAround(self):
        ...
        GetDllLibXls().XlsRangesCollection_BorderAround(self.Ptr)
    ...
    def BorderAround(self ,borderLine:LineStyleType):
        ...
        GetDllLibXls().XlsRangesCollection_BorderAroundB(self.Ptr, enumborderLine)
    ...
    def BorderAround(self ,borderLine:LineStyleType,borderColor:Color):
        ...
        GetDllLibXls().XlsRangesCollection_BorderAroundBB(self.Ptr, enumborderLine,intPtrborderColor)
    ...
    <param name="borderColor">Represents border color as ExcelColors.</param>
        ...
        GetDllLibXls().XlsRangesCollection_BorderAroundBB1(self.Ptr, enumborderLine,enumborderColor)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRangesCollection_BorderInside(self.Ptr)
    ...
    def BorderInside(self ,borderLine:LineStyleType):
        ...
        GetDllLibXls().XlsRangesCollection_BorderInsideB(self.Ptr, enumborderLine)
    ...
    def BorderInside(self ,borderLine:LineStyleType,borderColor:Color):
        ...
        GetDllLibXls().XlsRangesCollection_BorderInsideBB(self.Ptr, enumborderLine,intPtrborderColor)
    ...
    <param name="borderColor">Represents border color as ExcelColors.</param>
        ...
        GetDllLibXls().XlsRangesCollection_BorderInsideBB1(self.Ptr, enumborderLine,enumborderColor)
    ...
    def BorderNone(self):
        ...
        GetDllLibXls().XlsRangesCollection_BorderNone(self.Ptr)
    ...
    def CollapseGroup(self ,groupBy:'GroupByType'):
        ...
        GetDllLibXls().XlsRangesCollection_CollapseGroup(self.Ptr, enumgroupBy)
    ...
    def ExpandGroup(self ,groupBy:GroupByType):
        ...
        GetDllLibXls().XlsRangesCollection_ExpandGroup(self.Ptr, enumgroupBy)
    ...
    def ExpandGroup(self ,groupBy:GroupByType,flags:ExpandCollapseFlags):
        ...
        GetDllLibXls().XlsRangesCollection_ExpandGroupGF(self.Ptr, enumgroupBy,enumflags)
...
#        ret = GetDllLibXls().XlsRangesCollection_GetNewRangeLocation(self.Ptr, intPtrnames,intPtrsheetName)
#        return ret
#
...
#        intPtr = GetDllLibXls().XlsRangesCollection_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrbook)
#        ret = None if intPtr==None else XlsRange(intPtr)
#        return ret
#
    ...
    def CellsCount(self)->int:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_CellsCount(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRangesCollection_ClearConditionalFormats(self.Ptr)
    ...
    def GetRectangles(self)->List['Rectangle']:
        ...
        intPtrArray = GetDllLibXls().XlsRangesCollection_GetRectangles(self.Ptr)
    ...
    def GetRectanglesCount(self)->int:
        ...
        ret = GetDllLibXls().XlsRangesCollection_GetRectanglesCount(self.Ptr)
        return ret
    ...
    def WorksheetName(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_WorksheetName.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_WorksheetName(self.Ptr)
        return ret
    ...
    def Remove(self ,range:'IXLSRange'):
        ...
        GetDllLibXls().XlsRangesCollection_Remove(self.Ptr, intPtrrange)
    ...
    def get_Item(self ,index:int)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_Item(self.Ptr, index)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def set_Item(self ,index:int,value:IXLSRange):
        ...
        GetDllLibXls().XlsRangesCollection_set_Item(self.Ptr, index,intPtrvalue)
    ...
    def GetEnumerator(self)->'IEnumerator':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_GetEnumerator(self.Ptr)
    ...
    def EnvalutedValue(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_EnvalutedValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_EnvalutedValue(self.Ptr)
        return ret
    ...
    def RangeAddress(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_RangeAddress.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_RangeAddress(self.Ptr)
        return ret
    ...
    def RangeAddressLocal(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_RangeAddressLocal.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_RangeAddressLocal(self.Ptr)
        return ret
    ...
    def RangeGlobalAddress(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_RangeGlobalAddress.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_RangeGlobalAddress(self.Ptr)
        return ret
    ...
    def RangeR1C1Address(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_RangeR1C1Address.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_RangeR1C1Address(self.Ptr)
        return ret
    ...
    def RangeR1C1AddressLocal(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_RangeR1C1AddressLocal.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_RangeR1C1AddressLocal(self.Ptr)
        return ret
    ...
    def BooleanValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_BooleanValue(self.Ptr)
        return ret

    @BooleanValue.setter
    def BooleanValue(self, value:bool):
        GetDllLibXls().XlsRangesCollection_set_BooleanValue.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsRangesCollection_set_BooleanValue(self.Ptr, value)
    ...
    def Borders(self)->'IBorders':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_Borders(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsRangesCollection_get_Cells(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsRangesCollection_get_CellList(self.Ptr)
...
#
    ...
    def Column(self)->int:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_Column(self.Ptr)
        return ret
    ...
    def ColumnGroupLevel(self)->int:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_ColumnGroupLevel(self.Ptr)
        return ret
    ...
    def ColumnWidth(self)->float:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_ColumnWidth(self.Ptr)
        return ret

    @ColumnWidth.setter
    def ColumnWidth(self, value:float):
        GetDllLibXls().XlsRangesCollection_set_ColumnWidth.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsRangesCollection_set_ColumnWidth(self.Ptr, value)
    ...
    def DateTimeValue(self)->'DateTime':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_DateTimeValue(self.Ptr)
    ...
    def DateTimeValue(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsRangesCollection_set_DateTimeValue(self.Ptr, value.Ptr)
    ...
    def NumberText(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_NumberText.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_NumberText(self.Ptr)
        return ret
    ...
    def EndCell(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_EndCell(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def EntireColumn(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_EntireColumn(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def EntireRow(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_EntireRow(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def ErrorValue(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_ErrorValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_ErrorValue(self.Ptr)
        return ret
    ...
    def ErrorValue(self, value:str):
        ...
        GetDllLibXls().XlsRangesCollection_set_ErrorValue(self.Ptr, value)
    ...
    def Formula(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_Formula.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_Formula(self.Ptr)
        return ret
    ...
    def Formula(self, value:str):
        ...
        GetDllLibXls().XlsRangesCollection_set_Formula(self.Ptr, value)
    ...
    def FormulaR1C1(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_FormulaR1C1.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_FormulaR1C1(self.Ptr)
        return ret
    ...
    def FormulaR1C1(self, value:str):
        ...
        GetDllLibXls().XlsRangesCollection_set_FormulaR1C1(self.Ptr, value)
    ...
    def FormulaArray(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_FormulaArray.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_FormulaArray(self.Ptr)
        return ret
    ...
    def FormulaArray(self, value:str):
        ...
        GetDllLibXls().XlsRangesCollection_set_FormulaArray(self.Ptr, value)
    ...
    def FormulaArrayR1C1(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_FormulaArrayR1C1.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_FormulaArrayR1C1(self.Ptr)
        return ret
    ...
    def FormulaArrayR1C1(self, value:str):
        ...
        GetDllLibXls().XlsRangesCollection_set_FormulaArrayR1C1(self.Ptr, value)
    ...
    def IsFormulaHidden(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_IsFormulaHidden(self.Ptr)
        return ret
    ...
    def IsFormulaHidden(self, value:bool):
        ...
        GetDllLibXls().XlsRangesCollection_set_IsFormulaHidden(self.Ptr, value)
    ...
    def FormulaDateTime(self)->'DateTime':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_FormulaDateTime(self.Ptr)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def FormulaDateTime(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsRangesCollection_set_FormulaDateTime(self.Ptr, value.Ptr)
    ...
    def HasDataValidation(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasDataValidation(self.Ptr)
        return ret
    ...
    def HasBoolean(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasBoolean(self.Ptr)
        return ret
    ...
    def HasDateTime(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasDateTime(self.Ptr)
        return ret
    ...
    def HasFormulaBoolValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasFormulaBoolValue(self.Ptr)
        return ret
    ...
    def HasFormulaErrorValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasFormulaErrorValue(self.Ptr)
        return ret
    ...
    def HasFormulaDateTime(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasFormulaDateTime(self.Ptr)
        return ret
    ...
    def HasFormulaNumberValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasFormulaNumberValue(self.Ptr)
        return ret
    ...
    def HasFormulaStringValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasFormulaStringValue(self.Ptr)
        return ret
    ...
    def HasFormula(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasFormula(self.Ptr)
        return ret
    ...
    def HasFormulaArray(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasFormulaArray(self.Ptr)
        return ret
    ...
    def HasNumber(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasNumber(self.Ptr)
        return ret
    ...
    def HasRichText(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasRichText(self.Ptr)
        return ret
    ...
    def HasString(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasString(self.Ptr)
        return ret
    ...
    def HasStyle(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasStyle(self.Ptr)
        return ret
    ...
    def HorizontalAlignment(self)->'HorizontalAlignType':
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HorizontalAlignment(self.Ptr)
    ...
    def HorizontalAlignment(self, value:'HorizontalAlignType'):
        ...
        GetDllLibXls().XlsRangesCollection_set_HorizontalAlignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_Hyperlinks(self.Ptr)
    ...
    def IndentLevel(self)->int:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_IndentLevel(self.Ptr)
        return ret

    @IndentLevel.setter
    def IndentLevel(self, value:int):
        GetDllLibXls().XlsRangesCollection_set_IndentLevel.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsRangesCollection_set_IndentLevel(self.Ptr, value)
    ...
    def IsBlank(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_IsBlank(self.Ptr)
        return ret
    ...
    def HasError(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasError(self.Ptr)
        return ret
    ...
    def IsGroupedByColumn(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_IsGroupedByColumn(self.Ptr)
        return ret
    ...
    def IsGroupedByRow(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_IsGroupedByRow(self.Ptr)
        return ret
    ...
    def IsInitialized(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_IsInitialized(self.Ptr)
        return ret
    ...
    def LastColumn(self)->int:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_LastColumn(self.Ptr)
        return ret

    @LastColumn.setter
    def LastColumn(self, value:int):
        GetDllLibXls().XlsRangesCollection_set_LastColumn.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsRangesCollection_set_LastColumn(self.Ptr, value)
    ...
    def LastRow(self)->int:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_LastRow(self.Ptr)
        return ret

    @LastRow.setter
    def LastRow(self, value:int):
        GetDllLibXls().XlsRangesCollection_set_LastRow.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsRangesCollection_set_LastRow(self.Ptr, value)
    ...
    def NumberValue(self)->float:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_NumberValue(self.Ptr)
        return ret

    @NumberValue.setter
    def NumberValue(self, value:float):
        GetDllLibXls().XlsRangesCollection_set_NumberValue.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsRangesCollection_set_NumberValue(self.Ptr, value)
    ...
    def NumberFormat(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_NumberFormat.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_NumberFormat(self.Ptr)
        return ret
    ...
    def NumberFormat(self, value:str):
        ...
        GetDllLibXls().XlsRangesCollection_set_NumberFormat(self.Ptr, value)
    ...
    def Row(self)->int:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_Row(self.Ptr)
        return ret
    ...
    def RowGroupLevel(self)->int:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_RowGroupLevel(self.Ptr)
        return ret
    ...
    def RowHeight(self)->float:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_RowHeight(self.Ptr)
        return ret

    @RowHeight.setter
    def RowHeight(self, value:float):
        GetDllLibXls().XlsRangesCollection_set_RowHeight.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsRangesCollection_set_RowHeight(self.Ptr, value)
    ...
    def Rows(self)->ListXlsRanges:
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_Rows(self.Ptr)
    ...
    def Columns(self)->ListXlsRanges:
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_Columns(self.Ptr)
        ret = None if intPtr==None else ListXlsRanges(intPtr)
        return ret
    ...
    def Style(self)->'IStyle':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_Style(self.Ptr)
    ...
    def Style(self, value:'IStyle'):
        ...
        GetDllLibXls().XlsRangesCollection_set_Style(self.Ptr, value.Ptr)
    ...
    def CellStyleName(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_CellStyleName.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_CellStyleName(self.Ptr)
        return ret
    ...
    def CellStyleName(self, value:str):
        ...
        GetDllLibXls().XlsRangesCollection_set_CellStyleName(self.Ptr, value)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsRangesCollection_set_Text(self.Ptr, value)
    ...
    def TimeSpanValue(self)->'TimeSpan':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_TimeSpanValue(self.Ptr)
    ...
    def TimeSpanValue(self, value:'TimeSpan'):
        ...
        GetDllLibXls().XlsRangesCollection_set_TimeSpanValue(self.Ptr, value.Ptr)
    ...
    def Value(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_Value.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_Value(self.Ptr)
        return ret
    ...
    def Value(self, value:str):
        ...
        GetDllLibXls().XlsRangesCollection_set_Value(self.Ptr, value)
    ...
    def Value2(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_Value2(self.Ptr)
    ...
    def Value2(self, value:'SpireObject'):
        ...
        GetDllLibXls().XlsRangesCollection_set_Value2(self.Ptr, value.Ptr)
    ...
    def VerticalAlignment(self)->'VerticalAlignType':
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_VerticalAlignment(self.Ptr)
    ...
    def VerticalAlignment(self, value:'VerticalAlignType'):
        ...
        GetDllLibXls().XlsRangesCollection_set_VerticalAlignment(self.Ptr, value.value)
    ...
    def Worksheet(self)->'IWorksheet':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_Worksheet(self.Ptr)
    ...
    def get_Item(self ,row:int,column:int)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_ItemRC(self.Ptr, row,column)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def set_Item(self ,row:int,column:int,value:IXLSRange):
        ...
        GetDllLibXls().XlsRangesCollection_set_ItemRCV(self.Ptr, row,column,intPtrvalue)
    ...
    def get_Item(self ,row:int,column:int,lastRow:int,lastColumn:int)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_ItemRCLL(self.Ptr, row,column,lastRow,lastColumn)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def get_Item(self ,name:str)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def get_Item(self ,name:str,IsR1C1Notation:bool)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_ItemNI(self.Ptr, name,IsR1C1Notation)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def ConditionalFormats(self)->'ConditionalFormats':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_ConditionalFormats(self.Ptr)
    ...
    def DataValidation(self)->'Validation':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_DataValidation(self.Ptr)
    ...
    def FormulaStringValue(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_FormulaStringValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_FormulaStringValue(self.Ptr)
        return ret
    ...
    def FormulaStringValue(self, value:str):
        ...
        GetDllLibXls().XlsRangesCollection_set_FormulaStringValue(self.Ptr, value)
    ...
    def FormulaNumberValue(self)->float:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_FormulaNumberValue(self.Ptr)
        return ret
    ...
    def FormulaNumberValue(self, value:float):
        ...
        GetDllLibXls().XlsRangesCollection_set_FormulaNumberValue(self.Ptr, value)
    ...
    def FormulaBoolValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_FormulaBoolValue(self.Ptr)
        return ret
    ...
    def FormulaBoolValue(self, value:bool):
        ...
        GetDllLibXls().XlsRangesCollection_set_FormulaBoolValue(self.Ptr, value)
    ...
    def FormulaErrorValue(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_FormulaErrorValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_FormulaErrorValue(self.Ptr)
        return ret
    ...
    def FormulaErrorValue(self, value:str):
        ...
        GetDllLibXls().XlsRangesCollection_set_FormulaErrorValue(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRangesCollection_get_HtmlString.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_HtmlString(self.Ptr)
        return ret
    ...
    def HtmlString(self, value:str):
        ...
        GetDllLibXls().XlsRangesCollection_set_HtmlString(self.Ptr, value)
    ...
    def Comment(self)->'ICommentShape':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_Comment(self.Ptr)
        ret = None if intPtr==None else XlsComment(intPtr)
        return ret
    ...
    def RichText(self)->'IRichTextString':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_RichText(self.Ptr)
    ...
    def HasMerged(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasMerged(self.Ptr)
        return ret
    ...
    def MergeArea(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_MergeArea(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def IsWrapText(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_IsWrapText(self.Ptr)
        return ret

    @IsWrapText.setter
    def IsWrapText(self, value:bool):
        GetDllLibXls().XlsRangesCollection_set_IsWrapText.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsRangesCollection_set_IsWrapText(self.Ptr, value)
    ...
    def HasExternalFormula(self)->bool:
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_HasExternalFormula(self.Ptr)
        return ret
    ...
    def IgnoreErrorOptions(self)->'IgnoreErrorType':
        ...
        ret = GetDllLibXls().XlsRangesCollection_get_IgnoreErrorOptions(self.Ptr)
    ...
    def IgnoreErrorOptions(self, value:'IgnoreErrorType'):
        ...
        GetDllLibXls().XlsRangesCollection_set_IgnoreErrorOptions(self.Ptr, value.value)
    ...
    def IsStringsPreserved(self)->bool:
        ...
        return GetDllLibXls().XlsRangesCollection_get_IsStringsPreserved(self.Ptr)
    ...
    def IsStringsPreserved(self, value:bool):
        ...
        GetDllLibXls().XlsRangesCollection_set_IsStringsPreserved(self.Ptr, value)
    ...
    def BuiltInStyle(self)->BuiltInStyles:
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_get_BuiltInStyle(self.Ptr)
    ...
    def BuiltInStyle(self, value:BuiltInStyles):
        ...
        GetDllLibXls().XlsRangesCollection_set_BuiltInStyle(self.Ptr, value.value)
    ...
    def RangeGlobalAddress2007(self)->str:
        ...
        GetDllLibXls().XlsRangesCollection_get_RangeGlobalAddress2007.restype=c_wchar_p
        ret = GetDllLibXls().XlsRangesCollection_get_RangeGlobalAddress2007(self.Ptr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsRangesCollection_Activate(self.Ptr, scroll)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
...
#        intPtr = GetDllLibXls().XlsRangesCollection_ExportDataTable(self.Ptr, intPtroptions)
...
#
    ...
    def Merge(self):
        ...
        GetDllLibXls().XlsRangesCollection_Merge1(self.Ptr)
    ...
    def Merge(self ,clearCells:bool):
        ...
        GetDllLibXls().XlsRangesCollection_MergeC(self.Ptr, clearCells)
    ...
    def UnMerge(self):
        ...
        GetDllLibXls().XlsRangesCollection_UnMerge(self.Ptr)
    ...
    def FreezePanes(self):
        ...
        GetDllLibXls().XlsRangesCollection_FreezePanes(self.Ptr)
