...
class RingPinsCriticalSpeedAnalysis(_6587.MountableComponentCriticalSpeedAnalysis):
    """RingPinsCriticalSpeedAnalysis
    ...
    class _Cast_RingPinsCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'RingPinsCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def ring_pins_critical_speed_analysis(self) -> 'RingPinsCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RingPinsCriticalSpeedAnalysis._Cast_RingPinsCriticalSpeedAnalysis':
