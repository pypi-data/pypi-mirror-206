...
class ShaftAxialTorsionalComponentValues(_0.APIBase):
    ...
    class _Cast_ShaftAxialTorsionalComponentValues:
        ...
        def __init__(self, parent: 'ShaftAxialTorsionalComponentValues'):
            self._parent = parent

        @property
        def shaft_axial_bending_torsional_component_values(self):
            from mastapy.shafts import _16
            
            return self._parent._cast(_16.ShaftAxialBendingTorsionalComponentValues)

        @property
        def shaft_axial_bending_x_bending_y_torsional_component_values(self):
            from mastapy.shafts import _17
            
            return self._parent._cast(_17.ShaftAxialBendingXBendingYTorsionalComponentValues)

        @property
        def shaft_axial_torsional_component_values(self) -> 'ShaftAxialTorsionalComponentValues':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftAxialTorsionalComponentValues._Cast_ShaftAxialTorsionalComponentValues':
