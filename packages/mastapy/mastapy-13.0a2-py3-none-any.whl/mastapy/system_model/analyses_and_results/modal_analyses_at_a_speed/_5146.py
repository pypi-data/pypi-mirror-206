...
class FlexiblePinAssemblyModalAnalysisAtASpeed(_5187.SpecialisedAssemblyModalAnalysisAtASpeed):
    """FlexiblePinAssemblyModalAnalysisAtASpeed
    ...
    class _Cast_FlexiblePinAssemblyModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'FlexiblePinAssemblyModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def flexible_pin_assembly_modal_analysis_at_a_speed(self) -> 'FlexiblePinAssemblyModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FlexiblePinAssemblyModalAnalysisAtASpeed._Cast_FlexiblePinAssemblyModalAnalysisAtASpeed':
