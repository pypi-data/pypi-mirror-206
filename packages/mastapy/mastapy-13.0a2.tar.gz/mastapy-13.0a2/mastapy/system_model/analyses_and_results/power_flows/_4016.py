...
from mastapy.system_model.analyses_and_results.power_flows import (
    _4017, _4019, _4022, _4028,
    _4029, _4050, _4032, _4037,
    _4040, _4052, _4055, _4059,
    _4066, _4065, _4067, _4074,
    _4081, _4084, _4070, _4085,
    _4086, _4088, _4092, _4095,
    _4096, _4099, _4101, _4103,
    _4107, _4108, _4113, _4116,
    _4119, _4122, _4127, _4131,
    _4134, _4138, _4141, _4009
)
...
class AssemblyPowerFlow(_4009.AbstractAssemblyPowerFlow):
    """AssemblyPowerFlow
    ...
    class _Cast_AssemblyPowerFlow:
        ...
        def __init__(self, parent: 'AssemblyPowerFlow'):
            self._parent = parent
        ...
        @property
        def assembly_power_flow(self) -> 'AssemblyPowerFlow':
            return self._parent
    ...
    @property
    def bearings(self) -> 'List[_4017.BearingPowerFlow]':
    ...
    @property
    def belt_drives(self) -> 'List[_4019.BeltDrivePowerFlow]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4022.BevelDifferentialGearSetPowerFlow]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4028.BoltedJointPowerFlow]':
    ...
    @property
    def bolts(self) -> 'List[_4029.BoltPowerFlow]':
    ...
    @property
    def cv_ts(self) -> 'List[_4050.CVTPowerFlow]':
    ...
    @property
    def clutches(self) -> 'List[_4032.ClutchPowerFlow]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4037.ConceptCouplingPowerFlow]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4040.ConceptGearSetPowerFlow]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4052.CycloidalAssemblyPowerFlow]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4055.CycloidalDiscPowerFlow]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4059.CylindricalGearSetPowerFlow]':
    ...
    @property
    def fe_parts(self) -> 'List[_4066.FEPartPowerFlow]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4065.FaceGearSetPowerFlow]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4067.FlexiblePinAssemblyPowerFlow]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4074.HypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4081.KlingelnbergCycloPalloidHypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4084.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
    ...
    @property
    def loaded_gear_sets(self) -> 'List[_4070.GearSetPowerFlow]':
    ...
    @property
    def mass_discs(self) -> 'List[_4085.MassDiscPowerFlow]':
    ...
    @property
    def measurement_components(self) -> 'List[_4086.MeasurementComponentPowerFlow]':
    ...
    @property
    def oil_seals(self) -> 'List[_4088.OilSealPowerFlow]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4092.PartToPartShearCouplingPowerFlow]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4095.PlanetCarrierPowerFlow]':
    ...
    @property
    def point_loads(self) -> 'List[_4096.PointLoadPowerFlow]':
    ...
    @property
    def power_loads(self) -> 'List[_4099.PowerLoadPowerFlow]':
    ...
    @property
    def ring_pins(self) -> 'List[_4101.RingPinsPowerFlow]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4103.RollingRingAssemblyPowerFlow]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4107.ShaftHubConnectionPowerFlow]':
    ...
    @property
    def shafts(self) -> 'List[_4108.ShaftPowerFlow]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4113.SpiralBevelGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4119.StraightBevelDiffGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4122.StraightBevelGearSetPowerFlow]':
    ...
    @property
    def synchronisers(self) -> 'List[_4127.SynchroniserPowerFlow]':
    ...
    @property
    def torque_converters(self) -> 'List[_4131.TorqueConverterPowerFlow]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4134.UnbalancedMassPowerFlow]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4138.WormGearSetPowerFlow]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4141.ZerolBevelGearSetPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'AssemblyPowerFlow._Cast_AssemblyPowerFlow':
