...
class XlsVPageBreaksCollection (  CollectionBase[VPageBreak], IVPageBreaks) :
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsVPageBreaksCollection_Clone(self.Ptr, intPtrparent)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsVPageBreaksCollection_get_ManualBreakCount(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsVPageBreaksCollection_get_RecordCode(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsVPageBreaksCollection_get_NeedDataArray(self.Ptr)
        return ret
    ...
    def StreamPos(self)->int:
        ...
        ret = GetDllLibXls().XlsVPageBreaksCollection_get_StreamPos(self.Ptr)
        return ret

    @StreamPos.setter
    def StreamPos(self, value:int):
        GetDllLibXls().XlsVPageBreaksCollection_set_StreamPos.argtypes=[c_void_p, c_long]
        GetDllLibXls().XlsVPageBreaksCollection_set_StreamPos(self.Ptr, value)
