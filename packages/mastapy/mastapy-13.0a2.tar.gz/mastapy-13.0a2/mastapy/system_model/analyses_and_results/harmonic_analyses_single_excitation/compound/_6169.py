...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6167, _6168, _6111
...
class HypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6111.AGMAGleasonConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """HypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_HypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'HypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_set_compound_harmonic_analysis_of_single_excitation(self) -> 'HypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6040.HypoidGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def hypoid_gears_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6167.HypoidGearCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def hypoid_meshes_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6168.HypoidGearMeshCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6040.HypoidGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation._Cast_HypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation':
