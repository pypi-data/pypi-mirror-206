...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3903, _3904, _3934
...
class ConceptGearSetCompoundStabilityAnalysis(_3934.GearSetCompoundStabilityAnalysis):
    """ConceptGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3772.ConceptGearSetStabilityAnalysis]':
    ...
    @property
    def concept_gears_compound_stability_analysis(self) -> 'List[_3903.ConceptGearCompoundStabilityAnalysis]':
    ...
    @property
    def concept_meshes_compound_stability_analysis(self) -> 'List[_3904.ConceptGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3772.ConceptGearSetStabilityAnalysis]':
