...
class ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation(_7180.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def connector_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7009.ConnectorAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7009.ConnectorAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation(self)
