...
class PartToPartShearCouplingConnectionCompoundParametricStudyTool(_4456.CouplingConnectionCompoundParametricStudyTool):
    """PartToPartShearCouplingConnectionCompoundParametricStudyTool
    ...
    class _Cast_PartToPartShearCouplingConnectionCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingConnectionCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_connection_compound_parametric_study_tool(self) -> 'PartToPartShearCouplingConnectionCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4369.PartToPartShearCouplingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4369.PartToPartShearCouplingConnectionParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingConnectionCompoundParametricStudyTool._Cast_PartToPartShearCouplingConnectionCompoundParametricStudyTool':
        return self._Cast_PartToPartShearCouplingConnectionCompoundParametricStudyTool(self)
