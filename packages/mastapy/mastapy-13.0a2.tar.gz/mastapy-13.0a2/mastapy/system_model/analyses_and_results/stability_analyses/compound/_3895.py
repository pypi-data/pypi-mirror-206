...
class ClutchCompoundStabilityAnalysis(_3911.CouplingCompoundStabilityAnalysis):
    """ClutchCompoundStabilityAnalysis
    ...
    class _Cast_ClutchCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'ClutchCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_compound_stability_analysis(self) -> 'ClutchCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3765.ClutchStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3765.ClutchStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ClutchCompoundStabilityAnalysis._Cast_ClutchCompoundStabilityAnalysis':
