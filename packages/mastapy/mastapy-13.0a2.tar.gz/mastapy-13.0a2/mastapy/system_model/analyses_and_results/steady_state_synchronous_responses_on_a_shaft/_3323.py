...
class SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft(_3240.BevelGearMeshSteadyStateSynchronousResponseOnAShaft):
    """SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_steady_state_synchronous_response_on_a_shaft(self) -> 'SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft._Cast_SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft(self)
