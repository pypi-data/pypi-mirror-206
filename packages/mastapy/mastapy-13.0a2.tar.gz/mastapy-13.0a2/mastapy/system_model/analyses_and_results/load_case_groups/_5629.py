...
from mastapy.system_model.analyses_and_results.static_loads import _6912, _6768
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    class _Cast_AbstractLoadCaseGroup:
        ...
        def time_series_load_case_group(self):
            ...
            return self._parent._cast(_5641.TimeSeriesLoadCaseGroup)
    ...
    @property
    def load_case_root_assemblies(self) -> 'List[_6912.RootAssemblyLoadCase]':
    ...
    def create_load_cases(self, number_of_load_cases: 'int', token: '_7521.TaskProgress') -> 'List[_6768.LoadCase]':
    ...
    def perform_pst_with_progress(self, progress: '_7521.TaskProgress'):
