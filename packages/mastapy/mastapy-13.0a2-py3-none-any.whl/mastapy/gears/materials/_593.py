...
class ISOTR1417912001CoefficientOfFrictionConstants(_1816.NamedDatabaseItem):
    """ISOTR1417912001CoefficientOfFrictionConstants
    ...
    class _Cast_ISOTR1417912001CoefficientOfFrictionConstants:
        ...
        def __init__(self, parent: 'ISOTR1417912001CoefficientOfFrictionConstants'):
            self._parent = parent
        ...
        @property
        def isotr1417912001_coefficient_of_friction_constants(self) -> 'ISOTR1417912001CoefficientOfFrictionConstants':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ISOTR1417912001CoefficientOfFrictionConstants._Cast_ISOTR1417912001CoefficientOfFrictionConstants':
