...
class _LinkedinPerson:
    ...
    async def person_search(
        ...
        if birth_date_before:
            params['birth_date_before'] = birth_date_before
        if birth_date_after:
            params['birth_date_after'] = birth_date_after
        if connections_max:
            params['connections_max'] = connections_max
        if connections_min:
            params['connections_min'] = connections_min
        if state:
            params['state'] = state
        if city:
            params['city'] = city
        if country_full_name:
            params['country_full_name'] = country_full_name
        if country:
...
class _LinkedinCompany:
    ...
    async def reveal(
        ...
        if role_contact_number:
            params['role_contact_number'] = role_contact_number
