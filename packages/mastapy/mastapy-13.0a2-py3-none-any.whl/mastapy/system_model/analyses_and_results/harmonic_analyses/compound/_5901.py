...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5899, _5900, _5906
...
class FaceGearSetCompoundHarmonicAnalysis(_5906.GearSetCompoundHarmonicAnalysis):
    """FaceGearSetCompoundHarmonicAnalysis
    ...
    class _Cast_FaceGearSetCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'FaceGearSetCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def face_gear_set_compound_harmonic_analysis(self) -> 'FaceGearSetCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5718.FaceGearSetHarmonicAnalysis]':
    ...
    @property
    def face_gears_compound_harmonic_analysis(self) -> 'List[_5899.FaceGearCompoundHarmonicAnalysis]':
    ...
    @property
    def face_meshes_compound_harmonic_analysis(self) -> 'List[_5900.FaceGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5718.FaceGearSetHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'FaceGearSetCompoundHarmonicAnalysis._Cast_FaceGearSetCompoundHarmonicAnalysis':
