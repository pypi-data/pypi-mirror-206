...
class FEPartCompoundDynamicAnalysis(_6375.AbstractShaftOrHousingCompoundDynamicAnalysis):
    """FEPartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6300.FEPartDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6300.FEPartDynamicAnalysis]':
