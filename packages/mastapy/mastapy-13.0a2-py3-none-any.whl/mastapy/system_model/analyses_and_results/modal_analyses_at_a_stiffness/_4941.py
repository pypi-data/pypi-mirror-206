...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4940, _4939, _4848
...
class StraightBevelGearSetModalAnalysisAtAStiffness(_4848.BevelGearSetModalAnalysisAtAStiffness):
    """StraightBevelGearSetModalAnalysisAtAStiffness
    ...
    class _Cast_StraightBevelGearSetModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'StraightBevelGearSetModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_set_modal_analysis_at_a_stiffness(self) -> 'StraightBevelGearSetModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4940.StraightBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4939.StraightBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSetModalAnalysisAtAStiffness._Cast_StraightBevelGearSetModalAnalysisAtAStiffness':
