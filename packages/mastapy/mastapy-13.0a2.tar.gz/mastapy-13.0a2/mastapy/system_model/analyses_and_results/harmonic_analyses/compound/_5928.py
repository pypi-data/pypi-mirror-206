...
class PartToPartShearCouplingHalfCompoundHarmonicAnalysis(_5885.CouplingHalfCompoundHarmonicAnalysis):
    """PartToPartShearCouplingHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5757.PartToPartShearCouplingHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5757.PartToPartShearCouplingHalfHarmonicAnalysis]':
