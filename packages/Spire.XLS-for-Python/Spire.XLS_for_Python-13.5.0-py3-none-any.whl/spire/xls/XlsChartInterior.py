...
class XlsChartInterior (  XlsObject, IChartInterior, ICloneParent) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartInterior_get_ForegroundColorObject(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartInterior_get_BackgroundColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartInterior_get_ForegroundColor(self.Ptr)
    ...
    def ForegroundColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartInterior_set_ForegroundColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartInterior_get_BackgroundColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def BackgroundColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartInterior_set_BackgroundColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartInterior_get_Pattern(self.Ptr)
    ...
    def Pattern(self, value:'ExcelPatternType'):
        ...
        GetDllLibXls().XlsChartInterior_set_Pattern(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartInterior_get_ForegroundKnownColor(self.Ptr)
    ...
    def ForegroundKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartInterior_set_ForegroundKnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartInterior_get_BackgroundKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def BackgroundKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartInterior_set_BackgroundKnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartInterior_get_UseDefaultFormat(self.Ptr)
        return ret
    ...
    def UseDefaultFormat(self, value:bool):
        ...
        GetDllLibXls().XlsChartInterior_set_UseDefaultFormat(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartInterior_get_SwapColorsOnNegative(self.Ptr)
        return ret
    ...
    def SwapColorsOnNegative(self, value:bool):
        ...
        GetDllLibXls().XlsChartInterior_set_SwapColorsOnNegative(self.Ptr, value)
    ...
    def Clone(self ,parent:SpireObject,isFrameClone:bool)->'XlsChartInterior':
        ...
        intPtr = GetDllLibXls().XlsChartInterior_Clone(self.Ptr, intPtrparent,isFrameClone)
    ...
    def Clone(self ,parent:SpireObject)->'XlsChartInterior':
        ...
        intPtr = GetDllLibXls().XlsChartInterior_CloneP(self.Ptr, intPtrparent)
        ret = None if intPtr==None else XlsChartInterior(intPtr)
        return ret
    ...
    def InitForFrameFormat(self ,bIsAutoSize:bool,bIs3DChart:bool,bIsInteriorGray:bool):
        ...
        GetDllLibXls().XlsChartInterior_InitForFrameFormat(self.Ptr, bIsAutoSize,bIs3DChart,bIsInteriorGray)
    ...
    def InitForFrameFormat(self ,bIsAutoSize:bool,bIs3DChart:bool,bIsInteriorGray:bool,bIsGray50:bool):
        ...
        GetDllLibXls().XlsChartInterior_InitForFrameFormatBBBB(self.Ptr, bIsAutoSize,bIs3DChart,bIsInteriorGray,bIsGray50)
