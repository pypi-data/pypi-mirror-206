...
class FEPartDynamicAnalysis(_6245.AbstractShaftOrHousingDynamicAnalysis):
    """FEPartDynamicAnalysis
    ...
    class _Cast_FEPartDynamicAnalysis:
        ...
        def __init__(self, parent: 'FEPartDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def fe_part_dynamic_analysis(self) -> 'FEPartDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FEPartDynamicAnalysis._Cast_FEPartDynamicAnalysis':
