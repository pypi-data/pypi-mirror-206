...
class InputSliderForPareto(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    class _Cast_InputSliderForPareto:
        ...
        def __init__(self, parent: 'InputSliderForPareto'):
            self._parent = parent

        @property
        def input_slider_for_pareto(self) -> 'InputSliderForPareto':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'InputSliderForPareto._Cast_InputSliderForPareto':
