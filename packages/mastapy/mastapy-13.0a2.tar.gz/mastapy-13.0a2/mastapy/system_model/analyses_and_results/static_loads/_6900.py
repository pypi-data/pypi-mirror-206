...
class PlanetManufactureError(_0.APIBase):
    ...
    class _Cast_PlanetManufactureError:
        ...
        def __init__(self, parent: 'PlanetManufactureError'):
            self._parent = parent

        @property
        def planet_manufacture_error(self) -> 'PlanetManufactureError':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetManufactureError._Cast_PlanetManufactureError':
