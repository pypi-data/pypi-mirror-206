...
class WormGearAdvancedTimeSteppingAnalysisForModulation(_7031.GearAdvancedTimeSteppingAnalysisForModulation):
    """WormGearAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_WormGearAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'WormGearAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def worm_gear_advanced_time_stepping_analysis_for_modulation(self) -> 'WormGearAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearAdvancedTimeSteppingAnalysisForModulation._Cast_WormGearAdvancedTimeSteppingAnalysisForModulation':
