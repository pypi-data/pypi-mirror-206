...
class CycloidalAssemblyHarmonicAnalysisOfSingleExcitation(_6074.SpecialisedAssemblyHarmonicAnalysisOfSingleExcitation):
    """CycloidalAssemblyHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_CycloidalAssemblyHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'CycloidalAssemblyHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def cycloidal_assembly_harmonic_analysis_of_single_excitation(self) -> 'CycloidalAssemblyHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalAssemblyHarmonicAnalysisOfSingleExcitation._Cast_CycloidalAssemblyHarmonicAnalysisOfSingleExcitation':
