...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4860, _4859, _4891
...
class ConceptGearSetModalAnalysisAtAStiffness(_4891.GearSetModalAnalysisAtAStiffness):
    """ConceptGearSetModalAnalysisAtAStiffness
    ...
    class _Cast_ConceptGearSetModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ConceptGearSetModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def concept_gear_set_modal_analysis_at_a_stiffness(self) -> 'ConceptGearSetModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def concept_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4860.ConceptGearModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4859.ConceptGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'ConceptGearSetModalAnalysisAtAStiffness._Cast_ConceptGearSetModalAnalysisAtAStiffness':
