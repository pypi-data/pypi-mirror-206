...
from mastapy.gears.ltca import _844, _838
...
class GearMeshLoadDistributionAtRotation(_0.APIBase):
    ...
    class _Cast_GearMeshLoadDistributionAtRotation:
        ...
        def __init__(self, parent: 'GearMeshLoadDistributionAtRotation'):
            self._parent = parent

        @property
        def cylindrical_mesh_load_distribution_at_rotation(self):
            from mastapy.gears.ltca.cylindrical import _856
            
            return self._parent._cast(_856.CylindricalMeshLoadDistributionAtRotation)

        @property
        def conical_mesh_load_distribution_at_rotation(self):
            from mastapy.gears.ltca.conical import _866
            
            return self._parent._cast(_866.ConicalMeshLoadDistributionAtRotation)

        @property
        def gear_mesh_load_distribution_at_rotation(self) -> 'GearMeshLoadDistributionAtRotation':
            return self._parent
    ...
    @property
    def gear_a_in_mesh(self) -> '_844.MeshedGearLoadDistributionAnalysisAtRotation':
    ...
    @property
    def gear_b_in_mesh(self) -> '_844.MeshedGearLoadDistributionAnalysisAtRotation':
    ...
    @property
    def loaded_contact_lines(self) -> 'List[_838.GearMeshLoadedContactLine]':
    ...
    @property
    def meshed_gears(self) -> 'List[_844.MeshedGearLoadDistributionAnalysisAtRotation]':
    ...
    @property
    def cast_to(self) -> 'GearMeshLoadDistributionAtRotation._Cast_GearMeshLoadDistributionAtRotation':
