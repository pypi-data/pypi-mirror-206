...
class StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis(_5604.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_planet_gear_compound_multibody_dynamics_analysis(self) -> 'StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5472.StraightBevelPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5472.StraightBevelPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis._Cast_StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis':
