...
# return path as a sorted list of all images in all folder/subfolders
# def _get_all_img(folder):
#     imgPath = []
#     for subdir, dirs, files in os.walk(folder):
#         for file in files:
#             imgPath.append(os.path.join(subdir, file))
#     return sorted(imgPath)
