...
class PlanetCarrierDynamicAnalysis(_6321.MountableComponentDynamicAnalysis):
    """PlanetCarrierDynamicAnalysis
    ...
    class _Cast_PlanetCarrierDynamicAnalysis:
        ...
        def __init__(self, parent: 'PlanetCarrierDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def planet_carrier_dynamic_analysis(self) -> 'PlanetCarrierDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierDynamicAnalysis._Cast_PlanetCarrierDynamicAnalysis':
