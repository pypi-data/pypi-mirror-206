...
def get_rho_gradient(mesh: numpy.ndarray, coordinate_axis) -> numpy.ndarray:
    """
    Gets the gradient in the rho direction (polar coordinate).
    ...
    :rtype:     numpy.ndarray
    """
    Ygrad, Xgrad = gradientO4(mesh, coordinate_axis.dx, coordinate_axis.dy)
    gradient = (Xgrad * coordinate_axis.x_mesh + Ygrad * coordinate_axis.y_mesh)
    return gradient
