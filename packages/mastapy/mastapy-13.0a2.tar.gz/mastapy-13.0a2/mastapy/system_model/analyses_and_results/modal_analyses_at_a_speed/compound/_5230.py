...
class BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed(_5235.BevelGearMeshCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed
    ...
    class _Cast_BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_compound_modal_analysis_at_a_speed(self) -> 'BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5100.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5100.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed._Cast_BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed':
