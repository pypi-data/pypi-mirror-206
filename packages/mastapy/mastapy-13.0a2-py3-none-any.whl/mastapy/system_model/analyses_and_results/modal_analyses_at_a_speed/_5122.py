...
class ConicalGearModalAnalysisAtASpeed(_5148.GearModalAnalysisAtASpeed):
    """ConicalGearModalAnalysisAtASpeed
    ...
    class _Cast_ConicalGearModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ConicalGearModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def conical_gear_modal_analysis_at_a_speed(self) -> 'ConicalGearModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConicalGearModalAnalysisAtASpeed._Cast_ConicalGearModalAnalysisAtASpeed':
