...
Example: /user/my_fc"""
    ...
    relative_size = fields.Nested("netapp_ontap.models.flexcache_relative_size.FlexcacheRelativeSizeSchema", data_key="relative_size", unknown=EXCLUDE)
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412"""
    ...
    """links,aggregates.links,aggregates.name,aggregates.uuid,constituents_per_aggregate,dr_cache,global_file_locking_enabled,guarantee,name,origins,path,relative_size,size,svm.links,svm.name,svm.uuid,use_tiered_aggregate,uuid,writeback,"""
    ...
    """prepopulate,relative_size,writeback,"""
    ...
    """aggregates.links,aggregates.name,aggregates.uuid,constituents_per_aggregate,dr_cache,global_file_locking_enabled,guarantee,name,origins,path,prepopulate,relative_size,size,svm.name,svm.uuid,use_tiered_aggregate,writeback,"""
