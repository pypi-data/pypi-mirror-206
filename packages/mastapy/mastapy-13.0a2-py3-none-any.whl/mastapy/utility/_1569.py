...
from mastapy.utility import _1582, _1568
...
class EnvironmentSummary(_0.APIBase):
    ...
    class _Cast_EnvironmentSummary:
        ...
        def __init__(self, parent: 'EnvironmentSummary'):
            self._parent = parent

        @property
        def environment_summary(self) -> 'EnvironmentSummary':
            return self._parent
    ...
    @property
    def current_culture(self) -> '_1582.NumberFormatInfoSummary':
    ...
    @property
    def dispatchers(self) -> 'List[_1568.DispatcherHelper]':
    ...
    @property
    def cast_to(self) -> 'EnvironmentSummary._Cast_EnvironmentSummary':
