...
class StraightBevelPlanetGearCompoundParametricStudyTool(_4523.StraightBevelDiffGearCompoundParametricStudyTool):
    """StraightBevelPlanetGearCompoundParametricStudyTool
    ...
    class _Cast_StraightBevelPlanetGearCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'StraightBevelPlanetGearCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def straight_bevel_planet_gear_compound_parametric_study_tool(self) -> 'StraightBevelPlanetGearCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4400.StraightBevelPlanetGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4400.StraightBevelPlanetGearParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelPlanetGearCompoundParametricStudyTool._Cast_StraightBevelPlanetGearCompoundParametricStudyTool':
