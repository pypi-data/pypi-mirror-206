...
class AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation(_7005.ConicalGearAdvancedTimeSteppingAnalysisForModulation):
    """AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_advanced_time_stepping_analysis_for_modulation(self) -> 'AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation._Cast_AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation(self)
