...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4480, _4481, _4424
...
class HypoidGearSetCompoundParametricStudyTool(_4424.AGMAGleasonConicalGearSetCompoundParametricStudyTool):
    """HypoidGearSetCompoundParametricStudyTool
    ...
    class _Cast_HypoidGearSetCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'HypoidGearSetCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_set_compound_parametric_study_tool(self) -> 'HypoidGearSetCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4342.HypoidGearSetParametricStudyTool]':
    ...
    @property
    def hypoid_gears_compound_parametric_study_tool(self) -> 'List[_4480.HypoidGearCompoundParametricStudyTool]':
    ...
    @property
    def hypoid_meshes_compound_parametric_study_tool(self) -> 'List[_4481.HypoidGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4342.HypoidGearSetParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearSetCompoundParametricStudyTool._Cast_HypoidGearSetCompoundParametricStudyTool':
