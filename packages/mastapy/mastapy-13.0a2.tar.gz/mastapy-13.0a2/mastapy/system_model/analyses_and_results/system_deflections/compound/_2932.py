...
class SpiralBevelGearMeshCompoundSystemDeflection(_2847.BevelGearMeshCompoundSystemDeflection):
    """SpiralBevelGearMeshCompoundSystemDeflection
    ...
    class _Cast_SpiralBevelGearMeshCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_compound_system_deflection(self) -> 'SpiralBevelGearMeshCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2786.SpiralBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2786.SpiralBevelGearMeshSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshCompoundSystemDeflection._Cast_SpiralBevelGearMeshCompoundSystemDeflection':
