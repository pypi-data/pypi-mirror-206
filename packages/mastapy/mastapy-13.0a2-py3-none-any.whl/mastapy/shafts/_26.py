...
class ShaftMaterialForReports(_0.APIBase):
    ...
    class _Cast_ShaftMaterialForReports:
        ...
        def __init__(self, parent: 'ShaftMaterialForReports'):
            self._parent = parent

        @property
        def shaft_material_for_reports(self) -> 'ShaftMaterialForReports':
            return self._parent
    ...
    def casting_factor_condition(self) -> '_7.CastingFactorCondition':
        ...
        value = conversion.pn_to_mp_enum(temp, _7.CastingFactorCondition)
    ...
    def casting_factor_condition(self, value: '_7.CastingFactorCondition'):
        ...
        value = conversion.mp_to_pn_enum(value, _7.CastingFactorCondition.type_())
    ...
    def consequence_of_failure(self) -> '_8.ConsequenceOfFailure':
        ...
        value = conversion.pn_to_mp_enum(temp, _8.ConsequenceOfFailure)
    ...
    def consequence_of_failure(self, value: '_8.ConsequenceOfFailure'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _8.ConsequenceOfFailure.type_())
    ...
    def curve_model(self) -> '_12.FkmSnCurveModel':
        ...
        value = conversion.pn_to_mp_enum(temp, _12.FkmSnCurveModel)
    ...
    def curve_model(self, value: '_12.FkmSnCurveModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _12.FkmSnCurveModel.type_())
    ...
    def hardening_type_for_agma60016101e08(self) -> '_6.AGMAHardeningType':
        ...
        value = conversion.pn_to_mp_enum(temp, _6.AGMAHardeningType)
    ...
    def hardening_type_for_agma60016101e08(self, value: '_6.AGMAHardeningType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _6.AGMAHardeningType.type_())
    ...
    def material_group(self) -> '_11.FkmMaterialGroup':
        ...
        value = conversion.pn_to_mp_enum(temp, _11.FkmMaterialGroup)
    ...
    def material_group(self, value: '_11.FkmMaterialGroup'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _11.FkmMaterialGroup.type_())
    ...
    @property
    def cast_to(self) -> 'ShaftMaterialForReports._Cast_ShaftMaterialForReports':
        return self._Cast_ShaftMaterialForReports(self)
