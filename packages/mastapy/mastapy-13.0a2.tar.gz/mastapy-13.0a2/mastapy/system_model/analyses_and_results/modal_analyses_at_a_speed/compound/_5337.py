...
class TorqueConverterPumpCompoundModalAnalysisAtASpeed(_5257.CouplingHalfCompoundModalAnalysisAtASpeed):
    """TorqueConverterPumpCompoundModalAnalysisAtASpeed
    ...
    class _Cast_TorqueConverterPumpCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'TorqueConverterPumpCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def torque_converter_pump_compound_modal_analysis_at_a_speed(self) -> 'TorqueConverterPumpCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5208.TorqueConverterPumpModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5208.TorqueConverterPumpModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterPumpCompoundModalAnalysisAtASpeed._Cast_TorqueConverterPumpCompoundModalAnalysisAtASpeed':
