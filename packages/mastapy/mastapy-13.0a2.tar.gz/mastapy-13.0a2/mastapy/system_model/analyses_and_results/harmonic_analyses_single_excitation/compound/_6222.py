...
class TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation(_6142.CouplingCompoundHarmonicAnalysisOfSingleExcitation):
    """TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def torque_converter_compound_harmonic_analysis_of_single_excitation(self) -> 'TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6094.TorqueConverterHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6094.TorqueConverterHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation._Cast_TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation(self)
