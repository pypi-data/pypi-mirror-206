...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6370, _6371, _6261
...
class ZerolBevelGearSetDynamicAnalysis(_6261.BevelGearSetDynamicAnalysis):
    """ZerolBevelGearSetDynamicAnalysis
    ...
    class _Cast_ZerolBevelGearSetDynamicAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_dynamic_analysis(self) -> 'ZerolBevelGearSetDynamicAnalysis':
            return self._parent
    ...
    @property
    def zerol_bevel_gears_dynamic_analysis(self) -> 'List[_6370.ZerolBevelGearDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_dynamic_analysis(self) -> 'List[_6371.ZerolBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetDynamicAnalysis._Cast_ZerolBevelGearSetDynamicAnalysis':
