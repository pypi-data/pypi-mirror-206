...
class SynchroniserSleeveSteadyStateSynchronousResponse(_3080.SynchroniserPartSteadyStateSynchronousResponse):
    """SynchroniserSleeveSteadyStateSynchronousResponse
    ...
    class _Cast_SynchroniserSleeveSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'SynchroniserSleeveSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def synchroniser_sleeve_steady_state_synchronous_response(self) -> 'SynchroniserSleeveSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserSleeveSteadyStateSynchronousResponse._Cast_SynchroniserSleeveSteadyStateSynchronousResponse':
