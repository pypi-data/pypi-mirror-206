...
class Bucket(Construct):
    ...
    Args:
        ...
        bucket_has_cdn (str): Whether the S3 bucket will be serverd by a Cloudflare CDN
    ...
    def __init__(
        ...
        **kwargs
        ...
        cdk.CfnOutput(self, f"BucketAppName{app_name}{bucket_name}", value=str(app_name))
        cdk.CfnOutput(self, f"BucketPublicReadAccess{app_name}{bucket_name}", value=str(public_read_access))
        cdk.CfnOutput(self, f"BucketIncludesCdn{app_name}{bucket_name}", value=str(include_cdn))
        cdk.CfnOutput(self, f"BucketHasAuthentication{app_name}{bucket_name}", value=str(has_authentication))
        cdk.CfnOutput(self, f"BucketIsEncrypted{app_name}{bucket_name}", value=str(is_encrypted))
        cdk.CfnOutput(self, f"BucketBucketName{app_name}{bucket_name}", value=str(bucket_name))
