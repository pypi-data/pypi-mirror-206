...
class SingleCylindricalGearTriangularEndModification(_0.APIBase):
    ...
    class _Cast_SingleCylindricalGearTriangularEndModification:
        ...
        def __init__(self, parent: 'SingleCylindricalGearTriangularEndModification'):
            self._parent = parent

        @property
        def linear_cylindrical_gear_triangular_end_modification(self):
            from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1111
            
            return self._parent._cast(_1111.LinearCylindricalGearTriangularEndModification)

        @property
        def parabolic_cylindrical_gear_triangular_end_modification(self):
            from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1118
            
            return self._parent._cast(_1118.ParabolicCylindricalGearTriangularEndModification)

        @property
        def single_cylindrical_gear_triangular_end_modification(self) -> 'SingleCylindricalGearTriangularEndModification':
            return self._parent
    ...
    @property
    def profile_evaluation(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def profile_start(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def cast_to(self) -> 'SingleCylindricalGearTriangularEndModification._Cast_SingleCylindricalGearTriangularEndModification':
