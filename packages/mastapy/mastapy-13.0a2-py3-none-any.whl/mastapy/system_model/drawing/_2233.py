...
class ModelViewOptionsDrawStyle(_303.DrawStyle):
    """ModelViewOptionsDrawStyle
    ...
    class _Cast_ModelViewOptionsDrawStyle:
        ...
        def __init__(self, parent: 'ModelViewOptionsDrawStyle'):
            self._parent = parent
        ...
        @property
        def model_view_options_draw_style(self) -> 'ModelViewOptionsDrawStyle':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ModelViewOptionsDrawStyle._Cast_ModelViewOptionsDrawStyle':
