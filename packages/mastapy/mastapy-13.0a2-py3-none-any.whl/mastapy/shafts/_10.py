...
class DesignShaftSectionEnd(_0.APIBase):
    ...
    class _Cast_DesignShaftSectionEnd:
        ...
        def __init__(self, parent: 'DesignShaftSectionEnd'):
            self._parent = parent

        @property
        def design_shaft_section_end(self) -> 'DesignShaftSectionEnd':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DesignShaftSectionEnd._Cast_DesignShaftSectionEnd':
        return self._Cast_DesignShaftSectionEnd(self)
