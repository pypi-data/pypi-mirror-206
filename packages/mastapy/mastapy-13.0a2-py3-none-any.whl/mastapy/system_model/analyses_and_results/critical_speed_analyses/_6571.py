...
class GuideDxfModelCriticalSpeedAnalysis(_6533.ComponentCriticalSpeedAnalysis):
    """GuideDxfModelCriticalSpeedAnalysis
    ...
    class _Cast_GuideDxfModelCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'GuideDxfModelCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def guide_dxf_model_critical_speed_analysis(self) -> 'GuideDxfModelCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GuideDxfModelCriticalSpeedAnalysis._Cast_GuideDxfModelCriticalSpeedAnalysis':
