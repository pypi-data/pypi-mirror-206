...
# -*- coding: utf-8 -*-
#
# genki_widgets documentation build configuration file
#
...
project = 'genki_widgets'
copyright = '2023, BjarniHaukur'
author = 'BjarniHaukur'
...
_version_py = os.path.join(repo, 'genki_widgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'genki_widgetsdoc'
...
latex_documents = [
    (master_doc, 'genki_widgets.tex', 'genki_widgets Documentation',
     'BjarniHaukur', 'manual'),
]
