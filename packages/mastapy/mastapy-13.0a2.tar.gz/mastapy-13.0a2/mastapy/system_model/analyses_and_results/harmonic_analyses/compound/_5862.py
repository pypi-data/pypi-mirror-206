...
class BevelGearCompoundHarmonicAnalysis(_5850.AGMAGleasonConicalGearCompoundHarmonicAnalysis):
    """BevelGearCompoundHarmonicAnalysis
    ...
    class _Cast_BevelGearCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'BevelGearCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_gear_compound_harmonic_analysis(self) -> 'BevelGearCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5665.BevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5665.BevelGearHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BevelGearCompoundHarmonicAnalysis._Cast_BevelGearCompoundHarmonicAnalysis':
