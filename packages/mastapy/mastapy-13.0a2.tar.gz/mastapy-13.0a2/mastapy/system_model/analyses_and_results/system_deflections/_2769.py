...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2825
...
class PlanetCarrierSystemDeflection(_2761.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    class _Cast_PlanetCarrierSystemDeflection:
        ...
        def __init__(self, parent: 'PlanetCarrierSystemDeflection'):
            self._parent = parent
        ...
        @property
        def planet_carrier_system_deflection(self) -> 'PlanetCarrierSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4095.PlanetCarrierPowerFlow':
    ...
    @property
    def windup(self) -> 'List[_2825.PlanetCarrierWindup]':
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierSystemDeflection._Cast_PlanetCarrierSystemDeflection':
