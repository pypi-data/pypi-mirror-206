...
class FontsCollection (  XlsFontsCollection) :
    ...
    def Add(self ,font:XlsFontStyle):
        ...
        GetDllLibXls().FontsCollection_Add(self.Ptr, intPtrfont)
    ...
    def Add(self ,font:ExcelFont):
        ...
        GetDllLibXls().FontsCollection_AddF(self.Ptr, intPtrfont)
    ...
    def AddFonts(self ,fonts:'FontsCollection')->'IDictionary':
        ...
        intPtr = GetDllLibXls().FontsCollection_AddFonts(self.Ptr, intPtrfonts)
    ...
    def Contains(self ,font:XlsFontStyle)->bool:
        ...
        ret = GetDllLibXls().FontsCollection_Contains(self.Ptr, intPtrfont)
        return ret
    ...
    def Contains(self ,font:ExcelFont)->bool:
        ...
        ret = GetDllLibXls().FontsCollection_ContainsF(self.Ptr, intPtrfont)
        return ret
    ...
    def get_Item(self ,index:int)->'ExcelFont':
        ...
        intPtr = GetDllLibXls().FontsCollection_get_Item(self.Ptr, index)
