...
class ChartTextArea (  XlsObject, IChartDataLabels) :
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().ChartTextArea_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().ChartTextArea_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().ChartTextArea_set_Text(self.Ptr, value)
    ...
    def TextRotationAngle(self)->int:
        ...
        ret = GetDllLibXls().ChartTextArea_get_TextRotationAngle(self.Ptr)
        return ret
    ...
    def TextRotationAngle(self, value:int):
        ...
        GetDllLibXls().ChartTextArea_set_TextRotationAngle(self.Ptr, value)
    ...
    def FrameFormat(self)->'IChartFrameFormat':
        ...
        intPtr = GetDllLibXls().ChartTextArea_get_FrameFormat(self.Ptr)
    ...
    def BackgroundMode(self)->'ChartBackgroundMode':
        ...
        ret = GetDllLibXls().ChartTextArea_get_BackgroundMode(self.Ptr)
    ...
    def BackgroundMode(self, value:'ChartBackgroundMode'):
        ...
        GetDllLibXls().ChartTextArea_set_BackgroundMode(self.Ptr, value.value)
    ...
    def IsAutoMode(self)->bool:
        ...
        ret = GetDllLibXls().ChartTextArea_get_IsAutoMode(self.Ptr)
        return ret
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().ChartTextArea_get_Parent(self.Ptr)
    ...
    def IsBold(self)->bool:
        ...
        ret = GetDllLibXls().ChartTextArea_get_IsBold(self.Ptr)
        return ret

    @IsBold.setter
    def IsBold(self, value:bool):
        GetDllLibXls().ChartTextArea_set_IsBold.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ChartTextArea_set_IsBold(self.Ptr, value)
    ...
    def KnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().ChartTextArea_get_KnownColor(self.Ptr)
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().ChartTextArea_set_KnownColor(self.Ptr, value.value)
    ...
    def Color(self)->'Color':
        ...
        intPtr = GetDllLibXls().ChartTextArea_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().ChartTextArea_set_Color(self.Ptr, value.Ptr)
    ...
    def SetThemeColor(self ,type:'ThemeColorType',tint:float):
        ...
        GetDllLibXls().ChartTextArea_SetThemeColor(self.Ptr, enumtype,tint)
...
#        ret = GetDllLibXls().ChartTextArea_GetThemeColor(self.Ptr, intPtrtype,intPtrtint)
#        return ret
    ...
    def IsItalic(self)->bool:
        ...
        ret = GetDllLibXls().ChartTextArea_get_IsItalic(self.Ptr)
        return ret

    @IsItalic.setter
    def IsItalic(self, value:bool):
        GetDllLibXls().ChartTextArea_set_IsItalic.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ChartTextArea_set_IsItalic(self.Ptr, value)
    ...
    def Size(self)->float:
        ...
        ret = GetDllLibXls().ChartTextArea_get_Size(self.Ptr)
        return ret

    @Size.setter
    def Size(self, value:float):
        GetDllLibXls().ChartTextArea_set_Size.argtypes=[c_void_p, c_double]
        GetDllLibXls().ChartTextArea_set_Size(self.Ptr, value)
    ...
    def IsStrikethrough(self)->bool:
        ...
        ret = GetDllLibXls().ChartTextArea_get_IsStrikethrough(self.Ptr)
        return ret
    ...
    def IsStrikethrough(self, value:bool):
        ...
        GetDllLibXls().ChartTextArea_set_IsStrikethrough(self.Ptr, value)
    ...
    def IsSubscript(self)->bool:
        ...
        ret = GetDllLibXls().ChartTextArea_get_IsSubscript(self.Ptr)
        return ret

    @IsSubscript.setter
    def IsSubscript(self, value:bool):
        GetDllLibXls().ChartTextArea_set_IsSubscript.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ChartTextArea_set_IsSubscript(self.Ptr, value)
    ...
    def StrikethroughType(self)->str:
        ...
        GetDllLibXls().ChartTextArea_get_StrikethroughType.restype=c_wchar_p
        ret = GetDllLibXls().ChartTextArea_get_StrikethroughType(self.Ptr)
        return ret
    ...
    def StrikethroughType(self, value:str):
        ...
        GetDllLibXls().ChartTextArea_set_StrikethroughType(self.Ptr, value)
    ...
    def IsSuperscript(self)->bool:
        ...
        ret = GetDllLibXls().ChartTextArea_get_IsSuperscript(self.Ptr)
        return ret
    ...
    def IsSuperscript(self, value:bool):
        ...
        GetDllLibXls().ChartTextArea_set_IsSuperscript(self.Ptr, value)
    ...
    def Underline(self)->'FontUnderlineType':
        ...
        ret = GetDllLibXls().ChartTextArea_get_Underline(self.Ptr)
    ...
    def Underline(self, value:'FontUnderlineType'):
        ...
        GetDllLibXls().ChartTextArea_set_Underline(self.Ptr, value.value)
    ...
    def FontName(self)->str:
        ...
        GetDllLibXls().ChartTextArea_get_FontName.restype=c_wchar_p
        ret = GetDllLibXls().ChartTextArea_get_FontName(self.Ptr)
        return ret
    ...
    def FontName(self, value:str):
        ...
        GetDllLibXls().ChartTextArea_set_FontName(self.Ptr, value)
    ...
    def VerticalAlignment(self)->'FontVertialAlignmentType':
        ...
        ret = GetDllLibXls().ChartTextArea_get_VerticalAlignment(self.Ptr)
    ...
    def VerticalAlignment(self, value:'FontVertialAlignmentType'):
        ...
        GetDllLibXls().ChartTextArea_set_VerticalAlignment(self.Ptr, value.value)
    ...
    def IsAutoColor(self)->bool:
        ...
        ret = GetDllLibXls().ChartTextArea_get_IsAutoColor(self.Ptr)
        return ret
    ...
    def GenerateNativeFont(self)->'Font':
        ...
        intPtr = GetDllLibXls().ChartTextArea_GenerateNativeFont(self.Ptr)
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().ChartTextArea_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().ChartTextArea_EndUpdate(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartTextArea_get_OColor(self.Ptr)
    ...
    def ParagraphType(self)->'ChartParagraphType':
        ...
        ret = GetDllLibXls().ChartTextArea_get_ParagraphType(self.Ptr)
    ...
    def ParagraphType(self, value:'ChartParagraphType'):
        ...
        GetDllLibXls().ChartTextArea_set_ParagraphType(self.Ptr, value.value)
    ...
    def HasTextRotation(self)->bool:
        ...
        ret = GetDllLibXls().ChartTextArea_get_HasTextRotation(self.Ptr)
        return ret
    ...
    def IsResizeShapeToFitText(self)->bool:
        ...
        ret = GetDllLibXls().ChartTextArea_get_IsResizeShapeToFitText(self.Ptr)
        return ret
    ...
    def IsResizeShapeToFitText(self, value:bool):
        ...
        GetDllLibXls().ChartTextArea_set_IsResizeShapeToFitText(self.Ptr, value)
    ...
    def IsTextWrapped(self)->bool:
        ...
        ret = GetDllLibXls().ChartTextArea_get_IsTextWrapped(self.Ptr)
        return ret
    ...
    def IsTextWrapped(self, value:bool):
        ...
        GetDllLibXls().ChartTextArea_set_IsTextWrapped(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().ChartTextArea_get_Delimiter.restype=c_wchar_p
        ret = GetDllLibXls().ChartTextArea_get_Delimiter(self.Ptr)
        return ret
    ...
    def Delimiter(self, value:str):
        ...
        GetDllLibXls().ChartTextArea_set_Delimiter(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ChartTextArea_get_HasBubbleSize(self.Ptr)
        return ret
    ...
    def HasBubbleSize(self, value:bool):
        ...
        GetDllLibXls().ChartTextArea_set_HasBubbleSize(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ChartTextArea_get_HasCategoryName(self.Ptr)
        return ret
    ...
    def HasCategoryName(self, value:bool):
        ...
        GetDllLibXls().ChartTextArea_set_HasCategoryName(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ChartTextArea_get_HasLegendKey(self.Ptr)
        return ret

    @HasLegendKey.setter
    def HasLegendKey(self, value:bool):
        GetDllLibXls().ChartTextArea_set_HasLegendKey.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ChartTextArea_set_HasLegendKey(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ChartTextArea_get_HasPercentage(self.Ptr)
        return ret
    ...
    def HasPercentage(self, value:bool):
        ...
        GetDllLibXls().ChartTextArea_set_HasPercentage(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ChartTextArea_get_HasSeriesName(self.Ptr)
        return ret
    ...
    def HasSeriesName(self, value:bool):
        ...
        GetDllLibXls().ChartTextArea_set_HasSeriesName(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ChartTextArea_get_HasValue(self.Ptr)
        return ret

    @HasValue.setter
    def HasValue(self, value:bool):
        GetDllLibXls().ChartTextArea_set_HasValue.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ChartTextArea_set_HasValue(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ChartTextArea_get_Position(self.Ptr)
    ...
    def Position(self, value:'DataLabelPositionType'):
        ...
        GetDllLibXls().ChartTextArea_set_Position(self.Ptr, value.value)
    ...
    def ShowLeaderLines(self)->bool:
        ...
        ret = GetDllLibXls().ChartTextArea_get_ShowLeaderLines(self.Ptr)
        return ret
    ...
    def ShowLeaderLines(self, value:bool):
        ...
        GetDllLibXls().ChartTextArea_set_ShowLeaderLines(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().ChartTextArea_get_NumberFormat.restype=c_wchar_p
        ret = GetDllLibXls().ChartTextArea_get_NumberFormat(self.Ptr)
        return ret
    ...
    def NumberFormat(self, value:str):
        ...
        GetDllLibXls().ChartTextArea_set_NumberFormat(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ChartTextArea_get_HasDataLabels(self.Ptr)
        return ret
    ...
    def HorizontalAlignType(self)->'HorizontalAlignType':
        ...
        ret = GetDllLibXls().ChartTextArea_get_HorizontalAlignType(self.Ptr)
    ...
    def HorizontalAlignType(self, value:'HorizontalAlignType'):
        ...
        GetDllLibXls().ChartTextArea_set_HorizontalAlignType(self.Ptr, value.value)
    ...
    def Index(self)->int:
        ...
        ret = GetDllLibXls().ChartTextArea_get_Index(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().ChartTextArea_get_IsShowLabelPercent(self.Ptr)
        return ret
    ...
    def IsShowLabelPercent(self, value:bool):
        ...
        GetDllLibXls().ChartTextArea_set_IsShowLabelPercent(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ChartTextArea_get_IsTrend(self.Ptr)
        return ret

    @IsTrend.setter
    def IsTrend(self, value:bool):
        GetDllLibXls().ChartTextArea_set_IsTrend.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ChartTextArea_set_IsTrend(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ChartTextArea_get_NumberFormatIndex(self.Ptr)
        return ret
    ...
    def ParentWorkbook(self)->'XlsWorkbook':
        ...
        intPtr = GetDllLibXls().ChartTextArea_get_ParentWorkbook(self.Ptr)
    ...
    def X(self)->float:
        ...
        ret = GetDllLibXls().ChartTextArea_get_X(self.Ptr)
        return ret

    @X.setter
    def X(self, value:float):
        GetDllLibXls().ChartTextArea_set_X.argtypes=[c_void_p, c_float]
        GetDllLibXls().ChartTextArea_set_X(self.Ptr, value)
    ...
    def Y(self)->float:
        ...
        ret = GetDllLibXls().ChartTextArea_get_Y(self.Ptr)
        return ret

    @Y.setter
    def Y(self, value:float):
        GetDllLibXls().ChartTextArea_set_Y.argtypes=[c_void_p, c_float]
        GetDllLibXls().ChartTextArea_set_Y(self.Ptr, value)
    ...
    def SetFont(self ,font:'ExcelFont'):
        ...
        GetDllLibXls().ChartTextArea_SetFont(self.Ptr, intPtrfont)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartTextArea_get_Font(self.Ptr)
...
#        intPtr = GetDllLibXls().ChartTextArea_Clone(self.Ptr, intPtrparent,intPtrfontIndexes,intPtrdicNewSheetNames)
#        ret = None if intPtr==None else SpireObject(intPtr)
#        return ret
#
    ...
    def Clone(self ,parent:SpireObject)->SpireObject:
        ...
        intPtr = GetDllLibXls().ChartTextArea_CloneP(self.Ptr, intPtrparent)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
