...
class BHCurveSpecification(_0.APIBase):
    ...
    @property
    def bh_curve(self) -> '_1523.Vector2DListAccessor':
    ...
    @bh_curve.setter
    def bh_curve(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.BHCurve = value

    @property
    def bh_curve_plot(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def bh_curve_extrapolation_method(self) -> '_243.BHCurveExtrapolationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _243.BHCurveExtrapolationMethod)
        return constructor.new_from_mastapy_type(_243.BHCurveExtrapolationMethod)(value) if value is not None else None

    @bh_curve_extrapolation_method.setter
    def bh_curve_extrapolation_method(self, value: '_243.BHCurveExtrapolationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _243.BHCurveExtrapolationMethod.type_())
