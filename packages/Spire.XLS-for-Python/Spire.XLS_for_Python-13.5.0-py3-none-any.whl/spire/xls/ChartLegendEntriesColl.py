...
class ChartLegendEntriesColl (  XlsObject, IChartLegendEntries) :
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().ChartLegendEntriesColl_get_Count(self.Ptr)
        return ret
    ...
    def get_Item(self ,iIndex:int)->'IChartLegendEntry':
        ...
        intPtr = GetDllLibXls().ChartLegendEntriesColl_get_Item(self.Ptr, iIndex)
    ...
    def Add(self ,iIndex:int)->XlsChartLegendEntry:
        ...
        intPtr = GetDllLibXls().ChartLegendEntriesColl_Add(self.Ptr, iIndex)
        ret = None if intPtr==None else XlsChartLegendEntry(intPtr)
        return ret
    ...
    def Add(self ,iIndex:int,entry:XlsChartLegendEntry)->XlsChartLegendEntry:
        ...
        intPtr = GetDllLibXls().ChartLegendEntriesColl_AddIE(self.Ptr, iIndex,intPtrentry)
        ret = None if intPtr==None else XlsChartLegendEntry(intPtr)
        return ret
    ...
    def Contains(self ,iIndex:int)->bool:
        ...
        ret = GetDllLibXls().ChartLegendEntriesColl_Contains(self.Ptr, iIndex)
        return ret
    ...
    def CanDelete(self ,iIndex:int)->bool:
        ...
        ret = GetDllLibXls().ChartLegendEntriesColl_CanDelete(self.Ptr, iIndex)
        return ret
    ...
    def Remove(self ,iIndex:int):
        ...
        GetDllLibXls().ChartLegendEntriesColl_Remove(self.Ptr, iIndex)
    ...
    def Clear(self):
        ...
        GetDllLibXls().ChartLegendEntriesColl_Clear(self.Ptr)
...
#        intPtr = GetDllLibXls().ChartLegendEntriesColl_Clone(self.Ptr, intPtrparent,intPtrdicIndexes,intPtrdicNewSheetNames)
...
#
    ...
    def UpdateEntries(self ,entryIndex:int,value:int):
        ...
        GetDllLibXls().ChartLegendEntriesColl_UpdateEntries(self.Ptr, entryIndex,value)
