...
class DatumSteadyStateSynchronousResponseOnAShaft(_3249.ComponentSteadyStateSynchronousResponseOnAShaft):
    """DatumSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_DatumSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'DatumSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def datum_steady_state_synchronous_response_on_a_shaft(self) -> 'DatumSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DatumSteadyStateSynchronousResponseOnAShaft._Cast_DatumSteadyStateSynchronousResponseOnAShaft':
