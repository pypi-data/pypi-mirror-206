...
class HyperLinksCollection (  XlsHyperLinksCollection) :
    ...
    def get_Item(self ,index:int)->'HyperLink':
        ...
        intPtr = GetDllLibXls().HyperLinksCollection_get_Item(self.Ptr, index)
    ...
    def Add(self ,range:CellRange)->HyperLink:
        ...
        intPtr = GetDllLibXls().HyperLinksCollection_Add(self.Ptr, intPtrrange)
        ret = None if intPtr==None else HyperLink(intPtr)
        return ret
    ...
    def Add(self ,link:HyperLink)->int:
        ...
        ret = GetDllLibXls().HyperLinksCollection_AddL(self.Ptr, intPtrlink)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().HyperLinksCollection_GetRangeHyperlinks(self.Ptr, intPtrrange)
