...
class PlanetaryGearSetCompoundPowerFlow(_4191.CylindricalGearSetCompoundPowerFlow):
    """PlanetaryGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4094.PlanetaryGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4094.PlanetaryGearSetPowerFlow]':
