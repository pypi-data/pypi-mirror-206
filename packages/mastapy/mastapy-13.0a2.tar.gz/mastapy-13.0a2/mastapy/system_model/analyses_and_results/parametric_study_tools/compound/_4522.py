...
class SpringDamperHalfCompoundParametricStudyTool(_4457.CouplingHalfCompoundParametricStudyTool):
    """SpringDamperHalfCompoundParametricStudyTool
    ...
    class _Cast_SpringDamperHalfCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'SpringDamperHalfCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def spring_damper_half_compound_parametric_study_tool(self) -> 'SpringDamperHalfCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4392.SpringDamperHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4392.SpringDamperHalfParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperHalfCompoundParametricStudyTool._Cast_SpringDamperHalfCompoundParametricStudyTool':
