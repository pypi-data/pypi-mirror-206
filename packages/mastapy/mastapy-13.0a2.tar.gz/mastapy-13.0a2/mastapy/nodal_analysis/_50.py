...
class AnalysisSettingsItem(_1816.NamedDatabaseItem):
    """AnalysisSettingsItem
    ...
    class _Cast_AnalysisSettingsItem:
        ...
        def __init__(self, parent: 'AnalysisSettingsItem'):
            self._parent = parent
        ...
        @property
        def analysis_settings_item(self) -> 'AnalysisSettingsItem':
            return self._parent
    ...
    def rating_type_for_bearing_reliability(self) -> '_80.RatingTypeForBearingReliability':
        ...
        value = conversion.pn_to_mp_enum(temp, _80.RatingTypeForBearingReliability)
    ...
    def rating_type_for_bearing_reliability(self, value: '_80.RatingTypeForBearingReliability'):
        ...
        value = conversion.mp_to_pn_enum(value, _80.RatingTypeForBearingReliability.type_())
    ...
    def rating_type_for_shaft_reliability(self) -> '_81.RatingTypeForShaftReliability':
        ...
        value = conversion.pn_to_mp_enum(temp, _81.RatingTypeForShaftReliability)
    ...
    def rating_type_for_shaft_reliability(self, value: '_81.RatingTypeForShaftReliability'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _81.RatingTypeForShaftReliability.type_())
    ...
    @property
    def cast_to(self) -> 'AnalysisSettingsItem._Cast_AnalysisSettingsItem':
