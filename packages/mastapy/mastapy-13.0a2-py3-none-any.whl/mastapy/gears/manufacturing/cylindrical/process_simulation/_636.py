...
class ShapingProcessSimulation(_634.CutterProcessSimulation):
    """ShapingProcessSimulation
    ...
    class _Cast_ShapingProcessSimulation:
        ...
        def __init__(self, parent: 'ShapingProcessSimulation'):
            self._parent = parent

        @property
        def cutter_process_simulation(self):
            return self._parent._cast(_634.CutterProcessSimulation)

        @property
        def shaping_process_simulation(self) -> 'ShapingProcessSimulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShapingProcessSimulation._Cast_ShapingProcessSimulation':
