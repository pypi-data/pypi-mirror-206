...
class SpiralBevelGearLoadCase(_6792.BevelGearLoadCase):
    """SpiralBevelGearLoadCase
    ...
    class _Cast_SpiralBevelGearLoadCase:
        ...
        def __init__(self, parent: 'SpiralBevelGearLoadCase'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_load_case(self) -> 'SpiralBevelGearLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearLoadCase._Cast_SpiralBevelGearLoadCase':
