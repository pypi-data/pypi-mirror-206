...
class TorqueConverterPumpModalAnalysisAtASpeed(_5127.CouplingHalfModalAnalysisAtASpeed):
    """TorqueConverterPumpModalAnalysisAtASpeed
    ...
    class _Cast_TorqueConverterPumpModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'TorqueConverterPumpModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def torque_converter_pump_modal_analysis_at_a_speed(self) -> 'TorqueConverterPumpModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterPumpModalAnalysisAtASpeed._Cast_TorqueConverterPumpModalAnalysisAtASpeed':
