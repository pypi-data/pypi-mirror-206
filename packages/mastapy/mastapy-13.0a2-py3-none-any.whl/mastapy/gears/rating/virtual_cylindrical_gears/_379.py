...
class HypoidVirtualCylindricalGearSetISO10300MethodB2(_390.VirtualCylindricalGearSetISO10300MethodB2):
    """HypoidVirtualCylindricalGearSetISO10300MethodB2
    ...
    class _Cast_HypoidVirtualCylindricalGearSetISO10300MethodB2:
        ...
        def __init__(self, parent: 'HypoidVirtualCylindricalGearSetISO10300MethodB2'):
            self._parent = parent

        @property
        def virtual_cylindrical_gear_set_iso10300_method_b2(self):
            return self._parent._cast(_390.VirtualCylindricalGearSetISO10300MethodB2)

        @property
        def virtual_cylindrical_gear_set(self):
            from mastapy.gears.rating.virtual_cylindrical_gears import _388, _387
            
            return self._parent._cast(_388.VirtualCylindricalGearSet)

        @property
        def hypoid_virtual_cylindrical_gear_set_iso10300_method_b2(self) -> 'HypoidVirtualCylindricalGearSetISO10300MethodB2':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidVirtualCylindricalGearSetISO10300MethodB2._Cast_HypoidVirtualCylindricalGearSetISO10300MethodB2':
