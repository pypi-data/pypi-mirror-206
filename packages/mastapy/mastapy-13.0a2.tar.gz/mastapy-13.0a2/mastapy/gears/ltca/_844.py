...
class MeshedGearLoadDistributionAnalysisAtRotation(_0.APIBase):
    ...
    class _Cast_MeshedGearLoadDistributionAnalysisAtRotation:
        ...
        def __init__(self, parent: 'MeshedGearLoadDistributionAnalysisAtRotation'):
            self._parent = parent

        @property
        def meshed_gear_load_distribution_analysis_at_rotation(self) -> 'MeshedGearLoadDistributionAnalysisAtRotation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MeshedGearLoadDistributionAnalysisAtRotation._Cast_MeshedGearLoadDistributionAnalysisAtRotation':
