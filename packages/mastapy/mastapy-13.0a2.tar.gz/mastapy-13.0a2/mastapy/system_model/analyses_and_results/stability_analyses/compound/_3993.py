...
class TorqueConverterPumpCompoundStabilityAnalysis(_3913.CouplingHalfCompoundStabilityAnalysis):
    """TorqueConverterPumpCompoundStabilityAnalysis
    ...
    class _Cast_TorqueConverterPumpCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'TorqueConverterPumpCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def torque_converter_pump_compound_stability_analysis(self) -> 'TorqueConverterPumpCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3863.TorqueConverterPumpStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3863.TorqueConverterPumpStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterPumpCompoundStabilityAnalysis._Cast_TorqueConverterPumpCompoundStabilityAnalysis':
