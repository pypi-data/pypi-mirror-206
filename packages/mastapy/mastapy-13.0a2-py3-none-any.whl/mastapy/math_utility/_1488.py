...
class CoordinateSystemEditor(_0.APIBase):
    ...
    class _Cast_CoordinateSystemEditor:
        ...
        def __init__(self, parent: 'CoordinateSystemEditor'):
            self._parent = parent

        @property
        def coordinate_system_editor(self) -> 'CoordinateSystemEditor':
            return self._parent
    ...
    @property
    def coordinate_system_for_rotation_axes(self) -> '_1489.CoordinateSystemForRotation':
        ...
        value = conversion.pn_to_mp_enum(temp, _1489.CoordinateSystemForRotation)
        return constructor.new_from_mastapy_type(_1489.CoordinateSystemForRotation)(value) if value is not None else None

    @coordinate_system_for_rotation_axes.setter
    def coordinate_system_for_rotation_axes(self, value: '_1489.CoordinateSystemForRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1489.CoordinateSystemForRotation.type_())
        self.wrapped.CoordinateSystemForRotationAxes = value

    @property
    def coordinate_system_for_rotation_origin(self) -> '_1490.CoordinateSystemForRotationOrigin':
        ...
        value = conversion.pn_to_mp_enum(temp, _1490.CoordinateSystemForRotationOrigin)
        return constructor.new_from_mastapy_type(_1490.CoordinateSystemForRotationOrigin)(value) if value is not None else None

    @coordinate_system_for_rotation_origin.setter
    def coordinate_system_for_rotation_origin(self, value: '_1490.CoordinateSystemForRotationOrigin'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1490.CoordinateSystemForRotationOrigin.type_())
    ...
    @property
    def rotation_axis(self) -> '_1516.RotationAxis':
        ...
        value = conversion.pn_to_mp_enum(temp, _1516.RotationAxis)
        return constructor.new_from_mastapy_type(_1516.RotationAxis)(value) if value is not None else None

    @rotation_axis.setter
    def rotation_axis(self, value: '_1516.RotationAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1516.RotationAxis.type_())
    ...
    @property
    def modified_coordinate_system_for_rotation(self) -> '_1487.CoordinateSystem3D':
    ...
    @property
    def modified_coordinate_system_for_translation(self) -> '_1487.CoordinateSystem3D':
    ...
    @property
    def cast_to(self) -> 'CoordinateSystemEditor._Cast_CoordinateSystemEditor':
