...
class MicroPittingResultsRow(_0.APIBase):
    ...
    class _Cast_MicroPittingResultsRow:
        ...
        def __init__(self, parent: 'MicroPittingResultsRow'):
            self._parent = parent

        @property
        def micro_pitting_results_row(self) -> 'MicroPittingResultsRow':
            return self._parent
    ...
    @property
    def position_on_pinion(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def position_on_wheel(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def cast_to(self) -> 'MicroPittingResultsRow._Cast_MicroPittingResultsRow':
