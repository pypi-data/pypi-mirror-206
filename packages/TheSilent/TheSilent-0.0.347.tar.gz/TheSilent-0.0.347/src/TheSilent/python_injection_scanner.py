...
def python_injection_scanner(url, secure=True, tor=False, crawl=0, my_file=" ", parse=" ", delay=1):
    clear()
    ...
    my_list = []
    init_mal_payloads = ['eval(compile("import sys\ndef the_silent():\n return sys.version\nprint(the_silent())", "TheSilent", "exec"))', 'eval(compile("import time\ntime.sleep(60)", "TheSilent", "exec"))']
