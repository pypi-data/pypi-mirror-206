...
class ConceptCouplingDynamicAnalysis(_6281.CouplingDynamicAnalysis):
    """ConceptCouplingDynamicAnalysis
    ...
    class _Cast_ConceptCouplingDynamicAnalysis:
        ...
        def __init__(self, parent: 'ConceptCouplingDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_coupling_dynamic_analysis(self) -> 'ConceptCouplingDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingDynamicAnalysis._Cast_ConceptCouplingDynamicAnalysis':
