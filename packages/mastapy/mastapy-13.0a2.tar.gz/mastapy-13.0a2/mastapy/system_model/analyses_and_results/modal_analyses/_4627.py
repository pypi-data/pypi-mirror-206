...
class MeasurementComponentModalAnalysis(_4679.VirtualComponentModalAnalysis):
    """MeasurementComponentModalAnalysis
    ...
    class _Cast_MeasurementComponentModalAnalysis:
        ...
        def __init__(self, parent: 'MeasurementComponentModalAnalysis'):
            self._parent = parent
        ...
        @property
        def measurement_component_modal_analysis(self) -> 'MeasurementComponentModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MeasurementComponentModalAnalysis._Cast_MeasurementComponentModalAnalysis':
