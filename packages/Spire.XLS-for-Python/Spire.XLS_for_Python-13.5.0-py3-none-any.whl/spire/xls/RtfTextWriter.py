...
class RtfTextWriter (SpireObject) :
    ...
    def ToString(self)->str:
        ...
        GetDllLibXls().RtfTextWriter_ToString.restype=c_wchar_p
        ret = GetDllLibXls().RtfTextWriter_ToString(self.Ptr)
        return ret
    ...
    def Write(self ,value:bool):
        ...
        GetDllLibXls().RtfTextWriter_Write(self.Ptr, value)
    ...
    def Write(self ,value:int):
        ...
        GetDllLibXls().RtfTextWriter_WriteV(self.Ptr, value)
...
#        GetDllLibXls().RtfTextWriter_WriteB(self.Ptr, arraybuffer)
    ...
    def Write(self ,value:float):
        ...
        GetDllLibXls().RtfTextWriter_WriteV1(self.Ptr, value)
    ...
    def Write(self ,value:int):
        ...
        GetDllLibXls().RtfTextWriter_WriteV11(self.Ptr, value)
    ...
    def Write(self ,value:int):
        ...
        GetDllLibXls().RtfTextWriter_WriteV111(self.Ptr, value)
    ...
    def Write(self ,value:SpireObject):
        ...
        GetDllLibXls().RtfTextWriter_WriteV1111(self.Ptr, intPtrvalue)
    ...
    def Write(self ,value:float):
        ...
        GetDllLibXls().RtfTextWriter_WriteV11111(self.Ptr, value)
    ...
    def Write(self ,s:str):
        ...
        GetDllLibXls().RtfTextWriter_WriteS(self.Ptr, s)
    ...
    def Write(self ,value:UInt32):
        ...
        GetDllLibXls().RtfTextWriter_WriteV111111(self.Ptr, intPtrvalue)
    ...
    def Write(self ,format:str,arg0:SpireObject):
        ...
        GetDllLibXls().RtfTextWriter_WriteFA(self.Ptr, format,intPtrarg0)
    ...
    def Write(self ,format:str,arg:List[SpireObject]):
        ...
        GetDllLibXls().RtfTextWriter_WriteFA1(self.Ptr, format,arrayarg,countarg)
    ...
    def Write(self ,format:str,arg0:SpireObject,arg1:SpireObject):
        ...
        GetDllLibXls().RtfTextWriter_WriteFAA(self.Ptr, format,intPtrarg0,intPtrarg1)
...
#        GetDllLibXls().RtfTextWriter_WriteBIC(self.Ptr, arraybuffer,index,count)
    ...
    def WriteLine(self):
        ...
        GetDllLibXls().RtfTextWriter_WriteLine(self.Ptr)
    ...
    def WriteLine(self ,value:bool):
        ...
        GetDllLibXls().RtfTextWriter_WriteLineV(self.Ptr, value)
    ...
    def WriteLine(self ,value:int):
        ...
        GetDllLibXls().RtfTextWriter_WriteLineV1(self.Ptr, value)
...
#        GetDllLibXls().RtfTextWriter_WriteLineB(self.Ptr, arraybuffer)
    ...
    def WriteLine(self ,value:float):
        ...
        GetDllLibXls().RtfTextWriter_WriteLineV11(self.Ptr, value)
    ...
    def WriteLine(self ,value:int):
        ...
        GetDllLibXls().RtfTextWriter_WriteLineV111(self.Ptr, value)
    ...
    def WriteLine(self ,value:int):
        ...
        GetDllLibXls().RtfTextWriter_WriteLineV1111(self.Ptr, value)
    ...
    def WriteLine(self ,value:SpireObject):
        ...
        GetDllLibXls().RtfTextWriter_WriteLineV11111(self.Ptr, intPtrvalue)
    ...
    def WriteLine(self ,value:float):
        ...
        GetDllLibXls().RtfTextWriter_WriteLineV111111(self.Ptr, value)
    ...
    def WriteLine(self ,s:str):
        ...
        GetDllLibXls().RtfTextWriter_WriteLineS(self.Ptr, s)
    ...
    def WriteLine(self ,value:UInt32):
        ...
        GetDllLibXls().RtfTextWriter_WriteLineV1111111(self.Ptr, intPtrvalue)
    ...
    def WriteLine(self ,format:str,arg:List[SpireObject]):
        ...
        GetDllLibXls().RtfTextWriter_WriteLineFA(self.Ptr, format,arrayarg,countarg)
    ...
    def WriteLine(self ,format:str,arg0:SpireObject):
        ...
        GetDllLibXls().RtfTextWriter_WriteLineFA1(self.Ptr, format,intPtrarg0)
    ...
    def WriteLine(self ,format:str,arg0:SpireObject,arg1:SpireObject):
        ...
        GetDllLibXls().RtfTextWriter_WriteLineFAA(self.Ptr, format,intPtrarg0,intPtrarg1)
...
#        GetDllLibXls().RtfTextWriter_WriteLineBIC(self.Ptr, arraybuffer,index,count)
    ...
    def AddFont(self ,font:'Font')->int:
        ...
        ret = GetDllLibXls().RtfTextWriter_AddFont(self.Ptr, intPtrfont)
        return ret
    ...
    def AddColor(self ,color:'Color')->int:
        ...
        ret = GetDllLibXls().RtfTextWriter_AddColor(self.Ptr, intPtrcolor)
        return ret
    ...
    def WriteFontTable(self):
        ...
        GetDllLibXls().RtfTextWriter_WriteFontTable(self.Ptr)
    ...
    def WriteColorTable(self):
        ...
        GetDllLibXls().RtfTextWriter_WriteColorTable(self.Ptr)
    ...
    def WriteText(self ,font:Font,strText:str):
        ...
        GetDllLibXls().RtfTextWriter_WriteText(self.Ptr, intPtrfont,strText)
    ...
    def WriteText(self ,font:Font,foreColor:Color,strText:str):
        ...
        GetDllLibXls().RtfTextWriter_WriteTextFFS(self.Ptr, intPtrfont,intPtrforeColor,strText)
    ...
    def WriteText(self ,font:Font,foreColor:Color,backColor:Color,strText:str):
        ...
        GetDllLibXls().RtfTextWriter_WriteTextFFBS(self.Ptr, intPtrfont,intPtrforeColor,intPtrbackColor,strText)
    ...
    def WriteText(self ,font:IFont,strText:str):
        ...
        GetDllLibXls().RtfTextWriter_WriteTextFS(self.Ptr, intPtrfont,strText)
    ...
    def WriteFontAttribute(self ,font:'Font'):
        ...
        GetDllLibXls().RtfTextWriter_WriteFontAttribute(self.Ptr, intPtrfont)
    ...
    def WriteFont(self ,font:Font):
        ...
        GetDllLibXls().RtfTextWriter_WriteFont(self.Ptr, intPtrfont)
    ...
    def WriteFont(self ,font:IFont):
        ...
        GetDllLibXls().RtfTextWriter_WriteFontF(self.Ptr, intPtrfont)
    ...
    def WriteSubSuperScript(self ,font:'XlsFont'):
        ...
        GetDllLibXls().RtfTextWriter_WriteSubSuperScript(self.Ptr, intPtrfont)
    ...
    def WriteFontItalicBoldStriked(self ,font:'Font'):
        ...
        GetDllLibXls().RtfTextWriter_WriteFontItalicBoldStriked(self.Ptr, intPtrfont)
    ...
    def WriteUnderline(self ,font:'XlsFont'):
        ...
        GetDllLibXls().RtfTextWriter_WriteUnderline(self.Ptr, intPtrfont)
    ...
    def WriteUnderlineAttribute(self):
        ...
        GetDllLibXls().RtfTextWriter_WriteUnderlineAttribute(self.Ptr)
    ...
    def WriteUnderlineAttribute(self ,style:UnderlineStyle):
        ...
        GetDllLibXls().RtfTextWriter_WriteUnderlineAttributeS(self.Ptr, enumstyle)
    ...
    def WriteStrikeThrough(self ,style:'StrikeThroughStyle'):
        ...
        GetDllLibXls().RtfTextWriter_WriteStrikeThrough(self.Ptr, enumstyle)
    ...
    def WriteBackColorAttribute(self ,color:'Color'):
        ...
        GetDllLibXls().RtfTextWriter_WriteBackColorAttribute(self.Ptr, intPtrcolor)
    ...
    def WriteForeColorAttribute(self ,color:'Color'):
        ...
        GetDllLibXls().RtfTextWriter_WriteForeColorAttribute(self.Ptr, intPtrcolor)
    ...
    def WriteLineNoTabs(self ,s:str):
        ...
        GetDllLibXls().RtfTextWriter_WriteLineNoTabs(self.Ptr, s)
    ...
    def WriteTag(self ,tag:RtfTags):
        ...
        GetDllLibXls().RtfTextWriter_WriteTag(self.Ptr, enumtag)
    ...
    def WriteTag(self ,tag:RtfTags,arrParams:List[SpireObject]):
        ...
        GetDllLibXls().RtfTextWriter_WriteTagTA(self.Ptr, enumtag,arrayarrParams,countarrParams)
    ...
    def Escape(self)->bool:
        ...
        ret = GetDllLibXls().RtfTextWriter_get_Escape(self.Ptr)
        return ret

    @Escape.setter
    def Escape(self, value:bool):
        GetDllLibXls().RtfTextWriter_set_Escape.argtypes=[c_void_p, c_bool]
        GetDllLibXls().RtfTextWriter_set_Escape(self.Ptr, value)
    ...
    def Encoding(self)->'Encoding':
        ...
        intPtr = GetDllLibXls().RtfTextWriter_get_Encoding(self.Ptr)
