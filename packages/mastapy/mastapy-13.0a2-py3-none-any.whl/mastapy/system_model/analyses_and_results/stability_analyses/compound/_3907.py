...
class ConicalGearMeshCompoundStabilityAnalysis(_3933.GearMeshCompoundStabilityAnalysis):
    """ConicalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3774.ConicalGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3774.ConicalGearMeshStabilityAnalysis]':
