...
class CMSResults(_0.APIBase):
    ...
    class _Cast_CMSResults:
        ...
        def __init__(self, parent: 'CMSResults'):
            self._parent = parent

        @property
        def harmonic_cms_results(self):
            from mastapy.nodal_analysis.component_mode_synthesis import _227
            
            return self._parent._cast(_227.HarmonicCMSResults)

        @property
        def modal_cms_results(self):
            from mastapy.nodal_analysis.component_mode_synthesis import _228
            
            return self._parent._cast(_228.ModalCMSResults)
        ...
        def static_cms_results(self):
            ...
            return self._parent._cast(_231.StaticCMSResults)

        @property
        def cms_results(self) -> 'CMSResults':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CMSResults._Cast_CMSResults':
