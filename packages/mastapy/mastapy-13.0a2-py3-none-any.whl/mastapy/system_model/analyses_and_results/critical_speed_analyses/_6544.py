...
class ConnectorCriticalSpeedAnalysis(_6587.MountableComponentCriticalSpeedAnalysis):
    """ConnectorCriticalSpeedAnalysis
    ...
    class _Cast_ConnectorCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ConnectorCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def connector_critical_speed_analysis(self) -> 'ConnectorCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConnectorCriticalSpeedAnalysis._Cast_ConnectorCriticalSpeedAnalysis':
