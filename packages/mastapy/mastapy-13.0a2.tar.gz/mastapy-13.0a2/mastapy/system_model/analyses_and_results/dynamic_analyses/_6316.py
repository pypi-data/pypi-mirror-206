...
class KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis(_6310.KlingelnbergCycloPalloidConicalGearDynamicAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_dynamic_analysis(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis._Cast_KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis':
