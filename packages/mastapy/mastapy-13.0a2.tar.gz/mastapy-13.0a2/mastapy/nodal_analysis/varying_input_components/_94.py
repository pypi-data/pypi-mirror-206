...
class ForceInputComponent(_92.AbstractVaryingInputComponent):
    ...
    class _Cast_ForceInputComponent:
        ...
        def __init__(self, parent: 'ForceInputComponent'):
            self._parent = parent

        @property
        def abstract_varying_input_component(self):
            return self._parent._cast(_92.AbstractVaryingInputComponent)

        @property
        def force_input_component(self) -> 'ForceInputComponent':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ForceInputComponent._Cast_ForceInputComponent':
