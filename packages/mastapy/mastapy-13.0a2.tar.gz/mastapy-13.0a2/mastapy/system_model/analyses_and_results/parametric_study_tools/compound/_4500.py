...
class PartToPartShearCouplingHalfCompoundParametricStudyTool(_4457.CouplingHalfCompoundParametricStudyTool):
    """PartToPartShearCouplingHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4370.PartToPartShearCouplingHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4370.PartToPartShearCouplingHalfParametricStudyTool]':
