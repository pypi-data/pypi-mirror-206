...
class WormGearCompoundMultibodyDynamicsAnalysis(_5557.GearCompoundMultibodyDynamicsAnalysis):
    """WormGearCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_WormGearCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'WormGearCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def worm_gear_compound_multibody_dynamics_analysis(self) -> 'WormGearCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5488.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5488.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'WormGearCompoundMultibodyDynamicsAnalysis._Cast_WormGearCompoundMultibodyDynamicsAnalysis':
