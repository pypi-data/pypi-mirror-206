...
class MaterialsSettingsDatabase(_1815.NamedDatabase['_269.MaterialsSettingsItem']):
    """MaterialsSettingsDatabase
    ...
    class _Cast_MaterialsSettingsDatabase:
        ...
        def __init__(self, parent: 'MaterialsSettingsDatabase'):
            self._parent = parent
        ...
        @property
        def materials_settings_database(self) -> 'MaterialsSettingsDatabase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MaterialsSettingsDatabase._Cast_MaterialsSettingsDatabase':
