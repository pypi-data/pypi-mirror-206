...
class ShaftCreationOptions(_0.APIBase):
    ...
    class _Cast_ShaftCreationOptions:
        ...
        def __init__(self, parent: 'ShaftCreationOptions'):
            self._parent = parent

        @property
        def shaft_creation_options(self) -> 'ShaftCreationOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftCreationOptions._Cast_ShaftCreationOptions':
        return self._Cast_ShaftCreationOptions(self)
