...
class StraightBevelSunGearAdvancedSystemDeflection(_7343.StraightBevelDiffGearAdvancedSystemDeflection):
    """StraightBevelSunGearAdvancedSystemDeflection
    ...
    class _Cast_StraightBevelSunGearAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'StraightBevelSunGearAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def straight_bevel_sun_gear_advanced_system_deflection(self) -> 'StraightBevelSunGearAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelSunGearAdvancedSystemDeflection._Cast_StraightBevelSunGearAdvancedSystemDeflection':
