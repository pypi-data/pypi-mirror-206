...
class TextFileDelimiterOptions(_0.APIBase):
    ...
    class _Cast_TextFileDelimiterOptions:
        ...
        def __init__(self, parent: 'TextFileDelimiterOptions'):
            self._parent = parent

        @property
        def text_file_delimiter_options(self) -> 'TextFileDelimiterOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TextFileDelimiterOptions._Cast_TextFileDelimiterOptions':
