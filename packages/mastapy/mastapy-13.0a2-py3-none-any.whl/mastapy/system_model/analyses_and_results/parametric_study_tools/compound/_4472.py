...
class FaceGearMeshCompoundParametricStudyTool(_4477.GearMeshCompoundParametricStudyTool):
    """FaceGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4331.FaceGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4331.FaceGearMeshParametricStudyTool]':
