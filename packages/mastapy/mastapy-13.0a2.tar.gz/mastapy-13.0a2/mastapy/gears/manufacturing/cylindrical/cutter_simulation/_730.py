...
class CylindricalManufacturedVirtualGearInMesh(_0.APIBase):
    ...
    class _Cast_CylindricalManufacturedVirtualGearInMesh:
        ...
        def __init__(self, parent: 'CylindricalManufacturedVirtualGearInMesh'):
            self._parent = parent

        @property
        def cylindrical_manufactured_virtual_gear_in_mesh(self) -> 'CylindricalManufacturedVirtualGearInMesh':
            return self._parent
    ...
    @property
    def virtual_gear(self) -> '_742.VirtualSimulationCalculator':
    ...
    @property
    def cast_to(self) -> 'CylindricalManufacturedVirtualGearInMesh._Cast_CylindricalManufacturedVirtualGearInMesh':
