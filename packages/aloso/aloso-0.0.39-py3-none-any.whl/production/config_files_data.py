...
ExecStart=/home/bacari/Documents/Projects/pythonProject/venv/bin/gunicorn api.server:app -k uvicorn.workers.UvicornWorker --access-logfile /home/bacari/Documents/Projects/pythonProject/logs/access_log.log --error-logfile /home/bacari/Documents/Projects/pythonProject/logs/error_log.log --log-level debug --bind localhost:8015
#ExecStop=kill $(ps aux | grep '[g]unicorn'| awk '{print $2}' | head -n 1)
KillMode=process
...
Wants=portail.service
After=network.target portail.service
...
Group=sudo
WorkingDirectory=/home/bacari/Documents/Projects/pythonProject
ExecStart= watchmedo shell-command --patterns="config.py" --command="kill -HUP $(systemctl status portail |  sed -n 's/.*Main PID: \(.*\)$/\1/g p' | cut -f1 -d' ')" /home/bacari/Documents/Projects/pythonProject
