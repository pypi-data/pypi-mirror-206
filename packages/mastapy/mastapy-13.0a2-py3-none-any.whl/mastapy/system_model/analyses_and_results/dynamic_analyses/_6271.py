...
class ConceptCouplingHalfDynamicAnalysis(_6282.CouplingHalfDynamicAnalysis):
    """ConceptCouplingHalfDynamicAnalysis
    ...
    class _Cast_ConceptCouplingHalfDynamicAnalysis:
        ...
        def __init__(self, parent: 'ConceptCouplingHalfDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_coupling_half_dynamic_analysis(self) -> 'ConceptCouplingHalfDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHalfDynamicAnalysis._Cast_ConceptCouplingHalfDynamicAnalysis':
