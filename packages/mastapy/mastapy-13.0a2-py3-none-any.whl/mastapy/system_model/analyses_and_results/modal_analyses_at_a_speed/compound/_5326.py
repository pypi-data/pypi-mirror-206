...
class StraightBevelGearCompoundModalAnalysisAtASpeed(_5234.BevelGearCompoundModalAnalysisAtASpeed):
    """StraightBevelGearCompoundModalAnalysisAtASpeed
    ...
    class _Cast_StraightBevelGearCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelGearCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_compound_modal_analysis_at_a_speed(self) -> 'StraightBevelGearCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5198.StraightBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5198.StraightBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearCompoundModalAnalysisAtASpeed._Cast_StraightBevelGearCompoundModalAnalysisAtASpeed':
