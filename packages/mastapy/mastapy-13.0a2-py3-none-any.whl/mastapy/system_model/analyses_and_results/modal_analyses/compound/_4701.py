...
class AbstractAssemblyCompoundModalAnalysis(_4780.PartCompoundModalAnalysis):
    """AbstractAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4547.AbstractAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4547.AbstractAssemblyModalAnalysis]':
