...
class PartToPartShearCouplingStabilityAnalysis(_3781.CouplingStabilityAnalysis):
    """PartToPartShearCouplingStabilityAnalysis
    ...
    class _Cast_PartToPartShearCouplingStabilityAnalysis:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_stability_analysis(self) -> 'PartToPartShearCouplingStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingStabilityAnalysis._Cast_PartToPartShearCouplingStabilityAnalysis':
