...
class FEPartCompoundModalAnalysisAtAStiffness(_4962.AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness):
    """FEPartCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_FEPartCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'FEPartCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def fe_part_compound_modal_analysis_at_a_stiffness(self) -> 'FEPartCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4887.FEPartModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4887.FEPartModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'FEPartCompoundModalAnalysisAtAStiffness._Cast_FEPartCompoundModalAnalysisAtAStiffness':
