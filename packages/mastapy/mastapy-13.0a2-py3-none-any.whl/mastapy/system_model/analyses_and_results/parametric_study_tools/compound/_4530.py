...
class StraightBevelSunGearCompoundParametricStudyTool(_4523.StraightBevelDiffGearCompoundParametricStudyTool):
    """StraightBevelSunGearCompoundParametricStudyTool
    ...
    class _Cast_StraightBevelSunGearCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'StraightBevelSunGearCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def straight_bevel_sun_gear_compound_parametric_study_tool(self) -> 'StraightBevelSunGearCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4401.StraightBevelSunGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4401.StraightBevelSunGearParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelSunGearCompoundParametricStudyTool._Cast_StraightBevelSunGearCompoundParametricStudyTool':
