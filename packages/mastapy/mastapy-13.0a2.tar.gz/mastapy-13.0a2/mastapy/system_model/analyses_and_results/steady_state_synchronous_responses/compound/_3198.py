...
class SpringDamperConnectionCompoundSteadyStateSynchronousResponse(_3133.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """SpringDamperConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3065.SpringDamperConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3065.SpringDamperConnectionSteadyStateSynchronousResponse]':
