...
class PowerLoadPowerFlow(_4135.VirtualComponentPowerFlow):
    """PowerLoadPowerFlow
    ...
    class _Cast_PowerLoadPowerFlow:
        ...
        def __init__(self, parent: 'PowerLoadPowerFlow'):
            self._parent = parent
        ...
        @property
        def power_load_power_flow(self) -> 'PowerLoadPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PowerLoadPowerFlow._Cast_PowerLoadPowerFlow':
