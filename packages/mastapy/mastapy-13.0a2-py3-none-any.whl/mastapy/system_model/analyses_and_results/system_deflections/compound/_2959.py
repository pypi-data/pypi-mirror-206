...
class ZerolBevelGearMeshCompoundSystemDeflection(_2847.BevelGearMeshCompoundSystemDeflection):
    """ZerolBevelGearMeshCompoundSystemDeflection
    ...
    class _Cast_ZerolBevelGearMeshCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'ZerolBevelGearMeshCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_mesh_compound_system_deflection(self) -> 'ZerolBevelGearMeshCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2818.ZerolBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2818.ZerolBevelGearMeshSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearMeshCompoundSystemDeflection._Cast_ZerolBevelGearMeshCompoundSystemDeflection':
