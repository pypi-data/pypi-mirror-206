...
class OColor (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().OColor_get_Value(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().OColor_get_Tint(self.Ptr)
        return ret

    @Tint.setter
    def Tint(self, value:float):
        GetDllLibXls().OColor_set_Tint.argtypes=[c_void_p, c_double]
        GetDllLibXls().OColor_set_Tint(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().OColor_get_ColorType(self.Ptr)
    ...
    <returns>A 32-bit signed integer hash code.</returns>
        ...
        ret = GetDllLibXls().OColor_GetHashCode(self.Ptr)
        return ret
    ...
    def SetTheme(self ,themeIndex:int,book:IWorkbook):
        ...
        GetDllLibXls().OColor_SetTheme(self.Ptr, themeIndex,intPtrbook)
    ...
    def SetTheme(self ,themeIndex:int,book:IWorkbook,dTintValue:float):
        ...
        GetDllLibXls().OColor_SetThemeTBD(self.Ptr, themeIndex,intPtrbook,dTintValue)
...
#        ret = GetDllLibXls().OColor_GetThemeColor(self.Ptr, intPtrthemeIndex,intPtrtint)
#        return ret
    ...
    def SetRGB(self ,rgb:'Color',book:'IWorkbook',dTintValue:float):
        ...
        GetDllLibXls().OColor_SetRGB(self.Ptr, intPtrrgb,intPtrbook,dTintValue)
    ...
    <param name="value">Excel color to set.</param>
        ...
        GetDllLibXls().OColor_SetKnownColor(self.Ptr, enumvalue)
    ...
    def GetKnownColor(self ,book:'Workbook')->'ExcelColors':
        ...
        ret = GetDllLibXls().OColor_GetKnownColor(self.Ptr, intPtrbook)
    ...
    def Dispose(self):
        ...
        GetDllLibXls().OColor_Dispose(self.Ptr)
    ...
    <returns>true if the specified Object is equal to the current Object; otherwise, false.</returns>
        ...
        ret = GetDllLibXls().OColor_Equals(self.Ptr, intPtrobj)
        return ret
