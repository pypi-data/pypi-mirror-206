...
class GuideModelUsage(_0.APIBase):
    ...
    class _Cast_GuideModelUsage:
        ...
        def __init__(self, parent: 'GuideModelUsage'):
            self._parent = parent

        @property
        def guide_model_usage(self) -> 'GuideModelUsage':
            return self._parent
    ...
    def alignment_method(self) -> 'GuideModelUsage.AlignmentOptions':
        ...
        value = conversion.pn_to_mp_enum(temp, GuideModelUsage.AlignmentOptions)
    ...
    def alignment_method(self, value: 'GuideModelUsage.AlignmentOptions'):
        ...
        value = conversion.mp_to_pn_enum(value, GuideModelUsage.AlignmentOptions.type_())
    ...
    @property
    def cast_to(self) -> 'GuideModelUsage._Cast_GuideModelUsage':
