...
class ExcelSheetDesignStateSelector(_0.APIBase):
    ...
    class _Cast_ExcelSheetDesignStateSelector:
        ...
        def __init__(self, parent: 'ExcelSheetDesignStateSelector'):
            self._parent = parent

        @property
        def excel_sheet_design_state_selector(self) -> 'ExcelSheetDesignStateSelector':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ExcelSheetDesignStateSelector._Cast_ExcelSheetDesignStateSelector':
