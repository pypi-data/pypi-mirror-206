...
class ConceptCouplingHalfCompoundSystemDeflection(_2869.CouplingHalfCompoundSystemDeflection):
    """ConceptCouplingHalfCompoundSystemDeflection
    ...
    class _Cast_ConceptCouplingHalfCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'ConceptCouplingHalfCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def concept_coupling_half_compound_system_deflection(self) -> 'ConceptCouplingHalfCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2697.ConceptCouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2697.ConceptCouplingHalfSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHalfCompoundSystemDeflection._Cast_ConceptCouplingHalfCompoundSystemDeflection':
