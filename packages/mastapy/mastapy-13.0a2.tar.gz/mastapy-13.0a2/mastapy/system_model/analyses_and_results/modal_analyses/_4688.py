...
from mastapy.system_model.analyses_and_results.modal_analyses import _4687, _4686, _4565
...
class ZerolBevelGearSetModalAnalysis(_4565.BevelGearSetModalAnalysis):
    """ZerolBevelGearSetModalAnalysis
    ...
    class _Cast_ZerolBevelGearSetModalAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetModalAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_modal_analysis(self) -> 'ZerolBevelGearSetModalAnalysis':
            return self._parent
    ...
    @property
    def zerol_bevel_gears_modal_analysis(self) -> 'List[_4687.ZerolBevelGearModalAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis(self) -> 'List[_4686.ZerolBevelGearMeshModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetModalAnalysis._Cast_ZerolBevelGearSetModalAnalysis':
