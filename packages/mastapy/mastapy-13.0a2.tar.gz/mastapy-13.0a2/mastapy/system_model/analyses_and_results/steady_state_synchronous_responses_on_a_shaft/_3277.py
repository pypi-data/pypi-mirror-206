...
class FaceGearMeshSteadyStateSynchronousResponseOnAShaft(_3282.GearMeshSteadyStateSynchronousResponseOnAShaft):
    """FaceGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_FaceGearMeshSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'FaceGearMeshSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def face_gear_mesh_steady_state_synchronous_response_on_a_shaft(self) -> 'FaceGearMeshSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearMeshSteadyStateSynchronousResponseOnAShaft._Cast_FaceGearMeshSteadyStateSynchronousResponseOnAShaft':
