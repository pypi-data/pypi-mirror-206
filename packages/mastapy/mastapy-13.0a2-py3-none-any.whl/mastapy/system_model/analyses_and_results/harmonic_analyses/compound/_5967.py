...
class UnbalancedMassCompoundHarmonicAnalysis(_5968.VirtualComponentCompoundHarmonicAnalysis):
    """UnbalancedMassCompoundHarmonicAnalysis
    ...
    class _Cast_UnbalancedMassCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'UnbalancedMassCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_compound_harmonic_analysis(self) -> 'UnbalancedMassCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5803.UnbalancedMassHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5803.UnbalancedMassHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassCompoundHarmonicAnalysis._Cast_UnbalancedMassCompoundHarmonicAnalysis':
