...
class ConicalGearCompoundMultibodyDynamicsAnalysis(_5557.GearCompoundMultibodyDynamicsAnalysis):
    """ConicalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5383.ConicalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5383.ConicalGearMultibodyDynamicsAnalysis]':
