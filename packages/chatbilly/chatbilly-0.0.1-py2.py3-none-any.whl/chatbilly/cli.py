...
import typer
from chatbilly.api import serve
from chatbilly.core import DATABASE
...
def preflight_checks():
    ...
    if not os.path.exists("index.html"):
        typer.echo("index.html file not found")
        typer.echo("Run `chatbilly init` to create a new index.html file")
        failures += 1
