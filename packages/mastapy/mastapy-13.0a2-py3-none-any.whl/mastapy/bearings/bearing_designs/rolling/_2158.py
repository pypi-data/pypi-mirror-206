...
class ThrustBallBearing(_2125.BallBearing):
    """ThrustBallBearing
    ...
    class _Cast_ThrustBallBearing:
        ...
        def __init__(self, parent: 'ThrustBallBearing'):
            self._parent = parent
        ...
        @property
        def thrust_ball_bearing(self) -> 'ThrustBallBearing':
            return self._parent
    ...
    @property
    def outer_ring_mounting(self) -> '_1874.OuterRingMounting':
        ...
        value = conversion.pn_to_mp_enum(temp, _1874.OuterRingMounting)
        return constructor.new_from_mastapy_type(_1874.OuterRingMounting)(value) if value is not None else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1874.OuterRingMounting'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1874.OuterRingMounting.type_())
    ...
    @property
    def cast_to(self) -> 'ThrustBallBearing._Cast_ThrustBallBearing':
