...
class ClutchHalfHarmonicAnalysis(_5688.CouplingHalfHarmonicAnalysis):
    """ClutchHalfHarmonicAnalysis
    ...
    class _Cast_ClutchHalfHarmonicAnalysis:
        ...
        def __init__(self, parent: 'ClutchHalfHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_half_harmonic_analysis(self) -> 'ClutchHalfHarmonicAnalysis':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2691.ClutchHalfSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'ClutchHalfHarmonicAnalysis._Cast_ClutchHalfHarmonicAnalysis':
