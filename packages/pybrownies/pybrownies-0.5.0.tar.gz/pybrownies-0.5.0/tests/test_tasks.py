...
# will no longer work in Python 3.12. Invoke 2.0.0's loader module
# imports the deprecated "imp" module, which is slated for removal in
# Python 3.12.
# The warning is ignore for now, see [tool.pytest.ini_options].
