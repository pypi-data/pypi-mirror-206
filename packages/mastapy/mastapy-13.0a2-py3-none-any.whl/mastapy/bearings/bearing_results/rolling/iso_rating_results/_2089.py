...
class ISO762006Results(_0.APIBase):
    ...
    class _Cast_ISO762006Results:
        ...
        def __init__(self, parent: 'ISO762006Results'):
            self._parent = parent

        @property
        def iso762006_results(self) -> 'ISO762006Results':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ISO762006Results._Cast_ISO762006Results':
        return self._Cast_ISO762006Results(self)
