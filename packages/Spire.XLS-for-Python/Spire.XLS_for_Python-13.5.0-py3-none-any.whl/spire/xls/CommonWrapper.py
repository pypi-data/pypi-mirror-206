...
class CommonWrapper (  SpireObject, IOptimizedUpdate, ICloneParent) :
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().CommonWrapper_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().CommonWrapper_EndUpdate(self.Ptr)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().CommonWrapper_Clone(self.Ptr, intPtrparent)
