...
class RingPinsHarmonicAnalysis(_5753.MountableComponentHarmonicAnalysis):
    """RingPinsHarmonicAnalysis
    ...
    class _Cast_RingPinsHarmonicAnalysis:
        ...
        def __init__(self, parent: 'RingPinsHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def ring_pins_harmonic_analysis(self) -> 'RingPinsHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RingPinsHarmonicAnalysis._Cast_RingPinsHarmonicAnalysis':
