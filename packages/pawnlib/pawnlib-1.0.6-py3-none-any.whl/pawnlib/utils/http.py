...
class CallHttp:
    ...
    def fetch_response(self):
        ...
        try:
            ...
            # pawn.console.log(self.response.text)
            # # self.response = HttpResponse(self.response.status_code, self.response)
            # self.response = HttpResponse(status_code=self.response.status_code, response=self.response)


            pawn.console.log(f"response_type = {type(self.response)}")
        except Exception as e:
