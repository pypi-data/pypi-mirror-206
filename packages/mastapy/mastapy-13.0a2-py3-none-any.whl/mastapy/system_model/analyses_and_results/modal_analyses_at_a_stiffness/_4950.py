...
class TorqueConverterPumpModalAnalysisAtAStiffness(_4868.CouplingHalfModalAnalysisAtAStiffness):
    """TorqueConverterPumpModalAnalysisAtAStiffness
    ...
    class _Cast_TorqueConverterPumpModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'TorqueConverterPumpModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def torque_converter_pump_modal_analysis_at_a_stiffness(self) -> 'TorqueConverterPumpModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterPumpModalAnalysisAtAStiffness._Cast_TorqueConverterPumpModalAnalysisAtAStiffness':
