...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    class _Cast_GeneralTransmissionProperties:
        ...
        def __init__(self, parent: 'GeneralTransmissionProperties'):
            self._parent = parent

        @property
        def general_transmission_properties(self) -> 'GeneralTransmissionProperties':
            return self._parent
    ...
    def bearing_iso762006_static_safety_factor_limit(self) -> '_255.ISO76StaticSafetyFactorLimits':
        ...
        value = conversion.pn_to_mp_enum(temp, _255.ISO76StaticSafetyFactorLimits)
        return constructor.new_from_mastapy_type(_255.ISO76StaticSafetyFactorLimits)(value) if value is not None else None
    ...
    def bearing_iso762006_static_safety_factor_limit(self, value: '_255.ISO76StaticSafetyFactorLimits'):
        ...
        value = conversion.mp_to_pn_enum(value, _255.ISO76StaticSafetyFactorLimits.type_())
    ...
    @property
    def driven_machine_characteristics(self) -> '_287.WorkingCharacteristics':
        ...
        value = conversion.pn_to_mp_enum(temp, _287.WorkingCharacteristics)
        return constructor.new_from_mastapy_type(_287.WorkingCharacteristics)(value) if value is not None else None

    @driven_machine_characteristics.setter
    def driven_machine_characteristics(self, value: '_287.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _287.WorkingCharacteristics.type_())
        self.wrapped.DrivenMachineCharacteristics = value

    @property
    def driving_machine_characteristics(self) -> '_287.WorkingCharacteristics':
    ...
    def driving_machine_characteristics(self, value: '_287.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _287.WorkingCharacteristics.type_())
    ...
    @property
    def gearing_type(self) -> '_251.GearingTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, _251.GearingTypes)
        return constructor.new_from_mastapy_type(_251.GearingTypes)(value) if value is not None else None

    @gearing_type.setter
    def gearing_type(self, value: '_251.GearingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _251.GearingTypes.type_())
    ...
    @property
    def transmission_application(self) -> '_283.TransmissionApplications':
        ...
        value = conversion.pn_to_mp_enum(temp, _283.TransmissionApplications)
        return constructor.new_from_mastapy_type(_283.TransmissionApplications)(value) if value is not None else None

    @transmission_application.setter
    def transmission_application(self, value: '_283.TransmissionApplications'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _283.TransmissionApplications.type_())
        self.wrapped.TransmissionApplication = value

    @property
    def wind_turbine_standard(self) -> '_286.WindTurbineStandards':
        ...
        value = conversion.pn_to_mp_enum(temp, _286.WindTurbineStandards)
        return constructor.new_from_mastapy_type(_286.WindTurbineStandards)(value) if value is not None else None

    @wind_turbine_standard.setter
    def wind_turbine_standard(self, value: '_286.WindTurbineStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _286.WindTurbineStandards.type_())
    ...
    @property
    def air_properties(self) -> '_239.AirProperties':
    ...
    @property
    def vehicle_dynamics(self) -> '_285.VehicleDynamicsProperties':
    ...
    @property
    def cast_to(self) -> 'GeneralTransmissionProperties._Cast_GeneralTransmissionProperties':
