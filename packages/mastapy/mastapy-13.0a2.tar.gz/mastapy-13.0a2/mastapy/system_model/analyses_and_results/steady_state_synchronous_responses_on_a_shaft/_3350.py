...
class WormGearSteadyStateSynchronousResponseOnAShaft(_3284.GearSteadyStateSynchronousResponseOnAShaft):
    """WormGearSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_WormGearSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'WormGearSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def worm_gear_steady_state_synchronous_response_on_a_shaft(self) -> 'WormGearSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearSteadyStateSynchronousResponseOnAShaft._Cast_WormGearSteadyStateSynchronousResponseOnAShaft':
