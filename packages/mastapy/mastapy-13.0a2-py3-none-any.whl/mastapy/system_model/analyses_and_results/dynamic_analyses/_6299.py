...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6297, _6298, _6304
...
class FaceGearSetDynamicAnalysis(_6304.GearSetDynamicAnalysis):
    """FaceGearSetDynamicAnalysis
    ...
    class _Cast_FaceGearSetDynamicAnalysis:
        ...
        def __init__(self, parent: 'FaceGearSetDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def face_gear_set_dynamic_analysis(self) -> 'FaceGearSetDynamicAnalysis':
            return self._parent
    ...
    @property
    def face_gears_dynamic_analysis(self) -> 'List[_6297.FaceGearDynamicAnalysis]':
    ...
    @property
    def face_meshes_dynamic_analysis(self) -> 'List[_6298.FaceGearMeshDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'FaceGearSetDynamicAnalysis._Cast_FaceGearSetDynamicAnalysis':
