...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3547, _3545, _3488
...
class HypoidGearSetSteadyStateSynchronousResponseAtASpeed(_3488.AGMAGleasonConicalGearSetSteadyStateSynchronousResponseAtASpeed):
    """HypoidGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_HypoidGearSetSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'HypoidGearSetSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_set_steady_state_synchronous_response_at_a_speed(self) -> 'HypoidGearSetSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def hypoid_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3547.HypoidGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def hypoid_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3545.HypoidGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearSetSteadyStateSynchronousResponseAtASpeed._Cast_HypoidGearSetSteadyStateSynchronousResponseAtASpeed':
