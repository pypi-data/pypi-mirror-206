...
from mastapy.electric_machines.load_cases_and_analyses import _1365, _1339, _1347
...
class ElectricMachineLoadCaseBase(_0.APIBase):
    ...
    class _Cast_ElectricMachineLoadCaseBase:
        ...
        def electric_machine_mechanical_load_case(self):
            ...
            return self._parent._cast(_1348.ElectricMachineMechanicalLoadCase)
    ...
    @property
    def analyses(self) -> 'List[_1339.ElectricMachineAnalysis]':
    ...
    def analysis_for(self, setup: '_1259.ElectricMachineSetup') -> '_1339.ElectricMachineAnalysis':
    ...
    def copy_to(self, another_group: '_1347.ElectricMachineLoadCaseGroup') -> 'ElectricMachineLoadCaseBase':
    ...
    def remove_analysis(self, electric_machine_analysis: '_1339.ElectricMachineAnalysis'):
    ...
    def remove_analysis_for(self, setup: '_1259.ElectricMachineSetup'):
