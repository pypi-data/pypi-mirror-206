...
from mastapy.units_and_measurements import _7522
...
class ElectricMachineDataSet(_0.APIBase):
    ...
    class _Cast_ElectricMachineDataSet:
        ...
        def __init__(self, parent: 'ElectricMachineDataSet'):
            self._parent = parent

        @property
        def electric_machine_data_set(self) -> 'ElectricMachineDataSet':
            return self._parent
    ...
    def stator_tooth_moments_amplitude_cut_off(self, value: 'float'):
        self.wrapped.StatorToothMomentsAmplitudeCutOff = float(value) if value else 0.0
    ...
    @property
    def torque_ripple_input_type(self) -> '_6940.TorqueRippleInputType':
        ...
        value = conversion.pn_to_mp_enum(temp, _6940.TorqueRippleInputType)
        return constructor.new_from_mastapy_type(_6940.TorqueRippleInputType)(value) if value is not None else None

    @torque_ripple_input_type.setter
    def torque_ripple_input_type(self, value: '_6940.TorqueRippleInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _6940.TorqueRippleInputType.type_())
    ...
    def add_or_replace_excitation_data_with_amplitudes_phases_and_fe_node(self, harmonic_load_data_type: '_1370.HarmonicLoadDataType', node: '_2365.FESubstructureNode', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_7522.MeasurementType'):
        ...
        harmonic_load_data_type = conversion.mp_to_pn_enum(harmonic_load_data_type, _1370.HarmonicLoadDataType.type_())
        speed = float(speed)
        ...
        fourier_series_measurement_type = conversion.mp_to_pn_enum(fourier_series_measurement_type, _7522.MeasurementType.type_())
    ...
    def add_or_replace_excitation_data_with_fe_node(self, harmonic_load_data_type: '_1370.HarmonicLoadDataType', node: '_2365.FESubstructureNode', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_7522.MeasurementType'):
        """ 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_amplitudes_and_phases(self, harmonic_load_data_type: '_1370.HarmonicLoadDataType', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_7522.MeasurementType'):
        """ 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def add_or_replace_excitation_data(self, harmonic_load_data_type: '_1370.HarmonicLoadDataType', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_7522.MeasurementType'):
        """ 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def multiple_fourier_series_interpolator_for(self, harmonic_load_data_type: '_1370.HarmonicLoadDataType') -> '_1509.MultipleFourierSeriesInterpolator':
    ...
    def multiple_fourier_series_interpolator_for_with_fe_node(self, harmonic_load_data_type: '_1370.HarmonicLoadDataType', node: '_2365.FESubstructureNode') -> '_1509.MultipleFourierSeriesInterpolator':
        """ 'MultipleFourierSeriesInterpolatorFor' is the original name of this method.
    ...
    @property
    def cast_to(self) -> 'ElectricMachineDataSet._Cast_ElectricMachineDataSet':
