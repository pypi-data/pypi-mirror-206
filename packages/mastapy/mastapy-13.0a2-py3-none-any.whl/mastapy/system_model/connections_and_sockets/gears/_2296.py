...
class HypoidGearMesh(_2280.AGMAGleasonConicalGearMesh):
    """HypoidGearMesh
    ...
    @property
    def active_gear_mesh_design(self) -> '_981.HypoidGearMeshDesign':
    ...
    @property
    def hypoid_gear_mesh_design(self) -> '_981.HypoidGearMeshDesign':
