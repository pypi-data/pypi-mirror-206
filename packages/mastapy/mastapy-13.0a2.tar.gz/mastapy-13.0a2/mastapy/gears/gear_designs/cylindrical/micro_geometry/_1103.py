...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1089, _1095
...
class CylindricalGearToothMicroGeometry(_0.APIBase):
    ...
    class _Cast_CylindricalGearToothMicroGeometry:
        ...
        def __init__(self, parent: 'CylindricalGearToothMicroGeometry'):
            self._parent = parent

        @property
        def cylindrical_gear_tooth_micro_geometry(self) -> 'CylindricalGearToothMicroGeometry':
            return self._parent
    ...
    @property
    def gear(self) -> '_1095.CylindricalGearMicroGeometryBase':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearToothMicroGeometry._Cast_CylindricalGearToothMicroGeometry':
