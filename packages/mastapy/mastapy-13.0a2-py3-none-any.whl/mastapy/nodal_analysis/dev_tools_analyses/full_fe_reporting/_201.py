...
from mastapy.fe_tools.vis_tools_visualisation.enums import _1226
...
class CoordinateSystemReporting(_0.APIBase):
    ...
    class _Cast_CoordinateSystemReporting:
        ...
        def __init__(self, parent: 'CoordinateSystemReporting'):
            self._parent = parent

        @property
        def coordinate_system_reporting(self) -> 'CoordinateSystemReporting':
            return self._parent
    ...
    @property
    def type_(self) -> '_1226.CoordinateSystemType':
        ...
        value = conversion.pn_to_mp_enum(temp, _1226.CoordinateSystemType)
        return constructor.new_from_mastapy_type(_1226.CoordinateSystemType)(value) if value is not None else None
    ...
    @property
    def cast_to(self) -> 'CoordinateSystemReporting._Cast_CoordinateSystemReporting':
