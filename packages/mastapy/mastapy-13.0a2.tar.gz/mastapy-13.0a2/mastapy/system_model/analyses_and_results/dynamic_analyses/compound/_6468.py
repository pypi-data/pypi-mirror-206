...
class ShaftCompoundDynamicAnalysis(_6374.AbstractShaftCompoundDynamicAnalysis):
    """ShaftCompoundDynamicAnalysis
    ...
    class _Cast_ShaftCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'ShaftCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def shaft_compound_dynamic_analysis(self) -> 'ShaftCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6339.ShaftDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6339.ShaftDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ShaftCompoundDynamicAnalysis._Cast_ShaftCompoundDynamicAnalysis':
