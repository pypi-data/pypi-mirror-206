...
class ExportTableOptions (SpireObject) :
    ...
    def KeepDataFormat(self)->bool:
        ...
        ret = GetDllLibXls().ExportTableOptions_get_KeepDataFormat(self.Ptr)
        return ret
    ...
    def KeepDataFormat(self, value:bool):
        ...
        GetDllLibXls().ExportTableOptions_set_KeepDataFormat(self.Ptr, value)
    ...
    def ExportColumnNames(self)->bool:
        ...
        ret = GetDllLibXls().ExportTableOptions_get_ExportColumnNames(self.Ptr)
        return ret
    ...
    def ExportColumnNames(self, value:bool):
        ...
        GetDllLibXls().ExportTableOptions_set_ExportColumnNames(self.Ptr, value)
    ...
    def RenameStrategy(self)->'RenameStrategy':
        ...
        ret = GetDllLibXls().ExportTableOptions_get_RenameStrategy(self.Ptr)
    ...
    def RenameStrategy(self, value:'RenameStrategy'):
        ...
        GetDllLibXls().ExportTableOptions_set_RenameStrategy(self.Ptr, value.value)
    ...
    def ComputedFormulaValue(self)->bool:
        ...
        ret = GetDllLibXls().ExportTableOptions_get_ComputedFormulaValue(self.Ptr)
        return ret
    ...
    def ComputedFormulaValue(self, value:bool):
        ...
        GetDllLibXls().ExportTableOptions_set_ComputedFormulaValue(self.Ptr, value)
