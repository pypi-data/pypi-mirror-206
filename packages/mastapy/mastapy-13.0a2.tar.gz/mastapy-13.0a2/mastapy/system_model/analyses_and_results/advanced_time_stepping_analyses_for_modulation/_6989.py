...
class BevelGearAdvancedTimeSteppingAnalysisForModulation(_6976.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation):
    """BevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_BevelGearAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'BevelGearAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def bevel_gear_advanced_time_stepping_analysis_for_modulation(self) -> 'BevelGearAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2687.BevelGearSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'BevelGearAdvancedTimeSteppingAnalysisForModulation._Cast_BevelGearAdvancedTimeSteppingAnalysisForModulation':
