...
class BeltDriveCompoundAdvancedSystemDeflection(_7466.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """BeltDriveCompoundAdvancedSystemDeflection
    ...
    class _Cast_BeltDriveCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'BeltDriveCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def belt_drive_compound_advanced_system_deflection(self) -> 'BeltDriveCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7245.BeltDriveAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7245.BeltDriveAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'BeltDriveCompoundAdvancedSystemDeflection._Cast_BeltDriveCompoundAdvancedSystemDeflection':
