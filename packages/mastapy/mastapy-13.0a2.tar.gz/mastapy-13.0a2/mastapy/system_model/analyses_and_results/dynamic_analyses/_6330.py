...
class PointLoadDynamicAnalysis(_6366.VirtualComponentDynamicAnalysis):
    """PointLoadDynamicAnalysis
    ...
    class _Cast_PointLoadDynamicAnalysis:
        ...
        def __init__(self, parent: 'PointLoadDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def point_load_dynamic_analysis(self) -> 'PointLoadDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PointLoadDynamicAnalysis._Cast_PointLoadDynamicAnalysis':
