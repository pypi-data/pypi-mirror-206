...
class KlingelnbergCycloPalloidHypoidGearMesh(_2299.KlingelnbergCycloPalloidConicalGearMesh):
    """KlingelnbergCycloPalloidHypoidGearMesh
    ...
    @property
    def active_gear_mesh_design(self) -> '_973.KlingelnbergCycloPalloidHypoidGearMeshDesign':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_mesh_design(self) -> '_973.KlingelnbergCycloPalloidHypoidGearMeshDesign':
