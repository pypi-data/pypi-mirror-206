...
class TorqueConverterCompoundParametricStudyTool(_4455.CouplingCompoundParametricStudyTool):
    """TorqueConverterCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4407.TorqueConverterParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4407.TorqueConverterParametricStudyTool]':
