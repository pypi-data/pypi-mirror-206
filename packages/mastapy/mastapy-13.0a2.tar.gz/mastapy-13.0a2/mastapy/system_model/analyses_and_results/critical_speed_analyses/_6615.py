...
class StraightBevelDiffGearCriticalSpeedAnalysis(_6524.BevelGearCriticalSpeedAnalysis):
    """StraightBevelDiffGearCriticalSpeedAnalysis
    ...
    class _Cast_StraightBevelDiffGearCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_critical_speed_analysis(self) -> 'StraightBevelDiffGearCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearCriticalSpeedAnalysis._Cast_StraightBevelDiffGearCriticalSpeedAnalysis':
