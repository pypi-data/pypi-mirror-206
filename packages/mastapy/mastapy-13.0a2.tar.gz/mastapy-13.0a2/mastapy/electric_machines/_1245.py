...
class Coil(_0.APIBase):
    ...
    @property
    def in_slot_layer_index(self) -> 'int':
        """int: 'InSlotLayerIndex' is the original name of this property."""
    ...
    def in_slot_layer_index(self, value: 'int'):
        self.wrapped.InSlotLayerIndex = int(value) if value else 0
    ...
    @property
    def out_slot_layer_index(self) -> 'int':
        """int: 'OutSlotLayerIndex' is the original name of this property."""
    ...
    def out_slot_layer_index(self, value: 'int'):
        self.wrapped.OutSlotLayerIndex = int(value) if value else 0
    ...
    @property
    def parallel_path(self) -> 'int':
        """int: 'ParallelPath' is the original name of this property.
    ...
    @property
    def cast_to(self) -> 'Coil._Cast_Coil':
