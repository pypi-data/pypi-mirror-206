...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    class _Cast_HarmonicAnalysisOptions:
        ...
        def harmonic_analysis_options_for_advanced_time_stepping_analysis_for_modulation(self):
            ...
            return self._parent._cast(_7035.HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation)
    ...
    @property
    def response_cache_level(self) -> '_5766.ResponseCacheLevel':
        ...
        value = conversion.pn_to_mp_enum(temp, _5766.ResponseCacheLevel)
        return constructor.new_from_mastapy_type(_5766.ResponseCacheLevel)(value) if value is not None else None

    @response_cache_level.setter
    def response_cache_level(self, value: '_5766.ResponseCacheLevel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _5766.ResponseCacheLevel.type_())
    ...
    @property
    def excitation_selection(self) -> '_5814.ExcitationSourceSelectionGroup':
    ...
    @property
    def modal_analysis_options(self) -> '_4630.ModalAnalysisOptions':
    ...
    @property
    def stiffness_options(self) -> '_5785.StiffnessOptionsForHarmonicAnalysis':
