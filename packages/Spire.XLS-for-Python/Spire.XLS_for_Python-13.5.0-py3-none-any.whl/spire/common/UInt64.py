...
class UInt64 (SpireObject) :
    ...
    def CompareTo(self ,value:SpireObject)->int:
        ...
        ret = dlllib.UInt64_CompareTo(self.Ptr, intPtrvalue)
        return ret
    ...
    def CompareTo(self ,value:'UInt64')->int:
        ...
        ret = dlllib.UInt64_CompareToV(self.Ptr, intPtrvalue)
        return ret
    ...
    def Equals(self ,obj:SpireObject)->bool:
        ...
        ret = dlllib.UInt64_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def Equals(self ,obj:'UInt64')->bool:
        ...
        ret = dlllib.UInt64_EqualsO(self.Ptr, intPtrobj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = dlllib.UInt64_GetHashCode(self.Ptr)
        return ret
    ...
    def ToString(self)->str:
        ...
        dlllib.UInt64_ToString.restype=c_wchar_p
        ret = dlllib.UInt64_ToString(self.Ptr)
        return ret
...
#        ret = dlllib.UInt64_ToStringP(self.Ptr, intPtrprovider)
#        return ret
#
    ...
    def ToString(self ,format:str)->str:
        ...
        dlllib.UInt64_ToStringF.restype=c_wchar_p
        ret = dlllib.UInt64_ToStringF(self.Ptr, format)
        return ret
...
#        ret = dlllib.UInt64_ToStringFP(self.Ptr, format,intPtrprovider)
#        return ret
#
...
#        intPtr = dlllib.UInt64_ParseSS( s,enumstyle)
#        ret = None if intPtr==None else UInt64(intPtr)
#        return ret
#
...
#        intPtr = dlllib.UInt64_ParseSP( s,intPtrprovider)
#        ret = None if intPtr==None else UInt64(intPtr)
#        return ret
#
...
#        intPtr = dlllib.UInt64_ParseSSP( s,enumstyle,intPtrprovider)
#        ret = None if intPtr==None else UInt64(intPtr)
#        return ret
#
...
#        ret = dlllib.UInt64_TryParse( s,intPtrresult)
#        return ret
...
#        ret = dlllib.UInt64_TryParseSSPR( s,enumstyle,intPtrprovider,intPtrresult)
#        return ret
...
#        ret = dlllib.UInt64_GetTypeCode(self.Ptr)
