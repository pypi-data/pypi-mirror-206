...
class PlanetCarrierAdvancedTimeSteppingAnalysisForModulation(_7051.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    """PlanetCarrierAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_PlanetCarrierAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'PlanetCarrierAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def planet_carrier_advanced_time_stepping_analysis_for_modulation(self) -> 'PlanetCarrierAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2769.PlanetCarrierSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierAdvancedTimeSteppingAnalysisForModulation._Cast_PlanetCarrierAdvancedTimeSteppingAnalysisForModulation':
