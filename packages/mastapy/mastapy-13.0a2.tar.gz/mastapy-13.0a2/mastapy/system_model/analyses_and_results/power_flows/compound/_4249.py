...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4247, _4248, _4160
...
class StraightBevelDiffGearSetCompoundPowerFlow(_4160.BevelGearSetCompoundPowerFlow):
    """StraightBevelDiffGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4119.StraightBevelDiffGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gears_compound_power_flow(self) -> 'List[_4247.StraightBevelDiffGearCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_power_flow(self) -> 'List[_4248.StraightBevelDiffGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4119.StraightBevelDiffGearSetPowerFlow]':
