...
class ConceptCouplingHalfCompoundModalAnalysisAtAStiffness(_4999.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """ConceptCouplingHalfCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_ConceptCouplingHalfCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ConceptCouplingHalfCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def concept_coupling_half_compound_modal_analysis_at_a_stiffness(self) -> 'ConceptCouplingHalfCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4857.ConceptCouplingHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4857.ConceptCouplingHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHalfCompoundModalAnalysisAtAStiffness._Cast_ConceptCouplingHalfCompoundModalAnalysisAtAStiffness':
