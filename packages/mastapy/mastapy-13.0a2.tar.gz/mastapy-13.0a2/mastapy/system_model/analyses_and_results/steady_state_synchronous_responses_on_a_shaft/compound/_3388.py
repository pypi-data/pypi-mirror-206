...
class ConicalGearSetCompoundSteadyStateSynchronousResponseOnAShaft(_3414.GearSetCompoundSteadyStateSynchronousResponseOnAShaft):
    """ConicalGearSetCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_ConicalGearSetCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'ConicalGearSetCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def conical_gear_set_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'ConicalGearSetCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3257.ConicalGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3257.ConicalGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'ConicalGearSetCompoundSteadyStateSynchronousResponseOnAShaft._Cast_ConicalGearSetCompoundSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_ConicalGearSetCompoundSteadyStateSynchronousResponseOnAShaft(self)
