...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import (
    _5854, _5856, _5859, _5866,
    _5865, _5887, _5867, _5872,
    _5877, _5889, _5891, _5895,
    _5902, _5901, _5903, _5910,
    _5917, _5920, _5921, _5922,
    _5924, _5926, _5931, _5932,
    _5933, _5935, _5937, _5942,
    _5941, _5947, _5948, _5953,
    _5956, _5959, _5963, _5967,
    _5971, _5974, _5846
)
...
class AssemblyCompoundHarmonicAnalysis(_5846.AbstractAssemblyCompoundHarmonicAnalysis):
    """AssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5656.AssemblyHarmonicAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_5854.BearingCompoundHarmonicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5856.BeltDriveCompoundHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5859.BevelDifferentialGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5866.BoltedJointCompoundHarmonicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5865.BoltCompoundHarmonicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5887.CVTCompoundHarmonicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5867.ClutchCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5872.ConceptCouplingCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5877.ConceptGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5889.CycloidalAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5891.CycloidalDiscCompoundHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5895.CylindricalGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5902.FEPartCompoundHarmonicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5901.FaceGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5903.FlexiblePinAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5910.HypoidGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5917.KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5920.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5921.MassDiscCompoundHarmonicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5922.MeasurementComponentCompoundHarmonicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5924.OilSealCompoundHarmonicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5926.PartToPartShearCouplingCompoundHarmonicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5931.PlanetCarrierCompoundHarmonicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5932.PointLoadCompoundHarmonicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5933.PowerLoadCompoundHarmonicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5935.RingPinsCompoundHarmonicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5937.RollingRingAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5942.ShaftHubConnectionCompoundHarmonicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5941.ShaftCompoundHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5947.SpiralBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5948.SpringDamperCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5953.StraightBevelDiffGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5956.StraightBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5959.SynchroniserCompoundHarmonicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5963.TorqueConverterCompoundHarmonicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5967.UnbalancedMassCompoundHarmonicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5971.WormGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5974.ZerolBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5656.AssemblyHarmonicAnalysis]':
