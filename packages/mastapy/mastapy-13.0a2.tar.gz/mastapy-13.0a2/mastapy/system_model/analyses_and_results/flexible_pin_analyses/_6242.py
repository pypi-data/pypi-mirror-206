...
class WindTurbineCertificationReport(_6234.CombinationAnalysis):
    """WindTurbineCertificationReport
    ...
    class _Cast_WindTurbineCertificationReport:
        ...
        def __init__(self, parent: 'WindTurbineCertificationReport'):
            self._parent = parent
        ...
        @property
        def wind_turbine_certification_report(self) -> 'WindTurbineCertificationReport':
            return self._parent
    ...
    @property
    def design(self) -> '_2454.RootAssembly':
    ...
    @property
    def extreme_load_case_static_analysis(self) -> '_2779.RootAssemblySystemDeflection':
    ...
    @property
    def ldd_static_analysis(self) -> '_2925.RootAssemblyCompoundSystemDeflection':
    ...
    @property
    def nominal_load_case_static_analysis(self) -> '_2779.RootAssemblySystemDeflection':
    ...
    @property
    def cast_to(self) -> 'WindTurbineCertificationReport._Cast_WindTurbineCertificationReport':
