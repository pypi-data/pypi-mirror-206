...
if TYPE_CHECKING:
    from ..models.account_with_account_numbers import AccountWithAccountNumbers
    from ..models.link_common import LinkCommon


T = TypeVar("T", bound="GetAccountNumbersResponse")
...
class GetAccountNumbersResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for accounts_item_data in _accounts:
            accounts_item = AccountWithAccountNumbers.from_dict(accounts_item_data)

            accounts.append(accounts_item)

        link = LinkCommon.from_dict(d.pop("link"))

        get_account_numbers_response = cls(
            accounts=accounts,
            link=link,
        )

        get_account_numbers_response.additional_properties = d
        return get_account_numbers_response
