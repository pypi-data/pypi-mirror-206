...
class ISO2812007Results(_2090.ISOResults):
    """ISO2812007Results
    ...
    class _Cast_ISO2812007Results:
        ...
        def __init__(self, parent: 'ISO2812007Results'):
            self._parent = parent
        ...
        @property
        def iso2812007_results(self) -> 'ISO2812007Results':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ISO2812007Results._Cast_ISO2812007Results':
