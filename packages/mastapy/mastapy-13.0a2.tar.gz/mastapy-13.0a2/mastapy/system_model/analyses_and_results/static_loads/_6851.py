...
from mastapy.system_model.fe import _2340, _2363
...
class FEPartLoadCase(_6773.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2340.AngleSource':
        ...
        value = conversion.pn_to_mp_enum(temp, _2340.AngleSource)
        return constructor.new_from_mastapy_type(_2340.AngleSource)(value) if value is not None else None
