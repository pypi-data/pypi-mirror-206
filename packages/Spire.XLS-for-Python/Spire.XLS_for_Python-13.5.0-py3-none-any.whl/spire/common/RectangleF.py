...
class RectangleF (SpireObject) :
    ...
    def Location(self)->'PointF':
        ...
        intPtr = dlllib.RectangleF_get_Location(self.Ptr)
    ...
    def Size(self)->'SizeF':
        ...
        intPtr = dlllib.RectangleF_get_Size(self.Ptr)
    ...
    def Right(self)->float:
        ...
        ret = dlllib.RectangleF_get_Right(self.Ptr)
        return ret
    ...
    def Bottom(self)->float:
        ...
        ret = dlllib.RectangleF_get_Bottom(self.Ptr)
        return ret
    ...
    def Inflate(self ,x:float,y:float):
        ...
        dlllib.RectangleF_Inflate(self.Ptr, x,y)
    ...
    def Union(a:'RectangleF',b:'RectangleF')->'RectangleF':
        ...
        intPtr = dlllib.RectangleF_Union( intPtra,intPtrb)
    ...
    def op_Implicit(r:'Rectangle')->'RectangleF':
        ...
        intPtr = dlllib.RectangleF_op_Implicit( intPtrr)
        ret = None if intPtr==None else RectangleF(intPtr)
        return ret
    ...
    def FromLTRB(left:float,top:float,right:float,bottom:float)->'RectangleF':
        ...
        intPtr = dlllib.RectangleF_FromLTRB( left,top,right,bottom)
        ret = None if intPtr==None else RectangleF(intPtr)
        return ret
    ...
    def Location(self, value:'PointF'):
        ...
        dlllib.RectangleF_set_Location(self.Ptr, value.Ptr)

    @Size.setter
    def Size(self, value:'SizeF'):
        dlllib.RectangleF_set_Size.argtypes=[c_void_p, c_void_p]
        dlllib.RectangleF_set_Size(self.Ptr, value.Ptr)
    ...
    def X(self)->float:
        ...
        ret = dlllib.RectangleF_get_X(self.Ptr)
        return ret

    @X.setter
    def X(self, value:float):
        dlllib.RectangleF_set_X.argtypes=[c_void_p, c_float]
        dlllib.RectangleF_set_X(self.Ptr, value)
    ...
    def Y(self)->float:
        ...
        ret = dlllib.RectangleF_get_Y(self.Ptr)
        return ret

    @Y.setter
    def Y(self, value:float):
        dlllib.RectangleF_set_Y.argtypes=[c_void_p, c_float]
        dlllib.RectangleF_set_Y(self.Ptr, value)
    ...
    def Width(self)->float:
        ...
        ret = dlllib.RectangleF_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        dlllib.RectangleF_set_Width.argtypes=[c_void_p, c_float]
        dlllib.RectangleF_set_Width(self.Ptr, value)
    ...
    def Height(self)->float:
        ...
        ret = dlllib.RectangleF_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        dlllib.RectangleF_set_Height.argtypes=[c_void_p, c_float]
        dlllib.RectangleF_set_Height(self.Ptr, value)
    ...
    def Left(self)->float:
        ...
        ret = dlllib.RectangleF_get_Left(self.Ptr)
        return ret
    ...
    def Top(self)->float:
        ...
        ret = dlllib.RectangleF_get_Top(self.Ptr)
        return ret
    ...
    def IsEmpty(self)->bool:
        ...
        ret = dlllib.RectangleF_get_IsEmpty(self.Ptr)
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = dlllib.RectangleF_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def op_Equality(left:'RectangleF',right:'RectangleF')->bool:
        ...
        ret = dlllib.RectangleF_op_Equality( intPtrleft,intPtrright)
        return ret
    ...
    def op_Inequality(left:'RectangleF',right:'RectangleF')->bool:
        ...
        ret = dlllib.RectangleF_op_Inequality( intPtrleft,intPtrright)
        return ret
    ...
    def Contains(self ,x:float,y:float)->bool:
        ...
        ret = dlllib.RectangleF_Contains(self.Ptr, x,y)
        return ret
    ...
    def Contains(self ,pt:PointF)->bool:
        ...
        ret = dlllib.RectangleF_ContainsP(self.Ptr, intPtrpt)
        return ret
    ...
    def Contains(self ,rect:'RectangleF')->bool:
        ...
        ret = dlllib.RectangleF_ContainsR(self.Ptr, intPtrrect)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = dlllib.RectangleF_GetHashCode(self.Ptr)
        return ret
    ...
    def Inflate(self ,size:SizeF):
        ...
        dlllib.RectangleF_InflateS(self.Ptr, intPtrsize)
    ...
    def Inflate(rect:'RectangleF',x:float,y:float)->'RectangleF':
        ...
        intPtr = dlllib.RectangleF_InflateRXY( intPtrrect,x,y)
        ret = None if intPtr==None else RectangleF(intPtr)
        return ret
    ...
    def Intersect(self ,rect:'RectangleF'):
        ...
        dlllib.RectangleF_Intersect(self.Ptr, intPtrrect)
    ...
    def Intersect(a:'RectangleF',b:'RectangleF')->'RectangleF':
        ...
        intPtr = dlllib.RectangleF_IntersectAB( intPtra,intPtrb)
        ret = None if intPtr==None else RectangleF(intPtr)
        return ret
    ...
    def IntersectsWith(self ,rect:'RectangleF')->bool:
        ...
        ret = dlllib.RectangleF_IntersectsWith(self.Ptr, intPtrrect)
        return ret
    ...
    def Offset(self ,pos:PointF):
        ...
        dlllib.RectangleF_Offset(self.Ptr, intPtrpos)
    ...
    def Offset(self ,x:float,y:float):
        ...
        dlllib.RectangleF_OffsetXY(self.Ptr, x,y)
    ...
    def ToString(self)->str:
        ...
        dlllib.RectangleF_ToString.restype=c_wchar_p
        ret = dlllib.RectangleF_ToString(self.Ptr)
        return ret
    ...
    def Empty()->'RectangleF':
        ...
        intPtr = dlllib.RectangleF_Empty()
        ret = None if intPtr==None else RectangleF(intPtr)
        return ret
