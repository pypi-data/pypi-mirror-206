...
class ExternalLink (  XlsObject) :
    ...
    def DataSource(self)->str:
        ...
        GetDllLibXls().ExternalLink_get_DataSource.restype=c_wchar_p
        ret = GetDllLibXls().ExternalLink_get_DataSource(self.Ptr)
        return ret
    ...
    def DataSource(self, value:str):
        ...
        GetDllLibXls().ExternalLink_set_DataSource(self.Ptr, value)
    ...
    def IsReferred(self)->bool:
        ...
        ret = GetDllLibXls().ExternalLink_get_IsReferred(self.Ptr)
        return ret
    ...
    def IsVisible(self)->bool:
        ...
        ret = GetDllLibXls().ExternalLink_get_IsVisible(self.Ptr)
        return ret
    ...
    def AddExternalName(self ,text:str,referTo:str):
        ...
        GetDllLibXls().ExternalLink_AddExternalName(self.Ptr, text,referTo)
