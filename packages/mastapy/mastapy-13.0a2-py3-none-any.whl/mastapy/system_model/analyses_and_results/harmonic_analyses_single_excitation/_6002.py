...
class ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation(_6013.CouplingHalfHarmonicAnalysisOfSingleExcitation):
    """ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def concept_coupling_half_harmonic_analysis_of_single_excitation(self) -> 'ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation._Cast_ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation':
