...
class MagneticVectorPotential(_1594.MeasurementBase):
    """MagneticVectorPotential
    ...
    class _Cast_MagneticVectorPotential:
        ...
        def __init__(self, parent: 'MagneticVectorPotential'):
            self._parent = parent
        ...
        @property
        def magnetic_vector_potential(self) -> 'MagneticVectorPotential':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MagneticVectorPotential._Cast_MagneticVectorPotential':
