...
class BevelGearAdvancedSystemDeflection(_7239.AGMAGleasonConicalGearAdvancedSystemDeflection):
    """BevelGearAdvancedSystemDeflection
    ...
    class _Cast_BevelGearAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'BevelGearAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def bevel_gear_advanced_system_deflection(self) -> 'BevelGearAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearAdvancedSystemDeflection._Cast_BevelGearAdvancedSystemDeflection':
