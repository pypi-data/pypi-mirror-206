...
class RingPinManufacturingError(_0.APIBase):
    ...
    class _Cast_RingPinManufacturingError:
        ...
        def __init__(self, parent: 'RingPinManufacturingError'):
            self._parent = parent

        @property
        def ring_pin_manufacturing_error(self) -> 'RingPinManufacturingError':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RingPinManufacturingError._Cast_RingPinManufacturingError':
