...
class InterferenceFitRating(_1424.ShaftHubConnectionRating):
    """InterferenceFitRating
    ...
    class _Cast_InterferenceFitRating:
        ...
        def __init__(self, parent: 'InterferenceFitRating'):
            self._parent = parent
        ...
        @property
        def interference_fit_rating(self) -> 'InterferenceFitRating':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'InterferenceFitRating._Cast_InterferenceFitRating':
