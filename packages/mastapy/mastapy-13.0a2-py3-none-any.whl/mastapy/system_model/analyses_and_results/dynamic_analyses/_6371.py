...
class ZerolBevelGearMeshDynamicAnalysis(_6260.BevelGearMeshDynamicAnalysis):
    """ZerolBevelGearMeshDynamicAnalysis
    ...
    class _Cast_ZerolBevelGearMeshDynamicAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearMeshDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_mesh_dynamic_analysis(self) -> 'ZerolBevelGearMeshDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearMeshDynamicAnalysis._Cast_ZerolBevelGearMeshDynamicAnalysis':
