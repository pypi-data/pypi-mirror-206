...
class ZerolBevelGearModalAnalysisAtAStiffness(_4847.BevelGearModalAnalysisAtAStiffness):
    """ZerolBevelGearModalAnalysisAtAStiffness
    ...
    class _Cast_ZerolBevelGearModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ZerolBevelGearModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_modal_analysis_at_a_stiffness(self) -> 'ZerolBevelGearModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearModalAnalysisAtAStiffness._Cast_ZerolBevelGearModalAnalysisAtAStiffness':
