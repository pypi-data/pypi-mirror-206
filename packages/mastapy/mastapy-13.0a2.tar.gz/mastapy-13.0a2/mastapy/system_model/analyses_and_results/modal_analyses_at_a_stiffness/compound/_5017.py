...
class FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness(_5058.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def flexible_pin_assembly_compound_modal_analysis_at_a_stiffness(self) -> 'FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4888.FlexiblePinAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4888.FlexiblePinAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness._Cast_FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness':
