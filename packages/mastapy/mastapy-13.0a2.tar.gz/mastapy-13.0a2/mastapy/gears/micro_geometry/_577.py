...
class ProfileModification(_574.Modification):
    """ProfileModification
    ...
    class _Cast_ProfileModification:
        ...
        def __init__(self, parent: 'ProfileModification'):
            self._parent = parent
        ...
        def cylindrical_gear_profile_modification(self):
            ...
            return self._parent._cast(_1099.CylindricalGearProfileModification)
        ...
        def cylindrical_gear_profile_modification_at_face_width_position(self):
            ...
            return self._parent._cast(_1100.CylindricalGearProfileModificationAtFaceWidthPosition)

        @property
        def conical_gear_profile_modification(self):
            from mastapy.gears.gear_designs.conical.micro_geometry import _1169
            
            return self._parent._cast(_1169.ConicalGearProfileModification)

        @property
        def profile_modification(self) -> 'ProfileModification':
            return self._parent
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_root_relief(self) -> '_572.MainProfileReliefEndsAtTheStartOfRootReliefOption':
    ...
    def main_profile_modification_ends_at_the_start_of_root_relief(self, value: '_572.MainProfileReliefEndsAtTheStartOfRootReliefOption'):
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_tip_relief(self) -> '_573.MainProfileReliefEndsAtTheStartOfTipReliefOption':
    ...
    def main_profile_modification_ends_at_the_start_of_tip_relief(self, value: '_573.MainProfileReliefEndsAtTheStartOfTipReliefOption'):
        value = value if value else None
    ...
    @property
    def measured_data(self) -> '_1523.Vector2DListAccessor':
    ...
    def measured_data(self, value: '_1523.Vector2DListAccessor'):
    ...
    @property
    def parabolic_root_relief_starts_tangent_to_main_profile_relief(self) -> '_575.ParabolicRootReliefStartsTangentToMainProfileRelief':
    ...
    def parabolic_root_relief_starts_tangent_to_main_profile_relief(self, value: '_575.ParabolicRootReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
    ...
    @property
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief(self) -> '_576.ParabolicTipReliefStartsTangentToMainProfileRelief':
    ...
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief(self, value: '_576.ParabolicTipReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
    ...
    @property
    def cast_to(self) -> 'ProfileModification._Cast_ProfileModification':
