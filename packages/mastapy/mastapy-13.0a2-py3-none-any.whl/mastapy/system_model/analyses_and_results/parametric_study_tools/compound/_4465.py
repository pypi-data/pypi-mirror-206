...
class CylindricalGearCompoundParametricStudyTool(_4476.GearCompoundParametricStudyTool):
    """CylindricalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4319.CylindricalGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4319.CylindricalGearParametricStudyTool]':
