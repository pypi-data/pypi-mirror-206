...
class FaceGearCompoundSystemDeflection(_2889.GearCompoundSystemDeflection):
    """FaceGearCompoundSystemDeflection
    ...
    class _Cast_FaceGearCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'FaceGearCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def face_gear_compound_system_deflection(self) -> 'FaceGearCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2735.FaceGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2735.FaceGearSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'FaceGearCompoundSystemDeflection._Cast_FaceGearCompoundSystemDeflection':
