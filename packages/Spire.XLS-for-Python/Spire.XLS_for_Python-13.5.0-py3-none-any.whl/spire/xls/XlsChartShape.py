...
class XlsChartShape (  XlsShape, IChartShape) :
    ...
    <summary>
        ...
        GetDllLibXls().XlsChartShape_get_CategoryAxisTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartShape_get_CategoryAxisTitle(self.Ptr)
        return ret
    ...
    def CategoryAxisTitle(self, value:str):
        ...
        GetDllLibXls().XlsChartShape_set_CategoryAxisTitle(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChartShape_get_ValueAxisTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartShape_get_ValueAxisTitle(self.Ptr)
        return ret
    ...
    def ValueAxisTitle(self, value:str):
        ...
        GetDllLibXls().XlsChartShape_set_ValueAxisTitle(self.Ptr, value)
    ...
    def SecondaryCategoryAxisTitle(self)->str:
        ...
        GetDllLibXls().XlsChartShape_get_SecondaryCategoryAxisTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartShape_get_SecondaryCategoryAxisTitle(self.Ptr)
        return ret
    ...
    def SecondaryCategoryAxisTitle(self, value:str):
        ...
        GetDllLibXls().XlsChartShape_set_SecondaryCategoryAxisTitle(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChartShape_get_SecondaryValueAxisTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartShape_get_SecondaryValueAxisTitle(self.Ptr)
        return ret
    ...
    def SecondaryValueAxisTitle(self, value:str):
        ...
        GetDllLibXls().XlsChartShape_set_SecondaryValueAxisTitle(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChartShape_get_SeriesAxisTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartShape_get_SeriesAxisTitle(self.Ptr)
        return ret
    ...
    def SeriesAxisTitle(self, value:str):
        ...
        GetDllLibXls().XlsChartShape_set_SeriesAxisTitle(self.Ptr, value)
    ...
    def Shapes(self)->'IShapes':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_Shapes(self.Ptr)
    ...
    def TextBoxes(self)->'ITextBoxes':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_TextBoxes(self.Ptr)
    ...
    def CheckBoxes(self)->'ICheckBoxes':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_CheckBoxes(self.Ptr)
    ...
    def ComboBoxes(self)->'IComboBoxes':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_ComboBoxes(self.Ptr)
    ...
    def CodeName(self)->str:
        ...
        GetDllLibXls().XlsChartShape_get_CodeName.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartShape_get_CodeName(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartShape_get_IsRightToLeft(self.Ptr)
        return ret
    ...
    def IsRightToLeft(self, value:bool):
        ...
        GetDllLibXls().XlsChartShape_set_IsRightToLeft(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_PrimaryFormats(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_SecondaryFormats(self.Ptr)
        ret = None if intPtr==None else XlsChartFormatCollection(intPtr)
        return ret
    ...
    def AddShapeInChart(self ,type:'ExcelShapeType',placement:'ResizeBehaveType',left:int,top:int,height:int,width:int)->'IShape':
        ...
        intPtr = GetDllLibXls().XlsChartShape_AddShapeInChart(self.Ptr, enumtype,enumplacement,left,top,height,width)
    ...
    def RefreshChart(self):
        ...
        GetDllLibXls().XlsChartShape_RefreshChart(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsChartShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
#        ret = None if intPtr==None else IShape(intPtr)
#        return ret
#
    ...
    def ChartType(self)->'ExcelChartType':
        ...
        ret = GetDllLibXls().XlsChartShape_get_ChartType(self.Ptr)
    ...
    def ChartType(self, value:'ExcelChartType'):
        ...
        GetDllLibXls().XlsChartShape_set_ChartType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_DataRange(self.Ptr)
    ...
    def DataRange(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsChartShape_set_DataRange(self.Ptr, value.Ptr)
    ...
    def SeriesDataFromRange(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartShape_get_SeriesDataFromRange(self.Ptr)
        return ret
    ...
    def SeriesDataFromRange(self, value:bool):
        ...
        GetDllLibXls().XlsChartShape_set_SeriesDataFromRange(self.Ptr, value)
    ...
    def PageSetup(self)->'IChartPageSetup':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_PageSetup(self.Ptr)
    ...
    def XPos(self)->float:
        ...
        ret = GetDllLibXls().XlsChartShape_get_XPos(self.Ptr)
        return ret

    @XPos.setter
    def XPos(self, value:float):
        GetDllLibXls().XlsChartShape_set_XPos.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartShape_set_XPos(self.Ptr, value)
    ...
    def YPos(self)->float:
        ...
        ret = GetDllLibXls().XlsChartShape_get_YPos(self.Ptr)
        return ret

    @YPos.setter
    def YPos(self, value:float):
        GetDllLibXls().XlsChartShape_set_YPos.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartShape_set_YPos(self.Ptr, value)
    ...
    def PrimaryCategoryAxis(self)->'IChartCategoryAxis':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_PrimaryCategoryAxis(self.Ptr)
    ...
    def PrimaryValueAxis(self)->'IChartValueAxis':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_PrimaryValueAxis(self.Ptr)
    ...
    def PrimarySerieAxis(self)->'IChartSeriesAxis':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_PrimarySerieAxis(self.Ptr)
    ...
    def SecondaryCategoryAxis(self)->'IChartCategoryAxis':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_SecondaryCategoryAxis(self.Ptr)
        ret = None if intPtr==None else IChartCategoryAxis(intPtr)
        return ret
    ...
    def SecondaryValueAxis(self)->'IChartValueAxis':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_SecondaryValueAxis(self.Ptr)
        ret = None if intPtr==None else IChartValueAxis(intPtr)
        return ret
    ...
    def ChartArea(self)->'IChartFrameFormat':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_ChartArea(self.Ptr)
    ...
    def PlotArea(self)->'IChartFrameFormat':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_PlotArea(self.Ptr)
        ret = None if intPtr==None else XlsChartFrameFormat(intPtr)
        return ret
    ...
    def Walls(self)->'IChartWallOrFloor':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_Walls(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartShape_get_SupportWallsAndFloor(self.Ptr)
        return ret
    ...
    def Floor(self)->'IChartWallOrFloor':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_Floor(self.Ptr)
        ret = None if intPtr==None else IChartWallOrFloor(intPtr)
        return ret
    ...
    def DataTable(self)->'IChartDataTable':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_DataTable(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartShape_get_HasChartTitle(self.Ptr)
        return ret
    ...
    def HasChartTitle(self, value:bool):
        ...
        GetDllLibXls().XlsChartShape_set_HasChartTitle(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartShape_get_HasChartArea(self.Ptr)
        return ret

    @HasChartArea.setter
    def HasChartArea(self, value:bool):
        GetDllLibXls().XlsChartShape_set_HasChartArea.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartShape_set_HasChartArea(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartShape_get_HasDataTable(self.Ptr)
        return ret

    @HasDataTable.setter
    def HasDataTable(self, value:bool):
        GetDllLibXls().XlsChartShape_set_HasDataTable.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartShape_set_HasDataTable(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartShape_get_HasFloor(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartShape_get_HasWalls(self.Ptr)
        return ret
    ...
    def Legend(self)->'IChartLegend':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_Legend(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartShape_get_HasLegend(self.Ptr)
        return ret

    @HasLegend.setter
    def HasLegend(self, value:bool):
        GetDllLibXls().XlsChartShape_set_HasLegend.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartShape_set_HasLegend(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartShape_get_HasPivotTable(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartShape_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:int):
        GetDllLibXls().XlsChartShape_set_Rotation.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartShape_set_Rotation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartShape_get_Elevation(self.Ptr)
        return ret

    @Elevation.setter
    def Elevation(self, value:int):
        GetDllLibXls().XlsChartShape_set_Elevation.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartShape_set_Elevation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartShape_get_Perspective(self.Ptr)
        return ret

    @Perspective.setter
    def Perspective(self, value:int):
        GetDllLibXls().XlsChartShape_set_Perspective.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartShape_set_Perspective(self.Ptr, value)
    ...
    def DepthPercent(self)->int:
        ...
        ret = GetDllLibXls().XlsChartShape_get_DepthPercent(self.Ptr)
        return ret

    @DepthPercent.setter
    def DepthPercent(self, value:int):
        GetDllLibXls().XlsChartShape_set_DepthPercent.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartShape_set_DepthPercent(self.Ptr, value)
    ...
    def GapDepth(self)->int:
        ...
        ret = GetDllLibXls().XlsChartShape_get_GapDepth(self.Ptr)
        return ret

    @GapDepth.setter
    def GapDepth(self, value:int):
        GetDllLibXls().XlsChartShape_set_GapDepth.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartShape_set_GapDepth(self.Ptr, value)
    ...
    def RightAngleAxes(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartShape_get_RightAngleAxes(self.Ptr)
        return ret
    ...
    def RightAngleAxes(self, value:bool):
        ...
        GetDllLibXls().XlsChartShape_set_RightAngleAxes(self.Ptr, value)
    ...
    def AutoScaling(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartShape_get_AutoScaling(self.Ptr)
        return ret

    @AutoScaling.setter
    def AutoScaling(self, value:bool):
        GetDllLibXls().XlsChartShape_set_AutoScaling.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartShape_set_AutoScaling(self.Ptr, value)
    ...
    def WallsAndGridlines2D(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartShape_get_WallsAndGridlines2D(self.Ptr)
        return ret
    ...
    def WallsAndGridlines2D(self, value:bool):
        ...
        GetDllLibXls().XlsChartShape_set_WallsAndGridlines2D(self.Ptr, value)
    ...
    def HasPlotArea(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartShape_get_HasPlotArea(self.Ptr)
        return ret

    @HasPlotArea.setter
    def HasPlotArea(self, value:bool):
        GetDllLibXls().XlsChartShape_set_HasPlotArea.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartShape_set_HasPlotArea(self.Ptr, value)
    ...
    def DisplayBlanksAs(self)->'ChartPlotEmptyType':
        ...
        ret = GetDllLibXls().XlsChartShape_get_DisplayBlanksAs(self.Ptr)
    ...
    def DisplayBlanksAs(self, value:'ChartPlotEmptyType'):
        ...
        GetDllLibXls().XlsChartShape_set_DisplayBlanksAs(self.Ptr, value.value)
    ...
    def PlotVisibleOnly(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartShape_get_PlotVisibleOnly(self.Ptr)
        return ret
    ...
    def PlotVisibleOnly(self, value:bool):
        ...
        GetDllLibXls().XlsChartShape_set_PlotVisibleOnly(self.Ptr, value)
    ...
    def SizeWithWindow(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartShape_get_SizeWithWindow(self.Ptr)
        return ret
    ...
    def SizeWithWindow(self, value:bool):
        ...
        GetDllLibXls().XlsChartShape_set_SizeWithWindow(self.Ptr, value)
    ...
    def PivotTable(self)->'PivotTable':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_PivotTable(self.Ptr)
    ...
    def PivotTable(self, value:'PivotTable'):
        ...
        GetDllLibXls().XlsChartShape_set_PivotTable(self.Ptr, value.Ptr)
    ...
    def PivotChartType(self)->'ExcelChartType':
        ...
        ret = GetDllLibXls().XlsChartShape_get_PivotChartType(self.Ptr)
        objwraped = ExcelChartType(ret)
        return objwraped
    ...
    def PivotChartType(self, value:'ExcelChartType'):
        ...
        GetDllLibXls().XlsChartShape_set_PivotChartType(self.Ptr, value.value)
    ...
    def DisplayEntireFieldButtons(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartShape_get_DisplayEntireFieldButtons(self.Ptr)
        return ret
    ...
    def DisplayEntireFieldButtons(self, value:bool):
        ...
        GetDllLibXls().XlsChartShape_set_DisplayEntireFieldButtons(self.Ptr, value)
    ...
    def DisplayValueFieldButtons(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartShape_get_DisplayValueFieldButtons(self.Ptr)
        return ret
    ...
    def DisplayValueFieldButtons(self, value:bool):
        ...
        GetDllLibXls().XlsChartShape_set_DisplayValueFieldButtons(self.Ptr, value)
    ...
    def DisplayAxisFieldButtons(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartShape_get_DisplayAxisFieldButtons(self.Ptr)
        return ret
    ...
    def DisplayAxisFieldButtons(self, value:bool):
        ...
        GetDllLibXls().XlsChartShape_set_DisplayAxisFieldButtons(self.Ptr, value)
    ...
    def DisplayLegendFieldButtons(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartShape_get_DisplayLegendFieldButtons(self.Ptr)
        return ret
    ...
    def DisplayLegendFieldButtons(self, value:bool):
        ...
        GetDllLibXls().XlsChartShape_set_DisplayLegendFieldButtons(self.Ptr, value)
    ...
    def ShowReportFilterFieldButtons(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartShape_get_ShowReportFilterFieldButtons(self.Ptr)
        return ret
    ...
    def ShowReportFilterFieldButtons(self, value:bool):
        ...
        GetDllLibXls().XlsChartShape_set_ShowReportFilterFieldButtons(self.Ptr, value)
    ...
    def TopRow(self)->int:
        ...
        ret = GetDllLibXls().XlsChartShape_get_TopRow(self.Ptr)
        return ret

    @TopRow.setter
    def TopRow(self, value:int):
        GetDllLibXls().XlsChartShape_set_TopRow.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartShape_set_TopRow(self.Ptr, value)
    ...
    def BottomRow(self)->int:
        ...
        ret = GetDllLibXls().XlsChartShape_get_BottomRow(self.Ptr)
        return ret

    @BottomRow.setter
    def BottomRow(self, value:int):
        GetDllLibXls().XlsChartShape_set_BottomRow.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartShape_set_BottomRow(self.Ptr, value)
    ...
    def LeftColumn(self)->int:
        ...
        ret = GetDllLibXls().XlsChartShape_get_LeftColumn(self.Ptr)
        return ret

    @LeftColumn.setter
    def LeftColumn(self, value:int):
        GetDllLibXls().XlsChartShape_set_LeftColumn.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartShape_set_LeftColumn(self.Ptr, value)
    ...
    def RightColumn(self)->int:
        ...
        ret = GetDllLibXls().XlsChartShape_get_RightColumn(self.Ptr)
        return ret

    @RightColumn.setter
    def RightColumn(self, value:int):
        GetDllLibXls().XlsChartShape_set_RightColumn.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartShape_set_RightColumn(self.Ptr, value)
    ...
    def ChartTitleArea(self)->'IChartTextArea':
        ...
        intPtr = GetDllLibXls().XlsChartShape_get_ChartTitleArea(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChartShape_get_ChartSubTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartShape_get_ChartSubTitle(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsChartShape_get_ChartTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartShape_get_ChartTitle(self.Ptr)
        return ret

    @ChartTitle.setter
    def ChartTitle(self, value:str):
        GetDllLibXls().XlsChartShape_set_ChartTitle.argtypes=[c_void_p, c_wchar_p]
        GetDllLibXls().XlsChartShape_set_ChartTitle(self.Ptr, value)
