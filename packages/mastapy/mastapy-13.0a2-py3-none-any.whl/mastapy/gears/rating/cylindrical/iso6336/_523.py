...
class ToothFlankFractureAnalysisPoint(_0.APIBase):
    ...
    class _Cast_ToothFlankFractureAnalysisPoint:
        ...
        def __init__(self, parent: 'ToothFlankFractureAnalysisPoint'):
            self._parent = parent

        @property
        def tooth_flank_fracture_analysis_point(self) -> 'ToothFlankFractureAnalysisPoint':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ToothFlankFractureAnalysisPoint._Cast_ToothFlankFractureAnalysisPoint':
