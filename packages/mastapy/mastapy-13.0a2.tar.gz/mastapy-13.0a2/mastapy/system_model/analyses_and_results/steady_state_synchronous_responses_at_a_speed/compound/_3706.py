...
class RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3678.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def rolling_ring_connection_compound_steady_state_synchronous_response_at_a_speed(self) -> 'RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3575.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3575.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed._Cast_RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(self)
