...
class StraightBevelSunGearSteadyStateSynchronousResponseAtASpeed(_3591.StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelSunGearSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_StraightBevelSunGearSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelSunGearSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_sun_gear_steady_state_synchronous_response_at_a_speed(self) -> 'StraightBevelSunGearSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelSunGearSteadyStateSynchronousResponseAtASpeed._Cast_StraightBevelSunGearSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_StraightBevelSunGearSteadyStateSynchronousResponseAtASpeed(self)
