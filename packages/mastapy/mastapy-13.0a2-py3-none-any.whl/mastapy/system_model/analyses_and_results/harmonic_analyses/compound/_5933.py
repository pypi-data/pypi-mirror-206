...
class PowerLoadCompoundHarmonicAnalysis(_5968.VirtualComponentCompoundHarmonicAnalysis):
    """PowerLoadCompoundHarmonicAnalysis
    ...
    class _Cast_PowerLoadCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'PowerLoadCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def power_load_compound_harmonic_analysis(self) -> 'PowerLoadCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5764.PowerLoadHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5764.PowerLoadHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PowerLoadCompoundHarmonicAnalysis._Cast_PowerLoadCompoundHarmonicAnalysis':
