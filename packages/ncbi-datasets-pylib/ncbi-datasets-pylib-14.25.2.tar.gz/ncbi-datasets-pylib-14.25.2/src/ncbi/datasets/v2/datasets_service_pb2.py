...
_DATASETDOWNLOAD = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetFeatureDatasetStream',
    full_name='ncbi.datasets.v2.DatasetDownload.GetFeatureDatasetStream',
    index=4,
    containing_service=None,
    input_type=ncbi_dot_datasets_dot_v2_dot_datasets__pb2._FEATUREDATASETREQUEST,
    output_type=google_dot_protobuf_dot_wrappers__pb2._BYTESVALUE,
    serialized_options=b'\302\360\031\326\003\n\357\001\010\001\"6/v2alpha/genome/accession/{accession}/feature/download*\"Get a feature dataset by accession2\\Download a feature dataset including fasta sequence and a detailed data report by accession.:\030download_feature_packageB\006Genomer\017application/zip\n\341\001\010\002\" /v2alpha/genome/feature/download*\"Get a feature dataset by accession2\\Download a feature dataset including fasta sequence and a detailed data report by accession.: download_feature_package_by_postB\006Genomer\017application/zip',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
