...
class KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse(_3031.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_steady_state_synchronous_response(self) -> 'KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse._Cast_KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse(self)
