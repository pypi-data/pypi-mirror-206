...
class InterMountableComponentConnectionSteadyStateSynchronousResponse(_2997.ConnectionSteadyStateSynchronousResponse):
    """InterMountableComponentConnectionSteadyStateSynchronousResponse
    ...
    class _Cast_InterMountableComponentConnectionSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'InterMountableComponentConnectionSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def inter_mountable_component_connection_steady_state_synchronous_response(self) -> 'InterMountableComponentConnectionSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'InterMountableComponentConnectionSteadyStateSynchronousResponse._Cast_InterMountableComponentConnectionSteadyStateSynchronousResponse':
        return self._Cast_InterMountableComponentConnectionSteadyStateSynchronousResponse(self)
