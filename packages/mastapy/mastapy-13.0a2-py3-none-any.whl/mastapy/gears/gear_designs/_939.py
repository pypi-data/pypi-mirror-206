...
from mastapy.utility.model_validation import _1781
...
class DesignConstraint(_0.APIBase):
    ...
    class _Cast_DesignConstraint:
        ...
        def __init__(self, parent: 'DesignConstraint'):
            self._parent = parent

        @property
        def design_constraint(self) -> 'DesignConstraint':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DesignConstraint._Cast_DesignConstraint':
