...
class ConicalGearCompoundParametricStudyTool(_4476.GearCompoundParametricStudyTool):
    """ConicalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4304.ConicalGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4304.ConicalGearParametricStudyTool]':
