...
class CycloidalDiscCompoundStabilityAnalysis(_3875.AbstractShaftCompoundStabilityAnalysis):
    """CycloidalDiscCompoundStabilityAnalysis
    ...
    class _Cast_CycloidalDiscCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'CycloidalDiscCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_compound_stability_analysis(self) -> 'CycloidalDiscCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3789.CycloidalDiscStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3789.CycloidalDiscStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscCompoundStabilityAnalysis._Cast_CycloidalDiscCompoundStabilityAnalysis':
