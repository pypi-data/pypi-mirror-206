...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4523, _4524, _4436
...
class StraightBevelDiffGearSetCompoundParametricStudyTool(_4436.BevelGearSetCompoundParametricStudyTool):
    """StraightBevelDiffGearSetCompoundParametricStudyTool
    ...
    class _Cast_StraightBevelDiffGearSetCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearSetCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_set_compound_parametric_study_tool(self) -> 'StraightBevelDiffGearSetCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4396.StraightBevelDiffGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gears_compound_parametric_study_tool(self) -> 'List[_4523.StraightBevelDiffGearCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_parametric_study_tool(self) -> 'List[_4524.StraightBevelDiffGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4396.StraightBevelDiffGearSetParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearSetCompoundParametricStudyTool._Cast_StraightBevelDiffGearSetCompoundParametricStudyTool':
