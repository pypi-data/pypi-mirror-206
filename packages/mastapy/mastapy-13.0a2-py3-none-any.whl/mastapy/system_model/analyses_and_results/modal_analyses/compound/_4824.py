...
class WormGearCompoundModalAnalysis(_4759.GearCompoundModalAnalysis):
    """WormGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4684.WormGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4684.WormGearModalAnalysis]':
