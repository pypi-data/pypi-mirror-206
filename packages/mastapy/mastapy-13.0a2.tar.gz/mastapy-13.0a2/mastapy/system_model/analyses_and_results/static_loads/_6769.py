...
from mastapy.system_model.analyses_and_results import (
    _2625, _2620, _2600, _2611,
    _2619, _2603, _2622, _2614,
    _2604, _2621, _2602, _2608,
    _2662, _2599
)
...
from mastapy.system_model.analyses_and_results.load_case_groups import _5631, _5632, _5633
...
class StaticLoadCase(_6768.LoadCase):
    """StaticLoadCase
    ...
    @property
    def system_deflection(self) -> '_2625.SystemDeflectionAnalysis':
    ...
    @property
    def power_flow(self) -> '_2620.PowerFlowAnalysis':
    ...
    @property
    def advanced_system_deflection(self) -> '_2600.AdvancedSystemDeflectionAnalysis':
    ...
    @property
    def parametric_study_tool(self) -> '_2619.ParametricStudyToolAnalysis':
    ...
    @property
    def compound_parametric_study_tool(self) -> '_2603.CompoundParametricStudyToolAnalysis':
    ...
    @property
    def steady_state_synchronous_response(self) -> '_2622.SteadyStateSynchronousResponseAnalysis':
    ...
    @property
    def dynamic_model_for_modal_analysis(self) -> '_2608.DynamicModelForModalAnalysis':
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_337.PlanetaryRatingLoadSharingOption':
    ...
    def planetary_rating_load_sharing_method(self, value: '_337.PlanetaryRatingLoadSharingOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _337.PlanetaryRatingLoadSharingOption.type_())
    ...
    @property
    def advanced_system_deflection_options(self) -> '_7237.AdvancedSystemDeflectionOptions':
    ...
    @property
    def harmonic_analysis_options_for_atsam(self) -> '_5733.HarmonicAnalysisOptions':
    ...
    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2662.TESetUpForDynamicAnalysisOptions':
    ...
    @property
    def clutch_engagements(self) -> 'List[_5631.ClutchEngagementStatus]':
    ...
    @property
    def concept_clutch_engagements(self) -> 'List[_5632.ConceptSynchroGearEngagementStatus]':
    ...
    @property
    def design_state_load_case_group(self) -> '_5633.DesignState':
    ...
    def duplicate(self, new_design_state_group: '_5633.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
