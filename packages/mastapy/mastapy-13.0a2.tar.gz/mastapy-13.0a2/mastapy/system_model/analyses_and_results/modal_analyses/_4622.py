...
from mastapy.system_model.analyses_and_results.modal_analyses import _4621, _4620, _4619
...
class KlingelnbergCycloPalloidHypoidGearSetModalAnalysis(_4619.KlingelnbergCycloPalloidConicalGearSetModalAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetModalAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_modal_analysis(self) -> 'List[_4621.KlingelnbergCycloPalloidHypoidGearModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_modal_analysis(self) -> 'List[_4620.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis]':
