...
class ClutchConnectionAdvancedTimeSteppingAnalysisForModulation(_7011.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """ClutchConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_ClutchConnectionAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'ClutchConnectionAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def clutch_connection_advanced_time_stepping_analysis_for_modulation(self) -> 'ClutchConnectionAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2690.ClutchConnectionSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'ClutchConnectionAdvancedTimeSteppingAnalysisForModulation._Cast_ClutchConnectionAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_ClutchConnectionAdvancedTimeSteppingAnalysisForModulation(self)
