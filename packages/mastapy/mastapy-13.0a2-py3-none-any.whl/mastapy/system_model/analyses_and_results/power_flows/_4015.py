...
class AGMAGleasonConicalGearSetPowerFlow(_4043.ConicalGearSetPowerFlow):
    """AGMAGleasonConicalGearSetPowerFlow
    ...
    class _Cast_AGMAGleasonConicalGearSetPowerFlow:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearSetPowerFlow'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_set_power_flow(self) -> 'AGMAGleasonConicalGearSetPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearSetPowerFlow._Cast_AGMAGleasonConicalGearSetPowerFlow':
