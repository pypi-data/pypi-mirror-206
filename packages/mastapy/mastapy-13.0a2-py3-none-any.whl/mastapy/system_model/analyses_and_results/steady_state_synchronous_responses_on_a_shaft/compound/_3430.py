...
class MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft(_3476.VirtualComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def measurement_component_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3300.MeasurementComponentSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3300.MeasurementComponentSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft._Cast_MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft(self)
