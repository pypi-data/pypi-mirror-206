...
class XlsHyperLink (  XlsObject, IHyperLink, ICloneParent) :
    ...
    def Address(self)->str:
        ...
        GetDllLibXls().XlsHyperLink_get_Address.restype=c_wchar_p
        ret = GetDllLibXls().XlsHyperLink_get_Address(self.Ptr)
        return ret
    ...
    def Address(self, value:str):
        ...
        GetDllLibXls().XlsHyperLink_set_Address(self.Ptr, value)
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().XlsHyperLink_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().XlsHyperLink_get_Name(self.Ptr)
        return ret
    ...
    def Range(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsHyperLink_get_Range(self.Ptr)
    ...
    def Range(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsHyperLink_set_Range(self.Ptr, value.Ptr)
    ...
    def ScreenTip(self)->str:
        ...
        GetDllLibXls().XlsHyperLink_get_ScreenTip.restype=c_wchar_p
        ret = GetDllLibXls().XlsHyperLink_get_ScreenTip(self.Ptr)
        return ret
    ...
    def ScreenTip(self, value:str):
        ...
        GetDllLibXls().XlsHyperLink_set_ScreenTip(self.Ptr, value)
    ...
    def SubAddress(self)->str:
        ...
        GetDllLibXls().XlsHyperLink_get_SubAddress.restype=c_wchar_p
        ret = GetDllLibXls().XlsHyperLink_get_SubAddress(self.Ptr)
        return ret
    ...
    def SubAddress(self, value:str):
        ...
        GetDllLibXls().XlsHyperLink_set_SubAddress(self.Ptr, value)
    ...
    def SetAddress(self ,strAddress:str,bSetText:bool):
        ...
        GetDllLibXls().XlsHyperLink_SetAddress(self.Ptr, strAddress,bSetText)
    ...
    def SetSubAddress(self ,strSubAddress:str):
        ...
        GetDllLibXls().XlsHyperLink_SetSubAddress(self.Ptr, strSubAddress)
    ...
    <summary>
        ...
        GetDllLibXls().XlsHyperLink_get_TextToDisplay.restype=c_wchar_p
        ret = GetDllLibXls().XlsHyperLink_get_TextToDisplay(self.Ptr)
        return ret
    ...
    def TextToDisplay(self, value:str):
        ...
        GetDllLibXls().XlsHyperLink_set_TextToDisplay(self.Ptr, value)
    ...
    def Type(self)->'HyperLinkType':
        ...
        ret = GetDllLibXls().XlsHyperLink_get_Type(self.Ptr)
    ...
    def Type(self, value:'HyperLinkType'):
        ...
        GetDllLibXls().XlsHyperLink_set_Type(self.Ptr, value.value)
    ...
    def FirstRow(self)->int:
        ...
        ret = GetDllLibXls().XlsHyperLink_get_FirstRow(self.Ptr)
        return ret
    ...
    def FirstColumn(self)->int:
        ...
        ret = GetDllLibXls().XlsHyperLink_get_FirstColumn(self.Ptr)
        return ret
    ...
    def LastRow(self)->int:
        ...
        ret = GetDllLibXls().XlsHyperLink_get_LastRow(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsHyperLink_get_UnicodePath.restype=c_wchar_p
        ret = GetDllLibXls().XlsHyperLink_get_UnicodePath(self.Ptr)
        return ret
    ...
    def UnicodePath(self, value:str):
        ...
        GetDllLibXls().XlsHyperLink_set_UnicodePath(self.Ptr, value)
    ...
    def LastColumn(self)->int:
        ...
        ret = GetDllLibXls().XlsHyperLink_get_LastColumn(self.Ptr)
        return ret
    ...
    <returns>A new object that is a copy of this instance.</returns>
        ...
        intPtr = GetDllLibXls().XlsHyperLink_Clone(self.Ptr, intPtrparent)
