...
class ConicalGearMeshCompoundSystemDeflection(_2890.GearMeshCompoundSystemDeflection):
    """ConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2703.ConicalGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2703.ConicalGearMeshSystemDeflection]':
