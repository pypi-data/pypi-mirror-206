...
class PowerLoadSteadyStateSynchronousResponseOnAShaft(_3347.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    """PowerLoadSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_PowerLoadSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'PowerLoadSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def power_load_steady_state_synchronous_response_on_a_shaft(self) -> 'PowerLoadSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PowerLoadSteadyStateSynchronousResponseOnAShaft._Cast_PowerLoadSteadyStateSynchronousResponseOnAShaft':
