...
class CellStyleFlag (SpireObject) :
    ...
    def All(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_All(self.Ptr)
        return ret

    @All.setter
    def All(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_All.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_All(self.Ptr, value)
    ...
    def Borders(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_Borders(self.Ptr)
        return ret

    @Borders.setter
    def Borders(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_Borders.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_Borders(self.Ptr, value)
    ...
    def LeftBorder(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_LeftBorder(self.Ptr)
        return ret

    @LeftBorder.setter
    def LeftBorder(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_LeftBorder.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_LeftBorder(self.Ptr, value)
    ...
    def RightBorder(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_RightBorder(self.Ptr)
        return ret

    @RightBorder.setter
    def RightBorder(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_RightBorder.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_RightBorder(self.Ptr, value)
    ...
    def TopBorder(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_TopBorder(self.Ptr)
        return ret

    @TopBorder.setter
    def TopBorder(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_TopBorder.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_TopBorder(self.Ptr, value)
    ...
    def BottomBorder(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_BottomBorder(self.Ptr)
        return ret

    @BottomBorder.setter
    def BottomBorder(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_BottomBorder.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_BottomBorder(self.Ptr, value)
    ...
    def DiagonalDownBorder(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_DiagonalDownBorder(self.Ptr)
        return ret
    ...
    def DiagonalDownBorder(self, value:bool):
        ...
        GetDllLibXls().CellStyleFlag_set_DiagonalDownBorder(self.Ptr, value)
    ...
    def DiagonalUpBorder(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_DiagonalUpBorder(self.Ptr)
        return ret
    ...
    def DiagonalUpBorder(self, value:bool):
        ...
        GetDllLibXls().CellStyleFlag_set_DiagonalUpBorder(self.Ptr, value)
    ...
    def Font(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_Font(self.Ptr)
        return ret

    @Font.setter
    def Font(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_Font.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_Font(self.Ptr, value)
    ...
    def FontSize(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_FontSize(self.Ptr)
        return ret

    @FontSize.setter
    def FontSize(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_FontSize.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_FontSize(self.Ptr, value)
    ...
    def FontName(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_FontName(self.Ptr)
        return ret

    @FontName.setter
    def FontName(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_FontName.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_FontName(self.Ptr, value)
    ...
    def FontColor(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_FontColor(self.Ptr)
        return ret

    @FontColor.setter
    def FontColor(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_FontColor.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_FontColor(self.Ptr, value)
    ...
    def FontBold(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_FontBold(self.Ptr)
        return ret

    @FontBold.setter
    def FontBold(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_FontBold.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_FontBold(self.Ptr, value)
    ...
    def FontItalic(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_FontItalic(self.Ptr)
        return ret

    @FontItalic.setter
    def FontItalic(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_FontItalic.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_FontItalic(self.Ptr, value)
    ...
    def FontUnderline(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_FontUnderline(self.Ptr)
        return ret
    ...
    def FontUnderline(self, value:bool):
        ...
        GetDllLibXls().CellStyleFlag_set_FontUnderline(self.Ptr, value)
    ...
    def FontStrike(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_FontStrike(self.Ptr)
        return ret

    @FontStrike.setter
    def FontStrike(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_FontStrike.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_FontStrike(self.Ptr, value)
    ...
    def FontScript(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_FontScript(self.Ptr)
        return ret

    @FontScript.setter
    def FontScript(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_FontScript.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_FontScript(self.Ptr, value)
    ...
    def NumberFormat(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_NumberFormat(self.Ptr)
        return ret

    @NumberFormat.setter
    def NumberFormat(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_NumberFormat.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_NumberFormat(self.Ptr, value)
    ...
    def HorizontalAlignment(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_HorizontalAlignment(self.Ptr)
        return ret

    @HorizontalAlignment.setter
    def HorizontalAlignment(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_HorizontalAlignment.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_HorizontalAlignment(self.Ptr, value)
    ...
    def VerticalAlignment(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_VerticalAlignment(self.Ptr)
        return ret

    @VerticalAlignment.setter
    def VerticalAlignment(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_VerticalAlignment.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_VerticalAlignment(self.Ptr, value)
    ...
    def Indent(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_Indent(self.Ptr)
        return ret

    @Indent.setter
    def Indent(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_Indent.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_Indent(self.Ptr, value)
    ...
    def Rotation(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_Rotation.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_Rotation(self.Ptr, value)
    ...
    def WrapText(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_WrapText(self.Ptr)
        return ret

    @WrapText.setter
    def WrapText(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_WrapText.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_WrapText(self.Ptr, value)
    ...
    def ShrinkToFit(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_ShrinkToFit(self.Ptr)
        return ret

    @ShrinkToFit.setter
    def ShrinkToFit(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_ShrinkToFit.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_ShrinkToFit(self.Ptr, value)
    ...
    def TextDirection(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_TextDirection(self.Ptr)
        return ret
    ...
    def TextDirection(self, value:bool):
        ...
        GetDllLibXls().CellStyleFlag_set_TextDirection(self.Ptr, value)
    ...
    def CellShading(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_CellShading(self.Ptr)
        return ret

    @CellShading.setter
    def CellShading(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_CellShading.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_CellShading(self.Ptr, value)
    ...
    def Locked(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_Locked(self.Ptr)
        return ret

    @Locked.setter
    def Locked(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_Locked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_Locked(self.Ptr, value)
    ...
    def HideFormula(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleFlag_get_HideFormula(self.Ptr)
        return ret

    @HideFormula.setter
    def HideFormula(self, value:bool):
        GetDllLibXls().CellStyleFlag_set_HideFormula.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleFlag_set_HideFormula(self.Ptr, value)
