...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4824, _4825, _4761
...
class WormGearSetCompoundModalAnalysis(_4761.GearSetCompoundModalAnalysis):
    """WormGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4685.WormGearSetModalAnalysis]':
    ...
    @property
    def worm_gears_compound_modal_analysis(self) -> 'List[_4824.WormGearCompoundModalAnalysis]':
    ...
    @property
    def worm_meshes_compound_modal_analysis(self) -> 'List[_4825.WormGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4685.WormGearSetModalAnalysis]':
