...
class ListObjectCollection (  IListObjects) :
    """
    ...
    <returns>Newly created object.</returns>
        ...
        intPtr = GetDllLibXls().ListObjectCollection_Create(self.Ptr, name,intPtrrange)
    ...
    def get_Item(self ,name:str)->IListObject:
        ...
        intPtr = GetDllLibXls().ListObjectCollection_get_Item(self.Ptr, name)
        ret = None if intPtr==None else IListObject(intPtr)
        return ret
