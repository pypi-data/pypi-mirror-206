...
class PlanetCarrierCompoundModalAnalysisAtASpeed(_5295.MountableComponentCompoundModalAnalysisAtASpeed):
    """PlanetCarrierCompoundModalAnalysisAtASpeed
    ...
    class _Cast_PlanetCarrierCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'PlanetCarrierCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def planet_carrier_compound_modal_analysis_at_a_speed(self) -> 'PlanetCarrierCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5174.PlanetCarrierModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5174.PlanetCarrierModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierCompoundModalAnalysisAtASpeed._Cast_PlanetCarrierCompoundModalAnalysisAtASpeed':
