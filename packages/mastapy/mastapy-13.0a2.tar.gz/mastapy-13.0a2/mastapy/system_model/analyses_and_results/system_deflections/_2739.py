...
from mastapy.gears.analysis import _1225, _1222
...
class GearSetSystemDeflection(_2785.SpecialisedAssemblySystemDeflection):
    """GearSetSystemDeflection
    ...
    class _Cast_GearSetSystemDeflection:
        ...
        def __init__(self, parent: 'GearSetSystemDeflection'):
            self._parent = parent
        ...
        @property
        def gear_set_system_deflection(self) -> 'GearSetSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4070.GearSetPowerFlow':
    ...
    def analysis_for(self, gear_set_imp_detail: '_1225.GearSetImplementationDetail', gear_set_mode: '_325.GearSetModes') -> '_1222.GearSetImplementationAnalysis':
    ...
    def implementation_detail_results_failed_for(self, gear_set_imp_detail: '_1225.GearSetImplementationDetail', gear_set_mode: '_325.GearSetModes') -> 'bool':
    ...
    def perform_implementation_detail_analysis_with_progress(self, imp_detail: '_1225.GearSetImplementationDetail', gear_set_mode: '_325.GearSetModes', progress: '_7521.TaskProgress', run_all_planetary_meshes: Optional['bool'] = True):
    ...
    def perform_implementation_detail_analysis(self, imp_detail: '_1225.GearSetImplementationDetail', gear_set_mode: '_325.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True):
        """ 'PerformImplementationDetailAnalysis' is the original name of this method.
    ...
    @property
    def cast_to(self) -> 'GearSetSystemDeflection._Cast_GearSetSystemDeflection':
