...
class StraightBevelSunGearCriticalSpeedAnalysis(_6615.StraightBevelDiffGearCriticalSpeedAnalysis):
    """StraightBevelSunGearCriticalSpeedAnalysis
    ...
    class _Cast_StraightBevelSunGearCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelSunGearCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_sun_gear_critical_speed_analysis(self) -> 'StraightBevelSunGearCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelSunGearCriticalSpeedAnalysis._Cast_StraightBevelSunGearCriticalSpeedAnalysis':
