...
class Byte (SpireObject) :
    ...
    def CompareTo(self ,value:SpireObject)->int:
        ...
        ret = dlllib.Byte_CompareTo(self.Ptr, intPtrvalue)
        return ret
    ...
    def CompareTo(self ,value:int)->int:
        ...
        ret = dlllib.Byte_CompareToV(self.Ptr, value)
        return ret
    ...
    def Equals(self ,obj:SpireObject)->bool:
        ...
        ret = dlllib.Byte_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def Equals(self ,obj:int)->bool:
        ...
        ret = dlllib.Byte_EqualsO(self.Ptr, obj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = dlllib.Byte_GetHashCode(self.Ptr)
        return ret
...
#        ret = dlllib.Byte_ParseSS( s,enumstyle)
#        return ret
...
#        ret = dlllib.Byte_ParseSP( s,intPtrprovider)
#        return ret
...
#        ret = dlllib.Byte_ParseSSP( s,enumstyle,intPtrprovider)
#        return ret
...
#        ret = dlllib.Byte_TryParse( s,intPtrresult)
#        return ret
...
#        ret = dlllib.Byte_TryParseSSPR( s,enumstyle,intPtrprovider,intPtrresult)
#        return ret
    ...
    def ToString(self)->str:
        ...
        dlllib.Byte_ToString.restype=c_wchar_p
        ret = dlllib.Byte_ToString(self.Ptr)
        return ret
    ...
    def ToString(self ,format:str)->str:
        ...
        dlllib.Byte_ToStringF.restype=c_wchar_p
        ret = dlllib.Byte_ToStringF(self.Ptr, format)
        return ret
...
#        ret = dlllib.Byte_ToStringP(self.Ptr, intPtrprovider)
#        return ret
#
...
#        ret = dlllib.Byte_ToStringFP(self.Ptr, format,intPtrprovider)
#        return ret
#
...
#        ret = dlllib.Byte_GetTypeCode(self.Ptr)
