...
class SpringDamperConnectionPowerFlow(_4046.CouplingConnectionPowerFlow):
    """SpringDamperConnectionPowerFlow
    ...
    class _Cast_SpringDamperConnectionPowerFlow:
        ...
        def __init__(self, parent: 'SpringDamperConnectionPowerFlow'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_power_flow(self) -> 'SpringDamperConnectionPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionPowerFlow._Cast_SpringDamperConnectionPowerFlow':
