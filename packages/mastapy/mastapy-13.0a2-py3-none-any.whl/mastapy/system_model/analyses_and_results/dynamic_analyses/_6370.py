...
class ZerolBevelGearDynamicAnalysis(_6259.BevelGearDynamicAnalysis):
    """ZerolBevelGearDynamicAnalysis
    ...
    class _Cast_ZerolBevelGearDynamicAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_dynamic_analysis(self) -> 'ZerolBevelGearDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearDynamicAnalysis._Cast_ZerolBevelGearDynamicAnalysis':
