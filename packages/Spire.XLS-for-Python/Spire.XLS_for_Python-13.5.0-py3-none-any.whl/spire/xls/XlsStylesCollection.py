...
class XlsStylesCollection (  CollectionBase[CellStyleObject], IStyles) :
    ...
    <returns></returns>
        ...
        ret = GetDllLibXls().XlsStylesCollection_Contains(self.Ptr, name)
        return ret
    ...
    <param name="styleName">Style to remove.</param>
        ...
        GetDllLibXls().XlsStylesCollection_Remove(self.Ptr, styleName)
    ...
    def get_Item(self ,name:str)->'IStyle':
        ...
        intPtr = GetDllLibXls().XlsStylesCollection_get_Item(self.Ptr, name)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsStylesCollection_Clone(self.Ptr, intPtrparent)
    ...
    def UpdateStyleRecords(self):
        ...
        GetDllLibXls().XlsStylesCollection_UpdateStyleRecords(self.Ptr)
