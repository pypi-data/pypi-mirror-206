...
class InstitutionErrorNotFoundResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        class properties:
            class error_code(schemas.EnumBase, schemas.StrSchema):
                class MetaOapg:
                    enum_value_to_name = {
                        "institution_error.not_found": "INSTITUTION_ERROR_NOT_FOUND",
                    }

                @schemas.classproperty
                def INSTITUTION_ERROR_NOT_FOUND(cls):
                    return cls("institution_error.not_found")
