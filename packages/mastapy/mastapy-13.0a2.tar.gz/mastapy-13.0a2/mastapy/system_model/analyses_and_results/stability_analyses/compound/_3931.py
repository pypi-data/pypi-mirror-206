...
class FlexiblePinAssemblyCompoundStabilityAnalysis(_3972.SpecialisedAssemblyCompoundStabilityAnalysis):
    """FlexiblePinAssemblyCompoundStabilityAnalysis
    ...
    class _Cast_FlexiblePinAssemblyCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'FlexiblePinAssemblyCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def flexible_pin_assembly_compound_stability_analysis(self) -> 'FlexiblePinAssemblyCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3800.FlexiblePinAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3800.FlexiblePinAssemblyStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'FlexiblePinAssemblyCompoundStabilityAnalysis._Cast_FlexiblePinAssemblyCompoundStabilityAnalysis':
