...
class FlankMeasurementBorder(_0.APIBase):
    ...
    class _Cast_FlankMeasurementBorder:
        ...
        def __init__(self, parent: 'FlankMeasurementBorder'):
            self._parent = parent

        @property
        def flank_measurement_border(self) -> 'FlankMeasurementBorder':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FlankMeasurementBorder._Cast_FlankMeasurementBorder':
