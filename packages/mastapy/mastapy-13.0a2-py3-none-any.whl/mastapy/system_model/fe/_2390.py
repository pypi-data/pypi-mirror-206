...
from mastapy.system_model.fe import _2384, _2385
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    class _Cast_SystemDeflectionFEExportOptions:
        ...
        def __init__(self, parent: 'SystemDeflectionFEExportOptions'):
            self._parent = parent

        @property
        def system_deflection_fe_export_options(self) -> 'SystemDeflectionFEExportOptions':
            return self._parent
    ...
    def file_type(self) -> 'SystemDeflectionFEExportOptions.ExportType':
        ...
        value = conversion.pn_to_mp_enum(temp, SystemDeflectionFEExportOptions.ExportType)
    ...
    def file_type(self, value: 'SystemDeflectionFEExportOptions.ExportType'):
        ...
        value = conversion.mp_to_pn_enum(value, SystemDeflectionFEExportOptions.ExportType.type_())
    ...
    @property
    def links(self) -> 'List[_2384.PerLinkExportOptions]':
    ...
    @property
    def nodes(self) -> 'List[_2385.PerNodeExportOptions]':
    ...
    @property
    def cast_to(self) -> 'SystemDeflectionFEExportOptions._Cast_SystemDeflectionFEExportOptions':
