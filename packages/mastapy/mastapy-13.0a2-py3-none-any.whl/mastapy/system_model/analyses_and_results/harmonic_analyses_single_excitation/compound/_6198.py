...
class RollingRingConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6170.InterMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """RollingRingConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6068.RollingRingConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6068.RollingRingConnectionHarmonicAnalysisOfSingleExcitation]':
