...
class SynchroniserHalfCompoundModalAnalysis(_4816.SynchroniserPartCompoundModalAnalysis):
    """SynchroniserHalfCompoundModalAnalysis
    ...
    class _Cast_SynchroniserHalfCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserHalfCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_half_compound_modal_analysis(self) -> 'SynchroniserHalfCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4670.SynchroniserHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4670.SynchroniserHalfModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserHalfCompoundModalAnalysis._Cast_SynchroniserHalfCompoundModalAnalysis':
