...
class FlexiblePinAssemblyParametricStudyTool(_4387.SpecialisedAssemblyParametricStudyTool):
    """FlexiblePinAssemblyParametricStudyTool
    ...
    class _Cast_FlexiblePinAssemblyParametricStudyTool:
        ...
        def __init__(self, parent: 'FlexiblePinAssemblyParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def flexible_pin_assembly_parametric_study_tool(self) -> 'FlexiblePinAssemblyParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FlexiblePinAssemblyParametricStudyTool._Cast_FlexiblePinAssemblyParametricStudyTool':
