...
class UInt32 (SpireObject) :
    ...
    def CompareTo(self ,value:SpireObject)->int:
        ...
        ret = dlllib.UInt32_CompareTo(self.Ptr, intPtrvalue)
        return ret
    ...
    def CompareTo(self ,value:'UInt32')->int:
        ...
        ret = dlllib.UInt32_CompareToV(self.Ptr, intPtrvalue)
        return ret
    ...
    def Equals(self ,obj:SpireObject)->bool:
        ...
        ret = dlllib.UInt32_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def Equals(self ,obj:'UInt32')->bool:
        ...
        ret = dlllib.UInt32_EqualsO(self.Ptr, intPtrobj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = dlllib.UInt32_GetHashCode(self.Ptr)
        return ret
    ...
    def ToString(self)->str:
        ...
        dlllib.UInt32_ToString.restype=c_wchar_p
        ret = dlllib.UInt32_ToString(self.Ptr)
        return ret
...
#        ret = dlllib.UInt32_ToStringP(self.Ptr, intPtrprovider)
#        return ret
#
    ...
    def ToString(self ,format:str)->str:
        ...
        dlllib.UInt32_ToStringF.restype=c_wchar_p
        ret = dlllib.UInt32_ToStringF(self.Ptr, format)
        return ret
...
#        ret = dlllib.UInt32_ToStringFP(self.Ptr, format,intPtrprovider)
#        return ret
#
...
#        intPtr = dlllib.UInt32_ParseSS( s,enumstyle)
#        ret = None if intPtr==None else UInt32(intPtr)
#        return ret
#
...
#        intPtr = dlllib.UInt32_ParseSP( s,intPtrprovider)
#        ret = None if intPtr==None else UInt32(intPtr)
#        return ret
#
...
#        intPtr = dlllib.UInt32_ParseSSP( s,enumstyle,intPtrprovider)
#        ret = None if intPtr==None else UInt32(intPtr)
#        return ret
#
...
#        ret = dlllib.UInt32_TryParse( s,intPtrresult)
#        return ret
...
#        ret = dlllib.UInt32_TryParseSSPR( s,enumstyle,intPtrprovider,intPtrresult)
#        return ret
...
#        ret = dlllib.UInt32_GetTypeCode(self.Ptr)
