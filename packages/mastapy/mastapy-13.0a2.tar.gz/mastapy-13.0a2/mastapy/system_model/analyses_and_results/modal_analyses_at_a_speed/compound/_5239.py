...
class ClutchCompoundModalAnalysisAtASpeed(_5255.CouplingCompoundModalAnalysisAtASpeed):
    """ClutchCompoundModalAnalysisAtASpeed
    ...
    class _Cast_ClutchCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ClutchCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def clutch_compound_modal_analysis_at_a_speed(self) -> 'ClutchCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5112.ClutchModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5112.ClutchModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ClutchCompoundModalAnalysisAtASpeed._Cast_ClutchCompoundModalAnalysisAtASpeed':
