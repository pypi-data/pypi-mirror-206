...
class Format3D (  XlsObject, IFormat3D, ICloneParent) :
    ...
    def BevelTopType(self)->'XLSXChartBevelType':
        ...
        ret = GetDllLibXls().Format3D_get_BevelTopType(self.Ptr)
    ...
    def BevelTopType(self, value:'XLSXChartBevelType'):
        ...
        GetDllLibXls().Format3D_set_BevelTopType(self.Ptr, value.value)
    ...
    def BevelBottomType(self)->'XLSXChartBevelType':
        ...
        ret = GetDllLibXls().Format3D_get_BevelBottomType(self.Ptr)
        objwraped = XLSXChartBevelType(ret)
        return objwraped
    ...
    def BevelBottomType(self, value:'XLSXChartBevelType'):
        ...
        GetDllLibXls().Format3D_set_BevelBottomType(self.Ptr, value.value)
    ...
    def MaterialType(self)->'XLSXChartMaterialType':
        ...
        ret = GetDllLibXls().Format3D_get_MaterialType(self.Ptr)
    ...
    def MaterialType(self, value:'XLSXChartMaterialType'):
        ...
        GetDllLibXls().Format3D_set_MaterialType(self.Ptr, value.value)
    ...
    def LightingType(self)->'XLSXChartLightingType':
        ...
        ret = GetDllLibXls().Format3D_get_LightingType(self.Ptr)
    ...
    def LightingType(self, value:'XLSXChartLightingType'):
        ...
        GetDllLibXls().Format3D_set_LightingType(self.Ptr, value.value)
    ...
    def BevelTopHeight(self)->float:
        ...
        ret = GetDllLibXls().Format3D_get_BevelTopHeight(self.Ptr)
        return ret
    ...
    def BevelTopHeight(self, value:float):
        ...
        GetDllLibXls().Format3D_set_BevelTopHeight(self.Ptr, value)
    ...
    def BevelBottomWidth(self)->float:
        ...
        ret = GetDllLibXls().Format3D_get_BevelBottomWidth(self.Ptr)
        return ret
    ...
    def BevelBottomWidth(self, value:float):
        ...
        GetDllLibXls().Format3D_set_BevelBottomWidth(self.Ptr, value)
    ...
    def BevelBottomHeight(self)->float:
        ...
        ret = GetDllLibXls().Format3D_get_BevelBottomHeight(self.Ptr)
        return ret
    ...
    def BevelBottomHeight(self, value:float):
        ...
        GetDllLibXls().Format3D_set_BevelBottomHeight(self.Ptr, value)
    ...
    def ExtrusionHeight(self)->float:
        ...
        ret = GetDllLibXls().Format3D_get_ExtrusionHeight(self.Ptr)
        return ret
    ...
    def ExtrusionHeight(self, value:float):
        ...
        GetDllLibXls().Format3D_set_ExtrusionHeight(self.Ptr, value)
    ...
    def ExtrusionColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().Format3D_get_ExtrusionColor(self.Ptr)
    ...
    def ExtrusionColor(self, value:'Color'):
        ...
        GetDllLibXls().Format3D_set_ExtrusionColor(self.Ptr, value.Ptr)
    ...
    def ContourWidth(self)->float:
        ...
        ret = GetDllLibXls().Format3D_get_ContourWidth(self.Ptr)
        return ret

    @ContourWidth.setter
    def ContourWidth(self, value:float):
        GetDllLibXls().Format3D_set_ContourWidth.argtypes=[c_void_p, c_double]
        GetDllLibXls().Format3D_set_ContourWidth(self.Ptr, value)
    ...
    def ContourColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().Format3D_get_ContourColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def ContourColor(self, value:'Color'):
        ...
        GetDllLibXls().Format3D_set_ContourColor(self.Ptr, value.Ptr)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().Format3D_Clone(self.Ptr, intPtrparent)
