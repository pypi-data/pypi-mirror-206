...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.5.0 fwBuild=24/04/2023-20:35:55 fwHash=0x8593C75C fwDirty=0 kmodVersion=0.5.0 kmodBuild=26/04/2023-16:17:05 kmodHash=0x9B9FC069 kmodDirty=0 swVersion=0.5.0 swBuild=26/04/2023-16:17:05 swHash=0x9B9FC069 swDirty=0 cfgManVersion=0.2.0 cfgManBuild=26/04/2023-16:17:05 cfgManHash=0x9B9FC069 cfgManDirty=0"
            if build != build_ref:
    ...
    def _set_acq_scope_config(self, slot: int, acq_scope_config: Any) -> None:
        ...
        # SCPI call
        self._write_bin('SLOT{}:ACQ:SCOpe:CONFiguration '.format(slot), json.dumps(acq_scope_config).encode('utf-8'))
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_sequencer_config(self, slot: int, sequencer: int, sequencer_config: Any) -> None:
        """
        ...
        # SCPI call
        self._write_bin('SLOT{}:SEQuencer{}:CONFiguration '.format(slot, sequencer), json.dumps(sequencer_config).encode('utf-8'))
