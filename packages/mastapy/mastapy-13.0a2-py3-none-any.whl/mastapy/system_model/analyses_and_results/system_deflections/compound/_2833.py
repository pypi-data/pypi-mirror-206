...
class AbstractShaftToMountableComponentConnectionCompoundSystemDeflection(_2865.ConnectionCompoundSystemDeflection):
    """AbstractShaftToMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2667.AbstractShaftToMountableComponentConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2667.AbstractShaftToMountableComponentConnectionSystemDeflection]':
