...
class CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed(_3614.AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed):
    """CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3529.CycloidalDiscSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3529.CycloidalDiscSteadyStateSynchronousResponseAtASpeed]':
