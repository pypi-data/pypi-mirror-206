...
class XlsChartFill (  XlsShapeFill, IShapeFill) :
    ...
    def GradientStops(self)->'GradientStops':
        ...
        intPtr = GetDllLibXls().XlsChartFill_get_GradientStops(self.Ptr)
    ...
    def FillType(self)->'ShapeFillType':
        ...
        ret = GetDllLibXls().XlsChartFill_get_FillType(self.Ptr)
    ...
    def FillType(self, value:'ShapeFillType'):
        ...
        GetDllLibXls().XlsChartFill_set_FillType(self.Ptr, value.value)
    ...
    def GradientStyle(self)->'GradientStyleType':
        ...
        ret = GetDllLibXls().XlsChartFill_get_GradientStyle(self.Ptr)
    ...
    def GradientStyle(self, value:'GradientStyleType'):
        ...
        GetDllLibXls().XlsChartFill_set_GradientStyle(self.Ptr, value.value)
    ...
    def GradientVariant(self)->'GradientVariantsType':
        ...
        ret = GetDllLibXls().XlsChartFill_get_GradientVariant(self.Ptr)
    ...
    def GradientVariant(self, value:'GradientVariantsType'):
        ...
        GetDllLibXls().XlsChartFill_set_GradientVariant(self.Ptr, value.value)
    ...
    def TransparencyTo(self)->float:
        ...
        ret = GetDllLibXls().XlsChartFill_get_TransparencyTo(self.Ptr)
        return ret
    ...
    def TransparencyTo(self, value:float):
        ...
        GetDllLibXls().XlsChartFill_set_TransparencyTo(self.Ptr, value)
    ...
    def TransparencyFrom(self)->float:
        ...
        ret = GetDllLibXls().XlsChartFill_get_TransparencyFrom(self.Ptr)
        return ret
    ...
    def TransparencyFrom(self, value:float):
        ...
        GetDllLibXls().XlsChartFill_set_TransparencyFrom(self.Ptr, value)
    ...
    def GradientColorType(self)->'GradientColorType':
        ...
        ret = GetDllLibXls().XlsChartFill_get_GradientColorType(self.Ptr)
    ...
    def GradientColorType(self, value:'GradientColorType'):
        ...
        GetDllLibXls().XlsChartFill_set_GradientColorType(self.Ptr, value.value)
    ...
    def Pattern(self)->'GradientPatternType':
        ...
        ret = GetDllLibXls().XlsChartFill_get_Pattern(self.Ptr)
    ...
    def Pattern(self, value:'GradientPatternType'):
        ...
        GetDllLibXls().XlsChartFill_set_Pattern(self.Ptr, value.value)
    ...
    def Texture(self)->'GradientTextureType':
        ...
        ret = GetDllLibXls().XlsChartFill_get_Texture(self.Ptr)
    ...
    def Texture(self, value:'GradientTextureType'):
        ...
        GetDllLibXls().XlsChartFill_set_Texture(self.Ptr, value.value)
    ...
    def BackColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsChartFill_get_BackColorObject(self.Ptr)
    ...
    def ForeColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsChartFill_get_ForeColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def BackKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsChartFill_get_BackKnownColor(self.Ptr)
    ...
    def BackKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartFill_set_BackKnownColor(self.Ptr, value.value)
    ...
    def ForeKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsChartFill_get_ForeKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def ForeKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartFill_set_ForeKnownColor(self.Ptr, value.value)
    ...
    def BackColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsChartFill_get_BackColor(self.Ptr)
    ...
    def BackColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartFill_set_BackColor(self.Ptr, value.Ptr)
    ...
    def ForeColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsChartFill_get_ForeColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def ForeColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartFill_set_ForeColor(self.Ptr, value.Ptr)
    ...
    def PresetGradientType(self)->'GradientPresetType':
        ...
        ret = GetDllLibXls().XlsChartFill_get_PresetGradientType(self.Ptr)
    ...
    def PresetGradientType(self, value:'GradientPresetType'):
        ...
        GetDllLibXls().XlsChartFill_set_PresetGradientType(self.Ptr, value.value)
    ...
    def Picture(self)->'Image':
        ...
        intPtr = GetDllLibXls().XlsChartFill_get_Picture(self.Ptr)
    ...
    def PictureName(self)->str:
        ...
        GetDllLibXls().XlsChartFill_get_PictureName.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartFill_get_PictureName(self.Ptr)
        return ret
    ...
    def Visible(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFill_get_Visible(self.Ptr)
        return ret

    @Visible.setter
    def Visible(self, value:bool):
        GetDllLibXls().XlsChartFill_set_Visible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFill_set_Visible(self.Ptr, value)
    ...
    def GradientDegree(self)->float:
        ...
        ret = GetDllLibXls().XlsChartFill_get_GradientDegree(self.Ptr)
        return ret
    ...
    def GradientDegree(self, value:float):
        ...
        GetDllLibXls().XlsChartFill_set_GradientDegree(self.Ptr, value)
    ...
    def Transparency(self)->float:
        ...
        ret = GetDllLibXls().XlsChartFill_get_Transparency(self.Ptr)
        return ret

    @Transparency.setter
    def Transparency(self, value:float):
        GetDllLibXls().XlsChartFill_set_Transparency.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartFill_set_Transparency(self.Ptr, value)
    ...
    def CustomPicture(self ,path:str):
        ...
        GetDllLibXls().XlsChartFill_CustomPicture(self.Ptr, path)
    ...
    def CustomPicture(self ,im:Image,name:str):
        ...
        GetDllLibXls().XlsChartFill_CustomPictureIN(self.Ptr, intPtrim,name)
    ...
    def CustomTexture(self ,path:str):
        ...
        GetDllLibXls().XlsChartFill_CustomTexture(self.Ptr, path)
    ...
    def CustomTexture(self ,im:Image,name:str):
        ...
        GetDllLibXls().XlsChartFill_CustomTextureIN(self.Ptr, intPtrim,name)
    ...
    def Patterned(self ,pattern:'GradientPatternType'):
        ...
        GetDllLibXls().XlsChartFill_Patterned(self.Ptr, enumpattern)
    ...
    def PresetGradient(self ,grad:GradientPresetType):
        ...
        GetDllLibXls().XlsChartFill_PresetGradient(self.Ptr, enumgrad)
    ...
    def PresetGradient(self ,grad:GradientPresetType,shadStyle:GradientStyleType):
        ...
        GetDllLibXls().XlsChartFill_PresetGradientGS(self.Ptr, enumgrad,enumshadStyle)
    ...
    def PresetGradient(self ,grad:GradientPresetType,shadStyle:GradientStyleType,shadVar:GradientVariantsType):
        ...
        GetDllLibXls().XlsChartFill_PresetGradientGSS(self.Ptr, enumgrad,enumshadStyle,enumshadVar)
    ...
    def PresetTextured(self ,texture:'GradientTextureType'):
        ...
        GetDllLibXls().XlsChartFill_PresetTextured(self.Ptr, enumtexture)
    ...
    def TwoColorGradient(self):
        ...
        GetDllLibXls().XlsChartFill_TwoColorGradient(self.Ptr)
    ...
    def TwoColorGradient(self ,style:GradientStyleType):
        ...
        GetDllLibXls().XlsChartFill_TwoColorGradientS(self.Ptr, enumstyle)
    ...
    def TwoColorGradient(self ,style:GradientStyleType,variant:GradientVariantsType):
        ...
        GetDllLibXls().XlsChartFill_TwoColorGradientSV(self.Ptr, enumstyle,enumvariant)
    ...
    def OneColorGradient(self):
        ...
        GetDllLibXls().XlsChartFill_OneColorGradient(self.Ptr)
    ...
    def OneColorGradient(self ,style:GradientStyleType):
        ...
        GetDllLibXls().XlsChartFill_OneColorGradientS(self.Ptr, enumstyle)
    ...
    def OneColorGradient(self ,style:GradientStyleType,variant:GradientVariantsType):
        ...
        GetDllLibXls().XlsChartFill_OneColorGradientSV(self.Ptr, enumstyle,enumvariant)
    ...
    def Solid(self):
        ...
        GetDllLibXls().XlsChartFill_Solid(self.Ptr)
...
#        ret = GetDllLibXls().XlsChartFill_GetMetaUnit( enumunit)
...
#        intPtr = GetDllLibXls().XlsChartFill_SerializeMetafile( intPtrpicture)
...
#
    ...
    def PicStretch(self)->'PicStretch':
        ...
        intPtr = GetDllLibXls().XlsChartFill_get_PicStretch(self.Ptr)
    ...
    def PicStretch(self, value:'PicStretch'):
        ...
        GetDllLibXls().XlsChartFill_set_PicStretch(self.Ptr, value.Ptr)
    ...
    def Tile(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFill_get_Tile(self.Ptr)
        return ret

    @Tile.setter
    def Tile(self, value:bool):
        GetDllLibXls().XlsChartFill_set_Tile.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFill_set_Tile(self.Ptr, value)
