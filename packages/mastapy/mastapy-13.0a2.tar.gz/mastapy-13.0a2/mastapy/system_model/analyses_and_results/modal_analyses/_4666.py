...
class StraightBevelGearModalAnalysis(_4564.BevelGearModalAnalysis):
    """StraightBevelGearModalAnalysis
    ...
    class _Cast_StraightBevelGearModalAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearModalAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_modal_analysis(self) -> 'StraightBevelGearModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearModalAnalysis._Cast_StraightBevelGearModalAnalysis':
