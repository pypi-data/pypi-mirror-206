...
class CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation(_7020.CylindricalGearAdvancedTimeSteppingAnalysisForModulation):
    """CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def cylindrical_planet_gear_advanced_time_stepping_analysis_for_modulation(self) -> 'CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation._Cast_CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation(self)
