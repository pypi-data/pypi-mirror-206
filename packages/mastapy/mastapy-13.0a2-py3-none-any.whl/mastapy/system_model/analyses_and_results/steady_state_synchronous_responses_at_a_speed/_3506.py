...
class ClutchSteadyStateSynchronousResponseAtASpeed(_3522.CouplingSteadyStateSynchronousResponseAtASpeed):
    """ClutchSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ClutchSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ClutchSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def clutch_steady_state_synchronous_response_at_a_speed(self) -> 'ClutchSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchSteadyStateSynchronousResponseAtASpeed._Cast_ClutchSteadyStateSynchronousResponseAtASpeed':
