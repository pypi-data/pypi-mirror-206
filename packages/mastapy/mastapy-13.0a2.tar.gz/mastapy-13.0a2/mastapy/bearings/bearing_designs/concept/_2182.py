...
from mastapy.bearings.bearing_designs.concept import _2181, _2183
...
class ConceptAxialClearanceBearing(_2183.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    class _Cast_ConceptAxialClearanceBearing:
        ...
        def __init__(self, parent: 'ConceptAxialClearanceBearing'):
            self._parent = parent
        ...
        @property
        def concept_axial_clearance_bearing(self) -> 'ConceptAxialClearanceBearing':
            return self._parent
    ...
    @property
    def node_position(self) -> '_2181.BearingNodePosition':
        ...
        value = conversion.pn_to_mp_enum(temp, _2181.BearingNodePosition)
        return constructor.new_from_mastapy_type(_2181.BearingNodePosition)(value) if value is not None else None

    @node_position.setter
    def node_position(self, value: '_2181.BearingNodePosition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2181.BearingNodePosition.type_())
    ...
    @property
    def cast_to(self) -> 'ConceptAxialClearanceBearing._Cast_ConceptAxialClearanceBearing':
