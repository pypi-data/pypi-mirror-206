...
class MeasurementComponentCriticalSpeedAnalysis(_6632.VirtualComponentCriticalSpeedAnalysis):
    """MeasurementComponentCriticalSpeedAnalysis
    ...
    class _Cast_MeasurementComponentCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'MeasurementComponentCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def measurement_component_critical_speed_analysis(self) -> 'MeasurementComponentCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MeasurementComponentCriticalSpeedAnalysis._Cast_MeasurementComponentCriticalSpeedAnalysis':
