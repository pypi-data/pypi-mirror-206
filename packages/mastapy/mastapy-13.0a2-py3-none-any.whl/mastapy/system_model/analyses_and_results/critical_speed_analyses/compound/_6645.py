...
class AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis(_6673.ConicalGearSetCompoundCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis
    ...
    class _Cast_AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_set_compound_critical_speed_analysis(self) -> 'AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6514.AGMAGleasonConicalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6514.AGMAGleasonConicalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis._Cast_AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis':
