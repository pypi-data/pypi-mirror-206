...
class SingularDegreeOfFreedomAnalysis(_0.APIBase):
    ...
    class _Cast_SingularDegreeOfFreedomAnalysis:
        ...
        def __init__(self, parent: 'SingularDegreeOfFreedomAnalysis'):
            self._parent = parent

        @property
        def singular_degree_of_freedom_analysis(self) -> 'SingularDegreeOfFreedomAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SingularDegreeOfFreedomAnalysis._Cast_SingularDegreeOfFreedomAnalysis':
