...
class UInt16 (SpireObject) :
    ...
    def CompareTo(self ,value:SpireObject)->int:
        ...
        ret = dlllib.UInt16_CompareTo(self.Ptr, intPtrvalue)
        return ret
    ...
    def CompareTo(self ,value:'UInt16')->int:
        ...
        ret = dlllib.UInt16_CompareToV(self.Ptr, intPtrvalue)
        return ret
    ...
    def Equals(self ,obj:SpireObject)->bool:
        ...
        ret = dlllib.UInt16_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def Equals(self ,obj:'UInt16')->bool:
        ...
        ret = dlllib.UInt16_EqualsO(self.Ptr, intPtrobj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = dlllib.UInt16_GetHashCode(self.Ptr)
        return ret
    ...
    def ToString(self)->str:
        ...
        dlllib.UInt16_ToString.restype=c_wchar_p
        ret = dlllib.UInt16_ToString(self.Ptr)
        return ret
...
#        ret = dlllib.UInt16_ToStringP(self.Ptr, intPtrprovider)
#        return ret
#
    ...
    def ToString(self ,format:str)->str:
        ...
        dlllib.UInt16_ToStringF.restype=c_wchar_p
        ret = dlllib.UInt16_ToStringF(self.Ptr, format)
        return ret
...
#        ret = dlllib.UInt16_ToStringFP(self.Ptr, format,intPtrprovider)
#        return ret
#
...
#        intPtr = dlllib.UInt16_ParseSS( s,enumstyle)
#        ret = None if intPtr==None else UInt16(intPtr)
#        return ret
#
...
#        intPtr = dlllib.UInt16_ParseSP( s,intPtrprovider)
#        ret = None if intPtr==None else UInt16(intPtr)
#        return ret
#
...
#        intPtr = dlllib.UInt16_ParseSSP( s,enumstyle,intPtrprovider)
#        ret = None if intPtr==None else UInt16(intPtr)
#        return ret
#
...
#        ret = dlllib.UInt16_TryParse( s,intPtrresult)
#        return ret
...
#        ret = dlllib.UInt16_TryParseSSPR( s,enumstyle,intPtrprovider,intPtrresult)
#        return ret
...
#        ret = dlllib.UInt16_GetTypeCode(self.Ptr)
