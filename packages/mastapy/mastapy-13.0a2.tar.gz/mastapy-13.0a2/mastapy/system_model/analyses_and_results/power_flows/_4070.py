...
from mastapy.system_model.analyses_and_results.power_flows import _4069, _4068, _4110
...
class GearSetPowerFlow(_4110.SpecialisedAssemblyPowerFlow):
    """GearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4069.GearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4068.GearMeshPowerFlow]':
