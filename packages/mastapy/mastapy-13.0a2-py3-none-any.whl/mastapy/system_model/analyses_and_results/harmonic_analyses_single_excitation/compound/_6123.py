...
class BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6111.AGMAGleasonConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5993.BevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5993.BevelGearSetHarmonicAnalysisOfSingleExcitation]':
