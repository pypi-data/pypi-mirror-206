...
def lines_to_csv_file(lines, directory, headers=None, delimiter=None):
...
def array_to_csv_files(array_in, axis_rows, axis_columns, conditions_of_directories, headers=None, delimiter=None):
...
def n_csv_files_to_array_old(
        ...
        rows=slice(None), columns=slice(None), data_type=None, delimiter=None):
