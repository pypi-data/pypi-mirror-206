...
class BevelDifferentialPlanetGearCompoundModalAnalysis(_4712.BevelDifferentialGearCompoundModalAnalysis):
    """BevelDifferentialPlanetGearCompoundModalAnalysis
    ...
    class _Cast_BevelDifferentialPlanetGearCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialPlanetGearCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_planet_gear_compound_modal_analysis(self) -> 'BevelDifferentialPlanetGearCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4561.BevelDifferentialPlanetGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4561.BevelDifferentialPlanetGearModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialPlanetGearCompoundModalAnalysis._Cast_BevelDifferentialPlanetGearCompoundModalAnalysis':
