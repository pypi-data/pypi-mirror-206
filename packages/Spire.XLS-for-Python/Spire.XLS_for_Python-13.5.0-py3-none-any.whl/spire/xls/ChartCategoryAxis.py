...
class ChartCategoryAxis (  XlsChartCategoryAxis) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartCategoryAxis_get_CategoryLabels(self.Ptr)
    ...
    def CategoryLabels(self, value:'CellRange'):
        ...
        GetDllLibXls().ChartCategoryAxis_set_CategoryLabels(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartCategoryAxis_get_Font(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartCategoryAxis_get_TitleArea(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartCategoryAxis_get_MajorGridLines(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartCategoryAxis_get_MinorGridLines(self.Ptr)
        ret = None if intPtr==None else ChartGridLine(intPtr)
        return ret
