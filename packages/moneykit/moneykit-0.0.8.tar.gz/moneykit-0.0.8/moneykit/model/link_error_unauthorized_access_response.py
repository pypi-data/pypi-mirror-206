...
class LinkErrorUnauthorizedAccessResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        class properties:
            class error_code(schemas.EnumBase, schemas.StrSchema):
                class MetaOapg:
                    enum_value_to_name = {
                        "link_error.unauthorized_access": "LINK_ERROR_UNAUTHORIZED_ACCESS",
                    }

                @schemas.classproperty
                def LINK_ERROR_UNAUTHORIZED_ACCESS(cls):
                    return cls("link_error.unauthorized_access")
