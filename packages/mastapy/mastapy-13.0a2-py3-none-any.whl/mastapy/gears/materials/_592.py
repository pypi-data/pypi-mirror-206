...
class ISOCylindricalGearMaterial(_586.CylindricalGearMaterial):
    """ISOCylindricalGearMaterial
    ...
    class _Cast_ISOCylindricalGearMaterial:
        ...
        def __init__(self, parent: 'ISOCylindricalGearMaterial'):
            self._parent = parent
        ...
        @property
        def iso_cylindrical_gear_material(self) -> 'ISOCylindricalGearMaterial':
            return self._parent
    ...
    @property
    def quality_grade(self) -> '_274.QualityGrade':
        ...
        value = conversion.pn_to_mp_enum(temp, _274.QualityGrade)
        return constructor.new_from_mastapy_type(_274.QualityGrade)(value) if value is not None else None

    @quality_grade.setter
    def quality_grade(self, value: '_274.QualityGrade'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _274.QualityGrade.type_())
    ...
    @property
    def cast_to(self) -> 'ISOCylindricalGearMaterial._Cast_ISOCylindricalGearMaterial':
