...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4894, _4893, _4836
...
class HypoidGearSetModalAnalysisAtAStiffness(_4836.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness):
    """HypoidGearSetModalAnalysisAtAStiffness
    ...
    class _Cast_HypoidGearSetModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'HypoidGearSetModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_set_modal_analysis_at_a_stiffness(self) -> 'HypoidGearSetModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4894.HypoidGearModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4893.HypoidGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearSetModalAnalysisAtAStiffness._Cast_HypoidGearSetModalAnalysisAtAStiffness':
