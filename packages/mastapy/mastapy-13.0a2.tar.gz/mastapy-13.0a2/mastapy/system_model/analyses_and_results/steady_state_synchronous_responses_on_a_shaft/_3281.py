...
class FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft(_3322.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft):
    """FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def flexible_pin_assembly_steady_state_synchronous_response_on_a_shaft(self) -> 'FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft._Cast_FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft':
        return self._Cast_FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft(self)
