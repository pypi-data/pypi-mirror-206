...
class PowerLoadCompoundModalAnalysisAtAStiffness(_5082.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """PowerLoadCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_PowerLoadCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'PowerLoadCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def power_load_compound_modal_analysis_at_a_stiffness(self) -> 'PowerLoadCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4918.PowerLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4918.PowerLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'PowerLoadCompoundModalAnalysisAtAStiffness._Cast_PowerLoadCompoundModalAnalysisAtAStiffness':
