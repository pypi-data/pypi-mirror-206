...
class KlingelnbergCycloPalloidSpiralBevelGearModalAnalysisAtASpeed(_5156.KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed):
    """KlingelnbergCycloPalloidSpiralBevelGearModalAnalysisAtASpeed
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_modal_analysis_at_a_speed(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearModalAnalysisAtASpeed._Cast_KlingelnbergCycloPalloidSpiralBevelGearModalAnalysisAtASpeed':
        return self._Cast_KlingelnbergCycloPalloidSpiralBevelGearModalAnalysisAtASpeed(self)
