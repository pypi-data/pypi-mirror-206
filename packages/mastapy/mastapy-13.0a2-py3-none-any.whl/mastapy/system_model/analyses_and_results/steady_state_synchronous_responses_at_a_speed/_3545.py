...
class HypoidGearMeshSteadyStateSynchronousResponseAtASpeed(_3487.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseAtASpeed):
    """HypoidGearMeshSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_HypoidGearMeshSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'HypoidGearMeshSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_mesh_steady_state_synchronous_response_at_a_speed(self) -> 'HypoidGearMeshSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidGearMeshSteadyStateSynchronousResponseAtASpeed._Cast_HypoidGearMeshSteadyStateSynchronousResponseAtASpeed':
