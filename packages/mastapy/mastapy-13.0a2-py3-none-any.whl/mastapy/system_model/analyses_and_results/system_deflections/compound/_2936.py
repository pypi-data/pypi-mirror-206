...
class SpringDamperHalfCompoundSystemDeflection(_2869.CouplingHalfCompoundSystemDeflection):
    """SpringDamperHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2790.SpringDamperHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2790.SpringDamperHalfSystemDeflection]':
