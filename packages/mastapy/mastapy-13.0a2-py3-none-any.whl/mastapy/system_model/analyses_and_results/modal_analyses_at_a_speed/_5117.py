...
class ConceptCouplingModalAnalysisAtASpeed(_5128.CouplingModalAnalysisAtASpeed):
    """ConceptCouplingModalAnalysisAtASpeed
    ...
    class _Cast_ConceptCouplingModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ConceptCouplingModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def concept_coupling_modal_analysis_at_a_speed(self) -> 'ConceptCouplingModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingModalAnalysisAtASpeed._Cast_ConceptCouplingModalAnalysisAtASpeed':
