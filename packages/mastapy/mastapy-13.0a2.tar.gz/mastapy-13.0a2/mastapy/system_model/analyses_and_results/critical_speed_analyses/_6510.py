...
class AbstractShaftOrHousingCriticalSpeedAnalysis(_6533.ComponentCriticalSpeedAnalysis):
    """AbstractShaftOrHousingCriticalSpeedAnalysis
    ...
    class _Cast_AbstractShaftOrHousingCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'AbstractShaftOrHousingCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def abstract_shaft_or_housing_critical_speed_analysis(self) -> 'AbstractShaftOrHousingCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AbstractShaftOrHousingCriticalSpeedAnalysis._Cast_AbstractShaftOrHousingCriticalSpeedAnalysis':
