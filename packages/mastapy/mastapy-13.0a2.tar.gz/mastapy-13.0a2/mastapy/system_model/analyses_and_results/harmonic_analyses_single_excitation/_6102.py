...
class ZerolBevelGearHarmonicAnalysisOfSingleExcitation(_5991.BevelGearHarmonicAnalysisOfSingleExcitation):
    """ZerolBevelGearHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_ZerolBevelGearHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'ZerolBevelGearHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_harmonic_analysis_of_single_excitation(self) -> 'ZerolBevelGearHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearHarmonicAnalysisOfSingleExcitation._Cast_ZerolBevelGearHarmonicAnalysisOfSingleExcitation':
