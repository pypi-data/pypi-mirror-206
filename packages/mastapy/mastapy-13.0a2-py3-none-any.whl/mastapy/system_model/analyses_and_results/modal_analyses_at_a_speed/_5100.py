...
class BevelDifferentialGearMeshModalAnalysisAtASpeed(_5105.BevelGearMeshModalAnalysisAtASpeed):
    """BevelDifferentialGearMeshModalAnalysisAtASpeed
    ...
    class _Cast_BevelDifferentialGearMeshModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_modal_analysis_at_a_speed(self) -> 'BevelDifferentialGearMeshModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshModalAnalysisAtASpeed._Cast_BevelDifferentialGearMeshModalAnalysisAtASpeed':
