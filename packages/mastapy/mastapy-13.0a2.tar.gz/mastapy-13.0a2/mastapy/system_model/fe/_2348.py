...
class ContactPairWithSelection(_0.APIBase):
    ...
    class _Cast_ContactPairWithSelection:
        ...
        def __init__(self, parent: 'ContactPairWithSelection'):
            self._parent = parent

        @property
        def contact_pair_with_selection(self) -> 'ContactPairWithSelection':
            return self._parent
    ...
    @property
    def contact_pair(self) -> '_200.ContactPairReporting':
    ...
    @property
    def cast_to(self) -> 'ContactPairWithSelection._Cast_ContactPairWithSelection':
