...
class DateTimeGroupItem (SpireObject) :
    ...
    def MinValue(self)->'DateTime':
        ...
        intPtr = GetDllLibXls().DateTimeGroupItem_get_MinValue(self.Ptr)
    ...
    def DateTimeGroupingType(self)->'DateTimeGroupingType':
        ...
        ret = GetDllLibXls().DateTimeGroupItem_get_DateTimeGroupingType(self.Ptr)
    ...
    def DateTimeGroupingType(self, value:'DateTimeGroupingType'):
        ...
        GetDllLibXls().DateTimeGroupItem_set_DateTimeGroupingType(self.Ptr, value.value)
    ...
    def Year(self)->int:
        ...
        ret = GetDllLibXls().DateTimeGroupItem_get_Year(self.Ptr)
        return ret

    @Year.setter
    def Year(self, value:int):
        GetDllLibXls().DateTimeGroupItem_set_Year.argtypes=[c_void_p, c_int]
        GetDllLibXls().DateTimeGroupItem_set_Year(self.Ptr, value)
    ...
    def Month(self)->int:
        ...
        ret = GetDllLibXls().DateTimeGroupItem_get_Month(self.Ptr)
        return ret

    @Month.setter
    def Month(self, value:int):
        GetDllLibXls().DateTimeGroupItem_set_Month.argtypes=[c_void_p, c_int]
        GetDllLibXls().DateTimeGroupItem_set_Month(self.Ptr, value)
    ...
    def Day(self)->int:
        ...
        ret = GetDllLibXls().DateTimeGroupItem_get_Day(self.Ptr)
        return ret

    @Day.setter
    def Day(self, value:int):
        GetDllLibXls().DateTimeGroupItem_set_Day.argtypes=[c_void_p, c_int]
        GetDllLibXls().DateTimeGroupItem_set_Day(self.Ptr, value)
    ...
    def Hour(self)->int:
        ...
        ret = GetDllLibXls().DateTimeGroupItem_get_Hour(self.Ptr)
        return ret

    @Hour.setter
    def Hour(self, value:int):
        GetDllLibXls().DateTimeGroupItem_set_Hour.argtypes=[c_void_p, c_int]
        GetDllLibXls().DateTimeGroupItem_set_Hour(self.Ptr, value)
    ...
    def Minute(self)->int:
        ...
        ret = GetDllLibXls().DateTimeGroupItem_get_Minute(self.Ptr)
        return ret

    @Minute.setter
    def Minute(self, value:int):
        GetDllLibXls().DateTimeGroupItem_set_Minute.argtypes=[c_void_p, c_int]
        GetDllLibXls().DateTimeGroupItem_set_Minute(self.Ptr, value)
    ...
    def Second(self)->int:
        ...
        ret = GetDllLibXls().DateTimeGroupItem_get_Second(self.Ptr)
        return ret

    @Second.setter
    def Second(self, value:int):
        GetDllLibXls().DateTimeGroupItem_set_Second.argtypes=[c_void_p, c_int]
        GetDllLibXls().DateTimeGroupItem_set_Second(self.Ptr, value)
