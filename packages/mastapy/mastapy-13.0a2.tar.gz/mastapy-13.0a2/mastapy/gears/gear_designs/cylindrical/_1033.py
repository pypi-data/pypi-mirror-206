...
class CylindricalMeshedGearFlank(_0.APIBase):
    ...
    class _Cast_CylindricalMeshedGearFlank:
        ...
        def __init__(self, parent: 'CylindricalMeshedGearFlank'):
            self._parent = parent

        @property
        def cylindrical_meshed_gear_flank(self) -> 'CylindricalMeshedGearFlank':
            return self._parent
    ...
    @property
    def specific_sliding_chart(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def end_of_active_profile(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def start_of_active_profile(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def working_pitch(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def cast_to(self) -> 'CylindricalMeshedGearFlank._Cast_CylindricalMeshedGearFlank':
