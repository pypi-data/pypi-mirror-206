...
class PlanetaryConnectionModalAnalysisAtASpeed(_5186.ShaftToMountableComponentConnectionModalAnalysisAtASpeed):
    """PlanetaryConnectionModalAnalysisAtASpeed
    ...
    class _Cast_PlanetaryConnectionModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'PlanetaryConnectionModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def planetary_connection_modal_analysis_at_a_speed(self) -> 'PlanetaryConnectionModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetaryConnectionModalAnalysisAtASpeed._Cast_PlanetaryConnectionModalAnalysisAtASpeed':
