...
class DataBarBorder (SpireObject) :
    ...
    def Color(self)->'Color':
        ...
        intPtr = GetDllLibXls().DataBarBorder_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().DataBarBorder_set_Color(self.Ptr, value.Ptr)
    ...
    def Type(self)->'DataBarBorderType':
        ...
        ret = GetDllLibXls().DataBarBorder_get_Type(self.Ptr)
    ...
    def Type(self, value:'DataBarBorderType'):
        ...
        GetDllLibXls().DataBarBorder_set_Type(self.Ptr, value.value)
