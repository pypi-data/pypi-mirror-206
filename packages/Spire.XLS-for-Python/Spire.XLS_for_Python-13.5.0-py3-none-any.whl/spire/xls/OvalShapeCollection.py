...
class OvalShapeCollection (  CollectionBase[XlsOvalShape], IOvalShapes) :
    ...
    def get_Item(self ,index:int)->IOvalShape:
        ...
        intPtr = GetDllLibXls().OvalShapeCollection_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->IOvalShape:
        ...
        intPtr = GetDllLibXls().OvalShapeCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsOvalShape(intPtr)
        return ret
    ...
    def AddOval(self ,row:int,column:int,height:int,width:int)->'IOvalShape':
        ...
        intPtr = GetDllLibXls().OvalShapeCollection_AddOval(self.Ptr, row,column,height,width)
        ret = None if intPtr==None else XlsOvalShape(intPtr)
        return ret
    ...
    def AddCopy(self ,source:'IOvalShape'):
        ...
        GetDllLibXls().OvalShapeCollection_AddCopy(self.Ptr, intPtrsource)
    ...
    def Clear(self):
        ...
        GetDllLibXls().OvalShapeCollection_Clear(self.Ptr)
