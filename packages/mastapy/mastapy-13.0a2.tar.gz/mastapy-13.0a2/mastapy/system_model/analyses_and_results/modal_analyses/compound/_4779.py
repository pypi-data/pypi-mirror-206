...
class OilSealCompoundModalAnalysis(_4737.ConnectorCompoundModalAnalysis):
    """OilSealCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4633.OilSealModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4633.OilSealModalAnalysis]':
