...
class RedressingSettings(_0.APIBase, Generic[T]):
    ...
    class _Cast_RedressingSettings:
        ...
        def __init__(self, parent: 'RedressingSettings'):
            self._parent = parent

        @property
        def redressing_settings(self) -> 'RedressingSettings':
            return self._parent
    ...
    @property
    def redressed_shaver(self) -> '_710.CylindricalGearShaver':
    ...
    @property
    def cast_to(self) -> 'RedressingSettings._Cast_RedressingSettings':
