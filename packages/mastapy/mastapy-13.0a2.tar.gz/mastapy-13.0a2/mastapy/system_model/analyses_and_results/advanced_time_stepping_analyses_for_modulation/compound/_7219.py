...
class SynchroniserSleeveCompoundAdvancedTimeSteppingAnalysisForModulation(_7218.SynchroniserPartCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserSleeveCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7090.SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7090.SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation]':
