...
class StraightBevelGearMeshSystemDeflection(_2685.BevelGearMeshSystemDeflection):
    """StraightBevelGearMeshSystemDeflection
    ...
    class _Cast_StraightBevelGearMeshSystemDeflection:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshSystemDeflection'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_system_deflection(self) -> 'StraightBevelGearMeshSystemDeflection':
            return self._parent
    ...
    @property
    def rating(self) -> '_391.StraightBevelGearMeshRating':
    ...
    @property
    def power_flow_results(self) -> '_4120.StraightBevelGearMeshPowerFlow':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshSystemDeflection._Cast_StraightBevelGearMeshSystemDeflection':
