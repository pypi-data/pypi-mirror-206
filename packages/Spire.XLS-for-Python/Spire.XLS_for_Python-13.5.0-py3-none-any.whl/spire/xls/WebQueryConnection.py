...
class WebQueryConnection (  ExternalConnection) :
    ...
    def ID(self)->str:
        ...
        GetDllLibXls().WebQueryConnection_get_ID.restype=c_wchar_p
        ret = GetDllLibXls().WebQueryConnection_get_ID(self.Ptr)
        return ret
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().WebQueryConnection_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().WebQueryConnection_get_Name(self.Ptr)
        return ret
    ...
    def Name(self, value:str):
        ...
        GetDllLibXls().WebQueryConnection_set_Name(self.Ptr, value)
    ...
    def ConnType(self)->'ConnectionDataSourceType':
        ...
        ret = GetDllLibXls().WebQueryConnection_get_ConnType(self.Ptr)
    ...
    def BackgroundRefresh(self)->bool:
        ...
        ret = GetDllLibXls().WebQueryConnection_get_BackgroundRefresh(self.Ptr)
        return ret
    ...
    def BackgroundRefresh(self, value:bool):
        ...
        GetDllLibXls().WebQueryConnection_set_BackgroundRefresh(self.Ptr, value)
    ...
    def RefreshedVersion(self)->str:
        ...
        GetDllLibXls().WebQueryConnection_get_RefreshedVersion.restype=c_wchar_p
        ret = GetDllLibXls().WebQueryConnection_get_RefreshedVersion(self.Ptr)
        return ret
    ...
    def RefreshedVersion(self, value:str):
        ...
        GetDllLibXls().WebQueryConnection_set_RefreshedVersion(self.Ptr, value)
    ...
    def SaveData(self)->bool:
        ...
        ret = GetDllLibXls().WebQueryConnection_get_SaveData(self.Ptr)
        return ret

    @SaveData.setter
    def SaveData(self, value:bool):
        GetDllLibXls().WebQueryConnection_set_SaveData.argtypes=[c_void_p, c_bool]
        GetDllLibXls().WebQueryConnection_set_SaveData(self.Ptr, value)
    ...
    def OdcFile(self)->str:
        ...
        GetDllLibXls().WebQueryConnection_get_OdcFile.restype=c_wchar_p
        ret = GetDllLibXls().WebQueryConnection_get_OdcFile(self.Ptr)
        return ret
    ...
    def OdcFile(self, value:str):
        ...
        GetDllLibXls().WebQueryConnection_set_OdcFile(self.Ptr, value)
    ...
    def KeepAlive(self)->bool:
        ...
        ret = GetDllLibXls().WebQueryConnection_get_KeepAlive(self.Ptr)
        return ret

    @KeepAlive.setter
    def KeepAlive(self, value:bool):
        GetDllLibXls().WebQueryConnection_set_KeepAlive.argtypes=[c_void_p, c_bool]
        GetDllLibXls().WebQueryConnection_set_KeepAlive(self.Ptr, value)
    ...
    def OnlyUseConnectionFile(self)->bool:
        ...
        ret = GetDllLibXls().WebQueryConnection_get_OnlyUseConnectionFile(self.Ptr)
        return ret
    ...
    def OnlyUseConnectionFile(self, value:bool):
        ...
        GetDllLibXls().WebQueryConnection_set_OnlyUseConnectionFile(self.Ptr, value)
    ...
    def SourceData(self)->bool:
        ...
        ret = GetDllLibXls().WebQueryConnection_get_SourceData(self.Ptr)
        return ret

    @SourceData.setter
    def SourceData(self, value:bool):
        GetDllLibXls().WebQueryConnection_set_SourceData.argtypes=[c_void_p, c_bool]
        GetDllLibXls().WebQueryConnection_set_SourceData(self.Ptr, value)
    ...
    def ParsePre(self)->bool:
        ...
        ret = GetDllLibXls().WebQueryConnection_get_ParsePre(self.Ptr)
        return ret

    @ParsePre.setter
    def ParsePre(self, value:bool):
        GetDllLibXls().WebQueryConnection_set_ParsePre.argtypes=[c_void_p, c_bool]
        GetDllLibXls().WebQueryConnection_set_ParsePre(self.Ptr, value)
    ...
    def Consecutive(self)->bool:
        ...
        ret = GetDllLibXls().WebQueryConnection_get_Consecutive(self.Ptr)
        return ret

    @Consecutive.setter
    def Consecutive(self, value:bool):
        GetDllLibXls().WebQueryConnection_set_Consecutive.argtypes=[c_void_p, c_bool]
        GetDllLibXls().WebQueryConnection_set_Consecutive(self.Ptr, value)
    ...
    def Xl2000(self)->bool:
        ...
        ret = GetDllLibXls().WebQueryConnection_get_Xl2000(self.Ptr)
        return ret

    @Xl2000.setter
    def Xl2000(self, value:bool):
        GetDllLibXls().WebQueryConnection_set_Xl2000.argtypes=[c_void_p, c_bool]
        GetDllLibXls().WebQueryConnection_set_Xl2000(self.Ptr, value)
    ...
    def Url(self)->str:
        ...
        GetDllLibXls().WebQueryConnection_get_Url.restype=c_wchar_p
        ret = GetDllLibXls().WebQueryConnection_get_Url(self.Ptr)
        return ret
    ...
    def Url(self, value:str):
        ...
        GetDllLibXls().WebQueryConnection_set_Url(self.Ptr, value)
