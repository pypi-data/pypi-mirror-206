...
class ConceptCouplingConnectionCompoundSteadyStateSynchronousResponse(_3133.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """ConceptCouplingConnectionCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_compound_steady_state_synchronous_response(self) -> 'ConceptCouplingConnectionCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2988.ConceptCouplingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2988.ConceptCouplingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionCompoundSteadyStateSynchronousResponse._Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponse':
        return self._Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponse(self)
