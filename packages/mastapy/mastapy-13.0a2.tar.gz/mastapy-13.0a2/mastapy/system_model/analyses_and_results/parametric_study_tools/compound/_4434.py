...
class BevelGearCompoundParametricStudyTool(_4422.AGMAGleasonConicalGearCompoundParametricStudyTool):
    """BevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4288.BevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4288.BevelGearParametricStudyTool]':
