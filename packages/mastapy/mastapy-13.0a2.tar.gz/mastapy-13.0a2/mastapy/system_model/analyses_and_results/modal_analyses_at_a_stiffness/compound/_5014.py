...
class FaceGearMeshCompoundModalAnalysisAtAStiffness(_5019.GearMeshCompoundModalAnalysisAtAStiffness):
    """FaceGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4884.FaceGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4884.FaceGearMeshModalAnalysisAtAStiffness]':
