...
class SpecialisedAssemblyCriticalSpeedAnalysis(_6508.AbstractAssemblyCriticalSpeedAnalysis):
    """SpecialisedAssemblyCriticalSpeedAnalysis
    ...
    class _Cast_SpecialisedAssemblyCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'SpecialisedAssemblyCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def specialised_assembly_critical_speed_analysis(self) -> 'SpecialisedAssemblyCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpecialisedAssemblyCriticalSpeedAnalysis._Cast_SpecialisedAssemblyCriticalSpeedAnalysis':
