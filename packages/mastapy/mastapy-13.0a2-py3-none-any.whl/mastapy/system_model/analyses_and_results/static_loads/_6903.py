...
from mastapy.system_model import _2201, _2203, _2202
from mastapy.math_utility.measured_data import _1554
from mastapy.system_model.fe import _2354
from mastapy.system_model.analyses_and_results.static_loads import _6941, _6835, _6945
...
class PowerLoadLoadCase(_6945.VirtualComponentLoadCase):
    """PowerLoadLoadCase
    ...
    class _Cast_PowerLoadLoadCase:
        ...
        def __init__(self, parent: 'PowerLoadLoadCase'):
            self._parent = parent
        ...
        @property
        def power_load_load_case(self) -> 'PowerLoadLoadCase':
            return self._parent
    ...
    @property
    def constant_resistance_coefficient_time_profile(self) -> '_1523.Vector2DListAccessor':
    ...
    def constant_resistance_coefficient_time_profile(self, value: '_1523.Vector2DListAccessor'):
    ...
    @property
    def drag_torque_specification_method(self) -> '_2201.PowerLoadDragTorqueSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _2201.PowerLoadDragTorqueSpecificationMethod)
        return constructor.new_from_mastapy_type(_2201.PowerLoadDragTorqueSpecificationMethod)(value) if value is not None else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_2201.PowerLoadDragTorqueSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2201.PowerLoadDragTorqueSpecificationMethod.type_())
        self.wrapped.DragTorqueSpecificationMethod = value

    @property
    def drag_torque_vs_speed_and_time(self) -> '_1554.GriddedSurfaceAccessor':
    ...
    def drag_torque_vs_speed_and_time(self, value: '_1554.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def engine_throttle_time_profile(self) -> '_1523.Vector2DListAccessor':
    ...
    def engine_throttle_time_profile(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def linear_resistance_coefficient_time_profile(self) -> '_1523.Vector2DListAccessor':
    ...
    def linear_resistance_coefficient_time_profile(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def quadratic_resistance_coefficient_time_profile(self) -> '_1523.Vector2DListAccessor':
    ...
    def quadratic_resistance_coefficient_time_profile(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def speed_vs_time(self) -> '_1523.Vector2DListAccessor':
    ...
    def speed_vs_time(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def target_speed_input_type(self) -> '_2203.PowerLoadPIDControlSpeedInputType':
        ...
        value = conversion.pn_to_mp_enum(temp, _2203.PowerLoadPIDControlSpeedInputType)
        return constructor.new_from_mastapy_type(_2203.PowerLoadPIDControlSpeedInputType)(value) if value is not None else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_2203.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2203.PowerLoadPIDControlSpeedInputType.type_())
        self.wrapped.TargetSpeedInputType = value

    @property
    def target_speed_vs_time(self) -> '_1523.Vector2DListAccessor':
    ...
    def target_speed_vs_time(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def torque_vs_angle(self) -> '_1523.Vector2DListAccessor':
    ...
    def torque_vs_angle(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.TorqueVsAngle = value

    @property
    def torque_vs_angle_and_speed(self) -> '_1554.GriddedSurfaceAccessor':
    ...
    def torque_vs_angle_and_speed(self, value: '_1554.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
        self.wrapped.TorqueVsAngleAndSpeed = value

    @property
    def torque_vs_time(self) -> '_1523.Vector2DListAccessor':
    ...
    def torque_vs_time(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def velocity_first_order_lag_cutoff_frequency(self) -> 'float':
        """float: 'VelocityFirstOrderLagCutoffFrequency' is the original name of this property."""
    ...
    def velocity_first_order_lag_cutoff_frequency(self, value: 'float'):
        self.wrapped.VelocityFirstOrderLagCutoffFrequency = float(value) if value else 0.0

    @property
    def velocity_first_order_lag_time_constant(self) -> 'float':
        """float: 'VelocityFirstOrderLagTimeConstant' is the original name of this property."""
    ...
    def velocity_first_order_lag_time_constant(self, value: 'float'):
        self.wrapped.VelocityFirstOrderLagTimeConstant = float(value) if value else 0.0

    @property
    def wheel_slip_model(self) -> '_5486.WheelSlipType':
        ...
        value = conversion.pn_to_mp_enum(temp, _5486.WheelSlipType)
        return constructor.new_from_mastapy_type(_5486.WheelSlipType)(value) if value is not None else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5486.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _5486.WheelSlipType.type_())
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1565.PIDControlSettings':
    ...
    @property
    def pid_control_settings(self) -> '_1565.PIDControlSettings':
    ...
    def get_harmonic_load_data_for_import(self) -> '_6835.ElectricMachineHarmonicLoadData':
    ...
    @property
    def cast_to(self) -> 'PowerLoadLoadCase._Cast_PowerLoadLoadCase':
