...
class CouplingConnectionCompoundAdvancedSystemDeflection(_7433.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """CouplingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7274.CouplingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7274.CouplingConnectionAdvancedSystemDeflection]':
