...
class WormGearCompoundHarmonicAnalysis(_5904.GearCompoundHarmonicAnalysis):
    """WormGearCompoundHarmonicAnalysis
    ...
    class _Cast_WormGearCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'WormGearCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def worm_gear_compound_harmonic_analysis(self) -> 'WormGearCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5805.WormGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5805.WormGearHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'WormGearCompoundHarmonicAnalysis._Cast_WormGearCompoundHarmonicAnalysis':
