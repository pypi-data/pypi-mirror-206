...
from mastapy.system_model.analyses_and_results.power_flows import _4137, _4136, _4070
...
class WormGearSetPowerFlow(_4070.GearSetPowerFlow):
    """WormGearSetPowerFlow
    ...
    class _Cast_WormGearSetPowerFlow:
        ...
        def __init__(self, parent: 'WormGearSetPowerFlow'):
            self._parent = parent
        ...
        @property
        def worm_gear_set_power_flow(self) -> 'WormGearSetPowerFlow':
            return self._parent
    ...
    @property
    def gears_power_flow(self) -> 'List[_4137.WormGearPowerFlow]':
    ...
    @property
    def worm_gears_power_flow(self) -> 'List[_4137.WormGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4136.WormGearMeshPowerFlow]':
    ...
    @property
    def worm_meshes_power_flow(self) -> 'List[_4136.WormGearMeshPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'WormGearSetPowerFlow._Cast_WormGearSetPowerFlow':
