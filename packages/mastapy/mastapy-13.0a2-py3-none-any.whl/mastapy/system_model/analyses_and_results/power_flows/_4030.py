...
class ClutchConnectionPowerFlow(_4046.CouplingConnectionPowerFlow):
    """ClutchConnectionPowerFlow
    ...
    class _Cast_ClutchConnectionPowerFlow:
        ...
        def __init__(self, parent: 'ClutchConnectionPowerFlow'):
            self._parent = parent
        ...
        @property
        def clutch_connection_power_flow(self) -> 'ClutchConnectionPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchConnectionPowerFlow._Cast_ClutchConnectionPowerFlow':
