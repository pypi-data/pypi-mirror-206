...
class ArgumentTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        musicbrainzez.compat.build_opener = lambda *args: self.opener.add_handlers_and_return(args)
    ...
    def test_no_client(self):
        musicbrainzez.set_useragent("testapp", "0.1", "test@example.org")
    ...
    def test_false_useragent(self):
        self.assertRaises(ValueError, musicbrainzez.set_useragent, "", "0.1",
                "test@example.org")
        self.assertRaises(ValueError, musicbrainzez.set_useragent, "test", "",
                "test@example.org")
    ...
    def test_missing_useragent(self):
        ...
        self.assertRaises(musicbrainzez.musicbrainz.UsageError,
                musicbrainz._mb_request, path="foo")
...
class HostnameTest(unittest.TestCase):
    ...
    def tearDown(self):
        musicbrainz.set_rate_limit(True)
        musicbrainzez.set_hostname("musicbrainz.org", use_https=True)
    ...
    def test_set_http(self):
        musicbrainzez.set_hostname("beta.musicbrainz.org", use_https=False)

        musicbrainzez.get_release_by_id("5e3524ca-b4a1-4e51-9ba5-63ea2de8f49b")
        self.assertEqual("http://beta.musicbrainz.org/ws/2/release/5e3524ca-b4a1-4e51-9ba5-63ea2de8f49b?fmt=json", self.opener.get_url())

    def test_set_https(self):
        musicbrainzez.set_hostname("mbmirror.org", use_https=True)

        musicbrainzez.get_release_by_id("5e3524ca-b4a1-4e51-9ba5-63ea2de8f49b")
        self.assertEqual("https://mbmirror.org/ws/2/release/5e3524ca-b4a1-4e51-9ba5-63ea2de8f49b?fmt=json", self.opener.get_url())

    def test_set_port(self):
        musicbrainzez.set_hostname("localhost:8000", use_https=False)

        musicbrainzez.get_release_by_id("5e3524ca-b4a1-4e51-9ba5-63ea2de8f49b")
        self.assertEqual("http://localhost:8000/ws/2/release/5e3524ca-b4a1-4e51-9ba5-63ea2de8f49b?fmt=json", self.opener.get_url())
