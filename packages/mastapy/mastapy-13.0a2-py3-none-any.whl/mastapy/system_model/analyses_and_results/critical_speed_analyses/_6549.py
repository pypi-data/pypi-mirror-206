...
class CriticalSpeedAnalysisOptions(_0.APIBase):
    ...
    class _Cast_CriticalSpeedAnalysisOptions:
        ...
        def __init__(self, parent: 'CriticalSpeedAnalysisOptions'):
            self._parent = parent

        @property
        def critical_speed_analysis_options(self) -> 'CriticalSpeedAnalysisOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CriticalSpeedAnalysisOptions._Cast_CriticalSpeedAnalysisOptions':
