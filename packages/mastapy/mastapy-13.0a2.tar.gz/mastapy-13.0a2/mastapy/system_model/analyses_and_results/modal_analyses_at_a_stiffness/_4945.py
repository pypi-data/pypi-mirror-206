...
class SynchroniserModalAnalysisAtAStiffness(_4929.SpecialisedAssemblyModalAnalysisAtAStiffness):
    """SynchroniserModalAnalysisAtAStiffness
    ...
    class _Cast_SynchroniserModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'SynchroniserModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def synchroniser_modal_analysis_at_a_stiffness(self) -> 'SynchroniserModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserModalAnalysisAtAStiffness._Cast_SynchroniserModalAnalysisAtAStiffness':
