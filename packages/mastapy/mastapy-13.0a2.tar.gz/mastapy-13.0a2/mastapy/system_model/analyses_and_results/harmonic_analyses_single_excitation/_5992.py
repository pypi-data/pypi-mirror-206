...
class BevelGearMeshHarmonicAnalysisOfSingleExcitation(_5980.AGMAGleasonConicalGearMeshHarmonicAnalysisOfSingleExcitation):
    """BevelGearMeshHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_BevelGearMeshHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'BevelGearMeshHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def bevel_gear_mesh_harmonic_analysis_of_single_excitation(self) -> 'BevelGearMeshHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearMeshHarmonicAnalysisOfSingleExcitation._Cast_BevelGearMeshHarmonicAnalysisOfSingleExcitation':
