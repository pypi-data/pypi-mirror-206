...
class TorqueConverterSteadyStateSynchronousResponse(_3001.CouplingSteadyStateSynchronousResponse):
    """TorqueConverterSteadyStateSynchronousResponse
    ...
    class _Cast_TorqueConverterSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'TorqueConverterSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def torque_converter_steady_state_synchronous_response(self) -> 'TorqueConverterSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterSteadyStateSynchronousResponse._Cast_TorqueConverterSteadyStateSynchronousResponse':
