...
from mastapy.gears.gear_designs.cylindrical import _1044, _1001, _1026
...
class CylindricalGearCuttingOptions(_0.APIBase):
    ...
    @property
    def cylindrical_gear_cutter(self) -> '_1001.CylindricalGearAbstractRack':
    ...
    @property
    def manufacturing_configuration(self) -> '_607.CylindricalGearManufacturingConfig':
    ...
    @property
    def manufacturing_configuration_selection(self) -> '_1026.CylindricalGearSetManufacturingConfigurationSelection':
