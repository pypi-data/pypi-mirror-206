...
class WindingsViewer(_0.APIBase):
    ...
    class _Cast_WindingsViewer:
        ...
        def __init__(self, parent: 'WindingsViewer'):
            self._parent = parent

        @property
        def windings_viewer(self) -> 'WindingsViewer':
            return self._parent
    ...
    def show_all_parallel_paths(self, value: 'bool'):
        self.wrapped.ShowAllParallelPaths = bool(value) if value else False
    ...
    def show_all_phases(self, value: 'bool'):
        self.wrapped.ShowAllPhases = bool(value) if value else False
    ...
    @property
    def cast_to(self) -> 'WindingsViewer._Cast_WindingsViewer':
