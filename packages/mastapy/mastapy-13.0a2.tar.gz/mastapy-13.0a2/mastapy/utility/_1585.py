...
class ProgramSettings(_1583.PerMachineSettings):
    """ProgramSettings
    ...
    class _Cast_ProgramSettings:
        ...
        @property
        def program_settings(self) -> 'ProgramSettings':
            return self._parent
    ...
    def check_for_new_version_on_startup(self) -> 'ProgramSettings.CheckForNewerVersionOption':
        ...
        value = conversion.pn_to_mp_enum(temp, ProgramSettings.CheckForNewerVersionOption)
    ...
    def check_for_new_version_on_startup(self, value: 'ProgramSettings.CheckForNewerVersionOption'):
        ...
        value = conversion.mp_to_pn_enum(value, ProgramSettings.CheckForNewerVersionOption.type_())
    ...
    def user_name(self, value: 'str'):
        self.wrapped.UserName = str(value) if value else ''
    ...
    @property
    def cast_to(self) -> 'ProgramSettings._Cast_ProgramSettings':
