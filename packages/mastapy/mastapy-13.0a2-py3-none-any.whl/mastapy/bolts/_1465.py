...
class DetailedBoltDesign(_0.APIBase):
    ...
    class _Cast_DetailedBoltDesign:
        ...
        def __init__(self, parent: 'DetailedBoltDesign'):
            self._parent = parent

        @property
        def detailed_bolt_design(self) -> 'DetailedBoltDesign':
            return self._parent
    ...
    @property
    def clamped_parts(self) -> 'List[_1463.ClampedSection]':
    ...
    def clamped_parts(self, value: 'List[_1463.ClampedSection]'):
    ...
    @property
    def joint_geometry(self) -> '_1468.JointGeometries':
        ...
        value = conversion.pn_to_mp_enum(temp, _1468.JointGeometries)
        return constructor.new_from_mastapy_type(_1468.JointGeometries)(value) if value is not None else None

    @joint_geometry.setter
    def joint_geometry(self, value: '_1468.JointGeometries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1468.JointGeometries.type_())
    ...
    @property
    def rolled_before_or_after_heat_treatment(self) -> '_1471.RolledBeforeOrAfterHeatTreament':
        ...
        value = conversion.pn_to_mp_enum(temp, _1471.RolledBeforeOrAfterHeatTreament)
        return constructor.new_from_mastapy_type(_1471.RolledBeforeOrAfterHeatTreament)(value) if value is not None else None

    @rolled_before_or_after_heat_treatment.setter
    def rolled_before_or_after_heat_treatment(self, value: '_1471.RolledBeforeOrAfterHeatTreament'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1471.RolledBeforeOrAfterHeatTreament.type_())
    ...
    @property
    def bolt_geometry(self) -> '_1456.BoltGeometry':
    ...
    @property
    def material_of_bolt(self) -> '_1458.BoltMaterial':
    ...
    @property
    def material_of_nut(self) -> '_1454.BoltedJointMaterial':
    ...
    @property
    def material_of_tapped_thread(self) -> '_1454.BoltedJointMaterial':
    ...
    @property
    def clamped_sections(self) -> 'List[_1463.ClampedSection]':
    ...
    @property
    def cast_to(self) -> 'DetailedBoltDesign._Cast_DetailedBoltDesign':
