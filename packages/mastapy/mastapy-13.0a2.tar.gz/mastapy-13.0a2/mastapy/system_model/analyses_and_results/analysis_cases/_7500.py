...
class ConnectionAnalysisCase(_2628.ConnectionAnalysis):
    """ConnectionAnalysisCase
    ...
    class _Cast_ConnectionAnalysisCase:
        ...
        def __init__(self, parent: 'ConnectionAnalysisCase'):
            self._parent = parent
        ...
        @property
        def connection_analysis_case(self) -> 'ConnectionAnalysisCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConnectionAnalysisCase._Cast_ConnectionAnalysisCase':
