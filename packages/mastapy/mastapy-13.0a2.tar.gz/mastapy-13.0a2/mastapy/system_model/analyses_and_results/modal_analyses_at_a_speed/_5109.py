...
class BoltModalAnalysisAtASpeed(_5114.ComponentModalAnalysisAtASpeed):
    """BoltModalAnalysisAtASpeed
    ...
    class _Cast_BoltModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'BoltModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def bolt_modal_analysis_at_a_speed(self) -> 'BoltModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltModalAnalysisAtASpeed._Cast_BoltModalAnalysisAtASpeed':
