...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/links/{id}/identity".format(client.base_url, id=id)
    ...
    *,
    ...
    """/links/{id}/identity
     ...
     Returns account owner information from the institution, including names, emails, phone
        numbers, and addresses, for all permissioned accounts associated with a <a
    href=#tag/Links>link</a>.
        <p>Some fields may be empty, if not provided by the institution.
    ...
    Returns:
        Response[Union[APIErrorRateLimitExceededResponse, IdentityResponse, LinkErrorBadStateResponse, LinkErrorDeletedResponse, LinkErrorForbiddenActionResponse, LinkErrorNotFoundResponse, Union['APIErrorAuthExpiredAccessTokenResponse', 'APIErrorAuthUnauthorizedResponse', 'LinkErrorUnauthorizedAccessResponse']]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[APIErrorRateLimitExceededResponse, IdentityResponse, LinkErrorBadStateResponse, LinkErrorDeletedResponse, LinkErrorForbiddenActionResponse, LinkErrorNotFoundResponse, Union['APIErrorAuthExpiredAccessTokenResponse', 'APIErrorAuthUnauthorizedResponse', 'LinkErrorUnauthorizedAccessResponse']]
    """
