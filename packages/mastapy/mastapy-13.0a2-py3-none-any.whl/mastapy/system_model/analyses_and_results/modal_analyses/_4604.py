...
class FaceGearModalAnalysis(_4610.GearModalAnalysis):
    """FaceGearModalAnalysis
    ...
    class _Cast_FaceGearModalAnalysis:
        ...
        def __init__(self, parent: 'FaceGearModalAnalysis'):
            self._parent = parent
        ...
        @property
        def face_gear_modal_analysis(self) -> 'FaceGearModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearModalAnalysis._Cast_FaceGearModalAnalysis':
