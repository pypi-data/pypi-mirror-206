...
# Path params
InstitutionIdSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = InstitutionStylingResponse
...
SchemaFor404ResponseBodyApplicationJson = InstitutionErrorNotFoundResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_institution_styling_oapg(
        self,
    ...
    def _get_institution_styling_oapg(
        ...
        _path_params = {}
        for parameter in (request_path_institution_id,):
...
class GetInstitutionStyling(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_institution_styling(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_institution_styling(
        ...
        return self._get_institution_styling_oapg(
