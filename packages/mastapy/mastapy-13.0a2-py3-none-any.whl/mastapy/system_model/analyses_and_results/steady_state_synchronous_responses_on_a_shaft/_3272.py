...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3273, _3271, _3283
...
class CylindricalGearSetSteadyStateSynchronousResponseOnAShaft(_3283.GearSetSteadyStateSynchronousResponseOnAShaft):
    """CylindricalGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_CylindricalGearSetSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'CylindricalGearSetSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_set_steady_state_synchronous_response_on_a_shaft(self) -> 'CylindricalGearSetSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3273.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3271.CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearSetSteadyStateSynchronousResponseOnAShaft._Cast_CylindricalGearSetSteadyStateSynchronousResponseOnAShaft':
