...
class ClutchCompoundSystemDeflection(_2867.CouplingCompoundSystemDeflection):
    """ClutchCompoundSystemDeflection
    ...
    class _Cast_ClutchCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'ClutchCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def clutch_compound_system_deflection(self) -> 'ClutchCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2692.ClutchSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2692.ClutchSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'ClutchCompoundSystemDeflection._Cast_ClutchCompoundSystemDeflection':
