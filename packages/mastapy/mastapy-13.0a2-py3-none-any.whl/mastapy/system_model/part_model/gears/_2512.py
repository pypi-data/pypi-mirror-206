...
from mastapy.gears import _324, _325
from mastapy._internal import constructor, conversion
from mastapy.system_model.part_model.gears import (
    _2503, _2505, _2516, _2531
)
...
class GearSetConfiguration(_0.APIBase):
    ...
    class _Cast_GearSetConfiguration:
        ...
        def __init__(self, parent: 'GearSetConfiguration'):
            self._parent = parent

        @property
        def gear_set_configuration(self) -> 'GearSetConfiguration':
            return self._parent
    ...
    def implementation_detail_results_for_group(self, analysis_case: '_5630.AbstractStaticLoadCaseGroup', gear_set_mode: '_325.GearSetModes', run_all_planetary_meshes: 'bool') -> '_1221.GearSetGroupDutyCycle':
        ...
        gear_set_mode = conversion.mp_to_pn_enum(gear_set_mode, _325.GearSetModes.type_())
    ...
    def implementation_detail_results_for(self, analysis_case: '_6769.StaticLoadCase', gear_set_mode: '_325.GearSetModes', run_all_planetary_meshes: 'bool') -> '_1221.GearSetGroupDutyCycle':
        """ 'ImplementationDetailResultsFor' is the original name of this method.
    ...
    def perform_implementation_detail_analysis_group(self, static_load_case_group: '_5630.AbstractStaticLoadCaseGroup', gear_set_mode: '_325.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True, perform_system_analysis_if_not_ready: Optional['bool'] = True):
    ...
    def perform_implementation_detail_analysis(self, static_load: '_6769.StaticLoadCase', gear_set_mode: '_325.GearSetModes', run_all_planetary_meshes: Optional['bool'] = True, perform_system_analysis_if_not_ready: Optional['bool'] = True):
        """ 'PerformImplementationDetailAnalysis' is the original name of this method.
    ...
    @property
    def cast_to(self) -> 'GearSetConfiguration._Cast_GearSetConfiguration':
