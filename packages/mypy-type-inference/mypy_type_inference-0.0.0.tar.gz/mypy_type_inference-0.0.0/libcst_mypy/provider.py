...
class MypyTypeInferenceProvider(BatchableMetadataProvider[MypyType]):
    """
    ...
    ) -> Mapping[str, Optional[MypyTypeInferenceProviderCache]]:  # type: ignore
