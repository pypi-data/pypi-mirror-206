...
from moneykit.exceptions import ApiTypeError, ApiValueError
from moneykit.schemas import (
    BinarySchema,
    BoolClass,
    FileIO,
    NoneClass,
...
class Api:
    ...
    def _get_host_oapg(
        self,
        operation_id: str,
        servers: typing.Tuple[typing.Dict[str, str], ...] = (),
