...
class GuideDxfModelMultibodyDynamicsAnalysis(_5375.ComponentMultibodyDynamicsAnalysis):
    """GuideDxfModelMultibodyDynamicsAnalysis
    ...
    class _Cast_GuideDxfModelMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'GuideDxfModelMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def guide_dxf_model_multibody_dynamics_analysis(self) -> 'GuideDxfModelMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GuideDxfModelMultibodyDynamicsAnalysis._Cast_GuideDxfModelMultibodyDynamicsAnalysis':
