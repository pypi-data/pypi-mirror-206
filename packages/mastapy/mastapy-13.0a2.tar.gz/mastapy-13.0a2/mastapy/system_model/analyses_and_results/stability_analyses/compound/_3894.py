...
class BoltedJointCompoundStabilityAnalysis(_3972.SpecialisedAssemblyCompoundStabilityAnalysis):
    """BoltedJointCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3761.BoltedJointStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3761.BoltedJointStabilityAnalysis]':
