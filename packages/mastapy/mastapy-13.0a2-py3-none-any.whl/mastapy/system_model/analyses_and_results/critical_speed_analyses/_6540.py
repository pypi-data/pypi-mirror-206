...
class ConicalGearCriticalSpeedAnalysis(_6568.GearCriticalSpeedAnalysis):
    """ConicalGearCriticalSpeedAnalysis
    ...
    class _Cast_ConicalGearCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ConicalGearCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def conical_gear_critical_speed_analysis(self) -> 'ConicalGearCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConicalGearCriticalSpeedAnalysis._Cast_ConicalGearCriticalSpeedAnalysis':
