...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4301, _4300, _4338
...
class ConceptGearSetParametricStudyTool(_4338.GearSetParametricStudyTool):
    """ConceptGearSetParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2700.ConceptGearSetSystemDeflection]':
    ...
    @property
    def concept_gears_parametric_study_tool(self) -> 'List[_4301.ConceptGearParametricStudyTool]':
    ...
    @property
    def concept_meshes_parametric_study_tool(self) -> 'List[_4300.ConceptGearMeshParametricStudyTool]':
