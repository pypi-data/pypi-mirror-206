...
class VDI2737InternalGearSingleFlankRating(_0.APIBase):
    ...
    class _Cast_VDI2737InternalGearSingleFlankRating:
        ...
        def __init__(self, parent: 'VDI2737InternalGearSingleFlankRating'):
            self._parent = parent

        @property
        def vdi2737_internal_gear_single_flank_rating(self) -> 'VDI2737InternalGearSingleFlankRating':
            return self._parent
    ...
    @property
    def iso_gear_rating(self) -> '_514.ISO6336AbstractMetalGearSingleFlankRating':
    ...
    @property
    def cast_to(self) -> 'VDI2737InternalGearSingleFlankRating._Cast_VDI2737InternalGearSingleFlankRating':
