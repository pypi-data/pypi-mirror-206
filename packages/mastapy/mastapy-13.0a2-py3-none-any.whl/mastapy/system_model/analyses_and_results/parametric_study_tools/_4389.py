...
class SpiralBevelGearParametricStudyTool(_4288.BevelGearParametricStudyTool):
    """SpiralBevelGearParametricStudyTool
    ...
    class _Cast_SpiralBevelGearParametricStudyTool:
        ...
        def __init__(self, parent: 'SpiralBevelGearParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_parametric_study_tool(self) -> 'SpiralBevelGearParametricStudyTool':
            return self._parent
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2788.SpiralBevelGearSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearParametricStudyTool._Cast_SpiralBevelGearParametricStudyTool':
