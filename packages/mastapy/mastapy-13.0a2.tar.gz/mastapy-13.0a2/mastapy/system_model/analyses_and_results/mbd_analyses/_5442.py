...
class PlanetaryGearSetMultibodyDynamicsAnalysis(_5399.CylindricalGearSetMultibodyDynamicsAnalysis):
    """PlanetaryGearSetMultibodyDynamicsAnalysis
    ...
    class _Cast_PlanetaryGearSetMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'PlanetaryGearSetMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def planetary_gear_set_multibody_dynamics_analysis(self) -> 'PlanetaryGearSetMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetaryGearSetMultibodyDynamicsAnalysis._Cast_PlanetaryGearSetMultibodyDynamicsAnalysis':
