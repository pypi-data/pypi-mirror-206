...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5714, _5733
...
class HarmonicAnalysisExportOptions(_0.APIBase, Generic[TPartAnalysis, TPart]):
    ...
    class _Cast_HarmonicAnalysisExportOptions:
        ...
        def harmonic_analysis_fe_export_options(self):
            ...
            return self._parent._cast(_5732.HarmonicAnalysisFEExportOptions)
        ...
        def harmonic_analysis_root_assembly_export_options(self):
            ...
            return self._parent._cast(_5734.HarmonicAnalysisRootAssemblyExportOptions)
        ...
        def harmonic_analysis_shaft_export_options(self):
            ...
            return self._parent._cast(_5735.HarmonicAnalysisShaftExportOptions)
    ...
    @property
    def analysis_options(self) -> '_5733.HarmonicAnalysisOptions':
