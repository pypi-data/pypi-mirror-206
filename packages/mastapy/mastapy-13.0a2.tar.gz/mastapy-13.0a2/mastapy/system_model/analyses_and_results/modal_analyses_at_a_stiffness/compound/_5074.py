...
class SynchroniserHalfCompoundModalAnalysisAtAStiffness(_5075.SynchroniserPartCompoundModalAnalysisAtAStiffness):
    """SynchroniserHalfCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_SynchroniserHalfCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'SynchroniserHalfCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def synchroniser_half_compound_modal_analysis_at_a_stiffness(self) -> 'SynchroniserHalfCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4944.SynchroniserHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4944.SynchroniserHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserHalfCompoundModalAnalysisAtAStiffness._Cast_SynchroniserHalfCompoundModalAnalysisAtAStiffness':
