...
class ShaftToMountableComponentConnectionCompoundStabilityAnalysis(_3877.AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """ShaftToMountableComponentConnectionCompoundStabilityAnalysis
    ...
    class _Cast_ShaftToMountableComponentConnectionCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'ShaftToMountableComponentConnectionCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def shaft_to_mountable_component_connection_compound_stability_analysis(self) -> 'ShaftToMountableComponentConnectionCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3840.ShaftToMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3840.ShaftToMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ShaftToMountableComponentConnectionCompoundStabilityAnalysis._Cast_ShaftToMountableComponentConnectionCompoundStabilityAnalysis':
        return self._Cast_ShaftToMountableComponentConnectionCompoundStabilityAnalysis(self)
