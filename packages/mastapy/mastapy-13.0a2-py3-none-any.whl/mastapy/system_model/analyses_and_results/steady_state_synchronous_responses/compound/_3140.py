...
class CycloidalDiscCompoundSteadyStateSynchronousResponse(_3096.AbstractShaftCompoundSteadyStateSynchronousResponse):
    """CycloidalDiscCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3008.CycloidalDiscSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3008.CycloidalDiscSteadyStateSynchronousResponse]':
