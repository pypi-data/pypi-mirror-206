...
class XlsRange (  XlsObject, ICombinedRange,IEnumerable[IXLSRange]) :
    ...
    <returns>Merged ranges or null if wasn't able to merge ranges.</returns>
        ...
        intPtr = GetDllLibXls().XlsRange_Merge(self.Ptr, intPtrrange)
    ...
    <returns>Range intersection. If there is no intersection, NULL is returned.</returns>
        ...
        intPtr = GetDllLibXls().XlsRange_Intersect(self.Ptr, intPtrrange)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def IsIntersect(self ,range:'IXLSRange')->bool:
        ...
        ret = GetDllLibXls().XlsRange_IsIntersect(self.Ptr, intPtrrange)
        return ret
    ...
    <returns>Size of the string.</returns>
        ...
        intPtr = GetDllLibXls().XlsRange_MeasureString(self.Ptr, measureString)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_Merge1(self.Ptr)
    ...
    def RemoveMergeComment(self):
        ...
        GetDllLibXls().XlsRange_RemoveMergeComment(self.Ptr)
    ...
    <param name="clearCells">Indicates whether to clear unnecessary cells.</param>
        ...
        GetDllLibXls().XlsRange_MergeC(self.Ptr, clearCells)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_PartialClear(self.Ptr)
    ...
    <param name="newPartValue">The replacement value.</param>
        ...
        GetDllLibXls().XlsRange_TextPartReplace(self.Ptr, oldPartValue,newPartValue)
    ...
    def RemoveCombinedRange(self ,cr:'XlsRange'):
        ...
        GetDllLibXls().XlsRange_RemoveCombinedRange(self.Ptr, intPtrcr)
...
#        intPtr = GetDllLibXls().XlsRange_get_CombinedCells(self.Ptr)
...
#
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_CombinedAddress.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_CombinedAddress(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_UnMerge(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_ReparseFormulaString(self.Ptr)
    ...
    def GetEnumerator(self)->'EnumeratorXlsRange':
        ...
        intPtr = GetDllLibXls().XlsRange_GetEnumerator(self.Ptr)
    ...
    def AddComment(self ,bIsParseOptions:bool)->ICommentShape:
        ...
        intPtr = GetDllLibXls().XlsRange_AddComment(self.Ptr, bIsParseOptions)
    ...
    def SetAutoFormat(self ,format:AutoFormatType):
        ...
        GetDllLibXls().XlsRange_SetAutoFormat(self.Ptr, enumformat)
    ...
    def SetAutoFormat(self ,format:AutoFormatType,options:AutoFormatOptions):
        ...
        GetDllLibXls().XlsRange_SetAutoFormatFO(self.Ptr, enumformat,enumoptions)
    ...
    def SetDataValidation(self ,dv:'XlsValidation'):
        ...
        GetDllLibXls().XlsRange_SetDataValidation(self.Ptr, intPtrdv)
    ...
    <param name="isVertical">Indicates whether to insert values vertically or horizontally.</param>
        ...
        GetDllLibXls().XlsRange_Replace(self.Ptr, oldValue,arraynewValues,countnewValues,isVertical)
    ...
    <param name="newValue">The replacement value.</param>
        ...
        GetDllLibXls().XlsRange_ReplaceON(self.Ptr, oldValue,newValue)
    ...
    <param name="isFieldNamesShown">Indicates whether to insert values vertically or horizontally.</param>
        ...
        GetDllLibXls().XlsRange_ReplaceONI(self.Ptr, oldValue,arraynewValues,countnewValues,isVertical)
    ...
    <param name="isVertical">Indicates whether to insert values vertically or horizontally.</param>
        ...
        GetDllLibXls().XlsRange_ReplaceONI1(self.Ptr, oldValue,arraynewValues,countnewValues,isVertical)
...
#        GetDllLibXls().XlsRange_ReplaceONI11(self.Ptr, oldValue,intPtrnewValues,isFieldNamesShown)
    ...
    <param name="newValue">The replacement value.</param>
        ...
        GetDllLibXls().XlsRange_ReplaceON1(self.Ptr, oldValue,intPtrnewValue)
    ...
    <param name="newValue">The replacement value.</param>
        ...
        GetDllLibXls().XlsRange_ReplaceON11(self.Ptr, oldValue,newValue)
    ...
    def Union(self ,range:'XlsRange')->'RangesCollection':
        ...
        intPtr = GetDllLibXls().XlsRange_Union(self.Ptr, intPtrrange)
...
#        GetDllLibXls().XlsRange_ReplaceONI111(self.Ptr, oldValue,intPtrnewValues,isFieldNamesShown)
...
#        intPtr = GetDllLibXls().XlsRange_ExportDataTable(self.Ptr, intPtroptions)
...
#
    ...
    def AddCombinedRange(self ,cr:'XlsRange')->'XlsRange':
        ...
        intPtr = GetDllLibXls().XlsRange_AddCombinedRange(self.Ptr, intPtrcr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <param name="endColumn">last Column</param>
        ...
        GetDllLibXls().XlsRange_UpdateRange(self.Ptr, startRow,startColumn,endRow,endColumn)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_ConvertToNumber(self.Ptr)
    ...
    def SetSharedFormula(self ,sharedFormula:str,rowNumber:int,columnNumber:int):
        ...
        GetDllLibXls().XlsRange_SetSharedFormula(self.Ptr, sharedFormula,rowNumber,columnNumber)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsRange_GetConditionFormatsStyle(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_RangeR1C1Address.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_RangeR1C1Address(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_RangeR1C1AddressLocal.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_RangeR1C1AddressLocal(self.Ptr)
        return ret
    ...
    def RichText(self)->'IRichTextString':
        ...
        intPtr = GetDllLibXls().XlsRange_get_RichText(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_HtmlString.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_HtmlString(self.Ptr)
        return ret
    ...
    def HtmlString(self, value:str):
        ...
        GetDllLibXls().XlsRange_set_HtmlString(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_Row(self.Ptr)
        return ret
...
<remarks>
        ...
        ret = GetDllLibXls().XlsRange_get_RowGroupLevel(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_RowHeight(self.Ptr)
        return ret

    @RowHeight.setter
    def RowHeight(self, value:float):
        GetDllLibXls().XlsRange_set_RowHeight.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsRange_set_RowHeight(self.Ptr, value)
    ...
    def Rows(self)->'ListXlsRanges':
        ...
        intPtr = GetDllLibXls().XlsRange_get_Rows(self.Ptr)
    ...
    def ExtendedFormatIndex(self)->'UInt16':
        ...
        intPtr = GetDllLibXls().XlsRange_get_ExtendedFormatIndex(self.Ptr)
    ...
    def ExtendedFormatIndex(self, value:'UInt16'):
        ...
        GetDllLibXls().XlsRange_set_ExtendedFormatIndex(self.Ptr, value.Ptr)
    ...
    def SetExtendedFormatIndex(self ,index:int):
        ...
        GetDllLibXls().XlsRange_SetExtendedFormatIndex(self.Ptr, index)
    ...
    def SetRowHeight(self ,rowHeight:float,bIsBadFontHeight:bool):
        ...
        GetDllLibXls().XlsRange_SetRowHeight(self.Ptr, rowHeight,bIsBadFontHeight)
    ...
    def ApplyStyle(self ,style:'IStyle',flag:'CellStyleFlag'):
        ...
        GetDllLibXls().XlsRange_ApplyStyle(self.Ptr, intPtrstyle,intPtrflag)
    ...
    def Style(self)->'IStyle':
        ...
        intPtr = GetDllLibXls().XlsRange_get_Style(self.Ptr)
        ret = None if intPtr==None else CellStyle(intPtr)
        return ret
    ...
    def Style(self, value:'IStyle'):
        ...
        GetDllLibXls().XlsRange_set_Style(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsRange_set_Text(self.Ptr, value)
    ...
    def get_Item(self ,row:int,column:int,lastRow:int,lastColumn:int)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsRange_get_Item(self.Ptr, row,column,lastRow,lastColumn)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def get_Item(self ,row:int,column:int)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsRange_get_ItemRC(self.Ptr, row,column)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def set_Item(self ,row:int,column:int,value:'IXLSRange'):
        ...
        GetDllLibXls().XlsRange_set_Item(self.Ptr, row,column,intPtrvalue)
    ...
    def get_Item(self ,name:str,IsR1C1Notation:bool)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsRange_get_ItemNI(self.Ptr, name,IsR1C1Notation)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def get_Item(self ,name:str)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsRange_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsRange_get_TimeSpanValue(self.Ptr)
    ...
    def TimeSpanValue(self, value:'TimeSpan'):
        ...
        GetDllLibXls().XlsRange_set_TimeSpanValue(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_Value.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_Value(self.Ptr)
        return ret
    ...
    def Value(self, value:str):
        ...
        GetDllLibXls().XlsRange_set_Value(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsRange_get_Value2(self.Ptr)
    ...
    def Value2(self, value:'SpireObject'):
        ...
        GetDllLibXls().XlsRange_set_Value2(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_VerticalAlignment(self.Ptr)
    ...
    def VerticalAlignment(self, value:'VerticalAlignType'):
        ...
        GetDllLibXls().XlsRange_set_VerticalAlignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsRange_get_Worksheet(self.Ptr)
...
#        ret = GetDllLibXls().XlsRange_GetNewRangeLocation(self.Ptr, intPtrnames,intPtrsheetName)
#        return ret
#
...
#        intPtr = GetDllLibXls().XlsRange_Clone(self.Ptr, intPtrparent,intPtrrangeNames,intPtrbook)
#        ret = None if intPtr==None else XlsRange(intPtr)
#        return ret
#
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_ClearConditionalFormats(self.Ptr)
    ...
    <returns>Rectangles information</returns>
        ...
        intPtrArray = GetDllLibXls().XlsRange_GetRectangles(self.Ptr)
    ...
    <returns>Number of rectangles.</returns>
        ...
        ret = GetDllLibXls().XlsRange_GetRectanglesCount(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_WorksheetName.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_WorksheetName(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_CellsCount(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_RangeGlobalAddress2007.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_RangeGlobalAddress2007(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_CalculateAllValue(self.Ptr)
    ...
    <returns>Returns the active cell.</returns>
        ...
        intPtr = GetDllLibXls().XlsRange_Activate(self.Ptr, scroll)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <returns>Returns the active cell.</returns>
        ...
        intPtr = GetDllLibXls().XlsRange_Activate1(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <returns>Created comment or exists one.</returns>
        ...
        intPtr = GetDllLibXls().XlsRange_AddComment1(self.Ptr)
        ret = None if intPtr==None else XlsComment(intPtr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_AutoFitColumns(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_AutoFitRows(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_BorderAround(self.Ptr)
    ...
    <param name="borderLine">Represents border line.</param>
        ...
        GetDllLibXls().XlsRange_BorderAroundB(self.Ptr, enumborderLine)
    ...
    <param name="borderColor">Represents border color.</param>
        ...
        GetDllLibXls().XlsRange_BorderAroundBB(self.Ptr, enumborderLine,intPtrborderColor)
    ...
    <param name="borderColor">Represents border color as ExcelColors.</param>
        ...
        GetDllLibXls().XlsRange_BorderAroundBB1(self.Ptr, enumborderLine,enumborderColor)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_BorderInside(self.Ptr)
    ...
    <param name="borderLine">Represents border line.</param>
        ...
        GetDllLibXls().XlsRange_BorderInsideB(self.Ptr, enumborderLine)
    ...
    <param name="borderColor">Represents border color.</param>
        ...
        GetDllLibXls().XlsRange_BorderInsideBB(self.Ptr, enumborderLine,intPtrborderColor)
    ...
    <param name="borderColor">Represents border color as ExcelColors.</param>
        ...
        GetDllLibXls().XlsRange_BorderInsideBB1(self.Ptr, enumborderLine,enumborderColor)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_BorderNone(self.Ptr)
    ...
    <param name="option">Represents the clear options.</param>
        ...
        GetDllLibXls().XlsRange_Clear(self.Ptr, enumoption)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_ClearAll(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_ClearContents(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsRange_GroupByColumns(self.Ptr, isCollapsed)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsRange_GroupByRows(self.Ptr, isCollapsed)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsRange_UngroupByColumns(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsRange_UngroupByRows(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <param name="groupBy">
        ...
        GetDllLibXls().XlsRange_CollapseGroup(self.Ptr, enumgroupBy)
    ...
    def CopyToClipboard(self):
        ...
        GetDllLibXls().XlsRange_CopyToClipboard(self.Ptr)
    ...
    def Dispose(self):
        ...
        GetDllLibXls().XlsRange_Dispose(self.Ptr)
    ...
    <param name="groupBy">
        ...
        GetDllLibXls().XlsRange_ExpandGroup(self.Ptr, enumgroupBy)
    ...
    <param name="flags">Additional option flags.</param>
        ...
        GetDllLibXls().XlsRange_ExpandGroupGF(self.Ptr, enumgroupBy,enumflags)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_FreezePanes(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_BooleanValue(self.Ptr)
        return ret

    @BooleanValue.setter
    def BooleanValue(self, value:bool):
        GetDllLibXls().XlsRange_set_BooleanValue.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsRange_set_BooleanValue(self.Ptr, value)
    ...
    def Borders(self)->'IBorders':
        ...
        intPtr = GetDllLibXls().XlsRange_get_Borders(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsRange_get_BuiltInStyle(self.Ptr)
    ...
    def BuiltInStyle(self, value:BuiltInStyles):
        ...
        GetDllLibXls().XlsRange_set_BuiltInStyle(self.Ptr, value.value)
    ...
    def Cells(self)->'ListXlsRanges':
        ...
        intPtr = GetDllLibXls().XlsRange_get_Cells(self.Ptr)
        ret = None if intPtr==None else ListXlsRanges(intPtr)
        return ret
...
#        intPtr = GetDllLibXls().XlsRange_get_CellList(self.Ptr)
#        ret = None if intPtr==None else List1(intPtr)
#        return ret
#
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_CellStyleName.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_CellStyleName(self.Ptr)
        return ret
    ...
    def CellStyleName(self, value:str):
        ...
        GetDllLibXls().XlsRange_set_CellStyleName(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_Column(self.Ptr)
        return ret
...
<remarks>
        ...
        ret = GetDllLibXls().XlsRange_get_ColumnGroupLevel(self.Ptr)
        return ret
    ...
    def Columns(self)->'ListXlsRanges':
        ...
        intPtr = GetDllLibXls().XlsRange_get_Columns(self.Ptr)
        ret = None if intPtr==None else ListXlsRanges(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_ColumnWidth(self.Ptr)
        return ret

    @ColumnWidth.setter
    def ColumnWidth(self, value:float):
        GetDllLibXls().XlsRange_set_ColumnWidth.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsRange_set_ColumnWidth(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsRange_get_Comment(self.Ptr)
        ret = None if intPtr==None else XlsComment(intPtr)
        return ret
    ...
    def ConditionalFormats(self)->'ConditionalFormats':
        ...
        intPtr = GetDllLibXls().XlsRange_get_ConditionalFormats(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsRange_get_CurrentRegion(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsRange_get_DataValidation(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsRange_get_DateTimeValue(self.Ptr)
    ...
    def DateTimeValue(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsRange_set_DateTimeValue(self.Ptr, value.Ptr)
    ...
    def EndCell(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsRange_get_EndCell(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def EntireColumn(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsRange_get_EntireColumn(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsRange_get_EntireRow(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_EnvalutedValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_EnvalutedValue(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_ErrorValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_ErrorValue(self.Ptr)
        return ret
    ...
    def ErrorValue(self, value:str):
        ...
        GetDllLibXls().XlsRange_set_ErrorValue(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_Formula.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_Formula(self.Ptr)
        return ret
    ...
    def Formula(self, value:str):
        ...
        GetDllLibXls().XlsRange_set_Formula(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_FormulaArray.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_FormulaArray(self.Ptr)
        return ret
    ...
    def FormulaArray(self, value:str):
        ...
        GetDllLibXls().XlsRange_set_FormulaArray(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_FormulaArrayR1C1.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_FormulaArrayR1C1(self.Ptr)
        return ret
    ...
    def FormulaArrayR1C1(self, value:str):
        ...
        GetDllLibXls().XlsRange_set_FormulaArrayR1C1(self.Ptr, value)
    ...
    def FormulaBoolValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsRange_get_FormulaBoolValue(self.Ptr)
        return ret
    ...
    def FormulaBoolValue(self, value:bool):
        ...
        GetDllLibXls().XlsRange_set_FormulaBoolValue(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsRange_get_FormulaDateTime(self.Ptr)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def FormulaDateTime(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsRange_set_FormulaDateTime(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_FormulaErrorValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_FormulaErrorValue(self.Ptr)
        return ret
    ...
    def FormulaErrorValue(self, value:str):
        ...
        GetDllLibXls().XlsRange_set_FormulaErrorValue(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_FormulaNumberValue(self.Ptr)
        return ret
    ...
    def FormulaNumberValue(self, value:float):
        ...
        GetDllLibXls().XlsRange_set_FormulaNumberValue(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_FormulaR1C1.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_FormulaR1C1(self.Ptr)
        return ret
    ...
    def FormulaR1C1(self, value:str):
        ...
        GetDllLibXls().XlsRange_set_FormulaR1C1(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_FormulaStringValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_FormulaStringValue(self.Ptr)
        return ret
    ...
    def FormulaStringValue(self, value:str):
        ...
        GetDllLibXls().XlsRange_set_FormulaStringValue(self.Ptr, value)

    @property

    def FormulaValue(self)->'SpireObject':
        """
    <summary>
        Gets formula value.
    </summary>
        ...
        intPtr = GetDllLibXls().XlsRange_get_FormulaValue(self.Ptr)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasBoolean(self.Ptr)
        return ret
    ...
    def HasComment(self)->bool:
        ...
        ret = GetDllLibXls().XlsRange_get_HasComment(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_ColumnCount(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_RowCount(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasDataValidation(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasDateTime(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasError(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasExternalFormula(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasFormula(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasFormulaArray(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasFormulaBoolValue(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasFormulaDateTime(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasFormulaErrorValue(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasFormulaNumberValue(self.Ptr)
        return ret
    ...
    def HasFormulaStringValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsRange_get_HasFormulaStringValue(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasMerged(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasNumber(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasPictures(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasRichText(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasString(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasStyle(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HorizontalAlignment(self.Ptr)
    ...
    def HorizontalAlignment(self, value:'HorizontalAlignType'):
        ...
        GetDllLibXls().XlsRange_set_HorizontalAlignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsRange_get_Hyperlinks(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_IgnoreErrorOptions(self.Ptr)
    ...
    def IgnoreErrorOptions(self, value:'IgnoreErrorType'):
        ...
        GetDllLibXls().XlsRange_set_IgnoreErrorOptions(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_IndentLevel(self.Ptr)
        return ret

    @IndentLevel.setter
    def IndentLevel(self, value:int):
        GetDllLibXls().XlsRange_set_IndentLevel.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsRange_set_IndentLevel(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_IsAllNumber(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_IsBlank(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_IsFormulaHidden(self.Ptr)
        return ret
    ...
    def IsFormulaHidden(self, value:bool):
        ...
        GetDllLibXls().XlsRange_set_IsFormulaHidden(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_IsGroupedByColumn(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_IsGroupedByRow(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_IsInitialized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        return GetDllLibXls().XlsRange_get_IsStringsPreserved(self.Ptr)
    ...
    def IsStringsPreserved(self, value:bool):
        ...
        GetDllLibXls().XlsRange_set_IsStringsPreserved(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_IsWrapText(self.Ptr)
        return ret

    @IsWrapText.setter
    def IsWrapText(self, value:bool):
        GetDllLibXls().XlsRange_set_IsWrapText.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsRange_set_IsWrapText(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_LastColumn(self.Ptr)
        return ret

    @LastColumn.setter
    def LastColumn(self, value:int):
        GetDllLibXls().XlsRange_set_LastColumn.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsRange_set_LastColumn(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_LastRow(self.Ptr)
        return ret

    @LastRow.setter
    def LastRow(self, value:int):
        GetDllLibXls().XlsRange_set_LastRow.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsRange_set_LastRow(self.Ptr, value)
    ...
    def MergeArea(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsRange_get_MergeArea(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_DisplayedText.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_DisplayedText(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_HasConditionFormats(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_NumberFormat.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_NumberFormat(self.Ptr)
        return ret
    ...
    def NumberFormat(self, value:str):
        ...
        GetDllLibXls().XlsRange_set_NumberFormat(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_NumberText.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_NumberText(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsRange_get_NumberValue(self.Ptr)
        return ret

    @NumberValue.setter
    def NumberValue(self, value:float):
        GetDllLibXls().XlsRange_set_NumberValue.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsRange_set_NumberValue(self.Ptr, value)
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsRange_get_Parent(self.Ptr)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_RangeAddress.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_RangeAddress(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_RangeAddressLocal.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_RangeAddressLocal(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_RangeGlobalAddressWithoutSheetName.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_RangeGlobalAddressWithoutSheetName(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsRange_get_RangeGlobalAddress.restype=c_wchar_p
        ret = GetDllLibXls().XlsRange_get_RangeGlobalAddress(self.Ptr)
        return ret
    ...
    def DEF_MAX_HEIGHT()->float:
        ...
        ret = GetDllLibXls().XlsRange_DEF_MAX_HEIGHT()
        return ret
