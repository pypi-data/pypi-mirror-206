...
class ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis(_5350.AbstractShaftToMountableComponentConnectionMultibodyDynamicsAnalysis):
    """ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis
    ...
    class _Cast_ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def shaft_to_mountable_component_connection_multibody_dynamics_analysis(self) -> 'ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis._Cast_ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis':
        return self._Cast_ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis(self)
