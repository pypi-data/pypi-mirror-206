...
class ShaftToMountableComponentConnectionSteadyStateSynchronousResponse(_2965.AbstractShaftToMountableComponentConnectionSteadyStateSynchronousResponse):
    """ShaftToMountableComponentConnectionSteadyStateSynchronousResponse
    ...
    class _Cast_ShaftToMountableComponentConnectionSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'ShaftToMountableComponentConnectionSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def shaft_to_mountable_component_connection_steady_state_synchronous_response(self) -> 'ShaftToMountableComponentConnectionSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftToMountableComponentConnectionSteadyStateSynchronousResponse._Cast_ShaftToMountableComponentConnectionSteadyStateSynchronousResponse':
        return self._Cast_ShaftToMountableComponentConnectionSteadyStateSynchronousResponse(self)
