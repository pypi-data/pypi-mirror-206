...
class StraightBevelDiffGearModalAnalysisAtASpeed(_5106.BevelGearModalAnalysisAtASpeed):
    """StraightBevelDiffGearModalAnalysisAtASpeed
    ...
    class _Cast_StraightBevelDiffGearModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_modal_analysis_at_a_speed(self) -> 'StraightBevelDiffGearModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearModalAnalysisAtASpeed._Cast_StraightBevelDiffGearModalAnalysisAtASpeed':
