...
class PlanetaryConnectionCompoundMultibodyDynamicsAnalysis(_5596.ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """PlanetaryConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5441.PlanetaryConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5441.PlanetaryConnectionMultibodyDynamicsAnalysis]':
