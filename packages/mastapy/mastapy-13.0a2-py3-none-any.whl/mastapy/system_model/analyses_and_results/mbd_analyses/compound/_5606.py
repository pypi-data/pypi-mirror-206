...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5604, _5605, _5517
...
class StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis(_5517.BevelGearSetCompoundMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_set_compound_multibody_dynamics_analysis(self) -> 'StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5468.StraightBevelDiffGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5604.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5605.StraightBevelDiffGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5468.StraightBevelDiffGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis._Cast_StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis':
        return self._Cast_StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis(self)
