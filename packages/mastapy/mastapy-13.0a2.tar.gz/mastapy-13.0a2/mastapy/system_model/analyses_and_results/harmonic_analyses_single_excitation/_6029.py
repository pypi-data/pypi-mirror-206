...
class FaceGearMeshHarmonicAnalysisOfSingleExcitation(_6034.GearMeshHarmonicAnalysisOfSingleExcitation):
    """FaceGearMeshHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_FaceGearMeshHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'FaceGearMeshHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def face_gear_mesh_harmonic_analysis_of_single_excitation(self) -> 'FaceGearMeshHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearMeshHarmonicAnalysisOfSingleExcitation._Cast_FaceGearMeshHarmonicAnalysisOfSingleExcitation':
