...
class UnbalancedMassCompoundAdvancedTimeSteppingAnalysisForModulation(_7225.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """UnbalancedMassCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7095.UnbalancedMassAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7095.UnbalancedMassAdvancedTimeSteppingAnalysisForModulation]':
