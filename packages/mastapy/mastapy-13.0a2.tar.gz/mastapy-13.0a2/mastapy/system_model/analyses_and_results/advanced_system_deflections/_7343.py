...
class StraightBevelDiffGearAdvancedSystemDeflection(_7251.BevelGearAdvancedSystemDeflection):
    """StraightBevelDiffGearAdvancedSystemDeflection
    ...
    class _Cast_StraightBevelDiffGearAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_advanced_system_deflection(self) -> 'StraightBevelDiffGearAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_detailed_analysis(self) -> '_395.StraightBevelDiffGearRating':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2794.StraightBevelDiffGearSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearAdvancedSystemDeflection._Cast_StraightBevelDiffGearAdvancedSystemDeflection':
