...
class StraightBevelPlanetGearSteadyStateSynchronousResponse(_3073.StraightBevelDiffGearSteadyStateSynchronousResponse):
    """StraightBevelPlanetGearSteadyStateSynchronousResponse
    ...
    class _Cast_StraightBevelPlanetGearSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'StraightBevelPlanetGearSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def straight_bevel_planet_gear_steady_state_synchronous_response(self) -> 'StraightBevelPlanetGearSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelPlanetGearSteadyStateSynchronousResponse._Cast_StraightBevelPlanetGearSteadyStateSynchronousResponse':
