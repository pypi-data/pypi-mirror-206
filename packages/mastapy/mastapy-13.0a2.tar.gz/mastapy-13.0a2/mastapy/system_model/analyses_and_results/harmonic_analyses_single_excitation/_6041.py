...
class InterMountableComponentConnectionHarmonicAnalysisOfSingleExcitation(_6010.ConnectionHarmonicAnalysisOfSingleExcitation):
    """InterMountableComponentConnectionHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_InterMountableComponentConnectionHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'InterMountableComponentConnectionHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def inter_mountable_component_connection_harmonic_analysis_of_single_excitation(self) -> 'InterMountableComponentConnectionHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'InterMountableComponentConnectionHarmonicAnalysisOfSingleExcitation._Cast_InterMountableComponentConnectionHarmonicAnalysisOfSingleExcitation':
        return self._Cast_InterMountableComponentConnectionHarmonicAnalysisOfSingleExcitation(self)
