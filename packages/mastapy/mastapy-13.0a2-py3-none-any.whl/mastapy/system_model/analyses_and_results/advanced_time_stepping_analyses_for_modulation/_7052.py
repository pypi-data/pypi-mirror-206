...
class OilSealAdvancedTimeSteppingAnalysisForModulation(_7009.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    """OilSealAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_OilSealAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'OilSealAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def oil_seal_advanced_time_stepping_analysis_for_modulation(self) -> 'OilSealAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'OilSealAdvancedTimeSteppingAnalysisForModulation._Cast_OilSealAdvancedTimeSteppingAnalysisForModulation':
