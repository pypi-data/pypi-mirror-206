...
class BevelDifferentialGearMeshStabilityAnalysis(_3758.BevelGearMeshStabilityAnalysis):
    """BevelDifferentialGearMeshStabilityAnalysis
    ...
    class _Cast_BevelDifferentialGearMeshStabilityAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_stability_analysis(self) -> 'BevelDifferentialGearMeshStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshStabilityAnalysis._Cast_BevelDifferentialGearMeshStabilityAnalysis':
