...
class XlsPivotCache (  XlsObject, IPivotCache) :
    ...
    def Index(self)->int:
        ...
        ret = GetDllLibXls().XlsPivotCache_get_Index(self.Ptr)
        return ret
    ...
    def SourceType(self)->'DataSourceType':
        ...
        ret = GetDllLibXls().XlsPivotCache_get_SourceType(self.Ptr)
    ...
    def SourceRange(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsPivotCache_get_SourceRange(self.Ptr)
    ...
    def Parent(self)->'XlsPivotCachesCollection':
        ...
        intPtr = GetDllLibXls().XlsPivotCache_get_Parent(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotCache_get_IsUpgradeOnRefresh(self.Ptr)
        return ret
    ...
    def IsUpgradeOnRefresh(self, value:bool):
        ...
        GetDllLibXls().XlsPivotCache_set_IsUpgradeOnRefresh(self.Ptr, value)
    ...
    def RefreshedBy(self)->str:
        ...
        GetDllLibXls().XlsPivotCache_get_RefreshedBy.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotCache_get_RefreshedBy(self.Ptr)
        return ret
    ...
    def RefreshedBy(self, value:str):
        ...
        GetDllLibXls().XlsPivotCache_set_RefreshedBy(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotCache_get_IsSupportSubQuery(self.Ptr)
        return ret
    ...
    def IsSupportSubQuery(self, value:bool):
        ...
        GetDllLibXls().XlsPivotCache_set_IsSupportSubQuery(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotCache_get_IsSaveData(self.Ptr)
        return ret

    @IsSaveData.setter
    def IsSaveData(self, value:bool):
        GetDllLibXls().XlsPivotCache_set_IsSaveData.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotCache_set_IsSaveData(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotCache_get_IsOptimizedCache(self.Ptr)
        return ret
    ...
    def IsOptimizedCache(self, value:bool):
        ...
        GetDllLibXls().XlsPivotCache_set_IsOptimizedCache(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotCache_get_EnableRefresh(self.Ptr)
        return ret
    ...
    def EnableRefresh(self, value:bool):
        ...
        GetDllLibXls().XlsPivotCache_set_EnableRefresh(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotCache_get_IsBackgroundQuery(self.Ptr)
        return ret
    ...
    def IsBackgroundQuery(self, value:bool):
        ...
        GetDllLibXls().XlsPivotCache_set_IsBackgroundQuery(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotCache_get_CreatedVersion(self.Ptr)
        return ret
    ...
    def CreatedVersion(self, value:int):
        ...
        GetDllLibXls().XlsPivotCache_set_CreatedVersion(self.Ptr, value)
    ...
    def CalculatedItemIndex(self)->int:
        ...
        ret = GetDllLibXls().XlsPivotCache_get_CalculatedItemIndex(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotCache_get_MinRefreshableVersion(self.Ptr)
        return ret
    ...
    def MinRefreshableVersion(self, value:int):
        ...
        GetDllLibXls().XlsPivotCache_set_MinRefreshableVersion(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotCache_get_RefreshedVersion(self.Ptr)
        return ret
    ...
    def RefreshedVersion(self, value:int):
        ...
        GetDllLibXls().XlsPivotCache_set_RefreshedVersion(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotCache_get_IsInvalidData(self.Ptr)
        return ret
    ...
    def IsInvalidData(self, value:bool):
        ...
        GetDllLibXls().XlsPivotCache_set_IsInvalidData(self.Ptr, value)
    ...
    def SupportAdvancedDrill(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotCache_get_SupportAdvancedDrill(self.Ptr)
        return ret
    ...
    def SupportAdvancedDrill(self, value:bool):
        ...
        GetDllLibXls().XlsPivotCache_set_SupportAdvancedDrill(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotCache_get_IsRefreshOnLoad(self.Ptr)
        return ret
    ...
    def IsRefreshOnLoad(self, value:bool):
        ...
        GetDllLibXls().XlsPivotCache_set_IsRefreshOnLoad(self.Ptr, value)
    ...
    def NeedDataArray(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotCache_get_NeedDataArray(self.Ptr)
        return ret
    ...
    def RefreshDate(self)->'DateTime':
        ...
        intPtr = GetDllLibXls().XlsPivotCache_get_RefreshDate(self.Ptr)
    ...
    def RefreshDate(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsPivotCache_set_RefreshDate(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsPivotCache_get_RangeName.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotCache_get_RangeName(self.Ptr)
        return ret
    ...
    def RangeName(self, value:str):
        ...
        GetDllLibXls().XlsPivotCache_set_RangeName(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotCache_get_HasNamedRange(self.Ptr)
        return ret
    ...
    def InRange(sourceRange:'IXLSRange',worksheet:'XlsWorksheet',index:int,count:int,isRow:bool)->bool:
        ...
        ret = GetDllLibXls().XlsPivotCache_InRange( intPtrsourceRange,intPtrworksheet,index,count,isRow)
        return ret
    ...
    def Clone(self ,parent:SpireObject)->SpireObject:
        ...
        intPtr = GetDllLibXls().XlsPivotCache_Clone(self.Ptr, intPtrparent)
...
#        intPtr = GetDllLibXls().XlsPivotCache_ClonePH(self.Ptr, intPtrparent,intPtrhashNewNames)
#        ret = None if intPtr==None else SpireObject(intPtr)
#        return ret
#
