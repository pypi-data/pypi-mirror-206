...
class FESubstructureExportOptions(_0.APIBase):
    ...
    class _Cast_FESubstructureExportOptions:
        ...
        def __init__(self, parent: 'FESubstructureExportOptions'):
            self._parent = parent

        @property
        def fe_substructure_export_options(self) -> 'FESubstructureExportOptions':
            return self._parent
    ...
    @property
    def include_fe_mesh_definition(self) -> 'bool':
        """bool: 'IncludeFEMeshDefinition' is the original name of this property."""
    ...
    def include_fe_mesh_definition(self, value: 'bool'):
        self.wrapped.IncludeFEMeshDefinition = bool(value) if value else False
    ...
    @property
    def cast_to(self) -> 'FESubstructureExportOptions._Cast_FESubstructureExportOptions':
