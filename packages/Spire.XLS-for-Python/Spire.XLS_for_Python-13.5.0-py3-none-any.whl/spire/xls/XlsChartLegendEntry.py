...
class XlsChartLegendEntry (  XlsObject, IChartLegendEntry) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegendEntry_get_Index(self.Ptr)
        return ret

    @Index.setter
    def Index(self, value:int):
        GetDllLibXls().XlsChartLegendEntry_set_Index.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartLegendEntry_set_Index(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegendEntry_get_LegendEntityIndex(self.Ptr)
        return ret
    ...
    def LegendEntityIndex(self, value:int):
        ...
        GetDllLibXls().XlsChartLegendEntry_set_LegendEntityIndex(self.Ptr, value)
    ...
    def TextArea(self)->'IChartTextArea':
        ...
        intPtr = GetDllLibXls().XlsChartLegendEntry_get_TextArea(self.Ptr)
    ...
    def IsDeleted(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartLegendEntry_get_IsDeleted(self.Ptr)
        return ret

    @IsDeleted.setter
    def IsDeleted(self, value:bool):
        GetDllLibXls().XlsChartLegendEntry_set_IsDeleted.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartLegendEntry_set_IsDeleted(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegendEntry_get_IsFormatted(self.Ptr)
        return ret

    @IsFormatted.setter
    def IsFormatted(self, value:bool):
        GetDllLibXls().XlsChartLegendEntry_set_IsFormatted.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartLegendEntry_set_IsFormatted(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartLegendEntry_get_BackgroundMode(self.Ptr)
    ...
    def BackgroundMode(self, value:'ChartBackgroundMode'):
        ...
        GetDllLibXls().XlsChartLegendEntry_set_BackgroundMode(self.Ptr, value.value)
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().XlsChartLegendEntry_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().XlsChartLegendEntry_EndUpdate(self.Ptr)
    ...
    def Clear(self):
        ...
        GetDllLibXls().XlsChartLegendEntry_Clear(self.Ptr)
    ...
    def Delete(self):
        ...
        GetDllLibXls().XlsChartLegendEntry_Delete(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsChartLegendEntry_Clone(self.Ptr, intPtrparent,intPtrdicIndexes,intPtrdicNewSheetNames)
