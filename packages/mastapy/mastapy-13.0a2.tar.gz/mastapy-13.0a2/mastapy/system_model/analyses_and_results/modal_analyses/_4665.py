...
class StraightBevelGearMeshModalAnalysis(_4563.BevelGearMeshModalAnalysis):
    """StraightBevelGearMeshModalAnalysis
    ...
    class _Cast_StraightBevelGearMeshModalAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshModalAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_modal_analysis(self) -> 'StraightBevelGearMeshModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshModalAnalysis._Cast_StraightBevelGearMeshModalAnalysis':
