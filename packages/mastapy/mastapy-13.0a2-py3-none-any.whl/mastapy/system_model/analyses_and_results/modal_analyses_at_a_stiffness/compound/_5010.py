...
class CylindricalPlanetGearCompoundModalAnalysisAtAStiffness(_5007.CylindricalGearCompoundModalAnalysisAtAStiffness):
    """CylindricalPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4880.CylindricalPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4880.CylindricalPlanetGearModalAnalysisAtAStiffness]':
