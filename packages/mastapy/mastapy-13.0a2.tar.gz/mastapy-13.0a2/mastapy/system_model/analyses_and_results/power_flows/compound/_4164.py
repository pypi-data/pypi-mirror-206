...
class ClutchConnectionCompoundPowerFlow(_4180.CouplingConnectionCompoundPowerFlow):
    """ClutchConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4030.ClutchConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4030.ClutchConnectionPowerFlow]':
