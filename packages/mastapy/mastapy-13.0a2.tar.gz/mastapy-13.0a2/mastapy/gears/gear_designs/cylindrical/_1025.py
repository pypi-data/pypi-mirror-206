...
class CylindricalGearSetMacroGeometryOptimiser(_328.GearSetOptimiser):
    """CylindricalGearSetMacroGeometryOptimiser
    ...
    class _Cast_CylindricalGearSetMacroGeometryOptimiser:
        ...
        def __init__(self, parent: 'CylindricalGearSetMacroGeometryOptimiser'):
            self._parent = parent

        @property
        def gear_set_optimiser(self):
            return self._parent._cast(_328.GearSetOptimiser)

        @property
        def cylindrical_gear_set_macro_geometry_optimiser(self) -> 'CylindricalGearSetMacroGeometryOptimiser':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearSetMacroGeometryOptimiser._Cast_CylindricalGearSetMacroGeometryOptimiser':
