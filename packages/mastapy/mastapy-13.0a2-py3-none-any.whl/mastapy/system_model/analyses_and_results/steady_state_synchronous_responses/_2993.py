...
class ConceptGearSteadyStateSynchronousResponse(_3023.GearSteadyStateSynchronousResponse):
    """ConceptGearSteadyStateSynchronousResponse
    ...
    class _Cast_ConceptGearSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'ConceptGearSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def concept_gear_steady_state_synchronous_response(self) -> 'ConceptGearSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptGearSteadyStateSynchronousResponse._Cast_ConceptGearSteadyStateSynchronousResponse':
