...
class LinkSessionErrorForbiddenConfigResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error_code(schemas.EnumBase, schemas.StrSchema):
                class MetaOapg:
                    enum_value_to_name = {
                        "link_session_error.forbidden_config": "LINK_SESSION_ERROR_FORBIDDEN_CONFIG",
                    }

                @schemas.classproperty
                def LINK_SESSION_ERROR_FORBIDDEN_CONFIG(cls):
                    return cls("link_session_error.forbidden_config")
