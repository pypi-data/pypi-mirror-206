...
class RollingRingDynamicAnalysis(_6282.CouplingHalfDynamicAnalysis):
    """RollingRingDynamicAnalysis
    ...
    class _Cast_RollingRingDynamicAnalysis:
        ...
        def __init__(self, parent: 'RollingRingDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def rolling_ring_dynamic_analysis(self) -> 'RollingRingDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingDynamicAnalysis._Cast_RollingRingDynamicAnalysis':
