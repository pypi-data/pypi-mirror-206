...
class ConceptCouplingCompoundSystemDeflection(_2867.CouplingCompoundSystemDeflection):
    """ConceptCouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2698.ConceptCouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2698.ConceptCouplingSystemDeflection]':
