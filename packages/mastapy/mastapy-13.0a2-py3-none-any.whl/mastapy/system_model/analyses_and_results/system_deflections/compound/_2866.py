...
class ConnectorCompoundSystemDeflection(_2908.MountableComponentCompoundSystemDeflection):
    """ConnectorCompoundSystemDeflection
    ...
    class _Cast_ConnectorCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'ConnectorCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def connector_compound_system_deflection(self) -> 'ConnectorCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2707.ConnectorSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2707.ConnectorSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'ConnectorCompoundSystemDeflection._Cast_ConnectorCompoundSystemDeflection':
