...
class ModuleLicenceStatus:
    ...
    class _Cast_ModuleLicenceStatus:
        ...
        def __init__(self, parent: 'ModuleLicenceStatus'):
            self._parent = parent

        @property
        def module_licence_status(self) -> 'ModuleLicenceStatus':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ModuleLicenceStatus._Cast_ModuleLicenceStatus':
