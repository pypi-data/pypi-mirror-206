...
class AbstractAssemblyCompoundSystemDeflection(_2910.PartCompoundSystemDeflection):
    """AbstractAssemblyCompoundSystemDeflection
    ...
    class _Cast_AbstractAssemblyCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'AbstractAssemblyCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def abstract_assembly_compound_system_deflection(self) -> 'AbstractAssemblyCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2664.AbstractAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2664.AbstractAssemblySystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'AbstractAssemblyCompoundSystemDeflection._Cast_AbstractAssemblyCompoundSystemDeflection':
