...
class CylindricalGearCommonFlankMicroGeometry(_0.APIBase):
    ...
    class _Cast_CylindricalGearCommonFlankMicroGeometry:
        ...
        def __init__(self, parent: 'CylindricalGearCommonFlankMicroGeometry'):
            self._parent = parent

        @property
        def cylindrical_gear_common_flank_micro_geometry(self) -> 'CylindricalGearCommonFlankMicroGeometry':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearCommonFlankMicroGeometry._Cast_CylindricalGearCommonFlankMicroGeometry':
