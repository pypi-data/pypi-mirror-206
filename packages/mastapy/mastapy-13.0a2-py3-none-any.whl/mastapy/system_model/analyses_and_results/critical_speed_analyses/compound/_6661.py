...
class ClutchConnectionCompoundCriticalSpeedAnalysis(_6677.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """ClutchConnectionCompoundCriticalSpeedAnalysis
    ...
    class _Cast_ClutchConnectionCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ClutchConnectionCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_connection_compound_critical_speed_analysis(self) -> 'ClutchConnectionCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6529.ClutchConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6529.ClutchConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ClutchConnectionCompoundCriticalSpeedAnalysis._Cast_ClutchConnectionCompoundCriticalSpeedAnalysis':
