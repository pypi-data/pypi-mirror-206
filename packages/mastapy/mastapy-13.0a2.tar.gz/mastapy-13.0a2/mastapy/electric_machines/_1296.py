...
from mastapy.electric_machines import _1297, _1238
...
class ToothAndSlot(_1238.AbstractToothAndSlot):
    """ToothAndSlot
    ...
    def tooth_taper_angle(self, value: 'float'):
        self.wrapped.ToothTaperAngle = float(value) if value else 0.0
    ...
    @property
    def tooth_slot_style(self) -> '_1297.ToothSlotStyle':
        ...
        value = conversion.pn_to_mp_enum(temp, _1297.ToothSlotStyle)
        return constructor.new_from_mastapy_type(_1297.ToothSlotStyle)(value) if value is not None else None

    @tooth_slot_style.setter
    def tooth_slot_style(self, value: '_1297.ToothSlotStyle'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1297.ToothSlotStyle.type_())
