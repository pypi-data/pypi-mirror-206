...
class MeasurementComponentAdvancedTimeSteppingAnalysisForModulation(_7096.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """MeasurementComponentAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_MeasurementComponentAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'MeasurementComponentAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def measurement_component_advanced_time_stepping_analysis_for_modulation(self) -> 'MeasurementComponentAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2759.MeasurementComponentSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'MeasurementComponentAdvancedTimeSteppingAnalysisForModulation._Cast_MeasurementComponentAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_MeasurementComponentAdvancedTimeSteppingAnalysisForModulation(self)
