...
conf = cashfree_lrs_client.Configuration(
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'X-API-Version' in self.api_key:
            auth['X-API-Version'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-API-Version',
        ...
        if 'X-Client-ID' in self.api_key:
            auth['X-Client-ID'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-Client-ID',
        ...
        if 'X-Client-Secret' in self.api_key:
            auth['X-Client-Secret'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-Client-Secret',
                'value': self.get_api_key_with_prefix(
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://sandbox.cashfree.com/pg/lrs",
                'description': "Sandbox",
            },
            {
                'url': "https://api.cashfree.com/pg/lrs",
