...
class Spelling():
    ...
    def initDict(self,inputDict=os.path.join(THIADIR, "input/dict_lexitron.txt")):
    ...
    def correction(self,word):
        return max(self.checkSpell(word), key=self.P)
    ...
    def edits2(self,word):
        return list(e2 for e1 in self.edits1(word) for e2 in self.edits1(e1))
