...
class XlsRectangleShape (  XlsPrstGeomShape, IRectangleShape) :
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsRectangleShape_get_ShapeType(self.Ptr)
    ...
    def RectShapeType(self)->'RectangleShapeType':
        ...
        ret = GetDllLibXls().XlsRectangleShape_get_RectShapeType(self.Ptr)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().XlsRectangleShape_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsRectangleShape_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsRectangleShape_set_Text(self.Ptr, value)
    ...
    def IsTextLocked(self)->bool:
        ...
        ret = GetDllLibXls().XlsRectangleShape_get_IsTextLocked(self.Ptr)
        return ret

    @IsTextLocked.setter
    def IsTextLocked(self, value:bool):
        GetDllLibXls().XlsRectangleShape_set_IsTextLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsRectangleShape_set_IsTextLocked(self.Ptr, value)
    ...
    def TextRotation(self)->'TextRotationType':
        ...
        ret = GetDllLibXls().XlsRectangleShape_get_TextRotation(self.Ptr)
    ...
    def TextRotation(self, value:'TextRotationType'):
        ...
        GetDllLibXls().XlsRectangleShape_set_TextRotation(self.Ptr, value.value)
    ...
    def RichText(self)->'IRichTextString':
        ...
        intPtr = GetDllLibXls().XlsRectangleShape_get_RichText(self.Ptr)
    ...
    def HAlignment(self)->'CommentHAlignType':
        ...
        ret = GetDllLibXls().XlsRectangleShape_get_HAlignment(self.Ptr)
    ...
    def HAlignment(self, value:'CommentHAlignType'):
        ...
        GetDllLibXls().XlsRectangleShape_set_HAlignment(self.Ptr, value.value)
    ...
    def VAlignment(self)->'CommentVAlignType':
        ...
        ret = GetDllLibXls().XlsRectangleShape_get_VAlignment(self.Ptr)
    ...
    def VAlignment(self, value:'CommentVAlignType'):
        ...
        GetDllLibXls().XlsRectangleShape_set_VAlignment(self.Ptr, value.value)
    ...
    def HyLink(self)->'IHyperLink':
        ...
        intPtr = GetDllLibXls().XlsRectangleShape_get_HyLink(self.Ptr)
    ...
    def PrstShapeType(self)->'PrstGeomShapeType':
        ...
        ret = GetDllLibXls().XlsRectangleShape_get_PrstShapeType(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsRectangleShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
