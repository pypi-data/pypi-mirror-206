...
class ConceptGearCompoundPowerFlow(_4200.GearCompoundPowerFlow):
    """ConceptGearCompoundPowerFlow
    ...
    class _Cast_ConceptGearCompoundPowerFlow:
        ...
        def __init__(self, parent: 'ConceptGearCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def concept_gear_compound_power_flow(self) -> 'ConceptGearCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4039.ConceptGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4039.ConceptGearPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'ConceptGearCompoundPowerFlow._Cast_ConceptGearCompoundPowerFlow':
