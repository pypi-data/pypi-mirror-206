...
class PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation(_7010.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_advanced_time_stepping_analysis_for_modulation(self) -> 'PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2767.PartToPartShearCouplingSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation._Cast_PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation(self)
