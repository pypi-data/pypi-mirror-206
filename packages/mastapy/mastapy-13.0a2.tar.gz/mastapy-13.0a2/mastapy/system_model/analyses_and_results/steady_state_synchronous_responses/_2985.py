...
class ClutchSteadyStateSynchronousResponse(_3001.CouplingSteadyStateSynchronousResponse):
    """ClutchSteadyStateSynchronousResponse
    ...
    class _Cast_ClutchSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'ClutchSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def clutch_steady_state_synchronous_response(self) -> 'ClutchSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchSteadyStateSynchronousResponse._Cast_ClutchSteadyStateSynchronousResponse':
