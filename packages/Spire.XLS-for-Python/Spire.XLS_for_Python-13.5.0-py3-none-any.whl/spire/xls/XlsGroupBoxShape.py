...
class XlsGroupBoxShape (  XlsShape, IGroupBox) :
    ...
    def Display3DShading(self)->bool:
        ...
        ret = GetDllLibXls().XlsGroupBoxShape_get_Display3DShading(self.Ptr)
        return ret
    ...
    def Display3DShading(self, value:bool):
        ...
        GetDllLibXls().XlsGroupBoxShape_set_Display3DShading(self.Ptr, value)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().XlsGroupBoxShape_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsGroupBoxShape_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsGroupBoxShape_set_Text(self.Ptr, value)
    ...
    def IsTextLocked(self)->bool:
        ...
        ret = GetDllLibXls().XlsGroupBoxShape_get_IsTextLocked(self.Ptr)
        return ret

    @IsTextLocked.setter
    def IsTextLocked(self, value:bool):
        GetDllLibXls().XlsGroupBoxShape_set_IsTextLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsGroupBoxShape_set_IsTextLocked(self.Ptr, value)
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsGroupBoxShape_get_ShapeType(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsGroupBoxShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
