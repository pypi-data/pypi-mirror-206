...
class CylindricalGearLeadModification(_567.LeadModification):
    ...
    class _Cast_CylindricalGearLeadModification:
        ...
        def __init__(self, parent: 'CylindricalGearLeadModification'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_lead_modification(self) -> 'CylindricalGearLeadModification':
            return self._parent
    ...
    @property
    def lead_modification_chart(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearLeadModification._Cast_CylindricalGearLeadModification':
