...
class WormGearMeshCriticalSpeedAnalysis(_6569.GearMeshCriticalSpeedAnalysis):
    """WormGearMeshCriticalSpeedAnalysis
    ...
    class _Cast_WormGearMeshCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'WormGearMeshCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def worm_gear_mesh_critical_speed_analysis(self) -> 'WormGearMeshCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearMeshCriticalSpeedAnalysis._Cast_WormGearMeshCriticalSpeedAnalysis':
