...
class WormGearMeshSteadyStateSynchronousResponseOnAShaft(_3282.GearMeshSteadyStateSynchronousResponseOnAShaft):
    """WormGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_WormGearMeshSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'WormGearMeshSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def worm_gear_mesh_steady_state_synchronous_response_on_a_shaft(self) -> 'WormGearMeshSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearMeshSteadyStateSynchronousResponseOnAShaft._Cast_WormGearMeshSteadyStateSynchronousResponseOnAShaft':
