...
class GetWorkTest(unittest.TestCase):
    ...
    def testWorkAliases(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "80737426-8ef3-3a9c-a3a6-9507afb93e93-aliases.xml")
        ...
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "3d7c7cd2-da79-37f4-98b8-ccfb1a4ac6c4-aliases.xml")
        aliases = res["work"]["alias-list"]
    ...
    def testWorkAttributes(self):
        ...
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "8e134b32-99b8-4e96-ae5c-426f3be85f4c-attributes.xml")
        work_attrs = res["work"]["attribute-list"]
    ...
    def testWorkRelationAttributes(self):
        ...
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "72c9aad2-3c95-4e3e-8a01-3974f8fef8eb-series-rels.xml")
