...
class VolumeSpaceSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    capacity_tier_footprint_data_reduction = Size(data_key="capacity_tier_footprint_data_reduction")
    ...
    """afs_total,auto_adaptive_compression_footprint_data_reduction,available,available_percent,block_storage_inactive_user_data,block_storage_inactive_user_data_percent,capacity_tier_footprint,capacity_tier_footprint_data_reduction,cross_volume_dedupe_metafiles_footprint,cross_volume_dedupe_metafiles_temporary_footprint,dedupe_metafiles_footprint,dedupe_metafiles_temporary_footprint,delayed_free_footprint,effective_total_footprint,expected_available,file_operation_metadata,filesystem_size,filesystem_size_fixed,footprint,fractional_reserve,full_threshold_percent,is_used_stale,large_size_enabled,local_tier_footprint,logical_space,metadata,nearly_full_threshold_percent,over_provisioned,overwrite_reserve,overwrite_reserve_used,percent_used,performance_tier_footprint,physical_used,physical_used_percent,size,size_available_for_snapshots,snapmirror_destination_footprint,snapshot,snapshot_reserve_unusable,snapshot_spill,total_footprint,used,used_by_afs,user_data,volume_guarantee_footprint,"""
