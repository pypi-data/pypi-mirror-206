...
class ShaftCompoundSteadyStateSynchronousResponseOnAShaft(_3355.AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft):
    """ShaftCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_ShaftCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'ShaftCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def shaft_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'ShaftCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3320.ShaftSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3320.ShaftSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'ShaftCompoundSteadyStateSynchronousResponseOnAShaft._Cast_ShaftCompoundSteadyStateSynchronousResponseOnAShaft':
