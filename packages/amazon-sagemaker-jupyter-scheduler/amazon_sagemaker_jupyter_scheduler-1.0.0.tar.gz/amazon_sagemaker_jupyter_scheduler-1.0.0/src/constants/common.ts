  ...
  ScheduleNoteBook: {
    MainPanel: {
      AdvancedOptions: {
        ...
        efsPlaceholder: 'Enter file path',
        efsLabel: 'Initialization script location',
      ...
      Tooltips: {
        ...
        SecurityGroupsTooltip:
          'Specify or add security group(s) of the desired VPC.',
        SubnetTooltip:
          'Specify or add Private subnet(s) of the desired VPC.',
