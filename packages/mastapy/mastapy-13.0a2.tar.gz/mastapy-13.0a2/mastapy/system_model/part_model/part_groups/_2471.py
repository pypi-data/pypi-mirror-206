...
class PartGroup(_0.APIBase):
    ...
    class _Cast_PartGroup:
        ...
        def __init__(self, parent: 'PartGroup'):
            self._parent = parent

        @property
        def concentric_or_parallel_part_group(self):
            from mastapy.system_model.part_model.part_groups import _2466
            
            return self._parent._cast(_2466.ConcentricOrParallelPartGroup)

        @property
        def concentric_part_group(self):
            from mastapy.system_model.part_model.part_groups import _2467
            
            return self._parent._cast(_2467.ConcentricPartGroup)

        @property
        def parallel_part_group(self):
            from mastapy.system_model.part_model.part_groups import _2470
            
            return self._parent._cast(_2470.ParallelPartGroup)

        @property
        def part_group(self) -> 'PartGroup':
            return self._parent
    ...
    @property
    def parts(self) -> 'List[_2448.Part]':
    ...
    @property
    def cast_to(self) -> 'PartGroup._Cast_PartGroup':
