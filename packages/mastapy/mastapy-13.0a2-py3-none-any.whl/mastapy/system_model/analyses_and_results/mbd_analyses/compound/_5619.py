...
class TorqueConverterTurbineCompoundMultibodyDynamicsAnalysis(_5538.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """TorqueConverterTurbineCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5483.TorqueConverterTurbineMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5483.TorqueConverterTurbineMultibodyDynamicsAnalysis]':
