...
class CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection(_7371.AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection
    ...
    class _Cast_CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_planetary_bearing_connection_compound_advanced_system_deflection(self) -> 'CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7282.CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7282.CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection._Cast_CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection':
        return self._Cast_CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection(self)
