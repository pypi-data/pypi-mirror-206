...
class ClutchCompoundSteadyStateSynchronousResponseAtASpeed(_3650.CouplingCompoundSteadyStateSynchronousResponseAtASpeed):
    """ClutchCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ClutchCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ClutchCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def clutch_compound_steady_state_synchronous_response_at_a_speed(self) -> 'ClutchCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3506.ClutchSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3506.ClutchSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ClutchCompoundSteadyStateSynchronousResponseAtASpeed._Cast_ClutchCompoundSteadyStateSynchronousResponseAtASpeed':
