...
class KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool(_4452.ConicalGearSetCompoundParametricStudyTool):
    """KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool
    ...
    class _Cast_KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_conical_gear_set_compound_parametric_study_tool(self) -> 'KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4346.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4346.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool._Cast_KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool':
        return self._Cast_KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool(self)
