...
class SynchroniserSleeveModalAnalysisAtAStiffness(_4946.SynchroniserPartModalAnalysisAtAStiffness):
    """SynchroniserSleeveModalAnalysisAtAStiffness
    ...
    class _Cast_SynchroniserSleeveModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'SynchroniserSleeveModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def synchroniser_sleeve_modal_analysis_at_a_stiffness(self) -> 'SynchroniserSleeveModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserSleeveModalAnalysisAtAStiffness._Cast_SynchroniserSleeveModalAnalysisAtAStiffness':
