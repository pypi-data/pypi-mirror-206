...
class PlanetaryGearSetCompoundDynamicAnalysis(_6422.CylindricalGearSetCompoundDynamicAnalysis):
    """PlanetaryGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6328.PlanetaryGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6328.PlanetaryGearSetDynamicAnalysis]':
