...
class DataIndex(BaseEngineModel):
    ...
    def _from_engine_format(cls, data: dict) -> "DataIndex":
        return cls._create_instance(
            **{
                "type_id": data.pop("typeId"),
                "task_id": data.pop("taskId"),
                "file_url": data.pop("fileUrl"),
                "index_url": data.pop("indexUrl"),
                "loader_id": data.pop("loaderId"),
    ...
    def _to_engine_format(self) -> dict:
        ...
        return {
            "typeId": base_dict.pop("type_id"),
            "taskId": base_dict.pop("task_id"),
            "fileUrl": base_dict.pop("file_url"),
            "indexUrl": base_dict.pop("index_url"),
            "loaderId": base_dict.pop("loader_id"),
