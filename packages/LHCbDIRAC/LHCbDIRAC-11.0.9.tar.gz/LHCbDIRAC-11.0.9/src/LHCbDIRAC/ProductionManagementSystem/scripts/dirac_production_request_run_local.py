...
def parseArgs():
    ...
    return Path(yaml_path), name, eventType, inputFiles, useCfgOverride
...
def main():
    ...
    testProductionRequest(productionRequest, eventType=eventType, numTestEvents=numTestEvents, inputFiles=inputFiles)
