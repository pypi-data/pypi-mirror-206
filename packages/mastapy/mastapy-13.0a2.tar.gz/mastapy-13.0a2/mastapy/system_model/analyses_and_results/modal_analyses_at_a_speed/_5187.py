...
class SpecialisedAssemblyModalAnalysisAtASpeed(_5089.AbstractAssemblyModalAnalysisAtASpeed):
    """SpecialisedAssemblyModalAnalysisAtASpeed
    ...
    class _Cast_SpecialisedAssemblyModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'SpecialisedAssemblyModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def specialised_assembly_modal_analysis_at_a_speed(self) -> 'SpecialisedAssemblyModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpecialisedAssemblyModalAnalysisAtASpeed._Cast_SpecialisedAssemblyModalAnalysisAtASpeed':
