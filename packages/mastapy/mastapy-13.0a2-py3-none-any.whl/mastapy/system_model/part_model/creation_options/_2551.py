...
class CycloidalAssemblyCreationOptions(_0.APIBase):
    ...
    class _Cast_CycloidalAssemblyCreationOptions:
        ...
        def __init__(self, parent: 'CycloidalAssemblyCreationOptions'):
            self._parent = parent

        @property
        def cycloidal_assembly_creation_options(self) -> 'CycloidalAssemblyCreationOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalAssemblyCreationOptions._Cast_CycloidalAssemblyCreationOptions':
