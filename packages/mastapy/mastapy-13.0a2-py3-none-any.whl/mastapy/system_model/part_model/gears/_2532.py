...
class ZerolBevelGear(_2498.BevelGear):
    """ZerolBevelGear
    ...
    class _Cast_ZerolBevelGear:
        ...
        def __init__(self, parent: 'ZerolBevelGear'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear(self) -> 'ZerolBevelGear':
            return self._parent
    ...
    @property
    def bevel_gear_design(self) -> '_947.ZerolBevelGearDesign':
    ...
    @property
    def zerol_bevel_gear_design(self) -> '_947.ZerolBevelGearDesign':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGear._Cast_ZerolBevelGear':
