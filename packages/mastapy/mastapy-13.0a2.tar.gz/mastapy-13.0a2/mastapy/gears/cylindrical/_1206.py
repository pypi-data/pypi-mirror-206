...
class GearLTCAContactChartDataAsTextFile(_0.APIBase):
    ...
    class _Cast_GearLTCAContactChartDataAsTextFile:
        ...
        def __init__(self, parent: 'GearLTCAContactChartDataAsTextFile'):
            self._parent = parent

        @property
        def cylindrical_gear_ltca_contact_chart_data_as_text_file(self):
            from mastapy.gears.cylindrical import _1202
            
            return self._parent._cast(_1202.CylindricalGearLTCAContactChartDataAsTextFile)

        @property
        def gear_ltca_contact_chart_data_as_text_file(self) -> 'GearLTCAContactChartDataAsTextFile':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GearLTCAContactChartDataAsTextFile._Cast_GearLTCAContactChartDataAsTextFile':
