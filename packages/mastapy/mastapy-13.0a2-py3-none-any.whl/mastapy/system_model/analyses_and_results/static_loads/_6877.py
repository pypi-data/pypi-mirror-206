...
class KlingelnbergCycloPalloidConicalGearMeshLoadCase(_6810.ConicalGearMeshLoadCase):
    """KlingelnbergCycloPalloidConicalGearMeshLoadCase
    ...
    class _Cast_KlingelnbergCycloPalloidConicalGearMeshLoadCase:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidConicalGearMeshLoadCase'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_conical_gear_mesh_load_case(self) -> 'KlingelnbergCycloPalloidConicalGearMeshLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidConicalGearMeshLoadCase._Cast_KlingelnbergCycloPalloidConicalGearMeshLoadCase':
