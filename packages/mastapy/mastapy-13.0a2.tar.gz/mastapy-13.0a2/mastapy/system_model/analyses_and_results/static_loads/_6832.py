...
class DataFromMotorPackagePerSpeed(_0.APIBase):
    ...
    class _Cast_DataFromMotorPackagePerSpeed:
        ...
        def __init__(self, parent: 'DataFromMotorPackagePerSpeed'):
            self._parent = parent

        @property
        def data_from_motor_package_per_speed(self) -> 'DataFromMotorPackagePerSpeed':
            return self._parent
    ...
    @property
    def data_per_mean_torque(self) -> 'List[_6831.DataFromMotorPackagePerMeanTorque]':
    ...
    @property
    def cast_to(self) -> 'DataFromMotorPackagePerSpeed._Cast_DataFromMotorPackagePerSpeed':
