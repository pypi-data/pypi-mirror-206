...
class SpringDamperCriticalSpeedAnalysis(_6546.CouplingCriticalSpeedAnalysis):
    """SpringDamperCriticalSpeedAnalysis
    ...
    class _Cast_SpringDamperCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'SpringDamperCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def spring_damper_critical_speed_analysis(self) -> 'SpringDamperCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperCriticalSpeedAnalysis._Cast_SpringDamperCriticalSpeedAnalysis':
