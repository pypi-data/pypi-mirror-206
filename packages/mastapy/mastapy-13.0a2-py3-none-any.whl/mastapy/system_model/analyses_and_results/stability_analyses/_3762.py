...
class BoltStabilityAnalysis(_3767.ComponentStabilityAnalysis):
    """BoltStabilityAnalysis
    ...
    class _Cast_BoltStabilityAnalysis:
        ...
        def __init__(self, parent: 'BoltStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def bolt_stability_analysis(self) -> 'BoltStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltStabilityAnalysis._Cast_BoltStabilityAnalysis':
