...
class WormGearCompoundDynamicAnalysis(_6431.GearCompoundDynamicAnalysis):
    """WormGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6367.WormGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6367.WormGearDynamicAnalysis]':
