...
class DatumDynamicAnalysis(_6268.ComponentDynamicAnalysis):
    """DatumDynamicAnalysis
    ...
    class _Cast_DatumDynamicAnalysis:
        ...
        def __init__(self, parent: 'DatumDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def datum_dynamic_analysis(self) -> 'DatumDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DatumDynamicAnalysis._Cast_DatumDynamicAnalysis':
