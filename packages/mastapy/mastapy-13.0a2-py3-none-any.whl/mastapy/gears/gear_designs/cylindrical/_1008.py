...
class CylindricalGearDesignConstraint(_0.APIBase):
    ...
    class _Cast_CylindricalGearDesignConstraint:
        ...
        def __init__(self, parent: 'CylindricalGearDesignConstraint'):
            self._parent = parent

        @property
        def cylindrical_gear_design_constraint(self) -> 'CylindricalGearDesignConstraint':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearDesignConstraint._Cast_CylindricalGearDesignConstraint':
