...
class StraightBevelGearMeshCompoundStabilityAnalysis(_3891.BevelGearMeshCompoundStabilityAnalysis):
    """StraightBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3853.StraightBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3853.StraightBevelGearMeshStabilityAnalysis]':
