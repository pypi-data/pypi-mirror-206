...
class HypoidGearCompoundSteadyStateSynchronousResponse(_3099.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse):
    """HypoidGearCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_HypoidGearCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'HypoidGearCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_compound_steady_state_synchronous_response(self) -> 'HypoidGearCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3027.HypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3027.HypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearCompoundSteadyStateSynchronousResponse._Cast_HypoidGearCompoundSteadyStateSynchronousResponse':
