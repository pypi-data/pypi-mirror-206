...
class PointLoadCriticalSpeedAnalysis(_6632.VirtualComponentCriticalSpeedAnalysis):
    """PointLoadCriticalSpeedAnalysis
    ...
    class _Cast_PointLoadCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'PointLoadCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def point_load_critical_speed_analysis(self) -> 'PointLoadCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PointLoadCriticalSpeedAnalysis._Cast_PointLoadCriticalSpeedAnalysis':
