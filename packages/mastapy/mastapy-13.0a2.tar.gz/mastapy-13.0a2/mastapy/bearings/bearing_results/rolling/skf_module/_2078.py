...
class PermissibleAxialLoad(_0.APIBase):
    ...
    class _Cast_PermissibleAxialLoad:
        ...
        def __init__(self, parent: 'PermissibleAxialLoad'):
            self._parent = parent

        @property
        def permissible_axial_load(self) -> 'PermissibleAxialLoad':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PermissibleAxialLoad._Cast_PermissibleAxialLoad':
