...
class KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis(_4618.KlingelnbergCycloPalloidConicalGearModalAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_modal_analysis(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis._Cast_KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis':
