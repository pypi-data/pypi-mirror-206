...
class XlsListBoxShape (  XlsShape, IListBox) :
    ...
    def Display3DShading(self)->bool:
        ...
        ret = GetDllLibXls().XlsListBoxShape_get_Display3DShading(self.Ptr)
        return ret
    ...
    def Display3DShading(self, value:bool):
        ...
        GetDllLibXls().XlsListBoxShape_set_Display3DShading(self.Ptr, value)
    ...
    def LinkedCell(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsListBoxShape_get_LinkedCell(self.Ptr)
    ...
    def LinkedCell(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsListBoxShape_set_LinkedCell(self.Ptr, value.Ptr)
    ...
    def ListFillRange(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsListBoxShape_get_ListFillRange(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def ListFillRange(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsListBoxShape_set_ListFillRange(self.Ptr, value.Ptr)
    ...
    def SelectedIndex(self)->int:
        ...
        ret = GetDllLibXls().XlsListBoxShape_get_SelectedIndex(self.Ptr)
        return ret

    @SelectedIndex.setter
    def SelectedIndex(self, value:int):
        GetDllLibXls().XlsListBoxShape_set_SelectedIndex.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsListBoxShape_set_SelectedIndex(self.Ptr, value)
    ...
    def SelectionType(self)->'SelectionType':
        ...
        ret = GetDllLibXls().XlsListBoxShape_get_SelectionType(self.Ptr)
    ...
    def SelectionType(self, value:'SelectionType'):
        ...
        GetDllLibXls().XlsListBoxShape_set_SelectionType(self.Ptr, value.value)
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsListBoxShape_get_ShapeType(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsListBoxShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
