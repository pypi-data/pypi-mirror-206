...
class StraightBevelGearCompoundSystemDeflection(_2846.BevelGearCompoundSystemDeflection):
    """StraightBevelGearCompoundSystemDeflection
    ...
    class _Cast_StraightBevelGearCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'StraightBevelGearCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_compound_system_deflection(self) -> 'StraightBevelGearCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2797.StraightBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2797.StraightBevelGearSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearCompoundSystemDeflection._Cast_StraightBevelGearCompoundSystemDeflection':
