...
class BearingSteadyStateSynchronousResponseOnAShaft(_3260.ConnectorSteadyStateSynchronousResponseOnAShaft):
    """BearingSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_BearingSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'BearingSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def bearing_steady_state_synchronous_response_on_a_shaft(self) -> 'BearingSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BearingSteadyStateSynchronousResponseOnAShaft._Cast_BearingSteadyStateSynchronousResponseOnAShaft':
