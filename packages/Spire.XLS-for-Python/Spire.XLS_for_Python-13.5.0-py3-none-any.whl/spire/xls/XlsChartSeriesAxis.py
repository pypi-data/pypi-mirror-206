...
class XlsChartSeriesAxis (  XlsChartAxis, IChartSeriesAxis) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSeriesAxis_get_LabelsFrequency(self.Ptr)
        return ret
    ...
    def LabelsFrequency(self, value:int):
        ...
        GetDllLibXls().XlsChartSeriesAxis_set_LabelsFrequency(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSeriesAxis_get_TickLabelSpacing(self.Ptr)
        return ret
    ...
    def TickLabelSpacing(self, value:int):
        ...
        GetDllLibXls().XlsChartSeriesAxis_set_TickLabelSpacing(self.Ptr, value)
    ...
    def TickMarksFrequency(self)->int:
        ...
        ret = GetDllLibXls().XlsChartSeriesAxis_get_TickMarksFrequency(self.Ptr)
        return ret
    ...
    def TickMarksFrequency(self, value:int):
        ...
        GetDllLibXls().XlsChartSeriesAxis_set_TickMarksFrequency(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSeriesAxis_get_TickMarkSpacing(self.Ptr)
        return ret
    ...
    def TickMarkSpacing(self, value:int):
        ...
        GetDllLibXls().XlsChartSeriesAxis_set_TickMarkSpacing(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSeriesAxis_get_IsReverseOrder(self.Ptr)
        return ret
    ...
    def IsReverseOrder(self, value:bool):
        ...
        GetDllLibXls().XlsChartSeriesAxis_set_IsReverseOrder(self.Ptr, value)
    ...
    def CrossesAt(self)->int:
        ...
        ret = GetDllLibXls().XlsChartSeriesAxis_get_CrossesAt(self.Ptr)
        return ret

    @CrossesAt.setter
    def CrossesAt(self, value:int):
        GetDllLibXls().XlsChartSeriesAxis_set_CrossesAt.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartSeriesAxis_set_CrossesAt(self.Ptr, value)
    ...
    def IsBetween(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSeriesAxis_get_IsBetween(self.Ptr)
        return ret

    @IsBetween.setter
    def IsBetween(self, value:bool):
        GetDllLibXls().XlsChartSeriesAxis_set_IsBetween.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartSeriesAxis_set_IsBetween(self.Ptr, value)
    ...
    def LogBase(self)->float:
        ...
        ret = GetDllLibXls().XlsChartSeriesAxis_get_LogBase(self.Ptr)
        return ret

    @LogBase.setter
    def LogBase(self, value:float):
        GetDllLibXls().XlsChartSeriesAxis_set_LogBase.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartSeriesAxis_set_LogBase(self.Ptr, value)
    ...
    def IsLogScale(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSeriesAxis_get_IsLogScale(self.Ptr)
        return ret

    @IsLogScale.setter
    def IsLogScale(self, value:bool):
        GetDllLibXls().XlsChartSeriesAxis_set_IsLogScale.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartSeriesAxis_set_IsLogScale(self.Ptr, value)
    ...
    def MaxValue(self)->float:
        ...
        ret = GetDllLibXls().XlsChartSeriesAxis_get_MaxValue(self.Ptr)
        return ret

    @MaxValue.setter
    def MaxValue(self, value:float):
        GetDllLibXls().XlsChartSeriesAxis_set_MaxValue.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartSeriesAxis_set_MaxValue(self.Ptr, value)
    ...
    def MinValue(self)->float:
        ...
        ret = GetDllLibXls().XlsChartSeriesAxis_get_MinValue(self.Ptr)
        return ret

    @MinValue.setter
    def MinValue(self, value:float):
        GetDllLibXls().XlsChartSeriesAxis_set_MinValue.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartSeriesAxis_set_MinValue(self.Ptr, value)
...
#        intPtr = GetDllLibXls().XlsChartSeriesAxis_Clone(self.Ptr, intPtrparent,intPtrdicFontIndexes,intPtrdicNewSheetNames)
...
#
    ...
    def DefaultSeriesAxisId()->int:
        ...
        ret = GetDllLibXls().XlsChartSeriesAxis_DefaultSeriesAxisId()
        return ret
