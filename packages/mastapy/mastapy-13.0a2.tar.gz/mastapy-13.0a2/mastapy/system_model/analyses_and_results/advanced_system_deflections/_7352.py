...
class SynchroniserHalfAdvancedSystemDeflection(_7353.SynchroniserPartAdvancedSystemDeflection):
    """SynchroniserHalfAdvancedSystemDeflection
    ...
    class _Cast_SynchroniserHalfAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'SynchroniserHalfAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def synchroniser_half_advanced_system_deflection(self) -> 'SynchroniserHalfAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserHalfAdvancedSystemDeflection._Cast_SynchroniserHalfAdvancedSystemDeflection':
