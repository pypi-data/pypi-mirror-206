...
class PivotReportFilter (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().PivotReportFilter_get_IsMultipleSelect(self.Ptr)
        return ret
    ...
    def IsMultipleSelect(self, value:bool):
        ...
        GetDllLibXls().PivotReportFilter_set_IsMultipleSelect(self.Ptr, value)
...
#        intPtr = GetDllLibXls().PivotReportFilter_get_FilterItemStrings(self.Ptr)
...
#        GetDllLibXls().PivotReportFilter_set_FilterItemStrings(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().PivotReportFilter_get_FieldString.restype=c_wchar_p
        ret = GetDllLibXls().PivotReportFilter_get_FieldString(self.Ptr)
        return ret
    ...
    def FieldString(self, value:str):
        ...
        GetDllLibXls().PivotReportFilter_set_FieldString(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().PivotReportFilter_get_FieldName.restype=c_wchar_p
        ret = GetDllLibXls().PivotReportFilter_get_FieldName(self.Ptr)
        return ret
    ...
    def FieldName(self, value:str):
        ...
        GetDllLibXls().PivotReportFilter_set_FieldName(self.Ptr, value)
