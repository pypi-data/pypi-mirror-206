...
class FontArrayWrapper (  XlsObject, IFont, IOptimizedUpdate) :
    ...
    def IsItalic(self)->bool:
        ...
        ret = GetDllLibXls().FontArrayWrapper_get_IsItalic(self.Ptr)
        return ret

    @IsItalic.setter
    def IsItalic(self, value:bool):
        GetDllLibXls().FontArrayWrapper_set_IsItalic.argtypes=[c_void_p, c_bool]
        GetDllLibXls().FontArrayWrapper_set_IsItalic(self.Ptr, value)
    ...
    def KnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().FontArrayWrapper_get_KnownColor(self.Ptr)
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().FontArrayWrapper_set_KnownColor(self.Ptr, value.value)
    ...
    def Color(self)->'Color':
        ...
        intPtr = GetDllLibXls().FontArrayWrapper_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().FontArrayWrapper_set_Color(self.Ptr, value.Ptr)
    ...
    def SetThemeColor(self ,type:'ThemeColorType',tint:float):
        ...
        GetDllLibXls().FontArrayWrapper_SetThemeColor(self.Ptr, enumtype,tint)
...
#        ret = GetDllLibXls().FontArrayWrapper_GetThemeColor(self.Ptr, intPtrtype,intPtrtint)
#        return ret
    ...
    def IsBold(self)->bool:
        ...
        ret = GetDllLibXls().FontArrayWrapper_get_IsBold(self.Ptr)
        return ret

    @IsBold.setter
    def IsBold(self, value:bool):
        GetDllLibXls().FontArrayWrapper_set_IsBold.argtypes=[c_void_p, c_bool]
        GetDllLibXls().FontArrayWrapper_set_IsBold(self.Ptr, value)
    ...
    def Size(self)->float:
        ...
        ret = GetDllLibXls().FontArrayWrapper_get_Size(self.Ptr)
        return ret

    @Size.setter
    def Size(self, value:float):
        GetDllLibXls().FontArrayWrapper_set_Size.argtypes=[c_void_p, c_double]
        GetDllLibXls().FontArrayWrapper_set_Size(self.Ptr, value)
    ...
    def IsStrikethrough(self)->bool:
        ...
        ret = GetDllLibXls().FontArrayWrapper_get_IsStrikethrough(self.Ptr)
        return ret
    ...
    def IsStrikethrough(self, value:bool):
        ...
        GetDllLibXls().FontArrayWrapper_set_IsStrikethrough(self.Ptr, value)
    ...
    def StrikethroughType(self)->str:
        ...
        GetDllLibXls().FontArrayWrapper_get_StrikethroughType.restype=c_wchar_p
        ret = GetDllLibXls().FontArrayWrapper_get_StrikethroughType(self.Ptr)
        return ret
    ...
    def StrikethroughType(self, value:str):
        ...
        GetDllLibXls().FontArrayWrapper_set_StrikethroughType(self.Ptr, value)
    ...
    def IsSubscript(self)->bool:
        ...
        ret = GetDllLibXls().FontArrayWrapper_get_IsSubscript(self.Ptr)
        return ret

    @IsSubscript.setter
    def IsSubscript(self, value:bool):
        GetDllLibXls().FontArrayWrapper_set_IsSubscript.argtypes=[c_void_p, c_bool]
        GetDllLibXls().FontArrayWrapper_set_IsSubscript(self.Ptr, value)
    ...
    def IsSuperscript(self)->bool:
        ...
        ret = GetDllLibXls().FontArrayWrapper_get_IsSuperscript(self.Ptr)
        return ret
    ...
    def IsSuperscript(self, value:bool):
        ...
        GetDllLibXls().FontArrayWrapper_set_IsSuperscript(self.Ptr, value)
    ...
    def Underline(self)->'FontUnderlineType':
        ...
        ret = GetDllLibXls().FontArrayWrapper_get_Underline(self.Ptr)
    ...
    def Underline(self, value:'FontUnderlineType'):
        ...
        GetDllLibXls().FontArrayWrapper_set_Underline(self.Ptr, value.value)
    ...
    def FontName(self)->str:
        ...
        GetDllLibXls().FontArrayWrapper_get_FontName.restype=c_wchar_p
        ret = GetDllLibXls().FontArrayWrapper_get_FontName(self.Ptr)
        return ret
    ...
    def FontName(self, value:str):
        ...
        GetDllLibXls().FontArrayWrapper_set_FontName(self.Ptr, value)
    ...
    def VerticalAlignment(self)->'FontVertialAlignmentType':
        ...
        ret = GetDllLibXls().FontArrayWrapper_get_VerticalAlignment(self.Ptr)
    ...
    def VerticalAlignment(self, value:'FontVertialAlignmentType'):
        ...
        GetDllLibXls().FontArrayWrapper_set_VerticalAlignment(self.Ptr, value.value)
    ...
    def GenerateNativeFont(self)->'Font':
        ...
        intPtr = GetDllLibXls().FontArrayWrapper_GenerateNativeFont(self.Ptr)
    ...
    def IsAutoColor(self)->bool:
        ...
        ret = GetDllLibXls().FontArrayWrapper_get_IsAutoColor(self.Ptr)
        return ret
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().FontArrayWrapper_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().FontArrayWrapper_EndUpdate(self.Ptr)
