...
class ShaftToMountableComponentConnectionCompoundHarmonicAnalysis(_5849.AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """ShaftToMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5775.ShaftToMountableComponentConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5775.ShaftToMountableComponentConnectionHarmonicAnalysis]':
