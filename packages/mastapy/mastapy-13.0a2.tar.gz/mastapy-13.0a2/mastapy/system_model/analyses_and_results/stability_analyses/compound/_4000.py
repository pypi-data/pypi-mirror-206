...
class ZerolBevelGearCompoundStabilityAnalysis(_3890.BevelGearCompoundStabilityAnalysis):
    """ZerolBevelGearCompoundStabilityAnalysis
    ...
    class _Cast_ZerolBevelGearCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_compound_stability_analysis(self) -> 'ZerolBevelGearCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3873.ZerolBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3873.ZerolBevelGearStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearCompoundStabilityAnalysis._Cast_ZerolBevelGearCompoundStabilityAnalysis':
