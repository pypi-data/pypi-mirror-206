...
class BearingCompoundModalAnalysis(_4737.ConnectorCompoundModalAnalysis):
    """BearingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4555.BearingModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4555.BearingModalAnalysis]':
