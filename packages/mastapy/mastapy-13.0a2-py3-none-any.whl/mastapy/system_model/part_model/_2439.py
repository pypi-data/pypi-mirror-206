...
from mastapy.bearings.tolerances import _1887, _1889
...
class InternalClearanceTolerance(_0.APIBase):
    ...
    class _Cast_InternalClearanceTolerance:
        ...
        def __init__(self, parent: 'InternalClearanceTolerance'):
            self._parent = parent

        @property
        def axial_internal_clearance_tolerance(self):
            from mastapy.system_model.part_model import _2418
            
            return self._parent._cast(_2418.AxialInternalClearanceTolerance)

        @property
        def radial_internal_clearance_tolerance(self):
            from mastapy.system_model.part_model import _2453
            
            return self._parent._cast(_2453.RadialInternalClearanceTolerance)

        @property
        def internal_clearance_tolerance(self) -> 'InternalClearanceTolerance':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'InternalClearanceTolerance._Cast_InternalClearanceTolerance':
