...
class FaceGearModalAnalysisAtASpeed(_5148.GearModalAnalysisAtASpeed):
    """FaceGearModalAnalysisAtASpeed
    ...
    class _Cast_FaceGearModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'FaceGearModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def face_gear_modal_analysis_at_a_speed(self) -> 'FaceGearModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearModalAnalysisAtASpeed._Cast_FaceGearModalAnalysisAtASpeed':
