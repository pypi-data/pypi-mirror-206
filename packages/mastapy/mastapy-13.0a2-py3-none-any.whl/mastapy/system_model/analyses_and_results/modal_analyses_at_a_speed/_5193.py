...
class SpringDamperModalAnalysisAtASpeed(_5128.CouplingModalAnalysisAtASpeed):
    """SpringDamperModalAnalysisAtASpeed
    ...
    class _Cast_SpringDamperModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'SpringDamperModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def spring_damper_modal_analysis_at_a_speed(self) -> 'SpringDamperModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperModalAnalysisAtASpeed._Cast_SpringDamperModalAnalysisAtASpeed':
