...
class RollingRingConnectionSteadyStateSynchronousResponseOnAShaft(_3289.InterMountableComponentConnectionSteadyStateSynchronousResponseOnAShaft):
    """RollingRingConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_RollingRingConnectionSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'RollingRingConnectionSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def rolling_ring_connection_steady_state_synchronous_response_on_a_shaft(self) -> 'RollingRingConnectionSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingConnectionSteadyStateSynchronousResponseOnAShaft._Cast_RollingRingConnectionSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_RollingRingConnectionSteadyStateSynchronousResponseOnAShaft(self)
