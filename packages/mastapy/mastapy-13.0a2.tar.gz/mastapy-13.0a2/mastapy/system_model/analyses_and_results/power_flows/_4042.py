...
class ConicalGearPowerFlow(_4069.GearPowerFlow):
    """ConicalGearPowerFlow
    ...
    class _Cast_ConicalGearPowerFlow:
        ...
        def __init__(self, parent: 'ConicalGearPowerFlow'):
            self._parent = parent
        ...
        @property
        def conical_gear_power_flow(self) -> 'ConicalGearPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConicalGearPowerFlow._Cast_ConicalGearPowerFlow':
