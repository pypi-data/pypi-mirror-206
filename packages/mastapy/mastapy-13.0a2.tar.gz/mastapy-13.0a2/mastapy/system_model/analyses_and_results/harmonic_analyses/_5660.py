...
class BevelDifferentialGearHarmonicAnalysis(_5665.BevelGearHarmonicAnalysis):
    """BevelDifferentialGearHarmonicAnalysis
    ...
    class _Cast_BevelDifferentialGearHarmonicAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialGearHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_harmonic_analysis(self) -> 'BevelDifferentialGearHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearHarmonicAnalysis._Cast_BevelDifferentialGearHarmonicAnalysis':
