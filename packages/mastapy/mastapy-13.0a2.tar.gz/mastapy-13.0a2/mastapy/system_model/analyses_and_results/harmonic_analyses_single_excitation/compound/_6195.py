...
class RingPinsToDiscConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6170.InterMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """RingPinsToDiscConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_RingPinsToDiscConnectionCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'RingPinsToDiscConnectionCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def ring_pins_to_disc_connection_compound_harmonic_analysis_of_single_excitation(self) -> 'RingPinsToDiscConnectionCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6066.RingPinsToDiscConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6066.RingPinsToDiscConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'RingPinsToDiscConnectionCompoundHarmonicAnalysisOfSingleExcitation._Cast_RingPinsToDiscConnectionCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_RingPinsToDiscConnectionCompoundHarmonicAnalysisOfSingleExcitation(self)
