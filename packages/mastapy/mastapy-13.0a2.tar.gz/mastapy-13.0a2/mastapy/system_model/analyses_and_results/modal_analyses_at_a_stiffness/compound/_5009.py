...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5007, _5008, _5020
...
class CylindricalGearSetCompoundModalAnalysisAtAStiffness(_5020.GearSetCompoundModalAnalysisAtAStiffness):
    """CylindricalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4879.CylindricalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5007.CylindricalGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5008.CylindricalGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4879.CylindricalGearSetModalAnalysisAtAStiffness]':
