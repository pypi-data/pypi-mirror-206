...
class PointLoadCompoundCriticalSpeedAnalysis(_6761.VirtualComponentCompoundCriticalSpeedAnalysis):
    """PointLoadCompoundCriticalSpeedAnalysis
    ...
    class _Cast_PointLoadCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'PointLoadCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def point_load_compound_critical_speed_analysis(self) -> 'PointLoadCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6596.PointLoadCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6596.PointLoadCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PointLoadCompoundCriticalSpeedAnalysis._Cast_PointLoadCompoundCriticalSpeedAnalysis':
