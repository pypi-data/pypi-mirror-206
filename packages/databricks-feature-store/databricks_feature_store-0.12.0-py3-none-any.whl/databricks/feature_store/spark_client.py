...
from databricks.feature_store.utils.utils import sanitize_identifier
...
class SparkClient:
    ...
    def get_delta_table_object(self, full_table_name):
        ...
        return DeltaTable.forName(self._spark, full_table_name)
    ...
    def get_table_comment(self, delta_table_name):
        ...
        """
        comment = (
            self._spark.sql(f"DESCRIBE TABLE EXTENDED {delta_table_name}")
