...
SchemaFor200ResponseBodyApplicationJson = TransactionSyncResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_transactions_diff_oapg(
        self,
...
class GetTransactionsDiff(BaseApi):
    ...
    def get_transactions_diff(
        ...
        return self._get_transactions_diff_oapg(
