...
class SpiralBevelGearStabilityAnalysis(_3760.BevelGearStabilityAnalysis):
    """SpiralBevelGearStabilityAnalysis
    ...
    class _Cast_SpiralBevelGearStabilityAnalysis:
        ...
        def __init__(self, parent: 'SpiralBevelGearStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_stability_analysis(self) -> 'SpiralBevelGearStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearStabilityAnalysis._Cast_SpiralBevelGearStabilityAnalysis':
