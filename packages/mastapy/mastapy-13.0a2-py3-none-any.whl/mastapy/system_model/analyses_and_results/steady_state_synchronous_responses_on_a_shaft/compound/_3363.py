...
class BeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3419.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """BeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_BeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'BeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def belt_connection_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'BeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3233.BeltConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3233.BeltConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'BeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft._Cast_BeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_BeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft(self)
