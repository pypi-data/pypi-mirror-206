...
class StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis(_5515.BevelGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_compound_multibody_dynamics_analysis(self) -> 'StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5467.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5467.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis._Cast_StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis':
