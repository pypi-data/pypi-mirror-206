...
class PlanetCarrierCompoundCriticalSpeedAnalysis(_6716.MountableComponentCompoundCriticalSpeedAnalysis):
    """PlanetCarrierCompoundCriticalSpeedAnalysis
    ...
    class _Cast_PlanetCarrierCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'PlanetCarrierCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def planet_carrier_compound_critical_speed_analysis(self) -> 'PlanetCarrierCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6595.PlanetCarrierCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6595.PlanetCarrierCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierCompoundCriticalSpeedAnalysis._Cast_PlanetCarrierCompoundCriticalSpeedAnalysis':
