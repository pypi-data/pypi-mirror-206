...
from mastapy.gears.manufacturing.cylindrical import _629, _630
...
class CylindricalGearSpecifiedMicroGeometry(_0.APIBase):
    ...
    class _Cast_CylindricalGearSpecifiedMicroGeometry:
        ...
        def __init__(self, parent: 'CylindricalGearSpecifiedMicroGeometry'):
            self._parent = parent

        @property
        def cylindrical_gear_specified_micro_geometry(self) -> 'CylindricalGearSpecifiedMicroGeometry':
            return self._parent
    ...
    @property
    def lead_micro_geometry(self) -> '_629.MicroGeometryInputsLead':
    ...
    @property
    def profile_micro_geometry(self) -> 'List[_630.MicroGeometryInputsProfile]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearSpecifiedMicroGeometry._Cast_CylindricalGearSpecifiedMicroGeometry':
