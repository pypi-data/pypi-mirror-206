...
class MicroGeometryViewingOptions(_0.APIBase):
    ...
    class _Cast_MicroGeometryViewingOptions:
        ...
        def __init__(self, parent: 'MicroGeometryViewingOptions'):
            self._parent = parent

        @property
        def micro_geometry_viewing_options(self) -> 'MicroGeometryViewingOptions':
            return self._parent
    ...
    @property
    def gear_option(self) -> '_1106.DrawDefiningGearOrBoth':
        ...
        value = conversion.pn_to_mp_enum(temp, _1106.DrawDefiningGearOrBoth)
        return constructor.new_from_mastapy_type(_1106.DrawDefiningGearOrBoth)(value) if value is not None else None

    @gear_option.setter
    def gear_option(self, value: '_1106.DrawDefiningGearOrBoth'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1106.DrawDefiningGearOrBoth.type_())
    ...
    @property
    def cast_to(self) -> 'MicroGeometryViewingOptions._Cast_MicroGeometryViewingOptions':
