...
class ExternalCADModelCompoundSteadyStateSynchronousResponse(_3120.ComponentCompoundSteadyStateSynchronousResponse):
    """ExternalCADModelCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_ExternalCADModelCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'ExternalCADModelCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def external_cad_model_compound_steady_state_synchronous_response(self) -> 'ExternalCADModelCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3015.ExternalCADModelSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3015.ExternalCADModelSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'ExternalCADModelCompoundSteadyStateSynchronousResponse._Cast_ExternalCADModelCompoundSteadyStateSynchronousResponse':
