...
class BevelDifferentialGearCompoundParametricStudyTool(_4434.BevelGearCompoundParametricStudyTool):
    """BevelDifferentialGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4283.BevelDifferentialGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4283.BevelDifferentialGearParametricStudyTool]':
