...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool(_4485.KlingelnbergCycloPalloidConicalGearMeshCompoundParametricStudyTool):
    """KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh_compound_parametric_study_tool(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4350.KlingelnbergCycloPalloidSpiralBevelGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4350.KlingelnbergCycloPalloidSpiralBevelGearMeshParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool._Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool':
        return self._Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool(self)
