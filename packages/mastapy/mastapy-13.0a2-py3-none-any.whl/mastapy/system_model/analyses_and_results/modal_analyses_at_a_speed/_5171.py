...
class PartToPartShearCouplingModalAnalysisAtASpeed(_5128.CouplingModalAnalysisAtASpeed):
    """PartToPartShearCouplingModalAnalysisAtASpeed
    ...
    class _Cast_PartToPartShearCouplingModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_modal_analysis_at_a_speed(self) -> 'PartToPartShearCouplingModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingModalAnalysisAtASpeed._Cast_PartToPartShearCouplingModalAnalysisAtASpeed':
