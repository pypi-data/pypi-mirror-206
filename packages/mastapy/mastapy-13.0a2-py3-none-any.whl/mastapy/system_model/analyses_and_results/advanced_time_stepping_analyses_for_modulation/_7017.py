...
class CycloidalDiscAdvancedTimeSteppingAnalysisForModulation(_6970.AbstractShaftAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_CycloidalDiscAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'CycloidalDiscAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_advanced_time_stepping_analysis_for_modulation(self) -> 'CycloidalDiscAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscAdvancedTimeSteppingAnalysisForModulation._Cast_CycloidalDiscAdvancedTimeSteppingAnalysisForModulation':
