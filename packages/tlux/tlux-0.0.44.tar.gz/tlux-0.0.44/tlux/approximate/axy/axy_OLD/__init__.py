...
_ordered_dependencies = ['libopenblas.dylib', 'liblapack.dylib', 'libomp.dylib', 'axy_random.f90', 'axy_matrix_operations.f90', 'axy_sort_and_select.f90', 'axy.f90', 'axy_c_wrapper.f90']
