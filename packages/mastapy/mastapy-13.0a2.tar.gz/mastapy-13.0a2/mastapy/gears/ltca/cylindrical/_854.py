...
class CylindricalGearMeshLoadedContactPoint(_839.GearMeshLoadedContactPoint):
    """CylindricalGearMeshLoadedContactPoint
    ...
    class _Cast_CylindricalGearMeshLoadedContactPoint:
        ...
        def __init__(self, parent: 'CylindricalGearMeshLoadedContactPoint'):
            self._parent = parent

        @property
        def gear_mesh_loaded_contact_point(self):
            return self._parent._cast(_839.GearMeshLoadedContactPoint)

        @property
        def cylindrical_gear_mesh_loaded_contact_point(self) -> 'CylindricalGearMeshLoadedContactPoint':
            return self._parent
    ...
    @property
    def gear_a_profile_measurement(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def gear_b_profile_measurement(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def tooth_flank_fracture_analysis_gear_a(self) -> '_521.ToothFlankFractureAnalysisContactPointMethodA':
    ...
    @property
    def tooth_flank_fracture_analysis_gear_b(self) -> '_521.ToothFlankFractureAnalysisContactPointMethodA':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshLoadedContactPoint._Cast_CylindricalGearMeshLoadedContactPoint':
