...
class TransmissionTemperatureSet(_0.APIBase):
    ...
    class _Cast_TransmissionTemperatureSet:
        ...
        def __init__(self, parent: 'TransmissionTemperatureSet'):
            self._parent = parent

        @property
        def transmission_temperature_set(self) -> 'TransmissionTemperatureSet':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TransmissionTemperatureSet._Cast_TransmissionTemperatureSet':
