...
class BoltedJointCompoundModalAnalysisAtAStiffness(_5058.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """BoltedJointCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_BoltedJointCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'BoltedJointCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def bolted_joint_compound_modal_analysis_at_a_stiffness(self) -> 'BoltedJointCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4849.BoltedJointModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4849.BoltedJointModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'BoltedJointCompoundModalAnalysisAtAStiffness._Cast_BoltedJointCompoundModalAnalysisAtAStiffness':
