...
class ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation(_7128.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def external_cad_model_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7025.ExternalCADModelAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7025.ExternalCADModelAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation(self)
