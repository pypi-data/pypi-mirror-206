...
class FreyaEventBody(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["event", b"event"]) -> typing_extensions.Literal["member_change", "progress", "room_update", "message", "remove_chat", "room_destroy", "room_trigger"] | None: ...
