...
class SparklineCollection (  SpireObject, ISparklines) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().SparklineCollection_Add(self.Ptr)
    ...
    def Add(self ,dataRange:str,row:int,column:int)->Sparkline:
        ...
        intPtr = GetDllLibXls().SparklineCollection_AddDRC(self.Ptr, dataRange,row,column)
        ret = None if intPtr==None else Sparkline(intPtr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().SparklineCollection_AddDR(self.Ptr, intPtrdataRange,intPtrreferenceRange)
    ...
    <summary>
        ...
        GetDllLibXls().SparklineCollection_AddDRI(self.Ptr, intPtrdataRange,intPtrreferenceRange,isVertical)
    ...
    <summary>
        ...
        GetDllLibXls().SparklineCollection_RefreshRanges(self.Ptr, intPtrdataRange,intPtrreferenceRange)
    ...
    <summary>
        ...
        GetDllLibXls().SparklineCollection_RefreshRangesDRI(self.Ptr, intPtrdataRange,intPtrreferenceRange,isVertical)
    ...
    <param name="sparklineRange">The sparkline range.<see cref="!: IRange" /></param>
        ...
        GetDllLibXls().SparklineCollection_Clear(self.Ptr, intPtrsparkline)
