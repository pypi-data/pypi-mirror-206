...
class PointLoadPowerFlow(_4135.VirtualComponentPowerFlow):
    """PointLoadPowerFlow
    ...
    class _Cast_PointLoadPowerFlow:
        ...
        def __init__(self, parent: 'PointLoadPowerFlow'):
            self._parent = parent
        ...
        @property
        def point_load_power_flow(self) -> 'PointLoadPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PointLoadPowerFlow._Cast_PointLoadPowerFlow':
