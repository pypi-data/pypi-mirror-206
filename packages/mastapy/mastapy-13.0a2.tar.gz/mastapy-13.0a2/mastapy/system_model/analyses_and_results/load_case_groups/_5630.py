...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _5639, _5640, _5628, _5638,
    _5629
)
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5643, _5646, _5647
from mastapy.system_model.part_model import (
    _2419, _2433, _2451, _2452
)
from mastapy.system_model.analyses_and_results.static_loads import (
    _6784, _6825, _6827, _6829,
    _6851, _6902, _6903, _6769,
    _6782
)
from mastapy.system_model.part_model.gears import _2505, _2504
...
from mastapy.system_model.analyses_and_results import (
    _2660, _2655, _2637, _2647,
    _2657, _2650, _2640, _2656,
    _2639, _2644, _2598
)
...
class AbstractStaticLoadCaseGroup(_5629.AbstractLoadCaseGroup):
    """AbstractStaticLoadCaseGroup
    ...
    @property
    def gear_set_optimisation(self) -> '_5639.SystemOptimiserGearSetOptimisation':
        ...
        value = conversion.pn_to_mp_enum(temp, _5639.SystemOptimiserGearSetOptimisation)
        return constructor.new_from_mastapy_type(_5639.SystemOptimiserGearSetOptimisation)(value) if value is not None else None

    @gear_set_optimisation.setter
    def gear_set_optimisation(self, value: '_5639.SystemOptimiserGearSetOptimisation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _5639.SystemOptimiserGearSetOptimisation.type_())
    ...
    @property
    def optimum_tooth_numbers_target(self) -> '_5640.SystemOptimiserTargets':
        ...
        value = conversion.pn_to_mp_enum(temp, _5640.SystemOptimiserTargets)
        return constructor.new_from_mastapy_type(_5640.SystemOptimiserTargets)(value) if value is not None else None

    @optimum_tooth_numbers_target.setter
    def optimum_tooth_numbers_target(self, value: '_5640.SystemOptimiserTargets'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _5640.SystemOptimiserTargets.type_())
    ...
    @property
    def bearings(self) -> 'List[_5643.ComponentStaticLoadCaseGroup[_2419.Bearing, _6784.BearingLoadCase]]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5646.GearSetStaticLoadCaseGroup[_2505.CylindricalGearSet, _2504.CylindricalGear, _6825.CylindricalGearLoadCase, _2290.CylindricalGearMesh, _6827.CylindricalGearMeshLoadCase, _6829.CylindricalGearSetLoadCase]]':
    ...
    @property
    def design_states(self) -> 'List[_5628.AbstractDesignStateLoadCaseGroup]':
    ...
    @property
    def fe_parts(self) -> 'List[_5643.ComponentStaticLoadCaseGroup[_2433.FEPart, _6851.FEPartLoadCase]]':
    ...
    @property
    def loaded_gear_sets(self) -> 'List[_4191.CylindricalGearSetCompoundPowerFlow]':
    ...
    @property
    def parts_with_excitations(self) -> 'List[_5647.PartStaticLoadCaseGroup]':
    ...
    @property
    def point_loads(self) -> 'List[_5643.ComponentStaticLoadCaseGroup[_2451.PointLoad, _6902.PointLoadLoadCase]]':
    ...
    @property
    def power_loads(self) -> 'List[_5643.ComponentStaticLoadCaseGroup[_2452.PowerLoad, _6903.PowerLoadLoadCase]]':
    ...
    @property
    def static_loads_limited_by_max_number_of_load_cases_to_display(self) -> 'List[_6769.StaticLoadCase]':
    ...
    @property
    def system_optimisation_gear_sets(self) -> 'List[_5638.SystemOptimisationGearSet]':
    ...
    @property
    def compound_system_deflection(self) -> '_2660.CompoundSystemDeflectionAnalysis':
    ...
    @property
    def compound_power_flow(self) -> '_2655.CompoundPowerFlowAnalysis':
    ...
    @property
    def compound_advanced_system_deflection(self) -> '_2637.CompoundAdvancedSystemDeflectionAnalysis':
    ...
    @property
    def compound_harmonic_analysis(self) -> '_2647.CompoundHarmonicAnalysis':
    ...
    @property
    def compound_steady_state_synchronous_response(self) -> '_2657.CompoundSteadyStateSynchronousResponseAnalysis':
    ...
    @property
    def compound_modal_analysis(self) -> '_2650.CompoundModalAnalysis':
    ...
    @property
    def compound_critical_speed_analysis(self) -> '_2640.CompoundCriticalSpeedAnalysis':
    ...
    @property
    def compound_stability_analysis(self) -> '_2656.CompoundStabilityAnalysis':
    ...
    @property
    def compound_advanced_time_stepping_analysis_for_modulation(self) -> '_2639.CompoundAdvancedTimeSteppingAnalysisForModulation':
    ...
    @property
    def compound_dynamic_model_for_modal_analysis(self) -> '_2644.CompoundDynamicModelForModalAnalysis':
    ...
    def analysis_of(self, analysis_type: '_6782.AnalysisType') -> '_2598.CompoundAnalysis':
