...
class SynchroniserHalfStabilityAnalysis(_3859.SynchroniserPartStabilityAnalysis):
    """SynchroniserHalfStabilityAnalysis
    ...
    class _Cast_SynchroniserHalfStabilityAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserHalfStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_half_stability_analysis(self) -> 'SynchroniserHalfStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserHalfStabilityAnalysis._Cast_SynchroniserHalfStabilityAnalysis':
