...
class ChartsCollection (  XlsChartsCollection) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartsCollection_get_Item(self.Ptr, index)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartsCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else Chart(intPtr)
        return ret
    ...
    <returns>Created chart object.</returns>
        ...
        intPtr = GetDllLibXls().ChartsCollection_Add(self.Ptr)
    ...
    <returns>Created chart object.</returns>
        ...
        intPtr = GetDllLibXls().ChartsCollection_AddN(self.Ptr, name)
        ret = None if intPtr==None else ChartSheet(intPtr)
        return ret
    ...
    <returns>Added chart object.</returns>
        ...
        intPtr = GetDllLibXls().ChartsCollection_AddC(self.Ptr, intPtrchart)
        ret = None if intPtr==None else ChartSheet(intPtr)
        return ret
    ...
    <param name="name">Name of the chart to remove.</param>
        ...
        intPtr = GetDllLibXls().ChartsCollection_Remove(self.Ptr, name)
        ret = None if intPtr==None else ChartSheet(intPtr)
        return ret
