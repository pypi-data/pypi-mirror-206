...
class ExternalCADModelHarmonicAnalysisOfSingleExcitation(_6000.ComponentHarmonicAnalysisOfSingleExcitation):
    """ExternalCADModelHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_ExternalCADModelHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'ExternalCADModelHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def external_cad_model_harmonic_analysis_of_single_excitation(self) -> 'ExternalCADModelHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ExternalCADModelHarmonicAnalysisOfSingleExcitation._Cast_ExternalCADModelHarmonicAnalysisOfSingleExcitation':
