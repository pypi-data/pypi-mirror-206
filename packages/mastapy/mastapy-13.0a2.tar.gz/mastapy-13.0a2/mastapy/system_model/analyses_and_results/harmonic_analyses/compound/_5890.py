...
class CycloidalDiscCentralBearingConnectionCompoundHarmonicAnalysis(_5870.CoaxialConnectionCompoundHarmonicAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5694.CycloidalDiscCentralBearingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5694.CycloidalDiscCentralBearingConnectionHarmonicAnalysis]':
