...
class SpiralBevelGearSteadyStateSynchronousResponseOnAShaft(_3242.BevelGearSteadyStateSynchronousResponseOnAShaft):
    """SpiralBevelGearSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_SpiralBevelGearSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'SpiralBevelGearSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_steady_state_synchronous_response_on_a_shaft(self) -> 'SpiralBevelGearSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearSteadyStateSynchronousResponseOnAShaft._Cast_SpiralBevelGearSteadyStateSynchronousResponseOnAShaft':
