...
class ISO10300SingleFlankRating(_538.ConicalGearSingleFlankRating, Generic[T]):
    """ISO10300SingleFlankRating
    ...
    class _Cast_ISO10300SingleFlankRating:
        ...
        def __init__(self, parent: 'ISO10300SingleFlankRating'):
            self._parent = parent
        ...
        @property
        def iso10300_single_flank_rating(self) -> 'ISO10300SingleFlankRating':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ISO10300SingleFlankRating._Cast_ISO10300SingleFlankRating':
