...
class BevelDifferentialGearMeshSystemDeflection(_2685.BevelGearMeshSystemDeflection):
    """BevelDifferentialGearMeshSystemDeflection
    ...
    class _Cast_BevelDifferentialGearMeshSystemDeflection:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshSystemDeflection'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_system_deflection(self) -> 'BevelDifferentialGearMeshSystemDeflection':
            return self._parent
    ...
    @property
    def rating(self) -> '_549.BevelGearMeshRating':
    ...
    @property
    def power_flow_results(self) -> '_4020.BevelDifferentialGearMeshPowerFlow':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshSystemDeflection._Cast_BevelDifferentialGearMeshSystemDeflection':
