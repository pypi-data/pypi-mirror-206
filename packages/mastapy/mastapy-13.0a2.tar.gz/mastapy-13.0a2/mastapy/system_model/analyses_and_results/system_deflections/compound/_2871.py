...
class CVTCompoundSystemDeflection(_2840.BeltDriveCompoundSystemDeflection):
    """CVTCompoundSystemDeflection
    ...
    class _Cast_CVTCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'CVTCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def cvt_compound_system_deflection(self) -> 'CVTCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2713.CVTSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2713.CVTSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'CVTCompoundSystemDeflection._Cast_CVTCompoundSystemDeflection':
