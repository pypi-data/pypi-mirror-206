...
class OilSealCompoundHarmonicAnalysisOfSingleExcitation(_6141.ConnectorCompoundHarmonicAnalysisOfSingleExcitation):
    """OilSealCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_OilSealCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'OilSealCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def oil_seal_compound_harmonic_analysis_of_single_excitation(self) -> 'OilSealCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6054.OilSealHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6054.OilSealHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'OilSealCompoundHarmonicAnalysisOfSingleExcitation._Cast_OilSealCompoundHarmonicAnalysisOfSingleExcitation':
