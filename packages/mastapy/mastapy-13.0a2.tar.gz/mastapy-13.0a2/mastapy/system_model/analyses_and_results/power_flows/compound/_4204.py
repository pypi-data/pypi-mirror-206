...
class HypoidGearCompoundPowerFlow(_4146.AGMAGleasonConicalGearCompoundPowerFlow):
    """HypoidGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4073.HypoidGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4073.HypoidGearPowerFlow]':
