...
class RingPinsToDiscConnectionCompoundParametricStudyTool(_4483.InterMountableComponentConnectionCompoundParametricStudyTool):
    """RingPinsToDiscConnectionCompoundParametricStudyTool
    ...
    class _Cast_RingPinsToDiscConnectionCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'RingPinsToDiscConnectionCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def ring_pins_to_disc_connection_compound_parametric_study_tool(self) -> 'RingPinsToDiscConnectionCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4379.RingPinsToDiscConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4379.RingPinsToDiscConnectionParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'RingPinsToDiscConnectionCompoundParametricStudyTool._Cast_RingPinsToDiscConnectionCompoundParametricStudyTool':
