...
class ConceptCouplingCompoundHarmonicAnalysis(_5883.CouplingCompoundHarmonicAnalysis):
    """ConceptCouplingCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5678.ConceptCouplingHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5678.ConceptCouplingHarmonicAnalysis]':
