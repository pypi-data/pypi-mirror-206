...
class ConceptCouplingCompoundModalAnalysisAtASpeed(_5255.CouplingCompoundModalAnalysisAtASpeed):
    """ConceptCouplingCompoundModalAnalysisAtASpeed
    ...
    class _Cast_ConceptCouplingCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ConceptCouplingCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def concept_coupling_compound_modal_analysis_at_a_speed(self) -> 'ConceptCouplingCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5117.ConceptCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5117.ConceptCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingCompoundModalAnalysisAtASpeed._Cast_ConceptCouplingCompoundModalAnalysisAtASpeed':
