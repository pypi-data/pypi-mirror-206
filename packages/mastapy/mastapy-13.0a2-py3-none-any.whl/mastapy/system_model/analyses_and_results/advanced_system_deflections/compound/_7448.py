...
class PartToPartShearCouplingCompoundAdvancedSystemDeflection(_7405.CouplingCompoundAdvancedSystemDeflection):
    """PartToPartShearCouplingCompoundAdvancedSystemDeflection
    ...
    class _Cast_PartToPartShearCouplingCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_compound_advanced_system_deflection(self) -> 'PartToPartShearCouplingCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7318.PartToPartShearCouplingAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7318.PartToPartShearCouplingAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingCompoundAdvancedSystemDeflection._Cast_PartToPartShearCouplingCompoundAdvancedSystemDeflection':
