...
class CustomFilter (  IAutoFilterCondition) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().CustomFilter_get_FilterOperatorType(self.Ptr)
    ...
    def FilterOperatorType(self, value:'FilterOperatorType'):
        ...
        GetDllLibXls().CustomFilter_set_FilterOperatorType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CustomFilter_get_Criteria(self.Ptr)
    ...
    def Criteria(self, value:'SpireObject'):
        ...
        GetDllLibXls().CustomFilter_set_Criteria(self.Ptr, value.Ptr)
    ...
    def DataType(self)->'FilterDataType':
        ...
        ret = GetDllLibXls().CustomFilter_get_DataType(self.Ptr)
    ...
    def DataType(self, value:'FilterDataType'):
        ...
        GetDllLibXls().CustomFilter_set_DataType(self.Ptr, value.value)
    ...
    def ConditionOperator(self)->'FilterConditionType':
        ...
        ret = GetDllLibXls().CustomFilter_get_ConditionOperator(self.Ptr)
    ...
    def ConditionOperator(self, value:'FilterConditionType'):
        ...
        GetDllLibXls().CustomFilter_set_ConditionOperator(self.Ptr, value.value)
    ...
    def String(self)->str:
        ...
        GetDllLibXls().CustomFilter_get_String.restype=c_wchar_p
        ret = GetDllLibXls().CustomFilter_get_String(self.Ptr)
        return ret
    ...
    def String(self, value:str):
        ...
        GetDllLibXls().CustomFilter_set_String(self.Ptr, value)
    ...
    def Boolean(self)->bool:
        ...
        ret = GetDllLibXls().CustomFilter_get_Boolean(self.Ptr)
        return ret

    @Boolean.setter
    def Boolean(self, value:bool):
        GetDllLibXls().CustomFilter_set_Boolean.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CustomFilter_set_Boolean(self.Ptr, value)
    ...
    def ErrorCode(self)->int:
        ...
        ret = GetDllLibXls().CustomFilter_get_ErrorCode(self.Ptr)
        return ret

    @ErrorCode.setter
    def ErrorCode(self, value:int):
        GetDllLibXls().CustomFilter_set_ErrorCode.argtypes=[c_void_p, c_int]
        GetDllLibXls().CustomFilter_set_ErrorCode(self.Ptr, value)
    ...
    def Double(self)->float:
        ...
        ret = GetDllLibXls().CustomFilter_get_Double(self.Ptr)
        return ret

    @Double.setter
    def Double(self, value:float):
        GetDllLibXls().CustomFilter_set_Double.argtypes=[c_void_p, c_double]
        GetDllLibXls().CustomFilter_set_Double(self.Ptr, value)
