...
class TorqueConverterPumpCompoundHarmonicAnalysisOfSingleExcitation(_6144.CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation):
    """TorqueConverterPumpCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_TorqueConverterPumpCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'TorqueConverterPumpCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def torque_converter_pump_compound_harmonic_analysis_of_single_excitation(self) -> 'TorqueConverterPumpCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6095.TorqueConverterPumpHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6095.TorqueConverterPumpHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterPumpCompoundHarmonicAnalysisOfSingleExcitation._Cast_TorqueConverterPumpCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_TorqueConverterPumpCompoundHarmonicAnalysisOfSingleExcitation(self)
