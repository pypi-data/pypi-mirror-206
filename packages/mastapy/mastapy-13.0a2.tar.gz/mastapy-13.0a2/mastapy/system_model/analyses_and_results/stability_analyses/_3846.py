...
class SpringDamperHalfStabilityAnalysis(_3780.CouplingHalfStabilityAnalysis):
    """SpringDamperHalfStabilityAnalysis
    ...
    class _Cast_SpringDamperHalfStabilityAnalysis:
        ...
        def __init__(self, parent: 'SpringDamperHalfStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def spring_damper_half_stability_analysis(self) -> 'SpringDamperHalfStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperHalfStabilityAnalysis._Cast_SpringDamperHalfStabilityAnalysis':
