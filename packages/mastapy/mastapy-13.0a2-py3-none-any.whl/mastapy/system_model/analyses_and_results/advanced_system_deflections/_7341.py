...
class SpringDamperConnectionAdvancedSystemDeflection(_7274.CouplingConnectionAdvancedSystemDeflection):
    """SpringDamperConnectionAdvancedSystemDeflection
    ...
    class _Cast_SpringDamperConnectionAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'SpringDamperConnectionAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_advanced_system_deflection(self) -> 'SpringDamperConnectionAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2789.SpringDamperConnectionSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionAdvancedSystemDeflection._Cast_SpringDamperConnectionAdvancedSystemDeflection':
