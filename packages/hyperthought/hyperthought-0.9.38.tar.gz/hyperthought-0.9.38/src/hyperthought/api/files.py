...
class FilesAPI(GenericAPI):
    ...
    def upload_using_url(self, upload_url, local_path,
                         progress_callback=None, n_chunks=100):
        """
    ...
    def generate_blank_upload_urls(self, url_count, failed_url=None):
        """
        ...
        failedUrl : str or None
            A previously requested url that didn't work.
            This will be used to exclude a server from consideration
            for url generation -- if there are multiple servers associated
    ...
    def create_files_after_upload(self, file_info):
        """
