...
class XlsWorksheet (  XlsWorksheetBase, IInternalWorksheet) :
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_GroupByColumns(self.Ptr, firstColumn,lastColumn,isCollapsed)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_GroupByRows(self.Ptr, firstRow,lastRow,isCollapsed)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_UngroupByColumns(self.Ptr, firstColumn,lastColumn)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_UngroupByRows(self.Ptr, firstRow,lastRow)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
...
#        intPtr = GetDllLibXls().XlsWorksheet_SaveShapesToImage(self.Ptr, intPtroption)
...
#
    ...
    def ApplyStyle(self ,style:CellStyle):
        ...
        GetDllLibXls().XlsWorksheet_ApplyStyle(self.Ptr, intPtrstyle)
    ...
    <param name="applyColumnStyle">true means apply style to all columns</param>
        ...
        GetDllLibXls().XlsWorksheet_ApplyStyleSAA(self.Ptr, intPtrstyle,applyRowStyle,applyColumnStyle)
    ...
    <param name="subtotalType">The subtotal type.</param>
        ...
        GetDllLibXls().XlsWorksheet_Subtotal(self.Ptr, intPtrrange,groupByIndex,arraytotalFields,counttotalFields,enumsubtotalType)
    ...
    <param name="addsummaryBelowData">Indicates whether add summarry below data.</param>
        ...
        GetDllLibXls().XlsWorksheet_SubtotalRGTSRAA(self.Ptr, intPtrrange,groupByIndex,arraytotalFields,counttotalFields,enumsubtotalType,replace,addPageBreak,addsummaryBelowData)
    ...
    <returns>If the row is null Return false,else if the row height is Autofit Return true, the row height is CustomHeight Return false</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_GetRowIsAutoFit(self.Ptr, rowIndex)
        return ret
    ...
    <returns>If the column is null Return false,else if the column width is Autofit Return true, the column width is CustomWidth Return false</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_GetColumnIsAutoFit(self.Ptr, columnIndex)
        return ret
    ...
    def GetDefaultRowStyle(self ,rowIndex:int)->'IStyle':
        ...
        intPtr = GetDllLibXls().XlsWorksheet_GetDefaultRowStyle(self.Ptr, rowIndex)
    ...
    <returns>Returns error value or null.</returns>
        ...
        GetDllLibXls().XlsWorksheet_GetError.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorksheet_GetError(self.Ptr, row,column)
        return ret
    ...
    <returns>Returns error value or null.</returns>
        ...
        GetDllLibXls().XlsWorksheet_GetFormulaErrorValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorksheet_GetFormulaErrorValue(self.Ptr, row,column)
        return ret
    ...
    <returns>Number contained by the cell.</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_GetFormulaNumberValue(self.Ptr, row,column)
        return ret
    ...
    <returns>String contained by the cell.</returns>
        ...
        GetDllLibXls().XlsWorksheet_GetFormulaStringValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorksheet_GetFormulaStringValue(self.Ptr, row,column)
        return ret
    ...
    def GetFormula(self ,row:int,column:int,bR1C1:bool)->str:
        ...
        GetDllLibXls().XlsWorksheet_GetFormula.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorksheet_GetFormula(self.Ptr, row,column,bR1C1)
        return ret
    ...
    def GetFormula(self ,row:int,column:int,bR1C1:bool,isForSerialization:bool)->str:
        ...
        GetDllLibXls().XlsWorksheet_GetFormulaRCBI.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorksheet_GetFormulaRCBI(self.Ptr, row,column,bR1C1,isForSerialization)
        return ret
    ...
    <returns>Returns found bool value. If cannot found returns false.</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_GetFormulaBoolValue(self.Ptr, row,column)
        return ret
    ...
    <returns>Number contained by the cell.</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_GetNumber(self.Ptr, row,column)
        return ret
    ...
    <returns>Height of row</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_GetRowHeight(self.Ptr, row)
        return ret
    ...
    <returns></returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_GetColumnIsHide(self.Ptr, columnIndex)
        return ret
    ...
    <returns></returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_GetRowIsHide(self.Ptr, rowIndex)
        return ret
    ...
    <param name="columnIndex">Column index.</param>
        ...
        GetDllLibXls().XlsWorksheet_HideColumn(self.Ptr, columnIndex)
    ...
    <param name="columnCount">Column count.</param>
        ...
        GetDllLibXls().XlsWorksheet_HideColumns(self.Ptr, columnIndex,columnCount)
    ...
    <param name="rowIndex">Row index.</param>
        ...
        GetDllLibXls().XlsWorksheet_HideRow(self.Ptr, rowIndex)
    ...
    <param name="rowCount">Row count.</param>
        ...
        GetDllLibXls().XlsWorksheet_HideRows(self.Ptr, rowIndex,rowCount)
    ...
    <returns>Height of row</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_GetRowHeightPixels(self.Ptr, rowIndex)
        return ret
    ...
    <returns>String contained by the cell.</returns>
        ...
        GetDllLibXls().XlsWorksheet_GetText.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorksheet_GetText(self.Ptr, row,column)
        return ret
    ...
    <param name="deleteOption">Choose to move the right range to left or move the below range to above</param>
        ...
        GetDllLibXls().XlsWorksheet_DeleteRange(self.Ptr, intPtrrange,enumdeleteOption)
    ...
    <param name="destIndex">Destination index.</param>
        ...
        GetDllLibXls().XlsWorksheet_MoveWorksheet(self.Ptr, destIndex)
    ...
    def PixelsToColumnWidth(self ,pixels:float)->float:
        ...
        ret = GetDllLibXls().XlsWorksheet_PixelsToColumnWidth(self.Ptr, pixels)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsWorksheet_Remove(self.Ptr)
    ...
    def RemoveMergedCells(self ,range:'IXLSRange'):
        ...
        GetDllLibXls().XlsWorksheet_RemoveMergedCells(self.Ptr, intPtrrange)
    ...
    <summary>
        ...
        GetDllLibXls().XlsWorksheet_RemovePanes(self.Ptr)
...
#        GetDllLibXls().XlsWorksheet_Replace(self.Ptr, oldValue,intPtrcolumn,columnHeaders)
...
#        GetDllLibXls().XlsWorksheet_ReplaceONC(self.Ptr, oldValue,intPtrnewValues,columnHeaders)
...
<remarks>
        ...
        GetDllLibXls().XlsWorksheet_ReplaceON(self.Ptr, oldValue,intPtrnewValue)
    ...
    <param name="newValue">New value for the range with specified string.</param>
        ...
        GetDllLibXls().XlsWorksheet_ReplaceON1(self.Ptr, oldValue,newValue)
...
<remarks>
        ...
        GetDllLibXls().XlsWorksheet_ReplaceONI(self.Ptr, oldValue,arraynewValues,countnewValues,isVertical)
...
<remarks>
        ...
        GetDllLibXls().XlsWorksheet_ReplaceONI1(self.Ptr, oldValue,arraynewValues,countnewValues,isVertical)
...
<remarks>
        ...
        GetDllLibXls().XlsWorksheet_ReplaceON11(self.Ptr, oldValue,newValue)
    ...
    def ReplaceAll(self ,oldValue:str,newValue:str,matchCase:bool)->int:
        ...
        ret = GetDllLibXls().XlsWorksheet_ReplaceAll(self.Ptr, oldValue,newValue,matchCase)
        return ret
...
<remarks>
        ...
        GetDllLibXls().XlsWorksheet_ReplaceONI11(self.Ptr, oldValue,arraynewValues,countnewValues,isVertical)

    @dispatch

    def SaveToImage(self ,firstRow:int,firstColumn:int,lastRow:int,lastColumn:int)->Image:
        """
        ...
        intPtr = GetDllLibXls().XlsWorksheet_SaveToImage(self.Ptr, firstRow,firstColumn,lastRow,lastColumn)
    ...
    <returns></returns>
        ...
        GetDllLibXls().XlsWorksheet_SaveToImageFFFLL(self.Ptr, fileName,firstRow,firstColumn,lastRow,lastColumn)
    ...
    <returns></returns>
        ...
        GetDllLibXls().XlsWorksheet_SaveToImageF(self.Ptr, fileName)
...
<summary></summary>
    ...
    <param name="format">file format</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToImageFF(self.Ptr, fileName,intPtrformat)


    def ToImage(self ,firstRow:int,firstColumn:int,lastRow:int,lastColumn:int)->'Image':
        """
<summary></summary>
    ...
    <param name="lastColumn">One-based index of the last column to convert.</param>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_ToImage(self.Ptr, firstRow,firstColumn,lastRow,lastColumn)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def SaveToImage(self ,stream:Stream,firstRow:int,firstColumn:int,lastRow:int,lastColumn:int,imageType:ImageType)->Image:
        """
    <summary>
    ...
    <returns>Created image.</returns>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_SaveToImageSFFLLI(self.Ptr, intPtrstream,firstRow,firstColumn,lastRow,lastColumn,enumimageType)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def SaveToImage(self ,stream:Stream,firstRow:int,firstColumn:int,lastRow:int,lastColumn:int,emfType:EmfType)->Image:
        """
    <summary>
    ...
    <returns>Created image.</returns>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_SaveToImageSFFLLE(self.Ptr, intPtrstream,firstRow,firstColumn,lastRow,lastColumn,enumemfType)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def SaveToImage(self ,stream:Stream,firstRow:int,firstColumn:int,lastRow:int,lastColumn:int,imageType:ImageType,emfType:EmfType)->Image:
        """
    <summary>
        Converts range into image.
    </summary>
    ...
    <returns>Created image.</returns>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_SaveToImageSFFLLIE(self.Ptr, intPtrstream,firstRow,firstColumn,lastRow,lastColumn,enumimageType,enumemfType)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def SaveToEMFImage(self ,FilePath:str,firstRow:int,firstColumn:int,lastRow:int,lastColumn:int,emfType:'EmfType'):
        ...
        GetDllLibXls().XlsWorksheet_SaveToEMFImage(self.Ptr, FilePath,firstRow,firstColumn,lastRow,lastColumn,enumemfType)
    ...
    <param name="stream">Stream object</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToHtml(self.Ptr, intPtrstream)
    ...
    <param name="saveOption">The option</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToHtmlSS(self.Ptr, intPtrstream,intPtrsaveOption)
    ...
    <param name="filename">File name</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToHtmlF(self.Ptr, filename)
    ...
    <param name="saveOption">The option</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToHtmlFS(self.Ptr, fileName,intPtrsaveOption)
    ...
    <param name="separator">Seperator.</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToFile(self.Ptr, fileName,separator)
    ...
    <param name="retainHiddenData">retain hidden data</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToFileFSR(self.Ptr, fileName,separator,retainHiddenData)
    ...
    <param name="encoding">Encoding to use.</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToFileFSE(self.Ptr, fileName,separator,intPtrencoding)
    ...
    <param name="separator">Seperator.</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToStream(self.Ptr, intPtrstream,separator)
    ...
    <param name="retainHiddenData">retain hidden data</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToStreamSSR(self.Ptr, intPtrstream,separator,retainHiddenData)
    ...
    <param name="encoding">Encoding to use.</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToStreamSSE(self.Ptr, intPtrstream,separator,intPtrencoding)
    ...
    <param name="fileName">File name.</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToXps(self.Ptr, fileName)
    ...
    <param name="fileName">File name.</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToPdf(self.Ptr, fileName,enumfileFormat)
    ...
    <param name="fileName">File name.</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToPdfF(self.Ptr, fileName)
    ...
    def SaveToPdfStream(self ,stream:Stream,fileFormat:FileFormat):
        ...
        GetDllLibXls().XlsWorksheet_SaveToPdfStream(self.Ptr, intPtrstream,enumfileFormat)
    ...
    <param name="stream">Stream.</param>
        ...
        GetDllLibXls().XlsWorksheet_SaveToPdfStreamS(self.Ptr, intPtrstream)
    ...
    <param name="lastColumn">One-based index of the last column to convert.</param>
        ...
        GetDllLibXls().XlsWorksheet_ToSVGStream(self.Ptr, intPtrstream,firstRow,firstColumn,lastRow,lastColumn)
    ...
    <param name="iColumn">One-based column index of the cell to set value.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetBlank(self.Ptr, iRow,iColumn)
    ...
    <param name="value">Value to set.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetBoolean(self.Ptr, iRow,iColumn,value)
    ...
    <param name="value">Width in pixels to set.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetColumnWidthInPixels(self.Ptr, iColumn,value)
    ...
    <param name="width">Width to set.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetColumnWidth(self.Ptr, columnIndex,width)
    ...
    <param name="value">Value</param>
        ...
        GetDllLibXls().XlsWorksheet_SetColumnWidthInPixelsCCV(self.Ptr, columnIndex,count,value)
    ...
    <param name="defaultStyle">Default style.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetDefaultColumnStyle(self.Ptr, columnIndex,intPtrdefaultStyle)
    ...
    def SetDefaultColumnStyle(self ,firstColumnIndex:int,lastColumnIndex:int,defaultStyle:IStyle):
        ...
        GetDllLibXls().XlsWorksheet_SetDefaultColumnStyleFLD(self.Ptr, firstColumnIndex,lastColumnIndex,intPtrdefaultStyle)
    ...
    def SetDefaultRowStyle(self ,rowIndex:int,defaultStyle:IStyle):
        ...
        GetDllLibXls().XlsWorksheet_SetDefaultRowStyle(self.Ptr, rowIndex,intPtrdefaultStyle)
    ...
    def SetDefaultRowStyle(self ,firstRowIndex:int,lastRowIndex:int,defaultStyle:IStyle):
        ...
        GetDllLibXls().XlsWorksheet_SetDefaultRowStyleFLD(self.Ptr, firstRowIndex,lastRowIndex,intPtrdefaultStyle)
    ...
    <param name="value">Error to set.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetError(self.Ptr, iRow,iColumn,value)
...
<summary></summary>
    ...
    <param name="isSetText"></param>
        ...
        GetDllLibXls().XlsWorksheet_SetErrorIIVI(self.Ptr, iRow,iColumn,value,isSetText)
    ...
    <param name="value">Formula to set.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetFormula(self.Ptr, iRow,iColumn,value)
    ...
    <param name="bIsR1C1">Indicates is formula in R1C1 notation.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetFormulaIIVB(self.Ptr, iRow,iColumn,value,bIsR1C1)
    ...
    <param name="value">Represents formula bool value for set.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetFormulaBoolValue(self.Ptr, iRow,iColumn,value)
    ...
    <param name="value">Represents formula error value for set.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetFormulaErrorValue(self.Ptr, iRow,iColumn,value)
    ...
    <param name="value">Represents formula number value for set.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetFormulaNumberValue(self.Ptr, iRow,iColumn,value)
    ...
    <param name="value">Represents formula string value for set.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetFormulaStringValue(self.Ptr, iRow,iColumn,value)
    ...
    <param name="value">Value to set.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetNumber(self.Ptr, iRow,iColumn,value)
    ...
    <param name="value">Value</param>
        ...
        GetDllLibXls().XlsWorksheet_SetRowHeightInPixels(self.Ptr, rowIndex,count,value)
    ...
    <param name="height">Height.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetRowHeight(self.Ptr, rowIndex,height)
    ...
    <param name="height">Height.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetRowHeightPixels(self.Ptr, rowIndex,height)
    ...
    <param name="value">Text to set.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetText(self.Ptr, iRow,iColumn,value)
    ...
    def SetValue(self ,rowIndex:int,columnIndex:int,stringValue:str):
        ...
        GetDllLibXls().XlsWorksheet_SetValue(self.Ptr, rowIndex,columnIndex,stringValue)
    ...
    <param name="boolValue">Value to set.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetCellValue(self.Ptr, rowIndex,columnIndex,boolValue)
    ...
    <param name="stringValue">Value to set.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetCellValueRCS(self.Ptr, rowIndex,columnIndex,stringValue)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_HasMergedCells(self.Ptr)
        return ret
...
<value>
  <c>true</c> if this instance is OLE object; otherwise, <c>false</c>.
        ...
        ret = GetDllLibXls().XlsWorksheet_get_HasOleObjects(self.Ptr)
        return ret
    ...
    def HorizontalSplit(self)->int:
        ...
        ret = GetDllLibXls().XlsWorksheet_get_HorizontalSplit(self.Ptr)
        return ret
    ...
    def HorizontalSplit(self, value:int):
        ...
        GetDllLibXls().XlsWorksheet_set_HorizontalSplit(self.Ptr, value)
    ...
    def HPageBreaks(self)->'IHPageBreaks':
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_HPageBreaks(self.Ptr)
    ...
    def HyperLinks(self)->'IHyperLinks':
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_HyperLinks(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_IsDisplayZeros(self.Ptr)
        return ret
    ...
    def IsDisplayZeros(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheet_set_IsDisplayZeros(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_IsEmpty(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_IsFreezePanes(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_IsStringsPreserved(self.Ptr)
        return ret
    ...
    def IsStringsPreserved(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheet_set_IsStringsPreserved(self.Ptr, value)
    ...
    <param name="password">password</param>
        ...
        ret = GetDllLibXls().XlsWorksheet_AddAllowEditRange(self.Ptr, title,intPtrrange,password)
        return ret
    ...
    <param name="range">range</param>
        ...
        ret = GetDllLibXls().XlsWorksheet_AddAllowEditRangeTR(self.Ptr, title,intPtrrange)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_ListObjects(self.Ptr)
    ...
    def FormulasVisible(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorksheet_get_FormulasVisible(self.Ptr)
        return ret
    ...
    def FormulasVisible(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheet_set_FormulasVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_RowColumnHeadersVisible(self.Ptr)
        return ret
    ...
    def RowColumnHeadersVisible(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheet_set_RowColumnHeadersVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_ProtectContents(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_PivotTables(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsWorksheet_get_QuotedName.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorksheet_get_QuotedName(self.Ptr)
        return ret
    ...
    def DVTable(self)->'IDataValidationTable':
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_DVTable(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsWorksheet_CalculateAllValue(self.Ptr)


    def GetCaculateValue(self ,row:int,col:int)->'SpireObject':
        """
        ...
        intPtr = GetDllLibXls().XlsWorksheet_GetCaculateValue(self.Ptr, row,col)
    ...
    def SetCaculateValue(self ,value:'SpireObject',row:int,col:int):
        ...
        GetDllLibXls().XlsWorksheet_SetCaculateValue(self.Ptr, intPtrvalue,row,col)
...
#        ret = GetDllLibXls().XlsWorksheet_InsertArray(self.Ptr, arraydateTimeArray,firstRow,firstColumn,isVertical)
#        return ret
    ...
    <returns></returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_InsertArrayDFFI(self.Ptr, arraydoubleArray,countdoubleArray,firstRow,firstColumn,isVertical)
        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertArrayOFFI(self.Ptr, intPtrobjects,firstRow,firstColumn,isVertical)
#        return ret
    ...
    <returns></returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_InsertArrayIFFI(self.Ptr, arrayintArray,countintArray,firstRow,firstColumn,isVertical)
        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertArrayOFF(self.Ptr, arrayobjectArray,firstRow,firstColumn)
#        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertArrayOFFN(self.Ptr, arrayobjectArray,firstRow,firstColumn,needConvert)
#        return ret
    ...
    <returns></returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_InsertArraySFFI(self.Ptr, arraystringArray,countstringArray,firstRow,firstColumn,isVertical)
        return ret
    ...
    <returns>Number of imported elements.</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_InsertArrayAFFI(self.Ptr, arrayarrObject,countarrObject,firstRow,firstColumn,isVertical)
        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertArrayList(self.Ptr, intPtrarrayList,firstRow,firstColumn,isVertical)
#        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertDataColumn(self.Ptr, intPtrdataColumn,columnHeaders,firstRow,firstColumn)
#        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertDataColumns(self.Ptr, arraydataColumns,columnHeaders,firstRow,firstColumn)
#        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertDataTable(self.Ptr, intPtrdataTable,columnHeaders,firstRow,firstColumn)
#        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertDataTableDCFFT(self.Ptr, intPtrdataTable,columnHeaders,firstRow,firstColumn,transTypes)
#        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertDataTableDCFFMM(self.Ptr, intPtrdataTable,columnHeaders,firstRow,firstColumn,maxRows,maxColumns)
#        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertDataTableDCFFMMT(self.Ptr, intPtrdataTable,columnHeaders,firstRow,firstColumn,maxRows,maxColumns,transTypes)
#        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertDataTableDCFFMMCT(self.Ptr, intPtrdataTable,columnHeaders,firstRow,firstColumn,maxRows,maxColumns,arraycolumnsArray,transTypes)
#        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertDataView(self.Ptr, intPtrdataView,columnHeaders,firstRow,firstColumn)
#        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertDataViewDCFFT(self.Ptr, intPtrdataView,columnHeaders,firstRow,firstColumn,transTypes)
#        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertDataViewDCFFMM(self.Ptr, intPtrdataView,columnHeaders,firstRow,firstColumn,maxRows,maxColumns)
#        return ret
...
#        ret = GetDllLibXls().XlsWorksheet_InsertDataViewDCFFMMT(self.Ptr, intPtrdataView,columnHeaders,firstRow,firstColumn,maxRows,maxColumns,transTypes)
#        return ret
    ...
    def ImportCustomObjects(self ,list:ICollection,firstRow:int,firstColumn:int,options:ImportObjectOptions)->int:
        ...
        ret = GetDllLibXls().XlsWorksheet_ImportCustomObjects(self.Ptr, intPtrlist,firstRow,firstColumn,intPtroptions)
        return ret
    ...
    def ImportCustomObjects(self ,list:ICollection,propertyNames:List[str],isPropertyNameShown:bool,firstRow:int,firstColumn:int,rowNumber:int,insertRows:bool,dateFormatString:str,convertStringToNumber:bool)->int:
        ...
        ret = GetDllLibXls().XlsWorksheet_ImportCustomObjectsLPIFFRIDC(self.Ptr, intPtrlist,arraypropertyNames,countpropertyNames,isPropertyNameShown,firstRow,firstColumn,rowNumber,insertRows,dateFormatString,convertStringToNumber)
        return ret
    ...
    <returns>true - visible, otherwise false.</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_IsColumnVisible(self.Ptr, columnIndex)
        return ret
    ...
    <returns>If contain extern formula returns true; otherwise false.</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_IsExternalFormula(self.Ptr, row,column)
        return ret
    ...
    <returns>true - visible, otherwise false.</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_IsRowVisible(self.Ptr, rowIndex)
        return ret
    ...
    <param name="columnIndex">Column index.</param>
        ...
        GetDllLibXls().XlsWorksheet_AutoFitColumn(self.Ptr, columnIndex)
    ...
    <param name="options">auto fit options</param>
        ...
        GetDllLibXls().XlsWorksheet_AutoFitColumnCO(self.Ptr, columnIndex,intPtroptions)
    ...
    <param name="lastRow">One-based index of the last row to be used for autofit operation.</param>
        ...
        GetDllLibXls().XlsWorksheet_AutoFitColumnCFL(self.Ptr, columnIndex,firstRow,lastRow)
    ...
    <param name="options">auto fit options</param>
        ...
        GetDllLibXls().XlsWorksheet_AutoFitColumnCFLO(self.Ptr, columnIndex,firstRow,lastRow,intPtroptions)
    ...
    <param name="rowIndex">Row index</param>
        ...
        GetDllLibXls().XlsWorksheet_AutoFitRow(self.Ptr, rowIndex)
    ...
    <param name="options">auto fit options</param>
        ...
        GetDllLibXls().XlsWorksheet_AutoFitRowRFLO(self.Ptr, rowIndex,firstColumn,lastColumn,intPtroptions)
    ...
    <param name="bRaiseEvents">If true then raise events.</param>
        ...
        GetDllLibXls().XlsWorksheet_AutoFitRowRFLB(self.Ptr, rowIndex,firstColumn,lastColumn,bRaiseEvents)
    ...
    <param name="options">auto fit options</param>
        ...
        GetDllLibXls().XlsWorksheet_AutoFitRowRFLBO(self.Ptr, rowIndex,firstColumn,lastColumn,bRaiseEvents,intPtroptions)
    ...
    <returns>Value indicating whether the cell was initialized or accessed by the user.</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_CheckExistence(self.Ptr, row,column)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsWorksheet_Clear(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsWorksheet_ClearData(self.Ptr)
    ...
    def ColumnWidthToPixels(self ,widthInChars:float)->int:
        ...
        ret = GetDllLibXls().XlsWorksheet_ColumnWidthToPixels(self.Ptr, widthInChars)
        return ret
...
#        GetDllLibXls().XlsWorksheet_CopyFrom(self.Ptr, intPtrworksheet,intPtrhashStyleNames,intPtrhashWorksheetNames,intPtrdicFontIndexes,enumflags,intPtrhashExtFormatIndexes,intPtrhashNameIndexes,intPtrhashExternSheets)
    ...
    <returns>Returns cell type.</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_GetCellType(self.Ptr, row,column,bNeedFormulaSubType)
...
#        intPtr = GetDllLibXls().XlsWorksheet_GetClonedObject(self.Ptr, intPtrhashNewNames,intPtrbook)
...
#
    ...
    <returns>String contained by the cell.</returns>
        ...
        GetDllLibXls().XlsWorksheet_GetStringValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorksheet_GetStringValue(self.Ptr, cellIndex)
        return ret
    ...
    <returns>String contained by the cell.</returns>
        ...
        GetDllLibXls().XlsWorksheet_GetStringValueRC.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorksheet_GetStringValueRC(self.Ptr, row,column)
        return ret
    ...
    <returns>Object corresponding to the specified cell.</returns>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_GetTextObject(self.Ptr, cellIndex)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    <returns>Object corresponding to the specified cell.</returns>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_GetTextObjectRC(self.Ptr, row,column)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_HasArrayFormula(self.Ptr, cellIndex)
        return ret
    ...
    <returns>Indicates is contain array formula record.</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_HasArrayFormulaRecord(self.Ptr, row,column)
        return ret
    ...
    <returns>return the range that insert into worksheet</returns>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_InsertRange(self.Ptr, rowIndex,columnIndex,rowCount,columnCount,enummoveOptions,enuminsertOptions)
    ...
    <param name="moveOptions">insert options.</param>
        ...
        GetDllLibXls().XlsWorksheet_InsertCutRange(self.Ptr, intPtrcutRange,rowIndex,colIndex,enummoveOptions)
    ...
    def IsArrayFormula(self ,cellIndex:int)->bool:
        ...
        ret = GetDllLibXls().XlsWorksheet_IsArrayFormula(self.Ptr, cellIndex)
        return ret
    ...
    <returns>True if cell contains array-entered formula.</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_IsArrayFormulaRC(self.Ptr, row,column)
        return ret
    ...
    def ReparseFormula(self):
        ...
        GetDllLibXls().XlsWorksheet_ReparseFormula(self.Ptr)
    ...
    def CopyToClipboard(self):
        ...
        GetDllLibXls().XlsWorksheet_CopyToClipboard(self.Ptr)
    ...
    def CreateRanges(self ,ranges:'ListCellRanges')->'XlsRangesCollection':
        ...
        intPtr = GetDllLibXls().XlsWorksheet_CreateRanges(self.Ptr, arrayranges, countranges)
    ...
    def CreateNamedRanges(self ,namedRange:str,referRange:str,vertical:bool):
        ...
        GetDllLibXls().XlsWorksheet_CreateNamedRanges(self.Ptr, namedRange,referRange,vertical)
    ...
    <param name="columnIndex">Column index to remove..</param>
        ...
        GetDllLibXls().XlsWorksheet_DeleteColumn(self.Ptr, index)
    ...
    <param name="count">Number of columns to remove.</param>
        ...
        GetDllLibXls().XlsWorksheet_DeleteColumnIC(self.Ptr, index,count)
    ...
    <param name="index">Row index to remove</param>
        ...
        GetDllLibXls().XlsWorksheet_DeleteRow(self.Ptr, index)
    ...
    <param name="count">Number of rows to delete.</param>
        ...
        GetDllLibXls().XlsWorksheet_DeleteRowIC(self.Ptr, index,count)
    ...
    <param name="columnIndex">Column index</param>
        ...
        GetDllLibXls().XlsWorksheet_InsertColumn(self.Ptr, columnIndex)
    ...
    def InsertColumn(self ,columnIndex:int,columnCount:int,insertOptions:InsertOptionsType):
        ...
        GetDllLibXls().XlsWorksheet_InsertColumnCCI(self.Ptr, columnIndex,columnCount,enuminsertOptions)
    ...
    <param name="columnCount">Number of columns to insert.</param>
        ...
        GetDllLibXls().XlsWorksheet_InsertColumnCC(self.Ptr, columnIndex,columnCount)
    ...
    <param name="rowIndex">Index at which new row should be inserted</param>
        ...
        GetDllLibXls().XlsWorksheet_InsertRow(self.Ptr, rowIndex)
...
#        intPtr = GetDllLibXls().XlsWorksheet_ExportDataTable(self.Ptr)
...
#
    ...
    def InsertRow(self ,rowIndex:int,rowCount:int,insertOptions:InsertOptionsType):
        ...
        GetDllLibXls().XlsWorksheet_InsertRowRRI(self.Ptr, rowIndex,rowCount,enuminsertOptions)
    ...
    <param name="rowCount">Number of rows to be inserted. </param>
        ...
        GetDllLibXls().XlsWorksheet_InsertRowRR(self.Ptr, rowIndex,rowCount)
    ...
    <returns>Returns found bool value. If cannot found returns false.</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_GetBoolean(self.Ptr, row,column)
        return ret
    ...
    <returns>Width of column</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_GetColumnWidth(self.Ptr, columnIndex)
        return ret
    ...
    <returns>Width of column</returns>
        ...
        ret = GetDllLibXls().XlsWorksheet_GetColumnWidthPixels(self.Ptr, columnIndex)
        return ret
    ...
    def GetDefaultColumnStyle(self ,columnIndex:int)->'IStyle':
        ...
        intPtr = GetDllLibXls().XlsWorksheet_GetDefaultColumnStyle(self.Ptr, columnIndex)
        ret = None if intPtr==None else CellStyle(intPtr)
        return ret
    ...
    def add_CellValueChanged(self ,value:'CellValueChangedEventHandler'):
        ...
        GetDllLibXls().XlsWorksheet_add_CellValueChanged(self.Ptr, intPtrvalue)
    ...
    def remove_CellValueChanged(self ,value:'CellValueChangedEventHandler'):
        ...
        GetDllLibXls().XlsWorksheet_remove_CellValueChanged(self.Ptr, intPtrvalue)
    ...
    def Copying(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorksheet_get_Copying(self.Ptr)
        return ret

    @Copying.setter
    def Copying(self, value:bool):
        GetDllLibXls().XlsWorksheet_set_Copying.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsWorksheet_set_Copying(self.Ptr, value)
...
<value>The OLE objects.</value>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_OleObjects(self.Ptr)
    ...
    def AutoFilters(self)->'IAutoFilters':
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_AutoFilters(self.Ptr)
    ...
    def Cells(self)->ListXlsRanges:
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_Cells(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsWorksheet_get_CellList(self.Ptr)
#        ret = None if intPtr==None else List1(intPtr)
#        return ret
#
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_DisplayPageBreaks(self.Ptr)
        return ret
    ...
    def DisplayPageBreaks(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheet_set_DisplayPageBreaks(self.Ptr, value)
    ...
    def MergedCells(self)->ListXlsRanges:
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_MergedCells(self.Ptr)
        ret = None if intPtr==None else ListXlsRanges(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_Names(self.Ptr)
    ...
    def PageSetup(self)->'IPageSetup':
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_PageSetup(self.Ptr)
    ...
    def MaxDisplayRange(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_MaxDisplayRange(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def AllocatedRange(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_AllocatedRange(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def AllocatedRangeIncludesFormatting(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorksheet_get_AllocatedRangeIncludesFormatting(self.Ptr)
        return ret
    ...
    def AllocatedRangeIncludesFormatting(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheet_set_AllocatedRangeIncludesFormatting(self.Ptr, value)
    ...
    def Rows(self)->ListXlsRanges:
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_Rows(self.Ptr)
        ret = None if intPtr==None else ListXlsRanges(intPtr)
        return ret
    ...
    def Columns(self)->ListXlsRanges:
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_Columns(self.Ptr)
        ret = None if intPtr==None else ListXlsRanges(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_ConditionalFormats(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_DefaultRowHeight(self.Ptr)
        return ret
    ...
    def DefaultRowHeight(self, value:float):
        ...
        GetDllLibXls().XlsWorksheet_set_DefaultRowHeight(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_DefaultPrintRowHeight(self.Ptr)
        return ret
    ...
    def DefaultPrintRowHeight(self, value:int):
        ...
        GetDllLibXls().XlsWorksheet_set_DefaultPrintRowHeight(self.Ptr, value)
...
<value></value>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_ViewMode(self.Ptr)
    ...
    def ViewMode(self, value:'ViewMode'):
        ...
        GetDllLibXls().XlsWorksheet_set_ViewMode(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_DefaultColumnWidth(self.Ptr)
        return ret
    ...
    def DefaultColumnWidth(self, value:float):
        ...
        GetDllLibXls().XlsWorksheet_set_DefaultColumnWidth(self.Ptr, value)
...
<remarks> Value of zoom should be between 10 and 400.</remarks>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_Zoom(self.Ptr)
        return ret

    @Zoom.setter
    def Zoom(self, value:int):
        GetDllLibXls().XlsWorksheet_set_Zoom.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsWorksheet_set_Zoom(self.Ptr, value)
...
<value></value>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_ZoomScaleNormal(self.Ptr)
        return ret
    ...
    def ZoomScaleNormal(self, value:int):
        ...
        GetDllLibXls().XlsWorksheet_set_ZoomScaleNormal(self.Ptr, value)
...
<value></value>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_ZoomScalePageBreakView(self.Ptr)
        return ret
    ...
    def ZoomScalePageBreakView(self, value:int):
        ...
        GetDllLibXls().XlsWorksheet_set_ZoomScalePageBreakView(self.Ptr, value)
...
<value></value>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_ZoomScalePageLayoutView(self.Ptr)
        return ret
    ...
    def ZoomScalePageLayoutView(self, value:int):
        ...
        GetDllLibXls().XlsWorksheet_set_ZoomScalePageLayoutView(self.Ptr, value)
    ...
    def SelectionCount(self)->int:
        ...
        ret = GetDllLibXls().XlsWorksheet_get_SelectionCount(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_Version(self.Ptr)
    ...
    def Version(self, value:'ExcelVersion'):
        ...
        GetDllLibXls().XlsWorksheet_set_Version(self.Ptr, value.value)
    ...
    def SparklineGroups(self)->'SparklineGroupCollection':
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_SparklineGroups(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_StandardHeightFlag(self.Ptr)
        return ret
    ...
    def StandardHeightFlag(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheet_set_StandardHeightFlag(self.Ptr, value)
    ...
    def Type(self)->'ExcelSheetType':
        ...
        ret = GetDllLibXls().XlsWorksheet_get_Type(self.Ptr)
    ...
    def Range(self)->'XlsRange':
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_Range(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def get_Item(self ,row:int,column:int)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_Item(self.Ptr, row,column)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def get_Item(self ,row:int,column:int,lastRow:int,lastColumn:int)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_ItemRCLL(self.Ptr, row,column,lastRow,lastColumn)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def get_Item(self ,name:str)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_TopLeftCell(self.Ptr)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    def TopLeftCell(self, value:'CellRange'):
        ...
        GetDllLibXls().XlsWorksheet_set_TopLeftCell(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_UseRangesCache(self.Ptr)
        return ret
    ...
    def UseRangesCache(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheet_set_UseRangesCache(self.Ptr, value)
    ...
    def VPageBreaks(self)->'IVPageBreaks':
        ...
        intPtr = GetDllLibXls().XlsWorksheet_get_VPageBreaks(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_ActivePane(self.Ptr)
        return ret

    @ActivePane.setter
    def ActivePane(self, value:int):
        GetDllLibXls().XlsWorksheet_set_ActivePane.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsWorksheet_set_ActivePane(self.Ptr, value)
    ...
    def SetFirstColumn(self ,columnIndex:int):
        ...
        GetDllLibXls().XlsWorksheet_SetFirstColumn(self.Ptr, columnIndex)
    ...
    <param name="columnIndex">Column index.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetLastColumn(self.Ptr, columnIndex)
    ...
    <param name="rowIndex">Row index.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetFirstRow(self.Ptr, rowIndex)
    ...
    <param name="rowIndex">Row index.</param>
        ...
        GetDllLibXls().XlsWorksheet_SetLastRow(self.Ptr, rowIndex)
    ...
    <param name="columnIndex">Column index.</param>
        ...
        GetDllLibXls().XlsWorksheet_ShowColumn(self.Ptr, columnIndex)
    ...
    def ShowRow(self ,rowIndex:int):
        ...
        GetDllLibXls().XlsWorksheet_ShowRow(self.Ptr, rowIndex)
...
#        GetDllLibXls().XlsWorksheet_ToEMFStream(self.Ptr, intPtrstream,firstRow,firstColumn,lastRow,lastColumn,enumemfType)
...
#        GetDllLibXls().XlsWorksheet_ToEMFStreamSFFLL(self.Ptr, intPtrstream,firstRow,firstColumn,lastRow,lastColumn)
    ...
    def SetActiveCell(self ,range:IXLSRange):
        ...
        GetDllLibXls().XlsWorksheet_SetActiveCell(self.Ptr, intPtrrange)
    ...
    def SetActiveCell(self ,range:IXLSRange,updateApplication:bool):
        ...
        GetDllLibXls().XlsWorksheet_SetActiveCellRU(self.Ptr, intPtrrange,updateApplication)
    ...
    def FirstVisibleColumn(self)->int:
        ...
        ret = GetDllLibXls().XlsWorksheet_get_FirstVisibleColumn(self.Ptr)
        return ret
    ...
    def FirstVisibleColumn(self, value:int):
        ...
        GetDllLibXls().XlsWorksheet_set_FirstVisibleColumn(self.Ptr, value)
    ...
    def FirstVisibleRow(self)->int:
        ...
        ret = GetDllLibXls().XlsWorksheet_get_FirstVisibleRow(self.Ptr)
        return ret
    ...
    def FirstVisibleRow(self, value:int):
        ...
        GetDllLibXls().XlsWorksheet_set_FirstVisibleRow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheet_get_GridLinesVisible(self.Ptr)
        return ret
    ...
    def GridLinesVisible(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheet_set_GridLinesVisible(self.Ptr, value)
