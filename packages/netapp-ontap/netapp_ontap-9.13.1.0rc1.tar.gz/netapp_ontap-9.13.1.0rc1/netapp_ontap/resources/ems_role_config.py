...
class EmsRoleConfigSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    access_control_role = fields.Nested("netapp_ontap.resources.role.RoleSchema", data_key="access_control_role", unknown=EXCLUDE)
    r""" The access_control_role field of the ems_role_config."""

    event_filter = fields.Nested("netapp_ontap.resources.ems_filter.EmsFilterSchema", data_key="event_filter", unknown=EXCLUDE)
    r""" The event_filter field of the ems_role_config."""

    limit_access_to_global_configs = fields.Boolean(
