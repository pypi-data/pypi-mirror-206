...
class ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft(_3412.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    """ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def concept_gear_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3255.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3255.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft._Cast_ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft(self)
