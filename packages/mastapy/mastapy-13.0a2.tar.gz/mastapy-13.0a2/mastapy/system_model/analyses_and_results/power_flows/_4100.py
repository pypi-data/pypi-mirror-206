...
class PulleyPowerFlow(_4047.CouplingHalfPowerFlow):
    """PulleyPowerFlow
    ...
    class _Cast_PulleyPowerFlow:
        ...
        def __init__(self, parent: 'PulleyPowerFlow'):
            self._parent = parent
        ...
        @property
        def pulley_power_flow(self) -> 'PulleyPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PulleyPowerFlow._Cast_PulleyPowerFlow':
