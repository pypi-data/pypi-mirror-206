...
class ChartShadow (  XlsObject, IShadow, ICloneParent) :
    ...
    def ShadowOuterType(self)->'XLSXChartShadowOuterType':
        ...
        ret = GetDllLibXls().ChartShadow_get_ShadowOuterType(self.Ptr)
    ...
    def ShadowOuterType(self, value:'XLSXChartShadowOuterType'):
        ...
        GetDllLibXls().ChartShadow_set_ShadowOuterType(self.Ptr, value.value)
    ...
    def ShadowInnerType(self)->'XLSXChartShadowInnerType':
        ...
        ret = GetDllLibXls().ChartShadow_get_ShadowInnerType(self.Ptr)
    ...
    def ShadowInnerType(self, value:'XLSXChartShadowInnerType'):
        ...
        GetDllLibXls().ChartShadow_set_ShadowInnerType(self.Ptr, value.value)
    ...
    def ShadowPrespectiveType(self)->'XLSXChartPrespectiveType':
        ...
        ret = GetDllLibXls().ChartShadow_get_ShadowPrespectiveType(self.Ptr)
    ...
    def ShadowPrespectiveType(self, value:'XLSXChartPrespectiveType'):
        ...
        GetDllLibXls().ChartShadow_set_ShadowPrespectiveType(self.Ptr, value.value)
    ...
    def HasCustomStyle(self)->bool:
        ...
        ret = GetDllLibXls().ChartShadow_get_HasCustomStyle(self.Ptr)
        return ret
    ...
    def HasCustomStyle(self, value:bool):
        ...
        GetDllLibXls().ChartShadow_set_HasCustomStyle(self.Ptr, value)
    ...
    def Transparency(self)->int:
        ...
        ret = GetDllLibXls().ChartShadow_get_Transparency(self.Ptr)
        return ret

    @Transparency.setter
    def Transparency(self, value:int):
        GetDllLibXls().ChartShadow_set_Transparency.argtypes=[c_void_p, c_int]
        GetDllLibXls().ChartShadow_set_Transparency(self.Ptr, value)
    ...
    def Size(self)->int:
        ...
        ret = GetDllLibXls().ChartShadow_get_Size(self.Ptr)
        return ret

    @Size.setter
    def Size(self, value:int):
        GetDllLibXls().ChartShadow_set_Size.argtypes=[c_void_p, c_int]
        GetDllLibXls().ChartShadow_set_Size(self.Ptr, value)
    ...
    def Blur(self)->int:
        ...
        ret = GetDllLibXls().ChartShadow_get_Blur(self.Ptr)
        return ret

    @Blur.setter
    def Blur(self, value:int):
        GetDllLibXls().ChartShadow_set_Blur.argtypes=[c_void_p, c_int]
        GetDllLibXls().ChartShadow_set_Blur(self.Ptr, value)
    ...
    def Angle(self)->int:
        ...
        ret = GetDllLibXls().ChartShadow_get_Angle(self.Ptr)
        return ret

    @Angle.setter
    def Angle(self, value:int):
        GetDllLibXls().ChartShadow_set_Angle.argtypes=[c_void_p, c_int]
        GetDllLibXls().ChartShadow_set_Angle(self.Ptr, value)
    ...
    def Distance(self)->int:
        ...
        ret = GetDllLibXls().ChartShadow_get_Distance(self.Ptr)
        return ret

    @Distance.setter
    def Distance(self, value:int):
        GetDllLibXls().ChartShadow_set_Distance.argtypes=[c_void_p, c_int]
        GetDllLibXls().ChartShadow_set_Distance(self.Ptr, value)
    ...
    def Color(self)->'Color':
        ...
        intPtr = GetDllLibXls().ChartShadow_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().ChartShadow_set_Color(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ChartShadow_get_SoftEdge(self.Ptr)
        return ret

    @SoftEdge.setter
    def SoftEdge(self, value:int):
        GetDllLibXls().ChartShadow_set_SoftEdge.argtypes=[c_void_p, c_int]
        GetDllLibXls().ChartShadow_set_SoftEdge(self.Ptr, value)
    ...
    def CustomShadowStyles(self ,iOuter:XLSXChartShadowOuterType,iTransparency:int,iSize:int,iBlur:int,iAngle:int,iDistance:int,iCustomShadowStyle:bool):
        ...
        GetDllLibXls().ChartShadow_CustomShadowStyles(self.Ptr, enumiOuter,iTransparency,iSize,iBlur,iAngle,iDistance,iCustomShadowStyle)
    ...
    def CustomShadowStyles(self ,iInner:XLSXChartShadowInnerType,iTransparency:int,iBlur:int,iAngle:int,iDistance:int,iCustomShadowStyle:bool):
        ...
        GetDllLibXls().ChartShadow_CustomShadowStylesIIIIII(self.Ptr, enumiInner,iTransparency,iBlur,iAngle,iDistance,iCustomShadowStyle)
    ...
    def CustomShadowStyles(self ,iPerspective:XLSXChartPrespectiveType,iTransparency:int,iSize:int,iBlur:int,iAngle:int,iDistance:int,iCustomShadowStyle:bool):
        ...
        GetDllLibXls().ChartShadow_CustomShadowStylesIIIIIII(self.Ptr, enumiPerspective,iTransparency,iSize,iBlur,iAngle,iDistance,iCustomShadowStyle)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().ChartShadow_Clone(self.Ptr, intPtrparent)
