...
class PulleyCompoundPowerFlow(_4181.CouplingHalfCompoundPowerFlow):
    """PulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4100.PulleyPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4100.PulleyPowerFlow]':
