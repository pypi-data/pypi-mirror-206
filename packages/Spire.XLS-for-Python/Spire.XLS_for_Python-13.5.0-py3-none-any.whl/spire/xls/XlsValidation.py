...
class XlsValidation (  IDataValidation, IExcelApplication, IOptimizedUpdate, ICloneParent) :
    ...
    def InputTitle(self)->str:
        ...
        GetDllLibXls().XlsValidation_get_InputTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsValidation_get_InputTitle(self.Ptr)
        return ret
    ...
    def InputTitle(self, value:str):
        ...
        GetDllLibXls().XlsValidation_set_InputTitle(self.Ptr, value)
    ...
    def InputMessage(self)->str:
        ...
        GetDllLibXls().XlsValidation_get_InputMessage.restype=c_wchar_p
        ret = GetDllLibXls().XlsValidation_get_InputMessage(self.Ptr)
        return ret
    ...
    def InputMessage(self, value:str):
        ...
        GetDllLibXls().XlsValidation_set_InputMessage(self.Ptr, value)
    ...
    def ErrorTitle(self)->str:
        ...
        GetDllLibXls().XlsValidation_get_ErrorTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsValidation_get_ErrorTitle(self.Ptr)
        return ret
    ...
    def ErrorTitle(self, value:str):
        ...
        GetDllLibXls().XlsValidation_set_ErrorTitle(self.Ptr, value)
    ...
    def ErrorMessage(self)->str:
        ...
        GetDllLibXls().XlsValidation_get_ErrorMessage.restype=c_wchar_p
        ret = GetDllLibXls().XlsValidation_get_ErrorMessage(self.Ptr)
        return ret
    ...
    def ErrorMessage(self, value:str):
        ...
        GetDllLibXls().XlsValidation_set_ErrorMessage(self.Ptr, value)
    ...
    def Formula1(self)->str:
        ...
        GetDllLibXls().XlsValidation_get_Formula1.restype=c_wchar_p
        ret = GetDllLibXls().XlsValidation_get_Formula1(self.Ptr)
        return ret
    ...
    def Formula1(self, value:str):
        ...
        GetDllLibXls().XlsValidation_set_Formula1(self.Ptr, value)
    ...
    def DateTime1(self)->'DateTime':
        ...
        intPtr = GetDllLibXls().XlsValidation_get_DateTime1(self.Ptr)
    ...
    def DateTime1(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsValidation_set_DateTime1(self.Ptr, value.Ptr)
    ...
    def Formula2(self)->str:
        ...
        GetDllLibXls().XlsValidation_get_Formula2.restype=c_wchar_p
        ret = GetDllLibXls().XlsValidation_get_Formula2(self.Ptr)
        return ret
    ...
    def Formula2(self, value:str):
        ...
        GetDllLibXls().XlsValidation_set_Formula2(self.Ptr, value)
    ...
    def DateTime2(self)->'DateTime':
        ...
        intPtr = GetDllLibXls().XlsValidation_get_DateTime2(self.Ptr)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def DateTime2(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsValidation_set_DateTime2(self.Ptr, value.Ptr)
    ...
    def AllowType(self)->'CellDataType':
        ...
        ret = GetDllLibXls().XlsValidation_get_AllowType(self.Ptr)
    ...
    def AllowType(self, value:'CellDataType'):
        ...
        GetDllLibXls().XlsValidation_set_AllowType(self.Ptr, value.value)
    ...
    def CompareOperator(self)->'ValidationComparisonOperator':
        ...
        ret = GetDllLibXls().XlsValidation_get_CompareOperator(self.Ptr)
    ...
    def CompareOperator(self, value:'ValidationComparisonOperator'):
        ...
        GetDllLibXls().XlsValidation_set_CompareOperator(self.Ptr, value.value)
    ...
    def IsListInFormula(self)->bool:
        ...
        ret = GetDllLibXls().XlsValidation_get_IsListInFormula(self.Ptr)
        return ret
    ...
    def IsListInFormula(self, value:bool):
        ...
        GetDllLibXls().XlsValidation_set_IsListInFormula(self.Ptr, value)
    ...
    def IgnoreBlank(self)->bool:
        ...
        ret = GetDllLibXls().XlsValidation_get_IgnoreBlank(self.Ptr)
        return ret

    @IgnoreBlank.setter
    def IgnoreBlank(self, value:bool):
        GetDllLibXls().XlsValidation_set_IgnoreBlank.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsValidation_set_IgnoreBlank(self.Ptr, value)
    ...
    def IsSuppressDropDownArrow(self)->bool:
        ...
        ret = GetDllLibXls().XlsValidation_get_IsSuppressDropDownArrow(self.Ptr)
        return ret
    ...
    def IsSuppressDropDownArrow(self, value:bool):
        ...
        GetDllLibXls().XlsValidation_set_IsSuppressDropDownArrow(self.Ptr, value)
    ...
    def ShapesCount(self)->int:
        ...
        ret = GetDllLibXls().XlsValidation_get_ShapesCount(self.Ptr)
        return ret
    ...
    def ShowInput(self)->bool:
        ...
        ret = GetDllLibXls().XlsValidation_get_ShowInput(self.Ptr)
        return ret

    @ShowInput.setter
    def ShowInput(self, value:bool):
        GetDllLibXls().XlsValidation_set_ShowInput.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsValidation_set_ShowInput(self.Ptr, value)
    ...
    def ShowError(self)->bool:
        ...
        ret = GetDllLibXls().XlsValidation_get_ShowError(self.Ptr)
        return ret

    @ShowError.setter
    def ShowError(self, value:bool):
        GetDllLibXls().XlsValidation_set_ShowError.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsValidation_set_ShowError(self.Ptr, value)
    ...
    def PromptBoxHPosition(self)->int:
        ...
        ret = GetDllLibXls().XlsValidation_get_PromptBoxHPosition(self.Ptr)
        return ret
    ...
    def PromptBoxHPosition(self, value:int):
        ...
        GetDllLibXls().XlsValidation_set_PromptBoxHPosition(self.Ptr, value)
    ...
    def PromptBoxVPosition(self)->int:
        ...
        ret = GetDllLibXls().XlsValidation_get_PromptBoxVPosition(self.Ptr)
        return ret
    ...
    def PromptBoxVPosition(self, value:int):
        ...
        GetDllLibXls().XlsValidation_set_PromptBoxVPosition(self.Ptr, value)
    ...
    def IsInputVisible(self)->bool:
        ...
        ret = GetDllLibXls().XlsValidation_get_IsInputVisible(self.Ptr)
        return ret
    ...
    def IsInputVisible(self, value:bool):
        ...
        GetDllLibXls().XlsValidation_set_IsInputVisible(self.Ptr, value)
    ...
    def IsInputPositionFixed(self)->bool:
        ...
        ret = GetDllLibXls().XlsValidation_get_IsInputPositionFixed(self.Ptr)
        return ret
    ...
    def IsInputPositionFixed(self, value:bool):
        ...
        GetDllLibXls().XlsValidation_set_IsInputPositionFixed(self.Ptr, value)
    ...
    def AlertStyle(self)->'AlertStyleType':
        ...
        ret = GetDllLibXls().XlsValidation_get_AlertStyle(self.Ptr)
    ...
    def AlertStyle(self, value:'AlertStyleType'):
        ...
        GetDllLibXls().XlsValidation_set_AlertStyle(self.Ptr, value.value)
    ...
    def Values(self)->List[str]:
        ...
        intPtrArray = GetDllLibXls().XlsValidation_get_Values(self.Ptr)
    ...
    def Values(self, value:List[str]):
        ...
        GetDllLibXls().XlsValidation_set_Values(self.Ptr, vArray, vCount)
    ...
    def DataRange(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsValidation_get_DataRange(self.Ptr)
    ...
    def DataRange(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsValidation_set_DataRange(self.Ptr, value.Ptr)
    ...
    def AddRange(self ,dv:'XlsValidation'):
        ...
        GetDllLibXls().XlsValidation_AddRange(self.Ptr, intPtrdv)
    ...
    def AddRange(self ,range:XlsRange):
        ...
        GetDllLibXls().XlsValidation_AddRangeR(self.Ptr, intPtrrange)
...
#        GetDllLibXls().XlsValidation_RemoveRange(self.Ptr, arrayrectangles)
    ...
    def RemoveRange(self ,range:XlsRange):
        ...
        GetDllLibXls().XlsValidation_RemoveRangeR(self.Ptr, intPtrrange)
    ...
    def Worksheet(self)->'XlsWorksheet':
        ...
        intPtr = GetDllLibXls().XlsValidation_get_Worksheet(self.Ptr)
    ...
    def ContainsCell(self ,lCellIndex:int)->bool:
        ...
        ret = GetDllLibXls().XlsValidation_ContainsCell(self.Ptr, lCellIndex)
        return ret
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsValidation_Clone(self.Ptr, intPtrparent)
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsValidation_get_Parent(self.Ptr)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    def ParentCollection(self)->'XlsDataValidationCollection':
        ...
        intPtr = GetDllLibXls().XlsValidation_get_ParentCollection(self.Ptr)
    ...
    def ParentCollection(self, value:'XlsDataValidationCollection'):
        ...
        GetDllLibXls().XlsValidation_set_ParentCollection(self.Ptr, value.Ptr)
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().XlsValidation_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().XlsValidation_EndUpdate(self.Ptr)
