...
class RollingRingPowerFlow(_4047.CouplingHalfPowerFlow):
    """RollingRingPowerFlow
    ...
    class _Cast_RollingRingPowerFlow:
        ...
        def __init__(self, parent: 'RollingRingPowerFlow'):
            self._parent = parent
        ...
        @property
        def rolling_ring_power_flow(self) -> 'RollingRingPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingPowerFlow._Cast_RollingRingPowerFlow':
