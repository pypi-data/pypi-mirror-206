...
class VirtualCylindricalGearISO10300MethodB2(_385.VirtualCylindricalGearBasic):
    """VirtualCylindricalGearISO10300MethodB2
    ...
    class _Cast_VirtualCylindricalGearISO10300MethodB2:
        ...
        def __init__(self, parent: 'VirtualCylindricalGearISO10300MethodB2'):
            self._parent = parent
        ...
        @property
        def virtual_cylindrical_gear_iso10300_method_b2(self) -> 'VirtualCylindricalGearISO10300MethodB2':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'VirtualCylindricalGearISO10300MethodB2._Cast_VirtualCylindricalGearISO10300MethodB2':
