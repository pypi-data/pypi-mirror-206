...
class BeltDriveModalAnalysisAtAStiffness(_4929.SpecialisedAssemblyModalAnalysisAtAStiffness):
    """BeltDriveModalAnalysisAtAStiffness
    ...
    class _Cast_BeltDriveModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'BeltDriveModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def belt_drive_modal_analysis_at_a_stiffness(self) -> 'BeltDriveModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BeltDriveModalAnalysisAtAStiffness._Cast_BeltDriveModalAnalysisAtAStiffness':
