...
class StraightBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_6122.BevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    """StraightBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_StraightBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_compound_harmonic_analysis_of_single_excitation(self) -> 'StraightBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6085.StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6085.StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation._Cast_StraightBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_StraightBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation(self)
