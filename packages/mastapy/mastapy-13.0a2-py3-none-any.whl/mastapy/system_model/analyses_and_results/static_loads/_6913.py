...
from mastapy.system_model.part_model.couplings import _2577, _2578, _2572
...
class ShaftHubConnectionLoadCase(_6814.ConnectorLoadCase):
    """ShaftHubConnectionLoadCase
    ...
    class _Cast_ShaftHubConnectionLoadCase:
        ...
        def __init__(self, parent: 'ShaftHubConnectionLoadCase'):
            self._parent = parent
        ...
        @property
        def shaft_hub_connection_load_case(self) -> 'ShaftHubConnectionLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftHubConnectionLoadCase._Cast_ShaftHubConnectionLoadCase':
