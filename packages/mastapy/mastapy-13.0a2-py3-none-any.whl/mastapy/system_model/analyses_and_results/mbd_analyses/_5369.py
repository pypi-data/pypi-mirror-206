...
class BoltMultibodyDynamicsAnalysis(_5375.ComponentMultibodyDynamicsAnalysis):
    """BoltMultibodyDynamicsAnalysis
    ...
    class _Cast_BoltMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'BoltMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def bolt_multibody_dynamics_analysis(self) -> 'BoltMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltMultibodyDynamicsAnalysis._Cast_BoltMultibodyDynamicsAnalysis':
