...
class StraightBevelGearMeshModalAnalysisAtASpeed(_5105.BevelGearMeshModalAnalysisAtASpeed):
    """StraightBevelGearMeshModalAnalysisAtASpeed
    ...
    class _Cast_StraightBevelGearMeshModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_modal_analysis_at_a_speed(self) -> 'StraightBevelGearMeshModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshModalAnalysisAtASpeed._Cast_StraightBevelGearMeshModalAnalysisAtASpeed':
