...
class CycloidalDiscModalAnalysisAtAStiffness(_4831.AbstractShaftModalAnalysisAtAStiffness):
    """CycloidalDiscModalAnalysisAtAStiffness
    ...
    class _Cast_CycloidalDiscModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'CycloidalDiscModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_modal_analysis_at_a_stiffness(self) -> 'CycloidalDiscModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscModalAnalysisAtAStiffness._Cast_CycloidalDiscModalAnalysisAtAStiffness':
