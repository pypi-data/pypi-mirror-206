...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6313, _6314, _6312
...
class KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis(_6312.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_dynamic_analysis(self) -> 'List[_6313.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_dynamic_analysis(self) -> 'List[_6314.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis]':
