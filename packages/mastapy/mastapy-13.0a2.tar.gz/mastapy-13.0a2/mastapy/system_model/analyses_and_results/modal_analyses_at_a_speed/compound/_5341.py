...
class WormGearCompoundModalAnalysisAtASpeed(_5276.GearCompoundModalAnalysisAtASpeed):
    """WormGearCompoundModalAnalysisAtASpeed
    ...
    class _Cast_WormGearCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'WormGearCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def worm_gear_compound_modal_analysis_at_a_speed(self) -> 'WormGearCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5213.WormGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5213.WormGearModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'WormGearCompoundModalAnalysisAtASpeed._Cast_WormGearCompoundModalAnalysisAtASpeed':
