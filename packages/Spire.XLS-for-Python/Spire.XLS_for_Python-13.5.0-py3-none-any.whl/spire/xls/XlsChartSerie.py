...
class XlsChartSerie (  XlsObject, IChartSerie, INamedObject) :
    ...
    def ChartGroup(self)->int:
        ...
        ret = GetDllLibXls().XlsChartSerie_get_ChartGroup(self.Ptr)
        return ret
    ...
    def Values(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsChartSerie_get_Values(self.Ptr)
    ...
    def Values(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsChartSerie_set_Values(self.Ptr, value.Ptr)
    ...
    def CategoryLabels(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsChartSerie_get_CategoryLabels(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def CategoryLabels(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsChartSerie_set_CategoryLabels(self.Ptr, value.Ptr)
    ...
    def Bubbles(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsChartSerie_get_Bubbles(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def Bubbles(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsChartSerie_set_Bubbles(self.Ptr, value.Ptr)
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().XlsChartSerie_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartSerie_get_Name(self.Ptr)
        return ret
    ...
    def Name(self, value:str):
        ...
        GetDllLibXls().XlsChartSerie_set_Name(self.Ptr, value)
    ...
    def NamedRange(self)->'CellRange':
        ...
        intPtr = GetDllLibXls().XlsChartSerie_get_NamedRange(self.Ptr)
    ...
    def NameOrFormula(self)->str:
        ...
        GetDllLibXls().XlsChartSerie_get_NameOrFormula.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartSerie_get_NameOrFormula(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerie_get_Number(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartSerie_get_ParentSeries(self.Ptr)
    ...
    def UsePrimaryAxis(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerie_get_UsePrimaryAxis(self.Ptr)
        return ret
    ...
    def UsePrimaryAxis(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerie_set_UsePrimaryAxis(self.Ptr, value)

    def HasDroplines(self, value:bool):
        GetDllLibXls().XlsChartSerie_set_HasDroplines.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartSerie_set_HasDroplines(self.Ptr, value)
    ...
    def DataPoints(self)->'IChartDataPoints':
        ...
        intPtr = GetDllLibXls().XlsChartSerie_get_DataPoints(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerie_get_PointNumber(self.Ptr)
        return ret
    ...
    def RealIndex(self)->int:
        ...
        ret = GetDllLibXls().XlsChartSerie_get_RealIndex(self.Ptr)
        return ret

    @RealIndex.setter
    def RealIndex(self, value:int):
        GetDllLibXls().XlsChartSerie_set_RealIndex.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartSerie_set_RealIndex(self.Ptr, value)
    ...
    def Format(self)->'IChartSerieDataFormat':
        ...
        intPtr = GetDllLibXls().XlsChartSerie_get_Format(self.Ptr)
    ...
    def SerieType(self)->'ExcelChartType':
        ...
        ret = GetDllLibXls().XlsChartSerie_get_SerieType(self.Ptr)
    ...
    def SerieType(self, value:'ExcelChartType'):
        ...
        GetDllLibXls().XlsChartSerie_set_SerieType(self.Ptr, value.value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChartSerie_get_StartType.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartSerie_get_StartType(self.Ptr)
        return ret
    ...
    def EnteredDirectlyValues(self)->List['SpireObject']:
        ...
        intPtrArray = GetDllLibXls().XlsChartSerie_get_EnteredDirectlyValues(self.Ptr)
    ...
    def EnteredDirectlyValues(self, value:List['SpireObject']):
        ...
        GetDllLibXls().XlsChartSerie_set_EnteredDirectlyValues(self.Ptr, vArray, vCount)
    ...
    def EnteredDirectlyCategoryLabels(self)->List['SpireObject']:
        ...
        intPtrArray = GetDllLibXls().XlsChartSerie_get_EnteredDirectlyCategoryLabels(self.Ptr)
        ret = GetObjVectorFromArray(intPtrArray, SpireObject)
        return ret
    ...
    def EnteredDirectlyCategoryLabels(self, value:List['SpireObject']):
        ...
        GetDllLibXls().XlsChartSerie_set_EnteredDirectlyCategoryLabels(self.Ptr, vArray, vCount)
    ...
    def EnteredDirectlyBubbles(self)->List['SpireObject']:
        ...
        intPtrArray = GetDllLibXls().XlsChartSerie_get_EnteredDirectlyBubbles(self.Ptr)
    ...
    def EnteredDirectlyBubbles(self, value:List['SpireObject']):
        ...
        GetDllLibXls().XlsChartSerie_set_EnteredDirectlyBubbles(self.Ptr, vArray, vCount)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartSerie_get_ErrorBarsY(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerie_get_HasErrorBarsY(self.Ptr)
        return ret
    ...
    def HasErrorBarsY(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerie_set_HasErrorBarsY(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartSerie_get_ErrorBarsX(self.Ptr)
        ret = None if intPtr==None else IChartErrorBars(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerie_get_HasErrorBarsX(self.Ptr)
        return ret
    ...
    def HasErrorBarsX(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerie_set_HasErrorBarsX(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartSerie_get_TrendLines(self.Ptr)
    ...
    <summary>
        ...
        return GetDllLibXls().XlsChartSerie_get_InvertNegaColor(self.Ptr)
    ...
    def InvertNegaColor(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerie_set_InvertNegaColor(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerie_get_Index(self.Ptr)
        return ret
    ...
    def DataLabels(self)->'IChartDataLabels':
        ...
        intPtr = GetDllLibXls().XlsChartSerie_get_DataLabels(self.Ptr)
    ...
    def ParetoLineFormat(self)->'IChartFrameFormat':
        ...
        intPtr = GetDllLibXls().XlsChartSerie_get_ParetoLineFormat(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsChartSerie_Clone(self.Ptr, intPtrparent,intPtrnewNames,intPtrfontIndexes)
...
#
    ...
    def ErrorBar(self ,bIsY:bool)->IChartErrorBars:
        ...
        intPtr = GetDllLibXls().XlsChartSerie_ErrorBar(self.Ptr, bIsY)
        ret = None if intPtr==None else IChartErrorBars(intPtr)
        return ret
    ...
    def ErrorBar(self ,bIsY:bool,include:ErrorBarIncludeType)->IChartErrorBars:
        ...
        intPtr = GetDllLibXls().XlsChartSerie_ErrorBarBI(self.Ptr, bIsY,enuminclude)
        ret = None if intPtr==None else IChartErrorBars(intPtr)
        return ret
    ...
    def ErrorBar(self ,bIsY:bool,include:ErrorBarIncludeType,type:ErrorBarType)->IChartErrorBars:
        ...
        intPtr = GetDllLibXls().XlsChartSerie_ErrorBarBIT(self.Ptr, bIsY,enuminclude,enumtype)
        ret = None if intPtr==None else IChartErrorBars(intPtr)
        return ret
    ...
    def ErrorBar(self ,bIsY:bool,include:ErrorBarIncludeType,type:ErrorBarType,numberValue:float)->IChartErrorBars:
        ...
        intPtr = GetDllLibXls().XlsChartSerie_ErrorBarBITN(self.Ptr, bIsY,enuminclude,enumtype,numberValue)
        ret = None if intPtr==None else IChartErrorBars(intPtr)
        return ret
    ...
    def ErrorBar(self ,bIsY:bool,plusRange:IXLSRange,minusRange:IXLSRange)->IChartErrorBars:
        ...
        intPtr = GetDllLibXls().XlsChartSerie_ErrorBarBPM(self.Ptr, bIsY,intPtrplusRange,intPtrminusRange)
        ret = None if intPtr==None else IChartErrorBars(intPtr)
        return ret
    ...
    <returns>Returns common serie format.</returns>
        ...
        intPtr = GetDllLibXls().XlsChartSerie_GetCommonSerieFormat(self.Ptr)
    ...
    def GetSerieNameRange(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsChartSerie_GetSerieNameRange(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def SetDefaultName(self ,defaultName:str):
        ...
        GetDllLibXls().XlsChartSerie_SetDefaultName(self.Ptr, defaultName)
