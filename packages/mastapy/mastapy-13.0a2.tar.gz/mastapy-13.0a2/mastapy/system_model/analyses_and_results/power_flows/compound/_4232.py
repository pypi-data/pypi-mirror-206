...
class RingPinsToDiscConnectionCompoundPowerFlow(_4207.InterMountableComponentConnectionCompoundPowerFlow):
    """RingPinsToDiscConnectionCompoundPowerFlow
    ...
    class _Cast_RingPinsToDiscConnectionCompoundPowerFlow:
        ...
        def __init__(self, parent: 'RingPinsToDiscConnectionCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def ring_pins_to_disc_connection_compound_power_flow(self) -> 'RingPinsToDiscConnectionCompoundPowerFlow':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4102.RingPinsToDiscConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4102.RingPinsToDiscConnectionPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'RingPinsToDiscConnectionCompoundPowerFlow._Cast_RingPinsToDiscConnectionCompoundPowerFlow':
