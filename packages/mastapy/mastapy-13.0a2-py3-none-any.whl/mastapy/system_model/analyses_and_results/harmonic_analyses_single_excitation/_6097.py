...
class UnbalancedMassHarmonicAnalysisOfSingleExcitation(_6098.VirtualComponentHarmonicAnalysisOfSingleExcitation):
    """UnbalancedMassHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_UnbalancedMassHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'UnbalancedMassHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_harmonic_analysis_of_single_excitation(self) -> 'UnbalancedMassHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassHarmonicAnalysisOfSingleExcitation._Cast_UnbalancedMassHarmonicAnalysisOfSingleExcitation':
