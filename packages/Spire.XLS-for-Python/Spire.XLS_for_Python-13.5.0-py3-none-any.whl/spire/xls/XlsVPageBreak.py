...
class XlsVPageBreak (  XlsObject) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsVPageBreak_get_Type(self.Ptr)
    ...
    def Type(self, value:'PageBreakType'):
        ...
        GetDllLibXls().XlsVPageBreak_set_Type(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsVPageBreak_get_Column(self.Ptr)
        return ret

    @Column.setter
    def Column(self, value:int):
        GetDllLibXls().XlsVPageBreak_set_Column.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsVPageBreak_set_Column(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsVPageBreak_get_StartRow(self.Ptr)
        return ret

    @StartRow.setter
    def StartRow(self, value:int):
        GetDllLibXls().XlsVPageBreak_set_StartRow.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsVPageBreak_set_StartRow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsVPageBreak_get_EndRow(self.Ptr)
        return ret

    @EndRow.setter
    def EndRow(self, value:int):
        GetDllLibXls().XlsVPageBreak_set_EndRow.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsVPageBreak_set_EndRow(self.Ptr, value)
    ...
    def Clone(self ,parent:'SpireObject')->'XlsVPageBreak':
        ...
        intPtr = GetDllLibXls().XlsVPageBreak_Clone(self.Ptr, intPtrparent)
