...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3642, _3643, _3673
...
class ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3673.GearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3513.ConceptGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_gears_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3642.ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_meshes_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3643.ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3513.ConceptGearSetSteadyStateSynchronousResponseAtASpeed]':
