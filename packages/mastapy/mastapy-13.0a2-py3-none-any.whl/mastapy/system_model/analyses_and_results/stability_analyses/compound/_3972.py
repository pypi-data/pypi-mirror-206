...
class SpecialisedAssemblyCompoundStabilityAnalysis(_3874.AbstractAssemblyCompoundStabilityAnalysis):
    """SpecialisedAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3841.SpecialisedAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3841.SpecialisedAssemblyStabilityAnalysis]':
