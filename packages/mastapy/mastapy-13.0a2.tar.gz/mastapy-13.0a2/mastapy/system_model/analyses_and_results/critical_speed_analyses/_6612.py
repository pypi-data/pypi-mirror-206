...
class SpringDamperConnectionCriticalSpeedAnalysis(_6545.CouplingConnectionCriticalSpeedAnalysis):
    """SpringDamperConnectionCriticalSpeedAnalysis
    ...
    class _Cast_SpringDamperConnectionCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'SpringDamperConnectionCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_critical_speed_analysis(self) -> 'SpringDamperConnectionCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionCriticalSpeedAnalysis._Cast_SpringDamperConnectionCriticalSpeedAnalysis':
