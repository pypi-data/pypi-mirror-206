...
class FEMeshingProblem(_0.APIBase):
    ...
    class _Cast_FEMeshingProblem:
        ...
        def __init__(self, parent: 'FEMeshingProblem'):
            self._parent = parent

        @property
        def fe_meshing_problem(self) -> 'FEMeshingProblem':
            return self._parent
    ...
    def type_(self) -> '_63.FEMeshingProblems':
        ...
        value = conversion.pn_to_mp_enum(temp, _63.FEMeshingProblems)
    ...
    @property
    def cast_to(self) -> 'FEMeshingProblem._Cast_FEMeshingProblem':
