...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5404, _5403, _5411
...
class FaceGearSetMultibodyDynamicsAnalysis(_5411.GearSetMultibodyDynamicsAnalysis):
    """FaceGearSetMultibodyDynamicsAnalysis
    ...
    class _Cast_FaceGearSetMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'FaceGearSetMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def face_gear_set_multibody_dynamics_analysis(self) -> 'FaceGearSetMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def gears(self) -> 'List[_5404.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gears_multibody_dynamics_analysis(self) -> 'List[_5404.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_meshes_multibody_dynamics_analysis(self) -> 'List[_5403.FaceGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'FaceGearSetMultibodyDynamicsAnalysis._Cast_FaceGearSetMultibodyDynamicsAnalysis':
