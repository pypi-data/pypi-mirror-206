...
class SpecifiedConcentricPartGroupDrawingOrder(_0.APIBase):
    ...
    class _Cast_SpecifiedConcentricPartGroupDrawingOrder:
        ...
        def __init__(self, parent: 'SpecifiedConcentricPartGroupDrawingOrder'):
            self._parent = parent

        @property
        def specified_concentric_part_group_drawing_order(self) -> 'SpecifiedConcentricPartGroupDrawingOrder':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpecifiedConcentricPartGroupDrawingOrder._Cast_SpecifiedConcentricPartGroupDrawingOrder':
