...
class ClutchHalfCriticalSpeedAnalysis(_6547.CouplingHalfCriticalSpeedAnalysis):
    """ClutchHalfCriticalSpeedAnalysis
    ...
    class _Cast_ClutchHalfCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ClutchHalfCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_half_critical_speed_analysis(self) -> 'ClutchHalfCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchHalfCriticalSpeedAnalysis._Cast_ClutchHalfCriticalSpeedAnalysis':
