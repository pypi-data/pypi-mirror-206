...
class SpiralBevelGearCompoundSystemDeflection(_2846.BevelGearCompoundSystemDeflection):
    """SpiralBevelGearCompoundSystemDeflection
    ...
    class _Cast_SpiralBevelGearCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'SpiralBevelGearCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_compound_system_deflection(self) -> 'SpiralBevelGearCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2788.SpiralBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2788.SpiralBevelGearSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearCompoundSystemDeflection._Cast_SpiralBevelGearCompoundSystemDeflection':
