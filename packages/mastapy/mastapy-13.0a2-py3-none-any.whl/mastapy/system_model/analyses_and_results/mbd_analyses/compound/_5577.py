...
class OilSealCompoundMultibodyDynamicsAnalysis(_5535.ConnectorCompoundMultibodyDynamicsAnalysis):
    """OilSealCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_OilSealCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'OilSealCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def oil_seal_compound_multibody_dynamics_analysis(self) -> 'OilSealCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5436.OilSealMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5436.OilSealMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'OilSealCompoundMultibodyDynamicsAnalysis._Cast_OilSealCompoundMultibodyDynamicsAnalysis':
