...
class ColorFilter (SpireObject) :
    ...
    def FilterByFillColor(self)->bool:
        ...
        ret = GetDllLibXls().ColorFilter_get_FilterByFillColor(self.Ptr)
        return ret
    ...
    def FilterByFillColor(self, value:bool):
        ...
        GetDllLibXls().ColorFilter_set_FilterByFillColor(self.Ptr, value)
    ...
    def Value(self)->'Color':
        ...
        intPtr = GetDllLibXls().ColorFilter_get_Value(self.Ptr)
    ...
    def Value(self, value:'Color'):
        ...
        GetDllLibXls().ColorFilter_set_Value(self.Ptr, value.Ptr)
