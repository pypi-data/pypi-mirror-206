...
class StraightBevelGearCompoundModalAnalysisAtAStiffness(_4976.BevelGearCompoundModalAnalysisAtAStiffness):
    """StraightBevelGearCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_StraightBevelGearCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'StraightBevelGearCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_compound_modal_analysis_at_a_stiffness(self) -> 'StraightBevelGearCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4940.StraightBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4940.StraightBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearCompoundModalAnalysisAtAStiffness._Cast_StraightBevelGearCompoundModalAnalysisAtAStiffness':
