...
class MassDiscSteadyStateSynchronousResponseOnAShaft(_3347.VirtualComponentSteadyStateSynchronousResponseOnAShaft):
    """MassDiscSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_MassDiscSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'MassDiscSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def mass_disc_steady_state_synchronous_response_on_a_shaft(self) -> 'MassDiscSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MassDiscSteadyStateSynchronousResponseOnAShaft._Cast_MassDiscSteadyStateSynchronousResponseOnAShaft':
