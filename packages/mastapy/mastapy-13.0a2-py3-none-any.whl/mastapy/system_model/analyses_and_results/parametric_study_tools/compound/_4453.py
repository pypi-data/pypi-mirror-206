...
class ConnectionCompoundParametricStudyTool(_7501.ConnectionCompoundAnalysis):
    """ConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4306.ConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4306.ConnectionParametricStudyTool]':
