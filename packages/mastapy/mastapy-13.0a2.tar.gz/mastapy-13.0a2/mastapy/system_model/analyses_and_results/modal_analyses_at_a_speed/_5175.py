...
class PointLoadModalAnalysisAtASpeed(_5211.VirtualComponentModalAnalysisAtASpeed):
    """PointLoadModalAnalysisAtASpeed
    ...
    class _Cast_PointLoadModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'PointLoadModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def point_load_modal_analysis_at_a_speed(self) -> 'PointLoadModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PointLoadModalAnalysisAtASpeed._Cast_PointLoadModalAnalysisAtASpeed':
