...
class ConicalGearSetCompoundModalAnalysisAtAStiffness(_5020.GearSetCompoundModalAnalysisAtAStiffness):
    """ConicalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4864.ConicalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4864.ConicalGearSetModalAnalysisAtAStiffness]':
