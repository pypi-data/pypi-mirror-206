...
class SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed(_3728.SynchroniserPartCompoundSteadyStateSynchronousResponseAtASpeed):
    """SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def synchroniser_sleeve_compound_steady_state_synchronous_response_at_a_speed(self) -> 'SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3599.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3599.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed._Cast_SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed(self)
