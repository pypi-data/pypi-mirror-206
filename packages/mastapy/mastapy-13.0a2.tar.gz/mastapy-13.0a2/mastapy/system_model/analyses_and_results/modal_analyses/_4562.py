...
class BevelDifferentialSunGearModalAnalysis(_4559.BevelDifferentialGearModalAnalysis):
    """BevelDifferentialSunGearModalAnalysis
    ...
    class _Cast_BevelDifferentialSunGearModalAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialSunGearModalAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_sun_gear_modal_analysis(self) -> 'BevelDifferentialSunGearModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialSunGearModalAnalysis._Cast_BevelDifferentialSunGearModalAnalysis':
