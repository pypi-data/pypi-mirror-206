...
class FEPartCompoundParametricStudyTool(_4420.AbstractShaftOrHousingCompoundParametricStudyTool):
    """FEPartCompoundParametricStudyTool
    ...
    class _Cast_FEPartCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'FEPartCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def fe_part_compound_parametric_study_tool(self) -> 'FEPartCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4334.FEPartParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4334.FEPartParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'FEPartCompoundParametricStudyTool._Cast_FEPartCompoundParametricStudyTool':
