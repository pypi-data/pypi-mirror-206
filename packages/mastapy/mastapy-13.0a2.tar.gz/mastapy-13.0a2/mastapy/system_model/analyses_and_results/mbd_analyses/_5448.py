...
class RingPinsToDiscConnectionMultibodyDynamicsAnalysis(_5420.InterMountableComponentConnectionMultibodyDynamicsAnalysis):
    """RingPinsToDiscConnectionMultibodyDynamicsAnalysis
    ...
    class _Cast_RingPinsToDiscConnectionMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'RingPinsToDiscConnectionMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def ring_pins_to_disc_connection_multibody_dynamics_analysis(self) -> 'RingPinsToDiscConnectionMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RingPinsToDiscConnectionMultibodyDynamicsAnalysis._Cast_RingPinsToDiscConnectionMultibodyDynamicsAnalysis':
