...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5857, _5858, _5864
...
class BevelDifferentialGearSetCompoundHarmonicAnalysis(_5864.BevelGearSetCompoundHarmonicAnalysis):
    """BevelDifferentialGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5662.BevelDifferentialGearSetHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_harmonic_analysis(self) -> 'List[_5857.BevelDifferentialGearCompoundHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_harmonic_analysis(self) -> 'List[_5858.BevelDifferentialGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5662.BevelDifferentialGearSetHarmonicAnalysis]':
