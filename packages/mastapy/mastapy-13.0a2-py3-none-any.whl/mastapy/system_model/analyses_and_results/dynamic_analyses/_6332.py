...
class PulleyDynamicAnalysis(_6282.CouplingHalfDynamicAnalysis):
    """PulleyDynamicAnalysis
    ...
    class _Cast_PulleyDynamicAnalysis:
        ...
        def __init__(self, parent: 'PulleyDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def pulley_dynamic_analysis(self) -> 'PulleyDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PulleyDynamicAnalysis._Cast_PulleyDynamicAnalysis':
