...
class SpringDamperHalfModalAnalysisAtAStiffness(_4868.CouplingHalfModalAnalysisAtAStiffness):
    """SpringDamperHalfModalAnalysisAtAStiffness
    ...
    class _Cast_SpringDamperHalfModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'SpringDamperHalfModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def spring_damper_half_modal_analysis_at_a_stiffness(self) -> 'SpringDamperHalfModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperHalfModalAnalysisAtAStiffness._Cast_SpringDamperHalfModalAnalysisAtAStiffness':
