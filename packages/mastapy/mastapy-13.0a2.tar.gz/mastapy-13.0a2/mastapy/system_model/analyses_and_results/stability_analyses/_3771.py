...
class ConceptGearMeshStabilityAnalysis(_3801.GearMeshStabilityAnalysis):
    """ConceptGearMeshStabilityAnalysis
    ...
    class _Cast_ConceptGearMeshStabilityAnalysis:
        ...
        def __init__(self, parent: 'ConceptGearMeshStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_gear_mesh_stability_analysis(self) -> 'ConceptGearMeshStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptGearMeshStabilityAnalysis._Cast_ConceptGearMeshStabilityAnalysis':
