...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5491, _5490, _5367
...
class ZerolBevelGearSetMultibodyDynamicsAnalysis(_5367.BevelGearSetMultibodyDynamicsAnalysis):
    """ZerolBevelGearSetMultibodyDynamicsAnalysis
    ...
    class _Cast_ZerolBevelGearSetMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_multibody_dynamics_analysis(self) -> 'ZerolBevelGearSetMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def gears(self) -> 'List[_5491.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gears_multibody_dynamics_analysis(self) -> 'List[_5491.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_multibody_dynamics_analysis(self) -> 'List[_5490.ZerolBevelGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetMultibodyDynamicsAnalysis._Cast_ZerolBevelGearSetMultibodyDynamicsAnalysis':
