...
class PulleyCompoundSystemDeflection(_2869.CouplingHalfCompoundSystemDeflection):
    """PulleyCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2772.PulleySystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2772.PulleySystemDeflection]':
