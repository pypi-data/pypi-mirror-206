...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5820
...
class ResultLocationSelectionGroup(_0.APIBase):
    ...
    class _Cast_ResultLocationSelectionGroup:
        ...
        def __init__(self, parent: 'ResultLocationSelectionGroup'):
            self._parent = parent

        @property
        def result_location_selection_group(self) -> 'ResultLocationSelectionGroup':
            return self._parent
    ...
    @property
    def response_locations(self) -> 'List[_5820.ResultNodeSelection]':
    ...
    @property
    def cast_to(self) -> 'ResultLocationSelectionGroup._Cast_ResultLocationSelectionGroup':
