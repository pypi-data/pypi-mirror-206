...
from mastapy.system_model.part_model import _2429, _2461, _2459
...
class PowerLoad(_2459.VirtualComponent):
    """PowerLoad
    ...
    @property
    def electric_machine_search_region_specification_method(self) -> '_2429.ElectricMachineSearchRegionSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _2429.ElectricMachineSearchRegionSpecificationMethod)
        return constructor.new_from_mastapy_type(_2429.ElectricMachineSearchRegionSpecificationMethod)(value) if value is not None else None

    @electric_machine_search_region_specification_method.setter
    def electric_machine_search_region_specification_method(self, value: '_2429.ElectricMachineSearchRegionSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2429.ElectricMachineSearchRegionSpecificationMethod.type_())
        self.wrapped.ElectricMachineSearchRegionSpecificationMethod = value

    @property
    def engine_fuel_consumption_grid(self) -> '_1554.GriddedSurfaceAccessor':
    ...
    def engine_fuel_consumption_grid(self, value: '_1554.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
        self.wrapped.EngineFuelConsumptionGrid = value

    @property
    def engine_torque_grid(self) -> '_1554.GriddedSurfaceAccessor':
    ...
    def engine_torque_grid(self, value: '_1554.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def oil_pump_detail(self) -> '_294.OilPumpDetail':
    ...
    @property
    def single_blade_details(self) -> '_2461.WindTurbineSingleBladeDetails':
