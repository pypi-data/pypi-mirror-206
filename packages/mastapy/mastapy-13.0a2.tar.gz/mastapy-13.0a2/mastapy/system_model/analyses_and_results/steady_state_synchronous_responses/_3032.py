...
class KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse(_3029.KlingelnbergCycloPalloidConicalGearMeshSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_mesh_steady_state_synchronous_response(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse._Cast_KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse(self)
