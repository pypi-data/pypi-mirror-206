...
class NameSchema(schemas.StrBase, schemas.NoneBase, schemas.Schema, schemas.NoneStrMixin):
    def __new__(
        cls,
        *_args: typing.Union[
            None,
...
class FeaturedSchema(schemas.BoolBase, schemas.NoneBase, schemas.Schema, schemas.NoneBoolMixin):
    def __new__(
        cls,
        *_args: typing.Union[
            None,
...
class CursorSchema(schemas.StrBase, schemas.NoneBase, schemas.Schema, schemas.NoneStrMixin):
    def __new__(
        cls,
        *_args: typing.Union[
            None,
...
class LimitSchema(schemas.IntSchema):
    class MetaOapg:
...
SchemaFor200ResponseBodyApplicationJson = GetInstitutionsResponse
...
class GetInstitutions(BaseApi):
    ...
    def get_institutions(
        ...
        return self._get_institutions_oapg(
