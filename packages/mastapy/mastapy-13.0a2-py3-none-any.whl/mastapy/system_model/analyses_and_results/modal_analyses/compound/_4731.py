...
class ConceptGearMeshCompoundModalAnalysis(_4760.GearMeshCompoundModalAnalysis):
    """ConceptGearMeshCompoundModalAnalysis
    ...
    class _Cast_ConceptGearMeshCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'ConceptGearMeshCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_gear_mesh_compound_modal_analysis(self) -> 'ConceptGearMeshCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4576.ConceptGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4576.ConceptGearMeshModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ConceptGearMeshCompoundModalAnalysis._Cast_ConceptGearMeshCompoundModalAnalysis':
