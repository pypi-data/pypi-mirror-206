...
class WormGearModalAnalysis(_4610.GearModalAnalysis):
    """WormGearModalAnalysis
    ...
    class _Cast_WormGearModalAnalysis:
        ...
        def __init__(self, parent: 'WormGearModalAnalysis'):
            self._parent = parent
        ...
        @property
        def worm_gear_modal_analysis(self) -> 'WormGearModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearModalAnalysis._Cast_WormGearModalAnalysis':
