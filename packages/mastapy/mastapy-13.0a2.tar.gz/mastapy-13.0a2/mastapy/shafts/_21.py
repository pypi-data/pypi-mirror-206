...
class ShaftFeature(_0.APIBase):
    ...
    class _Cast_ShaftFeature:
        ...
        def __init__(self, parent: 'ShaftFeature'):
            self._parent = parent

        @property
        def generic_stress_concentration_factor(self):
            from mastapy.shafts import _14
            
            return self._parent._cast(_14.GenericStressConcentrationFactor)

        @property
        def shaft_groove(self):
    ...
    @property
    def cast_to(self) -> 'ShaftFeature._Cast_ShaftFeature':
