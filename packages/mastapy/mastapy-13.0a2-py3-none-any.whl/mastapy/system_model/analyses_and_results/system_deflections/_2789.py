...
class SpringDamperConnectionSystemDeflection(_2708.CouplingConnectionSystemDeflection):
    """SpringDamperConnectionSystemDeflection
    ...
    class _Cast_SpringDamperConnectionSystemDeflection:
        ...
        def __init__(self, parent: 'SpringDamperConnectionSystemDeflection'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_system_deflection(self) -> 'SpringDamperConnectionSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4114.SpringDamperConnectionPowerFlow':
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionSystemDeflection._Cast_SpringDamperConnectionSystemDeflection':
