...
class FaceGearMeshAdvancedSystemDeflection(_7296.GearMeshAdvancedSystemDeflection):
    """FaceGearMeshAdvancedSystemDeflection
    ...
    class _Cast_FaceGearMeshAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'FaceGearMeshAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def face_gear_mesh_advanced_system_deflection(self) -> 'FaceGearMeshAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2733.FaceGearMeshSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'FaceGearMeshAdvancedSystemDeflection._Cast_FaceGearMeshAdvancedSystemDeflection':
