...
class ConceptCouplingConnectionCompoundPowerFlow(_4180.CouplingConnectionCompoundPowerFlow):
    """ConceptCouplingConnectionCompoundPowerFlow
    ...
    class _Cast_ConceptCouplingConnectionCompoundPowerFlow:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_compound_power_flow(self) -> 'ConceptCouplingConnectionCompoundPowerFlow':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4035.ConceptCouplingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4035.ConceptCouplingConnectionPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionCompoundPowerFlow._Cast_ConceptCouplingConnectionCompoundPowerFlow':
