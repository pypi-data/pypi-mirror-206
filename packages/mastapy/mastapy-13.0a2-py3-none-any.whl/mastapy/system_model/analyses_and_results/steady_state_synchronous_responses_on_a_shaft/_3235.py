...
class BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft(_3240.BevelGearMeshSteadyStateSynchronousResponseOnAShaft):
    """BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_steady_state_synchronous_response_on_a_shaft(self) -> 'BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft._Cast_BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft(self)
