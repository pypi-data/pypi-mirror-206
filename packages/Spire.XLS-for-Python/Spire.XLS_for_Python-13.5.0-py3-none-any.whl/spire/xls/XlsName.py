...
class XlsName (  XlsObject, INamedRange, IXLSRange) :
    ...
    def Comment(self)->'ICommentShape':
        ...
        intPtr = GetDllLibXls().XlsName_get_Comment(self.Ptr)
    ...
    def RichText(self)->'IRichTextString':
        ...
        intPtr = GetDllLibXls().XlsName_get_RichText(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsName_get_HtmlString.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_HtmlString(self.Ptr)
        return ret
    ...
    def HtmlString(self, value:str):
        ...
        GetDllLibXls().XlsName_set_HtmlString(self.Ptr, value)
    ...
    def HasMerged(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasMerged(self.Ptr)
        return ret
    ...
    def MergeArea(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsName_get_MergeArea(self.Ptr)
    ...
    def IsWrapText(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_IsWrapText(self.Ptr)
        return ret

    @IsWrapText.setter
    def IsWrapText(self, value:bool):
        GetDllLibXls().XlsName_set_IsWrapText.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsName_set_IsWrapText(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsName_get_HasExternalFormula(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsName_get_IgnoreErrorOptions(self.Ptr)
    ...
    def IgnoreErrorOptions(self, value:'IgnoreErrorType'):
        ...
        GetDllLibXls().XlsName_set_IgnoreErrorOptions(self.Ptr, value.value)
    ...
    <summary>
        ...
        return GetDllLibXls().XlsName_get_IsStringsPreserved(self.Ptr)
    ...
    def IsStringsPreserved(self, value:bool):
        ...
        GetDllLibXls().XlsName_set_IsStringsPreserved(self.Ptr, value)
    ...
    def BuiltInStyle(self)->BuiltInStyles:
        ...
        intPtr = GetDllLibXls().XlsName_get_BuiltInStyle(self.Ptr)
    ...
    def BuiltInStyle(self, value:BuiltInStyles):
        ...
        GetDllLibXls().XlsName_set_BuiltInStyle(self.Ptr, value.value)
    ...
    def Hyperlinks(self)->'IHyperLinks':
        ...
        intPtr = GetDllLibXls().XlsName_get_Hyperlinks(self.Ptr)
    ...
    def Activate(self ,scroll:bool)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsName_Activate(self.Ptr, scroll)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def Merge(self):
        ...
        GetDllLibXls().XlsName_Merge(self.Ptr)
    ...
    def Merge(self ,clearCells:bool):
        ...
        GetDllLibXls().XlsName_MergeC(self.Ptr, clearCells)
    ...
    def UnMerge(self):
        ...
        GetDllLibXls().XlsName_UnMerge(self.Ptr)
    ...
    def FreezePanes(self):
        ...
        GetDllLibXls().XlsName_FreezePanes(self.Ptr)
    ...
    def ClearContents(self):
        ...
        GetDllLibXls().XlsName_ClearContents(self.Ptr)
    ...
    def Clear(self ,option:ExcelClearOptions):
        ...
        GetDllLibXls().XlsName_Clear(self.Ptr, enumoption)
    ...
    def Clear(self ,isClearFormat:bool):
        ...
        GetDllLibXls().XlsName_ClearI(self.Ptr, isClearFormat)
    ...
    def Intersect(self ,range:'IXLSRange')->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsName_Intersect(self.Ptr, intPtrrange)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def Merge(self ,range:IXLSRange)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsName_MergeR(self.Ptr, intPtrrange)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def AutoFitRows(self):
        ...
        GetDllLibXls().XlsName_AutoFitRows(self.Ptr)
    ...
    def AutoFitColumns(self):
        ...
        GetDllLibXls().XlsName_AutoFitColumns(self.Ptr)
    ...
    def AddComment(self)->'ICommentShape':
        ...
        intPtr = GetDllLibXls().XlsName_AddComment(self.Ptr)
        ret = None if intPtr==None else XlsComment(intPtr)
        return ret
    ...
    def BorderAround(self):
        ...
        GetDllLibXls().XlsName_BorderAround(self.Ptr)
    ...
    def BorderAround(self ,borderLine:LineStyleType):
        ...
        GetDllLibXls().XlsName_BorderAroundB(self.Ptr, enumborderLine)
    ...
    def BorderAround(self ,borderLine:LineStyleType,borderColor:Color):
        ...
        GetDllLibXls().XlsName_BorderAroundBB(self.Ptr, enumborderLine,intPtrborderColor)
    ...
    def BorderAround(self ,borderLine:LineStyleType,borderColor:ExcelColors):
        ...
        GetDllLibXls().XlsName_BorderAroundBB1(self.Ptr, enumborderLine,enumborderColor)
    ...
    def BorderInside(self):
        ...
        GetDllLibXls().XlsName_BorderInside(self.Ptr)
    ...
    def BorderInside(self ,borderLine:LineStyleType):
        ...
        GetDllLibXls().XlsName_BorderInsideB(self.Ptr, enumborderLine)
    ...
    def BorderInside(self ,borderLine:LineStyleType,borderColor:Color):
        ...
        GetDllLibXls().XlsName_BorderInsideBB(self.Ptr, enumborderLine,intPtrborderColor)
    ...
    def BorderInside(self ,borderLine:LineStyleType,borderColor:ExcelColors):
        ...
        GetDllLibXls().XlsName_BorderInsideBB1(self.Ptr, enumborderLine,enumborderColor)
    ...
    def BorderNone(self):
        ...
        GetDllLibXls().XlsName_BorderNone(self.Ptr)
    ...
    def CollapseGroup(self ,groupBy:'GroupByType'):
        ...
        GetDllLibXls().XlsName_CollapseGroup(self.Ptr, enumgroupBy)
    ...
    def ExpandGroup(self ,groupBy:GroupByType):
        ...
        GetDllLibXls().XlsName_ExpandGroup(self.Ptr, enumgroupBy)
    ...
    def ExpandGroup(self ,groupBy:GroupByType,flags:ExpandCollapseFlags):
        ...
        GetDllLibXls().XlsName_ExpandGroupGF(self.Ptr, enumgroupBy,enumflags)
    ...
    def GetEnumerator(self)->'IEnumerator':
        ...
        intPtr = GetDllLibXls().XlsName_GetEnumerator(self.Ptr)
    ...
    def Activate(self)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsName_Activate1(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def Clone(self ,parent:SpireObject)->SpireObject:
        ...
        intPtr = GetDllLibXls().XlsName_Clone(self.Ptr, intPtrparent)
...
#        intPtr = GetDllLibXls().XlsName_ClonePHB(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrbook)
#        ret = None if intPtr==None else XlsRange(intPtr)
#        return ret
#
    ...
    def ConvertFullRowColumnName(self ,version:'ExcelVersion'):
        ...
        GetDllLibXls().XlsName_ConvertFullRowColumnName(self.Ptr, enumversion)
    ...
    def CopyTo(self ,destination:'IXLSRange')->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsName_CopyTo(self.Ptr, intPtrdestination)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
...
#        intPtr = GetDllLibXls().XlsName_FindAll(self.Ptr, intPtrfindValue)
...
#        intPtr = GetDllLibXls().XlsName_FindAllF(self.Ptr, intPtrfindValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().XlsName_FindAllF1(self.Ptr, findValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().XlsName_FindAllFF(self.Ptr, findValue,enumflags)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().XlsName_FindAllFF1(self.Ptr, findValue,enumflags)
...
#
    ...
    def FindFirst(self ,findValue:TimeSpan)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsName_FindFirst(self.Ptr, intPtrfindValue)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def FindFirst(self ,findValue:DateTime)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsName_FindFirstF(self.Ptr, intPtrfindValue)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def FindFirst(self ,findValue:bool)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsName_FindFirstF1(self.Ptr, findValue)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def FindFirst(self ,findValue:float,flags:FindType)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsName_FindFirstFF(self.Ptr, findValue,enumflags)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def FindFirst(self ,findValue:str,flags:FindType)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsName_FindFirstFF1(self.Ptr, findValue,enumflags)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def SetIndex(self ,index:int):
        ...
        GetDllLibXls().XlsName_SetIndex(self.Ptr, index)
    ...
    def SetIndex(self ,index:int,bRaiseEvent:bool):
        ...
        GetDllLibXls().XlsName_SetIndexIB(self.Ptr, index,bRaiseEvent)
...
#        intPtr = GetDllLibXls().XlsName_ExportDataTable(self.Ptr, intPtroptions)
...
#
    ...
    def Index(self)->int:
        ...
        ret = GetDllLibXls().XlsName_get_Index(self.Ptr)
        return ret
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().XlsName_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_Name(self.Ptr)
        return ret
    ...
    def Name(self, value:str):
        ...
        GetDllLibXls().XlsName_set_Name(self.Ptr, value)
    ...
    def NameLocal(self)->str:
        ...
        GetDllLibXls().XlsName_get_NameLocal.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_NameLocal(self.Ptr)
        return ret
    ...
    def NameLocal(self, value:str):
        ...
        GetDllLibXls().XlsName_set_NameLocal(self.Ptr, value)
    ...
    def RefersToRange(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsName_get_RefersToRange(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def RefersToRange(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsName_set_RefersToRange(self.Ptr, value.Ptr)
    ...
    def Value(self)->str:
        ...
        GetDllLibXls().XlsName_get_Value.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_Value(self.Ptr)
        return ret
    ...
    def Value(self, value:str):
        ...
        GetDllLibXls().XlsName_set_Value(self.Ptr, value)
    ...
    def Visible(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_Visible(self.Ptr)
        return ret

    @Visible.setter
    def Visible(self, value:bool):
        GetDllLibXls().XlsName_set_Visible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsName_set_Visible(self.Ptr, value)
    ...
    def IsLocal(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_IsLocal(self.Ptr)
        return ret
    ...
    def ValueR1C1(self)->str:
        ...
        GetDllLibXls().XlsName_get_ValueR1C1.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_ValueR1C1(self.Ptr)
        return ret
    ...
    def Worksheet(self)->'IWorksheet':
        ...
        intPtr = GetDllLibXls().XlsName_get_Worksheet(self.Ptr)
    ...
    def Scope(self)->str:
        ...
        GetDllLibXls().XlsName_get_Scope.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_Scope(self.Ptr)
        return ret
    ...
    def Delete(self):
        ...
        GetDllLibXls().XlsName_Delete(self.Ptr)
    ...
    def RangeAddress(self)->str:
        ...
        GetDllLibXls().XlsName_get_RangeAddress.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_RangeAddress(self.Ptr)
        return ret
    ...
    def RangeAddressLocal(self)->str:
        ...
        GetDllLibXls().XlsName_get_RangeAddressLocal.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_RangeAddressLocal(self.Ptr)
        return ret
    ...
    def RangeGlobalAddress(self)->str:
        ...
        GetDllLibXls().XlsName_get_RangeGlobalAddress.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_RangeGlobalAddress(self.Ptr)
        return ret
    ...
    def RangeGlobalAddress2007(self)->str:
        ...
        GetDllLibXls().XlsName_get_RangeGlobalAddress2007.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_RangeGlobalAddress2007(self.Ptr)
        return ret
    ...
    def RangeR1C1Address(self)->str:
        ...
        GetDllLibXls().XlsName_get_RangeR1C1Address.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_RangeR1C1Address(self.Ptr)
        return ret
    ...
    def RangeR1C1AddressLocal(self)->str:
        ...
        GetDllLibXls().XlsName_get_RangeR1C1AddressLocal.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_RangeR1C1AddressLocal(self.Ptr)
        return ret
    ...
    def BooleanValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_BooleanValue(self.Ptr)
        return ret

    @BooleanValue.setter
    def BooleanValue(self, value:bool):
        GetDllLibXls().XlsName_set_BooleanValue.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsName_set_BooleanValue(self.Ptr, value)
    ...
    def Borders(self)->'IBorders':
        ...
        intPtr = GetDllLibXls().XlsName_get_Borders(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsName_get_Cells(self.Ptr)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().XlsName_get_CellList(self.Ptr)
#        ret = None if intPtr==None else List1(intPtr)
#        return ret
#
    ...
    def Column(self)->int:
        ...
        ret = GetDllLibXls().XlsName_get_Column(self.Ptr)
        return ret
    ...
    def ColumnGroupLevel(self)->int:
        ...
        ret = GetDllLibXls().XlsName_get_ColumnGroupLevel(self.Ptr)
        return ret
    ...
    def ColumnWidth(self)->float:
        ...
        ret = GetDllLibXls().XlsName_get_ColumnWidth(self.Ptr)
        return ret

    @ColumnWidth.setter
    def ColumnWidth(self, value:float):
        GetDllLibXls().XlsName_set_ColumnWidth.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsName_set_ColumnWidth(self.Ptr, value)
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().XlsName_get_Count(self.Ptr)
        return ret
    ...
    def DateTimeValue(self)->'DateTime':
        ...
        intPtr = GetDllLibXls().XlsName_get_DateTimeValue(self.Ptr)
    ...
    def DateTimeValue(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsName_set_DateTimeValue(self.Ptr, value.Ptr)
    ...
    def NumberText(self)->str:
        ...
        GetDllLibXls().XlsName_get_NumberText.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_NumberText(self.Ptr)
        return ret
    ...
    def EndCell(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsName_get_EndCell(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def EntireColumn(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsName_get_EntireColumn(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def EntireRow(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsName_get_EntireRow(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def ErrorValue(self)->str:
        ...
        GetDllLibXls().XlsName_get_ErrorValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_ErrorValue(self.Ptr)
        return ret
    ...
    def ErrorValue(self, value:str):
        ...
        GetDllLibXls().XlsName_set_ErrorValue(self.Ptr, value)
    ...
    def Formula(self)->str:
        ...
        GetDllLibXls().XlsName_get_Formula.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_Formula(self.Ptr)
        return ret
    ...
    def Formula(self, value:str):
        ...
        GetDllLibXls().XlsName_set_Formula(self.Ptr, value)
    ...
    def FormulaArray(self)->str:
        ...
        GetDllLibXls().XlsName_get_FormulaArray.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_FormulaArray(self.Ptr)
        return ret
    ...
    def FormulaArray(self, value:str):
        ...
        GetDllLibXls().XlsName_set_FormulaArray(self.Ptr, value)
    ...
    def FormulaArrayR1C1(self)->str:
        ...
        GetDllLibXls().XlsName_get_FormulaArrayR1C1.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_FormulaArrayR1C1(self.Ptr)
        return ret
    ...
    def FormulaArrayR1C1(self, value:str):
        ...
        GetDllLibXls().XlsName_set_FormulaArrayR1C1(self.Ptr, value)
    ...
    def IsFormulaHidden(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_IsFormulaHidden(self.Ptr)
        return ret
    ...
    def IsFormulaHidden(self, value:bool):
        ...
        GetDllLibXls().XlsName_set_IsFormulaHidden(self.Ptr, value)
    ...
    def FormulaDateTime(self)->'DateTime':
        ...
        intPtr = GetDllLibXls().XlsName_get_FormulaDateTime(self.Ptr)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def FormulaDateTime(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsName_set_FormulaDateTime(self.Ptr, value.Ptr)
    ...
    def FormulaR1C1(self)->str:
        ...
        GetDllLibXls().XlsName_get_FormulaR1C1.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_FormulaR1C1(self.Ptr)
        return ret
    ...
    def FormulaR1C1(self, value:str):
        ...
        GetDllLibXls().XlsName_set_FormulaR1C1(self.Ptr, value)
    ...
    def FormulaBoolValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_FormulaBoolValue(self.Ptr)
        return ret
    ...
    def FormulaBoolValue(self, value:bool):
        ...
        GetDllLibXls().XlsName_set_FormulaBoolValue(self.Ptr, value)
    ...
    def FormulaErrorValue(self)->str:
        ...
        GetDllLibXls().XlsName_get_FormulaErrorValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_FormulaErrorValue(self.Ptr)
        return ret
    ...
    def FormulaErrorValue(self, value:str):
        ...
        GetDllLibXls().XlsName_set_FormulaErrorValue(self.Ptr, value)
    ...
    def HasDataValidation(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasDataValidation(self.Ptr)
        return ret
    ...
    def HasBoolean(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasBoolean(self.Ptr)
        return ret
    ...
    def HasDateTime(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasDateTime(self.Ptr)
        return ret
    ...
    def HasFormula(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasFormula(self.Ptr)
        return ret
    ...
    def HasFormulaArray(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasFormulaArray(self.Ptr)
        return ret
    ...
    def HasFormulaDateTime(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasFormulaDateTime(self.Ptr)
        return ret
    ...
    def HasFormulaNumberValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasFormulaNumberValue(self.Ptr)
        return ret
    ...
    def HasFormulaStringValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasFormulaStringValue(self.Ptr)
        return ret
    ...
    def HasNumber(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasNumber(self.Ptr)
        return ret
    ...
    def HasRichText(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasRichText(self.Ptr)
        return ret
    ...
    def HasString(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasString(self.Ptr)
        return ret
    ...
    def HasStyle(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasStyle(self.Ptr)
        return ret
    ...
    def HorizontalAlignment(self)->'HorizontalAlignType':
        ...
        ret = GetDllLibXls().XlsName_get_HorizontalAlignment(self.Ptr)
    ...
    def HorizontalAlignment(self, value:'HorizontalAlignType'):
        ...
        GetDllLibXls().XlsName_set_HorizontalAlignment(self.Ptr, value.value)
    ...
    def IndentLevel(self)->int:
        ...
        ret = GetDllLibXls().XlsName_get_IndentLevel(self.Ptr)
        return ret

    @IndentLevel.setter
    def IndentLevel(self, value:int):
        GetDllLibXls().XlsName_set_IndentLevel.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsName_set_IndentLevel(self.Ptr, value)
    ...
    def IsBlank(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_IsBlank(self.Ptr)
        return ret
    ...
    def IsBuiltIn(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_IsBuiltIn(self.Ptr)
        return ret

    @IsBuiltIn.setter
    def IsBuiltIn(self, value:bool):
        GetDllLibXls().XlsName_set_IsBuiltIn.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsName_set_IsBuiltIn(self.Ptr, value)
    ...
    def IsExternName(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_IsExternName(self.Ptr)
        return ret
    ...
    def IsFunction(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_IsFunction(self.Ptr)
        return ret

    @IsFunction.setter
    def IsFunction(self, value:bool):
        GetDllLibXls().XlsName_set_IsFunction.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsName_set_IsFunction(self.Ptr, value)
    ...
    def HasError(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasError(self.Ptr)
        return ret
    ...
    def IsGroupedByColumn(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_IsGroupedByColumn(self.Ptr)
        return ret
    ...
    def IsGroupedByRow(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_IsGroupedByRow(self.Ptr)
        return ret
    ...
    def IsInitialized(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_IsInitialized(self.Ptr)
        return ret
    ...
    def LastColumn(self)->int:
        ...
        ret = GetDllLibXls().XlsName_get_LastColumn(self.Ptr)
        return ret

    @LastColumn.setter
    def LastColumn(self, value:int):
        GetDllLibXls().XlsName_set_LastColumn.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsName_set_LastColumn(self.Ptr, value)
    ...
    def LastRow(self)->int:
        ...
        ret = GetDllLibXls().XlsName_get_LastRow(self.Ptr)
        return ret

    @LastRow.setter
    def LastRow(self, value:int):
        GetDllLibXls().XlsName_set_LastRow.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsName_set_LastRow(self.Ptr, value)
    ...
    def NumberValue(self)->float:
        ...
        ret = GetDllLibXls().XlsName_get_NumberValue(self.Ptr)
        return ret

    @NumberValue.setter
    def NumberValue(self, value:float):
        GetDllLibXls().XlsName_set_NumberValue.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsName_set_NumberValue(self.Ptr, value)
    ...
    def NumberFormat(self)->str:
        ...
        GetDllLibXls().XlsName_get_NumberFormat.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_NumberFormat(self.Ptr)
        return ret
    ...
    def NumberFormat(self, value:str):
        ...
        GetDllLibXls().XlsName_set_NumberFormat(self.Ptr, value)
    ...
    def Row(self)->int:
        ...
        ret = GetDllLibXls().XlsName_get_Row(self.Ptr)
        return ret
    ...
    def RowGroupLevel(self)->int:
        ...
        ret = GetDllLibXls().XlsName_get_RowGroupLevel(self.Ptr)
        return ret
    ...
    def RowHeight(self)->float:
        ...
        ret = GetDllLibXls().XlsName_get_RowHeight(self.Ptr)
        return ret

    @RowHeight.setter
    def RowHeight(self, value:float):
        GetDllLibXls().XlsName_set_RowHeight.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsName_set_RowHeight(self.Ptr, value)
    ...
    def Rows(self)->ListXlsRanges:
        ...
        intPtr = GetDllLibXls().XlsName_get_Rows(self.Ptr)
    ...
    def Columns(self)->ListXlsRanges:
        ...
        intPtr = GetDllLibXls().XlsName_get_Columns(self.Ptr)
        ret = None if intPtr==None else ListXlsRanges(intPtr)
        return ret
    ...
    def Style(self)->'IStyle':
        ...
        intPtr = GetDllLibXls().XlsName_get_Style(self.Ptr)
    ...
    def Style(self, value:'IStyle'):
        ...
        GetDllLibXls().XlsName_set_Style(self.Ptr, value.Ptr)
    ...
    def CellStyleName(self)->str:
        ...
        GetDllLibXls().XlsName_get_CellStyleName.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_CellStyleName(self.Ptr)
        return ret
    ...
    def CellStyleName(self, value:str):
        ...
        GetDllLibXls().XlsName_set_CellStyleName(self.Ptr, value)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().XlsName_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsName_set_Text(self.Ptr, value)
    ...
    def TimeSpanValue(self)->'TimeSpan':
        ...
        intPtr = GetDllLibXls().XlsName_get_TimeSpanValue(self.Ptr)
    ...
    def TimeSpanValue(self, value:'TimeSpan'):
        ...
        GetDllLibXls().XlsName_set_TimeSpanValue(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsName_get_EnvalutedValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_EnvalutedValue(self.Ptr)
        return ret
    ...
    def VerticalAlignment(self)->'VerticalAlignType':
        ...
        ret = GetDllLibXls().XlsName_get_VerticalAlignment(self.Ptr)
    ...
    def VerticalAlignment(self, value:'VerticalAlignType'):
        ...
        GetDllLibXls().XlsName_set_VerticalAlignment(self.Ptr, value.value)
    ...
    def Value2(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsName_get_Value2(self.Ptr)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    def Value2(self, value:'SpireObject'):
        ...
        GetDllLibXls().XlsName_set_Value2(self.Ptr, value.Ptr)
    ...
    def get_Item(self ,row:int,column:int)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsName_get_Item(self.Ptr, row,column)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def set_Item(self ,row:int,column:int,value:'IXLSRange'):
        ...
        GetDllLibXls().XlsName_set_Item(self.Ptr, row,column,intPtrvalue)
    ...
    def get_Item(self ,row:int,column:int,lastRow:int,lastColumn:int)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsName_get_ItemRCLL(self.Ptr, row,column,lastRow,lastColumn)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def get_Item(self ,name:str)->IXLSRange:
        ...
        intPtr = GetDllLibXls().XlsName_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsName_get_ItemNI(self.Ptr, name,IsR1C1Notation)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsName_get_ConditionalFormats(self.Ptr)
    ...
    def DataValidation(self)->'Validation':
        ...
        intPtr = GetDllLibXls().XlsName_get_DataValidation(self.Ptr)
    ...
    def FormulaStringValue(self)->str:
        ...
        GetDllLibXls().XlsName_get_FormulaStringValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsName_get_FormulaStringValue(self.Ptr)
        return ret
    ...
    def FormulaStringValue(self, value:str):
        ...
        GetDllLibXls().XlsName_set_FormulaStringValue(self.Ptr, value)
    ...
    def FormulaNumberValue(self)->float:
        ...
        ret = GetDllLibXls().XlsName_get_FormulaNumberValue(self.Ptr)
        return ret
    ...
    def FormulaNumberValue(self, value:float):
        ...
        GetDllLibXls().XlsName_set_FormulaNumberValue(self.Ptr, value)
    ...
    def HasFormulaBoolValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasFormulaBoolValue(self.Ptr)
        return ret
    ...
    def HasFormulaErrorValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsName_get_HasFormulaErrorValue(self.Ptr)
        return ret
