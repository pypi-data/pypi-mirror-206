...
class FaceGearMeshCompoundAdvancedSystemDeflection(_7427.GearMeshCompoundAdvancedSystemDeflection):
    """FaceGearMeshCompoundAdvancedSystemDeflection
    ...
    class _Cast_FaceGearMeshCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'FaceGearMeshCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def face_gear_mesh_compound_advanced_system_deflection(self) -> 'FaceGearMeshCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7291.FaceGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7291.FaceGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'FaceGearMeshCompoundAdvancedSystemDeflection._Cast_FaceGearMeshCompoundAdvancedSystemDeflection':
