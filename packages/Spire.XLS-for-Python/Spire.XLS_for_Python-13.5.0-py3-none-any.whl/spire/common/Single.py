...
class Single (SpireObject) :
    ...
    def ToString(self)->str:
        ...
        dlllib.Single_ToString.restype=c_wchar_p
        ret = dlllib.Single_ToString(self.Ptr)
        return ret
...
#
    ...
    def ToString(self ,format:str)->str:
        ...
        dlllib.Single_ToStringF.restype=c_wchar_p
        ret = dlllib.Single_ToStringF(self.Ptr, format)
        return ret
