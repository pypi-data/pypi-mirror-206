...
class UnbalancedMassHarmonicAnalysis(_5804.VirtualComponentHarmonicAnalysis):
    """UnbalancedMassHarmonicAnalysis
    ...
    class _Cast_UnbalancedMassHarmonicAnalysis:
        ...
        def __init__(self, parent: 'UnbalancedMassHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_harmonic_analysis(self) -> 'UnbalancedMassHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassHarmonicAnalysis._Cast_UnbalancedMassHarmonicAnalysis':
