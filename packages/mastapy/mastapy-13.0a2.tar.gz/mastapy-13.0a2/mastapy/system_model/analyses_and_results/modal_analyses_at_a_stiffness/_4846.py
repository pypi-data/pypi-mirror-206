...
class BevelGearMeshModalAnalysisAtAStiffness(_4834.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness):
    """BevelGearMeshModalAnalysisAtAStiffness
    ...
    class _Cast_BevelGearMeshModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'BevelGearMeshModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def bevel_gear_mesh_modal_analysis_at_a_stiffness(self) -> 'BevelGearMeshModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearMeshModalAnalysisAtAStiffness._Cast_BevelGearMeshModalAnalysisAtAStiffness':
