...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4712, _4713, _4719
...
class BevelDifferentialGearSetCompoundModalAnalysis(_4719.BevelGearSetCompoundModalAnalysis):
    """BevelDifferentialGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4560.BevelDifferentialGearSetModalAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis(self) -> 'List[_4712.BevelDifferentialGearCompoundModalAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis(self) -> 'List[_4713.BevelDifferentialGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4560.BevelDifferentialGearSetModalAnalysis]':
