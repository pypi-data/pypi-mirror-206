...
class UrlTest(unittest.TestCase):
    ...
    def testGetDiscId(self):
        musicbrainzez.get_releases_by_discid("xp5tz6rE4OHrBafj0bLfDRMGK48-", api="xml")
        self.assertEqual("https://musicbrainz.org/ws/2/discid/xp5tz6rE4OHrBafj0bLfDRMGK48-", self.opener.get_url())

        # one include
        musicbrainzez.get_releases_by_discid("xp5tz6rE4OHrBafj0bLfDRMGK48-",
                                              includes=["recordings"], api="xml")
        ...
        musicbrainzez.get_releases_by_discid("xp5tz6rE4OHrBafj0bLfDRMGK48-", includes=["artists", "recordings", "artist-credits"], api="xml")
...
class GetDiscIdTest(unittest.TestCase):
    ...
    def testDiscId(self):
        ...
        """
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "xp5tz6rE4OHrBafj0bLfDRMGK48-.xml")
    ...
    def testTrackCount(self):
        ...
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "f7agNZK1HMQ2WUWq9bwDymw9aHA-.xml")
