...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4214, _4215, _4210
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow(_4210.KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4084.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_power_flow(self) -> 'List[_4214.KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_power_flow(self) -> 'List[_4215.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4084.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
