...
class Char (SpireObject) :
    ...
    def GetHashCode(self)->int:
        ...
        ret = dlllib.Char_GetHashCode(self.Ptr)
        return ret
    ...
    def Equals(self ,obj:SpireObject)->bool:
        ...
        ret = dlllib.Char_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def Equals(self ,obj:int)->bool:
        ...
        ret = dlllib.Char_EqualsO(self.Ptr, obj)
        return ret
    ...
    def CompareTo(self ,value:SpireObject)->int:
        ...
        ret = dlllib.Char_CompareTo(self.Ptr, intPtrvalue)
        return ret
    ...
    def CompareTo(self ,value:int)->int:
        ...
        ret = dlllib.Char_CompareToV(self.Ptr, value)
        return ret
    ...
    def ToString(self)->str:
        ...
        dlllib.Char_ToString.restype=c_wchar_p
        ret = dlllib.Char_ToString(self.Ptr)
        return ret
...
#        ret = dlllib.Char_ToStringP(self.Ptr, intPtrprovider)
#        return ret
#
    ...
    def ToString(c:int)->str:
        ...
        dlllib.Char_ToStringC.restype=c_wchar_p
        ret = dlllib.Char_ToStringC( c)
        return ret
...
#        ret = dlllib.Char_TryParse( s,intPtrresult)
#        return ret
    ...
    def IsWhiteSpace(c:int)->bool:
        ...
        ret = dlllib.Char_IsWhiteSpace( c)
        return ret
    ...
    def IsPunctuation(c:int)->bool:
        ...
        ret = dlllib.Char_IsPunctuation( c)
        return ret
    ...
    def IsLetterOrDigit(c:int)->bool:
        ...
        ret = dlllib.Char_IsLetterOrDigit( c)
        return ret
    ...
    def ToUpper(c:int,culture:CultureInfo)->int:
        ...
        ret = dlllib.Char_ToUpper( c,intPtrculture)
        return ret
    ...
    def ToUpperInvariant(c:int)->int:
        ...
        ret = dlllib.Char_ToUpperInvariant( c)
        return ret
    ...
    def ToLower(c:int,culture:CultureInfo)->int:
        ...
        ret = dlllib.Char_ToLower( c,intPtrculture)
        return ret
    ...
    def ToLowerInvariant(c:int)->int:
        ...
        ret = dlllib.Char_ToLowerInvariant( c)
        return ret
...
#        ret = dlllib.Char_GetTypeCode(self.Ptr)
...
#        return objwraped
    ...
    def IsControl(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsControlSI( s,index)
        return ret
    ...
    def IsDigit(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsDigitSI( s,index)
        return ret
    ...
    def IsLetter(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsLetterSI( s,index)
        return ret
    ...
    def IsLetterOrDigit(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsLetterOrDigitSI( s,index)
        return ret
    ...
    def IsLower(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsLowerSI( s,index)
        return ret
    ...
    def IsNumber(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsNumberSI( s,index)
        return ret
    ...
    def IsPunctuation(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsPunctuationSI( s,index)
        return ret
    ...
    def IsSeparator(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsSeparatorSI( s,index)
        return ret
    ...
    def IsSurrogate(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsSurrogateSI( s,index)
        return ret
    ...
    def IsSymbol(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsSymbolSI( s,index)
        return ret
    ...
    def IsUpper(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsUpperSI( s,index)
        return ret
    ...
    def IsWhiteSpace(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsWhiteSpaceSI( s,index)
        return ret
...
#        ret = dlllib.Char_GetUnicodeCategory( c)
...
#        ret = dlllib.Char_GetUnicodeCategorySI( s,index)
#        objwraped = UnicodeCategory(ret)
#        return objwraped
    ...
    def GetNumericValue(c:int)->float:
        ...
        ret = dlllib.Char_GetNumericValue( c)
        return ret
    ...
    def GetNumericValue(s:str,index:int)->float:
        ...
        ret = dlllib.Char_GetNumericValueSI( s,index)
        return ret
    ...
    def IsHighSurrogate(c:int)->bool:
        ...
        ret = dlllib.Char_IsHighSurrogate( c)
        return ret
    ...
    def IsHighSurrogate(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsHighSurrogateSI( s,index)
        return ret
    ...
    def IsLowSurrogate(c:int)->bool:
        ...
        ret = dlllib.Char_IsLowSurrogate( c)
        return ret
    ...
    def IsLowSurrogate(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsLowSurrogateSI( s,index)
        return ret
    ...
    def IsSurrogatePair(s:str,index:int)->bool:
        ...
        ret = dlllib.Char_IsSurrogatePair( s,index)
        return ret
    ...
    def IsSurrogatePair(highSurrogate:int,lowSurrogate:int)->bool:
        ...
        ret = dlllib.Char_IsSurrogatePairHL( highSurrogate,lowSurrogate)
        return ret
    ...
    def ConvertFromUtf32(utf32:int)->str:
        ...
        dlllib.Char_ConvertFromUtf32.restype=c_wchar_p
        ret = dlllib.Char_ConvertFromUtf32( utf32)
        return ret
    ...
    def ConvertToUtf32(highSurrogate:int,lowSurrogate:int)->int:
        ...
        ret = dlllib.Char_ConvertToUtf32( highSurrogate,lowSurrogate)
        return ret
    ...
    def ConvertToUtf32(s:str,index:int)->int:
        ...
        ret = dlllib.Char_ConvertToUtf32SI( s,index)
        return ret
