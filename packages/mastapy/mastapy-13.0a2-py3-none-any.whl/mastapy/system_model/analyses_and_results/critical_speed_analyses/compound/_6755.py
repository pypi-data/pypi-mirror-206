...
class SynchroniserSleeveCompoundCriticalSpeedAnalysis(_6754.SynchroniserPartCompoundCriticalSpeedAnalysis):
    """SynchroniserSleeveCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6626.SynchroniserSleeveCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6626.SynchroniserSleeveCriticalSpeedAnalysis]':
