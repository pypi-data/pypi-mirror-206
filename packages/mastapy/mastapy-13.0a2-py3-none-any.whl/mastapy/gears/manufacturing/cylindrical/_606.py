...
class CylindricalGearBlank(_0.APIBase):
    ...
    class _Cast_CylindricalGearBlank:
        ...
        def __init__(self, parent: 'CylindricalGearBlank'):
            self._parent = parent

        @property
        def cylindrical_gear_blank(self) -> 'CylindricalGearBlank':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearBlank._Cast_CylindricalGearBlank':
        return self._Cast_CylindricalGearBlank(self)
