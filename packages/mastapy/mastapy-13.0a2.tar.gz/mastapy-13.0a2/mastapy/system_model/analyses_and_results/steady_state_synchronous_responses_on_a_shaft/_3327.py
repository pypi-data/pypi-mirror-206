...
class SpringDamperHalfSteadyStateSynchronousResponseOnAShaft(_3262.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    """SpringDamperHalfSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_SpringDamperHalfSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'SpringDamperHalfSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def spring_damper_half_steady_state_synchronous_response_on_a_shaft(self) -> 'SpringDamperHalfSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperHalfSteadyStateSynchronousResponseOnAShaft._Cast_SpringDamperHalfSteadyStateSynchronousResponseOnAShaft':
