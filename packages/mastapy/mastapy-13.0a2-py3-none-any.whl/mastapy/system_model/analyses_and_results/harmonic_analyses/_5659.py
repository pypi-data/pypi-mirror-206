...
class BeltDriveHarmonicAnalysis(_5777.SpecialisedAssemblyHarmonicAnalysis):
    """BeltDriveHarmonicAnalysis
    ...
    class _Cast_BeltDriveHarmonicAnalysis:
        ...
        def __init__(self, parent: 'BeltDriveHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def belt_drive_harmonic_analysis(self) -> 'BeltDriveHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BeltDriveHarmonicAnalysis._Cast_BeltDriveHarmonicAnalysis':
