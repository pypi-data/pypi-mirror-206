...
class HypoidGearSteadyStateSynchronousResponse(_2968.AGMAGleasonConicalGearSteadyStateSynchronousResponse):
    ...
    class _Cast_HypoidGearSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'HypoidGearSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_steady_state_synchronous_response(self) -> 'HypoidGearSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidGearSteadyStateSynchronousResponse._Cast_HypoidGearSteadyStateSynchronousResponse':
