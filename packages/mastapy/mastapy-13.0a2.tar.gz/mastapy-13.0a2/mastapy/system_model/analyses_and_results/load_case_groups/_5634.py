...
from mastapy.system_model.analyses_and_results.load_case_groups import _5637, _5630
...
class DutyCycle(_5630.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_5637.SubGroupInSingleDesignState]':
    ...
    @property
    def time_series_importer(self) -> '_6965.TimeSeriesImporter':
    ...
    def add_static_load(self, static_load: '_6769.StaticLoadCase'):
    ...
    def remove_design_state_sub_group(self, sub_group: '_5637.SubGroupInSingleDesignState'):
