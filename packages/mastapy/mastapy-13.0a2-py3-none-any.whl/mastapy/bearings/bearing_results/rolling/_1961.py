...
class ISO14179SettingsPerBearingType(_1575.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    """ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1881.RollingBearingType':
        ...
        value = conversion.pn_to_mp_enum(temp, _1881.RollingBearingType)
        return constructor.new_from_mastapy_type(_1881.RollingBearingType)(value) if value is not None else None
