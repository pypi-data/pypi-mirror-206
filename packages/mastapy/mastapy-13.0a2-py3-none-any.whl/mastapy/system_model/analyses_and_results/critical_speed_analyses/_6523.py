...
class BevelDifferentialSunGearCriticalSpeedAnalysis(_6519.BevelDifferentialGearCriticalSpeedAnalysis):
    """BevelDifferentialSunGearCriticalSpeedAnalysis
    ...
    class _Cast_BevelDifferentialSunGearCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialSunGearCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_sun_gear_critical_speed_analysis(self) -> 'BevelDifferentialSunGearCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialSunGearCriticalSpeedAnalysis._Cast_BevelDifferentialSunGearCriticalSpeedAnalysis':
