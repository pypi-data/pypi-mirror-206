...
class UnbalancedMassSteadyStateSynchronousResponseAtASpeed(_3606.VirtualComponentSteadyStateSynchronousResponseAtASpeed):
    """UnbalancedMassSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_UnbalancedMassSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'UnbalancedMassSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_steady_state_synchronous_response_at_a_speed(self) -> 'UnbalancedMassSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassSteadyStateSynchronousResponseAtASpeed._Cast_UnbalancedMassSteadyStateSynchronousResponseAtASpeed':
