...
class StraightBevelPlanetGearModalAnalysis(_4663.StraightBevelDiffGearModalAnalysis):
    """StraightBevelPlanetGearModalAnalysis
    ...
    class _Cast_StraightBevelPlanetGearModalAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelPlanetGearModalAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_planet_gear_modal_analysis(self) -> 'StraightBevelPlanetGearModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelPlanetGearModalAnalysis._Cast_StraightBevelPlanetGearModalAnalysis':
