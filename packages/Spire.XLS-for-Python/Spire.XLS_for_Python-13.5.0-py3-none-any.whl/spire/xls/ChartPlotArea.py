...
class ChartPlotArea (  XlsChartPlotArea) :
    ...
    def Border(self)->'ChartBorder':
        ...
        intPtr = GetDllLibXls().ChartPlotArea_get_Border(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartPlotArea_get_Interior(self.Ptr)
    ...
    def Workbook(self)->'Workbook':
        ...
        intPtr = GetDllLibXls().ChartPlotArea_get_Workbook(self.Ptr)
