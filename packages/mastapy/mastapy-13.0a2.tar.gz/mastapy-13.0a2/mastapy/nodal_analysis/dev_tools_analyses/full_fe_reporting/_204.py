...
class ElementDetailsForFEModel(_0.APIBase):
    ...
    class _Cast_ElementDetailsForFEModel:
        ...
        def __init__(self, parent: 'ElementDetailsForFEModel'):
            self._parent = parent

        @property
        def element_details_for_fe_model(self) -> 'ElementDetailsForFEModel':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ElementDetailsForFEModel._Cast_ElementDetailsForFEModel':
