...
class BevelGearMultibodyDynamicsAnalysis(_5352.AGMAGleasonConicalGearMultibodyDynamicsAnalysis):
    """BevelGearMultibodyDynamicsAnalysis
    ...
    class _Cast_BevelGearMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'BevelGearMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_gear_multibody_dynamics_analysis(self) -> 'BevelGearMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearMultibodyDynamicsAnalysis._Cast_BevelGearMultibodyDynamicsAnalysis':
