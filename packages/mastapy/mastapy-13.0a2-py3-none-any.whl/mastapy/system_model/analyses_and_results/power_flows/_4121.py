...
class StraightBevelGearPowerFlow(_4026.BevelGearPowerFlow):
    """StraightBevelGearPowerFlow
    ...
    class _Cast_StraightBevelGearPowerFlow:
        ...
        def __init__(self, parent: 'StraightBevelGearPowerFlow'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_power_flow(self) -> 'StraightBevelGearPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearPowerFlow._Cast_StraightBevelGearPowerFlow':
