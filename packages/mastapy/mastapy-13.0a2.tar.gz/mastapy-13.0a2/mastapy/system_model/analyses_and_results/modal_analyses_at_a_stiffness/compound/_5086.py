...
class ZerolBevelGearCompoundModalAnalysisAtAStiffness(_4976.BevelGearCompoundModalAnalysisAtAStiffness):
    """ZerolBevelGearCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_ZerolBevelGearCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ZerolBevelGearCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_compound_modal_analysis_at_a_stiffness(self) -> 'ZerolBevelGearCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4958.ZerolBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4958.ZerolBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearCompoundModalAnalysisAtAStiffness._Cast_ZerolBevelGearCompoundModalAnalysisAtAStiffness':
