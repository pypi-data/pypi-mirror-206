...
class Double (SpireObject) :
    ...
    def Value(self)->float:
        ...
        ret = dlllib.Double_Value( self.Ptr)
        return ret
    ...
    def IsInfinity(d:float)->bool:
        ...
        ret = dlllib.Double_IsInfinity( d)
        return ret
    ...
    def IsPositiveInfinity(d:float)->bool:
        ...
        ret = dlllib.Double_IsPositiveInfinity( d)
        return ret
    ...
    def IsNegativeInfinity(d:float)->bool:
        ...
        ret = dlllib.Double_IsNegativeInfinity( d)
        return ret
    ...
    def CompareTo(self ,value:SpireObject)->int:
        ...
        ret = dlllib.Double_CompareTo(self.Ptr, intPtrvalue)
        return ret
    ...
    def CompareTo(self ,value:float)->int:
        ...
        ret = dlllib.Double_CompareToV(self.Ptr, value)
        return ret
    ...
    def Equals(self ,obj:SpireObject)->bool:
        ...
        ret = dlllib.Double_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def op_Equality(left:float,right:float)->bool:
        ...
        ret = dlllib.Double_op_Equality( left,right)
        return ret
    ...
    def op_Inequality(left:float,right:float)->bool:
        ...
        ret = dlllib.Double_op_Inequality( left,right)
        return ret
    ...
    def op_LessThan(left:float,right:float)->bool:
        ...
        ret = dlllib.Double_op_LessThan( left,right)
        return ret
    ...
    def op_GreaterThan(left:float,right:float)->bool:
        ...
        ret = dlllib.Double_op_GreaterThan( left,right)
        return ret
    ...
    def op_LessThanOrEqual(left:float,right:float)->bool:
        ...
        ret = dlllib.Double_op_LessThanOrEqual( left,right)
        return ret
    ...
    def op_GreaterThanOrEqual(left:float,right:float)->bool:
        ...
        ret = dlllib.Double_op_GreaterThanOrEqual( left,right)
        return ret
    ...
    def Equals(self ,obj:float)->bool:
        ...
        ret = dlllib.Double_EqualsO(self.Ptr, obj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = dlllib.Double_GetHashCode(self.Ptr)
        return ret
    ...
    def ToString(self)->str:
        ...
        dlllib.Double_ToString.restype=c_wchar_p
        ret = dlllib.Double_ToString(self.Ptr)
        return ret
    ...
    def ToString(self ,format:str)->str:
        ...
        dlllib.Double_ToStringF.restype=c_wchar_p
        ret = dlllib.Double_ToStringF(self.Ptr, format)
        return ret
...
#        ret = dlllib.Double_ToStringP(self.Ptr, intPtrprovider)
#        return ret
#
...
#        ret = dlllib.Double_ToStringFP(self.Ptr, format,intPtrprovider)
#        return ret
#
...
#        ret = dlllib.Double_ParseSS( s,enumstyle)
#        return ret
...
#        ret = dlllib.Double_ParseSP( s,intPtrprovider)
#        return ret
...
#        ret = dlllib.Double_ParseSSP( s,enumstyle,intPtrprovider)
#        return ret
...
#        ret = dlllib.Double_TryParse( s,intPtrresult)
#        return ret
...
#        ret = dlllib.Double_TryParseSSPR( s,enumstyle,intPtrprovider,intPtrresult)
#        return ret
...
#        ret = dlllib.Double_GetTypeCode(self.Ptr)
...
#        return objwraped
    ...
    def NegativeInfinity()->float:
        ...
        ret = dlllib.Double_NegativeInfinity()
        return ret
    ...
    def PositiveInfinity()->float:
        ...
        ret = dlllib.Double_PositiveInfinity()
        return ret
