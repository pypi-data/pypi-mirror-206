...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5287, _5288, _5286
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed(_5286.KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysisAtASpeed):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_set_compound_modal_analysis_at_a_speed(self) -> 'KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5160.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5287.KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5288.KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5160.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed._Cast_KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed(self)
