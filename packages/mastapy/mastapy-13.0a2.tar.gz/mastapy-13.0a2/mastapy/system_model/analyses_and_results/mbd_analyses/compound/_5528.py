...
class ConceptGearCompoundMultibodyDynamicsAnalysis(_5557.GearCompoundMultibodyDynamicsAnalysis):
    """ConceptGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5380.ConceptGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5380.ConceptGearMultibodyDynamicsAnalysis]':
