...
class ExternalCADModelAdvancedTimeSteppingAnalysisForModulation(_6998.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """ExternalCADModelAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_ExternalCADModelAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'ExternalCADModelAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def external_cad_model_advanced_time_stepping_analysis_for_modulation(self) -> 'ExternalCADModelAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ExternalCADModelAdvancedTimeSteppingAnalysisForModulation._Cast_ExternalCADModelAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_ExternalCADModelAdvancedTimeSteppingAnalysisForModulation(self)
