...
class SpecialisedAssemblyMultibodyDynamicsAnalysis(_5347.AbstractAssemblyMultibodyDynamicsAnalysis):
    """SpecialisedAssemblyMultibodyDynamicsAnalysis
    ...
    class _Cast_SpecialisedAssemblyMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'SpecialisedAssemblyMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def specialised_assembly_multibody_dynamics_analysis(self) -> 'SpecialisedAssemblyMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpecialisedAssemblyMultibodyDynamicsAnalysis._Cast_SpecialisedAssemblyMultibodyDynamicsAnalysis':
