...
# body param
SchemaForRequestBodyApplicationJson = UpdateLinkRequest


request_body_update_link_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = LinkResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_link_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_link_request.serialize(body, content_type)
