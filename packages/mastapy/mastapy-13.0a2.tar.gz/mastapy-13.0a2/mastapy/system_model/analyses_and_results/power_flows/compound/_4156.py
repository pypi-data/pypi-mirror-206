...
class BevelDifferentialPlanetGearCompoundPowerFlow(_4153.BevelDifferentialGearCompoundPowerFlow):
    """BevelDifferentialPlanetGearCompoundPowerFlow
    ...
    class _Cast_BevelDifferentialPlanetGearCompoundPowerFlow:
        ...
        def __init__(self, parent: 'BevelDifferentialPlanetGearCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def bevel_differential_planet_gear_compound_power_flow(self) -> 'BevelDifferentialPlanetGearCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4023.BevelDifferentialPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4023.BevelDifferentialPlanetGearPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialPlanetGearCompoundPowerFlow._Cast_BevelDifferentialPlanetGearCompoundPowerFlow':
