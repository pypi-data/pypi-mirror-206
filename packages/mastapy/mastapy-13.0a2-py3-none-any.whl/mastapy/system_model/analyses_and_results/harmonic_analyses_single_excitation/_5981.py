...
class AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation(_6009.ConicalGearSetHarmonicAnalysisOfSingleExcitation):
    """AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_set_harmonic_analysis_of_single_excitation(self) -> 'AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation._Cast_AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation':
        return self._Cast_AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation(self)
