...
class StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft(_3332.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def straight_bevel_sun_gear_steady_state_synchronous_response_on_a_shaft(self) -> 'StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft._Cast_StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft(self)
