...
class CycloidalDiscCompoundPowerFlow(_4143.AbstractShaftCompoundPowerFlow):
    """CycloidalDiscCompoundPowerFlow
    ...
    class _Cast_CycloidalDiscCompoundPowerFlow:
        ...
        def __init__(self, parent: 'CycloidalDiscCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_compound_power_flow(self) -> 'CycloidalDiscCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4055.CycloidalDiscPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4055.CycloidalDiscPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscCompoundPowerFlow._Cast_CycloidalDiscCompoundPowerFlow':
