...
class BoltedJointCriticalSpeedAnalysis(_6608.SpecialisedAssemblyCriticalSpeedAnalysis):
    """BoltedJointCriticalSpeedAnalysis
    ...
    class _Cast_BoltedJointCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'BoltedJointCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def bolted_joint_critical_speed_analysis(self) -> 'BoltedJointCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltedJointCriticalSpeedAnalysis._Cast_BoltedJointCriticalSpeedAnalysis':
