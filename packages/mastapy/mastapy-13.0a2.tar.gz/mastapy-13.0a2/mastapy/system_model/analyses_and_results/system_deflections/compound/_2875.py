...
class CycloidalDiscCompoundSystemDeflection(_2831.AbstractShaftCompoundSystemDeflection):
    """CycloidalDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2717.CycloidalDiscSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2717.CycloidalDiscSystemDeflection]':
