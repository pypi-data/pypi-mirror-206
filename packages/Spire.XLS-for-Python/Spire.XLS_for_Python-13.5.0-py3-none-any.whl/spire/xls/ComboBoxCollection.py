...
class ComboBoxCollection (  CollectionBase[XlsComboBoxShape],IComboBoxes) :
    ...
    def get_Item(self ,index:int)->IComboBoxShape:
        ...
        intPtr = GetDllLibXls().ComboBoxCollection_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->IComboBoxShape:
        ...
        intPtr = GetDllLibXls().ComboBoxCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsComboBoxShape(intPtr)
        return ret
    ...
    def AddCopy(self ,comboboxsource:'IComboBoxShape'):
        ...
        GetDllLibXls().ComboBoxCollection_AddCopy(self.Ptr, intPtrcomboboxsource)
    ...
    def AddComboBox(self ,row:int,column:int,height:int,width:int)->'IComboBoxShape':
        ...
        intPtr = GetDllLibXls().ComboBoxCollection_AddComboBox(self.Ptr, row,column,height,width)
        ret = None if intPtr==None else XlsComboBoxShape(intPtr)
        return ret
    ...
    def Clear(self):
        ...
        GetDllLibXls().ComboBoxCollection_Clear(self.Ptr)
