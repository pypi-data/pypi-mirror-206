...
class SynchroniserSleeveCompoundModalAnalysisAtASpeed(_5333.SynchroniserPartCompoundModalAnalysisAtASpeed):
    """SynchroniserSleeveCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5205.SynchroniserSleeveModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5205.SynchroniserSleeveModalAnalysisAtASpeed]':
