...
class HypoidGearSetParetoOptimiser(_907.GearSetParetoOptimiser):
    """HypoidGearSetParetoOptimiser
    ...
    class _Cast_HypoidGearSetParetoOptimiser:
        ...
        def __init__(self, parent: 'HypoidGearSetParetoOptimiser'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_set_pareto_optimiser(self) -> 'HypoidGearSetParetoOptimiser':
            return self._parent
    ...
    @property
    def selected_candidate_geometry(self) -> '_982.HypoidGearSetDesign':
    ...
    @property
    def all_candidate_gear_sets(self) -> 'List[_982.HypoidGearSetDesign]':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_982.HypoidGearSetDesign]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearSetParetoOptimiser._Cast_HypoidGearSetParetoOptimiser':
