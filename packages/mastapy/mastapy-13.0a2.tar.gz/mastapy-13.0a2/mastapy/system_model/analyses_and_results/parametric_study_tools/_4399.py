...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4398, _4397, _4289
...
class StraightBevelGearSetParametricStudyTool(_4289.BevelGearSetParametricStudyTool):
    """StraightBevelGearSetParametricStudyTool
    ...
    class _Cast_StraightBevelGearSetParametricStudyTool:
        ...
        def __init__(self, parent: 'StraightBevelGearSetParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_set_parametric_study_tool(self) -> 'StraightBevelGearSetParametricStudyTool':
            return self._parent
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2796.StraightBevelGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_parametric_study_tool(self) -> 'List[_4398.StraightBevelGearParametricStudyTool]':
    ...
    @property
    def straight_bevel_meshes_parametric_study_tool(self) -> 'List[_4397.StraightBevelGearMeshParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSetParametricStudyTool._Cast_StraightBevelGearSetParametricStudyTool':
