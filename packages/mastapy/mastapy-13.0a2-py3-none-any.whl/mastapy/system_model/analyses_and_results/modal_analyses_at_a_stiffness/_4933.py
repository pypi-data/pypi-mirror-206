...
class SpringDamperConnectionModalAnalysisAtAStiffness(_4867.CouplingConnectionModalAnalysisAtAStiffness):
    """SpringDamperConnectionModalAnalysisAtAStiffness
    ...
    class _Cast_SpringDamperConnectionModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'SpringDamperConnectionModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_modal_analysis_at_a_stiffness(self) -> 'SpringDamperConnectionModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionModalAnalysisAtAStiffness._Cast_SpringDamperConnectionModalAnalysisAtAStiffness':
