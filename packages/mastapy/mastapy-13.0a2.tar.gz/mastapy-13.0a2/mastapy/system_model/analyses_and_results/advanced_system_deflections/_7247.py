...
class BevelDifferentialGearMeshAdvancedSystemDeflection(_7252.BevelGearMeshAdvancedSystemDeflection):
    """BevelDifferentialGearMeshAdvancedSystemDeflection
    ...
    class _Cast_BevelDifferentialGearMeshAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_advanced_system_deflection(self) -> 'BevelDifferentialGearMeshAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_detailed_analysis(self) -> '_549.BevelGearMeshRating':
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2680.BevelDifferentialGearMeshSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshAdvancedSystemDeflection._Cast_BevelDifferentialGearMeshAdvancedSystemDeflection':
