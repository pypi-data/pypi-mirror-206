...
class HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation(_6977.AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2742.HypoidGearMeshSystemDeflection':
