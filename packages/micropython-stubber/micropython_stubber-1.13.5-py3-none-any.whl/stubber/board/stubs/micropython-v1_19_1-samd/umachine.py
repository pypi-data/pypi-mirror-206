"""
Module: 'umachine' on micropython-v1.19.1-samd
"""
...
class Pin():
    ...
    class board():
        ...
        5V_ENABLE : Any ## <class 'Pin'> = Pin("5V_ENABLE", mode=IN, pull=PULL_OFF, GPIO=PC14)
        A0_D0 : Any ## <class 'Pin'> = Pin("A0_D0", mode=IN, pull=PULL_OFF, GPIO=PB08)
        3V3_ENABLE : Any ## <class 'Pin'> = Pin("3V3_ENABLE", mode=IN, pull=PULL_OFF, GPIO=PC15)
