...
class FEPartModalAnalysisAtASpeed(_5091.AbstractShaftOrHousingModalAnalysisAtASpeed):
    """FEPartModalAnalysisAtASpeed
    ...
    class _Cast_FEPartModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'FEPartModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def fe_part_modal_analysis_at_a_speed(self) -> 'FEPartModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FEPartModalAnalysisAtASpeed._Cast_FEPartModalAnalysisAtASpeed':
