...
class QueryTableXls (SpireObject) :
    ...
    def AdjustColumnWidth(self)->bool:
        ...
        ret = GetDllLibXls().QueryTableXls_get_AdjustColumnWidth(self.Ptr)
        return ret
    ...
    def AdjustColumnWidth(self, value:bool):
        ...
        GetDllLibXls().QueryTableXls_set_AdjustColumnWidth(self.Ptr, value)
    ...
    def PreserveFormatting(self)->bool:
        ...
        ret = GetDllLibXls().QueryTableXls_get_PreserveFormatting(self.Ptr)
        return ret
    ...
    def PreserveFormatting(self, value:bool):
        ...
        GetDllLibXls().QueryTableXls_set_PreserveFormatting(self.Ptr, value)
