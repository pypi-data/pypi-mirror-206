...
class HeartbeatConfig(MonitorProcessConfig):
    heartbeat_ping_interval: float = conf_field(60.0 * 30.0, help="How often to check stats (in seconds)")


HeartbeatConfigT = TypeVar("HeartbeatConfigT", bound=HeartbeatConfig)
