...
class KlingelnbergCycloPalloidHypoidGearCompoundMultibodyDynamicsAnalysis(_5565.KlingelnbergCycloPalloidConicalGearCompoundMultibodyDynamicsAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_compound_multibody_dynamics_analysis(self) -> 'KlingelnbergCycloPalloidHypoidGearCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5425.KlingelnbergCycloPalloidHypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5425.KlingelnbergCycloPalloidHypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearCompoundMultibodyDynamicsAnalysis._Cast_KlingelnbergCycloPalloidHypoidGearCompoundMultibodyDynamicsAnalysis':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearCompoundMultibodyDynamicsAnalysis(self)
