...
class ShaftSettingsItem(_1816.NamedDatabaseItem):
    """ShaftSettingsItem
    ...
    def version_of_miners_rule(self) -> '_13.FkmVersionOfMinersRule':
        ...
        value = conversion.pn_to_mp_enum(temp, _13.FkmVersionOfMinersRule)
    ...
    def version_of_miners_rule(self, value: '_13.FkmVersionOfMinersRule'):
        ...
        value = conversion.mp_to_pn_enum(value, _13.FkmVersionOfMinersRule.type_())
