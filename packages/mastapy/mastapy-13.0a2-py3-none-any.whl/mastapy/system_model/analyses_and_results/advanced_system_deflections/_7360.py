...
class UnbalancedMassAdvancedSystemDeflection(_7361.VirtualComponentAdvancedSystemDeflection):
    """UnbalancedMassAdvancedSystemDeflection
    ...
    class _Cast_UnbalancedMassAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'UnbalancedMassAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_advanced_system_deflection(self) -> 'UnbalancedMassAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2813.UnbalancedMassSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassAdvancedSystemDeflection._Cast_UnbalancedMassAdvancedSystemDeflection':
