...
class ConceptCouplingConnectionCompoundCriticalSpeedAnalysis(_6677.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """ConceptCouplingConnectionCompoundCriticalSpeedAnalysis
    ...
    class _Cast_ConceptCouplingConnectionCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_compound_critical_speed_analysis(self) -> 'ConceptCouplingConnectionCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6534.ConceptCouplingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6534.ConceptCouplingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionCompoundCriticalSpeedAnalysis._Cast_ConceptCouplingConnectionCompoundCriticalSpeedAnalysis':
