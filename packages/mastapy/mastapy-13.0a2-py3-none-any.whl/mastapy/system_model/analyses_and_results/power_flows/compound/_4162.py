...
class BoltedJointCompoundPowerFlow(_4240.SpecialisedAssemblyCompoundPowerFlow):
    """BoltedJointCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4028.BoltedJointPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4028.BoltedJointPowerFlow]':
