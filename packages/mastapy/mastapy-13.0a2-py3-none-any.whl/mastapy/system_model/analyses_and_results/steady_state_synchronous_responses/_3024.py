...
class GuideDxfModelSteadyStateSynchronousResponse(_2987.ComponentSteadyStateSynchronousResponse):
    ...
    class _Cast_GuideDxfModelSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'GuideDxfModelSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def guide_dxf_model_steady_state_synchronous_response(self) -> 'GuideDxfModelSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GuideDxfModelSteadyStateSynchronousResponse._Cast_GuideDxfModelSteadyStateSynchronousResponse':
