...
class ExternalCADModelLoadCase(_6801.ComponentLoadCase):
    """ExternalCADModelLoadCase
    ...
    class _Cast_ExternalCADModelLoadCase:
        ...
        def __init__(self, parent: 'ExternalCADModelLoadCase'):
            self._parent = parent
        ...
        @property
        def external_cad_model_load_case(self) -> 'ExternalCADModelLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ExternalCADModelLoadCase._Cast_ExternalCADModelLoadCase':
