...
class OdsPageBackground (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().OdsPageBackground_get_Type(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().OdsPageBackground_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().OdsPageBackground_set_Color(self.Ptr, value.Ptr)
...
#        intPtrArray = GetDllLibXls().OdsPageBackground_get_ImageData(self.Ptr)
...
#        GetDllLibXls().OdsPageBackground_set_ImageData(self.Ptr, vArray, vCount)
    ...
    <summary>
        ...
        GetDllLibXls().OdsPageBackground_get_ImageLink.restype=c_wchar_p
        ret = GetDllLibXls().OdsPageBackground_get_ImageLink(self.Ptr)
        return ret
    ...
    def ImageLink(self, value:str):
        ...
        GetDllLibXls().OdsPageBackground_set_ImageLink(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().OdsPageBackground_get_ImageType(self.Ptr)
    ...
    def ImageType(self, value:'OdsPageBackgroundImageType'):
        ...
        GetDllLibXls().OdsPageBackground_set_ImageType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().OdsPageBackground_get_ImagePositonType(self.Ptr)
    ...
    def ImagePositonType(self, value:'OdsPageBackgroundImagePositionType'):
        ...
        GetDllLibXls().OdsPageBackground_set_ImagePositonType(self.Ptr, value.value)
