...
class RollAngleReportObject(_0.APIBase):
    ...
    class _Cast_RollAngleReportObject:
        ...
        def __init__(self, parent: 'RollAngleReportObject'):
            self._parent = parent

        @property
        def roll_angle_report_object(self) -> 'RollAngleReportObject':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollAngleReportObject._Cast_RollAngleReportObject':
