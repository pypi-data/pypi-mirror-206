...
class FEStiffnessTester(_0.APIBase):
    ...
    class _Cast_FEStiffnessTester:
        ...
        def __init__(self, parent: 'FEStiffnessTester'):
            self._parent = parent

        @property
        def fe_stiffness_tester(self) -> 'FEStiffnessTester':
            return self._parent
    ...
    @property
    def fe_stiffness(self) -> '_2363.FESubstructure':
    ...
    @property
    def force_and_displacement_results(self) -> 'List[_1549.ForceAndDisplacementResults]':
    ...
    @property
    def cast_to(self) -> 'FEStiffnessTester._Cast_FEStiffnessTester':
