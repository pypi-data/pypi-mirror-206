...
class TorqueConverterTurbineMultibodyDynamicsAnalysis(_5388.CouplingHalfMultibodyDynamicsAnalysis):
    """TorqueConverterTurbineMultibodyDynamicsAnalysis
    ...
    class _Cast_TorqueConverterTurbineMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_multibody_dynamics_analysis(self) -> 'TorqueConverterTurbineMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineMultibodyDynamicsAnalysis._Cast_TorqueConverterTurbineMultibodyDynamicsAnalysis':
