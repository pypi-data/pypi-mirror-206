...
class PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed(_3531.CylindricalGearSetSteadyStateSynchronousResponseAtASpeed):
    """PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def planetary_gear_set_steady_state_synchronous_response_at_a_speed(self) -> 'PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed._Cast_PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed':
