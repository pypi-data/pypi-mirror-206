...
from synodal import REPOS_DICT, KNOWN_REPOS, APPNAMES, FRONT_ENDS
...
class MySQL(DbEngine):
    ...
    default_port = "3306"
    apt_packages = "mysql-server mysql-client libmysqlclient-dev"
...
CONF_FILES = [str(Path(VENV) / '.getlino.conf') if VENV else '/etc/getlino/getlino.conf']
