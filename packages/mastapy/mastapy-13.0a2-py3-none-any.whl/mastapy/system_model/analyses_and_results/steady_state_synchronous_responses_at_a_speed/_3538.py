...
class FaceGearSteadyStateSynchronousResponseAtASpeed(_3543.GearSteadyStateSynchronousResponseAtASpeed):
    """FaceGearSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_FaceGearSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'FaceGearSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def face_gear_steady_state_synchronous_response_at_a_speed(self) -> 'FaceGearSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearSteadyStateSynchronousResponseAtASpeed._Cast_FaceGearSteadyStateSynchronousResponseAtASpeed':
