...
class GearSetAdvancedTimeSteppingAnalysisForModulation(_7072.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """GearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def eignenmodes_indexed_by_mode_id(self) -> 'List[_1496.Eigenmodes]':
