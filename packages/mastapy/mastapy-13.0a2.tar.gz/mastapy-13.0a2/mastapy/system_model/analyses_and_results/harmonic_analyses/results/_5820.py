...
class ResultNodeSelection(_0.APIBase):
    ...
    class _Cast_ResultNodeSelection:
        ...
        def __init__(self, parent: 'ResultNodeSelection'):
            self._parent = parent

        @property
        def result_node_selection(self) -> 'ResultNodeSelection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ResultNodeSelection._Cast_ResultNodeSelection':
