...
class ZerolBevelGearCompoundHarmonicAnalysisOfSingleExcitation(_6121.BevelGearCompoundHarmonicAnalysisOfSingleExcitation):
    """ZerolBevelGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_ZerolBevelGearCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'ZerolBevelGearCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_compound_harmonic_analysis_of_single_excitation(self) -> 'ZerolBevelGearCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6102.ZerolBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6102.ZerolBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearCompoundHarmonicAnalysisOfSingleExcitation._Cast_ZerolBevelGearCompoundHarmonicAnalysisOfSingleExcitation':
