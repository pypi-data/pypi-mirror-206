...
class SpringDamperCompoundDynamicAnalysis(_6410.CouplingCompoundDynamicAnalysis):
    """SpringDamperCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6347.SpringDamperDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6347.SpringDamperDynamicAnalysis]':
