...
class FaceGearMeshSteadyStateSynchronousResponseAtASpeed(_3541.GearMeshSteadyStateSynchronousResponseAtASpeed):
    """FaceGearMeshSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_FaceGearMeshSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'FaceGearMeshSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def face_gear_mesh_steady_state_synchronous_response_at_a_speed(self) -> 'FaceGearMeshSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearMeshSteadyStateSynchronousResponseAtASpeed._Cast_FaceGearMeshSteadyStateSynchronousResponseAtASpeed':
