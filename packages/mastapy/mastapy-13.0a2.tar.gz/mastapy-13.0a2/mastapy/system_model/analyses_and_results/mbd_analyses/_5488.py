...
class WormGearMultibodyDynamicsAnalysis(_5410.GearMultibodyDynamicsAnalysis):
    """WormGearMultibodyDynamicsAnalysis
    ...
    class _Cast_WormGearMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'WormGearMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def worm_gear_multibody_dynamics_analysis(self) -> 'WormGearMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearMultibodyDynamicsAnalysis._Cast_WormGearMultibodyDynamicsAnalysis':
