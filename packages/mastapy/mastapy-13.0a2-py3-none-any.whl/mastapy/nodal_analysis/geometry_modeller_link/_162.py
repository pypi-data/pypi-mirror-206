...
class MeshRequestResult(_0.APIBase):
    ...
    @property
    def cad_face_group(self) -> '_307.CADFaceGroup':
    ...
    def cad_face_group(self, value: '_307.CADFaceGroup'):
    ...
    @property
    def faceted_body(self) -> '_1499.FacetedBody':
    ...
    @faceted_body.setter
    def faceted_body(self, value: '_1499.FacetedBody'):
        value = value.wrapped if value else None
