...
class ElectricMachineResultsForLineToLine(_0.APIBase):
    ...
    class _Cast_ElectricMachineResultsForLineToLine:
        ...
        def __init__(self, parent: 'ElectricMachineResultsForLineToLine'):
            self._parent = parent

        @property
        def electric_machine_results_for_line_to_line(self) -> 'ElectricMachineResultsForLineToLine':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ElectricMachineResultsForLineToLine._Cast_ElectricMachineResultsForLineToLine':
        return self._Cast_ElectricMachineResultsForLineToLine(self)
