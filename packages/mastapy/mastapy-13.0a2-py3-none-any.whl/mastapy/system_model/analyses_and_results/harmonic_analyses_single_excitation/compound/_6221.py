...
class SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation(_6220.SynchroniserPartCompoundHarmonicAnalysisOfSingleExcitation):
    """SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def synchroniser_sleeve_compound_harmonic_analysis_of_single_excitation(self) -> 'SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6092.SynchroniserSleeveHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6092.SynchroniserSleeveHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation._Cast_SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation(self)
