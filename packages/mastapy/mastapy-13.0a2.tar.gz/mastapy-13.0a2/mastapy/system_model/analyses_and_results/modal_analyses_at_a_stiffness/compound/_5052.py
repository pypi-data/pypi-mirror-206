...
class RollingRingCompoundModalAnalysisAtAStiffness(_4999.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """RollingRingCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_RollingRingCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'RollingRingCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def rolling_ring_compound_modal_analysis_at_a_stiffness(self) -> 'RollingRingCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4924.RollingRingModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4924.RollingRingModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'RollingRingCompoundModalAnalysisAtAStiffness._Cast_RollingRingCompoundModalAnalysisAtAStiffness':
