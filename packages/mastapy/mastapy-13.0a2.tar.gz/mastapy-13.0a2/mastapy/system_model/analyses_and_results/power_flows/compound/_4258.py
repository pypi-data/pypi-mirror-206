...
class SynchroniserSleeveCompoundPowerFlow(_4257.SynchroniserPartCompoundPowerFlow):
    """SynchroniserSleeveCompoundPowerFlow
    ...
    class _Cast_SynchroniserSleeveCompoundPowerFlow:
        ...
        def __init__(self, parent: 'SynchroniserSleeveCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def synchroniser_sleeve_compound_power_flow(self) -> 'SynchroniserSleeveCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4128.SynchroniserSleevePowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4128.SynchroniserSleevePowerFlow]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserSleeveCompoundPowerFlow._Cast_SynchroniserSleeveCompoundPowerFlow':
