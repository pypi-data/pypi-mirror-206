...
class ToothFlankFractureStressStepAtAnalysisPointN1457(_0.APIBase):
    ...
    class _Cast_ToothFlankFractureStressStepAtAnalysisPointN1457:
        ...
        def __init__(self, parent: 'ToothFlankFractureStressStepAtAnalysisPointN1457'):
            self._parent = parent

        @property
        def tooth_flank_fracture_stress_step_at_analysis_point_n1457(self) -> 'ToothFlankFractureStressStepAtAnalysisPointN1457':
            return self._parent
    ...
    @property
    def contact_position_on_profile(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def stress(self) -> '_1553.VectorWithLinearAndAngularComponents':
    ...
    @property
    def cast_to(self) -> 'ToothFlankFractureStressStepAtAnalysisPointN1457._Cast_ToothFlankFractureStressStepAtAnalysisPointN1457':
