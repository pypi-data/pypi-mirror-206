...
class PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed(_5256.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed
    ...
    class _Cast_PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_connection_compound_modal_analysis_at_a_speed(self) -> 'PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5169.PartToPartShearCouplingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5169.PartToPartShearCouplingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed._Cast_PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed':
        return self._Cast_PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed(self)
