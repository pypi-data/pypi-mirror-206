...
class WormGearDynamicAnalysis(_6302.GearDynamicAnalysis):
    """WormGearDynamicAnalysis
    ...
    class _Cast_WormGearDynamicAnalysis:
        ...
        def __init__(self, parent: 'WormGearDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def worm_gear_dynamic_analysis(self) -> 'WormGearDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearDynamicAnalysis._Cast_WormGearDynamicAnalysis':
