...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _4000, _4001, _3892
...
class ZerolBevelGearSetCompoundStabilityAnalysis(_3892.BevelGearSetCompoundStabilityAnalysis):
    """ZerolBevelGearSetCompoundStabilityAnalysis
    ...
    class _Cast_ZerolBevelGearSetCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_compound_stability_analysis(self) -> 'ZerolBevelGearSetCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3872.ZerolBevelGearSetStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_stability_analysis(self) -> 'List[_4000.ZerolBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_stability_analysis(self) -> 'List[_4001.ZerolBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3872.ZerolBevelGearSetStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetCompoundStabilityAnalysis._Cast_ZerolBevelGearSetCompoundStabilityAnalysis':
