...
class ImportObjectOptions (SpireObject) :
    ...
    def ConvertNumericData(self)->bool:
        ...
        ret = GetDllLibXls().ImportObjectOptions_get_ConvertNumericData(self.Ptr)
        return ret
    ...
    def ConvertNumericData(self, value:bool):
        ...
        GetDllLibXls().ImportObjectOptions_set_ConvertNumericData(self.Ptr, value)
    ...
    def InsertRows(self)->bool:
        ...
        ret = GetDllLibXls().ImportObjectOptions_get_InsertRows(self.Ptr)
        return ret

    @InsertRows.setter
    def InsertRows(self, value:bool):
        GetDllLibXls().ImportObjectOptions_set_InsertRows.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ImportObjectOptions_set_InsertRows(self.Ptr, value)
    ...
    def CheckMergedCells(self)->bool:
        ...
        ret = GetDllLibXls().ImportObjectOptions_get_CheckMergedCells(self.Ptr)
        return ret
    ...
    def CheckMergedCells(self, value:bool):
        ...
        GetDllLibXls().ImportObjectOptions_set_CheckMergedCells(self.Ptr, value)
    ...
    def IsFieldNameShown(self)->bool:
        ...
        ret = GetDllLibXls().ImportObjectOptions_get_IsFieldNameShown(self.Ptr)
        return ret
    ...
    def IsFieldNameShown(self, value:bool):
        ...
        GetDllLibXls().ImportObjectOptions_set_IsFieldNameShown(self.Ptr, value)
    ...
    def DateFormat(self)->str:
        ...
        GetDllLibXls().ImportObjectOptions_get_DateFormat.restype=c_wchar_p
        ret = GetDllLibXls().ImportObjectOptions_get_DateFormat(self.Ptr)
        return ret
    ...
    def DateFormat(self, value:str):
        ...
        GetDllLibXls().ImportObjectOptions_set_DateFormat(self.Ptr, value)
