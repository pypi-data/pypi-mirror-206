...
class RichTextObject (  SpireObject, IRichTextString) :
    ...
    def GetFont(self ,position:int)->'IFont':
        """
        ...
        intPtr = GetDllLibXls().RichTextObject_GetFont(self.Ptr, position)
    ...
    def SetFont(self ,startPos:int,endPos:int,font:'IFont'):
        ...
        GetDllLibXls().RichTextObject_SetFont(self.Ptr, startPos,endPos,intPtrfont)
    ...
    <summary>
        ...
        GetDllLibXls().RichTextObject_ClearFormatting(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().RichTextObject_Clear(self.Ptr)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().RichTextObject_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().RichTextObject_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().RichTextObject_set_Text(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().RichTextObject_get_RtfText.restype=c_wchar_p
        ret = GetDllLibXls().RichTextObject_get_RtfText(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().RichTextObject_get_IsFormatted(self.Ptr)
        return ret
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().RichTextObject_get_Parent(self.Ptr)
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().RichTextObject_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().RichTextObject_EndUpdate(self.Ptr)
    ...
    def Append(self ,text:str,font:'IFont'):
        ...
        GetDllLibXls().RichTextObject_Append(self.Ptr, text,intPtrfont)
