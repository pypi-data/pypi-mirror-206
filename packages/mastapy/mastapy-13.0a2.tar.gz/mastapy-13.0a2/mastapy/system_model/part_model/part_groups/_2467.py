...
from mastapy.system_model.part_model.part_groups import _2468, _2466
...
class ConcentricPartGroup(_2466.ConcentricOrParallelPartGroup):
    """ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2468.ConcentricPartGroupParallelToThis]':
