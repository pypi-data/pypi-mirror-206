...
class StraightBevelGearMeshCompoundDynamicAnalysis(_6390.BevelGearMeshCompoundDynamicAnalysis):
    """StraightBevelGearMeshCompoundDynamicAnalysis
    ...
    class _Cast_StraightBevelGearMeshCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_compound_dynamic_analysis(self) -> 'StraightBevelGearMeshCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6353.StraightBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6353.StraightBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshCompoundDynamicAnalysis._Cast_StraightBevelGearMeshCompoundDynamicAnalysis':
