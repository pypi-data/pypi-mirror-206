...
class CylindricalPlanetGearCompoundSteadyStateSynchronousResponse(_3142.CylindricalGearCompoundSteadyStateSynchronousResponse):
    """CylindricalPlanetGearCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_CylindricalPlanetGearCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'CylindricalPlanetGearCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def cylindrical_planet_gear_compound_steady_state_synchronous_response(self) -> 'CylindricalPlanetGearCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3012.CylindricalPlanetGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3012.CylindricalPlanetGearSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'CylindricalPlanetGearCompoundSteadyStateSynchronousResponse._Cast_CylindricalPlanetGearCompoundSteadyStateSynchronousResponse':
        return self._Cast_CylindricalPlanetGearCompoundSteadyStateSynchronousResponse(self)
