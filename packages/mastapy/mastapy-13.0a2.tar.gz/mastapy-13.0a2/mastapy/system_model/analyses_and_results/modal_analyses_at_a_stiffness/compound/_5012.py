...
class ExternalCADModelCompoundModalAnalysisAtAStiffness(_4985.ComponentCompoundModalAnalysisAtAStiffness):
    """ExternalCADModelCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_ExternalCADModelCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ExternalCADModelCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def external_cad_model_compound_modal_analysis_at_a_stiffness(self) -> 'ExternalCADModelCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4883.ExternalCADModelModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4883.ExternalCADModelModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'ExternalCADModelCompoundModalAnalysisAtAStiffness._Cast_ExternalCADModelCompoundModalAnalysisAtAStiffness':
