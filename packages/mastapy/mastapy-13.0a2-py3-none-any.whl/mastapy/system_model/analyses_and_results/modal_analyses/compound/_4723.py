...
class ClutchConnectionCompoundModalAnalysis(_4739.CouplingConnectionCompoundModalAnalysis):
    """ClutchConnectionCompoundModalAnalysis
    ...
    class _Cast_ClutchConnectionCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'ClutchConnectionCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_connection_compound_modal_analysis(self) -> 'ClutchConnectionCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4568.ClutchConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4568.ClutchConnectionModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ClutchConnectionCompoundModalAnalysis._Cast_ClutchConnectionCompoundModalAnalysis':
