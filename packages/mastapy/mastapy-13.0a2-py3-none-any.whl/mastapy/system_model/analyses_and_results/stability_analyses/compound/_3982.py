...
class StraightBevelGearCompoundStabilityAnalysis(_3890.BevelGearCompoundStabilityAnalysis):
    """StraightBevelGearCompoundStabilityAnalysis
    ...
    class _Cast_StraightBevelGearCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_compound_stability_analysis(self) -> 'StraightBevelGearCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3855.StraightBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3855.StraightBevelGearStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearCompoundStabilityAnalysis._Cast_StraightBevelGearCompoundStabilityAnalysis':
