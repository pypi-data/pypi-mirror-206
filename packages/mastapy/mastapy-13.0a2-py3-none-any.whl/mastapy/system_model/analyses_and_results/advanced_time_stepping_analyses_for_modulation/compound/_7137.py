...
class ConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7163.GearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_ConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'ConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def conical_gear_set_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'ConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7007.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7007.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'ConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_ConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_ConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(self)
