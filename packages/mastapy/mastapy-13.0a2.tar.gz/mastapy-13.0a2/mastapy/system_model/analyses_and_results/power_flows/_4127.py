...
from mastapy.system_model.analyses_and_results.power_flows import _4125, _4110
...
class SynchroniserPowerFlow(_4110.SpecialisedAssemblyPowerFlow):
    """SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_4125.SynchroniserHalfPowerFlow]':
