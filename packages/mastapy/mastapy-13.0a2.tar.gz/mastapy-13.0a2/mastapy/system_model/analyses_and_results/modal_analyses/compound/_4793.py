...
class RollingRingCompoundModalAnalysis(_4740.CouplingHalfCompoundModalAnalysis):
    """RollingRingCompoundModalAnalysis
    ...
    class _Cast_RollingRingCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'RollingRingCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def rolling_ring_compound_modal_analysis(self) -> 'RollingRingCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4649.RollingRingModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4649.RollingRingModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'RollingRingCompoundModalAnalysis._Cast_RollingRingCompoundModalAnalysis':
