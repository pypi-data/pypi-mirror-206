...
class PlanetaryConnectionCompoundCriticalSpeedAnalysis(_6736.ShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """PlanetaryConnectionCompoundCriticalSpeedAnalysis
    ...
    class _Cast_PlanetaryConnectionCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'PlanetaryConnectionCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def planetary_connection_compound_critical_speed_analysis(self) -> 'PlanetaryConnectionCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6593.PlanetaryConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6593.PlanetaryConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PlanetaryConnectionCompoundCriticalSpeedAnalysis._Cast_PlanetaryConnectionCompoundCriticalSpeedAnalysis':
