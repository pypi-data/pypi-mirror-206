...
class BearingProtection(_0.APIBase):
    ...
    class _Cast_BearingProtection:
        ...
        def __init__(self, parent: 'BearingProtection'):
            self._parent = parent

        @property
        def bearing_protection(self) -> 'BearingProtection':
            return self._parent
    ...
    @property
    def protection_level(self) -> '_2130.BearingProtectionLevel':
    ...
    @property
    def cast_to(self) -> 'BearingProtection._Cast_BearingProtection':
