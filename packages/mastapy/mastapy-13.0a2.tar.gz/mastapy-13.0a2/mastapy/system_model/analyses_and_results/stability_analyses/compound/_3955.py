...
class PartToPartShearCouplingConnectionCompoundStabilityAnalysis(_3912.CouplingConnectionCompoundStabilityAnalysis):
    """PartToPartShearCouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3823.PartToPartShearCouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3823.PartToPartShearCouplingConnectionStabilityAnalysis]':
