...
class ChartDataPointsCollection (  XlsChartDataPointsCollection) :
    ...
    def Add(self ,point:'ChartDataPoint'):
        ...
        GetDllLibXls().ChartDataPointsCollection_Add(self.Ptr, intPtrpoint)
    ...
    def ClearDataFormats(self ,format:'ChartSerieDataFormat'):
        ...
        GetDllLibXls().ChartDataPointsCollection_ClearDataFormats(self.Ptr, intPtrformat)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartDataPointsCollection_get_DefaultDataPoint(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartDataPointsCollection_get_DefaultPointFormat(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartDataPointsCollection_get_Item(self.Ptr, index)
        ret = None if intPtr==None else ChartDataPoint(intPtr)
        return ret
