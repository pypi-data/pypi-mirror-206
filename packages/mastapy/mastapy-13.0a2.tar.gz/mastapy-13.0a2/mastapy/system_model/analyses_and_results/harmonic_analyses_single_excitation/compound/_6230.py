...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6228, _6229, _6165
...
class WormGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6165.GearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """WormGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_WormGearSetCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'WormGearSetCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def worm_gear_set_compound_harmonic_analysis_of_single_excitation(self) -> 'WormGearSetCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6101.WormGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_gears_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6228.WormGearCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_meshes_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6229.WormGearMeshCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6101.WormGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'WormGearSetCompoundHarmonicAnalysisOfSingleExcitation._Cast_WormGearSetCompoundHarmonicAnalysisOfSingleExcitation':
