...
class SpecialisedAssemblyCompoundHarmonicAnalysis(_5846.AbstractAssemblyCompoundHarmonicAnalysis):
    """SpecialisedAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5777.SpecialisedAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5777.SpecialisedAssemblyHarmonicAnalysis]':
