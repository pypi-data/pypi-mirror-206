...
class ElectricMachineResultsTimeStep(_0.APIBase):
    ...
    class _Cast_ElectricMachineResultsTimeStep:
        ...
        def __init__(self, parent: 'ElectricMachineResultsTimeStep'):
            self._parent = parent

        @property
        def electric_machine_results_time_step(self) -> 'ElectricMachineResultsTimeStep':
            return self._parent
    ...
    @property
    def ac_winding_loss(self) -> 'float':
        """float: 'ACWindingLoss' is the original name of this property."""
    ...
    def ac_winding_loss(self, value: 'float'):
        self.wrapped.ACWindingLoss = float(value) if value else 0.0
    ...
    @property
    def flux_density_in_air_gap_chart(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def force_density_in_air_gap_mst_chart(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def results_for_stator_teeth(self) -> 'List[_1322.ElectricMachineResultsForStatorToothAtTimeStep]':
    ...
    @property
    def results_at_locations(self) -> 'List[_1325.ElectricMachineResultsTimeStepAtLocation]':
    ...
    @property
    def results_for_line_to_line(self) -> 'List[_1323.ElectricMachineResultsLineToLineAtTimeStep]':
    ...
    @property
    def results_for_phases(self) -> 'List[_1321.ElectricMachineResultsForPhaseAtTimeStep]':
    ...
    @property
    def cast_to(self) -> 'ElectricMachineResultsTimeStep._Cast_ElectricMachineResultsTimeStep':
