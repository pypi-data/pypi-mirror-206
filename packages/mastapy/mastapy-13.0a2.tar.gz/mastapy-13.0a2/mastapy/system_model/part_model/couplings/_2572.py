...
class RigidConnectorToothLocation(_0.APIBase):
    ...
    class _Cast_RigidConnectorToothLocation:
        ...
        def __init__(self, parent: 'RigidConnectorToothLocation'):
            self._parent = parent

        @property
        def rigid_connector_tooth_location(self) -> 'RigidConnectorToothLocation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RigidConnectorToothLocation._Cast_RigidConnectorToothLocation':
