...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _3477, _3478, _3414
...
class WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft(_3414.GearSetCompoundSteadyStateSynchronousResponseOnAShaft):
    """WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def worm_gear_set_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3349.WormGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_gears_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3477.WormGearCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_meshes_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3478.WormGearMeshCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3349.WormGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft._Cast_WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft(self)
