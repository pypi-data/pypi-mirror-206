...
class PlanetCarrierCompoundModalAnalysis(_4778.MountableComponentCompoundModalAnalysis):
    """PlanetCarrierCompoundModalAnalysis
    ...
    class _Cast_PlanetCarrierCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'PlanetCarrierCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def planet_carrier_compound_modal_analysis(self) -> 'PlanetCarrierCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4641.PlanetCarrierModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4641.PlanetCarrierModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierCompoundModalAnalysis._Cast_PlanetCarrierCompoundModalAnalysis':
