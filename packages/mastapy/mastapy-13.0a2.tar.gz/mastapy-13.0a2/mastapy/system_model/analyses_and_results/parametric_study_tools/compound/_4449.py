...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4447, _4448, _4478
...
class ConceptGearSetCompoundParametricStudyTool(_4478.GearSetCompoundParametricStudyTool):
    """ConceptGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4302.ConceptGearSetParametricStudyTool]':
    ...
    @property
    def concept_gears_compound_parametric_study_tool(self) -> 'List[_4447.ConceptGearCompoundParametricStudyTool]':
    ...
    @property
    def concept_meshes_compound_parametric_study_tool(self) -> 'List[_4448.ConceptGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4302.ConceptGearSetParametricStudyTool]':
