...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6349, _6350, _6261
...
class StraightBevelDiffGearSetDynamicAnalysis(_6261.BevelGearSetDynamicAnalysis):
    """StraightBevelDiffGearSetDynamicAnalysis
    ...
    class _Cast_StraightBevelDiffGearSetDynamicAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearSetDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_set_dynamic_analysis(self) -> 'StraightBevelDiffGearSetDynamicAnalysis':
            return self._parent
    ...
    @property
    def straight_bevel_diff_gears_dynamic_analysis(self) -> 'List[_6349.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_dynamic_analysis(self) -> 'List[_6350.StraightBevelDiffGearMeshDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearSetDynamicAnalysis._Cast_StraightBevelDiffGearSetDynamicAnalysis':
