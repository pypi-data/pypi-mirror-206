...
class CylindricalGearMeshCriticalSpeedAnalysis(_6569.GearMeshCriticalSpeedAnalysis):
    """CylindricalGearMeshCriticalSpeedAnalysis
    ...
    class _Cast_CylindricalGearMeshCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'CylindricalGearMeshCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_critical_speed_analysis(self) -> 'CylindricalGearMeshCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshCriticalSpeedAnalysis._Cast_CylindricalGearMeshCriticalSpeedAnalysis':
