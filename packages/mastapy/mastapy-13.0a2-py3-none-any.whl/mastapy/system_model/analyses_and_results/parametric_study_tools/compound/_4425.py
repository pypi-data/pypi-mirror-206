...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4325, _4278
from mastapy._internal import constructor, conversion
from mastapy.system_model.part_model import _2413
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import (
    _4426, _4428, _4431, _4438,
    _4437, _4459, _4439, _4444,
    _4449, _4461, _4463, _4467,
    _4474, _4473, _4475, _4482,
    _4489, _4492, _4493, _4494,
    _4496, _4498, _4503, _4504,
    _4505, _4507, _4509, _4514,
    _4513, _4519, _4520, _4525,
    _4528, _4531, _4535, _4539,
    _4543, _4546, _4418
)
...
class AssemblyCompoundParametricStudyTool(_4418.AbstractAssemblyCompoundParametricStudyTool):
    """AssemblyCompoundParametricStudyTool
    ...
    class _Cast_AssemblyCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'AssemblyCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def assembly_compound_parametric_study_tool(self) -> 'AssemblyCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def all_duty_cycle_results(self) -> '_4325.DutyCycleResultsForAllComponents':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4278.AssemblyParametricStudyTool]':
    ...
    @property
    def bearings(self) -> 'List[_4426.BearingCompoundParametricStudyTool]':
    ...
    @property
    def belt_drives(self) -> 'List[_4428.BeltDriveCompoundParametricStudyTool]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4431.BevelDifferentialGearSetCompoundParametricStudyTool]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4438.BoltedJointCompoundParametricStudyTool]':
    ...
    @property
    def bolts(self) -> 'List[_4437.BoltCompoundParametricStudyTool]':
    ...
    @property
    def cv_ts(self) -> 'List[_4459.CVTCompoundParametricStudyTool]':
    ...
    @property
    def clutches(self) -> 'List[_4439.ClutchCompoundParametricStudyTool]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4444.ConceptCouplingCompoundParametricStudyTool]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4449.ConceptGearSetCompoundParametricStudyTool]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4461.CycloidalAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4463.CycloidalDiscCompoundParametricStudyTool]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4467.CylindricalGearSetCompoundParametricStudyTool]':
    ...
    @property
    def fe_parts(self) -> 'List[_4474.FEPartCompoundParametricStudyTool]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4473.FaceGearSetCompoundParametricStudyTool]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4475.FlexiblePinAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4482.HypoidGearSetCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4489.KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4492.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def mass_discs(self) -> 'List[_4493.MassDiscCompoundParametricStudyTool]':
    ...
    @property
    def measurement_components(self) -> 'List[_4494.MeasurementComponentCompoundParametricStudyTool]':
    ...
    @property
    def oil_seals(self) -> 'List[_4496.OilSealCompoundParametricStudyTool]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4498.PartToPartShearCouplingCompoundParametricStudyTool]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4503.PlanetCarrierCompoundParametricStudyTool]':
    ...
    @property
    def point_loads(self) -> 'List[_4504.PointLoadCompoundParametricStudyTool]':
    ...
    @property
    def power_loads(self) -> 'List[_4505.PowerLoadCompoundParametricStudyTool]':
    ...
    @property
    def ring_pins(self) -> 'List[_4507.RingPinsCompoundParametricStudyTool]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4509.RollingRingAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4514.ShaftHubConnectionCompoundParametricStudyTool]':
    ...
    @property
    def shafts(self) -> 'List[_4513.ShaftCompoundParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4519.SpiralBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4520.SpringDamperCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4525.StraightBevelDiffGearSetCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4528.StraightBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def synchronisers(self) -> 'List[_4531.SynchroniserCompoundParametricStudyTool]':
    ...
    @property
    def torque_converters(self) -> 'List[_4535.TorqueConverterCompoundParametricStudyTool]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4539.UnbalancedMassCompoundParametricStudyTool]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4543.WormGearSetCompoundParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4546.ZerolBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4278.AssemblyParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'AssemblyCompoundParametricStudyTool._Cast_AssemblyCompoundParametricStudyTool':
