...
class SpiralBevelGearCompoundDynamicAnalysis(_6389.BevelGearCompoundDynamicAnalysis):
    """SpiralBevelGearCompoundDynamicAnalysis
    ...
    class _Cast_SpiralBevelGearCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'SpiralBevelGearCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_compound_dynamic_analysis(self) -> 'SpiralBevelGearCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6343.SpiralBevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6343.SpiralBevelGearDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearCompoundDynamicAnalysis._Cast_SpiralBevelGearCompoundDynamicAnalysis':
