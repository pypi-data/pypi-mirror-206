...
class ComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3692.PartCompoundSteadyStateSynchronousResponseAtASpeed):
    """ComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3508.ComponentSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3508.ComponentSteadyStateSynchronousResponseAtASpeed]':
