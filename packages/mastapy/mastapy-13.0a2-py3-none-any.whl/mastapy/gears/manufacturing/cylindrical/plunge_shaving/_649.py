...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _640, _646
...
class RealPlungeShaverOutputs(_646.PlungeShaverOutputs):
    """RealPlungeShaverOutputs
    ...
    class _Cast_RealPlungeShaverOutputs:
        ...
        def plunge_shaver_outputs(self):
            return self._parent._cast(_646.PlungeShaverOutputs)
    ...
    @property
    def lead_measurement_method(self) -> '_640.MicroGeometryDefinitionMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _640.MicroGeometryDefinitionMethod)
        return constructor.new_from_mastapy_type(_640.MicroGeometryDefinitionMethod)(value) if value is not None else None

    @lead_measurement_method.setter
    def lead_measurement_method(self, value: '_640.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _640.MicroGeometryDefinitionMethod.type_())
    ...
    @property
    def profile_measurement_method(self) -> '_640.MicroGeometryDefinitionMethod':
    ...
    def profile_measurement_method(self, value: '_640.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _640.MicroGeometryDefinitionMethod.type_())
    ...
    @property
    def left_flank_micro_geometry(self) -> '_608.CylindricalGearSpecifiedMicroGeometry':
    ...
    @property
    def right_flank_micro_geometry(self) -> '_608.CylindricalGearSpecifiedMicroGeometry':
    ...
    @property
    def shaver(self) -> '_705.CylindricalGearPlungeShaver':
    ...
    @property
    def micro_geometry(self) -> 'List[_608.CylindricalGearSpecifiedMicroGeometry]':
