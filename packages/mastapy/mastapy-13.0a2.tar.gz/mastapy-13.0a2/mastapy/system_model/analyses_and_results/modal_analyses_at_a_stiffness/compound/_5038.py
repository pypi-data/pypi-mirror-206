...
class OilSealCompoundModalAnalysisAtAStiffness(_4996.ConnectorCompoundModalAnalysisAtAStiffness):
    """OilSealCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_OilSealCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'OilSealCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def oil_seal_compound_modal_analysis_at_a_stiffness(self) -> 'OilSealCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4909.OilSealModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4909.OilSealModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'OilSealCompoundModalAnalysisAtAStiffness._Cast_OilSealCompoundModalAnalysisAtAStiffness':
