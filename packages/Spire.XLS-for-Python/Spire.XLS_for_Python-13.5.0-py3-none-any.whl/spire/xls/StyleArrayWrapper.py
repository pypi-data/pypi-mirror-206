...
class StyleArrayWrapper (  XlsObject, IStyle, IExtendIndex) :
    ...
    def IsModified(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_IsModified(self.Ptr)
        return ret
    ...
    def Borders(self)->'IBorders':
        ...
        intPtr = GetDllLibXls().StyleArrayWrapper_get_Borders(self.Ptr)
    ...
    def BuiltIn(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_BuiltIn(self.Ptr)
        return ret
    ...
    def FillPattern(self)->'ExcelPatternType':
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_FillPattern(self.Ptr)
    ...
    def FillPattern(self, value:'ExcelPatternType'):
        ...
        GetDllLibXls().StyleArrayWrapper_set_FillPattern(self.Ptr, value.value)
    ...
    def FillBackground(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_FillBackground(self.Ptr)
    ...
    def FillBackground(self, value:'ExcelColors'):
        ...
        GetDllLibXls().StyleArrayWrapper_set_FillBackground(self.Ptr, value.value)
    ...
    def FillBackgroundRGB(self)->'Color':
        ...
        intPtr = GetDllLibXls().StyleArrayWrapper_get_FillBackgroundRGB(self.Ptr)
    ...
    def FillBackgroundRGB(self, value:'Color'):
        ...
        GetDllLibXls().StyleArrayWrapper_set_FillBackgroundRGB(self.Ptr, value.Ptr)
    ...
    def FillForeground(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_FillForeground(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def FillForeground(self, value:'ExcelColors'):
        ...
        GetDllLibXls().StyleArrayWrapper_set_FillForeground(self.Ptr, value.value)
    ...
    def FillForegroundRGB(self)->'Color':
        ...
        intPtr = GetDllLibXls().StyleArrayWrapper_get_FillForegroundRGB(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def FillForegroundRGB(self, value:'Color'):
        ...
        GetDllLibXls().StyleArrayWrapper_set_FillForegroundRGB(self.Ptr, value.Ptr)
    ...
    def Font(self)->'IFont':
        ...
        intPtr = GetDllLibXls().StyleArrayWrapper_get_Font(self.Ptr)
    ...
    def FormulaHidden(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_FormulaHidden(self.Ptr)
        return ret
    ...
    def FormulaHidden(self, value:bool):
        ...
        GetDllLibXls().StyleArrayWrapper_set_FormulaHidden(self.Ptr, value)
    ...
    def HorizontalAlignment(self)->'HorizontalAlignType':
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_HorizontalAlignment(self.Ptr)
    ...
    def HorizontalAlignment(self, value:'HorizontalAlignType'):
        ...
        GetDllLibXls().StyleArrayWrapper_set_HorizontalAlignment(self.Ptr, value.value)
    ...
    def IncludeAlignment(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_IncludeAlignment(self.Ptr)
        return ret
    ...
    def IncludeAlignment(self, value:bool):
        ...
        GetDllLibXls().StyleArrayWrapper_set_IncludeAlignment(self.Ptr, value)
    ...
    def IncludeBorder(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_IncludeBorder(self.Ptr)
        return ret
    ...
    def IncludeBorder(self, value:bool):
        ...
        GetDllLibXls().StyleArrayWrapper_set_IncludeBorder(self.Ptr, value)
    ...
    def IncludeFont(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_IncludeFont(self.Ptr)
        return ret

    @IncludeFont.setter
    def IncludeFont(self, value:bool):
        GetDllLibXls().StyleArrayWrapper_set_IncludeFont.argtypes=[c_void_p, c_bool]
        GetDllLibXls().StyleArrayWrapper_set_IncludeFont(self.Ptr, value)
    ...
    def IncludeNumberFormat(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_IncludeNumberFormat(self.Ptr)
        return ret
    ...
    def IncludeNumberFormat(self, value:bool):
        ...
        GetDllLibXls().StyleArrayWrapper_set_IncludeNumberFormat(self.Ptr, value)
    ...
    def IncludePatterns(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_IncludePatterns(self.Ptr)
        return ret
    ...
    def IncludePatterns(self, value:bool):
        ...
        GetDllLibXls().StyleArrayWrapper_set_IncludePatterns(self.Ptr, value)
    ...
    def IncludeProtection(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_IncludeProtection(self.Ptr)
        return ret
    ...
    def IncludeProtection(self, value:bool):
        ...
        GetDllLibXls().StyleArrayWrapper_set_IncludeProtection(self.Ptr, value)
    ...
    def IndentLevel(self)->int:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_IndentLevel(self.Ptr)
        return ret

    @IndentLevel.setter
    def IndentLevel(self, value:int):
        GetDllLibXls().StyleArrayWrapper_set_IndentLevel.argtypes=[c_void_p, c_int]
        GetDllLibXls().StyleArrayWrapper_set_IndentLevel(self.Ptr, value)
    ...
    def IsInitialized(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_IsInitialized(self.Ptr)
        return ret
    ...
    def Locked(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_Locked(self.Ptr)
        return ret

    @Locked.setter
    def Locked(self, value:bool):
        GetDllLibXls().StyleArrayWrapper_set_Locked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().StyleArrayWrapper_set_Locked(self.Ptr, value)
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().StyleArrayWrapper_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().StyleArrayWrapper_get_Name(self.Ptr)
        return ret
    ...
    def NumberFormat(self)->str:
        ...
        GetDllLibXls().StyleArrayWrapper_get_NumberFormat.restype=c_wchar_p
        ret = GetDllLibXls().StyleArrayWrapper_get_NumberFormat(self.Ptr)
        return ret
    ...
    def NumberFormat(self, value:str):
        ...
        GetDllLibXls().StyleArrayWrapper_set_NumberFormat(self.Ptr, value)
    ...
    def NumberFormatIndex(self)->int:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_NumberFormatIndex(self.Ptr)
        return ret
    ...
    def NumberFormatIndex(self, value:int):
        ...
        GetDllLibXls().StyleArrayWrapper_set_NumberFormatIndex(self.Ptr, value)
    ...
    def NumberFormatSettings(self)->'INumberFormat':
        ...
        intPtr = GetDllLibXls().StyleArrayWrapper_get_NumberFormatSettings(self.Ptr)
    ...
    def Rotation(self)->int:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:int):
        GetDllLibXls().StyleArrayWrapper_set_Rotation.argtypes=[c_void_p, c_int]
        GetDllLibXls().StyleArrayWrapper_set_Rotation(self.Ptr, value)
    ...
    def ShrinkToFit(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_ShrinkToFit(self.Ptr)
        return ret

    @ShrinkToFit.setter
    def ShrinkToFit(self, value:bool):
        GetDllLibXls().StyleArrayWrapper_set_ShrinkToFit.argtypes=[c_void_p, c_bool]
        GetDllLibXls().StyleArrayWrapper_set_ShrinkToFit(self.Ptr, value)
    ...
    def VerticalAlignment(self)->'VerticalAlignType':
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_VerticalAlignment(self.Ptr)
    ...
    def VerticalAlignment(self, value:'VerticalAlignType'):
        ...
        GetDllLibXls().StyleArrayWrapper_set_VerticalAlignment(self.Ptr, value.value)
    ...
    def WrapText(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_WrapText(self.Ptr)
        return ret

    @WrapText.setter
    def WrapText(self, value:bool):
        GetDllLibXls().StyleArrayWrapper_set_WrapText.argtypes=[c_void_p, c_bool]
        GetDllLibXls().StyleArrayWrapper_set_WrapText(self.Ptr, value)
    ...
    def ReadingOrder(self)->'ReadingOrderType':
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_ReadingOrder(self.Ptr)
    ...
    def ReadingOrder(self, value:'ReadingOrderType'):
        ...
        GetDllLibXls().StyleArrayWrapper_set_ReadingOrder(self.Ptr, value.value)
    ...
    def IsFirstSymbolApostrophe(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_IsFirstSymbolApostrophe(self.Ptr)
        return ret
    ...
    def IsFirstSymbolApostrophe(self, value:bool):
        ...
        GetDllLibXls().StyleArrayWrapper_set_IsFirstSymbolApostrophe(self.Ptr, value)
    ...
    def PatternKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_PatternKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def PatternKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().StyleArrayWrapper_set_PatternKnownColor(self.Ptr, value.value)
    ...
    def PatternColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().StyleArrayWrapper_get_PatternColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def PatternColor(self, value:'Color'):
        ...
        GetDllLibXls().StyleArrayWrapper_set_PatternColor(self.Ptr, value.Ptr)
    ...
    def KnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_KnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().StyleArrayWrapper_set_KnownColor(self.Ptr, value.value)
    ...
    def Color(self)->'Color':
        ...
        intPtr = GetDllLibXls().StyleArrayWrapper_get_Color(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().StyleArrayWrapper_set_Color(self.Ptr, value.Ptr)
    ...
    def Interior(self)->'IInterior':
        ...
        intPtr = GetDllLibXls().StyleArrayWrapper_get_Interior(self.Ptr)
    ...
    def SetThemeColor(self ,type:'ThemeColorType',tint:float):
        ...
        GetDllLibXls().StyleArrayWrapper_SetThemeColor(self.Ptr, enumtype,tint)
...
#        ret = GetDllLibXls().StyleArrayWrapper_GetThemeColor(self.Ptr, intPtrtype,intPtrtint)
#        return ret
    ...
    def JustifyLast(self)->bool:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_JustifyLast(self.Ptr)
        return ret

    @JustifyLast.setter
    def JustifyLast(self, value:bool):
        GetDllLibXls().StyleArrayWrapper_set_JustifyLast.argtypes=[c_void_p, c_bool]
        GetDllLibXls().StyleArrayWrapper_set_JustifyLast(self.Ptr, value)
    ...
    def NumberFormatLocal(self)->str:
        ...
        GetDllLibXls().StyleArrayWrapper_get_NumberFormatLocal.restype=c_wchar_p
        ret = GetDllLibXls().StyleArrayWrapper_get_NumberFormatLocal(self.Ptr)
        return ret
    ...
    def NumberFormatLocal(self, value:str):
        ...
        GetDllLibXls().StyleArrayWrapper_set_NumberFormatLocal(self.Ptr, value)
    ...
    def ExtendedFormatIndex(self)->int:
        ...
        ret = GetDllLibXls().StyleArrayWrapper_get_ExtendedFormatIndex(self.Ptr)
        return ret
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().StyleArrayWrapper_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().StyleArrayWrapper_EndUpdate(self.Ptr)
