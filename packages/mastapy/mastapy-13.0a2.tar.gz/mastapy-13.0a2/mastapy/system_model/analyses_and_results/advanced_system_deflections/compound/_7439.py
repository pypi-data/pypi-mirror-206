...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7437, _7438, _7436
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection(_7436.KlingelnbergCycloPalloidConicalGearSetCompoundAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7308.KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_advanced_system_deflection(self) -> 'List[_7437.KlingelnbergCycloPalloidHypoidGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_advanced_system_deflection(self) -> 'List[_7438.KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7308.KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection]':
