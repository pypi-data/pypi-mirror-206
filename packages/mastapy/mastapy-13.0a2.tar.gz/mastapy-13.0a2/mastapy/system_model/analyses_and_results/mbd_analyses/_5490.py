...
class ZerolBevelGearMeshMultibodyDynamicsAnalysis(_5365.BevelGearMeshMultibodyDynamicsAnalysis):
    """ZerolBevelGearMeshMultibodyDynamicsAnalysis
    ...
    class _Cast_ZerolBevelGearMeshMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearMeshMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_mesh_multibody_dynamics_analysis(self) -> 'ZerolBevelGearMeshMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearMeshMultibodyDynamicsAnalysis._Cast_ZerolBevelGearMeshMultibodyDynamicsAnalysis':
