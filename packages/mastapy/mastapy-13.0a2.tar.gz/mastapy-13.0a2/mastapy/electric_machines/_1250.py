...
class CoreLossCoefficients(_0.APIBase):
    ...
    class _Cast_CoreLossCoefficients:
        ...
        def __init__(self, parent: 'CoreLossCoefficients'):
            self._parent = parent

        @property
        def core_loss_coefficients(self) -> 'CoreLossCoefficients':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CoreLossCoefficients._Cast_CoreLossCoefficients':
