...
from mastapy.system_model.fe import _2380, _2370
...
class FESubstructureWithSelectionForStaticAnalysis(_2370.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    class _Cast_FESubstructureWithSelectionForStaticAnalysis:
        ...
        def __init__(self, parent: 'FESubstructureWithSelectionForStaticAnalysis'):
            self._parent = parent
        ...
        @property
        def fe_substructure_with_selection_for_static_analysis(self) -> 'FESubstructureWithSelectionForStaticAnalysis':
            return self._parent
    ...
    @property
    def full_fe_results(self) -> '_231.StaticCMSResults':
    ...
    @property
    def static_draw_style(self) -> '_188.FEModelStaticAnalysisDrawStyle':
    ...
    @property
    def boundary_conditions_all_nodes(self) -> 'List[_2380.NodeBoundaryConditionStaticAnalysis]':
    ...
    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_2380.NodeBoundaryConditionStaticAnalysis]':
    ...
    @property
    def displacement_results(self) -> 'List[_1553.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def force_results(self) -> 'List[_1553.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def cast_to(self) -> 'FESubstructureWithSelectionForStaticAnalysis._Cast_FESubstructureWithSelectionForStaticAnalysis':
