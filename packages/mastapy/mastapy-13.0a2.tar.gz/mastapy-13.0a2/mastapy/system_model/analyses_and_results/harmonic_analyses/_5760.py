...
class PlanetaryConnectionHarmonicAnalysis(_5775.ShaftToMountableComponentConnectionHarmonicAnalysis):
    """PlanetaryConnectionHarmonicAnalysis
    ...
    class _Cast_PlanetaryConnectionHarmonicAnalysis:
        ...
        def __init__(self, parent: 'PlanetaryConnectionHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def planetary_connection_harmonic_analysis(self) -> 'PlanetaryConnectionHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetaryConnectionHarmonicAnalysis._Cast_PlanetaryConnectionHarmonicAnalysis':
