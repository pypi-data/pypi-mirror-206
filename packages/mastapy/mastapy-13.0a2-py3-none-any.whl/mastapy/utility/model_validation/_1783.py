...
from mastapy.utility.model_validation import _1780
...
class StatusItem(_0.APIBase):
    ...
    class _Cast_StatusItem:
        ...
        def __init__(self, parent: 'StatusItem'):
            self._parent = parent
    ...
    @property
    def cast_to(self) -> 'StatusItem._Cast_StatusItem':
