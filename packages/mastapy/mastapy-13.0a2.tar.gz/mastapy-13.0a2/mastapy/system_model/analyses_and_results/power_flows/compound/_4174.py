...
class ConicalGearCompoundPowerFlow(_4200.GearCompoundPowerFlow):
    """ConicalGearCompoundPowerFlow
    ...
    class _Cast_ConicalGearCompoundPowerFlow:
        ...
        def __init__(self, parent: 'ConicalGearCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def conical_gear_compound_power_flow(self) -> 'ConicalGearCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4042.ConicalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4042.ConicalGearPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'ConicalGearCompoundPowerFlow._Cast_ConicalGearCompoundPowerFlow':
