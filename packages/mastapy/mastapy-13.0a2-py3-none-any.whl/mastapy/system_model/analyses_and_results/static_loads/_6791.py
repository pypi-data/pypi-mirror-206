...
class BevelDifferentialSunGearLoadCase(_6787.BevelDifferentialGearLoadCase):
    """BevelDifferentialSunGearLoadCase
    ...
    class _Cast_BevelDifferentialSunGearLoadCase:
        ...
        def __init__(self, parent: 'BevelDifferentialSunGearLoadCase'):
            self._parent = parent
        ...
        @property
        def bevel_differential_sun_gear_load_case(self) -> 'BevelDifferentialSunGearLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialSunGearLoadCase._Cast_BevelDifferentialSunGearLoadCase':
