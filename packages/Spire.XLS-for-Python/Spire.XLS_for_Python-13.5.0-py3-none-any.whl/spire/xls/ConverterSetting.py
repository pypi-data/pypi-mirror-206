...
#        GetDllLibXls().ConverterSetting_set_PrintPageEventHandler(self.Ptr, value.Ptr)
...
#        intPtr = GetDllLibXls().ConverterSetting_get_PrintPageEventHandler(self.Ptr)
...
#
    ...
    <summary>
        ...
        ret = GetDllLibXls().ConverterSetting_get_XDpi(self.Ptr)
        return ret

    @XDpi.setter
    def XDpi(self, value:int):
        GetDllLibXls().ConverterSetting_set_XDpi.argtypes=[c_void_p, c_int]
        GetDllLibXls().ConverterSetting_set_XDpi(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ConverterSetting_get_YDpi(self.Ptr)
        return ret

    @YDpi.setter
    def YDpi(self, value:int):
        GetDllLibXls().ConverterSetting_set_YDpi.argtypes=[c_void_p, c_int]
        GetDllLibXls().ConverterSetting_set_YDpi(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ConverterSetting_get_PrintWithSheetPageSetting(self.Ptr)
        return ret
    ...
    def PrintWithSheetPageSetting(self, value:bool):
        ...
        GetDllLibXls().ConverterSetting_set_PrintWithSheetPageSetting(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ConverterSetting_get_JPEGQuality(self.Ptr)
        return ret

    @JPEGQuality.setter
    def JPEGQuality(self, value:int):
        GetDllLibXls().ConverterSetting_set_JPEGQuality.argtypes=[c_void_p, c_int]
        GetDllLibXls().ConverterSetting_set_JPEGQuality(self.Ptr, value)
    ...
    def ImageFormat(self)->'ImageFormat':
        ...
        intPtr = GetDllLibXls().ConverterSetting_get_ImageFormat(self.Ptr)
    ...
    def ImageFormat(self, value:'ImageFormat'):
        ...
        GetDllLibXls().ConverterSetting_set_ImageFormat(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ConverterSetting_get_IsCellAutoFit(self.Ptr)
        return ret
    ...
    def IsCellAutoFit(self, value:bool):
        ...
        GetDllLibXls().ConverterSetting_set_IsCellAutoFit(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ConverterSetting_get_SheetFitToPage(self.Ptr)
        return ret
    ...
    def SheetFitToPage(self, value:bool):
        ...
        GetDllLibXls().ConverterSetting_set_SheetFitToPage(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ConverterSetting_get_SheetFitToWidth(self.Ptr)
        return ret
    ...
    def SheetFitToWidth(self, value:bool):
        ...
        GetDllLibXls().ConverterSetting_set_SheetFitToWidth(self.Ptr, value)
    ...
    def IsReCalculateOnConvert(self)->bool:
        ...
        ret = GetDllLibXls().ConverterSetting_get_IsReCalculateOnConvert(self.Ptr)
        return ret
    ...
    def IsReCalculateOnConvert(self, value:bool):
        ...
        GetDllLibXls().ConverterSetting_set_IsReCalculateOnConvert(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ConverterSetting_get_IgnoreErrorCalculateResult(self.Ptr)
        return ret
    ...
    def IgnoreErrorCalculateResult(self, value:bool):
        ...
        GetDllLibXls().ConverterSetting_set_IgnoreErrorCalculateResult(self.Ptr, value)
    ...
    def ClearCacheOnConverted(self)->bool:
        ...
        ret = GetDllLibXls().ConverterSetting_get_ClearCacheOnConverted(self.Ptr)
        return ret
    ...
    def ClearCacheOnConverted(self, value:bool):
        ...
        GetDllLibXls().ConverterSetting_set_ClearCacheOnConverted(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ConverterSetting_get_PdfConformanceLevel(self.Ptr)
    ...
    def PdfConformanceLevel(self, value:'PdfConformanceLevel'):
        ...
        GetDllLibXls().ConverterSetting_set_PdfConformanceLevel(self.Ptr, value.value)
...
#        intPtr = GetDllLibXls().ConverterSetting_get_PdfSecurity(self.Ptr)
...
#
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ConverterSetting_get_ChartImageType(self.Ptr)
        ret = None if intPtr==None else ImageFormat(intPtr)
        return ret
    ...
    def ChartImageType(self, value:'ImageFormat'):
        ...
        GetDllLibXls().ConverterSetting_set_ChartImageType(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ConverterSetting_get_IsRegionClip(self.Ptr)
        return ret

    @IsRegionClip.setter
    def IsRegionClip(self, value:bool):
        GetDllLibXls().ConverterSetting_set_IsRegionClip.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ConverterSetting_set_IsRegionClip(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ConverterSetting_get_MaxConvertPages(self.Ptr)
        return ret
    ...
    def MaxConvertPages(self, value:int):
        ...
        GetDllLibXls().ConverterSetting_set_MaxConvertPages(self.Ptr, value)
