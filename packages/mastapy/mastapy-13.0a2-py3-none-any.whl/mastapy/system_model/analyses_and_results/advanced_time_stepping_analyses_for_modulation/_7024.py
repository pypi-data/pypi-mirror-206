...
class DatumAdvancedTimeSteppingAnalysisForModulation(_6998.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """DatumAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_DatumAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'DatumAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def datum_advanced_time_stepping_analysis_for_modulation(self) -> 'DatumAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2730.DatumSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'DatumAdvancedTimeSteppingAnalysisForModulation._Cast_DatumAdvancedTimeSteppingAnalysisForModulation':
