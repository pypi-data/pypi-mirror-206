...
class FEPartCompoundSteadyStateSynchronousResponseAtASpeed(_3615.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed):
    """FEPartCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_FEPartCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'FEPartCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def fe_part_compound_steady_state_synchronous_response_at_a_speed(self) -> 'FEPartCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3539.FEPartSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3539.FEPartSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'FEPartCompoundSteadyStateSynchronousResponseAtASpeed._Cast_FEPartCompoundSteadyStateSynchronousResponseAtASpeed':
