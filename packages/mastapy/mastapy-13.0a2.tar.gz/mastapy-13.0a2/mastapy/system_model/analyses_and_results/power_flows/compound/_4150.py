...
class BearingCompoundPowerFlow(_4178.ConnectorCompoundPowerFlow):
    """BearingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4017.BearingPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4017.BearingPowerFlow]':
