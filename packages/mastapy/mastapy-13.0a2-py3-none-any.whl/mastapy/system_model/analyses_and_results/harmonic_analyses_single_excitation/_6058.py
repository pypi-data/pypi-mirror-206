...
class PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation(_6014.CouplingHarmonicAnalysisOfSingleExcitation):
    """PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_harmonic_analysis_of_single_excitation(self) -> 'PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation._Cast_PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation':
        return self._Cast_PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation(self)
