...
class PlainJournalHousing(_0.APIBase):
    ...
    class _Cast_PlainJournalHousing:
        ...
        def cylindrical_housing_journal_bearing(self):
            ...
            return self._parent._cast(_2170.CylindricalHousingJournalBearing)

        @property
        def machinery_encased_journal_bearing(self):
            from mastapy.bearings.bearing_designs.fluid_film import _2171
            
            return self._parent._cast(_2171.MachineryEncasedJournalBearing)

        @property
        def pedestal_journal_bearing(self):
            from mastapy.bearings.bearing_designs.fluid_film import _2173
            
            return self._parent._cast(_2173.PedestalJournalBearing)
    ...
    @property
    def heat_emitting_area_method(self) -> '_1928.DefaultOrUserInput':
        ...
        value = conversion.pn_to_mp_enum(temp, _1928.DefaultOrUserInput)
        return constructor.new_from_mastapy_type(_1928.DefaultOrUserInput)(value) if value is not None else None

    @heat_emitting_area_method.setter
    def heat_emitting_area_method(self, value: '_1928.DefaultOrUserInput'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1928.DefaultOrUserInput.type_())
