...
class KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed(_5122.ConicalGearModalAnalysisAtASpeed):
    """KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed
    ...
    class _Cast_KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_conical_gear_modal_analysis_at_a_speed(self) -> 'KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed._Cast_KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed':
