...
class StraightBevelDiffGearMeshHarmonicAnalysis(_5666.BevelGearMeshHarmonicAnalysis):
    """StraightBevelDiffGearMeshHarmonicAnalysis
    ...
    class _Cast_StraightBevelDiffGearMeshHarmonicAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearMeshHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_mesh_harmonic_analysis(self) -> 'StraightBevelDiffGearMeshHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearMeshHarmonicAnalysis._Cast_StraightBevelDiffGearMeshHarmonicAnalysis':
