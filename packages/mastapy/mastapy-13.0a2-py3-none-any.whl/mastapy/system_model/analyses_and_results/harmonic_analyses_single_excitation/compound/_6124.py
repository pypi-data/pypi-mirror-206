...
class BoltCompoundHarmonicAnalysisOfSingleExcitation(_6130.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """BoltCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_BoltCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'BoltCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def bolt_compound_harmonic_analysis_of_single_excitation(self) -> 'BoltCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5995.BoltHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5995.BoltHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'BoltCompoundHarmonicAnalysisOfSingleExcitation._Cast_BoltCompoundHarmonicAnalysisOfSingleExcitation':
