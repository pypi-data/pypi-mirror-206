...
class RingPinsCompoundModalAnalysisAtASpeed(_5295.MountableComponentCompoundModalAnalysisAtASpeed):
    """RingPinsCompoundModalAnalysisAtASpeed
    ...
    class _Cast_RingPinsCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'RingPinsCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def ring_pins_compound_modal_analysis_at_a_speed(self) -> 'RingPinsCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5178.RingPinsModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5178.RingPinsModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'RingPinsCompoundModalAnalysisAtASpeed._Cast_RingPinsCompoundModalAnalysisAtASpeed':
