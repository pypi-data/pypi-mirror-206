...
class PowerLoadCompoundPowerFlow(_4264.VirtualComponentCompoundPowerFlow):
    """PowerLoadCompoundPowerFlow
    ...
    class _Cast_PowerLoadCompoundPowerFlow:
        ...
        def __init__(self, parent: 'PowerLoadCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def power_load_compound_power_flow(self) -> 'PowerLoadCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4099.PowerLoadPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4099.PowerLoadPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'PowerLoadCompoundPowerFlow._Cast_PowerLoadCompoundPowerFlow':
