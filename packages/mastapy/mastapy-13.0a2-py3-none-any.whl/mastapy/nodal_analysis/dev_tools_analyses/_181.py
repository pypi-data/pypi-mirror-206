...
from mastapy.nodal_analysis.dev_tools_analyses import _196, _186
...
class FEModel(_0.APIBase):
    ...
    class _Cast_FEModel:
        ...
        def __init__(self, parent: 'FEModel'):
            self._parent = parent
    ...
    @property
    def model_splitting_method(self) -> '_196.ModelSplittingMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _196.ModelSplittingMethod)
        return constructor.new_from_mastapy_type(_196.ModelSplittingMethod)(value) if value is not None else None

    @model_splitting_method.setter
    def model_splitting_method(self, value: '_196.ModelSplittingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _196.ModelSplittingMethod.type_())
    ...
    @property
    def beam_element_properties(self) -> 'List[_206.ElementPropertiesBeam]':
    ...
    @property
    def coordinate_systems(self) -> 'List[_201.CoordinateSystemReporting]':
    ...
    @property
    def interface_element_properties(self) -> 'List[_207.ElementPropertiesInterface]':
    ...
    @property
    def mass_element_properties(self) -> 'List[_208.ElementPropertiesMass]':
    ...
    @property
    def materials(self) -> 'List[_214.MaterialPropertiesReporting]':
    ...
    @property
    def model_parts(self) -> 'List[_186.FEModelPart]':
    ...
    @property
    def other_element_properties(self) -> 'List[_205.ElementPropertiesBase]':
    ...
    @property
    def rigid_element_properties(self) -> 'List[_209.ElementPropertiesRigid]':
    ...
    @property
    def shell_element_properties(self) -> 'List[_210.ElementPropertiesShell]':
    ...
    @property
    def solid_element_properties(self) -> 'List[_211.ElementPropertiesSolid]':
    ...
    @property
    def spring_dashpot_element_properties(self) -> 'List[_212.ElementPropertiesSpringDashpot]':
    ...
    def get_all_element_details(self) -> '_204.ElementDetailsForFEModel':
    ...
    def get_all_node_details(self) -> '_215.NodeDetailsForFEModel':
    ...
    @property
    def cast_to(self) -> 'FEModel._Cast_FEModel':
