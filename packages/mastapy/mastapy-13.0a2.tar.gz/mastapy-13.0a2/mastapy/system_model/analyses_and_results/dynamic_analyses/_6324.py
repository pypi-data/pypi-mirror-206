...
class PartToPartShearCouplingConnectionDynamicAnalysis(_6280.CouplingConnectionDynamicAnalysis):
    """PartToPartShearCouplingConnectionDynamicAnalysis
    ...
    class _Cast_PartToPartShearCouplingConnectionDynamicAnalysis:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingConnectionDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_connection_dynamic_analysis(self) -> 'PartToPartShearCouplingConnectionDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingConnectionDynamicAnalysis._Cast_PartToPartShearCouplingConnectionDynamicAnalysis':
