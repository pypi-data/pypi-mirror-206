...
class NotchSpecification(_0.APIBase):
    ...
    class _Cast_NotchSpecification:
        ...
        def __init__(self, parent: 'NotchSpecification'):
            self._parent = parent

        @property
        def notch_specification(self) -> 'NotchSpecification':
            return self._parent
    ...
    @property
    def notch_shape(self) -> '_1277.NotchShape':
        ...
        value = conversion.pn_to_mp_enum(temp, _1277.NotchShape)
        return constructor.new_from_mastapy_type(_1277.NotchShape)(value) if value is not None else None

    @notch_shape.setter
    def notch_shape(self, value: '_1277.NotchShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1277.NotchShape.type_())
    ...
    @property
    def cast_to(self) -> 'NotchSpecification._Cast_NotchSpecification':
