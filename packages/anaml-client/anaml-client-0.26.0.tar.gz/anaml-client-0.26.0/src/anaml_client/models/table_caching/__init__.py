...
class TableCache:
    ...
    def from_json(cls, data: dict) -> TableCache:
        ...
        try:
            ...
            return TableCache(
                ...
                hashBits=(lambda v: v and HashBits.from_json(v))(data.get("hashBits", None)),
    ...
    def to_json(self) -> dict:
        ...
        return {
            ...
            "hashBits": (lambda v: v and v.to_json())(self.hashBits),
...
class TableCachingJobCreationRequest:
    ...
    def from_json(cls, data: dict) -> TableCachingJobCreationRequest:
        ...
        try:
            ...
            return TableCachingJobCreationRequest(
                ...
                retainment=(
                    lambda v: v and Duration.from_json(v)
                )(
    ...
    def to_json(self) -> dict:
        ...
        return {
            ...
            "retainment": (lambda v: v and v.to_json())(self.retainment),
