...
class StraightBevelGearCompoundSteadyStateSynchronousResponse(_3111.BevelGearCompoundSteadyStateSynchronousResponse):
    """StraightBevelGearCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_StraightBevelGearCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'StraightBevelGearCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_compound_steady_state_synchronous_response(self) -> 'StraightBevelGearCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3076.StraightBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3076.StraightBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearCompoundSteadyStateSynchronousResponse._Cast_StraightBevelGearCompoundSteadyStateSynchronousResponse':
