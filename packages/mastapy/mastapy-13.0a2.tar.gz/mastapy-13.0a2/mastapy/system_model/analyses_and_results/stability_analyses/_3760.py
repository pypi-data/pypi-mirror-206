...
class BevelGearStabilityAnalysis(_3748.AGMAGleasonConicalGearStabilityAnalysis):
    """BevelGearStabilityAnalysis
    ...
    class _Cast_BevelGearStabilityAnalysis:
        ...
        def __init__(self, parent: 'BevelGearStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_gear_stability_analysis(self) -> 'BevelGearStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearStabilityAnalysis._Cast_BevelGearStabilityAnalysis':
