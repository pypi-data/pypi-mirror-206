...
class GearSetGroupDutyCycle(_0.APIBase):
    ...
    class _Cast_GearSetGroupDutyCycle:
        ...
        def __init__(self, parent: 'GearSetGroupDutyCycle'):
            self._parent = parent

        @property
        def gear_set_group_duty_cycle(self) -> 'GearSetGroupDutyCycle':
            return self._parent
    ...
    @property
    def loaded_rating_duty_cycles(self) -> 'List[_358.GearSetDutyCycleRating]':
    ...
    @property
    def rating_duty_cycles(self) -> 'List[_358.GearSetDutyCycleRating]':
    ...
    @property
    def cast_to(self) -> 'GearSetGroupDutyCycle._Cast_GearSetGroupDutyCycle':
