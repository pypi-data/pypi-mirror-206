...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5908, _5909, _5852
...
class HypoidGearSetCompoundHarmonicAnalysis(_5852.AGMAGleasonConicalGearSetCompoundHarmonicAnalysis):
    """HypoidGearSetCompoundHarmonicAnalysis
    ...
    class _Cast_HypoidGearSetCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'HypoidGearSetCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_set_compound_harmonic_analysis(self) -> 'HypoidGearSetCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5740.HypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def hypoid_gears_compound_harmonic_analysis(self) -> 'List[_5908.HypoidGearCompoundHarmonicAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_harmonic_analysis(self) -> 'List[_5909.HypoidGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5740.HypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearSetCompoundHarmonicAnalysis._Cast_HypoidGearSetCompoundHarmonicAnalysis':
