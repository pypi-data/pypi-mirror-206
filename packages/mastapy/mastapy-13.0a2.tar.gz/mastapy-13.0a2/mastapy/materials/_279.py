...
class SoundPressureEnclosure(_0.APIBase):
    ...
    @property
    def enclosure_type(self) -> '_280.SoundPressureEnclosureType':
        ...
        value = conversion.pn_to_mp_enum(temp, _280.SoundPressureEnclosureType)
        return constructor.new_from_mastapy_type(_280.SoundPressureEnclosureType)(value) if value is not None else None

    @enclosure_type.setter
    def enclosure_type(self, value: '_280.SoundPressureEnclosureType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _280.SoundPressureEnclosureType.type_())
