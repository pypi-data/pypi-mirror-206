...
class OptimisationHistory(_0.APIBase):
    ...
    class _Cast_OptimisationHistory:
        ...
        def __init__(self, parent: 'OptimisationHistory'):
            self._parent = parent

        @property
        def optimisation_history(self) -> 'OptimisationHistory':
            return self._parent
    ...
    @property
    def input_history(self) -> 'List[_1534.OptimizationVariable]':
    ...
    @property
    def target_history(self) -> 'List[_1534.OptimizationVariable]':
    ...
    def add_input_history(self, value: '_1534.OptimizationVariable'):
    ...
    def add_target_history(self, value: '_1534.OptimizationVariable'):
    ...
    @property
    def cast_to(self) -> 'OptimisationHistory._Cast_OptimisationHistory':
