...
Example: 389"""
    ...
    restrict_discovery_to_site = fields.Boolean(
...
* subtree"""
    ...
    """ad_domain,base_dn,base_scope,bind_as_cifs_server,bind_dn,bind_password,group_dn,group_membership_filter,group_scope,is_netgroup_byhost_enabled,ldaps_enabled,min_bind_level,netgroup_byhost_dn,netgroup_byhost_scope,netgroup_dn,netgroup_scope,port,preferred_ad_servers,query_timeout,referral_enabled,restrict_discovery_to_site,schema,servers,session_security,skip_config_validation,status,svm.name,svm.uuid,try_channel_binding,use_start_tls,user_dn,user_scope,"""
