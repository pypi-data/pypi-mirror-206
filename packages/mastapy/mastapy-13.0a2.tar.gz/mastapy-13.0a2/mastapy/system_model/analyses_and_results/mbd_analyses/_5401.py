...
class DatumMultibodyDynamicsAnalysis(_5375.ComponentMultibodyDynamicsAnalysis):
    """DatumMultibodyDynamicsAnalysis
    ...
    class _Cast_DatumMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'DatumMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def datum_multibody_dynamics_analysis(self) -> 'DatumMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DatumMultibodyDynamicsAnalysis._Cast_DatumMultibodyDynamicsAnalysis':
