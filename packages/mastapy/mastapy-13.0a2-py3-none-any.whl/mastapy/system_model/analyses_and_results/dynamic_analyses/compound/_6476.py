...
class SpringDamperConnectionCompoundDynamicAnalysis(_6411.CouplingConnectionCompoundDynamicAnalysis):
    """SpringDamperConnectionCompoundDynamicAnalysis
    ...
    class _Cast_SpringDamperConnectionCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'SpringDamperConnectionCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_compound_dynamic_analysis(self) -> 'SpringDamperConnectionCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6346.SpringDamperConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6346.SpringDamperConnectionDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionCompoundDynamicAnalysis._Cast_SpringDamperConnectionCompoundDynamicAnalysis':
