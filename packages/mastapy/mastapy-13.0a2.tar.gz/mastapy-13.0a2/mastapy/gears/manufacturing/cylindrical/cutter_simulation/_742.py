...
class VirtualSimulationCalculator(_726.CutterSimulationCalc):
    """VirtualSimulationCalculator
    ...
    class _Cast_VirtualSimulationCalculator:
        ...
        def __init__(self, parent: 'VirtualSimulationCalculator'):
            self._parent = parent
        ...
        @property
        def virtual_simulation_calculator(self) -> 'VirtualSimulationCalculator':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'VirtualSimulationCalculator._Cast_VirtualSimulationCalculator':
