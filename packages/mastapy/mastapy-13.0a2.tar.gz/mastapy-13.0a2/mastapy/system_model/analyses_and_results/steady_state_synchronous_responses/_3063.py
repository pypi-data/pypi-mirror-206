...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3064, _3062, _2979
...
class SpiralBevelGearSetSteadyStateSynchronousResponse(_2979.BevelGearSetSteadyStateSynchronousResponse):
    """SpiralBevelGearSetSteadyStateSynchronousResponse
    ...
    class _Cast_SpiralBevelGearSetSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'SpiralBevelGearSetSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_set_steady_state_synchronous_response(self) -> 'SpiralBevelGearSetSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def spiral_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3064.SpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3062.SpiralBevelGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearSetSteadyStateSynchronousResponse._Cast_SpiralBevelGearSetSteadyStateSynchronousResponse':
