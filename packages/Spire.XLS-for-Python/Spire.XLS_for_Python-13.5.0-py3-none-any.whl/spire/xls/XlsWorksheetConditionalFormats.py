...
class XlsWorksheetConditionalFormats (  SpireObject,ICloneParent, IConditionalFormatsCollection) :
    """
    ...
    def Find(self ,arrRanges:List['Rectangle'])->'XlsConditionalFormats':
        ...
        intPtr = GetDllLibXls().XlsWorksheetConditionalFormats_Find(self.Ptr, arrayarrRanges,countarrRanges)
    ...
    def FindAll(self ,arrRanges:List['Rectangle'])->List['XlsConditionalFormats']:
        ...
        intPtrArray = GetDllLibXls().XlsWorksheetConditionalFormats_FindAll(self.Ptr, arrayarrRanges,countarrRanges)
    ...
    def Contains(self ,formats:'XlsConditionalFormats')->'XlsConditionalFormats':
        ...
        intPtr = GetDllLibXls().XlsWorksheetConditionalFormats_Contains(self.Ptr, intPtrformats)
        ret = None if intPtr==None else XlsConditionalFormats(intPtr)
        return ret
    ...
    def Add(self)->XlsConditionalFormats:
        ...
        intPtr = GetDllLibXls().XlsWorksheetConditionalFormats_Add(self.Ptr)
        ret = None if intPtr==None else XlsConditionalFormats(intPtr)
        return ret
    ...
    def Add(self ,formats:XlsConditionalFormats)->XlsConditionalFormats:
        ...
        intPtr = GetDllLibXls().XlsWorksheetConditionalFormats_AddF(self.Ptr, intPtrformats)
        ret = None if intPtr==None else XlsConditionalFormats(intPtr)
        return ret
...
#        GetDllLibXls().XlsWorksheetConditionalFormats_Remove(self.Ptr, arrayarrRanges)
    ...
    def CopyFrom(self ,srcFormats:'XlsWorksheetConditionalFormats'):
        ...
        GetDllLibXls().XlsWorksheetConditionalFormats_CopyFrom(self.Ptr, intPtrsrcFormats)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsWorksheetConditionalFormats_Clone(self.Ptr, intPtrparent)
    ...
    def RemoveAt(self ,index:int):
        ...
        GetDllLibXls().XlsWorksheetConditionalFormats_RemoveAt(self.Ptr, index)
    ...
    def GetByIndex(self ,index:int)->'XlsConditionalFormats':
        ...
        intPtr = GetDllLibXls().XlsWorksheetConditionalFormats_GetByIndex(self.Ptr, index)
        ret = None if intPtr==None else XlsConditionalFormats(intPtr)
        return ret
    ...
    def get_Item(self ,fieldIndex:int)->'XlsConditionalFormats':
        ...
        intPtr = GetDllLibXls().XlsWorksheetConditionalFormats_get_Item(self.Ptr, fieldIndex)
        ret = None if intPtr==None else XlsConditionalFormats(intPtr)
        return ret
    ...
    def GetEnumerator(self)->'IEnumerator':
        ...
        intPtr = GetDllLibXls().XlsWorksheetConditionalFormats_GetEnumerator(self.Ptr)
    ...
    def Clear(self):
        ...
        GetDllLibXls().XlsWorksheetConditionalFormats_Clear(self.Ptr)
    ...
    def Capacity(self)->int:
        ...
        ret = GetDllLibXls().XlsWorksheetConditionalFormats_get_Capacity(self.Ptr)
        return ret

    @Capacity.setter
    def Capacity(self, value:int):
        GetDllLibXls().XlsWorksheetConditionalFormats_set_Capacity.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsWorksheetConditionalFormats_set_Capacity(self.Ptr, value)
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().XlsWorksheetConditionalFormats_get_Count(self.Ptr)
        return ret
