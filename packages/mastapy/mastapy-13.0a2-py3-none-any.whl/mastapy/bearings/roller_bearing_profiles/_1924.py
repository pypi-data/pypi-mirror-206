...
class UserSpecifiedProfilePoint(_0.APIBase):
    ...
    class _Cast_UserSpecifiedProfilePoint:
        ...
        def __init__(self, parent: 'UserSpecifiedProfilePoint'):
            self._parent = parent

        @property
        def user_specified_profile_point(self) -> 'UserSpecifiedProfilePoint':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'UserSpecifiedProfilePoint._Cast_UserSpecifiedProfilePoint':
