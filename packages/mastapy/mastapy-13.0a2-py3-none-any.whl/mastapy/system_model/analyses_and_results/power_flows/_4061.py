...
class DatumPowerFlow(_4034.ComponentPowerFlow):
    """DatumPowerFlow
    ...
    class _Cast_DatumPowerFlow:
        ...
        def __init__(self, parent: 'DatumPowerFlow'):
            self._parent = parent
        ...
        @property
        def datum_power_flow(self) -> 'DatumPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DatumPowerFlow._Cast_DatumPowerFlow':
