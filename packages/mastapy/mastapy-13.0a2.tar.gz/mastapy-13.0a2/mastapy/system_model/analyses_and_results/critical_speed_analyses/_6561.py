...
class DatumCriticalSpeedAnalysis(_6533.ComponentCriticalSpeedAnalysis):
    """DatumCriticalSpeedAnalysis
    ...
    class _Cast_DatumCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'DatumCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def datum_critical_speed_analysis(self) -> 'DatumCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DatumCriticalSpeedAnalysis._Cast_DatumCriticalSpeedAnalysis':
