...
class SpringDamperConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3651.CouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """SpringDamperConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_SpringDamperConnectionCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'SpringDamperConnectionCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_compound_steady_state_synchronous_response_at_a_speed(self) -> 'SpringDamperConnectionCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3585.SpringDamperConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3585.SpringDamperConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionCompoundSteadyStateSynchronousResponseAtASpeed._Cast_SpringDamperConnectionCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_SpringDamperConnectionCompoundSteadyStateSynchronousResponseAtASpeed(self)
