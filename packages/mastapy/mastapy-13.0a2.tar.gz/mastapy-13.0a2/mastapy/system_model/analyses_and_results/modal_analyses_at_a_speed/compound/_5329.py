...
class StraightBevelPlanetGearCompoundModalAnalysisAtASpeed(_5323.StraightBevelDiffGearCompoundModalAnalysisAtASpeed):
    """StraightBevelPlanetGearCompoundModalAnalysisAtASpeed
    ...
    class _Cast_StraightBevelPlanetGearCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelPlanetGearCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_planet_gear_compound_modal_analysis_at_a_speed(self) -> 'StraightBevelPlanetGearCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5200.StraightBevelPlanetGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5200.StraightBevelPlanetGearModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelPlanetGearCompoundModalAnalysisAtASpeed._Cast_StraightBevelPlanetGearCompoundModalAnalysisAtASpeed':
