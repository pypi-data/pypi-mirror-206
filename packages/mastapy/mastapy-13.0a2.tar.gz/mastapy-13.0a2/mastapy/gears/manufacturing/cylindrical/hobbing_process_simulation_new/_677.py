...
class ProcessLeadCalculation(_0.APIBase):
    ...
    class _Cast_ProcessLeadCalculation:
        ...
        def __init__(self, parent: 'ProcessLeadCalculation'):
            self._parent = parent

        @property
        def process_lead_calculation(self) -> 'ProcessLeadCalculation':
            return self._parent
    ...
    @property
    def left_flank_accuracy_calculation(self) -> '_655.CalculateLeadDeviationAccuracy':
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_655.CalculateLeadDeviationAccuracy':
    ...
    @property
    def cast_to(self) -> 'ProcessLeadCalculation._Cast_ProcessLeadCalculation':
