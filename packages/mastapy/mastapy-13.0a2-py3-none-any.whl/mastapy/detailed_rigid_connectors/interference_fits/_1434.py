...
class InterferenceFitHalfDesign(_1376.DetailedRigidConnectorHalfDesign):
    """InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1435.StressRegions':
        ...
        value = conversion.pn_to_mp_enum(temp, _1435.StressRegions)
        return constructor.new_from_mastapy_type(_1435.StressRegions)(value) if value is not None else None
    ...
    @property
    def tolerance(self) -> '_1907.SupportTolerance':
