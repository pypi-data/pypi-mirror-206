...
class RollingRingConnectionModalAnalysis(_4616.InterMountableComponentConnectionModalAnalysis):
    """RollingRingConnectionModalAnalysis
    ...
    class _Cast_RollingRingConnectionModalAnalysis:
        ...
        def __init__(self, parent: 'RollingRingConnectionModalAnalysis'):
            self._parent = parent
        ...
        @property
        def rolling_ring_connection_modal_analysis(self) -> 'RollingRingConnectionModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingConnectionModalAnalysis._Cast_RollingRingConnectionModalAnalysis':
