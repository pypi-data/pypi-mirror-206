...
class SynchroniserSleeveHarmonicAnalysisOfSingleExcitation(_6091.SynchroniserPartHarmonicAnalysisOfSingleExcitation):
    """SynchroniserSleeveHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_SynchroniserSleeveHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'SynchroniserSleeveHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def synchroniser_sleeve_harmonic_analysis_of_single_excitation(self) -> 'SynchroniserSleeveHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserSleeveHarmonicAnalysisOfSingleExcitation._Cast_SynchroniserSleeveHarmonicAnalysisOfSingleExcitation':
