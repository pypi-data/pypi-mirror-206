...
class ExternalCADModelSteadyStateSynchronousResponseOnAShaft(_3249.ComponentSteadyStateSynchronousResponseOnAShaft):
    """ExternalCADModelSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_ExternalCADModelSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'ExternalCADModelSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def external_cad_model_steady_state_synchronous_response_on_a_shaft(self) -> 'ExternalCADModelSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ExternalCADModelSteadyStateSynchronousResponseOnAShaft._Cast_ExternalCADModelSteadyStateSynchronousResponseOnAShaft':
