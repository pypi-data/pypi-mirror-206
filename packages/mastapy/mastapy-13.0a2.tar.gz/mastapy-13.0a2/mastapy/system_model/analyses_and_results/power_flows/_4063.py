...
class FaceGearMeshPowerFlow(_4068.GearMeshPowerFlow):
    """FaceGearMeshPowerFlow
    ...
    class _Cast_FaceGearMeshPowerFlow:
        ...
        def __init__(self, parent: 'FaceGearMeshPowerFlow'):
            self._parent = parent
        ...
        @property
        def face_gear_mesh_power_flow(self) -> 'FaceGearMeshPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearMeshPowerFlow._Cast_FaceGearMeshPowerFlow':
