...
class TorqueConverterSteadyStateSynchronousResponseOnAShaft(_3263.CouplingSteadyStateSynchronousResponseOnAShaft):
    """TorqueConverterSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_TorqueConverterSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'TorqueConverterSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def torque_converter_steady_state_synchronous_response_on_a_shaft(self) -> 'TorqueConverterSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterSteadyStateSynchronousResponseOnAShaft._Cast_TorqueConverterSteadyStateSynchronousResponseOnAShaft':
