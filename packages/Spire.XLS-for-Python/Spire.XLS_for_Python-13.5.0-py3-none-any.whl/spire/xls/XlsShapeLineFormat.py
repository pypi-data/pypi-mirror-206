...
class XlsShapeLineFormat (  XlsObject, IShapeLineFormat) :
    ...
    def Weight(self)->float:
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_Weight(self.Ptr)
        return ret

    @Weight.setter
    def Weight(self, value:float):
        GetDllLibXls().XlsShapeLineFormat_set_Weight.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsShapeLineFormat_set_Weight(self.Ptr, value)
    ...
    def ForeColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsShapeLineFormat_get_ForeColor(self.Ptr)
    ...
    def ForeColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsShapeLineFormat_set_ForeColor(self.Ptr, value.Ptr)
    ...
    def BackColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsShapeLineFormat_get_BackColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def BackColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsShapeLineFormat_set_BackColor(self.Ptr, value.Ptr)
    ...
    def ForeKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_ForeKnownColor(self.Ptr)
    ...
    def ForeKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsShapeLineFormat_set_ForeKnownColor(self.Ptr, value.value)
    ...
    def BackKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_BackKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def BackKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsShapeLineFormat_set_BackKnownColor(self.Ptr, value.value)
    ...
    def BeginArrowHeadStyle(self)->'ShapeArrowStyleType':
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_BeginArrowHeadStyle(self.Ptr)
    ...
    def BeginArrowHeadStyle(self, value:'ShapeArrowStyleType'):
        ...
        GetDllLibXls().XlsShapeLineFormat_set_BeginArrowHeadStyle(self.Ptr, value.value)
    ...
    def EndArrowHeadStyle(self)->'ShapeArrowStyleType':
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_EndArrowHeadStyle(self.Ptr)
        objwraped = ShapeArrowStyleType(ret)
        return objwraped
    ...
    def EndArrowHeadStyle(self, value:'ShapeArrowStyleType'):
        ...
        GetDllLibXls().XlsShapeLineFormat_set_EndArrowHeadStyle(self.Ptr, value.value)
    ...
    def BeginArrowheadLength(self)->'ShapeArrowLengthType':
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_BeginArrowheadLength(self.Ptr)
    ...
    def BeginArrowheadLength(self, value:'ShapeArrowLengthType'):
        ...
        GetDllLibXls().XlsShapeLineFormat_set_BeginArrowheadLength(self.Ptr, value.value)
    ...
    def EndArrowheadLength(self)->'ShapeArrowLengthType':
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_EndArrowheadLength(self.Ptr)
        objwraped = ShapeArrowLengthType(ret)
        return objwraped
    ...
    def EndArrowheadLength(self, value:'ShapeArrowLengthType'):
        ...
        GetDllLibXls().XlsShapeLineFormat_set_EndArrowheadLength(self.Ptr, value.value)
    ...
    def BeginArrowheadWidth(self)->'ShapeArrowWidthType':
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_BeginArrowheadWidth(self.Ptr)
    ...
    def BeginArrowheadWidth(self, value:'ShapeArrowWidthType'):
        ...
        GetDllLibXls().XlsShapeLineFormat_set_BeginArrowheadWidth(self.Ptr, value.value)
    ...
    def EndArrowheadWidth(self)->'ShapeArrowWidthType':
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_EndArrowheadWidth(self.Ptr)
        objwraped = ShapeArrowWidthType(ret)
        return objwraped
    ...
    def EndArrowheadWidth(self, value:'ShapeArrowWidthType'):
        ...
        GetDllLibXls().XlsShapeLineFormat_set_EndArrowheadWidth(self.Ptr, value.value)
    ...
    def DashStyle(self)->'ShapeDashLineStyleType':
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_DashStyle(self.Ptr)
    ...
    def DashStyle(self, value:'ShapeDashLineStyleType'):
        ...
        GetDllLibXls().XlsShapeLineFormat_set_DashStyle(self.Ptr, value.value)
    ...
    def Style(self)->'ShapeLineStyleType':
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_Style(self.Ptr)
    ...
    def Style(self, value:'ShapeLineStyleType'):
        ...
        GetDllLibXls().XlsShapeLineFormat_set_Style(self.Ptr, value.value)
    ...
    def Transparency(self)->float:
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_Transparency(self.Ptr)
        return ret

    @Transparency.setter
    def Transparency(self, value:float):
        GetDllLibXls().XlsShapeLineFormat_set_Transparency.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsShapeLineFormat_set_Transparency(self.Ptr, value)
    ...
    def Visible(self)->bool:
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_Visible(self.Ptr)
        return ret

    @Visible.setter
    def Visible(self, value:bool):
        GetDllLibXls().XlsShapeLineFormat_set_Visible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShapeLineFormat_set_Visible(self.Ptr, value)
    ...
    def Pattern(self)->'GradientPatternType':
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_Pattern(self.Ptr)
    ...
    def Pattern(self, value:'GradientPatternType'):
        ...
        GetDllLibXls().XlsShapeLineFormat_set_Pattern(self.Ptr, value.value)
    ...
    def HasPattern(self)->bool:
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_HasPattern(self.Ptr)
        return ret

    @HasPattern.setter
    def HasPattern(self, value:bool):
        GetDllLibXls().XlsShapeLineFormat_set_HasPattern.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShapeLineFormat_set_HasPattern(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_IsRound(self.Ptr)
        return ret

    @IsRound.setter
    def IsRound(self, value:bool):
        GetDllLibXls().XlsShapeLineFormat_set_IsRound.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShapeLineFormat_set_IsRound(self.Ptr, value)
    ...
    def NoFill(self)->bool:
        ...
        ret = GetDllLibXls().XlsShapeLineFormat_get_NoFill(self.Ptr)
        return ret

    @NoFill.setter
    def NoFill(self, value:bool):
        GetDllLibXls().XlsShapeLineFormat_set_NoFill.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShapeLineFormat_set_NoFill(self.Ptr, value)
    ...
    def Clone(self ,parent:'SpireObject')->'XlsShapeLineFormat':
        ...
        intPtr = GetDllLibXls().XlsShapeLineFormat_Clone(self.Ptr, intPtrparent)
