...
class StraightBevelDiffGearSteadyStateSynchronousResponse(_2980.BevelGearSteadyStateSynchronousResponse):
    ...
    class _Cast_StraightBevelDiffGearSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_steady_state_synchronous_response(self) -> 'StraightBevelDiffGearSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearSteadyStateSynchronousResponse._Cast_StraightBevelDiffGearSteadyStateSynchronousResponse':
