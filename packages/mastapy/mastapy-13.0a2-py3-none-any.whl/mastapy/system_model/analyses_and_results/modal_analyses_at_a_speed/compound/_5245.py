...
class ConceptCouplingConnectionCompoundModalAnalysisAtASpeed(_5256.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """ConceptCouplingConnectionCompoundModalAnalysisAtASpeed
    ...
    class _Cast_ConceptCouplingConnectionCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_compound_modal_analysis_at_a_speed(self) -> 'ConceptCouplingConnectionCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5115.ConceptCouplingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5115.ConceptCouplingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionCompoundModalAnalysisAtASpeed._Cast_ConceptCouplingConnectionCompoundModalAnalysisAtASpeed':
