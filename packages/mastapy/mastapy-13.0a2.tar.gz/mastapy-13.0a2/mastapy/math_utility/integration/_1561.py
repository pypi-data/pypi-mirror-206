...
class GaussKronrodOptions(_0.APIBase):
    ...
    class _Cast_GaussKronrodOptions:
        ...
        def __init__(self, parent: 'GaussKronrodOptions'):
            self._parent = parent

        @property
        def gauss_kronrod_options(self) -> 'GaussKronrodOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GaussKronrodOptions._Cast_GaussKronrodOptions':
