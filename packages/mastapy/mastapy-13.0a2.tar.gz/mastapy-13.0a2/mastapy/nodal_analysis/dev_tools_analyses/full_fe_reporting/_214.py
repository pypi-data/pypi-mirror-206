...
class MaterialPropertiesReporting(_0.APIBase):
    ...
    class _Cast_MaterialPropertiesReporting:
        ...
        def __init__(self, parent: 'MaterialPropertiesReporting'):
            self._parent = parent

        @property
        def material_properties_reporting(self) -> 'MaterialPropertiesReporting':
            return self._parent
    ...
    @property
    def elastic_modulus_components(self) -> '_203.ElasticModulusOrthotropicComponents':
    ...
    @property
    def poissons_ratio_components(self) -> '_216.PoissonRatioOrthotropicComponents':
    ...
    @property
    def shear_modulus_components(self) -> '_218.ShearModulusOrthotropicComponents':
    ...
    @property
    def thermal_expansion_coefficient_components(self) -> '_219.ThermalExpansionOrthotropicComponents':
    ...
    @property
    def cast_to(self) -> 'MaterialPropertiesReporting._Cast_MaterialPropertiesReporting':
