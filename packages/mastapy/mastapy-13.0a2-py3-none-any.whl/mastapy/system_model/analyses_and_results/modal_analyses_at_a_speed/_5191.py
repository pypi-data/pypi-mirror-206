...
class SpringDamperConnectionModalAnalysisAtASpeed(_5126.CouplingConnectionModalAnalysisAtASpeed):
    """SpringDamperConnectionModalAnalysisAtASpeed
    ...
    class _Cast_SpringDamperConnectionModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'SpringDamperConnectionModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_modal_analysis_at_a_speed(self) -> 'SpringDamperConnectionModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionModalAnalysisAtASpeed._Cast_SpringDamperConnectionModalAnalysisAtASpeed':
