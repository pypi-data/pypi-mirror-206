...
def is_conda_env(debug: bool = False) -> tuple[
bool, str]:
    """
...
str, str] = {}
    ...
    if alnTool == "blast":
        ...
        ''' TODO: remove in the future as itis redundant
        if runMode != "default":
            print(f"\n{runMode}")
            runMode = "default"
            sys.stdout.write("INFO: as blastp is only supported in default mode, \
                the run mode was set to 'default'.\n\
