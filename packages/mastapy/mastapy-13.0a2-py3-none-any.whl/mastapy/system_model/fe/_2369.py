...
class FESubstructureWithBatchOptions(_0.APIBase):
    ...
    class _Cast_FESubstructureWithBatchOptions:
        ...
        def __init__(self, parent: 'FESubstructureWithBatchOptions'):
            self._parent = parent

        @property
        def fe_substructure_with_batch_options(self) -> 'FESubstructureWithBatchOptions':
            return self._parent
    ...
    @property
    def fe(self) -> '_2363.FESubstructure':
    ...
    @property
    def cast_to(self) -> 'FESubstructureWithBatchOptions._Cast_FESubstructureWithBatchOptions':
