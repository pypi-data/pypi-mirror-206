...
class PlanetaryConnectionSteadyStateSynchronousResponse(_3060.ShaftToMountableComponentConnectionSteadyStateSynchronousResponse):
    """PlanetaryConnectionSteadyStateSynchronousResponse
    ...
    class _Cast_PlanetaryConnectionSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'PlanetaryConnectionSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def planetary_connection_steady_state_synchronous_response(self) -> 'PlanetaryConnectionSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetaryConnectionSteadyStateSynchronousResponse._Cast_PlanetaryConnectionSteadyStateSynchronousResponse':
