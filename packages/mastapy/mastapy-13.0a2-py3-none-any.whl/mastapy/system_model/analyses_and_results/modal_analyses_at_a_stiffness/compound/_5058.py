...
class SpecialisedAssemblyCompoundModalAnalysisAtAStiffness(_4960.AbstractAssemblyCompoundModalAnalysisAtAStiffness):
    """SpecialisedAssemblyCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_SpecialisedAssemblyCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'SpecialisedAssemblyCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def specialised_assembly_compound_modal_analysis_at_a_stiffness(self) -> 'SpecialisedAssemblyCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4929.SpecialisedAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4929.SpecialisedAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'SpecialisedAssemblyCompoundModalAnalysisAtAStiffness._Cast_SpecialisedAssemblyCompoundModalAnalysisAtAStiffness':
