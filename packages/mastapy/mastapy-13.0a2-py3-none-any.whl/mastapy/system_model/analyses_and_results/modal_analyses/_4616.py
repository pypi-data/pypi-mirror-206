...
class InterMountableComponentConnectionModalAnalysis(_4582.ConnectionModalAnalysis):
    """InterMountableComponentConnectionModalAnalysis
    ...
    class _Cast_InterMountableComponentConnectionModalAnalysis:
        ...
        def __init__(self, parent: 'InterMountableComponentConnectionModalAnalysis'):
            self._parent = parent
        ...
        @property
        def inter_mountable_component_connection_modal_analysis(self) -> 'InterMountableComponentConnectionModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'InterMountableComponentConnectionModalAnalysis._Cast_InterMountableComponentConnectionModalAnalysis':
