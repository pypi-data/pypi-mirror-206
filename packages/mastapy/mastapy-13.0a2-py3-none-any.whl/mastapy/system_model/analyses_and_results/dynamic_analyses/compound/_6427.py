...
class FaceGearMeshCompoundDynamicAnalysis(_6432.GearMeshCompoundDynamicAnalysis):
    """FaceGearMeshCompoundDynamicAnalysis
    ...
    class _Cast_FaceGearMeshCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'FaceGearMeshCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def face_gear_mesh_compound_dynamic_analysis(self) -> 'FaceGearMeshCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6298.FaceGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6298.FaceGearMeshDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'FaceGearMeshCompoundDynamicAnalysis._Cast_FaceGearMeshCompoundDynamicAnalysis':
