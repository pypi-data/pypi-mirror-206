...
class StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness(_5065.StraightBevelDiffGearCompoundModalAnalysisAtAStiffness):
    """StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def straight_bevel_planet_gear_compound_modal_analysis_at_a_stiffness(self) -> 'StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4942.StraightBevelPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4942.StraightBevelPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness._Cast_StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness':
