...
class XlsChartPageSetup (  XlsPageSetupBase, IChartPageSetup) :
    ...
    def FitToPagesTall(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartPageSetup_get_FitToPagesTall(self.Ptr)
        return ret
    ...
    def FitToPagesTall(self, value:bool):
        ...
        GetDllLibXls().XlsChartPageSetup_set_FitToPagesTall(self.Ptr, value)
    ...
    def FitToPagesWide(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartPageSetup_get_FitToPagesWide(self.Ptr)
        return ret
    ...
    def FitToPagesWide(self, value:bool):
        ...
        GetDllLibXls().XlsChartPageSetup_set_FitToPagesWide(self.Ptr, value)
    ...
    def Clone(self ,parent:'SpireObject')->'XlsChartPageSetup':
        ...
        intPtr = GetDllLibXls().XlsChartPageSetup_Clone(self.Ptr, intPtrparent)
