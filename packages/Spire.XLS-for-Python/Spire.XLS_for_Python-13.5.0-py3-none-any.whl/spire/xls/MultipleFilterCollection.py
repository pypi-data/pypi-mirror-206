...
class MultipleFilterCollection (SpireObject) :
    ...
    def GetEnumerator(self)->'IEnumerator':
        ...
        intPtr = GetDllLibXls().MultipleFilterCollection_GetEnumerator(self.Ptr)
    ...
    def Clear(self):
        ...
        GetDllLibXls().MultipleFilterCollection_Clear(self.Ptr)
    ...
    def Capacity(self)->int:
        ...
        ret = GetDllLibXls().MultipleFilterCollection_get_Capacity(self.Ptr)
        return ret

    @Capacity.setter
    def Capacity(self, value:int):
        GetDllLibXls().MultipleFilterCollection_set_Capacity.argtypes=[c_void_p, c_int]
        GetDllLibXls().MultipleFilterCollection_set_Capacity(self.Ptr, value)
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().MultipleFilterCollection_get_Count(self.Ptr)
        return ret
    ...
    <param name="second"></param>
        ...
        GetDllLibXls().MultipleFilterCollection_RemoveDateFilter(self.Ptr, enumtype,year,month,day,hour,minute,second)
    ...
    def RemoveAt(self ,index:int):
        ...
        GetDllLibXls().MultipleFilterCollection_RemoveAt(self.Ptr, index)
    ...
    def RemoveFilter(self ,filter:str):
        ...
        GetDllLibXls().MultipleFilterCollection_RemoveFilter(self.Ptr, filter)
    ...
    def MatchBlank(self)->bool:
        ...
        ret = GetDllLibXls().MultipleFilterCollection_get_MatchBlank(self.Ptr)
        return ret

    @MatchBlank.setter
    def MatchBlank(self, value:bool):
        GetDllLibXls().MultipleFilterCollection_set_MatchBlank.argtypes=[c_void_p, c_bool]
        GetDllLibXls().MultipleFilterCollection_set_MatchBlank(self.Ptr, value)
    ...
    def get_Item(self ,index:int)->'SpireObject':
        ...
        intPtr = GetDllLibXls().MultipleFilterCollection_get_Item(self.Ptr, index)
    ...
    def GetByIndex(self ,index:int)->'SpireObject':
        ...
        intPtr = GetDllLibXls().MultipleFilterCollection_GetByIndex(self.Ptr, index)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    def Add(self ,filter:str):
        ...
        GetDllLibXls().MultipleFilterCollection_Add(self.Ptr, filter)
    ...
    def Add(self ,filter:DateTimeGroupItem):
        ...
        GetDllLibXls().MultipleFilterCollection_AddF(self.Ptr, intPtrfilter)
    ...
    def Add(self ,type:DateTimeGroupingType,year:int,month:int,day:int):
        ...
        GetDllLibXls().MultipleFilterCollection_AddTYMD(self.Ptr, enumtype,year,month,day)
