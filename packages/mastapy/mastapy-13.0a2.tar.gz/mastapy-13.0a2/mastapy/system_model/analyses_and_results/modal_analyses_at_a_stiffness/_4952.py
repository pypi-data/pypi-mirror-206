...
class UnbalancedMassModalAnalysisAtAStiffness(_4953.VirtualComponentModalAnalysisAtAStiffness):
    """UnbalancedMassModalAnalysisAtAStiffness
    ...
    class _Cast_UnbalancedMassModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'UnbalancedMassModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_modal_analysis_at_a_stiffness(self) -> 'UnbalancedMassModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassModalAnalysisAtAStiffness._Cast_UnbalancedMassModalAnalysisAtAStiffness':
