...
class StraightBevelDiffGearModalAnalysisAtAStiffness(_4847.BevelGearModalAnalysisAtAStiffness):
    """StraightBevelDiffGearModalAnalysisAtAStiffness
    ...
    class _Cast_StraightBevelDiffGearModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_modal_analysis_at_a_stiffness(self) -> 'StraightBevelDiffGearModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearModalAnalysisAtAStiffness._Cast_StraightBevelDiffGearModalAnalysisAtAStiffness':
