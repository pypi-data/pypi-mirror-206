...
class CouplingCompoundParametricStudyTool(_4516.SpecialisedAssemblyCompoundParametricStudyTool):
    """CouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4310.CouplingParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4310.CouplingParametricStudyTool]':
