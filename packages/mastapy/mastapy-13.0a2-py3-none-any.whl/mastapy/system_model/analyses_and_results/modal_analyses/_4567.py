...
class BoltModalAnalysis(_4572.ComponentModalAnalysis):
    """BoltModalAnalysis
    ...
    class _Cast_BoltModalAnalysis:
        ...
        def __init__(self, parent: 'BoltModalAnalysis'):
            self._parent = parent
        ...
        @property
        def bolt_modal_analysis(self) -> 'BoltModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltModalAnalysis._Cast_BoltModalAnalysis':
