...
class PrstGeomShapeCollection (  CollectionBase[XlsPrstGeomShape], IPrstGeomShapes) :
    ...
    def get_Item(self ,index:int)->IPrstGeomShape:
        ...
        intPtr = GetDllLibXls().PrstGeomShapeCollection_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->IPrstGeomShape:
        ...
        intPtr = GetDllLibXls().PrstGeomShapeCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsPrstGeomShape(intPtr)
        return ret
    ...
    def get_Item(self ,shapeType:PrstGeomShapeType)->List[IPrstGeomShape]:
        ...
        intPtrArray = GetDllLibXls().PrstGeomShapeCollection_get_ItemS(self.Ptr, enumshapeType)
    ...
    <param name="height">shape's height, in unit of pixel.</param>
        ...
        intPtr = GetDllLibXls().PrstGeomShapeCollection_AddNotPrimitiveShape(self.Ptr, row,column,width,height)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().PrstGeomShapeCollection_AddPrstGeomShape(self.Ptr, row,column,width,height,enumshapeType)
        ret = None if intPtr==None else XlsPrstGeomShape(intPtr)
        return ret
    ...
    def AddCopy(self ,source:'IPrstGeomShape'):
        ...
        GetDllLibXls().PrstGeomShapeCollection_AddCopy(self.Ptr, intPtrsource)
    ...
    <param name="shape">the shape to remove</param>
        ...
        GetDllLibXls().PrstGeomShapeCollection_Remove(self.Ptr, intPtrshape)
    ...
    def Clear(self):
        ...
        GetDllLibXls().PrstGeomShapeCollection_Clear(self.Ptr)
