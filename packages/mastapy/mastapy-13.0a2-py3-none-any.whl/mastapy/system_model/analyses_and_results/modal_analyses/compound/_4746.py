...
class CycloidalDiscCompoundModalAnalysis(_4702.AbstractShaftCompoundModalAnalysis):
    """CycloidalDiscCompoundModalAnalysis
    ...
    class _Cast_CycloidalDiscCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'CycloidalDiscCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_compound_modal_analysis(self) -> 'CycloidalDiscCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4593.CycloidalDiscModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4593.CycloidalDiscModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscCompoundModalAnalysis._Cast_CycloidalDiscCompoundModalAnalysis':
