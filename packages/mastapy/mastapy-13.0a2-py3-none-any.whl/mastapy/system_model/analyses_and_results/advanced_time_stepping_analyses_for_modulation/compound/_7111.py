...
class BearingCompoundAdvancedTimeSteppingAnalysisForModulation(_7139.ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BearingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_BearingCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'BearingCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def bearing_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'BearingCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6981.BearingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6981.BearingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'BearingCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_BearingCompoundAdvancedTimeSteppingAnalysisForModulation':
