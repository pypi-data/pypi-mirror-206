...
def _init_dotnet_core_if_required(path_to_dll_folder: str):
    path_to_deps = os.path.join(path_to_dll_folder,
                                'SMT.Utility.Tests.deps.json')
    ...
    if is_dotnet_core:
        try:
            ...
            message = ('Attempted to initialise mastapy using a .NET Core '
...
@deprecated(alternative='Use the debug button built into MASTA. You can find '
