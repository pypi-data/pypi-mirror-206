...
class CollectionBase (  IList[T]) :
    ...
    def Capacity(self)->int:
        ...
        ret = GetDllLibXls().CollectionBase_get_Capacity(self.Ptr)
        return ret

    @Capacity.setter
    def Capacity(self, value:int):
        GetDllLibXls().CollectionBase_set_Capacity.argtypes=[c_void_p, c_int]
        GetDllLibXls().CollectionBase_set_Capacity(self.Ptr, value)
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().CollectionBase_get_Count(self.Ptr)
        return ret
    ...
    def get_Item(self ,i:int)->'T':
        ...
        intPtr = GetDllLibXls().CollectionBase_get_Item(self.Ptr, i)
...
#        GetDllLibXls().CollectionBase_set_Item(self.Ptr, i,intPtrvalue)
    ...
    def Clear(self):
        ...
        GetDllLibXls().CollectionBase_Clear(self.Ptr)
...
#        GetDllLibXls().CollectionBase_Insert(self.Ptr, index,intPtritem)
...
#        intPtr = GetDllLibXls().CollectionBase_GetEnumerator(self.Ptr)
...
#
    ...
    def RemoveAt(self ,index:int):
        ...
        GetDllLibXls().CollectionBase_RemoveAt(self.Ptr, index)
...
#        ret = GetDllLibXls().CollectionBase_IndexOf(self.Ptr, intPtritem)
#        return ret
...
#        GetDllLibXls().CollectionBase_Add(self.Ptr, intPtritem)
...
#        ret = GetDllLibXls().CollectionBase_Contains(self.Ptr, intPtritem)
#        return ret
...
#        GetDllLibXls().CollectionBase_CopyTo(self.Ptr, arrayarray,arrayIndex)
    ...
    def IsReadOnly(self)->bool:
        ...
        ret = GetDllLibXls().CollectionBase_get_IsReadOnly(self.Ptr)
        return ret
...
#        ret = GetDllLibXls().CollectionBase_Remove(self.Ptr, intPtritem)
#        return ret
