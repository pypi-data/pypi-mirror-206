...
class BeltConnectionAdvancedSystemDeflection(_7302.InterMountableComponentConnectionAdvancedSystemDeflection):
    """BeltConnectionAdvancedSystemDeflection
    ...
    class _Cast_BeltConnectionAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'BeltConnectionAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def belt_connection_advanced_system_deflection(self) -> 'BeltConnectionAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BeltConnectionAdvancedSystemDeflection._Cast_BeltConnectionAdvancedSystemDeflection':
