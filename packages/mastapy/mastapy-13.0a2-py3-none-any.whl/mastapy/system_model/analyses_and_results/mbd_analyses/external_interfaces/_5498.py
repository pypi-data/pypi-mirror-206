...
class DynamicExternalInterfaceOptions(_0.APIBase):
    ...
    @property
    def input_signal_filter_level(self) -> '_5418.InputSignalFilterLevel':
        ...
        value = conversion.pn_to_mp_enum(temp, _5418.InputSignalFilterLevel)
        return constructor.new_from_mastapy_type(_5418.InputSignalFilterLevel)(value) if value is not None else None

    @input_signal_filter_level.setter
    def input_signal_filter_level(self, value: '_5418.InputSignalFilterLevel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _5418.InputSignalFilterLevel.type_())
