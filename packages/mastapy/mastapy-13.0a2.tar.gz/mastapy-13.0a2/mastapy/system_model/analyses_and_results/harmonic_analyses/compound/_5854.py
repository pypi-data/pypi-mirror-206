...
class BearingCompoundHarmonicAnalysis(_5882.ConnectorCompoundHarmonicAnalysis):
    """BearingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5657.BearingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5657.BearingHarmonicAnalysis]':
