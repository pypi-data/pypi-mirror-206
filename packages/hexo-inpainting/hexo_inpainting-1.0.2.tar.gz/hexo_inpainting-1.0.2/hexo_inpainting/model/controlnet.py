...
class ControlNet(DiffusionInpaintModel):
    ...
    def forward(self, image, mask, config: Config):
       ...
       # print(np.array(canny_image).shape, temp_mask.shape)
        canny_image = PIL.Image.fromarray(((255-temp_mask)//255) * np.array(canny_image))
        # plt.imshow(canny_image)
        # print(canny_image)
        # plt.show()
        #canny_image.save("/content/my_img.jpg")
