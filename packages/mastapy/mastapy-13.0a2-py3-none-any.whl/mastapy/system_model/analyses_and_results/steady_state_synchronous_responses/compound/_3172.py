...
class MountableComponentCompoundSteadyStateSynchronousResponse(_3120.ComponentCompoundSteadyStateSynchronousResponse):
    """MountableComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3040.MountableComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3040.MountableComponentSteadyStateSynchronousResponse]':
