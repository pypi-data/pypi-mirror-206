...
__date__      = '2023-May-2'                   
__url__       = 'https://engineering.purdue.edu/kak/distDLS/DLStudio-2.3.0.html'
    ...
    class DetectAndLocalize(nn.Module):             
        ...
        class DIoULoss(nn.Module):
            ...
            def forward(self, predicted, target, loss_mode):
                ...
                ##  normalizations we are going to later in our calculation of the IoU-based loss function.
