...
class SaveShapeTypeOption (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveGroupShape(self.Ptr)
        return ret
    ...
    def SaveGroupShape(self, value:bool):
        ...
        GetDllLibXls().SaveShapeTypeOption_set_SaveGroupShape(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SavePicture(self.Ptr)
        return ret

    @SavePicture.setter
    def SavePicture(self, value:bool):
        GetDllLibXls().SaveShapeTypeOption_set_SavePicture.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SaveShapeTypeOption_set_SavePicture(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveTextBox(self.Ptr)
        return ret

    @SaveTextBox.setter
    def SaveTextBox(self, value:bool):
        GetDllLibXls().SaveShapeTypeOption_set_SaveTextBox.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SaveShapeTypeOption_set_SaveTextBox(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveButton(self.Ptr)
        return ret

    @SaveButton.setter
    def SaveButton(self, value:bool):
        GetDllLibXls().SaveShapeTypeOption_set_SaveButton.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SaveShapeTypeOption_set_SaveButton(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveCheckBox(self.Ptr)
        return ret

    @SaveCheckBox.setter
    def SaveCheckBox(self, value:bool):
        GetDllLibXls().SaveShapeTypeOption_set_SaveCheckBox.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SaveShapeTypeOption_set_SaveCheckBox(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveRadioButton(self.Ptr)
        return ret
    ...
    def SaveRadioButton(self, value:bool):
        ...
        GetDllLibXls().SaveShapeTypeOption_set_SaveRadioButton(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveGroupBox(self.Ptr)
        return ret

    @SaveGroupBox.setter
    def SaveGroupBox(self, value:bool):
        GetDllLibXls().SaveShapeTypeOption_set_SaveGroupBox.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SaveShapeTypeOption_set_SaveGroupBox(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveLabel(self.Ptr)
        return ret

    @SaveLabel.setter
    def SaveLabel(self, value:bool):
        GetDllLibXls().SaveShapeTypeOption_set_SaveLabel.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SaveShapeTypeOption_set_SaveLabel(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveListBox(self.Ptr)
        return ret

    @SaveListBox.setter
    def SaveListBox(self, value:bool):
        GetDllLibXls().SaveShapeTypeOption_set_SaveListBox.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SaveShapeTypeOption_set_SaveListBox(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveComboBox(self.Ptr)
        return ret

    @SaveComboBox.setter
    def SaveComboBox(self, value:bool):
        GetDllLibXls().SaveShapeTypeOption_set_SaveComboBox.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SaveShapeTypeOption_set_SaveComboBox(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveArc(self.Ptr)
        return ret

    @SaveArc.setter
    def SaveArc(self, value:bool):
        GetDllLibXls().SaveShapeTypeOption_set_SaveArc.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SaveShapeTypeOption_set_SaveArc(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveLine(self.Ptr)
        return ret

    @SaveLine.setter
    def SaveLine(self, value:bool):
        GetDllLibXls().SaveShapeTypeOption_set_SaveLine.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SaveShapeTypeOption_set_SaveLine(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveOval(self.Ptr)
        return ret

    @SaveOval.setter
    def SaveOval(self, value:bool):
        GetDllLibXls().SaveShapeTypeOption_set_SaveOval.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SaveShapeTypeOption_set_SaveOval(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveRectangle(self.Ptr)
        return ret
    ...
    def SaveRectangle(self, value:bool):
        ...
        GetDllLibXls().SaveShapeTypeOption_set_SaveRectangle(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SavePrstGomShape(self.Ptr)
        return ret
    ...
    def SavePrstGomShape(self, value:bool):
        ...
        GetDllLibXls().SaveShapeTypeOption_set_SavePrstGomShape(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveDml(self.Ptr)
        return ret

    @SaveDml.setter
    def SaveDml(self, value:bool):
        GetDllLibXls().SaveShapeTypeOption_set_SaveDml.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SaveShapeTypeOption_set_SaveDml(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().SaveShapeTypeOption_get_SaveAll(self.Ptr)
        return ret

    @SaveAll.setter
    def SaveAll(self, value:bool):
        GetDllLibXls().SaveShapeTypeOption_set_SaveAll.argtypes=[c_void_p, c_bool]
        GetDllLibXls().SaveShapeTypeOption_set_SaveAll(self.Ptr, value)
