...
class SteadyStateSynchronousResponseOptions(_0.APIBase):
    ...
    class _Cast_SteadyStateSynchronousResponseOptions:
        ...
        def __init__(self, parent: 'SteadyStateSynchronousResponseOptions'):
            self._parent = parent

        @property
        def steady_state_synchronous_response_options(self) -> 'SteadyStateSynchronousResponseOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SteadyStateSynchronousResponseOptions._Cast_SteadyStateSynchronousResponseOptions':
