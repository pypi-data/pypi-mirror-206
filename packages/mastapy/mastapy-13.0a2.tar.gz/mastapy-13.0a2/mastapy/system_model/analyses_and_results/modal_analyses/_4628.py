...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    class _Cast_ModalAnalysisBarModelFEExportOptions:
        ...
        def __init__(self, parent: 'ModalAnalysisBarModelFEExportOptions'):
            self._parent = parent

        @property
        def modal_analysis_bar_model_fe_export_options(self) -> 'ModalAnalysisBarModelFEExportOptions':
            return self._parent
    ...
    def analysis_type(self) -> '_52.BarModelAnalysisType':
        ...
        value = conversion.pn_to_mp_enum(temp, _52.BarModelAnalysisType)
    ...
    def analysis_type(self, value: '_52.BarModelAnalysisType'):
        ...
        value = conversion.mp_to_pn_enum(value, _52.BarModelAnalysisType.type_())
    ...
    @property
    def mode_options(self) -> '_176.EigenvalueOptions':
    ...
    @property
    def cast_to(self) -> 'ModalAnalysisBarModelFEExportOptions._Cast_ModalAnalysisBarModelFEExportOptions':
