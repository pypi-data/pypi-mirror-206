...
class CradleStyleConicalMachineSettingsGenerated(_0.APIBase):
    ...
    class _Cast_CradleStyleConicalMachineSettingsGenerated:
        ...
        def __init__(self, parent: 'CradleStyleConicalMachineSettingsGenerated'):
            self._parent = parent

        @property
        def cradle_style_conical_machine_settings_generated(self) -> 'CradleStyleConicalMachineSettingsGenerated':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CradleStyleConicalMachineSettingsGenerated._Cast_CradleStyleConicalMachineSettingsGenerated':
