...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5748, _5749, _5744
...
class KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis(_5744.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_set_harmonic_analysis(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis':
            return self._parent
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5748.KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_harmonic_analysis(self) -> 'List[_5748.KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5749.KlingelnbergCycloPalloidSpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_harmonic_analysis(self) -> 'List[_5749.KlingelnbergCycloPalloidSpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis._Cast_KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis':
        return self._Cast_KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis(self)
