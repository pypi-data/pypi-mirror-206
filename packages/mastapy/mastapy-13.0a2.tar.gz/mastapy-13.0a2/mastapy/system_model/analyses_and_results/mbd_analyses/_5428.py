...
class KlingelnbergCycloPalloidSpiralBevelGearMultibodyDynamicsAnalysis(_5422.KlingelnbergCycloPalloidConicalGearMultibodyDynamicsAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearMultibodyDynamicsAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_multibody_dynamics_analysis(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearMultibodyDynamicsAnalysis._Cast_KlingelnbergCycloPalloidSpiralBevelGearMultibodyDynamicsAnalysis':
        return self._Cast_KlingelnbergCycloPalloidSpiralBevelGearMultibodyDynamicsAnalysis(self)
