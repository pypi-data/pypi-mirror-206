...
class SpecialisedAssemblyLoadCase(_6771.AbstractAssemblyLoadCase):
    """SpecialisedAssemblyLoadCase
    ...
    class _Cast_SpecialisedAssemblyLoadCase:
        ...
        def __init__(self, parent: 'SpecialisedAssemblyLoadCase'):
            self._parent = parent
        ...
        @property
        def specialised_assembly_load_case(self) -> 'SpecialisedAssemblyLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpecialisedAssemblyLoadCase._Cast_SpecialisedAssemblyLoadCase':
