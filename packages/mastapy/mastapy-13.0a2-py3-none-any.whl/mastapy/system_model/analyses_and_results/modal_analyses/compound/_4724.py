...
class ClutchHalfCompoundModalAnalysis(_4740.CouplingHalfCompoundModalAnalysis):
    """ClutchHalfCompoundModalAnalysis
    ...
    class _Cast_ClutchHalfCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'ClutchHalfCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_half_compound_modal_analysis(self) -> 'ClutchHalfCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4569.ClutchHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4569.ClutchHalfModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ClutchHalfCompoundModalAnalysis._Cast_ClutchHalfCompoundModalAnalysis':
