...
from mastapy.system_model.fe import _2338, _2345
...
class RaceBearingFE(_0.APIBase):
    ...
    class _Cast_RaceBearingFE:
        ...
        def __init__(self, parent: 'RaceBearingFE'):
            self._parent = parent

        @property
        def race_bearing_fe(self) -> 'RaceBearingFE':
            return self._parent
    ...
    @property
    def alignment_method(self) -> '_2338.AlignmentMethodForRaceBearing':
        ...
        value = conversion.pn_to_mp_enum(temp, _2338.AlignmentMethodForRaceBearing)
        return constructor.new_from_mastapy_type(_2338.AlignmentMethodForRaceBearing)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2338.AlignmentMethodForRaceBearing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2338.AlignmentMethodForRaceBearing.type_())
    ...
    @property
    def links(self) -> 'List[_2345.BearingRaceNodeLink]':
    ...
    @property
    def cast_to(self) -> 'RaceBearingFE._Cast_RaceBearingFE':
