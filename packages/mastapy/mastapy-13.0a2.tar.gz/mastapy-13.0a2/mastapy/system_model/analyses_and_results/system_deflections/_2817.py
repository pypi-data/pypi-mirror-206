...
class WormGearSystemDeflection(_2740.GearSystemDeflection):
    """WormGearSystemDeflection
    ...
    class _Cast_WormGearSystemDeflection:
        ...
        def __init__(self, parent: 'WormGearSystemDeflection'):
            self._parent = parent
        ...
        @property
        def worm_gear_system_deflection(self) -> 'WormGearSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4137.WormGearPowerFlow':
    ...
    @property
    def cast_to(self) -> 'WormGearSystemDeflection._Cast_WormGearSystemDeflection':
