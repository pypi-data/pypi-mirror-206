...
class ConceptCouplingCompoundSteadyStateSynchronousResponse(_3132.CouplingCompoundSteadyStateSynchronousResponse):
    """ConceptCouplingCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_ConceptCouplingCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'ConceptCouplingCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def concept_coupling_compound_steady_state_synchronous_response(self) -> 'ConceptCouplingCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2990.ConceptCouplingSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2990.ConceptCouplingSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingCompoundSteadyStateSynchronousResponse._Cast_ConceptCouplingCompoundSteadyStateSynchronousResponse':
