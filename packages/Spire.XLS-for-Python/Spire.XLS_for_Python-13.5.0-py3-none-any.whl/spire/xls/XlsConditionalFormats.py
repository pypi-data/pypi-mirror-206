...
class XlsConditionalFormats (  SpireObject, ICloneParent, IConditionalFormats) :
    ...
    def AddCondition(self)->'IConditionalFormat':
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddCondition(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddCellValueCondition(self.Ptr, enumoperatorType,value1,value2)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddCellValueConditionOVV(self.Ptr, enumoperatorType,value1,value2)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddBeginsWithCondition(self.Ptr, text)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddContainsTextCondition(self.Ptr, text)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddEndsWithCondition(self.Ptr, text)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddNotContainsTextCondition(self.Ptr, text)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddContainsBlanksCondition(self.Ptr)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddContainsErrorsCondition(self.Ptr)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddDuplicateValuesCondition(self.Ptr)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddNotContainsBlanksCondition(self.Ptr)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddNotContainsErrorsCondition(self.Ptr)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddUniqueValuesCondition(self.Ptr)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddTimePeriodCondition(self.Ptr, enumtimePeriodType)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddAverageCondition(self.Ptr, enumaverageType)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_AddTopBottomCondition(self.Ptr, enumtopBottomType,rank)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    def Remove(self ,startRow:int,startColumn:int,totalRows:int,totalColumns:int):
        ...
        GetDllLibXls().XlsConditionalFormats_Remove(self.Ptr, startRow,startColumn,totalRows,totalColumns)
    ...
    def RemoveAt(self ,index:int):
        ...
        GetDllLibXls().XlsConditionalFormats_RemoveAt(self.Ptr, index)
    ...
    def CompareTo(self ,formats:'XlsConditionalFormats')->bool:
        ...
        ret = GetDllLibXls().XlsConditionalFormats_CompareTo(self.Ptr, intPtrformats)
        return ret
    ...
    def CompareFormats(self ,firstFormat:'IConditionalFormat',secondFormat:'IConditionalFormat')->bool:
        ...
        ret = GetDllLibXls().XlsConditionalFormats_CompareFormats(self.Ptr, intPtrfirstFormat,intPtrsecondFormat)
        return ret
    ...
    def AddCells(self ,formats:'XlsConditionalFormats'):
        ...
        GetDllLibXls().XlsConditionalFormats_AddCells(self.Ptr, intPtrformats)
...
#        ret = GetDllLibXls().XlsConditionalFormats_Contains(self.Ptr, arrayarrRanges)
#        return ret
    ...
    def ContainsCount(self ,range:'Rectangle')->int:
        ...
        ret = GetDllLibXls().XlsConditionalFormats_ContainsCount(self.Ptr, intPtrrange)
        return ret
    ...
    def AddCells(self ,arrCells:IList):
        ...
        GetDllLibXls().XlsConditionalFormats_AddCellsA(self.Ptr, intPtrarrCells)
    ...
    def AddRange(self ,range:'IXLSRange'):
        ...
        GetDllLibXls().XlsConditionalFormats_AddRange(self.Ptr, intPtrrange)
...
#        GetDllLibXls().XlsConditionalFormats_RemoveA(self.Ptr, arrayarrRanges)
    ...
    def ClearCells(self):
        ...
        GetDllLibXls().XlsConditionalFormats_ClearCells(self.Ptr)
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().XlsConditionalFormats_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().XlsConditionalFormats_EndUpdate(self.Ptr)
    ...
    def GetHashCode(self)->int:
        ...
        ret = GetDllLibXls().XlsConditionalFormats_GetHashCode(self.Ptr)
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibXls().XlsConditionalFormats_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_Clone(self.Ptr, intPtrparent)
    ...
    def IsEmpty(self)->bool:
        ...
        ret = GetDllLibXls().XlsConditionalFormats_get_IsEmpty(self.Ptr)
        return ret
    ...
    def Address(self)->str:
        ...
        GetDllLibXls().XlsConditionalFormats_get_Address.restype=c_wchar_p
        ret = GetDllLibXls().XlsConditionalFormats_get_Address(self.Ptr)
        return ret
    ...
    def AddressR1C1(self)->str:
        ...
        GetDllLibXls().XlsConditionalFormats_get_AddressR1C1.restype=c_wchar_p
        ret = GetDllLibXls().XlsConditionalFormats_get_AddressR1C1(self.Ptr)
        return ret
...
#        intPtr = GetDllLibXls().XlsConditionalFormats_get_CellRectangles(self.Ptr)
...
#
    ...
    def GetByIndex(self ,index:int)->'IConditionalFormat':
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_GetByIndex(self.Ptr, index)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    def get_Item(self ,fieldIndex:int)->'IConditionalFormat':
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_get_Item(self.Ptr, fieldIndex)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    def GetEnumerator(self)->'IEnumerator':
        ...
        intPtr = GetDllLibXls().XlsConditionalFormats_GetEnumerator(self.Ptr)
    ...
    def Clear(self):
        ...
        GetDllLibXls().XlsConditionalFormats_Clear(self.Ptr)
    ...
    def Capacity(self)->int:
        ...
        ret = GetDllLibXls().XlsConditionalFormats_get_Capacity(self.Ptr)
        return ret

    @Capacity.setter
    def Capacity(self, value:int):
        GetDllLibXls().XlsConditionalFormats_set_Capacity.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsConditionalFormats_set_Capacity(self.Ptr, value)
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().XlsConditionalFormats_get_Count(self.Ptr)
        return ret
    ...
    def MAXIMUM_CF_NUMBER()->int:
        ...
        ret = GetDllLibXls().XlsConditionalFormats_MAXIMUM_CF_NUMBER()
        return ret
