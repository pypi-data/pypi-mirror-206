...
class ConceptGearSystemDeflection(_2740.GearSystemDeflection):
    """ConceptGearSystemDeflection
    ...
    class _Cast_ConceptGearSystemDeflection:
        ...
        def __init__(self, parent: 'ConceptGearSystemDeflection'):
            self._parent = parent
        ...
        @property
        def concept_gear_system_deflection(self) -> 'ConceptGearSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4039.ConceptGearPowerFlow':
    ...
    @property
    def cast_to(self) -> 'ConceptGearSystemDeflection._Cast_ConceptGearSystemDeflection':
