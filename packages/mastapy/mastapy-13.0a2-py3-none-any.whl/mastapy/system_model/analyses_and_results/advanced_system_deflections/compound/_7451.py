...
class PlanetaryConnectionCompoundAdvancedSystemDeflection(_7465.ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """PlanetaryConnectionCompoundAdvancedSystemDeflection
    ...
    class _Cast_PlanetaryConnectionCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'PlanetaryConnectionCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def planetary_connection_compound_advanced_system_deflection(self) -> 'PlanetaryConnectionCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7321.PlanetaryConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7321.PlanetaryConnectionAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'PlanetaryConnectionCompoundAdvancedSystemDeflection._Cast_PlanetaryConnectionCompoundAdvancedSystemDeflection':
