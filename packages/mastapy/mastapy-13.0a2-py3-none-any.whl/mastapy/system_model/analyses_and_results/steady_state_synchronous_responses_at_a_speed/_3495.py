...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3496, _3494, _3500
...
class BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed(_3500.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    """BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_set_steady_state_synchronous_response_at_a_speed(self) -> 'BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def bevel_differential_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3496.BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3494.BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed._Cast_BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed(self)
