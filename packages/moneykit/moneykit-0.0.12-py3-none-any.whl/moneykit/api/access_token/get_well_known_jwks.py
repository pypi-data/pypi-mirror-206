...
def _get_kwargs(
    *,
    ...
    url = "{}/.well-known/jwks.json".format(client.base_url)
...
) -> Optional[Union[JWKSet, Union["APIErrorAuthExpiredAccessTokenResponse", "APIErrorAuthUnauthorizedResponse"]]]:
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[JWKSet, Union["APIErrorAuthExpiredAccessTokenResponse", "APIErrorAuthUnauthorizedResponse"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """JSON Web Key Set
     ...
     The JSON Web Key Set (JWKS) is a set of keys containing the public keys used to verify webhook JSON
    Web Tokens
    (JWT) issued by MoneyKit webhooks.
...
def sync(
    *,
    ...
    Returns:
        Union[JWKSet, Union['APIErrorAuthExpiredAccessTokenResponse', 'APIErrorAuthUnauthorizedResponse']]
    """
