...
class StraightBevelGearHarmonicAnalysisOfSingleExcitation(_5991.BevelGearHarmonicAnalysisOfSingleExcitation):
    """StraightBevelGearHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_StraightBevelGearHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'StraightBevelGearHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_harmonic_analysis_of_single_excitation(self) -> 'StraightBevelGearHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearHarmonicAnalysisOfSingleExcitation._Cast_StraightBevelGearHarmonicAnalysisOfSingleExcitation':
