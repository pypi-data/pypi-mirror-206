...
class SpiralBevelGearMeshSteadyStateSynchronousResponse(_2978.BevelGearMeshSteadyStateSynchronousResponse):
    """SpiralBevelGearMeshSteadyStateSynchronousResponse
    ...
    class _Cast_SpiralBevelGearMeshSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_steady_state_synchronous_response(self) -> 'SpiralBevelGearMeshSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshSteadyStateSynchronousResponse._Cast_SpiralBevelGearMeshSteadyStateSynchronousResponse':
