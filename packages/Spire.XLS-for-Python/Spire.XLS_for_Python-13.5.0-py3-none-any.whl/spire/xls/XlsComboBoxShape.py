...
class XlsComboBoxShape (  XlsShape, IComboBoxShape) :
    ...
    def ComboType(self)->'ExcelComboType':
        ...
        ret = GetDllLibXls().XlsComboBoxShape_get_ComboType(self.Ptr)
    ...
    def SelectedValue(self)->str:
        ...
        GetDllLibXls().XlsComboBoxShape_get_SelectedValue.restype=c_wchar_p
        ret = GetDllLibXls().XlsComboBoxShape_get_SelectedValue(self.Ptr)
        return ret
    ...
    def Display3DShading(self)->bool:
        ...
        ret = GetDllLibXls().XlsComboBoxShape_get_Display3DShading(self.Ptr)
        return ret
    ...
    def Display3DShading(self, value:bool):
        ...
        GetDllLibXls().XlsComboBoxShape_set_Display3DShading(self.Ptr, value)
    ...
    def DropDownLines(self)->int:
        ...
        ret = GetDllLibXls().XlsComboBoxShape_get_DropDownLines(self.Ptr)
        return ret
    ...
    def DropDownLines(self, value:int):
        ...
        GetDllLibXls().XlsComboBoxShape_set_DropDownLines(self.Ptr, value)
    ...
    def SelectedIndex(self)->int:
        ...
        ret = GetDllLibXls().XlsComboBoxShape_get_SelectedIndex(self.Ptr)
        return ret

    @SelectedIndex.setter
    def SelectedIndex(self, value:int):
        GetDllLibXls().XlsComboBoxShape_set_SelectedIndex.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsComboBoxShape_set_SelectedIndex(self.Ptr, value)
    ...
    def ListFillRange(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsComboBoxShape_get_ListFillRange(self.Ptr)
    ...
    def ListFillRange(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsComboBoxShape_set_ListFillRange(self.Ptr, value.Ptr)
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsComboBoxShape_get_ShapeType(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsComboBoxShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
