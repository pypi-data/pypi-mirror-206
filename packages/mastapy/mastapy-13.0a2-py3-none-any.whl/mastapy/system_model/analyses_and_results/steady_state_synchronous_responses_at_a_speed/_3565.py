...
class PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed(_3522.CouplingSteadyStateSynchronousResponseAtASpeed):
    """PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_steady_state_synchronous_response_at_a_speed(self) -> 'PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed._Cast_PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed(self)
