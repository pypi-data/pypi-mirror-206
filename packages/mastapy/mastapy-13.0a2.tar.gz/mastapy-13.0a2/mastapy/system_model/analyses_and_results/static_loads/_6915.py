...
class ShaftToMountableComponentConnectionLoadCase(_6774.AbstractShaftToMountableComponentConnectionLoadCase):
    """ShaftToMountableComponentConnectionLoadCase
    ...
    class _Cast_ShaftToMountableComponentConnectionLoadCase:
        ...
        def __init__(self, parent: 'ShaftToMountableComponentConnectionLoadCase'):
            self._parent = parent
        ...
        @property
        def shaft_to_mountable_component_connection_load_case(self) -> 'ShaftToMountableComponentConnectionLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftToMountableComponentConnectionLoadCase._Cast_ShaftToMountableComponentConnectionLoadCase':
