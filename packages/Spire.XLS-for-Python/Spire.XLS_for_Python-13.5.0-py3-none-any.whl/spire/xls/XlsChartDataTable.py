...
class XlsChartDataTable (  XlsObject, IChartDataTable, IFont, IOptimizedUpdate) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_HasHorzBorder(self.Ptr)
        return ret
    ...
    def HasHorzBorder(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataTable_set_HasHorzBorder(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_HasVertBorder(self.Ptr)
        return ret
    ...
    def HasVertBorder(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataTable_set_HasVertBorder(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_HasBorders(self.Ptr)
        return ret

    @HasBorders.setter
    def HasBorders(self, value:bool):
        GetDllLibXls().XlsChartDataTable_set_HasBorders.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDataTable_set_HasBorders(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_ShowSeriesKeys(self.Ptr)
        return ret
    ...
    def ShowSeriesKeys(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataTable_set_ShowSeriesKeys(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_BackgroundMode(self.Ptr)
    ...
    def BackgroundMode(self, value:'ChartBackgroundMode'):
        ...
        GetDllLibXls().XlsChartDataTable_set_BackgroundMode(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_IsBold(self.Ptr)
        return ret

    @IsBold.setter
    def IsBold(self, value:bool):
        GetDllLibXls().XlsChartDataTable_set_IsBold.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDataTable_set_IsBold(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_KnownColor(self.Ptr)
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartDataTable_set_KnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartDataTable_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartDataTable_set_Color(self.Ptr, value.Ptr)
    ...
    def SetThemeColor(self ,type:'ThemeColorType',tint:float):
        ...
        GetDllLibXls().XlsChartDataTable_SetThemeColor(self.Ptr, enumtype,tint)
...
#        ret = GetDllLibXls().XlsChartDataTable_GetThemeColor(self.Ptr, intPtrtype,intPtrtint)
#        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_IsItalic(self.Ptr)
        return ret

    @IsItalic.setter
    def IsItalic(self, value:bool):
        GetDllLibXls().XlsChartDataTable_set_IsItalic.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDataTable_set_IsItalic(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_Size(self.Ptr)
        return ret

    @Size.setter
    def Size(self, value:float):
        GetDllLibXls().XlsChartDataTable_set_Size.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartDataTable_set_Size(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_IsStrikethrough(self.Ptr)
        return ret
    ...
    def IsStrikethrough(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataTable_set_IsStrikethrough(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_IsSubscript(self.Ptr)
        return ret

    @IsSubscript.setter
    def IsSubscript(self, value:bool):
        GetDllLibXls().XlsChartDataTable_set_IsSubscript.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDataTable_set_IsSubscript(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_IsSuperscript(self.Ptr)
        return ret
    ...
    def IsSuperscript(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataTable_set_IsSuperscript(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_Underline(self.Ptr)
    ...
    def Underline(self, value:'FontUnderlineType'):
        ...
        GetDllLibXls().XlsChartDataTable_set_Underline(self.Ptr, value.value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChartDataTable_get_FontName.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartDataTable_get_FontName(self.Ptr)
        return ret
    ...
    def FontName(self, value:str):
        ...
        GetDllLibXls().XlsChartDataTable_set_FontName(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_VerticalAlignment(self.Ptr)
    ...
    def VerticalAlignment(self, value:'FontVertialAlignmentType'):
        ...
        GetDllLibXls().XlsChartDataTable_set_VerticalAlignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataTable_get_IsAutoColor(self.Ptr)
        return ret
    ...
    def StrikethroughType(self)->str:
        ...
        GetDllLibXls().XlsChartDataTable_get_StrikethroughType.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartDataTable_get_StrikethroughType(self.Ptr)
        return ret
    ...
    def StrikethroughType(self, value:str):
        ...
        GetDllLibXls().XlsChartDataTable_set_StrikethroughType(self.Ptr, value)
    ...
    def GenerateNativeFont(self)->'Font':
        ...
        intPtr = GetDllLibXls().XlsChartDataTable_GenerateNativeFont(self.Ptr)
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().XlsChartDataTable_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().XlsChartDataTable_EndUpdate(self.Ptr)
    ...
    def Clone(self ,parent:'SpireObject')->'XlsChartDataTable':
        ...
        intPtr = GetDllLibXls().XlsChartDataTable_Clone(self.Ptr, intPtrparent)
