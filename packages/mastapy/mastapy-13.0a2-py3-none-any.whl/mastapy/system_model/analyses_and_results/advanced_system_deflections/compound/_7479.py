...
class StraightBevelPlanetGearCompoundAdvancedSystemDeflection(_7473.StraightBevelDiffGearCompoundAdvancedSystemDeflection):
    """StraightBevelPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7349.StraightBevelPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7349.StraightBevelPlanetGearAdvancedSystemDeflection]':
