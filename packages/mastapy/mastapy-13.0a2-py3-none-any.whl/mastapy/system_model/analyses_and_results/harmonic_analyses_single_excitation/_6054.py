...
class OilSealHarmonicAnalysisOfSingleExcitation(_6011.ConnectorHarmonicAnalysisOfSingleExcitation):
    """OilSealHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_OilSealHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'OilSealHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def oil_seal_harmonic_analysis_of_single_excitation(self) -> 'OilSealHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'OilSealHarmonicAnalysisOfSingleExcitation._Cast_OilSealHarmonicAnalysisOfSingleExcitation':
