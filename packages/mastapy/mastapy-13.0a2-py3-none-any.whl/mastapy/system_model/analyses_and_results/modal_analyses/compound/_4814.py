...
class SynchroniserCompoundModalAnalysis(_4799.SpecialisedAssemblyCompoundModalAnalysis):
    """SynchroniserCompoundModalAnalysis
    ...
    class _Cast_SynchroniserCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_compound_modal_analysis(self) -> 'SynchroniserCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4671.SynchroniserModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4671.SynchroniserModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserCompoundModalAnalysis._Cast_SynchroniserCompoundModalAnalysis':
