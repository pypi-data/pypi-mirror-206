...
class BearingCompoundStabilityAnalysis(_3910.ConnectorCompoundStabilityAnalysis):
    """BearingCompoundStabilityAnalysis
    ...
    class _Cast_BearingCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'BearingCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def bearing_compound_stability_analysis(self) -> 'BearingCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3750.BearingStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3750.BearingStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BearingCompoundStabilityAnalysis._Cast_BearingCompoundStabilityAnalysis':
