...
class ConceptGearDynamicAnalysis(_6302.GearDynamicAnalysis):
    """ConceptGearDynamicAnalysis
    ...
    class _Cast_ConceptGearDynamicAnalysis:
        ...
        def __init__(self, parent: 'ConceptGearDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_gear_dynamic_analysis(self) -> 'ConceptGearDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptGearDynamicAnalysis._Cast_ConceptGearDynamicAnalysis':
