...
class ButtonShapeCollection (  IButtonShapes) :
    ...
    def get_Item(self ,index:int)->IButtonShape:
        ...
        intPtr = GetDllLibXls().ButtonShapeCollection_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->IButtonShape:
        ...
        intPtr = GetDllLibXls().ButtonShapeCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else IButtonShape(intPtr)
        return ret
    ...
    def AddButton(self ,row:int,column:int,height:int,width:int)->'IButtonShape':
        ...
        intPtr = GetDllLibXls().ButtonShapeCollection_AddButton(self.Ptr, row,column,height,width)
        ret = None if intPtr==None else IButtonShape(intPtr)
        return ret
    ...
    def AddCopy(self ,source:'IButtonShape'):
        ...
        GetDllLibXls().ButtonShapeCollection_AddCopy(self.Ptr, intPtrsource)
    ...
    def Clear(self):
        ...
        GetDllLibXls().ButtonShapeCollection_Clear(self.Ptr)
