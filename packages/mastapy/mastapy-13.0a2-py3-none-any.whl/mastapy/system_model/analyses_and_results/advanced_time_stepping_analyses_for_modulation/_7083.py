...
class StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6990.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_advanced_time_stepping_analysis_for_modulation(self) -> 'StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation._Cast_StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(self)
