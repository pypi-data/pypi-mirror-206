...
class ShapeReflection (  XlsObject, IReflectionEffect, ICloneParent) :
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().ShapeReflection_Clone(self.Ptr, intPtrparent)
    ...
    def Blur(self)->int:
        ...
        ret = GetDllLibXls().ShapeReflection_get_Blur(self.Ptr)
        return ret

    @Blur.setter
    def Blur(self, value:int):
        GetDllLibXls().ShapeReflection_set_Blur.argtypes=[c_void_p, c_int]
        GetDllLibXls().ShapeReflection_set_Blur(self.Ptr, value)
    ...
    def Direction(self)->float:
        ...
        ret = GetDllLibXls().ShapeReflection_get_Direction(self.Ptr)
        return ret

    @Direction.setter
    def Direction(self, value:float):
        GetDllLibXls().ShapeReflection_set_Direction.argtypes=[c_void_p, c_double]
        GetDllLibXls().ShapeReflection_set_Direction(self.Ptr, value)
    ...
    def Distance(self)->int:
        ...
        ret = GetDllLibXls().ShapeReflection_get_Distance(self.Ptr)
        return ret

    @Distance.setter
    def Distance(self, value:int):
        GetDllLibXls().ShapeReflection_set_Distance.argtypes=[c_void_p, c_int]
        GetDllLibXls().ShapeReflection_set_Distance(self.Ptr, value)
    ...
    def FadeDirection(self)->float:
        ...
        ret = GetDllLibXls().ShapeReflection_get_FadeDirection(self.Ptr)
        return ret
    ...
    def FadeDirection(self, value:float):
        ...
        GetDllLibXls().ShapeReflection_set_FadeDirection(self.Ptr, value)
    ...
    def RotWithShape(self)->bool:
        ...
        ret = GetDllLibXls().ShapeReflection_get_RotWithShape(self.Ptr)
        return ret

    @RotWithShape.setter
    def RotWithShape(self, value:bool):
        GetDllLibXls().ShapeReflection_set_RotWithShape.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ShapeReflection_set_RotWithShape(self.Ptr, value)
    ...
    def Size(self)->int:
        ...
        ret = GetDllLibXls().ShapeReflection_get_Size(self.Ptr)
        return ret

    @Size.setter
    def Size(self, value:int):
        GetDllLibXls().ShapeReflection_set_Size.argtypes=[c_void_p, c_int]
        GetDllLibXls().ShapeReflection_set_Size(self.Ptr, value)
    ...
    def Transparency(self)->int:
        ...
        ret = GetDllLibXls().ShapeReflection_get_Transparency(self.Ptr)
        return ret

    @Transparency.setter
    def Transparency(self, value:int):
        GetDllLibXls().ShapeReflection_set_Transparency.argtypes=[c_void_p, c_int]
        GetDllLibXls().ShapeReflection_set_Transparency(self.Ptr, value)
