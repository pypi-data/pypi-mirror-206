...
class CylindricalGearMeshCompoundHarmonicAnalysis(_5905.GearMeshCompoundHarmonicAnalysis):
    """CylindricalGearMeshCompoundHarmonicAnalysis
    ...
    class _Cast_CylindricalGearMeshCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'CylindricalGearMeshCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_compound_harmonic_analysis(self) -> 'CylindricalGearMeshCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5698.CylindricalGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5698.CylindricalGearMeshHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshCompoundHarmonicAnalysis._Cast_CylindricalGearMeshCompoundHarmonicAnalysis':
