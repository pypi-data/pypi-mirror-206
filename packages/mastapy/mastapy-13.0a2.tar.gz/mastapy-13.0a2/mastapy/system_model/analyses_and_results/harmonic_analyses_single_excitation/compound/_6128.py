...
class ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation(_6144.CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation):
    """ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def clutch_half_compound_harmonic_analysis_of_single_excitation(self) -> 'ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5997.ClutchHalfHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5997.ClutchHalfHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation._Cast_ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation':
