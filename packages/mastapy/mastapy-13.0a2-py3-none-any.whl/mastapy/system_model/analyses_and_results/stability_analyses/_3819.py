...
class MeasurementComponentStabilityAnalysis(_3867.VirtualComponentStabilityAnalysis):
    """MeasurementComponentStabilityAnalysis
    ...
    class _Cast_MeasurementComponentStabilityAnalysis:
        ...
        def __init__(self, parent: 'MeasurementComponentStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def measurement_component_stability_analysis(self) -> 'MeasurementComponentStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MeasurementComponentStabilityAnalysis._Cast_MeasurementComponentStabilityAnalysis':
