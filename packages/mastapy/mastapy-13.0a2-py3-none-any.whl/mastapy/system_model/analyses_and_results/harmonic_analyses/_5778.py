...
class SpeedOptionsForHarmonicAnalysisResults(_7498.AbstractAnalysisOptions['_6769.StaticLoadCase']):
    """SpeedOptionsForHarmonicAnalysisResults
    ...
    class _Cast_SpeedOptionsForHarmonicAnalysisResults:
        ...
        def __init__(self, parent: 'SpeedOptionsForHarmonicAnalysisResults'):
            self._parent = parent
        ...
        @property
        def speed_options_for_harmonic_analysis_results(self) -> 'SpeedOptionsForHarmonicAnalysisResults':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpeedOptionsForHarmonicAnalysisResults._Cast_SpeedOptionsForHarmonicAnalysisResults':
