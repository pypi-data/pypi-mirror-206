...
class BevelDifferentialSunGearCompoundParametricStudyTool(_4429.BevelDifferentialGearCompoundParametricStudyTool):
    """BevelDifferentialSunGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4286.BevelDifferentialSunGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4286.BevelDifferentialSunGearParametricStudyTool]':
