...
class KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis(_5912.KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_compound_harmonic_analysis(self) -> 'KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5745.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5745.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis._Cast_KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis(self)
