...
class WormGearMeshAdvancedTimeSteppingAnalysisForModulation(_7032.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    """WormGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_WormGearMeshAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'WormGearMeshAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def worm_gear_mesh_advanced_time_stepping_analysis_for_modulation(self) -> 'WormGearMeshAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearMeshAdvancedTimeSteppingAnalysisForModulation._Cast_WormGearMeshAdvancedTimeSteppingAnalysisForModulation':
