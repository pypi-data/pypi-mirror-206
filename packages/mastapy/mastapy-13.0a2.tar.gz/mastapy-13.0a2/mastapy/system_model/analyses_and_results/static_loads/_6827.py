...
from mastapy.system_model.analyses_and_results.static_loads import _6828, _6856
...
class CylindricalGearMeshLoadCase(_6856.GearMeshLoadCase):
    """CylindricalGearMeshLoadCase
    ...
    class _Cast_CylindricalGearMeshLoadCase:
        ...
        def __init__(self, parent: 'CylindricalGearMeshLoadCase'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_load_case(self) -> 'CylindricalGearMeshLoadCase':
            return self._parent
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents(self) -> '_593.ISOTR1417912001CoefficientOfFrictionConstants':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshLoadCase._Cast_CylindricalGearMeshLoadCase':
