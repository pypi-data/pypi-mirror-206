...
class CalculatePitchDeviationAccuracy(_0.APIBase):
    ...
    class _Cast_CalculatePitchDeviationAccuracy:
        ...
        def __init__(self, parent: 'CalculatePitchDeviationAccuracy'):
            self._parent = parent

        @property
        def calculate_pitch_deviation_accuracy(self) -> 'CalculatePitchDeviationAccuracy':
            return self._parent
    ...
    @property
    def achieved_pitch_agma20151a01_quality_grade(self) -> 'float':
        """float: 'AchievedPitchAGMA20151A01QualityGrade' is the original name of this property.
    ...
    @property
    def cumulative_pitch_deviation_agma20151a01_quality_grade_obtained(self) -> 'float':
        """float: 'CumulativePitchDeviationAGMA20151A01QualityGradeObtained' is the original name of this property.
    ...
    @property
    def pitch_deviation_agma20151a01_quality_grade_designed(self) -> 'float':
        """float: 'PitchDeviationAGMA20151A01QualityGradeDesigned' is the original name of this property.
    ...
    @property
    def single_pitch_deviation_agma20151a01_quality_grade_obtained(self) -> 'float':
        """float: 'SinglePitchDeviationAGMA20151A01QualityGradeObtained' is the original name of this property.
    ...
    @property
    def manufactured_agma20151a01_quality_grades(self) -> 'List[_673.ManufacturedQualityGrade]':
    ...
    @property
    def manufactured_iso132811995e_quality_grades(self) -> 'List[_673.ManufacturedQualityGrade]':
    ...
    @property
    def cast_to(self) -> 'CalculatePitchDeviationAccuracy._Cast_CalculatePitchDeviationAccuracy':
