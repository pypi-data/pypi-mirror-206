...
class OverridableDisplacementBoundaryCondition(_0.APIBase):
    ...
    class _Cast_OverridableDisplacementBoundaryCondition:
        ...
        def __init__(self, parent: 'OverridableDisplacementBoundaryCondition'):
            self._parent = parent

        @property
        def overridable_displacement_boundary_condition(self) -> 'OverridableDisplacementBoundaryCondition':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'OverridableDisplacementBoundaryCondition._Cast_OverridableDisplacementBoundaryCondition':
        return self._Cast_OverridableDisplacementBoundaryCondition(self)
