...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1229, _1230
...
class ContactPairReporting(_0.APIBase):
    ...
    class _Cast_ContactPairReporting:
        ...
        def __init__(self, parent: 'ContactPairReporting'):
            self._parent = parent

        @property
        def contact_pair_reporting(self) -> 'ContactPairReporting':
            return self._parent
    ...
    @property
    def constrained_surface_type(self) -> '_1229.ContactPairConstrainedSurfaceType':
        ...
        value = conversion.pn_to_mp_enum(temp, _1229.ContactPairConstrainedSurfaceType)
        return constructor.new_from_mastapy_type(_1229.ContactPairConstrainedSurfaceType)(value) if value is not None else None
    ...
    @property
    def reference_surface_type(self) -> '_1230.ContactPairReferenceSurfaceType':
        ...
        value = conversion.pn_to_mp_enum(temp, _1230.ContactPairReferenceSurfaceType)
        return constructor.new_from_mastapy_type(_1230.ContactPairReferenceSurfaceType)(value) if value is not None else None
    ...
    @property
    def cast_to(self) -> 'ContactPairReporting._Cast_ContactPairReporting':
