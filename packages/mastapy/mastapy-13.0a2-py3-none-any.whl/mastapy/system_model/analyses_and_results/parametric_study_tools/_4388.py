...
class SpiralBevelGearMeshParametricStudyTool(_4287.BevelGearMeshParametricStudyTool):
    """SpiralBevelGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2786.SpiralBevelGearMeshSystemDeflection]':
