...
class GetUserTransactionsResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class accounts(schemas.DictSchema):
                class MetaOapg:
                    @staticmethod
                    def additional_properties() -> typing.Type["BasicAccountDetails"]:
                        return BasicAccountDetails

                def __getitem__(self, name: typing.Union[str,]) -> "BasicAccountDetails":
                    # dict_instance[name] accessor
                    return super().__getitem__(name)

                def get_item_oapg(self, name: typing.Union[str,]) -> "BasicAccountDetails":
