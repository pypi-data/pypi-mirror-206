...
class TripsApi(object):
    ...
    @validate_arguments
    def create_trip(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_trip : Annotated[WebTrip, Field(..., description="New essence creation request.")], **kwargs) -> WebTrip:  # noqa: E501
    ...
    @validate_arguments
    def create_trip_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_trip : Annotated[WebTrip, Field(..., description="New essence creation request.")], **kwargs):  # noqa: E501
        """Trip create  # noqa: E501
    ...
    @validate_arguments
    def delete_trip(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_trip_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs):  # noqa: E501
        """Remove trip  # noqa: E501
    ...
    @validate_arguments
    def read_trip(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> WebTrip:  # noqa: E501
        """Read trip  # noqa: E501
    ...
    @validate_arguments
    def read_trip_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs):  # noqa: E501
        """Read trip  # noqa: E501
    ...
    @validate_arguments
    def read_trips_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], offset : Annotated[Optional[conint(strict=True, le=10000000, ge=0)], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[conint(strict=True, le=10000000, ge=1)], Field(description="The number of items to return.")] = None, sort_field : Annotated[Optional[TableTripColumnType], Field(description="Trip table column name. ")] = None, sort_direction : Annotated[Optional[StrictStr], Field(description="Sort direction.")] = None, table_trip_filter_list : Annotated[Optional[TableTripFilterList], Field(description="Trip filter.")] = None, **kwargs):  # noqa: E501
        """Trip list  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['table_trip_filter_list']:
    ...
    @validate_arguments
    def read_trips_tracks(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], table_trip_filter_list : Annotated[Optional[TableTripFilterList], Field(description="Trips filter.")] = None, **kwargs) -> WebTripTrackList:  # noqa: E501
        ...
        >>> thread = api.read_trips_tracks(experiment_key, table_trip_filter_list, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_trips_tracks_with_http_info(experiment_key, table_trip_filter_list, **kwargs)  # noqa: E501

    @validate_arguments
    def read_trips_tracks_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], table_trip_filter_list : Annotated[Optional[TableTripFilterList], Field(description="Trips filter.")] = None, **kwargs):  # noqa: E501
        """Trip tracks  # noqa: E501
        ...
        >>> thread = api.read_trips_tracks_with_http_info(experiment_key, table_trip_filter_list, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/studio/experiments/{experiment_key}/trips/batch/tracks', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def update_trip(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_trip : Annotated[WebTrip, Field(..., description="Essence update request.")], **kwargs) -> WebTrip:  # noqa: E501
    ...
    @validate_arguments
    def update_trip_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_trip : Annotated[WebTrip, Field(..., description="Essence update request.")], **kwargs):  # noqa: E501
        """Trip update  # noqa: E501
