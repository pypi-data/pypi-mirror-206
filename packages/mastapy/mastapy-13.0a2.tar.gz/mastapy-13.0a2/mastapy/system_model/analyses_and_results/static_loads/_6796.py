...
class BoltLoadCase(_6801.ComponentLoadCase):
    """BoltLoadCase
    ...
    class _Cast_BoltLoadCase:
        ...
        def __init__(self, parent: 'BoltLoadCase'):
            self._parent = parent
        ...
        @property
        def bolt_load_case(self) -> 'BoltLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltLoadCase._Cast_BoltLoadCase':
