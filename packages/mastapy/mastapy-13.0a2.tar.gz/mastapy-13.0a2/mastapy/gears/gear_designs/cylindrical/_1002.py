...
from mastapy.gears.gear_designs.cylindrical import _1001, _1007
...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    class _Cast_CylindricalGearAbstractRackFlank:
        ...
        def __init__(self, parent: 'CylindricalGearAbstractRackFlank'):
            self._parent = parent
        ...
        def cylindrical_gear_basic_rack_flank(self):
            ...
            return self._parent._cast(_1004.CylindricalGearBasicRackFlank)

        @property
        def cylindrical_gear_pinion_type_cutter_flank(self):
            from mastapy.gears.gear_designs.cylindrical import _1019
            
            return self._parent._cast(_1019.CylindricalGearPinionTypeCutterFlank)
        ...
        @property
        def cylindrical_gear_abstract_rack_flank(self) -> 'CylindricalGearAbstractRackFlank':
            return self._parent
    ...
    def protuberance_specification(self) -> 'CylindricalGearAbstractRackFlank.ProtuberanceSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, CylindricalGearAbstractRackFlank.ProtuberanceSpecificationMethod)
    ...
    def protuberance_specification(self, value: 'CylindricalGearAbstractRackFlank.ProtuberanceSpecificationMethod'):
        ...
        value = conversion.mp_to_pn_enum(value, CylindricalGearAbstractRackFlank.ProtuberanceSpecificationMethod.type_())
    ...
    @property
    def cutter(self) -> '_1001.CylindricalGearAbstractRack':
    ...
    @property
    def gear(self) -> '_1007.CylindricalGearDesign':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearAbstractRackFlank._Cast_CylindricalGearAbstractRackFlank':
