...
class UnbalancedMassCompoundModalAnalysisAtAStiffness(_5082.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """UnbalancedMassCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_UnbalancedMassCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'UnbalancedMassCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_compound_modal_analysis_at_a_stiffness(self) -> 'UnbalancedMassCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4952.UnbalancedMassModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4952.UnbalancedMassModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassCompoundModalAnalysisAtAStiffness._Cast_UnbalancedMassCompoundModalAnalysisAtAStiffness':
