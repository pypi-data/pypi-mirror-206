...
class RollingRingCompoundPowerFlow(_4181.CouplingHalfCompoundPowerFlow):
    """RollingRingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4105.RollingRingPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4105.RollingRingPowerFlow]':
