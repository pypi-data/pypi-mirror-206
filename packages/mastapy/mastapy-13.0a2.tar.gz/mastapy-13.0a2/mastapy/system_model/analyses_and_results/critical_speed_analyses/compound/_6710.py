...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6708, _6709, _6707
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundCriticalSpeedAnalysis(_6707.KlingelnbergCycloPalloidConicalGearSetCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6581.KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_critical_speed_analysis(self) -> 'List[_6708.KlingelnbergCycloPalloidHypoidGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_critical_speed_analysis(self) -> 'List[_6709.KlingelnbergCycloPalloidHypoidGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6581.KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis]':
