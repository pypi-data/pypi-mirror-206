...
class ProcessSimulationInput(_0.APIBase):
    ...
    class _Cast_ProcessSimulationInput:
        ...
        def __init__(self, parent: 'ProcessSimulationInput'):
            self._parent = parent

        @property
        def hobbing_process_simulation_input(self):
            from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _667
            
            return self._parent._cast(_667.HobbingProcessSimulationInput)

        @property
        def worm_grinding_process_simulation_input(self):
            from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _694
            
            return self._parent._cast(_694.WormGrindingProcessSimulationInput)

        @property
        def process_simulation_input(self) -> 'ProcessSimulationInput':
            return self._parent
    ...
    @property
    def analysis_setting(self) -> '_654.AnalysisMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _654.AnalysisMethod)
        return constructor.new_from_mastapy_type(_654.AnalysisMethod)(value) if value is not None else None

    @analysis_setting.setter
    def analysis_setting(self, value: '_654.AnalysisMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _654.AnalysisMethod.type_())
    ...
    @property
    def centre_distance_offset_specification_method(self) -> '_658.CentreDistanceOffsetMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _658.CentreDistanceOffsetMethod)
        return constructor.new_from_mastapy_type(_658.CentreDistanceOffsetMethod)(value) if value is not None else None

    @centre_distance_offset_specification_method.setter
    def centre_distance_offset_specification_method(self, value: '_658.CentreDistanceOffsetMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _658.CentreDistanceOffsetMethod.type_())
    ...
    @property
    def user_specified_center_distance_offset_relative_to_cutter_height(self) -> '_1523.Vector2DListAccessor':
    ...
    def user_specified_center_distance_offset_relative_to_cutter_height(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.UserSpecifiedCenterDistanceOffsetRelativeToCutterHeight = value

    @property
    def cutter_head_slide_error(self) -> '_659.CutterHeadSlideError':
    ...
    @property
    def cutter_mounting_error(self) -> '_685.RackMountingError':
    ...
    @property
    def gear_mounting_error(self) -> '_660.GearMountingError':
    ...
    @property
    def cast_to(self) -> 'ProcessSimulationInput._Cast_ProcessSimulationInput':
