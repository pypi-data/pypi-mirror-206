...
class RingPinsModalAnalysis(_4631.MountableComponentModalAnalysis):
    """RingPinsModalAnalysis
    ...
    class _Cast_RingPinsModalAnalysis:
        ...
        def __init__(self, parent: 'RingPinsModalAnalysis'):
            self._parent = parent
        ...
        @property
        def ring_pins_modal_analysis(self) -> 'RingPinsModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RingPinsModalAnalysis._Cast_RingPinsModalAnalysis':
