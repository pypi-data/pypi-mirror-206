...
class ActiveImageLabelerWindow(LabelerWindow):
    ...
    def __init__(self):
        ...
        self.serverAPItoken.setCurrentText(settings.value('serverAPItoken', "", str))
    ...
    def closeEvent(self, event):
        ...
        settings.setValue('serverAPItoken', self.serverAPItoken.currentText())
...
def main():
    ...
    api = InferenceApi(win.serverHost.text(),
                    #    win.serverPort.value(), 
                       win.serverProject.currentText(), 
                       win.serverAPItoken.currentText())
    ...
    win.serverAPItoken.currentTextChanged.connect(api.setAPItoken)
