...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6316, _6317, _6312
...
class KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis(_6312.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_set_dynamic_analysis(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis':
            return self._parent
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_dynamic_analysis(self) -> 'List[_6316.KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_6317.KlingelnbergCycloPalloidSpiralBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis._Cast_KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis':
        return self._Cast_KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis(self)
