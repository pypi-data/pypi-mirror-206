...
class PartToPartShearCouplingConnectionModalAnalysisAtAStiffness(_4867.CouplingConnectionModalAnalysisAtAStiffness):
    """PartToPartShearCouplingConnectionModalAnalysisAtAStiffness
    ...
    class _Cast_PartToPartShearCouplingConnectionModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingConnectionModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_connection_modal_analysis_at_a_stiffness(self) -> 'PartToPartShearCouplingConnectionModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingConnectionModalAnalysisAtAStiffness._Cast_PartToPartShearCouplingConnectionModalAnalysisAtAStiffness':
        return self._Cast_PartToPartShearCouplingConnectionModalAnalysisAtAStiffness(self)
