...
class CVTPulleyCompoundHarmonicAnalysis(_5934.PulleyCompoundHarmonicAnalysis):
    """CVTPulleyCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5692.CVTPulleyHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5692.CVTPulleyHarmonicAnalysis]':
