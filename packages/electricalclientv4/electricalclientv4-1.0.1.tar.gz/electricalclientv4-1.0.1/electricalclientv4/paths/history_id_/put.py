...
# body param
SchemaForRequestBodyApplicationJson = History
SchemaForRequestBodyApplicationXWwwFormUrlencoded = History
SchemaForRequestBodyMultipartFormData = History


request_body_history = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _history_update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_history.serialize(body, content_type)
...
class HistoryUpdate(BaseApi):
    ...
    def history_update(
        ...
        return self._history_update_oapg(
            body=body,
