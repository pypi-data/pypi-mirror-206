...
class RollingRingSystemDeflection(_2709.CouplingHalfSystemDeflection):
    """RollingRingSystemDeflection
    ...
    class _Cast_RollingRingSystemDeflection:
        ...
        def __init__(self, parent: 'RollingRingSystemDeflection'):
            self._parent = parent
        ...
        @property
        def rolling_ring_system_deflection(self) -> 'RollingRingSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4105.RollingRingPowerFlow':
    ...
    @property
    def cast_to(self) -> 'RollingRingSystemDeflection._Cast_RollingRingSystemDeflection':
