...
class XlsShape (  XlsObject, IShape, ICloneParent, INamedObject) :
    ...
    <param name="imageFormat">Type of the image to create.</param>
        """
        intPtrimageFormat:c_void_p = imageFormat.Ptr

        GetDllLibXls().XlsShape_SaveToImage.argtypes=[c_void_p ,c_void_p,c_void_p]
        GetDllLibXls().XlsShape_SaveToImage(self.Ptr, fileName,intPtrimageFormat)
    ...
    <param name="fileStream">Output stream. It is ignored if null.</param>
        ...
        GetDllLibXls().XlsShape_SaveToImageF(self.Ptr, intPtrfileStream)
    ...
    <param name="fileName">Output file name.</param>
        ...
        GetDllLibXls().XlsShape_SaveToImageF1(self.Ptr, fileName)
    ...
    def SetTextEffect(self ,effect:'PresetTextEffect',text:str):
        ...
        GetDllLibXls().XlsShape_SetTextEffect(self.Ptr, enumeffect,text)
    ...
    <returns>A copy of the current shape.</returns>
        ...
        intPtr = GetDllLibXls().XlsShape_Clone(self.Ptr, intPtrparent)
...
#        intPtr = GetDllLibXls().XlsShape_ClonePHDA(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
...
#
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().XlsShape_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().XlsShape_get_Name(self.Ptr)
        return ret
    ...
    def Name(self, value:str):
        ...
        GetDllLibXls().XlsShape_set_Name(self.Ptr, value)
    ...
    def SetName(self ,name:str):
        ...
        GetDllLibXls().XlsShape_SetName(self.Ptr, name)
    ...
    def ChangeLayer(self ,changeType:'ShapeLayerChangeType'):
        ...
        GetDllLibXls().XlsShape_ChangeLayer(self.Ptr, enumchangeType)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:int):
        GetDllLibXls().XlsShape_set_Height.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsShape_set_Height(self.Ptr, value)
    ...
    def ID(self)->int:
        ...
        ret = GetDllLibXls().XlsShape_get_ID(self.Ptr)
        return ret
    ...
    def ShapeId(self)->int:
        ...
        ret = GetDllLibXls().XlsShape_get_ShapeId(self.Ptr)
        return ret

    @ShapeId.setter
    def ShapeId(self, value:int):
        GetDllLibXls().XlsShape_set_ShapeId.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsShape_set_ShapeId(self.Ptr, value)
    ...
    def Left(self)->int:
        ...
        ret = GetDllLibXls().XlsShape_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:int):
        GetDllLibXls().XlsShape_set_Left.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsShape_set_Left(self.Ptr, value)
    ...
    def Top(self)->int:
        ...
        ret = GetDllLibXls().XlsShape_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:int):
        GetDllLibXls().XlsShape_set_Top.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsShape_set_Top(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:int):
        GetDllLibXls().XlsShape_set_Width.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsShape_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_ShapeType(self.Ptr)
    ...
    def ShapeType(self, value:'ExcelShapeType'):
        ...
        GetDllLibXls().XlsShape_set_ShapeType(self.Ptr, value.value)
    ...
    def VmlShape(self)->bool:
        ...
        ret = GetDllLibXls().XlsShape_get_VmlShape(self.Ptr)
        return ret

    @VmlShape.setter
    def VmlShape(self, value:bool):
        GetDllLibXls().XlsShape_set_VmlShape.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShape_set_VmlShape(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_IsRelativeResize(self.Ptr)
        return ret
    ...
    def IsRelativeResize(self, value:bool):
        ...
        GetDllLibXls().XlsShape_set_IsRelativeResize(self.Ptr, value)
    ...
    def IsRelative(self)->bool:
        ...
        ret = GetDllLibXls().XlsShape_get_IsRelative(self.Ptr)
        return ret

    @IsRelative.setter
    def IsRelative(self, value:bool):
        GetDllLibXls().XlsShape_set_IsRelative.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShape_set_IsRelative(self.Ptr, value)
    ...
    def Instance(self)->int:
        ...
        ret = GetDllLibXls().XlsShape_get_Instance(self.Ptr)
        return ret
    ...
    def ShapeCount(self)->int:
        ...
        ret = GetDllLibXls().XlsShape_get_ShapeCount(self.Ptr)
        return ret
    ...
    def Visible(self)->bool:
        ...
        ret = GetDllLibXls().XlsShape_get_Visible(self.Ptr)
        return ret

    @Visible.setter
    def Visible(self, value:bool):
        GetDllLibXls().XlsShape_set_Visible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShape_set_Visible(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsShape_get_HtmlString.restype=c_wchar_p
        ret = GetDllLibXls().XlsShape_get_HtmlString(self.Ptr)
        return ret
    ...
    def HtmlString(self, value:str):
        ...
        GetDllLibXls().XlsShape_set_HtmlString(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsShape_get_AlternativeText.restype=c_wchar_p
        ret = GetDllLibXls().XlsShape_get_AlternativeText(self.Ptr)
        return ret
    ...
    def AlternativeText(self, value:str):
        ...
        GetDllLibXls().XlsShape_set_AlternativeText(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsShape_get_Fill(self.Ptr)
    ...
    def UpdatePositions(self)->bool:
        ...
        ret = GetDllLibXls().XlsShape_get_UpdatePositions(self.Ptr)
        return ret
    ...
    def UpdatePositions(self, value:bool):
        ...
        GetDllLibXls().XlsShape_set_UpdatePositions(self.Ptr, value)
    ...
    def HasFill(self)->bool:
        ...
        ret = GetDllLibXls().XlsShape_get_HasFill(self.Ptr)
        return ret

    @HasFill.setter
    def HasFill(self, value:bool):
        GetDllLibXls().XlsShape_set_HasFill.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShape_set_HasFill(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_IsFlipH(self.Ptr)
        return ret

    @IsFlipH.setter
    def IsFlipH(self, value:bool):
        GetDllLibXls().XlsShape_set_IsFlipH.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShape_set_IsFlipH(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_IsFlipV(self.Ptr)
        return ret

    @IsFlipV.setter
    def IsFlipV(self, value:bool):
        GetDllLibXls().XlsShape_set_IsFlipV.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShape_set_IsFlipV(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_IsGroup(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_IsInGroup(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsShape_get_AlternativeTextTitle.restype=c_wchar_p
        ret = GetDllLibXls().XlsShape_get_AlternativeTextTitle(self.Ptr)
        return ret
    ...
    def AlternativeTextTitle(self, value:str):
        ...
        GetDllLibXls().XlsShape_set_AlternativeTextTitle(self.Ptr, value)
    ...
    def OnAction(self)->str:
        ...
        GetDllLibXls().XlsShape_get_OnAction.restype=c_wchar_p
        ret = GetDllLibXls().XlsShape_get_OnAction(self.Ptr)
        return ret
    ...
    def OnAction(self, value:str):
        ...
        GetDllLibXls().XlsShape_set_OnAction(self.Ptr, value)
    ...
    def IsLocked(self)->bool:
        ...
        ret = GetDllLibXls().XlsShape_get_IsLocked(self.Ptr)
        return ret

    @IsLocked.setter
    def IsLocked(self, value:bool):
        GetDllLibXls().XlsShape_set_IsLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShape_set_IsLocked(self.Ptr, value)
    ...
    def IsPrintable(self)->bool:
        ...
        ret = GetDllLibXls().XlsShape_get_IsPrintable(self.Ptr)
        return ret

    @IsPrintable.setter
    def IsPrintable(self, value:bool):
        GetDllLibXls().XlsShape_set_IsPrintable.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShape_set_IsPrintable(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_ResizeBehave(self.Ptr)
    ...
    def ResizeBehave(self, value:'ResizeBehaveType'):
        ...
        GetDllLibXls().XlsShape_set_ResizeBehave(self.Ptr, value.value)
    ...
    def IsLockAspectRatio(self)->bool:
        ...
        ret = GetDllLibXls().XlsShape_get_IsLockAspectRatio(self.Ptr)
        return ret
    ...
    def IsLockAspectRatio(self, value:bool):
        ...
        GetDllLibXls().XlsShape_set_IsLockAspectRatio(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_BottomRow(self.Ptr)
        return ret

    @BottomRow.setter
    def BottomRow(self, value:int):
        GetDllLibXls().XlsShape_set_BottomRow.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsShape_set_BottomRow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_BottomRowOffset(self.Ptr)
        return ret
    ...
    def BottomRowOffset(self, value:int):
        ...
        GetDllLibXls().XlsShape_set_BottomRowOffset(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_LeftColumn(self.Ptr)
        return ret

    @LeftColumn.setter
    def LeftColumn(self, value:int):
        GetDllLibXls().XlsShape_set_LeftColumn.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsShape_set_LeftColumn(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_LeftColumnOffset(self.Ptr)
        return ret
    ...
    def LeftColumnOffset(self, value:int):
        ...
        GetDllLibXls().XlsShape_set_LeftColumnOffset(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_RightColumn(self.Ptr)
        return ret

    @RightColumn.setter
    def RightColumn(self, value:int):
        GetDllLibXls().XlsShape_set_RightColumn.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsShape_set_RightColumn(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_RightColumnOffset(self.Ptr)
        return ret
    ...
    def RightColumnOffset(self, value:int):
        ...
        GetDllLibXls().XlsShape_set_RightColumnOffset(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_TopRow(self.Ptr)
        return ret

    @TopRow.setter
    def TopRow(self, value:int):
        GetDllLibXls().XlsShape_set_TopRow.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsShape_set_TopRow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsShape_get_TopRowOffset(self.Ptr)
        return ret

    @TopRowOffset.setter
    def TopRowOffset(self, value:int):
        GetDllLibXls().XlsShape_set_TopRowOffset.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsShape_set_TopRowOffset(self.Ptr, value)
    ...
    def Line(self)->'IShapeLineFormat':
        ...
        intPtr = GetDllLibXls().XlsShape_get_Line(self.Ptr)
    ...
    def AutoSize(self)->bool:
        ...
        ret = GetDllLibXls().XlsShape_get_AutoSize(self.Ptr)
        return ret

    @AutoSize.setter
    def AutoSize(self, value:bool):
        GetDllLibXls().XlsShape_set_AutoSize.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShape_set_AutoSize(self.Ptr, value)
...
<value></value>
        ...
        ret = GetDllLibXls().XlsShape_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:int):
        GetDllLibXls().XlsShape_set_Rotation.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsShape_set_Rotation(self.Ptr, value)
    ...
    def Shadow(self)->'IShadow':
        ...
        intPtr = GetDllLibXls().XlsShape_get_Shadow(self.Ptr)
    ...
    def Glow(self)->'IGlow':
        ...
        intPtr = GetDllLibXls().XlsShape_get_Glow(self.Ptr)
    ...
    def Reflection(self)->'IReflectionEffect':
        ...
        intPtr = GetDllLibXls().XlsShape_get_Reflection(self.Ptr)
    ...
    def RichText(self)->'IRichTextString':
        ...
        intPtr = GetDllLibXls().XlsShape_get_RichText(self.Ptr)
    ...
    def ThreeD(self)->'IFormat3D':
        ...
        intPtr = GetDllLibXls().XlsShape_get_ThreeD(self.Ptr)
    ...
    def IsSmartArt(self)->bool:
        ...
        ret = GetDllLibXls().XlsShape_get_IsSmartArt(self.Ptr)
        return ret
    ...
    def TextFrame(self)->'ITextFrame':
        ...
        intPtr = GetDllLibXls().XlsShape_get_TextFrame(self.Ptr)
    ...
    def TextVerticalAlignment(self)->'ExcelVerticalAlignment':
        ...
        ret = GetDllLibXls().XlsShape_get_TextVerticalAlignment(self.Ptr)
    ...
    def TextVerticalAlignment(self, value:'ExcelVerticalAlignment'):
        ...
        GetDllLibXls().XlsShape_set_TextVerticalAlignment(self.Ptr, value.value)
    ...
    def LinkedCell(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().XlsShape_get_LinkedCell(self.Ptr)
    ...
    def LinkedCell(self, value:'IXLSRange'):
        ...
        GetDllLibXls().XlsShape_set_LinkedCell(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsShape_Remove(self.Ptr)
    ...
    <param name="scaleHeight">Height scale in percent.</param>
        ...
        GetDllLibXls().XlsShape_Scale(self.Ptr, scaleWidth,scaleHeight)

    @dispatch

    def SaveToImage(self)->Bitmap:
        """
    <summary>
        Save shape to image.
    </summary>
    <returns>Created image.</returns>
        ...
        intPtr = GetDllLibXls().XlsShape_SaveToImage1(self.Ptr)
    ...
    <param name="imageFormat">Type of the image to create.</param>
        ...
        GetDllLibXls().XlsShape_SaveToImageFI(self.Ptr, intPtrfileStream,intPtrimageFormat)
