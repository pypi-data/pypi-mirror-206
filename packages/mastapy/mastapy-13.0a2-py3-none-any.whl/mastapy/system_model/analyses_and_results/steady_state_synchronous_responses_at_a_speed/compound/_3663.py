...
class CylindricalPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed(_3660.CylindricalGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """CylindricalPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_CylindricalPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'CylindricalPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def cylindrical_planet_gear_compound_steady_state_synchronous_response_at_a_speed(self) -> 'CylindricalPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3533.CylindricalPlanetGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3533.CylindricalPlanetGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'CylindricalPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed._Cast_CylindricalPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_CylindricalPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed(self)
