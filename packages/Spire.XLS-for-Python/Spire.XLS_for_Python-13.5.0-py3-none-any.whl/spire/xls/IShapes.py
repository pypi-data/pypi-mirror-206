...
class IShapes (  SpireObject) :
    ...
    def Add(self)->'IChartShape':
        ...
        intPtr = GetDllLibXls().IShapes_Add(self.Ptr)
    ...
    <returns>Newly created line.</returns>
        ...
        intPtr = GetDllLibXls().IShapes_AddLine(self.Ptr, intPtrstartPoint,intPtrendPoint,enumlineShapeType)
    ...
    def AddPicture(self ,image:Image,pictureName:str,imageFormat:ImageFormatType)->IPictureShape:
        """
        ...
        intPtr = GetDllLibXls().IShapes_AddPicture(self.Ptr, intPtrimage,pictureName,enumimageFormat)
    ...
    def AddPicture(self ,fileName:str)->IPictureShape:
        ...
        intPtr = GetDllLibXls().IShapes_AddPictureF(self.Ptr, fileName)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def AddComment(self ,commentText:str,bIsParseOptions:bool)->ICommentShape:
        ...
        intPtr = GetDllLibXls().IShapes_AddComment(self.Ptr, commentText,bIsParseOptions)
    ...
    def AddComment(self ,commentText:str)->ICommentShape:
        ...
        intPtr = GetDllLibXls().IShapes_AddCommentC(self.Ptr, commentText)
        ret = None if intPtr==None else XlsComment(intPtr)
        return ret
    ...
    def AddComment(self)->ICommentShape:
        ...
        intPtr = GetDllLibXls().IShapes_AddComment1(self.Ptr)
        ret = None if intPtr==None else XlsComment(intPtr)
        return ret
    ...
    def AddCopy(self ,sourceShape:IShape)->IShape:
        ...
        intPtr = GetDllLibXls().IShapes_AddCopy(self.Ptr, intPtrsourceShape)
...
#        intPtr = GetDllLibXls().IShapes_AddCopySHA(self.Ptr, intPtrsourceShape,intPtrhashNewNames,intPtrarrFontIndexes)
#        ret = None if intPtr==None else IShape(intPtr)
#        return ret
#
    ...
    def AddTextBox(self)->'ITextBoxLinkShape':
        ...
        intPtr = GetDllLibXls().IShapes_AddTextBox(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().IShapes_AddOval(self.Ptr, row,column,height,width)
    ...
    def AddPrstGeomShape(self ,shapeType:'PrstGeomShapeType')->'IPrstGeomShape':
        ...
        intPtr = GetDllLibXls().IShapes_AddPrstGeomShape(self.Ptr, enumshapeType)
    ...
    def AddCheckBox(self)->'ICheckBox':
        ...
        intPtr = GetDllLibXls().IShapes_AddCheckBox(self.Ptr)
    ...
    def AddComboBox(self)->'IComboBoxShape':
        ...
        intPtr = GetDllLibXls().IShapes_AddComboBox(self.Ptr)
    ...
    def AddRadioButton(self)->'IRadioButton':
        ...
        intPtr = GetDllLibXls().IShapes_AddRadioButton(self.Ptr)
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().IShapes_get_Count(self.Ptr)
        return ret
    ...
    def get_Item(self ,index:int)->IShape:
        ...
        intPtr = GetDllLibXls().IShapes_get_Item(self.Ptr, index)
        ret = None if intPtr==None else IShape(intPtr)
        return ret
    ...
    def get_Item(self ,strShapeName:str)->IShape:
        ...
        intPtr = GetDllLibXls().IShapes_get_ItemS(self.Ptr, strShapeName)
        ret = None if intPtr==None else IShape(intPtr)
        return ret
