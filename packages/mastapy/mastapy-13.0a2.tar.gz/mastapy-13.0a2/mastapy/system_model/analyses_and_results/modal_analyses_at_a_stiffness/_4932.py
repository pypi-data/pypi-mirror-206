...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4931, _4930, _4848
...
class SpiralBevelGearSetModalAnalysisAtAStiffness(_4848.BevelGearSetModalAnalysisAtAStiffness):
    """SpiralBevelGearSetModalAnalysisAtAStiffness
    ...
    class _Cast_SpiralBevelGearSetModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'SpiralBevelGearSetModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_set_modal_analysis_at_a_stiffness(self) -> 'SpiralBevelGearSetModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def spiral_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4931.SpiralBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4930.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearSetModalAnalysisAtAStiffness._Cast_SpiralBevelGearSetModalAnalysisAtAStiffness':
