...
class ExternalCADModelHarmonicAnalysis(_5675.ComponentHarmonicAnalysis):
    """ExternalCADModelHarmonicAnalysis
    ...
    class _Cast_ExternalCADModelHarmonicAnalysis:
        ...
        def __init__(self, parent: 'ExternalCADModelHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def external_cad_model_harmonic_analysis(self) -> 'ExternalCADModelHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ExternalCADModelHarmonicAnalysis._Cast_ExternalCADModelHarmonicAnalysis':
