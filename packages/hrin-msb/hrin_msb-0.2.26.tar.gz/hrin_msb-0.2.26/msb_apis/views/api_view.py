...
from rest_framework.decorators import (
	permission_classes as require_permission, authentication_classes as require_authentication
)
from msb_auth import permissions
from msb_auth.users import TokenUser
from msb_auth.session import SessionData
...
class ApiView(viewsets.GenericViewSet):
	...
	@property
	def token(self) -> users.TokenUser:
		return self.request.user

	@property
	def user(self) -> session.SessionData:
