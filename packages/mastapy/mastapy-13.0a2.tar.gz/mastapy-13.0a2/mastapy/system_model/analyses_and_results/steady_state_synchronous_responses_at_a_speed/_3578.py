...
class ShaftHubConnectionSteadyStateSynchronousResponseAtASpeed(_3519.ConnectorSteadyStateSynchronousResponseAtASpeed):
    """ShaftHubConnectionSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ShaftHubConnectionSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ShaftHubConnectionSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def shaft_hub_connection_steady_state_synchronous_response_at_a_speed(self) -> 'ShaftHubConnectionSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftHubConnectionSteadyStateSynchronousResponseAtASpeed._Cast_ShaftHubConnectionSteadyStateSynchronousResponseAtASpeed':
