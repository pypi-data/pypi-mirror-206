...
class BevelDifferentialSunGearParametricStudyTool(_4283.BevelDifferentialGearParametricStudyTool):
    """BevelDifferentialSunGearParametricStudyTool
    ...
    class _Cast_BevelDifferentialSunGearParametricStudyTool:
        ...
        def __init__(self, parent: 'BevelDifferentialSunGearParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def bevel_differential_sun_gear_parametric_study_tool(self) -> 'BevelDifferentialSunGearParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialSunGearParametricStudyTool._Cast_BevelDifferentialSunGearParametricStudyTool':
