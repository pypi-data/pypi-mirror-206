...
class BevelGearHarmonicAnalysisOfSingleExcitation(_5979.AGMAGleasonConicalGearHarmonicAnalysisOfSingleExcitation):
    """BevelGearHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_BevelGearHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'BevelGearHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def bevel_gear_harmonic_analysis_of_single_excitation(self) -> 'BevelGearHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearHarmonicAnalysisOfSingleExcitation._Cast_BevelGearHarmonicAnalysisOfSingleExcitation':
