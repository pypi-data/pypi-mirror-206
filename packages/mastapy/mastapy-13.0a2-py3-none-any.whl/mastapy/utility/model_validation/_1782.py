...
from mastapy.utility.model_validation import _1783
...
class Status(_0.APIBase):
    ...
    @property
    def errors(self) -> 'List[_1783.StatusItem]':
    ...
    @property
    def warnings(self) -> 'List[_1783.StatusItem]':
    ...
    @property
    def cast_to(self) -> 'Status._Cast_Status':
