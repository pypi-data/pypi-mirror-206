...
from mastapy.detailed_rigid_connectors.splines import _1386, _1403
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1409
...
class SplineHalfDesign(_1376.DetailedRigidConnectorHalfDesign):
    """SplineHalfDesign
    ...
    class _Cast_SplineHalfDesign:
        ...
        def custom_spline_half_design(self):
            ...
            return self._parent._cast(_1377.CustomSplineHalfDesign)
    ...
    @property
    def heat_treatment(self) -> '_1386.HeatTreatmentTypes':
    ...
    def heat_treatment(self, value: '_1386.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_1409.FitAndTolerance':
