...
class AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis(_5531.ConicalGearCompoundMultibodyDynamicsAnalysis):
    """AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_compound_multibody_dynamics_analysis(self) -> 'AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5352.AGMAGleasonConicalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5352.AGMAGleasonConicalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis._Cast_AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis':
