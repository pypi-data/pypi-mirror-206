...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4695, _4692
...
class SingleExcitationResultsModalAnalysis(_4692.DesignEntityModalAnalysisGroupResults):
    """SingleExcitationResultsModalAnalysis
    ...
    class _Cast_SingleExcitationResultsModalAnalysis:
        ...
        def __init__(self, parent: 'SingleExcitationResultsModalAnalysis'):
            self._parent = parent

        @property
        def design_entity_modal_analysis_group_results(self):
            return self._parent._cast(_4692.DesignEntityModalAnalysisGroupResults)

        @property
        def single_excitation_results_modal_analysis(self) -> 'SingleExcitationResultsModalAnalysis':
            return self._parent
    ...
    @property
    def all_rigidly_connected_groups(self) -> 'List[_4695.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]':
    ...
    @property
    def rigidly_connected_groups_with_significant_energy(self) -> 'List[_4695.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]':
    ...
    @property
    def rigidly_connected_groups_with_significant_kinetic_energy(self) -> 'List[_4695.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]':
    ...
    @property
    def rigidly_connected_groups_with_significant_strain_energy(self) -> 'List[_4695.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SingleExcitationResultsModalAnalysis._Cast_SingleExcitationResultsModalAnalysis':
