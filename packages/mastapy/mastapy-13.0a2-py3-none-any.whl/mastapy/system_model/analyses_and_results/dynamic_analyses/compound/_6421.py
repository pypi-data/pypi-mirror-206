...
class CylindricalGearMeshCompoundDynamicAnalysis(_6432.GearMeshCompoundDynamicAnalysis):
    """CylindricalGearMeshCompoundDynamicAnalysis
    ...
    class _Cast_CylindricalGearMeshCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'CylindricalGearMeshCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_compound_dynamic_analysis(self) -> 'CylindricalGearMeshCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6291.CylindricalGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6291.CylindricalGearMeshDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshCompoundDynamicAnalysis._Cast_CylindricalGearMeshCompoundDynamicAnalysis':
