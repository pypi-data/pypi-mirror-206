...
class SpiralBevelGearMeshModalAnalysisAtASpeed(_5105.BevelGearMeshModalAnalysisAtASpeed):
    """SpiralBevelGearMeshModalAnalysisAtASpeed
    ...
    class _Cast_SpiralBevelGearMeshModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_modal_analysis_at_a_speed(self) -> 'SpiralBevelGearMeshModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshModalAnalysisAtASpeed._Cast_SpiralBevelGearMeshModalAnalysisAtASpeed':
