...
class ParetoSpiralBevelGearSetDutyCycleOptimisationStrategyDatabase(_918.ParetoConicalRatingOptimisationStrategyDatabase):
    """ParetoSpiralBevelGearSetDutyCycleOptimisationStrategyDatabase
    ...
    class _Cast_ParetoSpiralBevelGearSetDutyCycleOptimisationStrategyDatabase:
        ...
        def __init__(self, parent: 'ParetoSpiralBevelGearSetDutyCycleOptimisationStrategyDatabase'):
            self._parent = parent
        ...
        @property
        def pareto_spiral_bevel_gear_set_duty_cycle_optimisation_strategy_database(self) -> 'ParetoSpiralBevelGearSetDutyCycleOptimisationStrategyDatabase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ParetoSpiralBevelGearSetDutyCycleOptimisationStrategyDatabase._Cast_ParetoSpiralBevelGearSetDutyCycleOptimisationStrategyDatabase':
        return self._Cast_ParetoSpiralBevelGearSetDutyCycleOptimisationStrategyDatabase(self)
