...
class BevelDifferentialPlanetGearMultibodyDynamicsAnalysis(_5361.BevelDifferentialGearMultibodyDynamicsAnalysis):
    """BevelDifferentialPlanetGearMultibodyDynamicsAnalysis
    ...
    class _Cast_BevelDifferentialPlanetGearMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialPlanetGearMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_planet_gear_multibody_dynamics_analysis(self) -> 'BevelDifferentialPlanetGearMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialPlanetGearMultibodyDynamicsAnalysis._Cast_BevelDifferentialPlanetGearMultibodyDynamicsAnalysis':
