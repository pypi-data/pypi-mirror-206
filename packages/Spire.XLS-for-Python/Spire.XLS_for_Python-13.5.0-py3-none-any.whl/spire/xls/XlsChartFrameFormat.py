...
class XlsChartFrameFormat (  XlsObject, IChartFrameFormat, IChartFillBorder) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_IsBorderCornersRound(self.Ptr)
        return ret
    ...
    def IsBorderCornersRound(self, value:bool):
        ...
        GetDllLibXls().XlsChartFrameFormat_set_IsBorderCornersRound(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartFrameFormat_get_Border(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_HasInterior(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_HasLineProperties(self.Ptr)
        return ret
    ...
    def HasManualLayout(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_HasManualLayout(self.Ptr)
        return ret
    ...
    def InnerLayoutTarget(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_InnerLayoutTarget(self.Ptr)
        return ret
    ...
    def InnerLayoutTarget(self, value:bool):
        ...
        GetDllLibXls().XlsChartFrameFormat_set_InnerLayoutTarget(self.Ptr, value)
    ...
    def Interior(self)->'IChartInterior':
        ...
        intPtr = GetDllLibXls().XlsChartFrameFormat_get_Interior(self.Ptr)
...
<value>The chart3 D properties.</value>
        ...
        intPtr = GetDllLibXls().XlsChartFrameFormat_get_Format3D(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartFrameFormat_get_Fill(self.Ptr)
    ...
    def HasShadow(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_HasShadow(self.Ptr)
        return ret
    ...
    def HasFormat3D(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_HasFormat3D(self.Ptr)
        return ret
...
<value>The shadow properties.</value>
        ...
        intPtr = GetDllLibXls().XlsChartFrameFormat_get_Shadow(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartFrameFormat_get_LineProperties(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_IsAutoSize(self.Ptr)
        return ret

    @IsAutoSize.setter
    def IsAutoSize(self, value:bool):
        GetDllLibXls().XlsChartFrameFormat_set_IsAutoSize.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFrameFormat_set_IsAutoSize(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_IsAutoPosition(self.Ptr)
        return ret
    ...
    def IsAutoPosition(self, value:bool):
        ...
        GetDllLibXls().XlsChartFrameFormat_set_IsAutoPosition(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_X(self.Ptr)
        return ret

    @X.setter
    def X(self, value:int):
        GetDllLibXls().XlsChartFrameFormat_set_X.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFrameFormat_set_X(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_Y(self.Ptr)
        return ret

    @Y.setter
    def Y(self, value:int):
        GetDllLibXls().XlsChartFrameFormat_set_Y.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFrameFormat_set_Y(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:int):
        GetDllLibXls().XlsChartFrameFormat_set_Width.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFrameFormat_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:int):
        GetDllLibXls().XlsChartFrameFormat_set_Height.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartFrameFormat_set_Height(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_IsWMode(self.Ptr)
        return ret

    @IsWMode.setter
    def IsWMode(self, value:bool):
        GetDllLibXls().XlsChartFrameFormat_set_IsWMode.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFrameFormat_set_IsWMode(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_IsHMode(self.Ptr)
        return ret

    @IsHMode.setter
    def IsHMode(self, value:bool):
        GetDllLibXls().XlsChartFrameFormat_set_IsHMode.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFrameFormat_set_IsHMode(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_IsXMode(self.Ptr)
        return ret

    @IsXMode.setter
    def IsXMode(self, value:bool):
        GetDllLibXls().XlsChartFrameFormat_set_IsXMode.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFrameFormat_set_IsXMode(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_IsYMode(self.Ptr)
        return ret

    @IsYMode.setter
    def IsYMode(self, value:bool):
        GetDllLibXls().XlsChartFrameFormat_set_IsYMode.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFrameFormat_set_IsYMode(self.Ptr, value)
    ...
    def ForeGroundKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_ForeGroundKnownColor(self.Ptr)
    ...
    def ForeGroundKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartFrameFormat_set_ForeGroundKnownColor(self.Ptr, value.value)
    ...
    def ForeGroundColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsChartFrameFormat_get_ForeGroundColor(self.Ptr)
    ...
    def ForeGroundColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartFrameFormat_set_ForeGroundColor(self.Ptr, value.Ptr)
    ...
    def ForeGroundColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsChartFrameFormat_get_ForeGroundColorObject(self.Ptr)
    ...
    def BackGroundKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_BackGroundKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def BackGroundKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartFrameFormat_set_BackGroundKnownColor(self.Ptr, value.value)
    ...
    def BackGroundColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsChartFrameFormat_get_BackGroundColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def BackGroundColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartFrameFormat_set_BackGroundColor(self.Ptr, value.Ptr)
    ...
    def BackGroundColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsChartFrameFormat_get_BackGroundColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def Pattern(self)->'ExcelPatternType':
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_Pattern(self.Ptr)
    ...
    def Pattern(self, value:'ExcelPatternType'):
        ...
        GetDllLibXls().XlsChartFrameFormat_set_Pattern(self.Ptr, value.value)
    ...
    def RectangleStyle(self)->'RectangleStyleType':
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_RectangleStyle(self.Ptr)
    ...
    def RectangleStyle(self, value:'RectangleStyleType'):
        ...
        GetDllLibXls().XlsChartFrameFormat_set_RectangleStyle(self.Ptr, value.value)
    ...
    def IsAutomaticFormat(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_IsAutomaticFormat(self.Ptr)
        return ret
    ...
    def IsAutomaticFormat(self, value:bool):
        ...
        GetDllLibXls().XlsChartFrameFormat_set_IsAutomaticFormat(self.Ptr, value)
    ...
    def Visible(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartFrameFormat_get_Visible(self.Ptr)
        return ret

    @Visible.setter
    def Visible(self, value:bool):
        GetDllLibXls().XlsChartFrameFormat_set_Visible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartFrameFormat_set_Visible(self.Ptr, value)
    ...
    def Clear(self):
        ...
        GetDllLibXls().XlsChartFrameFormat_Clear(self.Ptr)
    ...
    def Clone(self ,parent:'SpireObject')->'XlsChartFrameFormat':
        ...
        intPtr = GetDllLibXls().XlsChartFrameFormat_Clone(self.Ptr, intPtrparent)
    ...
    def SetDefaultValues(self ,bAutoSize:bool,bIsInteriorGray:bool):
        ...
        GetDllLibXls().XlsChartFrameFormat_SetDefaultValues(self.Ptr, bAutoSize,bIsInteriorGray)
