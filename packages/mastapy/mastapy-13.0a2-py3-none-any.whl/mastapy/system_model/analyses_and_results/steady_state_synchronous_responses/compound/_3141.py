...
class CycloidalDiscPlanetaryBearingConnectionCompoundSteadyStateSynchronousResponse(_3098.AbstractShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """CycloidalDiscPlanetaryBearingConnectionCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_CycloidalDiscPlanetaryBearingConnectionCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'CycloidalDiscPlanetaryBearingConnectionCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_planetary_bearing_connection_compound_steady_state_synchronous_response(self) -> 'CycloidalDiscPlanetaryBearingConnectionCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3007.CycloidalDiscPlanetaryBearingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3007.CycloidalDiscPlanetaryBearingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscPlanetaryBearingConnectionCompoundSteadyStateSynchronousResponse._Cast_CycloidalDiscPlanetaryBearingConnectionCompoundSteadyStateSynchronousResponse':
        return self._Cast_CycloidalDiscPlanetaryBearingConnectionCompoundSteadyStateSynchronousResponse(self)
