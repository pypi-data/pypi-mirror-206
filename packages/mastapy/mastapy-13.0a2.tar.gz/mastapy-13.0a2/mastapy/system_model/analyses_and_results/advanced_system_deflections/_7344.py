...
class StraightBevelDiffGearMeshAdvancedSystemDeflection(_7252.BevelGearMeshAdvancedSystemDeflection):
    """StraightBevelDiffGearMeshAdvancedSystemDeflection
    ...
    class _Cast_StraightBevelDiffGearMeshAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearMeshAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_mesh_advanced_system_deflection(self) -> 'StraightBevelDiffGearMeshAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2792.StraightBevelDiffGearMeshSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearMeshAdvancedSystemDeflection._Cast_StraightBevelDiffGearMeshAdvancedSystemDeflection':
