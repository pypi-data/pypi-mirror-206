...
class SynchroniserPartHarmonicAnalysis(_5688.CouplingHalfHarmonicAnalysis):
    """SynchroniserPartHarmonicAnalysis
    ...
    class _Cast_SynchroniserPartHarmonicAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserPartHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_part_harmonic_analysis(self) -> 'SynchroniserPartHarmonicAnalysis':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2801.SynchroniserPartSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'SynchroniserPartHarmonicAnalysis._Cast_SynchroniserPartHarmonicAnalysis':
