...
class RigidElementNodeDegreesOfFreedom(_0.APIBase):
    ...
    @property
    def type_(self) -> '_202.DegreeOfFreedomType':
        ...
        value = conversion.pn_to_mp_enum(temp, _202.DegreeOfFreedomType)
        return constructor.new_from_mastapy_type(_202.DegreeOfFreedomType)(value) if value is not None else None
