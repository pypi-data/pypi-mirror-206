...
class FaceGearCompoundPowerFlow(_4200.GearCompoundPowerFlow):
    """FaceGearCompoundPowerFlow
    ...
    class _Cast_FaceGearCompoundPowerFlow:
        ...
        def __init__(self, parent: 'FaceGearCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def face_gear_compound_power_flow(self) -> 'FaceGearCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4064.FaceGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4064.FaceGearPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'FaceGearCompoundPowerFlow._Cast_FaceGearCompoundPowerFlow':
