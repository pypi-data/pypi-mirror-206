...
class ExternalCADModelCriticalSpeedAnalysis(_6533.ComponentCriticalSpeedAnalysis):
    """ExternalCADModelCriticalSpeedAnalysis
    ...
    class _Cast_ExternalCADModelCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'ExternalCADModelCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def external_cad_model_critical_speed_analysis(self) -> 'ExternalCADModelCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ExternalCADModelCriticalSpeedAnalysis._Cast_ExternalCADModelCriticalSpeedAnalysis':
