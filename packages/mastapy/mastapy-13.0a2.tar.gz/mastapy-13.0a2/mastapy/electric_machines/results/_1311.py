...
class EfficiencyResults(_0.APIBase):
    ...
    class _Cast_EfficiencyResults:
        ...
        def __init__(self, parent: 'EfficiencyResults'):
            self._parent = parent

        @property
        def efficiency_results(self) -> 'EfficiencyResults':
            return self._parent
    ...
    @property
    def ac_winding_loss(self) -> '_1850.ThreeDChartDefinition':
        """ThreeDChartDefinition: 'ACWindingLoss' is the original name of this property.
    ...
    @property
    def current_angle(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def d_axis_current(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def d_axis_flux_linkage(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def dc_winding_loss(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def efficiency_map(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def input_power(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def magnet_loss(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def output_power(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def peak_phase_current_magnitude(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def peak_phase_voltage_magnitude(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def q_axis_current(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def q_axis_flux_linkage(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def rotor_eddy_current_loss(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def rotor_excess_loss(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def rotor_hysteresis_loss(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def stator_eddy_current_loss(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def stator_excess_loss(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def stator_hysteresis_loss(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def total_loss(self) -> '_1850.ThreeDChartDefinition':
    ...
    @property
    def cast_to(self) -> 'EfficiencyResults._Cast_EfficiencyResults':
