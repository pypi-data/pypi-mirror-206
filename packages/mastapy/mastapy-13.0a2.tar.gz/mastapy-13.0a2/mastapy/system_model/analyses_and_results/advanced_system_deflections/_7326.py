...
class PulleyAdvancedSystemDeflection(_7275.CouplingHalfAdvancedSystemDeflection):
    """PulleyAdvancedSystemDeflection
    ...
    class _Cast_PulleyAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'PulleyAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def pulley_advanced_system_deflection(self) -> 'PulleyAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PulleyAdvancedSystemDeflection._Cast_PulleyAdvancedSystemDeflection':
