...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _637, _651
...
class PlungeShaverGeneration(_0.APIBase):
    ...
    @property
    def calculated_conjugate_face_width(self) -> '_1477.Range':
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_999.CrossedAxisCylindricalGearPairLineContact':
    ...
    @property
    def calculation_errors(self) -> 'List[_637.CalculationError]':
    ...
    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_651.ShaverPointOfInterest]':
