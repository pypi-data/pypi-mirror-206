...
class PointLoadCompoundModalAnalysisAtASpeed(_5340.VirtualComponentCompoundModalAnalysisAtASpeed):
    """PointLoadCompoundModalAnalysisAtASpeed
    ...
    class _Cast_PointLoadCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'PointLoadCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def point_load_compound_modal_analysis_at_a_speed(self) -> 'PointLoadCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5175.PointLoadModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5175.PointLoadModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'PointLoadCompoundModalAnalysisAtASpeed._Cast_PointLoadCompoundModalAnalysisAtASpeed':
