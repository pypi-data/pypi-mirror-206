...
class CylindricalGearModalAnalysisAtASpeed(_5148.GearModalAnalysisAtASpeed):
    """CylindricalGearModalAnalysisAtASpeed
    ...
    class _Cast_CylindricalGearModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'CylindricalGearModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_modal_analysis_at_a_speed(self) -> 'CylindricalGearModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearModalAnalysisAtASpeed._Cast_CylindricalGearModalAnalysisAtASpeed':
