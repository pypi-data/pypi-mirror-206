...
class ExternalCADModelStabilityAnalysis(_3767.ComponentStabilityAnalysis):
    """ExternalCADModelStabilityAnalysis
    ...
    class _Cast_ExternalCADModelStabilityAnalysis:
        ...
        def __init__(self, parent: 'ExternalCADModelStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def external_cad_model_stability_analysis(self) -> 'ExternalCADModelStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ExternalCADModelStabilityAnalysis._Cast_ExternalCADModelStabilityAnalysis':
