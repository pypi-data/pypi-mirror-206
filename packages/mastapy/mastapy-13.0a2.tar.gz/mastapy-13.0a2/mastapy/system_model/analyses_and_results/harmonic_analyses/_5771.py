...
class RollingRingHarmonicAnalysis(_5688.CouplingHalfHarmonicAnalysis):
    """RollingRingHarmonicAnalysis
    ...
    class _Cast_RollingRingHarmonicAnalysis:
        ...
        def __init__(self, parent: 'RollingRingHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def rolling_ring_harmonic_analysis(self) -> 'RollingRingHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingHarmonicAnalysis._Cast_RollingRingHarmonicAnalysis':
