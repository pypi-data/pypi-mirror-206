...
class XlsChartSeries (  CollectionBase[XlsChartSerie],ICloneParent, IChartSeries) :
    ...
    def AssignTrendDataLabel(self ,area:'ChartTextArea'):
        ...
        GetDllLibXls().XlsChartSeries_AssignTrendDataLabel(self.Ptr, intPtrarea)
    ...
    def Remove(self ,serieName:str):
        ...
        GetDllLibXls().XlsChartSeries_Remove(self.Ptr, serieName)
    ...
    def Clone(self ,parent:SpireObject)->SpireObject:
        ...
        intPtr = GetDllLibXls().XlsChartSeries_Clone(self.Ptr, intPtrparent)
...
#        intPtr = GetDllLibXls().XlsChartSeries_ClonePHF(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrfontIndexes)
...
#
    ...
    def FindOrderByType(self ,type:'ExcelChartType')->int:
        ...
        ret = GetDllLibXls().XlsChartSeries_FindOrderByType(self.Ptr, enumtype)
        return ret
    ...
    def GetLegendEntryOffset(self ,iSerIndex:int)->int:
        ...
        ret = GetDllLibXls().XlsChartSeries_GetLegendEntryOffset(self.Ptr, iSerIndex)
        return ret
    ...
    def GetTypeByOrder(self ,order:int)->'ExcelChartType':
        ...
        ret = GetDllLibXls().XlsChartSeries_GetTypeByOrder(self.Ptr, order)
