...
class PartToPartShearCouplingHalfAdvancedSystemDeflection(_7275.CouplingHalfAdvancedSystemDeflection):
    """PartToPartShearCouplingHalfAdvancedSystemDeflection
    ...
    class _Cast_PartToPartShearCouplingHalfAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingHalfAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_half_advanced_system_deflection(self) -> 'PartToPartShearCouplingHalfAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingHalfAdvancedSystemDeflection._Cast_PartToPartShearCouplingHalfAdvancedSystemDeflection':
