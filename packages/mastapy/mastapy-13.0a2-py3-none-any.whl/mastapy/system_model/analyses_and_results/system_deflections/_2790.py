...
class SpringDamperHalfSystemDeflection(_2709.CouplingHalfSystemDeflection):
    """SpringDamperHalfSystemDeflection
    ...
    class _Cast_SpringDamperHalfSystemDeflection:
        ...
        def __init__(self, parent: 'SpringDamperHalfSystemDeflection'):
            self._parent = parent
        ...
        @property
        def spring_damper_half_system_deflection(self) -> 'SpringDamperHalfSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4115.SpringDamperHalfPowerFlow':
    ...
    @property
    def cast_to(self) -> 'SpringDamperHalfSystemDeflection._Cast_SpringDamperHalfSystemDeflection':
