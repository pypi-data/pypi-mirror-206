...
class ConceptGearCompoundDynamicAnalysis(_6431.GearCompoundDynamicAnalysis):
    """ConceptGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6272.ConceptGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6272.ConceptGearDynamicAnalysis]':
