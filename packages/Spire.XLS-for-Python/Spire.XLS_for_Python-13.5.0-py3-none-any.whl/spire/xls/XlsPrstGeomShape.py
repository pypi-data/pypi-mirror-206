...
class XlsPrstGeomShape (  XlsShape, IPrstGeomShape) :
    ...
    def PrstShapeType(self)->'PrstGeomShapeType':
        ...
        ret = GetDllLibXls().XlsPrstGeomShape_get_PrstShapeType(self.Ptr)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().XlsPrstGeomShape_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsPrstGeomShape_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsPrstGeomShape_set_Text(self.Ptr, value)
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsPrstGeomShape_get_ShapeType(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsPrstGeomShape_get_GeomPaths(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsPrstGeomShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
...
#
    ...
    def ShapeAdjustValues(self)->'GeomertyAdjustValuesCollection':
        ...
        intPtr = GetDllLibXls().XlsPrstGeomShape_get_ShapeAdjustValues(self.Ptr)
