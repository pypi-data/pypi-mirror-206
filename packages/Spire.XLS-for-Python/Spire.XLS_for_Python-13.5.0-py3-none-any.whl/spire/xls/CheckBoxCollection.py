...
class CheckBoxCollection (  CollectionBase[XlsCheckBoxShape],ICheckBoxes) :
    ...
    def get_Item(self ,index:int)->ICheckBox:
        ...
        intPtr = GetDllLibXls().CheckBoxCollection_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->ICheckBox:
        ...
        intPtr = GetDllLibXls().CheckBoxCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsCheckBoxShape(intPtr)
        return ret
    ...
    def AddCopy(self ,checkboxsource:'ICheckBox'):
        ...
        GetDllLibXls().CheckBoxCollection_AddCopy(self.Ptr, intPtrcheckboxsource)
    ...
    def AddCheckBox(self ,row:int,column:int,height:int,width:int)->'ICheckBox':
        ...
        intPtr = GetDllLibXls().CheckBoxCollection_AddCheckBox(self.Ptr, row,column,height,width)
        ret = None if intPtr==None else XlsCheckBoxShape(intPtr)
        return ret
    ...
    def Clear(self):
        ...
        GetDllLibXls().CheckBoxCollection_Clear(self.Ptr)
