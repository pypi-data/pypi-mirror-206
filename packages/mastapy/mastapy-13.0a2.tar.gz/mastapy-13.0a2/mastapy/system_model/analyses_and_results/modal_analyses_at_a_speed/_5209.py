...
class TorqueConverterTurbineModalAnalysisAtASpeed(_5127.CouplingHalfModalAnalysisAtASpeed):
    """TorqueConverterTurbineModalAnalysisAtASpeed
    ...
    class _Cast_TorqueConverterTurbineModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_modal_analysis_at_a_speed(self) -> 'TorqueConverterTurbineModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineModalAnalysisAtASpeed._Cast_TorqueConverterTurbineModalAnalysisAtASpeed':
