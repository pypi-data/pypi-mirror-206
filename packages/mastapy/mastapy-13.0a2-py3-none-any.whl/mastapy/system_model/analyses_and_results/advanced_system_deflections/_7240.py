...
class AGMAGleasonConicalGearMeshAdvancedSystemDeflection(_7268.ConicalGearMeshAdvancedSystemDeflection):
    """AGMAGleasonConicalGearMeshAdvancedSystemDeflection
    ...
    class _Cast_AGMAGleasonConicalGearMeshAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearMeshAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_mesh_advanced_system_deflection(self) -> 'AGMAGleasonConicalGearMeshAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearMeshAdvancedSystemDeflection._Cast_AGMAGleasonConicalGearMeshAdvancedSystemDeflection':
