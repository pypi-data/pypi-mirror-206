...
class ZerolBevelGearMeshPowerFlow(_4025.BevelGearMeshPowerFlow):
    """ZerolBevelGearMeshPowerFlow
    ...
    class _Cast_ZerolBevelGearMeshPowerFlow:
        ...
        def __init__(self, parent: 'ZerolBevelGearMeshPowerFlow'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_mesh_power_flow(self) -> 'ZerolBevelGearMeshPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearMeshPowerFlow._Cast_ZerolBevelGearMeshPowerFlow':
