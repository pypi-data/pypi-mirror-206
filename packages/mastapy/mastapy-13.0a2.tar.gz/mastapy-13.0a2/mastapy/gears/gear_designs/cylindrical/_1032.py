...
class CylindricalMeshedGear(_0.APIBase):
    ...
    class _Cast_CylindricalMeshedGear:
        ...
        def __init__(self, parent: 'CylindricalMeshedGear'):
            self._parent = parent

        @property
        def cylindrical_meshed_gear(self) -> 'CylindricalMeshedGear':
            return self._parent
    ...
    @property
    def left_flank(self) -> '_1033.CylindricalMeshedGearFlank':
    ...
    @property
    def right_flank(self) -> '_1033.CylindricalMeshedGearFlank':
    ...
    @property
    def flanks(self) -> 'List[_1033.CylindricalMeshedGearFlank]':
    ...
    @property
    def both_flanks(self) -> '_1033.CylindricalMeshedGearFlank':
    ...
    @property
    def cast_to(self) -> 'CylindricalMeshedGear._Cast_CylindricalMeshedGear':
