...
class ConceptCouplingHalfCompoundAdvancedSystemDeflection(_7407.CouplingHalfCompoundAdvancedSystemDeflection):
    """ConceptCouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7263.ConceptCouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7263.ConceptCouplingHalfAdvancedSystemDeflection]':
