...
class OilSealCompoundStabilityAnalysis(_3910.ConnectorCompoundStabilityAnalysis):
    """OilSealCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3821.OilSealStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3821.OilSealStabilityAnalysis]':
