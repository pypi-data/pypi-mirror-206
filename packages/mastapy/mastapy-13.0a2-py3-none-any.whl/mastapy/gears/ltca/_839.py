...
class GearMeshLoadedContactPoint(_0.APIBase):
    ...
    class _Cast_GearMeshLoadedContactPoint:
        ...
        def __init__(self, parent: 'GearMeshLoadedContactPoint'):
            self._parent = parent

        @property
        def cylindrical_gear_mesh_loaded_contact_point(self):
            from mastapy.gears.ltca.cylindrical import _854
            
            return self._parent._cast(_854.CylindricalGearMeshLoadedContactPoint)

        @property
        def gear_mesh_loaded_contact_point(self) -> 'GearMeshLoadedContactPoint':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GearMeshLoadedContactPoint._Cast_GearMeshLoadedContactPoint':
