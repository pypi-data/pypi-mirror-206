...
class MassDiscCompoundPowerFlow(_4264.VirtualComponentCompoundPowerFlow):
    """MassDiscCompoundPowerFlow
    ...
    class _Cast_MassDiscCompoundPowerFlow:
        ...
        def __init__(self, parent: 'MassDiscCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def mass_disc_compound_power_flow(self) -> 'MassDiscCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4085.MassDiscPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4085.MassDiscPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'MassDiscCompoundPowerFlow._Cast_MassDiscCompoundPowerFlow':
