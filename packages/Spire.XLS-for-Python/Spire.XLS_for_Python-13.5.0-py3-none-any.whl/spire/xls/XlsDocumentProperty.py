...
class XlsDocumentProperty (  IDocumentProperty) :
    ...
    def IsBuiltIn(self)->bool:
        ...
        ret = GetDllLibXls().XlsDocumentProperty_get_IsBuiltIn(self.Ptr)
        return ret
    ...
    def PropertyId(self)->'BuiltInPropertyType':
        ...
        ret = GetDllLibXls().XlsDocumentProperty_get_PropertyId(self.Ptr)
    ...
    def PropertyId(self, value:'BuiltInPropertyType'):
        ...
        GetDllLibXls().XlsDocumentProperty_set_PropertyId(self.Ptr, value.value)
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().XlsDocumentProperty_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().XlsDocumentProperty_get_Name(self.Ptr)
        return ret
    ...
    def Value(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsDocumentProperty_get_Value(self.Ptr)
    ...
    def Value(self, value:'SpireObject'):
        ...
        GetDllLibXls().XlsDocumentProperty_set_Value(self.Ptr, value.Ptr)
    ...
    def Boolean(self)->bool:
        ...
        ret = GetDllLibXls().XlsDocumentProperty_get_Boolean(self.Ptr)
        return ret

    @Boolean.setter
    def Boolean(self, value:bool):
        GetDllLibXls().XlsDocumentProperty_set_Boolean.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsDocumentProperty_set_Boolean(self.Ptr, value)
    ...
    def Integer(self)->int:
        ...
        ret = GetDllLibXls().XlsDocumentProperty_get_Integer(self.Ptr)
        return ret

    @Integer.setter
    def Integer(self, value:int):
        GetDllLibXls().XlsDocumentProperty_set_Integer.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsDocumentProperty_set_Integer(self.Ptr, value)
    ...
    def Int32(self)->int:
        ...
        ret = GetDllLibXls().XlsDocumentProperty_get_Int32(self.Ptr)
        return ret

    @Int32.setter
    def Int32(self, value:int):
        GetDllLibXls().XlsDocumentProperty_set_Int32.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsDocumentProperty_set_Int32(self.Ptr, value)
    ...
    def Double(self)->float:
        ...
        ret = GetDllLibXls().XlsDocumentProperty_get_Double(self.Ptr)
        return ret

    @Double.setter
    def Double(self, value:float):
        GetDllLibXls().XlsDocumentProperty_set_Double.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsDocumentProperty_set_Double(self.Ptr, value)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().XlsDocumentProperty_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsDocumentProperty_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsDocumentProperty_set_Text(self.Ptr, value)
    ...
    def DateTime(self)->'DateTime':
        ...
        intPtr = GetDllLibXls().XlsDocumentProperty_get_DateTime(self.Ptr)
    ...
    def DateTime(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsDocumentProperty_set_DateTime(self.Ptr, value.Ptr)
    ...
    def TimeSpan(self)->'TimeSpan':
        ...
        intPtr = GetDllLibXls().XlsDocumentProperty_get_TimeSpan(self.Ptr)
    ...
    def TimeSpan(self, value:'TimeSpan'):
        ...
        GetDllLibXls().XlsDocumentProperty_set_TimeSpan(self.Ptr, value.Ptr)
    ...
    #    intPtrArray = GetDllLibXls().XlsDocumentProperty_get_Blob(self.Ptr)
...
#        GetDllLibXls().XlsDocumentProperty_set_Blob(self.Ptr, vArray, vCount)
    ...
    def StringArray(self)->List[str]:
        ...
        intPtrArray = GetDllLibXls().XlsDocumentProperty_get_StringArray(self.Ptr)
    ...
    def StringArray(self, value:List[str]):
        ...
        GetDllLibXls().XlsDocumentProperty_set_StringArray(self.Ptr, vArray, vCount)
    ...
    def ObjectArray(self)->List['SpireObject']:
        ...
        intPtrArray = GetDllLibXls().XlsDocumentProperty_get_ObjectArray(self.Ptr)
    ...
    def ObjectArray(self, value:List['SpireObject']):
        ...
        GetDllLibXls().XlsDocumentProperty_set_ObjectArray(self.Ptr, vArray, vCount)
    ...
    def PropertyType(self)->'PropertyType':
        ...
        ret = GetDllLibXls().XlsDocumentProperty_get_PropertyType(self.Ptr)
    ...
    def PropertyType(self, value:'PropertyType'):
        ...
        GetDllLibXls().XlsDocumentProperty_set_PropertyType(self.Ptr, value.value)
    ...
    def LinkSource(self)->str:
        ...
        GetDllLibXls().XlsDocumentProperty_get_LinkSource.restype=c_wchar_p
        ret = GetDllLibXls().XlsDocumentProperty_get_LinkSource(self.Ptr)
        return ret
    ...
    def LinkSource(self, value:str):
        ...
        GetDllLibXls().XlsDocumentProperty_set_LinkSource(self.Ptr, value)
    ...
    def LinkToContent(self)->bool:
        ...
        ret = GetDllLibXls().XlsDocumentProperty_get_LinkToContent(self.Ptr)
        return ret
    ...
    def LinkToContent(self, value:bool):
        ...
        GetDllLibXls().XlsDocumentProperty_set_LinkToContent(self.Ptr, value)
    ...
    def InternalName(self)->str:
        ...
        GetDllLibXls().XlsDocumentProperty_get_InternalName.restype=c_wchar_p
        ret = GetDllLibXls().XlsDocumentProperty_get_InternalName(self.Ptr)
        return ret
    ...
    def FillPropVariant(self ,variant:'IPropertyData',iPropertyId:int)->bool:
        ...
        ret = GetDllLibXls().XlsDocumentProperty_FillPropVariant(self.Ptr, intPtrvariant,iPropertyId)
        return ret
...
#        ret = GetDllLibXls().XlsDocumentProperty_CorrectIndex( enumpropertyId,intPtrbSummary)
#        return ret
    ...
    def SetLinkSource(self ,variant:'IPropertyData'):
        ...
        GetDllLibXls().XlsDocumentProperty_SetLinkSource(self.Ptr, intPtrvariant)
    ...
    def Clone(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsDocumentProperty_Clone(self.Ptr)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    def DEF_FILE_TIME_START_YEAR()->int:
        ...
        ret = GetDllLibXls().XlsDocumentProperty_DEF_FILE_TIME_START_YEAR()
        return ret
