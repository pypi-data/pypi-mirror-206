...
class RollingRingAssemblyCompoundModalAnalysis(_4799.SpecialisedAssemblyCompoundModalAnalysis):
    """RollingRingAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4647.RollingRingAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4647.RollingRingAssemblyModalAnalysis]':
