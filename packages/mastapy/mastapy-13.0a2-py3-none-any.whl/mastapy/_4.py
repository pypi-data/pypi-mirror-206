...
class UtilityMethods:
    ...
    class _Cast_UtilityMethods:
        ...
        def __init__(self, parent: 'UtilityMethods'):
            self._parent = parent

        @property
        def utility_methods(self) -> 'UtilityMethods':
            return self._parent
    ...
    @staticmethod
    def is_read_only(entity: 'UtilityMethods.T_is_read_only', property_: 'Callable[[UtilityMethods.T_is_read_only], object]') -> 'bool':
    ...
    @staticmethod
    def is_valid(entity: 'UtilityMethods.T_is_valid', property_: 'Callable[[UtilityMethods.T_is_valid], object]') -> 'bool':
    ...
    @staticmethod
    def is_method_valid(entity: 'UtilityMethods.T_is_method_valid', method: 'Callable[[UtilityMethods.T_is_method_valid], Callable[..., None]]') -> 'bool':
    ...
    @staticmethod
    def is_method_read_only(entity: 'UtilityMethods.T_is_method_read_only', method: 'Callable[[UtilityMethods.T_is_method_read_only], Callable[..., None]]') -> 'bool':
    ...
    @property
    def cast_to(self) -> 'UtilityMethods._Cast_UtilityMethods':
