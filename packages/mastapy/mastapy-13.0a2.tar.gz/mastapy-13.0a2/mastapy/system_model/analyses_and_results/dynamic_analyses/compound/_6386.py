...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6384, _6385, _6391
...
class BevelDifferentialGearSetCompoundDynamicAnalysis(_6391.BevelGearSetCompoundDynamicAnalysis):
    """BevelDifferentialGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6256.BevelDifferentialGearSetDynamicAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_dynamic_analysis(self) -> 'List[_6384.BevelDifferentialGearCompoundDynamicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_dynamic_analysis(self) -> 'List[_6385.BevelDifferentialGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6256.BevelDifferentialGearSetDynamicAnalysis]':
