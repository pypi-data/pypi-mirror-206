...
from mastapy.electric_machines import _1252, _1285
...
class Rotor(_0.APIBase):
    ...
    class _Cast_Rotor:
        ...
        def __init__(self, parent: 'Rotor'):
            self._parent = parent
        ...
        def cad_rotor(self):
            ...
            return self._parent._cast(_1242.CADRotor)
    ...
    def initial_angle(self, value: 'float'):
        self.wrapped.InitialAngle = float(value) if value else 0.0
    ...
    @property
    def skew_slices(self) -> 'List[_1285.RotorSkewSlice]':
    ...
    @property
    def cast_to(self) -> 'Rotor._Cast_Rotor':
