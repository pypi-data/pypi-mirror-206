...
class BevelGearSetCompoundModalAnalysis(_4707.AGMAGleasonConicalGearSetCompoundModalAnalysis):
    """BevelGearSetCompoundModalAnalysis
    ...
    class _Cast_BevelGearSetCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'BevelGearSetCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_gear_set_compound_modal_analysis(self) -> 'BevelGearSetCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4565.BevelGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4565.BevelGearSetModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BevelGearSetCompoundModalAnalysis._Cast_BevelGearSetCompoundModalAnalysis':
