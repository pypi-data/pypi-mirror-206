...
class ConceptCouplingConnectionSteadyStateSynchronousResponse(_2999.CouplingConnectionSteadyStateSynchronousResponse):
    """ConceptCouplingConnectionSteadyStateSynchronousResponse
    ...
    class _Cast_ConceptCouplingConnectionSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_steady_state_synchronous_response(self) -> 'ConceptCouplingConnectionSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionSteadyStateSynchronousResponse._Cast_ConceptCouplingConnectionSteadyStateSynchronousResponse':
