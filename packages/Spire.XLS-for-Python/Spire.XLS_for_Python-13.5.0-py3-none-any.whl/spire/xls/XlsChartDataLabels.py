...
class XlsChartDataLabels (  XlsObject, IChartDataLabels, IChartTextArea, IFont, IOptimizedUpdate) :
    ...
    def HasSeriesName(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_HasSeriesName(self.Ptr)
        return ret
    ...
    def HasSeriesName(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataLabels_set_HasSeriesName(self.Ptr, value)
    ...
    def HasCategoryName(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_HasCategoryName(self.Ptr)
        return ret
    ...
    def HasCategoryName(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataLabels_set_HasCategoryName(self.Ptr, value)
    ...
    def HasValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_HasValue(self.Ptr)
        return ret

    @HasValue.setter
    def HasValue(self, value:bool):
        GetDllLibXls().XlsChartDataLabels_set_HasValue.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDataLabels_set_HasValue(self.Ptr, value)
    ...
    def HasPercentage(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_HasPercentage(self.Ptr)
        return ret
    ...
    def HasPercentage(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataLabels_set_HasPercentage(self.Ptr, value)
    ...
    def HasBubbleSize(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_HasBubbleSize(self.Ptr)
        return ret
    ...
    def HasBubbleSize(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataLabels_set_HasBubbleSize(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_HasFormula(self.Ptr)
        return ret
    ...
    def Delimiter(self)->str:
        ...
        GetDllLibXls().XlsChartDataLabels_get_Delimiter.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartDataLabels_get_Delimiter(self.Ptr)
        return ret
    ...
    def Delimiter(self, value:str):
        ...
        GetDllLibXls().XlsChartDataLabels_set_Delimiter(self.Ptr, value)
    ...
    def HasLegendKey(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_HasLegendKey(self.Ptr)
        return ret

    @HasLegendKey.setter
    def HasLegendKey(self, value:bool):
        GetDllLibXls().XlsChartDataLabels_set_HasLegendKey.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDataLabels_set_HasLegendKey(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_HasManualLayout(self.Ptr)
        return ret
    ...
    def Position(self)->'DataLabelPositionType':
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_Position(self.Ptr)
    ...
    def Position(self, value:'DataLabelPositionType'):
        ...
        GetDllLibXls().XlsChartDataLabels_set_Position(self.Ptr, value.value)
    ...
    def ShowLeaderLines(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_ShowLeaderLines(self.Ptr)
        return ret
    ...
    def ShowLeaderLines(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataLabels_set_ShowLeaderLines(self.Ptr, value)
    ...
    def NumberFormat(self)->str:
        ...
        GetDllLibXls().XlsChartDataLabels_get_NumberFormat.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartDataLabels_get_NumberFormat(self.Ptr)
        return ret
    ...
    def NumberFormat(self, value:str):
        ...
        GetDllLibXls().XlsChartDataLabels_set_NumberFormat(self.Ptr, value)
    ...
    def IsTextWrapped(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_IsTextWrapped(self.Ptr)
        return ret
    ...
    def IsTextWrapped(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataLabels_set_IsTextWrapped(self.Ptr, value)
    ...
    def IsResizeShapeToFitText(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_IsResizeShapeToFitText(self.Ptr)
        return ret
    ...
    def IsResizeShapeToFitText(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataLabels_set_IsResizeShapeToFitText(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_IsBold(self.Ptr)
        return ret

    @IsBold.setter
    def IsBold(self, value:bool):
        GetDllLibXls().XlsChartDataLabels_set_IsBold.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDataLabels_set_IsBold(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_KnownColor(self.Ptr)
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartDataLabels_set_KnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartDataLabels_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartDataLabels_set_Color(self.Ptr, value.Ptr)
    ...
    def SetThemeColor(self ,type:'ThemeColorType',tint:float):
        ...
        GetDllLibXls().XlsChartDataLabels_SetThemeColor(self.Ptr, enumtype,tint)
...
#
#        GetDllLibXls().XlsChartDataLabels_GetThemeColor.argtypes=[c_void_p ,c_void_p,c_void_p]
#        GetDllLibXls().XlsChartDataLabels_GetThemeColor.restype=c_bool
#        ret = GetDllLibXls().XlsChartDataLabels_GetThemeColor(self.Ptr, intPtrtype,intPtrtint)
#        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_IsItalic(self.Ptr)
        return ret

    @IsItalic.setter
    def IsItalic(self, value:bool):
        GetDllLibXls().XlsChartDataLabels_set_IsItalic.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDataLabels_set_IsItalic(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_Size(self.Ptr)
        return ret

    @Size.setter
    def Size(self, value:float):
        GetDllLibXls().XlsChartDataLabels_set_Size.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsChartDataLabels_set_Size(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_IsStrikethrough(self.Ptr)
        return ret
    ...
    def IsStrikethrough(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataLabels_set_IsStrikethrough(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_IsSubscript(self.Ptr)
        return ret

    @IsSubscript.setter
    def IsSubscript(self, value:bool):
        GetDllLibXls().XlsChartDataLabels_set_IsSubscript.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDataLabels_set_IsSubscript(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_IsSuperscript(self.Ptr)
        return ret
    ...
    def IsSuperscript(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataLabels_set_IsSuperscript(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_Underline(self.Ptr)
    ...
    def Underline(self, value:'FontUnderlineType'):
        ...
        GetDllLibXls().XlsChartDataLabels_set_Underline(self.Ptr, value.value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChartDataLabels_get_FontName.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartDataLabels_get_FontName(self.Ptr)
        return ret
    ...
    def FontName(self, value:str):
        ...
        GetDllLibXls().XlsChartDataLabels_set_FontName(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_VerticalAlignment(self.Ptr)
    ...
    def VerticalAlignment(self, value:'FontVertialAlignmentType'):
        ...
        GetDllLibXls().XlsChartDataLabels_set_VerticalAlignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_IsAutoColor(self.Ptr)
        return ret
    ...
    def StrikethroughType(self)->str:
        ...
        GetDllLibXls().XlsChartDataLabels_get_StrikethroughType.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartDataLabels_get_StrikethroughType(self.Ptr)
        return ret
    ...
    def StrikethroughType(self, value:str):
        ...
        GetDllLibXls().XlsChartDataLabels_set_StrikethroughType(self.Ptr, value)
    ...
    def GenerateNativeFont(self)->'Font':
        ...
        intPtr = GetDllLibXls().XlsChartDataLabels_GenerateNativeFont(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsChartDataLabels_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsChartDataLabels_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsChartDataLabels_set_Text(self.Ptr, value)
    ...
    def FrameFormat(self)->'IChartFrameFormat':
        ...
        intPtr = GetDllLibXls().XlsChartDataLabels_get_FrameFormat(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_TextRotationAngle(self.Ptr)
        return ret
    ...
    def TextRotationAngle(self, value:int):
        ...
        GetDllLibXls().XlsChartDataLabels_set_TextRotationAngle(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_BackgroundMode(self.Ptr)
    ...
    def BackgroundMode(self, value:'ChartBackgroundMode'):
        ...
        GetDllLibXls().XlsChartDataLabels_set_BackgroundMode(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_IsAutoMode(self.Ptr)
        return ret
    ...
    def Format(self)->'XlsChartSerieDataFormat':
        ...
        intPtr = GetDllLibXls().XlsChartDataLabels_get_Format(self.Ptr)
    ...
    def Font(self)->'XlsFont':
        ...
        intPtr = GetDllLibXls().XlsChartDataLabels_get_Font(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartDataLabels_get_ValueFromCell(self.Ptr)
    ...
    def ValueFromCell(self, value:'CellRange'):
        ...
        GetDllLibXls().XlsChartDataLabels_set_ValueFromCell(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_IsWMode(self.Ptr)
        return ret

    @IsWMode.setter
    def IsWMode(self, value:bool):
        GetDllLibXls().XlsChartDataLabels_set_IsWMode.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDataLabels_set_IsWMode(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_IsHMode(self.Ptr)
        return ret

    @IsHMode.setter
    def IsHMode(self, value:bool):
        GetDllLibXls().XlsChartDataLabels_set_IsHMode.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDataLabels_set_IsHMode(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_IsXMode(self.Ptr)
        return ret

    @IsXMode.setter
    def IsXMode(self, value:bool):
        GetDllLibXls().XlsChartDataLabels_set_IsXMode.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDataLabels_set_IsXMode(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_IsYMode(self.Ptr)
        return ret

    @IsYMode.setter
    def IsYMode(self, value:bool):
        GetDllLibXls().XlsChartDataLabels_set_IsYMode.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDataLabels_set_IsYMode(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_X(self.Ptr)
        return ret

    @X.setter
    def X(self, value:int):
        GetDllLibXls().XlsChartDataLabels_set_X.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartDataLabels_set_X(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_Y(self.Ptr)
        return ret

    @Y.setter
    def Y(self, value:int):
        GetDllLibXls().XlsChartDataLabels_set_Y.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartDataLabels_set_Y(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartDataLabels_get_TextArea(self.Ptr)
    ...
    def HasWedgeCallout(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_HasWedgeCallout(self.Ptr)
        return ret
    ...
    def HasWedgeCallout(self, value:bool):
        ...
        GetDllLibXls().XlsChartDataLabels_set_HasWedgeCallout(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:int):
        GetDllLibXls().XlsChartDataLabels_set_Height.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartDataLabels_set_Height(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:int):
        GetDllLibXls().XlsChartDataLabels_set_Width.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartDataLabels_set_Width(self.Ptr, value)
    ...
    def Index(self)->int:
        ...
        ret = GetDllLibXls().XlsChartDataLabels_get_Index(self.Ptr)
        return ret
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().XlsChartDataLabels_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().XlsChartDataLabels_EndUpdate(self.Ptr)
