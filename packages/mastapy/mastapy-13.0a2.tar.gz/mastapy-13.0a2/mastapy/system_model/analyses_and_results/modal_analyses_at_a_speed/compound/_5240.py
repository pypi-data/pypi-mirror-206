...
class ClutchConnectionCompoundModalAnalysisAtASpeed(_5256.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """ClutchConnectionCompoundModalAnalysisAtASpeed
    ...
    class _Cast_ClutchConnectionCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ClutchConnectionCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def clutch_connection_compound_modal_analysis_at_a_speed(self) -> 'ClutchConnectionCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5110.ClutchConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5110.ClutchConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ClutchConnectionCompoundModalAnalysisAtASpeed._Cast_ClutchConnectionCompoundModalAnalysisAtASpeed':
