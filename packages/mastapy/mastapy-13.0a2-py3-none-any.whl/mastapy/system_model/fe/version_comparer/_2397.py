...
from mastapy.math_utility.measured_vectors import _1553, _1551
...
class NodeComparisonResult(_0.APIBase):
    ...
    class _Cast_NodeComparisonResult:
        ...
        def __init__(self, parent: 'NodeComparisonResult'):
            self._parent = parent

        @property
        def node_comparison_result(self) -> 'NodeComparisonResult':
            return self._parent
    ...
    @property
    def displacement_change(self) -> '_1553.VectorWithLinearAndAngularComponents':
    ...
    @property
    def new_result(self) -> '_1551.NodeResults':
    ...
    @property
    def original_result(self) -> '_1551.NodeResults':
    ...
    @property
    def cast_to(self) -> 'NodeComparisonResult._Cast_NodeComparisonResult':
