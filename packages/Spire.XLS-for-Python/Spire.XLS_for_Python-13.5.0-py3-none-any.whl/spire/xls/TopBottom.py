...
class TopBottom (SpireObject) :
    ...
    def Rank(self)->int:
        ...
        ret = GetDllLibXls().TopBottom_get_Rank(self.Ptr)
        return ret

    @Rank.setter
    def Rank(self, value:int):
        GetDllLibXls().TopBottom_set_Rank.argtypes=[c_void_p, c_int]
        GetDllLibXls().TopBottom_set_Rank(self.Ptr, value)
    ...
    def Type(self)->'TopBottomType':
        ...
        ret = GetDllLibXls().TopBottom_get_Type(self.Ptr)
    ...
    def Type(self, value:'TopBottomType'):
        ...
        GetDllLibXls().TopBottom_set_Type(self.Ptr, value.value)
