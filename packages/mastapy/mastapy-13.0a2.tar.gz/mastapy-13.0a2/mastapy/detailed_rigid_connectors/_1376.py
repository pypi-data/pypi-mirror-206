...
class DetailedRigidConnectorHalfDesign(_0.APIBase):
    ...
    class _Cast_DetailedRigidConnectorHalfDesign:
        ...
        def __init__(self, parent: 'DetailedRigidConnectorHalfDesign'):
            self._parent = parent
        ...
        def keyway_joint_half_design(self):
            ...
            return self._parent._cast(_1427.KeywayJointHalfDesign)

        @property
        def interference_fit_half_design(self):
            from mastapy.detailed_rigid_connectors.interference_fits import _1434
            
            return self._parent._cast(_1434.InterferenceFitHalfDesign)

        @property
        def detailed_rigid_connector_half_design(self) -> 'DetailedRigidConnectorHalfDesign':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DetailedRigidConnectorHalfDesign._Cast_DetailedRigidConnectorHalfDesign':
