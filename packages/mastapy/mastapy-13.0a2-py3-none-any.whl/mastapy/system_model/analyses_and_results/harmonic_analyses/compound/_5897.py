...
class DatumCompoundHarmonicAnalysis(_5871.ComponentCompoundHarmonicAnalysis):
    """DatumCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5701.DatumHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5701.DatumHarmonicAnalysis]':
