...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed(_5285.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtASpeed):
    """KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_mesh_compound_modal_analysis_at_a_speed(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5158.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5158.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed._Cast_KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed(self)
