...
class BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness(_4977.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_compound_modal_analysis_at_a_stiffness(self) -> 'BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4841.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4841.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness._Cast_BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness':
        return self._Cast_BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness(self)
