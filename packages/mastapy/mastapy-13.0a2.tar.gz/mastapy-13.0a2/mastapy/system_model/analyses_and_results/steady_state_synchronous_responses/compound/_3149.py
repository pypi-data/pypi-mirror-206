...
class FaceGearMeshCompoundSteadyStateSynchronousResponse(_3154.GearMeshCompoundSteadyStateSynchronousResponse):
    """FaceGearMeshCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_FaceGearMeshCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'FaceGearMeshCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def face_gear_mesh_compound_steady_state_synchronous_response(self) -> 'FaceGearMeshCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3016.FaceGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3016.FaceGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'FaceGearMeshCompoundSteadyStateSynchronousResponse._Cast_FaceGearMeshCompoundSteadyStateSynchronousResponse':
