...
T = TypeVar("T", bound="IdentityProductSettings")


@attr.s(auto_attribs=True)
class IdentityProductSettings:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        identity_product_settings = cls(
            required=required,
            prefetch=prefetch,
        )

        identity_product_settings.additional_properties = d
        return identity_product_settings
