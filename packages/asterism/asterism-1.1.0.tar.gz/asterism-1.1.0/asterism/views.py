...
from .view_mixins import JSONResponseView
...
class DatatableMixin(object):
    ...
    Code is cribbed from `django-datatables-view` library:
    ...
    is_data_list = True  # determines the type of results. If JavaScript passes data attribute that is not an integer
                         # then it expects dictionary with specific fields in # noqa: E114,E116
                         # the response, see: https://datatables.net/reference/option/columns.data # noqa: E114,E116
    ...
    def ordering(self, qs):  # noqa: C901
