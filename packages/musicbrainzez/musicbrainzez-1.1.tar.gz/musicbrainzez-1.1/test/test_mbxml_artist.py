...
class GetArtistTest(unittest.TestCase):
    ...
    def testArtistAliases(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "0e43fe9d-c472-4b62-be9e-55f971a023e1-aliases.xml")
        ...
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "2736bad5-6280-4c8f-92c8-27a5e63bbab2-aliases.xml")
        self.assertFalse("alias-list" in res["artist"])

    def testArtistTargets(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "b3785a55-2cf6-497d-b8e3-cfa21a36f997-artist-rels.xml")
