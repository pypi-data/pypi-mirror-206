...
class StraightBevelGearSteadyStateSynchronousResponseOnAShaft(_3242.BevelGearSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelGearSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_StraightBevelGearSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'StraightBevelGearSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_steady_state_synchronous_response_on_a_shaft(self) -> 'StraightBevelGearSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSteadyStateSynchronousResponseOnAShaft._Cast_StraightBevelGearSteadyStateSynchronousResponseOnAShaft':
