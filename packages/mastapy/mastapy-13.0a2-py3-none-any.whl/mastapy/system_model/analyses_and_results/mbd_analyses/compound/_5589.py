...
class RingPinsToDiscConnectionCompoundMultibodyDynamicsAnalysis(_5564.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """RingPinsToDiscConnectionCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_RingPinsToDiscConnectionCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'RingPinsToDiscConnectionCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def ring_pins_to_disc_connection_compound_multibody_dynamics_analysis(self) -> 'RingPinsToDiscConnectionCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5448.RingPinsToDiscConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5448.RingPinsToDiscConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'RingPinsToDiscConnectionCompoundMultibodyDynamicsAnalysis._Cast_RingPinsToDiscConnectionCompoundMultibodyDynamicsAnalysis':
        return self._Cast_RingPinsToDiscConnectionCompoundMultibodyDynamicsAnalysis(self)
