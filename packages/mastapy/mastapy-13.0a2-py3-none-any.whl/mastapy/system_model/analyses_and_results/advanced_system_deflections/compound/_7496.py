...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7494, _7495, _7386
...
class ZerolBevelGearSetCompoundAdvancedSystemDeflection(_7386.BevelGearSetCompoundAdvancedSystemDeflection):
    """ZerolBevelGearSetCompoundAdvancedSystemDeflection
    ...
    class _Cast_ZerolBevelGearSetCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_compound_advanced_system_deflection(self) -> 'ZerolBevelGearSetCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7367.ZerolBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7494.ZerolBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7495.ZerolBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7367.ZerolBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetCompoundAdvancedSystemDeflection._Cast_ZerolBevelGearSetCompoundAdvancedSystemDeflection':
