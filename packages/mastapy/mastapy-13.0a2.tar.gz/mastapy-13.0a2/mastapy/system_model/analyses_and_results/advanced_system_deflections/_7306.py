...
class KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection(_7303.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_advanced_system_deflection(self) -> 'KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2752.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection._Cast_KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection(self)
