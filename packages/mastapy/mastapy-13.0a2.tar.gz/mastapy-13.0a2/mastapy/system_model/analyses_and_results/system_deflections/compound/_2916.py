...
class PlanetCarrierCompoundSystemDeflection(_2908.MountableComponentCompoundSystemDeflection):
    """PlanetCarrierCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2769.PlanetCarrierSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2769.PlanetCarrierSystemDeflection]':
