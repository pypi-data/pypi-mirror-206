...
class ClutchModalAnalysis(_4587.CouplingModalAnalysis):
    """ClutchModalAnalysis
    ...
    class _Cast_ClutchModalAnalysis:
        ...
        def __init__(self, parent: 'ClutchModalAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_modal_analysis(self) -> 'ClutchModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchModalAnalysis._Cast_ClutchModalAnalysis':
