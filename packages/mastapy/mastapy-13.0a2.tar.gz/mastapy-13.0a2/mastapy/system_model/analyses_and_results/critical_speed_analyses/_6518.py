...
class BeltDriveCriticalSpeedAnalysis(_6608.SpecialisedAssemblyCriticalSpeedAnalysis):
    """BeltDriveCriticalSpeedAnalysis
    ...
    class _Cast_BeltDriveCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'BeltDriveCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def belt_drive_critical_speed_analysis(self) -> 'BeltDriveCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BeltDriveCriticalSpeedAnalysis._Cast_BeltDriveCriticalSpeedAnalysis':
