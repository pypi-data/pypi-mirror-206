...
from mastapy.gears.gear_designs.hypoid import _980, _981
...
class HypoidGearSetDesign(_1189.AGMAGleasonConicalGearSetDesign):
    """HypoidGearSetDesign
    ...
    class _Cast_HypoidGearSetDesign:
        ...
        def __init__(self, parent: 'HypoidGearSetDesign'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_set_design(self) -> 'HypoidGearSetDesign':
            return self._parent
    ...
    @property
    def gears(self) -> 'List[_980.HypoidGearDesign]':
    ...
    @property
    def hypoid_gears(self) -> 'List[_980.HypoidGearDesign]':
    ...
    @property
    def meshes(self) -> 'List[_981.HypoidGearMeshDesign]':
    ...
    @property
    def hypoid_meshes(self) -> 'List[_981.HypoidGearMeshDesign]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearSetDesign._Cast_HypoidGearSetDesign':
