...
class CVTPulleyStabilityAnalysis(_3831.PulleyStabilityAnalysis):
    """CVTPulleyStabilityAnalysis
    ...
    class _Cast_CVTPulleyStabilityAnalysis:
        ...
        def __init__(self, parent: 'CVTPulleyStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def cvt_pulley_stability_analysis(self) -> 'CVTPulleyStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CVTPulleyStabilityAnalysis._Cast_CVTPulleyStabilityAnalysis':
