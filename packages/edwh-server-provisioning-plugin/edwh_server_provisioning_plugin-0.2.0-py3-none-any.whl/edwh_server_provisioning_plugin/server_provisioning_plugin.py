...
import yaml
from fabric import task, Result, Connection
...
def install_docker(c):
    if execution_fails(c, "docker --version"):
        add_apt_repository(
            c,
...
def install_joplin(c):
    ...
    c.put(io.StringIO(JOPLIN_DOCKER_COMPOSE), "services/docker-compose.yml")
