...
from unfolded.data_sdk.enums import MediaType, QueryOutputType, TileMode, TimeInterval
...
class DataSDK:
    ...
    def list_data_connectors(
        ...
        if organization:
            url = f"{self.base_url}/internal/v1/data-connections/for-organization"
        else:
            url = f"{self.base_url}/internal/v1/data-connections"
    ...
    def execute_query(
        ...
        url = f"{self.base_url}/v1/query/gateway/data-queries"
    ...
    def _store_credentials_heuristic(self) -> bool:
        ...
        """
        # See discussion in https://github.com/foursquare/unfolded-platform/pull/2017 and
