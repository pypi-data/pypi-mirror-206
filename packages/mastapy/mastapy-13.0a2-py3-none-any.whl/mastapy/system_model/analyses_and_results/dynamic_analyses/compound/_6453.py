...
class PartToPartShearCouplingCompoundDynamicAnalysis(_6410.CouplingCompoundDynamicAnalysis):
    """PartToPartShearCouplingCompoundDynamicAnalysis
    ...
    class _Cast_PartToPartShearCouplingCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_compound_dynamic_analysis(self) -> 'PartToPartShearCouplingCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6325.PartToPartShearCouplingDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6325.PartToPartShearCouplingDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingCompoundDynamicAnalysis._Cast_PartToPartShearCouplingCompoundDynamicAnalysis':
