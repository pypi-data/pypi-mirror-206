...
class TiltingPadThrustBearing(_2172.PadFluidFilmBearing):
    """TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1885.TiltingPadTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, _1885.TiltingPadTypes)
        return constructor.new_from_mastapy_type(_1885.TiltingPadTypes)(value) if value is not None else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1885.TiltingPadTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1885.TiltingPadTypes.type_())
