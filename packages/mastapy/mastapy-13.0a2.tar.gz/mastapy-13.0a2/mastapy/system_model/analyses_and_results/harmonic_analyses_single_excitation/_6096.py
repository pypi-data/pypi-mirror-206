...
class TorqueConverterTurbineHarmonicAnalysisOfSingleExcitation(_6013.CouplingHalfHarmonicAnalysisOfSingleExcitation):
    """TorqueConverterTurbineHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_TorqueConverterTurbineHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_harmonic_analysis_of_single_excitation(self) -> 'TorqueConverterTurbineHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineHarmonicAnalysisOfSingleExcitation._Cast_TorqueConverterTurbineHarmonicAnalysisOfSingleExcitation':
