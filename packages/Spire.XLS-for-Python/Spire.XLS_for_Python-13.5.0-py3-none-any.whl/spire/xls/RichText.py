...
class RichText (  RichTextObject) :
    ...
    def __init__(self, obj:SpireObject):
        ...
        intPtr = GetDllLibXls().RichText_Create(obj.Ptr)
    ...
    <param name="Position">Position</param>
        ...
        intPtr = GetDllLibXls().RichText_GetFont(self.Ptr, position)
    ...
    <param name="font">Font to set.</param>
        ...
        GetDllLibXls().RichText_SetFont(self.Ptr, startPos,endPos,intPtrfont)
