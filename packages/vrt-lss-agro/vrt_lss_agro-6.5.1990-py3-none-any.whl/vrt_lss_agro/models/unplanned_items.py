...
class UnplannedItems(BaseModel):
    ...
    """
    crop_keys: Optional[conlist(constr(strict=True, max_length=1024, min_length=1), max_items=201, min_items=0, unique_items=True)] = Field(None, description="Unplanned crop keys.")
    ...
    elevator_keys: Optional[conlist(constr(strict=True, max_length=1024, min_length=1), max_items=201, min_items=0, unique_items=True)] = Field(None, description="Unplanned elevator keys.")
    factory_keys: Optional[conlist(constr(strict=True, max_length=1024, min_length=1), max_items=201, min_items=0, unique_items=True)] = Field(None, description="Unplanned factory keys.")
    __properties = ["crop_keys", "field_keys", "elevator_keys", "factory_keys"]
