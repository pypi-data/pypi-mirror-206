...
from mastapy.system_model.part_model.couplings import _2559, _2562
...
class Clutch(_2562.Coupling):
    ...
    class _Cast_Clutch:
        ...
        def __init__(self, parent: 'Clutch'):
            self._parent = parent
    ...
    @property
    def angular_speed_temperature_grid(self) -> '_1554.GriddedSurfaceAccessor':
    ...
    def angular_speed_temperature_grid(self, value: '_1554.GriddedSurfaceAccessor'):
    ...
    @property
    def clutch_type(self) -> '_2559.ClutchType':
        ...
        value = conversion.pn_to_mp_enum(temp, _2559.ClutchType)
        return constructor.new_from_mastapy_type(_2559.ClutchType)(value) if value is not None else None

    @clutch_type.setter
    def clutch_type(self, value: '_2559.ClutchType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2559.ClutchType.type_())
    ...
    @property
    def flow_rate_vs_speed(self) -> '_1523.Vector2DListAccessor':
    ...
    def flow_rate_vs_speed(self, value: '_1523.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def linear_speed_temperature_grid(self) -> '_1554.GriddedSurfaceAccessor':
    ...
    def linear_speed_temperature_grid(self, value: '_1554.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def spring_type(self) -> '_5373.ClutchSpringType':
        ...
        value = conversion.pn_to_mp_enum(temp, _5373.ClutchSpringType)
        return constructor.new_from_mastapy_type(_5373.ClutchSpringType)(value) if value is not None else None

    @spring_type.setter
    def spring_type(self, value: '_5373.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _5373.ClutchSpringType.type_())
    ...
    @property
    def clutch_connection(self) -> '_2323.ClutchConnection':
    ...
    @property
    def cast_to(self) -> 'Clutch._Cast_Clutch':
