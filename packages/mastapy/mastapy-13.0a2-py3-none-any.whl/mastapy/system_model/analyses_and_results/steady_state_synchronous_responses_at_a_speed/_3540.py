...
class FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed(_3581.SpecialisedAssemblySteadyStateSynchronousResponseAtASpeed):
    """FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def flexible_pin_assembly_steady_state_synchronous_response_at_a_speed(self) -> 'FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed._Cast_FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed':
        return self._Cast_FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed(self)
