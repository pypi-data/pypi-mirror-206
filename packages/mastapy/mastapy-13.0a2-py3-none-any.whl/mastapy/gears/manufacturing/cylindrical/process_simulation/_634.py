...
class CutterProcessSimulation(_0.APIBase):
    ...
    class _Cast_CutterProcessSimulation:
        ...
        def __init__(self, parent: 'CutterProcessSimulation'):
            self._parent = parent

        @property
        def form_wheel_grinding_process_simulation(self):
            from mastapy.gears.manufacturing.cylindrical.process_simulation import _635
            
            return self._parent._cast(_635.FormWheelGrindingProcessSimulation)

        @property
        def shaping_process_simulation(self):
            from mastapy.gears.manufacturing.cylindrical.process_simulation import _636
            
            return self._parent._cast(_636.ShapingProcessSimulation)

        @property
        def cutter_process_simulation(self) -> 'CutterProcessSimulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CutterProcessSimulation._Cast_CutterProcessSimulation':
