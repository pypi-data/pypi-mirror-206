...
class Script(ApiDto):
    ...
    def from_json(self, obj):
        ...
        if "needExactColumnNumbers" in obj.keys():
            if "needExactColumnNumbers".lower() == "false":
