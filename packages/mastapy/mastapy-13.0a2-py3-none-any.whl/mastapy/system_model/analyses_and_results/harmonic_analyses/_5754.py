...
class OilSealHarmonicAnalysis(_5686.ConnectorHarmonicAnalysis):
    """OilSealHarmonicAnalysis
    ...
    class _Cast_OilSealHarmonicAnalysis:
        ...
        def __init__(self, parent: 'OilSealHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def oil_seal_harmonic_analysis(self) -> 'OilSealHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'OilSealHarmonicAnalysis._Cast_OilSealHarmonicAnalysis':
