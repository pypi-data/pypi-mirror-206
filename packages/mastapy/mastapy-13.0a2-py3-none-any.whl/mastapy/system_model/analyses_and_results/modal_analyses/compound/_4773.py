...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysis(_4767.KlingelnbergCycloPalloidConicalGearCompoundModalAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_compound_modal_analysis(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4624.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4624.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysis._Cast_KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysis':
        return self._Cast_KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysis(self)
