...
class BevelDifferentialPlanetGearModalAnalysisAtAStiffness(_4842.BevelDifferentialGearModalAnalysisAtAStiffness):
    """BevelDifferentialPlanetGearModalAnalysisAtAStiffness
    ...
    class _Cast_BevelDifferentialPlanetGearModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'BevelDifferentialPlanetGearModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def bevel_differential_planet_gear_modal_analysis_at_a_stiffness(self) -> 'BevelDifferentialPlanetGearModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialPlanetGearModalAnalysisAtAStiffness._Cast_BevelDifferentialPlanetGearModalAnalysisAtAStiffness':
