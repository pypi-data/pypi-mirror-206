...
class BevelDifferentialGearCompoundHarmonicAnalysis(_5862.BevelGearCompoundHarmonicAnalysis):
    """BevelDifferentialGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5660.BevelDifferentialGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5660.BevelDifferentialGearHarmonicAnalysis]':
