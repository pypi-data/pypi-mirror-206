...
class ConceptGearMeshCompoundMultibodyDynamicsAnalysis(_5558.GearMeshCompoundMultibodyDynamicsAnalysis):
    """ConceptGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5379.ConceptGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5379.ConceptGearMeshMultibodyDynamicsAnalysis]':
