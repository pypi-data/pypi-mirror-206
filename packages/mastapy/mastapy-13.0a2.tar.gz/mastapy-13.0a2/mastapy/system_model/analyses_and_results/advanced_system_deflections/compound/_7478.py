...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7476, _7477, _7386
...
class StraightBevelGearSetCompoundAdvancedSystemDeflection(_7386.BevelGearSetCompoundAdvancedSystemDeflection):
    """StraightBevelGearSetCompoundAdvancedSystemDeflection
    ...
    class _Cast_StraightBevelGearSetCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'StraightBevelGearSetCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_set_compound_advanced_system_deflection(self) -> 'StraightBevelGearSetCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7348.StraightBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7476.StraightBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7477.StraightBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7348.StraightBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSetCompoundAdvancedSystemDeflection._Cast_StraightBevelGearSetCompoundAdvancedSystemDeflection':
