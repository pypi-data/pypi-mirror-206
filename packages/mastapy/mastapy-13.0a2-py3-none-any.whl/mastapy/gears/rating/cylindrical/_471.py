...
class MeshRatingForReports(_0.APIBase):
    ...
    class _Cast_MeshRatingForReports:
        ...
        def __init__(self, parent: 'MeshRatingForReports'):
            self._parent = parent

        @property
        def mesh_rating_for_reports(self) -> 'MeshRatingForReports':
            return self._parent
    ...
    @property
    def cylindrical_gear_mesh_rating(self) -> '_454.CylindricalGearMeshRating':
    ...
    @property
    def cast_to(self) -> 'MeshRatingForReports._Cast_MeshRatingForReports':
