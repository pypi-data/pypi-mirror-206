...
class SynchroniserHarmonicAnalysis(_5777.SpecialisedAssemblyHarmonicAnalysis):
    """SynchroniserHarmonicAnalysis
    ...
    class _Cast_SynchroniserHarmonicAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_harmonic_analysis(self) -> 'SynchroniserHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserHarmonicAnalysis._Cast_SynchroniserHarmonicAnalysis':
