...
class SpringDamperHalfSteadyStateSynchronousResponseAtASpeed(_3521.CouplingHalfSteadyStateSynchronousResponseAtASpeed):
    """SpringDamperHalfSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_SpringDamperHalfSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'SpringDamperHalfSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def spring_damper_half_steady_state_synchronous_response_at_a_speed(self) -> 'SpringDamperHalfSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperHalfSteadyStateSynchronousResponseAtASpeed._Cast_SpringDamperHalfSteadyStateSynchronousResponseAtASpeed':
