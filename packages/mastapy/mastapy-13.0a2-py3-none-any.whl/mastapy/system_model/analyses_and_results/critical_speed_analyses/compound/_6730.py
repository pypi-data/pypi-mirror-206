...
class RollingRingAssemblyCompoundCriticalSpeedAnalysis(_6737.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """RollingRingAssemblyCompoundCriticalSpeedAnalysis
    ...
    class _Cast_RollingRingAssemblyCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'RollingRingAssemblyCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def rolling_ring_assembly_compound_critical_speed_analysis(self) -> 'RollingRingAssemblyCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6601.RollingRingAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6601.RollingRingAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'RollingRingAssemblyCompoundCriticalSpeedAnalysis._Cast_RollingRingAssemblyCompoundCriticalSpeedAnalysis':
