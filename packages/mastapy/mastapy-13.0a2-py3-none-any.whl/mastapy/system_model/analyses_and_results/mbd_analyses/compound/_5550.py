...
class DatumCompoundMultibodyDynamicsAnalysis(_5524.ComponentCompoundMultibodyDynamicsAnalysis):
    """DatumCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5401.DatumMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5401.DatumMultibodyDynamicsAnalysis]':
