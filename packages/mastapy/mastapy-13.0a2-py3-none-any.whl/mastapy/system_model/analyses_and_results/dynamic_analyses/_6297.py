...
class FaceGearDynamicAnalysis(_6302.GearDynamicAnalysis):
    """FaceGearDynamicAnalysis
    ...
    class _Cast_FaceGearDynamicAnalysis:
        ...
        def __init__(self, parent: 'FaceGearDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def face_gear_dynamic_analysis(self) -> 'FaceGearDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearDynamicAnalysis._Cast_FaceGearDynamicAnalysis':
