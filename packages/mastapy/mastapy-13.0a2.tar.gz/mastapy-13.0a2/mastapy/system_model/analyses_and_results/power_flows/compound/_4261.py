...
class TorqueConverterPumpCompoundPowerFlow(_4181.CouplingHalfCompoundPowerFlow):
    """TorqueConverterPumpCompoundPowerFlow
    ...
    class _Cast_TorqueConverterPumpCompoundPowerFlow:
        ...
        def __init__(self, parent: 'TorqueConverterPumpCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def torque_converter_pump_compound_power_flow(self) -> 'TorqueConverterPumpCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4132.TorqueConverterPumpPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4132.TorqueConverterPumpPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterPumpCompoundPowerFlow._Cast_TorqueConverterPumpCompoundPowerFlow':
