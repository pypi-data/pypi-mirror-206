...
class WindTurbineBladeModeDetails(_0.APIBase):
    ...
    class _Cast_WindTurbineBladeModeDetails:
        ...
        def __init__(self, parent: 'WindTurbineBladeModeDetails'):
            self._parent = parent

        @property
        def wind_turbine_blade_mode_details(self) -> 'WindTurbineBladeModeDetails':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WindTurbineBladeModeDetails._Cast_WindTurbineBladeModeDetails':
