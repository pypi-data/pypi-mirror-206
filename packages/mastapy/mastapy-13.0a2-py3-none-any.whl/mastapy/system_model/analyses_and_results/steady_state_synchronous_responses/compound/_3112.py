...
class BevelGearMeshCompoundSteadyStateSynchronousResponse(_3100.AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponse):
    """BevelGearMeshCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_BevelGearMeshCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'BevelGearMeshCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def bevel_gear_mesh_compound_steady_state_synchronous_response(self) -> 'BevelGearMeshCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2978.BevelGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2978.BevelGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'BevelGearMeshCompoundSteadyStateSynchronousResponse._Cast_BevelGearMeshCompoundSteadyStateSynchronousResponse':
