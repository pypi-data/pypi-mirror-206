...
class RollingRingAssemblyCompoundParametricStudyTool(_4516.SpecialisedAssemblyCompoundParametricStudyTool):
    """RollingRingAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4380.RollingRingAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4380.RollingRingAssemblyParametricStudyTool]':
