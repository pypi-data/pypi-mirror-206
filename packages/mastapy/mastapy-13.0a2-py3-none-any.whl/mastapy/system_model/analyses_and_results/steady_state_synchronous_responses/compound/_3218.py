...
class WormGearCompoundSteadyStateSynchronousResponse(_3153.GearCompoundSteadyStateSynchronousResponse):
    """WormGearCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_WormGearCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'WormGearCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def worm_gear_compound_steady_state_synchronous_response(self) -> 'WormGearCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3091.WormGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3091.WormGearSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'WormGearCompoundSteadyStateSynchronousResponse._Cast_WormGearCompoundSteadyStateSynchronousResponse':
