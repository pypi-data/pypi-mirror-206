...
class LoadCaseGroupHistograms(_0.APIBase):
    ...
    @property
    def power_chart(self) -> '_1852.TwoDChartDefinition':
    ...
    def y_axis_variable(self) -> 'LoadCaseGroupHistograms.RevolutionsOrDuration':
        ...
        value = conversion.pn_to_mp_enum(temp, LoadCaseGroupHistograms.RevolutionsOrDuration)
    ...
    def y_axis_variable(self, value: 'LoadCaseGroupHistograms.RevolutionsOrDuration'):
        ...
        value = conversion.mp_to_pn_enum(value, LoadCaseGroupHistograms.RevolutionsOrDuration.type_())
