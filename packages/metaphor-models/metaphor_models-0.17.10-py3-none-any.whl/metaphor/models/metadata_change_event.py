...
class FiveTranConnector:
    ...
    def from_dict(obj: Any) -> 'FiveTranConnector':
        ...
        return FiveTranConnector(config, connector_logs_url, connector_name, connector_type_id, connector_type_name, connector_url, created_at, creator_email, paused, schema_metadata, source_entity_id, status, succeeded_at, sync_interval_in_minute)
...
class DatasetStatistics:
    ...
    def from_dict(obj: Any) -> 'DatasetStatistics':
        ...
        return DatasetStatistics(created_at, aspect_type, dataset_statistics_created_at, data_size, data_size_bytes, entity_id, field_statistics, id, last_updated, record_count)
