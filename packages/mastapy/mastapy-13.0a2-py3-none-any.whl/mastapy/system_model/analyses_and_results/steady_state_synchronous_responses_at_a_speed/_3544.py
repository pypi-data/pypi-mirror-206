...
class GuideDxfModelSteadyStateSynchronousResponseAtASpeed(_3508.ComponentSteadyStateSynchronousResponseAtASpeed):
    """GuideDxfModelSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_GuideDxfModelSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'GuideDxfModelSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def guide_dxf_model_steady_state_synchronous_response_at_a_speed(self) -> 'GuideDxfModelSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GuideDxfModelSteadyStateSynchronousResponseAtASpeed._Cast_GuideDxfModelSteadyStateSynchronousResponseAtASpeed':
