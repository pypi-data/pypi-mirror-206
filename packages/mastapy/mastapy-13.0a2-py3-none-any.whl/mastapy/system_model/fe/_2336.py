...
from mastapy.math_utility import _1480, _1479
...
class AlignConnectedComponentOptions(_0.APIBase):
    ...
    class _Cast_AlignConnectedComponentOptions:
        ...
        def __init__(self, parent: 'AlignConnectedComponentOptions'):
            self._parent = parent

        @property
        def align_connected_component_options(self) -> 'AlignConnectedComponentOptions':
            return self._parent
    ...
    @property
    def component_direction_normal_to_surface(self) -> '_1480.Axis':
        ...
        value = conversion.pn_to_mp_enum(temp, _1480.Axis)
        return constructor.new_from_mastapy_type(_1480.Axis)(value) if value is not None else None

    @component_direction_normal_to_surface.setter
    def component_direction_normal_to_surface(self, value: '_1480.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1480.Axis.type_())
    ...
    @property
    def fe_axis_approximately_in_perpendicular_direction(self) -> '_1479.AlignmentAxis':
    ...
    def fe_axis_approximately_in_perpendicular_direction(self, value: '_1479.AlignmentAxis'):
        value = value if value else None
    ...
    @property
    def first_component_alignment_axis(self) -> '_1480.Axis':
    ...
    def first_component_alignment_axis(self, value: '_1480.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1480.Axis.type_())
        self.wrapped.FirstComponentAlignmentAxis = value

    @property
    def first_fe_alignment_axis(self) -> '_1479.AlignmentAxis':
    ...
    def first_fe_alignment_axis(self, value: '_1479.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1479.AlignmentAxis.type_())
    ...
    @property
    def cast_to(self) -> 'AlignConnectedComponentOptions._Cast_AlignConnectedComponentOptions':
