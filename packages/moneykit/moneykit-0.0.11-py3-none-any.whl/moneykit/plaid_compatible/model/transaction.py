...
class Transaction(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'personal_finance_category_icon_url': (str, none_type,),  # noqa: E501
            'counterparties': ([TransactionCounterparty], none_type,),  # noqa: E501
        }
    ...
    def __init__(self, account_id, amount, date, name, pending, transaction_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            authorized_date (date, none_type): The date that the transaction was authorized. Dates are returned in an [ISO 8601](https://wikipedia.org/wiki/ISO_8601) format ( `YYYY-MM-DD` ).. [optional]  # noqa: E501
            ...
            personal_finance_category_icon_url (str, none_type): A link to the icon associated with the primary personal finance category. The logo will always be 100x100 pixels.. [optional]  # noqa: E501
            counterparties ([TransactionCounterparty], none_type): The counterparties present in the transaction. Counterparties, such as the financial institutions, are extracted by Plaid from the raw description.. [optional]  # noqa: E501
        """
