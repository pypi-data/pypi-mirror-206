...
from mastapy.gears.gear_designs.face import _990, _988, _987
...
class FaceGearSetMicroGeometry(_1225.GearSetImplementationDetail):
    """FaceGearSetMicroGeometry
    ...
    @property
    def face_mesh_micro_geometries(self) -> 'List[_987.FaceGearMeshMicroGeometry]':
