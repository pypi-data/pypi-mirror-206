...
class HypoidGearCriticalSpeedAnalysis(_6512.AGMAGleasonConicalGearCriticalSpeedAnalysis):
    """HypoidGearCriticalSpeedAnalysis
    ...
    class _Cast_HypoidGearCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'HypoidGearCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_critical_speed_analysis(self) -> 'HypoidGearCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidGearCriticalSpeedAnalysis._Cast_HypoidGearCriticalSpeedAnalysis':
