...
class TransformMatrix3D(_1513.RealMatrix):
    """TransformMatrix3D
    ...
    class _Cast_TransformMatrix3D:
        ...
        def __init__(self, parent: 'TransformMatrix3D'):
            self._parent = parent
        ...
        @property
        def transform_matrix_3d(self) -> 'TransformMatrix3D':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TransformMatrix3D._Cast_TransformMatrix3D':
