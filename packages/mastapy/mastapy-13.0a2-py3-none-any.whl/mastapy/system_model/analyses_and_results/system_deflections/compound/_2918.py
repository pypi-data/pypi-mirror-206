...
class PowerLoadCompoundSystemDeflection(_2954.VirtualComponentCompoundSystemDeflection):
    """PowerLoadCompoundSystemDeflection
    ...
    class _Cast_PowerLoadCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'PowerLoadCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def power_load_compound_system_deflection(self) -> 'PowerLoadCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2771.PowerLoadSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2771.PowerLoadSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'PowerLoadCompoundSystemDeflection._Cast_PowerLoadCompoundSystemDeflection':
