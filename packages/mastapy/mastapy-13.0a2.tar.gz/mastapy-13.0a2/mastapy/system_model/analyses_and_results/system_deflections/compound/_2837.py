...
from mastapy.system_model.analyses_and_results.system_deflections.compound import (
    _2838, _2840, _2843, _2850,
    _2849, _2871, _2851, _2856,
    _2861, _2873, _2875, _2879,
    _2887, _2886, _2888, _2895,
    _2902, _2905, _2906, _2907,
    _2909, _2911, _2916, _2917,
    _2918, _2920, _2922, _2928,
    _2926, _2933, _2934, _2939,
    _2942, _2945, _2949, _2953,
    _2957, _2960, _2830
)
...
class AssemblyCompoundSystemDeflection(_2830.AbstractAssemblyCompoundSystemDeflection):
    """AssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2671.AssemblySystemDeflection]':
    ...
    @property
    def bearings(self) -> 'List[_2838.BearingCompoundSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_2840.BeltDriveCompoundSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_2843.BevelDifferentialGearSetCompoundSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_2850.BoltedJointCompoundSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_2849.BoltCompoundSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_2871.CVTCompoundSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_2851.ClutchCompoundSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_2856.ConceptCouplingCompoundSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_2861.ConceptGearSetCompoundSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_2873.CycloidalAssemblyCompoundSystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_2875.CycloidalDiscCompoundSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_2879.CylindricalGearSetCompoundSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_2887.FEPartCompoundSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_2886.FaceGearSetCompoundSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_2888.FlexiblePinAssemblyCompoundSystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_2895.HypoidGearSetCompoundSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_2902.KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_2905.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_2906.MassDiscCompoundSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_2907.MeasurementComponentCompoundSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_2909.OilSealCompoundSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_2911.PartToPartShearCouplingCompoundSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_2916.PlanetCarrierCompoundSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_2917.PointLoadCompoundSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_2918.PowerLoadCompoundSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_2920.RingPinsCompoundSystemDeflection]':
    ...
    @property
    def rolling_bearings(self) -> 'List[_2838.BearingCompoundSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_2922.RollingRingAssemblyCompoundSystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_2928.ShaftHubConnectionCompoundSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_2926.ShaftCompoundSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_2933.SpiralBevelGearSetCompoundSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_2934.SpringDamperCompoundSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_2939.StraightBevelDiffGearSetCompoundSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_2942.StraightBevelGearSetCompoundSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_2945.SynchroniserCompoundSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_2949.TorqueConverterCompoundSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_2953.UnbalancedMassCompoundSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_2957.WormGearSetCompoundSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_2960.ZerolBevelGearSetCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2671.AssemblySystemDeflection]':
