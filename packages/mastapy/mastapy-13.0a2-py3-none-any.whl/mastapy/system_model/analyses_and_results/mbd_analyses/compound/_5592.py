...
class RollingRingConnectionCompoundMultibodyDynamicsAnalysis(_5564.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """RollingRingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5450.RollingRingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5450.RollingRingConnectionMultibodyDynamicsAnalysis]':
