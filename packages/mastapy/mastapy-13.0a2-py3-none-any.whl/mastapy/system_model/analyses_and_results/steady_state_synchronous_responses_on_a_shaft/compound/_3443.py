...
class RingPinsCompoundSteadyStateSynchronousResponseOnAShaft(_3431.MountableComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """RingPinsCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_RingPinsCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'RingPinsCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def ring_pins_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'RingPinsCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3313.RingPinsSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3313.RingPinsSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'RingPinsCompoundSteadyStateSynchronousResponseOnAShaft._Cast_RingPinsCompoundSteadyStateSynchronousResponseOnAShaft':
