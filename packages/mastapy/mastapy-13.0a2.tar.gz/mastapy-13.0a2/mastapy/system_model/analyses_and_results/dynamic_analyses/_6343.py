...
class SpiralBevelGearDynamicAnalysis(_6259.BevelGearDynamicAnalysis):
    """SpiralBevelGearDynamicAnalysis
    ...
    class _Cast_SpiralBevelGearDynamicAnalysis:
        ...
        def __init__(self, parent: 'SpiralBevelGearDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_dynamic_analysis(self) -> 'SpiralBevelGearDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearDynamicAnalysis._Cast_SpiralBevelGearDynamicAnalysis':
