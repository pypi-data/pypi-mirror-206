...
class ElectricMachineResultsForPhase(_0.APIBase):
    ...
    class _Cast_ElectricMachineResultsForPhase:
        ...
        def __init__(self, parent: 'ElectricMachineResultsForPhase'):
            self._parent = parent

        @property
        def electric_machine_results_for_phase(self) -> 'ElectricMachineResultsForPhase':
            return self._parent
    ...
    @property
    def power_factor_direction(self) -> '_1350.LeadingOrLagging':
        ...
        value = conversion.pn_to_mp_enum(temp, _1350.LeadingOrLagging)
        return constructor.new_from_mastapy_type(_1350.LeadingOrLagging)(value) if value is not None else None
    ...
    @property
    def cast_to(self) -> 'ElectricMachineResultsForPhase._Cast_ElectricMachineResultsForPhase':
