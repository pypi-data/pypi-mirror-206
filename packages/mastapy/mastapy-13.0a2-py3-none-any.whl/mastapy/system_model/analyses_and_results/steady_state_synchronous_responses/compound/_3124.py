...
class ConceptGearCompoundSteadyStateSynchronousResponse(_3153.GearCompoundSteadyStateSynchronousResponse):
    """ConceptGearCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_ConceptGearCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'ConceptGearCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def concept_gear_compound_steady_state_synchronous_response(self) -> 'ConceptGearCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2993.ConceptGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2993.ConceptGearSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'ConceptGearCompoundSteadyStateSynchronousResponse._Cast_ConceptGearCompoundSteadyStateSynchronousResponse':
