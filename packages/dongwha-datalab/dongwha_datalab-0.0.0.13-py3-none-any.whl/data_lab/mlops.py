...
def aws_connection(service_name, aws_access_key_id, aws_secret_access_key, endpoint_url = ""):
    if service_name == 's3' : 
    ...
    if service_name == 'ssm' : 
        if aws_access_key_id == '' or aws_secret_access_key == '': 
            cli = boto3.client('ssm', endpoint_url= endpoint_url)
        else :
...
def get_ssm( parameter_store_path, aws_access_key_id, aws_secret_access_key, endpoint_url ):
#     client = boto3.client('ssm')
    client = aws_connection('ssm', aws_access_key_id, aws_secret_access_key, endpoint_url )
...
def mongodb_connection(  environment, collection_div, aws_access_key_id, aws_secret_access_key, ssm_path, endpoint_url  ) : 
    ...
    print( SSM_PATH )
    CONN_INFO = get_ssm( SSM_PATH,  aws_access_key_id, aws_secret_access_key, endpoint_url )
...
def create_config_train_image( environment, model_id, endpoint_url,  aws_access_key_id = '', aws_secret_access_key = '', ssm_path = '/mlops/{0}/database/mongo' ) : 
    import datetime 
    ...
    image_config = {
                        ...
                        'extract_local_script_path' : r'./script/k121/sql.txt',
                        'transform_local_script_path' : r'./script/k121/k121_transform.py',
                        'train_local_script_path' : r'./script/k121/k121_density.py',
        
                        'endpoint_local_script_path' : r'./script/k121/k121_sf_api.py',
...
def upload_s3_ml_script(environment, config, endpoint_url = None, aws_access_key_id = '', aws_secret_access_key = '', stepfunction_job = 'mlops_test_step_01',  bucket = 'dwe-mlops-hub-repository',  ssm_path = '/mlops/{0}/database/mongo'  ):
...
def auto_excute(environment, model_id, endpoint_url = None, aws_access_key_id = '', aws_secret_access_key = '', stepfunction_job = 'mlops_test_step_01',  bucket = 'dwe-mlops-hub-repository',  ssm_path = '/mlops/{0}/database/mongo'  ):
