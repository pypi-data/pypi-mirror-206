...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import (
    _5226, _5228, _5231, _5238,
    _5237, _5259, _5239, _5244,
    _5249, _5261, _5263, _5267,
    _5274, _5273, _5275, _5282,
    _5289, _5292, _5293, _5294,
    _5296, _5298, _5303, _5304,
    _5305, _5307, _5309, _5314,
    _5313, _5319, _5320, _5325,
    _5328, _5331, _5335, _5339,
    _5343, _5346, _5218
)
...
class AssemblyCompoundModalAnalysisAtASpeed(_5218.AbstractAssemblyCompoundModalAnalysisAtASpeed):
    """AssemblyCompoundModalAnalysisAtASpeed
    ...
    class _Cast_AssemblyCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'AssemblyCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def assembly_compound_modal_analysis_at_a_speed(self) -> 'AssemblyCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5096.AssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def bearings(self) -> 'List[_5226.BearingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_5228.BeltDriveCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5231.BevelDifferentialGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5238.BoltedJointCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_5237.BoltCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_5259.CVTCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_5239.ClutchCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5244.ConceptCouplingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5249.ConceptGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5261.CycloidalAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5263.CycloidalDiscCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5267.CylindricalGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_5274.FEPartCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5273.FaceGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5275.FlexiblePinAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5282.HypoidGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5289.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5292.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_5293.MassDiscCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_5294.MeasurementComponentCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_5296.OilSealCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5298.PartToPartShearCouplingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5303.PlanetCarrierCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_5304.PointLoadCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_5305.PowerLoadCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_5307.RingPinsCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5309.RollingRingAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5314.ShaftHubConnectionCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_5313.ShaftCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5319.SpiralBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5320.SpringDamperCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5325.StraightBevelDiffGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5328.StraightBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_5331.SynchroniserCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_5335.TorqueConverterCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5339.UnbalancedMassCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5343.WormGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5346.ZerolBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5096.AssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'AssemblyCompoundModalAnalysisAtASpeed._Cast_AssemblyCompoundModalAnalysisAtASpeed':
