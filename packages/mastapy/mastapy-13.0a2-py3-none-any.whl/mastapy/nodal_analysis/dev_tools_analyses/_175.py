...
class DrawStyleForFE(_0.APIBase):
    ...
    class _Cast_DrawStyleForFE:
        ...
        def __init__(self, parent: 'DrawStyleForFE'):
            self._parent = parent

        @property
        def draw_style_for_fe(self) -> 'DrawStyleForFE':
            return self._parent
    ...
    def line_option(self) -> '_59.FEMeshElementEntityOption':
        ...
        value = conversion.pn_to_mp_enum(temp, _59.FEMeshElementEntityOption)
    ...
    def line_option(self, value: '_59.FEMeshElementEntityOption'):
        ...
        value = conversion.mp_to_pn_enum(value, _59.FEMeshElementEntityOption.type_())
    ...
    @property
    def cast_to(self) -> 'DrawStyleForFE._Cast_DrawStyleForFE':
