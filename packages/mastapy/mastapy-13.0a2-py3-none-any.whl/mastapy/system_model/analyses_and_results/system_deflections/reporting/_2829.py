...
class SplineFlankContactReporting(_0.APIBase):
    ...
    class _Cast_SplineFlankContactReporting:
        ...
        def __init__(self, parent: 'SplineFlankContactReporting'):
            self._parent = parent

        @property
        def spline_flank_contact_reporting(self) -> 'SplineFlankContactReporting':
            return self._parent
    ...
    @property
    def force_on_inner_contact_coordinate_system(self) -> '_1553.VectorWithLinearAndAngularComponents':
    ...
    @property
    def force_on_inner_wcs(self) -> '_1553.VectorWithLinearAndAngularComponents':
    ...
    @property
    def relative_deflection_lcs(self) -> '_1553.VectorWithLinearAndAngularComponents':
    ...
    @property
    def relative_deflection_wcs(self) -> '_1553.VectorWithLinearAndAngularComponents':
    ...
    @property
    def cast_to(self) -> 'SplineFlankContactReporting._Cast_SplineFlankContactReporting':
