...
class ConceptGearMeshCompoundStabilityAnalysis(_3933.GearMeshCompoundStabilityAnalysis):
    """ConceptGearMeshCompoundStabilityAnalysis
    ...
    class _Cast_ConceptGearMeshCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'ConceptGearMeshCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_gear_mesh_compound_stability_analysis(self) -> 'ConceptGearMeshCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3771.ConceptGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3771.ConceptGearMeshStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ConceptGearMeshCompoundStabilityAnalysis._Cast_ConceptGearMeshCompoundStabilityAnalysis':
