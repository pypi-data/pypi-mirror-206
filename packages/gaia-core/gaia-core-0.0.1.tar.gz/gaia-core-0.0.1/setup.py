...
dsp_files = package_files('gaia/cli/tester/dsp')
extra_files = package_files('gaia/cli/tester/deploy_files')
cloud_eval_extra_files = package_files('gaia/cli/tester/cloud_eval')
...
# for uninstall - python -m pip uninstall gaia-sdk
# for install - python -m pip install dist/gaia-sdk-0.1.0-py3-none-any.whl
...
'''
    ...
    pip install gaia-sdk --index-url https://pypi.org/simple
