...
class LinearDampingConnectionProperties(_46.AbstractLinearConnectionProperties):
    ...
    class _Cast_LinearDampingConnectionProperties:
        ...
        def __init__(self, parent: 'LinearDampingConnectionProperties'):
            self._parent = parent
        ...
        @property
        def linear_damping_connection_properties(self) -> 'LinearDampingConnectionProperties':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'LinearDampingConnectionProperties._Cast_LinearDampingConnectionProperties':
