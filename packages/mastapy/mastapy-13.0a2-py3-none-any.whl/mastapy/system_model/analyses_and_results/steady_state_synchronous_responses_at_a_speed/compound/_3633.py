...
class BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed(_3711.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def bolted_joint_compound_steady_state_synchronous_response_at_a_speed(self) -> 'BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def component_design(self) -> '_2423.BoltedJoint':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3502.BoltedJointSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3502.BoltedJointSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed._Cast_BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed(self)
