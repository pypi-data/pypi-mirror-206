...
class AbstractAssemblyCompoundDynamicAnalysis(_6452.PartCompoundDynamicAnalysis):
    """AbstractAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6243.AbstractAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6243.AbstractAssemblyDynamicAnalysis]':
