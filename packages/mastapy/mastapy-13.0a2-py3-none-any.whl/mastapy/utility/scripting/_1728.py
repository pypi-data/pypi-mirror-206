...
class ScriptingSetup(_1583.PerMachineSettings):
    """ScriptingSetup
    ...
    def python_remote_host(self, value: 'str'):
        self.wrapped.PythonRemoteHost = str(value) if value else ''
    ...
    def python_remote_port(self, value: 'int'):
        self.wrapped.PythonRemotePort = int(value) if value else 0
