...
class SpringDamperHalfSteadyStateSynchronousResponse(_3000.CouplingHalfSteadyStateSynchronousResponse):
    """SpringDamperHalfSteadyStateSynchronousResponse
    ...
    class _Cast_SpringDamperHalfSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'SpringDamperHalfSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def spring_damper_half_steady_state_synchronous_response(self) -> 'SpringDamperHalfSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperHalfSteadyStateSynchronousResponse._Cast_SpringDamperHalfSteadyStateSynchronousResponse':
