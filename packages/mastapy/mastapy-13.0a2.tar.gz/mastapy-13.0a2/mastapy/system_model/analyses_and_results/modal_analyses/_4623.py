...
class KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis(_4617.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh_modal_analysis(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis._Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis':
