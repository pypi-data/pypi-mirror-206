...
class SortColumns (  ISortColumns) :
    ...
    <returns>Added sort column.</returns>
        ...
        intPtr = GetDllLibXls().SortColumns_Add(self.Ptr, key,enumsortComparsionType,enumorderBy)
    ...
    <returns>Added sort column.</returns>
        ...
        intPtr = GetDllLibXls().SortColumns_AddKO(self.Ptr, key,enumorderBy)
        ret = None if intPtr==None else SortColumn(intPtr)
        return ret
    ...
    <returns>Added sort column.</returns>
        ...
        intPtr = GetDllLibXls().SortColumns_AddKC(self.Ptr, key,arraycustomSortOrder,countcustomSortOrder)
        ret = None if intPtr==None else SortColumn(intPtr)
        return ret
    ...
    def Remove(self ,sortColumn:SortColumn):
        ...
        GetDllLibXls().SortColumns_Remove(self.Ptr, intPtrsortColumn)
    ...
    <param name="fieldIndex">Field index to remove.</param>
        ...
        GetDllLibXls().SortColumns_RemoveK(self.Ptr, key)
    ...
    def RemoveAt(self ,index:int):
        ...
        GetDllLibXls().SortColumns_RemoveAt(self.Ptr, index)
    ...
    def GetByIndex(self ,index:int)->'SortColumn':
        ...
        intPtr = GetDllLibXls().SortColumns_GetByIndex(self.Ptr, index)
        ret = None if intPtr==None else SortColumn(intPtr)
        return ret
    ...
    def get_Item(self ,fieldIndex:int)->'SortColumn':
        ...
        intPtr = GetDllLibXls().SortColumns_get_Item(self.Ptr, fieldIndex)
        ret = None if intPtr==None else SortColumn(intPtr)
        return ret
    ...
    def GetEnumerator(self)->'IEnumerator':
        ...
        intPtr = GetDllLibXls().SortColumns_GetEnumerator(self.Ptr)
    ...
    def Clear(self):
        ...
        GetDllLibXls().SortColumns_Clear(self.Ptr)
    ...
    def Capacity(self)->int:
        ...
        ret = GetDllLibXls().SortColumns_get_Capacity(self.Ptr)
        return ret

    @Capacity.setter
    def Capacity(self, value:int):
        GetDllLibXls().SortColumns_set_Capacity.argtypes=[c_void_p, c_int]
        GetDllLibXls().SortColumns_set_Capacity(self.Ptr, value)
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().SortColumns_get_Count(self.Ptr)
        return ret
