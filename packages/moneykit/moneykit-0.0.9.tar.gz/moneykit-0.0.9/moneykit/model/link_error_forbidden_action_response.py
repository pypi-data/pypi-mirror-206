...
class LinkErrorForbiddenActionResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class error_code(schemas.EnumBase, schemas.StrSchema):
                class MetaOapg:
                    enum_value_to_name = {
                        "link_error.forbidden_action": "LINK_ERROR_FORBIDDEN_ACTION",
                    }

                @schemas.classproperty
                def LINK_ERROR_FORBIDDEN_ACTION(cls):
                    return cls("link_error.forbidden_action")
