...
class PartDetailSelection(_0.APIBase, Generic[TPart, TSelectableItem]):
    ...
    class _Cast_PartDetailSelection:
        ...
        def active_gear_set_design_selection(self):
            ...
            return self._parent._cast(_2490.ActiveGearSetDesignSelection)

        @property
        def active_fe_substructure_selection(self):
            from mastapy.system_model.part_model.configurations import _2590
            
            return self._parent._cast(_2590.ActiveFESubstructureSelection)

        @property
        def active_shaft_design_selection(self):
            from mastapy.system_model.part_model.configurations import _2592
            
            return self._parent._cast(_2592.ActiveShaftDesignSelection)

        @property
        def bearing_detail_selection(self):
            from mastapy.system_model.part_model.configurations import _2595
            
            return self._parent._cast(_2595.BearingDetailSelection)
    ...
    def part(self) -> 'TPart':
        ...
        return constructor.new_from_mastapy_type(TPart)(temp) if temp is not None else None
