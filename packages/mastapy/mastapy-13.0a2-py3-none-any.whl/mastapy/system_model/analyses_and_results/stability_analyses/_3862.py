...
class TorqueConverterConnectionStabilityAnalysis(_3779.CouplingConnectionStabilityAnalysis):
    """TorqueConverterConnectionStabilityAnalysis
    ...
    class _Cast_TorqueConverterConnectionStabilityAnalysis:
        ...
        def __init__(self, parent: 'TorqueConverterConnectionStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def torque_converter_connection_stability_analysis(self) -> 'TorqueConverterConnectionStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterConnectionStabilityAnalysis._Cast_TorqueConverterConnectionStabilityAnalysis':
