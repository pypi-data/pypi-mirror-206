...
def add_node(override_context: typing.Union[typing.
    ...
    ''' Add a node to the active tree :File: `startup/bl_operators/node.py\:113 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L113>`__
...
def collapse_hide_unused_toggle(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: typing.Optional[bool] = None):
    ''' Toggle collapsed nodes and hide unused sockets :File: `startup/bl_operators/node.py\:163 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L163>`__
...
def tree_path_parent(override_context: typing.
                     ...
                     execution_context: typing.Union[str, int] = None,
                     undo: typing.Optional[bool] = None):
    ''' Go to parent node tree :File: `startup/bl_operators/node.py\:193 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L193>`__
