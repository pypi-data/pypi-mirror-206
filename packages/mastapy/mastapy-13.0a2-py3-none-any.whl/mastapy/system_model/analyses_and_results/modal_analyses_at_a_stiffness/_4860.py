...
class ConceptGearModalAnalysisAtAStiffness(_4890.GearModalAnalysisAtAStiffness):
    """ConceptGearModalAnalysisAtAStiffness
    ...
    class _Cast_ConceptGearModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ConceptGearModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def concept_gear_modal_analysis_at_a_stiffness(self) -> 'ConceptGearModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptGearModalAnalysisAtAStiffness._Cast_ConceptGearModalAnalysisAtAStiffness':
