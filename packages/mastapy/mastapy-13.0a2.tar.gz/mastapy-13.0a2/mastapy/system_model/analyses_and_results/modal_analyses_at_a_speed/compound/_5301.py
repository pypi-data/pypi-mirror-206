...
class PlanetaryConnectionCompoundModalAnalysisAtASpeed(_5315.ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """PlanetaryConnectionCompoundModalAnalysisAtASpeed
    ...
    class _Cast_PlanetaryConnectionCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'PlanetaryConnectionCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def planetary_connection_compound_modal_analysis_at_a_speed(self) -> 'PlanetaryConnectionCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5172.PlanetaryConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5172.PlanetaryConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'PlanetaryConnectionCompoundModalAnalysisAtASpeed._Cast_PlanetaryConnectionCompoundModalAnalysisAtASpeed':
