...
class PowerLoadParametricStudyTool(_4411.VirtualComponentParametricStudyTool):
    """PowerLoadParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2771.PowerLoadSystemDeflection]':
