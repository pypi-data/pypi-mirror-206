...
class DataInputFileOptions(_0.APIBase):
    ...
    class _Cast_DataInputFileOptions:
        ...
        def __init__(self, parent: 'DataInputFileOptions'):
            self._parent = parent

        @property
        def rotor_set_data_input_file_options(self):
            from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2537
            
            return self._parent._cast(_2537.RotorSetDataInputFileOptions)

        @property
        def multi_time_series_data_input_file_options(self):
            from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6960
            
            return self._parent._cast(_6960.MultiTimeSeriesDataInputFileOptions)

        @property
        def data_input_file_options(self) -> 'DataInputFileOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DataInputFileOptions._Cast_DataInputFileOptions':
