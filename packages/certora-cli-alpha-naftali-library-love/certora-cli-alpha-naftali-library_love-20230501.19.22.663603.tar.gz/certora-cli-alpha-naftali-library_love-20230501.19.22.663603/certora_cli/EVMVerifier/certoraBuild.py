...
class CertoraBuildGenerator:
    ...
    def build(self, context: CertoraContext) -> None:
        ...
        for i, build_arg_contract_file in enumerate(sorted(self.input_config.files)):
            ...
            backup_dir = get_certora_sources_dir() / PRE_AUTOFINDER_BACKUP_DIR
            shutil.copytree(get_certora_sources_dir(), backup_dir, dirs_exist_ok=True)
            ...
            if compiler_lang == CompilerLangSol():
                ...
                if not success:
                    # roll back .certora_sources by copying again
