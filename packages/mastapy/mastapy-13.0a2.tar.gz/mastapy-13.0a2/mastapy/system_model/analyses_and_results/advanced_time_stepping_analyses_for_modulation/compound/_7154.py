...
class DatumCompoundAdvancedTimeSteppingAnalysisForModulation(_7128.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """DatumCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_DatumCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'DatumCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def datum_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'DatumCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7024.DatumAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7024.DatumAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'DatumCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_DatumCompoundAdvancedTimeSteppingAnalysisForModulation':
