...
class CylindricalGearSetFlankDesign(_0.APIBase):
    ...
    class _Cast_CylindricalGearSetFlankDesign:
        ...
        def __init__(self, parent: 'CylindricalGearSetFlankDesign'):
            self._parent = parent

        @property
        def cylindrical_gear_set_flank_design(self) -> 'CylindricalGearSetFlankDesign':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearSetFlankDesign._Cast_CylindricalGearSetFlankDesign':
