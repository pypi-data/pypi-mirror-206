...
class SlotDetailForAnalysis(_0.APIBase):
    ...
    class _Cast_SlotDetailForAnalysis:
        ...
        def __init__(self, parent: 'SlotDetailForAnalysis'):
            self._parent = parent

        @property
        def slot_detail_for_analysis(self) -> 'SlotDetailForAnalysis':
            return self._parent
    ...
    @property
    def slot_section_details(self) -> '_1288.SlotSectionDetail':
    ...
    @property
    def cast_to(self) -> 'SlotDetailForAnalysis._Cast_SlotDetailForAnalysis':
