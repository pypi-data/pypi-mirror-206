...
class StraightBevelGearMeshPowerFlow(_4025.BevelGearMeshPowerFlow):
    """StraightBevelGearMeshPowerFlow
    ...
    class _Cast_StraightBevelGearMeshPowerFlow:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshPowerFlow'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_power_flow(self) -> 'StraightBevelGearMeshPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshPowerFlow._Cast_StraightBevelGearMeshPowerFlow':
