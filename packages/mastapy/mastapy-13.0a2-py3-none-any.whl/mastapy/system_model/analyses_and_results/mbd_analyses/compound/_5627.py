...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5625, _5626, _5517
...
class ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis(_5517.BevelGearSetCompoundMultibodyDynamicsAnalysis):
    """ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_compound_multibody_dynamics_analysis(self) -> 'ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5492.ZerolBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5625.ZerolBevelGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5626.ZerolBevelGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5492.ZerolBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis._Cast_ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis':
