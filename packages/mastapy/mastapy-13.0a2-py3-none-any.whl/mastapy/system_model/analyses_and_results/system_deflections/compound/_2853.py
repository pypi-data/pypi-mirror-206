...
class ClutchHalfCompoundSystemDeflection(_2869.CouplingHalfCompoundSystemDeflection):
    """ClutchHalfCompoundSystemDeflection
    ...
    class _Cast_ClutchHalfCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'ClutchHalfCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def clutch_half_compound_system_deflection(self) -> 'ClutchHalfCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2691.ClutchHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2691.ClutchHalfSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'ClutchHalfCompoundSystemDeflection._Cast_ClutchHalfCompoundSystemDeflection':
