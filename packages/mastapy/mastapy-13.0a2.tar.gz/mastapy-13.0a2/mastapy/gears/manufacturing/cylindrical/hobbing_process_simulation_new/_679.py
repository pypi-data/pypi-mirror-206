...
class ProcessProfileCalculation(_0.APIBase):
    ...
    class _Cast_ProcessProfileCalculation:
        ...
        def __init__(self, parent: 'ProcessProfileCalculation'):
            self._parent = parent

        @property
        def process_profile_calculation(self) -> 'ProcessProfileCalculation':
            return self._parent
    ...
    @property
    def left_flank_accuracy_calculation(self) -> '_657.CalculateProfileDeviationAccuracy':
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_657.CalculateProfileDeviationAccuracy':
    ...
    @property
    def cast_to(self) -> 'ProcessProfileCalculation._Cast_ProcessProfileCalculation':
