...
class SystemDirectoryPopulator(_0.APIBase):
    ...
    class _Cast_SystemDirectoryPopulator:
        ...
        def __init__(self, parent: 'SystemDirectoryPopulator'):
            self._parent = parent

        @property
        def system_directory_populator(self) -> 'SystemDirectoryPopulator':
            return self._parent
    ...
    def copy_from(self) -> 'SystemDirectoryPopulator.SetupFrom':
        ...
        value = conversion.pn_to_mp_enum(temp, SystemDirectoryPopulator.SetupFrom)
    ...
    def copy_from(self, value: 'SystemDirectoryPopulator.SetupFrom'):
        ...
        value = conversion.mp_to_pn_enum(value, SystemDirectoryPopulator.SetupFrom.type_())
    ...
    @property
    def current_version(self) -> '_1589.SystemDirectory':
    ...
    @property
    def version_to_copy(self) -> '_1589.SystemDirectory':
    ...
    @property
    def cast_to(self) -> 'SystemDirectoryPopulator._Cast_SystemDirectoryPopulator':
