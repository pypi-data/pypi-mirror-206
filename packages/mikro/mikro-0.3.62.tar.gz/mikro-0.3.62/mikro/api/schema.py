...
from typing import Literal, List, Optional, Iterator, Tuple, AsyncIterator, Dict
...
class EraFragment(BaseModel):
    ...
    "The name of the era"
    id: ID
    timepoints: Tuple["TimepointFragment", ...]
...
class CreateTimepointMutation(BaseModel):
    ...
    class Meta:
        document = "fragment Timepoint on Timepoint {\n  name\n  id\n  deltaT\n}\n\nmutation CreateTimepoint($era: ID!, $delta_t: Float!, $name: String) {\n  createTimepoint(era: $era, deltaT: $delta_t, name: $name) {\n    ...Timepoint\n  }\n}"
...
class SearchErasQueryOptions(BaseModel):
    """Era(id, created_by, created_through, created_while, name, start, end)"""
...
async def acreate_era(
    ...
    """CreateEra
     ...
     createEra: Era(id, created_by, created_through, created_while, name, start, end)
...
async def acreate_timepoint(
    era: ID, delta_t: float, name: Optional[str] = None, rath: MikroRath = None
    ...
    return (
        await aexecute(
            ...
            {"era": era, "delta_t": delta_t, "name": name},
            rath=rath,
        )
    ).create_timepoint
...
async def aget_era(id: ID, rath: MikroRath = None) -> Optional[EraFragment]:
    """GetEra
     ...
     era: Era(id, created_by, created_through, created_while, name, start, end)
...
async def asearch_eras(
    ...
    """SearchEras
     ...
     options: Era(id, created_by, created_through, created_while, name, start, end)
