...
class IChartErrorBars (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().IChartErrorBars_get_Border(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IChartErrorBars_get_Include(self.Ptr)
    ...
    def Include(self, value:'ErrorBarIncludeType'):
        ...
        GetDllLibXls().IChartErrorBars_set_Include(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IChartErrorBars_get_HasCap(self.Ptr)
        return ret

    @HasCap.setter
    def HasCap(self, value:bool):
        GetDllLibXls().IChartErrorBars_set_HasCap.argtypes=[c_void_p, c_bool]
        GetDllLibXls().IChartErrorBars_set_HasCap(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IChartErrorBars_get_Type(self.Ptr)
    ...
    def Type(self, value:'ErrorBarType'):
        ...
        GetDllLibXls().IChartErrorBars_set_Type(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IChartErrorBars_get_NumberValue(self.Ptr)
        return ret

    @NumberValue.setter
    def NumberValue(self, value:float):
        GetDllLibXls().IChartErrorBars_set_NumberValue.argtypes=[c_void_p, c_double]
        GetDllLibXls().IChartErrorBars_set_NumberValue(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().IChartErrorBars_get_PlusRange(self.Ptr)
    ...
    def PlusRange(self, value:'IXLSRange'):
        ...
        GetDllLibXls().IChartErrorBars_set_PlusRange(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().IChartErrorBars_get_MinusRange(self.Ptr)
        ret = None if intPtr==None else XlsRange(intPtr)
        return ret
    ...
    def MinusRange(self, value:'IXLSRange'):
        ...
        GetDllLibXls().IChartErrorBars_set_MinusRange(self.Ptr, value.Ptr)
...
<value>The shadow.</value>
        ...
        intPtr = GetDllLibXls().IChartErrorBars_get_Shadow(self.Ptr)
...
<value>The chart3 D options.</value>
        ...
        intPtr = GetDllLibXls().IChartErrorBars_get_Chart3DOptions(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().IChartErrorBars_ClearFormats(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().IChartErrorBars_Delete(self.Ptr)
