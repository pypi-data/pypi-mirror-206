...
class MassDiscCompoundMultibodyDynamicsAnalysis(_5621.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """MassDiscCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_MassDiscCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'MassDiscCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def mass_disc_compound_multibody_dynamics_analysis(self) -> 'MassDiscCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5430.MassDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5430.MassDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'MassDiscCompoundMultibodyDynamicsAnalysis._Cast_MassDiscCompoundMultibodyDynamicsAnalysis':
