...
from mastapy.cycloidal import _1450, _1449, _1442
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self) -> '_1450.RingPinsDesign':
    ...
    @property
    def disc_phases(self) -> 'List[_1449.NamedDiscPhase]':
    ...
    @property
    def discs(self) -> 'List[_1442.CycloidalDiscDesign]':
