...
class SpiralBevelGearCompoundHarmonicAnalysis(_5862.BevelGearCompoundHarmonicAnalysis):
    """SpiralBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5779.SpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5779.SpiralBevelGearHarmonicAnalysis]':
