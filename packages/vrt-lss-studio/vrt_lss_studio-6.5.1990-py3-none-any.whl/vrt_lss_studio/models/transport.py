...
class Transport(BaseModel):
    ...
    """
    key: constr(strict=True, max_length=1024, min_length=1) = Field(..., description="Transport key, unique identifier.")
    shifts: conlist(TransportShift, max_items=15001, min_items=1, unique_items=True) = Field(..., description="List of working shifts of transport.")
    transport_type: Optional[TransportType] = None
    boxes: Optional[conlist(Box, max_items=100, min_items=0, unique_items=True)] = Field(None, description="A list of transport compartments that can accommodate the cargo.")
