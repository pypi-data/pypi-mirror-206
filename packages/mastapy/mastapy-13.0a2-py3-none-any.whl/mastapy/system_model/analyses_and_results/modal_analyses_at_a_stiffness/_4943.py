...
class StraightBevelSunGearModalAnalysisAtAStiffness(_4937.StraightBevelDiffGearModalAnalysisAtAStiffness):
    """StraightBevelSunGearModalAnalysisAtAStiffness
    ...
    class _Cast_StraightBevelSunGearModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'StraightBevelSunGearModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def straight_bevel_sun_gear_modal_analysis_at_a_stiffness(self) -> 'StraightBevelSunGearModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelSunGearModalAnalysisAtAStiffness._Cast_StraightBevelSunGearModalAnalysisAtAStiffness':
