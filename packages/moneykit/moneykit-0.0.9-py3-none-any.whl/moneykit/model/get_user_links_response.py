...
class GetUserLinksResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            class links(schemas.DictSchema):
                class MetaOapg:
                    @staticmethod
                    def additional_properties() -> typing.Type["LinkCommon"]:
                        return LinkCommon

                def __getitem__(self, name: typing.Union[str,]) -> "LinkCommon":
                    # dict_instance[name] accessor
                    return super().__getitem__(name)

                def get_item_oapg(self, name: typing.Union[str,]) -> "LinkCommon":
