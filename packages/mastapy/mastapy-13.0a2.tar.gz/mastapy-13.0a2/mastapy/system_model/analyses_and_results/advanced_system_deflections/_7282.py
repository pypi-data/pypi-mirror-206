...
class CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection(_7235.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection):
    """CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection
    ...
    class _Cast_CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def cycloidal_disc_planetary_bearing_connection_advanced_system_deflection(self) -> 'CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2716.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection._Cast_CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection':
        return self._Cast_CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection(self)
