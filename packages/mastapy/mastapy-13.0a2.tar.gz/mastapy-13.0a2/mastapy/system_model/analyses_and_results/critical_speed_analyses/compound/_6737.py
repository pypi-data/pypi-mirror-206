...
class SpecialisedAssemblyCompoundCriticalSpeedAnalysis(_6639.AbstractAssemblyCompoundCriticalSpeedAnalysis):
    """SpecialisedAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6608.SpecialisedAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6608.SpecialisedAssemblyCriticalSpeedAnalysis]':
