...
class ExternalConnection (SpireObject) :
    ...
    def ID(self)->str:
        ...
        GetDllLibXls().ExternalConnection_get_ID.restype=c_wchar_p
        ret = GetDllLibXls().ExternalConnection_get_ID(self.Ptr)
        return ret
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().ExternalConnection_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().ExternalConnection_get_Name(self.Ptr)
        return ret
    ...
    def Name(self, value:str):
        ...
        GetDllLibXls().ExternalConnection_set_Name(self.Ptr, value)
    ...
    def ConnType(self)->'ConnectionDataSourceType':
        ...
        ret = GetDllLibXls().ExternalConnection_get_ConnType(self.Ptr)
    ...
    def BackgroundRefresh(self)->bool:
        ...
        ret = GetDllLibXls().ExternalConnection_get_BackgroundRefresh(self.Ptr)
        return ret
    ...
    def BackgroundRefresh(self, value:bool):
        ...
        GetDllLibXls().ExternalConnection_set_BackgroundRefresh(self.Ptr, value)
    ...
    def RefreshedVersion(self)->str:
        ...
        GetDllLibXls().ExternalConnection_get_RefreshedVersion.restype=c_wchar_p
        ret = GetDllLibXls().ExternalConnection_get_RefreshedVersion(self.Ptr)
        return ret
    ...
    def RefreshedVersion(self, value:str):
        ...
        GetDllLibXls().ExternalConnection_set_RefreshedVersion(self.Ptr, value)
    ...
    def SaveData(self)->bool:
        ...
        ret = GetDllLibXls().ExternalConnection_get_SaveData(self.Ptr)
        return ret

    @SaveData.setter
    def SaveData(self, value:bool):
        GetDllLibXls().ExternalConnection_set_SaveData.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ExternalConnection_set_SaveData(self.Ptr, value)
    ...
    def OdcFile(self)->str:
        ...
        GetDllLibXls().ExternalConnection_get_OdcFile.restype=c_wchar_p
        ret = GetDllLibXls().ExternalConnection_get_OdcFile(self.Ptr)
        return ret
    ...
    def OdcFile(self, value:str):
        ...
        GetDllLibXls().ExternalConnection_set_OdcFile(self.Ptr, value)
    ...
    def KeepAlive(self)->bool:
        ...
        ret = GetDllLibXls().ExternalConnection_get_KeepAlive(self.Ptr)
        return ret

    @KeepAlive.setter
    def KeepAlive(self, value:bool):
        GetDllLibXls().ExternalConnection_set_KeepAlive.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ExternalConnection_set_KeepAlive(self.Ptr, value)
    ...
    def OnlyUseConnectionFile(self)->bool:
        ...
        ret = GetDllLibXls().ExternalConnection_get_OnlyUseConnectionFile(self.Ptr)
        return ret
    ...
    def OnlyUseConnectionFile(self, value:bool):
        ...
        GetDllLibXls().ExternalConnection_set_OnlyUseConnectionFile(self.Ptr, value)
