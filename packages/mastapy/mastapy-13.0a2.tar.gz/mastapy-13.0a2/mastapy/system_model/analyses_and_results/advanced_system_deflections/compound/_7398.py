...
class ConceptGearMeshCompoundAdvancedSystemDeflection(_7427.GearMeshCompoundAdvancedSystemDeflection):
    """ConceptGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7265.ConceptGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7265.ConceptGearMeshAdvancedSystemDeflection]':
