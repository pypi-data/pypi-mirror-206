...
class ConceptCouplingCompoundPowerFlow(_4179.CouplingCompoundPowerFlow):
    """ConceptCouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4037.ConceptCouplingPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4037.ConceptCouplingPowerFlow]':
