...
class BevelDifferentialSunGearSteadyStateSynchronousResponseAtASpeed(_3496.BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed):
    """BevelDifferentialSunGearSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_BevelDifferentialSunGearSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'BevelDifferentialSunGearSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def bevel_differential_sun_gear_steady_state_synchronous_response_at_a_speed(self) -> 'BevelDifferentialSunGearSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialSunGearSteadyStateSynchronousResponseAtASpeed._Cast_BevelDifferentialSunGearSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_BevelDifferentialSunGearSteadyStateSynchronousResponseAtASpeed(self)
