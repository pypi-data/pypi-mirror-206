...
class ParetoOptimisationOutput(_1543.ParetoOptimistaionVariable):
    """ParetoOptimisationOutput
    ...
    class _Cast_ParetoOptimisationOutput:
        ...
        def __init__(self, parent: 'ParetoOptimisationOutput'):
            self._parent = parent
        ...
        @property
        def pareto_optimisation_output(self) -> 'ParetoOptimisationOutput':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ParetoOptimisationOutput._Cast_ParetoOptimisationOutput':
