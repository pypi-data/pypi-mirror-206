...
class ConceptCouplingHalfSteadyStateSynchronousResponseAtASpeed(_3521.CouplingHalfSteadyStateSynchronousResponseAtASpeed):
    """ConceptCouplingHalfSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ConceptCouplingHalfSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ConceptCouplingHalfSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def concept_coupling_half_steady_state_synchronous_response_at_a_speed(self) -> 'ConceptCouplingHalfSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHalfSteadyStateSynchronousResponseAtASpeed._Cast_ConceptCouplingHalfSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_ConceptCouplingHalfSteadyStateSynchronousResponseAtASpeed(self)
