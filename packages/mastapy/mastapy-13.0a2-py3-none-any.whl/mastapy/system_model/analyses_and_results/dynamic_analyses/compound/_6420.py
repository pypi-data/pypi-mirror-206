...
class CylindricalGearCompoundDynamicAnalysis(_6431.GearCompoundDynamicAnalysis):
    """CylindricalGearCompoundDynamicAnalysis
    ...
    class _Cast_CylindricalGearCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'CylindricalGearCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_compound_dynamic_analysis(self) -> 'CylindricalGearCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6290.CylindricalGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6290.CylindricalGearDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearCompoundDynamicAnalysis._Cast_CylindricalGearCompoundDynamicAnalysis':
