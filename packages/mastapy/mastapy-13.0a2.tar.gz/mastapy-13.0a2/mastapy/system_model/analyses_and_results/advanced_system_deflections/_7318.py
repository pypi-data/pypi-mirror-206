...
class PartToPartShearCouplingAdvancedSystemDeflection(_7273.CouplingAdvancedSystemDeflection):
    """PartToPartShearCouplingAdvancedSystemDeflection
    ...
    class _Cast_PartToPartShearCouplingAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_advanced_system_deflection(self) -> 'PartToPartShearCouplingAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingAdvancedSystemDeflection._Cast_PartToPartShearCouplingAdvancedSystemDeflection':
