...
class ComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_7182.PartCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_ComponentCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'ComponentCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def component_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'ComponentCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6998.ComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6998.ComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'ComponentCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_ComponentCompoundAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_ComponentCompoundAdvancedTimeSteppingAnalysisForModulation(self)
