...
from mastapy.system_model.analyses_and_results.modal_analyses import _4663, _4662, _4565
...
class StraightBevelDiffGearSetModalAnalysis(_4565.BevelGearSetModalAnalysis):
    """StraightBevelDiffGearSetModalAnalysis
    ...
    class _Cast_StraightBevelDiffGearSetModalAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearSetModalAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_set_modal_analysis(self) -> 'StraightBevelDiffGearSetModalAnalysis':
            return self._parent
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis(self) -> 'List[_4663.StraightBevelDiffGearModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_modal_analysis(self) -> 'List[_4662.StraightBevelDiffGearMeshModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearSetModalAnalysis._Cast_StraightBevelDiffGearSetModalAnalysis':
