...
def compare_pdf_files(
    ...
    for i in range(len(filenames) - 1):
        for j in range(i + 1, len(filenames)):
            ...
            page_analysis_sec_iter = time.time() - page_analysis_sec_t0
            page_analysis_sec += page_analysis_sec_iter
            ...
            digit_analysis_sec_iter = time.time() - digit_analysis_sec_t0
            digit_analysis_sec += digit_analysis_sec_iter
            ...
            text_analysis_sec_iter = time.time() - text_analysis_sec_t0
            text_analysis_sec += text_analysis_sec_iter

            # Compare images
            image_analysis_sec_t0 = time.time()
            if "images" in methods:
                execute_images_method(a, a_new, b, b_new, suspicious_pairs, verbose)
            image_analysis_sec_iter = time.time() - image_analysis_sec_t0
            image_analysis_sec += image_analysis_sec_iter

            # print("%s,%s,%f,%f,%f,%f\n" % (a["filename"], b["filename"], page_analysis_sec_iter, digit_analysis_sec_iter, text_analysis_sec_iter, image_analysis_sec_iter))
