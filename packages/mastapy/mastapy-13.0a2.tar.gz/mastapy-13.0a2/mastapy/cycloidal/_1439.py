...
class ContactSpecification(_0.APIBase):
    ...
    class _Cast_ContactSpecification:
        ...
        def __init__(self, parent: 'ContactSpecification'):
            self._parent = parent

        @property
        def contact_specification(self) -> 'ContactSpecification':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ContactSpecification._Cast_ContactSpecification':
