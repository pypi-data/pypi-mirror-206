...
class ScanScreen(nsf.frameworks.qt_app.ModuleScreen):
    ...
    def do_setup_screen(self, module: module.ScanModule):
        ...
        self.check_show_power_spec = QtWidgets.QCheckBox("Show Spectral density")
    ...
    def update_plot(self): 
        ...
        if current_data.stream.get_stream_length() > 1:
            ...
            spec = nsf.sci_math.calc_fft(current_data.stream.get_channel(0), samplerate=samplefrq, spectral_density=calc_power_spec, compress=compress_spec)
