...
class IBeamScan(libBornAgainBase.ICloneable, libBornAgainParam.INode):
    ...
    def setAnalyzer(self, direction, efficiency, total_transmission):
        r"""setAnalyzer(IBeamScan self, R3 direction, double efficiency, double total_transmission)"""
        return _libBornAgainSim.IBeamScan_setAnalyzer(self, direction, efficiency, total_transmission)

    def setFootprint(self, footprint):
        r"""setFootprint(IBeamScan self, IFootprintFactor const * footprint)"""
