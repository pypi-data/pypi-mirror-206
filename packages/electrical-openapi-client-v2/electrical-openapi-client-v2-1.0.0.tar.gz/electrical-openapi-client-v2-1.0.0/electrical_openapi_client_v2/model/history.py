...
class History(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["pk", "datetime_create", "title", "quantity", "price", "price_sale", "score", "count_comments", "count_likes", "count_stars_all", "count_stars_1", "count_stars_2", "count_stars_3", "count_stars_4", "count_stars_5", "count_how_much_buy", "count_questions", "count_photo", "category", "category_url", "brand", "brand_url", "day_to_delivery", "sku", "url", "canonical_url", "img_url", "description", "params", "seller", "seller_url", "source_url", "urls_other_products_on_the_page", "worker", "task", "apartment_area", "apartment_completion_quarter", "apartment_completion_year", "apartment_floor", "apartment_floors_total", "apartment_ceilingheight", "apartment_room", "apartment_ppm", "apartment_address", "apartment_location_lat", "apartment_location_lon", ], str]):
