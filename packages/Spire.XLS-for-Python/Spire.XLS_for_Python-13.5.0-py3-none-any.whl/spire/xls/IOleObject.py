...
<value>The location.</value>
        ...
        intPtr = GetDllLibXls().IOleObject_get_Location(self.Ptr)
    ...
    def Location(self, value:'IXLSRange'):
        ...
        GetDllLibXls().IOleObject_set_Location(self.Ptr, value.Ptr)
...
<value>The size.</value>
        ...
        intPtr = GetDllLibXls().IOleObject_get_Size(self.Ptr)
    ...
    def Size(self, value:'Size'):
        ...
        GetDllLibXls().IOleObject_set_Size(self.Ptr, value.Ptr)
...
<value>The picture.</value>
        ...
        intPtr = GetDllLibXls().IOleObject_get_Picture(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().IOleObject_get_Shape(self.Ptr)
...
<value>
  <c>true</c> if [display as icon]; otherwise, <c>false</c>.</value>
    ...
    <summary>
        ...
        ret = GetDllLibXls().IOleObject_get_ObjectType(self.Ptr)
    ...
    def ObjectType(self, value:'OleObjectType'):
        ...
        GetDllLibXls().IOleObject_set_ObjectType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtrArray = GetDllLibXls().IOleObject_get_OleData(self.Ptr)
...
#        GetDllLibXls().IOleObject_set_OleData(self.Ptr, vArray, vCount)
...
#        intPtr = GetDllLibXls().IOleObject_get_OleObjectGuid(self.Ptr)
