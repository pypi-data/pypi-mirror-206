...
class LoadedSelfAligningBallBearingResults(_1987.LoadedBallBearingResults):
    """LoadedSelfAligningBallBearingResults
    ...
    class _Cast_LoadedSelfAligningBallBearingResults:
        ...
        def __init__(self, parent: 'LoadedSelfAligningBallBearingResults'):
            self._parent = parent
        ...
        @property
        def loaded_self_aligning_ball_bearing_results(self) -> 'LoadedSelfAligningBallBearingResults':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'LoadedSelfAligningBallBearingResults._Cast_LoadedSelfAligningBallBearingResults':
