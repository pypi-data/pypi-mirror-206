...
class XlsShapeFill (  XlsObject, IShapeFill) :
    ...
    def GradientStops(self)->'GradientStops':
        ...
        intPtr = GetDllLibXls().XlsShapeFill_get_GradientStops(self.Ptr)
    ...
    def FillType(self)->'ShapeFillType':
        ...
        ret = GetDllLibXls().XlsShapeFill_get_FillType(self.Ptr)
    ...
    def FillType(self, value:'ShapeFillType'):
        ...
        GetDllLibXls().XlsShapeFill_set_FillType(self.Ptr, value.value)
    ...
    def GradientStyle(self)->'GradientStyleType':
        ...
        ret = GetDllLibXls().XlsShapeFill_get_GradientStyle(self.Ptr)
    ...
    def GradientStyle(self, value:'GradientStyleType'):
        ...
        GetDllLibXls().XlsShapeFill_set_GradientStyle(self.Ptr, value.value)
    ...
    def GradientVariant(self)->'GradientVariantsType':
        ...
        ret = GetDllLibXls().XlsShapeFill_get_GradientVariant(self.Ptr)
    ...
    def GradientVariant(self, value:'GradientVariantsType'):
        ...
        GetDllLibXls().XlsShapeFill_set_GradientVariant(self.Ptr, value.value)
    ...
    def Transparency(self)->float:
        ...
        ret = GetDllLibXls().XlsShapeFill_get_Transparency(self.Ptr)
        return ret

    @Transparency.setter
    def Transparency(self, value:float):
        GetDllLibXls().XlsShapeFill_set_Transparency.argtypes=[c_void_p, c_double]
        GetDllLibXls().XlsShapeFill_set_Transparency(self.Ptr, value)
    ...
    def TransparencyFrom(self)->float:
        ...
        ret = GetDllLibXls().XlsShapeFill_get_TransparencyFrom(self.Ptr)
        return ret
    ...
    def TransparencyFrom(self, value:float):
        ...
        GetDllLibXls().XlsShapeFill_set_TransparencyFrom(self.Ptr, value)
    ...
    def TransparencyTo(self)->float:
        ...
        ret = GetDllLibXls().XlsShapeFill_get_TransparencyTo(self.Ptr)
        return ret
    ...
    def TransparencyTo(self, value:float):
        ...
        GetDllLibXls().XlsShapeFill_set_TransparencyTo(self.Ptr, value)
    ...
    def Visible(self)->bool:
        ...
        ret = GetDllLibXls().XlsShapeFill_get_Visible(self.Ptr)
        return ret

    @Visible.setter
    def Visible(self, value:bool):
        GetDllLibXls().XlsShapeFill_set_Visible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShapeFill_set_Visible(self.Ptr, value)
    ...
    def BackKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsShapeFill_get_BackKnownColor(self.Ptr)
    ...
    def BackKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsShapeFill_set_BackKnownColor(self.Ptr, value.value)
    ...
    def ForeKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsShapeFill_get_ForeKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def ForeKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsShapeFill_set_ForeKnownColor(self.Ptr, value.value)
    ...
    def BackColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsShapeFill_get_BackColor(self.Ptr)
    ...
    def BackColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsShapeFill_set_BackColor(self.Ptr, value.Ptr)
    ...
    def ForeColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsShapeFill_get_ForeColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def ForeColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsShapeFill_set_ForeColor(self.Ptr, value.Ptr)
    ...
    def BackColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsShapeFill_get_BackColorObject(self.Ptr)
    ...
    def ForeColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsShapeFill_get_ForeColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def GradientColorType(self)->'GradientColorType':
        ...
        ret = GetDllLibXls().XlsShapeFill_get_GradientColorType(self.Ptr)
    ...
    def GradientColorType(self, value:'GradientColorType'):
        ...
        GetDllLibXls().XlsShapeFill_set_GradientColorType(self.Ptr, value.value)
    ...
    def Texture(self)->'GradientTextureType':
        ...
        ret = GetDllLibXls().XlsShapeFill_get_Texture(self.Ptr)
    ...
    def Texture(self, value:'GradientTextureType'):
        ...
        GetDllLibXls().XlsShapeFill_set_Texture(self.Ptr, value.value)
    ...
    def Pattern(self)->'GradientPatternType':
        ...
        ret = GetDllLibXls().XlsShapeFill_get_Pattern(self.Ptr)
    ...
    def Pattern(self, value:'GradientPatternType'):
        ...
        GetDllLibXls().XlsShapeFill_set_Pattern(self.Ptr, value.value)
    ...
    def PresetGradientType(self)->'GradientPresetType':
        ...
        ret = GetDllLibXls().XlsShapeFill_get_PresetGradientType(self.Ptr)
    ...
    def PresetGradientType(self, value:'GradientPresetType'):
        ...
        GetDllLibXls().XlsShapeFill_set_PresetGradientType(self.Ptr, value.value)
    ...
    def Picture(self)->'Image':
        ...
        intPtr = GetDllLibXls().XlsShapeFill_get_Picture(self.Ptr)
    ...
    def PictureName(self)->str:
        ...
        GetDllLibXls().XlsShapeFill_get_PictureName.restype=c_wchar_p
        ret = GetDllLibXls().XlsShapeFill_get_PictureName(self.Ptr)
        return ret
    ...
    def GradientDegree(self)->float:
        ...
        ret = GetDllLibXls().XlsShapeFill_get_GradientDegree(self.Ptr)
        return ret
    ...
    def GradientDegree(self, value:float):
        ...
        GetDllLibXls().XlsShapeFill_set_GradientDegree(self.Ptr, value)
    ...
    def IsGradientSupported(self)->bool:
        ...
        ret = GetDllLibXls().XlsShapeFill_get_IsGradientSupported(self.Ptr)
        return ret
    ...
    def IsGradientSupported(self, value:bool):
        ...
        GetDllLibXls().XlsShapeFill_set_IsGradientSupported(self.Ptr, value)
    ...
    def Tile(self)->bool:
        ...
        ret = GetDllLibXls().XlsShapeFill_get_Tile(self.Ptr)
        return ret

    @Tile.setter
    def Tile(self, value:bool):
        GetDllLibXls().XlsShapeFill_set_Tile.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsShapeFill_set_Tile(self.Ptr, value)
    ...
    def PicStretch(self)->'PicStretch':
        ...
        intPtr = GetDllLibXls().XlsShapeFill_get_PicStretch(self.Ptr)
    ...
    def PicStretch(self, value:'PicStretch'):
        ...
        GetDllLibXls().XlsShapeFill_set_PicStretch(self.Ptr, value.Ptr)
    ...
    def PicTile(self)->'PicTile':
        ...
        intPtr = GetDllLibXls().XlsShapeFill_get_PicTile(self.Ptr)
    ...
    def PicTile(self, value:'PicTile'):
        ...
        GetDllLibXls().XlsShapeFill_set_PicTile(self.Ptr, value.Ptr)
    ...
    def IsDoubled(gradientStyle:'GradientStyleType',variant:'GradientVariantsType')->bool:
        ...
        ret = GetDllLibXls().XlsShapeFill_IsDoubled( enumgradientStyle,enumvariant)
        return ret
    ...
    def IsInverted(gradientStyle:'GradientStyleType',variant:'GradientVariantsType')->bool:
        ...
        ret = GetDllLibXls().XlsShapeFill_IsInverted( enumgradientStyle,enumvariant)
        return ret
    ...
    def CompareTo(self ,twin:'IGradient')->int:
        ...
        ret = GetDllLibXls().XlsShapeFill_CompareTo(self.Ptr, intPtrtwin)
        return ret
    ...
    def CustomPicture(self ,path:str):
        ...
        GetDllLibXls().XlsShapeFill_CustomPicture(self.Ptr, path)

    @dispatch

    def CustomPicture(self ,im:Image,name:str):
        """
        ...
        GetDllLibXls().XlsShapeFill_CustomPictureIN(self.Ptr, intPtrim,name)
    ...
    def CustomTexture(self ,path:str):
        ...
        GetDllLibXls().XlsShapeFill_CustomTexture(self.Ptr, path)

    @dispatch

    def CustomTexture(self ,im:Image,name:str):
        """
        ...
        GetDllLibXls().XlsShapeFill_CustomTextureIN(self.Ptr, intPtrim,name)
    ...
    def Patterned(self ,pattern:'GradientPatternType'):
        ...
        GetDllLibXls().XlsShapeFill_Patterned(self.Ptr, enumpattern)
    ...
    def PresetGradient(self ,grad:GradientPresetType):
        ...
        GetDllLibXls().XlsShapeFill_PresetGradient(self.Ptr, enumgrad)
    ...
    def PresetGradient(self ,grad:GradientPresetType,shadStyle:GradientStyleType):
        ...
        GetDllLibXls().XlsShapeFill_PresetGradientGS(self.Ptr, enumgrad,enumshadStyle)
    ...
    def PresetGradient(self ,grad:GradientPresetType,shadStyle:GradientStyleType,shadVar:GradientVariantsType):
        ...
        GetDllLibXls().XlsShapeFill_PresetGradientGSS(self.Ptr, enumgrad,enumshadStyle,enumshadVar)
    ...
    def PresetTextured(self ,texture:'GradientTextureType'):
        ...
        GetDllLibXls().XlsShapeFill_PresetTextured(self.Ptr, enumtexture)
    ...
    def TwoColorGradient(self):
        ...
        GetDllLibXls().XlsShapeFill_TwoColorGradient(self.Ptr)
    ...
    def TwoColorGradient(self ,style:GradientStyleType):
        ...
        GetDllLibXls().XlsShapeFill_TwoColorGradientS(self.Ptr, enumstyle)
    ...
    def TwoColorGradient(self ,style:GradientStyleType,variant:GradientVariantsType):
        ...
        GetDllLibXls().XlsShapeFill_TwoColorGradientSV(self.Ptr, enumstyle,enumvariant)
    ...
    def OneColorGradient(self):
        ...
        GetDllLibXls().XlsShapeFill_OneColorGradient(self.Ptr)
    ...
    def OneColorGradient(self ,style:GradientStyleType):
        ...
        GetDllLibXls().XlsShapeFill_OneColorGradientS(self.Ptr, enumstyle)
    ...
    def OneColorGradient(self ,style:GradientStyleType,variant:GradientVariantsType):
        ...
        GetDllLibXls().XlsShapeFill_OneColorGradientSV(self.Ptr, enumstyle,enumvariant)
    ...
    def Solid(self):
        ...
        GetDllLibXls().XlsShapeFill_Solid(self.Ptr)
    ...
    def Clone(self ,parent:'SpireObject')->'XlsShapeFill':
        ...
        intPtr = GetDllLibXls().XlsShapeFill_Clone(self.Ptr, intPtrparent)
