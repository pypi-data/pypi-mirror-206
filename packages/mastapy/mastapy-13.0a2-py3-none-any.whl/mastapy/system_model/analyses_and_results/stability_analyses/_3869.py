...
from mastapy.system_model.analyses_and_results.stability_analyses import _3870, _3868, _3802
...
class WormGearSetStabilityAnalysis(_3802.GearSetStabilityAnalysis):
    """WormGearSetStabilityAnalysis
    ...
    @property
    def worm_gears_stability_analysis(self) -> 'List[_3870.WormGearStabilityAnalysis]':
    ...
    @property
    def worm_meshes_stability_analysis(self) -> 'List[_3868.WormGearMeshStabilityAnalysis]':
