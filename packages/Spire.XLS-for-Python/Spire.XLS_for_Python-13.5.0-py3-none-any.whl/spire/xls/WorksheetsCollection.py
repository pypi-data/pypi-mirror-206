...
class WorksheetsCollection (  XlsWorksheetsCollection) :
    ...
    <returns>Added worksheet.</returns>
        ...
        intPtr = GetDllLibXls().WorksheetsCollection_Add(self.Ptr, name)
    ...
    <returns>Added worksheet.</returns>
        ...
        intPtr = GetDllLibXls().WorksheetsCollection_AddCopy(self.Ptr, sheetIndex)
        ret = None if intPtr==None else Worksheet(intPtr)
        return ret
    ...
    <returns>Added worksheet.</returns>
        ...
        intPtr = GetDllLibXls().WorksheetsCollection_AddCopySheet(self.Ptr, intPtrsheet)
        ret = None if intPtr==None else Worksheet(intPtr)
        return ret
    ...
    <param name="worksheets">Source worksheets collection.</param>
        ...
        GetDllLibXls().WorksheetsCollection_AddCopySheets(self.Ptr, intPtrsheets)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().WorksheetsCollection_Create(self.Ptr, name)
        ret = None if intPtr==None else Worksheet(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().WorksheetsCollection_Create1(self.Ptr)
        ret = None if intPtr==None else Worksheet(intPtr)
        return ret
...
#        intPtr = GetDllLibXls().WorksheetsCollection_FindAllNumber(self.Ptr, doubleValue,formulaValue)
...
#        intPtr = GetDllLibXls().WorksheetsCollection_FindAllString(self.Ptr, stringValue,formula,formulaValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().WorksheetsCollection_FindAllDateTime(self.Ptr, intPtrdateTimeValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().WorksheetsCollection_FindAllTimeSpan(self.Ptr, intPtrtimeSpanValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().WorksheetsCollection_FindAllBool(self.Ptr, boolValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
    ...
    <returns>Found range</returns>
        ...
        intPtr = GetDllLibXls().WorksheetsCollection_FindBool(self.Ptr, boolValue)
    ...
    <returns>Found range</returns>
        ...
        intPtr = GetDllLibXls().WorksheetsCollection_FindNumber(self.Ptr, doubleValue,formulaValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range</returns>
        ...
        intPtr = GetDllLibXls().WorksheetsCollection_FindString(self.Ptr, stringValue,formula,formulaValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range</returns>
        ...
        intPtr = GetDllLibXls().WorksheetsCollection_FindDateTime(self.Ptr, intPtrdateTimeValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range.</returns>
        ...
        intPtr = GetDllLibXls().WorksheetsCollection_FindTimeSpan(self.Ptr, intPtrtimeSpanValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <param name="sheet">Worksheet object.</param>
        ...
        GetDllLibXls().WorksheetsCollection_Remove(self.Ptr, intPtrsheet)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().WorksheetsCollection_get_Item(self.Ptr, Index)
        ret = None if intPtr==None else Worksheet(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().WorksheetsCollection_get_ItemN(self.Ptr, sheetName)
        ret = None if intPtr==None else Worksheet(intPtr)
        return ret
