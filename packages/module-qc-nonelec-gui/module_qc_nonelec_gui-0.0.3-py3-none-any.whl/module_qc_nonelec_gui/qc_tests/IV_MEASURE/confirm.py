...
class ConfirmWindow(QWidget):
    ...
    def layout_ModuleQC(self):
        ...
        self.add_info(
            Form_layout,
            "Comment :",
            self.parent.testRun["results"]["comment"],
        )
        ...
        for v, i, sigmaI in zip(
            self.parent.testRun["results"]["IV_ARRAY"]["voltage"],
            self.parent.testRun["results"]["IV_ARRAY"]["current"],
            self.parent.testRun["results"]["IV_ARRAY"]["sigma current"],
        ):
            current.append(i)
            voltage.append(v)
