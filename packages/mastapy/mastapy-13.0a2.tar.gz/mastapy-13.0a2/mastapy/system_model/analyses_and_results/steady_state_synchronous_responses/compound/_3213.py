...
class TorqueConverterConnectionCompoundSteadyStateSynchronousResponse(_3133.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """TorqueConverterConnectionCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_TorqueConverterConnectionCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'TorqueConverterConnectionCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def torque_converter_connection_compound_steady_state_synchronous_response(self) -> 'TorqueConverterConnectionCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3083.TorqueConverterConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3083.TorqueConverterConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterConnectionCompoundSteadyStateSynchronousResponse._Cast_TorqueConverterConnectionCompoundSteadyStateSynchronousResponse':
        return self._Cast_TorqueConverterConnectionCompoundSteadyStateSynchronousResponse(self)
