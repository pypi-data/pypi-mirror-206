...
class FolderDestinationReference(DestinationReference):
    ...
    def from_json(cls, data: dict) -> FolderDestinationReference:
        ...
        try:
            ...
            return FolderDestinationReference(
                ...
                saveMode=(
                    lambda v: v and BatchOutputMode.from_json(v)
                )(
                    data.get("saveMode", None)
                ),
                options=(
                    lambda v: v and [Attribute.from_json(v) for v in v]
                )(
    ...
    def to_json(self) -> dict:
        ...
        return {
            ...
            "saveMode": (lambda v: v and v.to_json())(self.saveMode),
            "options": (lambda v: v and [v.to_json() for v in v])(self.options)
        }
