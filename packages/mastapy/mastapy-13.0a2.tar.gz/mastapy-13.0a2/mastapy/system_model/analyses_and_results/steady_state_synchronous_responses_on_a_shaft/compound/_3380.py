...
class ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft(_3391.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    """ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def concept_coupling_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3252.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3252.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft._Cast_ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft(self)
