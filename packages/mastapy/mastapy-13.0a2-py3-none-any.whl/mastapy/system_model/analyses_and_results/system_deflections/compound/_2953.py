...
class UnbalancedMassCompoundSystemDeflection(_2954.VirtualComponentCompoundSystemDeflection):
    """UnbalancedMassCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2813.UnbalancedMassSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2813.UnbalancedMassSystemDeflection]':
