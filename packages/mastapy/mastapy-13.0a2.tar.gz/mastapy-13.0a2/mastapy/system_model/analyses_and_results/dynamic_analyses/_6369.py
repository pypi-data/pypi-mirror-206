...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6367, _6368, _6304
...
class WormGearSetDynamicAnalysis(_6304.GearSetDynamicAnalysis):
    """WormGearSetDynamicAnalysis
    ...
    class _Cast_WormGearSetDynamicAnalysis:
        ...
        def __init__(self, parent: 'WormGearSetDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def worm_gear_set_dynamic_analysis(self) -> 'WormGearSetDynamicAnalysis':
            return self._parent
    ...
    @property
    def worm_gears_dynamic_analysis(self) -> 'List[_6367.WormGearDynamicAnalysis]':
    ...
    @property
    def worm_meshes_dynamic_analysis(self) -> 'List[_6368.WormGearMeshDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'WormGearSetDynamicAnalysis._Cast_WormGearSetDynamicAnalysis':
