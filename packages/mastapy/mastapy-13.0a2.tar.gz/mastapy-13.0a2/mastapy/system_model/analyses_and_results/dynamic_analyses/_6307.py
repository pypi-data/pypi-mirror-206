...
class HypoidGearMeshDynamicAnalysis(_6248.AGMAGleasonConicalGearMeshDynamicAnalysis):
    """HypoidGearMeshDynamicAnalysis
    ...
    class _Cast_HypoidGearMeshDynamicAnalysis:
        ...
        def __init__(self, parent: 'HypoidGearMeshDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_mesh_dynamic_analysis(self) -> 'HypoidGearMeshDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidGearMeshDynamicAnalysis._Cast_HypoidGearMeshDynamicAnalysis':
