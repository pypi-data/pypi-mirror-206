...
class PointLoadModalAnalysis(_4679.VirtualComponentModalAnalysis):
    """PointLoadModalAnalysis
    ...
    class _Cast_PointLoadModalAnalysis:
        ...
        def __init__(self, parent: 'PointLoadModalAnalysis'):
            self._parent = parent
        ...
        @property
        def point_load_modal_analysis(self) -> 'PointLoadModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PointLoadModalAnalysis._Cast_PointLoadModalAnalysis':
