...
class SharekhanConnect(object):
    ...
    userType = "USER"
    sourceID = "WEB"
    def __init__(self, api_key=None,state=None, vendor_key=None,access_token=None, refresh_token=None, feed_token=None, userId=None, root=None,
    ...
    def get_access_token(self, apiKey, requestToken, userId,versionId=None):
    ...
    def exchange(self,exchange,customerId,orderId):
        exchangeResponse=self._getRequest("api.reports.exchange",{"exchange":exchange,"customerId":customerId,"orderId":orderId})
        return exchangeResponse

    def exchangetrades(self,exchange,customerId,orderId):
        exchangetradesResponse=self._getRequest("api.reports.exchange.trades",{"exchange":exchange,"customerId":customerId,"orderId":orderId})
    ...
    def historicaldata(self,exchange,scripcode,interval):
        historicaldataResponse = self._getRequest("api.historical.data", {"exchange": exchange,"scripcode": scripcode,"interval": interval})
