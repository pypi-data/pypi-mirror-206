...
from .base import CMProperty
from .functions import is_standalone, convert_bytes
...
class CMObjectsInSceneProperty(CMProperty):
    def __init__(self):
        super().__init__()
        # 获取场景中基于ls命令的属性
...
class CMDetailProperty(CMProperty):
    ...
    def __init__(self, display_name: str = None, value=None):
        super().__init__()
