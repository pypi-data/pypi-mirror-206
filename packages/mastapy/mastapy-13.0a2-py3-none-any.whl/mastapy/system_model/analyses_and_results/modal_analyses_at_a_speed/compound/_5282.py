...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5280, _5281, _5224
...
class HypoidGearSetCompoundModalAnalysisAtASpeed(_5224.AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed):
    """HypoidGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5153.HypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5280.HypoidGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5281.HypoidGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5153.HypoidGearSetModalAnalysisAtASpeed]':
