...
class MaximumTorqueResultsPoints(_0.APIBase):
    ...
    class _Cast_MaximumTorqueResultsPoints:
        ...
        def __init__(self, parent: 'MaximumTorqueResultsPoints'):
            self._parent = parent

        @property
        def maximum_torque_results_points(self) -> 'MaximumTorqueResultsPoints':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MaximumTorqueResultsPoints._Cast_MaximumTorqueResultsPoints':
