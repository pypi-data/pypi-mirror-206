...
class RollingRingAdvancedTimeSteppingAnalysisForModulation(_7012.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_RollingRingAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'RollingRingAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def rolling_ring_advanced_time_stepping_analysis_for_modulation(self) -> 'RollingRingAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingAdvancedTimeSteppingAnalysisForModulation._Cast_RollingRingAdvancedTimeSteppingAnalysisForModulation':
