...
@LastEditTime: 2022-10-17 17:40:25
...
class SpecialGoodsListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        if is_top_data == False:
            ...
            invoke_result_data = goods_base_model.get_special_goods_list_for_top(app_id, goods_id, access_token, app_key, app_secret, is_log, page_index, page_size)
