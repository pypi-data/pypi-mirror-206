...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4268, _4269, _4160
...
class ZerolBevelGearSetCompoundPowerFlow(_4160.BevelGearSetCompoundPowerFlow):
    """ZerolBevelGearSetCompoundPowerFlow
    ...
    class _Cast_ZerolBevelGearSetCompoundPowerFlow:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_compound_power_flow(self) -> 'ZerolBevelGearSetCompoundPowerFlow':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4141.ZerolBevelGearSetPowerFlow]':
    ...
    @property
    def zerol_bevel_gears_compound_power_flow(self) -> 'List[_4268.ZerolBevelGearCompoundPowerFlow]':
    ...
    @property
    def zerol_bevel_meshes_compound_power_flow(self) -> 'List[_4269.ZerolBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4141.ZerolBevelGearSetPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetCompoundPowerFlow._Cast_ZerolBevelGearSetCompoundPowerFlow':
