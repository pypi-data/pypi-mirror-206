...
class OilLevelSpecification(_0.APIBase):
    ...
    class _Cast_OilLevelSpecification:
        ...
        def __init__(self, parent: 'OilLevelSpecification'):
            self._parent = parent

        @property
        def oil_level_specification(self) -> 'OilLevelSpecification':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'OilLevelSpecification._Cast_OilLevelSpecification':
