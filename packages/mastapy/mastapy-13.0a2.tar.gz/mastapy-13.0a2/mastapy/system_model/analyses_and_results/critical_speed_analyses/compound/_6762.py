...
class WormGearCompoundCriticalSpeedAnalysis(_6697.GearCompoundCriticalSpeedAnalysis):
    """WormGearCompoundCriticalSpeedAnalysis
    ...
    class _Cast_WormGearCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'WormGearCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def worm_gear_compound_critical_speed_analysis(self) -> 'WormGearCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6633.WormGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6633.WormGearCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'WormGearCompoundCriticalSpeedAnalysis._Cast_WormGearCompoundCriticalSpeedAnalysis':
