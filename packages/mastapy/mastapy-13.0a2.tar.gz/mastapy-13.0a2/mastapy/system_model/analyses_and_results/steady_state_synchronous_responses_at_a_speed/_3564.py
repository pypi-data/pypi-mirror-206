...
class PartToPartShearCouplingHalfSteadyStateSynchronousResponseAtASpeed(_3521.CouplingHalfSteadyStateSynchronousResponseAtASpeed):
    """PartToPartShearCouplingHalfSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_PartToPartShearCouplingHalfSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingHalfSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_half_steady_state_synchronous_response_at_a_speed(self) -> 'PartToPartShearCouplingHalfSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingHalfSteadyStateSynchronousResponseAtASpeed._Cast_PartToPartShearCouplingHalfSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_PartToPartShearCouplingHalfSteadyStateSynchronousResponseAtASpeed(self)
