...
class StraightBevelDiffGearMeshSteadyStateSynchronousResponse(_2978.BevelGearMeshSteadyStateSynchronousResponse):
    """StraightBevelDiffGearMeshSteadyStateSynchronousResponse
    ...
    class _Cast_StraightBevelDiffGearMeshSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearMeshSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_mesh_steady_state_synchronous_response(self) -> 'StraightBevelDiffGearMeshSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearMeshSteadyStateSynchronousResponse._Cast_StraightBevelDiffGearMeshSteadyStateSynchronousResponse':
