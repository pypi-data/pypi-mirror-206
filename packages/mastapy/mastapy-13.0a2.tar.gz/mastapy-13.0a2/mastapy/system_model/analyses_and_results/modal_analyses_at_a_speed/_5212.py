...
class WormGearMeshModalAnalysisAtASpeed(_5147.GearMeshModalAnalysisAtASpeed):
    """WormGearMeshModalAnalysisAtASpeed
    ...
    class _Cast_WormGearMeshModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'WormGearMeshModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def worm_gear_mesh_modal_analysis_at_a_speed(self) -> 'WormGearMeshModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearMeshModalAnalysisAtASpeed._Cast_WormGearMeshModalAnalysisAtASpeed':
