...
class AbstractAssemblyCompoundPowerFlow(_4221.PartCompoundPowerFlow):
    """AbstractAssemblyCompoundPowerFlow
    ...
    class _Cast_AbstractAssemblyCompoundPowerFlow:
        ...
        def __init__(self, parent: 'AbstractAssemblyCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def abstract_assembly_compound_power_flow(self) -> 'AbstractAssemblyCompoundPowerFlow':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4009.AbstractAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4009.AbstractAssemblyPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'AbstractAssemblyCompoundPowerFlow._Cast_AbstractAssemblyCompoundPowerFlow':
