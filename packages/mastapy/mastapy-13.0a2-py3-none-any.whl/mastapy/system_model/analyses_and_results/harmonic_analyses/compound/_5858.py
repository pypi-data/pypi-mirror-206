...
class BevelDifferentialGearMeshCompoundHarmonicAnalysis(_5863.BevelGearMeshCompoundHarmonicAnalysis):
    """BevelDifferentialGearMeshCompoundHarmonicAnalysis
    ...
    class _Cast_BevelDifferentialGearMeshCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_compound_harmonic_analysis(self) -> 'BevelDifferentialGearMeshCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5661.BevelDifferentialGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5661.BevelDifferentialGearMeshHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshCompoundHarmonicAnalysis._Cast_BevelDifferentialGearMeshCompoundHarmonicAnalysis':
