...
class CVTBeltConnectionCompoundCriticalSpeedAnalysis(_6648.BeltConnectionCompoundCriticalSpeedAnalysis):
    """CVTBeltConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6550.CVTBeltConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6550.CVTBeltConnectionCriticalSpeedAnalysis]':
