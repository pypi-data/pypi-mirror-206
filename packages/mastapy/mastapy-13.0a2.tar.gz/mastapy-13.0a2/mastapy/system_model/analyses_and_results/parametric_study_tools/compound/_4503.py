...
class PlanetCarrierCompoundParametricStudyTool(_4495.MountableComponentCompoundParametricStudyTool):
    """PlanetCarrierCompoundParametricStudyTool
    ...
    class _Cast_PlanetCarrierCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'PlanetCarrierCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def planet_carrier_compound_parametric_study_tool(self) -> 'PlanetCarrierCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4374.PlanetCarrierParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4374.PlanetCarrierParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierCompoundParametricStudyTool._Cast_PlanetCarrierCompoundParametricStudyTool':
