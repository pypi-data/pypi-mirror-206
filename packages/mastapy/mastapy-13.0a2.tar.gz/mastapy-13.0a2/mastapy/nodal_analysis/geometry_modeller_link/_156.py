...
class GeometryModellerDimensions(_0.APIBase):
    ...
    class _Cast_GeometryModellerDimensions:
        ...
        def __init__(self, parent: 'GeometryModellerDimensions'):
            self._parent = parent

        @property
        def geometry_modeller_dimensions(self) -> 'GeometryModellerDimensions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GeometryModellerDimensions._Cast_GeometryModellerDimensions':
        return self._Cast_GeometryModellerDimensions(self)
