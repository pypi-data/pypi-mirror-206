...
class SuitableCutterSetup(_0.APIBase):
    ...
    class _Cast_SuitableCutterSetup:
        ...
        def __init__(self, parent: 'SuitableCutterSetup'):
            self._parent = parent

        @property
        def suitable_cutter_setup(self) -> 'SuitableCutterSetup':
            return self._parent
    ...
    @property
    def tool_clearances(self) -> '_736.ManufacturingOperationConstraints':
    ...
    @property
    def cast_to(self) -> 'SuitableCutterSetup._Cast_SuitableCutterSetup':
