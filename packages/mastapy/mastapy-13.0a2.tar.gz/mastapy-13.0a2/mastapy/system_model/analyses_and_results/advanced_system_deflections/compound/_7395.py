...
class ConceptCouplingConnectionCompoundAdvancedSystemDeflection(_7406.CouplingConnectionCompoundAdvancedSystemDeflection):
    """ConceptCouplingConnectionCompoundAdvancedSystemDeflection
    ...
    class _Cast_ConceptCouplingConnectionCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_compound_advanced_system_deflection(self) -> 'ConceptCouplingConnectionCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7262.ConceptCouplingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7262.ConceptCouplingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionCompoundAdvancedSystemDeflection._Cast_ConceptCouplingConnectionCompoundAdvancedSystemDeflection':
        return self._Cast_ConceptCouplingConnectionCompoundAdvancedSystemDeflection(self)
