...
class GetLabelTest(unittest.TestCase):
    ...
    def testLabelAliases(self):
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "022fe361-596c-43a0-8e22-bad712bb9548-aliases.xml")
        ...
        res = _common.open_and_parse_test_data(mbxml.XmlParser(), self.datadir, "e72fabf2-74a3-4444-a9a5-316296cbfc8d-aliases.xml")
        aliases = res["label"]["alias-list"]
