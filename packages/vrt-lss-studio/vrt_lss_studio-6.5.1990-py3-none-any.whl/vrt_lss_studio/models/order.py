...
class Order(BaseModel):
    ...
    cargos: Optional[conlist(Cargo, max_items=1000, min_items=0, unique_items=True)] = Field(None, description="Cargo list. Can contain one cargo for `DROP`, a list for `PICKUP`, should be empty for `WORK`. ")
