...
class FaceGearCompoundCriticalSpeedAnalysis(_6697.GearCompoundCriticalSpeedAnalysis):
    """FaceGearCompoundCriticalSpeedAnalysis
    ...
    class _Cast_FaceGearCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'FaceGearCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def face_gear_compound_critical_speed_analysis(self) -> 'FaceGearCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6563.FaceGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6563.FaceGearCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'FaceGearCompoundCriticalSpeedAnalysis._Cast_FaceGearCompoundCriticalSpeedAnalysis':
