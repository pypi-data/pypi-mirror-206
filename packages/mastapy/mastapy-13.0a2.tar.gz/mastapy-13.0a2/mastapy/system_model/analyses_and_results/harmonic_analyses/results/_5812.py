...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5815, _5813
...
class ExcitationSourceSelection(_5813.ExcitationSourceSelectionBase):
    """ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5815.HarmonicSelection]':
    ...
    def include_only_harmonic_with_order(self, order: '_1517.RoundedOrder') -> 'bool':
