...
class PivotReportFilters (SpireObject) :
    ...
    def get_Item(self ,name:str)->'PivotReportFilter':
        ...
        intPtr = GetDllLibXls().PivotReportFilters_get_Item(self.Ptr, name)
    ...
    def RemoveAt(self ,index:int):
        ...
        GetDllLibXls().PivotReportFilters_RemoveAt(self.Ptr, index)
    ...
    def Clear(self):
        ...
        GetDllLibXls().PivotReportFilters_Clear(self.Ptr)
    ...
    def Remove(self ,item:'PivotReportFilter')->bool:
        ...
        ret = GetDllLibXls().PivotReportFilters_Remove(self.Ptr, intPtritem)
        return ret
    ...
    def Add(self ,item:'PivotReportFilter'):
        ...
        GetDllLibXls().PivotReportFilters_Add(self.Ptr, intPtritem)
