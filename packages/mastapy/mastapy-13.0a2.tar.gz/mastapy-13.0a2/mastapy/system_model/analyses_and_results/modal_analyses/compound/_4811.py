...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4809, _4810, _4719
...
class StraightBevelGearSetCompoundModalAnalysis(_4719.BevelGearSetCompoundModalAnalysis):
    """StraightBevelGearSetCompoundModalAnalysis
    ...
    class _Cast_StraightBevelGearSetCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearSetCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_set_compound_modal_analysis(self) -> 'StraightBevelGearSetCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4667.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_modal_analysis(self) -> 'List[_4809.StraightBevelGearCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_modal_analysis(self) -> 'List[_4810.StraightBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4667.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSetCompoundModalAnalysis._Cast_StraightBevelGearSetCompoundModalAnalysis':
