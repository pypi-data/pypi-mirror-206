...
class XlsDataValidationCollection (  IDataValidationCollection) :
    ...
    def ParentTable(self)->'IDataValidationTable':
        ...
        intPtr = GetDllLibXls().XlsDataValidationCollection_get_ParentTable(self.Ptr)
    ...
    def Workbook(self)->'Workbook':
        ...
        intPtr = GetDllLibXls().XlsDataValidationCollection_get_Workbook(self.Ptr)
    ...
    def Worksheet(self)->'Worksheet':
        ...
        intPtr = GetDllLibXls().XlsDataValidationCollection_get_Worksheet(self.Ptr)
    ...
    def get_Item(self ,index:int)->'IDataValidation':
        ...
        intPtr = GetDllLibXls().XlsDataValidationCollection_get_Item(self.Ptr, index)
    ...
    def ShapesCount(self)->int:
        ...
        ret = GetDllLibXls().XlsDataValidationCollection_get_ShapesCount(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsDataValidationCollection_get_PromptBoxHPosition(self.Ptr)
        return ret
    ...
    def PromptBoxHPosition(self, value:int):
        ...
        GetDllLibXls().XlsDataValidationCollection_set_PromptBoxHPosition(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsDataValidationCollection_get_PromptBoxVPosition(self.Ptr)
        return ret
    ...
    def PromptBoxVPosition(self, value:int):
        ...
        GetDllLibXls().XlsDataValidationCollection_set_PromptBoxVPosition(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsDataValidationCollection_get_IsPromptBoxVisible(self.Ptr)
        return ret
    ...
    def IsPromptBoxVisible(self, value:bool):
        ...
        GetDllLibXls().XlsDataValidationCollection_set_IsPromptBoxVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsDataValidationCollection_get_IsPromptBoxPositionFixed(self.Ptr)
        return ret
    ...
    def IsPromptBoxPositionFixed(self, value:bool):
        ...
        GetDllLibXls().XlsDataValidationCollection_set_IsPromptBoxPositionFixed(self.Ptr, value)
...
#        GetDllLibXls().XlsDataValidationCollection_Remove(self.Ptr, arrayrectangles)
