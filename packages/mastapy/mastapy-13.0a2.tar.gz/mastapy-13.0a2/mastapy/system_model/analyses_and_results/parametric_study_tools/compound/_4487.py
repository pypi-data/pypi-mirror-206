...
class KlingelnbergCycloPalloidHypoidGearCompoundParametricStudyTool(_4484.KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool):
    """KlingelnbergCycloPalloidHypoidGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4348.KlingelnbergCycloPalloidHypoidGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4348.KlingelnbergCycloPalloidHypoidGearParametricStudyTool]':
