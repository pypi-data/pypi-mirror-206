...
class ShaftDamageResults(_0.APIBase):
    ...
    class _Cast_ShaftDamageResults:
        ...
        def __init__(self, parent: 'ShaftDamageResults'):
            self._parent = parent

        @property
        def shaft_damage_results(self) -> 'ShaftDamageResults':
            return self._parent
    ...
    @property
    def cyclic_degrees_of_utilisation(self) -> 'List[_1514.RealVector]':
    ...
    def shaft_damage_chart(self, item: 'str', title: 'str') -> '_1775.SimpleChartDefinition':
    ...
    @property
    def cast_to(self) -> 'ShaftDamageResults._Cast_ShaftDamageResults':
