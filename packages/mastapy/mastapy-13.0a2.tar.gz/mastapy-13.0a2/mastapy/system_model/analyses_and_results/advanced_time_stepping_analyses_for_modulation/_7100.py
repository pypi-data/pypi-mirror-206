...
class ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation(_6989.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_advanced_time_stepping_analysis_for_modulation(self) -> 'ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2820.ZerolBevelGearSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation._Cast_ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation':
