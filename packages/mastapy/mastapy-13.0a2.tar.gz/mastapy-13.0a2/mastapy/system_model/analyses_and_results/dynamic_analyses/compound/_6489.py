...
class SynchroniserSleeveCompoundDynamicAnalysis(_6488.SynchroniserPartCompoundDynamicAnalysis):
    """SynchroniserSleeveCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6360.SynchroniserSleeveDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6360.SynchroniserSleeveDynamicAnalysis]':
