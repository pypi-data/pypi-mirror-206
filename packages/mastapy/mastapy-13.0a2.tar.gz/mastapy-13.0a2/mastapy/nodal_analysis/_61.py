...
class FEMeshingOptions(_0.APIBase):
    ...
    class _Cast_FEMeshingOptions:
        ...
        def __init__(self, parent: 'FEMeshingOptions'):
            self._parent = parent

        @property
        def shaft_fe_meshing_options(self):
            from mastapy.nodal_analysis import _84
            
            return self._parent._cast(_84.ShaftFEMeshingOptions)

        @property
        def electric_machine_mechanical_analysis_meshing_options(self):
            from mastapy.electric_machines import _1256
            
            return self._parent._cast(_1256.ElectricMachineMechanicalAnalysisMeshingOptions)

        @property
        def electric_machine_meshing_options(self):
            from mastapy.electric_machines import _1257
            
            return self._parent._cast(_1257.ElectricMachineMeshingOptions)

        @property
        def electric_machine_meshing_options_base(self):
            from mastapy.electric_machines import _1258
            
            return self._parent._cast(_1258.ElectricMachineMeshingOptionsBase)

        @property
        def fe_meshing_options(self) -> 'FEMeshingOptions':
            return self._parent
    ...
    def element_shape(self) -> '_91.VolumeElementShape':
        ...
        value = conversion.pn_to_mp_enum(temp, _91.VolumeElementShape)
    ...
    def element_shape(self, value: '_91.VolumeElementShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _91.VolumeElementShape.type_())
    ...
    @property
    def cast_to(self) -> 'FEMeshingOptions._Cast_FEMeshingOptions':
