...
class OilSealCompoundCriticalSpeedAnalysis(_6675.ConnectorCompoundCriticalSpeedAnalysis):
    """OilSealCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6588.OilSealCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6588.OilSealCriticalSpeedAnalysis]':
