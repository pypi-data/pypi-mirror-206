...
class StraightBevelPlanetGearCompoundPowerFlow(_4247.StraightBevelDiffGearCompoundPowerFlow):
    """StraightBevelPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4123.StraightBevelPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4123.StraightBevelPlanetGearPowerFlow]':
