...
class CondFormatCollectionWrapper (  CommonWrapper, IConditionalFormats) :
    ...
    def GetEnumerator(self)->'IEnumerator':
        ...
        intPtr = GetDllLibXls().CondFormatCollectionWrapper_GetEnumerator(self.Ptr)
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().CondFormatCollectionWrapper_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().CondFormatCollectionWrapper_EndUpdate(self.Ptr)
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibXls().CondFormatCollectionWrapper_get_Count(self.Ptr)
        return ret
    ...
    def get_Item(self ,index:int)->'IConditionalFormat':
        ...
        intPtr = GetDllLibXls().CondFormatCollectionWrapper_get_Item(self.Ptr, index)
    ...
    def AddCondition(self)->'IConditionalFormat':
        ...
        intPtr = GetDllLibXls().CondFormatCollectionWrapper_AddCondition(self.Ptr)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    def Remove(self):
        ...
        GetDllLibXls().CondFormatCollectionWrapper_Remove(self.Ptr)
    ...
    def RemoveAt(self ,index:int):
        ...
        GetDllLibXls().CondFormatCollectionWrapper_RemoveAt(self.Ptr, index)
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().CondFormatCollectionWrapper_get_Parent(self.Ptr)
    ...
    def GetCondition(self ,iCondition:int)->'XlsConditionalFormat':
        ...
        intPtr = GetDllLibXls().CondFormatCollectionWrapper_GetCondition(self.Ptr, iCondition)
        ret = None if intPtr==None else XlsConditionalFormat(intPtr)
        return ret
    ...
    def AddRange(self ,range:'IXLSRange'):
        ...
        GetDllLibXls().CondFormatCollectionWrapper_AddRange(self.Ptr, intPtrrange)
