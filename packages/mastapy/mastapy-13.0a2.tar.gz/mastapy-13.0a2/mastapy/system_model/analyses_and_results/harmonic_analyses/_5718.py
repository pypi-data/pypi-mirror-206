...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5716, _5717, _5727
...
class FaceGearSetHarmonicAnalysis(_5727.GearSetHarmonicAnalysis):
    """FaceGearSetHarmonicAnalysis
    ...
    class _Cast_FaceGearSetHarmonicAnalysis:
        ...
        def __init__(self, parent: 'FaceGearSetHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def face_gear_set_harmonic_analysis(self) -> 'FaceGearSetHarmonicAnalysis':
            return self._parent
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5716.FaceGearHarmonicAnalysis]':
    ...
    @property
    def face_gears_harmonic_analysis(self) -> 'List[_5716.FaceGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5717.FaceGearMeshHarmonicAnalysis]':
    ...
    @property
    def face_meshes_harmonic_analysis(self) -> 'List[_5717.FaceGearMeshHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'FaceGearSetHarmonicAnalysis._Cast_FaceGearSetHarmonicAnalysis':
