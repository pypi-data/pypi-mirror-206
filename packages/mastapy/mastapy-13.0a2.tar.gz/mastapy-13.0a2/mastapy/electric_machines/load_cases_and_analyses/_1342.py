...
class ElectricMachineEfficiencyMapSettings(_0.APIBase):
    ...
    class _Cast_ElectricMachineEfficiencyMapSettings:
        ...
        def __init__(self, parent: 'ElectricMachineEfficiencyMapSettings'):
            self._parent = parent

        @property
        def electric_machine_efficiency_map_settings(self) -> 'ElectricMachineEfficiencyMapSettings':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ElectricMachineEfficiencyMapSettings._Cast_ElectricMachineEfficiencyMapSettings':
