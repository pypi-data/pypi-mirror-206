...
class StraightBevelPlanetGearDynamicAnalysis(_6349.StraightBevelDiffGearDynamicAnalysis):
    """StraightBevelPlanetGearDynamicAnalysis
    ...
    class _Cast_StraightBevelPlanetGearDynamicAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelPlanetGearDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_planet_gear_dynamic_analysis(self) -> 'StraightBevelPlanetGearDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelPlanetGearDynamicAnalysis._Cast_StraightBevelPlanetGearDynamicAnalysis':
