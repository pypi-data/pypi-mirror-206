...
################################################### INDEX ###################################################
    ...
    def NDMI(self,DataArray):
        ...
        """
        self.DataArray = DataArray
        swir = xarray.where(self.DataArray.swir_1==-9999,numpy.nan,self.DataArray.swir_1)
        nir = xarray.where(self.DataArray.nir==-9999,numpy.nan,self.DataArray.nir)
    ...
    def NMDI(self,DataArray):
        ...
        """
        self.DataArray = DataArray
        swir1 = xarray.where(self.DataArray.swir_1==-9999,numpy.nan,self.DataArray.swir_1)
        swir2 = xarray.where(self.DataArray.swir_2==-9999,numpy.nan,self.DataArray.swir_2)
        nir   = xarray.where(self.DataArray.nir==-9999,numpy.nan,self.DataArray.nir)
        ...
        def __init__(self,dataset):
            ...
            if isinstance(dataset,xarray.core.dataset.Dataset):
                try:
                    ...
                    mir   = dataset.swir_1.to_numpy()
                    mir2  = dataset.swir_2.to_numpy()
