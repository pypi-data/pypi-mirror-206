...
class BevelDifferentialPlanetGearCompoundParametricStudyTool(_4429.BevelDifferentialGearCompoundParametricStudyTool):
    """BevelDifferentialPlanetGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4285.BevelDifferentialPlanetGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4285.BevelDifferentialPlanetGearParametricStudyTool]':
