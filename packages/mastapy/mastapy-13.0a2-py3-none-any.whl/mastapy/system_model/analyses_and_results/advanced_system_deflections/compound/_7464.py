...
class ShaftHubConnectionCompoundAdvancedSystemDeflection(_7404.ConnectorCompoundAdvancedSystemDeflection):
    """ShaftHubConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7334.ShaftHubConnectionAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7334.ShaftHubConnectionAdvancedSystemDeflection]':
