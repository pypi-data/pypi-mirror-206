...
class StepHalvingTransientSolver(_103.InternalTransientSolver):
    ...
    class _Cast_StepHalvingTransientSolver:
        ...
        def __init__(self, parent: 'StepHalvingTransientSolver'):
            self._parent = parent
        ...
        @property
        def step_halving_transient_solver(self) -> 'StepHalvingTransientSolver':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StepHalvingTransientSolver._Cast_StepHalvingTransientSolver':
