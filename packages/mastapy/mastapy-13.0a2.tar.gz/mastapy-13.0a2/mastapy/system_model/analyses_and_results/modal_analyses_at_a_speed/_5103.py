...
class BevelDifferentialPlanetGearModalAnalysisAtASpeed(_5101.BevelDifferentialGearModalAnalysisAtASpeed):
    """BevelDifferentialPlanetGearModalAnalysisAtASpeed
    ...
    class _Cast_BevelDifferentialPlanetGearModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'BevelDifferentialPlanetGearModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def bevel_differential_planet_gear_modal_analysis_at_a_speed(self) -> 'BevelDifferentialPlanetGearModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialPlanetGearModalAnalysisAtASpeed._Cast_BevelDifferentialPlanetGearModalAnalysisAtASpeed':
