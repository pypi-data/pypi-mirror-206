...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4842, _4841, _4848
...
class BevelDifferentialGearSetModalAnalysisAtAStiffness(_4848.BevelGearSetModalAnalysisAtAStiffness):
    """BevelDifferentialGearSetModalAnalysisAtAStiffness
    ...
    class _Cast_BevelDifferentialGearSetModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'BevelDifferentialGearSetModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_set_modal_analysis_at_a_stiffness(self) -> 'BevelDifferentialGearSetModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4842.BevelDifferentialGearModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4841.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearSetModalAnalysisAtAStiffness._Cast_BevelDifferentialGearSetModalAnalysisAtAStiffness':
