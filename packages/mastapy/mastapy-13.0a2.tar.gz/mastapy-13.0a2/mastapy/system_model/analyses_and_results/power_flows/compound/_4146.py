...
class AGMAGleasonConicalGearCompoundPowerFlow(_4174.ConicalGearCompoundPowerFlow):
    """AGMAGleasonConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4014.AGMAGleasonConicalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4014.AGMAGleasonConicalGearPowerFlow]':
