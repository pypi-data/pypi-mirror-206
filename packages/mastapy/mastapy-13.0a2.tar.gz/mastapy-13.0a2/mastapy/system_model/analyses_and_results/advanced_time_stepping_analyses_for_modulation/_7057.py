...
class PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation(_7071.ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def planetary_connection_advanced_time_stepping_analysis_for_modulation(self) -> 'PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2768.PlanetaryConnectionSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation._Cast_PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation(self)
