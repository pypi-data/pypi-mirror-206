...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3142, _3143, _3155
...
class CylindricalGearSetCompoundSteadyStateSynchronousResponse(_3155.GearSetCompoundSteadyStateSynchronousResponse):
    """CylindricalGearSetCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_CylindricalGearSetCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'CylindricalGearSetCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_set_compound_steady_state_synchronous_response(self) -> 'CylindricalGearSetCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3010.CylindricalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_gears_compound_steady_state_synchronous_response(self) -> 'List[_3142.CylindricalGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3143.CylindricalGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3010.CylindricalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearSetCompoundSteadyStateSynchronousResponse._Cast_CylindricalGearSetCompoundSteadyStateSynchronousResponse':
