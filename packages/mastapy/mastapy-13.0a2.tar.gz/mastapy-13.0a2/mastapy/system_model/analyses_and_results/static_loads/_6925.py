...
from mastapy.system_model.analyses_and_results.static_loads import _6923, _6924, _6794
...
class StraightBevelDiffGearSetLoadCase(_6794.BevelGearSetLoadCase):
    """StraightBevelDiffGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6923.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_6923.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_6924.StraightBevelDiffGearMeshLoadCase]':
