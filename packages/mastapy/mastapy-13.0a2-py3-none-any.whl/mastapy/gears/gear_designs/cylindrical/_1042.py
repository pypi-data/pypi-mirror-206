...
from mastapy.gears.manufacturing.cylindrical import _618, _619
...
class GearManufacturingConfigSetupViewModel(_0.APIBase):
    ...
    class _Cast_GearManufacturingConfigSetupViewModel:
        ...
        def __init__(self, parent: 'GearManufacturingConfigSetupViewModel'):
            self._parent = parent

        @property
        def gear_manufacturing_config_setup_view_model(self) -> 'GearManufacturingConfigSetupViewModel':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GearManufacturingConfigSetupViewModel._Cast_GearManufacturingConfigSetupViewModel':
