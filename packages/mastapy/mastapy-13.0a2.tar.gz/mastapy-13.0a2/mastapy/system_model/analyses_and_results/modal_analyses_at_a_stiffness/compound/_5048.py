...
class PulleyCompoundModalAnalysisAtAStiffness(_4999.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """PulleyCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_PulleyCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'PulleyCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def pulley_compound_modal_analysis_at_a_stiffness(self) -> 'PulleyCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4919.PulleyModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4919.PulleyModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'PulleyCompoundModalAnalysisAtAStiffness._Cast_PulleyCompoundModalAnalysisAtAStiffness':
