...
class PulleyCompoundStabilityAnalysis(_3913.CouplingHalfCompoundStabilityAnalysis):
    """PulleyCompoundStabilityAnalysis
    ...
    class _Cast_PulleyCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'PulleyCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def pulley_compound_stability_analysis(self) -> 'PulleyCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3831.PulleyStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3831.PulleyStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PulleyCompoundStabilityAnalysis._Cast_PulleyCompoundStabilityAnalysis':
