...
class SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse(_3112.BevelGearMeshCompoundSteadyStateSynchronousResponse):
    """SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_compound_steady_state_synchronous_response(self) -> 'SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3062.SpiralBevelGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3062.SpiralBevelGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse._Cast_SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse':
        return self._Cast_SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse(self)
