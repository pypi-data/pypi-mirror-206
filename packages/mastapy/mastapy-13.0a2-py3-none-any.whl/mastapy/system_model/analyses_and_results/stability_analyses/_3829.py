...
class PointLoadStabilityAnalysis(_3867.VirtualComponentStabilityAnalysis):
    """PointLoadStabilityAnalysis
    ...
    class _Cast_PointLoadStabilityAnalysis:
        ...
        def __init__(self, parent: 'PointLoadStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def point_load_stability_analysis(self) -> 'PointLoadStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PointLoadStabilityAnalysis._Cast_PointLoadStabilityAnalysis':
