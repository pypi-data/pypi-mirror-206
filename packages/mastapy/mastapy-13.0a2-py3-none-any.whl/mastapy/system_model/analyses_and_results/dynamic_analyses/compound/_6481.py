...
class StraightBevelGearCompoundDynamicAnalysis(_6389.BevelGearCompoundDynamicAnalysis):
    """StraightBevelGearCompoundDynamicAnalysis
    ...
    class _Cast_StraightBevelGearCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_compound_dynamic_analysis(self) -> 'StraightBevelGearCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6352.StraightBevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6352.StraightBevelGearDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearCompoundDynamicAnalysis._Cast_StraightBevelGearCompoundDynamicAnalysis':
