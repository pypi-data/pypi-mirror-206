...
class PlanetaryConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3710.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """PlanetaryConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_PlanetaryConnectionCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'PlanetaryConnectionCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def planetary_connection_compound_steady_state_synchronous_response_at_a_speed(self) -> 'PlanetaryConnectionCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3566.PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3566.PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'PlanetaryConnectionCompoundSteadyStateSynchronousResponseAtASpeed._Cast_PlanetaryConnectionCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_PlanetaryConnectionCompoundSteadyStateSynchronousResponseAtASpeed(self)
