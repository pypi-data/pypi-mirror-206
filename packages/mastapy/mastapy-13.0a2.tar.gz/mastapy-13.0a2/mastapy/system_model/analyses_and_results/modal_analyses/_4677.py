...
class TorqueConverterTurbineModalAnalysis(_4586.CouplingHalfModalAnalysis):
    """TorqueConverterTurbineModalAnalysis
    ...
    class _Cast_TorqueConverterTurbineModalAnalysis:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineModalAnalysis'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_modal_analysis(self) -> 'TorqueConverterTurbineModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineModalAnalysis._Cast_TorqueConverterTurbineModalAnalysis':
