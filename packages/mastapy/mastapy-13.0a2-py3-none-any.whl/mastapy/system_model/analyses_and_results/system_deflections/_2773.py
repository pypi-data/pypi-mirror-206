...
class RingPinsSystemDeflection(_2761.MountableComponentSystemDeflection):
    """RingPinsSystemDeflection
    ...
    class _Cast_RingPinsSystemDeflection:
        ...
        def __init__(self, parent: 'RingPinsSystemDeflection'):
            self._parent = parent
        ...
        @property
        def ring_pins_system_deflection(self) -> 'RingPinsSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4101.RingPinsPowerFlow':
    ...
    @property
    def cast_to(self) -> 'RingPinsSystemDeflection._Cast_RingPinsSystemDeflection':
