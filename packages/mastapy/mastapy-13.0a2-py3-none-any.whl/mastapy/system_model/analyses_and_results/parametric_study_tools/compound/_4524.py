...
class StraightBevelDiffGearMeshCompoundParametricStudyTool(_4435.BevelGearMeshCompoundParametricStudyTool):
    """StraightBevelDiffGearMeshCompoundParametricStudyTool
    ...
    class _Cast_StraightBevelDiffGearMeshCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearMeshCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_mesh_compound_parametric_study_tool(self) -> 'StraightBevelDiffGearMeshCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4394.StraightBevelDiffGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4394.StraightBevelDiffGearMeshParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearMeshCompoundParametricStudyTool._Cast_StraightBevelDiffGearMeshCompoundParametricStudyTool':
