...
class StraightBevelGearMeshCriticalSpeedAnalysis(_6525.BevelGearMeshCriticalSpeedAnalysis):
    """StraightBevelGearMeshCriticalSpeedAnalysis
    ...
    class _Cast_StraightBevelGearMeshCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_critical_speed_analysis(self) -> 'StraightBevelGearMeshCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshCriticalSpeedAnalysis._Cast_StraightBevelGearMeshCriticalSpeedAnalysis':
