...
class BevelDifferentialGearMultibodyDynamicsAnalysis(_5366.BevelGearMultibodyDynamicsAnalysis):
    """BevelDifferentialGearMultibodyDynamicsAnalysis
    ...
    class _Cast_BevelDifferentialGearMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_multibody_dynamics_analysis(self) -> 'BevelDifferentialGearMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMultibodyDynamicsAnalysis._Cast_BevelDifferentialGearMultibodyDynamicsAnalysis':
