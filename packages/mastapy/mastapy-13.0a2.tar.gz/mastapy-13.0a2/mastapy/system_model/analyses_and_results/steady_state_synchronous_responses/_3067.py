...
class SpringDamperSteadyStateSynchronousResponse(_3001.CouplingSteadyStateSynchronousResponse):
    """SpringDamperSteadyStateSynchronousResponse
    ...
    class _Cast_SpringDamperSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'SpringDamperSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def spring_damper_steady_state_synchronous_response(self) -> 'SpringDamperSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperSteadyStateSynchronousResponse._Cast_SpringDamperSteadyStateSynchronousResponse':
