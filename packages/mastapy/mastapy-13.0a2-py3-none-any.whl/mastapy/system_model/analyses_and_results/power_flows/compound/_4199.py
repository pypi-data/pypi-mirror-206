...
class FlexiblePinAssemblyCompoundPowerFlow(_4240.SpecialisedAssemblyCompoundPowerFlow):
    """FlexiblePinAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4067.FlexiblePinAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4067.FlexiblePinAssemblyPowerFlow]':
