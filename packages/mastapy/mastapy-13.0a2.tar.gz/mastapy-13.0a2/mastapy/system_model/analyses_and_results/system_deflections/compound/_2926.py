...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2927, _2831
...
class ShaftCompoundSystemDeflection(_2831.AbstractShaftCompoundSystemDeflection):
    """ShaftCompoundSystemDeflection
    ...
    @property
    def shaft_duty_cycle_damage_results(self) -> '_2927.ShaftDutyCycleSystemDeflection':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2783.ShaftSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2783.ShaftSystemDeflection]':
