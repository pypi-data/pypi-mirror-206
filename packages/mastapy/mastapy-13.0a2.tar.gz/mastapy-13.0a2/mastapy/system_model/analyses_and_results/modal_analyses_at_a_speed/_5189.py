...
class SpiralBevelGearModalAnalysisAtASpeed(_5106.BevelGearModalAnalysisAtASpeed):
    """SpiralBevelGearModalAnalysisAtASpeed
    ...
    class _Cast_SpiralBevelGearModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'SpiralBevelGearModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_modal_analysis_at_a_speed(self) -> 'SpiralBevelGearModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearModalAnalysisAtASpeed._Cast_SpiralBevelGearModalAnalysisAtASpeed':
