...
class SpiralBevelGearMeshMultibodyDynamicsAnalysis(_5365.BevelGearMeshMultibodyDynamicsAnalysis):
    """SpiralBevelGearMeshMultibodyDynamicsAnalysis
    ...
    class _Cast_SpiralBevelGearMeshMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_multibody_dynamics_analysis(self) -> 'SpiralBevelGearMeshMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshMultibodyDynamicsAnalysis._Cast_SpiralBevelGearMeshMultibodyDynamicsAnalysis':
