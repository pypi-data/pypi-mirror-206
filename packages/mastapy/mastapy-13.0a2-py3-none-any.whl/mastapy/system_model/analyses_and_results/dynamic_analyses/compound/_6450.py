...
class MountableComponentCompoundDynamicAnalysis(_6398.ComponentCompoundDynamicAnalysis):
    """MountableComponentCompoundDynamicAnalysis
    ...
    class _Cast_MountableComponentCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'MountableComponentCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def mountable_component_compound_dynamic_analysis(self) -> 'MountableComponentCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6321.MountableComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6321.MountableComponentDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'MountableComponentCompoundDynamicAnalysis._Cast_MountableComponentCompoundDynamicAnalysis':
