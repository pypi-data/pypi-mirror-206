...
class ProfileSet(_0.APIBase):
    ...
    class _Cast_ProfileSet:
        ...
        def __init__(self, parent: 'ProfileSet'):
            self._parent = parent
    ...
    @property
    def active_profile_type(self) -> '_1876.RollerBearingProfileTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, _1876.RollerBearingProfileTypes)
        return constructor.new_from_mastapy_type(_1876.RollerBearingProfileTypes)(value) if value is not None else None

    @active_profile_type.setter
    def active_profile_type(self, value: '_1876.RollerBearingProfileTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1876.RollerBearingProfileTypes.type_())
        self.wrapped.ActiveProfileType = value

    @property
    def active_profile(self) -> '_1921.RollerBearingProfile':
    ...
    @property
    def cast_to(self) -> 'ProfileSet._Cast_ProfileSet':
