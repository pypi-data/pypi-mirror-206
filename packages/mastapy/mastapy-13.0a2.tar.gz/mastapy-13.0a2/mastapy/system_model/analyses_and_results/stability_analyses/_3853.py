...
class StraightBevelGearMeshStabilityAnalysis(_3758.BevelGearMeshStabilityAnalysis):
    """StraightBevelGearMeshStabilityAnalysis
    ...
    class _Cast_StraightBevelGearMeshStabilityAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_stability_analysis(self) -> 'StraightBevelGearMeshStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshStabilityAnalysis._Cast_StraightBevelGearMeshStabilityAnalysis':
