...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5398, _5397, _5411
...
class CylindricalGearSetMultibodyDynamicsAnalysis(_5411.GearSetMultibodyDynamicsAnalysis):
    """CylindricalGearSetMultibodyDynamicsAnalysis
    ...
    class _Cast_CylindricalGearSetMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'CylindricalGearSetMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_set_multibody_dynamics_analysis(self) -> 'CylindricalGearSetMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def gears(self) -> 'List[_5398.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gears_multibody_dynamics_analysis(self) -> 'List[_5398.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_meshes_multibody_dynamics_analysis(self) -> 'List[_5397.CylindricalGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearSetMultibodyDynamicsAnalysis._Cast_CylindricalGearSetMultibodyDynamicsAnalysis':
