...
from amazon_sagemaker_jupyter_scheduler.clients import S3AsyncBoto3Client, STSAsyncBotoClient, SageMakerAsyncBoto3Client
...
class TestFileUploader:
    @pytest.mark.asyncio
    @patch.object(S3AsyncBoto3Client, "get_bucket_location")
    ...
    async def test_upload__no_script_lcc__happy_path(
        ...
        assert S3AsyncBoto3Client.get_bucket_location is mock_get_bucket_location
        ...
        mock_get_bucket_location.return_value = {"LocationConstraint": None}
        ...
        # upload only 1 file
        mock_get_bucket_location.assert_has_calls(
            [call(bucket="sagemaker-us-east-1-177118115371")]
        )
