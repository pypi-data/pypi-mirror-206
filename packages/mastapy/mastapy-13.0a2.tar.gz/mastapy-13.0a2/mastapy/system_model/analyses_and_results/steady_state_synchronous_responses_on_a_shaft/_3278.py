...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3279, _3277, _3283
...
class FaceGearSetSteadyStateSynchronousResponseOnAShaft(_3283.GearSetSteadyStateSynchronousResponseOnAShaft):
    """FaceGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def face_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3279.FaceGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def face_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3277.FaceGearMeshSteadyStateSynchronousResponseOnAShaft]':
