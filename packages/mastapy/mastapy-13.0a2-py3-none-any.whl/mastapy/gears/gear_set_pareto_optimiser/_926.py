...
class ParetoHypoidGearSetOptimisationStrategyDatabase(_918.ParetoConicalRatingOptimisationStrategyDatabase):
    """ParetoHypoidGearSetOptimisationStrategyDatabase
    ...
    class _Cast_ParetoHypoidGearSetOptimisationStrategyDatabase:
        ...
        def __init__(self, parent: 'ParetoHypoidGearSetOptimisationStrategyDatabase'):
            self._parent = parent
        ...
        @property
        def pareto_hypoid_gear_set_optimisation_strategy_database(self) -> 'ParetoHypoidGearSetOptimisationStrategyDatabase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ParetoHypoidGearSetOptimisationStrategyDatabase._Cast_ParetoHypoidGearSetOptimisationStrategyDatabase':
