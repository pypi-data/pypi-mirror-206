...
class WormDesign(_952.WormGearDesign):
    """WormDesign
    ...
    class _Cast_WormDesign:
        ...
        def __init__(self, parent: 'WormDesign'):
            self._parent = parent
        ...
        @property
        def worm_design(self) -> 'WormDesign':
            return self._parent
    ...
    @property
    def addendum_factor(self) -> '_346.WormAddendumFactor':
        ...
        value = conversion.pn_to_mp_enum(temp, _346.WormAddendumFactor)
        return constructor.new_from_mastapy_type(_346.WormAddendumFactor)(value) if value is not None else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_346.WormAddendumFactor'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _346.WormAddendumFactor.type_())
    ...
    @property
    def cast_to(self) -> 'WormDesign._Cast_WormDesign':
