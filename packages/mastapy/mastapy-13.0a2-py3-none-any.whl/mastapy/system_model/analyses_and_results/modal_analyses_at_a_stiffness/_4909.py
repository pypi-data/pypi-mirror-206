...
class OilSealModalAnalysisAtAStiffness(_4866.ConnectorModalAnalysisAtAStiffness):
    """OilSealModalAnalysisAtAStiffness
    ...
    class _Cast_OilSealModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'OilSealModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def oil_seal_modal_analysis_at_a_stiffness(self) -> 'OilSealModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'OilSealModalAnalysisAtAStiffness._Cast_OilSealModalAnalysisAtAStiffness':
