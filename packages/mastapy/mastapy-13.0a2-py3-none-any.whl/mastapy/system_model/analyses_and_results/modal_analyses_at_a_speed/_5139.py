...
class CylindricalPlanetGearModalAnalysisAtASpeed(_5137.CylindricalGearModalAnalysisAtASpeed):
    """CylindricalPlanetGearModalAnalysisAtASpeed
    ...
    class _Cast_CylindricalPlanetGearModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'CylindricalPlanetGearModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def cylindrical_planet_gear_modal_analysis_at_a_speed(self) -> 'CylindricalPlanetGearModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalPlanetGearModalAnalysisAtASpeed._Cast_CylindricalPlanetGearModalAnalysisAtASpeed':
