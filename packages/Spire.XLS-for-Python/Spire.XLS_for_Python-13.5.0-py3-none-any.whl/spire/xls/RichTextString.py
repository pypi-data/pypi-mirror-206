...
class RichTextString (  CommonWrapper, IRichTextString, IExcelApplication) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().RichTextString_get_Parent(self.Ptr)
    ...
    def GetFont(self ,index:int)->'IFont':
        ...
        intPtr = GetDllLibXls().RichTextString_GetFont(self.Ptr, index)
    ...
    def SetFont(self ,startIndex:int,endIndex:int,font:'IFont'):
        ...
        GetDllLibXls().RichTextString_SetFont(self.Ptr, startIndex,endIndex,intPtrfont)
    ...
    def ClearFormatting(self):
        ...
        GetDllLibXls().RichTextString_ClearFormatting(self.Ptr)
    ...
    def Clear(self):
        ...
        GetDllLibXls().RichTextString_Clear(self.Ptr)
    ...
    def Append(self ,text:str,font:'IFont'):
        ...
        GetDllLibXls().RichTextString_Append(self.Ptr, text,intPtrfont)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().RichTextString_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().RichTextString_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().RichTextString_set_Text(self.Ptr, value)
    ...
    def RtfText(self)->str:
        ...
        GetDllLibXls().RichTextString_get_RtfText.restype=c_wchar_p
        ret = GetDllLibXls().RichTextString_get_RtfText(self.Ptr)
        return ret
    ...
    def IsFormatted(self)->bool:
        ...
        ret = GetDllLibXls().RichTextString_get_IsFormatted(self.Ptr)
        return ret
    ...
    def DefaultFont(self)->'XlsFont':
        ...
        intPtr = GetDllLibXls().RichTextString_get_DefaultFont(self.Ptr)
        ret = None if intPtr==None else XlsFont(intPtr)
        return ret
