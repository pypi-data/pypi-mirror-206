...
class ReferRangeArea (SpireObject) :
    ...
    def IsExternalLink(self)->bool:
        ...
        ret = GetDllLibXls().ReferRangeArea_get_IsExternalLink(self.Ptr)
        return ret
    ...
    def ExternalFileName(self)->str:
        ...
        GetDllLibXls().ReferRangeArea_get_ExternalFileName.restype=c_wchar_p
        ret = GetDllLibXls().ReferRangeArea_get_ExternalFileName(self.Ptr)
        return ret
    ...
    def SheetName(self)->str:
        ...
        GetDllLibXls().ReferRangeArea_get_SheetName.restype=c_wchar_p
        ret = GetDllLibXls().ReferRangeArea_get_SheetName(self.Ptr)
        return ret
    ...
    def EndColumn(self)->int:
        ...
        ret = GetDllLibXls().ReferRangeArea_get_EndColumn(self.Ptr)
        return ret
    ...
    def StartColumn(self)->int:
        ...
        ret = GetDllLibXls().ReferRangeArea_get_StartColumn(self.Ptr)
        return ret
    ...
    def EndRow(self)->int:
        ...
        ret = GetDllLibXls().ReferRangeArea_get_EndRow(self.Ptr)
        return ret
    ...
    def StartRow(self)->int:
        ...
        ret = GetDllLibXls().ReferRangeArea_get_StartRow(self.Ptr)
        return ret
