...
class DatumCompoundModalAnalysisAtAStiffness(_4985.ComponentCompoundModalAnalysisAtAStiffness):
    """DatumCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_DatumCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'DatumCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def datum_compound_modal_analysis_at_a_stiffness(self) -> 'DatumCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4881.DatumModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4881.DatumModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'DatumCompoundModalAnalysisAtAStiffness._Cast_DatumCompoundModalAnalysisAtAStiffness':
