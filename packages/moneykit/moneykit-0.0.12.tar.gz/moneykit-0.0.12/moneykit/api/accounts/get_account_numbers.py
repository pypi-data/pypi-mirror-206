...
from ...models.get_account_numbers_response import GetAccountNumbersResponse
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/links/{id}/accounts/numbers".format(client.base_url, id=id)
...
def _parse_response(
    *, client: Client, response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = GetAccountNumbersResponse.from_dict(response.json())
    ...
    *,
    ...
    """/links/{id}/accounts/numbers
     ...
     Returns a list of open, permissioned accounts associated with a <a href=#tag/Links>link</a>,
            including full account and routing numbers for appropriate accounts (such as checking and
    savings accounts).
    ...
    Returns:
        Response[Union[APIErrorRateLimitExceededResponse, GetAccountNumbersResponse, LinkErrorBadStateResponse, LinkErrorDeletedResponse, LinkErrorForbiddenActionResponse, LinkErrorNotFoundResponse, Union['APIErrorAuthExpiredAccessTokenResponse', 'APIErrorAuthUnauthorizedResponse', 'LinkErrorUnauthorizedAccessResponse']]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[APIErrorRateLimitExceededResponse, GetAccountNumbersResponse, LinkErrorBadStateResponse, LinkErrorDeletedResponse, LinkErrorForbiddenActionResponse, LinkErrorNotFoundResponse, Union['APIErrorAuthExpiredAccessTokenResponse', 'APIErrorAuthUnauthorizedResponse', 'LinkErrorUnauthorizedAccessResponse']]
    """
