...
class ListBoxCollection (  CollectionBase[XlsListBoxShape], IListBoxes) :
    ...
    def get_Item(self ,index:int)->IListBox:
        ...
        intPtr = GetDllLibXls().ListBoxCollection_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->IListBox:
        ...
        intPtr = GetDllLibXls().ListBoxCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsListBoxShape(intPtr)
        return ret
    ...
    def AddListBox(self ,row:int,column:int,height:int,width:int)->'IListBox':
        ...
        intPtr = GetDllLibXls().ListBoxCollection_AddListBox(self.Ptr, row,column,height,width)
        ret = None if intPtr==None else XlsListBoxShape(intPtr)
        return ret
    ...
    def AddCopy(self ,source:'IListBox'):
        ...
        GetDllLibXls().ListBoxCollection_AddCopy(self.Ptr, intPtrsource)
    ...
    def Clear(self):
        ...
        GetDllLibXls().ListBoxCollection_Clear(self.Ptr)
