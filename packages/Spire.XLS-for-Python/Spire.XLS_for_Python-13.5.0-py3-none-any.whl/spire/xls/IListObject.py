...
class IListObject (SpireObject) :
    ...
    <summary>
        ...
        GetDllLibXls().IListObject_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().IListObject_get_Name(self.Ptr)
        return ret
    ...
    def Name(self, value:str):
        ...
        GetDllLibXls().IListObject_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().IListObject_get_Location(self.Ptr)
    ...
    def Location(self, value:'IXLSRange'):
        ...
        GetDllLibXls().IListObject_set_Location(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().IListObject_get_Columns(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IListObject_get_Index(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().IListObject_get_BuiltInTableStyle(self.Ptr)
    ...
    def BuiltInTableStyle(self, value:'TableBuiltInStyles'):
        ...
        GetDllLibXls().IListObject_set_BuiltInTableStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().IListObject_get_Worksheet(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().IListObject_get_DisplayName.restype=c_wchar_p
        ret = GetDllLibXls().IListObject_get_DisplayName(self.Ptr)
        return ret
    ...
    def DisplayName(self, value:str):
        ...
        GetDllLibXls().IListObject_set_DisplayName(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IListObject_get_TotalsRowCount(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().IListObject_get_DisplayTotalRow(self.Ptr)
        return ret
    ...
    def DisplayTotalRow(self, value:bool):
        ...
        GetDllLibXls().IListObject_set_DisplayTotalRow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IListObject_get_ShowTableStyleRowStripes(self.Ptr)
        return ret
    ...
    def ShowTableStyleRowStripes(self, value:bool):
        ...
        GetDllLibXls().IListObject_set_ShowTableStyleRowStripes(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IListObject_get_ShowTableStyleColumnStripes(self.Ptr)
        return ret
    ...
    def ShowTableStyleColumnStripes(self, value:bool):
        ...
        GetDllLibXls().IListObject_set_ShowTableStyleColumnStripes(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IListObject_get_DisplayLastColumn(self.Ptr)
        return ret
    ...
    def DisplayLastColumn(self, value:bool):
        ...
        GetDllLibXls().IListObject_set_DisplayLastColumn(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IListObject_get_DisplayFirstColumn(self.Ptr)
        return ret
    ...
    def DisplayFirstColumn(self, value:bool):
        ...
        GetDllLibXls().IListObject_set_DisplayFirstColumn(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IListObject_get_DisplayHeaderRow(self.Ptr)
        return ret
    ...
    def DisplayHeaderRow(self, value:bool):
        ...
        GetDllLibXls().IListObject_set_DisplayHeaderRow(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().IListObject_get_AutoFilters(self.Ptr)
