...
class SynchroniserCompoundStabilityAnalysis(_3972.SpecialisedAssemblyCompoundStabilityAnalysis):
    """SynchroniserCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3861.SynchroniserStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3861.SynchroniserStabilityAnalysis]':
