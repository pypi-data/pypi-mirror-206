...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4348, _4347, _4346
...
class KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool(_4346.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool):
    """KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_set_parametric_study_tool(self) -> 'KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool':
            return self._parent
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_parametric_study_tool(self) -> 'List[_4348.KlingelnbergCycloPalloidHypoidGearParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_parametric_study_tool(self) -> 'List[_4347.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool._Cast_KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool':
