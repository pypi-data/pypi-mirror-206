...
class BoltCompoundAdvancedTimeSteppingAnalysisForModulation(_7128.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BoltCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_BoltCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'BoltCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def bolt_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'BoltCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6992.BoltAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6992.BoltAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'BoltCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_BoltCompoundAdvancedTimeSteppingAnalysisForModulation':
