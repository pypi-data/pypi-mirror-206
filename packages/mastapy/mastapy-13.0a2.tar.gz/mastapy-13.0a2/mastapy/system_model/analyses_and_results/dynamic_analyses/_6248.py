...
class AGMAGleasonConicalGearMeshDynamicAnalysis(_6276.ConicalGearMeshDynamicAnalysis):
    """AGMAGleasonConicalGearMeshDynamicAnalysis
    ...
    class _Cast_AGMAGleasonConicalGearMeshDynamicAnalysis:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearMeshDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_mesh_dynamic_analysis(self) -> 'AGMAGleasonConicalGearMeshDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearMeshDynamicAnalysis._Cast_AGMAGleasonConicalGearMeshDynamicAnalysis':
