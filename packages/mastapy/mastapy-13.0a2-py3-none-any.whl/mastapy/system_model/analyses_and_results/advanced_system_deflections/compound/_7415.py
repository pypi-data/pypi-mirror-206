...
class CylindricalGearCompoundAdvancedSystemDeflection(_7426.GearCompoundAdvancedSystemDeflection):
    """CylindricalGearCompoundAdvancedSystemDeflection
    ...
    class _Cast_CylindricalGearCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'CylindricalGearCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_compound_advanced_system_deflection(self) -> 'CylindricalGearCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cylindrical_gear_rating(self) -> '_451.CylindricalGearDutyCycleRating':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7283.CylindricalGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7283.CylindricalGearAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearCompoundAdvancedSystemDeflection._Cast_CylindricalGearCompoundAdvancedSystemDeflection':
