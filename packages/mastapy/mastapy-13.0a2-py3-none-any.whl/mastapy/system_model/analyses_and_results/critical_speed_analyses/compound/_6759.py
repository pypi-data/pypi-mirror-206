...
class TorqueConverterTurbineCompoundCriticalSpeedAnalysis(_6678.CouplingHalfCompoundCriticalSpeedAnalysis):
    """TorqueConverterTurbineCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6630.TorqueConverterTurbineCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6630.TorqueConverterTurbineCriticalSpeedAnalysis]':
