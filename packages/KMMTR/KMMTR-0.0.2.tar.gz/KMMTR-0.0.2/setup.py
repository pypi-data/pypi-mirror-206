...
setup(
    ...
    url='https://github.com/Bin-Cao/KMMTransferRegressor',  # github或者自己的网站地址
    packages=find_packages(include=['KMMTR', 'KMMTR.*']),
    classifiers=[
    ...
    install_requires=['scikit-learn','pandas','numpy','cvxopt'],  # 安装所需要的库
    entry_points={
        'console_scripts': [
            ''],
    },  # 设置命令行工具(可不使用就可以注释掉)
