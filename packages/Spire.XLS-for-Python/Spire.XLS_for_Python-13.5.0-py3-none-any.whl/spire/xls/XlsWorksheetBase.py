...
class XlsWorksheetBase (  XlsObject, INamedObject, ITabSheet, ICloneParent) :
    ...
    def Unselect(self ,Check:bool):
        ...
        GetDllLibXls().XlsWorksheetBase_Unselect(self.Ptr, Check)
...
<remarks>Password should be less than 15 symbols.</remarks>
        ...
        GetDllLibXls().XlsWorksheetBase_Protect.argtypes=[c_void_p ,c_void_p,c_int]
        GetDllLibXls().XlsWorksheetBase_Protect(self.Ptr, password,enumoptions)
...
<remarks>Password should be less than 15 symbols.</remarks>
        ...
        GetDllLibXls().XlsWorksheetBase_Protect(self.Ptr, password)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_Clone(self.Ptr, intPtrparent)
    ...
    <summary>
        ...
        GetDllLibXls().XlsWorksheetBase_Unprotect(self.Ptr)
    ...
    <param name="password">Password to unprotect.</param>
        ...
        GetDllLibXls().XlsWorksheetBase_UnprotectP(self.Ptr, password)
    ...
    def AddTextEffectShape(self ,effect:'PresetTextEffect',text:str,upperLeftRow:int,top:int,upperLeftColumn:int,left:int,height:int,width:int)->'IShape':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_AddTextEffectShape(self.Ptr, enumeffect,text,upperLeftRow,top,upperLeftColumn,left,height,width)
    ...
    def SetChanged(self):
        ...
        GetDllLibXls().XlsWorksheetBase_SetChanged(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().XlsWorksheetBase_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorksheetBase_get_Name(self.Ptr)
        return ret
    ...
    def Name(self, value:str):
        ...
        GetDllLibXls().XlsWorksheetBase_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsWorksheetBase_get_CodeName.restype=c_wchar_p
        ret = GetDllLibXls().XlsWorksheetBase_get_CodeName(self.Ptr)
        return ret
    ...
    def CodeName(self, value:str):
        ...
        GetDllLibXls().XlsWorksheetBase_set_CodeName(self.Ptr, value)
...
<remarks> Value of zoom should be between 10 and 400.</remarks>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_Zoom(self.Ptr)
        return ret

    @Zoom.setter
    def Zoom(self, value:int):
        GetDllLibXls().XlsWorksheetBase_set_Zoom.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsWorksheetBase_set_Zoom(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_Visibility(self.Ptr)
    ...
    def Visibility(self, value:'WorksheetVisibility'):
        ...
        GetDllLibXls().XlsWorksheetBase_set_Visibility(self.Ptr, value.value)
    ...
    def Workbook(self)->'IWorkbook':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_Workbook(self.Ptr)
    ...
    def Charts(self)->'IChartShapes':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_Charts(self.Ptr)
        ret = None if intPtr==None else IChartShapes(intPtr)
        return ret
    ...
    def QueryTables(self)->'QueryTableCollection':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_QueryTables(self.Ptr)
    ...
    def CheckBoxes(self)->'ICheckBoxes':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_CheckBoxes(self.Ptr)
    ...
    def ButtonShapes(self)->'IButtonShapes':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_ButtonShapes(self.Ptr)
    ...
    def LabelShapes(self)->'ILabelShapes':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_LabelShapes(self.Ptr)
    ...
    def Lines(self)->'ILines':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_Lines(self.Ptr)
    ...
    def ListBoxes(self)->'IListBoxes':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_ListBoxes(self.Ptr)
    ...
    def ComboBoxes(self)->'IComboBoxes':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_ComboBoxes(self.Ptr)
    ...
    def GroupBoxes(self)->'IGroupBoxes':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_GroupBoxes(self.Ptr)
    ...
    def OvalShapes(self)->'IOvalShapes':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_OvalShapes(self.Ptr)
    ...
    def RectangleShapes(self)->'IRectangleShapes':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_RectangleShapes(self.Ptr)
    ...
    def ScrollBarShapes(self)->'IScrollBarShapes':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_ScrollBarShapes(self.Ptr)
    ...
    def SpinnerShapes(self)->'ISpinnerShapes':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_SpinnerShapes(self.Ptr)
    ...
    def ArcShapes(self)->'IArcShapes':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_ArcShapes(self.Ptr)
    ...
    def Comments(self)->'IComments':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_Comments(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_GridLineColor(self.Ptr)
    ...
    def GridLineColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsWorksheetBase_set_GridLineColor(self.Ptr, value.value)
    ...
    def HasPictures(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_HasPictures(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_HasVmlShapes(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_HeaderFooterShapes(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_DefaultGridlineColor(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_FirstRow(self.Ptr)
        return ret

    @FirstRow.setter
    def FirstRow(self, value:int):
        GetDllLibXls().XlsWorksheetBase_set_FirstRow.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsWorksheetBase_set_FirstRow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_FirstColumn(self.Ptr)
        return ret

    @FirstColumn.setter
    def FirstColumn(self, value:int):
        GetDllLibXls().XlsWorksheetBase_set_FirstColumn.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsWorksheetBase_set_FirstColumn(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_FirstDataRow(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_FirstDataColumn(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_LastRow(self.Ptr)
        return ret

    @LastRow.setter
    def LastRow(self, value:int):
        GetDllLibXls().XlsWorksheetBase_set_LastRow.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsWorksheetBase_set_LastRow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_LastColumn(self.Ptr)
        return ret

    @LastColumn.setter
    def LastColumn(self, value:int):
        GetDllLibXls().XlsWorksheetBase_set_LastColumn.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsWorksheetBase_set_LastColumn(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_LastDataRow(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_LastDataColumn(self.Ptr)
        return ret
    ...
    def IsPasswordProtected(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_IsPasswordProtected(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_Index(self.Ptr)
        return ret

    @Index.setter
    def Index(self, value:int):
        GetDllLibXls().XlsWorksheetBase_set_Index.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsWorksheetBase_set_Index(self.Ptr, value)
    ...
    def IsTransitionEvaluation(self)->bool:
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_IsTransitionEvaluation(self.Ptr)
        return ret
    ...
    def IsTransitionEvaluation(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheetBase_set_IsTransitionEvaluation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_LeftVisibleColumn(self.Ptr)
        return ret
    ...
    def LeftVisibleColumn(self, value:int):
        ...
        GetDllLibXls().XlsWorksheetBase_set_LeftVisibleColumn(self.Ptr, value)
    ...
    def RealIndex(self)->int:
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_RealIndex(self.Ptr)
        return ret

    @RealIndex.setter
    def RealIndex(self, value:int):
        GetDllLibXls().XlsWorksheetBase_set_RealIndex.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsWorksheetBase_set_RealIndex(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_SheetId(self.Ptr)
        return ret

    @SheetId.setter
    def SheetId(self, value:int):
        GetDllLibXls().XlsWorksheetBase_set_SheetId.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsWorksheetBase_set_SheetId(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_IsRowColHeadersVisible(self.Ptr)
        return ret
    ...
    def IsRowColHeadersVisible(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheetBase_set_IsRowColHeadersVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_IsRightToLeft(self.Ptr)
        return ret
    ...
    def IsRightToLeft(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheetBase_set_IsRightToLeft(self.Ptr, value)
    ...
    def ParentWorkbook(self)->'XlsWorkbook':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_ParentWorkbook(self.Ptr)
    ...
    def Pictures(self)->'IPictures':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_Pictures(self.Ptr)
    ...
    def RadioButtons(self)->'IRadioButtons':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_RadioButtons(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TextBoxes(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_IsSelected(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_ProtectContents(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_ProtectDrawingObjects(self.Ptr)
        return ret
    ...
    def Protection(self)->'SheetProtectionType':
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_Protection(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_ProtectScenarios(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TabColor(self.Ptr)
    ...
    def TabColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsWorksheetBase_set_TabColor(self.Ptr, value.Ptr)
    ...
    def TabColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TabColorObject(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_TabKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def TabKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsWorksheetBase_set_TabKnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_TopVisibleRow(self.Ptr)
        return ret
    ...
    def TopVisibleRow(self, value:int):
        ...
        GetDllLibXls().XlsWorksheetBase_set_TopVisibleRow(self.Ptr, value)
    ...
    def TypedCheckBoxes(self)->'CheckBoxCollection':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedCheckBoxes(self.Ptr)
        ret = None if intPtr==None else CheckBoxCollection(intPtr)
        return ret
    ...
    def TypedComboBoxes(self)->'ComboBoxCollection':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedComboBoxes(self.Ptr)
        ret = None if intPtr==None else ComboBoxCollection(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedLines(self.Ptr)
        ret = None if intPtr==None else LineCollection(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedRects(self.Ptr)
        ret = None if intPtr==None else RectangleCollection(intPtr)
        return ret
    ...
    def TypedArcs(self)->'ArcShapeCollection':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedArcs(self.Ptr)
        ret = None if intPtr==None else ArcShapeCollection(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedOvals(self.Ptr)
        ret = None if intPtr==None else OvalShapeCollection(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedButtons(self.Ptr)
        ret = None if intPtr==None else ButtonShapeCollection(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedGroupBoxes(self.Ptr)
        ret = None if intPtr==None else GroupBoxCollection(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedLabels(self.Ptr)
        ret = None if intPtr==None else LabelShapeCollection(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedListBoxes(self.Ptr)
        ret = None if intPtr==None else ListBoxCollection(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedScollBars(self.Ptr)
        ret = None if intPtr==None else ScrollBarCollection(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedSpinners(self.Ptr)
        ret = None if intPtr==None else SpinnerShapeCollection(intPtr)
        return ret
    ...
    def TypedRadioButtons(self)->'RadioButtonCollection':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedRadioButtons(self.Ptr)
        ret = None if intPtr==None else RadioButtonCollection(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedTextBoxes(self.Ptr)
        ret = None if intPtr==None else TextBoxCollection(intPtr)
        return ret
    ...
    def PrstGeomShapes(self)->'PrstGeomShapeCollection':
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_PrstGeomShapes(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsWorksheetBase_get_TypedPictures(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_UnknownVmlShapes(self.Ptr)
        return ret
    ...
    def UnknownVmlShapes(self, value:bool):
        ...
        GetDllLibXls().XlsWorksheetBase_set_UnknownVmlShapes(self.Ptr, value)
    ...
    def VmlShapesCount(self)->int:
        ...
        ret = GetDllLibXls().XlsWorksheetBase_get_VmlShapesCount(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsWorksheetBase_Activate(self.Ptr)
    ...
    def Select(self):
        ...
        GetDllLibXls().XlsWorksheetBase_Select(self.Ptr)
    ...
    def SelectTab(self):
        ...
        GetDllLibXls().XlsWorksheetBase_SelectTab(self.Ptr)
    ...
    def Unselect(self):
        ...
        GetDllLibXls().XlsWorksheetBase_Unselect1(self.Ptr)
    ...
    def DEF_MIN_COLUMN_INDEX()->int:
        ...
        ret = GetDllLibXls().XlsWorksheetBase_DEF_MIN_COLUMN_INDEX()
        return ret
