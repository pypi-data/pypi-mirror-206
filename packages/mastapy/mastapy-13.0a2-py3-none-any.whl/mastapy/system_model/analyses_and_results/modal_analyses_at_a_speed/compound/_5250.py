...
class ConicalGearCompoundModalAnalysisAtASpeed(_5276.GearCompoundModalAnalysisAtASpeed):
    """ConicalGearCompoundModalAnalysisAtASpeed
    ...
    class _Cast_ConicalGearCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ConicalGearCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def conical_gear_compound_modal_analysis_at_a_speed(self) -> 'ConicalGearCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5122.ConicalGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5122.ConicalGearModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'ConicalGearCompoundModalAnalysisAtASpeed._Cast_ConicalGearCompoundModalAnalysisAtASpeed':
