...
from mastapy.nodal_analysis.component_mode_synthesis import _230, _225, _221
...
class CMSModel(_0.APIBase):
    ...
    @property
    def software_used_for_reduction(self) -> '_230.SoftwareUsedForReductionType':
        ...
        value = conversion.pn_to_mp_enum(temp, _230.SoftwareUsedForReductionType)
        return constructor.new_from_mastapy_type(_230.SoftwareUsedForReductionType)(value) if value is not None else None
    ...
    @property
    def fe_model(self) -> '_181.FEModel':
    ...
    @property
    def reduction_information(self) -> '_1567.AnalysisRunInformation':
    ...
    @property
    def reduction_options(self) -> '_225.CMSOptions':
    ...
    @property
    def element_face_groups(self) -> 'List[_221.CMSElementFaceGroup]':
