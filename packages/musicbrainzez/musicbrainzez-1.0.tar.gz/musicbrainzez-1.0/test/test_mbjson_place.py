...
class PlaceTest(unittest.TestCase):
    ...
    def testPlace(self):
        filename = "0c79cdbb-acd6-4e30-aaa3-a5c8d6b36a48-aliases+tags.json"
        p = _common.open_and_parse_test_data(mbjson.JsonParser(), self.datadir, filename)
        ...
        self.assertEqual("All Saints' Durham Road", p["aliases"][0]["name"])
        self.assertEqual("type=church", p["tags"][0]["name"])
        self.assertEqual(1, p["tags"][0]["count"])

    # def testListFromBrowse(self):
    #     filename = "browse-area-74e50e58-5deb-4b99-93a2-decbb365c07f-annotation.json"
