...
from mastapy.gears.rating.virtual_cylindrical_gears import _389, _386
...
class ISO10300MeshSingleFlankRatingMethodB1(_418.ISO10300MeshSingleFlankRating['_386.VirtualCylindricalGearISO10300MethodB1']):
    """ISO10300MeshSingleFlankRatingMethodB1
    ...
    class _Cast_ISO10300MeshSingleFlankRatingMethodB1:
        ...
        def __init__(self, parent: 'ISO10300MeshSingleFlankRatingMethodB1'):
            self._parent = parent
        ...
        @property
        def iso10300_mesh_single_flank_rating_method_b1(self) -> 'ISO10300MeshSingleFlankRatingMethodB1':
            return self._parent
    ...
    @property
    def virtual_cylindrical_gear_set_method_b1(self) -> '_389.VirtualCylindricalGearSetISO10300MethodB1':
    ...
    @property
    def cast_to(self) -> 'ISO10300MeshSingleFlankRatingMethodB1._Cast_ISO10300MeshSingleFlankRatingMethodB1':
