...
class SynchroniserSleeveCompoundParametricStudyTool(_4533.SynchroniserPartCompoundParametricStudyTool):
    """SynchroniserSleeveCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4405.SynchroniserSleeveParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4405.SynchroniserSleeveParametricStudyTool]':
