...
class CylindricalGearPairCreationOptions(_1141.GearSetCreationOptions['_1023.CylindricalGearSetDesign']):
    """CylindricalGearPairCreationOptions
    ...
    class _Cast_CylindricalGearPairCreationOptions:
        ...
        def __init__(self, parent: 'CylindricalGearPairCreationOptions'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_pair_creation_options(self) -> 'CylindricalGearPairCreationOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearPairCreationOptions._Cast_CylindricalGearPairCreationOptions':
