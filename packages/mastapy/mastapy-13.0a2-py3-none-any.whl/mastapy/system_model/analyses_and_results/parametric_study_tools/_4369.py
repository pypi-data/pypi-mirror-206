...
class PartToPartShearCouplingConnectionParametricStudyTool(_4308.CouplingConnectionParametricStudyTool):
    """PartToPartShearCouplingConnectionParametricStudyTool
    ...
    class _Cast_PartToPartShearCouplingConnectionParametricStudyTool:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingConnectionParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_connection_parametric_study_tool(self) -> 'PartToPartShearCouplingConnectionParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingConnectionParametricStudyTool._Cast_PartToPartShearCouplingConnectionParametricStudyTool':
