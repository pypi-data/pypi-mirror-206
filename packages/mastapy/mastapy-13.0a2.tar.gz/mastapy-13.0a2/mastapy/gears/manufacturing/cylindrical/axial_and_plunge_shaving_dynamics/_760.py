...
class ShavingDynamics(_0.APIBase):
    ...
    class _Cast_ShavingDynamics:
        ...
        def conventional_shaving_dynamics(self):
            from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _746
            
            return self._parent._cast(_746.ConventionalShavingDynamics)
        ...
        def plunge_shaver_dynamics(self):
            ...
            return self._parent._cast(_750.PlungeShaverDynamics)
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_1000.CrossedAxisCylindricalGearPairPointContact':
