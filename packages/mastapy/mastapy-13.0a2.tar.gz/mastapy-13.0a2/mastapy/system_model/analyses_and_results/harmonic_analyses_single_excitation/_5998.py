...
class ClutchHarmonicAnalysisOfSingleExcitation(_6014.CouplingHarmonicAnalysisOfSingleExcitation):
    """ClutchHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_ClutchHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'ClutchHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def clutch_harmonic_analysis_of_single_excitation(self) -> 'ClutchHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ClutchHarmonicAnalysisOfSingleExcitation._Cast_ClutchHarmonicAnalysisOfSingleExcitation':
