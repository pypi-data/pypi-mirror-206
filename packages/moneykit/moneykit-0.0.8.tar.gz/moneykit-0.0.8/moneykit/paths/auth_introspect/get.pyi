...
SchemaFor200ResponseBodyApplicationJson = IntrospectClientResponse
...
class InstrospectClient(BaseApi):
    ...
    def instrospect_client(
        ...
        return self._instrospect_client_oapg(
