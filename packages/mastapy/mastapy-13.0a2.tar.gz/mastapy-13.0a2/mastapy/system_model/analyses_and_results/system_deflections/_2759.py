...
class MeasurementComponentSystemDeflection(_2814.VirtualComponentSystemDeflection):
    """MeasurementComponentSystemDeflection
    ...
    class _Cast_MeasurementComponentSystemDeflection:
        ...
        def __init__(self, parent: 'MeasurementComponentSystemDeflection'):
            self._parent = parent
        ...
        @property
        def measurement_component_system_deflection(self) -> 'MeasurementComponentSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4086.MeasurementComponentPowerFlow':
    ...
    @property
    def cast_to(self) -> 'MeasurementComponentSystemDeflection._Cast_MeasurementComponentSystemDeflection':
