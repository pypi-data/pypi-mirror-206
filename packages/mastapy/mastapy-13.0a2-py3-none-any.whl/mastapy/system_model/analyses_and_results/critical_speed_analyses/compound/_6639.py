...
class AbstractAssemblyCompoundCriticalSpeedAnalysis(_6718.PartCompoundCriticalSpeedAnalysis):
    """AbstractAssemblyCompoundCriticalSpeedAnalysis
    ...
    class _Cast_AbstractAssemblyCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'AbstractAssemblyCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def abstract_assembly_compound_critical_speed_analysis(self) -> 'AbstractAssemblyCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6508.AbstractAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6508.AbstractAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'AbstractAssemblyCompoundCriticalSpeedAnalysis._Cast_AbstractAssemblyCompoundCriticalSpeedAnalysis':
