...
class AccountIdsSchema(schemas.ListBase, schemas.NoneBase, schemas.Schema, schemas.NoneTupleMixin):
    class MetaOapg:
...
request_query_account_ids = api_client.QueryParameter(
    name="account_ids",
    style=api_client.ParameterStyle.FORM,
    schema=AccountIdsSchema,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = IdentityResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_identities_oapg(
        ...
        for parameter in (request_query_account_ids,):
...
class GetIdentities(BaseApi):
    ...
    def get_identities(
        ...
        return self._get_identities_oapg(
