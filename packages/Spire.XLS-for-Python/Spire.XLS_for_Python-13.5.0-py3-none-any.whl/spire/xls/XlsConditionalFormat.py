...
class XlsConditionalFormat (  XlsObject, IConditionalFormat, ICloneParent) :
    ...
    def IconSet(self)->'IconSet':
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_IconSet(self.Ptr)
    ...
    <returns>ColorScale instance</returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_ColorScale(self.Ptr)
    ...
    def NumberFormat(self)->str:
        ...
        GetDllLibXls().XlsConditionalFormat_get_NumberFormat.restype=c_wchar_p
        ret = GetDllLibXls().XlsConditionalFormat_get_NumberFormat(self.Ptr)
        return ret
    ...
    def NumberFormat(self, value:str):
        ...
        GetDllLibXls().XlsConditionalFormat_set_NumberFormat(self.Ptr, value)
    ...
    def IsNumberFormatPresent(self)->bool:
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsNumberFormatPresent(self.Ptr)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = GetDllLibXls().XlsConditionalFormat_GetHashCode(self.Ptr)
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibXls().XlsConditionalFormat_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <returns>A new object that is a copy of this instance.</returns>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_Clone(self.Ptr, intPtrparent)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_OColor(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_BackColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_TopBorderColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_BottomBorderColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_LeftBorderColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_RightBorderColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_FontColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def MakeFormula(self)->str:
        ...
        GetDllLibXls().XlsConditionalFormat_MakeFormula.restype=c_wchar_p
        ret = GetDllLibXls().XlsConditionalFormat_MakeFormula(self.Ptr)
        return ret
    ...
    def MakeFormula(self ,para:str)->str:
        ...
        GetDllLibXls().XlsConditionalFormat_MakeFormulaP.restype=c_wchar_p
        ret = GetDllLibXls().XlsConditionalFormat_MakeFormulaP(self.Ptr, para)
        return ret
    ...
    def MakeFormula(self ,para:float)->str:
        ...
        GetDllLibXls().XlsConditionalFormat_MakeFormulaP1.restype=c_wchar_p
        ret = GetDllLibXls().XlsConditionalFormat_MakeFormulaP1(self.Ptr, para)
        return ret
    ...
    def UpdateFormula(self ,iCurIndex:int,iSourceIndex:int,sourceRect:'Rectangle',iDestIndex:int,destRect:'Rectangle',row:int,column:int):
        ...
        GetDllLibXls().XlsConditionalFormat_UpdateFormula(self.Ptr, iCurIndex,iSourceIndex,intPtrsourceRect,iDestIndex,intPtrdestRect,row,column)
    ...
    def Priority(self)->int:
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_Priority(self.Ptr)
        return ret

    @Priority.setter
    def Priority(self, value:int):
        GetDllLibXls().XlsConditionalFormat_set_Priority.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsConditionalFormat_set_Priority(self.Ptr, value)
    ...
    def StopIfTrue(self)->bool:
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_StopIfTrue(self.Ptr)
        return ret

    @StopIfTrue.setter
    def StopIfTrue(self, value:bool):
        GetDllLibXls().XlsConditionalFormat_set_StopIfTrue.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsConditionalFormat_set_StopIfTrue(self.Ptr, value)
    ...
    def DxfId(self)->int:
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_DxfId(self.Ptr)
        return ret

    @DxfId.setter
    def DxfId(self, value:int):
        GetDllLibXls().XlsConditionalFormat_set_DxfId.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsConditionalFormat_set_DxfId(self.Ptr, value)
    ...
    def Average(self)->'Average':
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_Average(self.Ptr)
    ...
    def TopBottom(self)->'TopBottom':
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_TopBottom(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_LeftBorderKnownColor(self.Ptr)
    ...
    def LeftBorderKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_LeftBorderKnownColor(self.Ptr, value.value)
    ...
    def LeftBorderColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_LeftBorderColor(self.Ptr)
    ...
    def LeftBorderColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_LeftBorderColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_LeftBorderStyle(self.Ptr)
    ...
    def LeftBorderStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_LeftBorderStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_RightBorderKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def RightBorderKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_RightBorderKnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_RightBorderColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def RightBorderColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_RightBorderColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_RightBorderStyle(self.Ptr)
        objwraped = LineStyleType(ret)
        return objwraped
    ...
    def RightBorderStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_RightBorderStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_TopBorderKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def TopBorderKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_TopBorderKnownColor(self.Ptr, value.value)
    ...
    def TopBorderColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_TopBorderColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def TopBorderColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_TopBorderColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_TopBorderStyle(self.Ptr)
        objwraped = LineStyleType(ret)
        return objwraped
    ...
    def TopBorderStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_TopBorderStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_BottomBorderKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def BottomBorderKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_BottomBorderKnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_BottomBorderColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def BottomBorderColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_BottomBorderColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_BottomBorderStyle(self.Ptr)
        objwraped = LineStyleType(ret)
        return objwraped
    ...
    def BottomBorderStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_BottomBorderStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsConditionalFormat_get_FirstFormula.restype=c_wchar_p
        ret = GetDllLibXls().XlsConditionalFormat_get_FirstFormula(self.Ptr)
        return ret
    ...
    def FirstFormula(self, value:str):
        ...
        GetDllLibXls().XlsConditionalFormat_set_FirstFormula(self.Ptr, value)
    ...
    def FirstFormulaR1C1(self)->str:
        ...
        GetDllLibXls().XlsConditionalFormat_get_FirstFormulaR1C1.restype=c_wchar_p
        ret = GetDllLibXls().XlsConditionalFormat_get_FirstFormulaR1C1(self.Ptr)
        return ret
    ...
    def FirstFormulaR1C1(self, value:str):
        ...
        GetDllLibXls().XlsConditionalFormat_set_FirstFormulaR1C1(self.Ptr, value)
    ...
    def SetTimePeriod(self ,timePeriod:'TimePeriodType'):
        ...
        GetDllLibXls().XlsConditionalFormat_SetTimePeriod(self.Ptr, enumtimePeriod)
    ...
    <summary>
        ...
        GetDllLibXls().XlsConditionalFormat_get_SecondFormula.restype=c_wchar_p
        ret = GetDllLibXls().XlsConditionalFormat_get_SecondFormula(self.Ptr)
        return ret
    ...
    def SecondFormula(self, value:str):
        ...
        GetDllLibXls().XlsConditionalFormat_set_SecondFormula(self.Ptr, value)
    ...
    def SecondFormulaR1C1(self)->str:
        ...
        GetDllLibXls().XlsConditionalFormat_get_SecondFormulaR1C1.restype=c_wchar_p
        ret = GetDllLibXls().XlsConditionalFormat_get_SecondFormulaR1C1(self.Ptr)
        return ret
    ...
    def SecondFormulaR1C1(self, value:str):
        ...
        GetDllLibXls().XlsConditionalFormat_set_SecondFormulaR1C1(self.Ptr, value)
    ...
    def FormatType(self)->'ConditionalFormatType':
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_FormatType(self.Ptr)
    ...
    def FormatType(self, value:'ConditionalFormatType'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_FormatType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_Operator(self.Ptr)
    ...
    def Operator(self, value:'ComparisonOperatorType'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_Operator(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsBold(self.Ptr)
        return ret

    @IsBold.setter
    def IsBold(self, value:bool):
        GetDllLibXls().XlsConditionalFormat_set_IsBold.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsConditionalFormat_set_IsBold(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsItalic(self.Ptr)
        return ret

    @IsItalic.setter
    def IsItalic(self, value:bool):
        GetDllLibXls().XlsConditionalFormat_set_IsItalic.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsConditionalFormat_set_IsItalic(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_FontKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def FontKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_FontKnownColor(self.Ptr, value.value)
    ...
    def FontColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_FontColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def FontColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_FontColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_Underline(self.Ptr)
    ...
    def Underline(self, value:'FontUnderlineType'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_Underline(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsStrikeThrough(self.Ptr)
        return ret
    ...
    def IsStrikeThrough(self, value:bool):
        ...
        GetDllLibXls().XlsConditionalFormat_set_IsStrikeThrough(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsSuperScript(self.Ptr)
        return ret
    ...
    def IsSuperScript(self, value:bool):
        ...
        GetDllLibXls().XlsConditionalFormat_set_IsSuperScript(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsSubScript(self.Ptr)
        return ret

    @IsSubScript.setter
    def IsSubScript(self, value:bool):
        GetDllLibXls().XlsConditionalFormat_set_IsSubScript.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsConditionalFormat_set_IsSubScript(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_KnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_KnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_Color(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_Color(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_BackKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def BackKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_BackKnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_BackColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def BackColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_BackColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_FillPattern(self.Ptr)
    ...
    def FillPattern(self, value:'ExcelPatternType'):
        ...
        GetDllLibXls().XlsConditionalFormat_set_FillPattern(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsFontFormatPresent(self.Ptr)
        return ret
    ...
    def IsFontFormatPresent(self, value:bool):
        ...
        GetDllLibXls().XlsConditionalFormat_set_IsFontFormatPresent(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsBorderFormatPresent(self.Ptr)
        return ret
    ...
    def IsBorderFormatPresent(self, value:bool):
        ...
        GetDllLibXls().XlsConditionalFormat_set_IsBorderFormatPresent(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsPatternFormatPresent(self.Ptr)
        return ret
    ...
    def IsPatternFormatPresent(self, value:bool):
        ...
        GetDllLibXls().XlsConditionalFormat_set_IsPatternFormatPresent(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsFontColorPresent(self.Ptr)
        return ret
    ...
    def IsFontColorPresent(self, value:bool):
        ...
        GetDllLibXls().XlsConditionalFormat_set_IsFontColorPresent(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsPatternColorPresent(self.Ptr)
        return ret
    ...
    def IsPatternColorPresent(self, value:bool):
        ...
        GetDllLibXls().XlsConditionalFormat_set_IsPatternColorPresent(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsPatternStyleModified(self.Ptr)
        return ret
    ...
    def IsPatternStyleModified(self, value:bool):
        ...
        GetDllLibXls().XlsConditionalFormat_set_IsPatternStyleModified(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsBackgroundColorPresent(self.Ptr)
        return ret
    ...
    def IsBackgroundColorPresent(self, value:bool):
        ...
        GetDllLibXls().XlsConditionalFormat_set_IsBackgroundColorPresent(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsLeftBorderModified(self.Ptr)
        return ret
    ...
    def IsLeftBorderModified(self, value:bool):
        ...
        GetDllLibXls().XlsConditionalFormat_set_IsLeftBorderModified(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsRightBorderModified(self.Ptr)
        return ret
    ...
    def IsRightBorderModified(self, value:bool):
        ...
        GetDllLibXls().XlsConditionalFormat_set_IsRightBorderModified(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsTopBorderModified(self.Ptr)
        return ret
    ...
    def IsTopBorderModified(self, value:bool):
        ...
        GetDllLibXls().XlsConditionalFormat_set_IsTopBorderModified(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsConditionalFormat_get_IsBottomBorderModified(self.Ptr)
        return ret
    ...
    def IsBottomBorderModified(self, value:bool):
        ...
        GetDllLibXls().XlsConditionalFormat_set_IsBottomBorderModified(self.Ptr, value)
    ...
    def DataBar(self)->'DataBar':
        ...
        intPtr = GetDllLibXls().XlsConditionalFormat_get_DataBar(self.Ptr)
