...
class LoadedTiltingPadThrustBearingResults(_2106.LoadedPadFluidFilmBearingResults):
    """LoadedTiltingPadThrustBearingResults
    ...
    class _Cast_LoadedTiltingPadThrustBearingResults:
        ...
        def __init__(self, parent: 'LoadedTiltingPadThrustBearingResults'):
            self._parent = parent
        ...
        @property
        def loaded_tilting_pad_thrust_bearing_results(self) -> 'LoadedTiltingPadThrustBearingResults':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'LoadedTiltingPadThrustBearingResults._Cast_LoadedTiltingPadThrustBearingResults':
