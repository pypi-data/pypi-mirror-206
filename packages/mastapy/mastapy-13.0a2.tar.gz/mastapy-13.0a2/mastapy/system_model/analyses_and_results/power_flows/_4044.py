...
class ConnectionPowerFlow(_7503.ConnectionStaticLoadAnalysisCase):
    """ConnectionPowerFlow
    ...
    class _Cast_ConnectionPowerFlow:
        ...
        def __init__(self, parent: 'ConnectionPowerFlow'):
            self._parent = parent
        ...
        @property
        def connection_power_flow(self) -> 'ConnectionPowerFlow':
            return self._parent
    ...
    @property
    def torsional_system_deflection_analysis(self) -> '_2706.ConnectionSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'ConnectionPowerFlow._Cast_ConnectionPowerFlow':
