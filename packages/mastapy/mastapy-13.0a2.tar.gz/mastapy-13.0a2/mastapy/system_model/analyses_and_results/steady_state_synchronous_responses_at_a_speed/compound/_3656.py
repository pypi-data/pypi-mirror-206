...
class CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3711.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def cycloidal_assembly_compound_steady_state_synchronous_response_at_a_speed(self) -> 'CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3526.CycloidalAssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3526.CycloidalAssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed._Cast_CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed(self)
