...
class NamedRangeWithOverridableMinAndMax(_0.APIBase, Generic[T, TMeasurement]):
    ...
    class _Cast_NamedRangeWithOverridableMinAndMax:
        ...
        def __init__(self, parent: 'NamedRangeWithOverridableMinAndMax'):
            self._parent = parent

        @property
        def named_range_with_overridable_min_and_max(self) -> 'NamedRangeWithOverridableMinAndMax':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'NamedRangeWithOverridableMinAndMax._Cast_NamedRangeWithOverridableMinAndMax':
