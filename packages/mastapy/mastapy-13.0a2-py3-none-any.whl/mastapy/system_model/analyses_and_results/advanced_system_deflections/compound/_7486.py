...
class TorqueConverterConnectionCompoundAdvancedSystemDeflection(_7406.CouplingConnectionCompoundAdvancedSystemDeflection):
    """TorqueConverterConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7356.TorqueConverterConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7356.TorqueConverterConnectionAdvancedSystemDeflection]':
