...
class MeasurementComponentCompoundSteadyStateSynchronousResponse(_3217.VirtualComponentCompoundSteadyStateSynchronousResponse):
    """MeasurementComponentCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_MeasurementComponentCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'MeasurementComponentCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def measurement_component_compound_steady_state_synchronous_response(self) -> 'MeasurementComponentCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3039.MeasurementComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3039.MeasurementComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'MeasurementComponentCompoundSteadyStateSynchronousResponse._Cast_MeasurementComponentCompoundSteadyStateSynchronousResponse':
        return self._Cast_MeasurementComponentCompoundSteadyStateSynchronousResponse(self)
