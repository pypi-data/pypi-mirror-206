...
from mastapy.system_model.analyses_and_results.parametric_study_tools import (
    _4325, _4279, _4281, _4284,
    _4290, _4291, _4312, _4294,
    _4299, _4302, _4314, _4316,
    _4320, _4334, _4333, _4335,
    _4342, _4349, _4352, _4353,
    _4354, _4357, _4371, _4374,
    _4375, _4376, _4378, _4380,
    _4384, _4385, _4390, _4393,
    _4396, _4399, _4403, _4407,
    _4410, _4414, _4417, _4271
)
...
class AssemblyParametricStudyTool(_4271.AbstractAssemblyParametricStudyTool):
    """AssemblyParametricStudyTool
    ...
    class _Cast_AssemblyParametricStudyTool:
        ...
        def __init__(self, parent: 'AssemblyParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def assembly_parametric_study_tool(self) -> 'AssemblyParametricStudyTool':
            return self._parent
    ...
    @property
    def all_duty_cycle_results(self) -> 'List[_4325.DutyCycleResultsForAllComponents]':
    ...
    @property
    def bearings(self) -> 'List[_4279.BearingParametricStudyTool]':
    ...
    @property
    def belt_drives(self) -> 'List[_4281.BeltDriveParametricStudyTool]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4284.BevelDifferentialGearSetParametricStudyTool]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4290.BoltedJointParametricStudyTool]':
    ...
    @property
    def bolts(self) -> 'List[_4291.BoltParametricStudyTool]':
    ...
    @property
    def cv_ts(self) -> 'List[_4312.CVTParametricStudyTool]':
    ...
    @property
    def clutches(self) -> 'List[_4294.ClutchParametricStudyTool]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4299.ConceptCouplingParametricStudyTool]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4302.ConceptGearSetParametricStudyTool]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4314.CycloidalAssemblyParametricStudyTool]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4316.CycloidalDiscParametricStudyTool]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4320.CylindricalGearSetParametricStudyTool]':
    ...
    @property
    def fe_parts(self) -> 'List[_4334.FEPartParametricStudyTool]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4333.FaceGearSetParametricStudyTool]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4335.FlexiblePinAssemblyParametricStudyTool]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4342.HypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4349.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4352.KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def mass_discs(self) -> 'List[_4353.MassDiscParametricStudyTool]':
    ...
    @property
    def measurement_components(self) -> 'List[_4354.MeasurementComponentParametricStudyTool]':
    ...
    @property
    def oil_seals(self) -> 'List[_4357.OilSealParametricStudyTool]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4371.PartToPartShearCouplingParametricStudyTool]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4374.PlanetCarrierParametricStudyTool]':
    ...
    @property
    def point_loads(self) -> 'List[_4375.PointLoadParametricStudyTool]':
    ...
    @property
    def power_loads(self) -> 'List[_4376.PowerLoadParametricStudyTool]':
    ...
    @property
    def ring_pins(self) -> 'List[_4378.RingPinsParametricStudyTool]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4380.RollingRingAssemblyParametricStudyTool]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4384.ShaftHubConnectionParametricStudyTool]':
    ...
    @property
    def shafts(self) -> 'List[_4385.ShaftParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4390.SpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4393.SpringDamperParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4396.StraightBevelDiffGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4399.StraightBevelGearSetParametricStudyTool]':
    ...
    @property
    def synchronisers(self) -> 'List[_4403.SynchroniserParametricStudyTool]':
    ...
    @property
    def torque_converters(self) -> 'List[_4407.TorqueConverterParametricStudyTool]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4410.UnbalancedMassParametricStudyTool]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4414.WormGearSetParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4417.ZerolBevelGearSetParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'AssemblyParametricStudyTool._Cast_AssemblyParametricStudyTool':
