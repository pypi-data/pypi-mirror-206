...
class BeltConnectionModalAnalysisAtASpeed(_5154.InterMountableComponentConnectionModalAnalysisAtASpeed):
    """BeltConnectionModalAnalysisAtASpeed
    ...
    class _Cast_BeltConnectionModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'BeltConnectionModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def belt_connection_modal_analysis_at_a_speed(self) -> 'BeltConnectionModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BeltConnectionModalAnalysisAtASpeed._Cast_BeltConnectionModalAnalysisAtASpeed':
