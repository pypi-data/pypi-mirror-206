...
class TorqueConverterPumpCompoundSystemDeflection(_2869.CouplingHalfCompoundSystemDeflection):
    """TorqueConverterPumpCompoundSystemDeflection
    ...
    class _Cast_TorqueConverterPumpCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'TorqueConverterPumpCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def torque_converter_pump_compound_system_deflection(self) -> 'TorqueConverterPumpCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2808.TorqueConverterPumpSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2808.TorqueConverterPumpSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterPumpCompoundSystemDeflection._Cast_TorqueConverterPumpCompoundSystemDeflection':
