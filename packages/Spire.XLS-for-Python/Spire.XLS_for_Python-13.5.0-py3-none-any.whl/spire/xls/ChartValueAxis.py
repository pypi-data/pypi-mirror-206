...
class ChartValueAxis (  XlsChartValueAxis) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartValueAxis_get_Font(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartValueAxis_get_MajorGridLines(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartValueAxis_get_MinorGridLines(self.Ptr)
        ret = None if intPtr==None else ChartGridLine(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartValueAxis_get_TitleArea(self.Ptr)
    ...
    def DefaultValueAxisId()->int:
        ...
        ret = GetDllLibXls().ChartValueAxis_DefaultValueAxisId()
        return ret
    ...
    def DefaultSecondaryValueAxisId()->int:
        ...
        ret = GetDllLibXls().ChartValueAxis_DefaultSecondaryValueAxisId()
        return ret
