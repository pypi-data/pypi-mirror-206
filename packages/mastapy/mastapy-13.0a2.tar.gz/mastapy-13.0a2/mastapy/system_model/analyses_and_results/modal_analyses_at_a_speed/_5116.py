...
class ConceptCouplingHalfModalAnalysisAtASpeed(_5127.CouplingHalfModalAnalysisAtASpeed):
    """ConceptCouplingHalfModalAnalysisAtASpeed
    ...
    class _Cast_ConceptCouplingHalfModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ConceptCouplingHalfModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def concept_coupling_half_modal_analysis_at_a_speed(self) -> 'ConceptCouplingHalfModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHalfModalAnalysisAtASpeed._Cast_ConceptCouplingHalfModalAnalysisAtASpeed':
