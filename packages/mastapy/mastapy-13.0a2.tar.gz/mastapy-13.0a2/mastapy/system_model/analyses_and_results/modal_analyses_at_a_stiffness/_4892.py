...
class GuideDxfModelModalAnalysisAtAStiffness(_4855.ComponentModalAnalysisAtAStiffness):
    """GuideDxfModelModalAnalysisAtAStiffness
    ...
    class _Cast_GuideDxfModelModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'GuideDxfModelModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def guide_dxf_model_modal_analysis_at_a_stiffness(self) -> 'GuideDxfModelModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GuideDxfModelModalAnalysisAtAStiffness._Cast_GuideDxfModelModalAnalysisAtAStiffness':
