...
class RTFStringArray (  XlsObject, IRichTextString, IOptimizedUpdate) :
    ...
    def GetFont(self ,iPosition:int)->'IFont':
        ...
        intPtr = GetDllLibXls().RTFStringArray_GetFont(self.Ptr, iPosition)
    ...
    def SetFont(self ,iStartPos:int,iEndPos:int,font:'IFont'):
        ...
        GetDllLibXls().RTFStringArray_SetFont(self.Ptr, iStartPos,iEndPos,intPtrfont)
    ...
    def ClearFormatting(self):
        ...
        GetDllLibXls().RTFStringArray_ClearFormatting(self.Ptr)
    ...
    def Append(self ,text:str,font:'IFont'):
        ...
        GetDllLibXls().RTFStringArray_Append(self.Ptr, text,intPtrfont)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().RTFStringArray_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().RTFStringArray_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().RTFStringArray_set_Text(self.Ptr, value)
    ...
    def RtfText(self)->str:
        ...
        GetDllLibXls().RTFStringArray_get_RtfText.restype=c_wchar_p
        ret = GetDllLibXls().RTFStringArray_get_RtfText(self.Ptr)
        return ret
    ...
    def IsFormatted(self)->bool:
        ...
        ret = GetDllLibXls().RTFStringArray_get_IsFormatted(self.Ptr)
        return ret
    ...
    def Clear(self):
        ...
        GetDllLibXls().RTFStringArray_Clear(self.Ptr)
...
<summary></summary>
        ...
        GetDllLibXls().RTFStringArray_BeginUpdate(self.Ptr)
...
<summary></summary>
        ...
        GetDllLibXls().RTFStringArray_EndUpdate(self.Ptr)
