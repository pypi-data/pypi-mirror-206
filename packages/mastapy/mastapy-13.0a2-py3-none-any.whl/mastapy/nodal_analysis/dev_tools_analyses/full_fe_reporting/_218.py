...
class ShearModulusOrthotropicComponents(_0.APIBase):
    ...
    class _Cast_ShearModulusOrthotropicComponents:
        ...
        def __init__(self, parent: 'ShearModulusOrthotropicComponents'):
            self._parent = parent

        @property
        def shear_modulus_orthotropic_components(self) -> 'ShearModulusOrthotropicComponents':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShearModulusOrthotropicComponents._Cast_ShearModulusOrthotropicComponents':
