...
class CylindricalGearShaperTangible(_718.CutterShapeDefinition):
    """CylindricalGearShaperTangible
    ...
    class _Cast_CylindricalGearShaperTangible:
        ...
        def __init__(self, parent: 'CylindricalGearShaperTangible'):
            self._parent = parent

        @property
        def cutter_shape_definition(self):
            return self._parent._cast(_718.CutterShapeDefinition)

        @property
        def cylindrical_gear_shaper_tangible(self) -> 'CylindricalGearShaperTangible':
            return self._parent
    ...
    @property
    def design(self) -> '_709.CylindricalGearShaper':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearShaperTangible._Cast_CylindricalGearShaperTangible':
