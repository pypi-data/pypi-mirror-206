...
class MassDiscPowerFlow(_4135.VirtualComponentPowerFlow):
    """MassDiscPowerFlow
    ...
    class _Cast_MassDiscPowerFlow:
        ...
        def __init__(self, parent: 'MassDiscPowerFlow'):
            self._parent = parent
        ...
        @property
        def mass_disc_power_flow(self) -> 'MassDiscPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MassDiscPowerFlow._Cast_MassDiscPowerFlow':
