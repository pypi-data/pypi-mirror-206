...
class PointLoadSystemDeflection(_2814.VirtualComponentSystemDeflection):
    """PointLoadSystemDeflection
    ...
    class _Cast_PointLoadSystemDeflection:
        ...
        def __init__(self, parent: 'PointLoadSystemDeflection'):
            self._parent = parent
        ...
        @property
        def point_load_system_deflection(self) -> 'PointLoadSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4096.PointLoadPowerFlow':
    ...
    @property
    def cast_to(self) -> 'PointLoadSystemDeflection._Cast_PointLoadSystemDeflection':
