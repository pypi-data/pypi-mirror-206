...
class TorqueConverterConnectionSteadyStateSynchronousResponse(_2999.CouplingConnectionSteadyStateSynchronousResponse):
    """TorqueConverterConnectionSteadyStateSynchronousResponse
    ...
    class _Cast_TorqueConverterConnectionSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'TorqueConverterConnectionSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def torque_converter_connection_steady_state_synchronous_response(self) -> 'TorqueConverterConnectionSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterConnectionSteadyStateSynchronousResponse._Cast_TorqueConverterConnectionSteadyStateSynchronousResponse':
