...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5068, _5069, _4978
...
class StraightBevelGearSetCompoundModalAnalysisAtAStiffness(_4978.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """StraightBevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_StraightBevelGearSetCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'StraightBevelGearSetCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_set_compound_modal_analysis_at_a_stiffness(self) -> 'StraightBevelGearSetCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4941.StraightBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5068.StraightBevelGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5069.StraightBevelGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4941.StraightBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSetCompoundModalAnalysisAtAStiffness._Cast_StraightBevelGearSetCompoundModalAnalysisAtAStiffness':
