...
class CylindricalGearMeshCompoundStabilityAnalysis(_3933.GearMeshCompoundStabilityAnalysis):
    """CylindricalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3790.CylindricalGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3790.CylindricalGearMeshStabilityAnalysis]':
