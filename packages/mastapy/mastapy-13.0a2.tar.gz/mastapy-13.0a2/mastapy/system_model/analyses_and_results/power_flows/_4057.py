...
class CylindricalGearMeshPowerFlow(_4068.GearMeshPowerFlow):
    """CylindricalGearMeshPowerFlow
    ...
    class _Cast_CylindricalGearMeshPowerFlow:
        ...
        def __init__(self, parent: 'CylindricalGearMeshPowerFlow'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_power_flow(self) -> 'CylindricalGearMeshPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshPowerFlow._Cast_CylindricalGearMeshPowerFlow':
