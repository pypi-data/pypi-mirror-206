...
class ConceptGearHarmonicAnalysisOfSingleExcitation(_6033.GearHarmonicAnalysisOfSingleExcitation):
    """ConceptGearHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_ConceptGearHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'ConceptGearHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def concept_gear_harmonic_analysis_of_single_excitation(self) -> 'ConceptGearHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptGearHarmonicAnalysisOfSingleExcitation._Cast_ConceptGearHarmonicAnalysisOfSingleExcitation':
