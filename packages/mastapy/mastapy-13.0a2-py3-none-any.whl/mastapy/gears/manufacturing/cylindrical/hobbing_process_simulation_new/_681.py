...
T = TypeVar('T', bound='_680.ProcessSimulationInput')
...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    class _Cast_ProcessSimulationNew:
        ...
        def __init__(self, parent: 'ProcessSimulationNew'):
            self._parent = parent

        @property
        def hobbing_process_simulation_new(self):
            from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _668
            
            return self._parent._cast(_668.HobbingProcessSimulationNew)

        @property
        def worm_grinding_process_simulation_new(self):
            from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _695
            
            return self._parent._cast(_695.WormGrindingProcessSimulationNew)

        @property
        def process_simulation_new(self) -> 'ProcessSimulationNew':
            return self._parent
    ...
    @property
    def achieved_agma20151a01_quality_grade(self) -> 'float':
        """float: 'AchievedAGMA20151A01QualityGrade' is the original name of this property.
    ...
    @property
    def gear_tooth_shape_calculation(self) -> '_676.ProcessGearShape':
    ...
    @property
    def lead_calculation(self) -> '_677.ProcessLeadCalculation':
    ...
    @property
    def pitch_calculation(self) -> '_678.ProcessPitchCalculation':
    ...
    @property
    def profile_calculation(self) -> '_679.ProcessProfileCalculation':
    ...
    @property
    def total_modification_calculation(self) -> '_683.ProcessTotalModificationCalculation':
    ...
    @property
    def cast_to(self) -> 'ProcessSimulationNew._Cast_ProcessSimulationNew':
