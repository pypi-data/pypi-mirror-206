...
class SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed(_3598.SynchroniserPartSteadyStateSynchronousResponseAtASpeed):
    """SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def synchroniser_sleeve_steady_state_synchronous_response_at_a_speed(self) -> 'SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed._Cast_SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed':
