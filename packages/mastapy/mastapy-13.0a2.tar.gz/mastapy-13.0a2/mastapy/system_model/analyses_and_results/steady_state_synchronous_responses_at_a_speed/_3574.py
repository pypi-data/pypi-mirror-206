...
class RollingRingAssemblySteadyStateSynchronousResponseAtASpeed(_3581.SpecialisedAssemblySteadyStateSynchronousResponseAtASpeed):
    """RollingRingAssemblySteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_RollingRingAssemblySteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'RollingRingAssemblySteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def rolling_ring_assembly_steady_state_synchronous_response_at_a_speed(self) -> 'RollingRingAssemblySteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingAssemblySteadyStateSynchronousResponseAtASpeed._Cast_RollingRingAssemblySteadyStateSynchronousResponseAtASpeed':
        return self._Cast_RollingRingAssemblySteadyStateSynchronousResponseAtASpeed(self)
