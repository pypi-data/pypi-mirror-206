...
class ExcelCommentObject (  SpireObject, IComment) :
    ...
    def SetCommentLocation(self ,isMoveWithCell:bool,isSizeWithCell:bool):
        ...
        GetDllLibXls().ExcelCommentObject_SetCommentLocation(self.Ptr, isMoveWithCell,isSizeWithCell)
    ...
    <summary>
        ...
        GetDllLibXls().ExcelCommentObject_get_Author.restype=c_wchar_p
        ret = GetDllLibXls().ExcelCommentObject_get_Author(self.Ptr)
        return ret
    ...
    def Author(self, value:str):
        ...
        GetDllLibXls().ExcelCommentObject_set_Author(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_IsVisible(self.Ptr)
        return ret

    @IsVisible.setter
    def IsVisible(self, value:bool):
        GetDllLibXls().ExcelCommentObject_set_IsVisible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ExcelCommentObject_set_IsVisible(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().ExcelCommentObject_get_HtmlString.restype=c_wchar_p
        ret = GetDllLibXls().ExcelCommentObject_get_HtmlString(self.Ptr)
        return ret
    ...
    def HtmlString(self, value:str):
        ...
        GetDllLibXls().ExcelCommentObject_set_HtmlString(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_Row(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_Column(self.Ptr)
        return ret
    ...
    def RichText(self)->'IRichTextString':
        ...
        intPtr = GetDllLibXls().ExcelCommentObject_get_RichText(self.Ptr)
    ...
    def Line(self)->'IShapeLineFormat':
        ...
        intPtr = GetDllLibXls().ExcelCommentObject_get_Line(self.Ptr)
    ...
    def Fill(self)->'IShapeFill':
        ...
        intPtr = GetDllLibXls().ExcelCommentObject_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().ExcelCommentObject_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().ExcelCommentObject_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().ExcelCommentObject_set_Text(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_AutoSize(self.Ptr)
        return ret

    @AutoSize.setter
    def AutoSize(self, value:bool):
        GetDllLibXls().ExcelCommentObject_set_AutoSize.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ExcelCommentObject_set_AutoSize(self.Ptr, value)
    ...
    def TextFrame(self)->'ITextFrame':
        ...
        intPtr = GetDllLibXls().ExcelCommentObject_get_TextFrame(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_ResizeBehave(self.Ptr)
    ...
    def ResizeBehave(self, value:'ResizeBehaveType'):
        ...
        GetDllLibXls().ExcelCommentObject_set_ResizeBehave(self.Ptr, value.value)
    ...
    def Visible(self)->bool:
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_Visible(self.Ptr)
        return ret

    @Visible.setter
    def Visible(self, value:bool):
        GetDllLibXls().ExcelCommentObject_set_Visible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ExcelCommentObject_set_Visible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:int):
        GetDllLibXls().ExcelCommentObject_set_Height.argtypes=[c_void_p, c_int]
        GetDllLibXls().ExcelCommentObject_set_Height(self.Ptr, value)
    ...
    def HAlignment(self)->'CommentHAlignType':
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_HAlignment(self.Ptr)
    ...
    def HAlignment(self, value:'CommentHAlignType'):
        ...
        GetDllLibXls().ExcelCommentObject_set_HAlignment(self.Ptr, value.value)
    ...
    def VAlignment(self)->'CommentVAlignType':
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_VAlignment(self.Ptr)
    ...
    def VAlignment(self, value:'CommentVAlignType'):
        ...
        GetDllLibXls().ExcelCommentObject_set_VAlignment(self.Ptr, value.value)
    ...
    def TextRotation(self)->'TextRotationType':
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_TextRotation(self.Ptr)
    ...
    def TextRotation(self, value:'TextRotationType'):
        ...
        GetDllLibXls().ExcelCommentObject_set_TextRotation(self.Ptr, value.value)
    ...
    def ID(self)->int:
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_ID(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:int):
        GetDllLibXls().ExcelCommentObject_set_Left.argtypes=[c_void_p, c_int]
        GetDllLibXls().ExcelCommentObject_set_Left(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().ExcelCommentObject_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().ExcelCommentObject_get_Name(self.Ptr)
        return ret
    ...
    def Name(self, value:str):
        ...
        GetDllLibXls().ExcelCommentObject_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:int):
        GetDllLibXls().ExcelCommentObject_set_Top.argtypes=[c_void_p, c_int]
        GetDllLibXls().ExcelCommentObject_set_Top(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:int):
        GetDllLibXls().ExcelCommentObject_set_Width.argtypes=[c_void_p, c_int]
        GetDllLibXls().ExcelCommentObject_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_ShapeType(self.Ptr)
    ...
    def ShapeType(self, value:'ExcelShapeType'):
        ...
        GetDllLibXls().ExcelCommentObject_set_ShapeType(self.Ptr, value.value)
    ...
    def IsLocked(self)->bool:
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_IsLocked(self.Ptr)
        return ret

    @IsLocked.setter
    def IsLocked(self, value:bool):
        GetDllLibXls().ExcelCommentObject_set_IsLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ExcelCommentObject_set_IsLocked(self.Ptr, value)
    ...
    def IsPrintable(self)->bool:
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_IsPrintable(self.Ptr)
        return ret

    @IsPrintable.setter
    def IsPrintable(self, value:bool):
        GetDllLibXls().ExcelCommentObject_set_IsPrintable.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ExcelCommentObject_set_IsPrintable(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().ExcelCommentObject_get_AlternativeText.restype=c_wchar_p
        ret = GetDllLibXls().ExcelCommentObject_get_AlternativeText(self.Ptr)
        return ret
    ...
    def AlternativeText(self, value:str):
        ...
        GetDllLibXls().ExcelCommentObject_set_AlternativeText(self.Ptr, value)
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().ExcelCommentObject_get_Parent(self.Ptr)
    ...
    def IsTextLocked(self)->bool:
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_IsTextLocked(self.Ptr)
        return ret

    @IsTextLocked.setter
    def IsTextLocked(self, value:bool):
        GetDllLibXls().ExcelCommentObject_set_IsTextLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().ExcelCommentObject_set_IsTextLocked(self.Ptr, value)
    ...
    def IsSmartArt(self)->bool:
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_IsSmartArt(self.Ptr)
        return ret
    ...
    def OnAction(self)->str:
        ...
        GetDllLibXls().ExcelCommentObject_get_OnAction.restype=c_wchar_p
        ret = GetDllLibXls().ExcelCommentObject_get_OnAction(self.Ptr)
        return ret
    ...
    def OnAction(self, value:str):
        ...
        GetDllLibXls().ExcelCommentObject_set_OnAction(self.Ptr, value)
    ...
    def IsLockAspectRatio(self)->bool:
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_IsLockAspectRatio(self.Ptr)
        return ret
    ...
    def IsLockAspectRatio(self, value:bool):
        ...
        GetDllLibXls().ExcelCommentObject_set_IsLockAspectRatio(self.Ptr, value)
    ...
    def Shadow(self)->'IShadow':
        ...
        intPtr = GetDllLibXls().ExcelCommentObject_get_Shadow(self.Ptr)
    ...
    def Glow(self)->'IGlow':
        ...
        intPtr = GetDllLibXls().ExcelCommentObject_get_Glow(self.Ptr)
    ...
    def Reflection(self)->'IReflectionEffect':
        ...
        intPtr = GetDllLibXls().ExcelCommentObject_get_Reflection(self.Ptr)
    ...
    def ThreeD(self)->'IFormat3D':
        ...
        intPtr = GetDllLibXls().ExcelCommentObject_get_ThreeD(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().ExcelCommentObject_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:int):
        GetDllLibXls().ExcelCommentObject_set_Rotation.argtypes=[c_void_p, c_int]
        GetDllLibXls().ExcelCommentObject_set_Rotation(self.Ptr, value)
    ...
    def LinkedCell(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().ExcelCommentObject_get_LinkedCell(self.Ptr)
    ...
    def LinkedCell(self, value:'IXLSRange'):
        ...
        GetDllLibXls().ExcelCommentObject_set_LinkedCell(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().ExcelCommentObject_Remove(self.Ptr)
    ...
    <param name="scaleHeight">Height scale in percents.</param>
        ...
        GetDllLibXls().ExcelCommentObject_Scale(self.Ptr, scaleWidth,scaleHeight)
