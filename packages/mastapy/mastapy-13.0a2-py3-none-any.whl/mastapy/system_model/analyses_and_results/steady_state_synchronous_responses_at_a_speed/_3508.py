...
class ComponentSteadyStateSynchronousResponseAtASpeed(_3562.PartSteadyStateSynchronousResponseAtASpeed):
    """ComponentSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_ComponentSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'ComponentSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def component_steady_state_synchronous_response_at_a_speed(self) -> 'ComponentSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ComponentSteadyStateSynchronousResponseAtASpeed._Cast_ComponentSteadyStateSynchronousResponseAtASpeed':
