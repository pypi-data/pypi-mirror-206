...
class TimeWindow(BaseModel):
    ...
    Time window.
    """
    var_from: datetime = Field(..., alias="from", description="Date and time in the [RFC 3339, section 5.6 (ISO 8601)](https://tools.ietf.org/html/rfc3339#section-5.6) format. ")
    to: datetime = Field(..., description="Date and time in the [RFC 3339, section 5.6 (ISO 8601)](https://tools.ietf.org/html/rfc3339#section-5.6) format. ")
