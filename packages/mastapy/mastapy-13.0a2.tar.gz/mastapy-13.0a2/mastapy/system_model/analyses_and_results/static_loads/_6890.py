...
class OilSealLoadCase(_6814.ConnectorLoadCase):
    """OilSealLoadCase
    ...
    class _Cast_OilSealLoadCase:
        ...
        def __init__(self, parent: 'OilSealLoadCase'):
            self._parent = parent
        ...
        @property
        def oil_seal_load_case(self) -> 'OilSealLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'OilSealLoadCase._Cast_OilSealLoadCase':
