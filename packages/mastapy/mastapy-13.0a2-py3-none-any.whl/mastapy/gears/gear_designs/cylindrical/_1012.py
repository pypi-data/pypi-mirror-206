...
class CylindricalGearFlankDesign(_0.APIBase):
    ...
    class _Cast_CylindricalGearFlankDesign:
        ...
        def __init__(self, parent: 'CylindricalGearFlankDesign'):
            self._parent = parent

        @property
        def cylindrical_gear_flank_design(self) -> 'CylindricalGearFlankDesign':
            return self._parent
    ...
    @property
    def highest_point_of_fewest_tooth_contacts(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def lowest_point_of_fewest_tooth_contacts(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def lowest_start_of_active_profile(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def root_diameter_reporting(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def root_form(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def tip_diameter_reporting(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def tip_form(self) -> '_1020.CylindricalGearProfileMeasurement':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearFlankDesign._Cast_CylindricalGearFlankDesign':
