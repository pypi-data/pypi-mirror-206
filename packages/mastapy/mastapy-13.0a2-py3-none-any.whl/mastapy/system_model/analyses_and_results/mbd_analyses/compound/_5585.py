...
class PointLoadCompoundMultibodyDynamicsAnalysis(_5621.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """PointLoadCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5444.PointLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5444.PointLoadMultibodyDynamicsAnalysis]':
