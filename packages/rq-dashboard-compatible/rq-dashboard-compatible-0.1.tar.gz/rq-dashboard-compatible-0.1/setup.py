...
setup(
    name='rq-dashboard-compatible',
    version=get_version(),
    url='https://github.com/mbhagdev/rq-dashboard',
    license='BSD',
    author='Vincent Driessen',
    author_email='vincent@3rdcloud.com',
    description='update from original is only flask 2.3.2 compatibility. rq-dashboard is a general purpose, lightweight, web interface'
