...
class SpiralBevelGearMeshModalAnalysis(_4563.BevelGearMeshModalAnalysis):
    """SpiralBevelGearMeshModalAnalysis
    ...
    class _Cast_SpiralBevelGearMeshModalAnalysis:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshModalAnalysis'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_modal_analysis(self) -> 'SpiralBevelGearMeshModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshModalAnalysis._Cast_SpiralBevelGearMeshModalAnalysis':
