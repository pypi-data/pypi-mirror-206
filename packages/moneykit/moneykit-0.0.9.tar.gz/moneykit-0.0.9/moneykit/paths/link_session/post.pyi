...
# body param
SchemaForRequestBodyApplicationJson = CreateLinkSessionRequest

request_body_create_link_session_request = api_client.RequestBody(
    content={
        "application/json": api_client.MediaType(schema=SchemaForRequestBodyApplicationJson),
    },
    required=True,
)
SchemaFor201ResponseBodyApplicationJson = CreateLinkSessionResponse
...
SchemaFor403ResponseBodyApplicationJson = LinkSessionErrorForbiddenConfigResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_link_session_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_link_session_request.serialize(body, content_type)
...
class CreateLinkSession(BaseApi):
    ...
    def create_link_session(
        ...
        return self._create_link_session_oapg(
            body=body,
