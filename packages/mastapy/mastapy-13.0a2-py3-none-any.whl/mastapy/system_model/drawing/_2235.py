...
class PowerFlowViewable(_0.APIBase):
    ...
    class _Cast_PowerFlowViewable:
        ...
        def __init__(self, parent: 'PowerFlowViewable'):
            self._parent = parent

        @property
        def power_flow_viewable(self) -> 'PowerFlowViewable':
            return self._parent
    ...
    @property
    def draw_style(self) -> '_4098.PowerFlowDrawStyle':
    ...
    @property
    def cast_to(self) -> 'PowerFlowViewable._Cast_PowerFlowViewable':
