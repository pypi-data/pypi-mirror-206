...
class Realm(models.Model):
    url = models.CharField(max_length=255, null=False, blank=False,
                            help_text='Url as known on the Keycloak server. '
                                      'This url is used in the API paths '
                                      'of this Realm.')
    ...
    client_id = models.CharField(max_length=255, null=False, blank=False,
                                 help_text='Client id as known on the Keycloak server. '
                                      'This name is used in the API paths '
                                      'of this Realm.')
    secret = models.CharField(max_length=255, null=False, blank=False,
                              help_text='Secret of client id on the Keycloak server.')
    username_or_email = models.CharField(max_length=255, null=False, blank=False,
                              help_text='User of client id on the Keycloak server.')
    password = models.CharField(max_length=255, null=False, blank=False,
                              help_text='Password of user on the Keycloak server.')
...
class Client(models.Model):
    realm = models.ForeignKey(Realm, related_name='client',
