...
class CylindricalGearMeshModalAnalysisAtASpeed(_5147.GearMeshModalAnalysisAtASpeed):
    """CylindricalGearMeshModalAnalysisAtASpeed
    ...
    class _Cast_CylindricalGearMeshModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'CylindricalGearMeshModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_modal_analysis_at_a_speed(self) -> 'CylindricalGearMeshModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshModalAnalysisAtASpeed._Cast_CylindricalGearMeshModalAnalysisAtASpeed':
