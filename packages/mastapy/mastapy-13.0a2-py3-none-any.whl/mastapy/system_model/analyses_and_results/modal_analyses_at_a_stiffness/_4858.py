...
class ConceptCouplingModalAnalysisAtAStiffness(_4869.CouplingModalAnalysisAtAStiffness):
    """ConceptCouplingModalAnalysisAtAStiffness
    ...
    class _Cast_ConceptCouplingModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ConceptCouplingModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def concept_coupling_modal_analysis_at_a_stiffness(self) -> 'ConceptCouplingModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingModalAnalysisAtAStiffness._Cast_ConceptCouplingModalAnalysisAtAStiffness':
