...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5083, _5084, _5020
...
class WormGearSetCompoundModalAnalysisAtAStiffness(_5020.GearSetCompoundModalAnalysisAtAStiffness):
    """WormGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4956.WormGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5083.WormGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5084.WormGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4956.WormGearSetModalAnalysisAtAStiffness]':
