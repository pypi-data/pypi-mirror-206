...
class PowerLoadModalAnalysisAtAStiffness(_4953.VirtualComponentModalAnalysisAtAStiffness):
    """PowerLoadModalAnalysisAtAStiffness
    ...
    class _Cast_PowerLoadModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'PowerLoadModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def power_load_modal_analysis_at_a_stiffness(self) -> 'PowerLoadModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PowerLoadModalAnalysisAtAStiffness._Cast_PowerLoadModalAnalysisAtAStiffness':
