...
class SpringDamperCompoundModalAnalysis(_4738.CouplingCompoundModalAnalysis):
    """SpringDamperCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4661.SpringDamperModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4661.SpringDamperModalAnalysis]':
