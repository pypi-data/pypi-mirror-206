...
from mastapy.system_model.fe.version_comparer import _2396, _2392
...
class FESubstructureVersionComparer(_0.APIBase):
    ...
    class _Cast_FESubstructureVersionComparer:
        ...
        def __init__(self, parent: 'FESubstructureVersionComparer'):
            self._parent = parent

        @property
        def fe_substructure_version_comparer(self) -> 'FESubstructureVersionComparer':
            return self._parent
    ...
    @property
    def load_cases_to_run(self) -> '_2396.LoadCasesToRun':
        ...
        value = conversion.pn_to_mp_enum(temp, _2396.LoadCasesToRun)
        return constructor.new_from_mastapy_type(_2396.LoadCasesToRun)(value) if value is not None else None

    @load_cases_to_run.setter
    def load_cases_to_run(self, value: '_2396.LoadCasesToRun'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2396.LoadCasesToRun.type_())
    ...
    @property
    def design_results(self) -> 'List[_2392.DesignResults]':
    ...
    @property
    def cast_to(self) -> 'FESubstructureVersionComparer._Cast_FESubstructureVersionComparer':
