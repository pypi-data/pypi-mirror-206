...
class StraightBevelGearMeshCompoundSystemDeflection(_2847.BevelGearMeshCompoundSystemDeflection):
    """StraightBevelGearMeshCompoundSystemDeflection
    ...
    class _Cast_StraightBevelGearMeshCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_compound_system_deflection(self) -> 'StraightBevelGearMeshCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2795.StraightBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2795.StraightBevelGearMeshSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshCompoundSystemDeflection._Cast_StraightBevelGearMeshCompoundSystemDeflection':
