...
class XlsAddInFunctionsCollection (  CollectionBase[XlsAddInFunction],IAddInFunctions) :
    ...
    def get_Item(self ,index:int)->'IAddInFunction':
        ...
        intPtr = GetDllLibXls().XlsAddInFunctionsCollection_get_Item(self.Ptr, index)
    ...
    <returns>Index of the new function.</returns>
        ...
        ret = GetDllLibXls().XlsAddInFunctionsCollection_Add(self.Ptr, fileName,functionName)
        return ret
    ...
    <returns>Index of the added function.</returns>
        ...
        ret = GetDllLibXls().XlsAddInFunctionsCollection_AddF(self.Ptr, functionName)
        return ret
    ...
    def Add(self ,bookIndex:int,nameIndex:int):
        ...
        GetDllLibXls().XlsAddInFunctionsCollection_AddBN(self.Ptr, bookIndex,nameIndex)
    ...
    <param name="index">Item index to remove.</param>
        ...
        GetDllLibXls().XlsAddInFunctionsCollection_RemoveAt(self.Ptr, index)
    ...
    def Contains(self ,workbookName:str)->bool:
        ...
        ret = GetDllLibXls().XlsAddInFunctionsCollection_Contains(self.Ptr, workbookName)
        return ret
    ...
    def CopyFrom(self ,addinFunctions:'XlsAddInFunctionsCollection'):
        ...
        GetDllLibXls().XlsAddInFunctionsCollection_CopyFrom(self.Ptr, intPtraddinFunctions)
