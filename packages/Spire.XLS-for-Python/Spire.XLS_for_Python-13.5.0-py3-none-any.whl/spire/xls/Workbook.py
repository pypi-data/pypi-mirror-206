...
from ctypes import *
import abc
from spire.common import dlllib
from spire.common import dlllibXls
...
class Workbook (SpireObject) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibXls().Workbook_CreateWorkbook()
        super(Workbook, self).__init__(intPtr)
    def __del__(self):
        GetDllLibXls().Workbook_Dispose.argtypes = [c_void_p]
        GetDllLibXls().Workbook_Dispose(self.Ptr)
        super(Workbook, self).__del__()

    @dispatch

    def SaveAsImage(self ,sheetIndex:int,dpiX:float,dpiY:float)->Image:
        """
    <summary>
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().Workbook_SaveAsImageIDD(self.Ptr, sheetIndex,dpiX,dpiY)
    ...
    <param name="fileName">XML file name.</param>
        ...
        GetDllLibXls().Workbook_SaveAsXml(self.Ptr, fileName)
    ...
    <param name="stream">Stream object.</param>
        ...
        GetDllLibXls().Workbook_SaveAsXmlS(self.Ptr, intPtrstream)
...
#        intPtrArray = GetDllLibXls().Workbook_SaveChartAsEmfImage(self.Ptr, intPtrworksheet)
...
#        return ret
    ...
    def SaveChartAsEmfImage(self ,worksheet:Worksheet,chartIndex:int)->Image:
        """
    <summary>
    ...
    <param name="chartIndex">chart index</param>
        ...
        intPtr = GetDllLibXls().Workbook_SaveChartAsEmfImageWC(self.Ptr, intPtrworksheet,chartIndex)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def SaveChartAsEmfImage(self ,worksheet:Worksheet,chartIndex:int,emfStream:Stream)->Image:
        """
    <summary>
        Save chart to vector image.
    </summary>
    ...
    <param name="emfStream">output stream</param>
        ...
        intPtr = GetDllLibXls().Workbook_SaveChartAsEmfImageWCE(self.Ptr, intPtrworksheet,chartIndex,intPtremfStream)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def SaveChartAsImage(self ,chartSheet:ChartSheet)->Image:
        """
    <summary>
        Save chart to image.
    </summary>
    <param name="worksheet">chart sheet</param>
        ...
        intPtr = GetDllLibXls().Workbook_SaveChartAsImage(self.Ptr, intPtrchartSheet)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    def SaveChartAsImage(self ,worksheet:Worksheet)->List[Image]:
        """
    <summary>
    ...
    <param name="worksheet">worksheet instance</param>
        ...
        intPtrArray = GetDllLibXls().Workbook_SaveChartAsImageW(self.Ptr, intPtrworksheet)
        ret = GetObjVectorFromArray(intPtrArray, Image)
        return ret
    ...
    def SaveChartAsImage(self ,worksheet:Worksheet,chartIndex:int)->Image:
        """
    <summary>
        Save chart to image.
    </summary>
    ...
    <param name="chartIndex">chart index</param>
        ...
        intPtr = GetDllLibXls().Workbook_SaveChartAsImageWC(self.Ptr, intPtrworksheet,chartIndex)
        ret = None if intPtr==None else Image(intPtr)
        return ret
    ...
    <param name="fileName">File name.</param>
        ...
        GetDllLibXls().Workbook_SaveAsTemplate(self.Ptr, fileName)
...
#        GetDllLibXls().Workbook_SaveAsTemplateFR(self.Ptr, fileName,intPtrresponse)
...
#        GetDllLibXls().Workbook_SaveToHttpResponse(self.Ptr, FileName,intPtrresponse)
...
#        GetDllLibXls().Workbook_SaveToHttpResponseFRI(self.Ptr, FileName,intPtrresponse,isInlineMode)
...
#        GetDllLibXls().Workbook_SaveToHttpResponseFRH(self.Ptr, FileName,intPtrresponse,enumhttpContextType)
...
#        GetDllLibXls().Workbook_SaveToHttpResponseFRHF(self.Ptr, FileName,intPtrresponse,enumhttpContextType,enumfileFormat)
    ...
    <param name="Stream">Stream object</param>
        ...
        GetDllLibXls().Workbook_SaveToStream(self.Ptr, intPtrStream)
    ...
    <param name="fileFormat"></param>
        ...
        GetDllLibXls().Workbook_SaveToStreamByFileFormat(self.Ptr, intPtrStream,enumfileFormat)
    ...
    <param name="separator">Separator.</param>
        ...
        GetDllLibXls().Workbook_SaveToStreamBySeparator(self.Ptr, intPtrstream,separator)
    ...
    def SetMaxDigitWidth(self ,w:int):
        ...
        GetDllLibXls().Workbook_SetMaxDigitWidth(self.Ptr, w)
    ...
    <param name="lastColumn">the visible range's last column index</param>
        ...
        GetDllLibXls().Workbook_SetOleSize(self.Ptr, firstRow,firstColumn,lastRow,lastColumn)
    ...
    <param name="password">Password to set</param>
        ...
        GetDllLibXls().Workbook_SetWriteProtectionPassword(self.Ptr, password)
    ...
    <summary>
        ...
        GetDllLibXls().Workbook_UnProtect(self.Ptr)
    ...
    <param name="bookWindowAndStructurePassword">password for protect workbook window and structure</param>
        ...
        GetDllLibXls().Workbook_UnProtectB(self.Ptr, bookWindowAndStructurePassword)
    ...
    <param name="password">password</param>
        ...
        GetDllLibXls().Workbook_UnProtectWorkbook(self.Ptr, password)
    ...
    def GetChartSheetByName(self ,name:str)->'ChartSheet':
        ...
        intPtr = GetDllLibXls().Workbook_GetChartSheetByName(self.Ptr, name)
    ...
    <returns>if there does not set the size ,return null</returns>
        ...
        intPtr = GetDllLibXls().Workbook_GetOleSize(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_HasTrackedChanges(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().Workbook_RejectAllTrackedChanges(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().Workbook_AcceptAllTrackedChanges(self.Ptr)
...
#        intPtr = GetDllLibXls().Workbook_AddDigitalSignature(self.Ptr, intPtrcertificate,comments,intPtrsignTime)
...
#
    ...
    <returns>Collection of DigitalSignature</returns>
        ...
        intPtr = GetDllLibXls().Workbook_GetDigitalSignatures(self.Ptr)
        ret = None if intPtr==None else IDigitalSignatures(intPtr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().Workbook_RemoveAllDigitalSignatures(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_IsDigitallySigned(self.Ptr)
        return ret
    ...
    <returns>The theme color.</returns>
        ...
        intPtr = GetDllLibXls().Workbook_GetThemeColor(self.Ptr, enumtype)
    ...
    <param name="color">the theme color</param>
        ...
        GetDllLibXls().Workbook_SetThemeColor(self.Ptr, enumtype,intPtrcolor)
    ...
    <param name="srcWorkbook">source workbook.</param>
        ...
        GetDllLibXls().Workbook_CopyTheme(self.Ptr, intPtrsrcWorkbook)
    ...
    <param name="srcWorkbook">source workbook.</param>
        ...
        GetDllLibXls().Workbook_CopyThemeColor(self.Ptr, intPtrsrcWorkbook)
    ...
    <param name="FileName">File name.</param>
        ...
        GetDllLibXls().Workbook_LoadFromFile.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibXls().Workbook_LoadFromFile.restype=IntPtrWithTypeName
        intPtr = GetDllLibXls().Workbook_LoadFromFile(self.Ptr, fileName)
        if intPtr.typeName != None :
    ...
    <param name="preserveMode">Preserve mode</param>
        ...
        GetDllLibXls().Workbook_LoadFromFileFP.argtypes=[c_void_p ,c_void_p,c_bool]
        GetDllLibXls().Workbook_LoadFromFileFP(self.Ptr, fileName,preserveMode)
    ...
    <param name="version">Excel version</param>
        ...
        GetDllLibXls().Workbook_LoadFromFileByVersion(self.Ptr, fileName,enumversion)
    ...
    <param name="separator">Delimiter of text file. </param>
        ...
        GetDllLibXls().Workbook_LoadFromFileBySeparator(self.Ptr, fileName,separator)
    ...
    <param name="column">Start column.</param>
        ...
        GetDllLibXls().Workbook_LoadFromFileBySRC(self.Ptr, fileName,separator,row,column)
    ...
    <param name="version">workbook version</param>
        ...
        GetDllLibXls().Workbook_LoadFromFileBySRCV(self.Ptr, fileName,separator,row,column,enumversion)
    ...
    <param name="encoding">Text Encoding</param>
        ...
        GetDllLibXls().Workbook_LoadFromFileSRCVE(self.Ptr, fileName,separator,row,column,enumversion,intPtrencoding)
    ...
    <param name="stream">Stream contains data.</param>
        ...
        GetDllLibXls().Workbook_LoadFromStream(self.Ptr, intPtrstream)
    ...
    <param name="loadStyles">Indicates whether loads styles.</param>
        ...
        GetDllLibXls().Workbook_LoadFromStreamByL(self.Ptr, intPtrstream,loadStyles)
    ...
    <param name="version">Excel version</param>
        ...
        GetDllLibXls().Workbook_LoadFromStreamV(self.Ptr, intPtrstream,enumversion)
    ...
    <param name="column">Start column.</param>
        ...
        GetDllLibXls().Workbook_LoadFromStreamSRC(self.Ptr, intPtrstream,separator,row,column)
    ...
    <param name="version">Excel version.</param>
        ...
        GetDllLibXls().Workbook_LoadFromStreamSRCV(self.Ptr, intPtrstream,separator,row,column,enumversion)
    ...
    <param name="fileName">File name.</param>
        ...
        GetDllLibXls().Workbook_LoadFromXml(self.Ptr, fileName)
    ...
    <param name="stream">Stream contains data.</param>
        ...
        GetDllLibXls().Workbook_LoadFromXmlStream(self.Ptr, intPtrstream)
    ...
    <param name="fileName">File name.</param>
        ...
        GetDllLibXls().Workbook_LoadFromHtml(self.Ptr, fileName)
    ...
    <param name="stream">Stream contains data.</param>
        ...
        GetDllLibXls().Workbook_LoadFromHtmlStream(self.Ptr, intPtrstream)
    ...
    <param name="fileName">File name.</param>
        ...
        GetDllLibXls().Workbook_LoadFromMHtml(self.Ptr, fileName)
    ...
    <param name="stream">Stream contains data.</param>
        ...
        GetDllLibXls().Workbook_LoadFromMHtmlStream(self.Ptr, intPtrstream)
    ...
    <param name="fileName">File name</param>
        ...
        GetDllLibXls().Workbook_LoadTemplateFromFile(self.Ptr, fileName)
    ...
    <param name="loadStyles">Indicates whehter load styles.</param>
        ...
        GetDllLibXls().Workbook_LoadTemplateFromFileFL(self.Ptr, fileName,loadStyles)
    ...
    <param name="fileName">File name.</param>
        ...
        GetDllLibXls().Workbook_SaveToHtml(self.Ptr, fileName)
    ...
    <param name="skipHideSheet">Whether skip hidden sheet.</param>
        ...
        GetDllLibXls().Workbook_SaveToHtmlS(self.Ptr, fileName,skipHideSheet)
    ...
    <param name="fileName">File name.</param>
        ...
        GetDllLibXls().Workbook_SaveToFile(self.Ptr, fileName)
    ...
    <param name="fileFormat">File format</param>
        ...
        GetDllLibXls().Workbook_SaveToFileF(self.Ptr, fileName,enumfileFormat)
    ...
    <param name="separator">Current separator.</param>
        ...
        GetDllLibXls().Workbook_SaveToFileS(self.Ptr, fileName,separator)
    ...
    <param name="retainHiddenDataToCSV">Retain hidden data when save to csv.</param>
        ...
        GetDllLibXls().Workbook_SaveToFileFR(self.Ptr, fileName,enumfileFormat,retainHiddenDataToCSV)
    ...
    <param name="textSaveOptions">Text save options.</param>
        ...
        GetDllLibXls().Workbook_SaveToFileByTextSaveOptions(self.Ptr, fileName,intPtrtextSaveOptions)
    ...
    <param name="version">Excel version</param>
        ...
        GetDllLibXls().Workbook_SaveToFileByVersion(self.Ptr, fileName,enumversion)
    ...
    def AddPivotTableStyle(self ,pts:'PivotTableStyle'):
        ...
        GetDllLibXls().Workbook_AddPivotTableStyle(self.Ptr, intPtrpts)


    def CaculateFormulaValue(self ,text:str)->'SpireObject':
        """
    <summary>
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().Workbook_CaculateFormulaValue(self.Ptr, text)
    ...
    <summary>
        ...
        GetDllLibXls().Workbook_CalculateAllValue(self.Ptr)
    ...
    <param name="index">Palette index,Value should be from 0 to 55</param>
        ...
        GetDllLibXls().Workbook_ChangePaletteColor(self.Ptr, intPtrcolor,index)
    ...
    <returns>Column width in pixels.</returns>
        ...
        ret = GetDllLibXls().Workbook_ColumnWidthToPixels(self.Ptr, columnWidth)
        return ret
    ...
    <returns></returns>
        ...
        ret = GetDllLibXls().Workbook_ContainsFont(self.Ptr, intPtrfont)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().Workbook_CopyToClipboard(self.Ptr)
    ...
    <param name="worksheet"></param>
        ...
        GetDllLibXls().Workbook_CopyToClipboardW(self.Ptr, intPtrworksheet)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().Workbook_CreateEmptySheet(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().Workbook_CreateEmptySheetN(self.Ptr, name)
        ret = None if intPtr==None else Worksheet(intPtr)
        return ret
    ...
    <param name="sheetCount"></param>
        ...
        GetDllLibXls().Workbook_CreateEmptySheets(self.Ptr, sheetCount)
    ...
    <param name="sheetNames"></param>
        ...
        GetDllLibXls().Workbook_CreateEmptySheetsN(self.Ptr, arraysheetNames,countsheetNames)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().Workbook_CreateFont(self.Ptr)
    ...
    def CreateFont(self ,font:Font)->ExcelFont:
        ...
        intPtr = GetDllLibXls().Workbook_CreateFontF(self.Ptr, intPtrfont)
        ret = None if intPtr==None else ExcelFont(intPtr)
        return ret
    ...
    def CreatePivotStyle(self)->'PivotStyle':
        ...
        intPtr = GetDllLibXls().Workbook_CreatePivotStyle(self.Ptr)
...
#        intPtr = GetDllLibXls().Workbook_FindAllBool(self.Ptr, boolValue)
...
#        intPtr = GetDllLibXls().Workbook_FindAllNumber(self.Ptr, doubleValue,formulaValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().Workbook_FindAllString(self.Ptr, stringValue,formula,formulaValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().Workbook_FindAllDateTime(self.Ptr, intPtrdateTimeValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().Workbook_FindAllTimeSpan(self.Ptr, intPtrtimeSpanValue)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
    ...
    <returns>Found range.</returns>
        ...
        intPtr = GetDllLibXls().Workbook_FindBool(self.Ptr, boolValue)
    ...
    <returns>Found range.</returns>
        ...
        intPtr = GetDllLibXls().Workbook_FindNumber(self.Ptr, doubleValue,formulaValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range.</returns>
        ...
        intPtr = GetDllLibXls().Workbook_FindString(self.Ptr, stringValue,formula,formulaValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range.</returns>
        ...
        intPtr = GetDllLibXls().Workbook_FindDateTime(self.Ptr, intPtrdateTimeValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range.</returns>
        ...
        intPtr = GetDllLibXls().Workbook_FindTimeSpan(self.Ptr, intPtrtimeSpanValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Workbook palette color.</returns>
        ...
        ret = GetDllLibXls().Workbook_GetMatchingColor(self.Ptr, intPtrcolor)
    ...
    <returns>Workbook palette color.</returns>
        ...
        ret = GetDllLibXls().Workbook_GetMatchingColorRGB(self.Ptr, r,g,b)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    <returns>RGB Color.</returns>
        ...
        intPtr = GetDllLibXls().Workbook_GetPaletteColor(self.Ptr, enumcolor)
        ret = None if intPtr==None else Color(intPtr)
        return ret
...
#        intPtr = GetDllLibXls().Workbook_GetSplitPageInfo(self.Ptr)
...
#        intPtr = GetDllLibXls().Workbook_GetSplitPageTable(self.Ptr, intPtrwb)
...
#
    ...
    <summary>
        ...
        GetDllLibXls().Workbook_InitCalcEngine(self.Ptr)
    ...
    <returns></returns>
        ...
        ret = GetDllLibXls().Workbook_IsPasswordProtected( fileName)
        return ret
    ...
    def IsPasswordProtected(stream:Stream)->bool:
        ...
        GetDllLibXls().Workbook_IsPasswordProtectedS.argtypes=[ c_void_p]
        GetDllLibXls().Workbook_IsPasswordProtectedS.restype=c_bool
        ret = GetDllLibXls().Workbook_IsPasswordProtectedS( intPtrstream)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().Workbook_PasteFromClipboard(self.Ptr)
    ...
    <returns>Column width in characters.</returns>
        ...
        ret = GetDllLibXls().Workbook_PixelsToColumnWidth(self.Ptr, pixels)
        return ret
    ...
    <param name="passwordToOpen">password to open file.</param>
        ...
        GetDllLibXls().Workbook_Protect(self.Ptr, passwordToOpen)
    ...
    <param name="bIsProtectContent">Indicates if protect workbook content.</param>
        ...
        GetDllLibXls().Workbook_ProtectB(self.Ptr, passwordToOpen,bIsProtectWindow,bIsProtectContent)
    ...
    <param name="password">password</param>
        ...
        GetDllLibXls().Workbook_ProtectWorkbook(self.Ptr, bIsProtectWindow,bIsProtectContent,password)
...
#        GetDllLibXls().Workbook_Replace(self.Ptr, oldValue,intPtrnewValues,includeColumnName)
...
#        GetDllLibXls().Workbook_ReplaceONI(self.Ptr, oldValue,intPtrnewValues,includeColumnName)
    ...
    <param name="newValue">New value</param>
        ...
        GetDllLibXls().Workbook_ReplaceDT(self.Ptr, oldValue,intPtrnewValue)
    ...
    <param name="newValue">New value.</param>
        ...
        GetDllLibXls().Workbook_ReplaceD(self.Ptr, oldValue,newValue)
    ...
    <param name="isVertical">Indicates whether new values should be inserted vertically.</param>
        ...
        GetDllLibXls().Workbook_ReplaceVD(self.Ptr, oldValue,arraynewValues,countnewValues,isVertical)
    ...
    <param name="isVertical">Indicates whether new values should be inserted vertically.</param>
        ...
        GetDllLibXls().Workbook_ReplaceVI(self.Ptr, oldValue,arraynewValues,countnewValues,isVertical)
    ...
    <param name="newValue">New value</param>
        ...
        GetDllLibXls().Workbook_ReplaceS(self.Ptr, oldValue,newValue)
    ...
    <param name="isVertical">Indicates whether new values should be inserted vertically.</param>
        ...
        GetDllLibXls().Workbook_ReplaceVS(self.Ptr, oldValue,arraynewValues,countnewValues,isVertical)
    ...
    <summary>
        ...
        GetDllLibXls().Workbook_ResetPalette(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibXls().Workbook_Save(self.Ptr)

    @dispatch
    def SaveAsImage(self ,dpiX:float,dpiY:float)->List[Image]:
        """
        ...
        intPtrArray = GetDllLibXls().Workbook_SaveAsImage(self.Ptr, dpiX,dpiY)
        ret = GetObjVectorFromArray(intPtrArray, Image)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Workbook_get_Worksheets(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Workbook_get_NameRanges(self.Ptr)
    ...
    def CheckComptiliblity(self)->bool:
        ...
        ret = GetDllLibXls().Workbook_get_CheckComptiliblity(self.Ptr)
        return ret
    ...
    def CheckComptiliblity(self, value:bool):
        ...
        GetDllLibXls().Workbook_set_CheckComptiliblityB(self.Ptr, value)
    ...
    def DataConns(self)->'DataConnections':
        ...
        intPtr = GetDllLibXls().Workbook_get_DataConns(self.Ptr)
    ...
    def CultureInfo(self)->'CultureInfo':
        ...
        intPtr = GetDllLibXls().Workbook_get_CultureInfo(self.Ptr)
    ...
    def CultureInfo(self, value:'CultureInfo'):
        ...
        GetDllLibXls().Workbook_set_CultureInfo(self.Ptr, value.Ptr)
    ...
    def ExternalLinks(self)->'ExternalLinkCollection':
        ...
        intPtr = GetDllLibXls().Workbook_get_ExternalLinks(self.Ptr)
    ...
    def GetSafeSheetName(self ,inputName:str)->str:
        ...
        GetDllLibXls().Workbook_GetSafeSheetName.restype=c_wchar_p
        ret = GetDllLibXls().Workbook_GetSafeSheetName(self.Ptr, inputName)
        return ret
    ...
    def GetSafeSheetName(self ,inputName:str,replaceChar:int)->str:
        ...
        GetDllLibXls().Workbook_GetSafeSheetNameIR.restype=c_wchar_p
        ret = GetDllLibXls().Workbook_GetSafeSheetNameIR(self.Ptr, inputName,replaceChar)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Workbook_get_ActiveSheet(self.Ptr)
        ret = None if intPtr==None else Worksheet(intPtr)
        return ret
    ...
    def Allow3DRangesInDataValidation(self)->bool:
        ...
        ret = GetDllLibXls().Workbook_get_Allow3DRangesInDataValidation(self.Ptr)
        return ret
    ...
    def Allow3DRangesInDataValidation(self, value:bool):
        ...
        GetDllLibXls().Workbook_set_Allow3DRangesInDataValidationV(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_ActiveSheetIndex(self.Ptr)
        return ret
    ...
    def ActiveSheetIndex(self, value:int):
        ...
        GetDllLibXls().Workbook_set_ActiveSheetIndex(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Workbook_get_AddInFunctions(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_CalculationMode(self.Ptr)
    ...
    def CalculationMode(self, value:'ExcelCalculationMode'):
        ...
        GetDllLibXls().Workbook_set_CalculationMode(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Workbook_get_DataSorter(self.Ptr)
    ...
    def MaxColumnCount(self)->int:
        ...
        ret = GetDllLibXls().Workbook_get_MaxColumnCount(self.Ptr)
        return ret
    ...
    def MaxRowCount(self)->int:
        ...
        ret = GetDllLibXls().Workbook_get_MaxRowCount(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().Workbook_get_CodeName.restype=c_wchar_p
        ret = GetDllLibXls().Workbook_get_CodeName(self.Ptr)
        return ret
    ...
    def CodeName(self, value:str):
        ...
        GetDllLibXls().Workbook_set_CodeName(self.Ptr, value)
    ...
    <summary>
        ...
        intPtrArray = GetDllLibXls().Workbook_get_Colors(self.Ptr)
    ...
    def ConverterSetting(self)->'ConverterSetting':
        ...
        intPtr = GetDllLibXls().Workbook_get_ConverterSetting(self.Ptr)
    ...
    def ConverterSetting(self, value:'ConverterSetting'):
        ...
        GetDllLibXls().Workbook_set_ConverterSetting(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_Date1904(self.Ptr)
        return ret

    @Date1904.setter
    def Date1904(self, value:bool):
        GetDllLibXls().Workbook_set_Date1904.argtypes=[c_void_p, c_bool]
        GetDllLibXls().Workbook_set_Date1904(self.Ptr, value)
    ...
    def MaxRowsOfSharedFormula(self)->int:
        ...
        ret = GetDllLibXls().Workbook_get_MaxRowsOfSharedFormula(self.Ptr)
        return ret
    ...
    def MaxRowsOfSharedFormula(self, value:int):
        ...
        GetDllLibXls().Workbook_set_MaxRowsOfSharedFormula(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().Workbook_get_DefaultFontName.restype=c_wchar_p
        ret = GetDllLibXls().Workbook_get_DefaultFontName(self.Ptr)
        return ret
    ...
    def DefaultFontName(self, value:str):
        ...
        GetDllLibXls().Workbook_set_DefaultFontName(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_DefaultFontSize(self.Ptr)
        return ret
    ...
    def DefaultFontSize(self, value:float):
        ...
        GetDllLibXls().Workbook_set_DefaultFontSize(self.Ptr, value)
    ...
    <summary>
        ...
        intPtrArray = GetDllLibXls().Workbook_get_CustomFontFilePaths(self.Ptr)
    ...
    def CustomFontFilePaths(self, value:List[str]):
        ...
        GetDllLibXls().Workbook_set_CustomFontFilePaths(self.Ptr, vArray, vCount)
...
#        intPtr = GetDllLibXls().Workbook_GetCustomFontParsedResult(self.Ptr)
...
#
    ...
    <summary>
        ...
        intPtrArray = GetDllLibXls().Workbook_get_CustomFontFileDirectory(self.Ptr)
        ret = GetVectorFromArray(intPtrArray, c_wchar_p)
        return ret
    ...
    def CustomFontFileDirectory(self, value:List[str]):
        ...
        GetDllLibXls().Workbook_set_CustomFontFileDirectory(self.Ptr, vArray, vCount)
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_DisableMacrosStart(self.Ptr)
        return ret
    ...
    def DisableMacrosStart(self, value:bool):
        ...
        GetDllLibXls().Workbook_set_DisableMacrosStart(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().Workbook_get_FileName.restype=c_wchar_p
        ret = GetDllLibXls().Workbook_get_FileName(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_HasMacros(self.Ptr)
        return ret

    @HasMacros.setter
    def HasMacros(self, value:bool):
        GetDllLibXls().Workbook_set_HasMacros.argtypes=[c_void_p, c_bool]
        GetDllLibXls().Workbook_set_HasMacros(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_IsCellProtection(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_IsSaved(self.Ptr)
        return ret

    @IsSaved.setter
    def IsSaved(self, value:bool):
        GetDllLibXls().Workbook_set_IsSaved.argtypes=[c_void_p, c_bool]
        GetDllLibXls().Workbook_set_IsSaved(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_IsWindowProtection(self.Ptr)
        return ret
    ...
    def MarkerDesigner(self)->'MarkerDesigner':
        ...
        intPtr = GetDllLibXls().Workbook_get_MarkerDesigner(self.Ptr)
    ...
    def MaxDigitWidth(self)->int:
        ...
        ret = GetDllLibXls().Workbook_get_MaxDigitWidth(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().Workbook_get_OpenPassword.restype=c_wchar_p
        ret = GetDllLibXls().Workbook_get_OpenPassword(self.Ptr)
        return ret
    ...
    def OpenPassword(self, value:str):
        ...
        GetDllLibXls().Workbook_set_OpenPassword(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Workbook_get_WriteProtection(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_IsVScrollBarVisible(self.Ptr)
        return ret
    ...
    def IsVScrollBarVisible(self, value:bool):
        ...
        GetDllLibXls().Workbook_set_IsVScrollBarVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_IsHScrollBarVisible(self.Ptr)
        return ret
    ...
    def IsHScrollBarVisible(self, value:bool):
        ...
        GetDllLibXls().Workbook_set_IsHScrollBarVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_SheetTabBarWidth(self.Ptr)
        return ret
    ...
    def SheetTabBarWidth(self, value:int):
        ...
        GetDllLibXls().Workbook_set_SheetTabBarWidth(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Workbook_get_PivotCaches(self.Ptr)
...
#        GetDllLibXls().Workbook_set_PrintDialog(self.Ptr, value.Ptr)
...
#        intPtr = GetDllLibXls().Workbook_get_PrintDocument(self.Ptr)
...
#
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_ReadOnly(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_SelectedTab(self.Ptr)
        return ret

    @SelectedTab.setter
    def SelectedTab(self, value:int):
        GetDllLibXls().Workbook_set_SelectedTab.argtypes=[c_void_p, c_int]
        GetDllLibXls().Workbook_set_SelectedTab(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_ShowTabs(self.Ptr)
        return ret

    @ShowTabs.setter
    def ShowTabs(self, value:bool):
        GetDllLibXls().Workbook_set_ShowTabs.argtypes=[c_void_p, c_bool]
        GetDllLibXls().Workbook_set_ShowTabs(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Workbook_get_Styles(self.Ptr)
    ...
    def Version(self)->'ExcelVersion':
        ...
        ret = GetDllLibXls().Workbook_get_Version(self.Ptr)
    ...
    def Version(self, value:'ExcelVersion'):
        ...
        GetDllLibXls().Workbook_set_Version(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().Workbook_get_IsHideWindow(self.Ptr)
        return ret

    @IsHideWindow.setter
    def IsHideWindow(self, value:bool):
        GetDllLibXls().Workbook_set_IsHideWindow.argtypes=[c_void_p, c_bool]
        GetDllLibXls().Workbook_set_IsHideWindow(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Workbook_get_Charts(self.Ptr)
...
#        intPtr = GetDllLibXls().Workbook_get_Chartsheets(self.Ptr)
#        ret = None if intPtr==None else List1(intPtr)
#        return ret
#
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Workbook_get_CustomDocumentProperties(self.Ptr)
...
#        intPtr = GetDllLibXls().Workbook_get_CustomTableStyles(self.Ptr)
...
#
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Workbook_get_DocumentProperties(self.Ptr)
    ...
    def FixDateTimeNow()->'DateTime':
        ...
        intPtr = GetDllLibXls().Workbook_FixDateTimeNow()
    ...
    def FixDateTimeToday()->'DateTime':
        ...
        intPtr = GetDllLibXls().Workbook_FixDateTimeToday()
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
