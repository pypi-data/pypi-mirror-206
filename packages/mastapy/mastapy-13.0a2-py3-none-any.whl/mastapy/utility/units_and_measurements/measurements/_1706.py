...
class TemperaturePerUnitTime(_1594.MeasurementBase):
    """TemperaturePerUnitTime
    ...
    class _Cast_TemperaturePerUnitTime:
        ...
        def __init__(self, parent: 'TemperaturePerUnitTime'):
            self._parent = parent
        ...
        @property
        def temperature_per_unit_time(self) -> 'TemperaturePerUnitTime':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TemperaturePerUnitTime._Cast_TemperaturePerUnitTime':
