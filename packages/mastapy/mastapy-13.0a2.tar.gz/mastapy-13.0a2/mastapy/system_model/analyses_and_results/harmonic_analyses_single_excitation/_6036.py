...
class GuideDxfModelHarmonicAnalysisOfSingleExcitation(_6000.ComponentHarmonicAnalysisOfSingleExcitation):
    """GuideDxfModelHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_GuideDxfModelHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'GuideDxfModelHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def guide_dxf_model_harmonic_analysis_of_single_excitation(self) -> 'GuideDxfModelHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GuideDxfModelHarmonicAnalysisOfSingleExcitation._Cast_GuideDxfModelHarmonicAnalysisOfSingleExcitation':
