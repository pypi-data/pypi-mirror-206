...
class ParetoOptimisationStrategyBars(_0.APIBase):
    ...
    class _Cast_ParetoOptimisationStrategyBars:
        ...
        def __init__(self, parent: 'ParetoOptimisationStrategyBars'):
            self._parent = parent

        @property
        def bar_for_pareto(self):
            from mastapy.gears.gear_set_pareto_optimiser import _897
            
            return self._parent._cast(_897.BarForPareto)

        @property
        def pareto_optimisation_strategy_bars(self) -> 'ParetoOptimisationStrategyBars':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ParetoOptimisationStrategyBars._Cast_ParetoOptimisationStrategyBars':
