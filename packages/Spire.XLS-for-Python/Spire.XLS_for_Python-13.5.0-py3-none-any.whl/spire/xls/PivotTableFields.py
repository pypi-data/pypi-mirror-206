...
class PivotTableFields (  CollectionBase[XlsPivotField], ICloneParent, IPivotFields) :
    ...
    def get_Item(self ,name:str)->IPivotField:
        ...
        intPtr = GetDllLibXls().PivotTableFields_get_Item(self.Ptr, name)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().PivotTableFields_Clone(self.Ptr, intPtrparent)
    ...
    def RemoveAt(self ,index:int):
        ...
        GetDllLibXls().PivotTableFields_RemoveAt(self.Ptr, index)
    ...
    def Remove(self ,item:'PivotField')->bool:
        ...
        ret = GetDllLibXls().PivotTableFields_Remove(self.Ptr, intPtritem)
        return ret
    ...
    def Clear(self):
        ...
        GetDllLibXls().PivotTableFields_Clear(self.Ptr)
    ...
    def Add(self ,item:'PivotField'):
        ...
        GetDllLibXls().PivotTableFields_Add(self.Ptr, intPtritem)
