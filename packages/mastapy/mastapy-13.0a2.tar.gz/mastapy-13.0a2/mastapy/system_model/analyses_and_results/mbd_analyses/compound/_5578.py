...
class PartCompoundMultibodyDynamicsAnalysis(_7508.PartCompoundAnalysis):
    """PartCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5437.PartMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5437.PartMultibodyDynamicsAnalysis]':
