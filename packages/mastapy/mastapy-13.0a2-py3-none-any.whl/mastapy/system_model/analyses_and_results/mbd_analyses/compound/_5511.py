...
class BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis(_5516.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_compound_multibody_dynamics_analysis(self) -> 'BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5360.BevelDifferentialGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5360.BevelDifferentialGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis._Cast_BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis':
        return self._Cast_BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis(self)
