...
class XlsSpinnerShape (  XlsShape, ISpinnerShape) :
    ...
    def Display3DShading(self)->bool:
        ...
        ret = GetDllLibXls().XlsSpinnerShape_get_Display3DShading(self.Ptr)
        return ret
    ...
    def Display3DShading(self, value:bool):
        ...
        GetDllLibXls().XlsSpinnerShape_set_Display3DShading(self.Ptr, value)
    ...
    def CurrentValue(self)->int:
        ...
        ret = GetDllLibXls().XlsSpinnerShape_get_CurrentValue(self.Ptr)
        return ret

    @CurrentValue.setter
    def CurrentValue(self, value:int):
        GetDllLibXls().XlsSpinnerShape_set_CurrentValue.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsSpinnerShape_set_CurrentValue(self.Ptr, value)
    ...
    def Min(self)->int:
        ...
        ret = GetDllLibXls().XlsSpinnerShape_get_Min(self.Ptr)
        return ret

    @Min.setter
    def Min(self, value:int):
        GetDllLibXls().XlsSpinnerShape_set_Min.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsSpinnerShape_set_Min(self.Ptr, value)
    ...
    def Max(self)->int:
        ...
        ret = GetDllLibXls().XlsSpinnerShape_get_Max(self.Ptr)
        return ret

    @Max.setter
    def Max(self, value:int):
        GetDllLibXls().XlsSpinnerShape_set_Max.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsSpinnerShape_set_Max(self.Ptr, value)
    ...
    def IncrementalChange(self)->int:
        ...
        ret = GetDllLibXls().XlsSpinnerShape_get_IncrementalChange(self.Ptr)
        return ret
    ...
    def IncrementalChange(self, value:int):
        ...
        GetDllLibXls().XlsSpinnerShape_set_IncrementalChange(self.Ptr, value)
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsSpinnerShape_get_ShapeType(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsSpinnerShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
