...
class ScrollBarCollection (  CollectionBase[XlsScrollBarShape],IScrollBarShapes) :
    ...
    def get_Item(self ,index:int)->IScrollBarShape:
        ...
        intPtr = GetDllLibXls().ScrollBarCollection_get_Item(self.Ptr, index)
    ...
    def get_Item(self ,name:str)->IScrollBarShape:
        ...
        intPtr = GetDllLibXls().ScrollBarCollection_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else XlsScrollBarShape(intPtr)
        return ret
    ...
    def AddScrollBar(self ,row:int,column:int,height:int,width:int)->'IScrollBarShape':
        ...
        intPtr = GetDllLibXls().ScrollBarCollection_AddScrollBar(self.Ptr, row,column,height,width)
        ret = None if intPtr==None else XlsScrollBarShape(intPtr)
        return ret
    ...
    def AddCopy(self ,source:'IScrollBarShape'):
        ...
        GetDllLibXls().ScrollBarCollection_AddCopy(self.Ptr, intPtrsource)
    ...
    def Clear(self):
        ...
        GetDllLibXls().ScrollBarCollection_Clear(self.Ptr)
