...
class ZerolBevelGearPowerFlow(_4026.BevelGearPowerFlow):
    """ZerolBevelGearPowerFlow
    ...
    class _Cast_ZerolBevelGearPowerFlow:
        ...
        def __init__(self, parent: 'ZerolBevelGearPowerFlow'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_power_flow(self) -> 'ZerolBevelGearPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearPowerFlow._Cast_ZerolBevelGearPowerFlow':
