...
from mastapy.bearings.bearing_designs.rolling.xml_import import _2162, _2161
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    class _Cast_XmlBearingTypeMapping:
        ...
        def __init__(self, parent: 'XmlBearingTypeMapping'):
            self._parent = parent

        @property
        def xml_bearing_type_mapping(self) -> 'XmlBearingTypeMapping':
            return self._parent
    ...
    @property
    def files(self) -> 'List[_2162.BearingImportFile]':
    ...
    @property
    def variables(self) -> 'List[_2161.AbstractXmlVariableAssignment]':
    ...
    @property
    def cast_to(self) -> 'XmlBearingTypeMapping._Cast_XmlBearingTypeMapping':
