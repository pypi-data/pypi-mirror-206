...
class StraightBevelDiffGearCompoundModalAnalysisAtASpeed(_5234.BevelGearCompoundModalAnalysisAtASpeed):
    """StraightBevelDiffGearCompoundModalAnalysisAtASpeed
    ...
    class _Cast_StraightBevelDiffGearCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_compound_modal_analysis_at_a_speed(self) -> 'StraightBevelDiffGearCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5195.StraightBevelDiffGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5195.StraightBevelDiffGearModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearCompoundModalAnalysisAtASpeed._Cast_StraightBevelDiffGearCompoundModalAnalysisAtASpeed':
