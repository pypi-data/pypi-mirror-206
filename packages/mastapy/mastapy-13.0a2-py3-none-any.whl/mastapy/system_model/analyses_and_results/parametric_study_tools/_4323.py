...
class DesignOfExperimentsVariableSetter(_0.APIBase):
    ...
    class _Cast_DesignOfExperimentsVariableSetter:
        ...
        def __init__(self, parent: 'DesignOfExperimentsVariableSetter'):
            self._parent = parent

        @property
        def design_of_experiments_variable_setter(self) -> 'DesignOfExperimentsVariableSetter':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DesignOfExperimentsVariableSetter._Cast_DesignOfExperimentsVariableSetter':
