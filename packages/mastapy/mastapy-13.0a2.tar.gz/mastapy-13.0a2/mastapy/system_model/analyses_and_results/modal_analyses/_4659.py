...
class SpringDamperConnectionModalAnalysis(_4585.CouplingConnectionModalAnalysis):
    """SpringDamperConnectionModalAnalysis
    ...
    class _Cast_SpringDamperConnectionModalAnalysis:
        ...
        def __init__(self, parent: 'SpringDamperConnectionModalAnalysis'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_modal_analysis(self) -> 'SpringDamperConnectionModalAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionModalAnalysis._Cast_SpringDamperConnectionModalAnalysis':
