...
from mastapy.system_model.analyses_and_results.dynamic_analyses import (
    _6251, _6253, _6256, _6263,
    _6262, _6284, _6265, _6270,
    _6274, _6286, _6288, _6292,
    _6300, _6299, _6301, _6308,
    _6315, _6318, _6319, _6320,
    _6322, _6325, _6329, _6330,
    _6331, _6333, _6335, _6340,
    _6339, _6345, _6347, _6351,
    _6354, _6357, _6362, _6365,
    _6369, _6372, _6243
)
...
class AssemblyDynamicAnalysis(_6243.AbstractAssemblyDynamicAnalysis):
    """AssemblyDynamicAnalysis
    ...
    class _Cast_AssemblyDynamicAnalysis:
        ...
        def __init__(self, parent: 'AssemblyDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def assembly_dynamic_analysis(self) -> 'AssemblyDynamicAnalysis':
            return self._parent
    ...
    @property
    def bearings(self) -> 'List[_6251.BearingDynamicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6253.BeltDriveDynamicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6256.BevelDifferentialGearSetDynamicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6263.BoltedJointDynamicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6262.BoltDynamicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6284.CVTDynamicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6265.ClutchDynamicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6270.ConceptCouplingDynamicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6274.ConceptGearSetDynamicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6286.CycloidalAssemblyDynamicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6288.CycloidalDiscDynamicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6292.CylindricalGearSetDynamicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6300.FEPartDynamicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6299.FaceGearSetDynamicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6301.FlexiblePinAssemblyDynamicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6308.HypoidGearSetDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6315.KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6318.KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6319.MassDiscDynamicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6320.MeasurementComponentDynamicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6322.OilSealDynamicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6325.PartToPartShearCouplingDynamicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6329.PlanetCarrierDynamicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6330.PointLoadDynamicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6331.PowerLoadDynamicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6333.RingPinsDynamicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6335.RollingRingAssemblyDynamicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6340.ShaftHubConnectionDynamicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6339.ShaftDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6345.SpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6347.SpringDamperDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6351.StraightBevelDiffGearSetDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6354.StraightBevelGearSetDynamicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6357.SynchroniserDynamicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6362.TorqueConverterDynamicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6365.UnbalancedMassDynamicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6369.WormGearSetDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6372.ZerolBevelGearSetDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'AssemblyDynamicAnalysis._Cast_AssemblyDynamicAnalysis':
