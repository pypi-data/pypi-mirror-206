...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4471, _4472, _4478
...
class FaceGearSetCompoundParametricStudyTool(_4478.GearSetCompoundParametricStudyTool):
    """FaceGearSetCompoundParametricStudyTool
    ...
    class _Cast_FaceGearSetCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'FaceGearSetCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def face_gear_set_compound_parametric_study_tool(self) -> 'FaceGearSetCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4333.FaceGearSetParametricStudyTool]':
    ...
    @property
    def face_gears_compound_parametric_study_tool(self) -> 'List[_4471.FaceGearCompoundParametricStudyTool]':
    ...
    @property
    def face_meshes_compound_parametric_study_tool(self) -> 'List[_4472.FaceGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4333.FaceGearSetParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'FaceGearSetCompoundParametricStudyTool._Cast_FaceGearSetCompoundParametricStudyTool':
