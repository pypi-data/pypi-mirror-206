...
class RollAngleRangeRelativeToAccuracy(_0.APIBase):
    ...
    class _Cast_RollAngleRangeRelativeToAccuracy:
        ...
        def __init__(self, parent: 'RollAngleRangeRelativeToAccuracy'):
            self._parent = parent

        @property
        def roll_angle_range_relative_to_accuracy(self) -> 'RollAngleRangeRelativeToAccuracy':
            return self._parent
    ...
    @property
    def roll_angle_range(self) -> 'List[_758.RollAngleReportObject]':
    ...
    @property
    def cast_to(self) -> 'RollAngleRangeRelativeToAccuracy._Cast_RollAngleRangeRelativeToAccuracy':
