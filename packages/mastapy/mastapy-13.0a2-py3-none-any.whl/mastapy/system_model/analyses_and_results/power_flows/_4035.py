...
class ConceptCouplingConnectionPowerFlow(_4046.CouplingConnectionPowerFlow):
    """ConceptCouplingConnectionPowerFlow
    ...
    class _Cast_ConceptCouplingConnectionPowerFlow:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionPowerFlow'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_power_flow(self) -> 'ConceptCouplingConnectionPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionPowerFlow._Cast_ConceptCouplingConnectionPowerFlow':
