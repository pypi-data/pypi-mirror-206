...
class PerLinkExportOptions(_0.APIBase):
    ...
    class _Cast_PerLinkExportOptions:
        ...
        def __init__(self, parent: 'PerLinkExportOptions'):
            self._parent = parent

        @property
        def per_link_export_options(self) -> 'PerLinkExportOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PerLinkExportOptions._Cast_PerLinkExportOptions':
