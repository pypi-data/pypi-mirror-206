...
class CellRange (  XlsRange) :
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().CellRange_Activate(self.Ptr)
    ...
    <param name="comment">Comment to add</param>
        ...
        GetDllLibXls().CellRange_AddComment(self.Ptr, intPtrcomment)
    ...
    <returns>Created comment or exists one.</returns>
        ...
        intPtr = GetDllLibXls().CellRange_AddComment1(self.Ptr)
...
#        intPtr = GetDllLibXls().CellRange_Clone(self.Ptr, intPtrparent,intPtrrangeNames,intPtrbook)
#        ret = None if intPtr==None else CellRange(intPtr)
#        return ret
#
    ...
    <param name="destination">Destnation Range.</param>
        ...
        GetDllLibXls().CellRange_Move(self.Ptr, intPtrdestRange)
    ...
    <param name="updateReference">Indicates whether to update reference range.</param>
        ...
        GetDllLibXls().CellRange_MoveDCU(self.Ptr, intPtrdestRange,copyStyle,updateReference)
    ...
    <returns>Destination range</returns>
        ...
        intPtr = GetDllLibXls().CellRange_Copy(self.Ptr, intPtrdestRange)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <param name="updateReference">Indicates whether to update reference cells.</param>
        ...
        intPtr = GetDllLibXls().CellRange_CopyDU(self.Ptr, intPtrdestRange,updateReference)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Destination range</returns>
        ...
        intPtr = GetDllLibXls().CellRange_CopyDUC(self.Ptr, intPtrdestRange,updateReference,copyStyles)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <param name="copyOptions">Copy options.</param>
        ...
        intPtr = GetDllLibXls().CellRange_CopyDC(self.Ptr, intPtrdestRange,enumcopyOptions)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found ranges</returns>
        ...
        intPtr = GetDllLibXls().CellRange_FindAllNumber(self.Ptr, doubleValue,formulaValue)
    ...
    <returns>Found ranges</returns>
        ...
        intPtr = GetDllLibXls().CellRange_FindAllString(self.Ptr, stringValue,formula,formulaValue)
        ret = None if intPtr==None else ListCellRanges(intPtr)
        return ret
    ...
    <returns>Found ranges</returns>
        ...
        intPtr = GetDllLibXls().CellRange_FindAllDateTime(self.Ptr, intPtrdateTimeValue)
        ret = None if intPtr==None else ListCellRanges(intPtr)
        return ret
    ...
    <returns>Found ranges</returns>
        ...
        intPtr = GetDllLibXls().CellRange_FindAllTimeSpan(self.Ptr, intPtrtimeSpanValue)
        ret = None if intPtr==None else ListCellRanges(intPtr)
        return ret
    ...
    <returns>Found ranges</returns>
        ...
        intPtr = GetDllLibXls().CellRange_FindAllBool(self.Ptr, boolValue)
        ret = None if intPtr==None else ListCellRanges(intPtr)
        return ret
    ...
    <returns>Found range</returns>
        ...
        intPtr = GetDllLibXls().CellRange_FindBool(self.Ptr, boolValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range</returns>
        ...
        intPtr = GetDllLibXls().CellRange_FindNumber(self.Ptr, doubleValue,formulaValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range</returns>
        ...
        intPtr = GetDllLibXls().CellRange_FindString(self.Ptr, stringValue,formula,formulaValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range</returns>
        ...
        intPtr = GetDllLibXls().CellRange_FindDateTime(self.Ptr, intPtrdateTimeValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Found range.</returns>
        ...
        intPtr = GetDllLibXls().CellRange_FindTimeSpan(self.Ptr, intPtrtimeSpanValue)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Range intersection.</returns>
        ...
        intPtr = GetDllLibXls().CellRange_Intersect(self.Ptr, intPtrrange)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns>Merged ranges.</returns>
        ...
        intPtr = GetDllLibXls().CellRange_Merge(self.Ptr, intPtrrange)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <param name="dv">Data validation to set.</param>
        ...
        GetDllLibXls().CellRange_SetDataValidation(self.Ptr, intPtrdataValidation)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellRange_get_Borders(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellRange_get_Style(self.Ptr)
    ...
    def Style(self, value:'CellStyle'):
        ...
        GetDllLibXls().CellRange_set_Style(self.Ptr, value.Ptr)
...
#        intPtr = GetDllLibXls().CellRange_get_Cells(self.Ptr)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().CellRange_get_CellList(self.Ptr)
...
#        intPtr = GetDllLibXls().CellRange_get_Columns(self.Ptr)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
...
#        intPtr = GetDllLibXls().CellRange_get_Rows(self.Ptr)
#        ret = None if intPtr==None else ListCellRanges(intPtr)
#        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().CellRange_get_Item(self.Ptr, row,column)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    def set_Item(self ,row:int,column:int,value:'CellRange'):
        ...
        GetDllLibXls().CellRange_set_Item(self.Ptr, row,column,intPtrvalue)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().CellRange_get_ItemRCLL(self.Ptr, row,column,lastRow,lastColumn)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().CellRange_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().CellRange_get_ItemNI(self.Ptr, name,IsR1C1Notation)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellRange_get_Comment(self.Ptr)
        ret = None if intPtr==None else ExcelComment(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellRange_get_Worksheet(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellRange_get_RichText(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellRange_get_EntireColumn(self.Ptr)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellRange_get_EndCell(self.Ptr)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellRange_get_MergeArea(self.Ptr)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellRange_get_EntireRow(self.Ptr)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    def GetDependentRanges(self ,isAll:bool)->'ListCellRanges':
        ...
        intPtr = GetDllLibXls().CellRange_GetDependentRanges(self.Ptr, isAll)
        ret = None if intPtr==None else ListCellRanges(intPtr)
        return ret
    ...
    def GetReferRanges(self)->'ListReferRangeAreas':
        ...
        intPtr = GetDllLibXls().CellRange_GetReferRanges(self.Ptr)
