...
class UnbalancedMassPowerFlow(_4135.VirtualComponentPowerFlow):
    """UnbalancedMassPowerFlow
    ...
    class _Cast_UnbalancedMassPowerFlow:
        ...
        def __init__(self, parent: 'UnbalancedMassPowerFlow'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_power_flow(self) -> 'UnbalancedMassPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassPowerFlow._Cast_UnbalancedMassPowerFlow':
