...
class FaceGearMeshCompoundHarmonicAnalysis(_5905.GearMeshCompoundHarmonicAnalysis):
    """FaceGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5717.FaceGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5717.FaceGearMeshHarmonicAnalysis]':
