...
class BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation(_6989.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_advanced_time_stepping_analysis_for_modulation(self) -> 'BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2682.BevelDifferentialGearSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation._Cast_BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation':
        return self._Cast_BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation(self)
