...
class PlanetCarrierWindup(_0.APIBase):
    ...
    class _Cast_PlanetCarrierWindup:
        ...
        def __init__(self, parent: 'PlanetCarrierWindup'):
            self._parent = parent

        @property
        def planet_carrier_windup(self) -> 'PlanetCarrierWindup':
            return self._parent
    ...
    @property
    def pin_wind_ups(self) -> 'List[_2826.PlanetPinWindup]':
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierWindup._Cast_PlanetCarrierWindup':
