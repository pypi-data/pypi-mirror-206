...
class CycloidalAssemblyCompoundAdvancedSystemDeflection(_7466.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """CycloidalAssemblyCompoundAdvancedSystemDeflection
    ...
    class _Cast_CycloidalAssemblyCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'CycloidalAssemblyCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def cycloidal_assembly_compound_advanced_system_deflection(self) -> 'CycloidalAssemblyCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7279.CycloidalAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7279.CycloidalAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'CycloidalAssemblyCompoundAdvancedSystemDeflection._Cast_CycloidalAssemblyCompoundAdvancedSystemDeflection':
