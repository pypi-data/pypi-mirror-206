...
class HypoidGearCompoundStabilityAnalysis(_3878.AGMAGleasonConicalGearCompoundStabilityAnalysis):
    """HypoidGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3807.HypoidGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3807.HypoidGearStabilityAnalysis]':
