...
class PartToPartShearCouplingHalfHarmonicAnalysis(_5688.CouplingHalfHarmonicAnalysis):
    """PartToPartShearCouplingHalfHarmonicAnalysis
    ...
    class _Cast_PartToPartShearCouplingHalfHarmonicAnalysis:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingHalfHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_half_harmonic_analysis(self) -> 'PartToPartShearCouplingHalfHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingHalfHarmonicAnalysis._Cast_PartToPartShearCouplingHalfHarmonicAnalysis':
