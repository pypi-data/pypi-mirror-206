...
class PicTile (SpireObject) :
    ...
    def OffsetX(self)->float:
        ...
        ret = GetDllLibXls().PicTile_get_OffsetX(self.Ptr)
        return ret

    @OffsetX.setter
    def OffsetX(self, value:float):
        GetDllLibXls().PicTile_set_OffsetX.argtypes=[c_void_p, c_double]
        GetDllLibXls().PicTile_set_OffsetX(self.Ptr, value)
    ...
    def OffsetY(self)->float:
        ...
        ret = GetDllLibXls().PicTile_get_OffsetY(self.Ptr)
        return ret

    @OffsetY.setter
    def OffsetY(self, value:float):
        GetDllLibXls().PicTile_set_OffsetY.argtypes=[c_void_p, c_double]
        GetDllLibXls().PicTile_set_OffsetY(self.Ptr, value)
    ...
    def ScaleX(self)->float:
        ...
        ret = GetDllLibXls().PicTile_get_ScaleX(self.Ptr)
        return ret

    @ScaleX.setter
    def ScaleX(self, value:float):
        GetDllLibXls().PicTile_set_ScaleX.argtypes=[c_void_p, c_double]
        GetDllLibXls().PicTile_set_ScaleX(self.Ptr, value)
    ...
    def ScaleY(self)->float:
        ...
        ret = GetDllLibXls().PicTile_get_ScaleY(self.Ptr)
        return ret

    @ScaleY.setter
    def ScaleY(self, value:float):
        GetDllLibXls().PicTile_set_ScaleY.argtypes=[c_void_p, c_double]
        GetDllLibXls().PicTile_set_ScaleY(self.Ptr, value)
