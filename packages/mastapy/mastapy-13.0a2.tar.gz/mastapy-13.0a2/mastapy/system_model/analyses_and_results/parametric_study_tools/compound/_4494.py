...
class MeasurementComponentCompoundParametricStudyTool(_4540.VirtualComponentCompoundParametricStudyTool):
    """MeasurementComponentCompoundParametricStudyTool
    ...
    class _Cast_MeasurementComponentCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'MeasurementComponentCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def measurement_component_compound_parametric_study_tool(self) -> 'MeasurementComponentCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4354.MeasurementComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4354.MeasurementComponentParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'MeasurementComponentCompoundParametricStudyTool._Cast_MeasurementComponentCompoundParametricStudyTool':
