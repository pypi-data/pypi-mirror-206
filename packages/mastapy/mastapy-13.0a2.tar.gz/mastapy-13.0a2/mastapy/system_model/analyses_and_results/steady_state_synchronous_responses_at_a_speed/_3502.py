...
class BoltedJointSteadyStateSynchronousResponseAtASpeed(_3581.SpecialisedAssemblySteadyStateSynchronousResponseAtASpeed):
    """BoltedJointSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_BoltedJointSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'BoltedJointSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def bolted_joint_steady_state_synchronous_response_at_a_speed(self) -> 'BoltedJointSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltedJointSteadyStateSynchronousResponseAtASpeed._Cast_BoltedJointSteadyStateSynchronousResponseAtASpeed':
