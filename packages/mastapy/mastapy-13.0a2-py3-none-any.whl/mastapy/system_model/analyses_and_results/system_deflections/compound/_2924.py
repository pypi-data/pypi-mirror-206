...
class RollingRingConnectionCompoundSystemDeflection(_2896.InterMountableComponentConnectionCompoundSystemDeflection):
    """RollingRingConnectionCompoundSystemDeflection
    ...
    class _Cast_RollingRingConnectionCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'RollingRingConnectionCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def rolling_ring_connection_compound_system_deflection(self) -> 'RollingRingConnectionCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2777.RollingRingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2777.RollingRingConnectionSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'RollingRingConnectionCompoundSystemDeflection._Cast_RollingRingConnectionCompoundSystemDeflection':
