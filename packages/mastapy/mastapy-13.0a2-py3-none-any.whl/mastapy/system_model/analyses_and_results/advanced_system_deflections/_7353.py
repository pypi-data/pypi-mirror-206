...
class SynchroniserPartAdvancedSystemDeflection(_7275.CouplingHalfAdvancedSystemDeflection):
    """SynchroniserPartAdvancedSystemDeflection
    ...
    class _Cast_SynchroniserPartAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'SynchroniserPartAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def synchroniser_part_advanced_system_deflection(self) -> 'SynchroniserPartAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserPartAdvancedSystemDeflection._Cast_SynchroniserPartAdvancedSystemDeflection':
