...
class ConceptGearMeshCompoundParametricStudyTool(_4477.GearMeshCompoundParametricStudyTool):
    """ConceptGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4300.ConceptGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4300.ConceptGearMeshParametricStudyTool]':
