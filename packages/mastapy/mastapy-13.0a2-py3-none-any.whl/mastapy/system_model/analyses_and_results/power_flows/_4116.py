...
class SpringDamperPowerFlow(_4048.CouplingPowerFlow):
    """SpringDamperPowerFlow
    ...
    class _Cast_SpringDamperPowerFlow:
        ...
        def __init__(self, parent: 'SpringDamperPowerFlow'):
            self._parent = parent
        ...
        @property
        def spring_damper_power_flow(self) -> 'SpringDamperPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperPowerFlow._Cast_SpringDamperPowerFlow':
