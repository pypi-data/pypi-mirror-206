...
class CVTPulleyMultibodyDynamicsAnalysis(_5446.PulleyMultibodyDynamicsAnalysis):
    """CVTPulleyMultibodyDynamicsAnalysis
    ...
    class _Cast_CVTPulleyMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'CVTPulleyMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def cvt_pulley_multibody_dynamics_analysis(self) -> 'CVTPulleyMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CVTPulleyMultibodyDynamicsAnalysis._Cast_CVTPulleyMultibodyDynamicsAnalysis':
