...
class SimpleShaftDefinition(_1816.NamedDatabaseItem):
    """SimpleShaftDefinition
    ...
    class _Cast_SimpleShaftDefinition:
        ...
        def __init__(self, parent: 'SimpleShaftDefinition'):
            self._parent = parent
        ...
        @property
        def simple_shaft_definition(self) -> 'SimpleShaftDefinition':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SimpleShaftDefinition._Cast_SimpleShaftDefinition':
