...
from mastapy.system_model.part_model.gears import _2517, _2516
...
class KlingelnbergCycloPalloidHypoidGearSet(_2516.KlingelnbergCycloPalloidConicalGearSet):
    """KlingelnbergCycloPalloidHypoidGearSet
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearSet:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearSet'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_set(self) -> 'KlingelnbergCycloPalloidHypoidGearSet':
            return self._parent
    ...
    @property
    def klingelnberg_conical_gear_set_design(self) -> '_974.KlingelnbergCycloPalloidHypoidGearSetDesign':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_set_design(self) -> '_974.KlingelnbergCycloPalloidHypoidGearSetDesign':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears(self) -> 'List[_2517.KlingelnbergCycloPalloidHypoidGear]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes(self) -> 'List[_2300.KlingelnbergCycloPalloidHypoidGearMesh]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearSet._Cast_KlingelnbergCycloPalloidHypoidGearSet':
