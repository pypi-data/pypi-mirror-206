...
class ExternalCADModelCompoundSystemDeflection(_2855.ComponentCompoundSystemDeflection):
    """ExternalCADModelCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2731.ExternalCADModelSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2731.ExternalCADModelSystemDeflection]':
