...
class ClutchHalfCompoundStabilityAnalysis(_3913.CouplingHalfCompoundStabilityAnalysis):
    """ClutchHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3764.ClutchHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3764.ClutchHalfStabilityAnalysis]':
