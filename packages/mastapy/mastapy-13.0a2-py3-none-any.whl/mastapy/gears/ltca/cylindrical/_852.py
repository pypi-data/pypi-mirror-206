...
from mastapy.gears.ltca import _827, _836
...
class CylindricalGearMeshLoadDistributionAnalysis(_836.GearMeshLoadDistributionAnalysis):
    """CylindricalGearMeshLoadDistributionAnalysis
    ...
    class _Cast_CylindricalGearMeshLoadDistributionAnalysis:
        ...
        def __init__(self, parent: 'CylindricalGearMeshLoadDistributionAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_load_distribution_analysis(self) -> 'CylindricalGearMeshLoadDistributionAnalysis':
            return self._parent
    ...
    @property
    def cylindrical_mesh_load_case(self) -> '_879.CylindricalMeshLoadCase':
    ...
    @property
    def gear_a_in_mesh(self) -> '_827.CylindricalMeshedGearLoadDistributionAnalysis':
    ...
    @property
    def gear_b_in_mesh(self) -> '_827.CylindricalMeshedGearLoadDistributionAnalysis':
    ...
    @property
    def mesh_micro_geometry(self) -> '_1092.CylindricalGearMeshMicroGeometry':
    ...
    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_856.CylindricalMeshLoadDistributionAtRotation]':
    ...
    @property
    def meshed_gears(self) -> 'List[_827.CylindricalMeshedGearLoadDistributionAnalysis]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshLoadDistributionAnalysis._Cast_CylindricalGearMeshLoadDistributionAnalysis':
