...
class PlanetCarrierSteadyStateSynchronousResponse(_3040.MountableComponentSteadyStateSynchronousResponse):
    """PlanetCarrierSteadyStateSynchronousResponse
    ...
    class _Cast_PlanetCarrierSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'PlanetCarrierSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def planet_carrier_steady_state_synchronous_response(self) -> 'PlanetCarrierSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierSteadyStateSynchronousResponse._Cast_PlanetCarrierSteadyStateSynchronousResponse':
