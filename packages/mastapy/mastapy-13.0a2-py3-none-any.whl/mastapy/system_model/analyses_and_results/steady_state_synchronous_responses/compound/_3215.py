...
class TorqueConverterTurbineCompoundSteadyStateSynchronousResponse(_3134.CouplingHalfCompoundSteadyStateSynchronousResponse):
    """TorqueConverterTurbineCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_TorqueConverterTurbineCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_compound_steady_state_synchronous_response(self) -> 'TorqueConverterTurbineCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3086.TorqueConverterTurbineSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3086.TorqueConverterTurbineSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineCompoundSteadyStateSynchronousResponse._Cast_TorqueConverterTurbineCompoundSteadyStateSynchronousResponse':
        return self._Cast_TorqueConverterTurbineCompoundSteadyStateSynchronousResponse(self)
