...
class KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis(_5684.ConicalGearSetHarmonicAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2748.KlingelnbergCycloPalloidConicalGearSetSystemDeflection':
