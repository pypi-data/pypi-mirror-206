...
class PointLoadCompoundPowerFlow(_4264.VirtualComponentCompoundPowerFlow):
    """PointLoadCompoundPowerFlow
    ...
    class _Cast_PointLoadCompoundPowerFlow:
        ...
        def __init__(self, parent: 'PointLoadCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def point_load_compound_power_flow(self) -> 'PointLoadCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4096.PointLoadPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4096.PointLoadPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'PointLoadCompoundPowerFlow._Cast_PointLoadCompoundPowerFlow':
