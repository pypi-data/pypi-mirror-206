...
# body param
SchemaForRequestBodyApplicationJson = PatchedHistory
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PatchedHistory
SchemaForRequestBodyMultipartFormData = PatchedHistory


request_body_patched_history = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = History
...
class BaseApi(api_client.Api):
    @typing.overload
    def _history_partial_update_oapg(
        self,
    ...
    def _history_partial_update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_history.serialize(body, content_type)
...
class HistoryPartialUpdate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def history_partial_update(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def history_partial_update(
        ...
        return self._history_partial_update_oapg(
            body=body,
