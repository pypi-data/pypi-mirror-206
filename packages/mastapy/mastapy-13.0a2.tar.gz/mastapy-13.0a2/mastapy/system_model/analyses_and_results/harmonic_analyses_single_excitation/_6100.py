...
class WormGearMeshHarmonicAnalysisOfSingleExcitation(_6034.GearMeshHarmonicAnalysisOfSingleExcitation):
    """WormGearMeshHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_WormGearMeshHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'WormGearMeshHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def worm_gear_mesh_harmonic_analysis_of_single_excitation(self) -> 'WormGearMeshHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearMeshHarmonicAnalysisOfSingleExcitation._Cast_WormGearMeshHarmonicAnalysisOfSingleExcitation':
