...
class BoltedJointPowerFlow(_4110.SpecialisedAssemblyPowerFlow):
    """BoltedJointPowerFlow
    ...
    class _Cast_BoltedJointPowerFlow:
        ...
        def __init__(self, parent: 'BoltedJointPowerFlow'):
            self._parent = parent
        ...
        @property
        def bolted_joint_power_flow(self) -> 'BoltedJointPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltedJointPowerFlow._Cast_BoltedJointPowerFlow':
