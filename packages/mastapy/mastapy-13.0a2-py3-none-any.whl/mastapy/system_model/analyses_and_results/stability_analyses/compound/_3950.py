...
class MeasurementComponentCompoundStabilityAnalysis(_3996.VirtualComponentCompoundStabilityAnalysis):
    """MeasurementComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3819.MeasurementComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3819.MeasurementComponentStabilityAnalysis]':
