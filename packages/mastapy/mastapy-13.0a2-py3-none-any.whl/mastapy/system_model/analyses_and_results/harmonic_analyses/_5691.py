...
class CVTHarmonicAnalysis(_5659.BeltDriveHarmonicAnalysis):
    """CVTHarmonicAnalysis
    ...
    class _Cast_CVTHarmonicAnalysis:
        ...
        def __init__(self, parent: 'CVTHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def cvt_harmonic_analysis(self) -> 'CVTHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CVTHarmonicAnalysis._Cast_CVTHarmonicAnalysis':
