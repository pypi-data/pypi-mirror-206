...
def dataDistillation(baseModel, targetModel, transforms, path, pathUnlabelled, outputPath, bs=32, size=224):
    if not testNameModel(baseModel):
        ...
        # Load base model
        bModel = getModel(baseModel, nClasses)
        ...
        omniData(path, pathUnlabelled, learn, transforms)
