...
class RollingRingConnectionSteadyStateSynchronousResponse(_3028.InterMountableComponentConnectionSteadyStateSynchronousResponse):
    """RollingRingConnectionSteadyStateSynchronousResponse
    ...
    class _Cast_RollingRingConnectionSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'RollingRingConnectionSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def rolling_ring_connection_steady_state_synchronous_response(self) -> 'RollingRingConnectionSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingConnectionSteadyStateSynchronousResponse._Cast_RollingRingConnectionSteadyStateSynchronousResponse':
