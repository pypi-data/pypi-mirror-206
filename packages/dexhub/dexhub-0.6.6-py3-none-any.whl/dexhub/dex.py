...
class Erc20:
    ...
    def approve(_web3:Web3,_abi,_erc20_address,_approve_address,_amount,_public_key,_private_key):
        ...
        tx_param={
            ...
            'nonce': nonce,
            'type': '0x2',
            'maxFeePerGas': Web3.toWei(160, 'gwei'),
            'maxPriorityFeePerGas': Web3.toWei(30, 'gwei'),
        }
        transaction=approve_function.buildTransaction(tx_param)
    ...
    def withdraw_with_nonce(_web3:Web3,_amount,_weth_address,_gas,_public_key,_private_key,_nonce):
        ...
        transaction=withdraw_function.buildTransaction(params)
        signed_transaction=_web3.eth.account.sign_transaction(transaction, private_key=_private_key)
        return _web3.toHex(_web3.eth.send_raw_transaction(signed_transaction.rawTransaction))
...
class UniswapV2:
    ...
    def send_raw_transation(_web3:Web3,_function,_params,_private_key):
        transaction=_function.buildTransaction(_params)
        signed_transaction=_web3.eth.account.sign_transaction(transaction, private_key=_private_key)
    ...
    def get_pair_data(_web3:Web3,_pair_address,_pair_abi):
...
class UniswapV3Router:
    ...
    def exactInputSingle(_web3:Web3,_route_address,_abi,_nonce,_public_key,_private_key,
        ...
        transaction=swap_function.buildTransaction(tx_params)
        signed_transaction=_web3.eth.account.sign_transaction(transaction, private_key=_private_key)
        return _web3.toHex(_web3.eth.send_raw_transaction(signed_transaction.rawTransaction))
