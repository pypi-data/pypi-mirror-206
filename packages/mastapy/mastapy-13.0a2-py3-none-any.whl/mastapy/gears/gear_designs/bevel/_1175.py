...
class BevelGearMeshDesign(_1188.AGMAGleasonConicalGearMeshDesign):
    """BevelGearMeshDesign
    ...
    class _Cast_BevelGearMeshDesign:
        ...
        def __init__(self, parent: 'BevelGearMeshDesign'):
            self._parent = parent
        ...
        @property
        def bevel_gear_mesh_design(self) -> 'BevelGearMeshDesign':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelGearMeshDesign._Cast_BevelGearMeshDesign':
