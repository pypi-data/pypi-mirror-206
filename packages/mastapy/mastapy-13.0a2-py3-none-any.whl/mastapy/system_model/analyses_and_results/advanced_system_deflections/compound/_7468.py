...
class SpiralBevelGearMeshCompoundAdvancedSystemDeflection(_7385.BevelGearMeshCompoundAdvancedSystemDeflection):
    """SpiralBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    class _Cast_SpiralBevelGearMeshCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_compound_advanced_system_deflection(self) -> 'SpiralBevelGearMeshCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7338.SpiralBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7338.SpiralBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshCompoundAdvancedSystemDeflection._Cast_SpiralBevelGearMeshCompoundAdvancedSystemDeflection':
