...
def lazy_import():
    ...
    globals()['AuthGetNumbers'] = AuthGetNumbers
    globals()['Item'] = Item


class AuthGetResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'numbers': (AuthGetNumbers,),  # noqa: E501
            'item': (Item,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, accounts, numbers, item, request_id, *args, **kwargs):  # noqa: E501
        """AuthGetResponse - a model defined in OpenAPI
