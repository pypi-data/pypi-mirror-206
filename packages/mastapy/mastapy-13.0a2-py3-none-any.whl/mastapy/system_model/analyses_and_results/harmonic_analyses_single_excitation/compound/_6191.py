...
class PointLoadCompoundHarmonicAnalysisOfSingleExcitation(_6227.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """PointLoadCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6062.PointLoadHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6062.PointLoadHarmonicAnalysisOfSingleExcitation]':
