...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5945, _5946, _5864
...
class SpiralBevelGearSetCompoundHarmonicAnalysis(_5864.BevelGearSetCompoundHarmonicAnalysis):
    """SpiralBevelGearSetCompoundHarmonicAnalysis
    ...
    class _Cast_SpiralBevelGearSetCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'SpiralBevelGearSetCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_set_compound_harmonic_analysis(self) -> 'SpiralBevelGearSetCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5781.SpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5945.SpiralBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5946.SpiralBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5781.SpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearSetCompoundHarmonicAnalysis._Cast_SpiralBevelGearSetCompoundHarmonicAnalysis':
