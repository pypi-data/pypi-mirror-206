...
from mastapy.system_model.fe import (
    _2337, _2343, _2391, _2368,
    _2339, _2364, _2375, _2361,
    _2376, _2365, _2389, _2371,
    _2372, _2373, _2374
)
from mastapy._internal.implicit import list_with_selected_item, overridable, enum_with_selected_value
from mastapy.system_model.part_model import _2424, _2428, _2433
...
from mastapy.materials import _233, _279
...
class FESubstructure(_66.FEStiffness):
    ...
    class _Cast_FESubstructure:
        ...
        def __init__(self, parent: 'FESubstructure'):
            self._parent = parent
        ...
        @property
        def fe_substructure(self) -> 'FESubstructure':
            return self._parent
    ...
    @property
    def alignment_method(self) -> '_2337.AlignmentMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _2337.AlignmentMethod)
        return constructor.new_from_mastapy_type(_2337.AlignmentMethod)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2337.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2337.AlignmentMethod.type_())
    ...
    @property
    def bearing_node_alignment(self) -> '_2343.BearingNodeAlignmentOption':
        ...
        value = conversion.pn_to_mp_enum(temp, _2343.BearingNodeAlignmentOption)
        return constructor.new_from_mastapy_type(_2343.BearingNodeAlignmentOption)(value) if value is not None else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2343.BearingNodeAlignmentOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2343.BearingNodeAlignmentOption.type_())
    ...
    def gravity_force_source(self) -> '_70.GravityForceSource':
        ...
        value = conversion.pn_to_mp_enum(temp, _70.GravityForceSource)
    ...
    @property
    def acoustic_radiation_efficiency(self) -> '_233.AcousticRadiationEfficiency':
    ...
    @property
    def alignment_using_axial_node_positions(self) -> '_2339.AlignmentUsingAxialNodePositions':
    ...
    @property
    def alignment_to_component(self) -> '_2205.RelativeComponentAlignment[_2424.Component]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2424.Component](temp) if temp is not None else None

    @property
    def cms_model(self) -> '_223.CMSModel':
    ...
    @property
    def coordinate_system(self) -> '_1487.CoordinateSystem3D':
    ...
    @property
    def export(self) -> '_2364.FESubstructureExportOptions':
    ...
    @property
    def sound_pressure_enclosure(self) -> '_279.SoundPressureEnclosure':
    ...
    @property
    def gear_meshing_options(self) -> 'List[_2375.GearMeshingOptions]':
    ...
    @property
    def geometries(self) -> 'List[_2361.FEStiffnessGeometry]':
    ...
    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2376.IndependentMastaCreatedCondensationNode]':
    ...
    @property
    def links(self) -> 'List[_2398.FELink]':
    ...
    @property
    def nodes(self) -> 'List[_2365.FESubstructureNode]':
    ...
    @property
    def replaced_shafts(self) -> 'List[_2462.Shaft]':
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2389.ReplacedShaftSelectionHelper]':
    ...
    @property
    def thermal_expansion_displacements(self) -> 'List[_1553.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def thermal_expansion_forces(self) -> 'List[_1553.VectorWithLinearAndAngularComponents]':
    ...
    def convert_shafts_to_fe(self, operation: '_60.FEMeshingOperation', export_file_name: 'str'):
        ...
        operation = conversion.mp_to_pn_enum(operation, _60.FEMeshingOperation.type_())
        export_file_name = str(export_file_name)
        self.wrapped.ConvertShaftsToFE(operation, export_file_name if export_file_name else '')

    def create_fe_substructure_with_selection_components(self) -> '_2371.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2372.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2373.FESubstructureWithSelectionForModalAnalysis':
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2374.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_165.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7521.TaskProgress'] = None):
        ...
        format_ = conversion.mp_to_pn_enum(format_, _165.FEExportFormat.type_())
    ...
    def import_node_positions(self, file_name: 'str', distance_unit: '_1599.Unit'):
    ...
    def import_reduced_stiffness(self, file_name: 'str', distance_unit: '_1599.Unit', force_unit: '_1599.Unit'):
    ...
    def links_for(self, node: '_2365.FESubstructureNode') -> 'List[_2398.FELink]':
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7521.TaskProgress'):
        """ 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def load_stl_geometry(self, length_unit: '_1599.Unit', file_name: 'str'):
    ...
    @property
    def cast_to(self) -> 'FESubstructure._Cast_FESubstructure':
