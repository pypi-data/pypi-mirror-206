...
class WormGearCompoundSteadyStateSynchronousResponseOnAShaft(_3412.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    """WormGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_WormGearCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'WormGearCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def worm_gear_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'WormGearCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3350.WormGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3350.WormGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'WormGearCompoundSteadyStateSynchronousResponseOnAShaft._Cast_WormGearCompoundSteadyStateSynchronousResponseOnAShaft':
