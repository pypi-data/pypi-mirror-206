...
class ShaftCompoundHarmonicAnalysisOfSingleExcitation(_6106.AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation):
    """ShaftCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6071.ShaftHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6071.ShaftHarmonicAnalysisOfSingleExcitation]':
