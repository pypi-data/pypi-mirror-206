...
class SpiralBevelGearMeshSteadyStateSynchronousResponseAtASpeed(_3499.BevelGearMeshSteadyStateSynchronousResponseAtASpeed):
    """SpiralBevelGearMeshSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_SpiralBevelGearMeshSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'SpiralBevelGearMeshSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_mesh_steady_state_synchronous_response_at_a_speed(self) -> 'SpiralBevelGearMeshSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearMeshSteadyStateSynchronousResponseAtASpeed._Cast_SpiralBevelGearMeshSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_SpiralBevelGearMeshSteadyStateSynchronousResponseAtASpeed(self)
