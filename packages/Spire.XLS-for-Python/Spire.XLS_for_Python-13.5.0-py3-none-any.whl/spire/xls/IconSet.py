...
#        intPtr = GetDllLibXls().IconSet_get_IconCriteria(self.Ptr)
...
#
    ...
    <summary>
        ...
        ret = GetDllLibXls().IconSet_get_IconSetType(self.Ptr)
    ...
    def IconSetType(self, value:'IconSetType'):
        ...
        GetDllLibXls().IconSet_set_IconSetType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IconSet_get_PercentileValues(self.Ptr)
        return ret
    ...
    def PercentileValues(self, value:bool):
        ...
        GetDllLibXls().IconSet_set_PercentileValues(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IconSet_get_ShowIconOnly(self.Ptr)
        return ret

    @ShowIconOnly.setter
    def ShowIconOnly(self, value:bool):
        GetDllLibXls().IconSet_set_ShowIconOnly.argtypes=[c_void_p, c_bool]
        GetDllLibXls().IconSet_set_ShowIconOnly(self.Ptr, value)
