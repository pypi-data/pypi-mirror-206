...
class BoltedJointCompoundDynamicAnalysis(_6471.SpecialisedAssemblyCompoundDynamicAnalysis):
    """BoltedJointCompoundDynamicAnalysis
    ...
    class _Cast_BoltedJointCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'BoltedJointCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def bolted_joint_compound_dynamic_analysis(self) -> 'BoltedJointCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6263.BoltedJointDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6263.BoltedJointDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BoltedJointCompoundDynamicAnalysis._Cast_BoltedJointCompoundDynamicAnalysis':
