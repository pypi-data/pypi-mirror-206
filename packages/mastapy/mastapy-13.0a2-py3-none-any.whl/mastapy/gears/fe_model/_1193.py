...
class GearMeshingElementOptions(_0.APIBase):
    ...
    class _Cast_GearMeshingElementOptions:
        ...
        def __init__(self, parent: 'GearMeshingElementOptions'):
            self._parent = parent

        @property
        def gear_meshing_element_options(self) -> 'GearMeshingElementOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'GearMeshingElementOptions._Cast_GearMeshingElementOptions':
