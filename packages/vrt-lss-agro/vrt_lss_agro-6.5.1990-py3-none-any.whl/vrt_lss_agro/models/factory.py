...
class Factory(BaseModel):
    ...
    bunkers: conlist(Bunker, max_items=201, min_items=1, unique_items=True) = Field(..., description="List of bunkers.")
    consumers: conlist(Consumer, max_items=201, min_items=1, unique_items=True) = Field(..., description="List of consumption.")
