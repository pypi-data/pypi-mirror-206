...
class XlsComment (  XlsShape, IComment, ITextBox) :
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsComment_get_ShapeType(self.Ptr)
    ...
    def Author(self)->str:
        ...
        GetDllLibXls().XlsComment_get_Author.restype=c_wchar_p
        ret = GetDllLibXls().XlsComment_get_Author(self.Ptr)
        return ret
    ...
    def Author(self, value:str):
        ...
        GetDllLibXls().XlsComment_set_Author(self.Ptr, value)
    ...
    def AutoSize(self)->bool:
        ...
        ret = GetDllLibXls().XlsComment_get_AutoSize(self.Ptr)
        return ret

    @AutoSize.setter
    def AutoSize(self, value:bool):
        GetDllLibXls().XlsComment_set_AutoSize.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsComment_set_AutoSize(self.Ptr, value)
    ...
    def Column(self)->int:
        ...
        ret = GetDllLibXls().XlsComment_get_Column(self.Ptr)
        return ret

    @Column.setter
    def Column(self, value:int):
        GetDllLibXls().XlsComment_set_Column.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsComment_set_Column(self.Ptr, value)
    ...
    def Row(self)->int:
        ...
        ret = GetDllLibXls().XlsComment_get_Row(self.Ptr)
        return ret

    @Row.setter
    def Row(self, value:int):
        GetDllLibXls().XlsComment_set_Row.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsComment_set_Row(self.Ptr, value)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().XlsComment_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsComment_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsComment_set_Text(self.Ptr, value)
    ...
    def IsTextLocked(self)->bool:
        ...
        ret = GetDllLibXls().XlsComment_get_IsTextLocked(self.Ptr)
        return ret

    @IsTextLocked.setter
    def IsTextLocked(self, value:bool):
        GetDllLibXls().XlsComment_set_IsTextLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsComment_set_IsTextLocked(self.Ptr, value)
    ...
    def TextRotation(self)->'TextRotationType':
        ...
        ret = GetDllLibXls().XlsComment_get_TextRotation(self.Ptr)
    ...
    def TextRotation(self, value:'TextRotationType'):
        ...
        GetDllLibXls().XlsComment_set_TextRotation(self.Ptr, value.value)
    ...
    def RichText(self)->'IRichTextString':
        ...
        intPtr = GetDllLibXls().XlsComment_get_RichText(self.Ptr)
    ...
    def HAlignment(self)->'CommentHAlignType':
        ...
        ret = GetDllLibXls().XlsComment_get_HAlignment(self.Ptr)
    ...
    def HAlignment(self, value:'CommentHAlignType'):
        ...
        GetDllLibXls().XlsComment_set_HAlignment(self.Ptr, value.value)
    ...
    def Remove(self):
        ...
        GetDllLibXls().XlsComment_Remove(self.Ptr)
    ...
    def VAlignment(self)->'CommentVAlignType':
        ...
        ret = GetDllLibXls().XlsComment_get_VAlignment(self.Ptr)
    ...
    def VAlignment(self, value:'CommentVAlignType'):
        ...
        GetDllLibXls().XlsComment_set_VAlignment(self.Ptr, value.value)
    ...
    def IsVisible(self)->bool:
        ...
        ret = GetDllLibXls().XlsComment_get_IsVisible(self.Ptr)
        return ret

    @IsVisible.setter
    def IsVisible(self, value:bool):
        GetDllLibXls().XlsComment_set_IsVisible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsComment_set_IsVisible(self.Ptr, value)
    ...
    def Fill(self)->'IShapeFill':
        ...
        intPtr = GetDllLibXls().XlsComment_get_Fill(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsComment_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
