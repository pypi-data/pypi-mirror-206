...
class SpringDamperHalfCompoundCriticalSpeedAnalysis(_6678.CouplingHalfCompoundCriticalSpeedAnalysis):
    """SpringDamperHalfCompoundCriticalSpeedAnalysis
    ...
    class _Cast_SpringDamperHalfCompoundCriticalSpeedAnalysis:
        ...
        def __init__(self, parent: 'SpringDamperHalfCompoundCriticalSpeedAnalysis'):
            self._parent = parent
        ...
        @property
        def spring_damper_half_compound_critical_speed_analysis(self) -> 'SpringDamperHalfCompoundCriticalSpeedAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6614.SpringDamperHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6614.SpringDamperHalfCriticalSpeedAnalysis]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperHalfCompoundCriticalSpeedAnalysis._Cast_SpringDamperHalfCompoundCriticalSpeedAnalysis':
