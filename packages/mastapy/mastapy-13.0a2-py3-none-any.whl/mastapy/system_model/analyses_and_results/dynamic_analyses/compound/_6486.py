...
class SynchroniserCompoundDynamicAnalysis(_6471.SpecialisedAssemblyCompoundDynamicAnalysis):
    """SynchroniserCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6357.SynchroniserDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6357.SynchroniserDynamicAnalysis]':
