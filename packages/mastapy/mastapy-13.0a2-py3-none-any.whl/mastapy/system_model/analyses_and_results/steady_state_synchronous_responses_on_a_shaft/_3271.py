...
class CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft(_3282.GearMeshSteadyStateSynchronousResponseOnAShaft):
    """CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_steady_state_synchronous_response_on_a_shaft(self) -> 'CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft._Cast_CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft(self)
