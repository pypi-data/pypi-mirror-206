...
class FEModelComponentDrawStyle(_0.APIBase):
    ...
    class _Cast_FEModelComponentDrawStyle:
        ...
        def __init__(self, parent: 'FEModelComponentDrawStyle'):
            self._parent = parent

        @property
        def fe_model_component_draw_style(self) -> 'FEModelComponentDrawStyle':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FEModelComponentDrawStyle._Cast_FEModelComponentDrawStyle':
