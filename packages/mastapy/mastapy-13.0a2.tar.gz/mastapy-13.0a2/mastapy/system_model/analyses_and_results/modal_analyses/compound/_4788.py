...
class PowerLoadCompoundModalAnalysis(_4823.VirtualComponentCompoundModalAnalysis):
    """PowerLoadCompoundModalAnalysis
    ...
    class _Cast_PowerLoadCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'PowerLoadCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def power_load_compound_modal_analysis(self) -> 'PowerLoadCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4643.PowerLoadModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4643.PowerLoadModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PowerLoadCompoundModalAnalysis._Cast_PowerLoadCompoundModalAnalysis':
