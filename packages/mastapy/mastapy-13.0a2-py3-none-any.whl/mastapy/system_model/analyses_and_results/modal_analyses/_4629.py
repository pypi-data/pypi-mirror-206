...
class ModalAnalysisDrawStyle(_6295.DynamicAnalysisDrawStyle):
    """ModalAnalysisDrawStyle
    ...
    class _Cast_ModalAnalysisDrawStyle:
        ...
        def __init__(self, parent: 'ModalAnalysisDrawStyle'):
            self._parent = parent
        ...
        @property
        def modal_analysis_draw_style(self) -> 'ModalAnalysisDrawStyle':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ModalAnalysisDrawStyle._Cast_ModalAnalysisDrawStyle':
