...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow(_4208.KlingelnbergCycloPalloidConicalGearCompoundPowerFlow):
    """KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow
    ...
    class _Cast_KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_spiral_bevel_gear_compound_power_flow(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4083.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4083.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow._Cast_KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow':
