...
class KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool(_4344.KlingelnbergCycloPalloidConicalGearMeshParametricStudyTool):
    """KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_mesh_parametric_study_tool(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool':
            return self._parent
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2750.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool._Cast_KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool(self)
