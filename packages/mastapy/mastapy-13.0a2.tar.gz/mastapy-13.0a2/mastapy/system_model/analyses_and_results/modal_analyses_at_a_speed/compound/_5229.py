...
class BevelDifferentialGearCompoundModalAnalysisAtASpeed(_5234.BevelGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearCompoundModalAnalysisAtASpeed
    ...
    class _Cast_BevelDifferentialGearCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'BevelDifferentialGearCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_compound_modal_analysis_at_a_speed(self) -> 'BevelDifferentialGearCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5101.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5101.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearCompoundModalAnalysisAtASpeed._Cast_BevelDifferentialGearCompoundModalAnalysisAtASpeed':
