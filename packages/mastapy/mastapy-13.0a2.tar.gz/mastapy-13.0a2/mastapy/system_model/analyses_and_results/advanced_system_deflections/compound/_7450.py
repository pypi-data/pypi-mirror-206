...
class PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection(_7407.CouplingHalfCompoundAdvancedSystemDeflection):
    """PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection
    ...
    class _Cast_PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_half_compound_advanced_system_deflection(self) -> 'PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7320.PartToPartShearCouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7320.PartToPartShearCouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection._Cast_PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection':
        return self._Cast_PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection(self)
