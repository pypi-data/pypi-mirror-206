...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundPowerFlow(_4209.KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow):
    """KlingelnbergCycloPalloidHypoidGearMeshCompoundPowerFlow
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearMeshCompoundPowerFlow:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearMeshCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_mesh_compound_power_flow(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshCompoundPowerFlow':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4079.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4079.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshCompoundPowerFlow._Cast_KlingelnbergCycloPalloidHypoidGearMeshCompoundPowerFlow':
