...
class XlsOvalShape (  XlsShape, IOvalShape) :
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsOvalShape_get_ShapeType(self.Ptr)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().XlsOvalShape_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsOvalShape_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsOvalShape_set_Text(self.Ptr, value)
    ...
    def IsTextLocked(self)->bool:
        ...
        ret = GetDllLibXls().XlsOvalShape_get_IsTextLocked(self.Ptr)
        return ret

    @IsTextLocked.setter
    def IsTextLocked(self, value:bool):
        GetDllLibXls().XlsOvalShape_set_IsTextLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsOvalShape_set_IsTextLocked(self.Ptr, value)
    ...
    def TextRotation(self)->'TextRotationType':
        ...
        ret = GetDllLibXls().XlsOvalShape_get_TextRotation(self.Ptr)
    ...
    def TextRotation(self, value:'TextRotationType'):
        ...
        GetDllLibXls().XlsOvalShape_set_TextRotation(self.Ptr, value.value)
    ...
    def RichText(self)->'IRichTextString':
        ...
        intPtr = GetDllLibXls().XlsOvalShape_get_RichText(self.Ptr)
    ...
    def HAlignment(self)->'CommentHAlignType':
        ...
        ret = GetDllLibXls().XlsOvalShape_get_HAlignment(self.Ptr)
    ...
    def HAlignment(self, value:'CommentHAlignType'):
        ...
        GetDllLibXls().XlsOvalShape_set_HAlignment(self.Ptr, value.value)
    ...
    def VAlignment(self)->'CommentVAlignType':
        ...
        ret = GetDllLibXls().XlsOvalShape_get_VAlignment(self.Ptr)
    ...
    def VAlignment(self, value:'CommentVAlignType'):
        ...
        GetDllLibXls().XlsOvalShape_set_VAlignment(self.Ptr, value.value)
    ...
    def HyLink(self)->'IHyperLink':
        ...
        intPtr = GetDllLibXls().XlsOvalShape_get_HyLink(self.Ptr)
    ...
    def PrstShapeType(self)->'PrstGeomShapeType':
        ...
        ret = GetDllLibXls().XlsOvalShape_get_PrstShapeType(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsOvalShape_get_GeomPaths(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsOvalShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
