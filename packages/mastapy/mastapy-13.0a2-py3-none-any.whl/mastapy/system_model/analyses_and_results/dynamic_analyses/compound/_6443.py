...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundDynamicAnalysis(_6440.KlingelnbergCycloPalloidConicalGearMeshCompoundDynamicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearMeshCompoundDynamicAnalysis
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearMeshCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearMeshCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_mesh_compound_dynamic_analysis(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6314.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6314.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearMeshCompoundDynamicAnalysis._Cast_KlingelnbergCycloPalloidHypoidGearMeshCompoundDynamicAnalysis':
        return self._Cast_KlingelnbergCycloPalloidHypoidGearMeshCompoundDynamicAnalysis(self)
