...
class ShaftSurfaceRoughness(_0.APIBase):
    ...
    class _Cast_ShaftSurfaceRoughness:
        ...
        def __init__(self, parent: 'ShaftSurfaceRoughness'):
            self._parent = parent

        @property
        def shaft_surface_roughness(self) -> 'ShaftSurfaceRoughness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ShaftSurfaceRoughness._Cast_ShaftSurfaceRoughness':
