...
class SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed(_3711.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def synchroniser_compound_steady_state_synchronous_response_at_a_speed(self) -> 'SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3600.SynchroniserSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3600.SynchroniserSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed._Cast_SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed(self)
