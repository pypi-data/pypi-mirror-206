...
class CommentsRange (  XlsObject, IComment, ITextBoxShape, ITextBox, IShape) :
    ...
    def Author(self)->str:
        ...
        GetDllLibXls().CommentsRange_get_Author.restype=c_wchar_p
        ret = GetDllLibXls().CommentsRange_get_Author(self.Ptr)
        return ret
    ...
    def Author(self, value:str):
        ...
        GetDllLibXls().CommentsRange_set_Author(self.Ptr, value)
    ...
    def IsVisible(self)->bool:
        ...
        ret = GetDllLibXls().CommentsRange_get_IsVisible(self.Ptr)
        return ret

    @IsVisible.setter
    def IsVisible(self, value:bool):
        GetDllLibXls().CommentsRange_set_IsVisible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CommentsRange_set_IsVisible(self.Ptr, value)
    ...
    def Row(self)->int:
        ...
        ret = GetDllLibXls().CommentsRange_get_Row(self.Ptr)
        return ret
    ...
    def Column(self)->int:
        ...
        ret = GetDllLibXls().CommentsRange_get_Column(self.Ptr)
        return ret
    ...
    def RichText(self)->'IRichTextString':
        ...
        intPtr = GetDllLibXls().CommentsRange_get_RichText(self.Ptr)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().CommentsRange_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().CommentsRange_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().CommentsRange_set_Text(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().CommentsRange_get_HtmlString.restype=c_wchar_p
        ret = GetDllLibXls().CommentsRange_get_HtmlString(self.Ptr)
        return ret
    ...
    def HtmlString(self, value:str):
        ...
        GetDllLibXls().CommentsRange_set_HtmlString(self.Ptr, value)
    ...
    def IsMoveWithCell(self)->bool:
        ...
        ret = GetDllLibXls().CommentsRange_get_IsMoveWithCell(self.Ptr)
        return ret
    ...
    def IsMoveWithCell(self, value:bool):
        ...
        GetDllLibXls().CommentsRange_set_IsMoveWithCell(self.Ptr, value)
    ...
    def AutoSize(self)->bool:
        ...
        ret = GetDllLibXls().CommentsRange_get_AutoSize(self.Ptr)
        return ret

    @AutoSize.setter
    def AutoSize(self, value:bool):
        GetDllLibXls().CommentsRange_set_AutoSize.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CommentsRange_set_AutoSize(self.Ptr, value)
    ...
    def Remove(self):
        ...
        GetDllLibXls().CommentsRange_Remove(self.Ptr)
    ...
    def Scale(self ,scaleWidth:int,scaleHeight:int):
        ...
        GetDllLibXls().CommentsRange_Scale(self.Ptr, scaleWidth,scaleHeight)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CommentsRange_get_ResizeBehave(self.Ptr)
    ...
    def ResizeBehave(self, value:'ResizeBehaveType'):
        ...
        GetDllLibXls().CommentsRange_set_ResizeBehave(self.Ptr, value.value)
    ...
    def Visible(self)->bool:
        ...
        ret = GetDllLibXls().CommentsRange_get_Visible(self.Ptr)
        return ret

    @Visible.setter
    def Visible(self, value:bool):
        GetDllLibXls().CommentsRange_set_Visible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CommentsRange_set_Visible(self.Ptr, value)
    ...
    def Height(self)->int:
        ...
        ret = GetDllLibXls().CommentsRange_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:int):
        GetDllLibXls().CommentsRange_set_Height.argtypes=[c_void_p, c_int]
        GetDllLibXls().CommentsRange_set_Height(self.Ptr, value)
    ...
    def ID(self)->int:
        ...
        ret = GetDllLibXls().CommentsRange_get_ID(self.Ptr)
        return ret
    ...
    def IsSmartArt(self)->bool:
        ...
        ret = GetDllLibXls().CommentsRange_get_IsSmartArt(self.Ptr)
        return ret
    ...
    def Left(self)->int:
        ...
        ret = GetDllLibXls().CommentsRange_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:int):
        GetDllLibXls().CommentsRange_set_Left.argtypes=[c_void_p, c_int]
        GetDllLibXls().CommentsRange_set_Left(self.Ptr, value)
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().CommentsRange_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().CommentsRange_get_Name(self.Ptr)
        return ret
    ...
    def Name(self, value:str):
        ...
        GetDllLibXls().CommentsRange_set_Name(self.Ptr, value)
    ...
    def Top(self)->int:
        ...
        ret = GetDllLibXls().CommentsRange_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:int):
        GetDllLibXls().CommentsRange_set_Top.argtypes=[c_void_p, c_int]
        GetDllLibXls().CommentsRange_set_Top(self.Ptr, value)
    ...
    def Width(self)->int:
        ...
        ret = GetDllLibXls().CommentsRange_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:int):
        GetDllLibXls().CommentsRange_set_Width.argtypes=[c_void_p, c_int]
        GetDllLibXls().CommentsRange_set_Width(self.Ptr, value)
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().CommentsRange_get_ShapeType(self.Ptr)
    ...
    def ShapeType(self, value:'ExcelShapeType'):
        ...
        GetDllLibXls().CommentsRange_set_ShapeType(self.Ptr, value.value)
    ...
    def AlternativeText(self)->str:
        ...
        GetDllLibXls().CommentsRange_get_AlternativeText.restype=c_wchar_p
        ret = GetDllLibXls().CommentsRange_get_AlternativeText(self.Ptr)
        return ret
    ...
    def AlternativeText(self, value:str):
        ...
        GetDllLibXls().CommentsRange_set_AlternativeText(self.Ptr, value)
    ...
    def TextFrame(self)->'ITextFrame':
        ...
        intPtr = GetDllLibXls().CommentsRange_get_TextFrame(self.Ptr)
    ...
    def Fill(self)->'IShapeFill':
        ...
        intPtr = GetDllLibXls().CommentsRange_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CommentsRange_get_Line(self.Ptr)
    ...
    def OnAction(self)->str:
        ...
        GetDllLibXls().CommentsRange_get_OnAction.restype=c_wchar_p
        ret = GetDllLibXls().CommentsRange_get_OnAction(self.Ptr)
        return ret
    ...
    def OnAction(self, value:str):
        ...
        GetDllLibXls().CommentsRange_set_OnAction(self.Ptr, value)
    ...
    def LinkedCell(self)->'IXLSRange':
        ...
        intPtr = GetDllLibXls().CommentsRange_get_LinkedCell(self.Ptr)
    ...
    def LinkedCell(self, value:'IXLSRange'):
        ...
        GetDllLibXls().CommentsRange_set_LinkedCell(self.Ptr, value.Ptr)
    ...
    def Rotation(self)->int:
        ...
        ret = GetDllLibXls().CommentsRange_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:int):
        GetDllLibXls().CommentsRange_set_Rotation.argtypes=[c_void_p, c_int]
        GetDllLibXls().CommentsRange_set_Rotation(self.Ptr, value)
    ...
    def ThreeD(self)->'IFormat3D':
        ...
        intPtr = GetDllLibXls().CommentsRange_get_ThreeD(self.Ptr)
    ...
    def Glow(self)->'IGlow':
        ...
        intPtr = GetDllLibXls().CommentsRange_get_Glow(self.Ptr)
    ...
    def Shadow(self)->'IShadow':
        ...
        intPtr = GetDllLibXls().CommentsRange_get_Shadow(self.Ptr)
    ...
    def Reflection(self)->'IReflectionEffect':
        ...
        intPtr = GetDllLibXls().CommentsRange_get_Reflection(self.Ptr)
    ...
    def IsLockAspectRatio(self)->bool:
        ...
        ret = GetDllLibXls().CommentsRange_get_IsLockAspectRatio(self.Ptr)
        return ret
    ...
    def IsLockAspectRatio(self, value:bool):
        ...
        GetDllLibXls().CommentsRange_set_IsLockAspectRatio(self.Ptr, value)
    ...
    def IsPrintable(self)->bool:
        ...
        ret = GetDllLibXls().CommentsRange_get_IsPrintable(self.Ptr)
        return ret

    @IsPrintable.setter
    def IsPrintable(self, value:bool):
        GetDllLibXls().CommentsRange_set_IsPrintable.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CommentsRange_set_IsPrintable(self.Ptr, value)
    ...
    def IsLocked(self)->bool:
        ...
        ret = GetDllLibXls().CommentsRange_get_IsLocked(self.Ptr)
        return ret

    @IsLocked.setter
    def IsLocked(self, value:bool):
        GetDllLibXls().CommentsRange_set_IsLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CommentsRange_set_IsLocked(self.Ptr, value)
    ...
    def HAlignment(self)->'CommentHAlignType':
        ...
        ret = GetDllLibXls().CommentsRange_get_HAlignment(self.Ptr)
    ...
    def HAlignment(self, value:'CommentHAlignType'):
        ...
        GetDllLibXls().CommentsRange_set_HAlignment(self.Ptr, value.value)
    ...
    def VAlignment(self)->'CommentVAlignType':
        ...
        ret = GetDllLibXls().CommentsRange_get_VAlignment(self.Ptr)
    ...
    def VAlignment(self, value:'CommentVAlignType'):
        ...
        GetDllLibXls().CommentsRange_set_VAlignment(self.Ptr, value.value)
    ...
    def TextRotation(self)->'TextRotationType':
        ...
        ret = GetDllLibXls().CommentsRange_get_TextRotation(self.Ptr)
    ...
    def TextRotation(self, value:'TextRotationType'):
        ...
        GetDllLibXls().CommentsRange_set_TextRotation(self.Ptr, value.value)
    ...
    def IsTextLocked(self)->bool:
        ...
        ret = GetDllLibXls().CommentsRange_get_IsTextLocked(self.Ptr)
        return ret

    @IsTextLocked.setter
    def IsTextLocked(self, value:bool):
        GetDllLibXls().CommentsRange_set_IsTextLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CommentsRange_set_IsTextLocked(self.Ptr, value)
