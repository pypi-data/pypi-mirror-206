...
Example: 02c9e252-41be-11e9-81d5-00a0986138f7"""
    ...
    """links,attempts,domains,dynamic_dns,packet_query_match,scope,servers,source_address_match,status,svm.links,svm.name,svm.uuid,timeout,tld_query_enabled,uuid,"""
    ...
    """attempts,domains,dynamic_dns,packet_query_match,servers,skip_config_validation,source_address_match,svm.name,svm.uuid,timeout,tld_query_enabled,uuid,"""
...
"""
    ...
    if RECLINE_INSTALLED:
        ...
        def dns_show(
            fields: List[Choices.define(["attempts", "domains", "packet_query_match", "scope", "servers", "skip_config_validation", "source_address_match", "timeout", "tld_query_enabled", "uuid", "*"])]=None,
        ) -> ResourceTable:
