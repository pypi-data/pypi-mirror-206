...
from mastapy.system_model.analyses_and_results.modal_analyses import _2614, _4554
...
class RootAssemblyModalAnalysis(_4554.AssemblyModalAnalysis):
    """RootAssemblyModalAnalysis
    ...
    class _Cast_RootAssemblyModalAnalysis:
        ...
        def __init__(self, parent: 'RootAssemblyModalAnalysis'):
            self._parent = parent
        ...
        @property
        def root_assembly_modal_analysis(self) -> 'RootAssemblyModalAnalysis':
            return self._parent
    ...
    @property
    def modal_analysis_inputs(self) -> '_2614.ModalAnalysis':
    ...
    @property
    def cast_to(self) -> 'RootAssemblyModalAnalysis._Cast_RootAssemblyModalAnalysis':
