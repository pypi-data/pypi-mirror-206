...
class WormGearMeshCompoundMultibodyDynamicsAnalysis(_5558.GearMeshCompoundMultibodyDynamicsAnalysis):
    """WormGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5487.WormGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5487.WormGearMeshMultibodyDynamicsAnalysis]':
