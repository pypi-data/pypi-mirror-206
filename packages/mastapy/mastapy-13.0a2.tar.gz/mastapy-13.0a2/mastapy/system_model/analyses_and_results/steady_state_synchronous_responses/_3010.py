...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3011, _3009, _3022
...
class CylindricalGearSetSteadyStateSynchronousResponse(_3022.GearSetSteadyStateSynchronousResponse):
    """CylindricalGearSetSteadyStateSynchronousResponse
    ...
    class _Cast_CylindricalGearSetSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'CylindricalGearSetSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_set_steady_state_synchronous_response(self) -> 'CylindricalGearSetSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response(self) -> 'List[_3011.CylindricalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response(self) -> 'List[_3009.CylindricalGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearSetSteadyStateSynchronousResponse._Cast_CylindricalGearSetSteadyStateSynchronousResponse':
