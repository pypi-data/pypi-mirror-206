...
class TorqueConverterPumpHarmonicAnalysis(_5688.CouplingHalfHarmonicAnalysis):
    """TorqueConverterPumpHarmonicAnalysis
    ...
    class _Cast_TorqueConverterPumpHarmonicAnalysis:
        ...
        def __init__(self, parent: 'TorqueConverterPumpHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def torque_converter_pump_harmonic_analysis(self) -> 'TorqueConverterPumpHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterPumpHarmonicAnalysis._Cast_TorqueConverterPumpHarmonicAnalysis':
