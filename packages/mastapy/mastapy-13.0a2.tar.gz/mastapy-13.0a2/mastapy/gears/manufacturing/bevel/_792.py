...
class HypoidAdvancedLibrary(_0.APIBase):
    ...
    class _Cast_HypoidAdvancedLibrary:
        ...
        def __init__(self, parent: 'HypoidAdvancedLibrary'):
            self._parent = parent

        @property
        def hypoid_advanced_library(self) -> 'HypoidAdvancedLibrary':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidAdvancedLibrary._Cast_HypoidAdvancedLibrary':
