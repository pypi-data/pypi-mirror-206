...
class XlsPivotTable (  XlsObject, IPivotTable) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotTable_get_ShowRowStripes(self.Ptr)
        return ret
    ...
    def ShowRowStripes(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_ShowRowStripes(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotTable_get_ShowDataFieldInRow(self.Ptr)
        return ret
    ...
    def ShowDataFieldInRow(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_ShowDataFieldInRow(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_ReportFilters(self.Ptr)
    ...
    def ReportFilters(self, value:'PivotReportFilters'):
        ...
        GetDllLibXls().XlsPivotTable_set_ReportFilters(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotTable_get_AllSubTotalTop(self.Ptr)
        return ret
    ...
    def AllSubTotalTop(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_AllSubTotalTop(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsPivotTable_get_CustomTableStyleName.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotTable_get_CustomTableStyleName(self.Ptr)
        return ret
    ...
    def CustomTableStyleName(self, value:str):
        ...
        GetDllLibXls().XlsPivotTable_set_CustomTableStyleName(self.Ptr, value)
    ...
    def CalculateData(self):
        ...
        GetDllLibXls().XlsPivotTable_CalculateData(self.Ptr)
    ...
    <param name="dataSource">New data source range.</param>
        ...
        GetDllLibXls().XlsPivotTable_ChangeDataSource(self.Ptr, intPtrdataSource)
    ...
    def Clone(self ,parent:SpireObject)->SpireObject:
        ...
        intPtr = GetDllLibXls().XlsPivotTable_Clone(self.Ptr, intPtrparent)
...
#        intPtr = GetDllLibXls().XlsPivotTable_ClonePCH(self.Ptr, intPtrparent,cacheIndex,intPtrhashWorksheetNames)
#        ret = None if intPtr==None else SpireObject(intPtr)
#        return ret
#
    ...
    def Name(self)->str:
        ...
        GetDllLibXls().XlsPivotTable_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotTable_get_Name(self.Ptr)
        return ret
    ...
    def Name(self, value:str):
        ...
        GetDllLibXls().XlsPivotTable_set_Name(self.Ptr, value)
    ...
    def PivotFields(self)->'PivotTableFields':
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_PivotFields(self.Ptr)
    ...
    def DataFields(self)->'PivotDataFields':
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_DataFields(self.Ptr)
    ...
    def IsRowGrand(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_IsRowGrand(self.Ptr)
        return ret

    @IsRowGrand.setter
    def IsRowGrand(self, value:bool):
        GetDllLibXls().XlsPivotTable_set_IsRowGrand.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotTable_set_IsRowGrand(self.Ptr, value)
    ...
    def IsColumnGrand(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_IsColumnGrand(self.Ptr)
        return ret
    ...
    def IsColumnGrand(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_IsColumnGrand(self.Ptr, value)
    ...
    def ShowDrillIndicators(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_ShowDrillIndicators(self.Ptr)
        return ret
    ...
    def ShowDrillIndicators(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_ShowDrillIndicators(self.Ptr, value)
    ...
    def DisplayFieldCaptions(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_DisplayFieldCaptions(self.Ptr)
        return ret
    ...
    def DisplayFieldCaptions(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_DisplayFieldCaptions(self.Ptr, value)
    ...
    def RepeatItemsOnEachPrintedPage(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_RepeatItemsOnEachPrintedPage(self.Ptr)
        return ret
    ...
    def RepeatItemsOnEachPrintedPage(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_RepeatItemsOnEachPrintedPage(self.Ptr, value)
    ...
    def BuiltInStyle(self)->PivotBuiltInStyles:
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_BuiltInStyle(self.Ptr)
    ...
    def BuiltInStyle(self, value:PivotBuiltInStyles):
        ...
        GetDllLibXls().XlsPivotTable_set_BuiltInStyle(self.Ptr, value.value)
    ...
    def ShowRowGrand(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_ShowRowGrand(self.Ptr)
        return ret

    @ShowRowGrand.setter
    def ShowRowGrand(self, value:bool):
        GetDllLibXls().XlsPivotTable_set_ShowRowGrand.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotTable_set_ShowRowGrand(self.Ptr, value)
    ...
    def ShowColumnGrand(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_ShowColumnGrand(self.Ptr)
        return ret
    ...
    def ShowColumnGrand(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_ShowColumnGrand(self.Ptr, value)
    ...
    def CacheIndex(self)->int:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_CacheIndex(self.Ptr)
        return ret
    ...
    def AutoFormatType(self)->'PivotAutoFomatTypes':
        ...
        ret = GetDllLibXls().XlsPivotTable_get_AutoFormatType(self.Ptr)
    ...
    def AutoFormatType(self, value:'PivotAutoFomatTypes'):
        ...
        GetDllLibXls().XlsPivotTable_set_AutoFormatType(self.Ptr, value.value)
    ...
    def IsCompatibleWithExcel2003(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_IsCompatibleWithExcel2003(self.Ptr)
        return ret
    ...
    def IsCompatibleWithExcel2003(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_IsCompatibleWithExcel2003(self.Ptr, value)
    ...
    def Location(self)->'CellRange':
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_Location(self.Ptr)
    ...
    def Location(self, value:'CellRange'):
        ...
        GetDllLibXls().XlsPivotTable_set_Location(self.Ptr, value.Ptr)
    ...
    def Options(self)->'IPivotTableOptions':
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_Options(self.Ptr)
    ...
    def RowsPerPage(self)->int:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_RowsPerPage(self.Ptr)
        return ret

    @RowsPerPage.setter
    def RowsPerPage(self, value:int):
        GetDllLibXls().XlsPivotTable_set_RowsPerPage.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsPivotTable_set_RowsPerPage(self.Ptr, value)
    ...
    def ColumnsPerPage(self)->int:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_ColumnsPerPage(self.Ptr)
        return ret
    ...
    def ColumnsPerPage(self, value:int):
        ...
        GetDllLibXls().XlsPivotTable_set_ColumnsPerPage(self.Ptr, value)
    ...
    def CalculatedFields(self)->'IPivotCalculatedFields':
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_CalculatedFields(self.Ptr)
        ret = None if intPtr==None else IPivotCalculatedFields(intPtr)
        return ret
    ...
    def PageFields(self)->'IPivotFields':
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_PageFields(self.Ptr)
        ret = None if intPtr==None else IPivotFields(intPtr)
        return ret
    ...
    def RowFields(self)->'IPivotFields':
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_RowFields(self.Ptr)
        ret = None if intPtr==None else IPivotFields(intPtr)
        return ret
    ...
    def ColumnFields(self)->'IPivotFields':
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_ColumnFields(self.Ptr)
        ret = None if intPtr==None else IPivotFields(intPtr)
        return ret
    ...
    def ShowSubtotals(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_ShowSubtotals(self.Ptr)
        return ret
    ...
    def ShowSubtotals(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_ShowSubtotals(self.Ptr, value)
    ...
    def Clear(self):
        ...
        GetDllLibXls().XlsPivotTable_Clear(self.Ptr)
    ...
    def ClearRowFieldFilter(self ,fieldName:str):
        ...
        GetDllLibXls().XlsPivotTable_ClearRowFieldFilter(self.Ptr, fieldName)
    ...
    def ClearColumnFieldFilter(self ,fieldName:str):
        ...
        GetDllLibXls().XlsPivotTable_ClearColumnFieldFilter(self.Ptr, fieldName)
    ...
    def ClearFilter(self ,fieldName:str):
        ...
        GetDllLibXls().XlsPivotTable_ClearFilter(self.Ptr, fieldName)
    ...
    def Parent(self)->'XlsPivotTablesCollection':
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_Parent(self.Ptr)
    ...
    def DisplayErrorString(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_DisplayErrorString(self.Ptr)
        return ret
    ...
    def DisplayErrorString(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_DisplayErrorString(self.Ptr, value)
    ...
    def DisplayNullString(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_DisplayNullString(self.Ptr)
        return ret
    ...
    def DisplayNullString(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_DisplayNullString(self.Ptr, value)
    ...
    def EnableDrilldown(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_EnableDrilldown(self.Ptr)
        return ret
    ...
    def EnableDrilldown(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_EnableDrilldown(self.Ptr, value)
    ...
    def EnableFieldDialog(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_EnableFieldDialog(self.Ptr)
        return ret
    ...
    def EnableFieldDialog(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_EnableFieldDialog(self.Ptr, value)
    ...
    def EnableWizard(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_EnableWizard(self.Ptr)
        return ret

    @EnableWizard.setter
    def EnableWizard(self, value:bool):
        GetDllLibXls().XlsPivotTable_set_EnableWizard.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotTable_set_EnableWizard(self.Ptr, value)
    ...
    def ErrorString(self)->str:
        ...
        GetDllLibXls().XlsPivotTable_get_ErrorString.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotTable_get_ErrorString(self.Ptr)
        return ret
    ...
    def ErrorString(self, value:str):
        ...
        GetDllLibXls().XlsPivotTable_set_ErrorString(self.Ptr, value)
    ...
    def ManualUpdate(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_ManualUpdate(self.Ptr)
        return ret

    @ManualUpdate.setter
    def ManualUpdate(self, value:bool):
        GetDllLibXls().XlsPivotTable_set_ManualUpdate.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotTable_set_ManualUpdate(self.Ptr, value)
    ...
    def MergeLabels(self)->bool:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_MergeLabels(self.Ptr)
        return ret

    @MergeLabels.setter
    def MergeLabels(self, value:bool):
        GetDllLibXls().XlsPivotTable_set_MergeLabels.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotTable_set_MergeLabels(self.Ptr, value)
    ...
    def NullString(self)->str:
        ...
        GetDllLibXls().XlsPivotTable_get_NullString.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotTable_get_NullString(self.Ptr)
        return ret
    ...
    def NullString(self, value:str):
        ...
        GetDllLibXls().XlsPivotTable_set_NullString(self.Ptr, value)
    ...
    def PageFieldOrder(self)->'PagesOrderType':
        ...
        ret = GetDllLibXls().XlsPivotTable_get_PageFieldOrder(self.Ptr)
    ...
    def PageFieldOrder(self, value:'PagesOrderType'):
        ...
        GetDllLibXls().XlsPivotTable_set_PageFieldOrder(self.Ptr, value.value)
    ...
    def PageFieldStyle(self)->str:
        ...
        GetDllLibXls().XlsPivotTable_get_PageFieldStyle.restype=c_wchar_p
        ret = GetDllLibXls().XlsPivotTable_get_PageFieldStyle(self.Ptr)
        return ret
    ...
    def PageFieldStyle(self, value:str):
        ...
        GetDllLibXls().XlsPivotTable_set_PageFieldStyle(self.Ptr, value)
    ...
    def PageFieldWrapCount(self)->int:
        ...
        ret = GetDllLibXls().XlsPivotTable_get_PageFieldWrapCount(self.Ptr)
        return ret
    ...
    def PageFieldWrapCount(self, value:int):
        ...
        GetDllLibXls().XlsPivotTable_set_PageFieldWrapCount(self.Ptr, value)
    ...
    def Cache(self)->'PivotCache':
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_Cache(self.Ptr)
    ...
    def PivotConditionalFormats(self)->'PivotConditionalFormatCollection':
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_PivotConditionalFormats(self.Ptr)
    ...
    def Workbook(self)->'XlsWorkbook':
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_Workbook(self.Ptr)
    ...
    def Worksheet(self)->'XlsWorksheet':
        ...
        intPtr = GetDllLibXls().XlsPivotTable_get_Worksheet(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotTable_get_FirstDataCol(self.Ptr)
        return ret

    @FirstDataCol.setter
    def FirstDataCol(self, value:int):
        GetDllLibXls().XlsPivotTable_set_FirstDataCol.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsPivotTable_set_FirstDataCol(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotTable_get_FirstDataRow(self.Ptr)
        return ret

    @FirstDataRow.setter
    def FirstDataRow(self, value:int):
        GetDllLibXls().XlsPivotTable_set_FirstDataRow.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsPivotTable_set_FirstDataRow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotTable_get_FirstHeaderRow(self.Ptr)
        return ret
    ...
    def FirstHeaderRow(self, value:int):
        ...
        GetDllLibXls().XlsPivotTable_set_FirstHeaderRow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotTable_get_ShowColHeaderStyle(self.Ptr)
        return ret
    ...
    def ShowColHeaderStyle(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_ShowColHeaderStyle(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotTable_get_ShowColStripes(self.Ptr)
        return ret
    ...
    def ShowColStripes(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_ShowColStripes(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotTable_get_ShowLastCol(self.Ptr)
        return ret

    @ShowLastCol.setter
    def ShowLastCol(self, value:bool):
        GetDllLibXls().XlsPivotTable_set_ShowLastCol.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsPivotTable_set_ShowLastCol(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsPivotTable_get_ShowRowHeaderStyle(self.Ptr)
        return ret
    ...
    def ShowRowHeaderStyle(self, value:bool):
        ...
        GetDllLibXls().XlsPivotTable_set_ShowRowHeaderStyle(self.Ptr, value)
