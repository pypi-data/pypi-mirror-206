...
class ChartSerieDataFormat (  XlsChartSerieDataFormat) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartSerieDataFormat_get_AreaProperties(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().ChartSerieDataFormat_get_LineProperties(self.Ptr)
    ...
    def ParentSerie(self)->'ChartSerie':
        ...
        intPtr = GetDllLibXls().ChartSerieDataFormat_get_ParentSerie(self.Ptr)
