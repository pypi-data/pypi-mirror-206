...
class Sparkline (  ISparkline) :
    ...
    def DataRange(self)->'CellRange':
        ...
        intPtr = GetDllLibXls().Sparkline_get_DataRange(self.Ptr)
    ...
    def DataRange(self, value:'CellRange'):
        ...
        GetDllLibXls().Sparkline_set_DataRange(self.Ptr, value.Ptr)
    ...
    def RefRange(self)->'CellRange':
        ...
        intPtr = GetDllLibXls().Sparkline_get_RefRange(self.Ptr)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    def RefRange(self, value:'CellRange'):
        ...
        GetDllLibXls().Sparkline_set_RefRange(self.Ptr, value.Ptr)
    ...
    def Column(self)->int:
        ...
        ret = GetDllLibXls().Sparkline_get_Column(self.Ptr)
        return ret
    ...
    def Row(self)->int:
        ...
        ret = GetDllLibXls().Sparkline_get_Row(self.Ptr)
        return ret
