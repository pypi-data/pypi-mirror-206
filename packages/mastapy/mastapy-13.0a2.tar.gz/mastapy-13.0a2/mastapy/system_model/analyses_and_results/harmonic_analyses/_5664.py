...
class BevelDifferentialSunGearHarmonicAnalysis(_5660.BevelDifferentialGearHarmonicAnalysis):
    """BevelDifferentialSunGearHarmonicAnalysis
    ...
    class _Cast_BevelDifferentialSunGearHarmonicAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialSunGearHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_sun_gear_harmonic_analysis(self) -> 'BevelDifferentialSunGearHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialSunGearHarmonicAnalysis._Cast_BevelDifferentialSunGearHarmonicAnalysis':
