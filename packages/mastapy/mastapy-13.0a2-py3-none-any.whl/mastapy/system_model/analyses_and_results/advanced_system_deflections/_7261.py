...
class ConceptCouplingAdvancedSystemDeflection(_7273.CouplingAdvancedSystemDeflection):
    """ConceptCouplingAdvancedSystemDeflection
    ...
    class _Cast_ConceptCouplingAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'ConceptCouplingAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def concept_coupling_advanced_system_deflection(self) -> 'ConceptCouplingAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2698.ConceptCouplingSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingAdvancedSystemDeflection._Cast_ConceptCouplingAdvancedSystemDeflection':
