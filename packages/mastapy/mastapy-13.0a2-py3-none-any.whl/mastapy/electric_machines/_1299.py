...
from mastapy.electric_machines import _1270, _1272, _1284
...
class UShapedLayerSpecification(_1284.RotorInternalLayerSpecification):
    """UShapedLayerSpecification
    ...
    @property
    def magnet_configuration(self) -> '_1270.MagnetConfiguration':
        ...
        value = conversion.pn_to_mp_enum(temp, _1270.MagnetConfiguration)
        return constructor.new_from_mastapy_type(_1270.MagnetConfiguration)(value) if value is not None else None

    @magnet_configuration.setter
    def magnet_configuration(self, value: '_1270.MagnetConfiguration'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1270.MagnetConfiguration.type_())
    ...
    @property
    def outer_magnets(self) -> '_1272.MagnetForLayer':
