...
class BeltDriveSteadyStateSynchronousResponse(_3061.SpecialisedAssemblySteadyStateSynchronousResponse):
    """BeltDriveSteadyStateSynchronousResponse
    ...
    class _Cast_BeltDriveSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'BeltDriveSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def belt_drive_steady_state_synchronous_response(self) -> 'BeltDriveSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BeltDriveSteadyStateSynchronousResponse._Cast_BeltDriveSteadyStateSynchronousResponse':
