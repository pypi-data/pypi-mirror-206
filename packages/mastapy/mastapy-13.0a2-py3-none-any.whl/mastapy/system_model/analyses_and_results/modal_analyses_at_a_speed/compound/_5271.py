...
class FaceGearCompoundModalAnalysisAtASpeed(_5276.GearCompoundModalAnalysisAtASpeed):
    """FaceGearCompoundModalAnalysisAtASpeed
    ...
    class _Cast_FaceGearCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'FaceGearCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def face_gear_compound_modal_analysis_at_a_speed(self) -> 'FaceGearCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5143.FaceGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5143.FaceGearModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'FaceGearCompoundModalAnalysisAtASpeed._Cast_FaceGearCompoundModalAnalysisAtASpeed':
