...
class BevelGearDesign(_1187.AGMAGleasonConicalGearDesign):
    """BevelGearDesign
    ...
    class _Cast_BevelGearDesign:
        ...
        def __init__(self, parent: 'BevelGearDesign'):
            self._parent = parent
        ...
        @property
        def bevel_gear_design(self) -> 'BevelGearDesign':
            return self._parent
    ...
    @property
    def finishing_method(self) -> '_1180.FinishingMethods':
        ...
        value = conversion.pn_to_mp_enum(temp, _1180.FinishingMethods)
        return constructor.new_from_mastapy_type(_1180.FinishingMethods)(value) if value is not None else None

    @finishing_method.setter
    def finishing_method(self, value: '_1180.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1180.FinishingMethods.type_())
    ...
    @property
    def cast_to(self) -> 'BevelGearDesign._Cast_BevelGearDesign':
