...
class MeshedCylindricalGearMicroGeometry(_0.APIBase):
    ...
    class _Cast_MeshedCylindricalGearMicroGeometry:
        ...
        def __init__(self, parent: 'MeshedCylindricalGearMicroGeometry'):
            self._parent = parent

        @property
        def meshed_cylindrical_gear_micro_geometry(self) -> 'MeshedCylindricalGearMicroGeometry':
            return self._parent
    ...
    @property
    def flanks(self) -> 'List[_1114.MeshedCylindricalGearFlankMicroGeometry]':
    ...
    @property
    def cast_to(self) -> 'MeshedCylindricalGearMicroGeometry._Cast_MeshedCylindricalGearMicroGeometry':
