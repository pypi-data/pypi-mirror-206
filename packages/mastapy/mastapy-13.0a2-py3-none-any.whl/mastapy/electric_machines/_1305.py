...
from mastapy.electric_machines import (
    _1251, _1261, _1287, _1302,
    _1307, _1308, _1306, _1245,
    _1301, _1281, _1288
)
...
class Windings(_0.APIBase):
    ...
    class _Cast_Windings:
        ...
        def __init__(self, parent: 'Windings'):
            self._parent = parent

        @property
        def windings(self) -> 'Windings':
            return self._parent
    ...
    @property
    def double_layer_winding_slot_positions(self) -> '_1251.DoubleLayerWindingSlotPositions':
        ...
        value = conversion.pn_to_mp_enum(temp, _1251.DoubleLayerWindingSlotPositions)
        return constructor.new_from_mastapy_type(_1251.DoubleLayerWindingSlotPositions)(value) if value is not None else None

    @double_layer_winding_slot_positions.setter
    def double_layer_winding_slot_positions(self, value: '_1251.DoubleLayerWindingSlotPositions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1251.DoubleLayerWindingSlotPositions.type_())
    ...
    @property
    def end_winding_inductance_method(self) -> '_1349.EndWindingInductanceMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _1349.EndWindingInductanceMethod)
        return constructor.new_from_mastapy_type(_1349.EndWindingInductanceMethod)(value) if value is not None else None

    @end_winding_inductance_method.setter
    def end_winding_inductance_method(self, value: '_1349.EndWindingInductanceMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1349.EndWindingInductanceMethod.type_())
    ...
    @property
    def fill_factor_specification_method(self) -> '_1261.FillFactorSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _1261.FillFactorSpecificationMethod)
        return constructor.new_from_mastapy_type(_1261.FillFactorSpecificationMethod)(value) if value is not None else None

    @fill_factor_specification_method.setter
    def fill_factor_specification_method(self, value: '_1261.FillFactorSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1261.FillFactorSpecificationMethod.type_())
    ...
    @property
    def include_individual_conductors(self) -> 'bool':
        """bool: 'IncludeIndividualConductors' is the original name of this property."""
    ...
    def include_individual_conductors(self, value: 'bool'):
        self.wrapped.IncludeIndividualConductors = bool(value) if value else False

    @property
    def mmf(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def number_of_coils_per_parallel_path(self) -> 'int':
        """int: 'NumberOfCoilsPerParallelPath' is the original name of this property.
    ...
    @property
    def number_of_coils_per_phase(self) -> 'int':
        """int: 'NumberOfCoilsPerPhase' is the original name of this property.
    ...
    @property
    def number_of_coils_per_phase_per_parallel_path(self) -> 'int':
        """int: 'NumberOfCoilsPerPhasePerParallelPath' is the original name of this property.
    ...
    def number_of_strands_per_turn(self, value: 'int'):
        self.wrapped.NumberOfStrandsPerTurn = int(value) if value else 0
    ...
    @property
    def number_of_winding_layers(self) -> 'int':
        """int: 'NumberOfWindingLayers' is the original name of this property."""
    ...
    def number_of_winding_layers(self, value: 'int'):
        self.wrapped.NumberOfWindingLayers = int(value) if value else 0
    ...
    @property
    def single_double_layer_windings(self) -> '_1287.SingleOrDoubleLayerWindings':
        ...
        value = conversion.pn_to_mp_enum(temp, _1287.SingleOrDoubleLayerWindings)
        return constructor.new_from_mastapy_type(_1287.SingleOrDoubleLayerWindings)(value) if value is not None else None

    @single_double_layer_windings.setter
    def single_double_layer_windings(self, value: '_1287.SingleOrDoubleLayerWindings'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1287.SingleOrDoubleLayerWindings.type_())
    ...
    @property
    def winding_connection(self) -> '_1302.WindingConnection':
        ...
        value = conversion.pn_to_mp_enum(temp, _1302.WindingConnection)
        return constructor.new_from_mastapy_type(_1302.WindingConnection)(value) if value is not None else None

    @winding_connection.setter
    def winding_connection(self, value: '_1302.WindingConnection'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1302.WindingConnection.type_())
    ...
    @property
    def winding_type(self) -> '_1307.WindingType':
        """WindingType: 'WindingType' is the original name of this property."""
        ...
        value = conversion.pn_to_mp_enum(temp, _1307.WindingType)
        return constructor.new_from_mastapy_type(_1307.WindingType)(value) if value is not None else None

    @winding_type.setter
    def winding_type(self, value: '_1307.WindingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1307.WindingType.type_())
        self.wrapped.WindingType = value

    @property
    def wire_size_specification_method(self) -> '_1308.WireSizeSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _1308.WireSizeSpecificationMethod)
        return constructor.new_from_mastapy_type(_1308.WireSizeSpecificationMethod)(value) if value is not None else None

    @wire_size_specification_method.setter
    def wire_size_specification_method(self, value: '_1308.WireSizeSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1308.WireSizeSpecificationMethod.type_())
        self.wrapped.WireSizeSpecificationMethod = value

    @property
    def mmf_fourier_series_electrical(self) -> '_1501.FourierSeries':
    ...
    @property
    def mmf_fourier_series_mechanical(self) -> '_1501.FourierSeries':
    ...
    @property
    def windings_viewer(self) -> '_1306.WindingsViewer':
    ...
    @property
    def coils(self) -> 'List[_1245.Coil]':
    ...
    @property
    def conductors(self) -> 'List[_1301.WindingConductor]':
    ...
    @property
    def phases(self) -> 'List[_1281.Phase]':
    ...
    @property
    def slot_section_details(self) -> 'List[_1288.SlotSectionDetail]':
    ...
    @property
    def cast_to(self) -> 'Windings._Cast_Windings':
