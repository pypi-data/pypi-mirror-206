...
class FontWrapper (  CommonWrapper, IInternalFont) :
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().FontWrapper_get_Parent(self.Ptr)
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().FontWrapper_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().FontWrapper_EndUpdate(self.Ptr)
...
#        GetDllLibXls().FontWrapper_add_AfterChangeEvent(self.Ptr, intPtrvalue)
...
#        GetDllLibXls().FontWrapper_remove_AfterChangeEvent(self.Ptr, intPtrvalue)
    ...
    <summary>
        ...
        ret = GetDllLibXls().FontWrapper_get_IsBold(self.Ptr)
        return ret

    @IsBold.setter
    def IsBold(self, value:bool):
        GetDllLibXls().FontWrapper_set_IsBold.argtypes=[c_void_p, c_bool]
        GetDllLibXls().FontWrapper_set_IsBold(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().FontWrapper_get_KnownColor(self.Ptr)
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().FontWrapper_set_KnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().FontWrapper_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().FontWrapper_set_Color(self.Ptr, value.Ptr)
    ...
    def SetThemeColor(self ,type:'ThemeColorType',tint:float):
        ...
        GetDllLibXls().FontWrapper_SetThemeColor(self.Ptr, enumtype,tint)
...
#        ret = GetDllLibXls().FontWrapper_GetThemeColor(self.Ptr, intPtrtype,intPtrtint)
#        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().FontWrapper_get_IsItalic(self.Ptr)
        return ret

    @IsItalic.setter
    def IsItalic(self, value:bool):
        GetDllLibXls().FontWrapper_set_IsItalic.argtypes=[c_void_p, c_bool]
        GetDllLibXls().FontWrapper_set_IsItalic(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().FontWrapper_get_MacOSOutlineFont(self.Ptr)
        return ret
    ...
    def MacOSOutlineFont(self, value:bool):
        ...
        GetDllLibXls().FontWrapper_set_MacOSOutlineFont(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().FontWrapper_get_MacOSShadow(self.Ptr)
        return ret

    @MacOSShadow.setter
    def MacOSShadow(self, value:bool):
        GetDllLibXls().FontWrapper_set_MacOSShadow.argtypes=[c_void_p, c_bool]
        GetDllLibXls().FontWrapper_set_MacOSShadow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().FontWrapper_get_Size(self.Ptr)
        return ret

    @Size.setter
    def Size(self, value:float):
        GetDllLibXls().FontWrapper_set_Size.argtypes=[c_void_p, c_double]
        GetDllLibXls().FontWrapper_set_Size(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().FontWrapper_get_IsStrikethrough(self.Ptr)
        return ret
    ...
    def IsStrikethrough(self, value:bool):
        ...
        GetDllLibXls().FontWrapper_set_IsStrikethrough(self.Ptr, value)
    ...
    def StrikethroughType(self)->str:
        ...
        GetDllLibXls().FontWrapper_get_StrikethroughType.restype=c_wchar_p
        ret = GetDllLibXls().FontWrapper_get_StrikethroughType(self.Ptr)
        return ret
    ...
    def StrikethroughType(self, value:str):
        ...
        GetDllLibXls().FontWrapper_set_StrikethroughType(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().FontWrapper_get_IsSubscript(self.Ptr)
        return ret

    @IsSubscript.setter
    def IsSubscript(self, value:bool):
        GetDllLibXls().FontWrapper_set_IsSubscript.argtypes=[c_void_p, c_bool]
        GetDllLibXls().FontWrapper_set_IsSubscript(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().FontWrapper_get_Underline(self.Ptr)
    ...
    def Underline(self, value:'FontUnderlineType'):
        ...
        GetDllLibXls().FontWrapper_set_Underline(self.Ptr, value.value)
    ...
    <summary>
        ...
        GetDllLibXls().FontWrapper_get_FontName.restype=c_wchar_p
        ret = GetDllLibXls().FontWrapper_get_FontName(self.Ptr)
        return ret
    ...
    def FontName(self, value:str):
        ...
        GetDllLibXls().FontWrapper_set_FontName(self.Ptr, value)
    ...
    def VerticalAlignment(self)->'FontVertialAlignmentType':
        ...
        ret = GetDllLibXls().FontWrapper_get_VerticalAlignment(self.Ptr)
    ...
    def VerticalAlignment(self, value:'FontVertialAlignmentType'):
        ...
        GetDllLibXls().FontWrapper_set_VerticalAlignment(self.Ptr, value.value)
    ...
    def GenerateNativeFont(self)->'Font':
        ...
        intPtr = GetDllLibXls().FontWrapper_GenerateNativeFont(self.Ptr)
    ...
    def IsAutoColor(self)->bool:
        ...
        ret = GetDllLibXls().FontWrapper_get_IsAutoColor(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().FontWrapper_get_Index(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().FontWrapper_get_Font(self.Ptr)
    ...
    def FontIndex(self)->int:
        ...
        ret = GetDllLibXls().FontWrapper_get_FontIndex(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().FontWrapper_get_IsReadOnly(self.Ptr)
        return ret

    @IsReadOnly.setter
    def IsReadOnly(self, value:bool):
        GetDllLibXls().FontWrapper_set_IsReadOnly.argtypes=[c_void_p, c_bool]
        GetDllLibXls().FontWrapper_set_IsReadOnly(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().FontWrapper_get_Workbook(self.Ptr)
    ...
    def ColorObjectUpdate(self):
        ...
        GetDllLibXls().FontWrapper_ColorObjectUpdate(self.Ptr)
    ...
    def Clone(self ,book:'XlsWorkbook',parent:'SpireObject',dicFontIndexes:'IDictionary')->'FontWrapper':
        ...
        intPtr = GetDllLibXls().FontWrapper_Clone(self.Ptr, intPtrbook,intPtrparent,intPtrdicFontIndexes)
