...
class ConceptCouplingParametricStudyTool(_4310.CouplingParametricStudyTool):
    """ConceptCouplingParametricStudyTool
    ...
    class _Cast_ConceptCouplingParametricStudyTool:
        ...
        def __init__(self, parent: 'ConceptCouplingParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def concept_coupling_parametric_study_tool(self) -> 'ConceptCouplingParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingParametricStudyTool._Cast_ConceptCouplingParametricStudyTool':
