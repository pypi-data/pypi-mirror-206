...
from mastapy.bearings.bearing_results.rolling import _1953, _1999
...
class LoadedBallBearingElement(_1999.LoadedElement):
    """LoadedBallBearingElement
    ...
    class _Cast_LoadedBallBearingElement:
        ...
        def __init__(self, parent: 'LoadedBallBearingElement'):
            self._parent = parent
        ...
        @property
        def loaded_ball_bearing_element(self) -> 'LoadedBallBearingElement':
            return self._parent
    ...
    @property
    def inner_race_contact_geometries(self) -> 'List[_1953.BallBearingRaceContactGeometry]':
    ...
    @property
    def outer_race_contact_geometries(self) -> 'List[_1953.BallBearingRaceContactGeometry]':
    ...
    @property
    def cast_to(self) -> 'LoadedBallBearingElement._Cast_LoadedBallBearingElement':
