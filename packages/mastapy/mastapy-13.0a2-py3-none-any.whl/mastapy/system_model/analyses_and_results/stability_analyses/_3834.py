...
class RollingRingAssemblyStabilityAnalysis(_3841.SpecialisedAssemblyStabilityAnalysis):
    """RollingRingAssemblyStabilityAnalysis
    ...
    class _Cast_RollingRingAssemblyStabilityAnalysis:
        ...
        def __init__(self, parent: 'RollingRingAssemblyStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def rolling_ring_assembly_stability_analysis(self) -> 'RollingRingAssemblyStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingAssemblyStabilityAnalysis._Cast_RollingRingAssemblyStabilityAnalysis':
