...
from mastapy.gears.gear_designs.klingelnberg_hypoid import _972, _973
...
class KlingelnbergCycloPalloidHypoidGearSetDesign(_978.KlingelnbergConicalGearSetDesign):
    """KlingelnbergCycloPalloidHypoidGearSetDesign
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearSetDesign:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearSetDesign'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_set_design(self) -> 'KlingelnbergCycloPalloidHypoidGearSetDesign':
            return self._parent
    ...
    @property
    def gears(self) -> 'List[_972.KlingelnbergCycloPalloidHypoidGearDesign]':
    ...
    @property
    def klingelnberg_conical_meshes(self) -> 'List[_973.KlingelnbergCycloPalloidHypoidGearMeshDesign]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes(self) -> 'List[_973.KlingelnbergCycloPalloidHypoidGearMeshDesign]':
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearSetDesign._Cast_KlingelnbergCycloPalloidHypoidGearSetDesign':
