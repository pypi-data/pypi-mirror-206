...
class StraightBevelSunGearHarmonicAnalysisOfSingleExcitation(_6081.StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation):
    """StraightBevelSunGearHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_StraightBevelSunGearHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'StraightBevelSunGearHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def straight_bevel_sun_gear_harmonic_analysis_of_single_excitation(self) -> 'StraightBevelSunGearHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelSunGearHarmonicAnalysisOfSingleExcitation._Cast_StraightBevelSunGearHarmonicAnalysisOfSingleExcitation':
