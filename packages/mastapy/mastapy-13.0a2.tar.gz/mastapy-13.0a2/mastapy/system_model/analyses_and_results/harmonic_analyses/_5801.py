...
class TorqueConverterTurbineHarmonicAnalysis(_5688.CouplingHalfHarmonicAnalysis):
    """TorqueConverterTurbineHarmonicAnalysis
    ...
    class _Cast_TorqueConverterTurbineHarmonicAnalysis:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_harmonic_analysis(self) -> 'TorqueConverterTurbineHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineHarmonicAnalysis._Cast_TorqueConverterTurbineHarmonicAnalysis':
