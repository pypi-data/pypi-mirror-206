...
class CVTSteadyStateSynchronousResponse(_2972.BeltDriveSteadyStateSynchronousResponse):
    """CVTSteadyStateSynchronousResponse
    ...
    class _Cast_CVTSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'CVTSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def cvt_steady_state_synchronous_response(self) -> 'CVTSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CVTSteadyStateSynchronousResponse._Cast_CVTSteadyStateSynchronousResponse':
