...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import (
    _4709, _4711, _4714, _4721,
    _4720, _4742, _4722, _4727,
    _4732, _4744, _4746, _4750,
    _4757, _4756, _4758, _4765,
    _4772, _4775, _4776, _4777,
    _4779, _4781, _4786, _4787,
    _4788, _4790, _4792, _4797,
    _4796, _4802, _4803, _4808,
    _4811, _4814, _4818, _4822,
    _4826, _4829, _4701
)
...
class AssemblyCompoundModalAnalysis(_4701.AbstractAssemblyCompoundModalAnalysis):
    """AssemblyCompoundModalAnalysis
    ...
    class _Cast_AssemblyCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'AssemblyCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def assembly_compound_modal_analysis(self) -> 'AssemblyCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4554.AssemblyModalAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_4709.BearingCompoundModalAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_4711.BeltDriveCompoundModalAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4714.BevelDifferentialGearSetCompoundModalAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4721.BoltedJointCompoundModalAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_4720.BoltCompoundModalAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_4742.CVTCompoundModalAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_4722.ClutchCompoundModalAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4727.ConceptCouplingCompoundModalAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4732.ConceptGearSetCompoundModalAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4744.CycloidalAssemblyCompoundModalAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4746.CycloidalDiscCompoundModalAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4750.CylindricalGearSetCompoundModalAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_4757.FEPartCompoundModalAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4756.FaceGearSetCompoundModalAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4758.FlexiblePinAssemblyCompoundModalAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4765.HypoidGearSetCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4772.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4775.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_4776.MassDiscCompoundModalAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_4777.MeasurementComponentCompoundModalAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_4779.OilSealCompoundModalAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4781.PartToPartShearCouplingCompoundModalAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4786.PlanetCarrierCompoundModalAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_4787.PointLoadCompoundModalAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_4788.PowerLoadCompoundModalAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_4790.RingPinsCompoundModalAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4792.RollingRingAssemblyCompoundModalAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4797.ShaftHubConnectionCompoundModalAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_4796.ShaftCompoundModalAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4802.SpiralBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4803.SpringDamperCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4808.StraightBevelDiffGearSetCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4811.StraightBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_4814.SynchroniserCompoundModalAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_4818.TorqueConverterCompoundModalAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4822.UnbalancedMassCompoundModalAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4826.WormGearSetCompoundModalAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4829.ZerolBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4554.AssemblyModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'AssemblyCompoundModalAnalysis._Cast_AssemblyCompoundModalAnalysis':
