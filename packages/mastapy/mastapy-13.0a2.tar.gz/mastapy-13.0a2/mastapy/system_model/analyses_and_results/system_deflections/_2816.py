...
from mastapy.system_model.analyses_and_results.system_deflections import _2817, _2815, _2739
...
class WormGearSetSystemDeflection(_2739.GearSetSystemDeflection):
    """WormGearSetSystemDeflection
    ...
    class _Cast_WormGearSetSystemDeflection:
        ...
        def __init__(self, parent: 'WormGearSetSystemDeflection'):
            self._parent = parent
        ...
        @property
        def worm_gear_set_system_deflection(self) -> 'WormGearSetSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4138.WormGearSetPowerFlow':
    ...
    @property
    def worm_gears_system_deflection(self) -> 'List[_2817.WormGearSystemDeflection]':
    ...
    @property
    def worm_meshes_system_deflection(self) -> 'List[_2815.WormGearMeshSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'WormGearSetSystemDeflection._Cast_WormGearSetSystemDeflection':
