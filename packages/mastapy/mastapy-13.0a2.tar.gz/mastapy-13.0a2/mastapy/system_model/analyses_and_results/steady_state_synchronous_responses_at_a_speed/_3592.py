...
class StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed(_3499.BevelGearMeshSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_steady_state_synchronous_response_at_a_speed(self) -> 'StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed._Cast_StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed':
        return self._Cast_StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed(self)
