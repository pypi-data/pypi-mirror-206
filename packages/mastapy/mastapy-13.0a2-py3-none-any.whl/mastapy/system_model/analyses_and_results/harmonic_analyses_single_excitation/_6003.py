...
class ConceptCouplingHarmonicAnalysisOfSingleExcitation(_6014.CouplingHarmonicAnalysisOfSingleExcitation):
    """ConceptCouplingHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_ConceptCouplingHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'ConceptCouplingHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def concept_coupling_harmonic_analysis_of_single_excitation(self) -> 'ConceptCouplingHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHarmonicAnalysisOfSingleExcitation._Cast_ConceptCouplingHarmonicAnalysisOfSingleExcitation':
