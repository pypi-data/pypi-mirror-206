...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5086, _5087, _4978
...
class ZerolBevelGearSetCompoundModalAnalysisAtAStiffness(_4978.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """ZerolBevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_ZerolBevelGearSetCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_compound_modal_analysis_at_a_stiffness(self) -> 'ZerolBevelGearSetCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4959.ZerolBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5086.ZerolBevelGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5087.ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4959.ZerolBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetCompoundModalAnalysisAtAStiffness._Cast_ZerolBevelGearSetCompoundModalAnalysisAtAStiffness':
