...
class ParetoOptimisationStrategyChartInformation(_0.APIBase):
    ...
    class _Cast_ParetoOptimisationStrategyChartInformation:
        ...
        def __init__(self, parent: 'ParetoOptimisationStrategyChartInformation'):
            self._parent = parent

        @property
        def pareto_optimisation_strategy_chart_information(self) -> 'ParetoOptimisationStrategyChartInformation':
            return self._parent
    ...
    def select_chart_type(self) -> 'ParetoOptimisationStrategyChartInformation.ScatterOrBarChart':
        ...
        value = conversion.pn_to_mp_enum(temp, ParetoOptimisationStrategyChartInformation.ScatterOrBarChart)
    ...
    def select_chart_type(self, value: 'ParetoOptimisationStrategyChartInformation.ScatterOrBarChart'):
        ...
        value = conversion.mp_to_pn_enum(value, ParetoOptimisationStrategyChartInformation.ScatterOrBarChart.type_())
        self.wrapped.SelectChartType = value

    @property
    def bars(self) -> 'List[_1539.ParetoOptimisationStrategyBars]':
    ...
    @property
    def cast_to(self) -> 'ParetoOptimisationStrategyChartInformation._Cast_ParetoOptimisationStrategyChartInformation':
