...
class MassDiscCompoundHarmonicAnalysisOfSingleExcitation(_6227.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """MassDiscCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_MassDiscCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'MassDiscCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def mass_disc_compound_harmonic_analysis_of_single_excitation(self) -> 'MassDiscCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6051.MassDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6051.MassDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'MassDiscCompoundHarmonicAnalysisOfSingleExcitation._Cast_MassDiscCompoundHarmonicAnalysisOfSingleExcitation':
