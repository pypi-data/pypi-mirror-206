...
class BeltDriveCompoundModalAnalysis(_4799.SpecialisedAssemblyCompoundModalAnalysis):
    """BeltDriveCompoundModalAnalysis
    ...
    class _Cast_BeltDriveCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'BeltDriveCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def belt_drive_compound_modal_analysis(self) -> 'BeltDriveCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4557.BeltDriveModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4557.BeltDriveModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'BeltDriveCompoundModalAnalysis._Cast_BeltDriveCompoundModalAnalysis':
