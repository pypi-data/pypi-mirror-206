...
class XlsChartDataPoint (  XlsObject, IChartDataPoint) :
    ...
    def DataFormat(self)->'IChartSerieDataFormat':
        ...
        intPtr = GetDllLibXls().XlsChartDataPoint_get_DataFormat(self.Ptr)
    ...
    def DataLabels(self)->'IChartDataLabels':
        ...
        intPtr = GetDllLibXls().XlsChartDataPoint_get_DataLabels(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartDataPoint_get_Index(self.Ptr)
        return ret
    ...
    def IsDefault(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDataPoint_get_IsDefault(self.Ptr)
        return ret
    ...
    def HasDataLabels(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartDataPoint_get_HasDataLabels(self.Ptr)
        return ret
...
<remarks>Applies only to Waterfall charts.</remarks>
        ...
        ret = GetDllLibXls().XlsChartDataPoint_get_SetAsTotal(self.Ptr)
        return ret

    @SetAsTotal.setter
    def SetAsTotal(self, value:bool):
        GetDllLibXls().XlsChartDataPoint_set_SetAsTotal.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartDataPoint_set_SetAsTotal(self.Ptr, value)
    ...
    def ClearDataFormats(self ,format:'XlsChartSerieDataFormat'):
        ...
        GetDllLibXls().XlsChartDataPoint_ClearDataFormats(self.Ptr, intPtrformat)
    ...
    def CloneDataFormat(self ,serieFormat:'XlsChartSerieDataFormat'):
        ...
        GetDllLibXls().XlsChartDataPoint_CloneDataFormat(self.Ptr, intPtrserieFormat)
