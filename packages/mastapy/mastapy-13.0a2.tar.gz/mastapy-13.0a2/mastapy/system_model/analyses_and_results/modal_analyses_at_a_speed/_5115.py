...
class ConceptCouplingConnectionModalAnalysisAtASpeed(_5126.CouplingConnectionModalAnalysisAtASpeed):
    """ConceptCouplingConnectionModalAnalysisAtASpeed
    ...
    class _Cast_ConceptCouplingConnectionModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'ConceptCouplingConnectionModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def concept_coupling_connection_modal_analysis_at_a_speed(self) -> 'ConceptCouplingConnectionModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingConnectionModalAnalysisAtASpeed._Cast_ConceptCouplingConnectionModalAnalysisAtASpeed':
