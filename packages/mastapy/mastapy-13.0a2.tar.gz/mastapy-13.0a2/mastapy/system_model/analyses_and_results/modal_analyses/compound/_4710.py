...
class BeltConnectionCompoundModalAnalysis(_4766.InterMountableComponentConnectionCompoundModalAnalysis):
    """BeltConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4556.BeltConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4556.BeltConnectionModalAnalysis]':
