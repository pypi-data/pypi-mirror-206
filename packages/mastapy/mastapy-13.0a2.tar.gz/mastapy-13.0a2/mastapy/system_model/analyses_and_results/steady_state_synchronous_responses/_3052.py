...
class RingPinsSteadyStateSynchronousResponse(_3040.MountableComponentSteadyStateSynchronousResponse):
    """RingPinsSteadyStateSynchronousResponse
    ...
    class _Cast_RingPinsSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'RingPinsSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def ring_pins_steady_state_synchronous_response(self) -> 'RingPinsSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RingPinsSteadyStateSynchronousResponse._Cast_RingPinsSteadyStateSynchronousResponse':
