...
class ConnectorPowerFlow(_4087.MountableComponentPowerFlow):
    """ConnectorPowerFlow
    ...
    class _Cast_ConnectorPowerFlow:
        ...
        def __init__(self, parent: 'ConnectorPowerFlow'):
            self._parent = parent
        ...
        @property
        def connector_power_flow(self) -> 'ConnectorPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConnectorPowerFlow._Cast_ConnectorPowerFlow':
