...
class BoltedJointCompoundSystemDeflection(_2930.SpecialisedAssemblyCompoundSystemDeflection):
    """BoltedJointCompoundSystemDeflection
    ...
    class _Cast_BoltedJointCompoundSystemDeflection:
        ...
        def __init__(self, parent: 'BoltedJointCompoundSystemDeflection'):
            self._parent = parent
        ...
        @property
        def bolted_joint_compound_system_deflection(self) -> 'BoltedJointCompoundSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2688.BoltedJointSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2688.BoltedJointSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'BoltedJointCompoundSystemDeflection._Cast_BoltedJointCompoundSystemDeflection':
