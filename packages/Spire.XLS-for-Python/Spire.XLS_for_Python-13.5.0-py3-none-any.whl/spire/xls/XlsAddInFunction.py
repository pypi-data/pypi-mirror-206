...
class XlsAddInFunction (  XlsObject, IAddInFunction, ICloneParent) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsAddInFunction_get_BookIndex(self.Ptr)
        return ret

    @BookIndex.setter
    def BookIndex(self, value:int):
        GetDllLibXls().XlsAddInFunction_set_BookIndex.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsAddInFunction_set_BookIndex(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsAddInFunction_get_NameIndex(self.Ptr)
        return ret

    @NameIndex.setter
    def NameIndex(self, value:int):
        GetDllLibXls().XlsAddInFunction_set_NameIndex.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsAddInFunction_set_NameIndex(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsAddInFunction_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().XlsAddInFunction_get_Name(self.Ptr)
        return ret
    ...
    <returns>A new object that is a copy of this instance.</returns>
        ...
        intPtr = GetDllLibXls().XlsAddInFunction_Clone(self.Ptr, intPtrparent)
