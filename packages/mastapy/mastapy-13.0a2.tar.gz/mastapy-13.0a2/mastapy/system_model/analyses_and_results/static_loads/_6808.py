...
from mastapy.system_model.analyses_and_results.static_loads import _6809, _6854
...
class ConicalGearLoadCase(_6854.GearLoadCase):
    """ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6809.ConicalGearManufactureError':
