...
class ComponentCompoundModalAnalysisAtAStiffness(_5039.PartCompoundModalAnalysisAtAStiffness):
    """ComponentCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_ComponentCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ComponentCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def component_compound_modal_analysis_at_a_stiffness(self) -> 'ComponentCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4855.ComponentModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4855.ComponentModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'ComponentCompoundModalAnalysisAtAStiffness._Cast_ComponentCompoundModalAnalysisAtAStiffness':
