...
class RollingBearingFrictionCoefficients(_1575.IndependentReportablePropertiesBase['RollingBearingFrictionCoefficients']):
    """RollingBearingFrictionCoefficients
    ...
    class _Cast_RollingBearingFrictionCoefficients:
        ...
        def __init__(self, parent: 'RollingBearingFrictionCoefficients'):
            self._parent = parent
        ...
        @property
        def rolling_bearing_friction_coefficients(self) -> 'RollingBearingFrictionCoefficients':
            return self._parent
    ...
    @property
    def use_user_specified_f1_for_din7322010(self) -> 'bool':
        """bool: 'UseUserSpecifiedF1ForDIN7322010' is the original name of this property."""
    ...
    def use_user_specified_f1_for_din7322010(self, value: 'bool'):
        self.wrapped.UseUserSpecifiedF1ForDIN7322010 = bool(value) if value else False
    ...
    @property
    def user_specified_f1_for_din7322010(self) -> 'float':
        """float: 'UserSpecifiedF1ForDIN7322010' is the original name of this property."""
    ...
    def user_specified_f1_for_din7322010(self, value: 'float'):
        self.wrapped.UserSpecifiedF1ForDIN7322010 = float(value) if value else 0.0
    ...
    @property
    def iso14179_dynamic_equivalent_load_factors(self) -> '_1930.EquivalentLoadFactors':
    ...
    @property
    def iso14179_settings(self) -> '_1959.ISO14179Settings':
    ...
    @property
    def iso14179_static_equivalent_load_factors(self) -> '_1930.EquivalentLoadFactors':
    ...
    @property
    def cast_to(self) -> 'RollingBearingFrictionCoefficients._Cast_RollingBearingFrictionCoefficients':
