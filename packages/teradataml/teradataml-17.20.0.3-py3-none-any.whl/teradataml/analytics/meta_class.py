...
class _FunctionMetaclass(type):
    ...
    def __str__(self):
        ...
        return "{}({})".format(self.__name__,
                               "<Get connection to Vantage to view signature>" if not self._signature else self._signature)
...
class _AnalyticFunction(metaclass=_FunctionMetaclass):
    ...
    # TODO : add the dart test cases for this two functions under this epic ELE-5621
