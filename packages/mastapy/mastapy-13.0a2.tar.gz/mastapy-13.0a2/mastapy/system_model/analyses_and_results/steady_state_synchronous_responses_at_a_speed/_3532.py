...
class CylindricalGearSteadyStateSynchronousResponseAtASpeed(_3543.GearSteadyStateSynchronousResponseAtASpeed):
    """CylindricalGearSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_CylindricalGearSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'CylindricalGearSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_steady_state_synchronous_response_at_a_speed(self) -> 'CylindricalGearSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearSteadyStateSynchronousResponseAtASpeed._Cast_CylindricalGearSteadyStateSynchronousResponseAtASpeed':
