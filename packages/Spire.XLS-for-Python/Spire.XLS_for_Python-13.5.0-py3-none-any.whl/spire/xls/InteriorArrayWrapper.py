...
class InteriorArrayWrapper (  XlsObject, IInterior) :
    ...
    def PatternKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().InteriorArrayWrapper_get_PatternKnownColor(self.Ptr)
    ...
    def PatternKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().InteriorArrayWrapper_set_PatternKnownColor(self.Ptr, value.value)
    ...
    def PatternColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().InteriorArrayWrapper_get_PatternColor(self.Ptr)
    ...
    def PatternColor(self, value:'Color'):
        ...
        GetDllLibXls().InteriorArrayWrapper_set_PatternColor(self.Ptr, value.Ptr)
    ...
    def KnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().InteriorArrayWrapper_get_KnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().InteriorArrayWrapper_set_KnownColor(self.Ptr, value.value)
    ...
    def Color(self)->'Color':
        ...
        intPtr = GetDllLibXls().InteriorArrayWrapper_get_Color(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().InteriorArrayWrapper_set_Color(self.Ptr, value.Ptr)
    ...
    def Gradient(self)->'ExcelGradient':
        ...
        intPtr = GetDllLibXls().InteriorArrayWrapper_get_Gradient(self.Ptr)
    ...
    def FillPattern(self)->'ExcelPatternType':
        ...
        ret = GetDllLibXls().InteriorArrayWrapper_get_FillPattern(self.Ptr)
    ...
    def FillPattern(self, value:'ExcelPatternType'):
        ...
        GetDllLibXls().InteriorArrayWrapper_set_FillPattern(self.Ptr, value.value)
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().InteriorArrayWrapper_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().InteriorArrayWrapper_EndUpdate(self.Ptr)
