...
class SynchroniserSleeveCompoundSteadyStateSynchronousResponseOnAShaft(_3469.SynchroniserPartCompoundSteadyStateSynchronousResponseOnAShaft):
    """SynchroniserSleeveCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_SynchroniserSleeveCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'SynchroniserSleeveCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def synchroniser_sleeve_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'SynchroniserSleeveCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3340.SynchroniserSleeveSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3340.SynchroniserSleeveSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'SynchroniserSleeveCompoundSteadyStateSynchronousResponseOnAShaft._Cast_SynchroniserSleeveCompoundSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_SynchroniserSleeveCompoundSteadyStateSynchronousResponseOnAShaft(self)
