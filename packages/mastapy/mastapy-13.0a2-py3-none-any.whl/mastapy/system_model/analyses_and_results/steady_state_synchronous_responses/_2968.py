...
class AGMAGleasonConicalGearSteadyStateSynchronousResponse(_2996.ConicalGearSteadyStateSynchronousResponse):
    ...
    class _Cast_AGMAGleasonConicalGearSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'AGMAGleasonConicalGearSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def agma_gleason_conical_gear_steady_state_synchronous_response(self) -> 'AGMAGleasonConicalGearSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMAGleasonConicalGearSteadyStateSynchronousResponse._Cast_AGMAGleasonConicalGearSteadyStateSynchronousResponse':
