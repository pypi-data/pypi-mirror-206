...
from nanolocal.modules.nl_nanolib import NanoLibTools, raw_high_precision_multiply
from nanolocal.modules.nl_rpc import NanoRpc
from nanolocal.internal.utils import read_from_package_if_needed, is_packaged_version
...
class ConfigParser:
    ...
    def _set_path_variables(self, app_dir):
        ...
        if is_packaged_version():
            self.services_dir = "nanolocal.internal.data.services"
