...
from mastapy.system_model_gui import _1832
from mastapy.gears import _318, _324
...
from mastapy.system_model.part_model import (
    _2452, _2455, _2458, _2454,
    _2448, _2413, _2414, _2415,
    _2416, _2419, _2422, _2423,
    _2424, _2427, _2428, _2432,
    _2433, _2434, _2435, _2442,
    _2443, _2444, _2446, _2449,
    _2451, _2456, _2457, _2459
)
from mastapy.system_model import (
    _2208, _2209, _2193, _2190,
    _2207, _2197
)
from mastapy.detailed_rigid_connectors.splines import _1379
from mastapy.system_model.fe import _2342
from mastapy.utility import _1571, _1572, _1570
from mastapy._math.vector_3d import Vector3D
from mastapy.gears.materials import _593
from mastapy.system_model.part_model.gears import (
    _2491, _2512, _2492, _2493,
    _2494, _2495, _2496, _2497,
    _2498, _2499, _2500, _2501,
    _2502, _2503, _2504, _2505,
    _2506, _2507, _2508, _2509,
    _2511, _2513, _2514, _2515,
    _2516, _2517, _2518, _2519,
    _2520, _2521, _2522, _2523,
    _2524, _2525, _2526, _2527,
    _2528, _2529, _2530, _2531,
    _2532, _2533
)
from mastapy.shafts import _35
from mastapy.system_model.part_model.configurations import _2594, _2591, _2593
from mastapy.bearings.bearing_results.rolling import _1961
from mastapy.system_model.database_access import _2245
from mastapy.system_model.analyses_and_results.load_case_groups import _5633, _5634, _5641
from mastapy.system_model.analyses_and_results.static_loads import _6769, _6768
from mastapy.utility.model_validation import _1782
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2961
from mastapy.system_model.part_model.creation_options import (
    _2550, _2551, _2552, _2553,
    _2554
)
from mastapy.gears.gear_designs.creation_options import _1140, _1142, _1143
from mastapy.nodal_analysis import _78
from mastapy.bearings.bearing_designs.rolling import _2150
from mastapy import _7521, _0
...
from mastapy.system_model.part_model.couplings import (
    _2555, _2557, _2558, _2560,
    _2561, _2562, _2563, _2565,
    _2566, _2567, _2568, _2569,
    _2575, _2576, _2577, _2579,
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1832.MASTAGUI':
    ...
    @property
    def axial_contact_ratio_requirement(self) -> '_318.ContactRatioRequirements':
        ...
        value = conversion.pn_to_mp_enum(temp, _318.ContactRatioRequirements)
        return constructor.new_from_mastapy_type(_318.ContactRatioRequirements)(value) if value is not None else None

    @axial_contact_ratio_requirement.setter
    def axial_contact_ratio_requirement(self, value: '_318.ContactRatioRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _318.ContactRatioRequirements.type_())
    ...
    @property
    def efficiency_rating_method_for_bearings(self) -> '_288.BearingEfficiencyRatingMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _288.BearingEfficiencyRatingMethod)
        return constructor.new_from_mastapy_type(_288.BearingEfficiencyRatingMethod)(value) if value is not None else None

    @efficiency_rating_method_for_bearings.setter
    def efficiency_rating_method_for_bearings(self, value: '_288.BearingEfficiencyRatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _288.BearingEfficiencyRatingMethod.type_())
    ...
    def save_external_fe_files_in_the_default_subfolder(self, value: 'bool'):
        self.wrapped.SaveExternalFEFilesInTheDefaultSubfolder = bool(value) if value else False
    ...
    @property
    def thermal_expansion_for_grounded_nodes(self) -> '_2208.ThermalExpansionOptionForGroundedNodes':
        ...
        value = conversion.pn_to_mp_enum(temp, _2208.ThermalExpansionOptionForGroundedNodes)
        return constructor.new_from_mastapy_type(_2208.ThermalExpansionOptionForGroundedNodes)(value) if value is not None else None

    @thermal_expansion_for_grounded_nodes.setter
    def thermal_expansion_for_grounded_nodes(self, value: '_2208.ThermalExpansionOptionForGroundedNodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2208.ThermalExpansionOptionForGroundedNodes.type_())
        self.wrapped.ThermalExpansionForGroundedNodes = value

    @property
    def transverse_contact_ratio_requirement(self) -> '_318.ContactRatioRequirements':
    ...
    def transverse_contact_ratio_requirement(self, value: '_318.ContactRatioRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _318.ContactRatioRequirements.type_())
        self.wrapped.TransverseContactRatioRequirement = value

    @property
    def unbalanced_mass_inclusion(self) -> '_2458.UnbalancedMassInclusionOption':
        ...
        value = conversion.pn_to_mp_enum(temp, _2458.UnbalancedMassInclusionOption)
        return constructor.new_from_mastapy_type(_2458.UnbalancedMassInclusionOption)(value) if value is not None else None

    @unbalanced_mass_inclusion.setter
    def unbalanced_mass_inclusion(self, value: '_2458.UnbalancedMassInclusionOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2458.UnbalancedMassInclusionOption.type_())
    ...
    @property
    def default_system_temperatures(self) -> '_2209.TransmissionTemperatureSet':
    ...
    @property
    def detailed_spline_settings(self) -> '_1379.DetailedSplineJointSettings':
    ...
    @property
    def electric_machine_group(self) -> '_2193.ElectricMachineGroup':
    ...
    @property
    def fe_batch_operations(self) -> '_2342.BatchOperations':
    ...
    @property
    def file_save_details_all(self) -> '_1571.FileHistory':
    ...
    @property
    def file_save_details_most_recent(self) -> '_1572.FileHistoryItem':
    ...
    @property
    def gear_set_design_group(self) -> '_324.GearSetDesignGroup':
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_external_external_meshes(self) -> '_593.ISOTR1417912001CoefficientOfFrictionConstants':
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_internal_external_meshes(self) -> '_593.ISOTR1417912001CoefficientOfFrictionConstants':
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_2491.ActiveGearSetDesignSelectionGroup':
    ...
    @property
    def settings(self) -> '_2190.DesignSettings':
    ...
    @property
    def system(self) -> '_2207.SystemReporting':
    ...
    @property
    def bearing_detail_configurations(self) -> 'List[_2594.BearingDetailConfiguration]':
    ...
    @property
    def fe_substructure_configurations(self) -> 'List[_2591.ActiveFESubstructureSelectionGroup]':
    ...
    @property
    def gear_set_configurations(self) -> 'List[_2491.ActiveGearSetDesignSelectionGroup]':
    ...
    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1961.ISO14179SettingsPerBearingType]':
    ...
    @property
    def shaft_detail_configurations(self) -> 'List[_2593.ActiveShaftDesignSelectionGroup]':
    ...
    @property
    def databases(self) -> '_2245.Databases':
    ...
    @property
    def design_states(self) -> 'List[_5633.DesignState]':
    ...
    @property
    def duty_cycles(self) -> 'List[_5634.DutyCycle]':
    ...
    @property
    def gear_set_config(self) -> '_2512.GearSetConfiguration':
    ...
    def gear_set_config(self, value: '_2512.GearSetConfiguration'):
        value = value.wrapped if value else None
        self.wrapped.GearSetConfig = value

    @property
    def masta_settings(self) -> '_2197.MastaSettings':
    ...
    @property
    def root_assembly(self) -> '_2454.RootAssembly':
    ...
    @property
    def static_loads(self) -> 'List[_6769.StaticLoadCase]':
    ...
    @property
    def time_series_load_case_groups(self) -> 'List[_5641.TimeSeriesLoadCaseGroup]':
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5633.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5634.DutyCycle':
    ...
    def add_synchroniser_shift_empty(self) -> '_2961.SynchroniserShift':
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2961.SynchroniserShift':
        """ 'AddSynchroniserShift' is the original name of this method.
    ...
    def design_state_load_case_group_named(self, name: 'str') -> '_5633.DesignState':
    ...
    def design_state_named(self, name: 'str') -> '_5633.DesignState':
    ...
    def duty_cycle_named(self, name: 'str') -> '_5634.DutyCycle':
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.08, pulley_b_diameter: Optional['float'] = 0.08, name: Optional['str'] = 'Belt Drive') -> '_2550.BeltCreationOptions':
    ...
    def new_cycloidal_assembly_creation_options(self, number_of_discs: Optional['int'] = 1, number_of_pins: Optional['int'] = 10, name: Optional['str'] = 'Cycloidal Assembly') -> '_2551.CycloidalAssemblyCreationOptions':
    ...
    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2552.CylindricalGearLinearTrainCreationOptions':
    ...
    def new_cylindrical_gear_pair_creation_options(self) -> '_1140.CylindricalGearPairCreationOptions':
    ...
    def new_hypoid_gear_set_creation_options(self) -> '_1142.HypoidGearSetCreationOptions':
    ...
    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.05) -> '_2553.PlanetCarrierCreationOptions':
    ...
    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.025, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2554.ShaftCreationOptions':
    ...
    def new_spiral_bevel_gear_set_creation_options(self) -> '_1143.SpiralBevelGearSetCreationOptions':
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_2150.RollingBearing'):
    ...
    def remove_synchroniser_shift(self, shift: '_2961.SynchroniserShift'):
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1782.Status':
    ...
    def save_with_progress(self, file_name: 'str', save_results: 'bool', progress: '_7521.TaskProgress') -> '_1782.Status':
        """ 'Save' is the original name of this method.
    ...
    def save_load_case_results(self, file_name: 'str', load_cases: 'List[_6768.LoadCase]'):
    ...
    def time_series_load_case_group_named(self, name: 'str') -> '_5641.TimeSeriesLoadCaseGroup':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_2413.Assembly]':
        """ 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2413.Assembly.TYPE]())
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1570.ExternalFullFEFileOption'] = _1570.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
        ...
        load_full_fe_option = conversion.mp_to_pn_enum(load_full_fe_option, _1570.ExternalFullFEFileOption.type_())
