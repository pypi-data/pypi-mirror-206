...
class LinkErrorBadStateResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            link_error_code = schemas.StrSchema

            class error_code(schemas.EnumBase, schemas.StrSchema):
                class MetaOapg:
                    enum_value_to_name = {
                        "link_error.bad_state": "LINK_ERROR_BAD_STATE",
                    }

                @schemas.classproperty
                def LINK_ERROR_BAD_STATE(cls):
                    return cls("link_error.bad_state")
    ...
    link_error_code: MetaOapg.properties.link_error_code
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["link_error_code"]) -> MetaOapg.properties.link_error_code:
        ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["link_error_code"]) -> MetaOapg.properties.link_error_code:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        link_error_code: typing.Union[
            MetaOapg.properties.link_error_code,
            str,
        ],
