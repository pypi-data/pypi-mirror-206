...
class SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft(_3391.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    """SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def spring_damper_compound_steady_state_synchronous_response_on_a_shaft(self) -> 'SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3328.SpringDamperSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3328.SpringDamperSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cast_to(self) -> 'SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft._Cast_SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft(self)
