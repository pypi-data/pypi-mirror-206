...
class GuideDxfModelSystemDeflection(_2694.ComponentSystemDeflection):
    """GuideDxfModelSystemDeflection
    ...
    class _Cast_GuideDxfModelSystemDeflection:
        ...
        def __init__(self, parent: 'GuideDxfModelSystemDeflection'):
            self._parent = parent
        ...
        @property
        def guide_dxf_model_system_deflection(self) -> 'GuideDxfModelSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4071.GuideDxfModelPowerFlow':
    ...
    @property
    def cast_to(self) -> 'GuideDxfModelSystemDeflection._Cast_GuideDxfModelSystemDeflection':
