...
class CustomisableEdgeProfile(_0.APIBase):
    ...
    class _Cast_CustomisableEdgeProfile:
        ...
        def __init__(self, parent: 'CustomisableEdgeProfile'):
            self._parent = parent

        @property
        def customisable_edge_profile(self) -> 'CustomisableEdgeProfile':
            return self._parent
    ...
    @property
    def customised_cutting_edge_profile(self) -> 'List[_714.MutatableCommon]':
    ...
    @property
    def cast_to(self) -> 'CustomisableEdgeProfile._Cast_CustomisableEdgeProfile':
