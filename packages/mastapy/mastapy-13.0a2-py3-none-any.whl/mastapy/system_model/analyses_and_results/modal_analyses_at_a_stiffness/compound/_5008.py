...
class CylindricalGearMeshCompoundModalAnalysisAtAStiffness(_5019.GearMeshCompoundModalAnalysisAtAStiffness):
    """CylindricalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    class _Cast_CylindricalGearMeshCompoundModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'CylindricalGearMeshCompoundModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_compound_modal_analysis_at_a_stiffness(self) -> 'CylindricalGearMeshCompoundModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4877.CylindricalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4877.CylindricalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshCompoundModalAnalysisAtAStiffness._Cast_CylindricalGearMeshCompoundModalAnalysisAtAStiffness':
