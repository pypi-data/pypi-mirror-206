...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4189, _4190, _4202
...
class CylindricalGearSetCompoundPowerFlow(_4202.GearSetCompoundPowerFlow):
    """CylindricalGearSetCompoundPowerFlow
    ...
    @property
    def gear_set_duty_cycle_rating(self) -> '_459.CylindricalGearSetDutyCycleRating':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4059.CylindricalGearSetPowerFlow]':
    ...
    @property
    def cylindrical_gears_compound_power_flow(self) -> 'List[_4189.CylindricalGearCompoundPowerFlow]':
    ...
    @property
    def cylindrical_meshes_compound_power_flow(self) -> 'List[_4190.CylindricalGearMeshCompoundPowerFlow]':
    ...
    @property
    def ratings_for_all_designs(self) -> 'List[_459.CylindricalGearSetDutyCycleRating]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4059.CylindricalGearSetPowerFlow]':
