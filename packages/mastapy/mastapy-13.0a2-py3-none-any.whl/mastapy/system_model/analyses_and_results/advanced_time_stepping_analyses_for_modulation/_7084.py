...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7082, _7083, _6991
...
class StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6991.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def straight_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7082.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7083.StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
