...
class BevelDifferentialGearMeshMultibodyDynamicsAnalysis(_5365.BevelGearMeshMultibodyDynamicsAnalysis):
    """BevelDifferentialGearMeshMultibodyDynamicsAnalysis
    ...
    class _Cast_BevelDifferentialGearMeshMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_multibody_dynamics_analysis(self) -> 'BevelDifferentialGearMeshMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshMultibodyDynamicsAnalysis._Cast_BevelDifferentialGearMeshMultibodyDynamicsAnalysis':
