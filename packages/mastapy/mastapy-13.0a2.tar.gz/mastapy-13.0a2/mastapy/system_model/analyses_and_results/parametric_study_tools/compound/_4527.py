...
class StraightBevelGearMeshCompoundParametricStudyTool(_4435.BevelGearMeshCompoundParametricStudyTool):
    """StraightBevelGearMeshCompoundParametricStudyTool
    ...
    class _Cast_StraightBevelGearMeshCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'StraightBevelGearMeshCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_mesh_compound_parametric_study_tool(self) -> 'StraightBevelGearMeshCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4397.StraightBevelGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4397.StraightBevelGearMeshParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMeshCompoundParametricStudyTool._Cast_StraightBevelGearMeshCompoundParametricStudyTool':
