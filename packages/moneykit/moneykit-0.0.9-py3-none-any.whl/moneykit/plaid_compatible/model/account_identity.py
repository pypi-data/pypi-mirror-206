...
class AccountIdentity(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'persistent_account_id': (str, none_type,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, balances, name, type, owners, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            subtype (AccountSubtype): [optional]  # noqa: E501
            ...
            persistent_account_id (str, none_type): A unique and persistent identifier for accounts that can be used to trace multiple instances of the same account across different Items for depository accounts. This is currently an opt-in field and only supported for Chase Items.. [optional]  # noqa: E501
        """
