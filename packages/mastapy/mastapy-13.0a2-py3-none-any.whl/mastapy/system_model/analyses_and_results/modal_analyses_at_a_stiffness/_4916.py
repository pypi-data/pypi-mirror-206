...
class PlanetCarrierModalAnalysisAtAStiffness(_4908.MountableComponentModalAnalysisAtAStiffness):
    """PlanetCarrierModalAnalysisAtAStiffness
    ...
    class _Cast_PlanetCarrierModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'PlanetCarrierModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def planet_carrier_modal_analysis_at_a_stiffness(self) -> 'PlanetCarrierModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierModalAnalysisAtAStiffness._Cast_PlanetCarrierModalAnalysisAtAStiffness':
