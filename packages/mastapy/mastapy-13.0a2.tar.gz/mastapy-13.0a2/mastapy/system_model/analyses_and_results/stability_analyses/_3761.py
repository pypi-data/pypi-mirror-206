...
class BoltedJointStabilityAnalysis(_3841.SpecialisedAssemblyStabilityAnalysis):
    """BoltedJointStabilityAnalysis
    ...
    class _Cast_BoltedJointStabilityAnalysis:
        ...
        def __init__(self, parent: 'BoltedJointStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def bolted_joint_stability_analysis(self) -> 'BoltedJointStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltedJointStabilityAnalysis._Cast_BoltedJointStabilityAnalysis':
