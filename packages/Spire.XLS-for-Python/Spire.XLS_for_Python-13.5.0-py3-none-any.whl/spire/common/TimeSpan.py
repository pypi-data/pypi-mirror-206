...
#        return ret
    ...
    def ToString(self)->str:
        ...
        dlllib.TimeSpan_ToString.restype=c_wchar_p
        ret = dlllib.TimeSpan_ToString(self.Ptr)
        return ret
    ...
    def ToString(self ,format:str)->str:
        ...
        dlllib.TimeSpan_ToStringF.restype=c_wchar_p
        ret = dlllib.TimeSpan_ToStringF(self.Ptr, format)
        return ret
