...
from mastapy.fe_tools.vfx_tools import _1232
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1491.DataPrecision':
        ...
        value = conversion.pn_to_mp_enum(temp, _1491.DataPrecision)
        return constructor.new_from_mastapy_type(_1491.DataPrecision)(value) if value is not None else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1491.DataPrecision'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _1491.DataPrecision.type_())
    ...
    @property
    def internal_mode_options(self) -> '_176.EigenvalueOptions':
    ...
    @property
    def solver_options(self) -> '_1232.ProSolveOptions':
