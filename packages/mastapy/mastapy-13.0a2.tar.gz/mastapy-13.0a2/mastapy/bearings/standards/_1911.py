...
class ISO2812007BallBearingDynamicEquivalentLoadCalculator(_0.APIBase):
    ...
    class _Cast_ISO2812007BallBearingDynamicEquivalentLoadCalculator:
        ...
        def __init__(self, parent: 'ISO2812007BallBearingDynamicEquivalentLoadCalculator'):
            self._parent = parent

        @property
        def iso2812007_ball_bearing_dynamic_equivalent_load_calculator(self) -> 'ISO2812007BallBearingDynamicEquivalentLoadCalculator':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ISO2812007BallBearingDynamicEquivalentLoadCalculator._Cast_ISO2812007BallBearingDynamicEquivalentLoadCalculator':
