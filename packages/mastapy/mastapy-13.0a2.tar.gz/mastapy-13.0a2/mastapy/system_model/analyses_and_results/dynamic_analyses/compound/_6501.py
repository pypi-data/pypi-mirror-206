...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6499, _6500, _6391
...
class ZerolBevelGearSetCompoundDynamicAnalysis(_6391.BevelGearSetCompoundDynamicAnalysis):
    """ZerolBevelGearSetCompoundDynamicAnalysis
    ...
    class _Cast_ZerolBevelGearSetCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'ZerolBevelGearSetCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_set_compound_dynamic_analysis(self) -> 'ZerolBevelGearSetCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6372.ZerolBevelGearSetDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6499.ZerolBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6500.ZerolBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6372.ZerolBevelGearSetDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearSetCompoundDynamicAnalysis._Cast_ZerolBevelGearSetCompoundDynamicAnalysis':
