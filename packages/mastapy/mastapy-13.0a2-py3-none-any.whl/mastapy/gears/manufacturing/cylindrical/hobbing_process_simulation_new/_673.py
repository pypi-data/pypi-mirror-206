...
class ManufacturedQualityGrade(_0.APIBase):
    ...
    class _Cast_ManufacturedQualityGrade:
        ...
        def __init__(self, parent: 'ManufacturedQualityGrade'):
            self._parent = parent

        @property
        def manufactured_quality_grade(self) -> 'ManufacturedQualityGrade':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ManufacturedQualityGrade._Cast_ManufacturedQualityGrade':
        return self._Cast_ManufacturedQualityGrade(self)
