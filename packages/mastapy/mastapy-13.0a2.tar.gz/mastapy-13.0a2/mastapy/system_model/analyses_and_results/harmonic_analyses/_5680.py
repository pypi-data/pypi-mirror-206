...
class ConceptGearMeshHarmonicAnalysis(_5724.GearMeshHarmonicAnalysis):
    """ConceptGearMeshHarmonicAnalysis
    ...
    class _Cast_ConceptGearMeshHarmonicAnalysis:
        ...
        def __init__(self, parent: 'ConceptGearMeshHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def concept_gear_mesh_harmonic_analysis(self) -> 'ConceptGearMeshHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptGearMeshHarmonicAnalysis._Cast_ConceptGearMeshHarmonicAnalysis':
