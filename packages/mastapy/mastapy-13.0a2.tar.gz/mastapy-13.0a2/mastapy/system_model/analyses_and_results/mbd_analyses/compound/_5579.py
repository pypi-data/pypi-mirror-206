...
class PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis(_5536.CouplingCompoundMultibodyDynamicsAnalysis):
    """PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_compound_multibody_dynamics_analysis(self) -> 'PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5440.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5440.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis._Cast_PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis':
