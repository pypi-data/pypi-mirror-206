...
class VehicleDynamicsProperties(_0.APIBase):
    ...
    class _Cast_VehicleDynamicsProperties:
        ...
        def __init__(self, parent: 'VehicleDynamicsProperties'):
            self._parent = parent

        @property
        def vehicle_dynamics_properties(self) -> 'VehicleDynamicsProperties':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'VehicleDynamicsProperties._Cast_VehicleDynamicsProperties':
