...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7467, _7468, _7386
...
class SpiralBevelGearSetCompoundAdvancedSystemDeflection(_7386.BevelGearSetCompoundAdvancedSystemDeflection):
    """SpiralBevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7339.SpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7467.SpiralBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7468.SpiralBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7339.SpiralBevelGearSetAdvancedSystemDeflection]':
