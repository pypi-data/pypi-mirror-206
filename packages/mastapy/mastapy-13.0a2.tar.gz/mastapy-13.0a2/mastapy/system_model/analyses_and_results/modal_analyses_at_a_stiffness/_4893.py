...
class HypoidGearMeshModalAnalysisAtAStiffness(_4834.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness):
    """HypoidGearMeshModalAnalysisAtAStiffness
    ...
    class _Cast_HypoidGearMeshModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'HypoidGearMeshModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_mesh_modal_analysis_at_a_stiffness(self) -> 'HypoidGearMeshModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'HypoidGearMeshModalAnalysisAtAStiffness._Cast_HypoidGearMeshModalAnalysisAtAStiffness':
