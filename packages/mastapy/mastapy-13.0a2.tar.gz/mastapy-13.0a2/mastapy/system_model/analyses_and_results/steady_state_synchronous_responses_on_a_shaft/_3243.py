...
class BoltedJointSteadyStateSynchronousResponseOnAShaft(_3322.SpecialisedAssemblySteadyStateSynchronousResponseOnAShaft):
    """BoltedJointSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_BoltedJointSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'BoltedJointSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def bolted_joint_steady_state_synchronous_response_on_a_shaft(self) -> 'BoltedJointSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltedJointSteadyStateSynchronousResponseOnAShaft._Cast_BoltedJointSteadyStateSynchronousResponseOnAShaft':
