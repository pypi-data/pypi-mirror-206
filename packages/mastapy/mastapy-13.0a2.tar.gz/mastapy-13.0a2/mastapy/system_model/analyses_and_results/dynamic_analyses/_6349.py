...
class StraightBevelDiffGearDynamicAnalysis(_6259.BevelGearDynamicAnalysis):
    """StraightBevelDiffGearDynamicAnalysis
    ...
    class _Cast_StraightBevelDiffGearDynamicAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelDiffGearDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_diff_gear_dynamic_analysis(self) -> 'StraightBevelDiffGearDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelDiffGearDynamicAnalysis._Cast_StraightBevelDiffGearDynamicAnalysis':
