...
T = TypeVar("T", bound="AccountIdentity")
...
class AccountIdentity:
    ...
    Attributes:
        ...
        owners (List['Owner']): A list of owners associated with the account.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for owners_item_data in _owners:
            owners_item = Owner.from_dict(owners_item_data)

            owners.append(owners_item)

        account_mask = d.pop("account_mask", UNSET)

        account_identity = cls(
            account_id=account_id,
            account_type=account_type,
            name=name,
            balances=balances,
        ...
        account_identity.additional_properties = d
