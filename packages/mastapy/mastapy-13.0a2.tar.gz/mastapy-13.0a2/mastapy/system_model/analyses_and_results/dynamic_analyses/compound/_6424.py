...
class DatumCompoundDynamicAnalysis(_6398.ComponentCompoundDynamicAnalysis):
    """DatumCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6294.DatumDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6294.DatumDynamicAnalysis]':
