...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4885, _4884, _4891
...
class FaceGearSetModalAnalysisAtAStiffness(_4891.GearSetModalAnalysisAtAStiffness):
    """FaceGearSetModalAnalysisAtAStiffness
    ...
    class _Cast_FaceGearSetModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'FaceGearSetModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def face_gear_set_modal_analysis_at_a_stiffness(self) -> 'FaceGearSetModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def face_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4885.FaceGearModalAnalysisAtAStiffness]':
    ...
    @property
    def face_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4884.FaceGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def cast_to(self) -> 'FaceGearSetModalAnalysisAtAStiffness._Cast_FaceGearSetModalAnalysisAtAStiffness':
