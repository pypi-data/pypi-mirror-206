...
from mastapy.system_model.analyses_and_results.stability_analyses import _3852, _3850, _3759
...
class StraightBevelDiffGearSetStabilityAnalysis(_3759.BevelGearSetStabilityAnalysis):
    """StraightBevelDiffGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_diff_gears_stability_analysis(self) -> 'List[_3852.StraightBevelDiffGearStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_stability_analysis(self) -> 'List[_3850.StraightBevelDiffGearMeshStabilityAnalysis]':
