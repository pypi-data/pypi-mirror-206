...
class TorqueConverterConnectionSystemDeflection(_2708.CouplingConnectionSystemDeflection):
    """TorqueConverterConnectionSystemDeflection
    ...
    class _Cast_TorqueConverterConnectionSystemDeflection:
        ...
        def __init__(self, parent: 'TorqueConverterConnectionSystemDeflection'):
            self._parent = parent
        ...
        @property
        def torque_converter_connection_system_deflection(self) -> 'TorqueConverterConnectionSystemDeflection':
            return self._parent
    ...
    @property
    def power_flow_results(self) -> '_4130.TorqueConverterConnectionPowerFlow':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterConnectionSystemDeflection._Cast_TorqueConverterConnectionSystemDeflection':
