...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5470, _5469, _5367
...
class StraightBevelGearSetMultibodyDynamicsAnalysis(_5367.BevelGearSetMultibodyDynamicsAnalysis):
    """StraightBevelGearSetMultibodyDynamicsAnalysis
    ...
    class _Cast_StraightBevelGearSetMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearSetMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_set_multibody_dynamics_analysis(self) -> 'StraightBevelGearSetMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def gears(self) -> 'List[_5470.StraightBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gears_multibody_dynamics_analysis(self) -> 'List[_5470.StraightBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_meshes_multibody_dynamics_analysis(self) -> 'List[_5469.StraightBevelGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSetMultibodyDynamicsAnalysis._Cast_StraightBevelGearSetMultibodyDynamicsAnalysis':
