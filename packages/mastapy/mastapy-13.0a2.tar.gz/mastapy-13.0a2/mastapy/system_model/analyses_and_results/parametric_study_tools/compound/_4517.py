...
class SpiralBevelGearCompoundParametricStudyTool(_4434.BevelGearCompoundParametricStudyTool):
    """SpiralBevelGearCompoundParametricStudyTool
    ...
    class _Cast_SpiralBevelGearCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'SpiralBevelGearCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_compound_parametric_study_tool(self) -> 'SpiralBevelGearCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4389.SpiralBevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4389.SpiralBevelGearParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearCompoundParametricStudyTool._Cast_SpiralBevelGearCompoundParametricStudyTool':
