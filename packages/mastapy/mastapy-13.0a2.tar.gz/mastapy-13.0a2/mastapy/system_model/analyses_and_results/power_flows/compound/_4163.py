...
class ClutchCompoundPowerFlow(_4179.CouplingCompoundPowerFlow):
    """ClutchCompoundPowerFlow
    ...
    class _Cast_ClutchCompoundPowerFlow:
        ...
        def __init__(self, parent: 'ClutchCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def clutch_compound_power_flow(self) -> 'ClutchCompoundPowerFlow':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4032.ClutchPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4032.ClutchPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'ClutchCompoundPowerFlow._Cast_ClutchCompoundPowerFlow':
