...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import (
    _3103, _3105, _3108, _3115,
    _3114, _3136, _3116, _3121,
    _3126, _3138, _3140, _3144,
    _3151, _3150, _3152, _3159,
    _3166, _3169, _3170, _3171,
    _3173, _3175, _3180, _3181,
    _3182, _3184, _3186, _3191,
    _3190, _3196, _3197, _3202,
    _3205, _3208, _3212, _3216,
    _3220, _3223, _3095
)
...
class AssemblyCompoundSteadyStateSynchronousResponse(_3095.AbstractAssemblyCompoundSteadyStateSynchronousResponse):
    """AssemblyCompoundSteadyStateSynchronousResponse
    ...
    class _Cast_AssemblyCompoundSteadyStateSynchronousResponse:
        ...
        def __init__(self, parent: 'AssemblyCompoundSteadyStateSynchronousResponse'):
            self._parent = parent
        ...
        @property
        def assembly_compound_steady_state_synchronous_response(self) -> 'AssemblyCompoundSteadyStateSynchronousResponse':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2969.AssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def bearings(self) -> 'List[_3103.BearingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def belt_drives(self) -> 'List[_3105.BeltDriveCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3108.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3115.BoltedJointCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bolts(self) -> 'List[_3114.BoltCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cv_ts(self) -> 'List[_3136.CVTCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def clutches(self) -> 'List[_3116.ClutchCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3121.ConceptCouplingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3126.ConceptGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3138.CycloidalAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3140.CycloidalDiscCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3144.CylindricalGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def fe_parts(self) -> 'List[_3151.FEPartCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3150.FaceGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3152.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3159.HypoidGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3166.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3169.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def mass_discs(self) -> 'List[_3170.MassDiscCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def measurement_components(self) -> 'List[_3171.MeasurementComponentCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def oil_seals(self) -> 'List[_3173.OilSealCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3175.PartToPartShearCouplingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3180.PlanetCarrierCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def point_loads(self) -> 'List[_3181.PointLoadCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def power_loads(self) -> 'List[_3182.PowerLoadCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def ring_pins(self) -> 'List[_3184.RingPinsCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3186.RollingRingAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3191.ShaftHubConnectionCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def shafts(self) -> 'List[_3190.ShaftCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3196.SpiralBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3197.SpringDamperCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3202.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3205.StraightBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def synchronisers(self) -> 'List[_3208.SynchroniserCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def torque_converters(self) -> 'List[_3212.TorqueConverterCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3216.UnbalancedMassCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3220.WormGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3223.ZerolBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2969.AssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def cast_to(self) -> 'AssemblyCompoundSteadyStateSynchronousResponse._Cast_AssemblyCompoundSteadyStateSynchronousResponse':
