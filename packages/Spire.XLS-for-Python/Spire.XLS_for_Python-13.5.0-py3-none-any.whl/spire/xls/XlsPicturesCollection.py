...
class XlsPicturesCollection (  CollectionBase[XlsBitmapShape], IPictures) :
    ...
    def Add(self ,image:Image,pictureName:str)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_Add(self.Ptr, intPtrimage,pictureName)
    ...
    def Add(self ,image:Image,pictureName:str,imageFormat:ImageFormatType)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddIPI(self.Ptr, intPtrimage,pictureName,enumimageFormat)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,strFileName:str)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddS(self.Ptr, strFileName)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,strFileName:str,imageFormat:ImageFormatType)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddSI(self.Ptr, strFileName,enumimageFormat)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,image:Image)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLI(self.Ptr, topRow,leftColumn,intPtrimage)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,image:Image,imageFormat:ImageFormatType)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLII(self.Ptr, topRow,leftColumn,intPtrimage,enumimageFormat)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,stream:Stream)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLS(self.Ptr, topRow,leftColumn,intPtrstream)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,stream:Stream,imageFormat:ImageFormatType)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLSI(self.Ptr, topRow,leftColumn,intPtrstream,enumimageFormat)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,fileName:str)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLF(self.Ptr, topRow,leftColumn,fileName)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,fileName:str,imageFormat:ImageFormatType)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLFI(self.Ptr, topRow,leftColumn,fileName,enumimageFormat)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,bottomRow:int,rightColumn:int,image:Image)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLBRI(self.Ptr, topRow,leftColumn,bottomRow,rightColumn,intPtrimage)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def AddLinkPic(self ,topRow:int,leftColumn:int,height:int,width:int,linktarget:str)->'IPictureShape':
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddLinkPic(self.Ptr, topRow,leftColumn,height,width,linktarget)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,bottomRow:int,rightColumn:int,image:Image,imageFormat:ImageFormatType)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLBRII(self.Ptr, topRow,leftColumn,bottomRow,rightColumn,intPtrimage,enumimageFormat)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,bottomRow:int,rightColumn:int,stream:Stream)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLBRS(self.Ptr, topRow,leftColumn,bottomRow,rightColumn,intPtrstream)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,bottomRow:int,rightColumn:int,stream:Stream,imageFormat:ImageFormatType)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLBRSI(self.Ptr, topRow,leftColumn,bottomRow,rightColumn,intPtrstream,enumimageFormat)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,bottomRow:int,rightColumn:int,fileName:str)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLBRF(self.Ptr, topRow,leftColumn,bottomRow,rightColumn,fileName)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,bottomRow:int,rightColumn:int,fileName:str,imageFormat:ImageFormatType)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLBRFI(self.Ptr, topRow,leftColumn,bottomRow,rightColumn,fileName,enumimageFormat)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,image:Image,scaleWidth:int,scaleHeight:int)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLISS(self.Ptr, topRow,leftColumn,intPtrimage,scaleWidth,scaleHeight)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,image:Image,scaleWidth:int,scaleHeight:int,imageFormat:ImageFormatType)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLISSI(self.Ptr, topRow,leftColumn,intPtrimage,scaleWidth,scaleHeight,enumimageFormat)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,stream:Stream,scaleWidth:int,scaleHeight:int)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLSSS(self.Ptr, topRow,leftColumn,intPtrstream,scaleWidth,scaleHeight)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,stream:Stream,scaleWidth:int,scaleHeight:int,imageFormat:ImageFormatType)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLSSSI(self.Ptr, topRow,leftColumn,intPtrstream,scaleWidth,scaleHeight,enumimageFormat)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,fileName:str,scaleWidth:int,scaleHeight:int)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLFSS(self.Ptr, topRow,leftColumn,fileName,scaleWidth,scaleHeight)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Add(self ,topRow:int,leftColumn:int,fileName:str,scaleWidth:int,scaleHeight:int,imageFormat:ImageFormatType)->IPictureShape:
        ...
        intPtr = GetDllLibXls().XlsPicturesCollection_AddTLFSSI(self.Ptr, topRow,leftColumn,fileName,scaleWidth,scaleHeight,enumimageFormat)
        ret = None if intPtr==None else XlsBitmapShape(intPtr)
        return ret
    ...
    def Clear(self):
        ...
        GetDllLibXls().XlsPicturesCollection_Clear(self.Ptr)
