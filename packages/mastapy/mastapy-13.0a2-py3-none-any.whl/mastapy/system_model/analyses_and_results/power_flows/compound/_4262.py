...
class TorqueConverterTurbineCompoundPowerFlow(_4181.CouplingHalfCompoundPowerFlow):
    """TorqueConverterTurbineCompoundPowerFlow
    ...
    class _Cast_TorqueConverterTurbineCompoundPowerFlow:
        ...
        def __init__(self, parent: 'TorqueConverterTurbineCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def torque_converter_turbine_compound_power_flow(self) -> 'TorqueConverterTurbineCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4133.TorqueConverterTurbinePowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4133.TorqueConverterTurbinePowerFlow]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterTurbineCompoundPowerFlow._Cast_TorqueConverterTurbineCompoundPowerFlow':
