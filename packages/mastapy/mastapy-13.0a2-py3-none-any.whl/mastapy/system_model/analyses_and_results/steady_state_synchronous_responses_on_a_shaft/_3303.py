...
class PartSteadyStateSynchronousResponseOnAShaft(_7510.PartStaticLoadAnalysisCase):
    """PartSteadyStateSynchronousResponseOnAShaft
    ...
    def create_viewable(self) -> '_2239.SteadyStateSynchronousResponseViewable':
