...
class CylindricalGearMeshHarmonicAnalysis(_5724.GearMeshHarmonicAnalysis):
    """CylindricalGearMeshHarmonicAnalysis
    ...
    class _Cast_CylindricalGearMeshHarmonicAnalysis:
        ...
        def __init__(self, parent: 'CylindricalGearMeshHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_harmonic_analysis(self) -> 'CylindricalGearMeshHarmonicAnalysis':
            return self._parent
    ...
    @property
    def advanced_system_deflection_results(self) -> '_7284.CylindricalGearMeshAdvancedSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshHarmonicAnalysis._Cast_CylindricalGearMeshHarmonicAnalysis':
