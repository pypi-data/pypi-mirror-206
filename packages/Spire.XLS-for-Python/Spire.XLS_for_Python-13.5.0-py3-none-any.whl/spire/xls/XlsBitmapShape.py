...
class XlsBitmapShape (  XlsShape, IPictureShape) :
    ...
    def Remove(self ,removeImage:bool):
        ...
        GetDllLibXls().XlsBitmapShape_Remove(self.Ptr, removeImage)
    ...
    def BlipId(self)->'UInt32':
        ...
        intPtr = GetDllLibXls().XlsBitmapShape_get_BlipId(self.Ptr)
    ...
    def ColorTo(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsBitmapShape_get_ColorTo(self.Ptr)
    ...
    def ColorTo(self, value:'Color'):
        ...
        GetDllLibXls().XlsBitmapShape_set_ColorTo(self.Ptr, value.Ptr)
    ...
    def RefRange(self)->str:
        ...
        GetDllLibXls().XlsBitmapShape_get_RefRange.restype=c_wchar_p
        ret = GetDllLibXls().XlsBitmapShape_get_RefRange(self.Ptr)
        return ret
    ...
    def RefRange(self, value:str):
        ...
        GetDllLibXls().XlsBitmapShape_set_RefRange(self.Ptr, value)
    ...
    def IsDDE(self)->bool:
        ...
        ret = GetDllLibXls().XlsBitmapShape_get_IsDDE(self.Ptr)
        return ret

    @IsDDE.setter
    def IsDDE(self, value:bool):
        GetDllLibXls().XlsBitmapShape_set_IsDDE.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsBitmapShape_set_IsDDE(self.Ptr, value)
    ...
    def IsCamera(self)->bool:
        ...
        ret = GetDllLibXls().XlsBitmapShape_get_IsCamera(self.Ptr)
        return ret

    @IsCamera.setter
    def IsCamera(self, value:bool):
        GetDllLibXls().XlsBitmapShape_set_IsCamera.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsBitmapShape_set_IsCamera(self.Ptr, value)
    ...
    def ColorFrom(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsBitmapShape_get_ColorFrom(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def ColorFrom(self, value:'Color'):
        ...
        GetDllLibXls().XlsBitmapShape_set_ColorFrom(self.Ptr, value.Ptr)
    ...
    def FileName(self)->str:
        ...
        GetDllLibXls().XlsBitmapShape_get_FileName.restype=c_wchar_p
        ret = GetDllLibXls().XlsBitmapShape_get_FileName(self.Ptr)
        return ret
    ...
    def FileName(self, value:str):
        ...
        GetDllLibXls().XlsBitmapShape_set_FileName(self.Ptr, value)
    ...
    def Picture(self)->'Image':
        ...
        intPtr = GetDllLibXls().XlsBitmapShape_get_Picture(self.Ptr)
        ret = None if intPtr==None else Image(intPtr)
        return ret


    @Picture.setter
    def Picture(self, value:'Image'):
        GetDllLibXls().XlsBitmapShape_set_Picture.argtypes=[c_void_p, c_void_p]
        GetDllLibXls().XlsBitmapShape_set_Picture(self.Ptr, value.Ptr)
    ...
    <param name="quality">picture quality.Range is 0~100</param>
        ...
        GetDllLibXls().XlsBitmapShape_Compress(self.Ptr, quality)
    ...
    def CropLeftOffset(self)->int:
        ...
        ret = GetDllLibXls().XlsBitmapShape_get_CropLeftOffset(self.Ptr)
        return ret
    ...
    def CropLeftOffset(self, value:int):
        ...
        GetDllLibXls().XlsBitmapShape_set_CropLeftOffset(self.Ptr, value)
    ...
    def CropRightOffset(self)->int:
        ...
        ret = GetDllLibXls().XlsBitmapShape_get_CropRightOffset(self.Ptr)
        return ret
    ...
    def CropRightOffset(self, value:int):
        ...
        GetDllLibXls().XlsBitmapShape_set_CropRightOffset(self.Ptr, value)
    ...
    def CropBottomOffset(self)->int:
        ...
        ret = GetDllLibXls().XlsBitmapShape_get_CropBottomOffset(self.Ptr)
        return ret
    ...
    def CropBottomOffset(self, value:int):
        ...
        GetDllLibXls().XlsBitmapShape_set_CropBottomOffset(self.Ptr, value)
    ...
    def CropTopOffset(self)->int:
        ...
        ret = GetDllLibXls().XlsBitmapShape_get_CropTopOffset(self.Ptr)
        return ret
    ...
    def CropTopOffset(self, value:int):
        ...
        GetDllLibXls().XlsBitmapShape_set_CropTopOffset(self.Ptr, value)
    ...
    def Macro(self)->str:
        ...
        GetDllLibXls().XlsBitmapShape_get_Macro.restype=c_wchar_p
        ret = GetDllLibXls().XlsBitmapShape_get_Macro(self.Ptr)
        return ret
    ...
    def Macro(self, value:str):
        ...
        GetDllLibXls().XlsBitmapShape_set_Macro(self.Ptr, value)
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsBitmapShape_get_ShapeType(self.Ptr)
    ...
    def Dispose(self):
        ...
        GetDllLibXls().XlsBitmapShape_Dispose(self.Ptr)
    ...
    def SetHyperLink(self ,linkString:str,isExternal:bool):
        ...
        GetDllLibXls().XlsBitmapShape_SetHyperLink(self.Ptr, linkString,isExternal)
...
#        intPtr = GetDllLibXls().XlsBitmapShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollection)
