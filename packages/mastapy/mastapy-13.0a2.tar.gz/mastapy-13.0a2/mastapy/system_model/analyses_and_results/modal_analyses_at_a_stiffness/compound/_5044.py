...
class PlanetaryGearSetCompoundModalAnalysisAtAStiffness(_5009.CylindricalGearSetCompoundModalAnalysisAtAStiffness):
    """PlanetaryGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4915.PlanetaryGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4915.PlanetaryGearSetModalAnalysisAtAStiffness]':
