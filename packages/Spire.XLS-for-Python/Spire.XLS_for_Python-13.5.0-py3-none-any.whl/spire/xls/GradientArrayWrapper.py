...
class GradientArrayWrapper (  XlsObject, IGradient) :
    ...
    def BackColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().GradientArrayWrapper_get_BackColorObject(self.Ptr)
    ...
    def BackColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().GradientArrayWrapper_get_BackColor(self.Ptr)
    ...
    def BackColor(self, value:'Color'):
        ...
        GetDllLibXls().GradientArrayWrapper_set_BackColor(self.Ptr, value.Ptr)
    ...
    def BackKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().GradientArrayWrapper_get_BackKnownColor(self.Ptr)
    ...
    def BackKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().GradientArrayWrapper_set_BackKnownColor(self.Ptr, value.value)
    ...
    def ForeColorObject(self)->'OColor':
        ...
        intPtr = GetDllLibXls().GradientArrayWrapper_get_ForeColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def ForeColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().GradientArrayWrapper_get_ForeColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def ForeColor(self, value:'Color'):
        ...
        GetDllLibXls().GradientArrayWrapper_set_ForeColor(self.Ptr, value.Ptr)
    ...
    def ForeKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().GradientArrayWrapper_get_ForeKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def ForeKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().GradientArrayWrapper_set_ForeKnownColor(self.Ptr, value.value)
    ...
    def GradientStyle(self)->'GradientStyleType':
        ...
        ret = GetDllLibXls().GradientArrayWrapper_get_GradientStyle(self.Ptr)
    ...
    def GradientStyle(self, value:'GradientStyleType'):
        ...
        GetDllLibXls().GradientArrayWrapper_set_GradientStyle(self.Ptr, value.value)
    ...
    def GradientVariant(self)->'GradientVariantsType':
        ...
        ret = GetDllLibXls().GradientArrayWrapper_get_GradientVariant(self.Ptr)
    ...
    def GradientVariant(self, value:'GradientVariantsType'):
        ...
        GetDllLibXls().GradientArrayWrapper_set_GradientVariant(self.Ptr, value.value)
    ...
    def CompareTo(self ,gradient:'IGradient')->int:
        ...
        ret = GetDllLibXls().GradientArrayWrapper_CompareTo(self.Ptr, intPtrgradient)
        return ret
    ...
    def TwoColorGradient(self):
        ...
        GetDllLibXls().GradientArrayWrapper_TwoColorGradient(self.Ptr)
    ...
    def TwoColorGradient(self ,style:GradientStyleType,variant:GradientVariantsType):
        ...
        GetDllLibXls().GradientArrayWrapper_TwoColorGradientSV(self.Ptr, enumstyle,enumvariant)
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().GradientArrayWrapper_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().GradientArrayWrapper_EndUpdate(self.Ptr)
