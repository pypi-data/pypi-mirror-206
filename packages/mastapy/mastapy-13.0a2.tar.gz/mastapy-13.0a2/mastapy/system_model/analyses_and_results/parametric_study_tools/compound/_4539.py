...
class UnbalancedMassCompoundParametricStudyTool(_4540.VirtualComponentCompoundParametricStudyTool):
    """UnbalancedMassCompoundParametricStudyTool
    ...
    class _Cast_UnbalancedMassCompoundParametricStudyTool:
        ...
        def __init__(self, parent: 'UnbalancedMassCompoundParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_compound_parametric_study_tool(self) -> 'UnbalancedMassCompoundParametricStudyTool':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4410.UnbalancedMassParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4410.UnbalancedMassParametricStudyTool]':
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassCompoundParametricStudyTool._Cast_UnbalancedMassCompoundParametricStudyTool':
