...
class BearingCompoundParametricStudyTool(_4454.ConnectorCompoundParametricStudyTool):
    """BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> '_1933.LoadedBearingDutyCycle':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4279.BearingParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4279.BearingParametricStudyTool]':
