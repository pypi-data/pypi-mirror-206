...
class MeasurementComponentModalAnalysisAtAStiffness(_4953.VirtualComponentModalAnalysisAtAStiffness):
    """MeasurementComponentModalAnalysisAtAStiffness
    ...
    class _Cast_MeasurementComponentModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'MeasurementComponentModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def measurement_component_modal_analysis_at_a_stiffness(self) -> 'MeasurementComponentModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'MeasurementComponentModalAnalysisAtAStiffness._Cast_MeasurementComponentModalAnalysisAtAStiffness':
