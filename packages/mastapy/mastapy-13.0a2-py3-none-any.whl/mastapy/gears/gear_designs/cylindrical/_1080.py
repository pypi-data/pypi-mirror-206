...
from mastapy.utility.units_and_measurements.measurements import _1656, _1677
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    class _Cast_ToothThicknessSpecificationBase:
        ...
        def finish_tooth_thickness_design_specification(self):
            ...
            return self._parent._cast(_1040.FinishToothThicknessDesignSpecification)

        @property
        def readonly_tooth_thickness_specification(self):
            from mastapy.gears.gear_designs.cylindrical import _1060
            
            return self._parent._cast(_1060.ReadonlyToothThicknessSpecification)

        @property
        def tooth_thickness_specification(self):
            from mastapy.gears.gear_designs.cylindrical import _1079
            
            return self._parent._cast(_1079.ToothThicknessSpecification)
    ...
    @property
    def chordal_span(self) -> '_1030.CylindricalGearToothThicknessSpecification[_1656.LengthShort]':
    ...
    @property
    def normal_thickness(self) -> '_1030.CylindricalGearToothThicknessSpecification[_1656.LengthShort]':
    ...
    @property
    def normal_thickness_at_specified_diameter(self) -> '_1030.CylindricalGearToothThicknessSpecification[_1656.LengthShort]':
    ...
    @property
    def over_balls(self) -> '_1030.CylindricalGearToothThicknessSpecification[_1656.LengthShort]':
    ...
    @property
    def over_two_pins_free_pin_method(self) -> '_1030.CylindricalGearToothThicknessSpecification[_1656.LengthShort]':
    ...
    @property
    def over_two_pins_transverse_method(self) -> '_1030.CylindricalGearToothThicknessSpecification[_1656.LengthShort]':
    ...
    @property
    def profile_shift(self) -> '_1030.CylindricalGearToothThicknessSpecification[_1656.LengthShort]':
    ...
    @property
    def profile_shift_coefficient(self) -> '_1030.CylindricalGearToothThicknessSpecification[_1677.Number]':
    ...
    @property
    def transverse_thickness(self) -> '_1030.CylindricalGearToothThicknessSpecification[_1656.LengthShort]':
    ...
    @property
    def transverse_thickness_at_specified_diameter(self) -> '_1030.CylindricalGearToothThicknessSpecification[_1656.LengthShort]':
    ...
    @property
    def tooth_thickness(self) -> 'List[_1030.CylindricalGearToothThicknessSpecification[_1656.LengthShort]]':
