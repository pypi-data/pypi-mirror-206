...
class ShaftSectionEndResultsSystemDeflection(_0.APIBase):
    ...
    class _Cast_ShaftSectionEndResultsSystemDeflection:
        ...
        def __init__(self, parent: 'ShaftSectionEndResultsSystemDeflection'):
            self._parent = parent

        @property
        def shaft_section_end_results_system_deflection(self) -> 'ShaftSectionEndResultsSystemDeflection':
            return self._parent
    ...
    @property
    def displacements(self) -> '_1553.VectorWithLinearAndAngularComponents':
    ...
    @property
    def forces(self) -> '_1553.VectorWithLinearAndAngularComponents':
    ...
    @property
    def cast_to(self) -> 'ShaftSectionEndResultsSystemDeflection._Cast_ShaftSectionEndResultsSystemDeflection':
