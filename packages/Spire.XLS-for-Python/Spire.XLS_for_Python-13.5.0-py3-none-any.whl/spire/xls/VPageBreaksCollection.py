...
class VPageBreaksCollection (  XlsVPageBreaksCollection) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().VPageBreaksCollection_get_Item(self.Ptr, index)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().VPageBreaksCollection_Add(self.Ptr, intPtrrange)
        ret = None if intPtr==None else VPageBreak(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        GetDllLibXls().VPageBreaksCollection_Remove(self.Ptr, intPtrrange)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().VPageBreaksCollection_GetPageBreak(self.Ptr, columnIndex)
        ret = None if intPtr==None else VPageBreak(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibXls().VPageBreaksCollection_GetPageBreakR(self.Ptr, intPtrrange)
        ret = None if intPtr==None else VPageBreak(intPtr)
        return ret
