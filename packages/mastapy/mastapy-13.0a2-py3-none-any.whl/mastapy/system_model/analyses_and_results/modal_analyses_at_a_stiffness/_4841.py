...
class BevelDifferentialGearMeshModalAnalysisAtAStiffness(_4846.BevelGearMeshModalAnalysisAtAStiffness):
    """BevelDifferentialGearMeshModalAnalysisAtAStiffness
    ...
    class _Cast_BevelDifferentialGearMeshModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'BevelDifferentialGearMeshModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def bevel_differential_gear_mesh_modal_analysis_at_a_stiffness(self) -> 'BevelDifferentialGearMeshModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialGearMeshModalAnalysisAtAStiffness._Cast_BevelDifferentialGearMeshModalAnalysisAtAStiffness':
