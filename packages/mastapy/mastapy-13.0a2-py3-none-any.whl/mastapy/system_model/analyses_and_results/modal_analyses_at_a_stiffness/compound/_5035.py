...
class MassDiscCompoundModalAnalysisAtAStiffness(_5082.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """MassDiscCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4906.MassDiscModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4906.MassDiscModalAnalysisAtAStiffness]':
