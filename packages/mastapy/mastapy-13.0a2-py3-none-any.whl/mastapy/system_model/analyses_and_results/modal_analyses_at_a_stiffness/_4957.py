...
class ZerolBevelGearMeshModalAnalysisAtAStiffness(_4846.BevelGearMeshModalAnalysisAtAStiffness):
    """ZerolBevelGearMeshModalAnalysisAtAStiffness
    ...
    class _Cast_ZerolBevelGearMeshModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'ZerolBevelGearMeshModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def zerol_bevel_gear_mesh_modal_analysis_at_a_stiffness(self) -> 'ZerolBevelGearMeshModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ZerolBevelGearMeshModalAnalysisAtAStiffness._Cast_ZerolBevelGearMeshModalAnalysisAtAStiffness':
