...
class Chart (  XlsChartShape) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_Series(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_ChartTitleArea(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_ChartArea(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_DataRange(self.Ptr)
    ...
    def DataRange(self, value:'CellRange'):
        ...
        GetDllLibXls().Chart_set_DataRange(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_DataTable(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_Floor(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_Legend(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_PageSetup(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_PlotArea(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_PrimaryCategoryAxis(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_PrimaryValueAxis(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_PrimarySerieAxis(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_SecondaryCategoryAxis(self.Ptr)
        ret = None if intPtr==None else ChartCategoryAxis(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_SecondaryValueAxis(self.Ptr)
        ret = None if intPtr==None else ChartValueAxis(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_Workbook(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_Walls(self.Ptr)
        ret = None if intPtr==None else ChartWallOrFloor(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().Chart_get_Worksheet(self.Ptr)
