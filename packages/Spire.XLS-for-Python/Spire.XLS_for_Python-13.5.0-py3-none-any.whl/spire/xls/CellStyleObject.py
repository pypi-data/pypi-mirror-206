...
class CellStyleObject (  SpireObject, IStyle) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_JustifyLast(self.Ptr)
        return ret

    @JustifyLast.setter
    def JustifyLast(self, value:bool):
        GetDllLibXls().CellStyleObject_set_JustifyLast.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleObject_set_JustifyLast(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().CellStyleObject_get_NumberFormatLocal.restype=c_wchar_p
        ret = GetDllLibXls().CellStyleObject_get_NumberFormatLocal(self.Ptr)
        return ret
    ...
    def NumberFormatLocal(self, value:str):
        ...
        GetDllLibXls().CellStyleObject_set_NumberFormatLocal(self.Ptr, value)
    ...
    def Interior(self)->'IInterior':
        ...
        intPtr = GetDllLibXls().CellStyleObject_get_Interior(self.Ptr)
    ...
    def IsModified(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleObject_get_IsModified(self.Ptr)
        return ret
    ...
    <param name="tint"></param>
        ...
        GetDllLibXls().CellStyleObject_SetThemeColor(self.Ptr, enumtype,tint)
...
#        ret = GetDllLibXls().CellStyleObject_GetThemeColor(self.Ptr, intPtrtype,intPtrtint)
#        return ret
    ...
    def Borders(self)->'IBorders':
        ...
        intPtr = GetDllLibXls().CellStyleObject_get_Borders(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_BuiltIn(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_FillPattern(self.Ptr)
    ...
    def FillPattern(self, value:'ExcelPatternType'):
        ...
        GetDllLibXls().CellStyleObject_set_FillPattern(self.Ptr, value.value)
    ...
    def Font(self)->'IFont':
        ...
        intPtr = GetDllLibXls().CellStyleObject_get_Font(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_FormulaHidden(self.Ptr)
        return ret
    ...
    def FormulaHidden(self, value:bool):
        ...
        GetDllLibXls().CellStyleObject_set_FormulaHidden(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_HorizontalAlignment(self.Ptr)
    ...
    def HorizontalAlignment(self, value:'HorizontalAlignType'):
        ...
        GetDllLibXls().CellStyleObject_set_HorizontalAlignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_IncludeAlignment(self.Ptr)
        return ret
    ...
    def IncludeAlignment(self, value:bool):
        ...
        GetDllLibXls().CellStyleObject_set_IncludeAlignment(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_IncludeBorder(self.Ptr)
        return ret
    ...
    def IncludeBorder(self, value:bool):
        ...
        GetDllLibXls().CellStyleObject_set_IncludeBorder(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_IncludeFont(self.Ptr)
        return ret

    @IncludeFont.setter
    def IncludeFont(self, value:bool):
        GetDllLibXls().CellStyleObject_set_IncludeFont.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleObject_set_IncludeFont(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_IncludeNumberFormat(self.Ptr)
        return ret
    ...
    def IncludeNumberFormat(self, value:bool):
        ...
        GetDllLibXls().CellStyleObject_set_IncludeNumberFormat(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_IncludePatterns(self.Ptr)
        return ret
    ...
    def IncludePatterns(self, value:bool):
        ...
        GetDllLibXls().CellStyleObject_set_IncludePatterns(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_IncludeProtection(self.Ptr)
        return ret
    ...
    def IncludeProtection(self, value:bool):
        ...
        GetDllLibXls().CellStyleObject_set_IncludeProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_IndentLevel(self.Ptr)
        return ret

    @IndentLevel.setter
    def IndentLevel(self, value:int):
        GetDllLibXls().CellStyleObject_set_IndentLevel.argtypes=[c_void_p, c_int]
        GetDllLibXls().CellStyleObject_set_IndentLevel(self.Ptr, value)
    ...
    def IsInitialized(self)->bool:
        ...
        ret = GetDllLibXls().CellStyleObject_get_IsInitialized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_Locked(self.Ptr)
        return ret

    @Locked.setter
    def Locked(self, value:bool):
        GetDllLibXls().CellStyleObject_set_Locked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleObject_set_Locked(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().CellStyleObject_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().CellStyleObject_get_Name(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().CellStyleObject_get_NumberFormat.restype=c_wchar_p
        ret = GetDllLibXls().CellStyleObject_get_NumberFormat(self.Ptr)
        return ret
    ...
    def NumberFormat(self, value:str):
        ...
        GetDllLibXls().CellStyleObject_set_NumberFormat(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_NumberFormatIndex(self.Ptr)
        return ret
    ...
    def NumberFormatIndex(self, value:int):
        ...
        GetDllLibXls().CellStyleObject_set_NumberFormatIndex(self.Ptr, value)
    ...
    def NumberFormatSettings(self)->'INumberFormat':
        ...
        intPtr = GetDllLibXls().CellStyleObject_get_NumberFormatSettings(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:int):
        GetDllLibXls().CellStyleObject_set_Rotation.argtypes=[c_void_p, c_int]
        GetDllLibXls().CellStyleObject_set_Rotation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_ShrinkToFit(self.Ptr)
        return ret

    @ShrinkToFit.setter
    def ShrinkToFit(self, value:bool):
        GetDllLibXls().CellStyleObject_set_ShrinkToFit.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleObject_set_ShrinkToFit(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_VerticalAlignment(self.Ptr)
    ...
    def VerticalAlignment(self, value:'VerticalAlignType'):
        ...
        GetDllLibXls().CellStyleObject_set_VerticalAlignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_WrapText(self.Ptr)
        return ret

    @WrapText.setter
    def WrapText(self, value:bool):
        GetDllLibXls().CellStyleObject_set_WrapText.argtypes=[c_void_p, c_bool]
        GetDllLibXls().CellStyleObject_set_WrapText(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_ReadingOrder(self.Ptr)
    ...
    def ReadingOrder(self, value:'ReadingOrderType'):
        ...
        GetDllLibXls().CellStyleObject_set_ReadingOrder(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_IsFirstSymbolApostrophe(self.Ptr)
        return ret
    ...
    def IsFirstSymbolApostrophe(self, value:bool):
        ...
        GetDllLibXls().CellStyleObject_set_IsFirstSymbolApostrophe(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_PatternKnownColor(self.Ptr)
    ...
    def PatternKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().CellStyleObject_set_PatternKnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellStyleObject_get_PatternColor(self.Ptr)
    ...
    def PatternColor(self, value:'Color'):
        ...
        GetDllLibXls().CellStyleObject_set_PatternColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().CellStyleObject_get_KnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().CellStyleObject_set_KnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().CellStyleObject_get_Color(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().CellStyleObject_set_Color(self.Ptr, value.Ptr)
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().CellStyleObject_get_Parent(self.Ptr)
    ...
    def BeginUpdate(self):
        ...
        GetDllLibXls().CellStyleObject_BeginUpdate(self.Ptr)
    ...
    def EndUpdate(self):
        ...
        GetDllLibXls().CellStyleObject_EndUpdate(self.Ptr)
