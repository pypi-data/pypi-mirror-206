...
class ClutchConnectionCompoundHarmonicAnalysis(_5884.CouplingConnectionCompoundHarmonicAnalysis):
    """ClutchConnectionCompoundHarmonicAnalysis
    ...
    class _Cast_ClutchConnectionCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'ClutchConnectionCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def clutch_connection_compound_harmonic_analysis(self) -> 'ClutchConnectionCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5670.ClutchConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5670.ClutchConnectionHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'ClutchConnectionCompoundHarmonicAnalysis._Cast_ClutchConnectionCompoundHarmonicAnalysis':
