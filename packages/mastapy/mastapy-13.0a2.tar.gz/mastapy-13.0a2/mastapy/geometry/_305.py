...
class PackagingLimits(_1575.IndependentReportablePropertiesBase['PackagingLimits']):
    """PackagingLimits
    ...
    class _Cast_PackagingLimits:
        ...
        def __init__(self, parent: 'PackagingLimits'):
            self._parent = parent
        ...
        @property
        def packaging_limits(self) -> 'PackagingLimits':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PackagingLimits._Cast_PackagingLimits':
