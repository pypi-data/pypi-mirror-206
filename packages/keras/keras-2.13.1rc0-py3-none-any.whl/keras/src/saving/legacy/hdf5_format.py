...
from keras.src.optimizers import optimizer as optimizer_base
from keras.src.optimizers import optimizer_v1
from keras.src.saving import object_registration
from keras.src.saving.legacy import model_config as model_config_lib
...
sequential_lib = LazyLoader(
    "sequential_lib", globals(), "keras.src.engine.sequential"
)
