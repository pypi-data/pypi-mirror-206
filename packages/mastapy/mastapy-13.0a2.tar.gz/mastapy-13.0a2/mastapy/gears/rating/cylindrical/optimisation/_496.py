...
class CylindricalGearSetRatingOptimisationHelper(_0.APIBase):
    ...
    class _Cast_CylindricalGearSetRatingOptimisationHelper:
        ...
        def __init__(self, parent: 'CylindricalGearSetRatingOptimisationHelper'):
            self._parent = parent

        @property
        def cylindrical_gear_set_rating_optimisation_helper(self) -> 'CylindricalGearSetRatingOptimisationHelper':
            return self._parent
    ...
    @property
    def helix_angle_optimisation_results(self) -> '_497.OptimisationResultsPair[_500.SafetyFactorOptimisationStepResultAngle]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_500.SafetyFactorOptimisationStepResultAngle](temp) if temp is not None else None

    @property
    def normal_module_optimisation_results(self) -> '_497.OptimisationResultsPair[_502.SafetyFactorOptimisationStepResultShortLength]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_502.SafetyFactorOptimisationStepResultShortLength](temp) if temp is not None else None

    @property
    def pressure_angle_optimisation_results(self) -> '_497.OptimisationResultsPair[_500.SafetyFactorOptimisationStepResultAngle]':
    ...
    @property
    def profile_shift_coefficient_optimisation_results(self) -> '_497.OptimisationResultsPair[_501.SafetyFactorOptimisationStepResultNumber]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_501.SafetyFactorOptimisationStepResultNumber](temp) if temp is not None else None

    @property
    def all_helix_angle_optimisation_results(self) -> 'List[_498.SafetyFactorOptimisationResults[_500.SafetyFactorOptimisationStepResultAngle]]':
    ...
    @property
    def all_normal_module_optimisation_results(self) -> 'List[_498.SafetyFactorOptimisationResults[_502.SafetyFactorOptimisationStepResultShortLength]]':
    ...
    @property
    def all_normal_pressure_angle_optimisation_results(self) -> 'List[_498.SafetyFactorOptimisationResults[_500.SafetyFactorOptimisationStepResultAngle]]':
    ...
    @property
    def all_profile_shift_optimisation_results(self) -> 'List[_498.SafetyFactorOptimisationResults[_501.SafetyFactorOptimisationStepResultNumber]]':
    ...
    @property
    def helix_angle_and_normal_pressure_angle_optimisation_results(self) -> 'List[_498.SafetyFactorOptimisationResults[_500.SafetyFactorOptimisationStepResultAngle]]':
    ...
    @property
    def cast_to(self) -> 'CylindricalGearSetRatingOptimisationHelper._Cast_CylindricalGearSetRatingOptimisationHelper':
