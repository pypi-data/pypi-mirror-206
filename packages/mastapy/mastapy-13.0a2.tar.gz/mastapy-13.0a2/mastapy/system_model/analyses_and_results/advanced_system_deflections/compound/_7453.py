...
class PlanetCarrierCompoundAdvancedSystemDeflection(_7445.MountableComponentCompoundAdvancedSystemDeflection):
    """PlanetCarrierCompoundAdvancedSystemDeflection
    ...
    class _Cast_PlanetCarrierCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'PlanetCarrierCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def planet_carrier_compound_advanced_system_deflection(self) -> 'PlanetCarrierCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7323.PlanetCarrierAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7323.PlanetCarrierAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'PlanetCarrierCompoundAdvancedSystemDeflection._Cast_PlanetCarrierCompoundAdvancedSystemDeflection':
