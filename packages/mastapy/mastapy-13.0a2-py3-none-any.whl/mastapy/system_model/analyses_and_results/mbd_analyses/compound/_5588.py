...
class RingPinsCompoundMultibodyDynamicsAnalysis(_5576.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """RingPinsCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_RingPinsCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'RingPinsCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def ring_pins_compound_multibody_dynamics_analysis(self) -> 'RingPinsCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5447.RingPinsMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5447.RingPinsMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'RingPinsCompoundMultibodyDynamicsAnalysis._Cast_RingPinsCompoundMultibodyDynamicsAnalysis':
