...
class DatumParametricStudyTool(_4296.ComponentParametricStudyTool):
    """DatumParametricStudyTool
    ...
    class _Cast_DatumParametricStudyTool:
        ...
        def __init__(self, parent: 'DatumParametricStudyTool'):
            self._parent = parent
        ...
        @property
        def datum_parametric_study_tool(self) -> 'DatumParametricStudyTool':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'DatumParametricStudyTool._Cast_DatumParametricStudyTool':
