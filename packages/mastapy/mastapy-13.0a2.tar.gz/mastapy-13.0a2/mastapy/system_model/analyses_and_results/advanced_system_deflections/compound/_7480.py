...
class StraightBevelSunGearCompoundAdvancedSystemDeflection(_7473.StraightBevelDiffGearCompoundAdvancedSystemDeflection):
    """StraightBevelSunGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7350.StraightBevelSunGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7350.StraightBevelSunGearAdvancedSystemDeflection]':
