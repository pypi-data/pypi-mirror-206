...
class PartToPartShearCouplingHalfMultibodyDynamicsAnalysis(_5388.CouplingHalfMultibodyDynamicsAnalysis):
    """PartToPartShearCouplingHalfMultibodyDynamicsAnalysis
    ...
    class _Cast_PartToPartShearCouplingHalfMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingHalfMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_half_multibody_dynamics_analysis(self) -> 'PartToPartShearCouplingHalfMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingHalfMultibodyDynamicsAnalysis._Cast_PartToPartShearCouplingHalfMultibodyDynamicsAnalysis':
