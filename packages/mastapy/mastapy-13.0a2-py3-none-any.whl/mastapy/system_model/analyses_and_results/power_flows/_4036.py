...
class ConceptCouplingHalfPowerFlow(_4047.CouplingHalfPowerFlow):
    """ConceptCouplingHalfPowerFlow
    ...
    class _Cast_ConceptCouplingHalfPowerFlow:
        ...
        def __init__(self, parent: 'ConceptCouplingHalfPowerFlow'):
            self._parent = parent
        ...
        @property
        def concept_coupling_half_power_flow(self) -> 'ConceptCouplingHalfPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'ConceptCouplingHalfPowerFlow._Cast_ConceptCouplingHalfPowerFlow':
