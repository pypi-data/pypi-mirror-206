...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4241, _4242, _4160
...
class SpiralBevelGearSetCompoundPowerFlow(_4160.BevelGearSetCompoundPowerFlow):
    """SpiralBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4113.SpiralBevelGearSetPowerFlow]':
    ...
    @property
    def spiral_bevel_gears_compound_power_flow(self) -> 'List[_4241.SpiralBevelGearCompoundPowerFlow]':
    ...
    @property
    def spiral_bevel_meshes_compound_power_flow(self) -> 'List[_4242.SpiralBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4113.SpiralBevelGearSetPowerFlow]':
