...
class CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft(_3273.CylindricalGearSteadyStateSynchronousResponseOnAShaft):
    """CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def cylindrical_planet_gear_steady_state_synchronous_response_on_a_shaft(self) -> 'CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft._Cast_CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft':
        return self._Cast_CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft(self)
