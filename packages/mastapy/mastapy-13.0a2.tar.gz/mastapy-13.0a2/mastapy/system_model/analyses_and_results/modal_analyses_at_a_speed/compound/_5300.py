...
class PartToPartShearCouplingHalfCompoundModalAnalysisAtASpeed(_5257.CouplingHalfCompoundModalAnalysisAtASpeed):
    """PartToPartShearCouplingHalfCompoundModalAnalysisAtASpeed
    ...
    class _Cast_PartToPartShearCouplingHalfCompoundModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingHalfCompoundModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_half_compound_modal_analysis_at_a_speed(self) -> 'PartToPartShearCouplingHalfCompoundModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5170.PartToPartShearCouplingHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5170.PartToPartShearCouplingHalfModalAnalysisAtASpeed]':
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingHalfCompoundModalAnalysisAtASpeed._Cast_PartToPartShearCouplingHalfCompoundModalAnalysisAtASpeed':
