...
class Int16 (SpireObject) :
    ...
    def ToString(self)->str:
        ...
        dlllib.Int16_ToString.restype=c_wchar_p
        ret = dlllib.Int16_ToString(self.Ptr)
        return ret
...
#
    ...
    def ToString(self ,format:str)->str:
        ...
        dlllib.Int16_ToStringF.restype=c_wchar_p
        ret = dlllib.Int16_ToStringF(self.Ptr, format)
        return ret
