...
from mastapy.electric_machines import _1254, _1260, _1276
...
class ElectricMachineGroup(_0.APIBase):
    ...
    @property
    def electric_machine_details(self) -> 'List[_1254.ElectricMachineDetail]':
    ...
    @property
    def electric_machine_load_case_groups(self) -> 'List[_1347.ElectricMachineLoadCaseGroup]':
    ...
    def add_electric_machine_detail(self, type_: '_1260.ElectricMachineType', name: Optional['str'] = 'Motor') -> '_1276.NonCADElectricMachineDetail':
        ...
        type_ = conversion.mp_to_pn_enum(type_, _1260.ElectricMachineType.type_())
        name = str(name)
        method_result = self.wrapped.AddElectricMachineDetail(type_, name if name else '')
        type_ = method_result.GetType()
        return constructor.new(type_.Namespace, type_.Name)(method_result) if method_result is not None else None

    def add_load_case_group(self, name: Optional['str'] = 'New Load Case Group') -> '_1347.ElectricMachineLoadCaseGroup':
    ...
    def duplicate_electric_machine_detail(self, detail: '_1254.ElectricMachineDetail') -> '_1254.ElectricMachineDetail':
    ...
    def electric_machine_detail_named(self, name: 'str', has_non_linear_dq_model: 'bool') -> '_1254.ElectricMachineDetail':
    ...
    def load_case_group_named(self, load_case_group_name: 'str') -> '_1347.ElectricMachineLoadCaseGroup':
    ...
    def remove_electric_machine_detail(self, motor: '_1254.ElectricMachineDetail') -> 'bool':
    ...
    def try_remove_load_case_group(self, load_case_group: '_1347.ElectricMachineLoadCaseGroup') -> 'bool':
