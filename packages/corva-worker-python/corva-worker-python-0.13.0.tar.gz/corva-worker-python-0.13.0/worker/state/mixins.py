...
class RedisMixin(LoggingMixin, RollbarMixin):
    ...
    def _size_limits(self):
        ...
        size_limits = {
            "fatal": float(state_storage_limit_fatal),
            "warning": float(state_storage_limit_warning)
        }
        return size_limits
    ...
    @staticmethod
    def get_formatted_state_key(asset_id: int, app_key: str, module_key: Union[str, None] = None) -> str:
        """
