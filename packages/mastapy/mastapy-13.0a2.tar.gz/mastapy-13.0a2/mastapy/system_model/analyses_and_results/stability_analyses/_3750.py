...
class BearingStabilityAnalysis(_3778.ConnectorStabilityAnalysis):
    """BearingStabilityAnalysis
    ...
    class _Cast_BearingStabilityAnalysis:
        ...
        def __init__(self, parent: 'BearingStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def bearing_stability_analysis(self) -> 'BearingStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BearingStabilityAnalysis._Cast_BearingStabilityAnalysis':
