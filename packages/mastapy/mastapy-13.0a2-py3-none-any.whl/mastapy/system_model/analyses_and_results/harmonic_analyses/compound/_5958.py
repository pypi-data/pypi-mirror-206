...
class StraightBevelSunGearCompoundHarmonicAnalysis(_5951.StraightBevelDiffGearCompoundHarmonicAnalysis):
    """StraightBevelSunGearCompoundHarmonicAnalysis
    ...
    class _Cast_StraightBevelSunGearCompoundHarmonicAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelSunGearCompoundHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_sun_gear_compound_harmonic_analysis(self) -> 'StraightBevelSunGearCompoundHarmonicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5793.StraightBevelSunGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5793.StraightBevelSunGearHarmonicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelSunGearCompoundHarmonicAnalysis._Cast_StraightBevelSunGearCompoundHarmonicAnalysis':
