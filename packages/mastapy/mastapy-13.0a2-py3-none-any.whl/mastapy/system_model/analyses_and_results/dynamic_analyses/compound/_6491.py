...
class TorqueConverterConnectionCompoundDynamicAnalysis(_6411.CouplingConnectionCompoundDynamicAnalysis):
    """TorqueConverterConnectionCompoundDynamicAnalysis
    ...
    class _Cast_TorqueConverterConnectionCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'TorqueConverterConnectionCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def torque_converter_connection_compound_dynamic_analysis(self) -> 'TorqueConverterConnectionCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6361.TorqueConverterConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6361.TorqueConverterConnectionDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterConnectionCompoundDynamicAnalysis._Cast_TorqueConverterConnectionCompoundDynamicAnalysis':
