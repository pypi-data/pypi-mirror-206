...
class SpringDamperLoadCase(_6817.CouplingLoadCase):
    """SpringDamperLoadCase
    ...
    class _Cast_SpringDamperLoadCase:
        ...
        def __init__(self, parent: 'SpringDamperLoadCase'):
            self._parent = parent
        ...
        @property
        def spring_damper_load_case(self) -> 'SpringDamperLoadCase':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperLoadCase._Cast_SpringDamperLoadCase':
