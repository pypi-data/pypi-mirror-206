...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4358, _4355, _4323
...
class ParametricStudyVariable(_2627.AnalysisCaseVariable):
    """ParametricStudyVariable
    ...
    class _Cast_ParametricStudyVariable:
        ...
        def __init__(self, parent: 'ParametricStudyVariable'):
            self._parent = parent

        @property
        def analysis_case_variable(self):
            return self._parent._cast(_2627.AnalysisCaseVariable)

        @property
        def parametric_study_variable(self) -> 'ParametricStudyVariable':
            return self._parent
    ...
    @property
    def dimension(self) -> '_4358.ParametricStudyDimension':
        ...
        value = conversion.pn_to_mp_enum(temp, _4358.ParametricStudyDimension)
        return constructor.new_from_mastapy_type(_4358.ParametricStudyDimension)(value) if value is not None else None

    @dimension.setter
    def dimension(self, value: '_4358.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _4358.ParametricStudyDimension.type_())
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4355.MonteCarloDistribution':
        ...
        value = conversion.pn_to_mp_enum(temp, _4355.MonteCarloDistribution)
        return constructor.new_from_mastapy_type(_4355.MonteCarloDistribution)(value) if value is not None else None

    @distribution.setter
    def distribution(self, value: '_4355.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _4355.MonteCarloDistribution.type_())
    ...
    @property
    def doe_variable_setter(self) -> '_4323.DesignOfExperimentsVariableSetter':
    ...
    @property
    def cast_to(self) -> 'ParametricStudyVariable._Cast_ParametricStudyVariable':
