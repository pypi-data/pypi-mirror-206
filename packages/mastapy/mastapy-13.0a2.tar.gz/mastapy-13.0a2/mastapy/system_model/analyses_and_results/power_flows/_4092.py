...
class PartToPartShearCouplingPowerFlow(_4048.CouplingPowerFlow):
    """PartToPartShearCouplingPowerFlow
    ...
    class _Cast_PartToPartShearCouplingPowerFlow:
        ...
        def __init__(self, parent: 'PartToPartShearCouplingPowerFlow'):
            self._parent = parent
        ...
        @property
        def part_to_part_shear_coupling_power_flow(self) -> 'PartToPartShearCouplingPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PartToPartShearCouplingPowerFlow._Cast_PartToPartShearCouplingPowerFlow':
