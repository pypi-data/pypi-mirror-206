...
class CylindricalGearMeshDynamicAnalysis(_6303.GearMeshDynamicAnalysis):
    """CylindricalGearMeshDynamicAnalysis
    ...
    class _Cast_CylindricalGearMeshDynamicAnalysis:
        ...
        def __init__(self, parent: 'CylindricalGearMeshDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_mesh_dynamic_analysis(self) -> 'CylindricalGearMeshDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMeshDynamicAnalysis._Cast_CylindricalGearMeshDynamicAnalysis':
