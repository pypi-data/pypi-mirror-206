...
class PulleySteadyStateSynchronousResponseOnAShaft(_3262.CouplingHalfSteadyStateSynchronousResponseOnAShaft):
    """PulleySteadyStateSynchronousResponseOnAShaft
    ...
    class _Cast_PulleySteadyStateSynchronousResponseOnAShaft:
        ...
        def __init__(self, parent: 'PulleySteadyStateSynchronousResponseOnAShaft'):
            self._parent = parent
        ...
        @property
        def pulley_steady_state_synchronous_response_on_a_shaft(self) -> 'PulleySteadyStateSynchronousResponseOnAShaft':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PulleySteadyStateSynchronousResponseOnAShaft._Cast_PulleySteadyStateSynchronousResponseOnAShaft':
