...
class IListObjectColumn (SpireObject) :
    ...
    <summary>
        ...
        GetDllLibXls().IListObjectColumn_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().IListObjectColumn_get_Name(self.Ptr)
        return ret
    ...
    def Name(self, value:str):
        ...
        GetDllLibXls().IListObjectColumn_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().IListObjectColumn_get_Index(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().IListObjectColumn_get_Id(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().IListObjectColumn_get_TotalsCalculation(self.Ptr)
    ...
    def TotalsCalculation(self, value:'ExcelTotalsCalculation'):
        ...
        GetDllLibXls().IListObjectColumn_set_TotalsCalculation(self.Ptr, value.value)
    ...
    <summary>
        ...
        GetDllLibXls().IListObjectColumn_get_TotalsRowLabel.restype=c_wchar_p
        ret = GetDllLibXls().IListObjectColumn_get_TotalsRowLabel(self.Ptr)
        return ret
    ...
    def TotalsRowLabel(self, value:str):
        ...
        GetDllLibXls().IListObjectColumn_set_TotalsRowLabel(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().IListObjectColumn_get_CalculatedFormula.restype=c_wchar_p
        ret = GetDllLibXls().IListObjectColumn_get_CalculatedFormula(self.Ptr)
        return ret
    ...
    def CalculatedFormula(self, value:str):
        ...
        GetDllLibXls().IListObjectColumn_set_CalculatedFormula(self.Ptr, value)
