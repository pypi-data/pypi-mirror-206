...
class TransmissionEfficiencySettings(_0.APIBase):
    ...
    class _Cast_TransmissionEfficiencySettings:
        ...
        def __init__(self, parent: 'TransmissionEfficiencySettings'):
            self._parent = parent

        @property
        def transmission_efficiency_settings(self) -> 'TransmissionEfficiencySettings':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TransmissionEfficiencySettings._Cast_TransmissionEfficiencySettings':
