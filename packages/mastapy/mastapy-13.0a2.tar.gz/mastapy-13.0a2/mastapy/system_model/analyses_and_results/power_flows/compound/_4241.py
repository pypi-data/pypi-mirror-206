...
class SpiralBevelGearCompoundPowerFlow(_4158.BevelGearCompoundPowerFlow):
    """SpiralBevelGearCompoundPowerFlow
    ...
    class _Cast_SpiralBevelGearCompoundPowerFlow:
        ...
        def __init__(self, parent: 'SpiralBevelGearCompoundPowerFlow'):
            self._parent = parent
        ...
        @property
        def spiral_bevel_gear_compound_power_flow(self) -> 'SpiralBevelGearCompoundPowerFlow':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4112.SpiralBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4112.SpiralBevelGearPowerFlow]':
    ...
    @property
    def cast_to(self) -> 'SpiralBevelGearCompoundPowerFlow._Cast_SpiralBevelGearCompoundPowerFlow':
