...
class CoaxialConnectionCompoundStabilityAnalysis(_3971.ShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """CoaxialConnectionCompoundStabilityAnalysis
    ...
    class _Cast_CoaxialConnectionCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'CoaxialConnectionCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def coaxial_connection_compound_stability_analysis(self) -> 'CoaxialConnectionCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3766.CoaxialConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3766.CoaxialConnectionStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'CoaxialConnectionCompoundStabilityAnalysis._Cast_CoaxialConnectionCompoundStabilityAnalysis':
