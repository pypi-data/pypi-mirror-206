...
requirements = [
    str(requirement)
    for requirement
    in parse_requirements(pathlib.Path('requirements.txt').open("r"))
]
...
setup(
    ...
    url="https://github.com/betepok506/RankingMetrics",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Andrey Rotanov",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="rotanov07@mail.ru",  # Optional
