...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3106, _3107, _3113
...
class BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse(_3113.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2974.BevelDifferentialGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_gears_compound_steady_state_synchronous_response(self) -> 'List[_3106.BevelDifferentialGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3107.BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2974.BevelDifferentialGearSetSteadyStateSynchronousResponse]':
