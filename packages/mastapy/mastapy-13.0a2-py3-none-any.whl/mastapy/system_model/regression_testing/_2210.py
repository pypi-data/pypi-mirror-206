...
class PerformRegressionTestFromMASTAOptions(_0.APIBase):
    ...
    class _Cast_PerformRegressionTestFromMASTAOptions:
        ...
        def __init__(self, parent: 'PerformRegressionTestFromMASTAOptions'):
            self._parent = parent

        @property
        def perform_regression_test_from_masta_options(self) -> 'PerformRegressionTestFromMASTAOptions':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PerformRegressionTestFromMASTAOptions._Cast_PerformRegressionTestFromMASTAOptions':
