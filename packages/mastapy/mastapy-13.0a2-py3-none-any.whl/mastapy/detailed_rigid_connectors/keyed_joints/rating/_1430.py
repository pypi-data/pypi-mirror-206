...
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1429
...
class KeywayRating(_1437.InterferenceFitRating):
    """KeywayRating
    ...
    class _Cast_KeywayRating:
        ...
        def shaft_hub_connection_rating(self):
            ...
            return self._parent._cast(_1424.ShaftHubConnectionRating)
    ...
    @property
    def keyed_joint_design(self) -> '_1425.KeyedJointDesign':
    ...
    @property
    def keyway_half_ratings(self) -> 'List[_1429.KeywayHalfRating]':
