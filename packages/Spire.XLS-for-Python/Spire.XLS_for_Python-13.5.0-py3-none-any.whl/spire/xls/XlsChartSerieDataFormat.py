...
class XlsChartSerieDataFormat (  XlsObject, IChartSerieDataFormat, IChartFillBorder) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_ShowMeanMarkers(self.Ptr)
        return ret
    ...
    def ShowMeanMarkers(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_ShowMeanMarkers(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_ShowInnerPoints(self.Ptr)
        return ret
    ...
    def ShowInnerPoints(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_ShowInnerPoints(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_ShowOutlierPoints(self.Ptr)
        return ret
    ...
    def ShowOutlierPoints(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_ShowOutlierPoints(self.Ptr, value)
...
<remarks>Applies only to Box and Whisker Charts</remarks>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_QuartileCalculationType(self.Ptr)
    ...
    def QuartileCalculationType(self, value:'ExcelQuartileCalculation'):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_QuartileCalculationType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_MarkerBackColorObject(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_MarkerForeColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    def AreaProperties(self)->'IChartInterior':
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_AreaProperties(self.Ptr)
    ...
    def BarType(self)->'BaseFormatType':
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_BarType(self.Ptr)
    ...
    def BarType(self, value:'BaseFormatType'):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_BarType(self.Ptr, value.value)
    ...
    def BarTopType(self)->'TopFormatType':
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_BarTopType(self.Ptr)
    ...
    def BarTopType(self, value:'TopFormatType'):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_BarTopType(self.Ptr, value.value)
    ...
    def MarkerBackgroundColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_MarkerBackgroundColor(self.Ptr)
    ...
    def MarkerBackgroundColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_MarkerBackgroundColor(self.Ptr, value.Ptr)
    ...
    def MarkerForegroundColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_MarkerForegroundColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def MarkerForegroundColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_MarkerForegroundColor(self.Ptr, value.Ptr)
    ...
    def MarkerStyle(self)->'ChartMarkerType':
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_MarkerStyle(self.Ptr)
    ...
    def MarkerStyle(self, value:'ChartMarkerType'):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_MarkerStyle(self.Ptr, value.value)
    ...
    def MarkerForegroundKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_MarkerForegroundKnownColor(self.Ptr)
    ...
    def MarkerForegroundKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_MarkerForegroundKnownColor(self.Ptr, value.value)
    ...
    def MarkerBackgroundKnownColor(self)->'ExcelColors':
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_MarkerBackgroundKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def MarkerBackgroundKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_MarkerBackgroundKnownColor(self.Ptr, value.value)
    ...
    def MarkerSize(self)->int:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_MarkerSize(self.Ptr)
        return ret

    @MarkerSize.setter
    def MarkerSize(self, value:int):
        GetDllLibXls().XlsChartSerieDataFormat_set_MarkerSize.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartSerieDataFormat_set_MarkerSize(self.Ptr, value)
    ...
    def IsAutoMarker(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_IsAutoMarker(self.Ptr)
        return ret

    @IsAutoMarker.setter
    def IsAutoMarker(self, value:bool):
        GetDllLibXls().XlsChartSerieDataFormat_set_IsAutoMarker.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartSerieDataFormat_set_IsAutoMarker(self.Ptr, value)
    ...
    def Percent(self)->int:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_Percent(self.Ptr)
        return ret

    @Percent.setter
    def Percent(self, value:int):
        GetDllLibXls().XlsChartSerieDataFormat_set_Percent.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartSerieDataFormat_set_Percent(self.Ptr, value)
    ...
    def Is3DBubbles(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_Is3DBubbles(self.Ptr)
        return ret

    @Is3DBubbles.setter
    def Is3DBubbles(self, value:bool):
        GetDllLibXls().XlsChartSerieDataFormat_set_Is3DBubbles.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartSerieDataFormat_set_Is3DBubbles(self.Ptr, value)
    ...
    def Options(self)->'IChartFormat':
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_Options(self.Ptr)
    ...
    def IsMarkerSupported(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_IsMarkerSupported(self.Ptr)
        return ret
    ...
    def IsShadow(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_IsShadow(self.Ptr)
        return ret

    @IsShadow.setter
    def IsShadow(self, value:bool):
        GetDllLibXls().XlsChartSerieDataFormat_set_IsShadow.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartSerieDataFormat_set_IsShadow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_IsShowBackground(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_IsShowForeground(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_IsSmoothed(self.Ptr)
        return ret
    ...
    def IsSmoothedLine(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_IsSmoothedLine(self.Ptr)
        return ret
    ...
    def IsSmoothedLine(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_IsSmoothedLine(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_IsSupportFill(self.Ptr)
        return ret
    ...
    def HasInterior(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_HasInterior(self.Ptr)
        return ret
    ...
    def HasLineProperties(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_HasLineProperties(self.Ptr)
        return ret
    ...
    def HasFormat3D(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_HasFormat3D(self.Ptr)
        return ret
    ...
    def HasShadow(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_HasShadow(self.Ptr)
        return ret
    ...
    def LineProperties(self)->'ChartBorder':
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_LineProperties(self.Ptr)
    ...
    def Interior(self)->'IChartInterior':
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_Interior(self.Ptr)
        ret = None if intPtr==None else IChartInterior(intPtr)
        return ret
    ...
    def Fill(self)->'IShapeFill':
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_MarkerFill(self.Ptr)
        ret = None if intPtr==None else XlsShapeFill(intPtr)
        return ret
    ...
    def Format3D(self)->'Format3D':
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_Format3D(self.Ptr)
    ...
    def Shadow(self)->'ChartShadow':
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_Shadow(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_ForeGroundColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def ForeGroundColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_ForeGroundColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_ForeGroundKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def ForeGroundKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_ForeGroundKnownColor(self.Ptr, value.value)
...
<value>The transparency.</value>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_MarkerTransparencyValue(self.Ptr)
        return ret
    ...
    def MarkerTransparencyValue(self, value:float):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_MarkerTransparencyValue(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_ForeGroundColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_BackGroundKnownColor(self.Ptr)
        objwraped = ExcelColors(ret)
        return objwraped
    ...
    def BackGroundKnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_BackGroundKnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_BackGroundColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    def BackGroundColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_BackGroundColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_BackGroundColorObject(self.Ptr)
        ret = None if intPtr==None else OColor(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_Pattern(self.Ptr)
    ...
    def Pattern(self, value:'ExcelPatternType'):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_Pattern(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_IsAutomaticFormat(self.Ptr)
        return ret
    ...
    def IsAutomaticFormat(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_IsAutomaticFormat(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_Visible(self.Ptr)
        return ret

    @Visible.setter
    def Visible(self, value:bool):
        GetDllLibXls().XlsChartSerieDataFormat_set_Visible.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartSerieDataFormat_set_Visible(self.Ptr, value)
    ...
    def ShowActiveValue(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_ShowActiveValue(self.Ptr)
        return ret
    ...
    def ShowActiveValue(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_ShowActiveValue(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_Has_dPtPieExplosion(self.Ptr)
        return ret
    ...
    def Has_dPtPieExplosion(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_Has_dPtPieExplosion(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_HasBorder(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_HasBorderLine(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_IsBorderSupported(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_IsFormatted(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_IsInteriorSupported(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_IsMarker(self.Ptr)
        return ret
    ...
    def ParentSerie(self)->'XlsChartSerie':
        ...
        intPtr = GetDllLibXls().XlsChartSerieDataFormat_get_ParentSerie(self.Ptr)
    ...
    def SeriesNumber(self)->int:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_SeriesNumber(self.Ptr)
        return ret

    @SeriesNumber.setter
    def SeriesNumber(self, value:int):
        GetDllLibXls().XlsChartSerieDataFormat_set_SeriesNumber.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsChartSerieDataFormat_set_SeriesNumber(self.Ptr, value)
    ...
    def ShowBubble(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_ShowBubble(self.Ptr)
        return ret

    @ShowBubble.setter
    def ShowBubble(self, value:bool):
        GetDllLibXls().XlsChartSerieDataFormat_set_ShowBubble.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartSerieDataFormat_set_ShowBubble(self.Ptr, value)
    ...
    def ShowCategoryLabel(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_ShowCategoryLabel(self.Ptr)
        return ret
    ...
    def ShowCategoryLabel(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_ShowCategoryLabel(self.Ptr, value)
    ...
    def ShowPieInPercents(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_ShowPieInPercents(self.Ptr)
        return ret
    ...
    def ShowPieInPercents(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_ShowPieInPercents(self.Ptr, value)
    ...
    def ShowPieCategoryLabel(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_ShowPieCategoryLabel(self.Ptr)
        return ret
    ...
    def ShowPieCategoryLabel(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_ShowPieCategoryLabel(self.Ptr, value)
    ...
    def SmoothLine(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_SmoothLine(self.Ptr)
        return ret

    @SmoothLine.setter
    def SmoothLine(self, value:bool):
        GetDllLibXls().XlsChartSerieDataFormat_set_SmoothLine.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartSerieDataFormat_set_SmoothLine(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_MarkerBorderWidth(self.Ptr)
        return ret
    ...
    def MarkerBorderWidth(self, value:float):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_MarkerBorderWidth(self.Ptr, value)
...
<remarks>Applies only to Waterfall Charts</remarks>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_ShowConnectorLines(self.Ptr)
        return ret
    ...
    def ShowConnectorLines(self, value:bool):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_ShowConnectorLines(self.Ptr, value)
...
<remarks>By Default the Label is overlapped</remarks>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_TreeMapLabelOption(self.Ptr)
    ...
    def TreeMapLabelOption(self, value:'ExcelTreeMapLabelOption'):
        ...
        GetDllLibXls().XlsChartSerieDataFormat_set_TreeMapLabelOption(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartSerieDataFormat_get_ShowMeanLine(self.Ptr)
        return ret

    @ShowMeanLine.setter
    def ShowMeanLine(self, value:bool):
        GetDllLibXls().XlsChartSerieDataFormat_set_ShowMeanLine.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsChartSerieDataFormat_set_ShowMeanLine(self.Ptr, value)
