...
class RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation(_6203.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def rolling_ring_assembly_compound_harmonic_analysis_of_single_excitation(self) -> 'RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6067.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6067.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation._Cast_RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation(self)
