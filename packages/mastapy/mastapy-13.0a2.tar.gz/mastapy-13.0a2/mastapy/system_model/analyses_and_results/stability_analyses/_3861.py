...
class SynchroniserStabilityAnalysis(_3841.SpecialisedAssemblyStabilityAnalysis):
    """SynchroniserStabilityAnalysis
    ...
    class _Cast_SynchroniserStabilityAnalysis:
        ...
        def __init__(self, parent: 'SynchroniserStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def synchroniser_stability_analysis(self) -> 'SynchroniserStabilityAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SynchroniserStabilityAnalysis._Cast_SynchroniserStabilityAnalysis':
