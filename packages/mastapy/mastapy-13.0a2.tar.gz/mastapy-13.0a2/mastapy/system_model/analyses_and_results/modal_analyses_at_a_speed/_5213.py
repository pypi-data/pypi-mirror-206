...
class WormGearModalAnalysisAtASpeed(_5148.GearModalAnalysisAtASpeed):
    """WormGearModalAnalysisAtASpeed
    ...
    class _Cast_WormGearModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'WormGearModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def worm_gear_modal_analysis_at_a_speed(self) -> 'WormGearModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'WormGearModalAnalysisAtASpeed._Cast_WormGearModalAnalysisAtASpeed':
