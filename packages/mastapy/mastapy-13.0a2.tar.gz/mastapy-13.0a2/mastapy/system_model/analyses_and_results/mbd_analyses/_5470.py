...
class StraightBevelGearMultibodyDynamicsAnalysis(_5366.BevelGearMultibodyDynamicsAnalysis):
    """StraightBevelGearMultibodyDynamicsAnalysis
    ...
    class _Cast_StraightBevelGearMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'StraightBevelGearMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_multibody_dynamics_analysis(self) -> 'StraightBevelGearMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearMultibodyDynamicsAnalysis._Cast_StraightBevelGearMultibodyDynamicsAnalysis':
