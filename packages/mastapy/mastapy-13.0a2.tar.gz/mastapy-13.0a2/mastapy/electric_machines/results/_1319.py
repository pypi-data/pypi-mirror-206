...
from mastapy.electric_machines.results import _1333, _1334
...
class ElectricMachineResultsForOpenCircuitAndOnLoad(_0.APIBase):
    ...
    class _Cast_ElectricMachineResultsForOpenCircuitAndOnLoad:
        ...
        def __init__(self, parent: 'ElectricMachineResultsForOpenCircuitAndOnLoad'):
            self._parent = parent

        @property
        def electric_machine_results_for_open_circuit_and_on_load(self) -> 'ElectricMachineResultsForOpenCircuitAndOnLoad':
            return self._parent
    ...
    @property
    def linear_dq_model_chart(self) -> '_1852.TwoDChartDefinition':
    ...
    @property
    def on_load_results(self) -> '_1333.OnLoadElectricMachineResults':
    ...
    @property
    def open_circuit_results(self) -> '_1334.OpenCircuitElectricMachineResults':
    ...
    @property
    def all_on_load_results(self) -> 'List[_1333.OnLoadElectricMachineResults]':
    ...
    @property
    def all_open_circuit_results(self) -> 'List[_1334.OpenCircuitElectricMachineResults]':
    ...
    @property
    def on_load_results_for_slices(self) -> 'List[_1333.OnLoadElectricMachineResults]':
    ...
    @property
    def open_circuit_results_for_slices(self) -> 'List[_1334.OpenCircuitElectricMachineResults]':
    ...
    @property
    def cast_to(self) -> 'ElectricMachineResultsForOpenCircuitAndOnLoad._Cast_ElectricMachineResultsForOpenCircuitAndOnLoad':
