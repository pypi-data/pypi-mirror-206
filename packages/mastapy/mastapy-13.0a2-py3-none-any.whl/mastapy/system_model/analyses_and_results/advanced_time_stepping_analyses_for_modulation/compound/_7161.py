...
class GearCompoundAdvancedTimeSteppingAnalysisForModulation(_7180.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """GearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_GearCompoundAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'GearCompoundAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def gear_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'GearCompoundAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7031.GearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7031.GearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cast_to(self) -> 'GearCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_GearCompoundAdvancedTimeSteppingAnalysisForModulation':
