...
class RingPinsCompoundDynamicAnalysis(_6450.MountableComponentCompoundDynamicAnalysis):
    """RingPinsCompoundDynamicAnalysis
    ...
    class _Cast_RingPinsCompoundDynamicAnalysis:
        ...
        def __init__(self, parent: 'RingPinsCompoundDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def ring_pins_compound_dynamic_analysis(self) -> 'RingPinsCompoundDynamicAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6333.RingPinsDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6333.RingPinsDynamicAnalysis]':
    ...
    @property
    def cast_to(self) -> 'RingPinsCompoundDynamicAnalysis._Cast_RingPinsCompoundDynamicAnalysis':
