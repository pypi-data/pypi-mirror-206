...
class FaceGearPowerFlow(_4069.GearPowerFlow):
    """FaceGearPowerFlow
    ...
    class _Cast_FaceGearPowerFlow:
        ...
        def __init__(self, parent: 'FaceGearPowerFlow'):
            self._parent = parent
        ...
        @property
        def face_gear_power_flow(self) -> 'FaceGearPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearPowerFlow._Cast_FaceGearPowerFlow':
