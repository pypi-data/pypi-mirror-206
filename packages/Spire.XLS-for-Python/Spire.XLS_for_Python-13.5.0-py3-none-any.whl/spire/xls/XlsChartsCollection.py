...
class XlsChartsCollection (  ICharts) :
    """
    ...
    def get_Item(self ,name:str)->'IChart':
        ...
        intPtr = GetDllLibXls().XlsChartsCollection_get_Item(self.Ptr, name)
    ...
    def Add(self)->IChart:
        ...
        intPtr = GetDllLibXls().XlsChartsCollection_Add(self.Ptr)
        ret = None if intPtr==None else IChart(intPtr)
        return ret
    ...
    def Add(self ,name:str)->IChart:
        ...
        intPtr = GetDllLibXls().XlsChartsCollection_AddN(self.Ptr, name)
        ret = None if intPtr==None else IChart(intPtr)
        return ret
    ...
    def Remove(self ,name:str)->'IChart':
        ...
        intPtr = GetDllLibXls().XlsChartsCollection_Remove(self.Ptr, name)
        ret = None if intPtr==None else IChart(intPtr)
        return ret
    ...
    def Move(self ,oldIndex:int,newIndex:int):
        ...
        GetDllLibXls().XlsChartsCollection_Move(self.Ptr, oldIndex,newIndex)
    ...
    def Add(self ,chartToAdd:IChart)->IChart:
        ...
        intPtr = GetDllLibXls().XlsChartsCollection_AddC(self.Ptr, intPtrchartToAdd)
        ret = None if intPtr==None else IChart(intPtr)
        return ret
