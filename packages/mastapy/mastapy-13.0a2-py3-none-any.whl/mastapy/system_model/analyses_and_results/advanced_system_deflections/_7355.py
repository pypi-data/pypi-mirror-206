...
class TorqueConverterAdvancedSystemDeflection(_7273.CouplingAdvancedSystemDeflection):
    """TorqueConverterAdvancedSystemDeflection
    ...
    class _Cast_TorqueConverterAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'TorqueConverterAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def torque_converter_advanced_system_deflection(self) -> 'TorqueConverterAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2809.TorqueConverterSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'TorqueConverterAdvancedSystemDeflection._Cast_TorqueConverterAdvancedSystemDeflection':
