...
class CylindricalPlanetGearAdvancedSystemDeflection(_7283.CylindricalGearAdvancedSystemDeflection):
    """CylindricalPlanetGearAdvancedSystemDeflection
    ...
    class _Cast_CylindricalPlanetGearAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'CylindricalPlanetGearAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def cylindrical_planet_gear_advanced_system_deflection(self) -> 'CylindricalPlanetGearAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalPlanetGearAdvancedSystemDeflection._Cast_CylindricalPlanetGearAdvancedSystemDeflection':
