...
class SpringDamperConnectionDynamicAnalysis(_6280.CouplingConnectionDynamicAnalysis):
    """SpringDamperConnectionDynamicAnalysis
    ...
    class _Cast_SpringDamperConnectionDynamicAnalysis:
        ...
        def __init__(self, parent: 'SpringDamperConnectionDynamicAnalysis'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_dynamic_analysis(self) -> 'SpringDamperConnectionDynamicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionDynamicAnalysis._Cast_SpringDamperConnectionDynamicAnalysis':
