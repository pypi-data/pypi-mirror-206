...
class AGMAGleasonConicalGearSetSystemDeflection(_2704.ConicalGearSetSystemDeflection):
    """AGMAGleasonConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4015.AGMAGleasonConicalGearSetPowerFlow':
