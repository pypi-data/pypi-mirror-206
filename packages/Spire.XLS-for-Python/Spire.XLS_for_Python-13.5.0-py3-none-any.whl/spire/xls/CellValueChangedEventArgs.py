...
<value>The old value.</value>
        ...
        intPtr = GetDllLibXls().CellValueChangedEventArgs_get_OldValue(self.Ptr)
    ...
    def OldValue(self, value:'SpireObject'):
        ...
        GetDllLibXls().CellValueChangedEventArgs_set_OldValue(self.Ptr, value.Ptr)
...
<value>The new value.</value>
        ...
        intPtr = GetDllLibXls().CellValueChangedEventArgs_get_NewValue(self.Ptr)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    def NewValue(self, value:'SpireObject'):
        ...
        GetDllLibXls().CellValueChangedEventArgs_set_NewValue(self.Ptr, value.Ptr)
...
<value>The range.</value>
        ...
        intPtr = GetDllLibXls().CellValueChangedEventArgs_get_Range(self.Ptr)
    ...
    def Range(self, value:'IXLSRange'):
        ...
        GetDllLibXls().CellValueChangedEventArgs_set_Range(self.Ptr, value.Ptr)
