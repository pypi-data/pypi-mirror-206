...
class SpringDamperHalfModalAnalysisAtASpeed(_5127.CouplingHalfModalAnalysisAtASpeed):
    """SpringDamperHalfModalAnalysisAtASpeed
    ...
    class _Cast_SpringDamperHalfModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'SpringDamperHalfModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def spring_damper_half_modal_analysis_at_a_speed(self) -> 'SpringDamperHalfModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperHalfModalAnalysisAtASpeed._Cast_SpringDamperHalfModalAnalysisAtASpeed':
