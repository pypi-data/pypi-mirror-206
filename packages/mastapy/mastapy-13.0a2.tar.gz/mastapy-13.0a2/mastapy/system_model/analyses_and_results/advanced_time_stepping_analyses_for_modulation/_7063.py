...
class RingPinsAdvancedTimeSteppingAnalysisForModulation(_7051.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsAdvancedTimeSteppingAnalysisForModulation
    ...
    class _Cast_RingPinsAdvancedTimeSteppingAnalysisForModulation:
        ...
        def __init__(self, parent: 'RingPinsAdvancedTimeSteppingAnalysisForModulation'):
            self._parent = parent
        ...
        @property
        def ring_pins_advanced_time_stepping_analysis_for_modulation(self) -> 'RingPinsAdvancedTimeSteppingAnalysisForModulation':
            return self._parent
    ...
    @property
    def system_deflection_results(self) -> '_2773.RingPinsSystemDeflection':
    ...
    @property
    def cast_to(self) -> 'RingPinsAdvancedTimeSteppingAnalysisForModulation._Cast_RingPinsAdvancedTimeSteppingAnalysisForModulation':
