...
class LoadedThrustBallBearingResults(_1987.LoadedBallBearingResults):
    """LoadedThrustBallBearingResults
    ...
    class _Cast_LoadedThrustBallBearingResults:
        ...
        def __init__(self, parent: 'LoadedThrustBallBearingResults'):
            self._parent = parent
        ...
        @property
        def loaded_thrust_ball_bearing_results(self) -> 'LoadedThrustBallBearingResults':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'LoadedThrustBallBearingResults._Cast_LoadedThrustBallBearingResults':
