...
class RouteTask(BaseModel):
    ...
    """
    waypoints: conlist(Waypoint, max_items=15001, min_items=2) = Field(..., description="Array of geographical points to build path between them.")
    transport_type: Optional[TransportType] = None
    geo_settings: Optional[GeoSettings] = None
    departure_time: Optional[datetime] = Field(None, description="Departure date and time according to the [RFC 3339, section 5.6 (ISO 8601)](https://tools.ietf.org/html/rfc3339#section-5.6).")
    result_timezone: Optional[conint(strict=True, le=12, ge=-12)] = Field(0, description="Time zone for calculation results.")
    detail: Optional[StrictBool] = Field(False, description="Planning a detailed route.")
    full_segments: Optional[StrictBool] = Field(True, description="Return full segments list. ")
    polyline: Optional[StrictBool] = Field(True, description="Generate a polyline between points.")
