...
class TorqueConverterConnectionAdvancedSystemDeflection(_7274.CouplingConnectionAdvancedSystemDeflection):
    """TorqueConverterConnectionAdvancedSystemDeflection
    ...
    class _Cast_TorqueConverterConnectionAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'TorqueConverterConnectionAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def torque_converter_connection_advanced_system_deflection(self) -> 'TorqueConverterConnectionAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterConnectionAdvancedSystemDeflection._Cast_TorqueConverterConnectionAdvancedSystemDeflection':
