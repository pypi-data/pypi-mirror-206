...
class UnbalancedMassCompoundAdvancedSystemDeflection(_7490.VirtualComponentCompoundAdvancedSystemDeflection):
    """UnbalancedMassCompoundAdvancedSystemDeflection
    ...
    class _Cast_UnbalancedMassCompoundAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'UnbalancedMassCompoundAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def unbalanced_mass_compound_advanced_system_deflection(self) -> 'UnbalancedMassCompoundAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7360.UnbalancedMassAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7360.UnbalancedMassAdvancedSystemDeflection]':
    ...
    @property
    def cast_to(self) -> 'UnbalancedMassCompoundAdvancedSystemDeflection._Cast_UnbalancedMassCompoundAdvancedSystemDeflection':
