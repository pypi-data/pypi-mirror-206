...
class RaceRoundnessAtAngle(_0.APIBase):
    ...
    class _Cast_RaceRoundnessAtAngle:
        ...
        def __init__(self, parent: 'RaceRoundnessAtAngle'):
            self._parent = parent

        @property
        def race_roundness_at_angle(self) -> 'RaceRoundnessAtAngle':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RaceRoundnessAtAngle._Cast_RaceRoundnessAtAngle':
