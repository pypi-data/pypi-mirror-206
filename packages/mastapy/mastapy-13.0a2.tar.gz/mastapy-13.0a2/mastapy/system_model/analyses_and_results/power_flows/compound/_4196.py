...
class FaceGearMeshCompoundPowerFlow(_4201.GearMeshCompoundPowerFlow):
    """FaceGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4063.FaceGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4063.FaceGearMeshPowerFlow]':
