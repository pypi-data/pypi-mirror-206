...
class BevelDifferentialPlanetGearHarmonicAnalysis(_5660.BevelDifferentialGearHarmonicAnalysis):
    """BevelDifferentialPlanetGearHarmonicAnalysis
    ...
    class _Cast_BevelDifferentialPlanetGearHarmonicAnalysis:
        ...
        def __init__(self, parent: 'BevelDifferentialPlanetGearHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def bevel_differential_planet_gear_harmonic_analysis(self) -> 'BevelDifferentialPlanetGearHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialPlanetGearHarmonicAnalysis._Cast_BevelDifferentialPlanetGearHarmonicAnalysis':
