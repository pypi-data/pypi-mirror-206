...
class PowerLoadCompoundMultibodyDynamicsAnalysis(_5621.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """PowerLoadCompoundMultibodyDynamicsAnalysis
    ...
    class _Cast_PowerLoadCompoundMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'PowerLoadCompoundMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def power_load_compound_multibody_dynamics_analysis(self) -> 'PowerLoadCompoundMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5445.PowerLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5445.PowerLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def cast_to(self) -> 'PowerLoadCompoundMultibodyDynamicsAnalysis._Cast_PowerLoadCompoundMultibodyDynamicsAnalysis':
