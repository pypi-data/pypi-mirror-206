...
class XlsBuiltInDocumentProperties (  CollectionBase[DocumentProperty], IBuiltInDocumentProperties) :
    ...
    def get_Item(self ,index:BuiltInPropertyType)->IDocumentProperty:
        ...
        intPtr = GetDllLibXls().XlsBuiltInDocumentProperties_get_Item(self.Ptr, enumindex)
    ...
    def get_Item(self ,iIndex:int)->IDocumentProperty:
        ...
        intPtr = GetDllLibXls().XlsBuiltInDocumentProperties_get_ItemI(self.Ptr, iIndex)
        ret = None if intPtr==None else DocumentProperty(intPtr)
        return ret
    ...
    <returns>True if collection contains specified property.</returns>
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_Contains(self.Ptr, enumindex)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_get_Title.restype=c_wchar_p
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_Title(self.Ptr)
        return ret
    ...
    def Title(self, value:str):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Title(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_get_DocumentVersion.restype=c_wchar_p
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_DocumentVersion(self.Ptr)
        return ret
    ...
    def DocumentVersion(self, value:str):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_DocumentVersion(self.Ptr, value)
    ...
    def Version(self)->int:
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_Version(self.Ptr)
        return ret

    @Version.setter
    def Version(self, value:int):
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Version.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Version(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_get_Subject.restype=c_wchar_p
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_Subject(self.Ptr)
        return ret
    ...
    def Subject(self, value:str):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Subject(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_get_Author.restype=c_wchar_p
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_Author(self.Ptr)
        return ret
    ...
    def Author(self, value:str):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Author(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_get_Keywords.restype=c_wchar_p
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_Keywords(self.Ptr)
        return ret
    ...
    def Keywords(self, value:str):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Keywords(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_get_Comments.restype=c_wchar_p
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_Comments(self.Ptr)
        return ret
    ...
    def Comments(self, value:str):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Comments(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_get_Template.restype=c_wchar_p
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_Template(self.Ptr)
        return ret
    ...
    def Template(self, value:str):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Template(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_get_LastAuthor.restype=c_wchar_p
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_LastAuthor(self.Ptr)
        return ret
    ...
    def LastAuthor(self, value:str):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_LastAuthor(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_get_RevisionNumber.restype=c_wchar_p
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_RevisionNumber(self.Ptr)
        return ret
    ...
    def RevisionNumber(self, value:str):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_RevisionNumber(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsBuiltInDocumentProperties_get_EditTime(self.Ptr)
    ...
    def EditTime(self, value:'TimeSpan'):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_EditTime(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsBuiltInDocumentProperties_get_LastPrinted(self.Ptr)
    ...
    def LastPrinted(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_LastPrinted(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsBuiltInDocumentProperties_get_CreatedTime(self.Ptr)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def CreatedTime(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_CreatedTime(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsBuiltInDocumentProperties_get_LastSaveTime(self.Ptr)
        ret = None if intPtr==None else DateTime(intPtr)
        return ret
    ...
    def LastSaveTime(self, value:'DateTime'):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_LastSaveTime(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_PageCount(self.Ptr)
        return ret

    @PageCount.setter
    def PageCount(self, value:int):
        GetDllLibXls().XlsBuiltInDocumentProperties_set_PageCount.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsBuiltInDocumentProperties_set_PageCount(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_WordCount(self.Ptr)
        return ret

    @WordCount.setter
    def WordCount(self, value:int):
        GetDllLibXls().XlsBuiltInDocumentProperties_set_WordCount.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsBuiltInDocumentProperties_set_WordCount(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_Characters(self.Ptr)
        return ret

    @Characters.setter
    def Characters(self, value:int):
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Characters.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Characters(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_get_ApplicationName.restype=c_wchar_p
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_ApplicationName(self.Ptr)
        return ret
    ...
    def ApplicationName(self, value:str):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_ApplicationName(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_Security(self.Ptr)
        return ret

    @Security.setter
    def Security(self, value:int):
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Security.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Security(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_get_Category.restype=c_wchar_p
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_Category(self.Ptr)
        return ret
    ...
    def Category(self, value:str):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Category(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_get_PresentationTarget.restype=c_wchar_p
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_PresentationTarget(self.Ptr)
        return ret
    ...
    def PresentationTarget(self, value:str):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_PresentationTarget(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_Bytes(self.Ptr)
        return ret

    @Bytes.setter
    def Bytes(self, value:int):
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Bytes.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Bytes(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_LineCount(self.Ptr)
        return ret

    @LineCount.setter
    def LineCount(self, value:int):
        GetDllLibXls().XlsBuiltInDocumentProperties_set_LineCount.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsBuiltInDocumentProperties_set_LineCount(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_ParagraphCount(self.Ptr)
        return ret
    ...
    def ParagraphCount(self, value:int):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_ParagraphCount(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_SlideCount(self.Ptr)
        return ret

    @SlideCount.setter
    def SlideCount(self, value:int):
        GetDllLibXls().XlsBuiltInDocumentProperties_set_SlideCount.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsBuiltInDocumentProperties_set_SlideCount(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_NoteCount(self.Ptr)
        return ret

    @NoteCount.setter
    def NoteCount(self, value:int):
        GetDllLibXls().XlsBuiltInDocumentProperties_set_NoteCount.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsBuiltInDocumentProperties_set_NoteCount(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_HiddenCount(self.Ptr)
        return ret

    @HiddenCount.setter
    def HiddenCount(self, value:int):
        GetDllLibXls().XlsBuiltInDocumentProperties_set_HiddenCount.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsBuiltInDocumentProperties_set_HiddenCount(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_MultimediaClipCount(self.Ptr)
        return ret
    ...
    def MultimediaClipCount(self, value:int):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_MultimediaClipCount(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_ScaleCrop(self.Ptr)
        return ret

    @ScaleCrop.setter
    def ScaleCrop(self, value:bool):
        GetDllLibXls().XlsBuiltInDocumentProperties_set_ScaleCrop.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsBuiltInDocumentProperties_set_ScaleCrop(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_get_Manager.restype=c_wchar_p
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_Manager(self.Ptr)
        return ret
    ...
    def Manager(self, value:str):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Manager(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_get_Company.restype=c_wchar_p
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_Company(self.Ptr)
        return ret
    ...
    def Company(self, value:str):
        ...
        GetDllLibXls().XlsBuiltInDocumentProperties_set_Company(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsBuiltInDocumentProperties_get_LinksDirty(self.Ptr)
        return ret

    @LinksDirty.setter
    def LinksDirty(self, value:bool):
        GetDllLibXls().XlsBuiltInDocumentProperties_set_LinksDirty.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsBuiltInDocumentProperties_set_LinksDirty(self.Ptr, value)
