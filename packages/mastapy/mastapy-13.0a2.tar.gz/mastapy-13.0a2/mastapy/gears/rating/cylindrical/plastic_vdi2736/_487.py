...
class PlasticGearVDI2736AbstractMeshSingleFlankRating(_513.ISO6336AbstractMeshSingleFlankRating):
    """PlasticGearVDI2736AbstractMeshSingleFlankRating
    ...
    class _Cast_PlasticGearVDI2736AbstractMeshSingleFlankRating:
        ...
        def __init__(self, parent: 'PlasticGearVDI2736AbstractMeshSingleFlankRating'):
            self._parent = parent
        ...
        @property
        def plastic_gear_vdi2736_abstract_mesh_single_flank_rating(self) -> 'PlasticGearVDI2736AbstractMeshSingleFlankRating':
            return self._parent
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_486.PlasticGearVDI2736AbstractGearSingleFlankRating]':
    ...
    @property
    def plastic_vdi2736_cylindrical_gear_single_flank_ratings(self) -> 'List[_486.PlasticGearVDI2736AbstractGearSingleFlankRating]':
    ...
    @property
    def cast_to(self) -> 'PlasticGearVDI2736AbstractMeshSingleFlankRating._Cast_PlasticGearVDI2736AbstractMeshSingleFlankRating':
