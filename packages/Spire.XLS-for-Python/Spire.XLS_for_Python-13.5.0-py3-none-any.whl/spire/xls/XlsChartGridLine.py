...
class XlsChartGridLine (  XlsObject, IChartGridLine) :
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartGridLine_get_AxisLineType(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartGridLine_get_Border(self.Ptr)
    ...
    def Format3D(self)->'Format3D':
        ...
        intPtr = GetDllLibXls().XlsChartGridLine_get_Format3D(self.Ptr)
    ...
    def HasFormat3D(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartGridLine_get_HasFormat3D(self.Ptr)
        return ret
    ...
    def HasInterior(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartGridLine_get_HasInterior(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibXls().XlsChartGridLine_get_HasLineProperties(self.Ptr)
        return ret
    ...
    def HasShadow(self)->bool:
        ...
        ret = GetDllLibXls().XlsChartGridLine_get_HasShadow(self.Ptr)
        return ret
    ...
    def Shadow(self)->'ChartShadow':
        ...
        intPtr = GetDllLibXls().XlsChartGridLine_get_Shadow(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsChartGridLine_get_LineProperties(self.Ptr)
        ret = None if intPtr==None else ChartBorder(intPtr)
        return ret
    ...
    def Interior(self)->'IChartInterior':
        ...
        intPtr = GetDllLibXls().XlsChartGridLine_get_Interior(self.Ptr)
    ...
    def Fill(self)->'IShapeFill':
        ...
        intPtr = GetDllLibXls().XlsChartGridLine_get_Fill(self.Ptr)
    ...
    def Clone(self ,parent:'SpireObject')->'SpireObject':
        ...
        intPtr = GetDllLibXls().XlsChartGridLine_Clone(self.Ptr, intPtrparent)
    ...
    def Delete(self):
        ...
        GetDllLibXls().XlsChartGridLine_Delete(self.Ptr)
