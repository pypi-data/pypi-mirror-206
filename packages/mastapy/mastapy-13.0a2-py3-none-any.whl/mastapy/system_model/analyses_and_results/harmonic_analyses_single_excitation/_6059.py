...
class PlanetaryConnectionHarmonicAnalysisOfSingleExcitation(_6073.ShaftToMountableComponentConnectionHarmonicAnalysisOfSingleExcitation):
    """PlanetaryConnectionHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_PlanetaryConnectionHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'PlanetaryConnectionHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def planetary_connection_harmonic_analysis_of_single_excitation(self) -> 'PlanetaryConnectionHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetaryConnectionHarmonicAnalysisOfSingleExcitation._Cast_PlanetaryConnectionHarmonicAnalysisOfSingleExcitation':
