...
class PartToPartShearCouplingHalfCompoundPowerFlow(_4181.CouplingHalfCompoundPowerFlow):
    """PartToPartShearCouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4091.PartToPartShearCouplingHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4091.PartToPartShearCouplingHalfPowerFlow]':
