...
class XlsButtonShape (  XlsShape, IShape, ITextBox) :
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().XlsButtonShape_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsButtonShape_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsButtonShape_set_Text(self.Ptr, value)
    ...
    def IsTextLocked(self)->bool:
        ...
        ret = GetDllLibXls().XlsButtonShape_get_IsTextLocked(self.Ptr)
        return ret

    @IsTextLocked.setter
    def IsTextLocked(self, value:bool):
        GetDllLibXls().XlsButtonShape_set_IsTextLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsButtonShape_set_IsTextLocked(self.Ptr, value)
    ...
    def TextRotation(self)->'TextRotationType':
        ...
        ret = GetDllLibXls().XlsButtonShape_get_TextRotation(self.Ptr)
    ...
    def TextRotation(self, value:'TextRotationType'):
        ...
        GetDllLibXls().XlsButtonShape_set_TextRotation(self.Ptr, value.value)
    ...
    def RichText(self)->'IRichTextString':
        ...
        intPtr = GetDllLibXls().XlsButtonShape_get_RichText(self.Ptr)
    ...
    def HAlignment(self)->'CommentHAlignType':
        ...
        ret = GetDllLibXls().XlsButtonShape_get_HAlignment(self.Ptr)
    ...
    def HAlignment(self, value:'CommentHAlignType'):
        ...
        GetDllLibXls().XlsButtonShape_set_HAlignment(self.Ptr, value.value)
    ...
    def VAlignment(self)->'CommentVAlignType':
        ...
        ret = GetDllLibXls().XlsButtonShape_get_VAlignment(self.Ptr)
    ...
    def VAlignment(self, value:'CommentVAlignType'):
        ...
        GetDllLibXls().XlsButtonShape_set_VAlignment(self.Ptr, value.value)
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsButtonShape_get_ShapeType(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsButtonShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
