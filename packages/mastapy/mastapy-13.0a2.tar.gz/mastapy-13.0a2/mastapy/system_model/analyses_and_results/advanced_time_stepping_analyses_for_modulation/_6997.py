...
class CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation(_7071.ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2693.CoaxialConnectionSystemDeflection':
