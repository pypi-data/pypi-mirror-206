...
class Weather:
    ...
    (The icon code can be found in weather data you get with the methods.
    For example, it is the fourth item in each tuple you get with the simplified methods.)
    ...
    def next_12h_simplified(self):
        ...
        for i in self.data['list'][:4]:
            simple_data.append((i['dt_txt'], i['main']['temp'],
