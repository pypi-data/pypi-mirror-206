...
class BordersCollection (  SpireObject, IBorders) :
    ...
    #    intPtr = GetDllLibXls().BordersCollection_GetEnumerator(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibXls().BordersCollection_get_KnownColor(self.Ptr)
    ...
    def KnownColor(self, value:'ExcelColors'):
        ...
        GetDllLibXls().BordersCollection_set_KnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().BordersCollection_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibXls().BordersCollection_set_Color(self.Ptr, value.Ptr)
    ...
    def _create(self, intPtrWithTypeName:IntPtrWithTypeName)->'IBorder':
        ...
        strName = intPtrWithTypeName.typeName
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().BordersCollection_get_Item(self.Ptr, enumIndex)
    ...
    <summary>
        ...
        ret = GetDllLibXls().BordersCollection_get_LineStyle(self.Ptr)
    ...
    def LineStyle(self, value:'LineStyleType'):
        ...
        GetDllLibXls().BordersCollection_set_LineStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().BordersCollection_get_Value(self.Ptr)
        objwraped = LineStyleType(ret)
        return objwraped
    ...
    def Value(self, value:'LineStyleType'):
        ...
        GetDllLibXls().BordersCollection_set_Value(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibXls().BordersCollection_get_Count(self.Ptr)
        return ret
    ...
    def Parent(self)->'SpireObject':
        ...
        intPtr = GetDllLibXls().BordersCollection_get_Parent(self.Ptr)
