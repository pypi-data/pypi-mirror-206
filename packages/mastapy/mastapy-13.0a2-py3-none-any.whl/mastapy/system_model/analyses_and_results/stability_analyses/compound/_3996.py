...
class VirtualComponentCompoundStabilityAnalysis(_3951.MountableComponentCompoundStabilityAnalysis):
    """VirtualComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3867.VirtualComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3867.VirtualComponentStabilityAnalysis]':
