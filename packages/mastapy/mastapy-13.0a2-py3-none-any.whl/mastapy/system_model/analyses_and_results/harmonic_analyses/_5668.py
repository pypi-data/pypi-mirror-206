...
class BoltedJointHarmonicAnalysis(_5777.SpecialisedAssemblyHarmonicAnalysis):
    """BoltedJointHarmonicAnalysis
    ...
    class _Cast_BoltedJointHarmonicAnalysis:
        ...
        def __init__(self, parent: 'BoltedJointHarmonicAnalysis'):
            self._parent = parent
        ...
        @property
        def bolted_joint_harmonic_analysis(self) -> 'BoltedJointHarmonicAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BoltedJointHarmonicAnalysis._Cast_BoltedJointHarmonicAnalysis':
