...
class CylindricalGearMultibodyDynamicsAnalysis(_5410.GearMultibodyDynamicsAnalysis):
    """CylindricalGearMultibodyDynamicsAnalysis
    ...
    class _Cast_CylindricalGearMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'CylindricalGearMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def cylindrical_gear_multibody_dynamics_analysis(self) -> 'CylindricalGearMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CylindricalGearMultibodyDynamicsAnalysis._Cast_CylindricalGearMultibodyDynamicsAnalysis':
