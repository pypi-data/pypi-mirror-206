...
class BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation(_5986.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def bevel_differential_sun_gear_harmonic_analysis_of_single_excitation(self) -> 'BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation._Cast_BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation':
        return self._Cast_BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation(self)
