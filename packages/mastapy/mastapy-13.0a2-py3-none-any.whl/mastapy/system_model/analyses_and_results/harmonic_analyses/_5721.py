...
class FrequencyOptionsForHarmonicAnalysisResults(_7498.AbstractAnalysisOptions['_6769.StaticLoadCase']):
    """FrequencyOptionsForHarmonicAnalysisResults
    ...
    class _Cast_FrequencyOptionsForHarmonicAnalysisResults:
        ...
        def __init__(self, parent: 'FrequencyOptionsForHarmonicAnalysisResults'):
            self._parent = parent
        ...
        @property
        def frequency_options_for_harmonic_analysis_results(self) -> 'FrequencyOptionsForHarmonicAnalysisResults':
            return self._parent
    ...
    @property
    def number_of_points_per_step_for_torque_map(self) -> 'overridable.Overridable_int':
        """overridable.Overridable_int: 'NumberOfPointsPerStepForTorqueMap' is the original name of this property."""
    ...
    def number_of_points_per_step_for_torque_map(self, value: 'overridable.Overridable_int.implicit_type()'):
        wrapper_type = overridable.Overridable_int.wrapper_type()
        enclosed_type = overridable.Overridable_int.implicit_type()
        value, is_overridden = _unpack_overridable(value)
        value = wrapper_type[enclosed_type](enclosed_type(value) if value is not None else 0, is_overridden)
    ...
    @property
    def cast_to(self) -> 'FrequencyOptionsForHarmonicAnalysisResults._Cast_FrequencyOptionsForHarmonicAnalysisResults':
