...
class AbstractAssemblyAdvancedSystemDeflection(_7317.PartAdvancedSystemDeflection):
    """AbstractAssemblyAdvancedSystemDeflection
    ...
    class _Cast_AbstractAssemblyAdvancedSystemDeflection:
        ...
        def __init__(self, parent: 'AbstractAssemblyAdvancedSystemDeflection'):
            self._parent = parent
        ...
        @property
        def abstract_assembly_advanced_system_deflection(self) -> 'AbstractAssemblyAdvancedSystemDeflection':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AbstractAssemblyAdvancedSystemDeflection._Cast_AbstractAssemblyAdvancedSystemDeflection':
