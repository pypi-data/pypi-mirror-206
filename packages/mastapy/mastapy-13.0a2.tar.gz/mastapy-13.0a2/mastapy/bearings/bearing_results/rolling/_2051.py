...
class PreloadFactorLookupTable(_0.APIBase):
    ...
    class _Cast_PreloadFactorLookupTable:
        ...
        def __init__(self, parent: 'PreloadFactorLookupTable'):
            self._parent = parent

        @property
        def preload_factor_lookup_table(self) -> 'PreloadFactorLookupTable':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PreloadFactorLookupTable._Cast_PreloadFactorLookupTable':
