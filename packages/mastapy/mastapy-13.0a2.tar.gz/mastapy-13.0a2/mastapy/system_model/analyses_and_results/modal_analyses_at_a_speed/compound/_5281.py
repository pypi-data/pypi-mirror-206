...
class HypoidGearMeshCompoundModalAnalysisAtASpeed(_5223.AGMAGleasonConicalGearMeshCompoundModalAnalysisAtASpeed):
    """HypoidGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5151.HypoidGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5151.HypoidGearMeshModalAnalysisAtASpeed]':
