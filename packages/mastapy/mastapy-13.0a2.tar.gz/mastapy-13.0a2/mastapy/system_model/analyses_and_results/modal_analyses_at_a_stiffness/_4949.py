...
class TorqueConverterModalAnalysisAtAStiffness(_4869.CouplingModalAnalysisAtAStiffness):
    """TorqueConverterModalAnalysisAtAStiffness
    ...
    class _Cast_TorqueConverterModalAnalysisAtAStiffness:
        ...
        def __init__(self, parent: 'TorqueConverterModalAnalysisAtAStiffness'):
            self._parent = parent
        ...
        @property
        def torque_converter_modal_analysis_at_a_stiffness(self) -> 'TorqueConverterModalAnalysisAtAStiffness':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterModalAnalysisAtAStiffness._Cast_TorqueConverterModalAnalysisAtAStiffness':
