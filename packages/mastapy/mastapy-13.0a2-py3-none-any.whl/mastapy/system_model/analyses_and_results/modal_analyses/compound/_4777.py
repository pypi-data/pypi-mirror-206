...
class MeasurementComponentCompoundModalAnalysis(_4823.VirtualComponentCompoundModalAnalysis):
    """MeasurementComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4627.MeasurementComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4627.MeasurementComponentModalAnalysis]':
