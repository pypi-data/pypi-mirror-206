...
class CVTBeltConnectionPowerFlow(_4018.BeltConnectionPowerFlow):
    """CVTBeltConnectionPowerFlow
    ...
    class _Cast_CVTBeltConnectionPowerFlow:
        ...
        def __init__(self, parent: 'CVTBeltConnectionPowerFlow'):
            self._parent = parent
        ...
        @property
        def cvt_belt_connection_power_flow(self) -> 'CVTBeltConnectionPowerFlow':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CVTBeltConnectionPowerFlow._Cast_CVTBeltConnectionPowerFlow':
