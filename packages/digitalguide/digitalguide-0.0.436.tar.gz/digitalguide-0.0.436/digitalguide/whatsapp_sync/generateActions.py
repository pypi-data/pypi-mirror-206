...
class Action():
    ...
    def __call__(self, client, update: WhatsAppUpdate, context):
        ...
        print("Reference: {}".format(context["user_id"]))
        print("Reference Type: {}".formate(type(context["user_id"])))
        ...
        for item in self.actions:
            ...
            for i in range(max_wait_itteration):
                print("unsend messages iterration {}: {}".format(i, r_unsend_messages.get(update.get_from())))
