...
from mastapy.bearings.bearing_designs.rolling import _2130
...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_2130.BearingProtectionLevel':
        ...
        value = conversion.pn_to_mp_enum(temp, _2130.BearingProtectionLevel)
        return constructor.new_from_mastapy_type(_2130.BearingProtectionLevel)(value) if value is not None else None
    ...
    @property
    def new_protection_level(self) -> '_2130.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_2130.BearingProtectionLevel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value, _2130.BearingProtectionLevel.type_())
