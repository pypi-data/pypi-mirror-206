...
class StraightBevelPlanetGearCompoundSystemDeflection(_2937.StraightBevelDiffGearCompoundSystemDeflection):
    """StraightBevelPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2798.StraightBevelPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2798.StraightBevelPlanetGearSystemDeflection]':
