...
class RollingRingModalAnalysisAtASpeed(_5127.CouplingHalfModalAnalysisAtASpeed):
    """RollingRingModalAnalysisAtASpeed
    ...
    class _Cast_RollingRingModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'RollingRingModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def rolling_ring_modal_analysis_at_a_speed(self) -> 'RollingRingModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'RollingRingModalAnalysisAtASpeed._Cast_RollingRingModalAnalysisAtASpeed':
