...
class ShaftFEMeshingOptions(_61.FEMeshingOptions):
    ...
    class _Cast_ShaftFEMeshingOptions:
        ...
        def __init__(self, parent: 'ShaftFEMeshingOptions'):
            self._parent = parent
        ...
        @property
        def shaft_fe_meshing_options(self) -> 'ShaftFEMeshingOptions':
            return self._parent
    ...
    def meshing_diameter_for_gear(self) -> '_76.MeshingDiameterForGear':
        ...
        value = conversion.pn_to_mp_enum(temp, _76.MeshingDiameterForGear)
    ...
    def meshing_diameter_for_gear(self, value: '_76.MeshingDiameterForGear'):
        ...
        value = conversion.mp_to_pn_enum(value, _76.MeshingDiameterForGear.type_())
    ...
    @property
    def cast_to(self) -> 'ShaftFEMeshingOptions._Cast_ShaftFEMeshingOptions':
