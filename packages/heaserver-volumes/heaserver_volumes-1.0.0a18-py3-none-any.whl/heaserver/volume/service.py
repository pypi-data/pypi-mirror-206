...
from heaserver.service.heaobjectsupport import type_to_resource_url, get
...
async def get_trash(request: web.Request) -> web.Response:
    """
    Gets the trash bin for the volume with the specified id.

    :param request: the HTTP request (required).
    :return: the HTTP response, a redirect to a URL for getting the volume's trash.
    ---
    summary: The volume's trash bin.
    tags:
