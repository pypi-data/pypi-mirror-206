...
class RollingRingCompoundStabilityAnalysis(_3913.CouplingHalfCompoundStabilityAnalysis):
    """RollingRingCompoundStabilityAnalysis
    ...
    class _Cast_RollingRingCompoundStabilityAnalysis:
        ...
        def __init__(self, parent: 'RollingRingCompoundStabilityAnalysis'):
            self._parent = parent
        ...
        @property
        def rolling_ring_compound_stability_analysis(self) -> 'RollingRingCompoundStabilityAnalysis':
            return self._parent
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3836.RollingRingStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3836.RollingRingStabilityAnalysis]':
    ...
    @property
    def cast_to(self) -> 'RollingRingCompoundStabilityAnalysis._Cast_RollingRingCompoundStabilityAnalysis':
