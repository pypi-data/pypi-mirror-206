...
class SpringDamperConnectionHarmonicAnalysisOfSingleExcitation(_6012.CouplingConnectionHarmonicAnalysisOfSingleExcitation):
    """SpringDamperConnectionHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_SpringDamperConnectionHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'SpringDamperConnectionHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def spring_damper_connection_harmonic_analysis_of_single_excitation(self) -> 'SpringDamperConnectionHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'SpringDamperConnectionHarmonicAnalysisOfSingleExcitation._Cast_SpringDamperConnectionHarmonicAnalysisOfSingleExcitation':
