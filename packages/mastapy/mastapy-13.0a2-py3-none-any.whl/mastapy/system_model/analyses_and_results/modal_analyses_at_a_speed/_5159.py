...
class KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed(_5156.KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed):
    """KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed
    ...
    class _Cast_KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def klingelnberg_cyclo_palloid_hypoid_gear_modal_analysis_at_a_speed(self) -> 'KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed._Cast_KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed':
