...
class WormGrindingProcessSimulationNew(_681.ProcessSimulationNew['_694.WormGrindingProcessSimulationInput']):
    """WormGrindingProcessSimulationNew
    ...
    @property
    def worm_grinding_cutter_calculation(self) -> '_687.WormGrindingCutterCalculation':
    ...
    @property
    def worm_grinding_process_gear_shape_calculation(self) -> '_690.WormGrindingProcessGearShape':
    ...
    @property
    def worm_grinding_process_lead_calculation(self) -> '_688.WormGrindingLeadCalculation':
    ...
    @property
    def worm_grinding_process_mark_on_shaft_calculation(self) -> '_691.WormGrindingProcessMarkOnShaft':
    ...
    @property
    def worm_grinding_process_pitch_calculation(self) -> '_692.WormGrindingProcessPitchCalculation':
    ...
    @property
    def worm_grinding_process_profile_calculation(self) -> '_693.WormGrindingProcessProfileCalculation':
    ...
    @property
    def worm_grinding_process_total_modification_calculation(self) -> '_697.WormGrindingProcessTotalModificationCalculation':
