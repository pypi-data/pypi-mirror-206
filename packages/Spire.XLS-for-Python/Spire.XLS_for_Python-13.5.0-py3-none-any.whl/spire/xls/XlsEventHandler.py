...
class XlsEventHandler (SpireObject) :
    ...
    def Invoke(self ,sender:'SpireObject',e:'XlsEventArgs'):
        ...
        GetDllLibXls().XlsEventHandler_Invoke(self.Ptr, intPtrsender,intPtre)
...
#        intPtr = GetDllLibXls().XlsEventHandler_BeginInvoke(self.Ptr, intPtrsender,intPtre,intPtrcallback,intPtrobject)
...
#        GetDllLibXls().XlsEventHandler_EndInvoke(self.Ptr, intPtrresult)
