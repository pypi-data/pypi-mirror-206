...
class StraightBevelDiffGearMeshCompoundPowerFlow(_4159.BevelGearMeshCompoundPowerFlow):
    """StraightBevelDiffGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4117.StraightBevelDiffGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4117.StraightBevelDiffGearMeshPowerFlow]':
