...
class BoltAdvancedSystemDeflection(_7260.ComponentAdvancedSystemDeflection):
    """BoltAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2689.BoltSystemDeflection]':
