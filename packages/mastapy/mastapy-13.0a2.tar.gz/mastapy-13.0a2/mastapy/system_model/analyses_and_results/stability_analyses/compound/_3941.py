...
class KlingelnbergCycloPalloidConicalGearMeshCompoundStabilityAnalysis(_3907.ConicalGearMeshCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3809.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3809.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis]':
