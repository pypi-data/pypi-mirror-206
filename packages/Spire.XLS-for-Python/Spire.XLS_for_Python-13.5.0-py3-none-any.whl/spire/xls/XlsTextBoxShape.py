...
class XlsTextBoxShape (  XlsShape, ITextBoxLinkShape, TextBoxShapeBase) :
    ...
    def ShapeType(self)->'ExcelShapeType':
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_ShapeType(self.Ptr)
    ...
    def Text(self)->str:
        ...
        GetDllLibXls().XlsTextBoxShape_get_Text.restype=c_wchar_p
        ret = GetDllLibXls().XlsTextBoxShape_get_Text(self.Ptr)
        return ret
    ...
    def Text(self, value:str):
        ...
        GetDllLibXls().XlsTextBoxShape_set_Text(self.Ptr, value)
    ...
    def IsTextLocked(self)->bool:
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_IsTextLocked(self.Ptr)
        return ret

    @IsTextLocked.setter
    def IsTextLocked(self, value:bool):
        GetDllLibXls().XlsTextBoxShape_set_IsTextLocked.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsTextBoxShape_set_IsTextLocked(self.Ptr, value)
    ...
    def IsWrapText(self)->bool:
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_IsWrapText(self.Ptr)
        return ret

    @IsWrapText.setter
    def IsWrapText(self, value:bool):
        GetDllLibXls().XlsTextBoxShape_set_IsWrapText.argtypes=[c_void_p, c_bool]
        GetDllLibXls().XlsTextBoxShape_set_IsWrapText(self.Ptr, value)
    ...
    def TextRotation(self)->'TextRotationType':
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_TextRotation(self.Ptr)
    ...
    def TextRotation(self, value:'TextRotationType'):
        ...
        GetDllLibXls().XlsTextBoxShape_set_TextRotation(self.Ptr, value.value)
    ...
    def RichText(self)->'IRichTextString':
        ...
        intPtr = GetDllLibXls().XlsTextBoxShape_get_RichText(self.Ptr)
    ...
    def HAlignment(self)->'CommentHAlignType':
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_HAlignment(self.Ptr)
    ...
    def HAlignment(self, value:'CommentHAlignType'):
        ...
        GetDllLibXls().XlsTextBoxShape_set_HAlignment(self.Ptr, value.value)
    ...
    def VAlignment(self)->'CommentVAlignType':
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_VAlignment(self.Ptr)
    ...
    def VAlignment(self, value:'CommentVAlignType'):
        ...
        GetDllLibXls().XlsTextBoxShape_set_VAlignment(self.Ptr, value.value)
    ...
    def Coordinates2007(self)->'Rectangle':
        ...
        intPtr = GetDllLibXls().XlsTextBoxShape_get_Coordinates2007(self.Ptr)
    ...
    def Coordinates2007(self, value:'Rectangle'):
        ...
        GetDllLibXls().XlsTextBoxShape_set_Coordinates2007(self.Ptr, value.Ptr)
    ...
    def HasStyleProperties(self)->bool:
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_HasStyleProperties(self.Ptr)
        return ret
    ...
    def TextFieldId(self)->str:
        ...
        GetDllLibXls().XlsTextBoxShape_get_TextFieldId.restype=c_wchar_p
        ret = GetDllLibXls().XlsTextBoxShape_get_TextFieldId(self.Ptr)
        return ret
    ...
    def TextFieldId(self, value:str):
        ...
        GetDllLibXls().XlsTextBoxShape_set_TextFieldId(self.Ptr, value)
    ...
    def TextFieldType(self)->str:
        ...
        GetDllLibXls().XlsTextBoxShape_get_TextFieldType.restype=c_wchar_p
        ret = GetDllLibXls().XlsTextBoxShape_get_TextFieldType(self.Ptr)
        return ret
    ...
    def TextFieldType(self, value:str):
        ...
        GetDllLibXls().XlsTextBoxShape_set_TextFieldType(self.Ptr, value)
    ...
    def FillColor(self)->'Color':
        ...
        intPtr = GetDllLibXls().XlsTextBoxShape_get_FillColor(self.Ptr)
    ...
    def FillColor(self, value:'Color'):
        ...
        GetDllLibXls().XlsTextBoxShape_set_FillColor(self.Ptr, value.Ptr)
    ...
    def InsetMode(self)->str:
        ...
        GetDllLibXls().XlsTextBoxShape_get_InsetMode.restype=c_wchar_p
        ret = GetDllLibXls().XlsTextBoxShape_get_InsetMode(self.Ptr)
        return ret
    ...
    def InsetMode(self, value:str):
        ...
        GetDllLibXls().XlsTextBoxShape_set_InsetMode(self.Ptr, value)
    ...
    def LeftMarginEMU(self)->int:
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_LeftMarginEMU(self.Ptr)
        return ret
    ...
    def LeftMarginEMU(self, value:int):
        ...
        GetDllLibXls().XlsTextBoxShape_set_LeftMarginEMU(self.Ptr, value)
    ...
    def TopMarginEMU(self)->int:
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_TopMarginEMU(self.Ptr)
        return ret

    @TopMarginEMU.setter
    def TopMarginEMU(self, value:int):
        GetDllLibXls().XlsTextBoxShape_set_TopMarginEMU.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsTextBoxShape_set_TopMarginEMU(self.Ptr, value)
    ...
    def RightMarginEMU(self)->int:
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_RightMarginEMU(self.Ptr)
        return ret
    ...
    def RightMarginEMU(self, value:int):
        ...
        GetDllLibXls().XlsTextBoxShape_set_RightMarginEMU(self.Ptr, value)
    ...
    def BottomMarginEMU(self)->int:
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_BottomMarginEMU(self.Ptr)
        return ret
    ...
    def BottomMarginEMU(self, value:int):
        ...
        GetDllLibXls().XlsTextBoxShape_set_BottomMarginEMU(self.Ptr, value)
    ...
    def InnerBottomMargin(self)->float:
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_InnerBottomMargin(self.Ptr)
        return ret
    ...
    def InnerBottomMargin(self, value:float):
        ...
        GetDllLibXls().XlsTextBoxShape_set_InnerBottomMargin(self.Ptr, value)
    ...
    def InnerLeftMargin(self)->float:
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_InnerLeftMargin(self.Ptr)
        return ret
    ...
    def InnerLeftMargin(self, value:float):
        ...
        GetDllLibXls().XlsTextBoxShape_set_InnerLeftMargin(self.Ptr, value)
    ...
    def InnerRightMargin(self)->float:
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_InnerRightMargin(self.Ptr)
        return ret
    ...
    def InnerRightMargin(self, value:float):
        ...
        GetDllLibXls().XlsTextBoxShape_set_InnerRightMargin(self.Ptr, value)
    ...
    def InnerTopMargin(self)->float:
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_InnerTopMargin(self.Ptr)
        return ret
    ...
    def InnerTopMargin(self, value:float):
        ...
        GetDllLibXls().XlsTextBoxShape_set_InnerTopMargin(self.Ptr, value)
    ...
    def VertOverflow(self)->str:
        ...
        GetDllLibXls().XlsTextBoxShape_get_VertOverflow.restype=c_wchar_p
        ret = GetDllLibXls().XlsTextBoxShape_get_VertOverflow(self.Ptr)
        return ret
    ...
    def VertOverflow(self, value:str):
        ...
        GetDllLibXls().XlsTextBoxShape_set_VertOverflow(self.Ptr, value)
    ...
    def HorzOverflow(self)->str:
        ...
        GetDllLibXls().XlsTextBoxShape_get_HorzOverflow.restype=c_wchar_p
        ret = GetDllLibXls().XlsTextBoxShape_get_HorzOverflow(self.Ptr)
        return ret
    ...
    def HorzOverflow(self, value:str):
        ...
        GetDllLibXls().XlsTextBoxShape_set_HorzOverflow(self.Ptr, value)
    ...
    def Anchor(self)->str:
        ...
        GetDllLibXls().XlsTextBoxShape_get_Anchor.restype=c_wchar_p
        ret = GetDllLibXls().XlsTextBoxShape_get_Anchor(self.Ptr)
        return ret
    ...
    def Anchor(self, value:str):
        ...
        GetDllLibXls().XlsTextBoxShape_set_Anchor(self.Ptr, value)
    ...
    def Vert(self)->str:
        ...
        GetDllLibXls().XlsTextBoxShape_get_Vert.restype=c_wchar_p
        ret = GetDllLibXls().XlsTextBoxShape_get_Vert(self.Ptr)
        return ret
    ...
    def Vert(self, value:str):
        ...
        GetDllLibXls().XlsTextBoxShape_set_Vert(self.Ptr, value)
    ...
    def IsTextWrapped(self)->bool:
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_IsTextWrapped(self.Ptr)
        return ret
    ...
    def IsTextWrapped(self, value:bool):
        ...
        GetDllLibXls().XlsTextBoxShape_set_IsTextWrapped(self.Ptr, value)
    ...
    def UpRight(self)->int:
        ...
        ret = GetDllLibXls().XlsTextBoxShape_get_UpRight(self.Ptr)
        return ret

    @UpRight.setter
    def UpRight(self, value:int):
        GetDllLibXls().XlsTextBoxShape_set_UpRight.argtypes=[c_void_p, c_int]
        GetDllLibXls().XlsTextBoxShape_set_UpRight(self.Ptr, value)
    ...
    def HyLink(self)->'IHyperLink':
        ...
        intPtr = GetDllLibXls().XlsTextBoxShape_get_HyLink(self.Ptr)
...
#        intPtr = GetDllLibXls().XlsTextBoxShape_Clone(self.Ptr, intPtrparent,intPtrhashNewNames,intPtrdicFontIndexes,addToCollections)
