...
class PowerLoadSteadyStateSynchronousResponseAtASpeed(_3606.VirtualComponentSteadyStateSynchronousResponseAtASpeed):
    """PowerLoadSteadyStateSynchronousResponseAtASpeed
    ...
    class _Cast_PowerLoadSteadyStateSynchronousResponseAtASpeed:
        ...
        def __init__(self, parent: 'PowerLoadSteadyStateSynchronousResponseAtASpeed'):
            self._parent = parent
        ...
        @property
        def power_load_steady_state_synchronous_response_at_a_speed(self) -> 'PowerLoadSteadyStateSynchronousResponseAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PowerLoadSteadyStateSynchronousResponseAtASpeed._Cast_PowerLoadSteadyStateSynchronousResponseAtASpeed':
