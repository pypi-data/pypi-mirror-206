...
mapping_clinical_category = json.load(open('data/PDPM_ICD10_Mappings_FY2020_clinical_category.json'))
mapping_NTA = json.load(open('data/PDPM_ICD10_Mappings_FY2020_NTA.json'))
mapping_SLP = json.load(open('data/PDPM_ICD10_Mappings_FY2020_SLP.json'))
