...
SchemaFor200ResponseBodyApplicationJson = GetAccountNumbersResponse
...
class GetAccountNumbers(BaseApi):
    ...
    def get_account_numbers(
        ...
        return self._get_account_numbers_oapg(
