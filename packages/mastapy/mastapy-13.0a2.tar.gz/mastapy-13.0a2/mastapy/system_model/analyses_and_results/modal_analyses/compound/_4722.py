...
class ClutchCompoundModalAnalysis(_4738.CouplingCompoundModalAnalysis):
    """ClutchCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4570.ClutchModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4570.ClutchModalAnalysis]':
