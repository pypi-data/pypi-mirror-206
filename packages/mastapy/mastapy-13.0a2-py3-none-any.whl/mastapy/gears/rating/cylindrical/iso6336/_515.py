...
from mastapy.gears.rating.cylindrical.iso6336 import _509, _514, _513
...
class ISO6336AbstractMetalMeshSingleFlankRating(_513.ISO6336AbstractMeshSingleFlankRating):
    """ISO6336AbstractMetalMeshSingleFlankRating
    ...
    class _Cast_ISO6336AbstractMetalMeshSingleFlankRating:
        ...
        def __init__(self, parent: 'ISO6336AbstractMetalMeshSingleFlankRating'):
            self._parent = parent
        ...
        @property
        def iso6336_abstract_metal_mesh_single_flank_rating(self) -> 'ISO6336AbstractMetalMeshSingleFlankRating':
            return self._parent
    ...
    @property
    def scuffing_rating_method_flash_temperature_method(self) -> '_476.ScuffingFlashTemperatureRatingMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _476.ScuffingFlashTemperatureRatingMethod)
        return constructor.new_from_mastapy_type(_476.ScuffingFlashTemperatureRatingMethod)(value) if value is not None else None

    @property
    def scuffing_rating_method_integral_temperature_method(self) -> '_477.ScuffingIntegralTemperatureRatingMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, _477.ScuffingIntegralTemperatureRatingMethod)
        return constructor.new_from_mastapy_type(_477.ScuffingIntegralTemperatureRatingMethod)(value) if value is not None else None
    ...
    @property
    def scuffing_temperature_method(self) -> '_1067.ScuffingTemperatureMethodsISO':
        ...
        value = conversion.pn_to_mp_enum(temp, _1067.ScuffingTemperatureMethodsISO)
        return constructor.new_from_mastapy_type(_1067.ScuffingTemperatureMethodsISO)(value) if value is not None else None
    ...
    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_509.ISO63362006MeshSingleFlankRating':
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_455.CylindricalGearMicroPittingResults':
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_514.ISO6336AbstractMetalGearSingleFlankRating]':
    ...
    @property
    def cast_to(self) -> 'ISO6336AbstractMetalMeshSingleFlankRating._Cast_ISO6336AbstractMetalMeshSingleFlankRating':
