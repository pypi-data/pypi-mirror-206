...
from mastapy.system_model.analyses_and_results.static_loads import _6926, _6927, _6794
...
class StraightBevelGearSetLoadCase(_6794.BevelGearSetLoadCase):
    """StraightBevelGearSetLoadCase
    ...
    class _Cast_StraightBevelGearSetLoadCase:
        ...
        def __init__(self, parent: 'StraightBevelGearSetLoadCase'):
            self._parent = parent
        ...
        @property
        def straight_bevel_gear_set_load_case(self) -> 'StraightBevelGearSetLoadCase':
            return self._parent
    ...
    @property
    def gears(self) -> 'List[_6926.StraightBevelGearLoadCase]':
    ...
    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6926.StraightBevelGearLoadCase]':
    ...
    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6927.StraightBevelGearMeshLoadCase]':
    ...
    @property
    def cast_to(self) -> 'StraightBevelGearSetLoadCase._Cast_StraightBevelGearSetLoadCase':
