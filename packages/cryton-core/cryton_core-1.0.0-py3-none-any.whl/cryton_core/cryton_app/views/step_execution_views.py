...
from cryton_core.cryton_app.models import StepExecutionModel
from cryton_core.lib.util import exceptions as core_exceptions
from cryton_core.lib.models.step import StepExecution
...
class StepExecutionViewSet(util.ExecutionViewSet):
    ...
    @extend_schema(
        description="Delete Step execution.",
        responses={
    ...
    def destroy(self, request: Request, *args, **kwargs):
        step_ex_id = kwargs.get('pk')

        try:
            StepExecution(step_execution_id=step_ex_id).delete()
