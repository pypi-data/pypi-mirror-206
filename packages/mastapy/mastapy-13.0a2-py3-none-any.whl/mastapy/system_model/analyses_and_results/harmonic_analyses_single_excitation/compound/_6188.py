...
class PlanetaryConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6202.ShaftToMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """PlanetaryConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_PlanetaryConnectionCompoundHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'PlanetaryConnectionCompoundHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def planetary_connection_compound_harmonic_analysis_of_single_excitation(self) -> 'PlanetaryConnectionCompoundHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6059.PlanetaryConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6059.PlanetaryConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cast_to(self) -> 'PlanetaryConnectionCompoundHarmonicAnalysisOfSingleExcitation._Cast_PlanetaryConnectionCompoundHarmonicAnalysisOfSingleExcitation':
        return self._Cast_PlanetaryConnectionCompoundHarmonicAnalysisOfSingleExcitation(self)
