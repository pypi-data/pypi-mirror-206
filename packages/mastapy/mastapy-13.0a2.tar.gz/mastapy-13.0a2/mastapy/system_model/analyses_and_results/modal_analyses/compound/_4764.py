...
class HypoidGearMeshCompoundModalAnalysis(_4706.AGMAGleasonConicalGearMeshCompoundModalAnalysis):
    """HypoidGearMeshCompoundModalAnalysis
    ...
    class _Cast_HypoidGearMeshCompoundModalAnalysis:
        ...
        def __init__(self, parent: 'HypoidGearMeshCompoundModalAnalysis'):
            self._parent = parent
        ...
        @property
        def hypoid_gear_mesh_compound_modal_analysis(self) -> 'HypoidGearMeshCompoundModalAnalysis':
            return self._parent
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4613.HypoidGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4613.HypoidGearMeshModalAnalysis]':
    ...
    @property
    def cast_to(self) -> 'HypoidGearMeshCompoundModalAnalysis._Cast_HypoidGearMeshCompoundModalAnalysis':
