...
class AGMA6123SplineJointDutyCycleRating(_0.APIBase):
    ...
    class _Cast_AGMA6123SplineJointDutyCycleRating:
        ...
        def __init__(self, parent: 'AGMA6123SplineJointDutyCycleRating'):
            self._parent = parent

        @property
        def agma6123_spline_joint_duty_cycle_rating(self) -> 'AGMA6123SplineJointDutyCycleRating':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'AGMA6123SplineJointDutyCycleRating._Cast_AGMA6123SplineJointDutyCycleRating':
