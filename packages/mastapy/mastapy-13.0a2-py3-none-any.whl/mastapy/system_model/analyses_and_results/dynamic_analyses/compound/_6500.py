...
class ZerolBevelGearMeshCompoundDynamicAnalysis(_6390.BevelGearMeshCompoundDynamicAnalysis):
    """ZerolBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6371.ZerolBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6371.ZerolBevelGearMeshDynamicAnalysis]':
