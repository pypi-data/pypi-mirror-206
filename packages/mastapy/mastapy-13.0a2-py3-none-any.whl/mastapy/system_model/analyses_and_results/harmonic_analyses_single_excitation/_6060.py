...
class PlanetaryGearSetHarmonicAnalysisOfSingleExcitation(_6024.CylindricalGearSetHarmonicAnalysisOfSingleExcitation):
    """PlanetaryGearSetHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_PlanetaryGearSetHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'PlanetaryGearSetHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def planetary_gear_set_harmonic_analysis_of_single_excitation(self) -> 'PlanetaryGearSetHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'PlanetaryGearSetHarmonicAnalysisOfSingleExcitation._Cast_PlanetaryGearSetHarmonicAnalysisOfSingleExcitation':
