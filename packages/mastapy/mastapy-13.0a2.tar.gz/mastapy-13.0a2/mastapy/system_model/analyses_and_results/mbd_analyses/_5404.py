...
class FaceGearMultibodyDynamicsAnalysis(_5410.GearMultibodyDynamicsAnalysis):
    """FaceGearMultibodyDynamicsAnalysis
    ...
    class _Cast_FaceGearMultibodyDynamicsAnalysis:
        ...
        def __init__(self, parent: 'FaceGearMultibodyDynamicsAnalysis'):
            self._parent = parent
        ...
        @property
        def face_gear_multibody_dynamics_analysis(self) -> 'FaceGearMultibodyDynamicsAnalysis':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'FaceGearMultibodyDynamicsAnalysis._Cast_FaceGearMultibodyDynamicsAnalysis':
