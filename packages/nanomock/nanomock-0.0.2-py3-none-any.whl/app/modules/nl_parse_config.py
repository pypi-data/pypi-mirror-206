...
from nanomesh.modules.nl_nanolib import NanoLibTools, raw_high_precision_multiply
from nanomesh.modules.nl_rpc import NanoRpc
from nanomesh.internal.utils import read_from_package_if_needed, is_packaged_version
...
class ConfigParser:
    ...
    def _set_path_variables(self, app_dir):
        ...
        if is_packaged_version():
            self.services_dir = "nanomesh.internal.data.services"
    ...
    def get_docker_tag(self, node_name):
        ...
        #last uses the default nanocurrency/nano-beta:latest tag
