...
sleep = asyncio.sleep  # unasync: remove
sleep = time.sleep

SyncFilterFunc: TypeAlias = Callable[[Window], Awaitable[bool]]  # unasync: remove
...
SyncPropertyReturnOptionalAsyncWindow: TypeAlias = Coroutine[None, None, Optional[Window]]  # unasync: remove
