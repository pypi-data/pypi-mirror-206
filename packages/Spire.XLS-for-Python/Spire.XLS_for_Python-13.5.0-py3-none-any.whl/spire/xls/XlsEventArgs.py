...
class XlsEventArgs (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsEventArgs_get_newValue(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsEventArgs_get_oldValue(self.Ptr)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    <summary>
        ...
        GetDllLibXls().XlsEventArgs_get_Name.restype=c_wchar_p
        ret = GetDllLibXls().XlsEventArgs_get_Name(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibXls().XlsEventArgs_get_Next(self.Ptr)
    ...
    def Next(self, value:'XlsEventArgs'):
        ...
        GetDllLibXls().XlsEventArgs_set_Next(self.Ptr, value.Ptr)
    ...
    def get_Empty()->'XlsEventArgs':
        ...
        intPtr = GetDllLibXls().XlsEventArgs_get_Empty()
        ret = None if intPtr==None else XlsEventArgs(intPtr)
        return ret
