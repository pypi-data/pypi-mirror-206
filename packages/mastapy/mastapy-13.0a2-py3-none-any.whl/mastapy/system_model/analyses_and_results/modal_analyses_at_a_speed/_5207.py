...
class TorqueConverterModalAnalysisAtASpeed(_5128.CouplingModalAnalysisAtASpeed):
    """TorqueConverterModalAnalysisAtASpeed
    ...
    class _Cast_TorqueConverterModalAnalysisAtASpeed:
        ...
        def __init__(self, parent: 'TorqueConverterModalAnalysisAtASpeed'):
            self._parent = parent
        ...
        @property
        def torque_converter_modal_analysis_at_a_speed(self) -> 'TorqueConverterModalAnalysisAtASpeed':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'TorqueConverterModalAnalysisAtASpeed._Cast_TorqueConverterModalAnalysisAtASpeed':
