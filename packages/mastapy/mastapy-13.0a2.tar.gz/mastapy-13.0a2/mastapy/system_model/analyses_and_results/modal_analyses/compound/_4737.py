...
class ConnectorCompoundModalAnalysis(_4778.MountableComponentCompoundModalAnalysis):
    """ConnectorCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4583.ConnectorModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4583.ConnectorModalAnalysis]':
