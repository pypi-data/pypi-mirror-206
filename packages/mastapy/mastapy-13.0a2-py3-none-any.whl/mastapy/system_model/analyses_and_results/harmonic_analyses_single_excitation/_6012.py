...
class CouplingConnectionHarmonicAnalysisOfSingleExcitation(_6041.InterMountableComponentConnectionHarmonicAnalysisOfSingleExcitation):
    """CouplingConnectionHarmonicAnalysisOfSingleExcitation
    ...
    class _Cast_CouplingConnectionHarmonicAnalysisOfSingleExcitation:
        ...
        def __init__(self, parent: 'CouplingConnectionHarmonicAnalysisOfSingleExcitation'):
            self._parent = parent
        ...
        @property
        def coupling_connection_harmonic_analysis_of_single_excitation(self) -> 'CouplingConnectionHarmonicAnalysisOfSingleExcitation':
            return self._parent
    ...
    @property
    def cast_to(self) -> 'CouplingConnectionHarmonicAnalysisOfSingleExcitation._Cast_CouplingConnectionHarmonicAnalysisOfSingleExcitation':
